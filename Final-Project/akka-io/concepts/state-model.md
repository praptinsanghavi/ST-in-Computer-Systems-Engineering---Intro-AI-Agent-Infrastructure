...
section: concepts
site: akka-io
source_url: https://doc.akka.io/concepts/state-model.html
title: 'Memory models :: Akka Documentation'
---

# Memory models :: Akka Documentation
...
Entities have operations that can change their state. These operations are triggered asynchronously and implemented via methods that return [`Effect`](declarative-effects.html). Operations allow entities to be dynamic and reflect the most up\-to\-date information and this all gets wired together for you.
...
---
*Source: [https://doc.akka.io/concepts/state-model.html](https://doc.akka.io/concepts/state-model.html)*