...
section: concepts
site: akka-io
source_url: https://doc.akka.io/concepts/saga-patterns.html
title: 'Saga patterns :: Akka Documentation'
---

# Saga patterns :: Akka Documentation
...
| - Centralized control and logic - Easier to track progress and transaction state - Clear audit trail - Can become a coordination bottleneck - Tighter coupling between orchestrator and services | - Decentralized control - Low coordination overhead - Services are only coupled to events - Increased complexity in ensuring proper failure handling - Harder to debug and monitor long\-running flows |
...
---
*Source: [https://doc.akka.io/concepts/saga-patterns.html](https://doc.akka.io/concepts/saga-patterns.html)*