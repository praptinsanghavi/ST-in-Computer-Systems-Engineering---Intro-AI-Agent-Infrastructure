...
scraped_at: '2026-04-05T19:39:29Z'
section: operations
site: akka-io
source_url: https://doc.akka.io/operations/services/view-data.html
title: 'Viewing data :: Akka Documentation'
---

# Viewing data :: Akka Documentation
...
The results are paged. To learn about interacting with pages, see [Paging results](#_paging_results).
...
- [`akka service components` commands](../../reference/cli/akka-cli/akka_services_components.html#_see_also)
...
### Example 2: Listing entity ids

```bash
akka service components list-ids my-service com.example.MyEntity
```

### Example 3: Listing event sourced entity events

```bash
akka service components list-events my-service com.example.MyEntity entity-id
```

### Example 4: Listing event sourced entity events

```bash
akka service components list-events my-service com.example.MyEntity entity-id -o json
```

### Example 5: Listing event sourced entity events

```bash
akka service components list-events my-service com.example.MyEntity entity-id -o json --raw
```

### Example 6: Paging results
...
---
*Source: [https://doc.akka.io/operations/services/view-data.html](https://doc.akka.io/operations/services/view-data.html)*