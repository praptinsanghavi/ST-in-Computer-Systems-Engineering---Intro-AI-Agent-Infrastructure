...
section: operations
site: akka-io
source_url: https://doc.akka.io/operations/organizations/regions.html
title: 'Regions :: Akka Documentation'
---

# Regions :: Akka Documentation
...
- [`akka regions` commands](../../reference/cli/akka-cli/akka_regions.html#_see_also)
- [`akka project regions` commands](../../reference/cli/akka-cli/akka_projects_regions.html#_see_also)

## Code Examples

### Example 1: For Organizations

```command
akka project new myproject --organization myorg --region aws-us-east-2
```

### Example 2: Finding Available Regions
...
### Example 3: Finding Available Regions

```command
akka regions list --organization myorg
```

### Example 4: Finding Available Regions
...
- https://doc.akka.io/reference/cli/akka-cli/akka_regions.html

---
*Source: [https://doc.akka.io/operations/organizations/regions.html](https://doc.akka.io/operations/organizations/regions.html)*