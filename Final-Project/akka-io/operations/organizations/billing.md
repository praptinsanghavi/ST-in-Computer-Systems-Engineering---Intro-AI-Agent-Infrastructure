...
section: operations
site: akka-io
source_url: https://doc.akka.io/operations/organizations/billing.html
title: 'Billing :: Akka Documentation'
---

# Billing :: Akka Documentation
...
Billing data is accessible only to users with the **billing\-admin** role. For more information on assigning this role, see the [Assigning the billing\-admin Role](#assigning_billing_admin) section below.
...
### Example 1: Assigning the billing-admin Role
...
### Example 2: Assigning the billing-admin Role
...
---
*Source: [https://doc.akka.io/operations/organizations/billing.html](https://doc.akka.io/operations/organizations/billing.html)*