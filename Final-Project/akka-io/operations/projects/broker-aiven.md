...
section: operations
site: akka-io
source_url: https://doc.akka.io/operations/projects/broker-aiven.html
title: 'Using Aiven for Apache Kafka :: Akka Documentation'
---

# Using Aiven for Apache Kafka :: Akka Documentation
...
7. Contact [\[email protected]](/cdn-cgi/l/email-protection#d2a1a7a2a2bda0a692b3b9b9b3fcbbbd) to open a port in Akka to reach your Aiven port configured above.
...
Instructions from Aiven’s [Creating an Apache Kafka topic](https://docs.aiven.io/docs/products/kafka/howto/create-topic)
...
See Aiven’s [Manage Aiven for Apache Kafka topics](https://docs.aiven.io/docs/tools/cli/service/topic#avn-cli-service-topic-create)
...
### Example 1: Steps to connect to an Aiven Kafka service

```command
akka config get-project
```

### Example 2: Steps to connect to an Aiven Kafka service

```command
akka secret create tls-ca kafka-ca-cert --cert ./ca.pem
```

### Example 3: Steps to connect to an Aiven Kafka service

```command
akka secret create generic kafka-secret --literal pwd=<the password>
```

### Example 4: Steps to connect to an Aiven Kafka service
...
### Example 5: Steps to connect to an Aiven Kafka service

```command
akka projects config get broker
```

### Example 6: Create a topic
...
---
*Source: [https://doc.akka.io/operations/projects/broker-aiven.html](https://doc.akka.io/operations/projects/broker-aiven.html)*