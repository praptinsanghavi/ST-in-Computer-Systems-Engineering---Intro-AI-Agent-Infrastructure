...
section: operations
site: akka-io
source_url: https://doc.akka.io/operations/projects/broker-confluent.html
title: 'Using Confluent Cloud as Kafka service :: Akka Documentation'
---

# Using Confluent Cloud as Kafka service :: Akka Documentation
...
### Example 1: Steps to connect to a Confluent Cloud Kafka broker

```command
akka config get-project
```

### Example 2: Steps to connect to a Confluent Cloud Kafka broker

```command
akka secret create generic confluent-api-secret --literal secret=<the API key secret>
```

### Example 3: Steps to connect to a Confluent Cloud Kafka broker
...
### Example 4: Steps to connect to a Confluent Cloud Kafka broker

```command
akka projects config get broker
```

### Example 5: Create a topic
...
---
*Source: [https://doc.akka.io/operations/projects/broker-confluent.html](https://doc.akka.io/operations/projects/broker-confluent.html)*