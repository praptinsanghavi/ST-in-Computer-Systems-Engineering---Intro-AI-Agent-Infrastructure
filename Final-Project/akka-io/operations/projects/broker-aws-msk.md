...
section: operations
site: akka-io
source_url: https://doc.akka.io/operations/projects/broker-aws-msk.html
title: 'Using AWS MSK as Kafka service :: Akka Documentation'
---

# Using AWS MSK as Kafka service :: Akka Documentation
...
2. The MSK cluster must be set up with [TLS for client broker connections and SASL/SCRAM for authentication](https://docs.aws.amazon.com/msk/latest/developerguide/msk-password.html)
...
### Example 1: Steps to connect to an AWS Kafka broker

```command
akka config get-project
```

### Example 2: Steps to connect to an AWS Kafka broker

```command
akka secret create generic aws-msk-secret --literal pwd=<sasl user password>
```

### Example 3: Steps to connect to an AWS Kafka broker
...
### Example 4: Steps to connect to an AWS Kafka broker

```command
akka projects config get broker
```

### Example 5: Custom key pair

```command
akka secret create tls-ca kafka-ca-cert --cert ./ca.pem
```

### Example 6: Custom key pair
...
---
*Source: [https://doc.akka.io/operations/projects/broker-aws-msk.html](https://doc.akka.io/operations/projects/broker-aws-msk.html)*