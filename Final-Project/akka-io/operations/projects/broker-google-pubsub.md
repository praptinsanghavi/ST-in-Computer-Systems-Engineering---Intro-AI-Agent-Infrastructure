...
scraped_at: '2026-04-05T18:28:53Z'
section: operations
site: akka-io
source_url: https://doc.akka.io/operations/projects/broker-google-pubsub.html
title: 'Using Google Cloud Pub/Sub as message broker :: Akka Documentation'
---

# Using Google Cloud Pub/Sub as message broker :: Akka Documentation
...
### Example 1: Setting up the service account
...
### Example 2: Setting up the service account

```command
gcloud iam service-accounts create akka-broker
```

### Example 3: Setting up the service account
...
### Example 4: Setting up the service account
...
### Example 5: Setting up the service account
...
### Example 7: Topic and subscription in separate projects

```java
@Consume.FromTopic("projects/the-other-project-id/topics/the-topic-id")
```

### Example 8: Topic and subscription in separate projects
...
### Example 9: Topic and subscription management options
...
---
*Source: [https://doc.akka.io/operations/projects/broker-google-pubsub.html](https://doc.akka.io/operations/projects/broker-google-pubsub.html)*