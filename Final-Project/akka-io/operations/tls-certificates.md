...
section: operations
site: akka-io
source_url: https://doc.akka.io/operations/tls-certificates.html
title: 'TLS certificates :: Akka Documentation'
---

# TLS certificates :: Akka Documentation
...
- [`akka secret create` commands](../reference/cli/akka-cli/akka_secrets_create.html)
- [`akka routes` commands](../reference/cli/akka-cli/akka_routes.html)
- [Route Descriptor reference](../reference/descriptors/route-descriptor.html)

## Code Examples

### Example 1: Creating your own CA
...
### Example 2: Creating your own CA
...
### Example 3: Configuring client CA in Akka

```shell
akka secret create tls-ca my-root-ca --cert ./my-root-ca.crt
```

### Example 4: Configuring client CA in Akka

```shell
akka route create my-route --client-ca-secret my-root-ca
```

### Example 5: Configuring client CA in Akka

```shell
akka route update my-route --client-ca-secret my-root-ca
```

### Example 6: Configuring a client CA via the Route Descriptor
...
### Example 9: Client certificate validation

```shellscript
akka route update my-route --client-certificate-subject client.acme.org
```

### Example 10: Client certificate validation

```shellscript
akka route update my-route --client-certificate-subject *.acme.org
```

### Example 11: Configuring certificate validation using the Route Descriptor
...
### Example 12: Configuring certificate validation using the Route Descriptor
...
### Example 13: Custom server certificates

```shell
akka secret create tls my-tls-cert --key ./my-key.pem --cert ./my-cert.pem
```

### Example 14: Custom server certificates

```shell
akka route update my-route --server-certificate-secret my-tls-cert
```

### Example 15: Configuring custom certificates with the Route Descriptor
...
---
*Source: [https://doc.akka.io/operations/tls-certificates.html](https://doc.akka.io/operations/tls-certificates.html)*