---
description: Release notes for all Alpakka Kafka 2.1.x releases.
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:18:32Z'
section: docs
site: akka-io
source_url: https://doc.akka.io/libraries/alpakka-kafka/current/release-notes/2.1.x.html
title: Alpakka Kafka 2.1.x • Alpakka Kafka Documentation
---

# Alpakka Kafka 2.1.x • Alpakka Kafka Documentation

> **Summary:** Release notes for all Alpakka Kafka 2.1.x releases.
...
| --- | --- | --- | --- |
| [ygree **ygree**](https://github.com/ygree) | 6 | 68 | 23 |
...
| Author | Commits | Lines added | Lines removed |
| --- | --- | --- | --- |
| [scala-steward **scala\-steward**](https://github.com/scala-steward) | 5 | 11 | 11 |
| [seglo **seglo**](https://github.com/seglo) | 1 | 265 | 7 |
...
| Author | Commits | Lines added | Lines removed |
| --- | --- | --- | --- |
| [scala-steward **scala\-steward**](https://github.com/scala-steward) | 39 | 41 | 41 |
| [ennru **ennru**](https://github.com/ennru) | 35 | 515 | 296 |
| [seglo **seglo**](https://github.com/seglo) | 25 | 2516 | 2593 |
| [octonato **octonato**](https://github.com/octonato) | 2 | 4 | 4 |
| [jyates **jyates**](https://github.com/jyates) | 1 | 925 | 71 |
| [jhooda **jhooda**](https://github.com/jhooda) | 1 | 381 | 20 |
| [Matzz **Matzz**](https://github.com/Matzz) | 1 | 94 | 65 |
| [altomch **altomch**](https://github.com/altomch) | 1 | 51 | 52 |
| [ashendon **ashendon**](https://github.com/ashendon) | 1 | 8 | 0 |
| [johanandren **johanandren**](https://github.com/johanandren) | 1 | 1 | 1 |
| [kciesielski **kciesielski**](https://github.com/kciesielski) | 1 | 1 | 1 |
...
| Author | Commits | Lines added | Lines removed |
| --- | --- | --- | --- |
| [ennru **ennru**](https://github.com/ennru) | 27 | 338 | 253 |
| [seglo **seglo**](https://github.com/seglo) | 11 | 1577 | 2228 |
| [scala-steward **scala\-steward**](https://github.com/scala-steward) | 6 | 6 | 6 |
| [herzrasen **herzrasen**](https://github.com/herzrasen) | 1 | 34 | 0 |

## Related Pages (Internal Links)

- https://doc.akka.io/
- https://doc.akka.io/docs/alpakka-kafka/current/release-notes/2.0.x.html
- https://doc.akka.io/docs/alpakka-kafka/current/release-notes/3.0.x.html

---
*Source: [https://doc.akka.io/docs/alpakka-kafka/current/release-notes/2.1.x.html](https://doc.akka.io/docs/alpakka-kafka/current/release-notes/2.1.x.html)*