...
scraped_at: '2026-04-06T16:59:02Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/XForwardedFor.html
title: XForwardedFor
---
...
`[X$minusForwarded$minusFor](../../../scaladsl/model/headers/X$minusForwarded$minusFor.html "class in akka.http.scaladsl.model.headers")`

---

```
public abstract class XForwardedFor
...
- - ### Nested Class Summary
	...
	| `static [XForwardedFor](XForwardedFor.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.RemoteAddress...))​([RemoteAddress](../RemoteAddress.html "class in akka.http.javadsl.model")... addresses)` |  |
	| `abstract java.lang.Iterable<[RemoteAddress](../RemoteAddress.html "class in akka.http.javadsl.model")>` | `[getAddresses](#getAddresses())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public abstract java.lang.Iterable<[RemoteAddress](../RemoteAddress.html "class in akka.http.javadsl.model")> getAddresses()
		```
		- #### create
		...
		```
		public static [XForwardedFor](XForwardedFor.html "class in akka.http.javadsl.model.headers") create​([RemoteAddress](../RemoteAddress.html "class in akka.http.javadsl.model")... addresses)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/XForwardedFor.html
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/X$minusForwarded$minusFor.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/XForwardedFor.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/XForwardedFor.html)*