...
scraped_at: '2026-04-06T16:58:45Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/LastEventId.html
title: LastEventId
---
...
`[Last$minusEvent$minusID](../../../scaladsl/model/headers/Last$minusEvent$minusID.html "class in akka.http.scaladsl.model.headers")`

---

```
public abstract class LastEventId
...
- - ### Nested Class Summary
	...
	| `static [LastEventId](LastEventId.html "class in akka.http.javadsl.model.headers")` | `[create](#create(java.lang.String))​(java.lang.String id)` | Creates a Last\-Event\-ID header. |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [LastEventId](LastEventId.html "class in akka.http.javadsl.model.headers") create​(java.lang.String id)
		```
		...
		See Also:
		[`ServerSentEvent`](../sse/ServerSentEvent.html "class in akka.http.javadsl.model.sse")
		- #### id
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/Last$minusEvent$minusID.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/LastEventId.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/LastEventId.html)*