...
scraped_at: '2026-04-06T16:58:43Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/IfUnmodifiedSince.html
...
`[If$minusUnmodified$minusSince](../../../scaladsl/model/headers/If$minusUnmodified$minusSince.html "class in akka.http.scaladsl.model.headers")`

---

```
public abstract class IfUnmodifiedSince
...
- - ### Nested Class Summary
	...
	| `static [IfUnmodifiedSince](IfUnmodifiedSince.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.DateTime))​([DateTime](../DateTime.html "class in akka.http.javadsl.model") date)` |  |
	| `abstract [DateTime](../DateTime.html "class in akka.http.javadsl.model")` | `[date](#date())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public abstract [DateTime](../DateTime.html "class in akka.http.javadsl.model") date()
		```
		- #### create
		...
		```
		public static [IfUnmodifiedSince](IfUnmodifiedSince.html "class in akka.http.javadsl.model.headers") create​([DateTime](../DateTime.html "class in akka.http.javadsl.model") date)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/If$minusUnmodified$minusSince.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/IfUnmodifiedSince.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/IfUnmodifiedSince.html)*