...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/ContentType.html
title: ContentType
---
...
`[Content$minusType](../../../scaladsl/model/headers/Content$minusType.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `abstract [ContentType](../ContentType.html "interface in akka.http.javadsl.model")` | `[contentType](#contentType())()` |  |
	| `static [ContentType](ContentType.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.ContentType))​([ContentType](../ContentType.html "interface in akka.http.javadsl.model") contentType)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public abstract [ContentType](../ContentType.html "interface in akka.http.javadsl.model") contentType()
		```
		- #### create
		...
		```
		public static [ContentType](ContentType.html "class in akka.http.javadsl.model.headers") create​([ContentType](../ContentType.html "interface in akka.http.javadsl.model") contentType)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/Content$minusType.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/ContentType.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/ContentType.html)*