...
scraped_at: '2026-04-06T16:59:01Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/UserAgent.html
title: UserAgent
---
...
`[User$minusAgent](../../../scaladsl/model/headers/User$minusAgent.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [UserAgent](UserAgent.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.headers.ProductVersion...))​([ProductVersion](ProductVersion.html "class in akka.http.javadsl.model.headers")... products)` |  |
	| `static [UserAgent](UserAgent.html "class in akka.http.javadsl.model.headers")` | `[create](#create(java.lang.String))​(java.lang.String products)` |  |
	| `abstract java.lang.Iterable<[ProductVersion](ProductVersion.html "class in akka.http.javadsl.model.headers")>` | `[getProducts](#getProducts())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public abstract java.lang.Iterable<[ProductVersion](ProductVersion.html "class in akka.http.javadsl.model.headers")> getProducts()
		```
		- #### create
		...
		```
		public static [UserAgent](UserAgent.html "class in akka.http.javadsl.model.headers") create​([ProductVersion](ProductVersion.html "class in akka.http.javadsl.model.headers")... products)
		```
		- #### create
		...
		```
		public static [UserAgent](UserAgent.html "class in akka.http.javadsl.model.headers") create​(java.lang.String products)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/UserAgent.html
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/User$minusAgent.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/UserAgent.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/UserAgent.html)*