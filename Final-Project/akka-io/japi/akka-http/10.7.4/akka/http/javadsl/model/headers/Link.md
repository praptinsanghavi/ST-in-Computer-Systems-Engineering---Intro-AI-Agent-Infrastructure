...
scraped_at: '2026-04-06T16:58:46Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Link.html
title: Link
---
...
`[Link](../../../scaladsl/model/headers/Link.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [Link](Link.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.headers.LinkValue...))​([LinkValue](LinkValue.html "class in akka.http.javadsl.model.headers")... values)` |  |
	| `abstract java.lang.Iterable<[LinkValue](LinkValue.html "class in akka.http.javadsl.model.headers")>` | `[getValues](#getValues())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public abstract java.lang.Iterable<[LinkValue](LinkValue.html "class in akka.http.javadsl.model.headers")> getValues()
		```
		- #### create
		...
		```
		public static [Link](Link.html "class in akka.http.javadsl.model.headers") create​([LinkValue](LinkValue.html "class in akka.http.javadsl.model.headers")... values)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/LinkValue.html
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/Link.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Link.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Link.html)*