...
scraped_at: '2026-04-06T16:58:35Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/ContentEncoding.html
...
`[Content$minusEncoding](../../../scaladsl/model/headers/Content$minusEncoding.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [ContentEncoding](ContentEncoding.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.headers.HttpEncoding...))​([HttpEncoding](HttpEncoding.html "class in akka.http.javadsl.model.headers")... encodings)` |  |
	| `abstract java.lang.Iterable<[HttpEncoding](HttpEncoding.html "class in akka.http.javadsl.model.headers")>` | `[getEncodings](#getEncodings())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public abstract java.lang.Iterable<[HttpEncoding](HttpEncoding.html "class in akka.http.javadsl.model.headers")> getEncodings()
		```
		- #### create
		...
		```
		public static [ContentEncoding](ContentEncoding.html "class in akka.http.javadsl.model.headers") create​([HttpEncoding](HttpEncoding.html "class in akka.http.javadsl.model.headers")... encodings)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/Content$minusEncoding.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/ContentEncoding.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/ContentEncoding.html)*