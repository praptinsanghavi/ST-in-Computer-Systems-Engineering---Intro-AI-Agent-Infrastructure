...
scraped_at: '2026-04-06T16:58:51Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Range.html
title: Range
---
...
`[Range](../../../scaladsl/model/headers/Range.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [Range](Range.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.headers.RangeUnit,akka.http.javadsl.model.headers.ByteRange...))​([RangeUnit](RangeUnit.html "class in akka.http.javadsl.model.headers") rangeUnit,  [ByteRange](ByteRange.html "class in akka.http.javadsl.model.headers")... ranges)` |  |
	| `abstract java.lang.Iterable<[ByteRange](ByteRange.html "class in akka.http.javadsl.model.headers")>` | `[getRanges](#getRanges())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public abstract java.lang.Iterable<[ByteRange](ByteRange.html "class in akka.http.javadsl.model.headers")> getRanges()
		```
		- #### create
		...
		```
		public static [Range](Range.html "class in akka.http.javadsl.model.headers") create​([RangeUnit](RangeUnit.html "class in akka.http.javadsl.model.headers") rangeUnit,
		                           [ByteRange](ByteRange.html "class in akka.http.javadsl.model.headers")... ranges)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Range.html
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/RangeUnit.html
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/Range.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Range.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Range.html)*