...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/AccessControlAllowCredentials.html
title: AccessControlAllowCredentials
---
...
`[Access$minusControl$minusAllow$minusCredentials](../../../scaladsl/model/headers/Access$minusControl$minusAllow$minusCredentials.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `[AccessControlAllowCredentials](#%3Cinit%3E())()` |  |
	...
	| `abstract boolean` | `[allow](#allow())()` |  |
	| `static [AccessControlAllowCredentials](AccessControlAllowCredentials.html "class in akka.http.javadsl.model.headers")` | `[create](#create(boolean))​(boolean allow)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [AccessControlAllowCredentials](AccessControlAllowCredentials.html "class in akka.http.javadsl.model.headers") create​(boolean allow)
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/AccessControlAllowCredentials.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/AccessControlAllowCredentials.html)*