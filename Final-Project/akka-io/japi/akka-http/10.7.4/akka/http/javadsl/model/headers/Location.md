...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Location.html
title: Location
---
...
`[Location](../../../scaladsl/model/headers/Location.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [Location](Location.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.Uri))​([Uri](../Uri.html "class in akka.http.javadsl.model") uri)` |  |
	| `static [Location](Location.html "class in akka.http.javadsl.model.headers")` | `[create](#create(java.lang.String))​(java.lang.String uri)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [Location](Location.html "class in akka.http.javadsl.model.headers") create​([Uri](../Uri.html "class in akka.http.javadsl.model") uri)
		```
		- #### create
		...
		```
		public static [Location](Location.html "class in akka.http.javadsl.model.headers") create​(java.lang.String uri)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/Location.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Location.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Location.html)*