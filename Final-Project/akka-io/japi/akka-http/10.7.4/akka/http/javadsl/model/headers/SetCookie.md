...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/SetCookie.html
title: SetCookie
---
...
`[Set$minusCookie](../../../scaladsl/model/headers/Set$minusCookie.html "class in akka.http.scaladsl.model.headers")`

---

```
public abstract class SetCookie
...
- - ### Nested Class Summary
	...
	| `abstract [HttpCookie](HttpCookie.html "class in akka.http.javadsl.model.headers")` | `[cookie](#cookie())()` |  |
	| `static [SetCookie](SetCookie.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.headers.HttpCookie))​([HttpCookie](HttpCookie.html "class in akka.http.javadsl.model.headers") cookie)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public abstract [HttpCookie](HttpCookie.html "class in akka.http.javadsl.model.headers") cookie()
		```
		- #### create
		...
		```
		public static [SetCookie](SetCookie.html "class in akka.http.javadsl.model.headers") create​([HttpCookie](HttpCookie.html "class in akka.http.javadsl.model.headers") cookie)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/SetCookie.html
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/Set$minusCookie.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/SetCookie.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/SetCookie.html)*