...
scraped_at: '2026-04-06T16:58:28Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/AccessControlAllowOrigin.html
...
- - ### Nested Class Summary
	...
	| `[AccessControlAllowOrigin](#%3Cinit%3E())()` |  |
	...
	| `static [AccessControlAllowOrigin](AccessControlAllowOrigin.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.headers.HttpOriginRange))​([HttpOriginRange](HttpOriginRange.html "class in akka.http.javadsl.model.headers") range)` |  |
	| `static [AccessControlAllowOrigin](AccessControlAllowOrigin.html "class in akka.http.javadsl.model.headers")` | `[nullOrigin](#nullOrigin())()` |  |
	| `abstract [HttpOriginRange](HttpOriginRange.html "class in akka.http.javadsl.model.headers")` | `[range](#range())()` |  |
	| `static [AccessControlAllowOrigin](AccessControlAllowOrigin.html "class in akka.http.javadsl.model.headers")` | `[wildcard](#wildcard())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public abstract [HttpOriginRange](HttpOriginRange.html "class in akka.http.javadsl.model.headers") range()
		```
		- #### wildcard
		...
		```
		public static [AccessControlAllowOrigin](AccessControlAllowOrigin.html "class in akka.http.javadsl.model.headers") wildcard()
		```
		- #### nullOrigin
		...
		```
		public static [AccessControlAllowOrigin](AccessControlAllowOrigin.html "class in akka.http.javadsl.model.headers") nullOrigin()
		```
		- #### create
		...
		```
		public static [AccessControlAllowOrigin](AccessControlAllowOrigin.html "class in akka.http.javadsl.model.headers") create​([HttpOriginRange](HttpOriginRange.html "class in akka.http.javadsl.model.headers") range)
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/AccessControlAllowOrigin.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/AccessControlAllowOrigin.html)*