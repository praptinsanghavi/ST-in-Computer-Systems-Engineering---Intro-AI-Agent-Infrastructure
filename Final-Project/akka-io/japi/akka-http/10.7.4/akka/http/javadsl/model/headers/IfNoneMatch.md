...
scraped_at: '2026-04-06T16:58:44Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/IfNoneMatch.html
title: IfNoneMatch
---
...
`[If$minusNone$minusMatch](../../../scaladsl/model/headers/If$minusNone$minusMatch.html "class in akka.http.scaladsl.model.headers")`

---

```
public abstract class IfNoneMatch
...
- - ### Nested Class Summary
	...
	| `static [IfNoneMatch](IfNoneMatch.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.headers.EntityTagRange))​([EntityTagRange](EntityTagRange.html "class in akka.http.javadsl.model.headers") m)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [IfNoneMatch](IfNoneMatch.html "class in akka.http.javadsl.model.headers") create​([EntityTagRange](EntityTagRange.html "class in akka.http.javadsl.model.headers") m)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/If$minusNone$minusMatch.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/IfNoneMatch.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/IfNoneMatch.html)*