...
scraped_at: '2026-04-06T16:58:54Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Referer.html
title: Referer
---
...
`[Referer](../../../scaladsl/model/headers/Referer.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [Referer](Referer.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.Uri))​([Uri](../Uri.html "class in akka.http.javadsl.model") uri)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [Referer](Referer.html "class in akka.http.javadsl.model.headers") create​([Uri](../Uri.html "class in akka.http.javadsl.model") uri)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Referer.html
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/Referer.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Referer.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Referer.html)*