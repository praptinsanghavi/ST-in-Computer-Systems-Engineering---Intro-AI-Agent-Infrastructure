...
scraped_at: '2026-04-06T16:59:03Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/XRealIp.html
title: XRealIp
---
...
`[X$minusReal$minusIp](../../../scaladsl/model/headers/X$minusReal$minusIp.html "class in akka.http.scaladsl.model.headers")`

---

```
public abstract class XRealIp
...
- - ### Nested Class Summary
	...
	| `abstract [RemoteAddress](../RemoteAddress.html "class in akka.http.javadsl.model")` | `[address](#address())()` |  |
	| `static [XRealIp](XRealIp.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.RemoteAddress))​([RemoteAddress](../RemoteAddress.html "class in akka.http.javadsl.model") address)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [XRealIp](XRealIp.html "class in akka.http.javadsl.model.headers") create​([RemoteAddress](../RemoteAddress.html "class in akka.http.javadsl.model") address)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/XRealIp.html
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/X$minusReal$minusIp.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/XRealIp.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/XRealIp.html)*