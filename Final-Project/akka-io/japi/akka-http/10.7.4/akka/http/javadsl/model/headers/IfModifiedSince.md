...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/IfModifiedSince.html
...
`[If$minusModified$minusSince](../../../scaladsl/model/headers/If$minusModified$minusSince.html "class in akka.http.scaladsl.model.headers")`

---

```
public abstract class IfModifiedSince
...
- - ### Nested Class Summary
	...
	| `static [IfModifiedSince](IfModifiedSince.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.DateTime))​([DateTime](../DateTime.html "class in akka.http.javadsl.model") date)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [IfModifiedSince](IfModifiedSince.html "class in akka.http.javadsl.model.headers") create​([DateTime](../DateTime.html "class in akka.http.javadsl.model") date)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/If$minusModified$minusSince.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/IfModifiedSince.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/IfModifiedSince.html)*