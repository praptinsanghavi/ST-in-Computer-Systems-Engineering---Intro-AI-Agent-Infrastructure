...
scraped_at: '2026-04-06T16:59:00Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/TransferEncoding.html
...
`[Transfer$minusEncoding](../../../scaladsl/model/headers/Transfer$minusEncoding.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [TransferEncoding](TransferEncoding.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.TransferEncoding...))​([TransferEncoding](../TransferEncoding.html "class in akka.http.javadsl.model")... encodings)` |  |
	| `abstract java.lang.Iterable<[TransferEncoding](../TransferEncoding.html "class in akka.http.javadsl.model")>` | `[getEncodings](#getEncodings())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public abstract java.lang.Iterable<[TransferEncoding](../TransferEncoding.html "class in akka.http.javadsl.model")> getEncodings()
		```
		- #### create
		...
		```
		public static [TransferEncoding](TransferEncoding.html "class in akka.http.javadsl.model.headers") create​([TransferEncoding](../TransferEncoding.html "class in akka.http.javadsl.model")... encodings)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/TransferEncoding.html
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/Transfer$minusEncoding.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/TransferEncoding.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/TransferEncoding.html)*