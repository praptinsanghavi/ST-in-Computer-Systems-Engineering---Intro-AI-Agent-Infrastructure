...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/AccessControlAllowMethods.html
title: AccessControlAllowMethods
---
...
`[Access$minusControl$minusAllow$minusMethods](../../../scaladsl/model/headers/Access$minusControl$minusAllow$minusMethods.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `[AccessControlAllowMethods](#%3Cinit%3E())()` |  |
	...
	| `static [AccessControlAllowMethods](AccessControlAllowMethods.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.HttpMethod...))​([HttpMethod](../HttpMethod.html "class in akka.http.javadsl.model")... methods)` |  |
	| `abstract java.lang.Iterable<[HttpMethod](../HttpMethod.html "class in akka.http.javadsl.model")>` | `[getMethods](#getMethods())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public abstract java.lang.Iterable<[HttpMethod](../HttpMethod.html "class in akka.http.javadsl.model")> getMethods()
		```
		- #### create
		...
		```
		public static [AccessControlAllowMethods](AccessControlAllowMethods.html "class in akka.http.javadsl.model.headers") create​([HttpMethod](../HttpMethod.html "class in akka.http.javadsl.model")... methods)
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/AccessControlAllowMethods.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/AccessControlAllowMethods.html)*