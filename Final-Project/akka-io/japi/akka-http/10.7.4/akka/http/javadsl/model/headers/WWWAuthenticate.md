...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/WWWAuthenticate.html
...
`[WWW$minusAuthenticate](../../../scaladsl/model/headers/WWW$minusAuthenticate.html "class in akka.http.scaladsl.model.headers")`

---

```
public abstract class WWWAuthenticate
...
- - ### Nested Class Summary
	...
	| `static [WWWAuthenticate](WWWAuthenticate.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.headers.HttpChallenge...))​([HttpChallenge](HttpChallenge.html "class in akka.http.javadsl.model.headers")... challenges)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [WWWAuthenticate](WWWAuthenticate.html "class in akka.http.javadsl.model.headers") create​([HttpChallenge](HttpChallenge.html "class in akka.http.javadsl.model.headers")... challenges)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/WWWAuthenticate.html
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/WWW$minusAuthenticate.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/WWWAuthenticate.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/WWWAuthenticate.html)*