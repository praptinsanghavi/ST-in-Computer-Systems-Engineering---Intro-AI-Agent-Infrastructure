...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/RawRequestURI.html
title: RawRequestURI
---
...
`[Raw$minusRequest$minusURI](../../../scaladsl/model/headers/Raw$minusRequest$minusURI.html "class in akka.http.scaladsl.model.headers")`

---

```
public abstract class RawRequestURI
...
- - ### Nested Class Summary
	...
	| `static [RawRequestURI](RawRequestURI.html "class in akka.http.javadsl.model.headers")` | `[create](#create(java.lang.String))​(java.lang.String uri)` |  |
	| `abstract java.lang.String` | `[uri](#uri())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [RawRequestURI](RawRequestURI.html "class in akka.http.javadsl.model.headers") create​(java.lang.String uri)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/RawRequestURI.html
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/Raw$minusRequest$minusURI.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/RawRequestURI.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/RawRequestURI.html)*