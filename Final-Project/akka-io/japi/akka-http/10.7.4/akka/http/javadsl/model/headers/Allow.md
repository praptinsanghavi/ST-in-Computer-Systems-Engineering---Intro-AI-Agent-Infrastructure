...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Allow.html
title: Allow
---
...
`[Allow](../../../scaladsl/model/headers/Allow.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [Allow](Allow.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.HttpMethod...))​([HttpMethod](../HttpMethod.html "class in akka.http.javadsl.model")... methods)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [Allow](Allow.html "class in akka.http.javadsl.model.headers") create​([HttpMethod](../HttpMethod.html "class in akka.http.javadsl.model")... methods)
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Allow.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Allow.html)*