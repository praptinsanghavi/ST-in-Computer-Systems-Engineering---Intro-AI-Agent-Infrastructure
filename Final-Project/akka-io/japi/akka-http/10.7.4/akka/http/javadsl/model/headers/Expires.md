...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Expires.html
title: Expires
---
...
`[Expires](../../../scaladsl/model/headers/Expires.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [Expires](Expires.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.DateTime))​([DateTime](../DateTime.html "class in akka.http.javadsl.model") date)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [Expires](Expires.html "class in akka.http.javadsl.model.headers") create​([DateTime](../DateTime.html "class in akka.http.javadsl.model") date)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/Expires.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Expires.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Expires.html)*