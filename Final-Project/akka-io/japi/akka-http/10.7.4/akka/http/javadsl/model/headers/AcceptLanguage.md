...
scraped_at: '2026-04-06T16:58:25Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/AcceptLanguage.html
...
`[Accept$minusLanguage](../../../scaladsl/model/headers/Accept$minusLanguage.html "class in akka.http.scaladsl.model.headers")`

---

```
public abstract class AcceptLanguage
...
- - ### Nested Class Summary
	...
	| `static [AcceptLanguage](AcceptLanguage.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.headers.LanguageRange...))​([LanguageRange](LanguageRange.html "interface in akka.http.javadsl.model.headers")... languages)` |  |
	| `abstract java.lang.Iterable<[LanguageRange](LanguageRange.html "interface in akka.http.javadsl.model.headers")>` | `[getLanguages](#getLanguages())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public abstract java.lang.Iterable<[LanguageRange](LanguageRange.html "interface in akka.http.javadsl.model.headers")> getLanguages()
		```
		- #### create
		...
		```
		public static [AcceptLanguage](AcceptLanguage.html "class in akka.http.javadsl.model.headers") create​([LanguageRange](LanguageRange.html "interface in akka.http.javadsl.model.headers")... languages)
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/AcceptLanguage.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/AcceptLanguage.html)*