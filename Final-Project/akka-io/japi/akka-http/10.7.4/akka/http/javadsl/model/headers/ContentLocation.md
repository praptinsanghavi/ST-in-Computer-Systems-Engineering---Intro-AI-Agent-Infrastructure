...
scraped_at: '2026-04-06T16:58:38Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/ContentLocation.html
...
`[Content$minusLocation](../../../scaladsl/model/headers/Content$minusLocation.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [ContentLocation](ContentLocation.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.Uri))​([Uri](../Uri.html "class in akka.http.javadsl.model") uri)` |  |
	| `static [ContentLocation](ContentLocation.html "class in akka.http.javadsl.model.headers")` | `[create](#create(java.lang.String))​(java.lang.String uri)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [ContentLocation](ContentLocation.html "class in akka.http.javadsl.model.headers") create​([Uri](../Uri.html "class in akka.http.javadsl.model") uri)
		```
		- #### create
		...
		```
		public static [ContentLocation](ContentLocation.html "class in akka.http.javadsl.model.headers") create​(java.lang.String uri)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/Content$minusLocation.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/ContentLocation.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/ContentLocation.html)*