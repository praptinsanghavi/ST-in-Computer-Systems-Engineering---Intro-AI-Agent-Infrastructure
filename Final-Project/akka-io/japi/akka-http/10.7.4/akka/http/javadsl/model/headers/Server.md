...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Server.html
title: Server
---
...
`[Server](../../../scaladsl/model/headers/Server.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [Server](Server.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.headers.ProductVersion...))​([ProductVersion](ProductVersion.html "class in akka.http.javadsl.model.headers")... products)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [Server](Server.html "class in akka.http.javadsl.model.headers") create​([ProductVersion](ProductVersion.html "class in akka.http.javadsl.model.headers")... products)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Server.html
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/Server.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Server.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/Server.html)*