...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/CacheControl.html
title: CacheControl
---
...
`[Cache$minusControl](../../../scaladsl/model/headers/Cache$minusControl.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [CacheControl](CacheControl.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.headers.CacheDirective...))​([CacheDirective](CacheDirective.html "interface in akka.http.javadsl.model.headers")... directives)` |  |
	| `abstract java.lang.Iterable<[CacheDirective](CacheDirective.html "interface in akka.http.javadsl.model.headers")>` | `[getDirectives](#getDirectives())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public abstract java.lang.Iterable<[CacheDirective](CacheDirective.html "interface in akka.http.javadsl.model.headers")> getDirectives()
		```
		- #### create
		...
		```
		public static [CacheControl](CacheControl.html "class in akka.http.javadsl.model.headers") create​([CacheDirective](CacheDirective.html "interface in akka.http.javadsl.model.headers")... directives)
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/CacheControl.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/CacheControl.html)*