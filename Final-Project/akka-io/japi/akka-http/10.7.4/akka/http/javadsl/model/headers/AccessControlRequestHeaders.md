...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/AccessControlRequestHeaders.html
title: AccessControlRequestHeaders
---
...
## Class AccessControlRequestHeaders
...
`[Access$minusControl$minusRequest$minusHeaders](../../../scaladsl/model/headers/Access$minusControl$minusRequest$minusHeaders.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `[AccessControlRequestHeaders](#%3Cinit%3E())()` |  |
	...
	| `static [AccessControlRequestHeaders](AccessControlRequestHeaders.html "class in akka.http.javadsl.model.headers")` | `[create](#create(java.lang.String...))​(java.lang.String... headers)` |  |
	| `abstract java.lang.Iterable<java.lang.String>` | `[getHeaders](#getHeaders())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public abstract java.lang.Iterable<java.lang.String> getHeaders()
		```
		- #### create
		...
		```
		public static [AccessControlRequestHeaders](AccessControlRequestHeaders.html "class in akka.http.javadsl.model.headers") create​(java.lang.String... headers)
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/AccessControlRequestHeaders.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/AccessControlRequestHeaders.html)*