...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/TlsSessionInfo.html
title: TlsSessionInfo
---
...
`[Tls$minusSession$minusInfo](../../../scaladsl/model/headers/Tls$minusSession$minusInfo.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [TlsSessionInfo](TlsSessionInfo.html "class in akka.http.javadsl.model.headers")` | `[create](#create(javax.net.ssl.SSLSession))​(javax.net.ssl.SSLSession session)` |  |
	| `abstract javax.net.ssl.SSLSession` | `[getSession](#getSession())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [TlsSessionInfo](TlsSessionInfo.html "class in akka.http.javadsl.model.headers") create​(javax.net.ssl.SSLSession session)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/TlsSessionInfo.html
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/Tls$minusSession$minusInfo.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/TlsSessionInfo.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/TlsSessionInfo.html)*