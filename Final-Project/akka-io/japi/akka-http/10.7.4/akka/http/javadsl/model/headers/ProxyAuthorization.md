...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/ProxyAuthorization.html
...
`[Proxy$minusAuthorization](../../../scaladsl/model/headers/Proxy$minusAuthorization.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [ProxyAuthorization](ProxyAuthorization.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.headers.HttpCredentials))​([HttpCredentials](HttpCredentials.html "class in akka.http.javadsl.model.headers") credentials)` |  |
	| `abstract [HttpCredentials](HttpCredentials.html "class in akka.http.javadsl.model.headers")` | `[credentials](#credentials())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public abstract [HttpCredentials](HttpCredentials.html "class in akka.http.javadsl.model.headers") credentials()
		```
		- #### create
		...
		```
		public static [ProxyAuthorization](ProxyAuthorization.html "class in akka.http.javadsl.model.headers") create​([HttpCredentials](HttpCredentials.html "class in akka.http.javadsl.model.headers") credentials)
		```
...
- https://doc.akka.io/japi/akka-http/10.7.4/akka/http/scaladsl/model/headers/Proxy$minusAuthorization.html

---
*Source: [https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/ProxyAuthorization.html](https://doc.akka.io/japi/akka-http/10.7.4/akka/http/javadsl/model/headers/ProxyAuthorization.html)*