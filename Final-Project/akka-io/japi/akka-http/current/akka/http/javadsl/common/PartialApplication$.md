...
- - ### Field Summary
	...
	| `static [PartialApplication$](PartialApplication$.html "class in akka.http.javadsl.common")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `<A,​B,​R>java.util.function.Function<B,​R>` | `[bindParameter](#bindParameter(java.util.function.BiFunction,A))​(java.util.function.BiFunction<A,​B,​R> f,  A a)` | It partially applies function A. |
...
- - ### Field Detail
		...
		```
		public static final [PartialApplication$](PartialApplication$.html "class in akka.http.javadsl.common") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public <A,​B,​R> java.util.function.Function<B,​R> bindParameter​(java.util.function.BiFunction<A,​B,​R> f,
		                                                                                A a)
		```
