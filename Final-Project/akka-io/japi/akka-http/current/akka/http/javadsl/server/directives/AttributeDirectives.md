...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/server/directives/AttributeDirectives.html
...
```
public abstract class AttributeDirectives
extends [HeaderDirectives](HeaderDirectives.html "class in akka.http.javadsl.server.directives")
```
...
- - ### Constructor Summary
	...
	| `<T> [RouteAdapter](RouteAdapter.html "class in akka.http.javadsl.server.directives")` | `[attribute](#attribute(akka.http.javadsl.model.AttributeKey,java.util.function.Function))​([AttributeKey](../../model/AttributeKey.html "class in akka.http.javadsl.model")<T> key,  java.util.function.Function<T,​[Route](../Route.html "interface in akka.http.javadsl.server")> inner)` | Extracts the value of the request attribute with the given key. |
	| `<T> [RouteAdapter](RouteAdapter.html "class in akka.http.javadsl.server.directives")` | `[optionalAttribute](#optionalAttribute(akka.http.javadsl.model.AttributeKey,java.util.function.Function))​([AttributeKey](../../model/AttributeKey.html "class in akka.http.javadsl.model")<T> key,  java.util.function.Function<java.util.Optional<T>,​[Route](../Route.html "interface in akka.http.javadsl.server")> inner)` | Extracts the value of the optional request attribute with the given key. |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public <T> [RouteAdapter](RouteAdapter.html "class in akka.http.javadsl.server.directives") attribute​([AttributeKey](../../model/AttributeKey.html "class in akka.http.javadsl.model")<T> key,
		...
		Extracts the value of the request attribute with the given key.
		 If no attribute is found the request is rejected with a [`MissingAttributeRejection`](../MissingAttributeRejection.html "interface in akka.http.javadsl.server").
		...
		```
		public <T> [RouteAdapter](RouteAdapter.html "class in akka.http.javadsl.server.directives") optionalAttribute​([AttributeKey](../../model/AttributeKey.html "class in akka.http.javadsl.model")<T> key,
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/server/directives/AttributeDirectives.html](https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/server/directives/AttributeDirectives.html)*