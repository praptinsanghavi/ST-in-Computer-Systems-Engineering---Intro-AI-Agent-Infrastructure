...
scraped_at: '2026-04-06T00:28:09Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/unmarshalling/sse/EventStreamUnmarshalling$.html
...
- - ### Field Summary
	...
	| `static [EventStreamUnmarshalling$](EventStreamUnmarshalling$.html "class in akka.http.javadsl.unmarshalling.sse")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [EventStreamUnmarshalling$](EventStreamUnmarshalling$.html "class in akka.http.javadsl.unmarshalling.sse") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public [Unmarshaller](../Unmarshaller.html "class in akka.http.javadsl.unmarshalling")<[HttpEntity](../../model/HttpEntity.html "interface in akka.http.javadsl.model"),​akka.stream.javadsl.Source<[ServerSentEvent](../../model/sse/ServerSentEvent.html "class in akka.http.javadsl.model.sse"),​akka.NotUsed>> fromEventStream()
		```
...
- https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/unmarshalling/sse/EventStreamUnmarshalling$.html
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/unmarshalling/sse/EventStreamUnmarshalling$.html](https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/unmarshalling/sse/EventStreamUnmarshalling$.html)*