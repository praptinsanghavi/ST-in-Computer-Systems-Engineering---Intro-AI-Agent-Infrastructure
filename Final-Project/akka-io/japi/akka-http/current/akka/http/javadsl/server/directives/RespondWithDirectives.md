...
scraped_at: '2026-04-05T23:49:12Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/server/directives/RespondWithDirectives.html
...
```
public abstract class RespondWithDirectives
extends [RangeDirectives](RangeDirectives.html "class in akka.http.javadsl.server.directives")
```
...
- - ### Constructor Summary
	...
	| `[RespondWithDirectives](#%3Cinit%3E())()` |  |
	...
	| `[Route](../Route.html "interface in akka.http.javadsl.server")` | `[respondWithDefaultHeader](#respondWithDefaultHeader(akka.http.javadsl.model.HttpHeader,java.util.function.Supplier))​([HttpHeader](../../model/HttpHeader.html "class in akka.http.javadsl.model") responseHeader,  java.util.function.Supplier<[Route](../Route.html "interface in akka.http.javadsl.server")> inner)` | Adds the given response header to all HTTP responses of its inner Route,  if the response from the inner Route doesn't already contain a header with the same name. |
	| `[Route](../Route.html "interface in akka.http.javadsl.server")` | `[respondWithDefaultHeaders](#respondWithDefaultHeaders(java.lang.Iterable,java.util.function.Supplier))​(java.lang.Iterable<[HttpHeader](../../model/HttpHeader.html "class in akka.http.javadsl.model")> responseHeaders,  java.util.function.Supplier<[Route](../Route.html "interface in akka.http.javadsl.server")> inner)` | Adds the given response headers to all HTTP responses of its inner Route,  if a header already exists it is not added again. |
	| `[Route](../Route.html "interface in akka.http.javadsl.server")` | `[respondWithHeader](#respondWithHeader(akka.http.javadsl.model.HttpHeader,java.util.function.Supplier))​([HttpHeader](../../model/HttpHeader.html "class in akka.http.javadsl.model") responseHeader,  java.util.function.Supplier<[Route](../Route.html "interface in akka.http.javadsl.server")> inner)` | Unconditionally adds the given response header to all HTTP responses of its inner Route. |
	| `[Route](../Route.html "interface in akka.http.javadsl.server")` | `[respondWithHeaders](#respondWithHeaders(java.lang.Iterable,java.util.function.Supplier))​(java.lang.Iterable<[HttpHeader](../../model/HttpHeader.html "class in akka.http.javadsl.model")> responseHeaders,  java.util.function.Supplier<[Route](../Route.html "interface in akka.http.javadsl.server")> inner)` | Unconditionally adds the given response headers to all HTTP responses of its inner Route. |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public [Route](../Route.html "interface in akka.http.javadsl.server") respondWithDefaultHeader​([HttpHeader](../../model/HttpHeader.html "class in akka.http.javadsl.model") responseHeader,
		...
		```
		public [Route](../Route.html "interface in akka.http.javadsl.server") respondWithDefaultHeaders​(java.lang.Iterable<[HttpHeader](../../model/HttpHeader.html "class in akka.http.javadsl.model")> responseHeaders,
		                                       java.util.function.Supplier<[Route](../Route.html "interface in akka.http.javadsl.server")> inner)
		```
		...
		```
		public [Route](../Route.html "interface in akka.http.javadsl.server") respondWithHeader​([HttpHeader](../../model/HttpHeader.html "class in akka.http.javadsl.model") responseHeader,
		                               java.util.function.Supplier<[Route](../Route.html "interface in akka.http.javadsl.server")> inner)
		```
		...
		```
		public [Route](../Route.html "interface in akka.http.javadsl.server") respondWithHeaders​(java.lang.Iterable<[HttpHeader](../../model/HttpHeader.html "class in akka.http.javadsl.model")> responseHeaders,
		                                java.util.function.Supplier<[Route](../Route.html "interface in akka.http.javadsl.server")> inner)
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/server/directives/RespondWithDirectives.html](https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/server/directives/RespondWithDirectives.html)*