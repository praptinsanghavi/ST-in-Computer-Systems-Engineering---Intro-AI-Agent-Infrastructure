...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/Connection.html
title: Connection
---
...
`[Connection](../../../scaladsl/model/headers/Connection.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [Connection](Connection.html "class in akka.http.javadsl.model.headers")` | `[create](#create(java.lang.String...))​(java.lang.String... directives)` |  |
	| `abstract java.lang.Iterable<java.lang.String>` | `[getTokens](#getTokens())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [Connection](Connection.html "class in akka.http.javadsl.model.headers") create​(java.lang.String... directives)
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/Connection.html](https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/Connection.html)*