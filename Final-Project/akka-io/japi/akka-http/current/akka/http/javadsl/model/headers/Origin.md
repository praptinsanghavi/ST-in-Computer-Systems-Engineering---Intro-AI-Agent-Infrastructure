...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/Origin.html
title: Origin
---
...
`[Origin](../../../scaladsl/model/headers/Origin.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [Origin](Origin.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.headers.HttpOrigin...))​([HttpOrigin](HttpOrigin.html "class in akka.http.javadsl.model.headers")... origins)` |  |
	| `abstract java.lang.Iterable<[HttpOrigin](HttpOrigin.html "class in akka.http.javadsl.model.headers")>` | `[getOrigins](#getOrigins())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public abstract java.lang.Iterable<[HttpOrigin](HttpOrigin.html "class in akka.http.javadsl.model.headers")> getOrigins()
		```
		- #### create
		...
		```
		public static [Origin](Origin.html "class in akka.http.javadsl.model.headers") create​([HttpOrigin](HttpOrigin.html "class in akka.http.javadsl.model.headers")... origins)
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/Origin.html](https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/Origin.html)*