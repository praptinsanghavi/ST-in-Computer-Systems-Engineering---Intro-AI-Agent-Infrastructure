...
scraped_at: '2026-04-05T23:45:09Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/Date.html
title: Date
---
...
`[Date](../../../scaladsl/model/headers/Date.html "class in akka.http.scaladsl.model.headers")`
...
- - ### Nested Class Summary
	...
	| `static [Date](Date.html "class in akka.http.javadsl.model.headers")` | `[create](#create(akka.http.javadsl.model.DateTime))​([DateTime](../DateTime.html "class in akka.http.javadsl.model") date)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [Date](Date.html "class in akka.http.javadsl.model.headers") create​([DateTime](../DateTime.html "class in akka.http.javadsl.model") date)
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/Date.html](https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/Date.html)*