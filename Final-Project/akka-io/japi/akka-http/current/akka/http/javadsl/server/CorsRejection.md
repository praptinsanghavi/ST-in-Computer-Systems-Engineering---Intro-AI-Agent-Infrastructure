...
scraped_at: '2026-04-05T23:46:49Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/server/CorsRejection.html
title: CorsRejection
---
...
`[CorsRejection](../../scaladsl/server/CorsRejection.html "class in akka.http.scaladsl.server")`

---

```
public interface CorsRejection
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/server/CorsRejection.html](https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/server/CorsRejection.html)*