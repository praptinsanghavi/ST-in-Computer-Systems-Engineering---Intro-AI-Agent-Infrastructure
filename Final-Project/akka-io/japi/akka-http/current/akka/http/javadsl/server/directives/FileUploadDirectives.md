...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/server/directives/FileUploadDirectives.html
...
```
public abstract class FileUploadDirectives
extends [FileAndResourceDirectives](FileAndResourceDirectives.html "class in akka.http.javadsl.server.directives")
```
...
- - ### Constructor Summary
	...
	| `[FileUploadDirectives](#%3Cinit%3E())()` |  |
	...
	| `[Route](../Route.html "interface in akka.http.javadsl.server")` | `[fileUpload](#fileUpload(java.lang.String,java.util.function.BiFunction))​(java.lang.String fieldName,  java.util.function.BiFunction<[FileInfo](FileInfo.html "class in akka.http.javadsl.server.directives"),​akka.stream.javadsl.Source<akka.util.ByteString,​java.lang.Object>,​[Route](../Route.html "interface in akka.http.javadsl.server")> inner)` | Collects each body part that is a multipart file as a tuple containing metadata and a `Source`  for streaming the file contents somewhere. |
	| `[Route](../Route.html "interface in akka.http.javadsl.server")` | `[fileUploadAll](#fileUploadAll(java.lang.String,java.util.function.Function))​(java.lang.String fieldName,  java.util.function.Function<java.util.List<java.util.Map.Entry<[FileInfo](FileInfo.html "class in akka.http.javadsl.server.directives"),​akka.stream.javadsl.Source<akka.util.ByteString,​java.lang.Object>>>,​[Route](../Route.html "interface in akka.http.javadsl.server")> inner)` | Collects each body part that is a multipart file as a tuple containing metadata and a `Source`  for streaming the file contents somewhere. |
	| `[Route](../Route.html "interface in akka.http.javadsl.server")` | `[storeUploadedFile](#storeUploadedFile(java.lang.String,java.util.function.Function,java.util.function.BiFunction))​(java.lang.String fieldName,  java.util.function.Function<[FileInfo](FileInfo.html "class in akka.http.javadsl.server.directives"),​java.io.File> destFn,  java.util.function.BiFunction<[FileInfo](FileInfo.html "class in akka.http.javadsl.server.directives"),​java.io.File,​[Route](../Route.html "interface in akka.http.javadsl.server")> inner)` | Streams the bytes of the file submitted using multipart with the given file name into a designated file on disk. |
	| `[Route](../Route.html "interface in akka.http.javadsl.server")` | `[storeUploadedFiles](#storeUploadedFiles(java.lang.String,java.util.function.Function,java.util.function.Function))​(java.lang.String fieldName,  java.util.function.Function<[FileInfo](FileInfo.html "class in akka.http.javadsl.server.directives"),​java.io.File> destFn,  java.util.function.Function<java.util.List<java.util.Map.Entry<[FileInfo](FileInfo.html "class in akka.http.javadsl.server.directives"),​java.io.File>>,​[Route](../Route.html "interface in akka.http.javadsl.server")> inner)` | Streams the bytes of the file submitted using multipart with the given field name into designated files on disk. |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public [Route](../Route.html "interface in akka.http.javadsl.server") fileUpload​(java.lang.String fieldName,
		...
		```
		public [Route](../Route.html "interface in akka.http.javadsl.server") fileUploadAll​(java.lang.String fieldName,
		...
		```
		public [Route](../Route.html "interface in akka.http.javadsl.server") storeUploadedFile​(java.lang.String fieldName,
		...
		```
		public [Route](../Route.html "interface in akka.http.javadsl.server") storeUploadedFiles​(java.lang.String fieldName,
		                                java.util.function.Function<[FileInfo](FileInfo.html "class in akka.http.javadsl.server.directives"),​java.io.File> destFn,
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/server/directives/FileUploadDirectives.html](https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/server/directives/FileUploadDirectives.html)*