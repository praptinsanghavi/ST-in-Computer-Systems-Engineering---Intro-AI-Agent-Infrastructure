...
- java.lang.Object
- - scala.runtime.AbstractFunction2\<akka.util.ByteString,​java.lang.Object,​[FrameData](FrameData.html "class in akka.http.impl.engine.ws")\>
	- - akka.http.impl.engine.ws.FrameData$

- All Implemented Interfaces:
`java.io.Serializable`, `scala.Function2<akka.util.ByteString,​java.lang.Object,​[FrameData](FrameData.html "class in akka.http.impl.engine.ws")>`

---

```
public class FrameData$
extends scala.runtime.AbstractFunction2<akka.util.ByteString,​java.lang.Object,​[FrameData](FrameData.html "class in akka.http.impl.engine.ws")>
...
- - ### Field Summary
	...
	| `static [FrameData$](FrameData$.html "class in akka.http.impl.engine.ws")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [FrameData$](FrameData$.html "class in akka.http.impl.engine.ws") MODULE$
		```
