...
- java.lang.Object
- - scala.runtime.AbstractFunction1\<akka.stream.scaladsl.Flow\<akka.util.ByteString,​akka.util.ByteString,​java.lang.Object\>,​[UpgradeToOtherProtocolResponseHeader](UpgradeToOtherProtocolResponseHeader.html "class in akka.http.impl.engine.server")\>
	- - akka.http.impl.engine.server.UpgradeToOtherProtocolResponseHeader$

- All Implemented Interfaces:
`java.io.Serializable`, `scala.Function1<akka.stream.scaladsl.Flow<akka.util.ByteString,​akka.util.ByteString,​java.lang.Object>,​[UpgradeToOtherProtocolResponseHeader](UpgradeToOtherProtocolResponseHeader.html "class in akka.http.impl.engine.server")>`

---

```
public class UpgradeToOtherProtocolResponseHeader$
extends scala.runtime.AbstractFunction1<akka.stream.scaladsl.Flow<akka.util.ByteString,​akka.util.ByteString,​java.lang.Object>,​[UpgradeToOtherProtocolResponseHeader](UpgradeToOtherProtocolResponseHeader.html "class in akka.http.impl.engine.server")>
...
- - ### Nested Class Summary
	...
	| `static [UpgradeToOtherProtocolResponseHeader$](UpgradeToOtherProtocolResponseHeader$.html "class in akka.http.impl.engine.server")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `[UpgradeToOtherProtocolResponseHeader$](#%3Cinit%3E())()` |  |
...
- - ### Field Detail
		...
		```
		public static final [UpgradeToOtherProtocolResponseHeader$](UpgradeToOtherProtocolResponseHeader$.html "class in akka.http.impl.engine.server") MODULE$
		```
	...
	- ### Constructor Detail
		...
		```
		public UpgradeToOtherProtocolResponseHeader$()
		```
