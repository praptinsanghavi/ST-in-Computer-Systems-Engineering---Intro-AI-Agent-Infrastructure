...
- java.lang.Object
- - scala.runtime.AbstractFunction1\<[Uri.Query](../../scaladsl/model/Uri.Query.html "class in akka.http.scaladsl.model"),​[JavaQuery](JavaQuery.html "class in akka.http.impl.model")\>
	- - akka.http.impl.model.JavaQuery$

- All Implemented Interfaces:
`java.io.Serializable`, `scala.Function1<[Uri.Query](../../scaladsl/model/Uri.Query.html "class in akka.http.scaladsl.model"),​[JavaQuery](JavaQuery.html "class in akka.http.impl.model")>`

---

```
public class JavaQuery$
extends scala.runtime.AbstractFunction1<[Uri.Query](../../scaladsl/model/Uri.Query.html "class in akka.http.scaladsl.model"),​[JavaQuery](JavaQuery.html "class in akka.http.impl.model")>
...
- - ### Nested Class Summary
	...
	| `static [JavaQuery$](JavaQuery$.html "class in akka.http.impl.model")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [JavaQuery$](JavaQuery$.html "class in akka.http.impl.model") MODULE$
		```
...
- https://doc.akka.io/japi/akka-http/current/akka/http/impl/model/JavaQuery$.html
- https://doc.akka.io/japi/akka-http/current/akka/http/impl/model/JavaQuery.html
