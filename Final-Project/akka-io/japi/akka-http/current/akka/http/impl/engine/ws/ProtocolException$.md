...
scraped_at: '2026-04-05T23:33:50Z'
section: japi
site: akka-io
...
- java.lang.Object
- - scala.runtime.AbstractFunction1\<java.lang.String,​[ProtocolException](ProtocolException.html "class in akka.http.impl.engine.ws")\>
	- - akka.http.impl.engine.ws.ProtocolException$

- All Implemented Interfaces:
`java.io.Serializable`, `scala.Function1<java.lang.String,​[ProtocolException](ProtocolException.html "class in akka.http.impl.engine.ws")>`

---

```
public class ProtocolException$
extends scala.runtime.AbstractFunction1<java.lang.String,​[ProtocolException](ProtocolException.html "class in akka.http.impl.engine.ws")>
...
- - ### Nested Class Summary
	...
	| `static [ProtocolException$](ProtocolException$.html "class in akka.http.impl.engine.ws")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [ProtocolException$](ProtocolException$.html "class in akka.http.impl.engine.ws") MODULE$
		```
