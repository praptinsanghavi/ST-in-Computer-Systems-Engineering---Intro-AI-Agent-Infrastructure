...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/impl/engine/http2/framing/RSTFrameLimit.html
title: RSTFrameLimit
---
...
```
public final class RSTFrameLimit
...
- - ### Nested Class Summary
	...
	| `[RSTFrameLimit](#%3Cinit%3E(akka.http.scaladsl.settings.Http2ServerSettings))​([Http2ServerSettings](../../../../scaladsl/settings/Http2ServerSettings.html "interface in akka.http.scaladsl.settings") http2ServerSettings)` |  |
	...
	| `akka.stream.Inlet<[FrameEvent](../FrameEvent.html "interface in akka.http.impl.engine.http2")>` | `[in](#in())()` |  |
	| `akka.stream.Outlet<[FrameEvent](../FrameEvent.html "interface in akka.http.impl.engine.http2")>` | `[out](#out())()` |  |
...
- - ### Constructor Detail
		...
		```
		public RSTFrameLimit​([Http2ServerSettings](../../../../scaladsl/settings/Http2ServerSettings.html "interface in akka.http.scaladsl.settings") http2ServerSettings)
		```
	...
	- ### Method Detail
		...
		```
		public akka.stream.Inlet<[FrameEvent](../FrameEvent.html "interface in akka.http.impl.engine.http2")> in()
		```
		- #### out
		...
		```
		public akka.stream.Outlet<[FrameEvent](../FrameEvent.html "interface in akka.http.impl.engine.http2")> out()
		```
		- #### shape
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/impl/engine/http2/framing/RSTFrameLimit.html](https://doc.akka.io/japi/akka-http/current/akka/http/impl/engine/http2/framing/RSTFrameLimit.html)*