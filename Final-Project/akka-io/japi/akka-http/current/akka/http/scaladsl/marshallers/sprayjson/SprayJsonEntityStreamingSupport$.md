...
scraped_at: '2026-04-06T00:29:42Z'
section: japi
site: akka-io
...
- - ### Field Summary
	...
	| `static [SprayJsonEntityStreamingSupport$](SprayJsonEntityStreamingSupport$.html "class in akka.http.scaladsl.marshallers.sprayjson")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `[JsonEntityStreamingSupport](JsonEntityStreamingSupport.html "class in akka.http.scaladsl.marshallers.sprayjson")` | `[json](#json())()` | Default `application/json` entity streaming support. |
	| `[JsonEntityStreamingSupport](JsonEntityStreamingSupport.html "class in akka.http.scaladsl.marshallers.sprayjson")` | `[json](#json(int))​(int maxObjectLength)` | Default `application/json` entity streaming support. |
...
- - ### Field Detail
		...
		```
		public static final [SprayJsonEntityStreamingSupport$](SprayJsonEntityStreamingSupport$.html "class in akka.http.scaladsl.marshallers.sprayjson") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public [JsonEntityStreamingSupport](JsonEntityStreamingSupport.html "class in akka.http.scaladsl.marshallers.sprayjson") json()
		```
		...
		```
		public [JsonEntityStreamingSupport](JsonEntityStreamingSupport.html "class in akka.http.scaladsl.marshallers.sprayjson") json​(int maxObjectLength)
		```
...
- https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/marshallers/sprayjson/SprayJsonEntityStreamingSupport$.html
