...
scraped_at: '2026-04-06T00:37:18Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Sec$minusWebSocket$minusExtensions.html
title: Sec$minusWebSocket$minusExtensions
---
...
## Class Sec$minusWebSocket$minusExtensions
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - akka.http.scaladsl.model.headers.Sec$minusWebSocket$minusExtensions
...
```
public final class Sec$minusWebSocket$minusExtensions
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Sec$minusWebSocket$minusExtensions)
...
- - ### Nested Class Summary
	...
	| `[Sec$minusWebSocket$minusExtensions](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<[WebSocketExtension](WebSocketExtension.html "class in akka.http.scaladsl.model.headers")> extensions)` |  |
	...
	| `protected [Sec$minusWebSocket$minusExtensions$](Sec$minusWebSocket$minusExtensions$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `scala.collection.immutable.Seq<[WebSocketExtension](WebSocketExtension.html "class in akka.http.scaladsl.model.headers")>` | `[extensions](#extensions())()` |  |
	| `static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[WebSocketExtension](WebSocketExtension.html "class in akka.http.scaladsl.model.headers")>>` | `[extensionsRenderer](#extensionsRenderer())()` |  |
...
- - ### Constructor Detail
		...
		```
		public Sec$minusWebSocket$minusExtensions​(scala.collection.immutable.Seq<[WebSocketExtension](WebSocketExtension.html "class in akka.http.scaladsl.model.headers")> extensions)
		```
	...
	- ### Method Detail
		...
		```
		public static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[WebSocketExtension](WebSocketExtension.html "class in akka.http.scaladsl.model.headers")>> extensionsRenderer()
		```
		- #### name
		...
		```
		public scala.collection.immutable.Seq<[WebSocketExtension](WebSocketExtension.html "class in akka.http.scaladsl.model.headers")> extensions()
		```
		- #### renderValue
		...
		```
		protected [Sec$minusWebSocket$minusExtensions$](Sec$minusWebSocket$minusExtensions$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Sec$minusWebSocket$minusExtensions.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Sec$minusWebSocket$minusExtensions.html)*