...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.Range](../../../javadsl/model/headers/Range.html "class in akka.http.javadsl.model.headers")
...
extends [Range](../../../javadsl/model/headers/Range.html "class in akka.http.javadsl.model.headers")
...
- - ### Nested Class Summary
	...
	| `[Range](#%3Cinit%3E(akka.http.scaladsl.model.headers.RangeUnit,scala.collection.immutable.Seq))​([RangeUnit](RangeUnit.html "class in akka.http.scaladsl.model.headers") rangeUnit,  scala.collection.immutable.Seq<[ByteRange](ByteRange.html "class in akka.http.scaladsl.model.headers")> ranges)` |  |
	...
	| `static [Range](Range.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(akka.http.scaladsl.model.headers.ByteRange,scala.collection.immutable.Seq))​([ByteRange](ByteRange.html "class in akka.http.scaladsl.model.headers") first,  scala.collection.immutable.Seq<[ByteRange](ByteRange.html "class in akka.http.scaladsl.model.headers")> more)` |  |
	| `static [Range](Range.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<[ByteRange](ByteRange.html "class in akka.http.scaladsl.model.headers")> ranges)` |  |
	| `protected [Range$](Range$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `java.lang.Iterable<[ByteRange](../../../javadsl/model/headers/ByteRange.html "class in akka.http.javadsl.model.headers")>` | `[getRanges](#getRanges())()` | Java API |
	...
	| `scala.collection.immutable.Seq<[ByteRange](ByteRange.html "class in akka.http.scaladsl.model.headers")>` | `[ranges](#ranges())()` |  |
	| `static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[ByteRange](ByteRange.html "class in akka.http.scaladsl.model.headers")>>` | `[rangesRenderer](#rangesRenderer())()` |  |
	| `[RangeUnit](RangeUnit.html "class in akka.http.scaladsl.model.headers")` | `[rangeUnit](#rangeUnit())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[Range](../../../javadsl/model/headers/Range.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/Range.html#create(akka.http.javadsl.model.headers.RangeUnit,akka.http.javadsl.model.headers.ByteRange...))`
...
- - ### Constructor Detail
		...
		```
		public Range​([RangeUnit](RangeUnit.html "class in akka.http.scaladsl.model.headers") rangeUnit,
		             scala.collection.immutable.Seq<[ByteRange](ByteRange.html "class in akka.http.scaladsl.model.headers")> ranges)
		```
	...
	- ### Method Detail
		...
		```
		public static [Range](Range.html "class in akka.http.scaladsl.model.headers") apply​([ByteRange](ByteRange.html "class in akka.http.scaladsl.model.headers") first,
		...
		```
		public static [Range](Range.html "class in akka.http.scaladsl.model.headers") apply​(scala.collection.immutable.Seq<[ByteRange](ByteRange.html "class in akka.http.scaladsl.model.headers")> ranges)
		```
		- #### rangesRenderer
		...
		```
		public static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[ByteRange](ByteRange.html "class in akka.http.scaladsl.model.headers")>> rangesRenderer()
		```
		- #### name
		...
		```
		public [RangeUnit](RangeUnit.html "class in akka.http.scaladsl.model.headers") rangeUnit()
		```
		
		
		Specified by:
		`[rangeUnit](../../../javadsl/model/headers/Range.html#rangeUnit())` in class `[Range](../../../javadsl/model/headers/Range.html "class in akka.http.javadsl.model.headers")`
		- #### ranges
		
		
		
		```
		public scala.collection.immutable.Seq<[ByteRange](ByteRange.html "class in akka.http.scaladsl.model.headers")> ranges()
		```
		- #### renderValue
		...
		```
		protected [Range$](Range$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		```
		public java.lang.Iterable<[ByteRange](../../../javadsl/model/headers/ByteRange.html "class in akka.http.javadsl.model.headers")> getRanges()
		```
		
		Java API
		
		Specified by:
		`[getRanges](../../../javadsl/model/headers/Range.html#getRanges())` in class `[Range](../../../javadsl/model/headers/Range.html "class in akka.http.javadsl.model.headers")`
...
- https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/Range.html
