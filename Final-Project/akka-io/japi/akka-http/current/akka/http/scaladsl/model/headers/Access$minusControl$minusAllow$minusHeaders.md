...
scraped_at: '2026-04-06T00:34:24Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Access$minusControl$minusAllow$minusHeaders.html
title: Access$minusControl$minusAllow$minusHeaders
---
...
## Class Access$minusControl$minusAllow$minusHeaders
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.AccessControlAllowHeaders](../../../javadsl/model/headers/AccessControlAllowHeaders.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.Access$minusControl$minusAllow$minusHeaders
...
```
public final class Access$minusControl$minusAllow$minusHeaders
extends [AccessControlAllowHeaders](../../../javadsl/model/headers/AccessControlAllowHeaders.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Access$minusControl$minusAllow$minusHeaders)
...
- - ### Nested Class Summary
	...
	| `[Access$minusControl$minusAllow$minusHeaders](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<java.lang.String> headers)` |  |
	...
	| `static [Access$minusControl$minusAllow$minusHeaders](Access$minusControl$minusAllow$minusHeaders.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(java.lang.String,scala.collection.immutable.Seq))​(java.lang.String firstHeader,  scala.collection.immutable.Seq<java.lang.String> otherHeaders)` |  |
	| `protected [Access$minusControl$minusAllow$minusHeaders$](Access$minusControl$minusAllow$minusHeaders$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[AccessControlAllowHeaders](../../../javadsl/model/headers/AccessControlAllowHeaders.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/AccessControlAllowHeaders.html#create(java.lang.String...))`
...
- - ### Constructor Detail
		...
		```
		public Access$minusControl$minusAllow$minusHeaders​(scala.collection.immutable.Seq<java.lang.String> headers)
		```
	...
	- ### Method Detail
		...
		```
		public static [Access$minusControl$minusAllow$minusHeaders](Access$minusControl$minusAllow$minusHeaders.html "class in akka.http.scaladsl.model.headers") apply​(java.lang.String firstHeader,
		...
		```
		protected [Access$minusControl$minusAllow$minusHeaders$](Access$minusControl$minusAllow$minusHeaders$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		Specified by:
		`[getHeaders](../../../javadsl/model/headers/AccessControlAllowHeaders.html#getHeaders())` in class `[AccessControlAllowHeaders](../../../javadsl/model/headers/AccessControlAllowHeaders.html "class in akka.http.javadsl.model.headers")`
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Access$minusControl$minusAllow$minusHeaders.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Access$minusControl$minusAllow$minusHeaders.html)*