...
scraped_at: '2026-04-06T00:37:06Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Retry$minusAfter.html
title: Retry$minusAfter
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.RetryAfter](../../../javadsl/model/headers/RetryAfter.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.Retry$minusAfter
...
```
public final class Retry$minusAfter
extends [RetryAfter](../../../javadsl/model/headers/RetryAfter.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Retry$minusAfter)
...
- - ### Nested Class Summary
	...
	| `[Retry$minusAfter](#%3Cinit%3E(akka.http.scaladsl.model.headers.RetryAfterParameter))​([RetryAfterParameter](RetryAfterParameter.html "class in akka.http.scaladsl.model.headers") delaySecondsOrDateTime)` |  |
	...
	| `static [Retry$minusAfter](Retry$minusAfter.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(long))​(long delaySeconds)` |  |
	| `static [Retry$minusAfter](Retry$minusAfter.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(akka.http.scaladsl.model.DateTime))​([DateTime](../DateTime.html "class in akka.http.scaladsl.model") timestamp)` |  |
	| `protected [Retry$minusAfter$](Retry$minusAfter$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `protected scala.Option<[DateTime](../DateTime.html "class in akka.http.scaladsl.model")>` | `[dateTime](#dateTime())()` |  |
	| `protected scala.Option<java.lang.Long>` | `[delaySeconds](#delaySeconds())()` | Java API suppport |
	| `[RetryAfterParameter](RetryAfterParameter.html "class in akka.http.scaladsl.model.headers")` | `[delaySecondsOrDateTime](#delaySecondsOrDateTime())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[RetryAfter](../../../javadsl/model/headers/RetryAfter.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/RetryAfter.html#create(akka.http.javadsl.model.DateTime)), [create](../../../javadsl/model/headers/RetryAfter.html#create(java.lang.Long)), [getDateTime](../../../javadsl/model/headers/RetryAfter.html#getDateTime()), [getDelaySeconds](../../../javadsl/model/headers/RetryAfter.html#getDelaySeconds())`
...
- - ### Constructor Detail
		...
		```
		public Retry$minusAfter​([RetryAfterParameter](RetryAfterParameter.html "class in akka.http.scaladsl.model.headers") delaySecondsOrDateTime)
		```
	...
	- ### Method Detail
		...
		```
		public static [Retry$minusAfter](Retry$minusAfter.html "class in akka.http.scaladsl.model.headers") apply​(long delaySeconds)
		```
		- #### apply
		...
		```
		public static [Retry$minusAfter](Retry$minusAfter.html "class in akka.http.scaladsl.model.headers") apply​([DateTime](../DateTime.html "class in akka.http.scaladsl.model") timestamp)
		```
		- #### name
		...
		```
		- #### delaySecondsOrDateTime
		
		
		
		```
		public [RetryAfterParameter](RetryAfterParameter.html "class in akka.http.scaladsl.model.headers") delaySecondsOrDateTime()
		```
		- #### renderValue
		...
		```
		protected [Retry$minusAfter$](Retry$minusAfter$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		```
		protected scala.Option<java.lang.Long> delaySeconds()
		```
		
		Java API suppport
		
		Specified by:
		`[delaySeconds](../../../javadsl/model/headers/RetryAfter.html#delaySeconds())` in class `[RetryAfter](../../../javadsl/model/headers/RetryAfter.html "class in akka.http.javadsl.model.headers")`
		- #### dateTime
		
		
		
		```
		protected scala.Option<[DateTime](../DateTime.html "class in akka.http.scaladsl.model")> dateTime()
		```
		
		
		Specified by:
		`[dateTime](../../../javadsl/model/headers/RetryAfter.html#dateTime())` in class `[RetryAfter](../../../javadsl/model/headers/RetryAfter.html "class in akka.http.javadsl.model.headers")`
...
- https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/RetryAfter.html
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Retry$minusAfter.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Retry$minusAfter.html)*