...
scraped_at: '2026-04-06T00:37:46Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/X$minusForwarded$minusProto.html
title: X$minusForwarded$minusProto
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.XForwardedProto](../../../javadsl/model/headers/XForwardedProto.html "class in akka.http.javadsl.model.headers")
...
```
public final class X$minusForwarded$minusProto
extends [XForwardedProto](../../../javadsl/model/headers/XForwardedProto.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.X$minusForwarded$minusProto)
...
- - ### Nested Class Summary
	...
	| `[X$minusForwarded$minusProto](#%3Cinit%3E(java.lang.String))​(java.lang.String protocol)` |  |
	...
	| `protected [X$minusForwarded$minusProto$](X$minusForwarded$minusProto$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `java.lang.String` | `[getProtocol](#getProtocol())()` | Java API |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[XForwardedProto](../../../javadsl/model/headers/XForwardedProto.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/XForwardedProto.html#create(java.lang.String))`
...
- - ### Constructor Detail
		...
		```
		public X$minusForwarded$minusProto​(java.lang.String protocol)
		```
	...
	- ### Method Detail
		...
		```
		protected [X$minusForwarded$minusProto$](X$minusForwarded$minusProto$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		Specified by:
		`[getProtocol](../../../javadsl/model/headers/XForwardedProto.html#getProtocol())` in class `[XForwardedProto](../../../javadsl/model/headers/XForwardedProto.html "class in akka.http.javadsl.model.headers")`
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/X$minusForwarded$minusProto.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/X$minusForwarded$minusProto.html)*