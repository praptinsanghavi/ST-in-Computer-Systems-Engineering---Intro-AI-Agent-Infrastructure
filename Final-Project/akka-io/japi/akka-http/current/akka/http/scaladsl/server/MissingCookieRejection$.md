...
scraped_at: '2026-04-06T00:38:41Z'
section: japi
site: akka-io
...
- java.lang.Object
- - scala.runtime.AbstractFunction1\<java.lang.String,​[MissingCookieRejection](MissingCookieRejection.html "class in akka.http.scaladsl.server")\>
	- - akka.http.scaladsl.server.MissingCookieRejection$

- All Implemented Interfaces:
`java.io.Serializable`, `scala.Function1<java.lang.String,​[MissingCookieRejection](MissingCookieRejection.html "class in akka.http.scaladsl.server")>`

---

```
public class MissingCookieRejection$
extends scala.runtime.AbstractFunction1<java.lang.String,​[MissingCookieRejection](MissingCookieRejection.html "class in akka.http.scaladsl.server")>
...
- - ### Nested Class Summary
	...
	| `static [MissingCookieRejection$](MissingCookieRejection$.html "class in akka.http.scaladsl.server")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `[MissingCookieRejection$](#%3Cinit%3E())()` |  |
...
- - ### Field Detail
		...
		```
		public static final [MissingCookieRejection$](MissingCookieRejection$.html "class in akka.http.scaladsl.server") MODULE$
		```
