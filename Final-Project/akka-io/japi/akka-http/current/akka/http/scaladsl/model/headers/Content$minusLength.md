...
scraped_at: '2026-04-06T00:35:09Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Content$minusLength.html
title: Content$minusLength
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.ContentLength](../../../javadsl/model/headers/ContentLength.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.Content$minusLength
...
```
public final class Content$minusLength
extends [ContentLength](../../../javadsl/model/headers/ContentLength.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Content$minusLength)
...
- - ### Nested Class Summary
	...
	| `[Content$minusLength](#%3Cinit%3E(long))​(long length)` |  |
	...
	| `protected [Content$minusLength$](Content$minusLength$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `long` | `[length](#length())()` |  |
...
- - ### Constructor Detail
		...
		```
		public Content$minusLength​(long length)
		```
	...
	- ### Method Detail
		...
		Specified by:
		`[length](../../../javadsl/model/headers/ContentLength.html#length())` in class `[ContentLength](../../../javadsl/model/headers/ContentLength.html "class in akka.http.javadsl.model.headers")`
		- #### renderValue
		...
		```
		protected [Content$minusLength$](Content$minusLength$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Content$minusLength.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Content$minusLength.html)*