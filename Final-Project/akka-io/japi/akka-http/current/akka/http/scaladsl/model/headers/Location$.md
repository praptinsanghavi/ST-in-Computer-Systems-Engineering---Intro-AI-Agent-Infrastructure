...
- java.lang.Object
- - [akka.http.scaladsl.model.headers.ModeledCompanion](ModeledCompanion.html "class in akka.http.scaladsl.model.headers")\<[Location](Location.html "class in akka.http.scaladsl.model.headers")\>
...
extends [ModeledCompanion](ModeledCompanion.html "class in akka.http.scaladsl.model.headers")<[Location](Location.html "class in akka.http.scaladsl.model.headers")>
...
- - ### Field Summary
	...
	| `static [Location$](Location$.html "class in akka.http.scaladsl.model.headers")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [Location$](Location$.html "class in akka.http.scaladsl.model.headers") MODULE$
		```
