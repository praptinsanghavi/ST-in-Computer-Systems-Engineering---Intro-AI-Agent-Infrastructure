...
scraped_at: '2026-04-06T00:32:33Z'
section: japi
site: akka-io
...
- java.lang.Object
- - scala.runtime.AbstractFunction2\<[HttpRequest](HttpRequest.html "class in akka.http.scaladsl.model"),​java.lang.String,​[RequestTimeoutException](RequestTimeoutException.html "class in akka.http.scaladsl.model")\>
	- - akka.http.scaladsl.model.RequestTimeoutException$

- All Implemented Interfaces:
`java.io.Serializable`, `scala.Function2<[HttpRequest](HttpRequest.html "class in akka.http.scaladsl.model"),​java.lang.String,​[RequestTimeoutException](RequestTimeoutException.html "class in akka.http.scaladsl.model")>`

---

```
public class RequestTimeoutException$
extends scala.runtime.AbstractFunction2<[HttpRequest](HttpRequest.html "class in akka.http.scaladsl.model"),​java.lang.String,​[RequestTimeoutException](RequestTimeoutException.html "class in akka.http.scaladsl.model")>
...
- - ### Field Summary
	...
	| `static [RequestTimeoutException$](RequestTimeoutException$.html "class in akka.http.scaladsl.model")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `[RequestTimeoutException$](#%3Cinit%3E())()` |  |
...
- - ### Field Detail
		...
		```
		public static final [RequestTimeoutException$](RequestTimeoutException$.html "class in akka.http.scaladsl.model") MODULE$
		```
...
- https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/RequestTimeoutException$.html
- https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/RequestTimeoutException.html
