...
- java.lang.Object
- - scala.runtime.AbstractFunction1\<java.lang.String,​[SchemeRejection](SchemeRejection.html "class in akka.http.scaladsl.server")\>
	- - akka.http.scaladsl.server.SchemeRejection$

- All Implemented Interfaces:
`java.io.Serializable`, `scala.Function1<java.lang.String,​[SchemeRejection](SchemeRejection.html "class in akka.http.scaladsl.server")>`

---

```
public class SchemeRejection$
extends scala.runtime.AbstractFunction1<java.lang.String,​[SchemeRejection](SchemeRejection.html "class in akka.http.scaladsl.server")>
...
- - ### Nested Class Summary
	...
	| `static [SchemeRejection$](SchemeRejection$.html "class in akka.http.scaladsl.server")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [SchemeRejection$](SchemeRejection$.html "class in akka.http.scaladsl.server") MODULE$
		```
