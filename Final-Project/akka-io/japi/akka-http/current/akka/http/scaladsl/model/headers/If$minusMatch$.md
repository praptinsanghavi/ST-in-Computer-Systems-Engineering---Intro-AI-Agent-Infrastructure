...
- java.lang.Object
- - [akka.http.scaladsl.model.headers.ModeledCompanion](ModeledCompanion.html "class in akka.http.scaladsl.model.headers")\<[If$minusMatch](If$minusMatch.html "class in akka.http.scaladsl.model.headers")\>
...
```
public class If$minusMatch$
extends [ModeledCompanion](ModeledCompanion.html "class in akka.http.scaladsl.model.headers")<[If$minusMatch](If$minusMatch.html "class in akka.http.scaladsl.model.headers")>
...
- - ### Field Summary
	...
	| `static [If$minusMatch$](If$minusMatch$.html "class in akka.http.scaladsl.model.headers")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [If$minusMatch$](If$minusMatch$.html "class in akka.http.scaladsl.model.headers") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public [If$minusMatch](If$minusMatch.html "class in akka.http.scaladsl.model.headers") apply​([EntityTag](EntityTag.html "class in akka.http.scaladsl.model.headers") first,
