...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Upgrade.html
title: Upgrade
---
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Upgrade)
...
- - ### Nested Class Summary
	...
	| `[Upgrade](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<[UpgradeProtocol](UpgradeProtocol.html "class in akka.http.scaladsl.model.headers")> protocols)` |  |
	...
	| `protected [Upgrade$](Upgrade$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `boolean` | `[hasWebSocket](#hasWebSocket())()` |  |
	...
	| `scala.collection.immutable.Seq<[UpgradeProtocol](UpgradeProtocol.html "class in akka.http.scaladsl.model.headers")>` | `[protocols](#protocols())()` |  |
	| `static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[UpgradeProtocol](UpgradeProtocol.html "class in akka.http.scaladsl.model.headers")>>` | `[protocolsRenderer](#protocolsRenderer())()` |  |
...
- - ### Constructor Detail
		...
		```
		public Upgrade​(scala.collection.immutable.Seq<[UpgradeProtocol](UpgradeProtocol.html "class in akka.http.scaladsl.model.headers")> protocols)
		```
	...
	- ### Method Detail
		...
		```
		public static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[UpgradeProtocol](UpgradeProtocol.html "class in akka.http.scaladsl.model.headers")>> protocolsRenderer()
		```
		- #### name
		...
		```
		public scala.collection.immutable.Seq<[UpgradeProtocol](UpgradeProtocol.html "class in akka.http.scaladsl.model.headers")> protocols()
		```
		- #### renderValue
		...
		```
		protected [Upgrade$](Upgrade$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Upgrade.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Upgrade.html)*