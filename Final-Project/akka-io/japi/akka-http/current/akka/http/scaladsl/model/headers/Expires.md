...
scraped_at: '2026-04-06T00:35:36Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Expires.html
title: Expires
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.Expires](../../../javadsl/model/headers/Expires.html "class in akka.http.javadsl.model.headers")
...
extends [Expires](../../../javadsl/model/headers/Expires.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Expires)
...
- - ### Nested Class Summary
	...
	| `[Expires](#%3Cinit%3E(akka.http.scaladsl.model.DateTime))​([DateTime](../DateTime.html "class in akka.http.scaladsl.model") date)` |  |
	...
	| `protected [Expires$](Expires$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[Expires](../../../javadsl/model/headers/Expires.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/Expires.html#create(akka.http.javadsl.model.DateTime))`
...
- - ### Constructor Detail
		...
		```
		public Expires​([DateTime](../DateTime.html "class in akka.http.scaladsl.model") date)
		```
	...
	- ### Method Detail
		...
		Specified by:
		`[date](../../../javadsl/model/headers/Expires.html#date())` in class `[Expires](../../../javadsl/model/headers/Expires.html "class in akka.http.javadsl.model.headers")`
		- #### renderValue
		...
		```
		protected [Expires$](Expires$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Expires.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Expires.html)*