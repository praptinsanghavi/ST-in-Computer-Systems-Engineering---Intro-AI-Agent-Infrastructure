...
scraped_at: '2026-04-06T00:38:44Z'
section: japi
site: akka-io
...
- java.lang.Object
- - scala.runtime.AbstractFunction1\<java.lang.String,​[MissingHeaderRejection](MissingHeaderRejection.html "class in akka.http.scaladsl.server")\>
	- - akka.http.scaladsl.server.MissingHeaderRejection$

- All Implemented Interfaces:
`java.io.Serializable`, `scala.Function1<java.lang.String,​[MissingHeaderRejection](MissingHeaderRejection.html "class in akka.http.scaladsl.server")>`

---

```
public class MissingHeaderRejection$
extends scala.runtime.AbstractFunction1<java.lang.String,​[MissingHeaderRejection](MissingHeaderRejection.html "class in akka.http.scaladsl.server")>
...
- - ### Nested Class Summary
	...
	| `static [MissingHeaderRejection$](MissingHeaderRejection$.html "class in akka.http.scaladsl.server")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `[MissingHeaderRejection$](#%3Cinit%3E())()` |  |
...
- - ### Field Detail
		...
		```
		public static final [MissingHeaderRejection$](MissingHeaderRejection$.html "class in akka.http.scaladsl.server") MODULE$
		```
