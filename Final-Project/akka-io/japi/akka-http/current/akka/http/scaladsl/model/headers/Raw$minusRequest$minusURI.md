...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Raw$minusRequest$minusURI.html
title: Raw$minusRequest$minusURI
---
...
## Class Raw$minusRequest$minusURI
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.RawRequestURI](../../../javadsl/model/headers/RawRequestURI.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.Raw$minusRequest$minusURI
...
```
public final class Raw$minusRequest$minusURI
extends [RawRequestURI](../../../javadsl/model/headers/RawRequestURI.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Raw$minusRequest$minusURI)
...
- - ### Nested Class Summary
	...
	| `[Raw$minusRequest$minusURI](#%3Cinit%3E(java.lang.String))​(java.lang.String uri)` |  |
	...
	| `protected [Raw$minusRequest$minusURI$](Raw$minusRequest$minusURI$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	...
	| `java.lang.String` | `[uri](#uri())()` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[RawRequestURI](../../../javadsl/model/headers/RawRequestURI.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/RawRequestURI.html#create(java.lang.String))`
...
- - ### Constructor Detail
		...
		```
		public Raw$minusRequest$minusURI​(java.lang.String uri)
		```
	...
	- ### Method Detail
		...
		Specified by:
		`[uri](../../../javadsl/model/headers/RawRequestURI.html#uri())` in class `[RawRequestURI](../../../javadsl/model/headers/RawRequestURI.html "class in akka.http.javadsl.model.headers")`
		- #### renderValue
		...
		```
		protected [Raw$minusRequest$minusURI$](Raw$minusRequest$minusURI$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
- https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/RawRequestURI.html
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Raw$minusRequest$minusURI.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Raw$minusRequest$minusURI.html)*