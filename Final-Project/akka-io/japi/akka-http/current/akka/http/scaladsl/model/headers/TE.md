...
scraped_at: '2026-04-06T00:37:27Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/TE.html
title: TE
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.TE](../../../javadsl/model/headers/TE.html "class in akka.http.javadsl.model.headers")
...
extends [TE](../../../javadsl/model/headers/TE.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.TE)
...
- - ### Nested Class Summary
	...
	| `[TE](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<[TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model")> acceptableEncodings)` |  |
	...
	| `scala.collection.immutable.Seq<[TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model")>` | `[acceptableEncodings](#acceptableEncodings())()` |  |
	| `[TE](TE.html "class in akka.http.scaladsl.model.headers")` | `[append](#append(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<[TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model")> encodings)` |  |
	| `static [TE](TE.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(akka.http.scaladsl.model.TransferEncoding,scala.collection.immutable.Seq))​([TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model") first,  scala.collection.immutable.Seq<[TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model")> more)` |  |
	| `protected [TE$](TE$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `java.lang.Iterable<[TransferEncoding](../../../javadsl/model/TransferEncoding.html "class in akka.http.javadsl.model")>` | `[getAcceptableEncodings](#getAcceptableEncodings())()` | Java API |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[TE](../../../javadsl/model/headers/TE.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/TE.html#create(akka.http.javadsl.model.TransferEncoding...))`
...
- - ### Constructor Detail
		...
		```
		public TE​(scala.collection.immutable.Seq<[TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model")> acceptableEncodings)
		```
	...
	- ### Method Detail
		...
		```
		public static [TE](TE.html "class in akka.http.scaladsl.model.headers") apply​([TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model") first,
		...
		```
		public scala.collection.immutable.Seq<[TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model")> acceptableEncodings()
		```
		- #### append
		...
		```
		public [TE](TE.html "class in akka.http.scaladsl.model.headers") append​(scala.collection.immutable.Seq<[TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model")> encodings)
		```
		- #### renderValue
		...
		```
		protected [TE$](TE$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		```
		public java.lang.Iterable<[TransferEncoding](../../../javadsl/model/TransferEncoding.html "class in akka.http.javadsl.model")> getAcceptableEncodings()
		```
		
		Java API
		
		Specified by:
		`[getAcceptableEncodings](../../../javadsl/model/headers/TE.html#getAcceptableEncodings())` in class `[TE](../../../javadsl/model/headers/TE.html "class in akka.http.javadsl.model.headers")`
...
- https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/TE.html
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/TE.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/TE.html)*