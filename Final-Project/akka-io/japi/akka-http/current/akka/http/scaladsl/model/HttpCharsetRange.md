...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/HttpCharsetRange.One$.html
title: HttpCharsetRange.One$
---
...
- java.lang.Object
- - scala.runtime.AbstractFunction2\<[HttpCharset](HttpCharset.html "class in akka.http.scaladsl.model"),​java.lang.Object,​[HttpCharsetRange.One](HttpCharsetRange.One.html "class in akka.http.scaladsl.model")\>
	- - akka.http.scaladsl.model.HttpCharsetRange.One$

- All Implemented Interfaces:
`java.io.Serializable`, `scala.Function2<[HttpCharset](HttpCharset.html "class in akka.http.scaladsl.model"),​java.lang.Object,​[HttpCharsetRange.One](HttpCharsetRange.One.html "class in akka.http.scaladsl.model")>`
...
```
public static class HttpCharsetRange.One$
extends scala.runtime.AbstractFunction2<[HttpCharset](HttpCharset.html "class in akka.http.scaladsl.model"),​java.lang.Object,​[HttpCharsetRange.One](HttpCharsetRange.One.html "class in akka.http.scaladsl.model")>
implements java.io.Serializable
```

See Also:
[Serialized Form](../../../../serialized-form.html#akka.http.scaladsl.model.HttpCharsetRange.One$)
...
- - ### Field Summary
	...
	| `static [HttpCharsetRange.One$](HttpCharsetRange.One$.html "class in akka.http.scaladsl.model")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [HttpCharsetRange.One$](HttpCharsetRange.One$.html "class in akka.http.scaladsl.model") MODULE$
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/HttpCharsetRange.One$.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/HttpCharsetRange.One$.html)*