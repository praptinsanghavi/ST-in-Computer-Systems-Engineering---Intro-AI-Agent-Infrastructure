...
scraped_at: '2026-04-06T00:35:05Z'
section: japi
site: akka-io
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.ContentEncoding](../../../javadsl/model/headers/ContentEncoding.html "class in akka.http.javadsl.model.headers")
...
extends [ContentEncoding](../../../javadsl/model/headers/ContentEncoding.html "class in akka.http.javadsl.model.headers")
...
- - ### Nested Class Summary
	...
	| `[Content$minusEncoding](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<[HttpEncoding](HttpEncoding.html "class in akka.http.scaladsl.model.headers")> encodings)` |  |
	...
	| `static [Content$minusEncoding](Content$minusEncoding.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(akka.http.scaladsl.model.headers.HttpEncoding,scala.collection.immutable.Seq))​([HttpEncoding](HttpEncoding.html "class in akka.http.scaladsl.model.headers") first,  scala.collection.immutable.Seq<[HttpEncoding](HttpEncoding.html "class in akka.http.scaladsl.model.headers")> more)` |  |
	| `protected [Content$minusEncoding$](Content$minusEncoding$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `scala.collection.immutable.Seq<[HttpEncoding](HttpEncoding.html "class in akka.http.scaladsl.model.headers")>` | `[encodings](#encodings())()` |  |
	| `static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[HttpEncoding](HttpEncoding.html "class in akka.http.scaladsl.model.headers")>>` | `[encodingsRenderer](#encodingsRenderer())()` |  |
	| `java.lang.Iterable<[HttpEncoding](../../../javadsl/model/headers/HttpEncoding.html "class in akka.http.javadsl.model.headers")>` | `[getEncodings](#getEncodings())()` | Java API |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[ContentEncoding](../../../javadsl/model/headers/ContentEncoding.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/ContentEncoding.html#create(akka.http.javadsl.model.headers.HttpEncoding...))`
...
- - ### Constructor Detail
		...
		```
		public Content$minusEncoding​(scala.collection.immutable.Seq<[HttpEncoding](HttpEncoding.html "class in akka.http.scaladsl.model.headers")> encodings)
		```
	...
	- ### Method Detail
		...
		```
		public static [Content$minusEncoding](Content$minusEncoding.html "class in akka.http.scaladsl.model.headers") apply​([HttpEncoding](HttpEncoding.html "class in akka.http.scaladsl.model.headers") first,
		...
		```
		public static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[HttpEncoding](HttpEncoding.html "class in akka.http.scaladsl.model.headers")>> encodingsRenderer()
		```
		- #### name
		...
		```
		public scala.collection.immutable.Seq<[HttpEncoding](HttpEncoding.html "class in akka.http.scaladsl.model.headers")> encodings()
		```
		- #### renderValue
		...
		```
		protected [Content$minusEncoding$](Content$minusEncoding$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		```
		public java.lang.Iterable<[HttpEncoding](../../../javadsl/model/headers/HttpEncoding.html "class in akka.http.javadsl.model.headers")> getEncodings()
		```
		
		Java API
		
		Specified by:
		`[getEncodings](../../../javadsl/model/headers/ContentEncoding.html#getEncodings())` in class `[ContentEncoding](../../../javadsl/model/headers/ContentEncoding.html "class in akka.http.javadsl.model.headers")`
