...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Set$minusCookie.html
title: Set$minusCookie
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.SetCookie](../../../javadsl/model/headers/SetCookie.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.Set$minusCookie
...
```
public final class Set$minusCookie
extends [SetCookie](../../../javadsl/model/headers/SetCookie.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Set$minusCookie)
...
- - ### Nested Class Summary
	...
	| `[Set$minusCookie](#%3Cinit%3E(akka.http.scaladsl.model.headers.HttpCookie))​([HttpCookie](HttpCookie.html "class in akka.http.scaladsl.model.headers") cookie)` |  |
	...
	| `protected [Set$minusCookie$](Set$minusCookie$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `[HttpCookie](HttpCookie.html "class in akka.http.scaladsl.model.headers")` | `[cookie](#cookie())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[SetCookie](../../../javadsl/model/headers/SetCookie.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/SetCookie.html#create(akka.http.javadsl.model.headers.HttpCookie))`
...
- - ### Constructor Detail
		...
		```
		public Set$minusCookie​([HttpCookie](HttpCookie.html "class in akka.http.scaladsl.model.headers") cookie)
		```
	...
	- ### Method Detail
		...
		```
		public [HttpCookie](HttpCookie.html "class in akka.http.scaladsl.model.headers") cookie()
		```
		
		
		Specified by:
		`[cookie](../../../javadsl/model/headers/SetCookie.html#cookie())` in class `[SetCookie](../../../javadsl/model/headers/SetCookie.html "class in akka.http.javadsl.model.headers")`
		- #### renderValue
		...
		```
		protected [Set$minusCookie$](Set$minusCookie$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
- https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/SetCookie.html
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Set$minusCookie.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Set$minusCookie.html)*