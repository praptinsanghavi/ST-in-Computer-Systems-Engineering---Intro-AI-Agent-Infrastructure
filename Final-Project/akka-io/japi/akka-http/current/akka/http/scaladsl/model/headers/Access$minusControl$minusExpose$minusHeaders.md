...
scraped_at: '2026-04-06T00:34:27Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Access$minusControl$minusExpose$minusHeaders.html
title: Access$minusControl$minusExpose$minusHeaders
---
...
## Class Access$minusControl$minusExpose$minusHeaders
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.AccessControlExposeHeaders](../../../javadsl/model/headers/AccessControlExposeHeaders.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.Access$minusControl$minusExpose$minusHeaders
...
```
public final class Access$minusControl$minusExpose$minusHeaders
extends [AccessControlExposeHeaders](../../../javadsl/model/headers/AccessControlExposeHeaders.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Access$minusControl$minusExpose$minusHeaders)
...
- - ### Nested Class Summary
	...
	| `[Access$minusControl$minusExpose$minusHeaders](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<java.lang.String> headers)` |  |
	...
	| `static [Access$minusControl$minusExpose$minusHeaders](Access$minusControl$minusExpose$minusHeaders.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(java.lang.String,scala.collection.immutable.Seq))​(java.lang.String firstHeader,  scala.collection.immutable.Seq<java.lang.String> otherHeaders)` |  |
	| `protected [Access$minusControl$minusExpose$minusHeaders$](Access$minusControl$minusExpose$minusHeaders$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[AccessControlExposeHeaders](../../../javadsl/model/headers/AccessControlExposeHeaders.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/AccessControlExposeHeaders.html#create(java.lang.String...))`
...
- - ### Constructor Detail
		...
		```
		public Access$minusControl$minusExpose$minusHeaders​(scala.collection.immutable.Seq<java.lang.String> headers)
		```
	...
	- ### Method Detail
		...
		```
		public static [Access$minusControl$minusExpose$minusHeaders](Access$minusControl$minusExpose$minusHeaders.html "class in akka.http.scaladsl.model.headers") apply​(java.lang.String firstHeader,
		...
		```
		protected [Access$minusControl$minusExpose$minusHeaders$](Access$minusControl$minusExpose$minusHeaders$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		Specified by:
		`[getHeaders](../../../javadsl/model/headers/AccessControlExposeHeaders.html#getHeaders())` in class `[AccessControlExposeHeaders](../../../javadsl/model/headers/AccessControlExposeHeaders.html "class in akka.http.javadsl.model.headers")`
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Access$minusControl$minusExpose$minusHeaders.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Access$minusControl$minusExpose$minusHeaders.html)*