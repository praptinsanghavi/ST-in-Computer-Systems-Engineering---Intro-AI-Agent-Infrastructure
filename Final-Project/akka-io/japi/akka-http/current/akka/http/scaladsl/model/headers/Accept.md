...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.Accept](../../../javadsl/model/headers/Accept.html "class in akka.http.javadsl.model.headers")
...
extends [Accept](../../../javadsl/model/headers/Accept.html "class in akka.http.javadsl.model.headers")
...
- - ### Nested Class Summary
	...
	| `[Accept](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<[MediaRange](../MediaRange.html "class in akka.http.scaladsl.model")> mediaRanges)` |  |
	...
	| `boolean` | `[acceptsAll](#acceptsAll())()` |  |
	| `static [Accept](Accept.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(akka.http.scaladsl.model.MediaRange,scala.collection.immutable.Seq))​([MediaRange](../MediaRange.html "class in akka.http.scaladsl.model") firstMediaRange,  scala.collection.immutable.Seq<[MediaRange](../MediaRange.html "class in akka.http.scaladsl.model")> otherMediaRanges)` |  |
	| `protected [Accept$](Accept$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `java.lang.Iterable<[MediaRange](../../../javadsl/model/MediaRange.html "class in akka.http.javadsl.model")>` | `[getMediaRanges](#getMediaRanges())()` | Java API |
	| `static java.lang.String` | `[lowercaseName](#lowercaseName())()` |  |
	| `scala.collection.immutable.Seq<[MediaRange](../MediaRange.html "class in akka.http.scaladsl.model")>` | `[mediaRanges](#mediaRanges())()` |  |
	| `static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[MediaRange](../MediaRange.html "class in akka.http.scaladsl.model")>>` | `[mediaRangesRenderer](#mediaRangesRenderer())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[Accept](../../../javadsl/model/headers/Accept.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/Accept.html#create(akka.http.javadsl.model.MediaRange...))`
...
- - ### Constructor Detail
		...
		```
		public Accept​(scala.collection.immutable.Seq<[MediaRange](../MediaRange.html "class in akka.http.scaladsl.model")> mediaRanges)
		```
	...
	- ### Method Detail
		...
		```
		public static [Accept](Accept.html "class in akka.http.scaladsl.model.headers") apply​([MediaRange](../MediaRange.html "class in akka.http.scaladsl.model") firstMediaRange,
		...
		```
		public static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[MediaRange](../MediaRange.html "class in akka.http.scaladsl.model")>> mediaRangesRenderer()
		```
		- #### name
		...
		```
		public scala.collection.immutable.Seq<[MediaRange](../MediaRange.html "class in akka.http.scaladsl.model")> mediaRanges()
		```
		- #### renderValue
		...
		```
		protected [Accept$](Accept$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		Specified by:
		`[acceptsAll](../../../javadsl/model/headers/Accept.html#acceptsAll())` in class `[Accept](../../../javadsl/model/headers/Accept.html "class in akka.http.javadsl.model.headers")`
		- #### getMediaRanges
		
		
		
		```
		public java.lang.Iterable<[MediaRange](../../../javadsl/model/MediaRange.html "class in akka.http.javadsl.model")> getMediaRanges()
		```
		
		Java API
		
		Specified by:
		`[getMediaRanges](../../../javadsl/model/headers/Accept.html#getMediaRanges())` in class `[Accept](../../../javadsl/model/headers/Accept.html "class in akka.http.javadsl.model.headers")`
