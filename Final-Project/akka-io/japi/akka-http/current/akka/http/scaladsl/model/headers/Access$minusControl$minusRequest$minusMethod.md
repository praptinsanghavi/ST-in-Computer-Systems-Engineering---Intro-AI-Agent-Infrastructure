...
scraped_at: '2026-04-06T00:34:31Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Access$minusControl$minusRequest$minusMethod.html
title: Access$minusControl$minusRequest$minusMethod
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.AccessControlRequestMethod](../../../javadsl/model/headers/AccessControlRequestMethod.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.Access$minusControl$minusRequest$minusMethod
...
```
public final class Access$minusControl$minusRequest$minusMethod
extends [AccessControlRequestMethod](../../../javadsl/model/headers/AccessControlRequestMethod.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Access$minusControl$minusRequest$minusMethod)
...
- - ### Nested Class Summary
	...
	| `[Access$minusControl$minusRequest$minusMethod](#%3Cinit%3E(akka.http.scaladsl.model.HttpMethod))​([HttpMethod](../HttpMethod.html "class in akka.http.scaladsl.model") method)` |  |
	...
	| `protected [Access$minusControl$minusRequest$minusMethod$](Access$minusControl$minusRequest$minusMethod$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `static java.lang.String` | `[lowercaseName](#lowercaseName())()` |  |
	| `[HttpMethod](../HttpMethod.html "class in akka.http.scaladsl.model")` | `[method](#method())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[AccessControlRequestMethod](../../../javadsl/model/headers/AccessControlRequestMethod.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/AccessControlRequestMethod.html#create(akka.http.javadsl.model.HttpMethod))`
...
- - ### Constructor Detail
		...
		```
		public Access$minusControl$minusRequest$minusMethod​([HttpMethod](../HttpMethod.html "class in akka.http.scaladsl.model") method)
		```
	...
	- ### Method Detail
		...
		Specified by:
		`[method](../../../javadsl/model/headers/AccessControlRequestMethod.html#method())` in class `[AccessControlRequestMethod](../../../javadsl/model/headers/AccessControlRequestMethod.html "class in akka.http.javadsl.model.headers")`
		- #### renderValue
		...
		```
		protected [Access$minusControl$minusRequest$minusMethod$](Access$minusControl$minusRequest$minusMethod$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Access$minusControl$minusRequest$minusMethod.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Access$minusControl$minusRequest$minusMethod.html)*