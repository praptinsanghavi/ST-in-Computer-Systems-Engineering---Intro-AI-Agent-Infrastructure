...
- java.lang.Object
- - scala.runtime.AbstractFunction1\<[Rejection](Rejection.html "interface in akka.http.scaladsl.server"),​[RejectionError](RejectionError.html "class in akka.http.scaladsl.server")\>
	- - akka.http.scaladsl.server.RejectionError$

- All Implemented Interfaces:
`java.io.Serializable`, `scala.Function1<[Rejection](Rejection.html "interface in akka.http.scaladsl.server"),​[RejectionError](RejectionError.html "class in akka.http.scaladsl.server")>`

---

```
public class RejectionError$
extends scala.runtime.AbstractFunction1<[Rejection](Rejection.html "interface in akka.http.scaladsl.server"),​[RejectionError](RejectionError.html "class in akka.http.scaladsl.server")>
...
- - ### Nested Class Summary
	...
	| `static [RejectionError$](RejectionError$.html "class in akka.http.scaladsl.server")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [RejectionError$](RejectionError$.html "class in akka.http.scaladsl.server") MODULE$
		```
