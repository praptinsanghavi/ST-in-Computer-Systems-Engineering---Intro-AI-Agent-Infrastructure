...
scraped_at: '2026-04-06T00:37:44Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/X$minusForwarded$minusHost.html
title: X$minusForwarded$minusHost
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.XForwardedHost](../../../javadsl/model/headers/XForwardedHost.html "class in akka.http.javadsl.model.headers")
...
```
public final class X$minusForwarded$minusHost
extends [XForwardedHost](../../../javadsl/model/headers/XForwardedHost.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.X$minusForwarded$minusHost)
...
- - ### Nested Class Summary
	...
	| `[X$minusForwarded$minusHost](#%3Cinit%3E(akka.http.scaladsl.model.Uri.Host))​([Uri.Host](../Uri.Host.html "class in akka.http.scaladsl.model") host)` |  |
	...
	| `protected [X$minusForwarded$minusHost$](X$minusForwarded$minusHost$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `[Host](../../../javadsl/model/Host.html "class in akka.http.javadsl.model")` | `[getHost](#getHost())()` | Java API |
	| `[Uri.Host](../Uri.Host.html "class in akka.http.scaladsl.model")` | `[host](#host())()` |  |
	| `static [UriRendering.HostRenderer$](../UriRendering.HostRenderer$.html "class in akka.http.scaladsl.model")` | `[hostRenderer](#hostRenderer())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[XForwardedHost](../../../javadsl/model/headers/XForwardedHost.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/XForwardedHost.html#create(akka.http.javadsl.model.Host))`
...
- - ### Constructor Detail
		...
		```
		public X$minusForwarded$minusHost​([Uri.Host](../Uri.Host.html "class in akka.http.scaladsl.model") host)
		```
	...
	- ### Method Detail
		...
		```
		public static [UriRendering.HostRenderer$](../UriRendering.HostRenderer$.html "class in akka.http.scaladsl.model") hostRenderer()
		```
		- #### name
		...
		```
		protected [X$minusForwarded$minusHost$](X$minusForwarded$minusHost$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		Specified by:
		`[getHost](../../../javadsl/model/headers/XForwardedHost.html#getHost())` in class `[XForwardedHost](../../../javadsl/model/headers/XForwardedHost.html "class in akka.http.javadsl.model.headers")`
...
- https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/UriRendering.HostRenderer$.html
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/X$minusForwarded$minusHost.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/X$minusForwarded$minusHost.html)*