...
- java.lang.Object
- - scala.runtime.AbstractFunction2\<java.lang.String,​scala.Option\<java.lang.Throwable\>,​[ValidationRejection](ValidationRejection.html "class in akka.http.scaladsl.server")\>
	- - akka.http.scaladsl.server.ValidationRejection$

- All Implemented Interfaces:
`java.io.Serializable`, `scala.Function2<java.lang.String,​scala.Option<java.lang.Throwable>,​[ValidationRejection](ValidationRejection.html "class in akka.http.scaladsl.server")>`

---

```
public class ValidationRejection$
extends scala.runtime.AbstractFunction2<java.lang.String,​scala.Option<java.lang.Throwable>,​[ValidationRejection](ValidationRejection.html "class in akka.http.scaladsl.server")>
...
- - ### Field Summary
	...
	| `static [ValidationRejection$](ValidationRejection$.html "class in akka.http.scaladsl.server")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [ValidationRejection$](ValidationRejection$.html "class in akka.http.scaladsl.server") MODULE$
		```
