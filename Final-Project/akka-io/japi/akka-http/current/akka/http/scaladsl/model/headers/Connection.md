...
scraped_at: '2026-04-06T00:35:02Z'
section: japi
site: akka-io
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.Connection](../../../javadsl/model/headers/Connection.html "class in akka.http.javadsl.model.headers")
...
extends [Connection](../../../javadsl/model/headers/Connection.html "class in akka.http.javadsl.model.headers")
...
- - ### Nested Class Summary
	...
	| `[Connection](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<java.lang.String> tokens)` |  |
	...
	| `[Connection](Connection.html "class in akka.http.scaladsl.model.headers")` | `[append](#append(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<java.lang.String> tokens)` |  |
	| `static [Connection](Connection.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(java.lang.String,scala.collection.immutable.Seq))​(java.lang.String first,  scala.collection.immutable.Seq<java.lang.String> more)` |  |
	| `protected [Connection$](Connection$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `java.lang.Iterable<java.lang.String>` | `[getTokens](#getTokens())()` | Java API |
	| `boolean` | `[hasClose](#hasClose())()` |  |
	| `boolean` | `[hasKeepAlive](#hasKeepAlive())()` |  |
	...
	| `scala.collection.immutable.Seq<java.lang.String>` | `[tokens](#tokens())()` |  |
	| `static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<java.lang.String>>` | `[tokensRenderer](#tokensRenderer())()` |  |
	
	
		- ### Methods inherited from class akka.http.javadsl.model.headers.[Connection](../../../javadsl/model/headers/Connection.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/Connection.html#create(java.lang.String...))`
...
- - ### Constructor Detail
		...
		```
		public Connection​(scala.collection.immutable.Seq<java.lang.String> tokens)
		```
	...
	- ### Method Detail
		...
		```
		public static [Connection](Connection.html "class in akka.http.scaladsl.model.headers") apply​(java.lang.String first,
		...
		```
		public static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<java.lang.String>> tokensRenderer()
		```
		- #### name
		...
		```
		public scala.collection.immutable.Seq<java.lang.String> tokens()
		```
		- #### renderValue
		...
		```
		public [Connection](Connection.html "class in akka.http.scaladsl.model.headers") append​(scala.collection.immutable.Seq<java.lang.String> tokens)
		```
		- #### companion
		...
		```
		protected [Connection$](Connection$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		```
		public java.lang.Iterable<java.lang.String> getTokens()
		```
		
		Java API
		
		Specified by:
		`[getTokens](../../../javadsl/model/headers/Connection.html#getTokens())` in class `[Connection](../../../javadsl/model/headers/Connection.html "class in akka.http.javadsl.model.headers")`
