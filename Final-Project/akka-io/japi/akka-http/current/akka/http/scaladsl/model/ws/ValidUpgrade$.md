...
- java.lang.Object
- - scala.runtime.AbstractFunction2\<[HttpResponse](../HttpResponse.html "class in akka.http.scaladsl.model"),​scala.Option\<java.lang.String\>,​[ValidUpgrade](ValidUpgrade.html "class in akka.http.scaladsl.model.ws")\>
	- - akka.http.scaladsl.model.ws.ValidUpgrade$

- All Implemented Interfaces:
`java.io.Serializable`, `scala.Function2<[HttpResponse](../HttpResponse.html "class in akka.http.scaladsl.model"),​scala.Option<java.lang.String>,​[ValidUpgrade](ValidUpgrade.html "class in akka.http.scaladsl.model.ws")>`

---

```
public class ValidUpgrade$
extends scala.runtime.AbstractFunction2<[HttpResponse](../HttpResponse.html "class in akka.http.scaladsl.model"),​scala.Option<java.lang.String>,​[ValidUpgrade](ValidUpgrade.html "class in akka.http.scaladsl.model.ws")>
...
- - ### Field Summary
	...
	| `static [ValidUpgrade$](ValidUpgrade$.html "class in akka.http.scaladsl.model.ws")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [ValidUpgrade$](ValidUpgrade$.html "class in akka.http.scaladsl.model.ws") MODULE$
		```
