...
scraped_at: '2026-04-06T00:32:21Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/Multipart.General$.Strict$.html
...
- java.lang.Object
- - scala.runtime.AbstractFunction2\<[MediaType.Multipart](MediaType.Multipart.html "class in akka.http.scaladsl.model"),​scala.collection.immutable.Seq\<akka.http.scaladsl.model.Multipart.General.BodyPart.Strict\>,​akka.http.scaladsl.model.Multipart.General.Strict\>
	- - akka.http.scaladsl.model.Multipart.General$.Strict$

- All Implemented Interfaces:
`java.io.Serializable`, `scala.Function2<[MediaType.Multipart](MediaType.Multipart.html "class in akka.http.scaladsl.model"),​scala.collection.immutable.Seq<akka.http.scaladsl.model.Multipart.General.BodyPart.Strict>,​akka.http.scaladsl.model.Multipart.General.Strict>`
...
extends scala.runtime.AbstractFunction2<[MediaType.Multipart](MediaType.Multipart.html "class in akka.http.scaladsl.model"),​scala.collection.immutable.Seq<akka.http.scaladsl.model.Multipart.General.BodyPart.Strict>,​akka.http.scaladsl.model.Multipart.General.Strict>
implements java.io.Serializable
```

See Also:
[Serialized Form](../../../../serialized-form.html#akka.http.scaladsl.model.Multipart.General$.Strict$)
...
- - ### Field Summary
	...
	| `static [Multipart.General$.Strict$](Multipart.General$.Strict$.html "class in akka.http.scaladsl.model")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [Multipart.General$.Strict$](Multipart.General$.Strict$.html "class in akka.http.scaladsl.model") MODULE$
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/Multipart.General$.Strict$.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/Multipart.General$.Strict$.html)*