...
- java.lang.Object
- - scala.runtime.AbstractFunction1\<scala.Function1\<scala.collection.immutable.Seq\<[Rejection](Rejection.html "interface in akka.http.scaladsl.server")\>,​scala.collection.immutable.Seq\<[Rejection](Rejection.html "interface in akka.http.scaladsl.server")\>\>,​[TransformationRejection](TransformationRejection.html "class in akka.http.scaladsl.server")\>
	- - akka.http.scaladsl.server.TransformationRejection$

- All Implemented Interfaces:
`java.io.Serializable`, `scala.Function1<scala.Function1<scala.collection.immutable.Seq<[Rejection](Rejection.html "interface in akka.http.scaladsl.server")>,​scala.collection.immutable.Seq<[Rejection](Rejection.html "interface in akka.http.scaladsl.server")>>,​[TransformationRejection](TransformationRejection.html "class in akka.http.scaladsl.server")>`

---

```
public class TransformationRejection$
...
- - ### Nested Class Summary
	...
	| `static [TransformationRejection$](TransformationRejection$.html "class in akka.http.scaladsl.server")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `[TransformationRejection$](#%3Cinit%3E())()` |  |
...
- - ### Field Detail
		...
		```
		public static final [TransformationRejection$](TransformationRejection$.html "class in akka.http.scaladsl.server") MODULE$
		```
	...
	- ### Constructor Detail
		...
		```
		public TransformationRejection$()
		```
