...
- - ### Constructor Summary
	...
	| `[ParsingException](#%3Cinit%3E(akka.http.scaladsl.model.ErrorInfo))​([ErrorInfo](ErrorInfo.html "class in akka.http.scaladsl.model") info)` |  |
	...
	| `static [ParsingException](ParsingException.html "class in akka.http.scaladsl.model")` | `[apply](#apply(java.lang.String,java.lang.String))​(java.lang.String summary,  java.lang.String detail)` |  |
...
- - ### Constructor Detail
		...
		```
		public ParsingException​([ErrorInfo](ErrorInfo.html "class in akka.http.scaladsl.model") info)
		```
	...
	- ### Method Detail
		...
		```
		public static [ParsingException](ParsingException.html "class in akka.http.scaladsl.model") apply​(java.lang.String summary,
