...
scraped_at: '2026-04-06T00:37:30Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Timeout$minusAccess.html
title: Timeout$minusAccess
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.TimeoutAccess](../../../javadsl/model/headers/TimeoutAccess.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.Timeout$minusAccess

- All Implemented Interfaces:
`[Renderable](../../../impl/util/Renderable.html "interface in akka.http.impl.util")`, `[ToStringRenderable](../../../impl/util/ToStringRenderable.html "interface in akka.http.impl.util")`, `[ModeledHeader](ModeledHeader.html "interface in akka.http.scaladsl.model.headers")`, `[SyntheticHeader](SyntheticHeader.html "interface in akka.http.scaladsl.model.headers")`, `java.io.Serializable`, `scala.Equals`, `scala.Product`

---

```
public final class Timeout$minusAccess
extends [TimeoutAccess](../../../javadsl/model/headers/TimeoutAccess.html "class in akka.http.javadsl.model.headers")
implements [SyntheticHeader](SyntheticHeader.html "interface in akka.http.scaladsl.model.headers"), scala.Product, java.io.Serializable
```

See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Timeout$minusAccess)
...
- - ### Nested Class Summary
	...
	| `[Timeout$minusAccess](#%3Cinit%3E(akka.http.scaladsl.TimeoutAccess))​([TimeoutAccess](../../TimeoutAccess.html "interface in akka.http.scaladsl") timeoutAccess)` |  |
	...
	| `protected [Timeout$minusAccess$](Timeout$minusAccess$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	...
	| `[TimeoutAccess](../../TimeoutAccess.html "interface in akka.http.scaladsl")` | `[timeoutAccess](#timeoutAccess())()` |  |
	
	
		- ### Methods inherited from class akka.http.javadsl.model.headers.[TimeoutAccess](../../../javadsl/model/headers/TimeoutAccess.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/TimeoutAccess.html#create(akka.http.javadsl.TimeoutAccess))`
...
- - ### Constructor Detail
		...
		```
		public Timeout$minusAccess​([TimeoutAccess](../../TimeoutAccess.html "interface in akka.http.scaladsl") timeoutAccess)
		```
	...
	- ### Method Detail
		...
		```
		public [TimeoutAccess](../../TimeoutAccess.html "interface in akka.http.scaladsl") timeoutAccess()
		```
		
		
		Specified by:
		`[timeoutAccess](../../../javadsl/model/headers/TimeoutAccess.html#timeoutAccess())` in class `[TimeoutAccess](../../../javadsl/model/headers/TimeoutAccess.html "class in akka.http.javadsl.model.headers")`
		- #### renderValue
		...
		```
		protected [Timeout$minusAccess$](Timeout$minusAccess$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
- https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/TimeoutAccess.html
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Timeout$minusAccess.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Timeout$minusAccess.html)*