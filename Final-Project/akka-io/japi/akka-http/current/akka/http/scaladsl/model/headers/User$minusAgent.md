...
scraped_at: '2026-04-06T00:37:37Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/User$minusAgent.html
title: User$minusAgent
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.UserAgent](../../../javadsl/model/headers/UserAgent.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.User$minusAgent
...
```
public final class User$minusAgent
extends [UserAgent](../../../javadsl/model/headers/UserAgent.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.User$minusAgent)
...
- - ### Nested Class Summary
	...
	| `[User$minusAgent](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<[ProductVersion](ProductVersion.html "class in akka.http.scaladsl.model.headers")> products)` |  |
	...
	| `static [User$minusAgent](User$minusAgent.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(akka.http.scaladsl.model.headers.ProductVersion,scala.collection.immutable.Seq))​([ProductVersion](ProductVersion.html "class in akka.http.scaladsl.model.headers") first,  scala.collection.immutable.Seq<[ProductVersion](ProductVersion.html "class in akka.http.scaladsl.model.headers")> more)` |  |
	| `static [User$minusAgent](User$minusAgent.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(java.lang.String))​(java.lang.String products)` |  |
	| `protected [User$minusAgent$](User$minusAgent$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `java.lang.Iterable<[ProductVersion](../../../javadsl/model/headers/ProductVersion.html "class in akka.http.javadsl.model.headers")>` | `[getProducts](#getProducts())()` | Java API |
	...
	| `scala.collection.immutable.Seq<[ProductVersion](ProductVersion.html "class in akka.http.scaladsl.model.headers")>` | `[products](#products())()` |  |
	| `static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[ProductVersion](ProductVersion.html "class in akka.http.scaladsl.model.headers")>>` | `[productsRenderer](#productsRenderer())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[UserAgent](../../../javadsl/model/headers/UserAgent.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/UserAgent.html#create(akka.http.javadsl.model.headers.ProductVersion...)), [create](../../../javadsl/model/headers/UserAgent.html#create(java.lang.String))`
...
- - ### Constructor Detail
		...
		```
		public User$minusAgent​(scala.collection.immutable.Seq<[ProductVersion](ProductVersion.html "class in akka.http.scaladsl.model.headers")> products)
		```
	...
	- ### Method Detail
		...
		```
		public static [User$minusAgent](User$minusAgent.html "class in akka.http.scaladsl.model.headers") apply​(java.lang.String products)
		```
		- #### apply
		...
		```
		public static [User$minusAgent](User$minusAgent.html "class in akka.http.scaladsl.model.headers") apply​([ProductVersion](ProductVersion.html "class in akka.http.scaladsl.model.headers") first,
		                                    scala.collection.immutable.Seq<[ProductVersion](ProductVersion.html "class in akka.http.scaladsl.model.headers")> more)
		```
		- #### productsRenderer
		...
		```
		public static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[ProductVersion](ProductVersion.html "class in akka.http.scaladsl.model.headers")>> productsRenderer()
		```
		- #### name
		...
		```
		public scala.collection.immutable.Seq<[ProductVersion](ProductVersion.html "class in akka.http.scaladsl.model.headers")> products()
		```
		- #### renderValue
		...
		```
		protected [User$minusAgent$](User$minusAgent$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		```
		public java.lang.Iterable<[ProductVersion](../../../javadsl/model/headers/ProductVersion.html "class in akka.http.javadsl.model.headers")> getProducts()
		```
		
		Java API
		
		Specified by:
		`[getProducts](../../../javadsl/model/headers/UserAgent.html#getProducts())` in class `[UserAgent](../../../javadsl/model/headers/UserAgent.html "class in akka.http.javadsl.model.headers")`
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/User$minusAgent.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/User$minusAgent.html)*