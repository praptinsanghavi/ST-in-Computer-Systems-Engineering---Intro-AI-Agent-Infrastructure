...
- java.lang.Object
- - [akka.http.scaladsl.model.headers.ModeledCompanion](ModeledCompanion.html "class in akka.http.scaladsl.model.headers")\<[Content$minusLocation](Content$minusLocation.html "class in akka.http.scaladsl.model.headers")\>
...
extends [ModeledCompanion](ModeledCompanion.html "class in akka.http.scaladsl.model.headers")<[Content$minusLocation](Content$minusLocation.html "class in akka.http.scaladsl.model.headers")>
...
- - ### Field Summary
	...
	| `static [Content$minusLocation$](Content$minusLocation$.html "class in akka.http.scaladsl.model.headers")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `[Content$minusLocation$](#%3Cinit%3E())()` |  |
...
- - ### Field Detail
		...
		```
		public static final [Content$minusLocation$](Content$minusLocation$.html "class in akka.http.scaladsl.model.headers") MODULE$
		```
