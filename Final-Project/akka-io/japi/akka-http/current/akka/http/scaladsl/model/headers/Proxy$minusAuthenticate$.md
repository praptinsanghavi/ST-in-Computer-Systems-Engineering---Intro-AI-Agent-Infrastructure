...
scraped_at: '2026-04-06T00:36:52Z'
section: japi
site: akka-io
...
- java.lang.Object
- - [akka.http.scaladsl.model.headers.ModeledCompanion](ModeledCompanion.html "class in akka.http.scaladsl.model.headers")\<[Proxy$minusAuthenticate](Proxy$minusAuthenticate.html "class in akka.http.scaladsl.model.headers")\>
...
extends [ModeledCompanion](ModeledCompanion.html "class in akka.http.scaladsl.model.headers")<[Proxy$minusAuthenticate](Proxy$minusAuthenticate.html "class in akka.http.scaladsl.model.headers")>
...
- - ### Field Summary
	...
	| `static [Proxy$minusAuthenticate$](Proxy$minusAuthenticate$.html "class in akka.http.scaladsl.model.headers")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `[Proxy$minusAuthenticate$](#%3Cinit%3E())()` |  |
	...
	| `[Proxy$minusAuthenticate](Proxy$minusAuthenticate.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(akka.http.scaladsl.model.headers.HttpChallenge,scala.collection.immutable.Seq))​([HttpChallenge](HttpChallenge.html "class in akka.http.scaladsl.model.headers") first,  scala.collection.immutable.Seq<[HttpChallenge](HttpChallenge.html "class in akka.http.scaladsl.model.headers")> more)` |  |
...
- - ### Field Detail
		...
		```
		public static final [Proxy$minusAuthenticate$](Proxy$minusAuthenticate$.html "class in akka.http.scaladsl.model.headers") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public [Proxy$minusAuthenticate](Proxy$minusAuthenticate.html "class in akka.http.scaladsl.model.headers") apply​([HttpChallenge](HttpChallenge.html "class in akka.http.scaladsl.model.headers") first,
