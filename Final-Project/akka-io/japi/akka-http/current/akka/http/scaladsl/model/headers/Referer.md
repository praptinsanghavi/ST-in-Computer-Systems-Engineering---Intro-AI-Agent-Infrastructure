...
scraped_at: '2026-04-06T00:37:01Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Referer.html
title: Referer
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.Referer](../../../javadsl/model/headers/Referer.html "class in akka.http.javadsl.model.headers")
...
extends [Referer](../../../javadsl/model/headers/Referer.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Referer)
...
- - ### Nested Class Summary
	...
	| `[Referer](#%3Cinit%3E(akka.http.scaladsl.model.Uri))​([Uri](../Uri.html "class in akka.http.scaladsl.model") uri)` |  |
	...
	| `protected [Referer$](Referer$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	...
	| `[Uri](../Uri.html "class in akka.http.scaladsl.model")` | `[uri](#uri())()` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[Referer](../../../javadsl/model/headers/Referer.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/Referer.html#create(akka.http.javadsl.model.Uri))`
...
- - ### Constructor Detail
		...
		```
		public Referer​([Uri](../Uri.html "class in akka.http.scaladsl.model") uri)
		```
	...
	- ### Method Detail
		...
		```
		protected [Referer$](Referer$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		Specified by:
		`[getUri](../../../javadsl/model/headers/Referer.html#getUri())` in class `[Referer](../../../javadsl/model/headers/Referer.html "class in akka.http.javadsl.model.headers")`
...
- https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/Referer.html
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Referer.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Referer.html)*