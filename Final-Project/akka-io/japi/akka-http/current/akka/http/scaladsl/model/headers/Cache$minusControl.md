...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.CacheControl](../../../javadsl/model/headers/CacheControl.html "class in akka.http.javadsl.model.headers")
...
```
public final class Cache$minusControl
extends [CacheControl](../../../javadsl/model/headers/CacheControl.html "class in akka.http.javadsl.model.headers")
...
- - ### Nested Class Summary
	...
	| `[Cache$minusControl](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<[CacheDirective](CacheDirective.html "interface in akka.http.scaladsl.model.headers")> directives)` |  |
	...
	| `static [Cache$minusControl](Cache$minusControl.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(akka.http.scaladsl.model.headers.CacheDirective,scala.collection.immutable.Seq))​([CacheDirective](CacheDirective.html "interface in akka.http.scaladsl.model.headers") first,  scala.collection.immutable.Seq<[CacheDirective](CacheDirective.html "interface in akka.http.scaladsl.model.headers")> more)` |  |
	| `protected [Cache$minusControl$](Cache$minusControl$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `scala.collection.immutable.Seq<[CacheDirective](CacheDirective.html "interface in akka.http.scaladsl.model.headers")>` | `[directives](#directives())()` |  |
	| `static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[CacheDirective](CacheDirective.html "interface in akka.http.scaladsl.model.headers")>>` | `[directivesRenderer](#directivesRenderer())()` |  |
	| `java.lang.Iterable<[CacheDirective](../../../javadsl/model/headers/CacheDirective.html "interface in akka.http.javadsl.model.headers")>` | `[getDirectives](#getDirectives())()` | Java API |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[CacheControl](../../../javadsl/model/headers/CacheControl.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/CacheControl.html#create(akka.http.javadsl.model.headers.CacheDirective...))`
...
- - ### Constructor Detail
		...
		```
		public Cache$minusControl​(scala.collection.immutable.Seq<[CacheDirective](CacheDirective.html "interface in akka.http.scaladsl.model.headers")> directives)
		```
	...
	- ### Method Detail
		...
		```
		public static [Cache$minusControl](Cache$minusControl.html "class in akka.http.scaladsl.model.headers") apply​([CacheDirective](CacheDirective.html "interface in akka.http.scaladsl.model.headers") first,
		...
		```
		public static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[CacheDirective](CacheDirective.html "interface in akka.http.scaladsl.model.headers")>> directivesRenderer()
		```
		- #### name
		...
		```
		public scala.collection.immutable.Seq<[CacheDirective](CacheDirective.html "interface in akka.http.scaladsl.model.headers")> directives()
		```
		- #### renderValue
		...
		```
		protected [Cache$minusControl$](Cache$minusControl$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		```
		public java.lang.Iterable<[CacheDirective](../../../javadsl/model/headers/CacheDirective.html "interface in akka.http.javadsl.model.headers")> getDirectives()
		```
		
		Java API
		
		Specified by:
		`[getDirectives](../../../javadsl/model/headers/CacheControl.html#getDirectives())` in class `[CacheControl](../../../javadsl/model/headers/CacheControl.html "class in akka.http.javadsl.model.headers")`
