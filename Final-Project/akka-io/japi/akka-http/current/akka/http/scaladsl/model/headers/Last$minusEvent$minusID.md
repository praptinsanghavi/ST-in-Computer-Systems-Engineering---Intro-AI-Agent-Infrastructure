...
scraped_at: '2026-04-06T00:36:17Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Last$minusEvent$minusID.html
title: Last$minusEvent$minusID
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.LastEventId](../../../javadsl/model/headers/LastEventId.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.Last$minusEvent$minusID
...
```
public final class Last$minusEvent$minusID
extends [LastEventId](../../../javadsl/model/headers/LastEventId.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Last$minusEvent$minusID)
...
- - ### Nested Class Summary
	...
	| `[Last$minusEvent$minusID](#%3Cinit%3E(java.lang.String))​(java.lang.String id)` |  |
	...
	| `protected [Last$minusEvent$minusID$](Last$minusEvent$minusID$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	...
	| `protected <R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[LastEventId](../../../javadsl/model/headers/LastEventId.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/LastEventId.html#create(java.lang.String))`
...
- - ### Constructor Detail
		...
		```
		public Last$minusEvent$minusID​(java.lang.String id)
		```
	...
	- ### Method Detail
		...
		Specified by:
		`[id](../../../javadsl/model/headers/LastEventId.html#id())` in class `[LastEventId](../../../javadsl/model/headers/LastEventId.html "class in akka.http.javadsl.model.headers")`
		- #### renderValue
		...
		```
		protected [Last$minusEvent$minusID$](Last$minusEvent$minusID$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Last$minusEvent$minusID.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Last$minusEvent$minusID.html)*