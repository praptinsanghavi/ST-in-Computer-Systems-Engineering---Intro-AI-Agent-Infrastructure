...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Accept$minusLanguage.html
title: Accept$minusLanguage
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.AcceptLanguage](../../../javadsl/model/headers/AcceptLanguage.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.Accept$minusLanguage
...
```
public final class Accept$minusLanguage
extends [AcceptLanguage](../../../javadsl/model/headers/AcceptLanguage.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Accept$minusLanguage)
...
- - ### Nested Class Summary
	...
	| `[Accept$minusLanguage](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<[LanguageRange](LanguageRange.html "interface in akka.http.scaladsl.model.headers")> languages)` |  |
	...
	| `static [Accept$minusLanguage](Accept$minusLanguage.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(akka.http.scaladsl.model.headers.LanguageRange,scala.collection.immutable.Seq))​([LanguageRange](LanguageRange.html "interface in akka.http.scaladsl.model.headers") first,  scala.collection.immutable.Seq<[LanguageRange](LanguageRange.html "interface in akka.http.scaladsl.model.headers")> more)` |  |
	| `protected [Accept$minusLanguage$](Accept$minusLanguage$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `java.lang.Iterable<[LanguageRange](../../../javadsl/model/headers/LanguageRange.html "interface in akka.http.javadsl.model.headers")>` | `[getLanguages](#getLanguages())()` | Java API |
	| `scala.collection.immutable.Seq<[LanguageRange](LanguageRange.html "interface in akka.http.scaladsl.model.headers")>` | `[languages](#languages())()` |  |
	| `static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[LanguageRange](LanguageRange.html "interface in akka.http.scaladsl.model.headers")>>` | `[languagesRenderer](#languagesRenderer())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[AcceptLanguage](../../../javadsl/model/headers/AcceptLanguage.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/AcceptLanguage.html#create(akka.http.javadsl.model.headers.LanguageRange...))`
...
- - ### Constructor Detail
		...
		```
		public Accept$minusLanguage​(scala.collection.immutable.Seq<[LanguageRange](LanguageRange.html "interface in akka.http.scaladsl.model.headers")> languages)
		```
	...
	- ### Method Detail
		...
		```
		public static [Accept$minusLanguage](Accept$minusLanguage.html "class in akka.http.scaladsl.model.headers") apply​([LanguageRange](LanguageRange.html "interface in akka.http.scaladsl.model.headers") first,
		                                         scala.collection.immutable.Seq<[LanguageRange](LanguageRange.html "interface in akka.http.scaladsl.model.headers")> more)
		```
		- #### languagesRenderer
		...
		```
		public static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[LanguageRange](LanguageRange.html "interface in akka.http.scaladsl.model.headers")>> languagesRenderer()
		```
		- #### name
		...
		```
		public scala.collection.immutable.Seq<[LanguageRange](LanguageRange.html "interface in akka.http.scaladsl.model.headers")> languages()
		```
		- #### renderValue
		...
		```
		protected [Accept$minusLanguage$](Accept$minusLanguage$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		```
		public java.lang.Iterable<[LanguageRange](../../../javadsl/model/headers/LanguageRange.html "interface in akka.http.javadsl.model.headers")> getLanguages()
		```
		
		Java API
		
		Specified by:
		`[getLanguages](../../../javadsl/model/headers/AcceptLanguage.html#getLanguages())` in class `[AcceptLanguage](../../../javadsl/model/headers/AcceptLanguage.html "class in akka.http.javadsl.model.headers")`
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Accept$minusLanguage.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Accept$minusLanguage.html)*