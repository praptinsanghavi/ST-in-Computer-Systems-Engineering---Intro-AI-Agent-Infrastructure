...
scraped_at: '2026-04-06T00:37:34Z'
section: japi
site: akka-io
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.TransferEncoding](../../../javadsl/model/headers/TransferEncoding.html "class in akka.http.javadsl.model.headers")
...
```
public final class Transfer$minusEncoding
extends [TransferEncoding](../../../javadsl/model/headers/TransferEncoding.html "class in akka.http.javadsl.model.headers")
...
- - ### Nested Class Summary
	...
	| `[Transfer$minusEncoding](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<[TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model")> encodings)` |  |
	...
	| `[Transfer$minusEncoding](Transfer$minusEncoding.html "class in akka.http.scaladsl.model.headers")` | `[append](#append(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<[TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model")> encodings)` |  |
	| `static [Transfer$minusEncoding](Transfer$minusEncoding.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(akka.http.scaladsl.model.TransferEncoding,scala.collection.immutable.Seq))​([TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model") first,  scala.collection.immutable.Seq<[TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model")> more)` |  |
	| `protected [Transfer$minusEncoding$](Transfer$minusEncoding$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `scala.collection.immutable.Seq<[TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model")>` | `[encodings](#encodings())()` |  |
	| `static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model")>>` | `[encodingsRenderer](#encodingsRenderer())()` |  |
	| `java.lang.Iterable<[TransferEncoding](../../../javadsl/model/TransferEncoding.html "class in akka.http.javadsl.model")>` | `[getEncodings](#getEncodings())()` | Java API |
	...
	| `[Transfer$minusEncoding](Transfer$minusEncoding.html "class in akka.http.scaladsl.model.headers")` | `[withChunked](#withChunked())()` |  |
	| `scala.Option<[Transfer$minusEncoding](Transfer$minusEncoding.html "class in akka.http.scaladsl.model.headers")>` | `[withChunkedPeeled](#withChunkedPeeled())()` |  |
	
	
		- ### Methods inherited from class akka.http.javadsl.model.headers.[TransferEncoding](../../../javadsl/model/headers/TransferEncoding.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/TransferEncoding.html#create(akka.http.javadsl.model.TransferEncoding...))`
...
- - ### Constructor Detail
		...
		```
		public Transfer$minusEncoding​(scala.collection.immutable.Seq<[TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model")> encodings)
		```
	...
	- ### Method Detail
		...
		```
		public static [Transfer$minusEncoding](Transfer$minusEncoding.html "class in akka.http.scaladsl.model.headers") apply​([TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model") first,
		...
		```
		public static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model")>> encodingsRenderer()
		```
		- #### name
		...
		```
		public scala.collection.immutable.Seq<[TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model")> encodings()
		```
		- #### isChunked
		...
		```
		public [Transfer$minusEncoding](Transfer$minusEncoding.html "class in akka.http.scaladsl.model.headers") withChunked()
		```
		- #### withChunkedPeeled
		...
		```
		public scala.Option<[Transfer$minusEncoding](Transfer$minusEncoding.html "class in akka.http.scaladsl.model.headers")> withChunkedPeeled()
		```
		- #### append
		...
		```
		public [Transfer$minusEncoding](Transfer$minusEncoding.html "class in akka.http.scaladsl.model.headers") append​(scala.collection.immutable.Seq<[TransferEncoding](../TransferEncoding.html "class in akka.http.scaladsl.model")> encodings)
		```
		- #### renderValue
		...
		```
		protected [Transfer$minusEncoding$](Transfer$minusEncoding$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		```
		public java.lang.Iterable<[TransferEncoding](../../../javadsl/model/TransferEncoding.html "class in akka.http.javadsl.model")> getEncodings()
		```
		
		Java API
		
		Specified by:
		`[getEncodings](../../../javadsl/model/headers/TransferEncoding.html#getEncodings())` in class `[TransferEncoding](../../../javadsl/model/headers/TransferEncoding.html "class in akka.http.javadsl.model.headers")`
...
- https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/TransferEncoding.html
