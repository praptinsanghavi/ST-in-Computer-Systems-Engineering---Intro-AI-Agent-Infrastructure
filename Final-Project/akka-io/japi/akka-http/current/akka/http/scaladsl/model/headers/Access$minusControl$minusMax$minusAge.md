...
scraped_at: '2026-04-06T00:34:29Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Access$minusControl$minusMax$minusAge.html
title: Access$minusControl$minusMax$minusAge
---
...
## Class Access$minusControl$minusMax$minusAge
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.AccessControlMaxAge](../../../javadsl/model/headers/AccessControlMaxAge.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.Access$minusControl$minusMax$minusAge
...
extends [AccessControlMaxAge](../../../javadsl/model/headers/AccessControlMaxAge.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Access$minusControl$minusMax$minusAge)
...
- - ### Nested Class Summary
	...
	| `[Access$minusControl$minusMax$minusAge](#%3Cinit%3E(long))​(long deltaSeconds)` |  |
	...
	| `protected [Access$minusControl$minusMax$minusAge$](Access$minusControl$minusMax$minusAge$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[AccessControlMaxAge](../../../javadsl/model/headers/AccessControlMaxAge.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/AccessControlMaxAge.html#create(long))`
...
- - ### Constructor Detail
		...
		```
		public Access$minusControl$minusMax$minusAge​(long deltaSeconds)
		```
	...
	- ### Method Detail
		...
		Specified by:
		`[deltaSeconds](../../../javadsl/model/headers/AccessControlMaxAge.html#deltaSeconds())` in class `[AccessControlMaxAge](../../../javadsl/model/headers/AccessControlMaxAge.html "class in akka.http.javadsl.model.headers")`
		- #### renderValue
		...
		```
		protected [Access$minusControl$minusMax$minusAge$](Access$minusControl$minusMax$minusAge$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Access$minusControl$minusMax$minusAge.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Access$minusControl$minusMax$minusAge.html)*