...
scraped_at: '2026-04-06T00:34:20Z'
section: japi
site: akka-io
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.AcceptRanges](../../../javadsl/model/headers/AcceptRanges.html "class in akka.http.javadsl.model.headers")
...
```
public final class Accept$minusRanges
extends [AcceptRanges](../../../javadsl/model/headers/AcceptRanges.html "class in akka.http.javadsl.model.headers")
...
- - ### Nested Class Summary
	...
	| `[Accept$minusRanges](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<[RangeUnit](RangeUnit.html "class in akka.http.scaladsl.model.headers")> rangeUnits)` |  |
	...
	| `static [Accept$minusRanges](Accept$minusRanges.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply())()` |  |
	| `static [Accept$minusRanges](Accept$minusRanges.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(akka.http.scaladsl.model.headers.RangeUnit,scala.collection.immutable.Seq))​([RangeUnit](RangeUnit.html "class in akka.http.scaladsl.model.headers") firstRangeUnit,  scala.collection.immutable.Seq<[RangeUnit](RangeUnit.html "class in akka.http.scaladsl.model.headers")> otherRangeUnits)` |  |
	| `protected [Accept$minusRanges$](Accept$minusRanges$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `java.lang.Iterable<[RangeUnit](../../../javadsl/model/headers/RangeUnit.html "class in akka.http.javadsl.model.headers")>` | `[getRangeUnits](#getRangeUnits())()` | Java API |
	...
	| `scala.collection.immutable.Seq<[RangeUnit](RangeUnit.html "class in akka.http.scaladsl.model.headers")>` | `[rangeUnits](#rangeUnits())()` |  |
	| `static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[RangeUnit](RangeUnit.html "class in akka.http.scaladsl.model.headers")>>` | `[rangeUnitsRenderer](#rangeUnitsRenderer())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[AcceptRanges](../../../javadsl/model/headers/AcceptRanges.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/AcceptRanges.html#create(akka.http.javadsl.model.headers.RangeUnit...))`
...
- - ### Constructor Detail
		...
		```
		public Accept$minusRanges​(scala.collection.immutable.Seq<[RangeUnit](RangeUnit.html "class in akka.http.scaladsl.model.headers")> rangeUnits)
		```
	...
	- ### Method Detail
		...
		```
		public static [Accept$minusRanges](Accept$minusRanges.html "class in akka.http.scaladsl.model.headers") apply()
		```
		- #### apply
		...
		```
		public static [Accept$minusRanges](Accept$minusRanges.html "class in akka.http.scaladsl.model.headers") apply​([RangeUnit](RangeUnit.html "class in akka.http.scaladsl.model.headers") firstRangeUnit,
		...
		```
		public static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[RangeUnit](RangeUnit.html "class in akka.http.scaladsl.model.headers")>> rangeUnitsRenderer()
		```
		- #### name
		...
		```
		public scala.collection.immutable.Seq<[RangeUnit](RangeUnit.html "class in akka.http.scaladsl.model.headers")> rangeUnits()
		```
		- #### renderValue
		...
		```
		protected [Accept$minusRanges$](Accept$minusRanges$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		```
		public java.lang.Iterable<[RangeUnit](../../../javadsl/model/headers/RangeUnit.html "class in akka.http.javadsl.model.headers")> getRangeUnits()
		```
		
		Java API
		
		Specified by:
		`[getRangeUnits](../../../javadsl/model/headers/AcceptRanges.html#getRangeUnits())` in class `[AcceptRanges](../../../javadsl/model/headers/AcceptRanges.html "class in akka.http.javadsl.model.headers")`
