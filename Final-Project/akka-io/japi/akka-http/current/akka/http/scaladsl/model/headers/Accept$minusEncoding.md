...
scraped_at: '2026-04-06T00:34:17Z'
section: japi
site: akka-io
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.AcceptEncoding](../../../javadsl/model/headers/AcceptEncoding.html "class in akka.http.javadsl.model.headers")
...
```
public final class Accept$minusEncoding
extends [AcceptEncoding](../../../javadsl/model/headers/AcceptEncoding.html "class in akka.http.javadsl.model.headers")
...
- - ### Nested Class Summary
	...
	| `[Accept$minusEncoding](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<[HttpEncodingRange](HttpEncodingRange.html "class in akka.http.scaladsl.model.headers")> encodings)` |  |
	...
	| `static [Accept$minusEncoding](Accept$minusEncoding.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply())()` |  |
	| `static [Accept$minusEncoding](Accept$minusEncoding.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(akka.http.scaladsl.model.headers.HttpEncodingRange,scala.collection.immutable.Seq))​([HttpEncodingRange](HttpEncodingRange.html "class in akka.http.scaladsl.model.headers") firstEncoding,  scala.collection.immutable.Seq<[HttpEncodingRange](HttpEncodingRange.html "class in akka.http.scaladsl.model.headers")> otherEncodings)` |  |
	| `protected [Accept$minusEncoding$](Accept$minusEncoding$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `scala.collection.immutable.Seq<[HttpEncodingRange](HttpEncodingRange.html "class in akka.http.scaladsl.model.headers")>` | `[encodings](#encodings())()` |  |
	| `static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[HttpEncodingRange](HttpEncodingRange.html "class in akka.http.scaladsl.model.headers")>>` | `[encodingsRenderer](#encodingsRenderer())()` |  |
	| `java.lang.Iterable<[HttpEncodingRange](../../../javadsl/model/headers/HttpEncodingRange.html "class in akka.http.javadsl.model.headers")>` | `[getEncodings](#getEncodings())()` | Java API |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[AcceptEncoding](../../../javadsl/model/headers/AcceptEncoding.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/AcceptEncoding.html#create(akka.http.javadsl.model.headers.HttpEncoding)), [create](../../../javadsl/model/headers/AcceptEncoding.html#create(akka.http.javadsl.model.headers.HttpEncodingRange...))`
...
- - ### Constructor Detail
		...
		```
		public Accept$minusEncoding​(scala.collection.immutable.Seq<[HttpEncodingRange](HttpEncodingRange.html "class in akka.http.scaladsl.model.headers")> encodings)
		```
	...
	- ### Method Detail
		...
		```
		public static [Accept$minusEncoding](Accept$minusEncoding.html "class in akka.http.scaladsl.model.headers") apply()
		```
		- #### apply
		...
		```
		public static [Accept$minusEncoding](Accept$minusEncoding.html "class in akka.http.scaladsl.model.headers") apply​([HttpEncodingRange](HttpEncodingRange.html "class in akka.http.scaladsl.model.headers") firstEncoding,
		...
		```
		public static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[HttpEncodingRange](HttpEncodingRange.html "class in akka.http.scaladsl.model.headers")>> encodingsRenderer()
		```
		- #### name
		...
		```
		public scala.collection.immutable.Seq<[HttpEncodingRange](HttpEncodingRange.html "class in akka.http.scaladsl.model.headers")> encodings()
		```
		- #### renderValue
		...
		```
		protected [Accept$minusEncoding$](Accept$minusEncoding$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		```
		public java.lang.Iterable<[HttpEncodingRange](../../../javadsl/model/headers/HttpEncodingRange.html "class in akka.http.javadsl.model.headers")> getEncodings()
		```
		
		Java API
		
		Specified by:
		`[getEncodings](../../../javadsl/model/headers/AcceptEncoding.html#getEncodings())` in class `[AcceptEncoding](../../../javadsl/model/headers/AcceptEncoding.html "class in akka.http.javadsl.model.headers")`
...
- https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/HttpEncodingRange.html
