...
scraped_at: '2026-04-06T00:36:08Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/If$minusUnmodified$minusSince.html
title: If$minusUnmodified$minusSince
---
...
## Class If$minusUnmodified$minusSince
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.IfUnmodifiedSince](../../../javadsl/model/headers/IfUnmodifiedSince.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.If$minusUnmodified$minusSince
...
```
public final class If$minusUnmodified$minusSince
extends [IfUnmodifiedSince](../../../javadsl/model/headers/IfUnmodifiedSince.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.If$minusUnmodified$minusSince)
...
- - ### Nested Class Summary
	...
	| `[If$minusUnmodified$minusSince](#%3Cinit%3E(akka.http.scaladsl.model.DateTime))​([DateTime](../DateTime.html "class in akka.http.scaladsl.model") date)` |  |
	...
	| `protected [If$minusUnmodified$minusSince$](If$minusUnmodified$minusSince$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `[DateTime](../DateTime.html "class in akka.http.scaladsl.model")` | `[date](#date())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[IfUnmodifiedSince](../../../javadsl/model/headers/IfUnmodifiedSince.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/IfUnmodifiedSince.html#create(akka.http.javadsl.model.DateTime))`
...
- - ### Constructor Detail
		...
		```
		public If$minusUnmodified$minusSince​([DateTime](../DateTime.html "class in akka.http.scaladsl.model") date)
		```
	...
	- ### Method Detail
		...
		```
		public [DateTime](../DateTime.html "class in akka.http.scaladsl.model") date()
		```
		
		
		Specified by:
		`[date](../../../javadsl/model/headers/IfUnmodifiedSince.html#date())` in class `[IfUnmodifiedSince](../../../javadsl/model/headers/IfUnmodifiedSince.html "class in akka.http.javadsl.model.headers")`
		- #### renderValue
		...
		```
		protected [If$minusUnmodified$minusSince$](If$minusUnmodified$minusSince$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/If$minusUnmodified$minusSince.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/If$minusUnmodified$minusSince.html)*