...
scraped_at: '2026-04-06T00:35:11Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Content$minusRange.html
title: Content$minusRange
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.ContentRange](../../../javadsl/model/headers/ContentRange.html "class in akka.http.javadsl.model.headers")
...
```
public final class Content$minusRange
extends [ContentRange](../../../javadsl/model/headers/ContentRange.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Content$minusRange)
...
- - ### Nested Class Summary
	...
	| `[Content$minusRange](#%3Cinit%3E(akka.http.scaladsl.model.headers.RangeUnit,akka.http.scaladsl.model.ContentRange))​([RangeUnit](RangeUnit.html "class in akka.http.scaladsl.model.headers") rangeUnit,  [ContentRange](../ContentRange.html "interface in akka.http.scaladsl.model") contentRange)` |  |
	...
	| `static [Content$minusRange](Content$minusRange.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(akka.http.scaladsl.model.ByteContentRange))​([ByteContentRange](../ByteContentRange.html "interface in akka.http.scaladsl.model") byteContentRange)` |  |
	| `protected [Content$minusRange$](Content$minusRange$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `[ContentRange](../ContentRange.html "interface in akka.http.scaladsl.model")` | `[contentRange](#contentRange())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[ContentRange](../../../javadsl/model/headers/ContentRange.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/ContentRange.html#create(akka.http.javadsl.model.headers.RangeUnit,akka.http.javadsl.model.ContentRange))`
...
- - ### Constructor Detail
		...
		```
		public Content$minusRange​([RangeUnit](RangeUnit.html "class in akka.http.scaladsl.model.headers") rangeUnit,
		                          [ContentRange](../ContentRange.html "interface in akka.http.scaladsl.model") contentRange)
		```
	...
	- ### Method Detail
		...
		```
		public static [Content$minusRange](Content$minusRange.html "class in akka.http.scaladsl.model.headers") apply​([ByteContentRange](../ByteContentRange.html "interface in akka.http.scaladsl.model") byteContentRange)
		```
		- #### name
		...
		Specified by:
		`[rangeUnit](../../../javadsl/model/headers/ContentRange.html#rangeUnit())` in class `[ContentRange](../../../javadsl/model/headers/ContentRange.html "class in akka.http.javadsl.model.headers")`
		- #### contentRange
		
		
		
		```
		public [ContentRange](../ContentRange.html "interface in akka.http.scaladsl.model") contentRange()
		```
		- #### renderValue
		...
		```
		protected [Content$minusRange$](Content$minusRange$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Content$minusRange.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Content$minusRange.html)*