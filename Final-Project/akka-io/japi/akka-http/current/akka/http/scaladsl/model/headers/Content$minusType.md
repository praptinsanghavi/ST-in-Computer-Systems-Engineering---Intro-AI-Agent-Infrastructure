...
scraped_at: '2026-04-06T00:35:12Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Content$minusType.html
title: Content$minusType
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.ContentType](../../../javadsl/model/headers/ContentType.html "class in akka.http.javadsl.model.headers")
...
```
public final class Content$minusType
extends [ContentType](../../../javadsl/model/headers/ContentType.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Content$minusType)
...
- - ### Nested Class Summary
	...
	| `[Content$minusType](#%3Cinit%3E(akka.http.scaladsl.model.ContentType))​([ContentType](../ContentType.html "interface in akka.http.scaladsl.model") contentType)` |  |
	...
	| `protected [Content$minusType$](Content$minusType$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `[ContentType](../ContentType.html "interface in akka.http.scaladsl.model")` | `[contentType](#contentType())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[ContentType](../../../javadsl/model/headers/ContentType.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/ContentType.html#create(akka.http.javadsl.model.ContentType))`
...
- - ### Constructor Detail
		...
		```
		public Content$minusType​([ContentType](../ContentType.html "interface in akka.http.scaladsl.model") contentType)
		```
	...
	- ### Method Detail
		...
		```
		public [ContentType](../ContentType.html "interface in akka.http.scaladsl.model") contentType()
		```
		
		
		Specified by:
		`[contentType](../../../javadsl/model/headers/ContentType.html#contentType())` in class `[ContentType](../../../javadsl/model/headers/ContentType.html "class in akka.http.javadsl.model.headers")`
		- #### renderValue
		...
		```
		protected [Content$minusType$](Content$minusType$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Content$minusType.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Content$minusType.html)*