...
- java.lang.Object
- - scala.runtime.AbstractFunction2\<java.lang.String,​scala.Option\<java.lang.String\>,​[UpgradeProtocol](UpgradeProtocol.html "class in akka.http.scaladsl.model.headers")\>
	- - akka.http.scaladsl.model.headers.UpgradeProtocol$

- All Implemented Interfaces:
`java.io.Serializable`, `scala.Function2<java.lang.String,​scala.Option<java.lang.String>,​[UpgradeProtocol](UpgradeProtocol.html "class in akka.http.scaladsl.model.headers")>`

---

```
public class UpgradeProtocol$
extends scala.runtime.AbstractFunction2<java.lang.String,​scala.Option<java.lang.String>,​[UpgradeProtocol](UpgradeProtocol.html "class in akka.http.scaladsl.model.headers")>
...
- - ### Field Summary
	...
	| `static [UpgradeProtocol$](UpgradeProtocol$.html "class in akka.http.scaladsl.model.headers")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [UpgradeProtocol$](UpgradeProtocol$.html "class in akka.http.scaladsl.model.headers") MODULE$
		```
