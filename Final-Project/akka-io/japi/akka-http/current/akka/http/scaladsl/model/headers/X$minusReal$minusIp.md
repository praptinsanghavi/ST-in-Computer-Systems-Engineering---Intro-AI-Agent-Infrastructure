...
scraped_at: '2026-04-06T00:37:47Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/X$minusReal$minusIp.html
title: X$minusReal$minusIp
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.XRealIp](../../../javadsl/model/headers/XRealIp.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.X$minusReal$minusIp
...
```
public final class X$minusReal$minusIp
extends [XRealIp](../../../javadsl/model/headers/XRealIp.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.X$minusReal$minusIp)
...
- - ### Nested Class Summary
	...
	| `[X$minusReal$minusIp](#%3Cinit%3E(akka.http.scaladsl.model.RemoteAddress))​([RemoteAddress](../RemoteAddress.html "class in akka.http.scaladsl.model") address)` |  |
	...
	| `[RemoteAddress](../RemoteAddress.html "class in akka.http.scaladsl.model")` | `[address](#address())()` |  |
	| `static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<[RemoteAddress](../RemoteAddress.html "class in akka.http.scaladsl.model")>` | `[addressRenderer](#addressRenderer())()` |  |
	| `protected [X$minusReal$minusIp$](X$minusReal$minusIp$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[XRealIp](../../../javadsl/model/headers/XRealIp.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/XRealIp.html#create(akka.http.javadsl.model.RemoteAddress))`
...
- - ### Constructor Detail
		...
		```
		public X$minusReal$minusIp​([RemoteAddress](../RemoteAddress.html "class in akka.http.scaladsl.model") address)
		```
	...
	- ### Method Detail
		...
		```
		public static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<[RemoteAddress](../RemoteAddress.html "class in akka.http.scaladsl.model")> addressRenderer()
		```
		- #### name
		...
		Specified by:
		`[address](../../../javadsl/model/headers/XRealIp.html#address())` in class `[XRealIp](../../../javadsl/model/headers/XRealIp.html "class in akka.http.javadsl.model.headers")`
		- #### renderValue
		...
		```
		protected [X$minusReal$minusIp$](X$minusReal$minusIp$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
- https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/XRealIp.html
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/X$minusReal$minusIp.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/X$minusReal$minusIp.html)*