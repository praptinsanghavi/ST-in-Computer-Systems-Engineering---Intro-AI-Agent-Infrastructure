...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.AcceptCharset](../../../javadsl/model/headers/AcceptCharset.html "class in akka.http.javadsl.model.headers")
...
```
public final class Accept$minusCharset
extends [AcceptCharset](../../../javadsl/model/headers/AcceptCharset.html "class in akka.http.javadsl.model.headers")
...
- - ### Nested Class Summary
	...
	| `[Accept$minusCharset](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<[HttpCharsetRange](../HttpCharsetRange.html "class in akka.http.scaladsl.model")> charsetRanges)` |  |
	...
	| `static [Accept$minusCharset](Accept$minusCharset.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(akka.http.scaladsl.model.HttpCharsetRange,scala.collection.immutable.Seq))​([HttpCharsetRange](../HttpCharsetRange.html "class in akka.http.scaladsl.model") first,  scala.collection.immutable.Seq<[HttpCharsetRange](../HttpCharsetRange.html "class in akka.http.scaladsl.model")> more)` |  |
	| `scala.collection.immutable.Seq<[HttpCharsetRange](../HttpCharsetRange.html "class in akka.http.scaladsl.model")>` | `[charsetRanges](#charsetRanges())()` |  |
	| `static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[HttpCharsetRange](../HttpCharsetRange.html "class in akka.http.scaladsl.model")>>` | `[charsetRangesRenderer](#charsetRangesRenderer())()` |  |
	| `protected [Accept$minusCharset$](Accept$minusCharset$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `java.lang.Iterable<[HttpCharsetRange](../../../javadsl/model/HttpCharsetRange.html "class in akka.http.javadsl.model")>` | `[getCharsetRanges](#getCharsetRanges())()` | Java API |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[AcceptCharset](../../../javadsl/model/headers/AcceptCharset.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/AcceptCharset.html#create(akka.http.javadsl.model.HttpCharsetRange...))`
...
- - ### Constructor Detail
		...
		```
		public Accept$minusCharset​(scala.collection.immutable.Seq<[HttpCharsetRange](../HttpCharsetRange.html "class in akka.http.scaladsl.model")> charsetRanges)
		```
	...
	- ### Method Detail
		...
		```
		public static [Accept$minusCharset](Accept$minusCharset.html "class in akka.http.scaladsl.model.headers") apply​([HttpCharsetRange](../HttpCharsetRange.html "class in akka.http.scaladsl.model") first,
		...
		```
		public static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<[HttpCharsetRange](../HttpCharsetRange.html "class in akka.http.scaladsl.model")>> charsetRangesRenderer()
		```
		- #### name
		...
		```
		public scala.collection.immutable.Seq<[HttpCharsetRange](../HttpCharsetRange.html "class in akka.http.scaladsl.model")> charsetRanges()
		```
		- #### renderValue
		...
		```
		protected [Accept$minusCharset$](Accept$minusCharset$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		```
		public java.lang.Iterable<[HttpCharsetRange](../../../javadsl/model/HttpCharsetRange.html "class in akka.http.javadsl.model")> getCharsetRanges()
		```
		
		Java API
		
		Specified by:
		`[getCharsetRanges](../../../javadsl/model/headers/AcceptCharset.html#getCharsetRanges())` in class `[AcceptCharset](../../../javadsl/model/headers/AcceptCharset.html "class in akka.http.javadsl.model.headers")`
