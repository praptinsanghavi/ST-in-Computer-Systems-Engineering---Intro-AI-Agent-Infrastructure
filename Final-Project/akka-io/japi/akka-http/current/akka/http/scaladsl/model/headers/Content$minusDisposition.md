...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.ContentDisposition](../../../javadsl/model/headers/ContentDisposition.html "class in akka.http.javadsl.model.headers")
...
```
public final class Content$minusDisposition
extends [ContentDisposition](../../../javadsl/model/headers/ContentDisposition.html "class in akka.http.javadsl.model.headers")
...
- - ### Nested Class Summary
	...
	| `[Content$minusDisposition](#%3Cinit%3E(akka.http.scaladsl.model.headers.ContentDispositionType,scala.collection.immutable.Map))​([ContentDispositionType](ContentDispositionType.html "interface in akka.http.scaladsl.model.headers") dispositionType,  scala.collection.immutable.Map<java.lang.String,​java.lang.String> params)` |  |
	...
	| `protected [Content$minusDisposition$](Content$minusDisposition$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `[ContentDispositionType](ContentDispositionType.html "interface in akka.http.scaladsl.model.headers")` | `[dispositionType](#dispositionType())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[ContentDisposition](../../../javadsl/model/headers/ContentDisposition.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/ContentDisposition.html#create(akka.http.javadsl.model.headers.ContentDispositionType,java.util.Map))`
...
- - ### Constructor Detail
		...
		```
		public Content$minusDisposition​([ContentDispositionType](ContentDispositionType.html "interface in akka.http.scaladsl.model.headers") dispositionType,
	...
	- ### Method Detail
		...
		```
		public [ContentDispositionType](ContentDispositionType.html "interface in akka.http.scaladsl.model.headers") dispositionType()
		```
		
		
		Specified by:
		`[dispositionType](../../../javadsl/model/headers/ContentDisposition.html#dispositionType())` in class `[ContentDisposition](../../../javadsl/model/headers/ContentDisposition.html "class in akka.http.javadsl.model.headers")`
		- #### params
		...
		```
		protected [Content$minusDisposition$](Content$minusDisposition$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		Specified by:
		`[getParams](../../../javadsl/model/headers/ContentDisposition.html#getParams())` in class `[ContentDisposition](../../../javadsl/model/headers/ContentDisposition.html "class in akka.http.javadsl.model.headers")`
...
- https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/ContentDispositionType.html
