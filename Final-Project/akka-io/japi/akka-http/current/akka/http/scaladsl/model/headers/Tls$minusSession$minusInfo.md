...
scraped_at: '2026-04-06T00:37:31Z'
section: japi
site: akka-io
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.TlsSessionInfo](../../../javadsl/model/headers/TlsSessionInfo.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.Tls$minusSession$minusInfo

- All Implemented Interfaces:
`[Renderable](../../../impl/util/Renderable.html "interface in akka.http.impl.util")`, `[ToStringRenderable](../../../impl/util/ToStringRenderable.html "interface in akka.http.impl.util")`, `[ModeledHeader](ModeledHeader.html "interface in akka.http.scaladsl.model.headers")`, `[SyntheticHeader](SyntheticHeader.html "interface in akka.http.scaladsl.model.headers")`, `akka.stream.scaladsl.ScalaSessionAPI`, `java.io.Serializable`, `scala.Equals`, `scala.Product`

---

```
public final class Tls$minusSession$minusInfo
extends [TlsSessionInfo](../../../javadsl/model/headers/TlsSessionInfo.html "class in akka.http.javadsl.model.headers")
implements [SyntheticHeader](SyntheticHeader.html "interface in akka.http.scaladsl.model.headers"), akka.stream.scaladsl.ScalaSessionAPI, scala.Product, java.io.Serializable
```
...
- - ### Nested Class Summary
	...
	| `[Tls$minusSession$minusInfo](#%3Cinit%3E(javax.net.ssl.SSLSession))​(javax.net.ssl.SSLSession session)` |  |
	...
	| `protected [Tls$minusSession$minusInfo$](Tls$minusSession$minusInfo$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	...
	| `javax.net.ssl.SSLSession` | `[session](#session())()` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[TlsSessionInfo](../../../javadsl/model/headers/TlsSessionInfo.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/TlsSessionInfo.html#create(javax.net.ssl.SSLSession))`
...
- - ### Constructor Detail
		...
		```
		public Tls$minusSession$minusInfo​(javax.net.ssl.SSLSession session)
		```
	...
	- ### Method Detail
		...
		```
		protected [Tls$minusSession$minusInfo$](Tls$minusSession$minusInfo$.html "class in akka.http.scaladsl.model.headers") companion()
		```
		...
		Specified by:
		`[getSession](../../../javadsl/model/headers/TlsSessionInfo.html#getSession())` in class `[TlsSessionInfo](../../../javadsl/model/headers/TlsSessionInfo.html "class in akka.http.javadsl.model.headers")`
		Returns:
...
- https://doc.akka.io/japi/akka-http/current/akka/http/javadsl/model/headers/TlsSessionInfo.html
