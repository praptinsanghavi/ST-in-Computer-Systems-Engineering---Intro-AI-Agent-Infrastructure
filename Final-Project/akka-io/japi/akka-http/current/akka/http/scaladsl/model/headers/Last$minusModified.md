...
scraped_at: '2026-04-06T00:36:18Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Last$minusModified.html
title: Last$minusModified
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.LastModified](../../../javadsl/model/headers/LastModified.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.Last$minusModified
...
```
public final class Last$minusModified
extends [LastModified](../../../javadsl/model/headers/LastModified.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Last$minusModified)
...
- - ### Nested Class Summary
	...
	| `[Last$minusModified](#%3Cinit%3E(akka.http.scaladsl.model.DateTime))​([DateTime](../DateTime.html "class in akka.http.scaladsl.model") date)` |  |
	...
	| `protected [Last$minusModified$](Last$minusModified$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[LastModified](../../../javadsl/model/headers/LastModified.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/LastModified.html#create(akka.http.javadsl.model.DateTime))`
...
- - ### Constructor Detail
		...
		```
		public Last$minusModified​([DateTime](../DateTime.html "class in akka.http.scaladsl.model") date)
		```
	...
	- ### Method Detail
		...
		Specified by:
		`[date](../../../javadsl/model/headers/LastModified.html#date())` in class `[LastModified](../../../javadsl/model/headers/LastModified.html "class in akka.http.javadsl.model.headers")`
		- #### renderValue
		...
		```
		protected [Last$minusModified$](Last$minusModified$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Last$minusModified.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Last$minusModified.html)*