...
scraped_at: '2026-04-06T00:36:05Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/If$minusNone$minusMatch.html
title: If$minusNone$minusMatch
---
...
- - [akka.http.javadsl.model.HttpHeader](../../../javadsl/model/HttpHeader.html "class in akka.http.javadsl.model")
	- - [akka.http.scaladsl.model.HttpHeader](../HttpHeader.html "class in akka.http.scaladsl.model")
		- - [akka.http.javadsl.model.headers.IfNoneMatch](../../../javadsl/model/headers/IfNoneMatch.html "class in akka.http.javadsl.model.headers")
			- - akka.http.scaladsl.model.headers.If$minusNone$minusMatch
...
```
public final class If$minusNone$minusMatch
extends [IfNoneMatch](../../../javadsl/model/headers/IfNoneMatch.html "class in akka.http.javadsl.model.headers")
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.If$minusNone$minusMatch)
...
- - ### Nested Class Summary
	...
	| `[If$minusNone$minusMatch](#%3Cinit%3E(akka.http.scaladsl.model.headers.EntityTagRange))​([EntityTagRange](EntityTagRange.html "class in akka.http.scaladsl.model.headers") m)` |  |
	...
	| `static [If$minusNone$minusMatch](If$minusNone$minusMatch.html "class in akka.http.scaladsl.model.headers")` | `[apply](#apply(akka.http.scaladsl.model.headers.EntityTag,scala.collection.immutable.Seq))​([EntityTag](EntityTag.html "class in akka.http.scaladsl.model.headers") first,  scala.collection.immutable.Seq<[EntityTag](EntityTag.html "class in akka.http.scaladsl.model.headers")> more)` |  |
	| `protected [If$minusNone$minusMatch$](If$minusNone$minusMatch$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	...
	| `<R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")>[Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")` | `[renderValue](#renderValue(R))​(R r)` |  |
		...
		- ### Methods inherited from class akka.http.javadsl.model.headers.[IfNoneMatch](../../../javadsl/model/headers/IfNoneMatch.html "class in akka.http.javadsl.model.headers")
		
		
		`[create](../../../javadsl/model/headers/IfNoneMatch.html#create(akka.http.javadsl.model.headers.EntityTagRange))`
...
- - ### Constructor Detail
		...
		```
		public If$minusNone$minusMatch​([EntityTagRange](EntityTagRange.html "class in akka.http.scaladsl.model.headers") m)
		```
	...
	- ### Method Detail
		...
		```
		public static [If$minusNone$minusMatch](If$minusNone$minusMatch.html "class in akka.http.scaladsl.model.headers") apply​([EntityTag](EntityTag.html "class in akka.http.scaladsl.model.headers") first,
		...
		Specified by:
		`[m](../../../javadsl/model/headers/IfNoneMatch.html#m())` in class `[IfNoneMatch](../../../javadsl/model/headers/IfNoneMatch.html "class in akka.http.javadsl.model.headers")`
		- #### renderValue
		...
		```
		protected [If$minusNone$minusMatch$](If$minusNone$minusMatch$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/If$minusNone$minusMatch.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/If$minusNone$minusMatch.html)*