...
- - ### Constructor Summary
	...
	| `static akka.stream.scaladsl.Flow<akka.util.ByteString,​[ServerSentEvent](../../model/sse/ServerSentEvent.html "class in akka.http.scaladsl.model.sse"),​akka.NotUsed>` | `[apply](#apply(int,int))​(int maxLineSize,  int maxEventSize)` | Flow that converts raw byte string input into `ServerSentEvent`s. |
	| `static akka.stream.scaladsl.Flow<akka.util.ByteString,​[ServerSentEvent](../../model/sse/ServerSentEvent.html "class in akka.http.scaladsl.model.sse"),​akka.NotUsed>` | `[apply](#apply(int,int,boolean))​(int maxLineSize,  int maxEventSize,  boolean emitEmptyEvents)` | Flow that converts raw byte string input into `ServerSentEvent`s. |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static akka.stream.scaladsl.Flow<akka.util.ByteString,​[ServerSentEvent](../../model/sse/ServerSentEvent.html "class in akka.http.scaladsl.model.sse"),​akka.NotUsed> apply​(int maxLineSize,
		                                                                                                             int maxEventSize)
		```
