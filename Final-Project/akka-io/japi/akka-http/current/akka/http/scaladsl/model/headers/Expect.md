...
- - ### Nested Class Summary
	...
	| `protected [Expect$](Expect$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public final <R extends [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util")> [Rendering](../../../impl/util/Rendering.html "interface in akka.http.impl.util") renderValue​(R r)
		```
		...
		```
		protected [Expect$](Expect$.html "class in akka.http.scaladsl.model.headers") companion()
		```
