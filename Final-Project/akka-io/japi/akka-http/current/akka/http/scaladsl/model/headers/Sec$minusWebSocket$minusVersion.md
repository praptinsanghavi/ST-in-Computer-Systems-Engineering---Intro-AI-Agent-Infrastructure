...
scraped_at: '2026-04-06T00:37:21Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Sec$minusWebSocket$minusVersion.html
title: Sec$minusWebSocket$minusVersion
---
...
## Class Sec$minusWebSocket$minusVersion
...
```
public final class Sec$minusWebSocket$minusVersion
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.http.scaladsl.model.headers.Sec$minusWebSocket$minusVersion)
...
- - ### Nested Class Summary
	...
	| `[Sec$minusWebSocket$minusVersion](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<java.lang.Object> versions)` |  |
	...
	| `protected [Sec$minusWebSocket$minusVersion$](Sec$minusWebSocket$minusVersion$.html "class in akka.http.scaladsl.model.headers")` | `[companion](#companion())()` |  |
	| `boolean` | `[hasVersion](#hasVersion(int))​(int versionNumber)` |  |
	...
	| `scala.collection.immutable.Seq<java.lang.Object>` | `[versions](#versions())()` |  |
	| `static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<java.lang.Object>>` | `[versionsRenderer](#versionsRenderer())()` |  |
...
- - ### Constructor Detail
		...
		```
		public Sec$minusWebSocket$minusVersion​(scala.collection.immutable.Seq<java.lang.Object> versions)
		```
	...
	- ### Method Detail
		...
		```
		public static [Renderer](../../../impl/util/Renderer.html "interface in akka.http.impl.util")<scala.collection.immutable.Iterable<java.lang.Object>> versionsRenderer()
		```
		- #### name
		...
		```
		public scala.collection.immutable.Seq<java.lang.Object> versions()
		```
		- #### renderValue
		...
		```
		protected [Sec$minusWebSocket$minusVersion$](Sec$minusWebSocket$minusVersion$.html "class in akka.http.scaladsl.model.headers") companion()
		```
...
---
*Source: [https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Sec$minusWebSocket$minusVersion.html](https://doc.akka.io/japi/akka-http/current/akka/http/scaladsl/model/headers/Sec$minusWebSocket$minusVersion.html)*