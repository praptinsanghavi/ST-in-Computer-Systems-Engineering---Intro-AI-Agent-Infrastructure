...
scraped_at: '2026-04-06T15:49:07Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.10.17/akka/persistence/typed/internal/ReplayOnlyLastRecovery$.html
...
See Also:
[Serialized Form](../../../../serialized-form.html#akka.persistence.typed.internal.ReplayOnlyLastRecovery$)
...
- - ### Field Summary
	...
	| `static [ReplayOnlyLastRecovery$](ReplayOnlyLastRecovery$.html "class in akka.persistence.typed.internal")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [ReplayOnlyLastRecovery$](ReplayOnlyLastRecovery$.html "class in akka.persistence.typed.internal") MODULE$
		```
...
---
*Source: [https://doc.akka.io/japi/akka-core/2.10.17/akka/persistence/typed/internal/ReplayOnlyLastRecovery$.html](https://doc.akka.io/japi/akka-core/2.10.17/akka/persistence/typed/internal/ReplayOnlyLastRecovery$.html)*