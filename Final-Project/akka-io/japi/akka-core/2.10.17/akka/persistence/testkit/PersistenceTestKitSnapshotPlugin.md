...
scraped_at: '2026-04-06T15:13:59Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.10.17/akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html
title: PersistenceTestKitSnapshotPlugin
---
...
`[Actor](../../actor/Actor.html "interface in akka.actor")`, `[ActorLogging](../../actor/ActorLogging.html "interface in akka.actor")`, `[SnapshotStore](../snapshot/SnapshotStore.html "interface in akka.persistence.snapshot")`
...
implements [SnapshotStore](../snapshot/SnapshotStore.html "interface in akka.persistence.snapshot")
```
...
- - ### Nested Class Summary
	...
	| `[PersistenceTestKitSnapshotPlugin](#%3Cinit%3E())()` |  |
	...
	| `static [PersistenceTestKitSnapshotPlugin$](PersistenceTestKitSnapshotPlugin$.html "class in akka.persistence.testkit")` | `[getInstance](#getInstance())()` |  |
	...
	| `[ActorRef](../../actor/ActorRef.html "class in akka.actor")` | `[self](#self())()` | The 'self' field holds the ActorRef for this actor. |
		...
		- ### Methods inherited from interface akka.persistence.snapshot.[SnapshotStore](../snapshot/SnapshotStore.html "interface in akka.persistence.snapshot")
		
		
		`[receive](../snapshot/SnapshotStore.html#receive()), [receivePluginInternal](../snapshot/SnapshotStore.html#receivePluginInternal()), [senderPersistentActor](../snapshot/SnapshotStore.html#senderPersistentActor()), [tryReceivePluginInternal](../snapshot/SnapshotStore.html#tryReceivePluginInternal(java.lang.Object))`
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [PersistenceTestKitSnapshotPlugin$](PersistenceTestKitSnapshotPlugin$.html "class in akka.persistence.testkit") getInstance()
		```
		- #### config
		...
		Specified by:
		`[receiveSnapshotStore](../snapshot/SnapshotStore.html#receiveSnapshotStore())` in interface `[SnapshotStore](../snapshot/SnapshotStore.html "interface in akka.persistence.snapshot")`
		...
		Specified by:
		`[akka$persistence$snapshot$SnapshotStore$_setter_$receiveSnapshotStore_$eq](../snapshot/SnapshotStore.html#akka$persistence$snapshot$SnapshotStore$_setter_$receiveSnapshotStore_$eq(scala.PartialFunction))` in interface `[SnapshotStore](../snapshot/SnapshotStore.html "interface in akka.persistence.snapshot")`
		- #### context
		...
		Description copied from interface: `[SnapshotStore](../snapshot/SnapshotStore.html#loadAsync(java.lang.String,akka.persistence.SnapshotSelectionCriteria))`
		...
		Specified by:
		`[loadAsync](../snapshot/SnapshotStore.html#loadAsync(java.lang.String,akka.persistence.SnapshotSelectionCriteria))` in interface `[SnapshotStore](../snapshot/SnapshotStore.html "interface in akka.persistence.snapshot")`
		Parameters:
		...
		Description copied from interface: `[SnapshotStore](../snapshot/SnapshotStore.html#saveAsync(akka.persistence.SnapshotMetadata,java.lang.Object))`
		...
		Specified by:
		`[saveAsync](../snapshot/SnapshotStore.html#saveAsync(akka.persistence.SnapshotMetadata,java.lang.Object))` in interface `[SnapshotStore](../snapshot/SnapshotStore.html "interface in akka.persistence.snapshot")`
		Parameters:
		...
		Description copied from interface: `[SnapshotStore](../snapshot/SnapshotStore.html#deleteAsync(akka.persistence.SnapshotMetadata))`
		...
		Specified by:
		`[deleteAsync](../snapshot/SnapshotStore.html#deleteAsync(akka.persistence.SnapshotMetadata))` in interface `[SnapshotStore](../snapshot/SnapshotStore.html "interface in akka.persistence.snapshot")`
		Parameters:
		`metadata` \- snapshot metadata.
		- #### deleteAsync
		...
		Description copied from interface: `[SnapshotStore](../snapshot/SnapshotStore.html#deleteAsync(java.lang.String,akka.persistence.SnapshotSelectionCriteria))`
		...
		Specified by:
		`[deleteAsync](../snapshot/SnapshotStore.html#deleteAsync(java.lang.String,akka.persistence.SnapshotSelectionCriteria))` in interface `[SnapshotStore](../snapshot/SnapshotStore.html "interface in akka.persistence.snapshot")`
		Parameters:
		`persistenceId` \- id of the persistent actor.
...
- https://doc.akka.io/japi/akka-core/2.10.17/akka/persistence/testkit/PersistenceTestKitSnapshotPlugin$.html
- https://doc.akka.io/japi/akka-core/2.10.17/akka/persistence/testkit/package-summary.html

---
*Source: [https://doc.akka.io/japi/akka-core/2.10.17/akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html](https://doc.akka.io/japi/akka-core/2.10.17/akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html)*