...
scraped_at: '2026-04-06T13:34:00Z'
section: japi
site: akka-io
...
- - ### Nested Class Summary
	...
	| `static class` | `[ShardingLogMarker.Properties$](ShardingLogMarker.Properties$.html "class in akka.cluster.sharding")` | INTERNAL API |
	...
	| `static [LogMarker](../../event/LogMarker.html "class in akka.event")` | `[shardAllocated](#shardAllocated(java.lang.String,java.lang.String,akka.actor.Address))​(java.lang.String shardTypeName,  java.lang.String shardId,  [Address](../../actor/Address.html "class in akka.actor") node)` | Marker "akkaShardAllocated" of log event when `ShardCoordinator` allocates a shard to a region. |
	| `static [LogMarker](../../event/LogMarker.html "class in akka.event")` | `[shardStarted](#shardStarted(java.lang.String,java.lang.String))​(java.lang.String shardTypeName,  java.lang.String shardId)` | Marker "akkaShardStarted" of log event when `ShardRegion` starts a shard. |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [LogMarker](../../event/LogMarker.html "class in akka.event") shardAllocated​(java.lang.String shardTypeName,
		...
		```
		public static [LogMarker](../../event/LogMarker.html "class in akka.event") shardStarted​(java.lang.String shardTypeName,
		                                     java.lang.String shardId)
		```
...
- https://doc.akka.io/japi/akka-core/2.10.17/akka/cluster/sharding/ShardingLogMarker.Properties$.html
