...
scraped_at: '2026-04-06T15:57:23Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.10.17/akka/actor/typed/scaladsl/Routers$.html
title: Routers$
---
...
- - ### Field Summary
	...
	| `static [Routers$](Routers$.html "class in akka.actor.typed.scaladsl")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `<T> [PoolRouter](PoolRouter.html "interface in akka.actor.typed.scaladsl")<T>` | `[pool](#pool(int,akka.actor.typed.Behavior))​(int poolSize,  [Behavior](../Behavior.html "class in akka.actor.typed")<T> behavior)` | Spawn `poolSize` children with the given `behavior` and forward messages to them using round robin. |
...
- - ### Field Detail
		...
		```
		public static final [Routers$](Routers$.html "class in akka.actor.typed.scaladsl") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public <T> [GroupRouter](GroupRouter.html "interface in akka.actor.typed.scaladsl")<T> group​([ServiceKey](../receptionist/ServiceKey.html "class in akka.actor.typed.receptionist")<T> key)
		```
		...
		```
		public <T> [PoolRouter](PoolRouter.html "interface in akka.actor.typed.scaladsl")<T> pool​(int poolSize,
...
- https://doc.akka.io/japi/akka-core/2.10.17/akka/actor/typed/scaladsl/PoolRouter.html
...
---
*Source: [https://doc.akka.io/japi/akka-core/2.10.17/akka/actor/typed/scaladsl/Routers$.html](https://doc.akka.io/japi/akka-core/2.10.17/akka/actor/typed/scaladsl/Routers$.html)*