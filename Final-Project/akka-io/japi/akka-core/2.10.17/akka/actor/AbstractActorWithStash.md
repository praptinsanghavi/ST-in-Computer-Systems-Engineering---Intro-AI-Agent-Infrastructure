...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.10.17/akka/actor/AbstractActorWithStash.html
title: AbstractActorWithStash
---
...
```
 ...
 For a `Stash` based actor that enforces unbounded deques see [`AbstractActorWithUnboundedStash`](AbstractActorWithUnboundedStash.html "class in akka.actor").
 There is also an unrestricted version [`AbstractActorWithUnrestrictedStash`](AbstractActorWithUnrestrictedStash.html "class in akka.actor") that does not
...
- - ### Nested Class Summary
	...
	| `[AbstractActorWithStash](#%3Cinit%3E())()` |  |
...
---
*Source: [https://doc.akka.io/japi/akka-core/2.10.17/akka/actor/AbstractActorWithStash.html](https://doc.akka.io/japi/akka-core/2.10.17/akka/actor/AbstractActorWithStash.html)*