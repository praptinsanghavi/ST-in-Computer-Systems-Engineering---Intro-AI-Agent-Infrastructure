...
scraped_at: '2026-04-06T13:12:10Z'
section: japi
site: akka-io
...
- - ### Constructor Summary
	...
	| `static [ForceDisassociateAck$](ForceDisassociateAck$.html "class in akka.remote.testkit")` | `[getInstance](#getInstance())()` | Java API: get the singleton instance |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [ForceDisassociateAck$](ForceDisassociateAck$.html "class in akka.remote.testkit") getInstance()
		```
