...
- - ### Constructor Summary
	...
	| `static [SetThrottleAck$](SetThrottleAck$.html "class in akka.remote.testkit")` | `[getInstance](#getInstance())()` | Java API: get the singleton instance |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [SetThrottleAck$](SetThrottleAck$.html "class in akka.remote.testkit") getInstance()
		```
