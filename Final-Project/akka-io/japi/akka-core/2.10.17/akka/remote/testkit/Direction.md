...
scraped_at: '2026-04-06T13:12:09Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.10.17/akka/remote/testkit/Direction.Send$.html
...
- - ### Nested Class Summary
	...
	| `static [Direction.Send$](Direction.Send$.html "class in akka.remote.testkit")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [Direction.Send$](Direction.Send$.html "class in akka.remote.testkit") MODULE$
		```
...
---
*Source: [https://doc.akka.io/japi/akka-core/2.10.17/akka/remote/testkit/Direction.Send$.html](https://doc.akka.io/japi/akka-core/2.10.17/akka/remote/testkit/Direction.Send$.html)*