...
scraped_at: '2026-04-06T15:55:41Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.10.17/akka/testkit/DebugFilter.html
title: DebugFilter
---
...
- - ### Constructor Summary
	...
	| `[DebugFilter](#%3Cinit%3E(java.lang.String,java.lang.String,boolean,boolean,int))​(java.lang.String source,  java.lang.String message,  boolean pattern,  boolean complete,  int occurrences)` | Java API: create a DebugFilter |
	| `[DebugFilter](#%3Cinit%3E(scala.Option,scala.util.Either,boolean,int))​(scala.Option<java.lang.String> source,  scala.util.Either<java.lang.String,​scala.util.matching.Regex> message,  boolean complete,  int occurrences)` |  |
	...
	| `static [DebugFilter](DebugFilter.html "class in akka.testkit")` | `[apply](#apply(scala.Option,scala.util.Either,boolean,int))​(scala.Option<java.lang.String> source,  scala.util.Either<java.lang.String,​scala.util.matching.Regex> message,  boolean complete,  int occurrences)` |  |
	| `boolean` | `[canEqual](#canEqual(java.lang.Object))​(java.lang.Object x$1)` |  |
	| `boolean` | `[complete](#complete())()` |  |
	| `[DebugFilter](DebugFilter.html "class in akka.testkit")` | `[copy](#copy(scala.Option,scala.util.Either,boolean,int))​(scala.Option<java.lang.String> source,  scala.util.Either<java.lang.String,​scala.util.matching.Regex> message,  boolean complete,  int occurrences)` |  |
	...
	| `static scala.Option<scala.Tuple3<scala.Option<java.lang.String>,​scala.util.Either<java.lang.String,​scala.util.matching.Regex>,​java.lang.Object>>` | `[unapply](#unapply(akka.testkit.DebugFilter))​([DebugFilter](DebugFilter.html "class in akka.testkit") x$0)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [DebugFilter](DebugFilter.html "class in akka.testkit") apply​(scala.Option<java.lang.String> source,
		                                scala.util.Either<java.lang.String,​scala.util.matching.Regex> message,
		                                boolean complete,
		                                int occurrences)
		```
		...
		```
		public static scala.Option<scala.Tuple3<scala.Option<java.lang.String>,​scala.util.Either<java.lang.String,​scala.util.matching.Regex>,​java.lang.Object>> unapply​([DebugFilter](DebugFilter.html "class in akka.testkit") x$0)
		```
		- #### source
		...
		```
		public [DebugFilter](DebugFilter.html "class in akka.testkit") copy​(scala.Option<java.lang.String> source,
		                        scala.util.Either<java.lang.String,​scala.util.matching.Regex> message,
		                        boolean complete,
		                        int occurrences)
		```
...
---
*Source: [https://doc.akka.io/japi/akka-core/2.10.17/akka/testkit/DebugFilter.html](https://doc.akka.io/japi/akka-core/2.10.17/akka/testkit/DebugFilter.html)*