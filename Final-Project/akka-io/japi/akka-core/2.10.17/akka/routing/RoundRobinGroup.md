...
scraped_at: '2026-04-06T15:53:44Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.10.17/akka/routing/RoundRobinGroup.html
title: RoundRobinGroup
---
...
```
public final class RoundRobinGroup
...
See Also:
[Serialized Form](../../serialized-form.html#akka.routing.RoundRobinGroup)
...
- - ### Constructor Summary
	...
	| `[RoundRobinGroup](#%3Cinit%3E(com.typesafe.config.Config))​(com.typesafe.config.Config config)` |  |
	| `[RoundRobinGroup](#%3Cinit%3E(java.lang.Iterable))​(java.lang.Iterable<java.lang.String> routeePaths)` | Java API |
	| `[RoundRobinGroup](#%3Cinit%3E(scala.collection.immutable.Iterable,java.lang.String))​(scala.collection.immutable.Iterable<java.lang.String> paths,  java.lang.String routerDispatcher)` |  |
	...
	| `static [RoundRobinGroup](RoundRobinGroup.html "class in akka.routing")` | `[apply](#apply(scala.collection.immutable.Iterable,java.lang.String))​(scala.collection.immutable.Iterable<java.lang.String> paths,  java.lang.String routerDispatcher)` |  |
	| `static java.lang.String` | `[apply$default$2](#apply$default$2())()` |  |
	| `boolean` | `[canEqual](#canEqual(java.lang.Object))​(java.lang.Object x$1)` |  |
	| `[RoundRobinGroup](RoundRobinGroup.html "class in akka.routing")` | `[copy](#copy(scala.collection.immutable.Iterable,java.lang.String))​(scala.collection.immutable.Iterable<java.lang.String> paths,  java.lang.String routerDispatcher)` |  |
	...
	| `static scala.Option<scala.Tuple2<scala.collection.immutable.Iterable<java.lang.String>,​java.lang.String>>` | `[unapply](#unapply(akka.routing.RoundRobinGroup))​([RoundRobinGroup](RoundRobinGroup.html "class in akka.routing") x$0)` |  |
	| `[RoundRobinGroup](RoundRobinGroup.html "class in akka.routing")` | `[withDispatcher](#withDispatcher(java.lang.String))​(java.lang.String dispatcherId)` | Setting the dispatcher to be used for the router head actor, which handles  router management messages |
...
- - ### Constructor Detail
		...
		```
		public RoundRobinGroup​(scala.collection.immutable.Iterable<java.lang.String> paths,
		...
		```
		public RoundRobinGroup​(com.typesafe.config.Config config)
		```
		- #### RoundRobinGroup
		...
		```
		public RoundRobinGroup​(java.lang.Iterable<java.lang.String> routeePaths)
		```
	...
	- ### Method Detail
		...
		```
		public static [RoundRobinGroup](RoundRobinGroup.html "class in akka.routing") apply​(scala.collection.immutable.Iterable<java.lang.String> paths,
		                                    java.lang.String routerDispatcher)
		```
		- #### apply$default$2
		...
		```
		public static scala.Option<scala.Tuple2<scala.collection.immutable.Iterable<java.lang.String>,​java.lang.String>> unapply​([RoundRobinGroup](RoundRobinGroup.html "class in akka.routing") x$0)
		```
		- #### paths
		...
		```
		public [RoundRobinGroup](RoundRobinGroup.html "class in akka.routing") withDispatcher​(java.lang.String dispatcherId)
		```
		...
		```
		public [RoundRobinGroup](RoundRobinGroup.html "class in akka.routing") copy​(scala.collection.immutable.Iterable<java.lang.String> paths,
		                            java.lang.String routerDispatcher)
		```
		- #### copy$default$1
...
- https://doc.akka.io/japi/akka-core/2.10.17/akka/routing/RoundRobinGroup.html
...
---
*Source: [https://doc.akka.io/japi/akka-core/2.10.17/akka/routing/RoundRobinGroup.html](https://doc.akka.io/japi/akka-core/2.10.17/akka/routing/RoundRobinGroup.html)*