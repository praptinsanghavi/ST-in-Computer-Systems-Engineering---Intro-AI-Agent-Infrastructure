...
scraped_at: '2026-04-06T15:53:03Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.10.17/akka/routing/ConsistentHashingPool.html
...
`[Pool](Pool.html "interface in akka.routing")`, `[PoolOverrideUnsetConfig](PoolOverrideUnsetConfig.html "interface in akka.routing")<[ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing")>`, `[RouterConfig](RouterConfig.html "interface in akka.routing")`, `java.io.Serializable`, `scala.Equals`, `scala.Product`
...
implements [Pool](Pool.html "interface in akka.routing"), [PoolOverrideUnsetConfig](PoolOverrideUnsetConfig.html "interface in akka.routing")<[ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing")>, scala.Product, java.io.Serializable
```

A router pool that uses consistent hashing to select a routee based on the
 sent message. The selection is described in [`ConsistentHashingRoutingLogic`](ConsistentHashingRoutingLogic.html "class in akka.routing").
...
# Supervision Setup
 ...
 param: virtualNodesFactor number of virtual nodes per node, used in [`ConsistentHash`](ConsistentHash.html "class in akka.routing")
...
- - ### Constructor Summary
	...
	| `static scala.PartialFunction<java.lang.Object,​java.lang.Object>` | `[$lessinit$greater$default$4](#$lessinit$greater$default$4())()` |  |
	...
	| `static [ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing")` | `[apply](#apply(int,scala.Option,int,scala.PartialFunction,akka.actor.SupervisorStrategy,java.lang.String,boolean))​(int nrOfInstances,  scala.Option<[Resizer](Resizer.html "interface in akka.routing")> resizer,  int virtualNodesFactor,  scala.PartialFunction<java.lang.Object,​java.lang.Object> hashMapping,  [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") supervisorStrategy,  java.lang.String routerDispatcher,  boolean usePoolDispatcher)` |  |
	...
	| `static scala.PartialFunction<java.lang.Object,​java.lang.Object>` | `[apply$default$4](#apply$default$4())()` |  |
	...
	| `[ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing")` | `[copy](#copy(int,scala.Option,int,scala.PartialFunction,akka.actor.SupervisorStrategy,java.lang.String,boolean))​(int nrOfInstances,  scala.Option<[Resizer](Resizer.html "interface in akka.routing")> resizer,  int virtualNodesFactor,  scala.PartialFunction<java.lang.Object,​java.lang.Object> hashMapping,  [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") supervisorStrategy,  java.lang.String routerDispatcher,  boolean usePoolDispatcher)` |  |
	...
	| `scala.PartialFunction<java.lang.Object,​java.lang.Object>` | `[copy$default$4](#copy$default$4())()` |  |
	...
	| `[ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing")` | `[withDispatcher](#withDispatcher(java.lang.String))​(java.lang.String dispatcherId)` | Setting the dispatcher to be used for the router head actor, which handles  supervision, death watch and router management messages. |
	...
	| `[ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing")` | `[withHashMapper](#withHashMapper(akka.routing.ConsistentHashingRouter.ConsistentHashMapper))​([ConsistentHashingRouter.ConsistentHashMapper](ConsistentHashingRouter.ConsistentHashMapper.html "interface in akka.routing") mapper)` | Java API: Setting the mapping from message to the data to use for the consistent hash key. |
	| `[ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing")` | `[withResizer](#withResizer(akka.routing.Resizer))​([Resizer](Resizer.html "interface in akka.routing") resizer)` | Setting the resizer to be used. |
	| `[ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing")` | `[withSupervisorStrategy](#withSupervisorStrategy(akka.actor.SupervisorStrategy))​([SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") strategy)` | Setting the supervisor strategy to be used for the \&ldquo;head\&rdquo; Router actor. |
	| `[ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing")` | `[withVirtualNodesFactor](#withVirtualNodesFactor(int))​(int vnodes)` | Setting the number of virtual nodes per node, used in [`ConsistentHash`](ConsistentHash.html "class in akka.routing") |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing") apply​(int nrOfInstances,
		                                          scala.Option<[Resizer](Resizer.html "interface in akka.routing")> resizer,
		                                          int virtualNodesFactor,
		                                          scala.PartialFunction<java.lang.Object,​java.lang.Object> hashMapping,
		                                          [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") supervisorStrategy,
		...
		```
		public [ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing") withSupervisorStrategy​([SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") strategy)
		```
		
		Setting the supervisor strategy to be used for the \&ldquo;head\&rdquo; Router actor.
		
		Specified by:
		`[withSupervisorStrategy](PoolOverrideUnsetConfig.html#withSupervisorStrategy(akka.actor.SupervisorStrategy))` in interface `[PoolOverrideUnsetConfig](PoolOverrideUnsetConfig.html "interface in akka.routing")<[ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing")>`
		- #### withResizer
		
		
		
		```
		public [ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing") withResizer​([Resizer](Resizer.html "interface in akka.routing") resizer)
		```
		
		Setting the resizer to be used.
		
		Specified by:
		`[withResizer](PoolOverrideUnsetConfig.html#withResizer(akka.routing.Resizer))` in interface `[PoolOverrideUnsetConfig](PoolOverrideUnsetConfig.html "interface in akka.routing")<[ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing")>`
		- #### withDispatcher
		
		
		
		```
		public [ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing") withDispatcher​(java.lang.String dispatcherId)
		```
		...
		```
		public [ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing") withVirtualNodesFactor​(int vnodes)
		```
		...
		```
		public [ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing") withHashMapper​([ConsistentHashingRouter.ConsistentHashMapper](ConsistentHashingRouter.ConsistentHashMapper.html "interface in akka.routing") mapper)
		```
		...
		```
		public [ConsistentHashingPool](ConsistentHashingPool.html "class in akka.routing") copy​(int nrOfInstances,
		                                  scala.Option<[Resizer](Resizer.html "interface in akka.routing")> resizer,
		                                  int virtualNodesFactor,
		                                  scala.PartialFunction<java.lang.Object,​java.lang.Object> hashMapping,
		                                  [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") supervisorStrategy,
...
- https://doc.akka.io/japi/akka-core/2.10.17/akka/routing/ConsistentHash.html
- https://doc.akka.io/japi/akka-core/2.10.17/akka/routing/ConsistentHashingPool.html
- https://doc.akka.io/japi/akka-core/2.10.17/akka/routing/ConsistentHashingRouter.ConsistentHashMapper.html
...
---
*Source: [https://doc.akka.io/japi/akka-core/2.10.17/akka/routing/ConsistentHashingPool.html](https://doc.akka.io/japi/akka-core/2.10.17/akka/routing/ConsistentHashingPool.html)*