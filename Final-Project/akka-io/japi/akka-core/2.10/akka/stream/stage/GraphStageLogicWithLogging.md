...
scraped_at: '2026-04-06T02:49:18Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.10/akka/stream/stage/GraphStageLogicWithLogging.html
title: GraphStageLogicWithLogging
---
...
## Class GraphStageLogicWithLogging
...
```
public abstract class GraphStageLogicWithLogging
...
Java API: [`GraphStageLogic`](GraphStageLogic.html "class in akka.stream.stage") with [`StageLogging`](StageLogging.html "interface in akka.stream.stage").
...
- - ### Nested Class Summary
	...
	| `[GraphStageLogicWithLogging](#%3Cinit%3E(akka.stream.Shape))​([Shape](../Shape.html "class in akka.stream") _shape)` |  |
...
- - ### Constructor Detail
		...
		```
		public GraphStageLogicWithLogging​([Shape](../Shape.html "class in akka.stream") _shape)
		```
...
---
*Source: [https://doc.akka.io/japi/akka-core/2.10/akka/stream/stage/GraphStageLogicWithLogging.html](https://doc.akka.io/japi/akka-core/2.10/akka/stream/stage/GraphStageLogicWithLogging.html)*