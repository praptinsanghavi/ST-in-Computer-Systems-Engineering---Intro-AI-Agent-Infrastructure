...
scraped_at: '2026-04-06T16:11:35Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.10/akka/util/Base62.html
title: Base62
---
...
- - ### Nested Class Summary
	...
	| `static class` | `[Base62.Base62EncodingException](Base62.Base62EncodingException.html "class in akka.util")` |  |
	...
	| `static byte[]` | `[decode](#decode(java.lang.String))​(java.lang.String encoded)` | Decode the given encoded string into a byte array. |
	| `static java.lang.String` | `[encode](#encode(byte%5B%5D))​(byte[] raw)` | Encode the given byte array into a string. |
...
---
*Source: [https://doc.akka.io/japi/akka-core/2.10/akka/util/Base62.html](https://doc.akka.io/japi/akka-core/2.10/akka/util/Base62.html)*