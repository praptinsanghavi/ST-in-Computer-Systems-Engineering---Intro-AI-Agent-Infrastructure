...
- - ### Nested Class Summary
	...
	| `static interface` | `[ShardingDirectReplication.Command](ShardingDirectReplication.Command.html "interface in akka.cluster.sharding.typed")` | Not for user extension |
	| `static class` | `[ShardingDirectReplication.VerifyStarted$](ShardingDirectReplication.VerifyStarted$.html "class in akka.cluster.sharding.typed")` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static <T> [Behavior](../../../actor/typed/Behavior.html "class in akka.actor.typed")<[ShardingDirectReplication.Command](ShardingDirectReplication.Command.html "interface in akka.cluster.sharding.typed")> apply​(java.lang.String typeName,
...
- https://doc.akka.io/japi/akka-core/2.10/akka/cluster/sharding/typed/ShardingDirectReplication.VerifyStarted$.html
