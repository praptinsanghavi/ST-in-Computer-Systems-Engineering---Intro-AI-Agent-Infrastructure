...
scraped_at: '2026-04-06T16:11:46Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.10/akka/AkkaVersion$.html
title: AkkaVersion$
---
...
- - ### Field Summary
	...
	| `static [AkkaVersion$](AkkaVersion$.html "class in akka")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [AkkaVersion$](AkkaVersion$.html "class in akka") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public void require​(java.lang.String libraryName,
...
---
*Source: [https://doc.akka.io/japi/akka-core/2.10/akka/AkkaVersion$.html](https://doc.akka.io/japi/akka-core/2.10/akka/AkkaVersion$.html)*