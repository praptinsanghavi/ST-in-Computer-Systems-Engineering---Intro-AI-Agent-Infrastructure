...
scraped_at: '2026-04-06T01:59:17Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.10/akka/actor/typed/internal/receptionist/ServiceKeySerializer.html
title: ServiceKeySerializer
---
...
```
public final class ServiceKeySerializer
...
- - ### Constructor Summary
	...
	| `[ServiceKeySerializer](#%3Cinit%3E(akka.actor.ExtendedActorSystem))​([ExtendedActorSystem](../../../ExtendedActorSystem.html "class in akka.actor") system)` |  |
	...
	| `[ServiceKey](../../receptionist/ServiceKey.html "class in akka.actor.typed.receptionist")<java.lang.Object>` | `[fromBinary](#fromBinary(byte%5B%5D,java.lang.String))​(byte[] bytes,  java.lang.String manifest)` | Produces an object from an array of bytes, with an optional type\-hint. |
	...
	| `[ExtendedActorSystem](../../../ExtendedActorSystem.html "class in akka.actor")` | `[system](#system())()` | Actor system which is required by most serializer implementations. |
...
- - ### Constructor Detail
		...
		```
		public ServiceKeySerializer​([ExtendedActorSystem](../../../ExtendedActorSystem.html "class in akka.actor") system)
		```
	...
	- ### Method Detail
		...
		```
		public [ServiceKey](../../receptionist/ServiceKey.html "class in akka.actor.typed.receptionist")<java.lang.Object> fromBinary​(byte[] bytes,
		...
		```
		public [ExtendedActorSystem](../../../ExtendedActorSystem.html "class in akka.actor") system()
		```
...
- https://doc.akka.io/japi/akka-core/2.10/akka/actor/typed/internal/receptionist/package-summary.html
...
---
*Source: [https://doc.akka.io/japi/akka-core/2.10/akka/actor/typed/internal/receptionist/ServiceKeySerializer.html](https://doc.akka.io/japi/akka-core/2.10/akka/actor/typed/internal/receptionist/ServiceKeySerializer.html)*