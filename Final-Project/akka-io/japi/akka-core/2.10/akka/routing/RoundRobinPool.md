...
scraped_at: '2026-04-05T20:16:54Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.10/akka/routing/RoundRobinPool.html
title: RoundRobinPool
---
...
`[Pool](Pool.html "interface in akka.routing")`, `[PoolOverrideUnsetConfig](PoolOverrideUnsetConfig.html "interface in akka.routing")<[RoundRobinPool](RoundRobinPool.html "class in akka.routing")>`, `[RouterConfig](RouterConfig.html "interface in akka.routing")`, `java.io.Serializable`, `scala.Equals`, `scala.Product`
...
implements [Pool](Pool.html "interface in akka.routing"), [PoolOverrideUnsetConfig](PoolOverrideUnsetConfig.html "interface in akka.routing")<[RoundRobinPool](RoundRobinPool.html "class in akka.routing")>, scala.Product, java.io.Serializable
```
...
See Also:
[Serialized Form](../../serialized-form.html#akka.routing.RoundRobinPool)
...
- - ### Constructor Summary
	...
	| `static [RoundRobinPool](RoundRobinPool.html "class in akka.routing")` | `[apply](#apply(int,scala.Option,akka.actor.SupervisorStrategy,java.lang.String,boolean))​(int nrOfInstances,  scala.Option<[Resizer](Resizer.html "interface in akka.routing")> resizer,  [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") supervisorStrategy,  java.lang.String routerDispatcher,  boolean usePoolDispatcher)` |  |
	...
	| `[RoundRobinPool](RoundRobinPool.html "class in akka.routing")` | `[copy](#copy(int,scala.Option,akka.actor.SupervisorStrategy,java.lang.String,boolean))​(int nrOfInstances,  scala.Option<[Resizer](Resizer.html "interface in akka.routing")> resizer,  [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") supervisorStrategy,  java.lang.String routerDispatcher,  boolean usePoolDispatcher)` |  |
	...
	| `static scala.Option<scala.Tuple5<java.lang.Object,​scala.Option<[Resizer](Resizer.html "interface in akka.routing")>,​[SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor"),​java.lang.String,​java.lang.Object>>` | `[unapply](#unapply(akka.routing.RoundRobinPool))​([RoundRobinPool](RoundRobinPool.html "class in akka.routing") x$0)` |  |
	| `boolean` | `[usePoolDispatcher](#usePoolDispatcher())()` | Use a dedicated dispatcher for the routees of the pool. |
	| `[RoundRobinPool](RoundRobinPool.html "class in akka.routing")` | `[withDispatcher](#withDispatcher(java.lang.String))​(java.lang.String dispatcherId)` | Setting the dispatcher to be used for the router head actor, which handles  supervision, death watch and router management messages. |
	...
	| `[RoundRobinPool](RoundRobinPool.html "class in akka.routing")` | `[withResizer](#withResizer(akka.routing.Resizer))​([Resizer](Resizer.html "interface in akka.routing") resizer)` | Setting the resizer to be used. |
	| `[RoundRobinPool](RoundRobinPool.html "class in akka.routing")` | `[withSupervisorStrategy](#withSupervisorStrategy(akka.actor.SupervisorStrategy))​([SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") strategy)` | Setting the supervisor strategy to be used for the \&ldquo;head\&rdquo; Router actor. |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [RoundRobinPool](RoundRobinPool.html "class in akka.routing") apply​(int nrOfInstances,
		                                   scala.Option<[Resizer](Resizer.html "interface in akka.routing")> resizer,
		                                   [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") supervisorStrategy,
		                                   java.lang.String routerDispatcher,
		                                   boolean usePoolDispatcher)
		...
		```
		public static scala.Option<scala.Tuple5<java.lang.Object,​scala.Option<[Resizer](Resizer.html "interface in akka.routing")>,​[SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor"),​java.lang.String,​java.lang.Object>> unapply​([RoundRobinPool](RoundRobinPool.html "class in akka.routing") x$0)
		```
		- #### nrOfInstances
		...
		```
		public [RoundRobinPool](RoundRobinPool.html "class in akka.routing") withSupervisorStrategy​([SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") strategy)
		```
		
		Setting the supervisor strategy to be used for the \&ldquo;head\&rdquo; Router actor.
		
		Specified by:
		`[withSupervisorStrategy](PoolOverrideUnsetConfig.html#withSupervisorStrategy(akka.actor.SupervisorStrategy))` in interface `[PoolOverrideUnsetConfig](PoolOverrideUnsetConfig.html "interface in akka.routing")<[RoundRobinPool](RoundRobinPool.html "class in akka.routing")>`
		- #### withResizer
		
		
		
		```
		public [RoundRobinPool](RoundRobinPool.html "class in akka.routing") withResizer​([Resizer](Resizer.html "interface in akka.routing") resizer)
		```
		
		Setting the resizer to be used.
		
		Specified by:
		`[withResizer](PoolOverrideUnsetConfig.html#withResizer(akka.routing.Resizer))` in interface `[PoolOverrideUnsetConfig](PoolOverrideUnsetConfig.html "interface in akka.routing")<[RoundRobinPool](RoundRobinPool.html "class in akka.routing")>`
		- #### withDispatcher
		
		
		
		```
		public [RoundRobinPool](RoundRobinPool.html "class in akka.routing") withDispatcher​(java.lang.String dispatcherId)
		```
		...
		```
		public [RoundRobinPool](RoundRobinPool.html "class in akka.routing") copy​(int nrOfInstances,
		                           scala.Option<[Resizer](Resizer.html "interface in akka.routing")> resizer,
		                           [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") supervisorStrategy,
		                           java.lang.String routerDispatcher,
		                           boolean usePoolDispatcher)
...
- https://doc.akka.io/japi/akka-core/2.10/akka/routing/RoundRobinPool.html
...
---
*Source: [https://doc.akka.io/japi/akka-core/2.10/akka/routing/RoundRobinPool.html](https://doc.akka.io/japi/akka-core/2.10/akka/routing/RoundRobinPool.html)*