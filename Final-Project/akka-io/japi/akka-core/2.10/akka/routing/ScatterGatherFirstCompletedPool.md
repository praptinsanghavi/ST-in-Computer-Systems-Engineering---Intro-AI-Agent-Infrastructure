...
scraped_at: '2026-04-05T20:17:00Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.10/akka/routing/ScatterGatherFirstCompletedPool.html
...
`[Pool](Pool.html "interface in akka.routing")`, `[PoolOverrideUnsetConfig](PoolOverrideUnsetConfig.html "interface in akka.routing")<[ScatterGatherFirstCompletedPool](ScatterGatherFirstCompletedPool.html "class in akka.routing")>`, `[RouterConfig](RouterConfig.html "interface in akka.routing")`, `java.io.Serializable`, `scala.Equals`, `scala.Product`

---

```
public final class ScatterGatherFirstCompletedPool
extends java.lang.Object
implements [Pool](Pool.html "interface in akka.routing"), [PoolOverrideUnsetConfig](PoolOverrideUnsetConfig.html "interface in akka.routing")<[ScatterGatherFirstCompletedPool](ScatterGatherFirstCompletedPool.html "class in akka.routing")>, scala.Product, java.io.Serializable
```
...
- - ### Constructor Summary
	...
	| `[ScatterGatherFirstCompletedPool](#%3Cinit%3E(int,java.time.Duration))​(int nr,  java.time.Duration within)` | Java API |
	| `[ScatterGatherFirstCompletedPool](#%3Cinit%3E(int,scala.concurrent.duration.FiniteDuration))​(int nr,  scala.concurrent.duration.FiniteDuration within)` | Java API |
	| `[ScatterGatherFirstCompletedPool](#%3Cinit%3E(int,scala.Option,scala.concurrent.duration.FiniteDuration,akka.actor.SupervisorStrategy,java.lang.String,boolean))​(int nrOfInstances,  scala.Option<[Resizer](Resizer.html "interface in akka.routing")> resizer,  scala.concurrent.duration.FiniteDuration within,  [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") supervisorStrategy,  java.lang.String routerDispatcher,  boolean usePoolDispatcher)` |  |
	| `[ScatterGatherFirstCompletedPool](#%3Cinit%3E(com.typesafe.config.Config))​(com.typesafe.config.Config config)` |  |
	...
	| `static [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor")` | `[$lessinit$greater$default$4](#$lessinit$greater$default$4())()` |  |
	| `static java.lang.String` | `[$lessinit$greater$default$5](#$lessinit$greater$default$5())()` |  |
	| `static boolean` | `[$lessinit$greater$default$6](#$lessinit$greater$default$6())()` |  |
	| `static [ScatterGatherFirstCompletedPool](ScatterGatherFirstCompletedPool.html "class in akka.routing")` | `[apply](#apply(int,scala.Option,scala.concurrent.duration.FiniteDuration,akka.actor.SupervisorStrategy,java.lang.String,boolean))​(int nrOfInstances,  scala.Option<[Resizer](Resizer.html "interface in akka.routing")> resizer,  scala.concurrent.duration.FiniteDuration within,  [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") supervisorStrategy,  java.lang.String routerDispatcher,  boolean usePoolDispatcher)` |  |
	| `static scala.Option<[Resizer](Resizer.html "interface in akka.routing")>` | `[apply$default$2](#apply$default$2())()` |  |
	| `static [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor")` | `[apply$default$4](#apply$default$4())()` |  |
	| `static java.lang.String` | `[apply$default$5](#apply$default$5())()` |  |
	| `static boolean` | `[apply$default$6](#apply$default$6())()` |  |
	| `boolean` | `[canEqual](#canEqual(java.lang.Object))​(java.lang.Object x$1)` |  |
	| `[ScatterGatherFirstCompletedPool](ScatterGatherFirstCompletedPool.html "class in akka.routing")` | `[copy](#copy(int,scala.Option,scala.concurrent.duration.FiniteDuration,akka.actor.SupervisorStrategy,java.lang.String,boolean))​(int nrOfInstances,  scala.Option<[Resizer](Resizer.html "interface in akka.routing")> resizer,  scala.concurrent.duration.FiniteDuration within,  [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") supervisorStrategy,  java.lang.String routerDispatcher,  boolean usePoolDispatcher)` |  |
	...
	| `[SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor")` | `[copy$default$4](#copy$default$4())()` |  |
	...
	| `[ScatterGatherFirstCompletedPool](ScatterGatherFirstCompletedPool.html "class in akka.routing")` | `[withResizer](#withResizer(akka.routing.Resizer))​([Resizer](Resizer.html "interface in akka.routing") resizer)` | Setting the resizer to be used. |
	| `[ScatterGatherFirstCompletedPool](ScatterGatherFirstCompletedPool.html "class in akka.routing")` | `[withSupervisorStrategy](#withSupervisorStrategy(akka.actor.SupervisorStrategy))​([SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") strategy)` | Setting the supervisor strategy to be used for the \&ldquo;head\&rdquo; Router actor. |
...
- - ### Constructor Detail
		...
		```
		public ScatterGatherFirstCompletedPool​(int nr,
		                                       scala.concurrent.duration.FiniteDuration within)
		```
	...
	- ### Method Detail
		...
		```
		public static [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") $lessinit$greater$default$4()
		```
		...
		```
		public static [ScatterGatherFirstCompletedPool](ScatterGatherFirstCompletedPool.html "class in akka.routing") apply​(int nrOfInstances,
		                                                    scala.Option<[Resizer](Resizer.html "interface in akka.routing")> resizer,
		                                                    scala.concurrent.duration.FiniteDuration within,
		                                                    [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") supervisorStrategy,
		                                                    java.lang.String routerDispatcher,
		...
		```
		public static [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") apply$default$4()
		```
		- #### apply$default$5
		...
		```
		public [ScatterGatherFirstCompletedPool](ScatterGatherFirstCompletedPool.html "class in akka.routing") withSupervisorStrategy​([SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") strategy)
		```
		
		Setting the supervisor strategy to be used for the \&ldquo;head\&rdquo; Router actor.
		
		Specified by:
		`[withSupervisorStrategy](PoolOverrideUnsetConfig.html#withSupervisorStrategy(akka.actor.SupervisorStrategy))` in interface `[PoolOverrideUnsetConfig](PoolOverrideUnsetConfig.html "interface in akka.routing")<[ScatterGatherFirstCompletedPool](ScatterGatherFirstCompletedPool.html "class in akka.routing")>`
		- #### withResizer
		
		
		
		```
		public [ScatterGatherFirstCompletedPool](ScatterGatherFirstCompletedPool.html "class in akka.routing") withResizer​([Resizer](Resizer.html "interface in akka.routing") resizer)
		```
		
		Setting the resizer to be used.
		
		Specified by:
		`[withResizer](PoolOverrideUnsetConfig.html#withResizer(akka.routing.Resizer))` in interface `[PoolOverrideUnsetConfig](PoolOverrideUnsetConfig.html "interface in akka.routing")<[ScatterGatherFirstCompletedPool](ScatterGatherFirstCompletedPool.html "class in akka.routing")>`
		- #### withDispatcher
		
		
		
		```
		public [ScatterGatherFirstCompletedPool](ScatterGatherFirstCompletedPool.html "class in akka.routing") withDispatcher​(java.lang.String dispatcherId)
		```
		...
		```
		public [ScatterGatherFirstCompletedPool](ScatterGatherFirstCompletedPool.html "class in akka.routing") copy​(int nrOfInstances,
		                                            scala.Option<[Resizer](Resizer.html "interface in akka.routing")> resizer,
		                                            scala.concurrent.duration.FiniteDuration within,
		                                            [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") supervisorStrategy,
		                                            java.lang.String routerDispatcher,
		...
		```
		public [SupervisorStrategy](../actor/SupervisorStrategy.html "class in akka.actor") copy$default$4()
		```
		- #### copy$default$5
...
- https://doc.akka.io/japi/akka-core/2.10/akka/routing/PoolOverrideUnsetConfig.html
...
- https://doc.akka.io/japi/akka-core/2.10/akka/routing/ScatterGatherFirstCompletedPool.html
- https://doc.akka.io/japi/akka-core/2.10/akka/routing/package-summary.html
- https://doc.akka.io/japi/akka-core/2.10/serialized-form.html

---
*Source: [https://doc.akka.io/japi/akka-core/2.10/akka/routing/ScatterGatherFirstCompletedPool.html](https://doc.akka.io/japi/akka-core/2.10/akka/routing/ScatterGatherFirstCompletedPool.html)*