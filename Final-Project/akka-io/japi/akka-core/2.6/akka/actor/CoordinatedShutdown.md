...
scraped_at: '2026-04-06T14:23:18Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.6/akka/actor/CoordinatedShutdown.html
...
- - ### Nested Class Summary
	...
	| `scala.concurrent.Future<[Done](../Done.html "class in akka")>` | `[run](#run())()` | Deprecated. Use the method with \`reason\` parameter instead. |
	...
	| `java.util.concurrent.CompletionStage<[Done](../Done.html "class in akka")>` | `[run](#run(java.util.Optional))​(java.util.Optional<java.lang.String> fromPhase)` | Deprecated. Use the method with \`reason\` parameter instead. |
	| `scala.concurrent.Future<[Done](../Done.html "class in akka")>` | `[run](#run(scala.Option))​(scala.Option<java.lang.String> fromPhase)` | Deprecated. Use the method with \`reason\` parameter instead. |
	| `java.util.concurrent.CompletionStage<[Done](../Done.html "class in akka")>` | `[runAll](#runAll())()` | Deprecated. Use the method with \`reason\` parameter instead. |
...
- - ### Method Detail
		...
		```
		public scala.concurrent.Future<[Done](../Done.html "class in akka")> run()
		```
		...
		```
		public java.util.concurrent.CompletionStage<[Done](../Done.html "class in akka")> runAll()
		```
		...
		```
		public scala.concurrent.Future<[Done](../Done.html "class in akka")> run​(scala.Option<java.lang.String> fromPhase)
		```
		...
		```
		public java.util.concurrent.CompletionStage<[Done](../Done.html "class in akka")> run​(java.util.Optional<java.lang.String> fromPhase)
		```
...
- https://doc.akka.io/japi/akka-core/2.6/akka/Done.html
...
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/CoordinatedShutdown.ActorSystemTerminateReason$.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/CoordinatedShutdown.ClusterDowningReason$.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/CoordinatedShutdown.ClusterJoinUnsuccessfulReason$.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/CoordinatedShutdown.ClusterLeavingReason$.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/CoordinatedShutdown.IncompatibleConfigurationDetectedReason$.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/CoordinatedShutdown.JvmExitReason$.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/CoordinatedShutdown.Phase$.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/CoordinatedShutdown.PhaseDefinition.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/CoordinatedShutdown.Reason.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/CoordinatedShutdown.UnknownReason$.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/CoordinatedShutdown.html
...
---
*Source: [https://doc.akka.io/japi/akka-core/2.6/akka/actor/CoordinatedShutdown.html](https://doc.akka.io/japi/akka-core/2.6/akka/actor/CoordinatedShutdown.html)*