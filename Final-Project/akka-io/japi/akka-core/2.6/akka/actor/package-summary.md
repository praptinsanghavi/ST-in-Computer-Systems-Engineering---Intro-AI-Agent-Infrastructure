...
scraped_at: '2026-04-06T14:16:11Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.6/akka/actor/package-summary.html
title: akka.actor
---
...
| [TypedActor.PostRestart](TypedActor.PostRestart.html "interface in akka.actor") |  |
| [TypedActor.PostStop](TypedActor.PostStop.html "interface in akka.actor") | Mix this into your TypedActor to be able to hook into its lifecycle |
| [TypedActor.PreRestart](TypedActor.PreRestart.html "interface in akka.actor") | Mix this into your TypedActor to be able to hook into its lifecycle |
| [TypedActor.PreStart](TypedActor.PreStart.html "interface in akka.actor") | Mix this into your TypedActor to be able to hook into its lifecycle |
| [TypedActor.Receiver](TypedActor.Receiver.html "interface in akka.actor") | Mix this into your TypedActor to be able to intercept Terminated messages |
| [TypedActor.Supervisor](TypedActor.Supervisor.html "interface in akka.actor") | Mix this into your TypedActor to be able to define supervisor strategy |
| [TypedActorFactory](TypedActorFactory.html "interface in akka.actor") | Deprecated. Use 'akka.actor.typed' API. |
...
| [ActorCell$](ActorCell$.html "class in akka.actor") | Everything in here is completely Akka PRIVATE. |
...
| [ChildActorPath](ChildActorPath.html "class in akka.actor") |  |
...
| [ContextualTypedActorFactory](ContextualTypedActorFactory.html "class in akka.actor") | ContextualTypedActorFactory allows TypedActors to create children, effectively forming the same Actor Supervision Hierarchies  as normal Actors can. |
| [ContextualTypedActorFactory$](ContextualTypedActorFactory$.html "class in akka.actor") |  |
...
| [TypedActor](TypedActor.html "class in akka.actor") | Deprecated. Use 'akka.actor.typed' API. |
| [TypedActor.MethodCall](TypedActor.MethodCall.html "class in akka.actor") | This class represents a Method call, and has a reference to the Method to be called and the parameters to supply  It's sent to the ActorRef backing the TypedActor and can be serialized and deserialized |
| [TypedActor.MethodCall$](TypedActor.MethodCall$.html "class in akka.actor") |  |
| [TypedActor.SerializedMethodCall$](TypedActor.SerializedMethodCall$.html "class in akka.actor") |  |
| [TypedActor.SerializedTypedActorInvocationHandler$](TypedActor.SerializedTypedActorInvocationHandler$.html "class in akka.actor") |  |
| [TypedActor$](TypedActor$.html "class in akka.actor") | Deprecated. Use 'akka.actor.typed' API. |
| [TypedActorExtension](TypedActorExtension.html "class in akka.actor") |  |
| [TypedProps](TypedProps.html "class in akka.actor")\<T\> |  |
| [TypedProps$](TypedProps$.html "class in akka.actor") | TypedProps is a TypedActor configuration object, that is thread safe and fully sharable. |
...
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/AbstractActorWithTimers.html
...
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/AbstractLoggingActor.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/AbstractLoggingFSM.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/AbstractProps.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/AbstractScheduler.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/AbstractSchedulerBase.html
...
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/ActorCell$.html
...
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/ActorInitializationException.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/ActorInterruptedException.html
...
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/ActorPath.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/ActorPathExtractor$.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/ActorPathExtractor.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/ActorPaths$.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/ActorPaths.html
...
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/ActorRefScope.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/ActorSelection$.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/ActorSelection.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/ActorSelectionMessage$.html
- https://doc.akka.io/japi/akka-core/2.6/akka/actor/ActorSystem$.html

---
*Source: [https://doc.akka.io/japi/akka-core/2.6/akka/actor/package-summary.html](https://doc.akka.io/japi/akka-core/2.6/akka/actor/package-summary.html)*