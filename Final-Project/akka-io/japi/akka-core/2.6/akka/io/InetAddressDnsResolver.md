...
scraped_at: '2026-04-06T14:17:06Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.6/akka/io/InetAddressDnsResolver.html
title: InetAddressDnsResolver
---
...
- - ### Nested Class Summary
	...
	| `[InetAddressDnsResolver](#%3Cinit%3E(akka.io.SimpleDnsCache,com.typesafe.config.Config))​([SimpleDnsCache](SimpleDnsCache.html "class in akka.io") cache,  com.typesafe.config.Config config)` |  |
	...
	| `[CachePolicy$CachePolicy](dns/CachePolicy$CachePolicy.html "interface in akka.io.dns")` | `[negativeCachePolicy](#negativeCachePolicy())()` |  |
	| `long` | `[negativeTtl](#negativeTtl())()` | Deprecated. Use negativeCacheDuration instead. |
	| `[CachePolicy$CachePolicy](dns/CachePolicy$CachePolicy.html "interface in akka.io.dns")` | `[positiveCachePolicy](#positiveCachePolicy())()` |  |
	| `long` | `[positiveTtl](#positiveTtl())()` | Deprecated. Use positiveCacheDuration instead. |
...
- - ### Constructor Detail
		...
		```
		public InetAddressDnsResolver​([SimpleDnsCache](SimpleDnsCache.html "class in akka.io") cache,
	...
	- ### Method Detail
		...
		```
		public [CachePolicy$CachePolicy](dns/CachePolicy$CachePolicy.html "interface in akka.io.dns") negativeCachePolicy()
		```
		- #### negativeTtl
		...
		```
		public [CachePolicy$CachePolicy](dns/CachePolicy$CachePolicy.html "interface in akka.io.dns") positiveCachePolicy()
		```
		- #### positiveTtl
...
- https://doc.akka.io/japi/akka-core/2.6/akka/io/SimpleDnsCache.html
- https://doc.akka.io/japi/akka-core/2.6/akka/io/dns/CachePolicy$CachePolicy.html
- https://doc.akka.io/japi/akka-core/2.6/akka/io/package-summary.html

---
*Source: [https://doc.akka.io/japi/akka-core/2.6/akka/io/InetAddressDnsResolver.html](https://doc.akka.io/japi/akka-core/2.6/akka/io/InetAddressDnsResolver.html)*