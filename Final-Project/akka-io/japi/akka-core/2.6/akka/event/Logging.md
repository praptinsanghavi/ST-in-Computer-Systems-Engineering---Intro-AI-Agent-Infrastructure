...
scraped_at: '2026-04-06T14:17:09Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.6/akka/event/Logging.DefaultLogger.html
title: Logging.DefaultLogger
---
...
`[Actor](../actor/Actor.html "interface in akka.actor")`, `[RequiresMessageQueue](../dispatch/RequiresMessageQueue.html "interface in akka.dispatch")<[LoggerMessageQueueSemantics](LoggerMessageQueueSemantics.html "interface in akka.event")>`, `[Logging.StdOutLogger](Logging.StdOutLogger.html "interface in akka.event")`

Direct Known Subclasses:
`[DefaultOSGiLogger](../osgi/DefaultOSGiLogger.html "class in akka.osgi")`, `[TestEventListener](../testkit/TestEventListener.html "class in akka.testkit")`
...
implements [Actor](../actor/Actor.html "interface in akka.actor"), [Logging.StdOutLogger](Logging.StdOutLogger.html "interface in akka.event"), [RequiresMessageQueue](../dispatch/RequiresMessageQueue.html "interface in akka.dispatch")<[LoggerMessageQueueSemantics](LoggerMessageQueueSemantics.html "interface in akka.event")>
```
...
- - ### Nested Class Summary
	...
	| `[ActorRef](../actor/ActorRef.html "class in akka.actor")` | `[self](#self())()` | The 'self' field holds the ActorRef for this actor. |
		...
		- ### Methods inherited from interface akka.event.[Logging.StdOutLogger](Logging.StdOutLogger.html "interface in akka.event")
		
		
		`[debug](Logging.StdOutLogger.html#debug(akka.event.Logging.Debug)), [error](Logging.StdOutLogger.html#error(akka.event.Logging.Error)), [formatMDC](Logging.StdOutLogger.html#formatMDC(scala.collection.immutable.Map)), [info](Logging.StdOutLogger.html#info(akka.event.Logging.Info)), [print](Logging.StdOutLogger.html#print(java.lang.Object)), [timestamp](Logging.StdOutLogger.html#timestamp(akka.event.Logging.LogEvent)), [warning](Logging.StdOutLogger.html#warning(akka.event.Logging.Warning))`
...
- https://doc.akka.io/japi/akka-core/2.6/akka/event/Logging.html
- https://doc.akka.io/japi/akka-core/2.6/akka/event/package-summary.html
- https://doc.akka.io/japi/akka-core/2.6/akka/osgi/DefaultOSGiLogger.html
- https://doc.akka.io/japi/akka-core/2.6/akka/testkit/TestEventListener.html

---
*Source: [https://doc.akka.io/japi/akka-core/2.6/akka/event/Logging.DefaultLogger.html](https://doc.akka.io/japi/akka-core/2.6/akka/event/Logging.DefaultLogger.html)*