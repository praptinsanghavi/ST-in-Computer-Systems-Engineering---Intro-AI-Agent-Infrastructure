...
scraped_at: '2026-04-06T14:17:29Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.6/akka/event/slf4j/Slf4jLogger.html
title: Slf4jLogger
---
...
`[Actor](../../actor/Actor.html "interface in akka.actor")`, `[RequiresMessageQueue](../../dispatch/RequiresMessageQueue.html "interface in akka.dispatch")<[LoggerMessageQueueSemantics](../LoggerMessageQueueSemantics.html "interface in akka.event")>`, `[SLF4JLogging](SLF4JLogging.html "interface in akka.event.slf4j")`
...
implements [Actor](../../actor/Actor.html "interface in akka.actor"), [SLF4JLogging](SLF4JLogging.html "interface in akka.event.slf4j"), [RequiresMessageQueue](../../dispatch/RequiresMessageQueue.html "interface in akka.dispatch")<[LoggerMessageQueueSemantics](../LoggerMessageQueueSemantics.html "interface in akka.event")>
```
...
- - ### Nested Class Summary
	...
	| `java.lang.String` | `[akkaUid](#akkaUid())()` |  |
	...
	| `protected java.lang.String` | `[formatTimestamp](#formatTimestamp(long))​(long timestamp)` | Override this method to provide a differently formatted timestamp |
	| `org.slf4j.Logger` | `[log](#log())()` |  |
	| `java.lang.String` | `[mdcActorSystemAttributeName](#mdcActorSystemAttributeName())()` |  |
	| `java.lang.String` | `[mdcAkkaAddressAttributeName](#mdcAkkaAddressAttributeName())()` |  |
	| `java.lang.String` | `[mdcAkkaSourceAttributeName](#mdcAkkaSourceAttributeName())()` |  |
	| `java.lang.String` | `[mdcAkkaTimestamp](#mdcAkkaTimestamp())()` |  |
	| `java.lang.String` | `[mdcAkkaUidAttributeName](#mdcAkkaUidAttributeName())()` |  |
	| `java.lang.String` | `[mdcThreadAttributeName](#mdcThreadAttributeName())()` |  |
	...
	| `void` | `[withMdc](#withMdc(java.lang.String,akka.event.Logging.LogEvent,scala.Function0))​(java.lang.String logSource,  [Logging.LogEvent](../Logging.LogEvent.html "interface in akka.event") logEvent,  scala.Function0<scala.runtime.BoxedUnit> logStatement)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		Specified by:
		`[log](SLF4JLogging.html#log())` in interface `[SLF4JLogging](SLF4JLogging.html "interface in akka.event.slf4j")`
		...
		public final void withMdc​(java.lang.String logSource,
		                          [Logging.LogEvent](../Logging.LogEvent.html "interface in akka.event") logEvent,
...
- https://doc.akka.io/japi/akka-core/2.6/akka/event/slf4j/SLF4JLogging.html
- https://doc.akka.io/japi/akka-core/2.6/akka/event/slf4j/package-summary.html

---
*Source: [https://doc.akka.io/japi/akka-core/2.6/akka/event/slf4j/Slf4jLogger.html](https://doc.akka.io/japi/akka-core/2.6/akka/event/slf4j/Slf4jLogger.html)*