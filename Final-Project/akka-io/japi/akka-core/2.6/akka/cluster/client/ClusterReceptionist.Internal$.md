...
scraped_at: '2026-04-06T14:17:00Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.6/akka/cluster/client/ClusterReceptionist.Internal$.ClientResponseTunnel.html
title: ClusterReceptionist.Internal$.ClientResponseTunnel
---
...
- java.lang.Object
- - akka.cluster.client.ClusterReceptionist.Internal$.ClientResponseTunnel

- All Implemented Interfaces:
`[Actor](../../actor/Actor.html "interface in akka.actor")`, `[ActorLogging](../../actor/ActorLogging.html "interface in akka.actor")`

Enclosing class:
[ClusterReceptionist.Internal$](ClusterReceptionist.Internal$.html "class in akka.cluster.client")

---

```
public class ClusterReceptionist.Internal$.ClientResponseTunnel
...
- - ### Nested Class Summary
	...
	| `[ClientResponseTunnel](#%3Cinit%3E(akka.actor.ActorRef,scala.concurrent.duration.FiniteDuration))​([ActorRef](../../actor/ActorRef.html "class in akka.actor") client,  scala.concurrent.duration.FiniteDuration timeout)` |  |
...
- - ### Constructor Detail
		...
		- #### ClientResponseTunnel
		
		
		
		```
		public ClientResponseTunnel​([ActorRef](../../actor/ActorRef.html "class in akka.actor") client,
...
---
*Source: [https://doc.akka.io/japi/akka-core/2.6/akka/cluster/client/ClusterReceptionist.Internal$.ClientResponseTunnel.html](https://doc.akka.io/japi/akka-core/2.6/akka/cluster/client/ClusterReceptionist.Internal$.ClientResponseTunnel.html)*