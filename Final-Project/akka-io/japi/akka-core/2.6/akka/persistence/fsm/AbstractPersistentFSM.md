...
scraped_at: '2026-04-06T14:16:51Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.6/akka/persistence/fsm/AbstractPersistentFSM.html
title: AbstractPersistentFSM
---
...
## Class AbstractPersistentFSM\<S extends [PersistentFSM.FSMState](PersistentFSM.FSMState.html "interface in akka.persistence.fsm"),​D,​E\>
...
```
public abstract class AbstractPersistentFSM<S extends [PersistentFSM.FSMState](PersistentFSM.FSMState.html "interface in akka.persistence.fsm"),​D,​E>
extends [AbstractPersistentFSMBase](AbstractPersistentFSMBase.html "class in akka.persistence.fsm")<S,​D,​E>
implements [PersistentFSM](PersistentFSM.html "interface in akka.persistence.fsm")<S,​D,​E>
```
...
- - ### Nested Class Summary
	...
	| `[AbstractPersistentFSM](#%3Cinit%3E())()` | Deprecated. |
	...
	| `protected void` | `[akka$persistence$fsm$PersistentFSM$_setter_$domainEventTag_$eq](#akka$persistence$fsm$PersistentFSM$_setter_$domainEventTag_$eq(scala.reflect.ClassTag))​(scala.reflect.ClassTag<[E](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")> x$1)` | Deprecated. Domain event's `ClassTag`  Used for identifying domain events during recovery |
	| `abstract java.lang.Class<[E](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")>` | `[domainEventClass](#domainEventClass())()` | Deprecated. Domain event's `Class`  Used for identifying domain events during recovery |
	| `scala.reflect.ClassTag<[E](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")>` | `[domainEventClassTag](#domainEventClassTag())()` | Deprecated. Adapter from Java `Class` to `ClassTag` |
	| `scala.reflect.ClassTag<[E](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")>` | `[domainEventTag](#domainEventTag())()` | Deprecated. Domain event's `ClassTag`  Used for identifying domain events during recovery |
	| `scala.Function1<[D](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM"),​scala.runtime.BoxedUnit>` | `[exec](#exec(java.util.function.Consumer))​(java.util.function.Consumer<[D](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")> action)` | Deprecated. Adapter from Java 8 Functional Interface to Scala Function |
	...
	| `scala.collection.immutable.Map<java.lang.String,​[S](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")>` | `[statesMap](#statesMap())()` | Deprecated. Map from state identifier to state instance |
		...
		`[defer](../PersistentActor.html#defer(A,scala.Function1)), [deferAsync](../PersistentActor.html#deferAsync(A,scala.Function1)), [persist](../PersistentActor.html#persist(A,scala.Function1)), [persistAll](../PersistentActor.html#persistAll(scala.collection.immutable.Seq,scala.Function1)), [persistAllAsync](../PersistentActor.html#persistAllAsync(scala.collection.immutable.Seq,scala.Function1)), [persistAsync](../PersistentActor.html#persistAsync(A,scala.Function1))`
		- ### Methods inherited from interface akka.persistence.fsm.[PersistentFSM](PersistentFSM.html "interface in akka.persistence.fsm")
		
		
		`[applyEvent](PersistentFSM.html#applyEvent(E,D)), [applyState](PersistentFSM.html#applyState(akka.persistence.fsm.PersistentFSM.State)), [currentStateTimeout_$eq](PersistentFSM.html#currentStateTimeout_$eq(scala.Option)), [onRecoveryCompleted](PersistentFSM.html#onRecoveryCompleted()), [receiveCommand](PersistentFSM.html#receiveCommand()), [receiveRecover](PersistentFSM.html#receiveRecover()), [saveStateSnapshot](PersistentFSM.html#saveStateSnapshot()), [super$applyState](PersistentFSM.html#super$applyState(akka.persistence.fsm.PersistentFSM.State))`
		...
		`[preRestart](../../actor/UnrestrictedStash.html#preRestart(java.lang.Throwable,scala.Option)), [super$postStop](../../actor/UnrestrictedStash.html#super$postStop()), [super$preRestart](../../actor/UnrestrictedStash.html#super$preRestart(java.lang.Throwable,scala.Option))`
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		protected void akka$persistence$fsm$PersistentFSM$_setter_$domainEventTag_$eq​(scala.reflect.ClassTag<[E](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")> x$1)
		```
		
		Deprecated.
		Description copied from interface: `[PersistentFSM](PersistentFSM.html#akka$persistence$fsm$PersistentFSM$_setter_$domainEventTag_$eq(scala.reflect.ClassTag))`
		Domain event's `ClassTag`
		 Used for identifying domain events during recovery
		
		Specified by:
		`[akka$persistence$fsm$PersistentFSM$_setter_$domainEventTag_$eq](PersistentFSM.html#akka$persistence$fsm$PersistentFSM$_setter_$domainEventTag_$eq(scala.reflect.ClassTag))` in interface `[PersistentFSM](PersistentFSM.html "interface in akka.persistence.fsm")<[S](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM") extends [PersistentFSM.FSMState](PersistentFSM.FSMState.html "interface in akka.persistence.fsm"),​[D](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM"),​[E](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")>`
		- #### domainEventClass
		
		
		
		```
		public abstract java.lang.Class<[E](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")> domainEventClass()
		```
		...
		```
		public final scala.reflect.ClassTag<[E](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")> domainEventClassTag()
		```
		...
		Specified by:
		`[domainEventClassTag](PersistentFSM.html#domainEventClassTag())` in interface `[PersistentFSM](PersistentFSM.html "interface in akka.persistence.fsm")<[S](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM") extends [PersistentFSM.FSMState](PersistentFSM.FSMState.html "interface in akka.persistence.fsm"),​[D](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM"),​[E](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")>`
		Returns:
		domain event `ClassTag`
		- #### domainEventTag
		
		
		
		```
		public scala.reflect.ClassTag<[E](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")> domainEventTag()
		```
		
		Deprecated.
		Description copied from interface: `[PersistentFSM](PersistentFSM.html#domainEventTag())`
		Domain event's `ClassTag`
		 Used for identifying domain events during recovery
		
		Specified by:
		`[domainEventTag](PersistentFSM.html#domainEventTag())` in interface `[PersistentFSM](PersistentFSM.html "interface in akka.persistence.fsm")<[S](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM") extends [PersistentFSM.FSMState](PersistentFSM.FSMState.html "interface in akka.persistence.fsm"),​[D](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM"),​[E](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")>`
		- #### exec
		
		
		
		```
		public final scala.Function1<[D](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM"),​scala.runtime.BoxedUnit> exec​(java.util.function.Consumer<[D](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")> action)
		```
		...
		Specified by:
		`[postStop](PersistentFSMBase.html#postStop())` in interface `[PersistentFSMBase](PersistentFSMBase.html "interface in akka.persistence.fsm")<[S](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM") extends [PersistentFSM.FSMState](PersistentFSM.FSMState.html "interface in akka.persistence.fsm"),​[D](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM"),​[E](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")>`
		Specified by:
		`[postStop](../../actor/UnrestrictedStash.html#postStop())` in interface `[UnrestrictedStash](../../actor/UnrestrictedStash.html "interface in akka.actor")`
		Throws:
		`java.lang.Exception`
		- #### receive
		...
		Specified by:
		`[receive](../PersistentActor.html#receive())` in interface `[PersistentActor](../PersistentActor.html "interface in akka.persistence")`
		Specified by:
		`[receive](PersistentFSMBase.html#receive())` in interface `[PersistentFSMBase](PersistentFSMBase.html "interface in akka.persistence.fsm")<[S](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM") extends [PersistentFSM.FSMState](PersistentFSM.FSMState.html "interface in akka.persistence.fsm"),​[D](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM"),​[E](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")>`
		- #### snapshotStore
		...
		```
		public scala.collection.immutable.Map<java.lang.String,​[S](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")> statesMap()
		```
		
		Deprecated.
		Description copied from interface: `[PersistentFSM](PersistentFSM.html#statesMap())`
		Map from state identifier to state instance
		
		Specified by:
		`[statesMap](PersistentFSM.html#statesMap())` in interface `[PersistentFSM](PersistentFSM.html "interface in akka.persistence.fsm")<[S](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM") extends [PersistentFSM.FSMState](PersistentFSM.FSMState.html "interface in akka.persistence.fsm"),​[D](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM"),​[E](AbstractPersistentFSM.html "type parameter in AbstractPersistentFSM")>`
...
---
*Source: [https://doc.akka.io/japi/akka-core/2.6/akka/persistence/fsm/AbstractPersistentFSM.html](https://doc.akka.io/japi/akka-core/2.6/akka/persistence/fsm/AbstractPersistentFSM.html)*