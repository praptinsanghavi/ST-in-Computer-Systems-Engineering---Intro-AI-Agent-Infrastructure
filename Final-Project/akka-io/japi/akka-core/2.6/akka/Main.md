...
scraped_at: '2026-04-06T14:17:12Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/2.6/akka/Main.Terminator.html
title: Main.Terminator
---
...
Enclosing class:
[Main](Main.html "class in akka")

---

```
public static class Main.Terminator
...
- - ### Nested Class Summary
	...
	| `[Terminator](#%3Cinit%3E(akka.actor.ActorRef))​([ActorRef](actor/ActorRef.html "class in akka.actor") app)` |  |
...
- - ### Constructor Detail
		...
		```
		public Terminator​([ActorRef](actor/ActorRef.html "class in akka.actor") app)
		```
...
- https://doc.akka.io/japi/akka-core/2.6/akka/Main.html
...
- https://doc.akka.io/japi/akka-core/2.6/akka/package-summary.html

---
*Source: [https://doc.akka.io/japi/akka-core/2.6/akka/Main.Terminator.html](https://doc.akka.io/japi/akka-core/2.6/akka/Main.Terminator.html)*