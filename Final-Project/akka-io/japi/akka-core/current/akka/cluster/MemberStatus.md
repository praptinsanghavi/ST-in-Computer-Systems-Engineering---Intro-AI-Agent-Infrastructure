...
scraped_at: '2026-04-06T13:52:52Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka-core/current/akka/cluster/MemberStatus.Up$.html
title: MemberStatus.Up$
---
...
```
public static class MemberStatus.Up$
extends [MemberStatus](MemberStatus.html "class in akka.cluster")
implements scala.Product, java.io.Serializable
```

See Also:
[Serialized Form](../../serialized-form.html#akka.cluster.MemberStatus.Up$)
...
- - ### Nested Class Summary
	...
	| `static [MemberStatus.Up$](MemberStatus.Up$.html "class in akka.cluster")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [MemberStatus.Up$](MemberStatus.Up$.html "class in akka.cluster") MODULE$
		```
...
- https://doc.akka.io/japi/akka-core/current/akka/cluster/MemberStatus.Down$.html
- https://doc.akka.io/japi/akka-core/current/akka/cluster/MemberStatus.Exiting$.html
- https://doc.akka.io/japi/akka-core/current/akka/cluster/MemberStatus.Joining$.html
- https://doc.akka.io/japi/akka-core/current/akka/cluster/MemberStatus.Leaving$.html
- https://doc.akka.io/japi/akka-core/current/akka/cluster/MemberStatus.PreparingForShutdown$.html
- https://doc.akka.io/japi/akka-core/current/akka/cluster/MemberStatus.ReadyForShutdown$.html
- https://doc.akka.io/japi/akka-core/current/akka/cluster/MemberStatus.Removed$.html
- https://doc.akka.io/japi/akka-core/current/akka/cluster/MemberStatus.Up$.html
- https://doc.akka.io/japi/akka-core/current/akka/cluster/MemberStatus.WeaklyUp$.html
...
---
*Source: [https://doc.akka.io/japi/akka-core/current/akka/cluster/MemberStatus.Up$.html](https://doc.akka.io/japi/akka-core/current/akka/cluster/MemberStatus.Up$.html)*