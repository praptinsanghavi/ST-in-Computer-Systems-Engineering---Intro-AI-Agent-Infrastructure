...
scraped_at: '2026-04-06T03:01:24Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/FileIO.html
title: FileIO
---
...
- - ### Constructor Summary
	...
	| `static [Source](Source.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.util.concurrent.CompletionStage<[IOResult](../IOResult.html "class in akka.stream")>>` | `[fromFile](#fromFile(java.io.File))​(java.io.File f)` | Deprecated. Use \`fromPath\` instead. |
	| `static [Source](Source.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.util.concurrent.CompletionStage<[IOResult](../IOResult.html "class in akka.stream")>>` | `[fromFile](#fromFile(java.io.File,int))​(java.io.File f,  int chunkSize)` | Deprecated. Use \`fromPath\` instead. |
	| `static [Source](Source.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.util.concurrent.CompletionStage<[IOResult](../IOResult.html "class in akka.stream")>>` | `[fromPath](#fromPath(java.nio.file.Path))​(java.nio.file.Path f)` | Creates a Source from a files contents. |
	...
	| `static [Sink](Sink.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.util.concurrent.CompletionStage<[IOResult](../IOResult.html "class in akka.stream")>>` | `[toFile](#toFile(java.io.File))​(java.io.File f)` | Deprecated. Use \`toPath\` instead. |
	| `static <Opt extends java.nio.file.OpenOption>[Sink](Sink.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.util.concurrent.CompletionStage<[IOResult](../IOResult.html "class in akka.stream")>>` | `[toFile](#toFile(java.io.File,java.util.Set))​(java.io.File f,  java.util.Set<Opt> options)` | Deprecated. Use \`toPath\` instead. |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [Sink](Sink.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.util.concurrent.CompletionStage<[IOResult](../IOResult.html "class in akka.stream")>> toFile​(java.io.File f)
		```
		...
		```
		public static [Sink](Sink.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.util.concurrent.CompletionStage<[IOResult](../IOResult.html "class in akka.stream")>> toPath​(java.nio.file.Path f)
		```
		...
		```
		public static <Opt extends java.nio.file.OpenOption> [Sink](Sink.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.util.concurrent.CompletionStage<[IOResult](../IOResult.html "class in akka.stream")>> toFile​(java.io.File f,
		...
		```
		public static <Opt extends java.nio.file.OpenOption> [Sink](Sink.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.util.concurrent.CompletionStage<[IOResult](../IOResult.html "class in akka.stream")>> toPath​(java.nio.file.Path f,
		                                                                                                                                  java.util.Set<Opt> options)
		```
		...
		```
		public static [Source](Source.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.util.concurrent.CompletionStage<[IOResult](../IOResult.html "class in akka.stream")>> fromFile​(java.io.File f)
		```
		...
		```
		public static [Source](Source.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.util.concurrent.CompletionStage<[IOResult](../IOResult.html "class in akka.stream")>> fromPath​(java.nio.file.Path f)
		```
...
- https://doc.akka.io/japi/akka/2.10/akka/stream/ActorAttributes.html
- https://doc.akka.io/japi/akka/2.10/akka/stream/IOResult.html
...
---
*Source: [https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/FileIO.html](https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/FileIO.html)*