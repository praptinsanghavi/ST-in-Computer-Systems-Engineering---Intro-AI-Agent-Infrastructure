...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/StreamConverters$.html
...
- - ### Field Summary
	...
	| `static [StreamConverters$](StreamConverters$.html "class in akka.stream.javadsl")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `[Sink](Sink.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.io.InputStream>` | `[asInputStream](#asInputStream())()` | Creates a Sink which when materialized will return an `InputStream` which it is possible  to read the values produced by the stream this Sink is attached to. |
	...
	| `<T> [Sink](Sink.html "class in akka.stream.javadsl")<T,​java.util.stream.Stream<T>>` | `[asJavaStream](#asJavaStream())()` | Creates a sink which materializes into Java 8 Stream that can be run to trigger demand through the sink. |
...
- - ### Field Detail
		...
		```
		public static final [StreamConverters$](StreamConverters$.html "class in akka.stream.javadsl") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public [Sink](Sink.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.util.concurrent.CompletionStage<[IOResult](../IOResult.html "class in akka.stream")>> fromOutputStream​([Creator](../../japi/function/Creator.html "interface in akka.japi.function")<java.io.OutputStream> f)
		```
		...
		```
		public [Sink](Sink.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.io.InputStream> asInputStream()
		```
		...
		```
		public [Sink](Sink.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.io.InputStream> asInputStream​(java.time.Duration readTimeout)
		```
		...
		```
		public [Source](Source.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.util.concurrent.CompletionStage<[IOResult](../IOResult.html "class in akka.stream")>> fromInputStream​([Creator](../../japi/function/Creator.html "interface in akka.japi.function")<java.io.InputStream> in,
		                                                                                               int chunkSize)
		```
		...
		```
		public [Source](Source.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.io.OutputStream> asOutputStream​(java.time.Duration writeTimeout)
		```
		...
		```
		public [Source](Source.html "class in akka.stream.javadsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.io.OutputStream> asOutputStream()
		```
		...
		```
		public <T> [Sink](Sink.html "class in akka.stream.javadsl")<T,​java.util.stream.Stream<T>> asJavaStream()
		```
		...
		```
		public <T,​R> [Sink](Sink.html "class in akka.stream.javadsl")<T,​java.util.concurrent.CompletionStage<R>> javaCollector​([Creator](../../japi/function/Creator.html "interface in akka.japi.function")<java.util.stream.Collector<T,​?,​R>> collector)
		```
		...
		```
		public <T,​R> [Sink](Sink.html "class in akka.stream.javadsl")<T,​java.util.concurrent.CompletionStage<R>> javaCollectorParallelUnordered​(int parallelism,
...
- https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/StreamConverters$.html
...
---
*Source: [https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/StreamConverters$.html](https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/StreamConverters$.html)*