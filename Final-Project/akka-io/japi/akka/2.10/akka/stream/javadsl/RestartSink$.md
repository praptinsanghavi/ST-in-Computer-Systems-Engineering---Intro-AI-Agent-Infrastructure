...
scraped_at: '2026-04-06T03:01:58Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/RestartSink$.html
title: RestartSink$
---
...
- - ### Field Summary
	...
	| `static [RestartSink$](RestartSink$.html "class in akka.stream.javadsl")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [RestartSink$](RestartSink$.html "class in akka.stream.javadsl") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public <T> [Sink](Sink.html "class in akka.stream.javadsl")<T,​[NotUsed](../../NotUsed.html "class in akka")> withBackoff​(java.time.Duration minBackoff,
		...
		```
		public <T> [Sink](Sink.html "class in akka.stream.javadsl")<T,​[NotUsed](../../NotUsed.html "class in akka")> withBackoff​([RestartSettings](../RestartSettings.html "class in akka.stream") settings,
		                                             [Creator](../../japi/function/Creator.html "interface in akka.japi.function")<[Sink](Sink.html "class in akka.stream.javadsl")<T,​?>> sinkFactory)
		```
...
- https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/RestartSink$.html
...
---
*Source: [https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/RestartSink$.html](https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/RestartSink$.html)*