...
scraped_at: '2026-04-06T03:02:15Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/StreamRefs.html
title: StreamRefs
---
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static <T> [Sink](Sink.html "class in akka.stream.javadsl")<T,​[SourceRef](../SourceRef.html "interface in akka.stream")<T>> sourceRef()
		```
		...
		```
		public static <T> [Source](Source.html "class in akka.stream.javadsl")<T,​[SinkRef](../SinkRef.html "interface in akka.stream")<T>> sinkRef()
		```
...
- https://doc.akka.io/japi/akka/2.10/akka/stream/SourceRef.html
...
---
*Source: [https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/StreamRefs.html](https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/StreamRefs.html)*