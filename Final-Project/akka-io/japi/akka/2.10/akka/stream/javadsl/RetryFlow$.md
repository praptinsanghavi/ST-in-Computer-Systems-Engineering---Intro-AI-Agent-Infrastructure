...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/RetryFlow$.html
title: RetryFlow$
---
...
- - ### Field Detail
		...
		```
		public static final [RetryFlow$](RetryFlow$.html "class in akka.stream.javadsl") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public <In,​Out,​Mat> [Flow](Flow.html "class in akka.stream.javadsl")<In,​Out,​Mat> withBackoff​(java.time.Duration minBackoff,
		...
		```
		public <In,​InCtx,​Out,​OutCtx,​Mat> [FlowWithContext](FlowWithContext.html "class in akka.stream.javadsl")<In,​InCtx,​Out,​OutCtx,​Mat> withBackoffAndContext​(java.time.Duration minBackoff,
		                                                                                                                                                java.time.Duration maxBackoff,
		                                                                                                                                                double randomFactor,
		                                                                                                                                                int maxRetries,
...
- https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/RetryFlow$.html
- https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/package-summary.html

---
*Source: [https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/RetryFlow$.html](https://doc.akka.io/japi/akka/2.10/akka/stream/javadsl/RetryFlow$.html)*