...
- - ### Field Summary
	...
	| `static [BoundedStablePriorityMailbox$](BoundedStablePriorityMailbox$.html "class in akka.dispatch")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `[BoundedStablePriorityMailbox$](#%3Cinit%3E())()` |  |
...
- - ### Field Detail
		...
		```
		public static final [BoundedStablePriorityMailbox$](BoundedStablePriorityMailbox$.html "class in akka.dispatch") MODULE$
		```
	...
	- ### Constructor Detail
		...
		```
		public BoundedStablePriorityMailbox$()
		```
