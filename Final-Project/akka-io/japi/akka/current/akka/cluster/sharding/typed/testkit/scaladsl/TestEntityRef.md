...
scraped_at: '2026-04-05T21:12:22Z'
section: japi
site: akka-io
...
- - ### Constructor Summary
	...
	| `static <M> [EntityRef](../../scaladsl/EntityRef.html "interface in akka.cluster.sharding.typed.scaladsl")<M>` | `[apply](#apply(akka.cluster.sharding.typed.scaladsl.EntityTypeKey,java.lang.String,akka.actor.typed.ActorRef))​([EntityTypeKey](../../scaladsl/EntityTypeKey.html "interface in akka.cluster.sharding.typed.scaladsl")<M> typeKey,  java.lang.String entityId,  [ActorRef](../../../../../actor/typed/ActorRef.html "interface in akka.actor.typed")<M> probe)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static <M> [EntityRef](../../scaladsl/EntityRef.html "interface in akka.cluster.sharding.typed.scaladsl")<M> apply​([EntityTypeKey](../../scaladsl/EntityTypeKey.html "interface in akka.cluster.sharding.typed.scaladsl")<M> typeKey,
