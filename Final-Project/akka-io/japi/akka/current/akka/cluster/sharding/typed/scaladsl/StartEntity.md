...
- - ### Constructor Summary
	...
	| `static <M> [ShardingEnvelope](../ShardingEnvelope.html "class in akka.cluster.sharding.typed")<M>` | `[apply](#apply(java.lang.String))​(java.lang.String entityId)` | Returns `ShardingEnvelope` which can be sent via Cluster Sharding in order to wake up the  specified (by `entityId`) Sharded Entity, ''without'' delivering a real message to it. |
