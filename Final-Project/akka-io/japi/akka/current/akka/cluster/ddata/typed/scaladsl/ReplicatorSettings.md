...
- - ### Constructor Summary
	...
	| `static [ReplicatorSettings](../../ReplicatorSettings.html "class in akka.cluster.ddata")` | `[apply](#apply(akka.actor.typed.ActorSystem))​([ActorSystem](../../../../actor/typed/ActorSystem.html "class in akka.actor.typed")<?> system)` | Create settings from the default configuration  `akka.cluster.distributed-data`. |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [ReplicatorSettings](../../ReplicatorSettings.html "class in akka.cluster.ddata") apply​([ActorSystem](../../../../actor/typed/ActorSystem.html "class in akka.actor.typed")<?> system)
		```
