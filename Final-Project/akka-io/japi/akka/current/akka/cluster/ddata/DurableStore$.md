...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/cluster/ddata/DurableStore$.html
title: DurableStore$
---
...
- - ### Field Summary
	...
	| `static [DurableStore$](DurableStore$.html "class in akka.cluster.ddata")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [DurableStore$](DurableStore$.html "class in akka.cluster.ddata") MODULE$
		```
...
---
*Source: [https://doc.akka.io/japi/akka/current/akka/cluster/ddata/DurableStore$.html](https://doc.akka.io/japi/akka/current/akka/cluster/ddata/DurableStore$.html)*