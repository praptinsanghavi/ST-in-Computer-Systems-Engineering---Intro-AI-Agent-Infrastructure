...
scraped_at: '2026-04-05T20:57:04Z'
section: japi
site: akka-io
...
- - ### Constructor Summary
	...
	| `static scala.concurrent.duration.FiniteDuration` | `[additionalAskTimeout](#additionalAskTimeout())()` |  |
	| `static [Behavior](../../../../actor/typed/Behavior.html "class in akka.actor.typed")<[Replicator.Command](../scaladsl/Replicator.Command.html "interface in akka.cluster.ddata.typed.scaladsl")>` | `[apply](#apply(akka.cluster.ddata.ReplicatorSettings,scala.Option))​([ReplicatorSettings](../../ReplicatorSettings.html "class in akka.cluster.ddata") settings,  scala.Option<[ActorRef](../../../../actor/ActorRef.html "class in akka.actor")> underlyingReplicator)` |  |
	| `static scala.concurrent.duration.FiniteDuration` | `[localAskTimeout](#localAskTimeout())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static scala.concurrent.duration.FiniteDuration localAskTimeout()
		```
		...
		```
		public static scala.concurrent.duration.FiniteDuration additionalAskTimeout()
		```
		- #### apply
		...
		```
		public static [Behavior](../../../../actor/typed/Behavior.html "class in akka.actor.typed")<[Replicator.Command](../scaladsl/Replicator.Command.html "interface in akka.cluster.ddata.typed.scaladsl")> apply​([ReplicatorSettings](../../ReplicatorSettings.html "class in akka.cluster.ddata") settings,
		                                                 scala.Option<[ActorRef](../../../../actor/ActorRef.html "class in akka.actor")> underlyingReplicator)
		```
