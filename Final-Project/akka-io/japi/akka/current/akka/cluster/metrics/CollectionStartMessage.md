...
scraped_at: '2026-04-05T21:02:39Z'
section: japi
site: akka-io
...
- - ### Constructor Summary
	...
	| `static [CollectionStartMessage$](CollectionStartMessage$.html "class in akka.cluster.metrics")` | `[getInstance](#getInstance())()` | Java API |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [CollectionStartMessage$](CollectionStartMessage$.html "class in akka.cluster.metrics") getInstance()
		```
