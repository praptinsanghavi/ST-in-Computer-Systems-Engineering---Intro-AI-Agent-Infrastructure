...
scraped_at: '2026-04-05T21:36:54Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/remote/serialization/MiscMessageSerializer.html
title: MiscMessageSerializer
---
...
- - ### Constructor Summary
	...
	| `[MiscMessageSerializer](#%3Cinit%3E(akka.actor.ExtendedActorSystem))​([ExtendedActorSystem](../../actor/ExtendedActorSystem.html "class in akka.actor") system)` |  |
	...
	| `byte[]` | `[serializeStatusReplyError](#serializeStatusReplyError(akka.pattern.StatusReply))​([StatusReply](../../pattern/StatusReply.html "class in akka.pattern")<?> r)` |  |
	| `byte[]` | `[serializeStatusReplySuccess](#serializeStatusReplySuccess(akka.pattern.StatusReply))​([StatusReply](../../pattern/StatusReply.html "class in akka.pattern")<java.lang.Object> r)` |  |
...
- - ### Constructor Detail
		...
		```
		public MiscMessageSerializer​([ExtendedActorSystem](../../actor/ExtendedActorSystem.html "class in akka.actor") system)
		```
	...
	- ### Method Detail
		...
		- #### serializeStatusReplyError
		
		
		
		```
		public byte[] serializeStatusReplyError​([StatusReply](../../pattern/StatusReply.html "class in akka.pattern")<?> r)
		```
		- #### serializeStatusReplySuccess
		
		
		
		```
		public byte[] serializeStatusReplySuccess​([StatusReply](../../pattern/StatusReply.html "class in akka.pattern")<java.lang.Object> r)
		```
		- #### system
...
---
*Source: [https://doc.akka.io/japi/akka/current/akka/remote/serialization/MiscMessageSerializer.html](https://doc.akka.io/japi/akka/current/akka/remote/serialization/MiscMessageSerializer.html)*