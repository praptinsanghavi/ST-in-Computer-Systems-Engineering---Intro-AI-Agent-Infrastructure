...
scraped_at: '2026-04-05T21:37:23Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/remote/testconductor/Player.Waiter.html
title: Player.Waiter
---
...
- - ### Nested Class Summary
	...
	| `void` | `[waiting_$eq](#waiting_$eq(akka.actor.ActorRef))​([ActorRef](../../actor/ActorRef.html "class in akka.actor") x$1)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public [ActorRef](../../actor/ActorRef.html "class in akka.actor") waiting()
		```
		- #### waiting\_$eq
		...
		```
		public void waiting_$eq​([ActorRef](../../actor/ActorRef.html "class in akka.actor") x$1)
		```
...
---
*Source: [https://doc.akka.io/japi/akka/current/akka/remote/testconductor/Player.Waiter.html](https://doc.akka.io/japi/akka/current/akka/remote/testconductor/Player.Waiter.html)*