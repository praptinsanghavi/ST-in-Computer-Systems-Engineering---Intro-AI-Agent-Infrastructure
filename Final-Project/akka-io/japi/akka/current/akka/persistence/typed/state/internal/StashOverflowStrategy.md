...
scraped_at: '2026-04-05T21:31:54Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/persistence/typed/state/internal/StashOverflowStrategy.Fail$.html
...
- java.lang.Object
- - akka.persistence.typed.state.internal.StashOverflowStrategy.Fail$
...
See Also:
[Serialized Form](../../../../../serialized-form.html#akka.persistence.typed.state.internal.StashOverflowStrategy.Fail$)
...
- - ### Nested Class Summary
	...
	| `static [StashOverflowStrategy.Fail$](StashOverflowStrategy.Fail$.html "class in akka.persistence.typed.state.internal")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [StashOverflowStrategy.Fail$](StashOverflowStrategy.Fail$.html "class in akka.persistence.typed.state.internal") MODULE$
		```
...
- https://doc.akka.io/japi/akka/current/akka/persistence/typed/state/internal/StashOverflowStrategy.Drop$.html
- https://doc.akka.io/japi/akka/current/akka/persistence/typed/state/internal/StashOverflowStrategy.Fail$.html
...
---
*Source: [https://doc.akka.io/japi/akka/current/akka/persistence/typed/state/internal/StashOverflowStrategy.Fail$.html](https://doc.akka.io/japi/akka/current/akka/persistence/typed/state/internal/StashOverflowStrategy.Fail$.html)*