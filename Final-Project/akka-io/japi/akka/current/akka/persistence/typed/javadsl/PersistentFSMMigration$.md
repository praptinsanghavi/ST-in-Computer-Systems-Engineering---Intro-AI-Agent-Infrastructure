...
scraped_at: '2026-04-05T21:30:01Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/persistence/typed/javadsl/PersistentFSMMigration$.html
...
- - ### Field Summary
	...
	| `static [PersistentFSMMigration$](PersistentFSMMigration$.html "class in akka.persistence.typed.javadsl")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [PersistentFSMMigration$](PersistentFSMMigration$.html "class in akka.persistence.typed.javadsl") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public <State> [SnapshotAdapter](../SnapshotAdapter.html "interface in akka.persistence.typed")<State> snapshotAdapter​([Function3](../../../japi/function/Function3.html "interface in akka.japi.function")<java.lang.String,​java.lang.Object,​java.util.Optional<java.time.Duration>,​State> adapt)
		```
...
---
*Source: [https://doc.akka.io/japi/akka/current/akka/persistence/typed/javadsl/PersistentFSMMigration$.html](https://doc.akka.io/japi/akka/current/akka/persistence/typed/javadsl/PersistentFSMMigration$.html)*