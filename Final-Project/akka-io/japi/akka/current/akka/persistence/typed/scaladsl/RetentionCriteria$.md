...
- - ### Field Summary
	...
	| `static [RetentionCriteria$](RetentionCriteria$.html "class in akka.persistence.typed.scaladsl")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `[RetentionCriteria](RetentionCriteria.html "interface in akka.persistence.typed.scaladsl")` | `[disabled](#disabled())()` | Snapshots are not saved and deleted automatically, events are not deleted. |
	| `[SnapshotCountRetentionCriteria](SnapshotCountRetentionCriteria.html "interface in akka.persistence.typed.scaladsl")` | `[snapshotEvery](#snapshotEvery(int))​(int numberOfEvents)` | Save snapshots automatically every `numberOfEvents`. |
	| `[SnapshotCountRetentionCriteria](SnapshotCountRetentionCriteria.html "interface in akka.persistence.typed.scaladsl")` | `[snapshotEvery](#snapshotEvery(int,int))​(int numberOfEvents,  int keepNSnapshots)` | Save snapshots automatically every `numberOfEvents`. |
...
- - ### Field Detail
		...
		```
		public static final [RetentionCriteria$](RetentionCriteria$.html "class in akka.persistence.typed.scaladsl") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public [RetentionCriteria](RetentionCriteria.html "interface in akka.persistence.typed.scaladsl") disabled()
		```
		...
		```
		public [SnapshotCountRetentionCriteria](SnapshotCountRetentionCriteria.html "interface in akka.persistence.typed.scaladsl") snapshotEvery​(int numberOfEvents,
		                                                    int keepNSnapshots)
		```
