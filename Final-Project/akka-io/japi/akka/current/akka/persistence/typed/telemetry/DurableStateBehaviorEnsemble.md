...
scraped_at: '2026-04-05T21:31:18Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/persistence/typed/telemetry/DurableStateBehaviorEnsemble.html
title: DurableStateBehaviorEnsemble
---
...
```
public class DurableStateBehaviorEnsemble
...
- - ### Constructor Summary
	...
	| `[DurableStateBehaviorEnsemble](#%3Cinit%3E(scala.collection.immutable.Seq))​(scala.collection.immutable.Seq<[DurableStateBehaviorInstrumentation](DurableStateBehaviorInstrumentation.html "interface in akka.persistence.typed.telemetry")> instrumentations)` |  |
	...
	| `scala.collection.immutable.Seq<[DurableStateBehaviorInstrumentation](DurableStateBehaviorInstrumentation.html "interface in akka.persistence.typed.telemetry")>` | `[instrumentations](#instrumentations())()` |  |
...
- - ### Constructor Detail
		...
		```
		public DurableStateBehaviorEnsemble​(scala.collection.immutable.Seq<[DurableStateBehaviorInstrumentation](DurableStateBehaviorInstrumentation.html "interface in akka.persistence.typed.telemetry")> instrumentations)
		```
	...
	- ### Method Detail
		...
		```
		public scala.collection.immutable.Seq<[DurableStateBehaviorInstrumentation](DurableStateBehaviorInstrumentation.html "interface in akka.persistence.typed.telemetry")> instrumentations()
		```
		- #### persistFailed
...
---
*Source: [https://doc.akka.io/japi/akka/current/akka/persistence/typed/telemetry/DurableStateBehaviorEnsemble.html](https://doc.akka.io/japi/akka/current/akka/persistence/typed/telemetry/DurableStateBehaviorEnsemble.html)*