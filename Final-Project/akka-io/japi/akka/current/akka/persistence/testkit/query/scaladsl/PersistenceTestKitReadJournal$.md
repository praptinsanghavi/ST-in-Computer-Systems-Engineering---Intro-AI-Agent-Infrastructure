...
```
public class PersistenceTestKitReadJournal$
...
- - ### Field Summary
	...
	| `static [PersistenceTestKitReadJournal$](PersistenceTestKitReadJournal$.html "class in akka.persistence.testkit.query.scaladsl")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `[PersistenceTestKitReadJournal$](#%3Cinit%3E())()` |  |
...
- - ### Field Detail
		...
		```
		public static final [PersistenceTestKitReadJournal$](PersistenceTestKitReadJournal$.html "class in akka.persistence.testkit.query.scaladsl") MODULE$
		```
	...
	- ### Constructor Detail
		...
		```
		public PersistenceTestKitReadJournal$()
		```
