...
scraped_at: '2026-04-05T21:24:14Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/persistence/journal/IdentityEventAdapters.html
...
- - ### Constructor Summary
	...
	| `static [EventAdapter](EventAdapter.html "interface in akka.persistence.journal")` | `[get](#get(java.lang.Class))​(java.lang.Class<?> clazz)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [EventAdapter](EventAdapter.html "interface in akka.persistence.journal") get​(java.lang.Class<?> clazz)
		```
		- #### toString
...
---
*Source: [https://doc.akka.io/japi/akka/current/akka/persistence/journal/IdentityEventAdapters.html](https://doc.akka.io/japi/akka/current/akka/persistence/journal/IdentityEventAdapters.html)*