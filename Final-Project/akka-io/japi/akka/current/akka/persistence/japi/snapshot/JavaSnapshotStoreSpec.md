...
scraped_at: '2026-04-05T21:23:31Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/persistence/japi/snapshot/JavaSnapshotStoreSpec.html
title: JavaSnapshotStoreSpec
---
...
Package [akka.persistence.japi.snapshot](package-summary.html)
## Class JavaSnapshotStoreSpec

- java.lang.Object
- - [akka.persistence.PluginSpec](../../PluginSpec.html "class in akka.persistence")
	- - [akka.persistence.snapshot.SnapshotStoreSpec](../../snapshot/SnapshotStoreSpec.html "class in akka.persistence.snapshot")
		- - akka.persistence.japi.snapshot.JavaSnapshotStoreSpec

- All Implemented Interfaces:
`[CapabilityFlags](../../CapabilityFlags.html "interface in akka.persistence")`, `[MayVerb](../../scalatest/MayVerb.html "interface in akka.persistence.scalatest")`, `[OptionalTests](../../scalatest/OptionalTests.html "interface in akka.persistence.scalatest")`, `[SnapshotStoreCapabilityFlags](../../SnapshotStoreCapabilityFlags.html "interface in akka.persistence")`, `[TestKitBase](../../../testkit/TestKitBase.html "interface in akka.testkit")`, `java.io.Serializable`, `org.scalactic.Explicitly`, `org.scalactic.Tolerance`, `org.scalactic.TripleEquals`, `org.scalactic.TripleEqualsSupport`, `org.scalatest.Alerting`, `org.scalatest.Assertions`, `org.scalatest.BeforeAndAfterAll`, `org.scalatest.BeforeAndAfterEach`, `org.scalatest.Documenting`, `org.scalatest.Informing`, `org.scalatest.matchers.dsl.MatcherWords`, `org.scalatest.matchers.should.Matchers`, `org.scalatest.Notifying`, `org.scalatest.Suite`, `org.scalatest.SuiteMixin`, `org.scalatest.TestRegistration`, `org.scalatest.TestSuite`, `org.scalatest.verbs.CanVerb`, `org.scalatest.verbs.MustVerb`, `org.scalatest.verbs.ShouldVerb`, `org.scalatest.wordspec.AnyWordSpecLike`

---

```
public class JavaSnapshotStoreSpec
extends [SnapshotStoreSpec](../../snapshot/SnapshotStoreSpec.html "class in akka.persistence.snapshot")
```

JAVA API
 
 This spec aims to verify custom akka\-persistence [`SnapshotStore`](../../snapshot/SnapshotStore.html "interface in akka.persistence.snapshot") implementations.
...
[Serialized Form](../../../../serialized-form.html#akka.persistence.japi.snapshot.JavaSnapshotStoreSpec)
...
- - ### Nested Class Summary
	...
	| `[JavaSnapshotStoreSpec](#%3Cinit%3E(com.typesafe.config.Config))​(com.typesafe.config.Config config)` |  |
	...
	| `int` | `[expectedTestCount](#expectedTestCount(org.scalatest.Filter))​(org.scalatest.Filter filter)` |  |
	| `scala.collection.immutable.IndexedSeq<org.scalatest.Suite>` | `[nestedSuites](#nestedSuites())()` |  |
	| `scala.Option<java.lang.String>` | `[rerunner](#rerunner())()` |  |
	| `org.scalatest.Status` | `[run](#run(scala.Option,org.scalatest.Args))​(scala.Option<java.lang.String> testName,  org.scalatest.Args args)` |  |
	| `org.scalatest.Status` | `[runNestedSuites](#runNestedSuites(org.scalatest.Args))​(org.scalatest.Args args)` |  |
	| `org.scalatest.Status` | `[runTest](#runTest(java.lang.String,org.scalatest.Args))​(java.lang.String testName,  org.scalatest.Args args)` |  |
	| `org.scalatest.Status` | `[runTests](#runTests(scala.Option,org.scalatest.Args))​(scala.Option<java.lang.String> testName,  org.scalatest.Args args)` |  |
	| `java.lang.String` | `[suiteId](#suiteId())()` |  |
	| `java.lang.String` | `[suiteName](#suiteName())()` |  |
	| `protected [CapabilityFlag](../../CapabilityFlag.html "class in akka.persistence")` | `[supportsSerialization](#supportsSerialization())()` | When `true` enables tests which check if the snapshot store properly serialize and  deserialize snapshots. |
	| `scala.collection.immutable.Map<java.lang.String,​scala.collection.immutable.Set<java.lang.String>>` | `[tags](#tags())()` |  |
	| `org.scalatest.TestData` | `[testDataFor](#testDataFor(java.lang.String,org.scalatest.ConfigMap))​(java.lang.String testName,  org.scalatest.ConfigMap theConfigMap)` |  |
	| `scala.collection.immutable.Set<java.lang.String>` | `[testNames](#testNames())()` |  |
	
	
		- ### Methods inherited from class akka.persistence.snapshot.[SnapshotStoreSpec](../../snapshot/SnapshotStoreSpec.html "class in akka.persistence.snapshot")
		
		
		`[beforeEach](../../snapshot/SnapshotStoreSpec.html#beforeEach()), [config](../../snapshot/SnapshotStoreSpec.html#config()), [snapshotByteSizeLimit](../../snapshot/SnapshotStoreSpec.html#snapshotByteSizeLimit()), [snapshotStore](../../snapshot/SnapshotStoreSpec.html#snapshotStore()), [supportsMetadata](../../snapshot/SnapshotStoreSpec.html#supportsMetadata()), [system](../../snapshot/SnapshotStoreSpec.html#system()), [writeSnapshots](../../snapshot/SnapshotStoreSpec.html#writeSnapshots())`
		...
		`createCatchReporter, execute, execute$default$1, execute$default$2, execute$default$3, execute$default$4, execute$default$5, execute$default$6, execute$default$7`
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		Description copied from interface: `[SnapshotStoreCapabilityFlags](../../SnapshotStoreCapabilityFlags.html#supportsSerialization())`
		When `true` enables tests which check if the snapshot store properly serialize and
		 deserialize snapshots.
		
		Specified by:
		`[supportsSerialization](../../SnapshotStoreCapabilityFlags.html#supportsSerialization())` in interface `[SnapshotStoreCapabilityFlags](../../SnapshotStoreCapabilityFlags.html "interface in akka.persistence")`
		Overrides:
		`[supportsSerialization](../../snapshot/SnapshotStoreSpec.html#supportsSerialization())` in class `[SnapshotStoreSpec](../../snapshot/SnapshotStoreSpec.html "class in akka.persistence.snapshot")`
		- #### tags
...
- https://doc.akka.io/japi/akka/current/akka/persistence/SnapshotStoreCapabilityFlags.html
- https://doc.akka.io/japi/akka/current/akka/persistence/japi/snapshot/package-summary.html
- https://doc.akka.io/japi/akka/current/akka/persistence/scalatest/MayVerb.StringMayWrapperForVerb.html
...
- https://doc.akka.io/japi/akka/current/akka/persistence/scalatest/OptionalTests.html
- https://doc.akka.io/japi/akka/current/akka/persistence/snapshot/SnapshotStore.html
...
---
*Source: [https://doc.akka.io/japi/akka/current/akka/persistence/japi/snapshot/JavaSnapshotStoreSpec.html](https://doc.akka.io/japi/akka/current/akka/persistence/japi/snapshot/JavaSnapshotStoreSpec.html)*