...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/persistence/snapshot/SnapshotStoreSpec.html
title: SnapshotStoreSpec
---
...
`[JavaSnapshotStoreSpec](../japi/snapshot/JavaSnapshotStoreSpec.html "class in akka.persistence.japi.snapshot")`
...
implements [MayVerb](../scalatest/MayVerb.html "interface in akka.persistence.scalatest"), [OptionalTests](../scalatest/OptionalTests.html "interface in akka.persistence.scalatest"), [SnapshotStoreCapabilityFlags](../SnapshotStoreCapabilityFlags.html "interface in akka.persistence")
```

This spec aims to verify custom akka\-persistence [`SnapshotStore`](SnapshotStore.html "interface in akka.persistence.snapshot") implementations.
 ...
 For a Java and JUnit consumable version of the TCK please refer to [`JavaSnapshotStoreSpec`](../japi/snapshot/JavaSnapshotStoreSpec.html "class in akka.persistence.japi.snapshot").
 

See Also:
[`JavaSnapshotStoreSpec`](../japi/snapshot/JavaSnapshotStoreSpec.html "class in akka.persistence.japi.snapshot"), 
[Serialized Form](../../../serialized-form.html#akka.persistence.snapshot.SnapshotStoreSpec)
...
- - ### Nested Class Summary
	...
	| `[SnapshotStoreSpec](#%3Cinit%3E(com.typesafe.config.Config))​(com.typesafe.config.Config config)` |  |
	...
	| `int` | `[snapshotByteSizeLimit](#snapshotByteSizeLimit())()` | The limit defines a number of bytes persistence plugin can support to store the snapshot. |
	| `[ActorRef](../../actor/ActorRef.html "class in akka.actor")` | `[snapshotStore](#snapshotStore())()` |  |
	| `protected [CapabilityFlag](../CapabilityFlag.html "class in akka.persistence")` | `[supportsMetadata](#supportsMetadata())()` | When `true` enables tests which check if the snapshot store properly stores and  loads metadata (needed for replication) along with the snapshots |
	...
	| `scala.collection.immutable.Seq<[SnapshotMetadata](../SnapshotMetadata.html "class in akka.persistence")>` | `[writeSnapshots](#writeSnapshots())()` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		Description copied from interface: `[SnapshotStoreCapabilityFlags](../SnapshotStoreCapabilityFlags.html#supportsMetadata())`
		...
		Specified by:
		`[supportsMetadata](../SnapshotStoreCapabilityFlags.html#supportsMetadata())` in interface `[SnapshotStoreCapabilityFlags](../SnapshotStoreCapabilityFlags.html "interface in akka.persistence")`
		- #### beforeEach
		...
		```
		public [ActorRef](../../actor/ActorRef.html "class in akka.actor") snapshotStore()
		```
		- #### writeSnapshots
		...
		```
		public scala.collection.immutable.Seq<[SnapshotMetadata](../SnapshotMetadata.html "class in akka.persistence")> writeSnapshots()
		```
...
- https://doc.akka.io/japi/akka/current/akka/persistence/snapshot/package-summary.html
- https://doc.akka.io/japi/akka/current/akka/testkit/TestKitBase.html
- https://doc.akka.io/japi/akka/current/serialized-form.html

---
*Source: [https://doc.akka.io/japi/akka/current/akka/persistence/snapshot/SnapshotStoreSpec.html](https://doc.akka.io/japi/akka/current/akka/persistence/snapshot/SnapshotStoreSpec.html)*