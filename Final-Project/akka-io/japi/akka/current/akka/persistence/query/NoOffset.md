...
scraped_at: '2026-04-05T21:24:40Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/persistence/query/NoOffset.html
title: NoOffset
---
...
- - ### Constructor Summary
	...
	| `static [Offset](Offset.html "class in akka.persistence.query")` | `[getInstance](#getInstance())()` | Java API: |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [Offset](Offset.html "class in akka.persistence.query") getInstance()
		```
...
---
*Source: [https://doc.akka.io/japi/akka/current/akka/persistence/query/NoOffset.html](https://doc.akka.io/japi/akka/current/akka/persistence/query/NoOffset.html)*