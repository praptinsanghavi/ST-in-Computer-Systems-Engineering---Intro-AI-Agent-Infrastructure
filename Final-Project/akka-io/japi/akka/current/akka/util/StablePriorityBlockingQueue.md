...
scraped_at: '2026-04-05T21:50:21Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/util/StablePriorityBlockingQueue.html
title: StablePriorityBlockingQueue
---
...
- - java.util.AbstractCollection\<E\>
	- - java.util.AbstractQueue\<E\>
		- - akka.util.StablePriorityBlockingQueue\<E\>
...
`[UnboundedStablePriorityMailbox.MessageQueue](../dispatch/UnboundedStablePriorityMailbox.MessageQueue.html "class in akka.dispatch")`

---

```
public class StablePriorityBlockingQueue<E>
...
- - ### Nested Class Summary
	...
	| `[StablePriorityBlockingQueue](#%3Cinit%3E(int,java.util.Comparator))​(int capacity,  java.util.Comparator<[E](StablePriorityBlockingQueue.html "type parameter in StablePriorityBlockingQueue")> cmp)` |  |
	...
	| `java.util.concurrent.PriorityBlockingQueue<[PriorityQueueStabilizer.WrappedElement](PriorityQueueStabilizer.WrappedElement.html "class in akka.util")<[E](StablePriorityBlockingQueue.html "type parameter in StablePriorityBlockingQueue")>>` | `[backingQueue](#backingQueue())()` |  |
...
- - ### Constructor Detail
		...
		```
		public StablePriorityBlockingQueue​(int capacity,
		                                   java.util.Comparator<[E](StablePriorityBlockingQueue.html "type parameter in StablePriorityBlockingQueue")> cmp)
		```
	...
	- ### Method Detail
		...
		Specified by:
		`[akka$util$PriorityQueueStabilizer$_setter_$seqNum_$eq](PriorityQueueStabilizer.html#akka$util$PriorityQueueStabilizer$_setter_$seqNum_$eq(java.util.concurrent.atomic.AtomicLong))` in interface `[PriorityQueueStabilizer](PriorityQueueStabilizer.html "interface in akka.util")<[E](StablePriorityBlockingQueue.html "type parameter in StablePriorityBlockingQueue")>`
		- #### backingQueue
		
		
		
		```
		public java.util.concurrent.PriorityBlockingQueue<[PriorityQueueStabilizer.WrappedElement](PriorityQueueStabilizer.WrappedElement.html "class in akka.util")<[E](StablePriorityBlockingQueue.html "type parameter in StablePriorityBlockingQueue")>> backingQueue()
		```
		
		
		Specified by:
		`[backingQueue](PriorityQueueStabilizer.html#backingQueue())` in interface `[PriorityQueueStabilizer](PriorityQueueStabilizer.html "interface in akka.util")<[E](StablePriorityBlockingQueue.html "type parameter in StablePriorityBlockingQueue")>`
		- #### seqNum
		...
		Specified by:
		`[seqNum](PriorityQueueStabilizer.html#seqNum())` in interface `[PriorityQueueStabilizer](PriorityQueueStabilizer.html "interface in akka.util")<[E](StablePriorityBlockingQueue.html "type parameter in StablePriorityBlockingQueue")>`
...
- https://doc.akka.io/japi/akka/current/akka/util/StablePriorityBlockingQueue.html
- https://doc.akka.io/japi/akka/current/akka/util/package-summary.html

---
*Source: [https://doc.akka.io/japi/akka/current/akka/util/StablePriorityBlockingQueue.html](https://doc.akka.io/japi/akka/current/akka/util/StablePriorityBlockingQueue.html)*