...
scraped_at: '2026-04-05T21:48:23Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/testkit/InfoFilter.html
title: InfoFilter
---
...
- - ### Constructor Summary
	...
	| `[InfoFilter](#%3Cinit%3E(java.lang.String,java.lang.String,boolean,boolean,int))​(java.lang.String source,  java.lang.String message,  boolean pattern,  boolean complete,  int occurrences)` | Java API: create an InfoFilter |
	| `[InfoFilter](#%3Cinit%3E(scala.Option,scala.util.Either,boolean,int))​(scala.Option<java.lang.String> source,  scala.util.Either<java.lang.String,​scala.util.matching.Regex> message,  boolean complete,  int occurrences)` |  |
	...
	| `static [InfoFilter](InfoFilter.html "class in akka.testkit")` | `[apply](#apply(scala.Option,scala.util.Either,boolean,int))​(scala.Option<java.lang.String> source,  scala.util.Either<java.lang.String,​scala.util.matching.Regex> message,  boolean complete,  int occurrences)` |  |
	| `boolean` | `[canEqual](#canEqual(java.lang.Object))​(java.lang.Object x$1)` |  |
	| `boolean` | `[complete](#complete())()` |  |
	| `[InfoFilter](InfoFilter.html "class in akka.testkit")` | `[copy](#copy(scala.Option,scala.util.Either,boolean,int))​(scala.Option<java.lang.String> source,  scala.util.Either<java.lang.String,​scala.util.matching.Regex> message,  boolean complete,  int occurrences)` |  |
	...
	| `static scala.Option<scala.Tuple3<scala.Option<java.lang.String>,​scala.util.Either<java.lang.String,​scala.util.matching.Regex>,​java.lang.Object>>` | `[unapply](#unapply(akka.testkit.InfoFilter))​([InfoFilter](InfoFilter.html "class in akka.testkit") x$0)` |  |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static [InfoFilter](InfoFilter.html "class in akka.testkit") apply​(scala.Option<java.lang.String> source,
		                               scala.util.Either<java.lang.String,​scala.util.matching.Regex> message,
		                               boolean complete,
		                               int occurrences)
		```
		...
		```
		public static scala.Option<scala.Tuple3<scala.Option<java.lang.String>,​scala.util.Either<java.lang.String,​scala.util.matching.Regex>,​java.lang.Object>> unapply​([InfoFilter](InfoFilter.html "class in akka.testkit") x$0)
		```
		- #### source
		...
		```
		public [InfoFilter](InfoFilter.html "class in akka.testkit") copy​(scala.Option<java.lang.String> source,
		                       scala.util.Either<java.lang.String,​scala.util.matching.Regex> message,
		                       boolean complete,
		                       int occurrences)
		```
...
- https://doc.akka.io/japi/akka/current/akka/testkit/InfoFilter.html
- https://doc.akka.io/japi/akka/current/akka/testkit/package-summary.html
- https://doc.akka.io/japi/akka/current/serialized-form.html

---
*Source: [https://doc.akka.io/japi/akka/current/akka/testkit/InfoFilter.html](https://doc.akka.io/japi/akka/current/akka/testkit/InfoFilter.html)*