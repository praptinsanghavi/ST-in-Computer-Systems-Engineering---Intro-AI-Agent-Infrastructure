...
- - ### Field Summary
	...
	| `static [TestKitUtils$](TestKitUtils$.html "class in akka.actor.testkit.typed.internal")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `void` | `[shutdown](#shutdown(akka.actor.typed.ActorSystem,scala.concurrent.duration.Duration,boolean))​([ActorSystem](../../../typed/ActorSystem.html "class in akka.actor.typed")<?> system,  scala.concurrent.duration.Duration timeout,  boolean throwIfShutdownTimesOut)` |  |
	| `java.lang.String` | `[testNameFromCallStack](#testNameFromCallStack(java.lang.Class))​(java.lang.Class<?> classToStartFrom)` |  |
...
- - ### Field Detail
		...
		```
		public static final [TestKitUtils$](TestKitUtils$.html "class in akka.actor.testkit.typed.internal") MODULE$
		```
