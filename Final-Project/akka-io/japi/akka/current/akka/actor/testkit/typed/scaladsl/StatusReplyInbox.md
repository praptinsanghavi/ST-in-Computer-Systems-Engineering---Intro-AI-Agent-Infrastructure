...
scraped_at: '2026-04-05T20:53:53Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/actor/testkit/typed/scaladsl/StatusReplyInbox.html
...
A [`ReplyInbox`](ReplyInbox.html "interface in akka.actor.testkit.typed.scaladsl") which specially handles [`StatusReply`](../../../../pattern/StatusReply.html "class in akka.pattern").
...
- - ### Method Summary
	...
	| `void` | `[expectDone](#expectDone(scala.$eq$colon$eq))​(scala.$eq$colon$eq<[T](StatusReplyInbox.html "type parameter in StatusReplyInbox"),​[Done](../../../../Done.html "class in akka")> ev)` | Assert that the successful value of the status reply is [`Done`](../../../../Done.html "class in akka"). |
	...
	| `[StatusReplyInbox](StatusReplyInbox.html "interface in akka.actor.testkit.typed.scaladsl")<[T](StatusReplyInbox.html "type parameter in StatusReplyInbox")>` | `[expectNoReply](#expectNoReply())()` | Assert that this inbox has \*never\* received a reply. |
...
- - ### Method Detail
		...
		```
		void expectDone​(scala.$eq$colon$eq<[T](StatusReplyInbox.html "type parameter in StatusReplyInbox"),​[Done](../../../../Done.html "class in akka")> ev)
		```
		
		Assert that the successful value of the status reply is [`Done`](../../../../Done.html "class in akka"). Subsequent calls to any `receive` or
		...
		```
		[StatusReplyInbox](StatusReplyInbox.html "interface in akka.actor.testkit.typed.scaladsl")<[T](StatusReplyInbox.html "type parameter in StatusReplyInbox")> expectNoReply()
		```
...
---
*Source: [https://doc.akka.io/japi/akka/current/akka/actor/testkit/typed/scaladsl/StatusReplyInbox.html](https://doc.akka.io/japi/akka/current/akka/actor/testkit/typed/scaladsl/StatusReplyInbox.html)*