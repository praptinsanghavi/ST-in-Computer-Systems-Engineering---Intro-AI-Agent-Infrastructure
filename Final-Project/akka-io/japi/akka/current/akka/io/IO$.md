...
- - ### Field Summary
	...
	| `static [IO$](IO$.html "class in akka.io")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [IO$](IO$.html "class in akka.io") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public <T extends [IO.Extension](IO.Extension.html "interface in akka.io")> [ActorRef](../actor/ActorRef.html "class in akka.actor") apply​([ExtensionId](../actor/ExtensionId.html "interface in akka.actor")<T> key,
...
- https://doc.akka.io/japi/akka/current/akka/io/IO$.html
