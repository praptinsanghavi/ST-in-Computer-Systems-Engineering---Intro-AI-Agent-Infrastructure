...
scraped_at: '2026-04-05T21:44:29Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/stream/javadsl/BroadcastHub$.html
title: BroadcastHub$
---
...
- - ### Field Summary
	...
	| `static [BroadcastHub$](BroadcastHub$.html "class in akka.stream.javadsl")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [BroadcastHub$](BroadcastHub$.html "class in akka.stream.javadsl") MODULE$
		```
...
---
*Source: [https://doc.akka.io/japi/akka/current/akka/stream/javadsl/BroadcastHub$.html](https://doc.akka.io/japi/akka/current/akka/stream/javadsl/BroadcastHub$.html)*