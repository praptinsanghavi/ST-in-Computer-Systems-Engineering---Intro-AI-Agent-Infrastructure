...
scraped_at: '2026-04-05T21:44:52Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/stream/javadsl/MergeHub.html
title: MergeHub
---
...
- - ### Nested Class Summary
	...
	| `static interface` | `[MergeHub.DrainingControl](MergeHub.DrainingControl.html "interface in akka.stream.javadsl")` | A DrainingControl object is created during the materialization of a MergeHub and allows to initiate the draining  and eventual completion of the Hub from the outside. |
...
- - ### Constructor Detail
	...
	- ### Method Detail
		...
		```
		public static <T> [Source](Source.html "class in akka.stream.javadsl")<T,​[Sink](Sink.html "class in akka.stream.javadsl")<T,​[NotUsed](../../NotUsed.html "class in akka")>> of​(java.lang.Class<T> clazz,
		...
		Creates a [`Source`](Source.html "class in akka.stream.javadsl") that emits elements merged from a dynamic set of producers. After the [`Source`](Source.html "class in akka.stream.javadsl") returned
		 ...
		 The materialized [`MergeHub.DrainingControl`](MergeHub.DrainingControl.html "interface in akka.stream.javadsl") can be used to drain the Hub: any new produces using the [`Sink`](Sink.html "class in akka.stream.javadsl") will be cancelled
...
---
*Source: [https://doc.akka.io/japi/akka/current/akka/stream/javadsl/MergeHub.html](https://doc.akka.io/japi/akka/current/akka/stream/javadsl/MergeHub.html)*