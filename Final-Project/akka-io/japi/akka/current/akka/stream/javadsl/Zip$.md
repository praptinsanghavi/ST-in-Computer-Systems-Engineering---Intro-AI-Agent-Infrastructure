...
scraped_at: '2026-04-05T21:45:55Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/stream/javadsl/Zip$.html
title: Zip$
---
...
- - ### Field Summary
	...
	| `<A,​B>[Graph](../Graph.html "interface in akka.stream")<[FanInShape2](../FanInShape2.html "class in akka.stream")<A,​B,​[Pair](../../japi/Pair.html "class in akka.japi")<A,​B>>,​[NotUsed](../../NotUsed.html "class in akka")>` | `[create](#create())()` | Create a new `Zip` operator with the specified input types and zipping\-function  which creates `akka.japi.Pair`s. |
...
- - ### Field Detail
		...
		```
		public static final [Zip$](Zip$.html "class in akka.stream.javadsl") MODULE$
		```
...
- https://doc.akka.io/japi/akka/current/akka/stream/javadsl/Zip$.html
- https://doc.akka.io/japi/akka/current/akka/stream/javadsl/package-summary.html

---
*Source: [https://doc.akka.io/japi/akka/current/akka/stream/javadsl/Zip$.html](https://doc.akka.io/japi/akka/current/akka/stream/javadsl/Zip$.html)*