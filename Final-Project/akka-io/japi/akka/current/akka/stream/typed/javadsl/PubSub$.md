...
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/stream/typed/javadsl/PubSub$.html
title: PubSub$
---
...
- - ### Field Summary
	...
	| `static [PubSub$](PubSub$.html "class in akka.stream.typed.javadsl")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [PubSub$](PubSub$.html "class in akka.stream.typed.javadsl") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public <T> [Source](../../javadsl/Source.html "class in akka.stream.javadsl")<T,​[NotUsed](../../../NotUsed.html "class in akka")> source​([ActorRef](../../../actor/typed/ActorRef.html "interface in akka.actor.typed")<[Topic.Command](../../../actor/typed/pubsub/Topic.Command.html "interface in akka.actor.typed.pubsub")<T>> topicActor,
		                                          int bufferSize,
		...
		```
		public <T> [Sink](../../javadsl/Sink.html "class in akka.stream.javadsl")<T,​[NotUsed](../../../NotUsed.html "class in akka")> sink​([ActorRef](../../../actor/typed/ActorRef.html "interface in akka.actor.typed")<[Topic.Command](../../../actor/typed/pubsub/Topic.Command.html "interface in akka.actor.typed.pubsub")<T>> topicActor)
		```
...
---
*Source: [https://doc.akka.io/japi/akka/current/akka/stream/typed/javadsl/PubSub$.html](https://doc.akka.io/japi/akka/current/akka/stream/typed/javadsl/PubSub$.html)*