...
scraped_at: '2026-04-05T21:47:34Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/stream/typed/javadsl/ActorSource$.html
title: ActorSource$
---
...
- - ### Field Summary
	...
	| `static [ActorSource$](ActorSource$.html "class in akka.stream.typed.javadsl")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [ActorSource$](ActorSource$.html "class in akka.stream.typed.javadsl") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public <T> [Source](../../javadsl/Source.html "class in akka.stream.javadsl")<T,​[ActorRef](../../../actor/typed/ActorRef.html "interface in akka.actor.typed")<T>> actorRef​(java.util.function.Predicate<T> completionMatcher,
		...
		```
		public <T,​Ack> [Source](../../javadsl/Source.html "class in akka.stream.javadsl")<T,​[ActorRef](../../../actor/typed/ActorRef.html "interface in akka.actor.typed")<T>> actorRefWithBackpressure​([ActorRef](../../../actor/typed/ActorRef.html "interface in akka.actor.typed")<Ack> ackTo,
		                                                                          Ack ackMessage,
		...
		```
		public <T,​Ack> [Source](../../javadsl/Source.html "class in akka.stream.javadsl")<T,​[ActorRef](../../../actor/typed/ActorRef.html "interface in akka.actor.typed")<T>> actorRefWithAck​([ActorRef](../../../actor/typed/ActorRef.html "interface in akka.actor.typed")<Ack> ackTo,
		                                                                 Ack ackMessage,
		                                                                 [Function](../../../japi/function/Function.html "interface in akka.japi.function")<T,​java.util.Optional<[CompletionStrategy](../../CompletionStrategy.html "interface in akka.stream")>> completionMatcher,
		                                                                 [Function](../../../japi/function/Function.html "interface in akka.japi.function")<T,​java.util.Optional<java.lang.Throwable>> failureMatcher)
		```
...
- https://doc.akka.io/japi/akka/current/akka/stream/typed/javadsl/ActorSource$.html
- https://doc.akka.io/japi/akka/current/akka/stream/typed/javadsl/package-summary.html

---
*Source: [https://doc.akka.io/japi/akka/current/akka/stream/typed/javadsl/ActorSource$.html](https://doc.akka.io/japi/akka/current/akka/stream/typed/javadsl/ActorSource$.html)*