...
- - ### Field Summary
	...
	| `static [ActorSource$](ActorSource$.html "class in akka.stream.typed.scaladsl")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [ActorSource$](ActorSource$.html "class in akka.stream.typed.scaladsl") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public <T> [Source](../../scaladsl/Source.html "class in akka.stream.scaladsl")<T,​[ActorRef](../../../actor/typed/ActorRef.html "interface in akka.actor.typed")<T>> actorRef​(scala.PartialFunction<T,​scala.runtime.BoxedUnit> completionMatcher,
		...
		```
		public <T,​Ack> [Source](../../scaladsl/Source.html "class in akka.stream.scaladsl")<T,​[ActorRef](../../../actor/typed/ActorRef.html "interface in akka.actor.typed")<T>> actorRefWithBackpressure​([ActorRef](../../../actor/typed/ActorRef.html "interface in akka.actor.typed")<Ack> ackTo,
		                                                                          Ack ackMessage,
		...
		```
		public <T,​Ack> [Source](../../scaladsl/Source.html "class in akka.stream.scaladsl")<T,​[ActorRef](../../../actor/typed/ActorRef.html "interface in akka.actor.typed")<T>> actorRefWithAck​([ActorRef](../../../actor/typed/ActorRef.html "interface in akka.actor.typed")<Ack> ackTo,
		                                                                 Ack ackMessage,
		                                                                 scala.PartialFunction<T,​[CompletionStrategy](../../CompletionStrategy.html "interface in akka.stream")> completionMatcher,
		                                                                 scala.PartialFunction<T,​java.lang.Throwable> failureMatcher)
		```
...
- https://doc.akka.io/japi/akka/current/akka/stream/typed/scaladsl/ActorSource$.html
