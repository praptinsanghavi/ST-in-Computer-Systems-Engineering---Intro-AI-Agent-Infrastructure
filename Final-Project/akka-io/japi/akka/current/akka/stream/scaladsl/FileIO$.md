...
scraped_at: '2026-04-05T21:41:28Z'
section: japi
site: akka-io
...
- - ### Field Summary
	...
	| `static [FileIO$](FileIO$.html "class in akka.stream.scaladsl")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `[Source](Source.html "class in akka.stream.scaladsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​scala.concurrent.Future<[IOResult](../IOResult.html "class in akka.stream")>>` | `[fromFile](#fromFile(java.io.File,int))​(java.io.File f,  int chunkSize)` | Deprecated. Use \`fromPath\` instead. |
	| `int` | `[fromFile$default$2](#fromFile$default$2())()` |  |
	| `[Source](Source.html "class in akka.stream.scaladsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​scala.concurrent.Future<[IOResult](../IOResult.html "class in akka.stream")>>` | `[fromPath](#fromPath(java.nio.file.Path,int))​(java.nio.file.Path f,  int chunkSize)` | Creates a Source from a files contents. |
	...
	| `int` | `[fromPath$default$2](#fromPath$default$2())()` |  |
	...
	| `scala.collection.immutable.Set<java.nio.file.OpenOption>` | `[toFile$default$2](#toFile$default$2())()` |  |
	...
	| `scala.collection.immutable.Set<java.nio.file.OpenOption>` | `[toPath$default$2](#toPath$default$2())()` |  |
...
- - ### Field Detail
		...
		```
		public static final [FileIO$](FileIO$.html "class in akka.stream.scaladsl") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public [Source](Source.html "class in akka.stream.scaladsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​scala.concurrent.Future<[IOResult](../IOResult.html "class in akka.stream")>> fromFile​(java.io.File f,
		                                                                           int chunkSize)
		```
		...
		```
		public [Source](Source.html "class in akka.stream.scaladsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​scala.concurrent.Future<[IOResult](../IOResult.html "class in akka.stream")>> fromPath​(java.nio.file.Path f,
		                                                                           int chunkSize)
		```
		...
		```
		public [Sink](Sink.html "class in akka.stream.scaladsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​scala.concurrent.Future<[IOResult](../IOResult.html "class in akka.stream")>> toFile​(java.io.File f,
		...
		```
		public [Sink](Sink.html "class in akka.stream.scaladsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​scala.concurrent.Future<[IOResult](../IOResult.html "class in akka.stream")>> toPath​(java.nio.file.Path f,
		                                                                       scala.collection.immutable.Set<java.nio.file.OpenOption> options)
		```
...
- https://doc.akka.io/japi/akka/current/akka/stream/scaladsl/FileIO$.html
