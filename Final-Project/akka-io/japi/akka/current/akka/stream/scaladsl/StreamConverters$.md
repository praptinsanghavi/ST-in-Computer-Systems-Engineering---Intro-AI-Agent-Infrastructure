...
scraped_at: '2026-04-05T21:42:24Z'
section: japi
site: akka-io
...
- - ### Field Summary
	...
	| `static [StreamConverters$](StreamConverters$.html "class in akka.stream.scaladsl")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
	...
	| `int` | `[fromInputStream$default$2](#fromInputStream$default$2())()` |  |
	...
	| `boolean` | `[fromOutputStream$default$2](#fromOutputStream$default$2())()` |  |
	| `<T,​R>[Sink](Sink.html "class in akka.stream.scaladsl")<T,​scala.concurrent.Future<R>>` | `[javaCollector](#javaCollector(scala.Function0))​(scala.Function0<java.util.stream.Collector<T,​?,​R>> collectorFactory)` | Creates a sink which materializes into a Future which will be completed with result of the Java 8 Collector transformation  and reduction operations. |
	| `<T,​R>[Sink](Sink.html "class in akka.stream.scaladsl")<T,​scala.concurrent.Future<R>>` | `[javaCollectorParallelUnordered](#javaCollectorParallelUnordered(int,scala.Function0))​(int parallelism,  scala.Function0<java.util.stream.Collector<T,​?,​R>> collectorFactory)` | Creates a sink which materializes into a Future which will be completed with result of the Java 8 Collector transformation  and reduction operations. |
...
- - ### Field Detail
		...
		```
		public static final [StreamConverters$](StreamConverters$.html "class in akka.stream.scaladsl") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public [Source](Source.html "class in akka.stream.scaladsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​scala.concurrent.Future<[IOResult](../IOResult.html "class in akka.stream")>> fromInputStream​(scala.Function0<java.io.InputStream> in,
		                                                                                  int chunkSize)
		```
		...
		```
		public [Source](Source.html "class in akka.stream.scaladsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.io.OutputStream> asOutputStream​(scala.concurrent.duration.FiniteDuration writeTimeout)
		```
		...
		```
		public [Sink](Sink.html "class in akka.stream.scaladsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​scala.concurrent.Future<[IOResult](../IOResult.html "class in akka.stream")>> fromOutputStream​(scala.Function0<java.io.OutputStream> out,
		                                                                                 boolean autoFlush)
		```
		...
		```
		public [Sink](Sink.html "class in akka.stream.scaladsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​java.io.InputStream> asInputStream​(scala.concurrent.duration.FiniteDuration readTimeout)
		```
		...
		```
		public <T,​R> [Sink](Sink.html "class in akka.stream.scaladsl")<T,​scala.concurrent.Future<R>> javaCollector​(scala.Function0<java.util.stream.Collector<T,​?,​R>> collectorFactory)
		```
		...
		```
		public <T,​R> [Sink](Sink.html "class in akka.stream.scaladsl")<T,​scala.concurrent.Future<R>> javaCollectorParallelUnordered​(int parallelism,
		...
		```
		public <T> [Sink](Sink.html "class in akka.stream.scaladsl")<T,​java.util.stream.Stream<T>> asJavaStream()
		```
...
- https://doc.akka.io/japi/akka/current/akka/stream/scaladsl/StreamConverters$.html
