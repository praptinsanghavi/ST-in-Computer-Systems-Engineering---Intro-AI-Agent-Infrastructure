...
scraped_at: '2026-04-05T21:41:42Z'
section: japi
site: akka-io
source_url: https://doc.akka.io/japi/akka/current/akka/stream/scaladsl/JsonFraming$.html
title: JsonFraming$
---
...
- - ### Field Summary
	...
	| `static [JsonFraming$](JsonFraming$.html "class in akka.stream.scaladsl")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [JsonFraming$](JsonFraming$.html "class in akka.stream.scaladsl") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public [Flow](Flow.html "class in akka.stream.scaladsl")<[ByteString](../../util/ByteString.html "class in akka.util"),​[ByteString](../../util/ByteString.html "class in akka.util"),​[NotUsed](../../NotUsed.html "class in akka")> objectScanner​(int maximumObjectLength)
		```
...
---
*Source: [https://doc.akka.io/japi/akka/current/akka/stream/scaladsl/JsonFraming$.html](https://doc.akka.io/japi/akka/current/akka/stream/scaladsl/JsonFraming$.html)*