...
- - ### Field Summary
	...
	| `static [TLS$](TLS$.html "class in akka.stream.scaladsl")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [TLS$](TLS$.html "class in akka.stream.scaladsl") MODULE$
		```
