...
scraped_at: '2026-04-05T21:41:58Z'
section: japi
site: akka-io
...
- - ### Field Summary
	...
	| `static [RestartFlow$](RestartFlow$.html "class in akka.stream.scaladsl")` | `[MODULE$](#MODULE$)` | Static reference to the singleton instance of this Scala object. |
...
- - ### Field Detail
		...
		```
		public static final [RestartFlow$](RestartFlow$.html "class in akka.stream.scaladsl") MODULE$
		```
	...
	- ### Method Detail
		...
		```
		public <In,​Out> [Flow](Flow.html "class in akka.stream.scaladsl")<In,​Out,​[NotUsed](../../NotUsed.html "class in akka")> withBackoff​(scala.concurrent.duration.FiniteDuration minBackoff,
		...
		```
		public <In,​Out> [Flow](Flow.html "class in akka.stream.scaladsl")<In,​Out,​[NotUsed](../../NotUsed.html "class in akka")> withBackoff​([RestartSettings](../RestartSettings.html "class in akka.stream") settings,
		                                                                   scala.Function0<[Flow](Flow.html "class in akka.stream.scaladsl")<In,​Out,​?>> flowFactory)
		```
		...
		```
		public <In,​Out> [Flow](Flow.html "class in akka.stream.scaladsl")<In,​Out,​[NotUsed](../../NotUsed.html "class in akka")> onFailuresWithBackoff​(scala.concurrent.duration.FiniteDuration minBackoff,
		                                                                             scala.concurrent.duration.FiniteDuration maxBackoff,
		                                                                             double randomFactor,
		                                                                             int maxRestarts,
		                                                                             scala.Function0<[Flow](Flow.html "class in akka.stream.scaladsl")<In,​Out,​?>> flowFactory)
		...
		```
		public <In,​Out> [Flow](Flow.html "class in akka.stream.scaladsl")<In,​Out,​[NotUsed](../../NotUsed.html "class in akka")> onFailuresWithBackoff​([RestartSettings](../RestartSettings.html "class in akka.stream") settings,
		                                                                             scala.Function0<[Flow](Flow.html "class in akka.stream.scaladsl")<In,​Out,​?>> flowFactory)
		```
...
- https://doc.akka.io/japi/akka/current/akka/stream/scaladsl/RestartFlow$.html
