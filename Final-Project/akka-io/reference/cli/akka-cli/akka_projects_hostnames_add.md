...
section: reference
site: akka-io
source_url: https://doc.akka.io/reference/cli/akka-cli/akka_projects_hostnames_add.html
title: 'akka projects hostnames add :: Akka Documentation'
---

# akka projects hostnames add :: Akka Documentation
...
The \`akka project hostnames add *name*' command will add a hostname to the project.
...
---
*Source: [https://doc.akka.io/reference/cli/akka-cli/akka_projects_hostnames_add.html](https://doc.akka.io/reference/cli/akka-cli/akka_projects_hostnames_add.html)*