...
scraped_at: '2026-04-05T18:20:44Z'
section: reference
site: akka-io
source_url: https://doc.akka.io/reference/cli/akka-cli/akka_routes_update.html
title: 'akka routes update :: Akka Documentation'
---

# akka routes update :: Akka Documentation
...
The \`akka routes update *name*' command will update a route for the project.
...
---
*Source: [https://doc.akka.io/reference/cli/akka-cli/akka_routes_update.html](https://doc.akka.io/reference/cli/akka-cli/akka_routes_update.html)*