...
section: reference
site: akka-io
source_url: https://doc.akka.io/reference/cli/akka-cli/akka_services_delete.html
title: 'akka services delete :: Akka Documentation'
---

# akka services delete :: Akka Documentation
...
The `akka services delete service-name` command deletes a service and removes all associated resources.
...
---
*Source: [https://doc.akka.io/reference/cli/akka-cli/akka_services_delete.html](https://doc.akka.io/reference/cli/akka-cli/akka_services_delete.html)*