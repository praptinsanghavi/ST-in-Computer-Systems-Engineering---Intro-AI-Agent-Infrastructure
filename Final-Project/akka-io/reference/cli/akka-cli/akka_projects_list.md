...
section: reference
site: akka-io
source_url: https://doc.akka.io/reference/cli/akka-cli/akka_projects_list.html
title: 'akka projects list :: Akka Documentation'
---

# akka projects list :: Akka Documentation
...
|  | You can change the current project using `akka config set project my-project` |
| --- | --- |
...
---
*Source: [https://doc.akka.io/reference/cli/akka-cli/akka_projects_list.html](https://doc.akka.io/reference/cli/akka-cli/akka_projects_list.html)*