...
section: reference
site: akka-io
source_url: https://doc.akka.io/reference/cli/akka-cli/akka_projects_observability_set_logs_otlp-http.html
title: 'akka projects observability set logs otlp-http :: Akka Documentation'
---

# akka projects observability set logs otlp-http :: Akka Documentation
...
---
*Source: [https://doc.akka.io/reference/cli/akka-cli/akka_projects_observability_set_logs_otlp-http.html](https://doc.akka.io/reference/cli/akka-cli/akka_projects_observability_set_logs_otlp-http.html)*