...
section: reference
site: akka-io
source_url: https://doc.akka.io/reference/cli/akka-cli/akka_services_deploy.html
title: 'akka services deploy :: Akka Documentation'
---

# akka services deploy :: Akka Documentation
...
The `akka service deploy service-name docker-image` command deploys a service with name *service\-name* using the *docker\-image*.
...
|  | If using a private image repository, you will need Docker credentials to be set up in order for Akka to be able to pull from your images. For more info see `akka docker` |
| --- | --- |
...
---
*Source: [https://doc.akka.io/reference/cli/akka-cli/akka_services_deploy.html](https://doc.akka.io/reference/cli/akka-cli/akka_services_deploy.html)*