...
scraped_at: '2026-04-05T18:20:13Z'
section: reference
site: akka-io
source_url: https://doc.akka.io/reference/cli/akka-cli/akka_projects_observability_add_traces_otlp-http.html
title: 'akka projects observability add traces otlp-http :: Akka Documentation'
---

# akka projects observability add traces otlp-http :: Akka Documentation
...
---
*Source: [https://doc.akka.io/reference/cli/akka-cli/akka_projects_observability_add_traces_otlp-http.html](https://doc.akka.io/reference/cli/akka-cli/akka_projects_observability_add_traces_otlp-http.html)*