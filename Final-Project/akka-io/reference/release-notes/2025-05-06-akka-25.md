...
section: reference
site: akka-io
source_url: https://doc.akka.io/reference/release-notes/2025-05-06-akka-25.05-released.html
title: 'Akka 25.05 Released :: Akka Documentation'
---

# Akka 25.05 Released :: Akka Documentation
...
As reference of versions that go together for Akka 25\.05, please see [Akka module versions 25\.05](https://doc.akka.io/libraries/akka-dependencies/25.05/).
...
For more details see [the blocking operations section of the docs](https://doc.akka.io/libraries/akka-core/current/typed/dispatchers.html#solution-virtual-threads-dispatcher-for-blocking-operations)
and [reference.conf](https://github.com/akka/akka/blob/v2.10.5/akka-actor/src/main/resources/reference.conf#L547)
...
- Multiple fixes in the async DNS client [akka \#32636](https://github.com/akka/akka/pull/32636)
- Avoid a range of more than Int MaxValue elements in JournalSequenceActor [akka\-persistence\-jdbc](https://github.com/akka/akka-persistence-jdbc/pull/904)
...
- https://doc.akka.io/libraries/akka-dependencies/25.05/
- https://doc.akka.io/libraries/akka-insights/current/project/release-notes.html

---
*Source: [https://doc.akka.io/reference/release-notes/2025-05-06-akka-25.05-released.html](https://doc.akka.io/reference/release-notes/2025-05-06-akka-25.05-released.html)*