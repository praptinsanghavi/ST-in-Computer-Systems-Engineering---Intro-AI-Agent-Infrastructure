...
section: reference
site: akka-io
source_url: https://doc.akka.io/reference/config/reference.html
title: 'Service reference configuration (HOCON) :: Akka Documentation'
---

# Service reference configuration (HOCON) :: Akka Documentation
...
### Example 1: Akka SDK reference configuration
...
---
*Source: [https://doc.akka.io/reference/config/reference.html](https://doc.akka.io/reference/config/reference.html)*