...
scraped_at: '2026-04-06T03:13:15Z'
section: api
site: akka-io
...
[c](LeveledCompactionStrategy$.html "See companion object")[akka](../../../index.html).[persistence](../../index.html).[cassandra](../index.html).[compaction](index.html)

# [LeveledCompactionStrategy](LeveledCompactionStrategy$.html "See companion object")[**](../../../../akka/persistence/cassandra/compaction/LeveledCompactionStrategy.html "Permalink")

### Companion [object LeveledCompactionStrategy](LeveledCompactionStrategy$.html "See companion object")

#### class LeveledCompactionStrategy extends [BaseCompactionStrategy](BaseCompactionStrategy.html)

Source[LeveledCompactionStrategy.scala](https://github.com/akka/akka-persistence-cassandra/tree/v1.3.4/core/src/main/scala/akka/persistence/cassandra/compaction/LeveledCompactionStrategy.scala#L12)Linear Supertypes[BaseCompactionStrategy](BaseCompactionStrategy.html), [CassandraCompactionStrategy](CassandraCompactionStrategy.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../../../akka/persistence/cassandra/compaction/LeveledCompactionStrategy.html#<init>(config:com.typesafe.config.Config):akka.persistence.cassandra.compaction.LeveledCompactionStrategy "Permalink")  new LeveledCompactionStrategy(config: Config)
### Value Members
...
4. [**](../../../../akka/persistence/cassandra/compaction/LeveledCompactionStrategy.html#asCQL:String "Permalink")  def asCQL: StringDefinition ClassesLeveledCompactionStrategy → [BaseCompactionStrategy](BaseCompactionStrategy.html) → [CassandraCompactionStrategy](CassandraCompactionStrategy.html)
...
7. [**](../../../../akka/persistence/cassandra/compaction/LeveledCompactionStrategy.html#enabled:Boolean "Permalink")  val enabled: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition Classes[BaseCompactionStrategy](BaseCompactionStrategy.html)
8. [**](../../../../akka/persistence/cassandra/compaction/LeveledCompactionStrategy.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
...
16. [**](../../../../akka/persistence/cassandra/compaction/LeveledCompactionStrategy.html#ssTableSizeInMB:Long "Permalink")  val ssTableSizeInMB: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)
...
19. [**](../../../../akka/persistence/cassandra/compaction/LeveledCompactionStrategy.html#tombstoneCompactionInterval:Long "Permalink")  val tombstoneCompactionInterval: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)Definition Classes[BaseCompactionStrategy](BaseCompactionStrategy.html)
20. [**](../../../../akka/persistence/cassandra/compaction/LeveledCompactionStrategy.html#tombstoneThreshold:Double "Permalink")  val tombstoneThreshold: [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double)Definition Classes[BaseCompactionStrategy](BaseCompactionStrategy.html)
21. [**](../../../../akka/persistence/cassandra/compaction/LeveledCompactionStrategy.html#uncheckedTombstoneCompaction:Boolean "Permalink")  val uncheckedTombstoneCompaction: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition Classes[BaseCompactionStrategy](BaseCompactionStrategy.html)
22. [**](../../../../akka/persistence/cassandra/compaction/LeveledCompactionStrategy.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../../../akka/persistence/cassandra/compaction/LeveledCompactionStrategy.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../../../akka/persistence/cassandra/compaction/LeveledCompactionStrategy.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
