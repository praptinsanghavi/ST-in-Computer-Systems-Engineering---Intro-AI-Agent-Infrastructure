---
description: Akka 2.10.17 - akka.persistence.ThrowExceptionConfigurator
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:42:13Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/persistence/ThrowExceptionConfigurator.html
title: Akka 2.10.17 - akka.persistence.ThrowExceptionConfigurator
---

# Akka 2.10.17 - akka.persistence.ThrowExceptionConfigurator

> **Summary:** Akka 2.10.17 - akka.persistence.ThrowExceptionConfigurator
...
# ThrowExceptionConfigurator[**](../../akka/persistence/ThrowExceptionConfigurator.html "Permalink")

### 

#### final  class ThrowExceptionConfigurator extends [StashOverflowStrategyConfigurator](StashOverflowStrategyConfigurator.html)

Source[PersistentActor.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-persistence/src/main/scala/akka/persistence/PersistentActor.scala#L156)Linear Supertypes[StashOverflowStrategyConfigurator](StashOverflowStrategyConfigurator.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ThrowExceptionConfigurator
...
1. [**](../../akka/persistence/ThrowExceptionConfigurator.html#<init>():akka.persistence.ThrowExceptionConfigurator "Permalink")  new ThrowExceptionConfigurator()
### Value Members

1. [**](../../akka/persistence/ThrowExceptionConfigurator.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/persistence/ThrowExceptionConfigurator.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/persistence/ThrowExceptionConfigurator.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ThrowExceptionConfigurator toany2stringadd\[ThrowExceptionConfigurator] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/persistence/ThrowExceptionConfigurator.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ThrowExceptionConfigurator, B)ImplicitThis member is added by an implicit conversion from ThrowExceptionConfigurator toArrowAssoc\[ThrowExceptionConfigurator] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/persistence/ThrowExceptionConfigurator.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/persistence/ThrowExceptionConfigurator.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/persistence/ThrowExceptionConfigurator.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/persistence/ThrowExceptionConfigurator.html#create(config:com.typesafe.config.Config):akka.persistence.ThrowOverflowExceptionStrategy.type "Permalink")  def create(config: Config): [ThrowOverflowExceptionStrategy](ThrowOverflowExceptionStrategy$.html)Definition ClassesThrowExceptionConfigurator → [StashOverflowStrategyConfigurator](StashOverflowStrategyConfigurator.html)
9. [**](../../akka/persistence/ThrowExceptionConfigurator.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ThrowExceptionConfigurator) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ThrowExceptionConfiguratorImplicitThis member is added by an implicit conversion from ThrowExceptionConfigurator toEnsuring\[ThrowExceptionConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/persistence/ThrowExceptionConfigurator.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ThrowExceptionConfigurator) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ThrowExceptionConfiguratorImplicitThis member is added by an implicit conversion from ThrowExceptionConfigurator toEnsuring\[ThrowExceptionConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/persistence/ThrowExceptionConfigurator.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ThrowExceptionConfiguratorImplicitThis member is added by an implicit conversion from ThrowExceptionConfigurator toEnsuring\[ThrowExceptionConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/persistence/ThrowExceptionConfigurator.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ThrowExceptionConfiguratorImplicitThis member is added by an implicit conversion from ThrowExceptionConfigurator toEnsuring\[ThrowExceptionConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/persistence/ThrowExceptionConfigurator.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/persistence/ThrowExceptionConfigurator.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
15. [**](../../akka/persistence/ThrowExceptionConfigurator.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/persistence/ThrowExceptionConfigurator.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/persistence/ThrowExceptionConfigurator.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
18. [**](../../akka/persistence/ThrowExceptionConfigurator.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../akka/persistence/ThrowExceptionConfigurator.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/persistence/ThrowExceptionConfigurator.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../akka/persistence/ThrowExceptionConfigurator.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../akka/persistence/ThrowExceptionConfigurator.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
23. [**](../../akka/persistence/ThrowExceptionConfigurator.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../akka/persistence/ThrowExceptionConfigurator.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../akka/persistence/ThrowExceptionConfigurator.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/persistence/ThrowExceptionConfigurator.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/persistence/ThrowExceptionConfigurator.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ThrowExceptionConfigurator toStringFormat\[ThrowExceptionConfigurator] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/persistence/ThrowExceptionConfigurator.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ThrowExceptionConfigurator, B)ImplicitThis member is added by an implicit conversion from ThrowExceptionConfigurator toArrowAssoc\[ThrowExceptionConfigurator] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromThrowExceptionConfigurator to any2stringadd\[ThrowExceptionConfigurator]

### Inherited by implicit conversion StringFormat fromThrowExceptionConfigurator to StringFormat\[ThrowExceptionConfigurator]

### Inherited by implicit conversion Ensuring fromThrowExceptionConfigurator to Ensuring\[ThrowExceptionConfigurator]

### Inherited by implicit conversion ArrowAssoc fromThrowExceptionConfigurator to ArrowAssoc\[ThrowExceptionConfigurator]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/persistence/ThrowExceptionConfigurator.html](https://doc.akka.io/api/akka-core/2.10.17/akka/persistence/ThrowExceptionConfigurator.html)*