...
scraped_at: '2026-04-06T01:50:07Z'
section: api
site: akka-io
...
[o](RetentionCriteria.html "See companion class")[akka](../../../index.html).[persistence](../../index.html).[typed](../index.html).[javadsl](index.html)

# [RetentionCriteria](RetentionCriteria.html "See companion class")[**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html "Permalink")

### Companion [class RetentionCriteria](RetentionCriteria.html "See companion class")

#### object RetentionCriteria

Criteria for retention/deletion of snapshots and events.

Source[RetentionCriteria.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-persistence-typed/src/main/scala/akka/persistence/typed/javadsl/RetentionCriteria.scala#L21)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. RetentionCriteria
2. AnyRef
...
3. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#disabled:akka.persistence.typed.javadsl.RetentionCriteria "Permalink")  val disabled: [RetentionCriteria](RetentionCriteria.html)Snapshots are not saved and deleted automatically, events are not deleted.
7. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
8. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
9. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
10. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
11. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
12. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#snapshotEvery(numberOfEvents:Int):akka.persistence.typed.javadsl.SnapshotCountRetentionCriteria "Permalink")  def snapshotEvery(numberOfEvents: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [SnapshotCountRetentionCriteria](SnapshotCountRetentionCriteria.html)Save snapshots automatically every `numberOfEvents`.

Save snapshots automatically every `numberOfEvents`.

Use [SnapshotCountRetentionCriteria.withDeleteEventsOnSnapshot](SnapshotCountRetentionCriteria.html#withDeleteEventsOnSnapshot:akka.persistence.typed.javadsl.SnapshotCountRetentionCriteria) to
...
16. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#snapshotEvery(numberOfEvents:Int,keepNSnapshots:Int):akka.persistence.typed.javadsl.SnapshotCountRetentionCriteria "Permalink")  def snapshotEvery(numberOfEvents: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), keepNSnapshots: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [SnapshotCountRetentionCriteria](SnapshotCountRetentionCriteria.html)Save snapshots automatically every `numberOfEvents`.
...
If multiple events are persisted with a single Effect, the snapshot will happen after
all of the events are persisted rather than precisely every `numberOfEvents`.
17. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
18. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
19. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
20. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
21. [**](../../../../akka/persistence/typed/javadsl/RetentionCriteria$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
