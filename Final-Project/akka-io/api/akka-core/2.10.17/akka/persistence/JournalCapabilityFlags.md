---
description: Akka 2.10.17 - akka.persistence.JournalCapabilityFlags
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:41:08Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/persistence/JournalCapabilityFlags.html
title: Akka 2.10.17 - akka.persistence.JournalCapabilityFlags
---

# Akka 2.10.17 - akka.persistence.JournalCapabilityFlags

> **Summary:** Akka 2.10.17 - akka.persistence.JournalCapabilityFlags
...
# JournalCapabilityFlags[**](../../akka/persistence/JournalCapabilityFlags.html "Permalink")

### 

#### trait JournalCapabilityFlags extends [CapabilityFlags](CapabilityFlags.html)

Source[CapabilityFlags.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-persistence-tck/src/main/scala/akka/persistence/CapabilityFlags.scala#L41)Linear Supertypes[CapabilityFlags](CapabilityFlags.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[JavaJournalPerfSpec](japi/journal/JavaJournalPerfSpec.html), [JavaJournalSpec](japi/journal/JavaJournalSpec.html), [JournalPerfSpec](journal/JournalPerfSpec.html), [JournalSpec](journal/JournalSpec.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. JournalCapabilityFlags
2. CapabilityFlags
3. AnyRef
4. Any
Implicitly  
...
1. [**](../../akka/persistence/JournalCapabilityFlags.html#supportsMetadata:akka.persistence.CapabilityFlag "Permalink") abstract  def supportsMetadata: [CapabilityFlag](CapabilityFlag.html)When `true` enables tests which check if the Journal stores and returns
...
Attributesprotected
2. [**](../../akka/persistence/JournalCapabilityFlags.html#supportsRejectingNonSerializableObjects:akka.persistence.CapabilityFlag "Permalink") abstract  def supportsRejectingNonSerializableObjects: [CapabilityFlag](CapabilityFlag.html)When `true` enables tests which check if the Journal properly rejects
...
Attributesprotected
3. [**](../../akka/persistence/JournalCapabilityFlags.html#supportsReplayOnlyLast:akka.persistence.CapabilityFlag "Permalink") abstract  def supportsReplayOnlyLast: [CapabilityFlag](CapabilityFlag.html)When `true` enables tests which check if the Journal can replay only the last event.

When `true` enables tests which check if the Journal can replay only the last event.

Attributesprotected
4. [**](../../akka/persistence/JournalCapabilityFlags.html#supportsSerialization:akka.persistence.CapabilityFlag "Permalink") abstract  def supportsSerialization: [CapabilityFlag](CapabilityFlag.html)When `true` enables tests which check if the Journal properly serialize and
deserialize events.
...
1. [**](../../akka/persistence/JournalCapabilityFlags.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/persistence/JournalCapabilityFlags.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/persistence/JournalCapabilityFlags.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from JournalCapabilityFlags toany2stringadd\[JournalCapabilityFlags] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/persistence/JournalCapabilityFlags.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (JournalCapabilityFlags, B)ImplicitThis member is added by an implicit conversion from JournalCapabilityFlags toArrowAssoc\[JournalCapabilityFlags] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/persistence/JournalCapabilityFlags.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/persistence/JournalCapabilityFlags.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/persistence/JournalCapabilityFlags.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/persistence/JournalCapabilityFlags.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (JournalCapabilityFlags) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): JournalCapabilityFlagsImplicitThis member is added by an implicit conversion from JournalCapabilityFlags toEnsuring\[JournalCapabilityFlags] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/persistence/JournalCapabilityFlags.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (JournalCapabilityFlags) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): JournalCapabilityFlagsImplicitThis member is added by an implicit conversion from JournalCapabilityFlags toEnsuring\[JournalCapabilityFlags] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/persistence/JournalCapabilityFlags.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): JournalCapabilityFlagsImplicitThis member is added by an implicit conversion from JournalCapabilityFlags toEnsuring\[JournalCapabilityFlags] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/persistence/JournalCapabilityFlags.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): JournalCapabilityFlagsImplicitThis member is added by an implicit conversion from JournalCapabilityFlags toEnsuring\[JournalCapabilityFlags] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/persistence/JournalCapabilityFlags.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/persistence/JournalCapabilityFlags.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/persistence/JournalCapabilityFlags.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/persistence/JournalCapabilityFlags.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/persistence/JournalCapabilityFlags.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/persistence/JournalCapabilityFlags.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/persistence/JournalCapabilityFlags.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/persistence/JournalCapabilityFlags.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/persistence/JournalCapabilityFlags.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/persistence/JournalCapabilityFlags.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/persistence/JournalCapabilityFlags.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/persistence/JournalCapabilityFlags.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/persistence/JournalCapabilityFlags.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/persistence/JournalCapabilityFlags.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/persistence/JournalCapabilityFlags.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from JournalCapabilityFlags toStringFormat\[JournalCapabilityFlags] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/persistence/JournalCapabilityFlags.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (JournalCapabilityFlags, B)ImplicitThis member is added by an implicit conversion from JournalCapabilityFlags toArrowAssoc\[JournalCapabilityFlags] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromJournalCapabilityFlags to any2stringadd\[JournalCapabilityFlags]

### Inherited by implicit conversion StringFormat fromJournalCapabilityFlags to StringFormat\[JournalCapabilityFlags]

### Inherited by implicit conversion Ensuring fromJournalCapabilityFlags to Ensuring\[JournalCapabilityFlags]

### Inherited by implicit conversion ArrowAssoc fromJournalCapabilityFlags to ArrowAssoc\[JournalCapabilityFlags]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/persistence/JournalCapabilityFlags.html](https://doc.akka.io/api/akka-core/2.10.17/akka/persistence/JournalCapabilityFlags.html)*