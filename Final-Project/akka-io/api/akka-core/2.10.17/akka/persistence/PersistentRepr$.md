...
scraped_at: '2026-04-06T01:41:19Z'
section: api
site: akka-io
...
[o](PersistentRepr.html "See companion trait")[akka](../index.html).[persistence](index.html)

# [PersistentRepr](PersistentRepr.html "See companion trait")[**](../../akka/persistence/PersistentRepr$.html "Permalink")

### Companion [trait PersistentRepr](PersistentRepr.html "See companion trait")

#### object PersistentRepr extends [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)

Source[Persistent.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-persistence/src/main/scala/akka/persistence/Persistent.scala#L155)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. PersistentRepr
2. Serializable
...
3. [**](../../akka/persistence/PersistentRepr$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/persistence/PersistentRepr$.html#Undefined:String "Permalink")  val Undefined: [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Plugin API: value of an undefined persistenceId or manifest.
5. [**](../../akka/persistence/PersistentRepr$.html#UndefinedId:Int "Permalink")  val UndefinedId: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Plugin API: value of an undefined / identity event adapter.
6. [**](../../akka/persistence/PersistentRepr$.html#apply(payload:Any,sequenceNr:Long,persistenceId:String,manifest:String,deleted:Boolean,sender:akka.actor.ActorRef,writerUuid:String):akka.persistence.PersistentRepr "Permalink")  def apply(payload: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any), sequenceNr: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long) \= 0L, persistenceId: String \= PersistentRepr.Undefined, manifest: String \= PersistentRepr.Undefined, deleted: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean) \= false, sender: [ActorRef](../actor/ActorRef.html) \= null, writerUuid: String \= PersistentRepr.Undefined): [PersistentRepr](PersistentRepr.html)Plugin API.
7. [**](../../akka/persistence/PersistentRepr$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
8. [**](../../akka/persistence/PersistentRepr$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../akka/persistence/PersistentRepr$.html#create:(Any,Long,String,String,Boolean,akka.actor.ActorRef,String)=>akka.persistence.PersistentRepr "Permalink")  def create: ([Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any), [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), String, String, [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), [ActorRef](../actor/ActorRef.html), String) \=\> [PersistentRepr](PersistentRepr.html)Java API, Plugin API.
10. [**](../../akka/persistence/PersistentRepr$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
11. [**](../../akka/persistence/PersistentRepr$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
12. [**](../../akka/persistence/PersistentRepr$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../akka/persistence/PersistentRepr$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../akka/persistence/PersistentRepr$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
15. [**](../../akka/persistence/PersistentRepr$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
16. [**](../../akka/persistence/PersistentRepr$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/persistence/PersistentRepr$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/persistence/PersistentRepr$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
19. [**](../../akka/persistence/PersistentRepr$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
20. [**](../../akka/persistence/PersistentRepr$.html#unapply(persistent:akka.persistence.PersistentRepr):Option[(Any,Long)] "Permalink")  def unapply(persistent: [PersistentRepr](PersistentRepr.html)): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[([Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any), [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long))]extractor of payload and sequenceNr.
21. [**](../../akka/persistence/PersistentRepr$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
22. [**](../../akka/persistence/PersistentRepr$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
23. [**](../../akka/persistence/PersistentRepr$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
