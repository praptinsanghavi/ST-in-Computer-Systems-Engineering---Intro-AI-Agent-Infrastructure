---
description: Akka 2.10.17 - akka.persistence.SelectedSnapshot
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:41:50Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/persistence/SelectedSnapshot.html
title: Akka 2.10.17 - akka.persistence.SelectedSnapshot
---

# Akka 2.10.17 - akka.persistence.SelectedSnapshot

> **Summary:** Akka 2.10.17 - akka.persistence.SelectedSnapshot
...
[c](SelectedSnapshot$.html "See companion object")[akka](../index.html).[persistence](index.html)

# [SelectedSnapshot](SelectedSnapshot$.html "See companion object")[**](../../akka/persistence/SelectedSnapshot.html "Permalink")

### Companion [object SelectedSnapshot](SelectedSnapshot$.html "See companion object")

#### final  case class SelectedSnapshot(metadata: [SnapshotMetadata](SnapshotMetadata.html), snapshot: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)) extends [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
...
1. [**](../../akka/persistence/SelectedSnapshot.html#<init>(metadata:akka.persistence.SnapshotMetadata,snapshot:Any):akka.persistence.SelectedSnapshot "Permalink")  new SelectedSnapshot(metadata: [SnapshotMetadata](SnapshotMetadata.html), snapshot: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any))metadatasnapshot metadata.

snapshotsnapshot.
### Value Members

1. [**](../../akka/persistence/SelectedSnapshot.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/persistence/SelectedSnapshot.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/persistence/SelectedSnapshot.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from SelectedSnapshot toany2stringadd\[SelectedSnapshot] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/persistence/SelectedSnapshot.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (SelectedSnapshot, B)ImplicitThis member is added by an implicit conversion from SelectedSnapshot toArrowAssoc\[SelectedSnapshot] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/persistence/SelectedSnapshot.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/persistence/SelectedSnapshot.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/persistence/SelectedSnapshot.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/persistence/SelectedSnapshot.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (SelectedSnapshot) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SelectedSnapshotImplicitThis member is added by an implicit conversion from SelectedSnapshot toEnsuring\[SelectedSnapshot] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/persistence/SelectedSnapshot.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (SelectedSnapshot) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SelectedSnapshotImplicitThis member is added by an implicit conversion from SelectedSnapshot toEnsuring\[SelectedSnapshot] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/persistence/SelectedSnapshot.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SelectedSnapshotImplicitThis member is added by an implicit conversion from SelectedSnapshot toEnsuring\[SelectedSnapshot] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/persistence/SelectedSnapshot.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SelectedSnapshotImplicitThis member is added by an implicit conversion from SelectedSnapshot toEnsuring\[SelectedSnapshot] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/persistence/SelectedSnapshot.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/persistence/SelectedSnapshot.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../akka/persistence/SelectedSnapshot.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
15. [**](../../akka/persistence/SelectedSnapshot.html#metadata:akka.persistence.SnapshotMetadata "Permalink")  val metadata: [SnapshotMetadata](SnapshotMetadata.html)
16. [**](../../akka/persistence/SelectedSnapshot.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/persistence/SelectedSnapshot.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/persistence/SelectedSnapshot.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/persistence/SelectedSnapshot.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
20. [**](../../akka/persistence/SelectedSnapshot.html#snapshot:Any "Permalink")  val snapshot: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)
21. [**](../../akka/persistence/SelectedSnapshot.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../akka/persistence/SelectedSnapshot.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/persistence/SelectedSnapshot.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/persistence/SelectedSnapshot.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/persistence/SelectedSnapshot.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/persistence/SelectedSnapshot.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from SelectedSnapshot toStringFormat\[SelectedSnapshot] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/persistence/SelectedSnapshot.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (SelectedSnapshot, B)ImplicitThis member is added by an implicit conversion from SelectedSnapshot toArrowAssoc\[SelectedSnapshot] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromSelectedSnapshot to any2stringadd\[SelectedSnapshot]

### Inherited by implicit conversion StringFormat fromSelectedSnapshot to StringFormat\[SelectedSnapshot]

### Inherited by implicit conversion Ensuring fromSelectedSnapshot to Ensuring\[SelectedSnapshot]

### Inherited by implicit conversion ArrowAssoc fromSelectedSnapshot to ArrowAssoc\[SelectedSnapshot]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/persistence/SelectedSnapshot.html](https://doc.akka.io/api/akka-core/2.10.17/akka/persistence/SelectedSnapshot.html)*