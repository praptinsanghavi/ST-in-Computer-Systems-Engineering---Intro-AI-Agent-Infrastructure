---
description: Akka 2.10.17 - akka.stream.Attributes
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:31:25Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/Attributes$.html
title: Akka 2.10.17 - akka.stream.Attributes
---

# Akka 2.10.17 - akka.stream.Attributes

> **Summary:** Akka 2.10.17 - akka.stream.Attributes
...
[o](Attributes.html "See companion class")[akka](../index.html).[stream](index.html)

# [Attributes](Attributes.html "See companion class")[**](../../akka/stream/Attributes$.html "Permalink")

### Companion [class Attributes](Attributes.html "See companion class")

#### object Attributes extends [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)

Note that more attributes for the [Materializer](Materializer.html) are defined in [ActorAttributes](ActorAttributes$.html).

Source[Attributes.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/Attributes.scala#L336)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Content Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Attributes
2. Serializable
...
1. [**](../../akka/stream/Attributes$$Attribute.html "Permalink")  trait [Attribute](Attributes$$Attribute.html) extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
2. [**](../../akka/stream/Attributes$$CancellationStrategy.html "Permalink") final  case class [CancellationStrategy](Attributes$$CancellationStrategy.html "Cancellation strategies provide a way to configure the behavior of a stage when cancelStage is called.")(strategy: [Strategy](Attributes$$CancellationStrategy$$Strategy.html)) extends [MandatoryAttribute](Attributes$$MandatoryAttribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableCancellation strategies provide a way to configure the behavior of a stage when `cancelStage` is called.
...
3. [**](../../akka/stream/Attributes$$InputBuffer.html "Permalink") final  case class [InputBuffer](Attributes$$InputBuffer.html "Each asynchronous piece of a materialized stream topology is executed by one Actor that manages an input buffer for all inlets of its shape.")(initial: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), max: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)) extends [MandatoryAttribute](Attributes$$MandatoryAttribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableEach asynchronous piece of a materialized stream topology is executed by one Actor
...
Use factory method [Attributes\#inputBuffer](#inputBuffer(initial:Int,max:Int):akka.stream.Attributes) to create instances.
4. [**](../../akka/stream/Attributes$$LogLevels.html "Permalink") final  case class [LogLevels](Attributes$$LogLevels.html)(onElement: [LogLevel](../event/Logging$$LogLevel.html), onFinish: [LogLevel](../event/Logging$$LogLevel.html), onFailure: [LogLevel](../event/Logging$$LogLevel.html)) extends [Attribute](Attributes$$Attribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
5. [**](../../akka/stream/Attributes$$MandatoryAttribute.html "Permalink") sealed  trait [MandatoryAttribute](Attributes$$MandatoryAttribute.html "Attributes that are always present (is defined with default values by the materializer)") extends [Attribute](Attributes$$Attribute.html)Attributes that are always present (is defined with default values by the materializer)
...
6. [**](../../akka/stream/Attributes$$Name.html "Permalink") final  case class [Name](Attributes$$Name.html)(n: String) extends [Attribute](Attributes$$Attribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
7. [**](../../akka/stream/Attributes$$NestedMaterializationCancellationPolicy.html "Permalink") final  class [NestedMaterializationCancellationPolicy](Attributes$$NestedMaterializationCancellationPolicy.html "Nested materialization cancellation strategy provides a way to configure the cancellation behavior of stages that materialize a nested flow.") extends [MandatoryAttribute](Attributes$$MandatoryAttribute.html)Nested materialization cancellation strategy provides a way to configure the cancellation behavior of stages that materialize a nested flow.
...
8. [**](../../akka/stream/Attributes$$SourceLocation.html "Permalink") final  class [SourceLocation](Attributes$$SourceLocation.html "Attribute that contains the source location of for example a lambda passed to an operator, useful for example for debugging.") extends [Attribute](Attributes$$Attribute.html)Attribute that contains the source location of for example a lambda passed to an operator, useful for example
for debugging.
...
1. [**](../../akka/stream/Attributes$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/Attributes$.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/Attributes$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/stream/Attributes$.html#apply(attribute:akka.stream.Attributes.Attribute):akka.stream.Attributes "Permalink")  def apply(attribute: [Attribute](Attributes$$Attribute.html)): [Attributes](Attributes.html)INTERNAL API
5. [**](../../akka/stream/Attributes$.html#apply(attributeList:List[akka.stream.Attributes.Attribute]):akka.stream.Attributes "Permalink")  def apply(attributeList: List\[[Attribute](Attributes$$Attribute.html)] \= Nil): [Attributes](Attributes.html)Annotations@nowarn()
6. [**](../../akka/stream/Attributes$.html#apply():akka.stream.Attributes "Permalink")  def apply(): [Attributes](Attributes.html)
7. [**](../../akka/stream/Attributes$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
8. [**](../../akka/stream/Attributes$.html#asyncBoundary:akka.stream.Attributes "Permalink")  val asyncBoundary: [Attributes](Attributes.html)
9. [**](../../akka/stream/Attributes$.html#cancellationStrategyAfterDelay(delay:scala.concurrent.duration.FiniteDuration,strategy:akka.stream.Attributes.CancellationStrategy.Strategy):akka.stream.Attributes.CancellationStrategy.Strategy "Permalink")  def cancellationStrategyAfterDelay(delay: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), strategy: [Strategy](Attributes$$CancellationStrategy$$Strategy.html)): [Strategy](Attributes$$CancellationStrategy$$Strategy.html)Java API
...
10. [**](../../akka/stream/Attributes$.html#cancellationStrategyCompleteState:akka.stream.Attributes.CancellationStrategy.Strategy "Permalink")  def cancellationStrategyCompleteState: [Strategy](Attributes$$CancellationStrategy$$Strategy.html)Java API
...
11. [**](../../akka/stream/Attributes$.html#cancellationStrategyFailStage:akka.stream.Attributes.CancellationStrategy.Strategy "Permalink")  def cancellationStrategyFailStage: [Strategy](Attributes$$CancellationStrategy$$Strategy.html)Java API
...
12. [**](../../akka/stream/Attributes$.html#cancellationStrategyPropagateFailure:akka.stream.Attributes.CancellationStrategy.Strategy "Permalink")  def cancellationStrategyPropagateFailure: [Strategy](Attributes$$CancellationStrategy$$Strategy.html)Java API
...
13. [**](../../akka/stream/Attributes$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
14. [**](../../akka/stream/Attributes$.html#createLogLevels(onElement:akka.event.Logging.LogLevel):akka.stream.Attributes "Permalink")  def createLogLevels(onElement: [LogLevel](../event/Logging$$LogLevel.html)): [Attributes](Attributes.html)Java API

Java API

Configures `log()` operator log\-levels to be used when logging onElement.
Logging a certain operation can be completely disabled by using [Attributes\#logLevelOff](#logLevelOff:akka.event.Logging.LogLevel).
15. [**](../../akka/stream/Attributes$.html#createLogLevels(onElement:akka.event.Logging.LogLevel,onFinish:akka.event.Logging.LogLevel,onFailure:akka.event.Logging.LogLevel):akka.stream.Attributes "Permalink")  def createLogLevels(onElement: [LogLevel](../event/Logging$$LogLevel.html), onFinish: [LogLevel](../event/Logging$$LogLevel.html), onFailure: [LogLevel](../event/Logging$$LogLevel.html)): [Attributes](Attributes.html)Java API

Java API

Configures `log()` operator log\-levels to be used when logging.
Logging a certain operation can be completely disabled by using [Attributes\#logLevelOff](#logLevelOff:akka.event.Logging.LogLevel).
16. [**](../../akka/stream/Attributes$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/stream/Attributes$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
18. [**](../../akka/stream/Attributes$.html#extractName(builder:akka.stream.impl.TraversalBuilder,default:String):String "Permalink")  def extractName(builder: TraversalBuilder, default: String): StringCompute a name by concatenating all Name attributes that the given module
has, returning the given default value if none are found.
19. [**](../../akka/stream/Attributes$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/stream/Attributes$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../akka/stream/Attributes$.html#inputBuffer(initial:Int,max:Int):akka.stream.Attributes "Permalink")  def inputBuffer(initial: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), max: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Attributes](Attributes.html)Each asynchronous piece of a materialized stream topology is executed by one Actor
that manages an input buffer for all inlets of its shape.

Each asynchronous piece of a materialized stream topology is executed by one Actor
that manages an input buffer for all inlets of its shape. This attribute configures
the initial and maximal input buffer in number of elements for each inlet.
22. [**](../../akka/stream/Attributes$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
23. [**](../../akka/stream/Attributes$.html#logLevelDebug:akka.event.Logging.LogLevel "Permalink")  def logLevelDebug: [LogLevel](../event/Logging$$LogLevel.html)Java API: Use to enable logging at DEBUG level for certain operations when configuring [Attributes\#createLogLevels](#createLogLevels(onElement:akka.event.Logging.LogLevel):akka.stream.Attributes)
24. [**](../../akka/stream/Attributes$.html#logLevelError:akka.event.Logging.LogLevel "Permalink")  def logLevelError: [LogLevel](../event/Logging$$LogLevel.html)Java API: Use to enable logging at ERROR level for certain operations when configuring [Attributes\#createLogLevels](#createLogLevels(onElement:akka.event.Logging.LogLevel):akka.stream.Attributes)
25. [**](../../akka/stream/Attributes$.html#logLevelInfo:akka.event.Logging.LogLevel "Permalink")  def logLevelInfo: [LogLevel](../event/Logging$$LogLevel.html)Java API: Use to enable logging at INFO level for certain operations when configuring [Attributes\#createLogLevels](#createLogLevels(onElement:akka.event.Logging.LogLevel):akka.stream.Attributes)
26. [**](../../akka/stream/Attributes$.html#logLevelOff:akka.event.Logging.LogLevel "Permalink")  def logLevelOff: [LogLevel](../event/Logging$$LogLevel.html)Java API: Use to disable logging on certain operations when configuring [Attributes\#createLogLevels](#createLogLevels(onElement:akka.event.Logging.LogLevel):akka.stream.Attributes)
27. [**](../../akka/stream/Attributes$.html#logLevelWarning:akka.event.Logging.LogLevel "Permalink")  def logLevelWarning: [LogLevel](../event/Logging$$LogLevel.html)Java API: Use to enable logging at WARNING level for certain operations when configuring [Attributes\#createLogLevels](#createLogLevels(onElement:akka.event.Logging.LogLevel):akka.stream.Attributes)
28. [**](../../akka/stream/Attributes$.html#logLevels(onElement:akka.event.Logging.LogLevel,onFinish:akka.event.Logging.LogLevel,onFailure:akka.event.Logging.LogLevel):akka.stream.Attributes "Permalink")  def logLevels(onElement: [LogLevel](../event/Logging$$LogLevel.html) \= [Logging.DebugLevel](../index.html), onFinish: [LogLevel](../event/Logging$$LogLevel.html) \= [Logging.DebugLevel](../index.html), onFailure: [LogLevel](../event/Logging$$LogLevel.html) \= [Logging.ErrorLevel](../index.html)): [Attributes](Attributes.html)Configures `log()` operator log\-levels to be used when logging.

Configures `log()` operator log\-levels to be used when logging.
Logging a certain operation can be completely disabled by using [LogLevels.Off](Attributes$$LogLevels$.html#Off:akka.event.Logging.LogLevel).

See [Attributes.createLogLevels](#createLogLevels(onElement:akka.event.Logging.LogLevel):akka.stream.Attributes) for Java API
29. [**](../../akka/stream/Attributes$.html#name(name:String):akka.stream.Attributes "Permalink")  def name(name: String): [Attributes](Attributes.html)Specifies the name of the operation.

Specifies the name of the operation.
If the name is null or empty the name is ignored, i.e. [\#none](#none:akka.stream.Attributes) is returned.
30. [**](../../akka/stream/Attributes$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
31. [**](../../akka/stream/Attributes$.html#nestedMaterializationCancellationPolicyDefault():akka.stream.Attributes.NestedMaterializationCancellationPolicy "Permalink")  def nestedMaterializationCancellationPolicyDefault(): [NestedMaterializationCancellationPolicy](Attributes$$NestedMaterializationCancellationPolicy.html)Default [NestedMaterializationCancellationPolicy](Attributes$$NestedMaterializationCancellationPolicy.html),
please see akka.stream.Attributes\#nestedMaterializationCancellationPolicyEagerCancellation() for details.
32. [**](../../akka/stream/Attributes$.html#nestedMaterializationCancellationPolicyEagerCancellation():akka.stream.Attributes.NestedMaterializationCancellationPolicy "Permalink")  def nestedMaterializationCancellationPolicyEagerCancellation(): [NestedMaterializationCancellationPolicy](Attributes$$NestedMaterializationCancellationPolicy.html)Java API
...
33. [**](../../akka/stream/Attributes$.html#nestedMaterializationCancellationPolicyPropagateToNested():akka.stream.Attributes.NestedMaterializationCancellationPolicy "Permalink")  def nestedMaterializationCancellationPolicyPropagateToNested(): [NestedMaterializationCancellationPolicy](Attributes$$NestedMaterializationCancellationPolicy.html)Java API
A [NestedMaterializationCancellationPolicy](Attributes$$NestedMaterializationCancellationPolicy.html) that configures graph stages
...
This applies to [akka.stream.scaladsl.FlowOps.flatMapPrefix](scaladsl/FlowOps.html#flatMapPrefix[Out2,Mat2](n:Int)(f:Seq[Out]=>akka.stream.scaladsl.Flow[Out,Out2,Mat2]):FlowOps.this.Repr[Out2]), [akka.stream.scaladsl.Flow.futureFlow](scaladsl/Flow$.html#futureFlow[I,O,M](flow:scala.concurrent.Future[akka.stream.scaladsl.Flow[I,O,M]]):akka.stream.scaladsl.Flow[I,O,scala.concurrent.Future[M]]) and derived operators.
34. [**](../../akka/stream/Attributes$.html#none:akka.stream.Attributes "Permalink")  val none: [Attributes](Attributes.html)
35. [**](../../akka/stream/Attributes$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
36. [**](../../akka/stream/Attributes$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
37. [**](../../akka/stream/Attributes$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
38. [**](../../akka/stream/Attributes$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
39. [**](../../akka/stream/Attributes$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
40. [**](../../akka/stream/Attributes$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
41. [**](../../akka/stream/Attributes$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
42. [**](../../akka/stream/Attributes$$AsyncBoundary$.html "Permalink")  case object [AsyncBoundary](Attributes$$AsyncBoundary$.html) extends [Attribute](Attributes$$Attribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
43. [**](../../akka/stream/Attributes$$CancellationStrategy$.html "Permalink")  object [CancellationStrategy](Attributes$$CancellationStrategy$.html) extends [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)
44. [**](../../akka/stream/Attributes$$LogLevels$.html "Permalink")  object [LogLevels](Attributes$$LogLevels$.html) extends [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)
45. [**](../../akka/stream/Attributes$$NestedMaterializationCancellationPolicy$.html "Permalink")  object [NestedMaterializationCancellationPolicy](Attributes$$NestedMaterializationCancellationPolicy$.html)
46. [**](../../akka/stream/Attributes$$SourceLocation$.html "Permalink")  object [SourceLocation](Attributes$$SourceLocation$.html)
### Deprecated Value Members

1. [**](../../akka/stream/Attributes$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/stream/Attributes$.html#unapply(attrs:akka.stream.Attributes):Option[List[akka.stream.Attributes.Attribute]] "Permalink")  def unapply(attrs: [Attributes](Attributes.html)): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[List\[[Attribute](Attributes$$Attribute.html)]]Annotations@deprecated Deprecated*(Since version 2\.8\.0\)* Use explicit methods on Attributes to interact, not the synthetic case class ones
...
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Attributes$$AsyncBoundary$.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Attributes$$Attribute.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Attributes$$CancellationStrategy$$Strategy.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Attributes$$CancellationStrategy$.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Attributes$$CancellationStrategy.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Attributes$$InputBuffer.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Attributes$$LogLevels$.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Attributes$$LogLevels.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Attributes$$MandatoryAttribute.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Attributes$$Name.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Attributes$$NestedMaterializationCancellationPolicy$.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Attributes$$NestedMaterializationCancellationPolicy.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Attributes$$SourceLocation$.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Attributes$$SourceLocation.html
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Attributes$.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Attributes$.html)*