---
description: Akka 2.10.17 - akka.stream.StreamRefSettings
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:36:24Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/StreamRefSettings.html
title: Akka 2.10.17 - akka.stream.StreamRefSettings
---

# Akka 2.10.17 - akka.stream.StreamRefSettings

> **Summary:** Akka 2.10.17 - akka.stream.StreamRefSettings
...
[t](StreamRefSettings$.html "See companion object")[akka](../index.html).[stream](index.html)

# [StreamRefSettings](StreamRefSettings$.html "See companion object")[**](../../akka/stream/StreamRefSettings.html "Permalink")

### Companion [object StreamRefSettings](StreamRefSettings$.html "See companion object")

#### trait StreamRefSettings extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
...
1. [**](../../akka/stream/StreamRefSettings.html#withBufferCapacity(value:Int):akka.stream.StreamRefSettings "Permalink") abstract  def withBufferCapacity(value: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): StreamRefSettings
2. [**](../../akka/stream/StreamRefSettings.html#withDemandRedeliveryInterval(value:scala.concurrent.duration.FiniteDuration):akka.stream.StreamRefSettings "Permalink") abstract  def withDemandRedeliveryInterval(value: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): StreamRefSettings
3. [**](../../akka/stream/StreamRefSettings.html#withSubscriptionTimeout(value:scala.concurrent.duration.FiniteDuration):akka.stream.StreamRefSettings "Permalink") abstract  def withSubscriptionTimeout(value: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): StreamRefSettings
4. [**](../../akka/stream/StreamRefSettings.html#withTerminationReceivedBeforeCompletionLeeway(value:scala.concurrent.duration.FiniteDuration):akka.stream.StreamRefSettings "Permalink") abstract  def withTerminationReceivedBeforeCompletionLeeway(value: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): StreamRefSettings
5. [**](../../akka/stream/StreamRefSettings.html#bufferCapacity:Int "Permalink") abstract  def bufferCapacity: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'StreamRefAttributes.BufferCapacity' to read the concrete setting value
6. [**](../../akka/stream/StreamRefSettings.html#demandRedeliveryInterval:scala.concurrent.duration.FiniteDuration "Permalink") abstract  def demandRedeliveryInterval: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'StreamRefAttributes.DemandRedeliveryInterval' to read the concrete setting value
7. [**](../../akka/stream/StreamRefSettings.html#finalTerminationSignalDeadline:scala.concurrent.duration.FiniteDuration "Permalink") abstract  def finalTerminationSignalDeadline: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'StreamRefAttributes.FinalTerminationSignalDeadline' to read the concrete setting value
8. [**](../../akka/stream/StreamRefSettings.html#subscriptionTimeout:scala.concurrent.duration.FiniteDuration "Permalink") abstract  def subscriptionTimeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'StreamRefAttributes.SubscriptionTimeout' to read the concrete setting value
### Concrete Value Members

1. [**](../../akka/stream/StreamRefSettings.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/StreamRefSettings.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/StreamRefSettings.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from StreamRefSettings toany2stringadd\[StreamRefSettings] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/StreamRefSettings.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (StreamRefSettings, B)ImplicitThis member is added by an implicit conversion from StreamRefSettings toArrowAssoc\[StreamRefSettings] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/StreamRefSettings.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/StreamRefSettings.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/stream/StreamRefSettings.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/stream/StreamRefSettings.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (StreamRefSettings) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): StreamRefSettingsImplicitThis member is added by an implicit conversion from StreamRefSettings toEnsuring\[StreamRefSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/stream/StreamRefSettings.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (StreamRefSettings) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): StreamRefSettingsImplicitThis member is added by an implicit conversion from StreamRefSettings toEnsuring\[StreamRefSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/stream/StreamRefSettings.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): StreamRefSettingsImplicitThis member is added by an implicit conversion from StreamRefSettings toEnsuring\[StreamRefSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/stream/StreamRefSettings.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): StreamRefSettingsImplicitThis member is added by an implicit conversion from StreamRefSettings toEnsuring\[StreamRefSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/stream/StreamRefSettings.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/stream/StreamRefSettings.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/stream/StreamRefSettings.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/stream/StreamRefSettings.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/stream/StreamRefSettings.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/stream/StreamRefSettings.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/stream/StreamRefSettings.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/stream/StreamRefSettings.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/stream/StreamRefSettings.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/stream/StreamRefSettings.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/stream/StreamRefSettings.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/stream/StreamRefSettings.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/stream/StreamRefSettings.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/stream/StreamRefSettings.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/stream/StreamRefSettings.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from StreamRefSettings toStringFormat\[StreamRefSettings] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/stream/StreamRefSettings.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (StreamRefSettings, B)ImplicitThis member is added by an implicit conversion from StreamRefSettings toArrowAssoc\[StreamRefSettings] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromStreamRefSettings to any2stringadd\[StreamRefSettings]

### Inherited by implicit conversion StringFormat fromStreamRefSettings to StringFormat\[StreamRefSettings]

### Inherited by implicit conversion Ensuring fromStreamRefSettings to Ensuring\[StreamRefSettings]

### Inherited by implicit conversion ArrowAssoc fromStreamRefSettings to ArrowAssoc\[StreamRefSettings]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/StreamRefSettings.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/StreamRefSettings.html)*