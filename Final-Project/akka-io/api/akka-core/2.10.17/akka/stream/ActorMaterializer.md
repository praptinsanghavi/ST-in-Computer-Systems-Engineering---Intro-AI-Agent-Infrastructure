---
description: Akka 2.10.17 - akka.stream.ActorMaterializer
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:31:14Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/ActorMaterializer.html
title: Akka 2.10.17 - akka.stream.ActorMaterializer
---

# Akka 2.10.17 - akka.stream.ActorMaterializer

> **Summary:** Akka 2.10.17 - akka.stream.ActorMaterializer
...
[c](ActorMaterializer$.html "See companion object")[akka](../index.html).[stream](index.html)

# [ActorMaterializer](ActorMaterializer$.html "See companion object")[**](../../akka/stream/ActorMaterializer.html "Permalink")

### Companion [object ActorMaterializer](ActorMaterializer$.html "See companion object")

#### abstract  class ActorMaterializer extends [Materializer](Materializer.html) with [MaterializerLoggingProvider](MaterializerLoggingProvider.html)
...
Source[ActorMaterializer.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/ActorMaterializer.scala#L209)Linear Supertypes[MaterializerLoggingProvider](MaterializerLoggingProvider.html), [Materializer](Materializer.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ActorMaterializer
...
1. [**](../../akka/stream/ActorMaterializer.html#<init>():akka.stream.ActorMaterializer "Permalink")  new ActorMaterializer()
### Abstract Value Members

1. [**](../../akka/stream/ActorMaterializer.html#executionContext:scala.concurrent.ExecutionContextExecutor "Permalink") implicit abstract  def executionContext: [ExecutionContextExecutor](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContextExecutor.html#scala.concurrent.ExecutionContextExecutor)Running a flow graph will require execution resources, as will computations
within Sources, Sinks, etc.

Running a flow graph will require execution resources, as will computations
within Sources, Sinks, etc. This [scala.concurrent.ExecutionContextExecutor](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContextExecutor.html)
...
Definition Classes[Materializer](Materializer.html)
2. [**](../../akka/stream/ActorMaterializer.html#isShutdown:Boolean "Permalink") abstract  def isShutdown: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Indicates if the materializer has been shut down.

Indicates if the materializer has been shut down.

Definition ClassesActorMaterializer → [Materializer](Materializer.html)
3. [**](../../akka/stream/ActorMaterializer.html#makeLogger(logSource:Class[Any]):akka.event.LoggingAdapter "Permalink") abstract  def makeLogger(logSource: Class\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]): [LoggingAdapter](../event/LoggingAdapter.html)Definition Classes[MaterializerLoggingProvider](MaterializerLoggingProvider.html)
4. [**](../../akka/stream/ActorMaterializer.html#materialize[Mat](runnable:akka.stream.Graph[akka.stream.ClosedShape,Mat],defaultAttributes:akka.stream.Attributes):Mat "Permalink") abstract  def materialize\[Mat](runnable: [Graph](Graph.html)\[[ClosedShape](ClosedShape.html), Mat], defaultAttributes: [Attributes](Attributes.html)): MatThis method interprets the given Flow description and creates the running
stream using an explicitly provided [Attributes](Attributes.html) as top level (least specific) attributes that
...
Definition Classes[Materializer](Materializer.html)
5. [**](../../akka/stream/ActorMaterializer.html#materialize[Mat](runnable:akka.stream.Graph[akka.stream.ClosedShape,Mat]):Mat "Permalink") abstract  def materialize\[Mat](runnable: [Graph](Graph.html)\[[ClosedShape](ClosedShape.html), Mat]): MatThis method interprets the given Flow description and creates the running
stream.
...
Definition Classes[Materializer](Materializer.html)
6. [**](../../akka/stream/ActorMaterializer.html#scheduleAtFixedRate(initialDelay:scala.concurrent.duration.FiniteDuration,interval:scala.concurrent.duration.FiniteDuration,task:Runnable):akka.actor.Cancellable "Permalink") abstract  def scheduleAtFixedRate(initialDelay: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), interval: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), task: [Runnable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Runnable.html#java.lang.Runnable)): [Cancellable](../actor/Cancellable.html)Interface for operators that need timer services for their functionality.
...
returnsA [akka.actor.Cancellable](../actor/Cancellable.html) that allows cancelling the timer. Cancelling is best effort, if the event
 has been already enqueued it will not have an effect.

Definition Classes[Materializer](Materializer.html)Exceptions thrown`IllegalArgumentException` if the given delays exceed the maximum
 supported by the `Scheduler`.
7. [**](../../akka/stream/ActorMaterializer.html#scheduleOnce(delay:scala.concurrent.duration.FiniteDuration,task:Runnable):akka.actor.Cancellable "Permalink") abstract  def scheduleOnce(delay: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), task: [Runnable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Runnable.html#java.lang.Runnable)): [Cancellable](../actor/Cancellable.html)Interface for operators that need timer services for their functionality.
...
Definition Classes[Materializer](Materializer.html)
8. [**](../../akka/stream/ActorMaterializer.html#scheduleWithFixedDelay(initialDelay:scala.concurrent.duration.FiniteDuration,delay:scala.concurrent.duration.FiniteDuration,task:Runnable):akka.actor.Cancellable "Permalink") abstract  def scheduleWithFixedDelay(initialDelay: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), delay: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), task: [Runnable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Runnable.html#java.lang.Runnable)): [Cancellable](../actor/Cancellable.html)Interface for operators that need timer services for their functionality.
...
Definition Classes[Materializer](Materializer.html)Exceptions thrown`IllegalArgumentException` if the given delays exceed the maximum
 supported by the `Scheduler`.
9. [**](../../akka/stream/ActorMaterializer.html#shutdown():Unit "Permalink") abstract  def shutdown(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Shuts down this materializer and all the operators that have been materialized through this materializer.
...
Definition ClassesActorMaterializer → [Materializer](Materializer.html)
10. [**](../../akka/stream/ActorMaterializer.html#system:akka.actor.ActorSystem "Permalink") abstract  def system: [ActorSystem](../actor/ActorSystem.html)INTERNAL API

INTERNAL API

Definition ClassesActorMaterializer → [Materializer](Materializer.html)
11. [**](../../akka/stream/ActorMaterializer.html#withNamePrefix(name:String):akka.stream.Materializer "Permalink") abstract  def withNamePrefix(name: String): [Materializer](Materializer.html)The `namePrefix` shall be used for deriving the names of processing
...
Definition Classes[Materializer](Materializer.html)
12. [**](../../akka/stream/ActorMaterializer.html#schedulePeriodically(initialDelay:scala.concurrent.duration.FiniteDuration,interval:scala.concurrent.duration.FiniteDuration,task:Runnable):akka.actor.Cancellable "Permalink") abstract  def schedulePeriodically(initialDelay: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), interval: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), task: [Runnable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Runnable.html#java.lang.Runnable)): [Cancellable](../actor/Cancellable.html)Interface for operators that need timer services for their functionality.
...
Definition Classes[Materializer](Materializer.html)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use scheduleWithFixedDelay or scheduleAtFixedRate instead. This has the same semantics as scheduleAtFixedRate, but scheduleWithFixedDelay is often preferred.
13. [**](../../akka/stream/ActorMaterializer.html#settings:akka.stream.ActorMaterializerSettings "Permalink") abstract  def settings: [ActorMaterializerSettings](ActorMaterializerSettings.html)Definition ClassesActorMaterializer → [Materializer](Materializer.html)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attributes to access settings from stages, see https://doc.akka.io/libraries/akka\-core/2\.6/project/migration\-guide\-2\.5\.x\-2\.6\.x.html
### Concrete Value Members

1. [**](../../akka/stream/ActorMaterializer.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/ActorMaterializer.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/ActorMaterializer.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ActorMaterializer toany2stringadd\[ActorMaterializer] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/ActorMaterializer.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ActorMaterializer, B)ImplicitThis member is added by an implicit conversion from ActorMaterializer toArrowAssoc\[ActorMaterializer] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/ActorMaterializer.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/ActorMaterializer.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/stream/ActorMaterializer.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/stream/ActorMaterializer.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ActorMaterializer) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ActorMaterializerImplicitThis member is added by an implicit conversion from ActorMaterializer toEnsuring\[ActorMaterializer] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/stream/ActorMaterializer.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ActorMaterializer) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ActorMaterializerImplicitThis member is added by an implicit conversion from ActorMaterializer toEnsuring\[ActorMaterializer] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/stream/ActorMaterializer.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ActorMaterializerImplicitThis member is added by an implicit conversion from ActorMaterializer toEnsuring\[ActorMaterializer] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/stream/ActorMaterializer.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ActorMaterializerImplicitThis member is added by an implicit conversion from ActorMaterializer toEnsuring\[ActorMaterializer] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/stream/ActorMaterializer.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/stream/ActorMaterializer.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/stream/ActorMaterializer.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/stream/ActorMaterializer.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/stream/ActorMaterializer.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/stream/ActorMaterializer.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/stream/ActorMaterializer.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/stream/ActorMaterializer.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/stream/ActorMaterializer.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/stream/ActorMaterializer.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/stream/ActorMaterializer.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/stream/ActorMaterializer.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/stream/ActorMaterializer.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/stream/ActorMaterializer.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/stream/ActorMaterializer.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ActorMaterializer toStringFormat\[ActorMaterializer] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/stream/ActorMaterializer.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ActorMaterializer, B)ImplicitThis member is added by an implicit conversion from ActorMaterializer toArrowAssoc\[ActorMaterializer] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [MaterializerLoggingProvider](MaterializerLoggingProvider.html)

### Inherited from [Materializer](Materializer.html)

### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromActorMaterializer to any2stringadd\[ActorMaterializer]

### Inherited by implicit conversion StringFormat fromActorMaterializer to StringFormat\[ActorMaterializer]

### Inherited by implicit conversion Ensuring fromActorMaterializer to Ensuring\[ActorMaterializer]

### Inherited by implicit conversion ArrowAssoc fromActorMaterializer to ArrowAssoc\[ActorMaterializer]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/ActorMaterializer.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/ActorMaterializer.html)*