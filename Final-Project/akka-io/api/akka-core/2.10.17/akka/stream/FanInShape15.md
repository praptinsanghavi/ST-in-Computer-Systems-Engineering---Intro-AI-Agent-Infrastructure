---
description: Akka 2.10.17 - akka.stream.FanInShape15
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:32:29Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/FanInShape15.html
title: Akka 2.10.17 - akka.stream.FanInShape15
---

# Akka 2.10.17 - akka.stream.FanInShape15

> **Summary:** Akka 2.10.17 - akka.stream.FanInShape15
...
# FanInShape15[**](../../akka/stream/FanInShape15.html "Permalink")

### 

#### class FanInShape15\[\-T0, \-T1, \-T2, \-T3, \-T4, \-T5, \-T6, \-T7, \-T8, \-T9, \-T10, \-T11, \-T12, \-T13, \-T14, \+O] extends [FanInShape](FanInShape.html)\[O]

Source[FanInShapeN.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/target/scala-2.13/src_managed/main/akka/stream/FanInShapeN.scala#L218)Linear Supertypes[FanInShape](FanInShape.html)\[O], [Shape](Shape.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. FanInShape15
2. FanInShape
...
1. [**](../../akka/stream/FanInShape15.html#<init>(in0:akka.stream.Inlet[T0],in1:akka.stream.Inlet[T1],in2:akka.stream.Inlet[T2],in3:akka.stream.Inlet[T3],in4:akka.stream.Inlet[T4],in5:akka.stream.Inlet[T5],in6:akka.stream.Inlet[T6],in7:akka.stream.Inlet[T7],in8:akka.stream.Inlet[T8],in9:akka.stream.Inlet[T9],in10:akka.stream.Inlet[T10],in11:akka.stream.Inlet[T11],in12:akka.stream.Inlet[T12],in13:akka.stream.Inlet[T13],in14:akka.stream.Inlet[T14],out:akka.stream.Outlet[O]):akka.stream.FanInShape15[T0,T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,T13,T14,O] "Permalink")  new FanInShape15(in0: [Inlet](Inlet.html)\[T0], in1: [Inlet](Inlet.html)\[T1], in2: [Inlet](Inlet.html)\[T2], in3: [Inlet](Inlet.html)\[T3], in4: [Inlet](Inlet.html)\[T4], in5: [Inlet](Inlet.html)\[T5], in6: [Inlet](Inlet.html)\[T6], in7: [Inlet](Inlet.html)\[T7], in8: [Inlet](Inlet.html)\[T8], in9: [Inlet](Inlet.html)\[T9], in10: [Inlet](Inlet.html)\[T10], in11: [Inlet](Inlet.html)\[T11], in12: [Inlet](Inlet.html)\[T12], in13: [Inlet](Inlet.html)\[T13], in14: [Inlet](Inlet.html)\[T14], out: [Outlet](Outlet.html)\[O])
2. [**](../../akka/stream/FanInShape15.html#<init>(name:String):akka.stream.FanInShape15[T0,T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,T13,T14,O] "Permalink")  new FanInShape15(name: String)
3. [**](../../akka/stream/FanInShape15.html#<init>(_init:akka.stream.FanInShape.Init[O]):akka.stream.FanInShape15[T0,T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,T13,T14,O] "Permalink")  new FanInShape15(\_init: [Init](FanInShape$$Init.html)\[O])
### Value Members

1. [**](../../akka/stream/FanInShape15.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/FanInShape15.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/FanInShape15.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O] toany2stringadd\[FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/FanInShape15.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O], B)ImplicitThis member is added by an implicit conversion from FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O] toArrowAssoc\[FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/FanInShape15.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/FanInShape15.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/stream/FanInShape15.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/stream/FanInShape15.html#construct(init:akka.stream.FanInShape.Init[O@scala.annotation.unchecked.uncheckedVariance]):akka.stream.FanInShape[O] "Permalink")  def construct(init: [Init](FanInShape$$Init.html)\[O]): [FanInShape](FanInShape.html)\[O]Attributesprotected Definition ClassesFanInShape15 → [FanInShape](FanInShape.html)
9. [**](../../akka/stream/FanInShape15.html#deepCopy():akka.stream.FanInShape15[T0,T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,T13,T14,O] "Permalink")  def deepCopy(): FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]Create a copy of this Shape object, returning the same type as the
...
Definition ClassesFanInShape15 → [FanInShape](FanInShape.html) → [Shape](Shape.html)
10. [**](../../akka/stream/FanInShape15.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]ImplicitThis member is added by an implicit conversion from FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O] toEnsuring\[FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/stream/FanInShape15.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]ImplicitThis member is added by an implicit conversion from FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O] toEnsuring\[FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/stream/FanInShape15.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]ImplicitThis member is added by an implicit conversion from FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O] toEnsuring\[FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/stream/FanInShape15.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]ImplicitThis member is added by an implicit conversion from FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O] toEnsuring\[FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/stream/FanInShape15.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../akka/stream/FanInShape15.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
16. [**](../../akka/stream/FanInShape15.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/stream/FanInShape15.html#getInlets:java.util.List[akka.stream.Inlet[_]] "Permalink")  def getInlets: [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[[Inlet](Inlet.html)\[\_]]Java API: get a list of all input ports

Java API: get a list of all input ports

Definition Classes[Shape](Shape.html)
18. [**](../../akka/stream/FanInShape15.html#getOutlets:java.util.List[akka.stream.Outlet[_]] "Permalink")  def getOutlets: [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[[Outlet](Outlet.html)\[\_]]Java API: get a list of all output ports

Java API: get a list of all output ports

Definition Classes[Shape](Shape.html)
19. [**](../../akka/stream/FanInShape15.html#hasSamePortsAndShapeAs(s:akka.stream.Shape):Boolean "Permalink")  def hasSamePortsAndShapeAs(s: [Shape](Shape.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Compare this to another shape and determine whether the arrangement of ports is the same (including their ordering).

Compare this to another shape and determine whether the arrangement of ports is the same (including their ordering).

Definition Classes[Shape](Shape.html)
20. [**](../../akka/stream/FanInShape15.html#hasSamePortsAs(s:akka.stream.Shape):Boolean "Permalink")  def hasSamePortsAs(s: [Shape](Shape.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Compare this to another shape and determine whether the set of ports is the same (ignoring their ordering).

Compare this to another shape and determine whether the set of ports is the same (ignoring their ordering).

Definition Classes[Shape](Shape.html)
21. [**](../../akka/stream/FanInShape15.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/stream/FanInShape15.html#in0:akka.stream.Inlet[T0@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in0: [Inlet](Inlet.html)\[T0]
23. [**](../../akka/stream/FanInShape15.html#in1:akka.stream.Inlet[T1@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in1: [Inlet](Inlet.html)\[T1]
24. [**](../../akka/stream/FanInShape15.html#in10:akka.stream.Inlet[T10@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in10: [Inlet](Inlet.html)\[T10]
25. [**](../../akka/stream/FanInShape15.html#in11:akka.stream.Inlet[T11@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in11: [Inlet](Inlet.html)\[T11]
26. [**](../../akka/stream/FanInShape15.html#in12:akka.stream.Inlet[T12@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in12: [Inlet](Inlet.html)\[T12]
27. [**](../../akka/stream/FanInShape15.html#in13:akka.stream.Inlet[T13@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in13: [Inlet](Inlet.html)\[T13]
28. [**](../../akka/stream/FanInShape15.html#in14:akka.stream.Inlet[T14@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in14: [Inlet](Inlet.html)\[T14]
29. [**](../../akka/stream/FanInShape15.html#in2:akka.stream.Inlet[T2@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in2: [Inlet](Inlet.html)\[T2]
30. [**](../../akka/stream/FanInShape15.html#in3:akka.stream.Inlet[T3@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in3: [Inlet](Inlet.html)\[T3]
31. [**](../../akka/stream/FanInShape15.html#in4:akka.stream.Inlet[T4@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in4: [Inlet](Inlet.html)\[T4]
32. [**](../../akka/stream/FanInShape15.html#in5:akka.stream.Inlet[T5@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in5: [Inlet](Inlet.html)\[T5]
33. [**](../../akka/stream/FanInShape15.html#in6:akka.stream.Inlet[T6@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in6: [Inlet](Inlet.html)\[T6]
34. [**](../../akka/stream/FanInShape15.html#in7:akka.stream.Inlet[T7@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in7: [Inlet](Inlet.html)\[T7]
35. [**](../../akka/stream/FanInShape15.html#in8:akka.stream.Inlet[T8@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in8: [Inlet](Inlet.html)\[T8]
36. [**](../../akka/stream/FanInShape15.html#in9:akka.stream.Inlet[T9@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in9: [Inlet](Inlet.html)\[T9]
37. [**](../../akka/stream/FanInShape15.html#inlets:Seq[akka.stream.Inlet[_]] "Permalink")  def inlets: [Seq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[[Inlet](Inlet.html)\[\_]]Not meant for overriding outside of Akka.

Not meant for overriding outside of Akka.

Definition Classes[FanInShape](FanInShape.html) → [Shape](Shape.html)
38. [**](../../akka/stream/FanInShape15.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
39. [**](../../akka/stream/FanInShape15.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
40. [**](../../akka/stream/FanInShape15.html#newInlet[T](name:String):akka.stream.Inlet[T] "Permalink")  def newInlet\[T](name: String): [Inlet](Inlet.html)\[T]Attributesprotected Definition Classes[FanInShape](FanInShape.html)
41. [**](../../akka/stream/FanInShape15.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
42. [**](../../akka/stream/FanInShape15.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
43. [**](../../akka/stream/FanInShape15.html#out:akka.stream.Outlet[O@scala.annotation.unchecked.uncheckedVariance] "Permalink") final  def out: [Outlet](Outlet.html)\[O]Definition Classes[FanInShape](FanInShape.html)
44. [**](../../akka/stream/FanInShape15.html#outlets:Seq[akka.stream.Outlet[O@scala.annotation.unchecked.uncheckedVariance]] "Permalink") final  def outlets: [Seq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[[Outlet](Outlet.html)\[O]]Scala API: get a list of all output ports

Scala API: get a list of all output ports

Definition Classes[FanInShape](FanInShape.html) → [Shape](Shape.html)
45. [**](../../akka/stream/FanInShape15.html#requireSamePortsAndShapeAs(s:akka.stream.Shape):Unit "Permalink")  def requireSamePortsAndShapeAs(s: [Shape](Shape.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Asserting version of [\#hasSamePortsAndShapeAs](#hasSamePortsAndShapeAs(s:akka.stream.Shape):Boolean).

Asserting version of [\#hasSamePortsAndShapeAs](#hasSamePortsAndShapeAs(s:akka.stream.Shape):Boolean).

Definition Classes[Shape](Shape.html)
46. [**](../../akka/stream/FanInShape15.html#requireSamePortsAs(s:akka.stream.Shape):Unit "Permalink")  def requireSamePortsAs(s: [Shape](Shape.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Asserting version of [\#hasSamePortsAs](#hasSamePortsAs(s:akka.stream.Shape):Boolean).

Asserting version of [\#hasSamePortsAs](#hasSamePortsAs(s:akka.stream.Shape):Boolean).

Definition Classes[Shape](Shape.html)
47. [**](../../akka/stream/FanInShape15.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
48. [**](../../akka/stream/FanInShape15.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
49. [**](../../akka/stream/FanInShape15.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
50. [**](../../akka/stream/FanInShape15.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
51. [**](../../akka/stream/FanInShape15.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/stream/FanInShape15.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/stream/FanInShape15.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O] toStringFormat\[FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/stream/FanInShape15.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O], B)ImplicitThis member is added by an implicit conversion from FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O] toArrowAssoc\[FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromFanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O] to any2stringadd\[FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]]

### Inherited by implicit conversion StringFormat fromFanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O] to StringFormat\[FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]]

### Inherited by implicit conversion Ensuring fromFanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O] to Ensuring\[FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]]

### Inherited by implicit conversion ArrowAssoc fromFanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O] to ArrowAssoc\[FanInShape15\[T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, O]]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/FanInShape15.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/FanInShape15.html)*