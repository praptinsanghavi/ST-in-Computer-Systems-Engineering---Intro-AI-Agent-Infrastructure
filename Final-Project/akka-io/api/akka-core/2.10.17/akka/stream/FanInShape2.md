---
description: Akka 2.10.17 - akka.stream.FanInShape2
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:32:41Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/FanInShape2.html
title: Akka 2.10.17 - akka.stream.FanInShape2
---

# Akka 2.10.17 - akka.stream.FanInShape2

> **Summary:** Akka 2.10.17 - akka.stream.FanInShape2
...
1. [**](../../akka/stream/FanInShape2.html#<init>(in0:akka.stream.Inlet[T0],in1:akka.stream.Inlet[T1],out:akka.stream.Outlet[O]):akka.stream.FanInShape2[T0,T1,O] "Permalink")  new FanInShape2(in0: [Inlet](Inlet.html)\[T0], in1: [Inlet](Inlet.html)\[T1], out: [Outlet](Outlet.html)\[O])
2. [**](../../akka/stream/FanInShape2.html#<init>(name:String):akka.stream.FanInShape2[T0,T1,O] "Permalink")  new FanInShape2(name: String)
3. [**](../../akka/stream/FanInShape2.html#<init>(_init:akka.stream.FanInShape.Init[O]):akka.stream.FanInShape2[T0,T1,O] "Permalink")  new FanInShape2(\_init: [Init](FanInShape$$Init.html)\[O])
### Value Members

1. [**](../../akka/stream/FanInShape2.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/FanInShape2.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/FanInShape2.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from FanInShape2\[T0, T1, O] toany2stringadd\[FanInShape2\[T0, T1, O]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/FanInShape2.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (FanInShape2\[T0, T1, O], B)ImplicitThis member is added by an implicit conversion from FanInShape2\[T0, T1, O] toArrowAssoc\[FanInShape2\[T0, T1, O]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/FanInShape2.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/FanInShape2.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/stream/FanInShape2.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/stream/FanInShape2.html#construct(init:akka.stream.FanInShape.Init[O@scala.annotation.unchecked.uncheckedVariance]):akka.stream.FanInShape[O] "Permalink")  def construct(init: [Init](FanInShape$$Init.html)\[O]): [FanInShape](FanInShape.html)\[O]Attributesprotected Definition ClassesFanInShape2 → [FanInShape](FanInShape.html)
9. [**](../../akka/stream/FanInShape2.html#deepCopy():akka.stream.FanInShape2[T0,T1,O] "Permalink")  def deepCopy(): FanInShape2\[T0, T1, O]Create a copy of this Shape object, returning the same type as the
...
Definition ClassesFanInShape2 → [FanInShape](FanInShape.html) → [Shape](Shape.html)
10. [**](../../akka/stream/FanInShape2.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (FanInShape2\[T0, T1, O]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): FanInShape2\[T0, T1, O]ImplicitThis member is added by an implicit conversion from FanInShape2\[T0, T1, O] toEnsuring\[FanInShape2\[T0, T1, O]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/stream/FanInShape2.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (FanInShape2\[T0, T1, O]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): FanInShape2\[T0, T1, O]ImplicitThis member is added by an implicit conversion from FanInShape2\[T0, T1, O] toEnsuring\[FanInShape2\[T0, T1, O]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/stream/FanInShape2.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): FanInShape2\[T0, T1, O]ImplicitThis member is added by an implicit conversion from FanInShape2\[T0, T1, O] toEnsuring\[FanInShape2\[T0, T1, O]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/stream/FanInShape2.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): FanInShape2\[T0, T1, O]ImplicitThis member is added by an implicit conversion from FanInShape2\[T0, T1, O] toEnsuring\[FanInShape2\[T0, T1, O]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/stream/FanInShape2.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../akka/stream/FanInShape2.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
16. [**](../../akka/stream/FanInShape2.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/stream/FanInShape2.html#getInlets:java.util.List[akka.stream.Inlet[_]] "Permalink")  def getInlets: [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[[Inlet](Inlet.html)\[\_]]Java API: get a list of all input ports

Java API: get a list of all input ports

Definition Classes[Shape](Shape.html)
18. [**](../../akka/stream/FanInShape2.html#getOutlets:java.util.List[akka.stream.Outlet[_]] "Permalink")  def getOutlets: [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[[Outlet](Outlet.html)\[\_]]Java API: get a list of all output ports

Java API: get a list of all output ports

Definition Classes[Shape](Shape.html)
19. [**](../../akka/stream/FanInShape2.html#hasSamePortsAndShapeAs(s:akka.stream.Shape):Boolean "Permalink")  def hasSamePortsAndShapeAs(s: [Shape](Shape.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Compare this to another shape and determine whether the arrangement of ports is the same (including their ordering).

Compare this to another shape and determine whether the arrangement of ports is the same (including their ordering).

Definition Classes[Shape](Shape.html)
20. [**](../../akka/stream/FanInShape2.html#hasSamePortsAs(s:akka.stream.Shape):Boolean "Permalink")  def hasSamePortsAs(s: [Shape](Shape.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Compare this to another shape and determine whether the set of ports is the same (ignoring their ordering).

Compare this to another shape and determine whether the set of ports is the same (ignoring their ordering).

Definition Classes[Shape](Shape.html)
21. [**](../../akka/stream/FanInShape2.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/stream/FanInShape2.html#in0:akka.stream.Inlet[T0@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in0: [Inlet](Inlet.html)\[T0]
23. [**](../../akka/stream/FanInShape2.html#in1:akka.stream.Inlet[T1@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val in1: [Inlet](Inlet.html)\[T1]
24. [**](../../akka/stream/FanInShape2.html#inlets:Seq[akka.stream.Inlet[_]] "Permalink")  def inlets: [Seq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[[Inlet](Inlet.html)\[\_]]Not meant for overriding outside of Akka.

Not meant for overriding outside of Akka.

Definition Classes[FanInShape](FanInShape.html) → [Shape](Shape.html)
25. [**](../../akka/stream/FanInShape2.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
26. [**](../../akka/stream/FanInShape2.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
27. [**](../../akka/stream/FanInShape2.html#newInlet[T](name:String):akka.stream.Inlet[T] "Permalink")  def newInlet\[T](name: String): [Inlet](Inlet.html)\[T]Attributesprotected Definition Classes[FanInShape](FanInShape.html)
28. [**](../../akka/stream/FanInShape2.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
29. [**](../../akka/stream/FanInShape2.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
30. [**](../../akka/stream/FanInShape2.html#out:akka.stream.Outlet[O@scala.annotation.unchecked.uncheckedVariance] "Permalink") final  def out: [Outlet](Outlet.html)\[O]Definition Classes[FanInShape](FanInShape.html)
31. [**](../../akka/stream/FanInShape2.html#outlets:Seq[akka.stream.Outlet[O@scala.annotation.unchecked.uncheckedVariance]] "Permalink") final  def outlets: [Seq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[[Outlet](Outlet.html)\[O]]Scala API: get a list of all output ports

Scala API: get a list of all output ports

Definition Classes[FanInShape](FanInShape.html) → [Shape](Shape.html)
32. [**](../../akka/stream/FanInShape2.html#requireSamePortsAndShapeAs(s:akka.stream.Shape):Unit "Permalink")  def requireSamePortsAndShapeAs(s: [Shape](Shape.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Asserting version of [\#hasSamePortsAndShapeAs](#hasSamePortsAndShapeAs(s:akka.stream.Shape):Boolean).

Asserting version of [\#hasSamePortsAndShapeAs](#hasSamePortsAndShapeAs(s:akka.stream.Shape):Boolean).

Definition Classes[Shape](Shape.html)
33. [**](../../akka/stream/FanInShape2.html#requireSamePortsAs(s:akka.stream.Shape):Unit "Permalink")  def requireSamePortsAs(s: [Shape](Shape.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Asserting version of [\#hasSamePortsAs](#hasSamePortsAs(s:akka.stream.Shape):Boolean).

Asserting version of [\#hasSamePortsAs](#hasSamePortsAs(s:akka.stream.Shape):Boolean).

Definition Classes[Shape](Shape.html)
34. [**](../../akka/stream/FanInShape2.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
35. [**](../../akka/stream/FanInShape2.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
36. [**](../../akka/stream/FanInShape2.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
37. [**](../../akka/stream/FanInShape2.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
38. [**](../../akka/stream/FanInShape2.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/stream/FanInShape2.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/stream/FanInShape2.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from FanInShape2\[T0, T1, O] toStringFormat\[FanInShape2\[T0, T1, O]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/stream/FanInShape2.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (FanInShape2\[T0, T1, O], B)ImplicitThis member is added by an implicit conversion from FanInShape2\[T0, T1, O] toArrowAssoc\[FanInShape2\[T0, T1, O]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromFanInShape2\[T0, T1, O] to any2stringadd\[FanInShape2\[T0, T1, O]]

### Inherited by implicit conversion StringFormat fromFanInShape2\[T0, T1, O] to StringFormat\[FanInShape2\[T0, T1, O]]

### Inherited by implicit conversion Ensuring fromFanInShape2\[T0, T1, O] to Ensuring\[FanInShape2\[T0, T1, O]]

### Inherited by implicit conversion ArrowAssoc fromFanInShape2\[T0, T1, O] to ArrowAssoc\[FanInShape2\[T0, T1, O]]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/FanInShape2.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/FanInShape2.html)*