---
description: Akka 2.10.17 - akka.stream.IOSettings
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:34:38Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/IOSettings.html
title: Akka 2.10.17 - akka.stream.IOSettings
---

# Akka 2.10.17 - akka.stream.IOSettings

> **Summary:** Akka 2.10.17 - akka.stream.IOSettings
...
[c](IOSettings$.html "See companion object")[akka](../index.html).[stream](index.html)

# [IOSettings](IOSettings$.html "See companion object")[**](../../akka/stream/IOSettings.html "Permalink")

### Companion [object IOSettings](IOSettings$.html "See companion object")

#### final  class IOSettings extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

Annotations@nowarn() Source[ActorMaterializer.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/ActorMaterializer.scala#L725)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. IOSettings
2. AnyRef
...
1. [**](../../akka/stream/IOSettings.html#<init>(tcpWriteBufferSize:Int):akka.stream.IOSettings "Permalink")  new IOSettings(tcpWriteBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int))Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'TcpAttributes.TcpWriteBufferSize' to read the concrete setting value
### Value Members

1. [**](../../akka/stream/IOSettings.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/IOSettings.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/IOSettings.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from IOSettings toany2stringadd\[IOSettings] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/IOSettings.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (IOSettings, B)ImplicitThis member is added by an implicit conversion from IOSettings toArrowAssoc\[IOSettings] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/IOSettings.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/IOSettings.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/stream/IOSettings.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/stream/IOSettings.html#coalesceWrites:Int "Permalink")  val coalesceWrites: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
9. [**](../../akka/stream/IOSettings.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (IOSettings) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): IOSettingsImplicitThis member is added by an implicit conversion from IOSettings toEnsuring\[IOSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/stream/IOSettings.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (IOSettings) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): IOSettingsImplicitThis member is added by an implicit conversion from IOSettings toEnsuring\[IOSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/stream/IOSettings.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): IOSettingsImplicitThis member is added by an implicit conversion from IOSettings toEnsuring\[IOSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/stream/IOSettings.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): IOSettingsImplicitThis member is added by an implicit conversion from IOSettings toEnsuring\[IOSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/stream/IOSettings.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/stream/IOSettings.html#equals(other:Any):Boolean "Permalink")  def equals(other: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesIOSettings → AnyRef → Any
15. [**](../../akka/stream/IOSettings.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/stream/IOSettings.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesIOSettings → AnyRef → Any
17. [**](../../akka/stream/IOSettings.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
18. [**](../../akka/stream/IOSettings.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../akka/stream/IOSettings.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/stream/IOSettings.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../akka/stream/IOSettings.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../akka/stream/IOSettings.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesIOSettings → AnyRef → Any
23. [**](../../akka/stream/IOSettings.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../akka/stream/IOSettings.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../akka/stream/IOSettings.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../akka/stream/IOSettings.html#withCoalesceWrites(value:Int):akka.stream.IOSettings "Permalink")  def withCoalesceWrites(value: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): IOSettings
27. [**](../../akka/stream/IOSettings.html#withTcpWriteBufferSize(value:Int):akka.stream.IOSettings "Permalink")  def withTcpWriteBufferSize(value: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): IOSettings
### Deprecated Value Members

1. [**](../../akka/stream/IOSettings.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/stream/IOSettings.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from IOSettings toStringFormat\[IOSettings] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/stream/IOSettings.html#tcpWriteBufferSize:Int "Permalink")  val tcpWriteBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'TcpAttributes.TcpWriteBufferSize' to read the concrete setting value
4. [**](../../akka/stream/IOSettings.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (IOSettings, B)ImplicitThis member is added by an implicit conversion from IOSettings toArrowAssoc\[IOSettings] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromIOSettings to any2stringadd\[IOSettings]

### Inherited by implicit conversion StringFormat fromIOSettings to StringFormat\[IOSettings]

### Inherited by implicit conversion Ensuring fromIOSettings to Ensuring\[IOSettings]

### Inherited by implicit conversion ArrowAssoc fromIOSettings to ArrowAssoc\[IOSettings]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/IOSettings.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/IOSettings.html)*