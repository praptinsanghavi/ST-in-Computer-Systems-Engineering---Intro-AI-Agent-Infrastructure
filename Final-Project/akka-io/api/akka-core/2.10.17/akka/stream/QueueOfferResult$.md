...
scraped_at: '2026-04-06T01:35:25Z'
section: api
site: akka-io
...
[o](QueueOfferResult.html "See companion class")[akka](../index.html).[stream](index.html)

# [QueueOfferResult](QueueOfferResult.html "See companion class")[**](../../akka/stream/QueueOfferResult$.html "Permalink")

### Companion [class QueueOfferResult](QueueOfferResult.html "See companion class")

#### object QueueOfferResult

Contains types that is used as return types for streams Source queues

Source[QueueOfferResult.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/QueueOfferResult.scala#L30)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. QueueOfferResult
2. AnyRef
...
1. [**](../../akka/stream/QueueOfferResult$$Failure.html "Permalink") final  case class [Failure](QueueOfferResult$$Failure.html "Type is used to indicate that stream is failed before or during call to the stream")(cause: Throwable) extends [QueueCompletionResult](QueueCompletionResult.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableType is used to indicate that stream is failed before or during call to the stream

Type is used to indicate that stream is failed before or during call to the stream

cause\- exception that stream failed with
### Value Members
...
3. [**](../../akka/stream/QueueOfferResult$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/stream/QueueOfferResult$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../akka/stream/QueueOfferResult$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../akka/stream/QueueOfferResult$.html#dropped:akka.stream.QueueOfferResult "Permalink")  def dropped: [QueueOfferResult](QueueOfferResult.html)Java API: The `Dropped` singleton instance
7. [**](../../akka/stream/QueueOfferResult$.html#enqueued:akka.stream.QueueOfferResult "Permalink")  def enqueued: [QueueOfferResult](QueueOfferResult.html)Java API: The `Enqueued` singleton instance
8. [**](../../akka/stream/QueueOfferResult$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
9. [**](../../akka/stream/QueueOfferResult$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
10. [**](../../akka/stream/QueueOfferResult$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
11. [**](../../akka/stream/QueueOfferResult$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
12. [**](../../akka/stream/QueueOfferResult$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
13. [**](../../akka/stream/QueueOfferResult$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/stream/QueueOfferResult$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/stream/QueueOfferResult$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/stream/QueueOfferResult$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
17. [**](../../akka/stream/QueueOfferResult$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
18. [**](../../akka/stream/QueueOfferResult$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
19. [**](../../akka/stream/QueueOfferResult$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
20. [**](../../akka/stream/QueueOfferResult$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
21. [**](../../akka/stream/QueueOfferResult$$Dropped$.html "Permalink")  case object [Dropped](QueueOfferResult$$Dropped$.html "Type is used to indicate that stream is dropped an element") extends [QueueOfferResult](QueueOfferResult.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableType is used to indicate that stream is dropped an element
22. [**](../../akka/stream/QueueOfferResult$$Enqueued$.html "Permalink")  case object [Enqueued](QueueOfferResult$$Enqueued$.html "Type is used to indicate that stream is successfully enqueued an element") extends [QueueOfferResult](QueueOfferResult.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableType is used to indicate that stream is successfully enqueued an element
23. [**](../../akka/stream/QueueOfferResult$$QueueClosed$.html "Permalink")  case object [QueueClosed](QueueOfferResult$$QueueClosed$.html "Type is used to indicate that stream is completed before call") extends [QueueCompletionResult](QueueCompletionResult.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableType is used to indicate that stream is completed before call
