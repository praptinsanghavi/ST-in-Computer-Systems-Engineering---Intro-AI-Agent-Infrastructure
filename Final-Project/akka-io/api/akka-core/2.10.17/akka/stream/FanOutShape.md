---
description: Akka 2.10.17 - akka.stream.FanOutShape
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:33:16Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/FanOutShape.html
title: Akka 2.10.17 - akka.stream.FanOutShape
---

# Akka 2.10.17 - akka.stream.FanOutShape

> **Summary:** Akka 2.10.17 - akka.stream.FanOutShape
...
1. [**](../../akka/stream/FanOutShape.html#<init>(init:akka.stream.FanOutShape.Init[I]):akka.stream.FanOutShape[I] "Permalink")  new FanOutShape(init: [Init](FanOutShape$$Init.html)\[I])
### Abstract Value Members

1. [**](../../akka/stream/FanOutShape.html#construct(init:akka.stream.FanOutShape.Init[I@scala.annotation.unchecked.uncheckedVariance]):akka.stream.FanOutShape[I] "Permalink") abstract  def construct(init: [Init](FanOutShape$$Init.html)\[I]): FanOutShape\[I]Attributesprotected
### Concrete Value Members

1. [**](../../akka/stream/FanOutShape.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/FanOutShape.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/FanOutShape.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from FanOutShape\[I] toany2stringadd\[FanOutShape\[I]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/FanOutShape.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (FanOutShape\[I], B)ImplicitThis member is added by an implicit conversion from FanOutShape\[I] toArrowAssoc\[FanOutShape\[I]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/FanOutShape.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/FanOutShape.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/stream/FanOutShape.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/stream/FanOutShape.html#deepCopy():akka.stream.FanOutShape[I] "Permalink")  def deepCopy(): FanOutShape\[I]Create a copy of this Shape object, returning the same type as the
...
Definition ClassesFanOutShape → [Shape](Shape.html)
9. [**](../../akka/stream/FanOutShape.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (FanOutShape\[I]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): FanOutShape\[I]ImplicitThis member is added by an implicit conversion from FanOutShape\[I] toEnsuring\[FanOutShape\[I]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/stream/FanOutShape.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (FanOutShape\[I]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): FanOutShape\[I]ImplicitThis member is added by an implicit conversion from FanOutShape\[I] toEnsuring\[FanOutShape\[I]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/stream/FanOutShape.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): FanOutShape\[I]ImplicitThis member is added by an implicit conversion from FanOutShape\[I] toEnsuring\[FanOutShape\[I]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/stream/FanOutShape.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): FanOutShape\[I]ImplicitThis member is added by an implicit conversion from FanOutShape\[I] toEnsuring\[FanOutShape\[I]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/stream/FanOutShape.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/stream/FanOutShape.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
15. [**](../../akka/stream/FanOutShape.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/stream/FanOutShape.html#getInlets:java.util.List[akka.stream.Inlet[_]] "Permalink")  def getInlets: [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[[Inlet](Inlet.html)\[\_]]Java API: get a list of all input ports

Java API: get a list of all input ports

Definition Classes[Shape](Shape.html)
17. [**](../../akka/stream/FanOutShape.html#getOutlets:java.util.List[akka.stream.Outlet[_]] "Permalink")  def getOutlets: [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[[Outlet](Outlet.html)\[\_]]Java API: get a list of all output ports

Java API: get a list of all output ports

Definition Classes[Shape](Shape.html)
18. [**](../../akka/stream/FanOutShape.html#hasSamePortsAndShapeAs(s:akka.stream.Shape):Boolean "Permalink")  def hasSamePortsAndShapeAs(s: [Shape](Shape.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Compare this to another shape and determine whether the arrangement of ports is the same (including their ordering).

Compare this to another shape and determine whether the arrangement of ports is the same (including their ordering).

Definition Classes[Shape](Shape.html)
19. [**](../../akka/stream/FanOutShape.html#hasSamePortsAs(s:akka.stream.Shape):Boolean "Permalink")  def hasSamePortsAs(s: [Shape](Shape.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Compare this to another shape and determine whether the set of ports is the same (ignoring their ordering).

Compare this to another shape and determine whether the set of ports is the same (ignoring their ordering).

Definition Classes[Shape](Shape.html)
20. [**](../../akka/stream/FanOutShape.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../akka/stream/FanOutShape.html#in:akka.stream.Inlet[I@scala.annotation.unchecked.uncheckedVariance] "Permalink") final  def in: [Inlet](Inlet.html)\[I]
22. [**](../../akka/stream/FanOutShape.html#inlets:Seq[akka.stream.Inlet[I@scala.annotation.unchecked.uncheckedVariance]] "Permalink") final  def inlets: [Seq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[[Inlet](Inlet.html)\[I]]Scala API: get a list of all input ports

Scala API: get a list of all input ports

Definition ClassesFanOutShape → [Shape](Shape.html)
23. [**](../../akka/stream/FanOutShape.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
24. [**](../../akka/stream/FanOutShape.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
25. [**](../../akka/stream/FanOutShape.html#newOutlet[T](name:String):akka.stream.Outlet[T] "Permalink")  def newOutlet\[T](name: String): [Outlet](Outlet.html)\[T]Attributesprotected
26. [**](../../akka/stream/FanOutShape.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
27. [**](../../akka/stream/FanOutShape.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
28. [**](../../akka/stream/FanOutShape.html#outlets:Seq[akka.stream.Outlet[_]] "Permalink")  def outlets: [Seq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[[Outlet](Outlet.html)\[\_]]Not meant for overriding outside of Akka.

Not meant for overriding outside of Akka.

Definition ClassesFanOutShape → [Shape](Shape.html)
29. [**](../../akka/stream/FanOutShape.html#requireSamePortsAndShapeAs(s:akka.stream.Shape):Unit "Permalink")  def requireSamePortsAndShapeAs(s: [Shape](Shape.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Asserting version of [\#hasSamePortsAndShapeAs](#hasSamePortsAndShapeAs(s:akka.stream.Shape):Boolean).

Asserting version of [\#hasSamePortsAndShapeAs](#hasSamePortsAndShapeAs(s:akka.stream.Shape):Boolean).

Definition Classes[Shape](Shape.html)
30. [**](../../akka/stream/FanOutShape.html#requireSamePortsAs(s:akka.stream.Shape):Unit "Permalink")  def requireSamePortsAs(s: [Shape](Shape.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Asserting version of [\#hasSamePortsAs](#hasSamePortsAs(s:akka.stream.Shape):Boolean).

Asserting version of [\#hasSamePortsAs](#hasSamePortsAs(s:akka.stream.Shape):Boolean).

Definition Classes[Shape](Shape.html)
31. [**](../../akka/stream/FanOutShape.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
32. [**](../../akka/stream/FanOutShape.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
33. [**](../../akka/stream/FanOutShape.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
34. [**](../../akka/stream/FanOutShape.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
35. [**](../../akka/stream/FanOutShape.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/stream/FanOutShape.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/stream/FanOutShape.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from FanOutShape\[I] toStringFormat\[FanOutShape\[I]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/stream/FanOutShape.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (FanOutShape\[I], B)ImplicitThis member is added by an implicit conversion from FanOutShape\[I] toArrowAssoc\[FanOutShape\[I]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromFanOutShape\[I] to any2stringadd\[FanOutShape\[I]]

### Inherited by implicit conversion StringFormat fromFanOutShape\[I] to StringFormat\[FanOutShape\[I]]

### Inherited by implicit conversion Ensuring fromFanOutShape\[I] to Ensuring\[FanOutShape\[I]]

### Inherited by implicit conversion ArrowAssoc fromFanOutShape\[I] to ArrowAssoc\[FanOutShape\[I]]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/FanOutShape.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/FanOutShape.html)*