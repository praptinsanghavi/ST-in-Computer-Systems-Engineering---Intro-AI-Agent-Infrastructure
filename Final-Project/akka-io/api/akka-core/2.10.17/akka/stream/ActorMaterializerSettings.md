---
description: Akka 2.10.17 - akka.stream.ActorMaterializerSettings
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:31:21Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/ActorMaterializerSettings.html
title: Akka 2.10.17 - akka.stream.ActorMaterializerSettings
---

# Akka 2.10.17 - akka.stream.ActorMaterializerSettings

> **Summary:** Akka 2.10.17 - akka.stream.ActorMaterializerSettings
...
[c](ActorMaterializerSettings$.html "See companion object")[akka](../index.html).[stream](index.html)

# [ActorMaterializerSettings](ActorMaterializerSettings$.html "See companion object")[**](../../akka/stream/ActorMaterializerSettings.html "Permalink")

### Companion [object ActorMaterializerSettings](ActorMaterializerSettings$.html "See companion object")

#### final  class ActorMaterializerSettings extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
...
Annotations@nowarn() Source[ActorMaterializer.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/ActorMaterializer.scala#L432)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/stream/ActorMaterializerSettings.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/ActorMaterializerSettings.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/ActorMaterializerSettings.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ActorMaterializerSettings toany2stringadd\[ActorMaterializerSettings] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/ActorMaterializerSettings.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ActorMaterializerSettings, B)ImplicitThis member is added by an implicit conversion from ActorMaterializerSettings toArrowAssoc\[ActorMaterializerSettings] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/ActorMaterializerSettings.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/ActorMaterializerSettings.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/stream/ActorMaterializerSettings.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/stream/ActorMaterializerSettings.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ActorMaterializerSettings) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ActorMaterializerSettingsImplicitThis member is added by an implicit conversion from ActorMaterializerSettings toEnsuring\[ActorMaterializerSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/stream/ActorMaterializerSettings.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ActorMaterializerSettings) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ActorMaterializerSettingsImplicitThis member is added by an implicit conversion from ActorMaterializerSettings toEnsuring\[ActorMaterializerSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/stream/ActorMaterializerSettings.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ActorMaterializerSettingsImplicitThis member is added by an implicit conversion from ActorMaterializerSettings toEnsuring\[ActorMaterializerSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/stream/ActorMaterializerSettings.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ActorMaterializerSettingsImplicitThis member is added by an implicit conversion from ActorMaterializerSettings toEnsuring\[ActorMaterializerSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/stream/ActorMaterializerSettings.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/stream/ActorMaterializerSettings.html#equals(other:Any):Boolean "Permalink")  def equals(other: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesActorMaterializerSettings → AnyRef → Any
14. [**](../../akka/stream/ActorMaterializerSettings.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/stream/ActorMaterializerSettings.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/stream/ActorMaterializerSettings.html#ioSettings:akka.stream.IOSettings "Permalink")  val ioSettings: [IOSettings](IOSettings.html)
17. [**](../../akka/stream/ActorMaterializerSettings.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
18. [**](../../akka/stream/ActorMaterializerSettings.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../akka/stream/ActorMaterializerSettings.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/stream/ActorMaterializerSettings.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../akka/stream/ActorMaterializerSettings.html#streamRefSettings:akka.stream.StreamRefSettings "Permalink")  val streamRefSettings: [StreamRefSettings](StreamRefSettings.html)
22. [**](../../akka/stream/ActorMaterializerSettings.html#subscriptionTimeoutSettings:akka.stream.StreamSubscriptionTimeoutSettings "Permalink")  val subscriptionTimeoutSettings: [StreamSubscriptionTimeoutSettings](StreamSubscriptionTimeoutSettings.html)
23. [**](../../akka/stream/ActorMaterializerSettings.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
24. [**](../../akka/stream/ActorMaterializerSettings.html#toString():String "Permalink")  def toString(): StringDefinition ClassesActorMaterializerSettings → AnyRef → Any
25. [**](../../akka/stream/ActorMaterializerSettings.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../akka/stream/ActorMaterializerSettings.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
27. [**](../../akka/stream/ActorMaterializerSettings.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../akka/stream/ActorMaterializerSettings.html#withIOSettings(ioSettings:akka.stream.IOSettings):akka.stream.ActorMaterializerSettings "Permalink")  def withIOSettings(ioSettings: [IOSettings](IOSettings.html)): ActorMaterializerSettings
29. [**](../../akka/stream/ActorMaterializerSettings.html#withStreamRefSettings(streamRefSettings:akka.stream.StreamRefSettings):akka.stream.ActorMaterializerSettings "Permalink")  def withStreamRefSettings(streamRefSettings: [StreamRefSettings](StreamRefSettings.html)): ActorMaterializerSettingsChange settings specific to [SourceRef](SourceRef.html) and [SinkRef](SinkRef.html).
30. [**](../../akka/stream/ActorMaterializerSettings.html#withSubscriptionTimeoutSettings(settings:akka.stream.StreamSubscriptionTimeoutSettings):akka.stream.ActorMaterializerSettings "Permalink")  def withSubscriptionTimeoutSettings(settings: [StreamSubscriptionTimeoutSettings](StreamSubscriptionTimeoutSettings.html)): ActorMaterializerSettingsLeaked publishers and subscribers are cleaned up when they are not used within a given
deadline, configured by [StreamSubscriptionTimeoutSettings](StreamSubscriptionTimeoutSettings.html).
### Deprecated Value Members

1. [**](../../akka/stream/ActorMaterializerSettings.html#autoFusing:Boolean "Permalink")  val autoFusing: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* No longer has any effect
2. [**](../../akka/stream/ActorMaterializerSettings.html#blockingIoDispatcher:String "Permalink")  val blockingIoDispatcher: StringAnnotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.BlockingIoDispatcher' to read the concrete setting value
3. [**](../../akka/stream/ActorMaterializerSettings.html#debugLogging:Boolean "Permalink")  val debugLogging: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.DebugLogging' to read the concrete setting value
4. [**](../../akka/stream/ActorMaterializerSettings.html#dispatcher:String "Permalink")  val dispatcher: StringAnnotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.Dispatcher' to read the concrete setting value
5. [**](../../akka/stream/ActorMaterializerSettings.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
6. [**](../../akka/stream/ActorMaterializerSettings.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ActorMaterializerSettings toStringFormat\[ActorMaterializerSettings] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
7. [**](../../akka/stream/ActorMaterializerSettings.html#fuzzingMode:Boolean "Permalink")  val fuzzingMode: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.FuzzingMode' to read the concrete setting value
8. [**](../../akka/stream/ActorMaterializerSettings.html#initialInputBufferSize:Int "Permalink")  val initialInputBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'Attributes.InputBuffer' to read the concrete setting value
9. [**](../../akka/stream/ActorMaterializerSettings.html#maxFixedBufferSize:Int "Permalink")  val maxFixedBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.MaxFixedBufferSize' to read the concrete setting value
10. [**](../../akka/stream/ActorMaterializerSettings.html#maxInputBufferSize:Int "Permalink")  val maxInputBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'Attributes.InputBuffer' to read the concrete setting value
11. [**](../../akka/stream/ActorMaterializerSettings.html#outputBurstLimit:Int "Permalink")  val outputBurstLimit: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.OutputBurstLimit' to read the concrete setting value
12. [**](../../akka/stream/ActorMaterializerSettings.html#supervisionDecider:akka.stream.Supervision.Decider "Permalink")  val supervisionDecider: [Decider](Supervision$.html#Decider=Function[Throwable,akka.stream.Supervision.Directive])Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.SupervisionStrategy' to read the concrete setting value
13. [**](../../akka/stream/ActorMaterializerSettings.html#syncProcessingLimit:Int "Permalink")  val syncProcessingLimit: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.SyncProcessingLimit' to read the concrete setting value
14. [**](../../akka/stream/ActorMaterializerSettings.html#withBlockingIoDispatcher(newBlockingIoDispatcher:String):akka.stream.ActorMaterializerSettings "Permalink")  def withBlockingIoDispatcher(newBlockingIoDispatcher: String): ActorMaterializerSettingsAnnotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.BlockingIoDispatcher' to change setting value
15. [**](../../akka/stream/ActorMaterializerSettings.html#withDebugLogging(enable:Boolean):akka.stream.ActorMaterializerSettings "Permalink")  def withDebugLogging(enable: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ActorMaterializerSettingsEnable to log all elements that are dropped due to failures (at DEBUG level).

Enable to log all elements that are dropped due to failures (at DEBUG level).

Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.DebugLogging' to change setting value
16. [**](../../akka/stream/ActorMaterializerSettings.html#withDispatcher(dispatcher:String):akka.stream.ActorMaterializerSettings "Permalink")  def withDispatcher(dispatcher: String): ActorMaterializerSettingsThis setting configures the default dispatcher to be used by streams materialized
with the [ActorMaterializer](ActorMaterializer.html).

This setting configures the default dispatcher to be used by streams materialized
with the [ActorMaterializer](ActorMaterializer.html). This can be overridden for individual parts of the
stream topology by using akka.stream.Attributes\#dispatcher.

Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.Dispatcher' to change setting value
17. [**](../../akka/stream/ActorMaterializerSettings.html#withFuzzing(enable:Boolean):akka.stream.ActorMaterializerSettings "Permalink")  def withFuzzing(enable: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ActorMaterializerSettingsTest utility: fuzzing mode means that GraphStage events are not processed
...
Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.FuzzingMode' to change setting value
18. [**](../../akka/stream/ActorMaterializerSettings.html#withInputBuffer(initialSize:Int,maxSize:Int):akka.stream.ActorMaterializerSettings "Permalink")  def withInputBuffer(initialSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), maxSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): ActorMaterializerSettingsEach asynchronous piece of a materialized stream topology is executed by one Actor
...
stream topology by using [akka.stream.Attributes\#inputBuffer](Attributes$.html#inputBuffer(initial:Int,max:Int):akka.stream.Attributes).
...
Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'Attributes.InputBuffer' to change setting value
19. [**](../../akka/stream/ActorMaterializerSettings.html#withMaxFixedBufferSize(size:Int):akka.stream.ActorMaterializerSettings "Permalink")  def withMaxFixedBufferSize(size: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): ActorMaterializerSettingsConfigure the maximum buffer size for which a FixedSizeBuffer will be preallocated.
...
Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.MaxFixedBufferSize' to change setting value
20. [**](../../akka/stream/ActorMaterializerSettings.html#withOutputBurstLimit(limit:Int):akka.stream.ActorMaterializerSettings "Permalink")  def withOutputBurstLimit(limit: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): ActorMaterializerSettingsMaximum number of elements emitted in batch if downstream signals large demand.

Maximum number of elements emitted in batch if downstream signals large demand.

Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.OutputBurstLimit' to change setting value
21. [**](../../akka/stream/ActorMaterializerSettings.html#withSupervisionStrategy(decider:akka.japi.function.Function[Throwable,akka.stream.Supervision.Directive]):akka.stream.ActorMaterializerSettings "Permalink")  def withSupervisionStrategy(decider: [Function](../japi/function/Function.html)\[Throwable, [Directive](Supervision$$Directive.html)]): ActorMaterializerSettingsJava API: Decides how exceptions from application code are to be handled, unless
...
Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.SupervisionStrategy' to change setting value
22. [**](../../akka/stream/ActorMaterializerSettings.html#withSupervisionStrategy(decider:akka.stream.Supervision.Decider):akka.stream.ActorMaterializerSettings "Permalink")  def withSupervisionStrategy(decider: [Decider](Supervision$.html#Decider=Function[Throwable,akka.stream.Supervision.Directive])): ActorMaterializerSettingsScala API: Decides how exceptions from application code are to be handled, unless
overridden for specific flows of the stream operations with
akka.stream.Attributes\#supervisionStrategy.
...
Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.supervisionStrategy' to change setting value
23. [**](../../akka/stream/ActorMaterializerSettings.html#withSyncProcessingLimit(limit:Int):akka.stream.ActorMaterializerSettings "Permalink")  def withSyncProcessingLimit(limit: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): ActorMaterializerSettingsLimit for number of messages that can be processed synchronously in stream to substream communication

Limit for number of messages that can be processed synchronously in stream to substream communication

Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.SyncProcessingLimit' to change setting value
24. [**](../../akka/stream/ActorMaterializerSettings.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ActorMaterializerSettings, B)ImplicitThis member is added by an implicit conversion from ActorMaterializerSettings toArrowAssoc\[ActorMaterializerSettings] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromActorMaterializerSettings to any2stringadd\[ActorMaterializerSettings]

### Inherited by implicit conversion StringFormat fromActorMaterializerSettings to StringFormat\[ActorMaterializerSettings]

### Inherited by implicit conversion Ensuring fromActorMaterializerSettings to Ensuring\[ActorMaterializerSettings]

### Inherited by implicit conversion ArrowAssoc fromActorMaterializerSettings to ArrowAssoc\[ActorMaterializerSettings]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/ActorMaterializerSettings.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/ActorMaterializerSettings.html)*