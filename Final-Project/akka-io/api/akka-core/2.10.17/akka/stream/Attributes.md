...
scraped_at: '2026-04-06T01:31:27Z'
section: api
site: akka-io
...
[c](Attributes$.html "See companion object")[akka](../index.html).[stream](index.html)

# [Attributes](Attributes$.html "See companion object")[**](../../akka/stream/Attributes.html "Permalink")

### Companion [object Attributes](Attributes$.html "See companion object")

#### final  class Attributes extends [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable with [Equals](https://www.scala-lang.org/api/2.13.17/scala/Equals.html#scala.Equals)
...
1. [**](../../akka/stream/Attributes.html#<init>(attributeList:List[akka.stream.Attributes.Attribute]):akka.stream.Attributes "Permalink")  new Attributes(attributeList: List\[[Attribute](Attributes$$Attribute.html)] \= Nil)Annotations@deprecated Deprecated*(Since version 2\.8\.0\)* Use factories on companion object instead
### Value Members
...
3. [**](../../akka/stream/Attributes.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from Attributes toany2stringadd\[Attributes] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/Attributes.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (Attributes, B)ImplicitThis member is added by an implicit conversion from Attributes toArrowAssoc\[Attributes] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/Attributes.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/Attributes.html#and(other:akka.stream.Attributes.Attribute):akka.stream.Attributes "Permalink")  def and(other: [Attribute](Attributes$$Attribute.html)): AttributesAdds given attribute.

Adds given attribute. Added attribute is considered more specific than
already existing attributes of the same type.
7. [**](../../akka/stream/Attributes.html#and(other:akka.stream.Attributes):akka.stream.Attributes "Permalink")  def and(other: Attributes): AttributesAdds given attributes.

Adds given attributes. Added attributes are considered more specific than
already existing attributes of the same type.
8. [**](../../akka/stream/Attributes.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
9. [**](../../akka/stream/Attributes.html#attributeList:List[akka.stream.Attributes.Attribute] "Permalink")  val attributeList: List\[[Attribute](Attributes$$Attribute.html)]
10. [**](../../akka/stream/Attributes.html#canEqual(that:Any):Boolean "Permalink")  def canEqual(that: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAttributes → Equals
11. [**](../../akka/stream/Attributes.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
12. [**](../../akka/stream/Attributes.html#contains(attr:akka.stream.Attributes.Attribute):Boolean "Permalink")  def contains(attr: [Attribute](Attributes$$Attribute.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Test whether the given attribute is contained within this attributes list.
...
13. [**](../../akka/stream/Attributes.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (Attributes) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): AttributesImplicitThis member is added by an implicit conversion from Attributes toEnsuring\[Attributes] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/stream/Attributes.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (Attributes) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): AttributesImplicitThis member is added by an implicit conversion from Attributes toEnsuring\[Attributes] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/stream/Attributes.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): AttributesImplicitThis member is added by an implicit conversion from Attributes toEnsuring\[Attributes] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/stream/Attributes.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): AttributesImplicitThis member is added by an implicit conversion from Attributes toEnsuring\[Attributes] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../akka/stream/Attributes.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/stream/Attributes.html#equals(other:Any):Boolean "Permalink")  def equals(other: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAttributes → Equals → AnyRef → Any
19. [**](../../akka/stream/Attributes.html#filtered[T<:akka.stream.Attributes.Attribute](implicitevidence$4:scala.reflect.ClassTag[T]):List[T] "Permalink")  def filtered\[T \<: [Attribute](Attributes$$Attribute.html)](implicit arg0: [ClassTag](https://www.scala-lang.org/api/2.13.17/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[T]): List\[T]Scala API: Get all attributes of a given type (or subtypes thereof).
...
Note that the order was the opposite in Akka 2\.4\.x.
20. [**](../../akka/stream/Attributes.html#get[T<:akka.stream.Attributes.Attribute](implicitevidence$2:scala.reflect.ClassTag[T]):Option[T] "Permalink")  def get\[T \<: [Attribute](Attributes$$Attribute.html)](implicit arg0: [ClassTag](https://www.scala-lang.org/api/2.13.17/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[T]): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[T]Scala API: Get the most specific attribute value for a given Attribute type or subclass thereof.
...
See also[Attributes\#get](#get[T<:akka.stream.Attributes.Attribute](implicitevidence$2:scala.reflect.ClassTag[T]):Option[T]) For providing a default value if the attribute was not set
21. [**](../../akka/stream/Attributes.html#get[T<:akka.stream.Attributes.Attribute](default:T)(implicitevidence$1:scala.reflect.ClassTag[T]):T "Permalink")  def get\[T \<: [Attribute](Attributes$$Attribute.html)](default: T)(implicit arg0: [ClassTag](https://www.scala-lang.org/api/2.13.17/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[T]): TScala API: Get the most specific attribute value for a given Attribute type or subclass thereof or
...
This is the expected way for operators to access attributes.
22. [**](../../akka/stream/Attributes.html#getAttribute[T<:akka.stream.Attributes.Attribute](c:Class[T]):java.util.Optional[T] "Permalink")  def getAttribute\[T \<: [Attribute](Attributes$$Attribute.html)](c: Class\[T]): [Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[T]Java API: Get the most specific attribute value for a given Attribute type or subclass thereof.
...
This is the expected way for operators to access attributes.
23. [**](../../akka/stream/Attributes.html#getAttribute[T<:akka.stream.Attributes.Attribute](c:Class[T],default:T):T "Permalink")  def getAttribute\[T \<: [Attribute](Attributes$$Attribute.html)](c: Class\[T], default: T): TJava API: Get the most specific attribute value for a given Attribute type or subclass thereof.
...
This is the expected way for operators to access attributes.
24. [**](../../akka/stream/Attributes.html#getAttributeList[T<:akka.stream.Attributes.Attribute](c:Class[T]):java.util.List[T] "Permalink")  def getAttributeList\[T \<: [Attribute](Attributes$$Attribute.html)](c: Class\[T]): [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[T]Java API: Get all attributes of a given `Class` or
subclass thereof.
...
Note that operators in general should not inspect the whole hierarchy but instead use
`get` to get the most specific attribute value.
25. [**](../../akka/stream/Attributes.html#getAttributeList():java.util.List[akka.stream.Attributes.Attribute] "Permalink")  def getAttributeList(): [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[[Attribute](Attributes$$Attribute.html)]Java API
...
Note that operators in general should not inspect the whole hierarchy but instead use
`get` to get the most specific attribute value.
26. [**](../../akka/stream/Attributes.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
27. [**](../../akka/stream/Attributes.html#getMandatoryAttribute[T<:akka.stream.Attributes.MandatoryAttribute](c:Class[T]):T "Permalink")  def getMandatoryAttribute\[T \<: [MandatoryAttribute](Attributes$$MandatoryAttribute.html)](c: Class\[T]): TJava API: Get the most specific of one of the mandatory attributes.
...
cA class that is a subtype of MandatoryAttribute
28. [**](../../akka/stream/Attributes.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAttributes → AnyRef → Any
29. [**](../../akka/stream/Attributes.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
30. [**](../../akka/stream/Attributes.html#mandatoryAttribute[T<:akka.stream.Attributes.MandatoryAttribute](implicitevidence$3:scala.reflect.ClassTag[T]):T "Permalink")  def mandatoryAttribute\[T \<: [MandatoryAttribute](Attributes$$MandatoryAttribute.html)](implicit arg0: [ClassTag](https://www.scala-lang.org/api/2.13.17/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[T]): TScala API: Get the most specific of one of the mandatory attributes.

Scala API: Get the most specific of one of the mandatory attributes. Mandatory attributes are guaranteed
to always be among the attributes when the attributes are coming from a materialization.

Note: looks for the exact mandatory attribute class, hierarchies of the same mandatory attribute not supported
31. [**](../../akka/stream/Attributes.html#nameLifted:Option[String] "Permalink")  def nameLifted: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[String]Extracts Name attributes and concatenates them.
32. [**](../../akka/stream/Attributes.html#nameOrDefault(default:String):String "Permalink")  def nameOrDefault(default: String \= "unnamed"): StringAnnotations@[InternalApi](../annotation/InternalApi.html)()
33. [**](../../akka/stream/Attributes.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
34. [**](../../akka/stream/Attributes.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
35. [**](../../akka/stream/Attributes.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
36. [**](../../akka/stream/Attributes.html#productElementName(n:Int):String "Permalink")  def productElementName(n: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): StringDefinition ClassesProduct
37. [**](../../akka/stream/Attributes.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
38. [**](../../akka/stream/Attributes.html#productIterator:Iterator[Any] "Permalink")  def productIterator: Iterator\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]Definition ClassesProduct
39. [**](../../akka/stream/Attributes.html#productPrefix:String "Permalink")  def productPrefix: StringDefinition ClassesProduct
40. [**](../../akka/stream/Attributes.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
41. [**](../../akka/stream/Attributes.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
42. [**](../../akka/stream/Attributes.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
43. [**](../../akka/stream/Attributes.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
44. [**](../../akka/stream/Attributes.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/stream/Attributes.html#copy(attributeList:List[akka.stream.Attributes.Attribute]):akka.stream.Attributes "Permalink")  def copy(attributeList: List\[[Attribute](Attributes$$Attribute.html)] \= attributeList): AttributesAnnotations@deprecated Deprecated*(Since version 2\.8\.0\)* Don't use copy on Attributes
2. [**](../../akka/stream/Attributes.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
3. [**](../../akka/stream/Attributes.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from Attributes toStringFormat\[Attributes] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
4. [**](../../akka/stream/Attributes.html#getFirst[T<:akka.stream.Attributes.Attribute](implicitevidence$5:scala.reflect.ClassTag[T]):Option[T] "Permalink")  def getFirst\[T \<: [Attribute](Attributes$$Attribute.html)](implicit arg0: [ClassTag](https://www.scala-lang.org/api/2.13.17/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[T]): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[T]Scala API: Get the least specific attribute (added first) of a given type parameter T `Class` or subclass thereof.

Scala API: Get the least specific attribute (added first) of a given type parameter T `Class` or subclass thereof.

Annotations@deprecated Deprecated*(Since version 2\.5\.7\)* Attributes should always be most specific, use get\[T]
5. [**](../../akka/stream/Attributes.html#productArity:Int "Permalink")  def productArity: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAttributes → ProductAnnotations@deprecated Deprecated*(Since version 2\.8\.0\)* Use explicit methods on Attributes to interact, not the ones provided by Product
6. [**](../../akka/stream/Attributes.html#productElement(n:Int):Any "Permalink")  def productElement(n: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Definition ClassesAttributes → ProductAnnotations@deprecated Deprecated*(Since version 2\.8\.0\)* Use explicit methods on Attributes to interact, not the ones provided by Product
7. [**](../../akka/stream/Attributes.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (Attributes, B)ImplicitThis member is added by an implicit conversion from Attributes toArrowAssoc\[Attributes] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromAttributes to any2stringadd\[Attributes]

### Inherited by implicit conversion StringFormat fromAttributes to StringFormat\[Attributes]

### Inherited by implicit conversion Ensuring fromAttributes to Ensuring\[Attributes]

### Inherited by implicit conversion ArrowAssoc fromAttributes to ArrowAssoc\[Attributes]
