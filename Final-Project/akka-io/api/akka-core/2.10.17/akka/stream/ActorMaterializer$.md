...
scraped_at: '2026-04-06T01:31:17Z'
section: api
site: akka-io
...
[o](ActorMaterializer.html "See companion class")[akka](../index.html).[stream](index.html)

# [ActorMaterializer](ActorMaterializer.html "See companion class")[**](../../akka/stream/ActorMaterializer$.html "Permalink")

### Companion [class ActorMaterializer](ActorMaterializer.html "See companion class")

#### object ActorMaterializer

Source[ActorMaterializer.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/ActorMaterializer.scala#L26)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ActorMaterializer
2. AnyRef
...
3. [**](../../akka/stream/ActorMaterializer$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/stream/ActorMaterializer$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../akka/stream/ActorMaterializer$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../akka/stream/ActorMaterializer$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
7. [**](../../akka/stream/ActorMaterializer$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
8. [**](../../akka/stream/ActorMaterializer$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
9. [**](../../akka/stream/ActorMaterializer$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
10. [**](../../akka/stream/ActorMaterializer$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
11. [**](../../akka/stream/ActorMaterializer$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
12. [**](../../akka/stream/ActorMaterializer$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../akka/stream/ActorMaterializer$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../akka/stream/ActorMaterializer$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
15. [**](../../akka/stream/ActorMaterializer$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
16. [**](../../akka/stream/ActorMaterializer$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
17. [**](../../akka/stream/ActorMaterializer$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
18. [**](../../akka/stream/ActorMaterializer$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/stream/ActorMaterializer$.html#apply(materializerSettings:akka.stream.ActorMaterializerSettings)(implicitcontext:akka.actor.ActorRefFactory):akka.stream.ActorMaterializer "Permalink")  def apply(materializerSettings: [ActorMaterializerSettings](ActorMaterializerSettings.html))(implicit context: [ActorRefFactory](../actor/ActorRefFactory.html)): [ActorMaterializer](ActorMaterializer.html)Scala API: Creates an ActorMaterializer that can materialize stream blueprints as running streams.

Scala API: Creates an ActorMaterializer that can materialize stream blueprints as running streams.

The required [akka.actor.ActorRefFactory](../actor/ActorRefFactory.html)
(which can be either an [akka.actor.ActorSystem](../actor/ActorSystem.html) or an [akka.actor.ActorContext](../actor/ActorContext.html))
...
Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use the system wide materializer or Materializer.apply(actorContext) with stream attributes or configuration settings to change defaults
2. [**](../../akka/stream/ActorMaterializer$.html#apply(materializerSettings:akka.stream.ActorMaterializerSettings,namePrefix:String)(implicitcontext:akka.actor.ActorRefFactory):akka.stream.ActorMaterializer "Permalink")  def apply(materializerSettings: [ActorMaterializerSettings](ActorMaterializerSettings.html), namePrefix: String)(implicit context: [ActorRefFactory](../actor/ActorRefFactory.html)): [ActorMaterializer](ActorMaterializer.html)Scala API: Creates an ActorMaterializer that can materialize stream blueprints as running streams.
...
Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use the system wide materializer with stream attributes or configuration settings to change defaults
3. [**](../../akka/stream/ActorMaterializer$.html#apply(materializerSettings:Option[akka.stream.ActorMaterializerSettings],namePrefix:Option[String])(implicitcontext:akka.actor.ActorRefFactory):akka.stream.ActorMaterializer "Permalink")  def apply(materializerSettings: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ActorMaterializerSettings](ActorMaterializerSettings.html)] \= None, namePrefix: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[String] \= None)(implicit context: [ActorRefFactory](../actor/ActorRefFactory.html)): [ActorMaterializer](ActorMaterializer.html)Scala API: Creates an ActorMaterializer that can materialize stream blueprints as running streams.

Scala API: Creates an ActorMaterializer that can materialize stream blueprints as running streams.

The required [akka.actor.ActorRefFactory](../actor/ActorRefFactory.html) (which can be either an [akka.actor.ActorSystem](../actor/ActorSystem.html) or an [akka.actor.ActorContext](../actor/ActorContext.html))
will be used to create one actor that in turn creates actors for the transformation steps.

The materializer's [akka.stream.ActorMaterializerSettings](ActorMaterializerSettings.html) will be obtained from the
configuration of the `context`'s underlying [akka.actor.ActorSystem](../actor/ActorSystem.html).
...
Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use the system wide materializer with stream attributes or configuration settings to change defaults
4. [**](../../akka/stream/ActorMaterializer$.html#create(settings:akka.stream.ActorMaterializerSettings,context:akka.actor.ActorRefFactory,namePrefix:String):akka.stream.ActorMaterializer "Permalink")  def create(settings: [ActorMaterializerSettings](ActorMaterializerSettings.html), context: [ActorRefFactory](../actor/ActorRefFactory.html), namePrefix: String): [ActorMaterializer](ActorMaterializer.html)Java API: Creates an ActorMaterializer that can materialize stream blueprints as running streams.
...
Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use the system wide materializer or Materializer.create(actorContext) with stream attributes or configuration settings to change defaults
5. [**](../../akka/stream/ActorMaterializer$.html#create(settings:akka.stream.ActorMaterializerSettings,context:akka.actor.ActorRefFactory):akka.stream.ActorMaterializer "Permalink")  def create(settings: [ActorMaterializerSettings](ActorMaterializerSettings.html), context: [ActorRefFactory](../actor/ActorRefFactory.html)): [ActorMaterializer](ActorMaterializer.html)Java API: Creates an ActorMaterializer that can materialize stream blueprints as running streams.
...
Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use the system wide materializer or Materializer.create(actorContext) with stream attributes or configuration settings to change defaults
6. [**](../../akka/stream/ActorMaterializer$.html#create(context:akka.actor.ActorRefFactory,namePrefix:String):akka.stream.ActorMaterializer "Permalink")  def create(context: [ActorRefFactory](../actor/ActorRefFactory.html), namePrefix: String): [ActorMaterializer](ActorMaterializer.html)Java API: Creates an ActorMaterializer that can materialize stream blueprints as running streams.
...
Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use the system wide materializer or Materializer.create(actorContext) with stream attributes or configuration settings to change defaults
7. [**](../../akka/stream/ActorMaterializer$.html#create(context:akka.actor.ActorRefFactory):akka.stream.ActorMaterializer "Permalink")  def create(context: [ActorRefFactory](../actor/ActorRefFactory.html)): [ActorMaterializer](ActorMaterializer.html)Java API: Creates an ActorMaterializer that can materialize stream blueprints as running streams.
...
Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use the system wide materializer or Materializer.create(actorContext) with stream attributes or configuration settings to change defaults
8. [**](../../akka/stream/ActorMaterializer$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
