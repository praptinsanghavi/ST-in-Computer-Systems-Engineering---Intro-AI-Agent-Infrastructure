---
description: Akka 2.10.17 - akka.stream.snapshot
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:30:51Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/snapshot/index.html
title: Akka 2.10.17 - akka.stream.snapshot
---

# Akka 2.10.17 - akka.stream.snapshot

> **Summary:** Akka 2.10.17 - akka.stream.snapshot
...
Definition Classes[stream](../index.html)
- [**](../../../akka/stream/snapshot/index.html "Permalink")  package snapshotDefinition Classes[stream](../index.html)
...
# snapshot[**](../../../akka/stream/snapshot/index.html "Permalink")
...
1. [**](../../../akka/stream/snapshot/ConnectionSnapshot.html "Permalink") sealed  trait [ConnectionSnapshot](ConnectionSnapshot.html "Not for user extension") extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Not for user extension

Not for user extension

Annotations@[DoNotInherit](../../annotation/DoNotInherit.html)()
2. [**](../../../akka/stream/snapshot/HideImpl.html "Permalink")  trait [HideImpl](HideImpl.html "INTERNAL API") extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)INTERNAL API

INTERNAL API

Annotations@[InternalApi](../../annotation/InternalApi.html)()
3. [**](../../../akka/stream/snapshot/InterpreterSnapshot.html "Permalink") sealed  trait [InterpreterSnapshot](InterpreterSnapshot.html "A snapshot of one interpreter - contains a set of logics running in the same underlying actor.") extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)A snapshot of one interpreter \- contains a set of logics running in the same underlying actor.
...
Annotations@[DoNotInherit](../../annotation/DoNotInherit.html)()
4. [**](../../../akka/stream/snapshot/LogicSnapshot.html "Permalink") sealed  trait [LogicSnapshot](LogicSnapshot.html "Not for user extension") extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Not for user extension

Not for user extension

Annotations@[DoNotInherit](../../annotation/DoNotInherit.html)()
5. [**](../../../akka/stream/snapshot/RunningInterpreter.html "Permalink") sealed  trait [RunningInterpreter](RunningInterpreter.html "A stream interpreter that is running/has been started") extends [InterpreterSnapshot](InterpreterSnapshot.html)A stream interpreter that is running/has been started

A stream interpreter that is running/has been started

Annotations@[DoNotInherit](../../annotation/DoNotInherit.html)()
6. [**](../../../akka/stream/snapshot/StreamSnapshot.html "Permalink") sealed  trait [StreamSnapshot](StreamSnapshot.html "A snapshot of one running stream") extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)A snapshot of one running stream
...
Annotations@[DoNotInherit](../../annotation/DoNotInherit.html)()
7. [**](../../../akka/stream/snapshot/UninitializedInterpreter.html "Permalink") sealed  trait [UninitializedInterpreter](UninitializedInterpreter.html "A stream interpreter that was not yet initialized when the snapshot was taken") extends [InterpreterSnapshot](InterpreterSnapshot.html)A stream interpreter that was not yet initialized when the snapshot was taken
...
1. [**](../../../akka/stream/snapshot/ConnectionSnapshot$.html "Permalink")  object [ConnectionSnapshot](ConnectionSnapshot$.html)
2. [**](../../../akka/stream/snapshot/MaterializerState$.html "Permalink")  object [MaterializerState](MaterializerState$.html "Debug utility to dump the running streams of a materializers in a structure describing the graph layout and \"waits-on\" relationships.")Debug utility to dump the running streams of a materializers in a structure describing the graph layout
...
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/snapshot/ConnectionSnapshot$.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/snapshot/ConnectionSnapshot.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/snapshot/HideImpl.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/snapshot/InterpreterSnapshot.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/snapshot/LogicSnapshot.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/snapshot/MaterializerState$.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/snapshot/RunningInterpreter.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/snapshot/StreamSnapshot.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/snapshot/UninitializedInterpreter.html
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/snapshot/index.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/snapshot/index.html)*