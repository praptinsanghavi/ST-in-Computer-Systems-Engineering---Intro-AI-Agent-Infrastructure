---
description: Akka 2.10.17 - akka.stream.SubscriptionWithCancelException
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:36:41Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/SubscriptionWithCancelException.html
title: Akka 2.10.17 - akka.stream.SubscriptionWithCancelException
---

# Akka 2.10.17 - akka.stream.SubscriptionWithCancelException

> **Summary:** Akka 2.10.17 - akka.stream.SubscriptionWithCancelException
...
[t](SubscriptionWithCancelException$.html "See companion object")[akka](../index.html).[stream](index.html)

# [SubscriptionWithCancelException](SubscriptionWithCancelException$.html "See companion object")[**](../../akka/stream/SubscriptionWithCancelException.html "Permalink")

### Companion [object SubscriptionWithCancelException](SubscriptionWithCancelException$.html "See companion object")
...
1. [**](../../akka/stream/SubscriptionWithCancelException.html#cancel(cause:Throwable):Unit "Permalink") abstract  def cancel(cause: Throwable): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)
2. [**](../../akka/stream/SubscriptionWithCancelException.html#request(x$1:Long):Unit "Permalink") abstract  def request(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesSubscription
### Concrete Value Members

1. [**](../../akka/stream/SubscriptionWithCancelException.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/SubscriptionWithCancelException.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/SubscriptionWithCancelException.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from SubscriptionWithCancelException toany2stringadd\[SubscriptionWithCancelException] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/SubscriptionWithCancelException.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (SubscriptionWithCancelException, B)ImplicitThis member is added by an implicit conversion from SubscriptionWithCancelException toArrowAssoc\[SubscriptionWithCancelException] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/SubscriptionWithCancelException.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/SubscriptionWithCancelException.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/stream/SubscriptionWithCancelException.html#cancel():Unit "Permalink") final  def cancel(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesSubscriptionWithCancelException → Subscription
8. [**](../../akka/stream/SubscriptionWithCancelException.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../akka/stream/SubscriptionWithCancelException.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (SubscriptionWithCancelException) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SubscriptionWithCancelExceptionImplicitThis member is added by an implicit conversion from SubscriptionWithCancelException toEnsuring\[SubscriptionWithCancelException] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/stream/SubscriptionWithCancelException.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (SubscriptionWithCancelException) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SubscriptionWithCancelExceptionImplicitThis member is added by an implicit conversion from SubscriptionWithCancelException toEnsuring\[SubscriptionWithCancelException] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/stream/SubscriptionWithCancelException.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SubscriptionWithCancelExceptionImplicitThis member is added by an implicit conversion from SubscriptionWithCancelException toEnsuring\[SubscriptionWithCancelException] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/stream/SubscriptionWithCancelException.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SubscriptionWithCancelExceptionImplicitThis member is added by an implicit conversion from SubscriptionWithCancelException toEnsuring\[SubscriptionWithCancelException] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/stream/SubscriptionWithCancelException.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/stream/SubscriptionWithCancelException.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
15. [**](../../akka/stream/SubscriptionWithCancelException.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/stream/SubscriptionWithCancelException.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/stream/SubscriptionWithCancelException.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
18. [**](../../akka/stream/SubscriptionWithCancelException.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../akka/stream/SubscriptionWithCancelException.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/stream/SubscriptionWithCancelException.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../akka/stream/SubscriptionWithCancelException.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../akka/stream/SubscriptionWithCancelException.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
23. [**](../../akka/stream/SubscriptionWithCancelException.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../akka/stream/SubscriptionWithCancelException.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../akka/stream/SubscriptionWithCancelException.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/stream/SubscriptionWithCancelException.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/stream/SubscriptionWithCancelException.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from SubscriptionWithCancelException toStringFormat\[SubscriptionWithCancelException] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/stream/SubscriptionWithCancelException.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (SubscriptionWithCancelException, B)ImplicitThis member is added by an implicit conversion from SubscriptionWithCancelException toArrowAssoc\[SubscriptionWithCancelException] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromSubscriptionWithCancelException to any2stringadd\[SubscriptionWithCancelException]

### Inherited by implicit conversion StringFormat fromSubscriptionWithCancelException to StringFormat\[SubscriptionWithCancelException]

### Inherited by implicit conversion Ensuring fromSubscriptionWithCancelException to Ensuring\[SubscriptionWithCancelException]

### Inherited by implicit conversion ArrowAssoc fromSubscriptionWithCancelException to ArrowAssoc\[SubscriptionWithCancelException]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/SubscriptionWithCancelException.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/SubscriptionWithCancelException.html)*