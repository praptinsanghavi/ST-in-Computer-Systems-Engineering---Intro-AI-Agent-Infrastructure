---
description: Akka 2.10.17 - akka.stream.UniqueKillSwitch
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:37:25Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/UniqueKillSwitch.html
title: Akka 2.10.17 - akka.stream.UniqueKillSwitch
---

# Akka 2.10.17 - akka.stream.UniqueKillSwitch

> **Summary:** Akka 2.10.17 - akka.stream.UniqueKillSwitch
...
# UniqueKillSwitch[**](../../akka/stream/UniqueKillSwitch.html "Permalink")

### 

#### final  class UniqueKillSwitch extends [KillSwitch](KillSwitch.html)

A UniqueKillSwitch is always a result of a materialization (unlike [SharedKillSwitch](SharedKillSwitch.html) which is constructed
before any materialization) and it always controls that graph and operator which yielded the materialized value.

After calling [UniqueKillSwitch\#shutdown](#shutdown():Unit) the running instance of the [Graph](Graph.html) of [FlowShape](FlowShape.html) that materialized to the
...
After calling [UniqueKillSwitch\#abort](#abort(ex:Throwable):Unit) the running instance of the [Graph](Graph.html) of [FlowShape](FlowShape.html) that materialized to the
...
Source[KillSwitch.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/KillSwitch.scala#L205)Linear Supertypes[KillSwitch](KillSwitch.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. UniqueKillSwitch
2. KillSwitch
...
1. [**](../../akka/stream/UniqueKillSwitch.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/UniqueKillSwitch.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/UniqueKillSwitch.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from UniqueKillSwitch toany2stringadd\[UniqueKillSwitch] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/UniqueKillSwitch.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (UniqueKillSwitch, B)ImplicitThis member is added by an implicit conversion from UniqueKillSwitch toArrowAssoc\[UniqueKillSwitch] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/UniqueKillSwitch.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/UniqueKillSwitch.html#abort(ex:Throwable):Unit "Permalink")  def abort(ex: Throwable): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)After calling [UniqueKillSwitch\#abort](#abort(ex:Throwable):Unit) the running instance of the [Graph](Graph.html) of [FlowShape](FlowShape.html) that materialized to the
UniqueKillSwitch will fail its downstream with the provided exception and cancel its upstream
...
Definition ClassesUniqueKillSwitch → [KillSwitch](KillSwitch.html)
7. [**](../../akka/stream/UniqueKillSwitch.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
8. [**](../../akka/stream/UniqueKillSwitch.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../akka/stream/UniqueKillSwitch.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (UniqueKillSwitch) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): UniqueKillSwitchImplicitThis member is added by an implicit conversion from UniqueKillSwitch toEnsuring\[UniqueKillSwitch] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/stream/UniqueKillSwitch.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (UniqueKillSwitch) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): UniqueKillSwitchImplicitThis member is added by an implicit conversion from UniqueKillSwitch toEnsuring\[UniqueKillSwitch] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/stream/UniqueKillSwitch.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): UniqueKillSwitchImplicitThis member is added by an implicit conversion from UniqueKillSwitch toEnsuring\[UniqueKillSwitch] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/stream/UniqueKillSwitch.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): UniqueKillSwitchImplicitThis member is added by an implicit conversion from UniqueKillSwitch toEnsuring\[UniqueKillSwitch] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/stream/UniqueKillSwitch.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/stream/UniqueKillSwitch.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
15. [**](../../akka/stream/UniqueKillSwitch.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/stream/UniqueKillSwitch.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/stream/UniqueKillSwitch.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
18. [**](../../akka/stream/UniqueKillSwitch.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../akka/stream/UniqueKillSwitch.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/stream/UniqueKillSwitch.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../akka/stream/UniqueKillSwitch.html#shutdown():Unit "Permalink")  def shutdown(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)After calling [UniqueKillSwitch\#shutdown](#shutdown():Unit) the running instance of the [Graph](Graph.html) of [FlowShape](FlowShape.html) that materialized to the
UniqueKillSwitch will complete its downstream and cancel its upstream (unless if finished or failed already in which
...
Definition ClassesUniqueKillSwitch → [KillSwitch](KillSwitch.html)
22. [**](../../akka/stream/UniqueKillSwitch.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
23. [**](../../akka/stream/UniqueKillSwitch.html#toString():String "Permalink")  def toString(): StringDefinition ClassesUniqueKillSwitch → AnyRef → Any
24. [**](../../akka/stream/UniqueKillSwitch.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
25. [**](../../akka/stream/UniqueKillSwitch.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
26. [**](../../akka/stream/UniqueKillSwitch.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/stream/UniqueKillSwitch.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/stream/UniqueKillSwitch.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from UniqueKillSwitch toStringFormat\[UniqueKillSwitch] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/stream/UniqueKillSwitch.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (UniqueKillSwitch, B)ImplicitThis member is added by an implicit conversion from UniqueKillSwitch toArrowAssoc\[UniqueKillSwitch] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromUniqueKillSwitch to any2stringadd\[UniqueKillSwitch]

### Inherited by implicit conversion StringFormat fromUniqueKillSwitch to StringFormat\[UniqueKillSwitch]

### Inherited by implicit conversion Ensuring fromUniqueKillSwitch to Ensuring\[UniqueKillSwitch]

### Inherited by implicit conversion ArrowAssoc fromUniqueKillSwitch to ArrowAssoc\[UniqueKillSwitch]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/UniqueKillSwitch.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/UniqueKillSwitch.html)*