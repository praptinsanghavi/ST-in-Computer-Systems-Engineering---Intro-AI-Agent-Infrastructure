---
description: Akka 2.10.17 - akka.stream.StreamRefAttributes
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:36:16Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/StreamRefAttributes$.html
title: Akka 2.10.17 - akka.stream.StreamRefAttributes
---

# Akka 2.10.17 - akka.stream.StreamRefAttributes

> **Summary:** Akka 2.10.17 - akka.stream.StreamRefAttributes
...
# StreamRefAttributes[**](../../akka/stream/StreamRefAttributes$.html "Permalink")
...
Source[Attributes.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/Attributes.scala#L956)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Content Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/stream/StreamRefAttributes$$BufferCapacity.html "Permalink") final  case class [BufferCapacity](StreamRefAttributes$$BufferCapacity.html)(capacity: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)) extends [StreamRefAttribute](StreamRefAttributes$$StreamRefAttribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
2. [**](../../akka/stream/StreamRefAttributes$$DemandRedeliveryInterval.html "Permalink") final  case class [DemandRedeliveryInterval](StreamRefAttributes$$DemandRedeliveryInterval.html)(timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)) extends [StreamRefAttribute](StreamRefAttributes$$StreamRefAttribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
3. [**](../../akka/stream/StreamRefAttributes$$FinalTerminationSignalDeadline.html "Permalink") final  case class [FinalTerminationSignalDeadline](StreamRefAttributes$$FinalTerminationSignalDeadline.html)(timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)) extends [StreamRefAttribute](StreamRefAttributes$$StreamRefAttribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
4. [**](../../akka/stream/StreamRefAttributes$$StreamRefAttribute.html "Permalink") sealed  trait [StreamRefAttribute](StreamRefAttributes$$StreamRefAttribute.html "Attributes specific to stream refs.") extends [Attribute](Attributes$$Attribute.html)Attributes specific to stream refs.
...
5. [**](../../akka/stream/StreamRefAttributes$$SubscriptionTimeout.html "Permalink") final  case class [SubscriptionTimeout](StreamRefAttributes$$SubscriptionTimeout.html)(timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)) extends [StreamRefAttribute](StreamRefAttributes$$StreamRefAttribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
### Value Members

1. [**](../../akka/stream/StreamRefAttributes$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/StreamRefAttributes$.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/StreamRefAttributes$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/stream/StreamRefAttributes$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../akka/stream/StreamRefAttributes$.html#bufferCapacity(capacity:Int):akka.stream.Attributes "Permalink")  def bufferCapacity(capacity: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Attributes](Attributes.html)Specifies the size of the buffer on the receiving side that is eagerly filled even without demand.
6. [**](../../akka/stream/StreamRefAttributes$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
7. [**](../../akka/stream/StreamRefAttributes$.html#demandRedeliveryInterval(timeout:java.time.Duration):akka.stream.Attributes "Permalink")  def demandRedeliveryInterval(timeout: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): [Attributes](Attributes.html) Java API: If no new elements arrive within this timeout, demand is redelivered.
8. [**](../../akka/stream/StreamRefAttributes$.html#demandRedeliveryInterval(timeout:scala.concurrent.duration.FiniteDuration):akka.stream.Attributes "Permalink")  def demandRedeliveryInterval(timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): [Attributes](Attributes.html) Scala API: If no new elements arrive within this timeout, demand is redelivered.
9. [**](../../akka/stream/StreamRefAttributes$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
10. [**](../../akka/stream/StreamRefAttributes$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
11. [**](../../akka/stream/StreamRefAttributes$.html#finalTerminationSignalDeadline(timeout:java.time.Duration):akka.stream.Attributes "Permalink")  def finalTerminationSignalDeadline(timeout: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): [Attributes](Attributes.html)Java API: The time between the Terminated signal being received and when the local SourceRef determines to fail itself
12. [**](../../akka/stream/StreamRefAttributes$.html#finalTerminationSignalDeadline(timeout:scala.concurrent.duration.FiniteDuration):akka.stream.Attributes "Permalink")  def finalTerminationSignalDeadline(timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): [Attributes](Attributes.html)Scala API: The time between the Terminated signal being received and when the local SourceRef determines to fail itself
13. [**](../../akka/stream/StreamRefAttributes$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../akka/stream/StreamRefAttributes$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/stream/StreamRefAttributes$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
16. [**](../../akka/stream/StreamRefAttributes$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/stream/StreamRefAttributes$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/stream/StreamRefAttributes$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/stream/StreamRefAttributes$.html#subscriptionTimeout(timeout:java.time.Duration):akka.stream.Attributes "Permalink")  def subscriptionTimeout(timeout: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): [Attributes](Attributes.html)Java API: Specifies the subscription timeout within which the remote side MUST subscribe to the handed out stream reference.
20. [**](../../akka/stream/StreamRefAttributes$.html#subscriptionTimeout(timeout:scala.concurrent.duration.FiniteDuration):akka.stream.Attributes "Permalink")  def subscriptionTimeout(timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): [Attributes](Attributes.html)Scala API: Specifies the subscription timeout within which the remote side MUST subscribe to the handed out stream reference.
21. [**](../../akka/stream/StreamRefAttributes$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../akka/stream/StreamRefAttributes$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
23. [**](../../akka/stream/StreamRefAttributes$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../akka/stream/StreamRefAttributes$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../akka/stream/StreamRefAttributes$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/stream/StreamRefAttributes$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/StreamRefAttributes$.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/StreamRefAttributes$.html)*