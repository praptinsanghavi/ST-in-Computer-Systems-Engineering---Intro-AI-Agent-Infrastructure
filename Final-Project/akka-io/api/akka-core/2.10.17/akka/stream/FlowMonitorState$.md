---
description: Akka 2.10.17 - akka.stream.FlowMonitorState
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:34:18Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/FlowMonitorState$.html
title: Akka 2.10.17 - akka.stream.FlowMonitorState
---

# Akka 2.10.17 - akka.stream.FlowMonitorState

> **Summary:** Akka 2.10.17 - akka.stream.FlowMonitorState
...
# FlowMonitorState[**](../../akka/stream/FlowMonitorState$.html "Permalink")

### 

#### object FlowMonitorState

Source[FlowMonitor.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/FlowMonitor.scala#L18)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Content Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. FlowMonitorState
2. AnyRef
...
1. [**](../../akka/stream/FlowMonitorState$$Failed.html "Permalink") final  case class [Failed](FlowMonitorState$$Failed.html "Stream failed")(cause: Throwable) extends [StreamState](FlowMonitorState$$StreamState.html)\[[Nothing](https://www.scala-lang.org/api/2.13.17/scala/Nothing.html#scala.Nothing)] with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableStream failed

Stream failed

causeThe cause of the failure
2. [**](../../akka/stream/FlowMonitorState$$Received.html "Permalink") final  case class [Received](FlowMonitorState$$Received.html "Stream processed a message")\[\+U](msg: U) extends [StreamState](FlowMonitorState$$StreamState.html)\[U] with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableStream processed a message

Stream processed a message

msgThe processed message
3. [**](../../akka/stream/FlowMonitorState$$StreamState.html "Permalink") sealed  trait [StreamState](FlowMonitorState$$StreamState.html)\[\+U] extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
### Value Members

1. [**](../../akka/stream/FlowMonitorState$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/FlowMonitorState$.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/FlowMonitorState$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/stream/FlowMonitorState$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../akka/stream/FlowMonitorState$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../akka/stream/FlowMonitorState$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
7. [**](../../akka/stream/FlowMonitorState$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
8. [**](../../akka/stream/FlowMonitorState$.html#failed[U](cause:Throwable):akka.stream.FlowMonitorState.StreamState[U] "Permalink")  def failed\[U](cause: Throwable): [StreamState](FlowMonitorState$$StreamState.html)\[U]Java API
9. [**](../../akka/stream/FlowMonitorState$.html#finished[U]():akka.stream.FlowMonitorState.StreamState[U] "Permalink")  def finished\[U](): [StreamState](FlowMonitorState$$StreamState.html)\[U]Java API
10. [**](../../akka/stream/FlowMonitorState$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
11. [**](../../akka/stream/FlowMonitorState$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
12. [**](../../akka/stream/FlowMonitorState$.html#initialized[U]():akka.stream.FlowMonitorState.StreamState[U] "Permalink")  def initialized\[U](): [StreamState](FlowMonitorState$$StreamState.html)\[U]Java API
13. [**](../../akka/stream/FlowMonitorState$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
14. [**](../../akka/stream/FlowMonitorState$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../akka/stream/FlowMonitorState$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/stream/FlowMonitorState$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/stream/FlowMonitorState$.html#received[U](msg:U):akka.stream.FlowMonitorState.StreamState[U] "Permalink")  def received\[U](msg: U): [StreamState](FlowMonitorState$$StreamState.html)\[U]Java API
18. [**](../../akka/stream/FlowMonitorState$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
19. [**](../../akka/stream/FlowMonitorState$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
20. [**](../../akka/stream/FlowMonitorState$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
21. [**](../../akka/stream/FlowMonitorState$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
22. [**](../../akka/stream/FlowMonitorState$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/stream/FlowMonitorState$$Finished$.html "Permalink")  case object [Finished](FlowMonitorState$$Finished$.html "Stream completed successfully") extends [StreamState](FlowMonitorState$$StreamState.html)\[[Nothing](https://www.scala-lang.org/api/2.13.17/scala/Nothing.html#scala.Nothing)] with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableStream completed successfully
24. [**](../../akka/stream/FlowMonitorState$$Initialized$.html "Permalink")  case object [Initialized](FlowMonitorState$$Initialized$.html "Stream was created, but no events have passed through it") extends [StreamState](FlowMonitorState$$StreamState.html)\[[Nothing](https://www.scala-lang.org/api/2.13.17/scala/Nothing.html#scala.Nothing)] with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableStream was created, but no events have passed through it
### Deprecated Value Members

1. [**](../../akka/stream/FlowMonitorState$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/FlowMonitorState$.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/FlowMonitorState$.html)*