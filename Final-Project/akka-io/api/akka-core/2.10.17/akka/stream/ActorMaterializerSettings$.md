...
scraped_at: '2026-04-06T01:31:16Z'
section: api
site: akka-io
...
[o](ActorMaterializerSettings.html "See companion class")[akka](../index.html).[stream](index.html)

# [ActorMaterializerSettings](ActorMaterializerSettings.html "See companion class")[**](../../akka/stream/ActorMaterializerSettings$.html "Permalink")

### Companion [class ActorMaterializerSettings](ActorMaterializerSettings.html "See companion class")

#### object ActorMaterializerSettings

Source[ActorMaterializer.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/ActorMaterializer.scala#L284)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
3. [**](../../akka/stream/ActorMaterializerSettings$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/stream/ActorMaterializerSettings$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../akka/stream/ActorMaterializerSettings$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../akka/stream/ActorMaterializerSettings$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
7. [**](../../akka/stream/ActorMaterializerSettings$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
8. [**](../../akka/stream/ActorMaterializerSettings$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
9. [**](../../akka/stream/ActorMaterializerSettings$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
10. [**](../../akka/stream/ActorMaterializerSettings$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
11. [**](../../akka/stream/ActorMaterializerSettings$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
12. [**](../../akka/stream/ActorMaterializerSettings$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../akka/stream/ActorMaterializerSettings$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../akka/stream/ActorMaterializerSettings$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
15. [**](../../akka/stream/ActorMaterializerSettings$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
16. [**](../../akka/stream/ActorMaterializerSettings$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
17. [**](../../akka/stream/ActorMaterializerSettings$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
18. [**](../../akka/stream/ActorMaterializerSettings$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/stream/ActorMaterializerSettings$.html#apply(config:com.typesafe.config.Config):akka.stream.ActorMaterializerSettings "Permalink")  def apply(config: Config): [ActorMaterializerSettings](ActorMaterializerSettings.html)Create [ActorMaterializerSettings](ActorMaterializerSettings.html) from a Config subsection (Scala).

Create [ActorMaterializerSettings](ActorMaterializerSettings.html) from a Config subsection (Scala).
...
Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use config or attributes to configure the materializer. See migration guide for details https://doc.akka.io/libraries/akka\-core/2\.6/project/migration\-guide\-2\.5\.x\-2\.6\.x.html
2. [**](../../akka/stream/ActorMaterializerSettings$.html#apply(system:akka.actor.ActorSystem):akka.stream.ActorMaterializerSettings "Permalink")  def apply(system: [ActorSystem](../actor/ActorSystem.html)): [ActorMaterializerSettings](ActorMaterializerSettings.html)Create [ActorMaterializerSettings](ActorMaterializerSettings.html) from the settings of an [akka.actor.ActorSystem](../actor/ActorSystem.html) (Scala).

Create [ActorMaterializerSettings](ActorMaterializerSettings.html) from the settings of an [akka.actor.ActorSystem](../actor/ActorSystem.html) (Scala).

Prefer using either config for defaults or attributes for per\-stream config.
See migration guide for details https://doc.akka.io/libraries/akka\-core/2\.6/project/migration\-guide\-2\.5\.x\-2\.6\.x.html"

Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use config or attributes to configure the materializer. See migration guide for details https://doc.akka.io/libraries/akka\-core/2\.6/project/migration\-guide\-2\.5\.x\-2\.6\.x.html
3. [**](../../akka/stream/ActorMaterializerSettings$.html#apply(initialInputBufferSize:Int,maxInputBufferSize:Int,dispatcher:String,supervisionDecider:akka.stream.Supervision.Decider,subscriptionTimeoutSettings:akka.stream.StreamSubscriptionTimeoutSettings,debugLogging:Boolean,outputBurstLimit:Int,fuzzingMode:Boolean,autoFusing:Boolean,maxFixedBufferSize:Int):akka.stream.ActorMaterializerSettings "Permalink")  def apply(initialInputBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), maxInputBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), dispatcher: String, supervisionDecider: [Decider](Supervision$.html#Decider=Function[Throwable,akka.stream.Supervision.Directive]), subscriptionTimeoutSettings: [StreamSubscriptionTimeoutSettings](StreamSubscriptionTimeoutSettings.html), debugLogging: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), outputBurstLimit: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), fuzzingMode: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), autoFusing: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), maxFixedBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [ActorMaterializerSettings](ActorMaterializerSettings.html)Create [ActorMaterializerSettings](ActorMaterializerSettings.html) from individual settings (Scala).

Create [ActorMaterializerSettings](ActorMaterializerSettings.html) from individual settings (Scala).

Prefer using either config for defaults or attributes for per\-stream config.
See migration guide for details https://doc.akka.io/libraries/akka\-core/2\.6/project/migration\-guide\-2\.5\.x\-2\.6\.x.html"

Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use config or attributes to configure the materializer. See migration guide for details https://doc.akka.io/libraries/akka\-core/2\.6/project/migration\-guide\-2\.5\.x\-2\.6\.x.html
4. [**](../../akka/stream/ActorMaterializerSettings$.html#create(config:com.typesafe.config.Config):akka.stream.ActorMaterializerSettings "Permalink")  def create(config: Config): [ActorMaterializerSettings](ActorMaterializerSettings.html)Create [ActorMaterializerSettings](ActorMaterializerSettings.html) from a Config subsection (Java).

Create [ActorMaterializerSettings](ActorMaterializerSettings.html) from a Config subsection (Java).

Prefer using either config for defaults or attributes for per\-stream config.
See migration guide for details https://doc.akka.io/libraries/akka\-core/2\.6/project/migration\-guide\-2\.5\.x\-2\.6\.x.html"

Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use config or attributes to configure the materializer. See migration guide for details https://doc.akka.io/libraries/akka\-core/2\.6/project/migration\-guide\-2\.5\.x\-2\.6\.x.html
5. [**](../../akka/stream/ActorMaterializerSettings$.html#create(system:akka.actor.ActorSystem):akka.stream.ActorMaterializerSettings "Permalink")  def create(system: [ActorSystem](../actor/ActorSystem.html)): [ActorMaterializerSettings](ActorMaterializerSettings.html)Create [ActorMaterializerSettings](ActorMaterializerSettings.html) from the settings of an [akka.actor.ActorSystem](../actor/ActorSystem.html) (Java).

Create [ActorMaterializerSettings](ActorMaterializerSettings.html) from the settings of an [akka.actor.ActorSystem](../actor/ActorSystem.html) (Java).

Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use config or attributes to configure the materializer. See migration guide for details https://doc.akka.io/libraries/akka\-core/2\.6/project/migration\-guide\-2\.5\.x\-2\.6\.x.html
6. [**](../../akka/stream/ActorMaterializerSettings$.html#create(initialInputBufferSize:Int,maxInputBufferSize:Int,dispatcher:String,supervisionDecider:akka.stream.Supervision.Decider,subscriptionTimeoutSettings:akka.stream.StreamSubscriptionTimeoutSettings,debugLogging:Boolean,outputBurstLimit:Int,fuzzingMode:Boolean,autoFusing:Boolean,maxFixedBufferSize:Int):akka.stream.ActorMaterializerSettings "Permalink")  def create(initialInputBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), maxInputBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), dispatcher: String, supervisionDecider: [Decider](Supervision$.html#Decider=Function[Throwable,akka.stream.Supervision.Directive]), subscriptionTimeoutSettings: [StreamSubscriptionTimeoutSettings](StreamSubscriptionTimeoutSettings.html), debugLogging: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), outputBurstLimit: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), fuzzingMode: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), autoFusing: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), maxFixedBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [ActorMaterializerSettings](ActorMaterializerSettings.html)Create [ActorMaterializerSettings](ActorMaterializerSettings.html) from individual settings (Java).

Create [ActorMaterializerSettings](ActorMaterializerSettings.html) from individual settings (Java).

Prefer using either config for defaults or attributes for per\-stream config.
See migration guide for details https://doc.akka.io/libraries/akka\-core/2\.6/project/migration\-guide\-2\.5\.x\-2\.6\.x.html"

Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use config or attributes to configure the materializer. See migration guide for details https://doc.akka.io/libraries/akka\-core/2\.6/project/migration\-guide\-2\.5\.x\-2\.6\.x.html
7. [**](../../akka/stream/ActorMaterializerSettings$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
