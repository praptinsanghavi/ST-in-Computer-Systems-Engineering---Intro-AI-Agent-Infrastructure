...
scraped_at: '2026-04-06T01:36:30Z'
section: api
site: akka-io
...
[o](StreamSubscriptionTimeoutTerminationMode.html "See companion class")[akka](../index.html).[stream](index.html)

# [StreamSubscriptionTimeoutTerminationMode](StreamSubscriptionTimeoutTerminationMode.html "See companion class")[**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html "Permalink")

### Companion [class StreamSubscriptionTimeoutTerminationMode](StreamSubscriptionTimeoutTerminationMode.html "See companion class")

#### object StreamSubscriptionTimeoutTerminationMode

Source[ActorMaterializer.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/ActorMaterializer.scala#L816)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
3. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#cancel:akka.stream.StreamSubscriptionTimeoutTerminationMode "Permalink")  def cancel: [StreamSubscriptionTimeoutTerminationMode](StreamSubscriptionTimeoutTerminationMode.html)When the timeout expires attach a Subscriber that will immediately cancel its subscription.
6. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
7. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
8. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
9. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
10. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
11. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
12. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#noop:akka.stream.StreamSubscriptionTimeoutTerminationMode "Permalink")  def noop: [StreamSubscriptionTimeoutTerminationMode](StreamSubscriptionTimeoutTerminationMode.html)Do not do anything when timeout expires.
14. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
17. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
18. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
19. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
20. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
21. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$.html#warn:akka.stream.StreamSubscriptionTimeoutTerminationMode "Permalink")  def warn: [StreamSubscriptionTimeoutTerminationMode](StreamSubscriptionTimeoutTerminationMode.html)Log a warning when the timeout expires.
22. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$$CancelTermination$.html "Permalink")  case object [CancelTermination](StreamSubscriptionTimeoutTerminationMode$$CancelTermination$.html) extends [StreamSubscriptionTimeoutTerminationMode](StreamSubscriptionTimeoutTerminationMode.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
23. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$$NoopTermination$.html "Permalink")  case object [NoopTermination](StreamSubscriptionTimeoutTerminationMode$$NoopTermination$.html) extends [StreamSubscriptionTimeoutTerminationMode](StreamSubscriptionTimeoutTerminationMode.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
24. [**](../../akka/stream/StreamSubscriptionTimeoutTerminationMode$$WarnTermination$.html "Permalink")  case object [WarnTermination](StreamSubscriptionTimeoutTerminationMode$$WarnTermination$.html) extends [StreamSubscriptionTimeoutTerminationMode](StreamSubscriptionTimeoutTerminationMode.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
