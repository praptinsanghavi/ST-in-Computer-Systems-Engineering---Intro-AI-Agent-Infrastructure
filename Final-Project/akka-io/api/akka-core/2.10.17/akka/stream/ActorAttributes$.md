---
description: Akka 2.10.17 - akka.stream.ActorAttributes
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:31:12Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/ActorAttributes$.html
title: Akka 2.10.17 - akka.stream.ActorAttributes
---

# Akka 2.10.17 - akka.stream.ActorAttributes

> **Summary:** Akka 2.10.17 - akka.stream.ActorAttributes
...
o[akka](../index.html).[stream](index.html)

# ActorAttributes[**](../../akka/stream/ActorAttributes$.html "Permalink")
...
Source[Attributes.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/Attributes.scala#L783)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ActorAttributes
2. AnyRef
...
1. [**](../../akka/stream/ActorAttributes$$DebugLogging.html "Permalink") final  case class [DebugLogging](ActorAttributes$$DebugLogging.html "Enables additional low level troubleshooting logging at DEBUG log level")(enabled: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)) extends [MandatoryAttribute](Attributes$$MandatoryAttribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableEnables additional low level troubleshooting logging at DEBUG log level

Enables additional low level troubleshooting logging at DEBUG log level

Use factory method [\#debugLogging](#debugLogging(enabled:Boolean):akka.stream.Attributes) to create.
2. [**](../../akka/stream/ActorAttributes$$Dispatcher.html "Permalink") final  case class [Dispatcher](ActorAttributes$$Dispatcher.html "Configures the dispatcher to be used by streams.")(dispatcher: String) extends [MandatoryAttribute](Attributes$$MandatoryAttribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableConfigures the dispatcher to be used by streams.

Configures the dispatcher to be used by streams.

Use factory method [ActorAttributes\#dispatcher](#dispatcher(dispatcher:String):akka.stream.Attributes) to create instances.
3. [**](../../akka/stream/ActorAttributes$$FuzzingMode.html "Permalink") final  case class [FuzzingMode](ActorAttributes$$FuzzingMode.html "Test utility: fuzzing mode means that GraphStage events are not processed in FIFO order within a fused subgraph, but randomized.")(enabled: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)) extends [MandatoryAttribute](Attributes$$MandatoryAttribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableTest utility: fuzzing mode means that GraphStage events are not processed
...
Use factory method [\#fuzzingMode](#fuzzingMode(enabled:Boolean):akka.stream.Attributes) to create.
4. [**](../../akka/stream/ActorAttributes$$MaxFixedBufferSize.html "Permalink") final  case class [MaxFixedBufferSize](ActorAttributes$$MaxFixedBufferSize.html "Configure the maximum buffer size for which a FixedSizeBuffer will be preallocated.")(size: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)) extends [MandatoryAttribute](Attributes$$MandatoryAttribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableConfigure the maximum buffer size for which a FixedSizeBuffer will be preallocated.
...
Use factory method [\#maxFixedBufferSize](#maxFixedBufferSize(size:Int):akka.stream.Attributes) to create.
5. [**](../../akka/stream/ActorAttributes$$OutputBurstLimit.html "Permalink") final  case class [OutputBurstLimit](ActorAttributes$$OutputBurstLimit.html "Maximum number of elements emitted in batch if downstream signals large demand.")(limit: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)) extends [MandatoryAttribute](Attributes$$MandatoryAttribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableMaximum number of elements emitted in batch if downstream signals large demand.

Maximum number of elements emitted in batch if downstream signals large demand.

Use factory method [\#outputBurstLimit](#outputBurstLimit(limit:Int):akka.stream.Attributes) to create.
6. [**](../../akka/stream/ActorAttributes$$StreamSubscriptionTimeout.html "Permalink") final  case class [StreamSubscriptionTimeout](ActorAttributes$$StreamSubscriptionTimeout.html "Defines a timeout for stream subscription and what action to take when that hits.")(timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), mode: [StreamSubscriptionTimeoutTerminationMode](StreamSubscriptionTimeoutTerminationMode.html)) extends [MandatoryAttribute](Attributes$$MandatoryAttribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableDefines a timeout for stream subscription and what action to take when that hits.
...
7. [**](../../akka/stream/ActorAttributes$$SupervisionStrategy.html "Permalink") final  case class [SupervisionStrategy](ActorAttributes$$SupervisionStrategy.html)(decider: [Decider](Supervision$.html#Decider=Function[Throwable,akka.stream.Supervision.Directive])) extends [MandatoryAttribute](Attributes$$MandatoryAttribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
8. [**](../../akka/stream/ActorAttributes$$SyncProcessingLimit.html "Permalink") final  case class [SyncProcessingLimit](ActorAttributes$$SyncProcessingLimit.html "Limit for number of messages that can be processed synchronously in stream to substream communication.")(limit: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)) extends [MandatoryAttribute](Attributes$$MandatoryAttribute.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableLimit for number of messages that can be processed synchronously in stream to substream communication.

Limit for number of messages that can be processed synchronously in stream to substream communication.

Use factory method [\#syncProcessingLimit](#syncProcessingLimit(limit:Int):akka.stream.Attributes) to create.
### Value Members

1. [**](../../akka/stream/ActorAttributes$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/ActorAttributes$.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/ActorAttributes$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/stream/ActorAttributes$.html#IODispatcher:akka.stream.ActorAttributes.Dispatcher "Permalink")  val IODispatcher: [Dispatcher](ActorAttributes$$Dispatcher.html)
5. [**](../../akka/stream/ActorAttributes$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
6. [**](../../akka/stream/ActorAttributes$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
7. [**](../../akka/stream/ActorAttributes$.html#createLogLevels(onElement:akka.event.Logging.LogLevel):akka.stream.Attributes "Permalink")  def createLogLevels(onElement: [LogLevel](../event/Logging$$LogLevel.html)): [Attributes](Attributes.html)Java API

Java API

Configures `log()` operator log\-levels to be used when logging onElement.
Logging a certain operation can be completely disabled by using [Attributes\#logLevelOff](Attributes$.html#logLevelOff:akka.event.Logging.LogLevel).
8. [**](../../akka/stream/ActorAttributes$.html#createLogLevels(onElement:akka.event.Logging.LogLevel,onFinish:akka.event.Logging.LogLevel,onFailure:akka.event.Logging.LogLevel):akka.stream.Attributes "Permalink")  def createLogLevels(onElement: [LogLevel](../event/Logging$$LogLevel.html), onFinish: [LogLevel](../event/Logging$$LogLevel.html), onFailure: [LogLevel](../event/Logging$$LogLevel.html)): [Attributes](Attributes.html)Java API

Java API

Configures `log()` operator log\-levels to be used when logging.
Logging a certain operation can be completely disabled by using [Attributes\#logLevelOff](Attributes$.html#logLevelOff:akka.event.Logging.LogLevel).
9. [**](../../akka/stream/ActorAttributes$.html#debugLogging(enabled:Boolean):akka.stream.Attributes "Permalink")  def debugLogging(enabled: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): [Attributes](Attributes.html)Enables additional low level troubleshooting logging at DEBUG log level
10. [**](../../akka/stream/ActorAttributes$.html#dispatcher(dispatcher:String):akka.stream.Attributes "Permalink")  def dispatcher(dispatcher: String): [Attributes](Attributes.html)Specifies the name of the dispatcher.

Specifies the name of the dispatcher. This also adds an async boundary.
11. [**](../../akka/stream/ActorAttributes$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
12. [**](../../akka/stream/ActorAttributes$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
13. [**](../../akka/stream/ActorAttributes$.html#fuzzingMode(enabled:Boolean):akka.stream.Attributes "Permalink")  def fuzzingMode(enabled: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): [Attributes](Attributes.html)Test utility: fuzzing mode means that GraphStage events are not processed
in FIFO order within a fused subgraph, but randomized.
14. [**](../../akka/stream/ActorAttributes$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/stream/ActorAttributes$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/stream/ActorAttributes$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/stream/ActorAttributes$.html#logLevels(onElement:akka.event.Logging.LogLevel,onFinish:akka.event.Logging.LogLevel,onFailure:akka.event.Logging.LogLevel):akka.stream.Attributes "Permalink")  def logLevels(onElement: [LogLevel](../event/Logging$$LogLevel.html) \= [Logging.DebugLevel](../index.html), onFinish: [LogLevel](../event/Logging$$LogLevel.html) \= [Logging.DebugLevel](../index.html), onFailure: [LogLevel](../event/Logging$$LogLevel.html) \= [Logging.ErrorLevel](../index.html)): [Attributes](Attributes.html)Configures `log()` operator log\-levels to be used when logging.

Configures `log()` operator log\-levels to be used when logging.
Logging a certain operation can be completely disabled by using LogLevels.Off.

See [Attributes.createLogLevels](Attributes$.html#createLogLevels(onElement:akka.event.Logging.LogLevel):akka.stream.Attributes) for Java API
18. [**](../../akka/stream/ActorAttributes$.html#maxFixedBufferSize(size:Int):akka.stream.Attributes "Permalink")  def maxFixedBufferSize(size: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Attributes](Attributes.html)Configure the maximum buffer size for which a FixedSizeBuffer will be preallocated.

Configure the maximum buffer size for which a FixedSizeBuffer will be preallocated.
This defaults to a large value because it is usually better to fail early when
system memory is not sufficient to hold the buffer.
19. [**](../../akka/stream/ActorAttributes$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
20. [**](../../akka/stream/ActorAttributes$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../akka/stream/ActorAttributes$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/stream/ActorAttributes$.html#outputBurstLimit(limit:Int):akka.stream.Attributes "Permalink")  def outputBurstLimit(limit: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Attributes](Attributes.html)Maximum number of elements emitted in batch if downstream signals large demand.
23. [**](../../akka/stream/ActorAttributes$.html#streamSubscriptionTimeout(timeout:java.time.Duration,mode:akka.stream.StreamSubscriptionTimeoutTerminationMode):akka.stream.Attributes "Permalink")  def streamSubscriptionTimeout(timeout: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), mode: [StreamSubscriptionTimeoutTerminationMode](StreamSubscriptionTimeoutTerminationMode.html)): [Attributes](Attributes.html)Java API: Defines a timeout for stream subscription and what action to take when that hits.
24. [**](../../akka/stream/ActorAttributes$.html#streamSubscriptionTimeout(timeout:scala.concurrent.duration.FiniteDuration,mode:akka.stream.StreamSubscriptionTimeoutTerminationMode):akka.stream.Attributes "Permalink")  def streamSubscriptionTimeout(timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), mode: [StreamSubscriptionTimeoutTerminationMode](StreamSubscriptionTimeoutTerminationMode.html)): [Attributes](Attributes.html)Scala API: Defines a timeout for stream subscription and what action to take when that hits.
25. [**](../../akka/stream/ActorAttributes$.html#supervisionStrategy(decider:akka.stream.Supervision.Decider):akka.stream.Attributes "Permalink")  def supervisionStrategy(decider: [Decider](Supervision$.html#Decider=Function[Throwable,akka.stream.Supervision.Directive])): [Attributes](Attributes.html)Scala API: Decides how exceptions from user are to be handled.
...
For the Java API see [\#withSupervisionStrategy](#withSupervisionStrategy(decider:akka.japi.function.Function[Throwable,akka.stream.Supervision.Directive]):akka.stream.Attributes)
26. [**](../../akka/stream/ActorAttributes$.html#syncProcessingLimit(limit:Int):akka.stream.Attributes "Permalink")  def syncProcessingLimit(limit: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Attributes](Attributes.html)Limit for number of messages that can be processed synchronously in stream to substream communication
27. [**](../../akka/stream/ActorAttributes$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
28. [**](../../akka/stream/ActorAttributes$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
29. [**](../../akka/stream/ActorAttributes$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
30. [**](../../akka/stream/ActorAttributes$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
31. [**](../../akka/stream/ActorAttributes$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
32. [**](../../akka/stream/ActorAttributes$.html#withSupervisionStrategy(decider:akka.japi.function.Function[Throwable,akka.stream.Supervision.Directive]):akka.stream.Attributes "Permalink")  def withSupervisionStrategy(decider: [Function](../japi/function/Function.html)\[Throwable, [Directive](Supervision$$Directive.html)]): [Attributes](Attributes.html)Java API: Decides how exceptions from application code are to be handled.
...
For the Scala API see [\#supervisionStrategy](#supervisionStrategy(decider:akka.stream.Supervision.Decider):akka.stream.Attributes)
### Deprecated Value Members

1. [**](../../akka/stream/ActorAttributes$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/ActorAttributes$$DebugLogging.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/ActorAttributes$$Dispatcher.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/ActorAttributes$$FuzzingMode.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/ActorAttributes$$MaxFixedBufferSize.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/ActorAttributes$$OutputBurstLimit.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/ActorAttributes$$StreamSubscriptionTimeout.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/ActorAttributes$$SupervisionStrategy.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/ActorAttributes$$SyncProcessingLimit.html
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/ActorAttributes$.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/ActorAttributes$.html)*