---
description: Akka 2.10.17 - akka.stream.StreamSubscriptionTimeoutSettings
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:36:31Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/StreamSubscriptionTimeoutSettings.html
title: Akka 2.10.17 - akka.stream.StreamSubscriptionTimeoutSettings
---

# Akka 2.10.17 - akka.stream.StreamSubscriptionTimeoutSettings

> **Summary:** Akka 2.10.17 - akka.stream.StreamSubscriptionTimeoutSettings
...
[c](StreamSubscriptionTimeoutSettings$.html "See companion object")[akka](../index.html).[stream](index.html)

# [StreamSubscriptionTimeoutSettings](StreamSubscriptionTimeoutSettings$.html "See companion object")[**](../../akka/stream/StreamSubscriptionTimeoutSettings.html "Permalink")

### Companion [object StreamSubscriptionTimeoutSettings](StreamSubscriptionTimeoutSettings$.html "See companion object")

#### final  class StreamSubscriptionTimeoutSettings extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
...
Annotations@nowarn() Source[ActorMaterializer.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/ActorMaterializer.scala#L796)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#<init>(mode:akka.stream.StreamSubscriptionTimeoutTerminationMode,timeout:scala.concurrent.duration.FiniteDuration):akka.stream.StreamSubscriptionTimeoutSettings "Permalink")  new StreamSubscriptionTimeoutSettings(mode: [StreamSubscriptionTimeoutTerminationMode](StreamSubscriptionTimeoutTerminationMode.html), timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration))
### Value Members

1. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from StreamSubscriptionTimeoutSettings toany2stringadd\[StreamSubscriptionTimeoutSettings] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (StreamSubscriptionTimeoutSettings, B)ImplicitThis member is added by an implicit conversion from StreamSubscriptionTimeoutSettings toArrowAssoc\[StreamSubscriptionTimeoutSettings] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (StreamSubscriptionTimeoutSettings) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): StreamSubscriptionTimeoutSettingsImplicitThis member is added by an implicit conversion from StreamSubscriptionTimeoutSettings toEnsuring\[StreamSubscriptionTimeoutSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (StreamSubscriptionTimeoutSettings) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): StreamSubscriptionTimeoutSettingsImplicitThis member is added by an implicit conversion from StreamSubscriptionTimeoutSettings toEnsuring\[StreamSubscriptionTimeoutSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): StreamSubscriptionTimeoutSettingsImplicitThis member is added by an implicit conversion from StreamSubscriptionTimeoutSettings toEnsuring\[StreamSubscriptionTimeoutSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): StreamSubscriptionTimeoutSettingsImplicitThis member is added by an implicit conversion from StreamSubscriptionTimeoutSettings toEnsuring\[StreamSubscriptionTimeoutSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#equals(other:Any):Boolean "Permalink")  def equals(other: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesStreamSubscriptionTimeoutSettings → AnyRef → Any
14. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#toString():String "Permalink")  def toString(): StringDefinition ClassesStreamSubscriptionTimeoutSettings → AnyRef → Any
22. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from StreamSubscriptionTimeoutSettings toStringFormat\[StreamSubscriptionTimeoutSettings] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#mode:akka.stream.StreamSubscriptionTimeoutTerminationMode "Permalink")  val mode: [StreamSubscriptionTimeoutTerminationMode](StreamSubscriptionTimeoutTerminationMode.html)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.StreamSubscriptionTimeoutMode' to read the concrete setting value
4. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#timeout:scala.concurrent.duration.FiniteDuration "Permalink")  val timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attribute 'ActorAttributes.StreamSubscriptionTimeout' to read the concrete setting value
5. [**](../../akka/stream/StreamSubscriptionTimeoutSettings.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (StreamSubscriptionTimeoutSettings, B)ImplicitThis member is added by an implicit conversion from StreamSubscriptionTimeoutSettings toArrowAssoc\[StreamSubscriptionTimeoutSettings] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromStreamSubscriptionTimeoutSettings to any2stringadd\[StreamSubscriptionTimeoutSettings]

### Inherited by implicit conversion StringFormat fromStreamSubscriptionTimeoutSettings to StringFormat\[StreamSubscriptionTimeoutSettings]

### Inherited by implicit conversion Ensuring fromStreamSubscriptionTimeoutSettings to Ensuring\[StreamSubscriptionTimeoutSettings]

### Inherited by implicit conversion ArrowAssoc fromStreamSubscriptionTimeoutSettings to ArrowAssoc\[StreamSubscriptionTimeoutSettings]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/StreamSubscriptionTimeoutSettings.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/StreamSubscriptionTimeoutSettings.html)*