---
description: Akka 2.10.17 - akka.stream.FanOutShape8
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:34:15Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/FanOutShape8.html
title: Akka 2.10.17 - akka.stream.FanOutShape8
---

# Akka 2.10.17 - akka.stream.FanOutShape8

> **Summary:** Akka 2.10.17 - akka.stream.FanOutShape8
...
1. [**](../../akka/stream/FanOutShape8.html#<init>(in:akka.stream.Inlet[I],out0:akka.stream.Outlet[O0],out1:akka.stream.Outlet[O1],out2:akka.stream.Outlet[O2],out3:akka.stream.Outlet[O3],out4:akka.stream.Outlet[O4],out5:akka.stream.Outlet[O5],out6:akka.stream.Outlet[O6],out7:akka.stream.Outlet[O7]):akka.stream.FanOutShape8[I,O0,O1,O2,O3,O4,O5,O6,O7] "Permalink")  new FanOutShape8(in: [Inlet](Inlet.html)\[I], out0: [Outlet](Outlet.html)\[O0], out1: [Outlet](Outlet.html)\[O1], out2: [Outlet](Outlet.html)\[O2], out3: [Outlet](Outlet.html)\[O3], out4: [Outlet](Outlet.html)\[O4], out5: [Outlet](Outlet.html)\[O5], out6: [Outlet](Outlet.html)\[O6], out7: [Outlet](Outlet.html)\[O7])
2. [**](../../akka/stream/FanOutShape8.html#<init>(name:String):akka.stream.FanOutShape8[I,O0,O1,O2,O3,O4,O5,O6,O7] "Permalink")  new FanOutShape8(name: String)
3. [**](../../akka/stream/FanOutShape8.html#<init>(_init:akka.stream.FanOutShape.Init[I@scala.annotation.unchecked.uncheckedVariance]):akka.stream.FanOutShape8[I,O0,O1,O2,O3,O4,O5,O6,O7] "Permalink")  new FanOutShape8(\_init: [Init](FanOutShape$$Init.html)\[I])
### Value Members

1. [**](../../akka/stream/FanOutShape8.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/FanOutShape8.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/FanOutShape8.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7] toany2stringadd\[FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/FanOutShape8.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7], B)ImplicitThis member is added by an implicit conversion from FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7] toArrowAssoc\[FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/FanOutShape8.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/FanOutShape8.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/stream/FanOutShape8.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/stream/FanOutShape8.html#construct(init:akka.stream.FanOutShape.Init[I@scala.annotation.unchecked.uncheckedVariance]):akka.stream.FanOutShape[I] "Permalink")  def construct(init: [Init](FanOutShape$$Init.html)\[I]): [FanOutShape](FanOutShape.html)\[I]Attributesprotected Definition ClassesFanOutShape8 → [FanOutShape](FanOutShape.html)
9. [**](../../akka/stream/FanOutShape8.html#deepCopy():akka.stream.FanOutShape8[I,O0,O1,O2,O3,O4,O5,O6,O7] "Permalink")  def deepCopy(): FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]Create a copy of this Shape object, returning the same type as the
...
Definition ClassesFanOutShape8 → [FanOutShape](FanOutShape.html) → [Shape](Shape.html)
10. [**](../../akka/stream/FanOutShape8.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]ImplicitThis member is added by an implicit conversion from FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7] toEnsuring\[FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/stream/FanOutShape8.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]ImplicitThis member is added by an implicit conversion from FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7] toEnsuring\[FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/stream/FanOutShape8.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]ImplicitThis member is added by an implicit conversion from FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7] toEnsuring\[FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/stream/FanOutShape8.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]ImplicitThis member is added by an implicit conversion from FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7] toEnsuring\[FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/stream/FanOutShape8.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../akka/stream/FanOutShape8.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
16. [**](../../akka/stream/FanOutShape8.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/stream/FanOutShape8.html#getInlets:java.util.List[akka.stream.Inlet[_]] "Permalink")  def getInlets: [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[[Inlet](Inlet.html)\[\_]]Java API: get a list of all input ports

Java API: get a list of all input ports

Definition Classes[Shape](Shape.html)
18. [**](../../akka/stream/FanOutShape8.html#getOutlets:java.util.List[akka.stream.Outlet[_]] "Permalink")  def getOutlets: [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[[Outlet](Outlet.html)\[\_]]Java API: get a list of all output ports

Java API: get a list of all output ports

Definition Classes[Shape](Shape.html)
19. [**](../../akka/stream/FanOutShape8.html#hasSamePortsAndShapeAs(s:akka.stream.Shape):Boolean "Permalink")  def hasSamePortsAndShapeAs(s: [Shape](Shape.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Compare this to another shape and determine whether the arrangement of ports is the same (including their ordering).

Compare this to another shape and determine whether the arrangement of ports is the same (including their ordering).

Definition Classes[Shape](Shape.html)
20. [**](../../akka/stream/FanOutShape8.html#hasSamePortsAs(s:akka.stream.Shape):Boolean "Permalink")  def hasSamePortsAs(s: [Shape](Shape.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Compare this to another shape and determine whether the set of ports is the same (ignoring their ordering).

Compare this to another shape and determine whether the set of ports is the same (ignoring their ordering).

Definition Classes[Shape](Shape.html)
21. [**](../../akka/stream/FanOutShape8.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/stream/FanOutShape8.html#in:akka.stream.Inlet[I@scala.annotation.unchecked.uncheckedVariance] "Permalink") final  def in: [Inlet](Inlet.html)\[I]Definition Classes[FanOutShape](FanOutShape.html)
23. [**](../../akka/stream/FanOutShape8.html#inlets:Seq[akka.stream.Inlet[I@scala.annotation.unchecked.uncheckedVariance]] "Permalink") final  def inlets: [Seq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[[Inlet](Inlet.html)\[I]]Scala API: get a list of all input ports

Scala API: get a list of all input ports

Definition Classes[FanOutShape](FanOutShape.html) → [Shape](Shape.html)
24. [**](../../akka/stream/FanOutShape8.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
25. [**](../../akka/stream/FanOutShape8.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
26. [**](../../akka/stream/FanOutShape8.html#newOutlet[T](name:String):akka.stream.Outlet[T] "Permalink")  def newOutlet\[T](name: String): [Outlet](Outlet.html)\[T]Attributesprotected Definition Classes[FanOutShape](FanOutShape.html)
27. [**](../../akka/stream/FanOutShape8.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
28. [**](../../akka/stream/FanOutShape8.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
29. [**](../../akka/stream/FanOutShape8.html#out0:akka.stream.Outlet[O0@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val out0: [Outlet](Outlet.html)\[O0]
30. [**](../../akka/stream/FanOutShape8.html#out1:akka.stream.Outlet[O1@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val out1: [Outlet](Outlet.html)\[O1]
31. [**](../../akka/stream/FanOutShape8.html#out2:akka.stream.Outlet[O2@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val out2: [Outlet](Outlet.html)\[O2]
32. [**](../../akka/stream/FanOutShape8.html#out3:akka.stream.Outlet[O3@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val out3: [Outlet](Outlet.html)\[O3]
33. [**](../../akka/stream/FanOutShape8.html#out4:akka.stream.Outlet[O4@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val out4: [Outlet](Outlet.html)\[O4]
34. [**](../../akka/stream/FanOutShape8.html#out5:akka.stream.Outlet[O5@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val out5: [Outlet](Outlet.html)\[O5]
35. [**](../../akka/stream/FanOutShape8.html#out6:akka.stream.Outlet[O6@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val out6: [Outlet](Outlet.html)\[O6]
36. [**](../../akka/stream/FanOutShape8.html#out7:akka.stream.Outlet[O7@scala.annotation.unchecked.uncheckedVariance] "Permalink")  val out7: [Outlet](Outlet.html)\[O7]
37. [**](../../akka/stream/FanOutShape8.html#outlets:Seq[akka.stream.Outlet[_]] "Permalink")  def outlets: [Seq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[[Outlet](Outlet.html)\[\_]]Not meant for overriding outside of Akka.

Not meant for overriding outside of Akka.

Definition Classes[FanOutShape](FanOutShape.html) → [Shape](Shape.html)
38. [**](../../akka/stream/FanOutShape8.html#requireSamePortsAndShapeAs(s:akka.stream.Shape):Unit "Permalink")  def requireSamePortsAndShapeAs(s: [Shape](Shape.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Asserting version of [\#hasSamePortsAndShapeAs](#hasSamePortsAndShapeAs(s:akka.stream.Shape):Boolean).

Asserting version of [\#hasSamePortsAndShapeAs](#hasSamePortsAndShapeAs(s:akka.stream.Shape):Boolean).

Definition Classes[Shape](Shape.html)
39. [**](../../akka/stream/FanOutShape8.html#requireSamePortsAs(s:akka.stream.Shape):Unit "Permalink")  def requireSamePortsAs(s: [Shape](Shape.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Asserting version of [\#hasSamePortsAs](#hasSamePortsAs(s:akka.stream.Shape):Boolean).

Asserting version of [\#hasSamePortsAs](#hasSamePortsAs(s:akka.stream.Shape):Boolean).

Definition Classes[Shape](Shape.html)
40. [**](../../akka/stream/FanOutShape8.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
41. [**](../../akka/stream/FanOutShape8.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
42. [**](../../akka/stream/FanOutShape8.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
43. [**](../../akka/stream/FanOutShape8.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
44. [**](../../akka/stream/FanOutShape8.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/stream/FanOutShape8.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/stream/FanOutShape8.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7] toStringFormat\[FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/stream/FanOutShape8.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7], B)ImplicitThis member is added by an implicit conversion from FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7] toArrowAssoc\[FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromFanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7] to any2stringadd\[FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]]

### Inherited by implicit conversion StringFormat fromFanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7] to StringFormat\[FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]]

### Inherited by implicit conversion Ensuring fromFanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7] to Ensuring\[FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]]

### Inherited by implicit conversion ArrowAssoc fromFanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7] to ArrowAssoc\[FanOutShape8\[I, O0, O1, O2, O3, O4, O5, O6, O7]]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/FanOutShape8.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/FanOutShape8.html)*