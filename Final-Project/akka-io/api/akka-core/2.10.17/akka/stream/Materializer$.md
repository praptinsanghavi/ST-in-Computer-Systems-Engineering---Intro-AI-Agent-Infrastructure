...
scraped_at: '2026-04-06T01:35:10Z'
section: api
site: akka-io
...
[o](Materializer.html "See companion class")[akka](../index.html).[stream](index.html)

# [Materializer](Materializer.html "See companion class")[**](../../akka/stream/Materializer$.html "Permalink")

### Companion [class Materializer](Materializer.html "See companion class")

#### object Materializer

Source[Materializer.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/Materializer.scala#L193)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Materializer
2. AnyRef
...
3. [**](../../akka/stream/Materializer$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/stream/Materializer$.html#apply(systemProvider:akka.actor.ClassicActorSystemProvider,defaultAttributes:akka.stream.Attributes):akka.stream.Materializer "Permalink")  def apply(systemProvider: [ClassicActorSystemProvider](../actor/ClassicActorSystemProvider.html), defaultAttributes: [Attributes](Attributes.html)): [Materializer](Materializer.html)Scala API: Create a new materializer that will stay alive as long as the system does or until it is explicitly stopped.
...
5. [**](../../akka/stream/Materializer$.html#apply(systemProvider:akka.actor.ClassicActorSystemProvider):akka.stream.Materializer "Permalink")  def apply(systemProvider: [ClassicActorSystemProvider](../actor/ClassicActorSystemProvider.html)): [Materializer](Materializer.html)Scala API: Create a new materializer that will stay alive as long as the system does or until it is explicitly stopped.

Scala API: Create a new materializer that will stay alive as long as the system does or until it is explicitly stopped.

\*Note\* prefer using the default [SystemMaterializer](SystemMaterializer.html) that is implicitly available if you have an implicit
...
6. [**](../../akka/stream/Materializer$.html#apply(contextProvider:akka.actor.ClassicActorContextProvider,defaultAttributes:akka.stream.Attributes):akka.stream.Materializer "Permalink")  def apply(contextProvider: [ClassicActorContextProvider](../actor/ClassicActorContextProvider.html), defaultAttributes: [Attributes](Attributes.html)): [Materializer](Materializer.html)Scala API: Create a materializer whose lifecycle will be tied to the one of the passed actor context.
...
7. [**](../../akka/stream/Materializer$.html#apply(contextProvider:akka.actor.ClassicActorContextProvider):akka.stream.Materializer "Permalink")  def apply(contextProvider: [ClassicActorContextProvider](../actor/ClassicActorContextProvider.html)): [Materializer](Materializer.html)Scala API: Create a materializer whose lifecycle will be tied to the one of the passed actor context.
...
Annotations@nowarn()
8. [**](../../akka/stream/Materializer$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
9. [**](../../akka/stream/Materializer$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
10. [**](../../akka/stream/Materializer$.html#createMaterializer(systemProvider:akka.actor.ClassicActorSystemProvider,defaultAttributes:akka.stream.Attributes):akka.stream.Materializer "Permalink")  def createMaterializer(systemProvider: [ClassicActorSystemProvider](../actor/ClassicActorSystemProvider.html), defaultAttributes: [Attributes](Attributes.html)): [Materializer](Materializer.html)Java API: Create a new materializer that will stay alive as long as the system does or until it is explicitly stopped.

Java API: Create a new materializer that will stay alive as long as the system does or until it is explicitly stopped.

It is generally advised to limit the number of system level materializers created.
11. [**](../../akka/stream/Materializer$.html#createMaterializer(systemProvider:akka.actor.ClassicActorSystemProvider):akka.stream.Materializer "Permalink")  def createMaterializer(systemProvider: [ClassicActorSystemProvider](../actor/ClassicActorSystemProvider.html)): [Materializer](Materializer.html)Java API: Create a new materializer that will stay alive as long as the system does or until it is explicitly stopped.

Java API: Create a new materializer that will stay alive as long as the system does or until it is explicitly stopped.

\*Note\* prefer using the default [SystemMaterializer](SystemMaterializer.html) by passing the `ActorSystem` to the various `run`
...
12. [**](../../akka/stream/Materializer$.html#createMaterializer(contextProvider:akka.actor.ClassicActorContextProvider,defaultAttributes:akka.stream.Attributes):akka.stream.Materializer "Permalink")  def createMaterializer(contextProvider: [ClassicActorContextProvider](../actor/ClassicActorContextProvider.html), defaultAttributes: [Attributes](Attributes.html)): [Materializer](Materializer.html)Java API: Create a materializer whose lifecycle will be tied to the one of the passed actor context.

Java API: Create a materializer whose lifecycle will be tied to the one of the passed actor context.
When the actor stops the materializer will stop and all streams created with it will be failed with an AbruptTerminationExeption

You can pass either a classic actor context or a typed actor context.
13. [**](../../akka/stream/Materializer$.html#createMaterializer(contextProvider:akka.actor.ClassicActorContextProvider):akka.stream.Materializer "Permalink")  def createMaterializer(contextProvider: [ClassicActorContextProvider](../actor/ClassicActorContextProvider.html)): [Materializer](Materializer.html)Java API: Create a materializer whose lifecycle will be tied to the one of the passed actor context.

Java API: Create a materializer whose lifecycle will be tied to the one of the passed actor context.
When the actor stops the materializer will stop and all streams created with it will be failed with an AbruptTerminationExeption

You can pass either a classic actor context or a typed actor context.
14. [**](../../akka/stream/Materializer$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../akka/stream/Materializer$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
16. [**](../../akka/stream/Materializer$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/stream/Materializer$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/stream/Materializer$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
19. [**](../../akka/stream/Materializer$.html#matFromSystem(implicitprovider:akka.actor.ClassicActorSystemProvider):akka.stream.Materializer "Permalink") implicit  def matFromSystem(implicit provider: [ClassicActorSystemProvider](../actor/ClassicActorSystemProvider.html)): [Materializer](Materializer.html)Implicitly provides the system wide materializer from a classic or typed `ActorSystem`
20. [**](../../akka/stream/Materializer$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
21. [**](../../akka/stream/Materializer$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/stream/Materializer$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../akka/stream/Materializer$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
24. [**](../../akka/stream/Materializer$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
25. [**](../../akka/stream/Materializer$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../akka/stream/Materializer$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
27. [**](../../akka/stream/Materializer$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
