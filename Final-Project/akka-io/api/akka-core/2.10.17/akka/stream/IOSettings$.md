...
scraped_at: '2026-04-06T01:34:36Z'
section: api
site: akka-io
...
[o](IOSettings.html "See companion class")[akka](../index.html).[stream](index.html)

# [IOSettings](IOSettings.html "See companion class")[**](../../akka/stream/IOSettings$.html "Permalink")

### Companion [class IOSettings](IOSettings.html "See companion class")

#### object IOSettings

Source[ActorMaterializer.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/ActorMaterializer.scala#L683)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. IOSettings
2. AnyRef
...
3. [**](../../akka/stream/IOSettings$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/stream/IOSettings$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../akka/stream/IOSettings$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../akka/stream/IOSettings$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
7. [**](../../akka/stream/IOSettings$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
8. [**](../../akka/stream/IOSettings$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
9. [**](../../akka/stream/IOSettings$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
10. [**](../../akka/stream/IOSettings$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
11. [**](../../akka/stream/IOSettings$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
12. [**](../../akka/stream/IOSettings$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../akka/stream/IOSettings$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../akka/stream/IOSettings$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
15. [**](../../akka/stream/IOSettings$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
16. [**](../../akka/stream/IOSettings$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
17. [**](../../akka/stream/IOSettings$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
18. [**](../../akka/stream/IOSettings$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/stream/IOSettings$.html#apply(tcpWriteBufferSize:Int):akka.stream.IOSettings "Permalink")  def apply(tcpWriteBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [IOSettings](IOSettings.html)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use setting 'akka.stream.materializer.io.tcp.write\-buffer\-size' or attribute TcpAttributes.writeBufferSize instead
2. [**](../../akka/stream/IOSettings$.html#apply(config:com.typesafe.config.Config):akka.stream.IOSettings "Permalink")  def apply(config: Config): [IOSettings](IOSettings.html)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use setting 'akka.stream.materializer.io.tcp.write\-buffer\-size' or attribute TcpAttributes.writeBufferSize instead
3. [**](../../akka/stream/IOSettings$.html#apply(system:akka.actor.ActorSystem):akka.stream.IOSettings "Permalink")  def apply(system: [ActorSystem](../actor/ActorSystem.html)): [IOSettings](IOSettings.html)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use setting 'akka.stream.materializer.io.tcp.write\-buffer\-size' or attribute TcpAttributes.writeBufferSize instead
4. [**](../../akka/stream/IOSettings$.html#create(tcpWriteBufferSize:Int):akka.stream.IOSettings "Permalink")  def create(tcpWriteBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [IOSettings](IOSettings.html)Java API

Java API

Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use setting 'akka.stream.materializer.io.tcp.write\-buffer\-size' or attribute TcpAttributes.writeBufferSize instead
5. [**](../../akka/stream/IOSettings$.html#create(system:akka.actor.ActorSystem):akka.stream.IOSettings "Permalink")  def create(system: [ActorSystem](../actor/ActorSystem.html)): [IOSettings](IOSettings.html)Java API

Java API

Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use setting 'akka.stream.materializer.io.tcp.write\-buffer\-size' or attribute TcpAttributes.writeBufferSize instead
6. [**](../../akka/stream/IOSettings$.html#create(config:com.typesafe.config.Config):akka.stream.IOSettings "Permalink")  def create(config: Config): [IOSettings](IOSettings.html)Java API

Java API

Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use setting 'akka.stream.materializer.io.tcp.write\-buffer\-size' or attribute TcpAttributes.writeBufferSize instead
7. [**](../../akka/stream/IOSettings$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
