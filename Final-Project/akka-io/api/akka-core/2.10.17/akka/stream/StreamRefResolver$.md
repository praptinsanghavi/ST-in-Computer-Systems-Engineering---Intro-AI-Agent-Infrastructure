...
scraped_at: '2026-04-06T01:36:14Z'
section: api
site: akka-io
...
[o](StreamRefResolver.html "See companion trait")[akka](../index.html).[stream](index.html)

# [StreamRefResolver](StreamRefResolver.html "See companion trait")[**](../../akka/stream/StreamRefResolver$.html "Permalink")

### Companion [trait StreamRefResolver](StreamRefResolver.html "See companion trait")

#### object StreamRefResolver extends [ExtensionId](../actor/ExtensionId.html)\[[StreamRefResolver](StreamRefResolver.html)]

The stream ref resolver extension provides a way to serialize and deserialize streamrefs in user serializers.

Source[StreamRefs.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/StreamRefs.scala#L123)Linear Supertypes[ExtensionId](../actor/ExtensionId.html)\[[StreamRefResolver](StreamRefResolver.html)], [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. StreamRefResolver
2. ExtensionId
...
3. [**](../../akka/stream/StreamRefResolver$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/stream/StreamRefResolver$.html#apply(system:akka.actor.ClassicActorSystemProvider):T "Permalink")  def apply(system: [ClassicActorSystemProvider](../actor/ClassicActorSystemProvider.html)): [StreamRefResolver](StreamRefResolver.html)Returns an instance of the extension identified by this ExtensionId instance.

Returns an instance of the extension identified by this ExtensionId instance.

Definition Classes[ExtensionId](../actor/ExtensionId.html)
5. [**](../../akka/stream/StreamRefResolver$.html#apply(system:akka.actor.ActorSystem):T "Permalink")  def apply(system: [ActorSystem](../actor/ActorSystem.html)): [StreamRefResolver](StreamRefResolver.html)Returns an instance of the extension identified by this ExtensionId instance.
...
8. [**](../../akka/stream/StreamRefResolver$.html#createExtension(system:akka.actor.ExtendedActorSystem):akka.stream.StreamRefResolver "Permalink")  def createExtension(system: [ExtendedActorSystem](../actor/ExtendedActorSystem.html)): [StreamRefResolver](StreamRefResolver.html)Is used by Akka to instantiate the Extension identified by this ExtensionId,
internal use only.

Is used by Akka to instantiate the Extension identified by this ExtensionId,
internal use only.

Definition ClassesStreamRefResolver → [ExtensionId](../actor/ExtensionId.html)
9. [**](../../akka/stream/StreamRefResolver$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
10. [**](../../akka/stream/StreamRefResolver$.html#equals(other:Any):Boolean "Permalink") final  def equals(other: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition Classes[ExtensionId](../actor/ExtensionId.html) → AnyRef → Any
11. [**](../../akka/stream/StreamRefResolver$.html#get(system:akka.actor.ClassicActorSystemProvider):akka.stream.StreamRefResolver "Permalink")  def get(system: [ClassicActorSystemProvider](../actor/ClassicActorSystemProvider.html)): [StreamRefResolver](StreamRefResolver.html)Returns an instance of the extension identified by this ExtensionId instance.
...
```
Definition ClassesStreamRefResolver → [ExtensionId](../actor/ExtensionId.html)
12. [**](../../akka/stream/StreamRefResolver$.html#get(system:akka.actor.ActorSystem):akka.stream.StreamRefResolver "Permalink")  def get(system: [ActorSystem](../actor/ActorSystem.html)): [StreamRefResolver](StreamRefResolver.html)Returns an instance of the extension identified by this ExtensionId instance.
...
```
Definition ClassesStreamRefResolver → [ExtensionId](../actor/ExtensionId.html)
13. [**](../../akka/stream/StreamRefResolver$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../akka/stream/StreamRefResolver$.html#hashCode():Int "Permalink") final  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition Classes[ExtensionId](../actor/ExtensionId.html) → AnyRef → Any
15. [**](../../akka/stream/StreamRefResolver$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
16. [**](../../akka/stream/StreamRefResolver$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/stream/StreamRefResolver$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/stream/StreamRefResolver$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/stream/StreamRefResolver$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
20. [**](../../akka/stream/StreamRefResolver$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
21. [**](../../akka/stream/StreamRefResolver$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
22. [**](../../akka/stream/StreamRefResolver$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
23. [**](../../akka/stream/StreamRefResolver$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
### Inherited from [ExtensionId](../actor/ExtensionId.html)\[[StreamRefResolver](StreamRefResolver.html)]
