---
description: Akka 2.10.17 - akka.stream.RestartSettings
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:35:37Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/RestartSettings.html
title: Akka 2.10.17 - akka.stream.RestartSettings
---

# Akka 2.10.17 - akka.stream.RestartSettings

> **Summary:** Akka 2.10.17 - akka.stream.RestartSettings
...
[c](RestartSettings$.html "See companion object")[akka](../index.html).[stream](index.html)

# [RestartSettings](RestartSettings$.html "See companion object")[**](../../akka/stream/RestartSettings.html "Permalink")

### Companion [object RestartSettings](RestartSettings$.html "See companion object")

#### final  class RestartSettings extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

Source[RestartSettings.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/RestartSettings.scala#L15)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. RestartSettings
2. AnyRef
...
1. [**](../../akka/stream/RestartSettings.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/RestartSettings.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/RestartSettings.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from RestartSettings toany2stringadd\[RestartSettings] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/RestartSettings.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (RestartSettings, B)ImplicitThis member is added by an implicit conversion from RestartSettings toArrowAssoc\[RestartSettings] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/RestartSettings.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/RestartSettings.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/stream/RestartSettings.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/stream/RestartSettings.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (RestartSettings) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): RestartSettingsImplicitThis member is added by an implicit conversion from RestartSettings toEnsuring\[RestartSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/stream/RestartSettings.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (RestartSettings) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): RestartSettingsImplicitThis member is added by an implicit conversion from RestartSettings toEnsuring\[RestartSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/stream/RestartSettings.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): RestartSettingsImplicitThis member is added by an implicit conversion from RestartSettings toEnsuring\[RestartSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/stream/RestartSettings.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): RestartSettingsImplicitThis member is added by an implicit conversion from RestartSettings toEnsuring\[RestartSettings] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/stream/RestartSettings.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/stream/RestartSettings.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/stream/RestartSettings.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/stream/RestartSettings.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/stream/RestartSettings.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/stream/RestartSettings.html#logSettings:akka.stream.RestartSettings.LogSettings "Permalink")  val logSettings: [LogSettings](RestartSettings$$LogSettings.html)
18. [**](../../akka/stream/RestartSettings.html#maxBackoff:scala.concurrent.duration.FiniteDuration "Permalink")  val maxBackoff: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)
19. [**](../../akka/stream/RestartSettings.html#maxRestarts:Int "Permalink")  val maxRestarts: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
20. [**](../../akka/stream/RestartSettings.html#maxRestartsWithin:scala.concurrent.duration.FiniteDuration "Permalink")  val maxRestartsWithin: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)
21. [**](../../akka/stream/RestartSettings.html#minBackoff:scala.concurrent.duration.FiniteDuration "Permalink")  val minBackoff: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)
22. [**](../../akka/stream/RestartSettings.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
23. [**](../../akka/stream/RestartSettings.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../akka/stream/RestartSettings.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
25. [**](../../akka/stream/RestartSettings.html#randomFactor:Double "Permalink")  val randomFactor: [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double)
26. [**](../../akka/stream/RestartSettings.html#restartOn:Throwable=>Boolean "Permalink")  val restartOn: (Throwable) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)
27. [**](../../akka/stream/RestartSettings.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
28. [**](../../akka/stream/RestartSettings.html#toString():String "Permalink")  def toString(): StringDefinition ClassesRestartSettings → AnyRef → Any
29. [**](../../akka/stream/RestartSettings.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
30. [**](../../akka/stream/RestartSettings.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
31. [**](../../akka/stream/RestartSettings.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
32. [**](../../akka/stream/RestartSettings.html#withLogSettings(newLogSettings:akka.stream.RestartSettings.LogSettings):akka.stream.RestartSettings "Permalink")  def withLogSettings(newLogSettings: [LogSettings](RestartSettings$$LogSettings.html)): RestartSettings
33. [**](../../akka/stream/RestartSettings.html#withMaxBackoff(value:java.time.Duration):akka.stream.RestartSettings "Permalink")  def withMaxBackoff(value: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): RestartSettingsJava API: the exponential back\-off is capped to this duration
34. [**](../../akka/stream/RestartSettings.html#withMaxBackoff(value:scala.concurrent.duration.FiniteDuration):akka.stream.RestartSettings "Permalink")  def withMaxBackoff(value: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): RestartSettingsScala API: the exponential back\-off is capped to this duration
35. [**](../../akka/stream/RestartSettings.html#withMaxRestarts(count:Int,within:java.time.Duration):akka.stream.RestartSettings "Permalink")  def withMaxRestarts(count: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), within: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): RestartSettingsJava API: The amount of restarts is capped to `count` within a timeframe of `within`
36. [**](../../akka/stream/RestartSettings.html#withMaxRestarts(count:Int,within:scala.concurrent.duration.FiniteDuration):akka.stream.RestartSettings "Permalink")  def withMaxRestarts(count: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), within: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): RestartSettingsScala API: The amount of restarts is capped to `count` within a timeframe of `within`
37. [**](../../akka/stream/RestartSettings.html#withMinBackoff(value:java.time.Duration):akka.stream.RestartSettings "Permalink")  def withMinBackoff(value: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): RestartSettingsJava API: minimum (initial) duration until the child actor will started again, if it is terminated
38. [**](../../akka/stream/RestartSettings.html#withMinBackoff(value:scala.concurrent.duration.FiniteDuration):akka.stream.RestartSettings "Permalink")  def withMinBackoff(value: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): RestartSettingsScala API: minimum (initial) duration until the child actor will started again, if it is terminated
39. [**](../../akka/stream/RestartSettings.html#withRandomFactor(value:Double):akka.stream.RestartSettings "Permalink")  def withRandomFactor(value: [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double)): RestartSettingsAfter calculation of the exponential back\-off an additional random delay based on this factor is added
e.g.
...
40. [**](../../akka/stream/RestartSettings.html#withRestartOn(restartOn:java.util.function.Predicate[Throwable]):akka.stream.RestartSettings "Permalink")  def withRestartOn(restartOn: [Predicate](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Predicate.html#java.util.function.Predicate)\[Throwable]): RestartSettingsDecides whether the failure should restart the stream or make the surrounding stream fail
### Deprecated Value Members

1. [**](../../akka/stream/RestartSettings.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/stream/RestartSettings.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from RestartSettings toStringFormat\[RestartSettings] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/stream/RestartSettings.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (RestartSettings, B)ImplicitThis member is added by an implicit conversion from RestartSettings toArrowAssoc\[RestartSettings] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromRestartSettings to any2stringadd\[RestartSettings]

### Inherited by implicit conversion StringFormat fromRestartSettings to StringFormat\[RestartSettings]

### Inherited by implicit conversion Ensuring fromRestartSettings to Ensuring\[RestartSettings]

### Inherited by implicit conversion ArrowAssoc fromRestartSettings to ArrowAssoc\[RestartSettings]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/RestartSettings.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/RestartSettings.html)*