---
description: Akka 2.10.17 - akka.stream.Supervision
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:36:47Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/Supervision$.html
title: Akka 2.10.17 - akka.stream.Supervision
---

# Akka 2.10.17 - akka.stream.Supervision

> **Summary:** Akka 2.10.17 - akka.stream.Supervision
...
# Supervision[**](../../akka/stream/Supervision$.html "Permalink")

### 

#### object Supervision

Source[Supervision.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/Supervision.scala#L9)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Content Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Supervision
2. AnyRef
...
1. [**](../../akka/stream/Supervision$.html#Decider=Function[Throwable,akka.stream.Supervision.Directive] "Permalink")  type Decider \= (Throwable) \=\> [Directive](Supervision$$Directive.html)
2. [**](../../akka/stream/Supervision$$Directive.html "Permalink") sealed  trait [Directive](Supervision$$Directive.html) extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
### Value Members

1. [**](../../akka/stream/Supervision$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/Supervision$.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/Supervision$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/stream/Supervision$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../akka/stream/Supervision$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../akka/stream/Supervision$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
7. [**](../../akka/stream/Supervision$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
8. [**](../../akka/stream/Supervision$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
9. [**](../../akka/stream/Supervision$.html#getRestartingDecider:akka.japi.function.Function[Throwable,akka.stream.Supervision.Directive] "Permalink")  val getRestartingDecider: [Function](../japi/function/Function.html)\[Throwable, [Directive](Supervision$$Directive.html)]Java API: Decider function that returns [\#restart](#restart:akka.stream.Supervision.Restart.type) for all exceptions.
10. [**](../../akka/stream/Supervision$.html#getResumingDecider:akka.japi.function.Function[Throwable,akka.stream.Supervision.Directive] "Permalink")  val getResumingDecider: [Function](../japi/function/Function.html)\[Throwable, [Directive](Supervision$$Directive.html)]Java API: Decider function that returns [\#resume](#resume:akka.stream.Supervision.Resume.type) for all exceptions.
11. [**](../../akka/stream/Supervision$.html#getStoppingDecider:akka.japi.function.Function[Throwable,akka.stream.Supervision.Directive] "Permalink")  val getStoppingDecider: [Function](../japi/function/Function.html)\[Throwable, [Directive](Supervision$$Directive.html)]Java API: Decider function that returns [\#stop](#stop:akka.stream.Supervision.Stop.type) for all exceptions.
12. [**](../../akka/stream/Supervision$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../akka/stream/Supervision$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
14. [**](../../akka/stream/Supervision$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../akka/stream/Supervision$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/stream/Supervision$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/stream/Supervision$.html#restart:akka.stream.Supervision.Restart.type "Permalink")  def restart: [Restart](Supervision$$Restart$.html)Java API: The element is dropped and the stream continues after restarting the operator
...
18. [**](../../akka/stream/Supervision$.html#restartingDecider:akka.stream.Supervision.Deciderwithakka.japi.function.Function[Throwable,akka.stream.Supervision.Directive] "Permalink")  val restartingDecider: [Decider](#Decider=Function[Throwable,akka.stream.Supervision.Directive]) with [Function](../japi/function/Function.html)\[Throwable, [Directive](Supervision$$Directive.html)]Scala API: [Decider](#Decider=Function[Throwable,akka.stream.Supervision.Directive]) that returns [Restart](Supervision$$Restart$.html) for all exceptions.
19. [**](../../akka/stream/Supervision$.html#resume:akka.stream.Supervision.Resume.type "Permalink")  def resume: [Resume](Supervision$$Resume$.html)Java API: The element is dropped and the stream continues if application code for processing
an element throws an exception.
20. [**](../../akka/stream/Supervision$.html#resumingDecider:akka.stream.Supervision.Deciderwithakka.japi.function.Function[Throwable,akka.stream.Supervision.Directive] "Permalink")  val resumingDecider: [Decider](#Decider=Function[Throwable,akka.stream.Supervision.Directive]) with [Function](../japi/function/Function.html)\[Throwable, [Directive](Supervision$$Directive.html)]Scala API: [Decider](#Decider=Function[Throwable,akka.stream.Supervision.Directive]) that returns [Resume](Supervision$$Resume$.html) for all exceptions.
21. [**](../../akka/stream/Supervision$.html#stop:akka.stream.Supervision.Stop.type "Permalink")  def stop: [Stop](Supervision$$Stop$.html)Java API: The stream will be completed with failure if application code for processing an element
throws an exception.
22. [**](../../akka/stream/Supervision$.html#stoppingDecider:akka.stream.Supervision.Deciderwithakka.japi.function.Function[Throwable,akka.stream.Supervision.Directive] "Permalink")  val stoppingDecider: [Decider](#Decider=Function[Throwable,akka.stream.Supervision.Directive]) with [Function](../japi/function/Function.html)\[Throwable, [Directive](Supervision$$Directive.html)]Scala API: [Decider](#Decider=Function[Throwable,akka.stream.Supervision.Directive]) that returns [Stop](Supervision$$Stop$.html) for all exceptions.
23. [**](../../akka/stream/Supervision$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
24. [**](../../akka/stream/Supervision$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
25. [**](../../akka/stream/Supervision$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../akka/stream/Supervision$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
27. [**](../../akka/stream/Supervision$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../akka/stream/Supervision$$Restart$.html "Permalink")  case object [Restart](Supervision$$Restart$.html "Scala API: The element is dropped and the stream continues after restarting the operator if application code for processing an element throws an exception.") extends [Directive](Supervision$$Directive.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableScala API: The element is dropped and the stream continues after restarting the operator
if application code for processing an element throws an exception.
...
Restarting an operator means that any accumulated state is cleared. This is typically
performed by creating a new instance of the operator.
29. [**](../../akka/stream/Supervision$$Resume$.html "Permalink")  case object [Resume](Supervision$$Resume$.html "Scala API: The element is dropped and the stream continues if application code for processing an element throws an exception.") extends [Directive](Supervision$$Directive.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableScala API: The element is dropped and the stream continues if application code for processing
an element throws an exception.
30. [**](../../akka/stream/Supervision$$Stop$.html "Permalink")  case object [Stop](Supervision$$Stop$.html "Scala API: The stream will be completed with failure if application code for processing an element throws an exception.") extends [Directive](Supervision$$Directive.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableScala API: The stream will be completed with failure if application code for processing an element
throws an exception.
### Deprecated Value Members

1. [**](../../akka/stream/Supervision$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Supervision$.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Supervision$.html)*