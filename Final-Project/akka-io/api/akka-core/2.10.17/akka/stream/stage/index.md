---
description: Akka 2.10.17 - akka.stream.stage
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:30:57Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/stage/index.html
title: Akka 2.10.17 - akka.stream.stage
---

# Akka 2.10.17 - akka.stream.stage

> **Summary:** Akka 2.10.17 - akka.stream.stage
...
The architecture of Akka Streams internally consists of several distinct layers:
 ...
 \* The [akka.stream.stage.GraphStage](GraphStage.html) API is the user facing API for creating new stream operators. These
 ...
 are used to execute synchronous islands (subgraphs) of [akka.stream.stage.GraphStage](GraphStage.html)s.
...
- [**](../../../akka/stream/stage/index.html "Permalink")  package stageDefinition Classes[stream](../index.html)
...
# stage[**](../../../akka/stream/stage/index.html "Permalink")
...
1. [**](../../../akka/stream/stage/AbstractGraphStageWithMaterializedValue.html "Permalink") abstract  class [AbstractGraphStageWithMaterializedValue](AbstractGraphStageWithMaterializedValue.html "Java API: A GraphStage represents a reusable graph stream processing operator.")\[\+S \<: [Shape](../Shape.html), M] extends [GraphStageWithMaterializedValue](GraphStageWithMaterializedValue.html)\[S, M]Java API: A GraphStage represents a reusable graph stream processing operator.
...
A GraphStage consists of a [Shape](AbstractGraphStageWithMaterializedValue.html#Shape=S@scala.annotation.unchecked.uncheckedVariance) which describes its input and output ports and a factory function that
...
2. [**](../../../akka/stream/stage/AbstractInHandler.html "Permalink") abstract  class [AbstractInHandler](AbstractInHandler.html "Java API: callbacks for an input port where termination logic is predefined (completing when upstream completes, failing when upstream fails).") extends [InHandler](InHandler.html)Java API: callbacks for an input port where termination logic is predefined
(completing when upstream completes, failing when upstream fails).
3. [**](../../../akka/stream/stage/AbstractInOutHandler.html "Permalink") abstract  class [AbstractInOutHandler](AbstractInOutHandler.html "Java API: callback combination for output and input ports where termination logic is predefined (completing when upstream completes, failing when upstream fails, completing when downstream cancels).") extends [InHandler](InHandler.html) with [OutHandler](OutHandler.html)Java API: callback combination for output and input ports where termination logic is predefined
(completing when upstream completes, failing when upstream fails, completing when downstream cancels).
4. [**](../../../akka/stream/stage/AbstractOutHandler.html "Permalink") abstract  class [AbstractOutHandler](AbstractOutHandler.html "Java API: callbacks for an output port where termination logic is predefined (completing when downstream cancels).") extends [OutHandler](OutHandler.html)Java API: callbacks for an output port where termination logic is predefined
(completing when downstream cancels).
5. [**](../../../akka/stream/stage/AsyncCallback.html "Permalink")  trait [AsyncCallback](AsyncCallback.html "An asynchronous callback holder that is attached to a GraphStageLogic.")\[T] extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)An asynchronous callback holder that is attached to a [GraphStageLogic](GraphStageLogic.html).

An asynchronous callback holder that is attached to a [GraphStageLogic](GraphStageLogic.html).
Initializing [AsyncCallback\#invoke](AsyncCallback.html#invoke(t:T):Unit) will eventually lead to the registered handler
being called.
...
6. [**](../../../akka/stream/stage/GraphStage.html "Permalink") abstract  class [GraphStage](GraphStage.html "A GraphStage represents a reusable graph stream processing operator.")\[S \<: [Shape](../Shape.html)] extends [GraphStageWithMaterializedValue](GraphStageWithMaterializedValue.html)\[S, [NotUsed](../../NotUsed.html)]A GraphStage represents a reusable graph stream processing operator.

A GraphStage represents a reusable graph stream processing operator.

A GraphStage consists of a [Shape](GraphStage.html#Shape=S@scala.annotation.unchecked.uncheckedVariance) which describes its input and output ports and a factory function that
creates a [GraphStageLogic](GraphStageLogic.html) which implements the processing logic that ties the ports together.
7. [**](../../../akka/stream/stage/GraphStageLogic.html "Permalink") abstract  class [GraphStageLogic](GraphStageLogic.html "Represents the processing logic behind a GraphStage.") extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Represents the processing logic behind a [GraphStage](GraphStage.html).
...
8. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html "Permalink") abstract  class [GraphStageLogicWithLogging](GraphStageLogicWithLogging.html "Java API: GraphStageLogic with StageLogging.") extends [GraphStageLogic](GraphStageLogic.html) with [StageLogging](StageLogging.html)Java API: [GraphStageLogic](GraphStageLogic.html) with [StageLogging](StageLogging.html).
9. [**](../../../akka/stream/stage/GraphStageWithMaterializedValue.html "Permalink") abstract  class [GraphStageWithMaterializedValue](GraphStageWithMaterializedValue.html "Scala API: A GraphStage represents a reusable graph stream processing operator.")\[\+S \<: [Shape](../Shape.html), \+M] extends [Graph](../Graph.html)\[S, M]Scala API: A GraphStage represents a reusable graph stream processing operator.
...
A GraphStage consists of a [Shape](GraphStageWithMaterializedValue.html#Shape=S@scala.annotation.unchecked.uncheckedVariance) which describes its input and output ports and a factory function that
creates a [GraphStageLogic](GraphStageLogic.html) which implements the processing logic that ties the ports together.
...
10. [**](../../../akka/stream/stage/InHandler.html "Permalink")  trait [InHandler](InHandler.html "Collection of callbacks for an input port of a GraphStage") extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Collection of callbacks for an input port of a [GraphStage](GraphStage.html)
11. [**](../../../akka/stream/stage/OutHandler.html "Permalink")  trait [OutHandler](OutHandler.html "Collection of callbacks for an output port of a GraphStage") extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Collection of callbacks for an output port of a [GraphStage](GraphStage.html)
12. [**](../../../akka/stream/stage/StageLogging.html "Permalink")  trait [StageLogging](StageLogging.html "Simple way to obtain a akka.event.LoggingAdapter when used together with an akka.stream.Materializer.") extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Simple way to obtain a [akka.event.LoggingAdapter](../../event/LoggingAdapter.html) when used together with an [akka.stream.Materializer](../Materializer.html).

Simple way to obtain a [akka.event.LoggingAdapter](../../event/LoggingAdapter.html) when used together with an [akka.stream.Materializer](../Materializer.html).
If used with a different materializer [akka.event.NoLogging](../../event/NoLogging$.html) will be returned.

Make sure to only access `log` from GraphStage callbacks (such as `pull`, `push` or the async\-callback).

Note, abiding to [akka.stream.ActorAttributes.logLevels](../ActorAttributes$.html#logLevels(onElement:akka.event.Logging.LogLevel,onFinish:akka.event.Logging.LogLevel,onFailure:akka.event.Logging.LogLevel):akka.stream.Attributes) has to be done manually,
...
13. [**](../../../akka/stream/stage/TimerGraphStageLogic.html "Permalink") abstract  class [TimerGraphStageLogic](TimerGraphStageLogic.html "Provides timer related facilities to a GraphStageLogic.") extends [GraphStageLogic](GraphStageLogic.html)Provides timer related facilities to a [GraphStageLogic](GraphStageLogic.html).
...
14. [**](../../../akka/stream/stage/TimerGraphStageLogicWithLogging.html "Permalink") abstract  class [TimerGraphStageLogicWithLogging](TimerGraphStageLogicWithLogging.html "Java API: TimerGraphStageLogic with StageLogging.") extends [TimerGraphStageLogic](TimerGraphStageLogic.html) with [StageLogging](StageLogging.html)Java API: [TimerGraphStageLogic](TimerGraphStageLogic.html) with [StageLogging](StageLogging.html).
### Value Members

1. [**](../../../akka/stream/stage/GraphStageLogic$.html "Permalink")  object [GraphStageLogic](GraphStageLogic$.html)
### Ungrouped
...
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/InPort.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Inlet.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Materializer.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/OutPort.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Outlet.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Shape.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/impl/index.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/index.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/javadsl/index.html
...
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/scaladsl/RunnableGraph.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/scaladsl/Sink.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/scaladsl/Source.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/scaladsl/index.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/snapshot/index.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/AbstractGraphStageWithMaterializedValue.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/AbstractInHandler.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/AbstractInOutHandler.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/AbstractOutHandler.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/AsyncCallback.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/GraphStage.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/GraphStageLogic$.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/GraphStageLogic.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/GraphStageLogicWithLogging.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/GraphStageWithMaterializedValue.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/InHandler.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/OutHandler.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/StageLogging.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/TimerGraphStageLogic.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/TimerGraphStageLogicWithLogging.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/index.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/testkit/index.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/stream/typed/index.html
- https://doc.akka.io/api/akka-core/2.10.17/index.html

---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/index.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/stage/index.html)*