---
description: Akka 2.10.17 - akka.stream.SinkRef
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:35:42Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/SinkRef.html
title: Akka 2.10.17 - akka.stream.SinkRef
---

# Akka 2.10.17 - akka.stream.SinkRef

> **Summary:** Akka 2.10.17 - akka.stream.SinkRef
...
[t](SinkRef$.html "See companion object")[akka](../index.html).[stream](index.html)

# [SinkRef](SinkRef$.html "See companion object")[**](../../akka/stream/SinkRef.html "Permalink")

### Companion [object SinkRef](SinkRef$.html "See companion object")

#### trait SinkRef\[In] extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
...
Annotations@[DoNotInherit](../annotation/DoNotInherit.html)() Source[StreamRefs.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/StreamRefs.scala#L45)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. SinkRef
2. AnyRef
...
1. [**](../../akka/stream/SinkRef.html#sink():akka.stream.scaladsl.Sink[In,akka.NotUsed] "Permalink") abstract  def sink(): [Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)]Scala API: Get Sink underlying to this source ref.
### Concrete Value Members

1. [**](../../akka/stream/SinkRef.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/SinkRef.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/SinkRef.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from SinkRef\[In] toany2stringadd\[SinkRef\[In]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/SinkRef.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (SinkRef\[In], B)ImplicitThis member is added by an implicit conversion from SinkRef\[In] toArrowAssoc\[SinkRef\[In]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/SinkRef.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/SinkRef.html#addAttributes(attr:akka.stream.Attributes):akka.stream.scaladsl.Sink[In,Mat] "Permalink")  def addAttributes(attr: [Attributes](Attributes.html)): [Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)]Add the given attributes to this [Sink](scaladsl/Sink.html).

Add the given attributes to this [Sink](scaladsl/Sink.html). If the specific attribute was already present
on this graph this means the added attribute will be more specific than the existing one.
If this Sink is a composite of multiple graphs, new attributes on the composite will be
less specific than attributes set directly on the individual graphs of the composite.

ImplicitThis member is added by an implicit conversion from SinkRef\[In] to[Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)] performed by method convertRefToSink in [akka.stream.SinkRef](SinkRef$.html).Definition Classes[Sink](scaladsl/Sink.html) → [Graph](Graph.html)
7. [**](../../akka/stream/SinkRef.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
8. [**](../../akka/stream/SinkRef.html#asJava[JIn<:In]:akka.stream.javadsl.Sink[JIn,Mat@scala.annotation.unchecked.uncheckedVariance] "Permalink")  def asJava\[JIn \<: In]: [Sink](javadsl/Sink.html)\[JIn, [NotUsed](../NotUsed.html)]Converts this Scala DSL element to it's Java DSL counterpart.

Converts this Scala DSL element to it's Java DSL counterpart.

ImplicitThis member is added by an implicit conversion from SinkRef\[In] to[Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)] performed by method convertRefToSink in [akka.stream.SinkRef](SinkRef$.html).Definition Classes[Sink](scaladsl/Sink.html)
9. [**](../../akka/stream/SinkRef.html#async(dispatcher:String,inputBufferSize:Int):akka.stream.scaladsl.Sink[In,Mat] "Permalink")  def async(dispatcher: String, inputBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)]Put an asynchronous boundary around this `Graph`
...
ImplicitThis member is added by an implicit conversion from SinkRef\[In] to[Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)] performed by method convertRefToSink in [akka.stream.SinkRef](SinkRef$.html).Definition Classes[Sink](scaladsl/Sink.html) → [Graph](Graph.html)
10. [**](../../akka/stream/SinkRef.html#async(dispatcher:String):akka.stream.scaladsl.Sink[In,Mat] "Permalink")  def async(dispatcher: String): [Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)]Put an asynchronous boundary around this `Graph`
...
ImplicitThis member is added by an implicit conversion from SinkRef\[In] to[Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)] performed by method convertRefToSink in [akka.stream.SinkRef](SinkRef$.html).Definition Classes[Sink](scaladsl/Sink.html) → [Graph](Graph.html)
11. [**](../../akka/stream/SinkRef.html#async:akka.stream.scaladsl.Sink[In,Mat] "Permalink")  def async: [Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)]Put an asynchronous boundary around this `Source`

Put an asynchronous boundary around this `Source`

ImplicitThis member is added by an implicit conversion from SinkRef\[In] to[Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)] performed by method convertRefToSink in [akka.stream.SinkRef](SinkRef$.html).Definition Classes[Sink](scaladsl/Sink.html) → [Graph](Graph.html)
12. [**](../../akka/stream/SinkRef.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
13. [**](../../akka/stream/SinkRef.html#contramap[In2](f:In2=>In):akka.stream.scaladsl.Sink[In2,Mat] "Permalink")  def contramap\[In2](f: (In2) \=\> In): [Sink](scaladsl/Sink.html)\[In2, [NotUsed](../NotUsed.html)]Transform this Sink by applying a function to each \*incoming\* upstream element before
it is passed to the [Sink](scaladsl/Sink.html)

Transform this Sink by applying a function to each \*incoming\* upstream element before
it is passed to the [Sink](scaladsl/Sink.html)

**Backpressures when** original [Sink](scaladsl/Sink.html) backpressures

**Cancels when** original [Sink](scaladsl/Sink.html) cancels

ImplicitThis member is added by an implicit conversion from SinkRef\[In] to[Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)] performed by method convertRefToSink in [akka.stream.SinkRef](SinkRef$.html).Definition Classes[Sink](scaladsl/Sink.html)
14. [**](../../akka/stream/SinkRef.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (SinkRef\[In]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SinkRef\[In]ImplicitThis member is added by an implicit conversion from SinkRef\[In] toEnsuring\[SinkRef\[In]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/stream/SinkRef.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (SinkRef\[In]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SinkRef\[In]ImplicitThis member is added by an implicit conversion from SinkRef\[In] toEnsuring\[SinkRef\[In]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/stream/SinkRef.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SinkRef\[In]ImplicitThis member is added by an implicit conversion from SinkRef\[In] toEnsuring\[SinkRef\[In]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../akka/stream/SinkRef.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SinkRef\[In]ImplicitThis member is added by an implicit conversion from SinkRef\[In] toEnsuring\[SinkRef\[In]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
18. [**](../../akka/stream/SinkRef.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../akka/stream/SinkRef.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
20. [**](../../akka/stream/SinkRef.html#getAttributes:akka.stream.Attributes "Permalink")  def getAttributes: [Attributes](Attributes.html)ImplicitThis member is added by an implicit conversion from SinkRef\[In] to[Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)] performed by method convertRefToSink in [akka.stream.SinkRef](SinkRef$.html).Definition Classes[Sink](scaladsl/Sink.html) → [Graph](Graph.html)
21. [**](../../akka/stream/SinkRef.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/stream/SinkRef.html#getSink():akka.stream.javadsl.Sink[In,akka.NotUsed] "Permalink") final  def getSink(): [Sink](javadsl/Sink.html)\[In, [NotUsed](../NotUsed.html)]Java API: Get [javadsl.Sink](javadsl/Sink.html) underlying to this source ref.
23. [**](../../akka/stream/SinkRef.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../akka/stream/SinkRef.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
25. [**](../../akka/stream/SinkRef.html#mapMaterializedValue[Mat2](f:Mat=>Mat2):akka.stream.scaladsl.Sink[In,Mat2] "Permalink")  def mapMaterializedValue\[Mat2](f: ([NotUsed](../NotUsed.html)) \=\> Mat2): [Sink](scaladsl/Sink.html)\[In, Mat2]Transform only the materialized value of this Sink, leaving all other properties as they were.

Transform only the materialized value of this Sink, leaving all other properties as they were.

ImplicitThis member is added by an implicit conversion from SinkRef\[In] to[Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)] performed by method convertRefToSink in [akka.stream.SinkRef](SinkRef$.html).Definition Classes[Sink](scaladsl/Sink.html)
26. [**](../../akka/stream/SinkRef.html#named(name:String):akka.stream.scaladsl.Sink[In,Mat] "Permalink")  def named(name: String): [Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)]Add a `name` attribute to this Sink.

Add a `name` attribute to this Sink.

ImplicitThis member is added by an implicit conversion from SinkRef\[In] to[Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)] performed by method convertRefToSink in [akka.stream.SinkRef](SinkRef$.html).Definition Classes[Sink](scaladsl/Sink.html) → [Graph](Graph.html)
27. [**](../../akka/stream/SinkRef.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
28. [**](../../akka/stream/SinkRef.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
29. [**](../../akka/stream/SinkRef.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
30. [**](../../akka/stream/SinkRef.html#preMaterialize()(implicitmaterializer:akka.stream.Materializer):(Mat,akka.stream.scaladsl.Sink[In,akka.NotUsed]) "Permalink")  def preMaterialize()(implicit materializer: [Materializer](Materializer.html)): ([NotUsed](../NotUsed.html), [Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)])Materializes this Sink, immediately returning (1\) its materialized value, and (2\) a new Sink
...
ImplicitThis member is added by an implicit conversion from SinkRef\[In] to[Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)] performed by method convertRefToSink in [akka.stream.SinkRef](SinkRef$.html).Definition Classes[Sink](scaladsl/Sink.html)
32. [**](../../akka/stream/SinkRef.html#shape:akka.stream.SinkShape[In] "Permalink")  val shape: [SinkShape](SinkShape.html)\[In]The shape of a graph is all that is externally visible: its inlets and outlets.

The shape of a graph is all that is externally visible: its inlets and outlets.

ImplicitThis member is added by an implicit conversion from SinkRef\[In] to[Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)] performed by method convertRefToSink in [akka.stream.SinkRef](SinkRef$.html).Definition Classes[Sink](scaladsl/Sink.html) → [Graph](Graph.html)
33. [**](../../akka/stream/SinkRef.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
34. [**](../../akka/stream/SinkRef.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
35. [**](../../akka/stream/SinkRef.html#traversalBuilder:akka.stream.impl.LinearTraversalBuilder "Permalink")  val traversalBuilder: LinearTraversalBuilderINTERNAL API.
...
ImplicitThis member is added by an implicit conversion from SinkRef\[In] to[Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)] performed by method convertRefToSink in [akka.stream.SinkRef](SinkRef$.html).Definition Classes[Sink](scaladsl/Sink.html) → [Graph](Graph.html)
36. [**](../../akka/stream/SinkRef.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
37. [**](../../akka/stream/SinkRef.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
38. [**](../../akka/stream/SinkRef.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
39. [**](../../akka/stream/SinkRef.html#withAttributes(attr:akka.stream.Attributes):akka.stream.scaladsl.Sink[In,Mat] "Permalink")  def withAttributes(attr: [Attributes](Attributes.html)): [Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)]Replace the attributes of this [Sink](scaladsl/Sink.html) with the given ones.

Replace the attributes of this [Sink](scaladsl/Sink.html) with the given ones. If this Sink is a composite
...
1. [**](../../akka/stream/SinkRef.html#toString():String "Permalink")  def toString(): StringImplicitThis member is added by an implicit conversion from SinkRef\[In] to[Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)] performed by method convertRefToSink in [akka.stream.SinkRef](SinkRef$.html).ShadowingThis implicitly inherited member is shadowed by one or more members in this class.  
To access this member you can use a [type ascription](https://stackoverflow.com/questions/2087250/what-is-the-purpose-of-type-ascription-in-scala):  

```
(sinkRef: Sink[In, NotUsed]).toString()
```
Definition Classes[Sink](scaladsl/Sink.html) → AnyRef → Any
### Deprecated Value Members

1. [**](../../akka/stream/SinkRef.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/stream/SinkRef.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from SinkRef\[In] toStringFormat\[SinkRef\[In]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/stream/SinkRef.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (SinkRef\[In], B)ImplicitThis member is added by an implicit conversion from SinkRef\[In] toArrowAssoc\[SinkRef\[In]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion convertRefToSink fromSinkRef\[In] to [Sink](scaladsl/Sink.html)\[In, [NotUsed](../NotUsed.html)]

### Inherited by implicit conversion any2stringadd fromSinkRef\[In] to any2stringadd\[SinkRef\[In]]

### Inherited by implicit conversion StringFormat fromSinkRef\[In] to StringFormat\[SinkRef\[In]]

### Inherited by implicit conversion Ensuring fromSinkRef\[In] to Ensuring\[SinkRef\[In]]

### Inherited by implicit conversion ArrowAssoc fromSinkRef\[In] to ArrowAssoc\[SinkRef\[In]]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/SinkRef.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/SinkRef.html)*