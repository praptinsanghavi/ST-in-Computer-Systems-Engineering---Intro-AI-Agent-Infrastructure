---
description: Akka 2.10.17 - akka.stream.Materializer
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:30:54Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/Materializer.html
title: Akka 2.10.17 - akka.stream.Materializer
---

# Akka 2.10.17 - akka.stream.Materializer

> **Summary:** Akka 2.10.17 - akka.stream.Materializer
...
[c](Materializer$.html "See companion object")[akka](../index.html).[stream](index.html)

# [Materializer](Materializer$.html "See companion object")[**](../../akka/stream/Materializer.html "Permalink")

### Companion [object Materializer](Materializer$.html "See companion object")

#### abstract  class Materializer extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
...
Annotations@implicitNotFound() @nowarn() @[DoNotInherit](../annotation/DoNotInherit.html)() Source[Materializer.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/Materializer.scala#L31)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[ActorMaterializer](ActorMaterializer.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Materializer
2. AnyRef
...
2. [**](../../akka/stream/Materializer.html#isShutdown:Boolean "Permalink") abstract  def isShutdown: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Indicates if the materializer has been shut down.
3. [**](../../akka/stream/Materializer.html#materialize[Mat](runnable:akka.stream.Graph[akka.stream.ClosedShape,Mat],defaultAttributes:akka.stream.Attributes):Mat "Permalink") abstract  def materialize\[Mat](runnable: [Graph](Graph.html)\[[ClosedShape](ClosedShape.html), Mat], defaultAttributes: [Attributes](Attributes.html)): MatThis method interprets the given Flow description and creates the running
...
processing networks.
4. [**](../../akka/stream/Materializer.html#materialize[Mat](runnable:akka.stream.Graph[akka.stream.ClosedShape,Mat]):Mat "Permalink") abstract  def materialize\[Mat](runnable: [Graph](Graph.html)\[[ClosedShape](ClosedShape.html), Mat]): MatThis method interprets the given Flow description and creates the running
stream.
...
5. [**](../../akka/stream/Materializer.html#scheduleAtFixedRate(initialDelay:scala.concurrent.duration.FiniteDuration,interval:scala.concurrent.duration.FiniteDuration,task:Runnable):akka.actor.Cancellable "Permalink") abstract  def scheduleAtFixedRate(initialDelay: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), interval: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), task: [Runnable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Runnable.html#java.lang.Runnable)): [Cancellable](../actor/Cancellable.html)Interface for operators that need timer services for their functionality.
...
6. [**](../../akka/stream/Materializer.html#scheduleOnce(delay:scala.concurrent.duration.FiniteDuration,task:Runnable):akka.actor.Cancellable "Permalink") abstract  def scheduleOnce(delay: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), task: [Runnable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Runnable.html#java.lang.Runnable)): [Cancellable](../actor/Cancellable.html)Interface for operators that need timer services for their functionality.
...
returnsA [akka.actor.Cancellable](../actor/Cancellable.html) that allows cancelling the timer. Cancelling is best effort, if the event
 has been already enqueued it will not have an effect.
7. [**](../../akka/stream/Materializer.html#scheduleWithFixedDelay(initialDelay:scala.concurrent.duration.FiniteDuration,delay:scala.concurrent.duration.FiniteDuration,task:Runnable):akka.actor.Cancellable "Permalink") abstract  def scheduleWithFixedDelay(initialDelay: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), delay: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), task: [Runnable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Runnable.html#java.lang.Runnable)): [Cancellable](../actor/Cancellable.html)Interface for operators that need timer services for their functionality.
...
Exceptions thrown`IllegalArgumentException` if the given delays exceed the maximum
 supported by the `Scheduler`.
8. [**](../../akka/stream/Materializer.html#shutdown():Unit "Permalink") abstract  def shutdown(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Shuts down this materializer and all the operators that have been materialized through this materializer.
...
9. [**](../../akka/stream/Materializer.html#system:akka.actor.ActorSystem "Permalink") abstract  def system: [ActorSystem](../actor/ActorSystem.html)The classic actor system this materializer is backed by (and in which the streams materialized with the
materializer will run)
10. [**](../../akka/stream/Materializer.html#withNamePrefix(name:String):akka.stream.Materializer "Permalink") abstract  def withNamePrefix(name: String): MaterializerThe `namePrefix` shall be used for deriving the names of processing
...
stream is running.
11. [**](../../akka/stream/Materializer.html#schedulePeriodically(initialDelay:scala.concurrent.duration.FiniteDuration,interval:scala.concurrent.duration.FiniteDuration,task:Runnable):akka.actor.Cancellable "Permalink") abstract  def schedulePeriodically(initialDelay: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), interval: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), task: [Runnable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Runnable.html#java.lang.Runnable)): [Cancellable](../actor/Cancellable.html)Interface for operators that need timer services for their functionality.
...
12. [**](../../akka/stream/Materializer.html#settings:akka.stream.ActorMaterializerSettings "Permalink") abstract  def settings: [ActorMaterializerSettings](ActorMaterializerSettings.html)Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use attributes to access settings from stages
### Concrete Value Members

1. [**](../../akka/stream/Materializer.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/Materializer.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/Materializer.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from Materializer toany2stringadd\[Materializer] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/Materializer.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (Materializer, B)ImplicitThis member is added by an implicit conversion from Materializer toArrowAssoc\[Materializer] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/Materializer.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/Materializer.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/stream/Materializer.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/stream/Materializer.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (Materializer) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): MaterializerImplicitThis member is added by an implicit conversion from Materializer toEnsuring\[Materializer] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/stream/Materializer.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (Materializer) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): MaterializerImplicitThis member is added by an implicit conversion from Materializer toEnsuring\[Materializer] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/stream/Materializer.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): MaterializerImplicitThis member is added by an implicit conversion from Materializer toEnsuring\[Materializer] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/stream/Materializer.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): MaterializerImplicitThis member is added by an implicit conversion from Materializer toEnsuring\[Materializer] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/stream/Materializer.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/stream/Materializer.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/stream/Materializer.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/stream/Materializer.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/stream/Materializer.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/stream/Materializer.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/stream/Materializer.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/stream/Materializer.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/stream/Materializer.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/stream/Materializer.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/stream/Materializer.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/stream/Materializer.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/stream/Materializer.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/stream/Materializer.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/stream/Materializer.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from Materializer toStringFormat\[Materializer] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/stream/Materializer.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (Materializer, B)ImplicitThis member is added by an implicit conversion from Materializer toArrowAssoc\[Materializer] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromMaterializer to any2stringadd\[Materializer]

### Inherited by implicit conversion StringFormat fromMaterializer to StringFormat\[Materializer]

### Inherited by implicit conversion Ensuring fromMaterializer to Ensuring\[Materializer]

### Inherited by implicit conversion ArrowAssoc fromMaterializer to ArrowAssoc\[Materializer]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Materializer.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/Materializer.html)*