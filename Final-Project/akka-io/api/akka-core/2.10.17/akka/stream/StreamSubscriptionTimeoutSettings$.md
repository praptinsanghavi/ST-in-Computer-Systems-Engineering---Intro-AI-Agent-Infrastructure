...
scraped_at: '2026-04-06T01:36:33Z'
section: api
site: akka-io
...
[o](StreamSubscriptionTimeoutSettings.html "See companion class")[akka](../index.html).[stream](index.html)

# [StreamSubscriptionTimeoutSettings](StreamSubscriptionTimeoutSettings.html "See companion class")[**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html "Permalink")

### Companion [class StreamSubscriptionTimeoutSettings](StreamSubscriptionTimeoutSettings.html "See companion class")

#### object StreamSubscriptionTimeoutSettings

Source[ActorMaterializer.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/ActorMaterializer.scala#L753)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
3. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#apply(config:com.typesafe.config.Config):akka.stream.StreamSubscriptionTimeoutSettings "Permalink")  def apply(config: Config): [StreamSubscriptionTimeoutSettings](StreamSubscriptionTimeoutSettings.html)Create settings from a Config subsection (Scala).
5. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#apply(mode:akka.stream.StreamSubscriptionTimeoutTerminationMode,timeout:scala.concurrent.duration.FiniteDuration):akka.stream.StreamSubscriptionTimeoutSettings "Permalink")  def apply(mode: [StreamSubscriptionTimeoutTerminationMode](StreamSubscriptionTimeoutTerminationMode.html), timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): [StreamSubscriptionTimeoutSettings](StreamSubscriptionTimeoutSettings.html)Create settings from individual values (Scala).
...
8. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#create(config:com.typesafe.config.Config):akka.stream.StreamSubscriptionTimeoutSettings "Permalink")  def create(config: Config): [StreamSubscriptionTimeoutSettings](StreamSubscriptionTimeoutSettings.html)Create settings from a Config subsection (Java).
9. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#create(mode:akka.stream.StreamSubscriptionTimeoutTerminationMode,timeout:scala.concurrent.duration.FiniteDuration):akka.stream.StreamSubscriptionTimeoutSettings "Permalink")  def create(mode: [StreamSubscriptionTimeoutTerminationMode](StreamSubscriptionTimeoutTerminationMode.html), timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): [StreamSubscriptionTimeoutSettings](StreamSubscriptionTimeoutSettings.html)Create settings from individual values (Java).
10. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
11. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
12. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
15. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
16. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
19. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
20. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
21. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
22. [**](../../akka/stream/StreamSubscriptionTimeoutSettings$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
