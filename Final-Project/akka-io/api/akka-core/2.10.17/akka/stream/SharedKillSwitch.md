---
description: Akka 2.10.17 - akka.stream.SharedKillSwitch
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:35:45Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/SharedKillSwitch.html
title: Akka 2.10.17 - akka.stream.SharedKillSwitch
---

# Akka 2.10.17 - akka.stream.SharedKillSwitch

> **Summary:** Akka 2.10.17 - akka.stream.SharedKillSwitch
...
# SharedKillSwitch[**](../../akka/stream/SharedKillSwitch.html "Permalink")

### 

#### final  class SharedKillSwitch extends [KillSwitch](KillSwitch.html)

A SharedKillSwitch is a provider for [Graph](Graph.html)s of [FlowShape](FlowShape.html) that can be completed or failed from the outside.
...
After calling [SharedKillSwitch\#shutdown](#shutdown():Unit) all materialized, running instances of all [Graph](Graph.html)s provided by the
...
case the command is ignored). Subsequent invocations of [SharedKillSwitch\#shutdown](#shutdown():Unit) and [SharedKillSwitch\#abort](#abort(reason:Throwable):Unit) will be
ignored.

After calling [SharedKillSwitch\#abort](#abort(reason:Throwable):Unit) all materialized, running instances of all [Graph](Graph.html)s provided by the
...
[SharedKillSwitch\#shutdown](#shutdown():Unit) and [SharedKillSwitch\#abort](#abort(reason:Throwable):Unit) will be ignored.

The [Graph](Graph.html)s provided by the SharedKillSwitch do not modify the passed through elements in any way or affect
backpressure in the stream. All provided [Graph](Graph.html)s provide the parent SharedKillSwitch as materialized value.

This class is thread\-safe, the instance can be passed safely among threads and its methods may be invoked concurrently.

Source[KillSwitch.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/KillSwitch.scala#L246)Linear Supertypes[KillSwitch](KillSwitch.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. SharedKillSwitch
2. KillSwitch
...
1. [**](../../akka/stream/SharedKillSwitch.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/SharedKillSwitch.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/SharedKillSwitch.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from SharedKillSwitch toany2stringadd\[SharedKillSwitch] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/SharedKillSwitch.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (SharedKillSwitch, B)ImplicitThis member is added by an implicit conversion from SharedKillSwitch toArrowAssoc\[SharedKillSwitch] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/SharedKillSwitch.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/SharedKillSwitch.html#abort(reason:Throwable):Unit "Permalink")  def abort(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)After calling [SharedKillSwitch\#abort](#abort(reason:Throwable):Unit) all materialized, running instances of all [Graph](Graph.html)s provided by the
SharedKillSwitch will fail their downstreams with the provided exception and cancel their upstreams
...
These provided [Graph](Graph.html)s materialize to their owning switch. This might make certain integrations simpler than
passing around the switch instance itself.

reasonThe exception to be used for failing the linked [Graph](Graph.html)s

Definition ClassesSharedKillSwitch → [KillSwitch](KillSwitch.html)
7. [**](../../akka/stream/SharedKillSwitch.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
8. [**](../../akka/stream/SharedKillSwitch.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../akka/stream/SharedKillSwitch.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (SharedKillSwitch) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SharedKillSwitchImplicitThis member is added by an implicit conversion from SharedKillSwitch toEnsuring\[SharedKillSwitch] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/stream/SharedKillSwitch.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (SharedKillSwitch) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SharedKillSwitchImplicitThis member is added by an implicit conversion from SharedKillSwitch toEnsuring\[SharedKillSwitch] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/stream/SharedKillSwitch.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SharedKillSwitchImplicitThis member is added by an implicit conversion from SharedKillSwitch toEnsuring\[SharedKillSwitch] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/stream/SharedKillSwitch.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SharedKillSwitchImplicitThis member is added by an implicit conversion from SharedKillSwitch toEnsuring\[SharedKillSwitch] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/stream/SharedKillSwitch.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/stream/SharedKillSwitch.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
15. [**](../../akka/stream/SharedKillSwitch.html#flow[T]:akka.stream.Graph[akka.stream.FlowShape[T,T],akka.stream.SharedKillSwitch] "Permalink")  def flow\[T]: [Graph](Graph.html)\[[FlowShape](FlowShape.html)\[T, T], SharedKillSwitch]Returns a typed Flow of a requested type that will be linked to this SharedKillSwitch instance.

Returns a typed Flow of a requested type that will be linked to this SharedKillSwitch instance. By invoking
[SharedKillSwitch\#shutdown](#shutdown():Unit) or [SharedKillSwitch\#abort](#abort(reason:Throwable):Unit) all running instances of all provided [Graph](Graph.html)s by this
switch will be stopped normally or failed.

TType of the elements the Flow will forward

returnsA reusable [Graph](Graph.html) that is linked with the switch. The materialized value provided is this switch itself.
16. [**](../../akka/stream/SharedKillSwitch.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/stream/SharedKillSwitch.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/stream/SharedKillSwitch.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
19. [**](../../akka/stream/SharedKillSwitch.html#name:String "Permalink")  val name: String
20. [**](../../akka/stream/SharedKillSwitch.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
21. [**](../../akka/stream/SharedKillSwitch.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/stream/SharedKillSwitch.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../akka/stream/SharedKillSwitch.html#shutdown():Unit "Permalink")  def shutdown(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)After calling [SharedKillSwitch\#shutdown](#shutdown():Unit) all materialized, running instances of all [Graph](Graph.html)s provided by the
SharedKillSwitch will complete their downstreams and cancel their upstreams (unless if finished or failed already in which
...
Definition ClassesSharedKillSwitch → [KillSwitch](KillSwitch.html)
24. [**](../../akka/stream/SharedKillSwitch.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
25. [**](../../akka/stream/SharedKillSwitch.html#toString():String "Permalink")  def toString(): StringDefinition ClassesSharedKillSwitch → AnyRef → Any
26. [**](../../akka/stream/SharedKillSwitch.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
27. [**](../../akka/stream/SharedKillSwitch.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
28. [**](../../akka/stream/SharedKillSwitch.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/stream/SharedKillSwitch.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/stream/SharedKillSwitch.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from SharedKillSwitch toStringFormat\[SharedKillSwitch] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/stream/SharedKillSwitch.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (SharedKillSwitch, B)ImplicitThis member is added by an implicit conversion from SharedKillSwitch toArrowAssoc\[SharedKillSwitch] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [KillSwitch](KillSwitch.html)

### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromSharedKillSwitch to any2stringadd\[SharedKillSwitch]

### Inherited by implicit conversion StringFormat fromSharedKillSwitch to StringFormat\[SharedKillSwitch]

### Inherited by implicit conversion Ensuring fromSharedKillSwitch to Ensuring\[SharedKillSwitch]

### Inherited by implicit conversion ArrowAssoc fromSharedKillSwitch to ArrowAssoc\[SharedKillSwitch]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/stream/SharedKillSwitch.html](https://doc.akka.io/api/akka-core/2.10.17/akka/stream/SharedKillSwitch.html)*