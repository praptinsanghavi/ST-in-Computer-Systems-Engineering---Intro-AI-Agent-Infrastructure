...
scraped_at: '2026-04-06T15:08:57Z'
section: api
site: akka-io
...
[o](SerializerDetails.html "See companion class")[akka](../index.html).[serialization](index.html)

# [SerializerDetails](SerializerDetails.html "See companion class")[**](../../akka/serialization/SerializerDetails$.html "Permalink")

### Companion [class SerializerDetails](SerializerDetails.html "See companion class")

#### object SerializerDetails

Source[SerializationSetup.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/serialization/SerializationSetup.scala#L39)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. SerializerDetails
2. AnyRef
...
3. [**](../../akka/serialization/SerializerDetails$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/serialization/SerializerDetails$.html#apply(alias:String,serializer:akka.serialization.Serializer,useFor:Seq[Class[_]]):akka.serialization.SerializerDetails "Permalink")  def apply(alias: String, serializer: [Serializer](Serializer.html), useFor: [Seq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[Class\[\_]]): [SerializerDetails](SerializerDetails.html)Scala API: factory for details about one programmatically setup serializer

Scala API: factory for details about one programmatically setup serializer

aliasRegister the serializer under this alias (this allows it to be used by bindings in the config)

useForA set of classes or superclasses to bind to the serializer, selection works just as if
 the classes, the alias and the serializer had been in the config.
5. [**](../../akka/serialization/SerializerDetails$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
6. [**](../../akka/serialization/SerializerDetails$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
7. [**](../../akka/serialization/SerializerDetails$.html#create(alias:String,serializer:akka.serialization.Serializer,useFor:java.util.List[Class[_]]):akka.serialization.SerializerDetails "Permalink")  def create(alias: String, serializer: [Serializer](Serializer.html), useFor: [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[Class\[\_]]): [SerializerDetails](SerializerDetails.html)Java API: factory for details about one programmatically setup serializer
...
useForA set of classes or superclasses to bind to the serializer, selection works just as if
 the classes, the alias and the serializer had been in the config.
8. [**](../../akka/serialization/SerializerDetails$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
9. [**](../../akka/serialization/SerializerDetails$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
10. [**](../../akka/serialization/SerializerDetails$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
11. [**](../../akka/serialization/SerializerDetails$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
12. [**](../../akka/serialization/SerializerDetails$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
13. [**](../../akka/serialization/SerializerDetails$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/serialization/SerializerDetails$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/serialization/SerializerDetails$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/serialization/SerializerDetails$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
17. [**](../../akka/serialization/SerializerDetails$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
...
20. [**](../../akka/serialization/SerializerDetails$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/serialization/SerializerDetails$.html](https://doc.akka.io/api/akka-core/2.10.17/akka/serialization/SerializerDetails$.html)*