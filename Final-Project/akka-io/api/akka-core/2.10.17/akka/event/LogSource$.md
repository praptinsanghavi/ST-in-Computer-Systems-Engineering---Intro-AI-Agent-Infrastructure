...
scraped_at: '2026-04-05T19:52:42Z'
section: api
site: akka-io
...
[o](LogSource.html "See companion trait")[akka](../index.html).[event](index.html)

# [LogSource](LogSource.html "See companion trait")[**](../../akka/event/LogSource$.html "Permalink")

### Companion [trait LogSource](LogSource.html "See companion trait")
...
In case a [akka.event.LoggingBus](LoggingBus.html) is provided, the following apply:

- [akka.actor.Actor](../actor/Actor.html) and [akka.actor.ActorRef](../actor/ActorRef.html) will be represented by their absolute physical path
- providing a `String` as source will be used as is
- providing a `Class` will extract its simple name
- anything else gives compile error unless implicit [akka.event.LogSource](LogSource.html) is in scope for it
Source[Logging.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/event/Logging.scala#L304)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. LogSource
2. AnyRef
...
3. [**](../../akka/event/LogSource$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/event/LogSource$.html#apply[T](o:T,system:akka.actor.ActorSystem)(implicitevidence$2:akka.event.LogSource[T]):(String,Class[_]) "Permalink")  def apply\[T](o: T, system: [ActorSystem](../actor/ActorSystem.html))(implicit arg0: [LogSource](LogSource.html)\[T]): (String, Class\[\_])Convenience converter access: given an implicit `LogSource` and
[akka.actor.ActorSystem](../actor/ActorSystem.html), generate the string representation and
originating class.
5. [**](../../akka/event/LogSource$.html#apply[T](o:T)(implicitevidence$1:akka.event.LogSource[T]):(String,Class[_]) "Permalink")  def apply\[T](o: T)(implicit arg0: [LogSource](LogSource.html)\[T]): (String, Class\[\_])Convenience converter access: given an implicit `LogSource`, generate the
...
8. [**](../../akka/event/LogSource$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
9. [**](../../akka/event/LogSource$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
10. [**](../../akka/event/LogSource$.html#fromActor:akka.event.LogSource[akka.actor.Actor] "Permalink") implicit  val fromActor: [LogSource](LogSource.html)\[[Actor](../actor/Actor.html)]
11. [**](../../akka/event/LogSource$.html#fromActorRef:akka.event.LogSource[akka.actor.ActorRef] "Permalink") implicit  val fromActorRef: [LogSource](LogSource.html)\[[ActorRef](../actor/ActorRef.html)]
12. [**](../../akka/event/LogSource$.html#fromAnyClass[T]:akka.event.LogSource[Class[T]] "Permalink") implicit  def fromAnyClass\[T]: [LogSource](LogSource.html)\[Class\[T]]
13. [**](../../akka/event/LogSource$.html#fromAnyRef(o:AnyRef,system:akka.actor.ActorSystem):(String,Class[_]) "Permalink")  def fromAnyRef(o: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), system: [ActorSystem](../actor/ActorSystem.html)): (String, Class\[\_])construct string representation for any object according to
rules above (including the actor system’s address) with fallback to its
`Class`’s simple name.
14. [**](../../akka/event/LogSource$.html#fromAnyRef(o:AnyRef):(String,Class[_]) "Permalink")  def fromAnyRef(o: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): (String, Class\[\_])construct string representation for any object according to
rules above with fallback to its `Class`’s simple name.
15. [**](../../akka/event/LogSource$.html#fromClass:akka.event.LogSource[Class[_]] "Permalink")  val fromClass: [LogSource](LogSource.html)\[Class\[\_]]
16. [**](../../akka/event/LogSource$.html#fromString:akka.event.LogSource[String] "Permalink") implicit  val fromString: [LogSource](LogSource.html)\[String]
17. [**](../../akka/event/LogSource$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/event/LogSource$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/event/LogSource$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
20. [**](../../akka/event/LogSource$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
21. [**](../../akka/event/LogSource$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/event/LogSource$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../akka/event/LogSource$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
24. [**](../../akka/event/LogSource$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
25. [**](../../akka/event/LogSource$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../akka/event/LogSource$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
27. [**](../../akka/event/LogSource$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
