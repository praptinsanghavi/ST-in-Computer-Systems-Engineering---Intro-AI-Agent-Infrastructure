---
description: Akka 2.10.17 - akka.event.LogMarker
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:52:41Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/event/LogMarker.html
title: Akka 2.10.17 - akka.event.LogMarker
---

# Akka 2.10.17 - akka.event.LogMarker

> **Summary:** Akka 2.10.17 - akka.event.LogMarker
...
[c](LogMarker$.html "See companion object")[akka](../index.html).[event](index.html)

# [LogMarker](LogMarker$.html "See companion object")[**](../../akka/event/LogMarker.html "Permalink")

### Companion [object LogMarker](LogMarker$.html "See companion object")

#### class LogMarker extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

DO NOT INHERIT: Class is open only for use by akka\-slf4j

Annotations@[DoNotInherit](../annotation/DoNotInherit.html)() Source[Logging.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/event/Logging.scala#L1676)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[Slf4jLogMarker](slf4j/Slf4jLogMarker.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. LogMarker
2. AnyRef
...
1. [**](../../akka/event/LogMarker.html#<init>(name:String):akka.event.LogMarker "Permalink")  new LogMarker(name: String)
2. [**](../../akka/event/LogMarker.html#<init>(name:String,properties:Map[String,Any]):akka.event.LogMarker "Permalink")  new LogMarker(name: String, properties: Map\[String, [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)])
### Value Members
...
3. [**](../../akka/event/LogMarker.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from LogMarker toany2stringadd\[LogMarker] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/event/LogMarker.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (LogMarker, B)ImplicitThis member is added by an implicit conversion from LogMarker toArrowAssoc\[LogMarker] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/event/LogMarker.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
8. [**](../../akka/event/LogMarker.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (LogMarker) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): LogMarkerImplicitThis member is added by an implicit conversion from LogMarker toEnsuring\[LogMarker] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/event/LogMarker.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (LogMarker) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): LogMarkerImplicitThis member is added by an implicit conversion from LogMarker toEnsuring\[LogMarker] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/event/LogMarker.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): LogMarkerImplicitThis member is added by an implicit conversion from LogMarker toEnsuring\[LogMarker] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/event/LogMarker.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): LogMarkerImplicitThis member is added by an implicit conversion from LogMarker toEnsuring\[LogMarker] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/event/LogMarker.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/event/LogMarker.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/event/LogMarker.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/event/LogMarker.html#getProperties:java.util.Map[String,Object] "Permalink")  def getProperties: [Map](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html#java.util.Map)\[String, [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Java API
16. [**](../../akka/event/LogMarker.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/event/LogMarker.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
18. [**](../../akka/event/LogMarker.html#name:String "Permalink")  val name: String
19. [**](../../akka/event/LogMarker.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
20. [**](../../akka/event/LogMarker.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../akka/event/LogMarker.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/event/LogMarker.html#properties:Map[String,Any] "Permalink")  val properties: Map\[String, [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]
23. [**](../../akka/event/LogMarker.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
24. [**](../../akka/event/LogMarker.html#toString():String "Permalink")  def toString(): StringDefinition ClassesLogMarker → AnyRef → Any
25. [**](../../akka/event/LogMarker.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../akka/event/LogMarker.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
27. [**](../../akka/event/LogMarker.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
2. [**](../../akka/event/LogMarker.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from LogMarker toStringFormat\[LogMarker] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/event/LogMarker.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (LogMarker, B)ImplicitThis member is added by an implicit conversion from LogMarker toArrowAssoc\[LogMarker] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromLogMarker to any2stringadd\[LogMarker]

### Inherited by implicit conversion StringFormat fromLogMarker to StringFormat\[LogMarker]

### Inherited by implicit conversion Ensuring fromLogMarker to Ensuring\[LogMarker]

### Inherited by implicit conversion ArrowAssoc fromLogMarker to ArrowAssoc\[LogMarker]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/event/LogMarker.html](https://doc.akka.io/api/akka-core/2.10.17/akka/event/LogMarker.html)*