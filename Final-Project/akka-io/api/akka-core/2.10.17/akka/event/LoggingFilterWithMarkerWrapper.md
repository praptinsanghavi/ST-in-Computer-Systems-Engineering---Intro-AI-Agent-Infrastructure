---
description: Akka 2.10.17 - akka.event.LoggingFilterWithMarkerWrapper
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:52:53Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/event/LoggingFilterWithMarkerWrapper.html
title: Akka 2.10.17 - akka.event.LoggingFilterWithMarkerWrapper
---

# Akka 2.10.17 - akka.event.LoggingFilterWithMarkerWrapper

> **Summary:** Akka 2.10.17 - akka.event.LoggingFilterWithMarkerWrapper
...
# LoggingFilterWithMarkerWrapper[**](../../akka/event/LoggingFilterWithMarkerWrapper.html "Permalink")

### 

#### class LoggingFilterWithMarkerWrapper extends [LoggingFilterWithMarker](LoggingFilterWithMarker.html)

Source[Logging.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/event/Logging.scala#L1580)Linear Supertypes[LoggingFilterWithMarker](LoggingFilterWithMarker.html), [LoggingFilter](LoggingFilter.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. LoggingFilterWithMarkerWrapper
...
1. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#<init>(loggingFilter:akka.event.LoggingFilter):akka.event.LoggingFilterWithMarkerWrapper "Permalink")  new LoggingFilterWithMarkerWrapper(loggingFilter: [LoggingFilter](LoggingFilter.html))
### Value Members

1. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from LoggingFilterWithMarkerWrapper toany2stringadd\[LoggingFilterWithMarkerWrapper] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (LoggingFilterWithMarkerWrapper, B)ImplicitThis member is added by an implicit conversion from LoggingFilterWithMarkerWrapper toArrowAssoc\[LoggingFilterWithMarkerWrapper] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (LoggingFilterWithMarkerWrapper) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): LoggingFilterWithMarkerWrapperImplicitThis member is added by an implicit conversion from LoggingFilterWithMarkerWrapper toEnsuring\[LoggingFilterWithMarkerWrapper] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (LoggingFilterWithMarkerWrapper) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): LoggingFilterWithMarkerWrapperImplicitThis member is added by an implicit conversion from LoggingFilterWithMarkerWrapper toEnsuring\[LoggingFilterWithMarkerWrapper] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): LoggingFilterWithMarkerWrapperImplicitThis member is added by an implicit conversion from LoggingFilterWithMarkerWrapper toEnsuring\[LoggingFilterWithMarkerWrapper] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): LoggingFilterWithMarkerWrapperImplicitThis member is added by an implicit conversion from LoggingFilterWithMarkerWrapper toEnsuring\[LoggingFilterWithMarkerWrapper] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#isDebugEnabled(logClass:Class[_],logSource:String):Boolean "Permalink")  def isDebugEnabled(logClass: Class\[\_], logSource: String): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesLoggingFilterWithMarkerWrapper → [LoggingFilter](LoggingFilter.html)
17. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#isDebugEnabled(logClass:Class[_],logSource:String,marker:akka.event.LogMarker):Boolean "Permalink")  def isDebugEnabled(logClass: Class\[\_], logSource: String, marker: [LogMarker](LogMarker.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition Classes[LoggingFilterWithMarker](LoggingFilterWithMarker.html)
18. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#isErrorEnabled(logClass:Class[_],logSource:String):Boolean "Permalink")  def isErrorEnabled(logClass: Class\[\_], logSource: String): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesLoggingFilterWithMarkerWrapper → [LoggingFilter](LoggingFilter.html)
19. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#isErrorEnabled(logClass:Class[_],logSource:String,marker:akka.event.LogMarker):Boolean "Permalink")  def isErrorEnabled(logClass: Class\[\_], logSource: String, marker: [LogMarker](LogMarker.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition Classes[LoggingFilterWithMarker](LoggingFilterWithMarker.html)
20. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#isInfoEnabled(logClass:Class[_],logSource:String):Boolean "Permalink")  def isInfoEnabled(logClass: Class\[\_], logSource: String): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesLoggingFilterWithMarkerWrapper → [LoggingFilter](LoggingFilter.html)
21. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#isInfoEnabled(logClass:Class[_],logSource:String,marker:akka.event.LogMarker):Boolean "Permalink")  def isInfoEnabled(logClass: Class\[\_], logSource: String, marker: [LogMarker](LogMarker.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition Classes[LoggingFilterWithMarker](LoggingFilterWithMarker.html)
22. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
23. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#isWarningEnabled(logClass:Class[_],logSource:String):Boolean "Permalink")  def isWarningEnabled(logClass: Class\[\_], logSource: String): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesLoggingFilterWithMarkerWrapper → [LoggingFilter](LoggingFilter.html)
24. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#isWarningEnabled(logClass:Class[_],logSource:String,marker:akka.event.LogMarker):Boolean "Permalink")  def isWarningEnabled(logClass: Class\[\_], logSource: String, marker: [LogMarker](LogMarker.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition Classes[LoggingFilterWithMarker](LoggingFilterWithMarker.html)
25. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
26. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
27. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
28. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
29. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
30. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
31. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
32. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/event/LoggingFilterWithMarkerWrapper.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from LoggingFilterWithMarkerWrapper toStringFormat\[LoggingFilterWithMarkerWrapper] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
...
### Inherited by implicit conversion any2stringadd fromLoggingFilterWithMarkerWrapper to any2stringadd\[LoggingFilterWithMarkerWrapper]

### Inherited by implicit conversion StringFormat fromLoggingFilterWithMarkerWrapper to StringFormat\[LoggingFilterWithMarkerWrapper]

### Inherited by implicit conversion Ensuring fromLoggingFilterWithMarkerWrapper to Ensuring\[LoggingFilterWithMarkerWrapper]

### Inherited by implicit conversion ArrowAssoc fromLoggingFilterWithMarkerWrapper to ArrowAssoc\[LoggingFilterWithMarkerWrapper]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/event/LoggingFilterWithMarkerWrapper.html](https://doc.akka.io/api/akka-core/2.10.17/akka/event/LoggingFilterWithMarkerWrapper.html)*