---
description: Akka 2.10.17 - akka.dispatch.MonitorableThreadFactory
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:05:44Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/MonitorableThreadFactory.html
title: Akka 2.10.17 - akka.dispatch.MonitorableThreadFactory
---

# Akka 2.10.17 - akka.dispatch.MonitorableThreadFactory

> **Summary:** Akka 2.10.17 - akka.dispatch.MonitorableThreadFactory
...
[c](MonitorableThreadFactory$.html "See companion object")[akka](../index.html).[dispatch](index.html)

# [MonitorableThreadFactory](MonitorableThreadFactory$.html "See companion object")[**](../../akka/dispatch/MonitorableThreadFactory.html "Permalink")

### Companion [object MonitorableThreadFactory](MonitorableThreadFactory$.html "See companion object")
...
Source[ThreadPoolBuilder.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/dispatch/ThreadPoolBuilder.scala#L189)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.17/scala/Equals.html#scala.Equals), ForkJoinWorkerThreadFactory, [ThreadFactory](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/ThreadFactory.html#java.util.concurrent.ThreadFactory), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/dispatch/MonitorableThreadFactory.html#<init>(name:String,daemonic:Boolean,contextClassLoader:Option[ClassLoader],exceptionHandler:Thread.UncaughtExceptionHandler,counter:java.util.concurrent.atomic.AtomicLong):akka.dispatch.MonitorableThreadFactory "Permalink")  new MonitorableThreadFactory(name: String, daemonic: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), contextClassLoader: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)], exceptionHandler: UncaughtExceptionHandler \= [MonitorableThreadFactory.doNothing](MonitorableThreadFactory$.html), counter: [AtomicLong](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/atomic/AtomicLong.html#java.util.concurrent.atomic.AtomicLong) \= new AtomicLong)
### Value Members

1. [**](../../akka/dispatch/MonitorableThreadFactory.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/MonitorableThreadFactory.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/MonitorableThreadFactory.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from MonitorableThreadFactory toany2stringadd\[MonitorableThreadFactory] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/MonitorableThreadFactory.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (MonitorableThreadFactory, B)ImplicitThis member is added by an implicit conversion from MonitorableThreadFactory toArrowAssoc\[MonitorableThreadFactory] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/MonitorableThreadFactory.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/MonitorableThreadFactory.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/dispatch/MonitorableThreadFactory.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/dispatch/MonitorableThreadFactory.html#contextClassLoader:Option[ClassLoader] "Permalink")  val contextClassLoader: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)]
9. [**](../../akka/dispatch/MonitorableThreadFactory.html#counter:java.util.concurrent.atomic.AtomicLong "Permalink")  val counter: [AtomicLong](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/atomic/AtomicLong.html#java.util.concurrent.atomic.AtomicLong)Attributesprotected
10. [**](../../akka/dispatch/MonitorableThreadFactory.html#daemonic:Boolean "Permalink")  val daemonic: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)
11. [**](../../akka/dispatch/MonitorableThreadFactory.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (MonitorableThreadFactory) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): MonitorableThreadFactoryImplicitThis member is added by an implicit conversion from MonitorableThreadFactory toEnsuring\[MonitorableThreadFactory] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/dispatch/MonitorableThreadFactory.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (MonitorableThreadFactory) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): MonitorableThreadFactoryImplicitThis member is added by an implicit conversion from MonitorableThreadFactory toEnsuring\[MonitorableThreadFactory] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/dispatch/MonitorableThreadFactory.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): MonitorableThreadFactoryImplicitThis member is added by an implicit conversion from MonitorableThreadFactory toEnsuring\[MonitorableThreadFactory] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/dispatch/MonitorableThreadFactory.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): MonitorableThreadFactoryImplicitThis member is added by an implicit conversion from MonitorableThreadFactory toEnsuring\[MonitorableThreadFactory] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/dispatch/MonitorableThreadFactory.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
16. [**](../../akka/dispatch/MonitorableThreadFactory.html#exceptionHandler:Thread.UncaughtExceptionHandler "Permalink")  val exceptionHandler: UncaughtExceptionHandler
17. [**](../../akka/dispatch/MonitorableThreadFactory.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/dispatch/MonitorableThreadFactory.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
19. [**](../../akka/dispatch/MonitorableThreadFactory.html#name:String "Permalink")  val name: String
20. [**](../../akka/dispatch/MonitorableThreadFactory.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
21. [**](../../akka/dispatch/MonitorableThreadFactory.html#newThread(runnable:Runnable):Thread "Permalink")  def newThread(runnable: [Runnable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Runnable.html#java.lang.Runnable)): [Thread](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Thread.html#java.lang.Thread)Definition ClassesMonitorableThreadFactory → ThreadFactory
22. [**](../../akka/dispatch/MonitorableThreadFactory.html#newThread(pool:java.util.concurrent.ForkJoinPool):java.util.concurrent.ForkJoinWorkerThread "Permalink")  def newThread(pool: [ForkJoinPool](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/ForkJoinPool.html#java.util.concurrent.ForkJoinPool)): [ForkJoinWorkerThread](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/ForkJoinWorkerThread.html#java.util.concurrent.ForkJoinWorkerThread)Definition ClassesMonitorableThreadFactory → ForkJoinWorkerThreadFactory
23. [**](../../akka/dispatch/MonitorableThreadFactory.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../akka/dispatch/MonitorableThreadFactory.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
25. [**](../../akka/dispatch/MonitorableThreadFactory.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
26. [**](../../akka/dispatch/MonitorableThreadFactory.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
27. [**](../../akka/dispatch/MonitorableThreadFactory.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../akka/dispatch/MonitorableThreadFactory.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
29. [**](../../akka/dispatch/MonitorableThreadFactory.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
30. [**](../../akka/dispatch/MonitorableThreadFactory.html#wire[T<:Thread](t:T):T "Permalink")  def wire\[T \<: [Thread](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Thread.html#java.lang.Thread)](t: T): TAttributesprotected
31. [**](../../akka/dispatch/MonitorableThreadFactory.html#withName(newName:String):akka.dispatch.MonitorableThreadFactory "Permalink")  def withName(newName: String): MonitorableThreadFactory
### Deprecated Value Members

1. [**](../../akka/dispatch/MonitorableThreadFactory.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/MonitorableThreadFactory.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from MonitorableThreadFactory toStringFormat\[MonitorableThreadFactory] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/dispatch/MonitorableThreadFactory.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (MonitorableThreadFactory, B)ImplicitThis member is added by an implicit conversion from MonitorableThreadFactory toArrowAssoc\[MonitorableThreadFactory] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited from ForkJoinWorkerThreadFactory

### Inherited from [ThreadFactory](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/ThreadFactory.html#java.util.concurrent.ThreadFactory)

### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromMonitorableThreadFactory to any2stringadd\[MonitorableThreadFactory]

### Inherited by implicit conversion StringFormat fromMonitorableThreadFactory to StringFormat\[MonitorableThreadFactory]

### Inherited by implicit conversion Ensuring fromMonitorableThreadFactory to Ensuring\[MonitorableThreadFactory]

### Inherited by implicit conversion ArrowAssoc fromMonitorableThreadFactory to ArrowAssoc\[MonitorableThreadFactory]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/MonitorableThreadFactory.html](https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/MonitorableThreadFactory.html)*