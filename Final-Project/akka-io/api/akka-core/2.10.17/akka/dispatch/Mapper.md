---
description: Akka 2.10.17 - akka.dispatch.Mapper
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:05:33Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/Mapper.html
title: Akka 2.10.17 - akka.dispatch.Mapper
---

# Akka 2.10.17 - akka.dispatch.Mapper

> **Summary:** Akka 2.10.17 - akka.dispatch.Mapper
...
# Mapper[**](../../akka/dispatch/Mapper.html "Permalink")

### 

#### abstract  class Mapper\[\-T, \+R] extends [AbstractFunction1](https://www.scala-lang.org/api/2.13.17/scala/runtime/AbstractFunction1.html#scala.runtime.AbstractFunction1)\[T, R]
...
Source[Future.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/dispatch/Future.scala#L365)Linear Supertypes[AbstractFunction1](https://www.scala-lang.org/api/2.13.17/scala/runtime/AbstractFunction1.html#scala.runtime.AbstractFunction1)\[T, R], (T) \=\> R, [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Mapper
2. AbstractFunction1
...
1. [**](../../akka/dispatch/Mapper.html#<init>():akka.dispatch.Mapper[T,R] "Permalink")  new Mapper()
### Value Members

1. [**](../../akka/dispatch/Mapper.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/Mapper.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/Mapper.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from Mapper\[T, R] toany2stringadd\[Mapper\[T, R]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/Mapper.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (Mapper\[T, R], B)ImplicitThis member is added by an implicit conversion from Mapper\[T, R] toArrowAssoc\[Mapper\[T, R]] performed by method ArrowAssoc in scala.Predef.This conversion will take place only if R is a subclass of Option\[Nothing] (R \<: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Nothing](https://www.scala-lang.org/api/2.13.17/scala/Nothing.html#scala.Nothing)]).Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/Mapper.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/Mapper.html#andThen[A](g:R=>A):T1=>A "Permalink")  def andThen\[A](g: (R) \=\> A): (T) \=\> ADefinition ClassesFunction1Annotations@unspecialized()
7. [**](../../akka/dispatch/Mapper.html#apply(parameter:T):R "Permalink")  def apply(parameter: T): ROverride this method to perform the map operation, by default delegates to "checkedApply"
...
Definition ClassesMapper → Function1
8. [**](../../akka/dispatch/Mapper.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
9. [**](../../akka/dispatch/Mapper.html#checkedApply(parameter:T):R "Permalink")  def checkedApply(parameter: T): ROverride this method if you need to throw checked exceptions
...
10. [**](../../akka/dispatch/Mapper.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
11. [**](../../akka/dispatch/Mapper.html#compose[A](g:A=>T1):A=>R "Permalink")  def compose\[A](g: (A) \=\> T): (A) \=\> RDefinition ClassesFunction1Annotations@unspecialized()
12. [**](../../akka/dispatch/Mapper.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (Mapper\[T, R]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): Mapper\[T, R]ImplicitThis member is added by an implicit conversion from Mapper\[T, R] toEnsuring\[Mapper\[T, R]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/dispatch/Mapper.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (Mapper\[T, R]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): Mapper\[T, R]ImplicitThis member is added by an implicit conversion from Mapper\[T, R] toEnsuring\[Mapper\[T, R]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/dispatch/Mapper.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): Mapper\[T, R]ImplicitThis member is added by an implicit conversion from Mapper\[T, R] toEnsuring\[Mapper\[T, R]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/dispatch/Mapper.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): Mapper\[T, R]ImplicitThis member is added by an implicit conversion from Mapper\[T, R] toEnsuring\[Mapper\[T, R]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/dispatch/Mapper.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/dispatch/Mapper.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
18. [**](../../akka/dispatch/Mapper.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/dispatch/Mapper.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/dispatch/Mapper.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
21. [**](../../akka/dispatch/Mapper.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
22. [**](../../akka/dispatch/Mapper.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../akka/dispatch/Mapper.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../akka/dispatch/Mapper.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
25. [**](../../akka/dispatch/Mapper.html#toString():String "Permalink")  def toString(): StringDefinition ClassesFunction1 → AnyRef → Any
26. [**](../../akka/dispatch/Mapper.html#unlift:PartialFunction[A,B] "Permalink")  def unlift: [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[T, B]ImplicitThis member is added by an implicit conversion from Mapper\[T, R] toUnliftOps\[T, B] performed by method UnliftOps in scala.Function1\.This conversion will take place only if R is a subclass of Option\[B] (R \<: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[B]).Definition ClassesUnliftOps
27. [**](../../akka/dispatch/Mapper.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../akka/dispatch/Mapper.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
29. [**](../../akka/dispatch/Mapper.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/Mapper.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/Mapper.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from Mapper\[T, R] toStringFormat\[Mapper\[T, R]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/dispatch/Mapper.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (Mapper\[T, R], B)ImplicitThis member is added by an implicit conversion from Mapper\[T, R] toArrowAssoc\[Mapper\[T, R]] performed by method ArrowAssoc in scala.Predef.This conversion will take place only if R is a subclass of Option\[Nothing] (R \<: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Nothing](https://www.scala-lang.org/api/2.13.17/scala/Nothing.html#scala.Nothing)]).Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AbstractFunction1](https://www.scala-lang.org/api/2.13.17/scala/runtime/AbstractFunction1.html#scala.runtime.AbstractFunction1)\[T, R]
...
### Inherited by implicit conversion UnliftOps fromMapper\[T, R] to UnliftOps\[T, B]

### Inherited by implicit conversion any2stringadd fromMapper\[T, R] to any2stringadd\[Mapper\[T, R]]

### Inherited by implicit conversion StringFormat fromMapper\[T, R] to StringFormat\[Mapper\[T, R]]

### Inherited by implicit conversion Ensuring fromMapper\[T, R] to Ensuring\[Mapper\[T, R]]

### Inherited by implicit conversion ArrowAssoc fromMapper\[T, R] to ArrowAssoc\[Mapper\[T, R]]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/Mapper.html](https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/Mapper.html)*