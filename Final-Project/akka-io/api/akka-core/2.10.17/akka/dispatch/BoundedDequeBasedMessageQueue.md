---
description: Akka 2.10.17 - akka.dispatch.BoundedDequeBasedMessageQueue
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:04:39Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/BoundedDequeBasedMessageQueue.html
title: Akka 2.10.17 - akka.dispatch.BoundedDequeBasedMessageQueue
---

# Akka 2.10.17 - akka.dispatch.BoundedDequeBasedMessageQueue

> **Summary:** Akka 2.10.17 - akka.dispatch.BoundedDequeBasedMessageQueue
...
# BoundedDequeBasedMessageQueue[**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html "Permalink")

### 

#### trait BoundedDequeBasedMessageQueue extends [DequeBasedMessageQueue](DequeBasedMessageQueue.html) with [BoundedDequeBasedMessageQueueSemantics](BoundedDequeBasedMessageQueueSemantics.html)

BoundedMessageQueueSemantics adds bounded semantics to a DequeBasedMessageQueue,
i.e. blocking enqueue with timeout.

Source[Mailbox.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/dispatch/Mailbox.scala#L599)Linear Supertypes[BoundedDequeBasedMessageQueueSemantics](BoundedDequeBasedMessageQueueSemantics.html), [BoundedMessageQueueSemantics](BoundedMessageQueueSemantics.html), [DequeBasedMessageQueue](DequeBasedMessageQueue.html), [DequeBasedMessageQueueSemantics](DequeBasedMessageQueueSemantics.html), [QueueBasedMessageQueue](QueueBasedMessageQueue.html), [MultipleConsumerSemantics](MultipleConsumerSemantics.html), [MessageQueue](MessageQueue.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[MessageQueue](BoundedDequeBasedMailbox$$MessageQueue.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. BoundedDequeBasedMessageQueue
2. BoundedDequeBasedMessageQueueSemantics
3. BoundedMessageQueueSemantics
4. DequeBasedMessageQueue
5. DequeBasedMessageQueueSemantics
6. QueueBasedMessageQueue
7. MultipleConsumerSemantics
8. MessageQueue
9. AnyRef
10. Any
Implicitly  
...
1. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#pushTimeOut:scala.concurrent.duration.Duration "Permalink") abstract  def pushTimeOut: [Duration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/Duration.html#scala.concurrent.duration.Duration)Definition ClassesBoundedDequeBasedMessageQueue → [BoundedMessageQueueSemantics](BoundedMessageQueueSemantics.html)
2. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#queue:java.util.concurrent.BlockingDeque[akka.dispatch.Envelope] "Permalink") abstract  def queue: [BlockingDeque](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/BlockingDeque.html#java.util.concurrent.BlockingDeque)\[[Envelope](Envelope.html)]Definition ClassesBoundedDequeBasedMessageQueue → [DequeBasedMessageQueue](DequeBasedMessageQueue.html) → [QueueBasedMessageQueue](QueueBasedMessageQueue.html)
### Concrete Value Members

1. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from BoundedDequeBasedMessageQueue toany2stringadd\[BoundedDequeBasedMessageQueue] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (BoundedDequeBasedMessageQueue, B)ImplicitThis member is added by an implicit conversion from BoundedDequeBasedMessageQueue toArrowAssoc\[BoundedDequeBasedMessageQueue] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#cleanUp(owner:akka.actor.ActorRef,deadLetters:akka.dispatch.MessageQueue):Unit "Permalink")  def cleanUp(owner: [ActorRef](../actor/ActorRef.html), deadLetters: [MessageQueue](MessageQueue.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Called when the mailbox this queue belongs to is disposed of.
...
8. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#dequeue():akka.dispatch.Envelope "Permalink")  def dequeue(): [Envelope](Envelope.html)Try to dequeue the next message from this queue, return null failing that.

Try to dequeue the next message from this queue, return null failing that.

Definition ClassesBoundedDequeBasedMessageQueue → [MessageQueue](MessageQueue.html)
10. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#enqueue(receiver:akka.actor.ActorRef,handle:akka.dispatch.Envelope):Unit "Permalink")  def enqueue(receiver: [ActorRef](../actor/ActorRef.html), handle: [Envelope](Envelope.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Try to enqueue the message to this queue, or throw an exception.

Try to enqueue the message to this queue, or throw an exception.

Definition ClassesBoundedDequeBasedMessageQueue → [MessageQueue](MessageQueue.html)
11. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#enqueueFirst(receiver:akka.actor.ActorRef,handle:akka.dispatch.Envelope):Unit "Permalink")  def enqueueFirst(receiver: [ActorRef](../actor/ActorRef.html), handle: [Envelope](Envelope.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesBoundedDequeBasedMessageQueue → [DequeBasedMessageQueueSemantics](DequeBasedMessageQueueSemantics.html)
12. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (BoundedDequeBasedMessageQueue) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BoundedDequeBasedMessageQueueImplicitThis member is added by an implicit conversion from BoundedDequeBasedMessageQueue toEnsuring\[BoundedDequeBasedMessageQueue] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (BoundedDequeBasedMessageQueue) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BoundedDequeBasedMessageQueueImplicitThis member is added by an implicit conversion from BoundedDequeBasedMessageQueue toEnsuring\[BoundedDequeBasedMessageQueue] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BoundedDequeBasedMessageQueueImplicitThis member is added by an implicit conversion from BoundedDequeBasedMessageQueue toEnsuring\[BoundedDequeBasedMessageQueue] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BoundedDequeBasedMessageQueueImplicitThis member is added by an implicit conversion from BoundedDequeBasedMessageQueue toEnsuring\[BoundedDequeBasedMessageQueue] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
18. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#hasMessages:Boolean "Permalink")  def hasMessages: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Indicates whether this queue is non\-empty.

Indicates whether this queue is non\-empty.

Definition Classes[QueueBasedMessageQueue](QueueBasedMessageQueue.html) → [MessageQueue](MessageQueue.html)
20. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
22. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
23. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
25. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#numberOfMessages:Int "Permalink")  def numberOfMessages: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Should return the current number of messages held in this queue; may
...
Definition Classes[QueueBasedMessageQueue](QueueBasedMessageQueue.html) → [MessageQueue](MessageQueue.html)
26. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
27. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
28. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
29. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
30. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from BoundedDequeBasedMessageQueue toStringFormat\[BoundedDequeBasedMessageQueue] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/dispatch/BoundedDequeBasedMessageQueue.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (BoundedDequeBasedMessageQueue, B)ImplicitThis member is added by an implicit conversion from BoundedDequeBasedMessageQueue toArrowAssoc\[BoundedDequeBasedMessageQueue] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromBoundedDequeBasedMessageQueue to any2stringadd\[BoundedDequeBasedMessageQueue]

### Inherited by implicit conversion StringFormat fromBoundedDequeBasedMessageQueue to StringFormat\[BoundedDequeBasedMessageQueue]

### Inherited by implicit conversion Ensuring fromBoundedDequeBasedMessageQueue to Ensuring\[BoundedDequeBasedMessageQueue]

### Inherited by implicit conversion ArrowAssoc fromBoundedDequeBasedMessageQueue to ArrowAssoc\[BoundedDequeBasedMessageQueue]
...
- https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/BoundedDequeBasedMailbox$$MessageQueue.html
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/BoundedDequeBasedMessageQueue.html](https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/BoundedDequeBasedMessageQueue.html)*