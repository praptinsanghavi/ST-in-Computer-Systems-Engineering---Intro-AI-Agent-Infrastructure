---
description: Akka 2.10.17 - akka.dispatch.ThreadPoolExecutorConfigurator
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:06:23Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/ThreadPoolExecutorConfigurator.html
title: Akka 2.10.17 - akka.dispatch.ThreadPoolExecutorConfigurator
---

# Akka 2.10.17 - akka.dispatch.ThreadPoolExecutorConfigurator

> **Summary:** Akka 2.10.17 - akka.dispatch.ThreadPoolExecutorConfigurator
...
# ThreadPoolExecutorConfigurator[**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html "Permalink")

### 

#### class ThreadPoolExecutorConfigurator extends [ExecutorServiceConfigurator](ExecutorServiceConfigurator.html)

Source[AbstractDispatcher.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/dispatch/AbstractDispatcher.scala#L407)Linear Supertypes[ExecutorServiceConfigurator](ExecutorServiceConfigurator.html), [ExecutorServiceFactoryProvider](ExecutorServiceFactoryProvider.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ThreadPoolExecutorConfigurator
2. ExecutorServiceConfigurator
3. ExecutorServiceFactoryProvider
4. AnyRef
5. Any
Implicitly  
1. by any2stringadd
...
1. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#<init>(config:com.typesafe.config.Config,prerequisites:akka.dispatch.DispatcherPrerequisites):akka.dispatch.ThreadPoolExecutorConfigurator "Permalink")  new ThreadPoolExecutorConfigurator(config: Config, prerequisites: [DispatcherPrerequisites](DispatcherPrerequisites.html))
### Value Members

1. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ThreadPoolExecutorConfigurator toany2stringadd\[ThreadPoolExecutorConfigurator] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ThreadPoolExecutorConfigurator, B)ImplicitThis member is added by an implicit conversion from ThreadPoolExecutorConfigurator toArrowAssoc\[ThreadPoolExecutorConfigurator] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#createExecutorServiceFactory(id:String,threadFactory:java.util.concurrent.ThreadFactory):akka.dispatch.ExecutorServiceFactory "Permalink")  def createExecutorServiceFactory(id: String, threadFactory: [ThreadFactory](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/ThreadFactory.html#java.util.concurrent.ThreadFactory)): [ExecutorServiceFactory](ExecutorServiceFactory.html)Definition ClassesThreadPoolExecutorConfigurator → [ExecutorServiceFactoryProvider](ExecutorServiceFactoryProvider.html)
9. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#createThreadPoolConfigBuilder(config:com.typesafe.config.Config,prerequisites:akka.dispatch.DispatcherPrerequisites):akka.dispatch.ThreadPoolConfigBuilder "Permalink")  def createThreadPoolConfigBuilder(config: Config, prerequisites: [DispatcherPrerequisites](DispatcherPrerequisites.html)): [ThreadPoolConfigBuilder](ThreadPoolConfigBuilder.html)Attributesprotected
10. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ThreadPoolExecutorConfigurator) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ThreadPoolExecutorConfiguratorImplicitThis member is added by an implicit conversion from ThreadPoolExecutorConfigurator toEnsuring\[ThreadPoolExecutorConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ThreadPoolExecutorConfigurator) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ThreadPoolExecutorConfiguratorImplicitThis member is added by an implicit conversion from ThreadPoolExecutorConfigurator toEnsuring\[ThreadPoolExecutorConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ThreadPoolExecutorConfiguratorImplicitThis member is added by an implicit conversion from ThreadPoolExecutorConfigurator toEnsuring\[ThreadPoolExecutorConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ThreadPoolExecutorConfiguratorImplicitThis member is added by an implicit conversion from ThreadPoolExecutorConfigurator toEnsuring\[ThreadPoolExecutorConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
16. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
19. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
20. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
23. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#threadPoolConfig:akka.dispatch.ThreadPoolConfig "Permalink")  val threadPoolConfig: [ThreadPoolConfig](ThreadPoolConfig.html)
24. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
25. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
27. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ThreadPoolExecutorConfigurator toStringFormat\[ThreadPoolExecutorConfigurator] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/dispatch/ThreadPoolExecutorConfigurator.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ThreadPoolExecutorConfigurator, B)ImplicitThis member is added by an implicit conversion from ThreadPoolExecutorConfigurator toArrowAssoc\[ThreadPoolExecutorConfigurator] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [ExecutorServiceConfigurator](ExecutorServiceConfigurator.html)

### Inherited from [ExecutorServiceFactoryProvider](ExecutorServiceFactoryProvider.html)

### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromThreadPoolExecutorConfigurator to any2stringadd\[ThreadPoolExecutorConfigurator]

### Inherited by implicit conversion StringFormat fromThreadPoolExecutorConfigurator to StringFormat\[ThreadPoolExecutorConfigurator]

### Inherited by implicit conversion Ensuring fromThreadPoolExecutorConfigurator to Ensuring\[ThreadPoolExecutorConfigurator]

### Inherited by implicit conversion ArrowAssoc fromThreadPoolExecutorConfigurator to ArrowAssoc\[ThreadPoolExecutorConfigurator]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/ThreadPoolExecutorConfigurator.html](https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/ThreadPoolExecutorConfigurator.html)*