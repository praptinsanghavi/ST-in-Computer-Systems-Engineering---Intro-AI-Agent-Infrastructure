---
description: Akka 2.10.17 - akka.dispatch.OnSuccess
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:05:55Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/OnSuccess.html
title: Akka 2.10.17 - akka.dispatch.OnSuccess
---

# Akka 2.10.17 - akka.dispatch.OnSuccess

> **Summary:** Akka 2.10.17 - akka.dispatch.OnSuccess
...
# OnSuccess[**](../../akka/dispatch/OnSuccess.html "Permalink")

### 

#### abstract  class OnSuccess\[\-T] extends [CallbackBridge](japi$$CallbackBridge.html)\[T]
...
1. [**](../../akka/dispatch/OnSuccess.html#<init>():akka.dispatch.OnSuccess[T] "Permalink")  new OnSuccess()
### Abstract Value Members

1. [**](../../akka/dispatch/OnSuccess.html#onSuccess(result:T):Unit "Permalink") abstract  def onSuccess(result: T): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)This method will be invoked once when/if a Future that this callback is registered on
...
1. [**](../../akka/dispatch/OnSuccess.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/OnSuccess.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/OnSuccess.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from OnSuccess\[T] toany2stringadd\[OnSuccess\[T]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/OnSuccess.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (OnSuccess\[T], B)ImplicitThis member is added by an implicit conversion from OnSuccess\[T] toArrowAssoc\[OnSuccess\[T]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/OnSuccess.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/OnSuccess.html#andThen[C](k:PartialFunction[B,C]):PartialFunction[A,C] "Permalink")  def andThen\[C](k: [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[[BoxedUnit](https://www.scala-lang.org/api/2.13.17/scala/runtime/BoxedUnit.html#scala.runtime.BoxedUnit), C]): [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[T, C]Definition ClassesPartialFunction
7. [**](../../akka/dispatch/OnSuccess.html#andThen[C](k:B=>C):PartialFunction[A,C] "Permalink")  def andThen\[C](k: ([BoxedUnit](https://www.scala-lang.org/api/2.13.17/scala/runtime/BoxedUnit.html#scala.runtime.BoxedUnit)) \=\> C): [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[T, C]Definition ClassesPartialFunction → Function1
8. [**](../../akka/dispatch/OnSuccess.html#apply(t:T):scala.runtime.BoxedUnit "Permalink") final  def apply(t: T): [BoxedUnit](https://www.scala-lang.org/api/2.13.17/scala/runtime/BoxedUnit.html#scala.runtime.BoxedUnit)Definition Classes[CallbackBridge](japi$$CallbackBridge.html) → AbstractPartialFunction → Function1
9. [**](../../akka/dispatch/OnSuccess.html#applyOrElse[A1<:A,B1>:B](x:A1,default:A1=>B1):B1 "Permalink")  def applyOrElse\[A1 \<: T, B1 \>: [BoxedUnit](https://www.scala-lang.org/api/2.13.17/scala/runtime/BoxedUnit.html#scala.runtime.BoxedUnit)](x: A1, default: (A1) \=\> B1): B1Definition ClassesPartialFunction
10. [**](../../akka/dispatch/OnSuccess.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
11. [**](../../akka/dispatch/OnSuccess.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
12. [**](../../akka/dispatch/OnSuccess.html#compose[R](k:PartialFunction[R,A]):PartialFunction[R,B] "Permalink")  def compose\[R](k: [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[R, T]): [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[R, [BoxedUnit](https://www.scala-lang.org/api/2.13.17/scala/runtime/BoxedUnit.html#scala.runtime.BoxedUnit)]Definition ClassesPartialFunction
13. [**](../../akka/dispatch/OnSuccess.html#compose[A](g:A=>T1):A=>R "Permalink")  def compose\[A](g: (A) \=\> T): (A) \=\> [BoxedUnit](https://www.scala-lang.org/api/2.13.17/scala/runtime/BoxedUnit.html#scala.runtime.BoxedUnit)Definition ClassesFunction1Annotations@unspecialized()
14. [**](../../akka/dispatch/OnSuccess.html#elementWise:PartialFunction.ElementWiseExtractor[A,B] "Permalink")  def elementWise: ElementWiseExtractor\[T, [BoxedUnit](https://www.scala-lang.org/api/2.13.17/scala/runtime/BoxedUnit.html#scala.runtime.BoxedUnit)]Definition ClassesPartialFunction
15. [**](../../akka/dispatch/OnSuccess.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (OnSuccess\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): OnSuccess\[T]ImplicitThis member is added by an implicit conversion from OnSuccess\[T] toEnsuring\[OnSuccess\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/dispatch/OnSuccess.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (OnSuccess\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): OnSuccess\[T]ImplicitThis member is added by an implicit conversion from OnSuccess\[T] toEnsuring\[OnSuccess\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../akka/dispatch/OnSuccess.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): OnSuccess\[T]ImplicitThis member is added by an implicit conversion from OnSuccess\[T] toEnsuring\[OnSuccess\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
18. [**](../../akka/dispatch/OnSuccess.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): OnSuccess\[T]ImplicitThis member is added by an implicit conversion from OnSuccess\[T] toEnsuring\[OnSuccess\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
19. [**](../../akka/dispatch/OnSuccess.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
20. [**](../../akka/dispatch/OnSuccess.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
21. [**](../../akka/dispatch/OnSuccess.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/dispatch/OnSuccess.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../akka/dispatch/OnSuccess.html#internal(result:T):Unit "Permalink") final  def internal(result: T): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected Definition ClassesOnSuccess → [CallbackBridge](japi$$CallbackBridge.html)
24. [**](../../akka/dispatch/OnSuccess.html#isDefinedAt(t:T):Boolean "Permalink") final  def isDefinedAt(t: T): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition Classes[CallbackBridge](japi$$CallbackBridge.html) → PartialFunction
25. [**](../../akka/dispatch/OnSuccess.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
26. [**](../../akka/dispatch/OnSuccess.html#lift:A=>Option[B] "Permalink")  def lift: (T) \=\> [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[BoxedUnit](https://www.scala-lang.org/api/2.13.17/scala/runtime/BoxedUnit.html#scala.runtime.BoxedUnit)]Definition ClassesPartialFunction
27. [**](../../akka/dispatch/OnSuccess.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
28. [**](../../akka/dispatch/OnSuccess.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
29. [**](../../akka/dispatch/OnSuccess.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
30. [**](../../akka/dispatch/OnSuccess.html#orElse[A1<:A,B1>:B](that:PartialFunction[A1,B1]):PartialFunction[A1,B1] "Permalink")  def orElse\[A1 \<: T, B1 \>: [BoxedUnit](https://www.scala-lang.org/api/2.13.17/scala/runtime/BoxedUnit.html#scala.runtime.BoxedUnit)](that: [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[A1, B1]): [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[A1, B1]Definition ClassesPartialFunction
31. [**](../../akka/dispatch/OnSuccess.html#runWith[U](action:B=>U):A=>Boolean "Permalink")  def runWith\[U](action: ([BoxedUnit](https://www.scala-lang.org/api/2.13.17/scala/runtime/BoxedUnit.html#scala.runtime.BoxedUnit)) \=\> U): (T) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesPartialFunction
32. [**](../../akka/dispatch/OnSuccess.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
33. [**](../../akka/dispatch/OnSuccess.html#toString():String "Permalink")  def toString(): StringDefinition ClassesFunction1 → AnyRef → Any
34. [**](../../akka/dispatch/OnSuccess.html#unapply(a:A):Option[B] "Permalink")  def unapply(a: T): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[BoxedUnit](https://www.scala-lang.org/api/2.13.17/scala/runtime/BoxedUnit.html#scala.runtime.BoxedUnit)]Definition ClassesPartialFunction
35. [**](../../akka/dispatch/OnSuccess.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
36. [**](../../akka/dispatch/OnSuccess.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
37. [**](../../akka/dispatch/OnSuccess.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/OnSuccess.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/OnSuccess.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from OnSuccess\[T] toStringFormat\[OnSuccess\[T]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/dispatch/OnSuccess.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (OnSuccess\[T], B)ImplicitThis member is added by an implicit conversion from OnSuccess\[T] toArrowAssoc\[OnSuccess\[T]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [CallbackBridge](japi$$CallbackBridge.html)\[T]
...
### Inherited by implicit conversion any2stringadd fromOnSuccess\[T] to any2stringadd\[OnSuccess\[T]]

### Inherited by implicit conversion StringFormat fromOnSuccess\[T] to StringFormat\[OnSuccess\[T]]

### Inherited by implicit conversion Ensuring fromOnSuccess\[T] to Ensuring\[OnSuccess\[T]]

### Inherited by implicit conversion ArrowAssoc fromOnSuccess\[T] to ArrowAssoc\[OnSuccess\[T]]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/OnSuccess.html](https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/OnSuccess.html)*