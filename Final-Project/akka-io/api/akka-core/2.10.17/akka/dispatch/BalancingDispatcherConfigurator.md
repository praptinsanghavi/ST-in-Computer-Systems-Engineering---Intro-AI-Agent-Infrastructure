---
description: Akka 2.10.17 - akka.dispatch.BalancingDispatcherConfigurator
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:04:34Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/BalancingDispatcherConfigurator.html
title: Akka 2.10.17 - akka.dispatch.BalancingDispatcherConfigurator
---

# Akka 2.10.17 - akka.dispatch.BalancingDispatcherConfigurator

> **Summary:** Akka 2.10.17 - akka.dispatch.BalancingDispatcherConfigurator
...
# BalancingDispatcherConfigurator[**](../../akka/dispatch/BalancingDispatcherConfigurator.html "Permalink")

### 

#### class BalancingDispatcherConfigurator extends [MessageDispatcherConfigurator](MessageDispatcherConfigurator.html)

Configurator for creating akka.dispatch.BalancingDispatcher.
Returns the same dispatcher instance for each invocation
of the `dispatcher()` method.

Annotations@nowarn() Source[Dispatchers.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/dispatch/Dispatchers.scala#L321)Linear Supertypes[MessageDispatcherConfigurator](MessageDispatcherConfigurator.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. BalancingDispatcherConfigurator
...
1. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#<init>(_config:com.typesafe.config.Config,_prerequisites:akka.dispatch.DispatcherPrerequisites):akka.dispatch.BalancingDispatcherConfigurator "Permalink")  new BalancingDispatcherConfigurator(\_config: Config, \_prerequisites: [DispatcherPrerequisites](DispatcherPrerequisites.html))
### Value Members

1. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from BalancingDispatcherConfigurator toany2stringadd\[BalancingDispatcherConfigurator] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (BalancingDispatcherConfigurator, B)ImplicitThis member is added by an implicit conversion from BalancingDispatcherConfigurator toArrowAssoc\[BalancingDispatcherConfigurator] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#config:com.typesafe.config.Config "Permalink")  val config: ConfigDefinition Classes[MessageDispatcherConfigurator](MessageDispatcherConfigurator.html)
9. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#configureExecutor():akka.dispatch.ExecutorServiceConfigurator "Permalink")  def configureExecutor(): [ExecutorServiceConfigurator](ExecutorServiceConfigurator.html)Definition Classes[MessageDispatcherConfigurator](MessageDispatcherConfigurator.html)
10. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#create(mailboxType:akka.dispatch.MailboxType):akka.dispatch.BalancingDispatcher "Permalink")  def create(mailboxType: [MailboxType](MailboxType.html)): BalancingDispatcherAttributesprotected
11. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#dispatcher():akka.dispatch.MessageDispatcher "Permalink")  def dispatcher(): [MessageDispatcher](MessageDispatcher.html)Returns the same dispatcher instance for each invocation

Returns the same dispatcher instance for each invocation

Definition ClassesBalancingDispatcherConfigurator → [MessageDispatcherConfigurator](MessageDispatcherConfigurator.html)
12. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (BalancingDispatcherConfigurator) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BalancingDispatcherConfiguratorImplicitThis member is added by an implicit conversion from BalancingDispatcherConfigurator toEnsuring\[BalancingDispatcherConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (BalancingDispatcherConfigurator) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BalancingDispatcherConfiguratorImplicitThis member is added by an implicit conversion from BalancingDispatcherConfigurator toEnsuring\[BalancingDispatcherConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BalancingDispatcherConfiguratorImplicitThis member is added by an implicit conversion from BalancingDispatcherConfigurator toEnsuring\[BalancingDispatcherConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BalancingDispatcherConfiguratorImplicitThis member is added by an implicit conversion from BalancingDispatcherConfigurator toEnsuring\[BalancingDispatcherConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
18. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
21. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
22. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#prerequisites:akka.dispatch.DispatcherPrerequisites "Permalink")  val prerequisites: [DispatcherPrerequisites](DispatcherPrerequisites.html)Definition Classes[MessageDispatcherConfigurator](MessageDispatcherConfigurator.html)
25. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
26. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
27. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
29. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from BalancingDispatcherConfigurator toStringFormat\[BalancingDispatcherConfigurator] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/dispatch/BalancingDispatcherConfigurator.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (BalancingDispatcherConfigurator, B)ImplicitThis member is added by an implicit conversion from BalancingDispatcherConfigurator toArrowAssoc\[BalancingDispatcherConfigurator] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [MessageDispatcherConfigurator](MessageDispatcherConfigurator.html)

### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromBalancingDispatcherConfigurator to any2stringadd\[BalancingDispatcherConfigurator]

### Inherited by implicit conversion StringFormat fromBalancingDispatcherConfigurator to StringFormat\[BalancingDispatcherConfigurator]

### Inherited by implicit conversion Ensuring fromBalancingDispatcherConfigurator to Ensuring\[BalancingDispatcherConfigurator]

### Inherited by implicit conversion ArrowAssoc fromBalancingDispatcherConfigurator to ArrowAssoc\[BalancingDispatcherConfigurator]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/BalancingDispatcherConfigurator.html](https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/BalancingDispatcherConfigurator.html)*