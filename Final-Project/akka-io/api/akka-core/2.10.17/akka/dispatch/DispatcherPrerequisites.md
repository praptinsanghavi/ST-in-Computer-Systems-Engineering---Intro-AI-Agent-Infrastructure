---
description: Akka 2.10.17 - akka.dispatch.DispatcherPrerequisites
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:05:05Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/DispatcherPrerequisites.html
title: Akka 2.10.17 - akka.dispatch.DispatcherPrerequisites
---

# Akka 2.10.17 - akka.dispatch.DispatcherPrerequisites

> **Summary:** Akka 2.10.17 - akka.dispatch.DispatcherPrerequisites
...
# DispatcherPrerequisites[**](../../akka/dispatch/DispatcherPrerequisites.html "Permalink")

### 

#### trait DispatcherPrerequisites extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

DispatcherPrerequisites represents useful contextual pieces when constructing a MessageDispatcher

Source[Dispatchers.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/dispatch/Dispatchers.scala#L24)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. DispatcherPrerequisites
2. AnyRef
3. Any
Implicitly  
1. by any2stringadd
...
1. [**](../../akka/dispatch/DispatcherPrerequisites.html#defaultExecutionContext:Option[scala.concurrent.ExecutionContext] "Permalink") abstract  def defaultExecutionContext: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ExecutionContext](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContext.html#scala.concurrent.ExecutionContext)]
2. [**](../../akka/dispatch/DispatcherPrerequisites.html#dynamicAccess:akka.actor.DynamicAccess "Permalink") abstract  def dynamicAccess: [DynamicAccess](../actor/DynamicAccess.html)
3. [**](../../akka/dispatch/DispatcherPrerequisites.html#eventStream:akka.event.EventStream "Permalink") abstract  def eventStream: [EventStream](../event/EventStream.html)
4. [**](../../akka/dispatch/DispatcherPrerequisites.html#mailboxes:akka.dispatch.Mailboxes "Permalink") abstract  def mailboxes: Mailboxes
5. [**](../../akka/dispatch/DispatcherPrerequisites.html#scheduler:akka.actor.Scheduler "Permalink") abstract  def scheduler: [Scheduler](../actor/Scheduler.html)
6. [**](../../akka/dispatch/DispatcherPrerequisites.html#settings:akka.actor.ActorSystem.Settings "Permalink") abstract  def settings: [Settings](../actor/ActorSystem$$Settings.html)
7. [**](../../akka/dispatch/DispatcherPrerequisites.html#threadFactory:java.util.concurrent.ThreadFactory "Permalink") abstract  def threadFactory: [ThreadFactory](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/ThreadFactory.html#java.util.concurrent.ThreadFactory)
### Concrete Value Members

1. [**](../../akka/dispatch/DispatcherPrerequisites.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/DispatcherPrerequisites.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/DispatcherPrerequisites.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from DispatcherPrerequisites toany2stringadd\[DispatcherPrerequisites] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/DispatcherPrerequisites.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (DispatcherPrerequisites, B)ImplicitThis member is added by an implicit conversion from DispatcherPrerequisites toArrowAssoc\[DispatcherPrerequisites] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/DispatcherPrerequisites.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/DispatcherPrerequisites.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/dispatch/DispatcherPrerequisites.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/dispatch/DispatcherPrerequisites.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (DispatcherPrerequisites) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): DispatcherPrerequisitesImplicitThis member is added by an implicit conversion from DispatcherPrerequisites toEnsuring\[DispatcherPrerequisites] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/dispatch/DispatcherPrerequisites.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (DispatcherPrerequisites) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): DispatcherPrerequisitesImplicitThis member is added by an implicit conversion from DispatcherPrerequisites toEnsuring\[DispatcherPrerequisites] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/dispatch/DispatcherPrerequisites.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): DispatcherPrerequisitesImplicitThis member is added by an implicit conversion from DispatcherPrerequisites toEnsuring\[DispatcherPrerequisites] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/dispatch/DispatcherPrerequisites.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): DispatcherPrerequisitesImplicitThis member is added by an implicit conversion from DispatcherPrerequisites toEnsuring\[DispatcherPrerequisites] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/dispatch/DispatcherPrerequisites.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/dispatch/DispatcherPrerequisites.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/dispatch/DispatcherPrerequisites.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/dispatch/DispatcherPrerequisites.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/dispatch/DispatcherPrerequisites.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/dispatch/DispatcherPrerequisites.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/dispatch/DispatcherPrerequisites.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/dispatch/DispatcherPrerequisites.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/dispatch/DispatcherPrerequisites.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/dispatch/DispatcherPrerequisites.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/dispatch/DispatcherPrerequisites.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/dispatch/DispatcherPrerequisites.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/dispatch/DispatcherPrerequisites.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/DispatcherPrerequisites.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/DispatcherPrerequisites.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from DispatcherPrerequisites toStringFormat\[DispatcherPrerequisites] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/dispatch/DispatcherPrerequisites.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (DispatcherPrerequisites, B)ImplicitThis member is added by an implicit conversion from DispatcherPrerequisites toArrowAssoc\[DispatcherPrerequisites] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromDispatcherPrerequisites to any2stringadd\[DispatcherPrerequisites]

### Inherited by implicit conversion StringFormat fromDispatcherPrerequisites to StringFormat\[DispatcherPrerequisites]

### Inherited by implicit conversion Ensuring fromDispatcherPrerequisites to Ensuring\[DispatcherPrerequisites]

### Inherited by implicit conversion ArrowAssoc fromDispatcherPrerequisites to ArrowAssoc\[DispatcherPrerequisites]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/DispatcherPrerequisites.html](https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/DispatcherPrerequisites.html)*