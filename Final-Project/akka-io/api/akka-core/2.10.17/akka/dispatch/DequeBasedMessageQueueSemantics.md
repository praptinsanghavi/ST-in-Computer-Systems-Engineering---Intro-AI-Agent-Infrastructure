---
description: Akka 2.10.17 - akka.dispatch.DequeBasedMessageQueueSemantics
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:41:40Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/DequeBasedMessageQueueSemantics.html
title: Akka 2.10.17 - akka.dispatch.DequeBasedMessageQueueSemantics
---

# Akka 2.10.17 - akka.dispatch.DequeBasedMessageQueueSemantics

> **Summary:** Akka 2.10.17 - akka.dispatch.DequeBasedMessageQueueSemantics
...
# DequeBasedMessageQueueSemantics[**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html "Permalink")

### 

#### trait DequeBasedMessageQueueSemantics extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

DequeBasedMessageQueue refines QueueBasedMessageQueue to be backed by a java.util.Deque.

Source[Mailbox.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/dispatch/Mailbox.scala#L571)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[MessageQueue](BoundedDequeBasedMailbox$$MessageQueue.html), [BoundedDequeBasedMessageQueue](BoundedDequeBasedMessageQueue.html), [BoundedDequeBasedMessageQueueSemantics](BoundedDequeBasedMessageQueueSemantics.html), [DequeBasedMessageQueue](DequeBasedMessageQueue.html), [MessageQueue](UnboundedDequeBasedMailbox$$MessageQueue.html), [UnboundedDequeBasedMessageQueue](UnboundedDequeBasedMessageQueue.html), [UnboundedDequeBasedMessageQueueSemantics](UnboundedDequeBasedMessageQueueSemantics.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. DequeBasedMessageQueueSemantics
2. AnyRef
3. Any
Implicitly  
1. by any2stringadd
...
1. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#enqueueFirst(receiver:akka.actor.ActorRef,handle:akka.dispatch.Envelope):Unit "Permalink") abstract  def enqueueFirst(receiver: [ActorRef](../actor/ActorRef.html), handle: [Envelope](Envelope.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)
### Concrete Value Members

1. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from DequeBasedMessageQueueSemantics toany2stringadd\[DequeBasedMessageQueueSemantics] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (DequeBasedMessageQueueSemantics, B)ImplicitThis member is added by an implicit conversion from DequeBasedMessageQueueSemantics toArrowAssoc\[DequeBasedMessageQueueSemantics] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (DequeBasedMessageQueueSemantics) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): DequeBasedMessageQueueSemanticsImplicitThis member is added by an implicit conversion from DequeBasedMessageQueueSemantics toEnsuring\[DequeBasedMessageQueueSemantics] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (DequeBasedMessageQueueSemantics) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): DequeBasedMessageQueueSemanticsImplicitThis member is added by an implicit conversion from DequeBasedMessageQueueSemantics toEnsuring\[DequeBasedMessageQueueSemantics] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): DequeBasedMessageQueueSemanticsImplicitThis member is added by an implicit conversion from DequeBasedMessageQueueSemantics toEnsuring\[DequeBasedMessageQueueSemantics] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): DequeBasedMessageQueueSemanticsImplicitThis member is added by an implicit conversion from DequeBasedMessageQueueSemantics toEnsuring\[DequeBasedMessageQueueSemantics] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from DequeBasedMessageQueueSemantics toStringFormat\[DequeBasedMessageQueueSemantics] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/dispatch/DequeBasedMessageQueueSemantics.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (DequeBasedMessageQueueSemantics, B)ImplicitThis member is added by an implicit conversion from DequeBasedMessageQueueSemantics toArrowAssoc\[DequeBasedMessageQueueSemantics] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromDequeBasedMessageQueueSemantics to any2stringadd\[DequeBasedMessageQueueSemantics]

### Inherited by implicit conversion StringFormat fromDequeBasedMessageQueueSemantics to StringFormat\[DequeBasedMessageQueueSemantics]

### Inherited by implicit conversion Ensuring fromDequeBasedMessageQueueSemantics to Ensuring\[DequeBasedMessageQueueSemantics]

### Inherited by implicit conversion ArrowAssoc fromDequeBasedMessageQueueSemantics to ArrowAssoc\[DequeBasedMessageQueueSemantics]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/DequeBasedMessageQueueSemantics.html](https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/DequeBasedMessageQueueSemantics.html)*