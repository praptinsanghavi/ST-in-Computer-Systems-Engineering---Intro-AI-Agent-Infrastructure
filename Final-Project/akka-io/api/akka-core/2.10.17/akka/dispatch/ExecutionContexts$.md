---
description: Akka 2.10.17 - akka.dispatch.ExecutionContexts
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:05:13Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/ExecutionContexts$.html
title: Akka 2.10.17 - akka.dispatch.ExecutionContexts
---

# Akka 2.10.17 - akka.dispatch.ExecutionContexts

> **Summary:** Akka 2.10.17 - akka.dispatch.ExecutionContexts
...
# ExecutionContexts[**](../../akka/dispatch/ExecutionContexts$.html "Permalink")
...
Source[Future.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/dispatch/Future.scala#L24)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ExecutionContexts
2. AnyRef
...
1. [**](../../akka/dispatch/ExecutionContexts$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/ExecutionContexts$.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/ExecutionContexts$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/dispatch/ExecutionContexts$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../akka/dispatch/ExecutionContexts$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../akka/dispatch/ExecutionContexts$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
7. [**](../../akka/dispatch/ExecutionContexts$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
8. [**](../../akka/dispatch/ExecutionContexts$.html#fromExecutor(executor:java.util.concurrent.Executor,errorReporter:akka.japi.Procedure[Throwable]):scala.concurrent.ExecutionContextExecutor "Permalink")  def fromExecutor(executor: [Executor](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/Executor.html#java.util.concurrent.Executor), errorReporter: [Procedure](../japi/Procedure.html)\[Throwable]): [ExecutionContextExecutor](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContextExecutor.html#scala.concurrent.ExecutionContextExecutor)Returns a new ExecutionContextExecutor which will delegate execution to the underlying Executor,
and which will use the provided error reporter.

Returns a new ExecutionContextExecutor which will delegate execution to the underlying Executor,
and which will use the provided error reporter.

executorthe Executor which will be used for the ExecutionContext

errorReportera Procedure that will log any exceptions passed to it

returnsa new ExecutionContext
9. [**](../../akka/dispatch/ExecutionContexts$.html#fromExecutor(executor:java.util.concurrent.Executor):scala.concurrent.ExecutionContextExecutor "Permalink")  def fromExecutor(executor: [Executor](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/Executor.html#java.util.concurrent.Executor)): [ExecutionContextExecutor](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContextExecutor.html#scala.concurrent.ExecutionContextExecutor)Returns a new ExecutionContextExecutor which will delegate execution to the underlying Executor,
...
returnsa new ExecutionContext
10. [**](../../akka/dispatch/ExecutionContexts$.html#fromExecutorService(executorService:java.util.concurrent.ExecutorService,errorReporter:akka.japi.Procedure[Throwable]):scala.concurrent.ExecutionContextExecutorService "Permalink")  def fromExecutorService(executorService: [ExecutorService](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/ExecutorService.html#java.util.concurrent.ExecutorService), errorReporter: [Procedure](../japi/Procedure.html)\[Throwable]): [ExecutionContextExecutorService](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContextExecutorService.html#scala.concurrent.ExecutionContextExecutorService)Returns a new ExecutionContextExecutorService which will delegate execution to the underlying ExecutorService,
and which will use the provided error reporter.

Returns a new ExecutionContextExecutorService which will delegate execution to the underlying ExecutorService,
and which will use the provided error reporter.

executorServicethe ExecutorService which will be used for the ExecutionContext

errorReportera Procedure that will log any exceptions passed to it

returnsa new ExecutionContext
11. [**](../../akka/dispatch/ExecutionContexts$.html#fromExecutorService(executorService:java.util.concurrent.ExecutorService):scala.concurrent.ExecutionContextExecutorService "Permalink")  def fromExecutorService(executorService: [ExecutorService](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/ExecutorService.html#java.util.concurrent.ExecutorService)): [ExecutionContextExecutorService](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContextExecutorService.html#scala.concurrent.ExecutionContextExecutorService)Returns a new ExecutionContextExecutorService which will delegate execution to the underlying ExecutorService,
and which will use the default error reporter.
...
returnsa new ExecutionContext
12. [**](../../akka/dispatch/ExecutionContexts$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../akka/dispatch/ExecutionContexts$.html#global():scala.concurrent.ExecutionContextExecutor "Permalink")  def global(): [ExecutionContextExecutor](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContextExecutor.html#scala.concurrent.ExecutionContextExecutor)returnsa reference to the global ExecutionContext
14. [**](../../akka/dispatch/ExecutionContexts$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/dispatch/ExecutionContexts$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
16. [**](../../akka/dispatch/ExecutionContexts$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/dispatch/ExecutionContexts$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/dispatch/ExecutionContexts$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/dispatch/ExecutionContexts$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
20. [**](../../akka/dispatch/ExecutionContexts$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
21. [**](../../akka/dispatch/ExecutionContexts$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
22. [**](../../akka/dispatch/ExecutionContexts$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
23. [**](../../akka/dispatch/ExecutionContexts$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/ExecutionContexts$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/ExecutionContexts$.html](https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/ExecutionContexts$.html)*