...
scraped_at: '2026-04-06T15:06:19Z'
section: api
site: akka-io
...
[o](ThreadPoolConfig.html "See companion class")[akka](../index.html).[dispatch](index.html)

# [ThreadPoolConfig](ThreadPoolConfig.html "See companion class")[**](../../akka/dispatch/ThreadPoolConfig$.html "Permalink")

### Companion [class ThreadPoolConfig](ThreadPoolConfig.html "See companion class")

#### object ThreadPoolConfig extends [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)

Source[ThreadPoolBuilder.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/dispatch/ThreadPoolBuilder.scala#L28)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ThreadPoolConfig
2. Serializable
...
3. [**](../../akka/dispatch/ThreadPoolConfig$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/dispatch/ThreadPoolConfig$.html#arrayBlockingQueue(capacity:Int,fair:Boolean):akka.dispatch.ThreadPoolConfig.QueueFactory "Permalink")  def arrayBlockingQueue(capacity: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), fair: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): [QueueFactory](#QueueFactory=()=>java.util.concurrent.BlockingQueue[Runnable])
5. [**](../../akka/dispatch/ThreadPoolConfig$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
6. [**](../../akka/dispatch/ThreadPoolConfig$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
7. [**](../../akka/dispatch/ThreadPoolConfig$.html#defaultAllowCoreThreadTimeout:Boolean "Permalink")  val defaultAllowCoreThreadTimeout: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)
8. [**](../../akka/dispatch/ThreadPoolConfig$.html#defaultCorePoolSize:Int "Permalink")  val defaultCorePoolSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
9. [**](../../akka/dispatch/ThreadPoolConfig$.html#defaultMaxPoolSize:Int "Permalink")  val defaultMaxPoolSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
10. [**](../../akka/dispatch/ThreadPoolConfig$.html#defaultRejectionPolicy:java.util.concurrent.RejectedExecutionHandler "Permalink")  val defaultRejectionPolicy: [RejectedExecutionHandler](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/RejectedExecutionHandler.html#java.util.concurrent.RejectedExecutionHandler)
11. [**](../../akka/dispatch/ThreadPoolConfig$.html#defaultTimeout:scala.concurrent.duration.Duration "Permalink")  val defaultTimeout: [Duration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/Duration.html#scala.concurrent.duration.Duration)
12. [**](../../akka/dispatch/ThreadPoolConfig$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/dispatch/ThreadPoolConfig$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/dispatch/ThreadPoolConfig$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/dispatch/ThreadPoolConfig$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/dispatch/ThreadPoolConfig$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/dispatch/ThreadPoolConfig$.html#linkedBlockingQueue(capacity:Int):akka.dispatch.ThreadPoolConfig.QueueFactory "Permalink")  def linkedBlockingQueue(capacity: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [QueueFactory](#QueueFactory=()=>java.util.concurrent.BlockingQueue[Runnable])
18. [**](../../akka/dispatch/ThreadPoolConfig$.html#linkedBlockingQueue():akka.dispatch.ThreadPoolConfig.QueueFactory "Permalink")  def linkedBlockingQueue(): [QueueFactory](#QueueFactory=()=>java.util.concurrent.BlockingQueue[Runnable])
...
22. [**](../../akka/dispatch/ThreadPoolConfig$.html#reusableQueue(queueFactory:akka.dispatch.ThreadPoolConfig.QueueFactory):akka.dispatch.ThreadPoolConfig.QueueFactory "Permalink")  def reusableQueue(queueFactory: [QueueFactory](#QueueFactory=()=>java.util.concurrent.BlockingQueue[Runnable])): [QueueFactory](#QueueFactory=()=>java.util.concurrent.BlockingQueue[Runnable])
23. [**](../../akka/dispatch/ThreadPoolConfig$.html#reusableQueue(queue:java.util.concurrent.BlockingQueue[Runnable]):akka.dispatch.ThreadPoolConfig.QueueFactory "Permalink")  def reusableQueue(queue: [BlockingQueue](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/BlockingQueue.html#java.util.concurrent.BlockingQueue)\[[Runnable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Runnable.html#java.lang.Runnable)]): [QueueFactory](#QueueFactory=()=>java.util.concurrent.BlockingQueue[Runnable])
24. [**](../../akka/dispatch/ThreadPoolConfig$.html#scaledPoolSize(floor:Int,multiplier:Double,ceiling:Int):Int "Permalink")  def scaledPoolSize(floor: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), multiplier: [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double), ceiling: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
...
26. [**](../../akka/dispatch/ThreadPoolConfig$.html#synchronousQueue(fair:Boolean):akka.dispatch.ThreadPoolConfig.QueueFactory "Permalink")  def synchronousQueue(fair: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): [QueueFactory](#QueueFactory=()=>java.util.concurrent.BlockingQueue[Runnable])
27. [**](../../akka/dispatch/ThreadPoolConfig$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
28. [**](../../akka/dispatch/ThreadPoolConfig$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
29. [**](../../akka/dispatch/ThreadPoolConfig$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
30. [**](../../akka/dispatch/ThreadPoolConfig$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
