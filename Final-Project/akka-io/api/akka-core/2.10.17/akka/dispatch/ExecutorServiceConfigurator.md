---
description: Akka 2.10.17 - akka.dispatch.ExecutorServiceConfigurator
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:05:17Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/ExecutorServiceConfigurator.html
title: Akka 2.10.17 - akka.dispatch.ExecutorServiceConfigurator
---

# Akka 2.10.17 - akka.dispatch.ExecutorServiceConfigurator

> **Summary:** Akka 2.10.17 - akka.dispatch.ExecutorServiceConfigurator
...
# ExecutorServiceConfigurator[**](../../akka/dispatch/ExecutorServiceConfigurator.html "Permalink")

### 

#### abstract  class ExecutorServiceConfigurator extends [ExecutorServiceFactoryProvider](ExecutorServiceFactoryProvider.html)
...
Source[AbstractDispatcher.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/dispatch/AbstractDispatcher.scala#L340)Linear Supertypes[ExecutorServiceFactoryProvider](ExecutorServiceFactoryProvider.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[DefaultExecutorServiceConfigurator](DefaultExecutorServiceConfigurator.html), [ForkJoinExecutorConfigurator](ForkJoinExecutorConfigurator.html), [ThreadPoolExecutorConfigurator](ThreadPoolExecutorConfigurator.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ExecutorServiceConfigurator
2. ExecutorServiceFactoryProvider
3. AnyRef
4. Any
Implicitly  
1. by any2stringadd
...
1. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#<init>(config:com.typesafe.config.Config,prerequisites:akka.dispatch.DispatcherPrerequisites):akka.dispatch.ExecutorServiceConfigurator "Permalink")  new ExecutorServiceConfigurator(config: Config, prerequisites: [DispatcherPrerequisites](DispatcherPrerequisites.html))
### Abstract Value Members

1. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#createExecutorServiceFactory(id:String,threadFactory:java.util.concurrent.ThreadFactory):akka.dispatch.ExecutorServiceFactory "Permalink") abstract  def createExecutorServiceFactory(id: String, threadFactory: [ThreadFactory](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/ThreadFactory.html#java.util.concurrent.ThreadFactory)): [ExecutorServiceFactory](ExecutorServiceFactory.html)Definition Classes[ExecutorServiceFactoryProvider](ExecutorServiceFactoryProvider.html)
### Concrete Value Members

1. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/ExecutorServiceConfigurator.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ExecutorServiceConfigurator toany2stringadd\[ExecutorServiceConfigurator] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ExecutorServiceConfigurator, B)ImplicitThis member is added by an implicit conversion from ExecutorServiceConfigurator toArrowAssoc\[ExecutorServiceConfigurator] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ExecutorServiceConfigurator) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ExecutorServiceConfiguratorImplicitThis member is added by an implicit conversion from ExecutorServiceConfigurator toEnsuring\[ExecutorServiceConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ExecutorServiceConfigurator) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ExecutorServiceConfiguratorImplicitThis member is added by an implicit conversion from ExecutorServiceConfigurator toEnsuring\[ExecutorServiceConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ExecutorServiceConfiguratorImplicitThis member is added by an implicit conversion from ExecutorServiceConfigurator toEnsuring\[ExecutorServiceConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ExecutorServiceConfiguratorImplicitThis member is added by an implicit conversion from ExecutorServiceConfigurator toEnsuring\[ExecutorServiceConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ExecutorServiceConfigurator toStringFormat\[ExecutorServiceConfigurator] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/dispatch/ExecutorServiceConfigurator.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ExecutorServiceConfigurator, B)ImplicitThis member is added by an implicit conversion from ExecutorServiceConfigurator toArrowAssoc\[ExecutorServiceConfigurator] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromExecutorServiceConfigurator to any2stringadd\[ExecutorServiceConfigurator]

### Inherited by implicit conversion StringFormat fromExecutorServiceConfigurator to StringFormat\[ExecutorServiceConfigurator]

### Inherited by implicit conversion Ensuring fromExecutorServiceConfigurator to Ensuring\[ExecutorServiceConfigurator]

### Inherited by implicit conversion ArrowAssoc fromExecutorServiceConfigurator to ArrowAssoc\[ExecutorServiceConfigurator]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/ExecutorServiceConfigurator.html](https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/ExecutorServiceConfigurator.html)*