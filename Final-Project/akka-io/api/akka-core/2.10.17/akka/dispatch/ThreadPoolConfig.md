---
description: Akka 2.10.17 - akka.dispatch.ThreadPoolConfig
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:06:18Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/ThreadPoolConfig.html
title: Akka 2.10.17 - akka.dispatch.ThreadPoolConfig
---

# Akka 2.10.17 - akka.dispatch.ThreadPoolConfig

> **Summary:** Akka 2.10.17 - akka.dispatch.ThreadPoolConfig
...
1. [**](../../akka/dispatch/ThreadPoolConfig.html#<init>(allowCorePoolTimeout:Boolean,corePoolSize:Int,maxPoolSize:Int,threadTimeout:scala.concurrent.duration.Duration,queueFactory:akka.dispatch.ThreadPoolConfig.QueueFactory,rejectionPolicy:java.util.concurrent.RejectedExecutionHandler):akka.dispatch.ThreadPoolConfig "Permalink")  new ThreadPoolConfig(allowCorePoolTimeout: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean) \= [ThreadPoolConfig.defaultAllowCoreThreadTimeout](ThreadPoolConfig$.html), corePoolSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int) \= [ThreadPoolConfig.defaultCorePoolSize](ThreadPoolConfig$.html), maxPoolSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int) \= [ThreadPoolConfig.defaultMaxPoolSize](ThreadPoolConfig$.html), threadTimeout: [Duration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/Duration.html#scala.concurrent.duration.Duration) \= [ThreadPoolConfig.defaultTimeout](ThreadPoolConfig$.html), queueFactory: [QueueFactory](ThreadPoolConfig$.html#QueueFactory=()=>java.util.concurrent.BlockingQueue[Runnable]) \= [ThreadPoolConfig.linkedBlockingQueue()](ThreadPoolConfig$.html), rejectionPolicy: [RejectedExecutionHandler](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/RejectedExecutionHandler.html#java.util.concurrent.RejectedExecutionHandler) \= [ThreadPoolConfig.defaultRejectionPolicy](ThreadPoolConfig$.html))
### Type Members

1. [**](../../akka/dispatch/ThreadPoolConfig$ThreadPoolExecutorServiceFactory.html "Permalink")  class [ThreadPoolExecutorServiceFactory](ThreadPoolConfig$ThreadPoolExecutorServiceFactory.html) extends [ExecutorServiceFactory](ExecutorServiceFactory.html)
### Value Members

1. [**](../../akka/dispatch/ThreadPoolConfig.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/ThreadPoolConfig.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/ThreadPoolConfig.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ThreadPoolConfig toany2stringadd\[ThreadPoolConfig] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/ThreadPoolConfig.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ThreadPoolConfig, B)ImplicitThis member is added by an implicit conversion from ThreadPoolConfig toArrowAssoc\[ThreadPoolConfig] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/ThreadPoolConfig.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/ThreadPoolConfig.html#allowCorePoolTimeout:Boolean "Permalink")  val allowCorePoolTimeout: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)
7. [**](../../akka/dispatch/ThreadPoolConfig.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
8. [**](../../akka/dispatch/ThreadPoolConfig.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../akka/dispatch/ThreadPoolConfig.html#corePoolSize:Int "Permalink")  val corePoolSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
10. [**](../../akka/dispatch/ThreadPoolConfig.html#createExecutorServiceFactory(id:String,threadFactory:java.util.concurrent.ThreadFactory):akka.dispatch.ExecutorServiceFactory "Permalink")  def createExecutorServiceFactory(id: String, threadFactory: [ThreadFactory](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/ThreadFactory.html#java.util.concurrent.ThreadFactory)): [ExecutorServiceFactory](ExecutorServiceFactory.html)Definition ClassesThreadPoolConfig → [ExecutorServiceFactoryProvider](ExecutorServiceFactoryProvider.html)
11. [**](../../akka/dispatch/ThreadPoolConfig.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ThreadPoolConfig) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ThreadPoolConfigImplicitThis member is added by an implicit conversion from ThreadPoolConfig toEnsuring\[ThreadPoolConfig] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/dispatch/ThreadPoolConfig.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ThreadPoolConfig) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ThreadPoolConfigImplicitThis member is added by an implicit conversion from ThreadPoolConfig toEnsuring\[ThreadPoolConfig] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/dispatch/ThreadPoolConfig.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ThreadPoolConfigImplicitThis member is added by an implicit conversion from ThreadPoolConfig toEnsuring\[ThreadPoolConfig] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/dispatch/ThreadPoolConfig.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ThreadPoolConfigImplicitThis member is added by an implicit conversion from ThreadPoolConfig toEnsuring\[ThreadPoolConfig] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/dispatch/ThreadPoolConfig.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
16. [**](../../akka/dispatch/ThreadPoolConfig.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/dispatch/ThreadPoolConfig.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
18. [**](../../akka/dispatch/ThreadPoolConfig.html#maxPoolSize:Int "Permalink")  val maxPoolSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
19. [**](../../akka/dispatch/ThreadPoolConfig.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
20. [**](../../akka/dispatch/ThreadPoolConfig.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../akka/dispatch/ThreadPoolConfig.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/dispatch/ThreadPoolConfig.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
23. [**](../../akka/dispatch/ThreadPoolConfig.html#queueFactory:akka.dispatch.ThreadPoolConfig.QueueFactory "Permalink")  val queueFactory: [QueueFactory](ThreadPoolConfig$.html#QueueFactory=()=>java.util.concurrent.BlockingQueue[Runnable])
24. [**](../../akka/dispatch/ThreadPoolConfig.html#rejectionPolicy:java.util.concurrent.RejectedExecutionHandler "Permalink")  val rejectionPolicy: [RejectedExecutionHandler](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/RejectedExecutionHandler.html#java.util.concurrent.RejectedExecutionHandler)
25. [**](../../akka/dispatch/ThreadPoolConfig.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
26. [**](../../akka/dispatch/ThreadPoolConfig.html#threadTimeout:scala.concurrent.duration.Duration "Permalink")  val threadTimeout: [Duration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/Duration.html#scala.concurrent.duration.Duration)
27. [**](../../akka/dispatch/ThreadPoolConfig.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../akka/dispatch/ThreadPoolConfig.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
29. [**](../../akka/dispatch/ThreadPoolConfig.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/ThreadPoolConfig.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/ThreadPoolConfig.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ThreadPoolConfig toStringFormat\[ThreadPoolConfig] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/dispatch/ThreadPoolConfig.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ThreadPoolConfig, B)ImplicitThis member is added by an implicit conversion from ThreadPoolConfig toArrowAssoc\[ThreadPoolConfig] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromThreadPoolConfig to any2stringadd\[ThreadPoolConfig]

### Inherited by implicit conversion StringFormat fromThreadPoolConfig to StringFormat\[ThreadPoolConfig]

### Inherited by implicit conversion Ensuring fromThreadPoolConfig to Ensuring\[ThreadPoolConfig]

### Inherited by implicit conversion ArrowAssoc fromThreadPoolConfig to ArrowAssoc\[ThreadPoolConfig]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/ThreadPoolConfig.html](https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/ThreadPoolConfig.html)*