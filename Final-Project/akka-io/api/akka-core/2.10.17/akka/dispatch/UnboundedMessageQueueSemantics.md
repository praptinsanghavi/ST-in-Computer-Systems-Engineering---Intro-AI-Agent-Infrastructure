---
description: Akka 2.10.17 - akka.dispatch.UnboundedMessageQueueSemantics
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:03:51Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/UnboundedMessageQueueSemantics.html
title: Akka 2.10.17 - akka.dispatch.UnboundedMessageQueueSemantics
---

# Akka 2.10.17 - akka.dispatch.UnboundedMessageQueueSemantics

> **Summary:** Akka 2.10.17 - akka.dispatch.UnboundedMessageQueueSemantics
...
# UnboundedMessageQueueSemantics[**](../../akka/dispatch/UnboundedMessageQueueSemantics.html "Permalink")

### 

#### trait UnboundedMessageQueueSemantics extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
...
Source[Mailbox.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/dispatch/Mailbox.scala#L528)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[NodeMessageQueue](NodeMessageQueue.html), [MessageQueue](UnboundedControlAwareMailbox$$MessageQueue.html), [UnboundedControlAwareMessageQueueSemantics](UnboundedControlAwareMessageQueueSemantics.html), [MessageQueue](UnboundedDequeBasedMailbox$$MessageQueue.html), [UnboundedDequeBasedMessageQueue](UnboundedDequeBasedMessageQueue.html), [UnboundedDequeBasedMessageQueueSemantics](UnboundedDequeBasedMessageQueueSemantics.html), [MessageQueue](UnboundedMailbox$$MessageQueue.html), [MessageQueue](UnboundedPriorityMailbox$$MessageQueue.html), [UnboundedQueueBasedMessageQueue](UnboundedQueueBasedMessageQueue.html), [MessageQueue](UnboundedStablePriorityMailbox$$MessageQueue.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. UnboundedMessageQueueSemantics
2. AnyRef
3. Any
Implicitly  
1. by any2stringadd
...
1. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from UnboundedMessageQueueSemantics toany2stringadd\[UnboundedMessageQueueSemantics] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (UnboundedMessageQueueSemantics, B)ImplicitThis member is added by an implicit conversion from UnboundedMessageQueueSemantics toArrowAssoc\[UnboundedMessageQueueSemantics] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (UnboundedMessageQueueSemantics) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): UnboundedMessageQueueSemanticsImplicitThis member is added by an implicit conversion from UnboundedMessageQueueSemantics toEnsuring\[UnboundedMessageQueueSemantics] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (UnboundedMessageQueueSemantics) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): UnboundedMessageQueueSemanticsImplicitThis member is added by an implicit conversion from UnboundedMessageQueueSemantics toEnsuring\[UnboundedMessageQueueSemantics] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): UnboundedMessageQueueSemanticsImplicitThis member is added by an implicit conversion from UnboundedMessageQueueSemantics toEnsuring\[UnboundedMessageQueueSemantics] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): UnboundedMessageQueueSemanticsImplicitThis member is added by an implicit conversion from UnboundedMessageQueueSemantics toEnsuring\[UnboundedMessageQueueSemantics] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from UnboundedMessageQueueSemantics toStringFormat\[UnboundedMessageQueueSemantics] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/dispatch/UnboundedMessageQueueSemantics.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (UnboundedMessageQueueSemantics, B)ImplicitThis member is added by an implicit conversion from UnboundedMessageQueueSemantics toArrowAssoc\[UnboundedMessageQueueSemantics] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromUnboundedMessageQueueSemantics to any2stringadd\[UnboundedMessageQueueSemantics]

### Inherited by implicit conversion StringFormat fromUnboundedMessageQueueSemantics to StringFormat\[UnboundedMessageQueueSemantics]

### Inherited by implicit conversion Ensuring fromUnboundedMessageQueueSemantics to Ensuring\[UnboundedMessageQueueSemantics]

### Inherited by implicit conversion ArrowAssoc fromUnboundedMessageQueueSemantics to ArrowAssoc\[UnboundedMessageQueueSemantics]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/UnboundedMessageQueueSemantics.html](https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/UnboundedMessageQueueSemantics.html)*