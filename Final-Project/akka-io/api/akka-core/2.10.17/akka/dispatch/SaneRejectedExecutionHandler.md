---
description: Akka 2.10.17 - akka.dispatch.SaneRejectedExecutionHandler
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:06:10Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/SaneRejectedExecutionHandler.html
title: Akka 2.10.17 - akka.dispatch.SaneRejectedExecutionHandler
---

# Akka 2.10.17 - akka.dispatch.SaneRejectedExecutionHandler

> **Summary:** Akka 2.10.17 - akka.dispatch.SaneRejectedExecutionHandler
...
# SaneRejectedExecutionHandler[**](../../akka/dispatch/SaneRejectedExecutionHandler.html "Permalink")

### 

#### class SaneRejectedExecutionHandler extends [RejectedExecutionHandler](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/RejectedExecutionHandler.html#java.util.concurrent.RejectedExecutionHandler)
...
1. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#<init>():akka.dispatch.SaneRejectedExecutionHandler "Permalink")  new SaneRejectedExecutionHandler()
### Value Members

1. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from SaneRejectedExecutionHandler toany2stringadd\[SaneRejectedExecutionHandler] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (SaneRejectedExecutionHandler, B)ImplicitThis member is added by an implicit conversion from SaneRejectedExecutionHandler toArrowAssoc\[SaneRejectedExecutionHandler] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (SaneRejectedExecutionHandler) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SaneRejectedExecutionHandlerImplicitThis member is added by an implicit conversion from SaneRejectedExecutionHandler toEnsuring\[SaneRejectedExecutionHandler] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (SaneRejectedExecutionHandler) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SaneRejectedExecutionHandlerImplicitThis member is added by an implicit conversion from SaneRejectedExecutionHandler toEnsuring\[SaneRejectedExecutionHandler] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SaneRejectedExecutionHandlerImplicitThis member is added by an implicit conversion from SaneRejectedExecutionHandler toEnsuring\[SaneRejectedExecutionHandler] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SaneRejectedExecutionHandlerImplicitThis member is added by an implicit conversion from SaneRejectedExecutionHandler toEnsuring\[SaneRejectedExecutionHandler] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#rejectedExecution(runnable:Runnable,threadPoolExecutor:java.util.concurrent.ThreadPoolExecutor):Unit "Permalink")  def rejectedExecution(runnable: [Runnable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Runnable.html#java.lang.Runnable), threadPoolExecutor: [ThreadPoolExecutor](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/ThreadPoolExecutor.html#java.util.concurrent.ThreadPoolExecutor)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesSaneRejectedExecutionHandler → RejectedExecutionHandler
21. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
23. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from SaneRejectedExecutionHandler toStringFormat\[SaneRejectedExecutionHandler] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/dispatch/SaneRejectedExecutionHandler.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (SaneRejectedExecutionHandler, B)ImplicitThis member is added by an implicit conversion from SaneRejectedExecutionHandler toArrowAssoc\[SaneRejectedExecutionHandler] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [RejectedExecutionHandler](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/RejectedExecutionHandler.html#java.util.concurrent.RejectedExecutionHandler)

### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromSaneRejectedExecutionHandler to any2stringadd\[SaneRejectedExecutionHandler]

### Inherited by implicit conversion StringFormat fromSaneRejectedExecutionHandler to StringFormat\[SaneRejectedExecutionHandler]

### Inherited by implicit conversion Ensuring fromSaneRejectedExecutionHandler to Ensuring\[SaneRejectedExecutionHandler]

### Inherited by implicit conversion ArrowAssoc fromSaneRejectedExecutionHandler to ArrowAssoc\[SaneRejectedExecutionHandler]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/SaneRejectedExecutionHandler.html](https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/SaneRejectedExecutionHandler.html)*