---
description: Akka 2.10.17 - akka.dispatch.UnboundedStablePriorityMailbox
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:06:46Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/UnboundedStablePriorityMailbox.html
title: Akka 2.10.17 - akka.dispatch.UnboundedStablePriorityMailbox
---

# Akka 2.10.17 - akka.dispatch.UnboundedStablePriorityMailbox

> **Summary:** Akka 2.10.17 - akka.dispatch.UnboundedStablePriorityMailbox
...
[c](UnboundedStablePriorityMailbox$.html "See companion object")[akka](../index.html).[dispatch](index.html)

# [UnboundedStablePriorityMailbox](UnboundedStablePriorityMailbox$.html "See companion object")[**](../../akka/dispatch/UnboundedStablePriorityMailbox.html "Permalink")

### Companion [object UnboundedStablePriorityMailbox](UnboundedStablePriorityMailbox$.html "See companion object")

#### class UnboundedStablePriorityMailbox extends [MailboxType](MailboxType.html) with [ProducesMessageQueue](ProducesMessageQueue.html)\[[dispatch.UnboundedStablePriorityMailbox.MessageQueue](UnboundedStablePriorityMailbox$$MessageQueue.html)]
...
Source[Mailbox.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/dispatch/Mailbox.scala#L775)Linear Supertypes[ProducesMessageQueue](ProducesMessageQueue.html)\[[UnboundedStablePriorityMailbox.MessageQueue](UnboundedStablePriorityMailbox$$MessageQueue.html)], [MailboxType](MailboxType.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#<init>(cmp:java.util.Comparator[akka.dispatch.Envelope]):akka.dispatch.UnboundedStablePriorityMailbox "Permalink")  new UnboundedStablePriorityMailbox(cmp: [Comparator](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Comparator.html#java.util.Comparator)\[[Envelope](Envelope.html)])
2. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#<init>(cmp:java.util.Comparator[akka.dispatch.Envelope],initialCapacity:Int):akka.dispatch.UnboundedStablePriorityMailbox "Permalink")  new UnboundedStablePriorityMailbox(cmp: [Comparator](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Comparator.html#java.util.Comparator)\[[Envelope](Envelope.html)], initialCapacity: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int))
### Value Members

1. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from UnboundedStablePriorityMailbox toany2stringadd\[UnboundedStablePriorityMailbox] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (UnboundedStablePriorityMailbox, B)ImplicitThis member is added by an implicit conversion from UnboundedStablePriorityMailbox toArrowAssoc\[UnboundedStablePriorityMailbox] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#cmp:java.util.Comparator[akka.dispatch.Envelope] "Permalink")  val cmp: [Comparator](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Comparator.html#java.util.Comparator)\[[Envelope](Envelope.html)]
9. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#create(owner:Option[akka.actor.ActorRef],system:Option[akka.actor.ActorSystem]):akka.dispatch.MessageQueue "Permalink") final  def create(owner: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ActorRef](../actor/ActorRef.html)], system: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ActorSystem](../actor/ActorSystem.html)]): [MessageQueue](MessageQueue.html)Definition ClassesUnboundedStablePriorityMailbox → [MailboxType](MailboxType.html)
10. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (UnboundedStablePriorityMailbox) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): UnboundedStablePriorityMailboxImplicitThis member is added by an implicit conversion from UnboundedStablePriorityMailbox toEnsuring\[UnboundedStablePriorityMailbox] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (UnboundedStablePriorityMailbox) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): UnboundedStablePriorityMailboxImplicitThis member is added by an implicit conversion from UnboundedStablePriorityMailbox toEnsuring\[UnboundedStablePriorityMailbox] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): UnboundedStablePriorityMailboxImplicitThis member is added by an implicit conversion from UnboundedStablePriorityMailbox toEnsuring\[UnboundedStablePriorityMailbox] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): UnboundedStablePriorityMailboxImplicitThis member is added by an implicit conversion from UnboundedStablePriorityMailbox toEnsuring\[UnboundedStablePriorityMailbox] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
16. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#initialCapacity:Int "Permalink")  val initialCapacity: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
19. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
20. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
21. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
24. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
25. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
27. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from UnboundedStablePriorityMailbox toStringFormat\[UnboundedStablePriorityMailbox] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/dispatch/UnboundedStablePriorityMailbox.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (UnboundedStablePriorityMailbox, B)ImplicitThis member is added by an implicit conversion from UnboundedStablePriorityMailbox toArrowAssoc\[UnboundedStablePriorityMailbox] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [ProducesMessageQueue](ProducesMessageQueue.html)\[[UnboundedStablePriorityMailbox.MessageQueue](UnboundedStablePriorityMailbox$$MessageQueue.html)]
...
### Inherited by implicit conversion any2stringadd fromUnboundedStablePriorityMailbox to any2stringadd\[UnboundedStablePriorityMailbox]

### Inherited by implicit conversion StringFormat fromUnboundedStablePriorityMailbox to StringFormat\[UnboundedStablePriorityMailbox]

### Inherited by implicit conversion Ensuring fromUnboundedStablePriorityMailbox to Ensuring\[UnboundedStablePriorityMailbox]

### Inherited by implicit conversion ArrowAssoc fromUnboundedStablePriorityMailbox to ArrowAssoc\[UnboundedStablePriorityMailbox]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/UnboundedStablePriorityMailbox.html](https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/UnboundedStablePriorityMailbox.html)*