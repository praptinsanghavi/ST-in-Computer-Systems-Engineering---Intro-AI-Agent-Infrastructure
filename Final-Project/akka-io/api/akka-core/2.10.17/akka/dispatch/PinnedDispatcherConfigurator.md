---
description: Akka 2.10.17 - akka.dispatch.PinnedDispatcherConfigurator
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:06:03Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/PinnedDispatcherConfigurator.html
title: Akka 2.10.17 - akka.dispatch.PinnedDispatcherConfigurator
---

# Akka 2.10.17 - akka.dispatch.PinnedDispatcherConfigurator

> **Summary:** Akka 2.10.17 - akka.dispatch.PinnedDispatcherConfigurator
...
# PinnedDispatcherConfigurator[**](../../akka/dispatch/PinnedDispatcherConfigurator.html "Permalink")

### 

#### class PinnedDispatcherConfigurator extends [MessageDispatcherConfigurator](MessageDispatcherConfigurator.html)
...
1. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#<init>(config:com.typesafe.config.Config,prerequisites:akka.dispatch.DispatcherPrerequisites):akka.dispatch.PinnedDispatcherConfigurator "Permalink")  new PinnedDispatcherConfigurator(config: Config, prerequisites: [DispatcherPrerequisites](DispatcherPrerequisites.html))
### Value Members

1. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from PinnedDispatcherConfigurator toany2stringadd\[PinnedDispatcherConfigurator] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (PinnedDispatcherConfigurator, B)ImplicitThis member is added by an implicit conversion from PinnedDispatcherConfigurator toArrowAssoc\[PinnedDispatcherConfigurator] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#config:com.typesafe.config.Config "Permalink")  val config: ConfigDefinition Classes[MessageDispatcherConfigurator](MessageDispatcherConfigurator.html)
9. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#configureExecutor():akka.dispatch.ExecutorServiceConfigurator "Permalink")  def configureExecutor(): [ExecutorServiceConfigurator](ExecutorServiceConfigurator.html)Definition Classes[MessageDispatcherConfigurator](MessageDispatcherConfigurator.html)
10. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#dispatcher():akka.dispatch.MessageDispatcher "Permalink")  def dispatcher(): [MessageDispatcher](MessageDispatcher.html)Creates new dispatcher for each invocation.

Creates new dispatcher for each invocation.

Definition ClassesPinnedDispatcherConfigurator → [MessageDispatcherConfigurator](MessageDispatcherConfigurator.html)
11. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (PinnedDispatcherConfigurator) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): PinnedDispatcherConfiguratorImplicitThis member is added by an implicit conversion from PinnedDispatcherConfigurator toEnsuring\[PinnedDispatcherConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (PinnedDispatcherConfigurator) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): PinnedDispatcherConfiguratorImplicitThis member is added by an implicit conversion from PinnedDispatcherConfigurator toEnsuring\[PinnedDispatcherConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): PinnedDispatcherConfiguratorImplicitThis member is added by an implicit conversion from PinnedDispatcherConfigurator toEnsuring\[PinnedDispatcherConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): PinnedDispatcherConfiguratorImplicitThis member is added by an implicit conversion from PinnedDispatcherConfigurator toEnsuring\[PinnedDispatcherConfigurator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
16. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
17. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
20. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
21. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#prerequisites:akka.dispatch.DispatcherPrerequisites "Permalink")  val prerequisites: [DispatcherPrerequisites](DispatcherPrerequisites.html)Definition Classes[MessageDispatcherConfigurator](MessageDispatcherConfigurator.html)
24. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
25. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
26. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
27. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
28. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from PinnedDispatcherConfigurator toStringFormat\[PinnedDispatcherConfigurator] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/dispatch/PinnedDispatcherConfigurator.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (PinnedDispatcherConfigurator, B)ImplicitThis member is added by an implicit conversion from PinnedDispatcherConfigurator toArrowAssoc\[PinnedDispatcherConfigurator] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromPinnedDispatcherConfigurator to any2stringadd\[PinnedDispatcherConfigurator]

### Inherited by implicit conversion StringFormat fromPinnedDispatcherConfigurator to StringFormat\[PinnedDispatcherConfigurator]

### Inherited by implicit conversion Ensuring fromPinnedDispatcherConfigurator to Ensuring\[PinnedDispatcherConfigurator]

### Inherited by implicit conversion ArrowAssoc fromPinnedDispatcherConfigurator to ArrowAssoc\[PinnedDispatcherConfigurator]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/PinnedDispatcherConfigurator.html](https://doc.akka.io/api/akka-core/2.10.17/akka/dispatch/PinnedDispatcherConfigurator.html)*