---
description: Akka 2.10.17 - akka.routing.ConsistentHashingRoutingLogic
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:02:35Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/routing/ConsistentHashingRoutingLogic.html
title: Akka 2.10.17 - akka.routing.ConsistentHashingRoutingLogic
---

# Akka 2.10.17 - akka.routing.ConsistentHashingRoutingLogic

> **Summary:** Akka 2.10.17 - akka.routing.ConsistentHashingRoutingLogic
...
[c](ConsistentHashingRoutingLogic$.html "See companion object")[akka](../index.html).[routing](index.html)

# [ConsistentHashingRoutingLogic](ConsistentHashingRoutingLogic$.html "See companion object")[**](../../akka/routing/ConsistentHashingRoutingLogic.html "Permalink")

### Companion [object ConsistentHashingRoutingLogic](ConsistentHashingRoutingLogic$.html "See companion object")

#### final  case class ConsistentHashingRoutingLogic(system: [ActorSystem](../actor/ActorSystem.html), virtualNodesFactor: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int) \= 0, hashMapping: [ConsistentHashMapping](ConsistentHashingRouter$.html#ConsistentHashMapping=PartialFunction[Any,Any]) \= [ConsistentHashingRouter.emptyConsistentHashMapping](ConsistentHashingRouter$.html)) extends [RoutingLogic](RoutingLogic.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
...
1. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#<init>(system:akka.actor.ActorSystem):akka.routing.ConsistentHashingRoutingLogic "Permalink")  new ConsistentHashingRoutingLogic(system: [ActorSystem](../actor/ActorSystem.html))Java API

Java API

systemthe actor system hosting this router
2. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#<init>(system:akka.actor.ActorSystem,virtualNodesFactor:Int,hashMapping:akka.routing.ConsistentHashingRouter.ConsistentHashMapping):akka.routing.ConsistentHashingRoutingLogic "Permalink")  new ConsistentHashingRoutingLogic(system: [ActorSystem](../actor/ActorSystem.html), virtualNodesFactor: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int) \= 0, hashMapping: [ConsistentHashMapping](ConsistentHashingRouter$.html#ConsistentHashMapping=PartialFunction[Any,Any]) \= [ConsistentHashingRouter.emptyConsistentHashMapping](ConsistentHashingRouter$.html))systemthe actor system hosting this router
...
1. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/routing/ConsistentHashingRoutingLogic.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ConsistentHashingRoutingLogic toany2stringadd\[ConsistentHashingRoutingLogic] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ConsistentHashingRoutingLogic, B)ImplicitThis member is added by an implicit conversion from ConsistentHashingRoutingLogic toArrowAssoc\[ConsistentHashingRoutingLogic] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ConsistentHashingRoutingLogic) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ConsistentHashingRoutingLogicImplicitThis member is added by an implicit conversion from ConsistentHashingRoutingLogic toEnsuring\[ConsistentHashingRoutingLogic] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ConsistentHashingRoutingLogic) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ConsistentHashingRoutingLogicImplicitThis member is added by an implicit conversion from ConsistentHashingRoutingLogic toEnsuring\[ConsistentHashingRoutingLogic] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ConsistentHashingRoutingLogicImplicitThis member is added by an implicit conversion from ConsistentHashingRoutingLogic toEnsuring\[ConsistentHashingRoutingLogic] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ConsistentHashingRoutingLogicImplicitThis member is added by an implicit conversion from ConsistentHashingRoutingLogic toEnsuring\[ConsistentHashingRoutingLogic] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#hashMapping:akka.routing.ConsistentHashingRouter.ConsistentHashMapping "Permalink")  val hashMapping: [ConsistentHashMapping](ConsistentHashingRouter$.html#ConsistentHashMapping=PartialFunction[Any,Any])
15. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
16. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
20. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#select(message:Any,routees:IndexedSeq[akka.routing.Routee]):akka.routing.Routee "Permalink")  def select(message: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any), routees: [IndexedSeq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/IndexedSeq.html#scala.collection.immutable.IndexedSeq)\[[Routee](Routee.html)]): [Routee](Routee.html)Pick the destination for a given message.
...
Definition ClassesConsistentHashingRoutingLogic → [RoutingLogic](RoutingLogic.html)
21. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#system:akka.actor.ActorSystem "Permalink")  val system: [ActorSystem](../actor/ActorSystem.html)
23. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#virtualNodesFactor:Int "Permalink")  val virtualNodesFactor: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
24. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#vnodes:Int "Permalink")  val vnodes: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
25. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
27. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#withHashMapper(mapper:akka.routing.ConsistentHashingRouter.ConsistentHashMapper):akka.routing.ConsistentHashingRoutingLogic "Permalink")  def withHashMapper(mapper: [ConsistentHashMapper](ConsistentHashingRouter$$ConsistentHashMapper.html)): ConsistentHashingRoutingLogicJava API: Setting the mapping from message to the data to use for the consistent hash key.
29. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#withVirtualNodesFactor(vnodes:Int):akka.routing.ConsistentHashingRoutingLogic "Permalink")  def withVirtualNodesFactor(vnodes: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): ConsistentHashingRoutingLogicSetting the number of virtual nodes per node, used in [akka.routing.ConsistentHash](ConsistentHash.html)
### Deprecated Value Members

1. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ConsistentHashingRoutingLogic toStringFormat\[ConsistentHashingRoutingLogic] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/routing/ConsistentHashingRoutingLogic.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ConsistentHashingRoutingLogic, B)ImplicitThis member is added by an implicit conversion from ConsistentHashingRoutingLogic toArrowAssoc\[ConsistentHashingRoutingLogic] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromConsistentHashingRoutingLogic to any2stringadd\[ConsistentHashingRoutingLogic]

### Inherited by implicit conversion StringFormat fromConsistentHashingRoutingLogic to StringFormat\[ConsistentHashingRoutingLogic]

### Inherited by implicit conversion Ensuring fromConsistentHashingRoutingLogic to Ensuring\[ConsistentHashingRoutingLogic]

### Inherited by implicit conversion ArrowAssoc fromConsistentHashingRoutingLogic to ArrowAssoc\[ConsistentHashingRoutingLogic]
...
- https://doc.akka.io/api/akka-core/2.10.17/akka/routing/ConsistentHashingRouter$$ConsistentHashable.html
- https://doc.akka.io/api/akka-core/2.10.17/akka/routing/ConsistentHashingRouter$$ConsistentHashableEnvelope.html
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/routing/ConsistentHashingRoutingLogic.html](https://doc.akka.io/api/akka-core/2.10.17/akka/routing/ConsistentHashingRoutingLogic.html)*