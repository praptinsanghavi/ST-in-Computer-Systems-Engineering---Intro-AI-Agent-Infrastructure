---
description: Akka 2.10.17 - akka.routing.OptimalSizeExploringResizer
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:09:58Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/routing/OptimalSizeExploringResizer.html
title: Akka 2.10.17 - akka.routing.OptimalSizeExploringResizer
---

# Akka 2.10.17 - akka.routing.OptimalSizeExploringResizer

> **Summary:** Akka 2.10.17 - akka.routing.OptimalSizeExploringResizer
...
[t](OptimalSizeExploringResizer$.html "See companion object")[akka](../index.html).[routing](index.html)

# [OptimalSizeExploringResizer](OptimalSizeExploringResizer$.html "See companion object")[**](../../akka/routing/OptimalSizeExploringResizer.html "Permalink")

### Companion [object OptimalSizeExploringResizer](OptimalSizeExploringResizer$.html "See companion object")

#### trait OptimalSizeExploringResizer extends [Resizer](Resizer.html)

Source[OptimalSizeExploringResizer.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/routing/OptimalSizeExploringResizer.scala#L20)Linear Supertypes[Resizer](Resizer.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[DefaultOptimalSizeExploringResizer](DefaultOptimalSizeExploringResizer.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. OptimalSizeExploringResizer
2. Resizer
3. AnyRef
4. Any
Implicitly  
...
1. [**](../../akka/routing/OptimalSizeExploringResizer.html#isTimeForResize(messageCounter:Long):Boolean "Permalink") abstract  def isTimeForResize(messageCounter: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Is it time for resizing.
...
Definition Classes[Resizer](Resizer.html)
2. [**](../../akka/routing/OptimalSizeExploringResizer.html#reportMessageCount(currentRoutees:IndexedSeq[akka.routing.Routee],messageCounter:Long):Unit "Permalink") abstract  def reportMessageCount(currentRoutees: [IndexedSeq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/IndexedSeq.html#scala.collection.immutable.IndexedSeq)\[[Routee](Routee.html)], messageCounter: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Report the messageCount as well as current routees so that the
...
1. [**](../../akka/routing/OptimalSizeExploringResizer.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/routing/OptimalSizeExploringResizer.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/routing/OptimalSizeExploringResizer.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from OptimalSizeExploringResizer toany2stringadd\[OptimalSizeExploringResizer] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/routing/OptimalSizeExploringResizer.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (OptimalSizeExploringResizer, B)ImplicitThis member is added by an implicit conversion from OptimalSizeExploringResizer toArrowAssoc\[OptimalSizeExploringResizer] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/routing/OptimalSizeExploringResizer.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/routing/OptimalSizeExploringResizer.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/routing/OptimalSizeExploringResizer.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/routing/OptimalSizeExploringResizer.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (OptimalSizeExploringResizer) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): OptimalSizeExploringResizerImplicitThis member is added by an implicit conversion from OptimalSizeExploringResizer toEnsuring\[OptimalSizeExploringResizer] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/routing/OptimalSizeExploringResizer.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (OptimalSizeExploringResizer) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): OptimalSizeExploringResizerImplicitThis member is added by an implicit conversion from OptimalSizeExploringResizer toEnsuring\[OptimalSizeExploringResizer] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/routing/OptimalSizeExploringResizer.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): OptimalSizeExploringResizerImplicitThis member is added by an implicit conversion from OptimalSizeExploringResizer toEnsuring\[OptimalSizeExploringResizer] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/routing/OptimalSizeExploringResizer.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): OptimalSizeExploringResizerImplicitThis member is added by an implicit conversion from OptimalSizeExploringResizer toEnsuring\[OptimalSizeExploringResizer] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/routing/OptimalSizeExploringResizer.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/routing/OptimalSizeExploringResizer.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/routing/OptimalSizeExploringResizer.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/routing/OptimalSizeExploringResizer.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/routing/OptimalSizeExploringResizer.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/routing/OptimalSizeExploringResizer.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/routing/OptimalSizeExploringResizer.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/routing/OptimalSizeExploringResizer.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/routing/OptimalSizeExploringResizer.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/routing/OptimalSizeExploringResizer.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/routing/OptimalSizeExploringResizer.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/routing/OptimalSizeExploringResizer.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/routing/OptimalSizeExploringResizer.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/routing/OptimalSizeExploringResizer.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/routing/OptimalSizeExploringResizer.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from OptimalSizeExploringResizer toStringFormat\[OptimalSizeExploringResizer] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/routing/OptimalSizeExploringResizer.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (OptimalSizeExploringResizer, B)ImplicitThis member is added by an implicit conversion from OptimalSizeExploringResizer toArrowAssoc\[OptimalSizeExploringResizer] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromOptimalSizeExploringResizer to any2stringadd\[OptimalSizeExploringResizer]

### Inherited by implicit conversion StringFormat fromOptimalSizeExploringResizer to StringFormat\[OptimalSizeExploringResizer]

### Inherited by implicit conversion Ensuring fromOptimalSizeExploringResizer to Ensuring\[OptimalSizeExploringResizer]

### Inherited by implicit conversion ArrowAssoc fromOptimalSizeExploringResizer to ArrowAssoc\[OptimalSizeExploringResizer]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/routing/OptimalSizeExploringResizer.html](https://doc.akka.io/api/akka-core/2.10.17/akka/routing/OptimalSizeExploringResizer.html)*