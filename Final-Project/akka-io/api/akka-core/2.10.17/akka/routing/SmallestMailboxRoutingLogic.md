---
description: Akka 2.10.17 - akka.routing.SmallestMailboxRoutingLogic
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:02:39Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/routing/SmallestMailboxRoutingLogic.html
title: Akka 2.10.17 - akka.routing.SmallestMailboxRoutingLogic
---

# Akka 2.10.17 - akka.routing.SmallestMailboxRoutingLogic

> **Summary:** Akka 2.10.17 - akka.routing.SmallestMailboxRoutingLogic
...
[c](SmallestMailboxRoutingLogic$.html "See companion object")[akka](../index.html).[routing](index.html)

# [SmallestMailboxRoutingLogic](SmallestMailboxRoutingLogic$.html "See companion object")[**](../../akka/routing/SmallestMailboxRoutingLogic.html "Permalink")

### Companion [object SmallestMailboxRoutingLogic](SmallestMailboxRoutingLogic$.html "See companion object")

#### class SmallestMailboxRoutingLogic extends [RoutingLogic](RoutingLogic.html)
...
Annotations@nowarn() @SerialVersionUID() Source[SmallestMailbox.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/routing/SmallestMailbox.scala#L38)Linear Supertypes[RoutingLogic](RoutingLogic.html), [NoSerializationVerificationNeeded](../actor/NoSerializationVerificationNeeded.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#<init>():akka.routing.SmallestMailboxRoutingLogic "Permalink")  new SmallestMailboxRoutingLogic()
### Value Members

1. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/routing/SmallestMailboxRoutingLogic.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from SmallestMailboxRoutingLogic toany2stringadd\[SmallestMailboxRoutingLogic] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (SmallestMailboxRoutingLogic, B)ImplicitThis member is added by an implicit conversion from SmallestMailboxRoutingLogic toArrowAssoc\[SmallestMailboxRoutingLogic] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (SmallestMailboxRoutingLogic) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SmallestMailboxRoutingLogicImplicitThis member is added by an implicit conversion from SmallestMailboxRoutingLogic toEnsuring\[SmallestMailboxRoutingLogic] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (SmallestMailboxRoutingLogic) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SmallestMailboxRoutingLogicImplicitThis member is added by an implicit conversion from SmallestMailboxRoutingLogic toEnsuring\[SmallestMailboxRoutingLogic] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SmallestMailboxRoutingLogicImplicitThis member is added by an implicit conversion from SmallestMailboxRoutingLogic toEnsuring\[SmallestMailboxRoutingLogic] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SmallestMailboxRoutingLogicImplicitThis member is added by an implicit conversion from SmallestMailboxRoutingLogic toEnsuring\[SmallestMailboxRoutingLogic] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#hasMessages(a:akka.routing.Routee):Boolean "Permalink")  def hasMessages(a: [Routee](Routee.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Returns true if the actor currently has any pending messages
in the mailbox, i.e.
...
Attributesprotected
16. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
18. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#isProcessingMessage(a:akka.routing.Routee):Boolean "Permalink")  def isProcessingMessage(a: [Routee](Routee.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Returns true if the actor is currently processing a message.
...
Attributesprotected
19. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#isSuspended(a:akka.routing.Routee):Boolean "Permalink")  def isSuspended(a: [Routee](Routee.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Returns true if the actor is currently suspended.
...
Attributesprotected
20. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#isTerminated(a:akka.routing.Routee):Boolean "Permalink")  def isTerminated(a: [Routee](Routee.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Attributesprotected
21. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
22. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#numberOfMessages(a:akka.routing.Routee):Int "Permalink")  def numberOfMessages(a: [Routee](Routee.html)): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Returns the number of pending messages in the mailbox of the actor.
...
Definition ClassesSmallestMailboxRoutingLogic → [RoutingLogic](RoutingLogic.html)
26. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
27. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
28. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
29. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
30. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from SmallestMailboxRoutingLogic toStringFormat\[SmallestMailboxRoutingLogic] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/routing/SmallestMailboxRoutingLogic.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (SmallestMailboxRoutingLogic, B)ImplicitThis member is added by an implicit conversion from SmallestMailboxRoutingLogic toArrowAssoc\[SmallestMailboxRoutingLogic] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromSmallestMailboxRoutingLogic to any2stringadd\[SmallestMailboxRoutingLogic]

### Inherited by implicit conversion StringFormat fromSmallestMailboxRoutingLogic to StringFormat\[SmallestMailboxRoutingLogic]

### Inherited by implicit conversion Ensuring fromSmallestMailboxRoutingLogic to Ensuring\[SmallestMailboxRoutingLogic]

### Inherited by implicit conversion ArrowAssoc fromSmallestMailboxRoutingLogic to ArrowAssoc\[SmallestMailboxRoutingLogic]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/routing/SmallestMailboxRoutingLogic.html](https://doc.akka.io/api/akka-core/2.10.17/akka/routing/SmallestMailboxRoutingLogic.html)*