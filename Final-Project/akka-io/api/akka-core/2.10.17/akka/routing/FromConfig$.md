...
scraped_at: '2026-04-06T15:09:35Z'
section: api
site: akka-io
...
[o](FromConfig.html "See companion class")[akka](../index.html).[routing](index.html)

# [FromConfig](FromConfig.html "See companion class")[**](../../akka/routing/FromConfig$.html "Permalink")

### Companion [class FromConfig](FromConfig.html "See companion class")

#### case object FromConfig extends [FromConfig](FromConfig.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
...
Source[RouterConfig.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/routing/RouterConfig.scala#L271)Linear Supertypes[Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.17/scala/Equals.html#scala.Equals), [FromConfig](FromConfig.html), [Pool](Pool.html), [RouterConfig](RouterConfig.html), [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. FromConfig
2. Product
...
3. [**](../../akka/routing/FromConfig$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/routing/FromConfig$.html#apply(resizer:Option[akka.routing.Resizer],supervisorStrategy:akka.actor.SupervisorStrategy,routerDispatcher:String):akka.routing.FromConfig "Permalink") final  def apply(resizer: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Resizer](Resizer.html)] \= None, supervisorStrategy: [SupervisorStrategy](../actor/SupervisorStrategy.html) \= [Pool.defaultSupervisorStrategy](Pool$.html), routerDispatcher: String \= [Dispatchers.DefaultDispatcherId](../index.html)): [FromConfig](FromConfig.html)Annotations@inline()
5. [**](../../akka/routing/FromConfig$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
6. [**](../../akka/routing/FromConfig$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
7. [**](../../akka/routing/FromConfig$.html#createRouter(system:akka.actor.ActorSystem):akka.routing.Router "Permalink")  def createRouter(system: [ActorSystem](../actor/ActorSystem.html)): [Router](Router.html)Create the actual router, responsible for routing messages to routees.

Create the actual router, responsible for routing messages to routees.

systemthe ActorSystem this router belongs to

Definition Classes[FromConfig](FromConfig.html) → [RouterConfig](RouterConfig.html)
8. [**](../../akka/routing/FromConfig$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
9. [**](../../akka/routing/FromConfig$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
10. [**](../../akka/routing/FromConfig$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
11. [**](../../akka/routing/FromConfig$.html#getInstance:akka.routing.FromConfig.type "Permalink")  def getInstance: FromConfigJava API: get the singleton instance
12. [**](../../akka/routing/FromConfig$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
13. [**](../../akka/routing/FromConfig$.html#isManagementMessage(msg:Any):Boolean "Permalink")  def isManagementMessage(msg: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Is the message handled by the router head actor or the
...
14. [**](../../akka/routing/FromConfig$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../akka/routing/FromConfig$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/routing/FromConfig$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/routing/FromConfig$.html#nrOfInstances(sys:akka.actor.ActorSystem):Int "Permalink")  def nrOfInstances(sys: [ActorSystem](../actor/ActorSystem.html)): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Initial number of routee instances

Initial number of routee instances

Definition Classes[FromConfig](FromConfig.html) → [Pool](Pool.html)
18. [**](../../akka/routing/FromConfig$.html#productElementName(n:Int):String "Permalink")  def productElementName(n: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): StringDefinition ClassesProduct
19. [**](../../akka/routing/FromConfig$.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
20. [**](../../akka/routing/FromConfig$.html#props():akka.actor.Props "Permalink")  def props(): [Props](../actor/Props.html)[akka.actor.Props](../actor/Props.html) for a group router based on the settings defined by
this instance.

[akka.actor.Props](../actor/Props.html) for a group router based on the settings defined by
this instance.

Definition Classes[FromConfig](FromConfig.html)
21. [**](../../akka/routing/FromConfig$.html#props(routeeProps:akka.actor.Props):akka.actor.Props "Permalink")  def props(routeeProps: [Props](../actor/Props.html)): [Props](../actor/Props.html)[akka.actor.Props](../actor/Props.html) for a pool router based on the settings defined by
...
22. [**](../../akka/routing/FromConfig$.html#resizer:Option[akka.routing.Resizer] "Permalink")  val resizer: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Resizer](Resizer.html)]Pool with dynamically resizable number of routees return the [akka.routing.Resizer](Resizer.html)
to use.
...
Definition Classes[FromConfig](FromConfig.html) → [Pool](Pool.html)
23. [**](../../akka/routing/FromConfig$.html#routerDispatcher:String "Permalink")  val routerDispatcher: StringDispatcher ID to use for running the “head” actor, which handles
...
Definition Classes[RouterConfig](RouterConfig.html)
25. [**](../../akka/routing/FromConfig$.html#stopRouterWhenAllRouteesRemoved:Boolean "Permalink")  def stopRouterWhenAllRouteesRemoved: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition Classes[Pool](Pool.html) → [RouterConfig](RouterConfig.html)
26. [**](../../akka/routing/FromConfig$.html#supervisorStrategy:akka.actor.SupervisorStrategy "Permalink")  val supervisorStrategy: [SupervisorStrategy](../actor/SupervisorStrategy.html)SupervisorStrategy for the head actor, i.e.

SupervisorStrategy for the head actor, i.e. for supervising the routees of the pool.

Definition Classes[FromConfig](FromConfig.html) → [Pool](Pool.html)
27. [**](../../akka/routing/FromConfig$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
28. [**](../../akka/routing/FromConfig$.html#unapply(fc:akka.routing.FromConfig):Option[String] "Permalink") final  def unapply(fc: [FromConfig](FromConfig.html)): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[String]Annotations@inline()
29. [**](../../akka/routing/FromConfig$.html#usePoolDispatcher:Boolean "Permalink")  def usePoolDispatcher: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Use a dedicated dispatcher for the routees of the pool.
...
Definition Classes[Pool](Pool.html)
30. [**](../../akka/routing/FromConfig$.html#verifyConfig(path:akka.actor.ActorPath):Unit "Permalink")  def verifyConfig(path: [ActorPath](../actor/ActorPath.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Check that everything is there which is needed.

Check that everything is there which is needed. Called in constructor of RoutedActorRef to fail early.

Definition Classes[FromConfig](FromConfig.html) → [RouterConfig](RouterConfig.html)
31. [**](../../akka/routing/FromConfig$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
32. [**](../../akka/routing/FromConfig$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
33. [**](../../akka/routing/FromConfig$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
34. [**](../../akka/routing/FromConfig$.html#withDispatcher(dispatcherId:String):akka.routing.FromConfig "Permalink")  def withDispatcher(dispatcherId: String): [FromConfig](FromConfig.html)Setting the dispatcher to be used for the router head actor, which handles
supervision, death watch and router management messages.
...
Definition Classes[FromConfig](FromConfig.html)
35. [**](../../akka/routing/FromConfig$.html#withFallback(other:akka.routing.RouterConfig):akka.routing.RouterConfig "Permalink")  def withFallback(other: [RouterConfig](RouterConfig.html)): [RouterConfig](RouterConfig.html)Overridable merge strategy, by default completely prefers `this` (i.e.

Overridable merge strategy, by default completely prefers `this` (i.e. no merge).

Definition Classes[RouterConfig](RouterConfig.html)
36. [**](../../akka/routing/FromConfig$.html#withResizer(resizer:akka.routing.Resizer):akka.routing.FromConfig "Permalink")  def withResizer(resizer: [Resizer](Resizer.html)): [FromConfig](FromConfig.html)Setting the resizer to be used.

Setting the resizer to be used.

Definition Classes[FromConfig](FromConfig.html)
37. [**](../../akka/routing/FromConfig$.html#withSupervisorStrategy(strategy:akka.actor.SupervisorStrategy):akka.routing.FromConfig "Permalink")  def withSupervisorStrategy(strategy: [SupervisorStrategy](../actor/SupervisorStrategy.html)): [FromConfig](FromConfig.html)Setting the supervisor strategy to be used for the “head” Router actor.
...
### Inherited from [FromConfig](FromConfig.html)
