---
description: Akka 2.10.17 - akka.routing.ScatterGatherFirstCompletedPool
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:10:24Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/routing/ScatterGatherFirstCompletedPool.html
title: Akka 2.10.17 - akka.routing.ScatterGatherFirstCompletedPool
---

# Akka 2.10.17 - akka.routing.ScatterGatherFirstCompletedPool

> **Summary:** Akka 2.10.17 - akka.routing.ScatterGatherFirstCompletedPool
...
[\#withSupervisorStrategy](#withSupervisorStrategy(strategy:akka.actor.SupervisorStrategy):akka.routing.ScatterGatherFirstCompletedPool). If no strategy is provided, routers default to
...
1. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#<init>(nr:Int,within:java.time.Duration):akka.routing.ScatterGatherFirstCompletedPool "Permalink")  new ScatterGatherFirstCompletedPool(nr: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), within: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration))Java API
...
withinexpecting at least one reply within this duration, otherwise
 it will reply with [akka.pattern.AskTimeoutException](../pattern/AskTimeoutException.html) in a [akka.actor.Status.Failure](../actor/Status$$Failure.html)
2. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#<init>(nr:Int,within:scala.concurrent.duration.FiniteDuration):akka.routing.ScatterGatherFirstCompletedPool "Permalink")  new ScatterGatherFirstCompletedPool(nr: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), within: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration))Java API
...
withinexpecting at least one reply within this duration, otherwise
 it will reply with [akka.pattern.AskTimeoutException](../pattern/AskTimeoutException.html) in a [akka.actor.Status.Failure](../actor/Status$$Failure.html)
3. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#<init>(config:com.typesafe.config.Config):akka.routing.ScatterGatherFirstCompletedPool "Permalink")  new ScatterGatherFirstCompletedPool(config: Config)
4. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#<init>(nrOfInstances:Int,resizer:Option[akka.routing.Resizer],within:scala.concurrent.duration.FiniteDuration,supervisorStrategy:akka.actor.SupervisorStrategy,routerDispatcher:String,usePoolDispatcher:Boolean):akka.routing.ScatterGatherFirstCompletedPool "Permalink")  new ScatterGatherFirstCompletedPool(nrOfInstances: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), resizer: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Resizer](Resizer.html)] \= None, within: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), supervisorStrategy: [SupervisorStrategy](../actor/SupervisorStrategy.html) \= [Pool.defaultSupervisorStrategy](Pool$.html), routerDispatcher: String \= [Dispatchers.DefaultDispatcherId](../index.html), usePoolDispatcher: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean) \= false)nrOfInstancesinitial number of routees in the pool
...
1. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ScatterGatherFirstCompletedPool toany2stringadd\[ScatterGatherFirstCompletedPool] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ScatterGatherFirstCompletedPool, B)ImplicitThis member is added by an implicit conversion from ScatterGatherFirstCompletedPool toArrowAssoc\[ScatterGatherFirstCompletedPool] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#createRouter(system:akka.actor.ActorSystem):akka.routing.Router "Permalink")  def createRouter(system: [ActorSystem](../actor/ActorSystem.html)): [Router](Router.html)Create the actual router, responsible for routing messages to routees.

Create the actual router, responsible for routing messages to routees.

systemthe ActorSystem this router belongs to

Definition ClassesScatterGatherFirstCompletedPool → [RouterConfig](RouterConfig.html)
9. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ScatterGatherFirstCompletedPool) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ScatterGatherFirstCompletedPoolImplicitThis member is added by an implicit conversion from ScatterGatherFirstCompletedPool toEnsuring\[ScatterGatherFirstCompletedPool] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ScatterGatherFirstCompletedPool) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ScatterGatherFirstCompletedPoolImplicitThis member is added by an implicit conversion from ScatterGatherFirstCompletedPool toEnsuring\[ScatterGatherFirstCompletedPool] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ScatterGatherFirstCompletedPoolImplicitThis member is added by an implicit conversion from ScatterGatherFirstCompletedPool toEnsuring\[ScatterGatherFirstCompletedPool] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ScatterGatherFirstCompletedPoolImplicitThis member is added by an implicit conversion from ScatterGatherFirstCompletedPool toEnsuring\[ScatterGatherFirstCompletedPool] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
16. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#isManagementMessage(msg:Any):Boolean "Permalink")  def isManagementMessage(msg: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Is the message handled by the router head actor or the
...
17. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#nrOfInstances(sys:akka.actor.ActorSystem):Int "Permalink")  def nrOfInstances(sys: [ActorSystem](../actor/ActorSystem.html)): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesScatterGatherFirstCompletedPool → [Pool](Pool.html)
21. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#nrOfInstances:Int "Permalink")  val nrOfInstances: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
22. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#overrideUnsetConfig(other:akka.routing.RouterConfig):akka.routing.RouterConfig "Permalink") final  def overrideUnsetConfig(other: [RouterConfig](RouterConfig.html)): [RouterConfig](RouterConfig.html)Definition ClassesPoolOverrideUnsetConfig
23. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
24. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#props(routeeProps:akka.actor.Props):akka.actor.Props "Permalink")  def props(routeeProps: [Props](../actor/Props.html)): [Props](../actor/Props.html)[akka.actor.Props](../actor/Props.html) for a pool router based on the settings defined by
...
25. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#resizer:Option[akka.routing.Resizer] "Permalink")  val resizer: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Resizer](Resizer.html)]Pool with dynamically resizable number of routees return the [akka.routing.Resizer](Resizer.html)
to use.
...
Definition ClassesScatterGatherFirstCompletedPool → [Pool](Pool.html)
26. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#routerDispatcher:String "Permalink")  val routerDispatcher: StringDispatcher ID to use for running the “head” actor, which handles
supervision, death watch and router management messages
...
Definition Classes[RouterConfig](RouterConfig.html)
28. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#stopRouterWhenAllRouteesRemoved:Boolean "Permalink")  def stopRouterWhenAllRouteesRemoved: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition Classes[Pool](Pool.html) → [RouterConfig](RouterConfig.html)
29. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#supervisorStrategy:akka.actor.SupervisorStrategy "Permalink")  val supervisorStrategy: [SupervisorStrategy](../actor/SupervisorStrategy.html)SupervisorStrategy for the head actor, i.e.

SupervisorStrategy for the head actor, i.e. for supervising the routees of the pool.

Definition ClassesScatterGatherFirstCompletedPool → [Pool](Pool.html)
30. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
31. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#usePoolDispatcher:Boolean "Permalink")  val usePoolDispatcher: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Use a dedicated dispatcher for the routees of the pool.
...
Definition ClassesScatterGatherFirstCompletedPool → [Pool](Pool.html)
32. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#verifyConfig(path:akka.actor.ActorPath):Unit "Permalink")  def verifyConfig(path: [ActorPath](../actor/ActorPath.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Check that everything is there which is needed.

Check that everything is there which is needed. Called in constructor of RoutedActorRef to fail early.

Definition Classes[RouterConfig](RouterConfig.html)
33. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
34. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
35. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
36. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#withDispatcher(dispatcherId:String):akka.routing.ScatterGatherFirstCompletedPool "Permalink")  def withDispatcher(dispatcherId: String): ScatterGatherFirstCompletedPoolSetting the dispatcher to be used for the router head actor, which handles
supervision, death watch and router management messages.
37. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#withFallback(other:akka.routing.RouterConfig):akka.routing.RouterConfig "Permalink")  def withFallback(other: [RouterConfig](RouterConfig.html)): [RouterConfig](RouterConfig.html)Uses the resizer and/or the supervisor strategy of the given RouterConfig
...
Definition ClassesScatterGatherFirstCompletedPool → [RouterConfig](RouterConfig.html)
38. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#withResizer(resizer:akka.routing.Resizer):akka.routing.ScatterGatherFirstCompletedPool "Permalink")  def withResizer(resizer: [Resizer](Resizer.html)): ScatterGatherFirstCompletedPoolSetting the resizer to be used.

Setting the resizer to be used.

Definition ClassesScatterGatherFirstCompletedPool → PoolOverrideUnsetConfig
39. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#withSupervisorStrategy(strategy:akka.actor.SupervisorStrategy):akka.routing.ScatterGatherFirstCompletedPool "Permalink")  def withSupervisorStrategy(strategy: [SupervisorStrategy](../actor/SupervisorStrategy.html)): ScatterGatherFirstCompletedPoolSetting the supervisor strategy to be used for the “head” Router actor.

Setting the supervisor strategy to be used for the “head” Router actor.

Definition ClassesScatterGatherFirstCompletedPool → PoolOverrideUnsetConfig
40. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#within:scala.concurrent.duration.FiniteDuration "Permalink")  val within: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)
### Deprecated Value Members

1. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ScatterGatherFirstCompletedPool toStringFormat\[ScatterGatherFirstCompletedPool] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/routing/ScatterGatherFirstCompletedPool.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ScatterGatherFirstCompletedPool, B)ImplicitThis member is added by an implicit conversion from ScatterGatherFirstCompletedPool toArrowAssoc\[ScatterGatherFirstCompletedPool] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product)

### Inherited from [Equals](https://www.scala-lang.org/api/2.13.17/scala/Equals.html#scala.Equals)

### Inherited from PoolOverrideUnsetConfig\[ScatterGatherFirstCompletedPool]
...
### Inherited by implicit conversion any2stringadd fromScatterGatherFirstCompletedPool to any2stringadd\[ScatterGatherFirstCompletedPool]

### Inherited by implicit conversion StringFormat fromScatterGatherFirstCompletedPool to StringFormat\[ScatterGatherFirstCompletedPool]

### Inherited by implicit conversion Ensuring fromScatterGatherFirstCompletedPool to Ensuring\[ScatterGatherFirstCompletedPool]

### Inherited by implicit conversion ArrowAssoc fromScatterGatherFirstCompletedPool to ArrowAssoc\[ScatterGatherFirstCompletedPool]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/routing/ScatterGatherFirstCompletedPool.html](https://doc.akka.io/api/akka-core/2.10.17/akka/routing/ScatterGatherFirstCompletedPool.html)*