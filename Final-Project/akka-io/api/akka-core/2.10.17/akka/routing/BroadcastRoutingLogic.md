---
description: Akka 2.10.17 - akka.routing.BroadcastRoutingLogic
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:02:32Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/routing/BroadcastRoutingLogic.html
title: Akka 2.10.17 - akka.routing.BroadcastRoutingLogic
---

# Akka 2.10.17 - akka.routing.BroadcastRoutingLogic

> **Summary:** Akka 2.10.17 - akka.routing.BroadcastRoutingLogic
...
[c](BroadcastRoutingLogic$.html "See companion object")[akka](../index.html).[routing](index.html)

# [BroadcastRoutingLogic](BroadcastRoutingLogic$.html "See companion object")[**](../../akka/routing/BroadcastRoutingLogic.html "Permalink")

### Companion [object BroadcastRoutingLogic](BroadcastRoutingLogic$.html "See companion object")

#### final  class BroadcastRoutingLogic extends [RoutingLogic](RoutingLogic.html)

Broadcasts a message to all its routees.

Annotations@nowarn() @SerialVersionUID() Source[Broadcast.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/routing/Broadcast.scala#L26)Linear Supertypes[RoutingLogic](RoutingLogic.html), [NoSerializationVerificationNeeded](../actor/NoSerializationVerificationNeeded.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/routing/BroadcastRoutingLogic.html#<init>():akka.routing.BroadcastRoutingLogic "Permalink")  new BroadcastRoutingLogic()
### Value Members

1. [**](../../akka/routing/BroadcastRoutingLogic.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/routing/BroadcastRoutingLogic.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/routing/BroadcastRoutingLogic.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from BroadcastRoutingLogic toany2stringadd\[BroadcastRoutingLogic] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/routing/BroadcastRoutingLogic.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (BroadcastRoutingLogic, B)ImplicitThis member is added by an implicit conversion from BroadcastRoutingLogic toArrowAssoc\[BroadcastRoutingLogic] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/routing/BroadcastRoutingLogic.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/routing/BroadcastRoutingLogic.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/routing/BroadcastRoutingLogic.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/routing/BroadcastRoutingLogic.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (BroadcastRoutingLogic) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BroadcastRoutingLogicImplicitThis member is added by an implicit conversion from BroadcastRoutingLogic toEnsuring\[BroadcastRoutingLogic] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/routing/BroadcastRoutingLogic.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (BroadcastRoutingLogic) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BroadcastRoutingLogicImplicitThis member is added by an implicit conversion from BroadcastRoutingLogic toEnsuring\[BroadcastRoutingLogic] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/routing/BroadcastRoutingLogic.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BroadcastRoutingLogicImplicitThis member is added by an implicit conversion from BroadcastRoutingLogic toEnsuring\[BroadcastRoutingLogic] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/routing/BroadcastRoutingLogic.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BroadcastRoutingLogicImplicitThis member is added by an implicit conversion from BroadcastRoutingLogic toEnsuring\[BroadcastRoutingLogic] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/routing/BroadcastRoutingLogic.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/routing/BroadcastRoutingLogic.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/routing/BroadcastRoutingLogic.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/routing/BroadcastRoutingLogic.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/routing/BroadcastRoutingLogic.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/routing/BroadcastRoutingLogic.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/routing/BroadcastRoutingLogic.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/routing/BroadcastRoutingLogic.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/routing/BroadcastRoutingLogic.html#select(message:Any,routees:IndexedSeq[akka.routing.Routee]):akka.routing.Routee "Permalink")  def select(message: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any), routees: [IndexedSeq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/IndexedSeq.html#scala.collection.immutable.IndexedSeq)\[[Routee](Routee.html)]): [Routee](Routee.html)Pick the destination for a given message.
...
Definition ClassesBroadcastRoutingLogic → [RoutingLogic](RoutingLogic.html)
21. [**](../../akka/routing/BroadcastRoutingLogic.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../akka/routing/BroadcastRoutingLogic.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
23. [**](../../akka/routing/BroadcastRoutingLogic.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../akka/routing/BroadcastRoutingLogic.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../akka/routing/BroadcastRoutingLogic.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/routing/BroadcastRoutingLogic.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/routing/BroadcastRoutingLogic.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from BroadcastRoutingLogic toStringFormat\[BroadcastRoutingLogic] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/routing/BroadcastRoutingLogic.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (BroadcastRoutingLogic, B)ImplicitThis member is added by an implicit conversion from BroadcastRoutingLogic toArrowAssoc\[BroadcastRoutingLogic] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromBroadcastRoutingLogic to any2stringadd\[BroadcastRoutingLogic]

### Inherited by implicit conversion StringFormat fromBroadcastRoutingLogic to StringFormat\[BroadcastRoutingLogic]

### Inherited by implicit conversion Ensuring fromBroadcastRoutingLogic to Ensuring\[BroadcastRoutingLogic]

### Inherited by implicit conversion ArrowAssoc fromBroadcastRoutingLogic to ArrowAssoc\[BroadcastRoutingLogic]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/routing/BroadcastRoutingLogic.html](https://doc.akka.io/api/akka-core/2.10.17/akka/routing/BroadcastRoutingLogic.html)*