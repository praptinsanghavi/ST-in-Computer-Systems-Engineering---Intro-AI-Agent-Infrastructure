---
description: Akka 2.10.17 - akka.routing.BroadcastGroup
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:09:09Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/routing/BroadcastGroup.html
title: Akka 2.10.17 - akka.routing.BroadcastGroup
---

# Akka 2.10.17 - akka.routing.BroadcastGroup

> **Summary:** Akka 2.10.17 - akka.routing.BroadcastGroup
...
# BroadcastGroup[**](../../akka/routing/BroadcastGroup.html "Permalink")

### 

#### final  case class BroadcastGroup(paths: [Iterable](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Iterable.html#scala.collection.immutable.Iterable)\[String], routerDispatcher: String \= [Dispatchers.DefaultDispatcherId](../index.html)) extends [Group](Group.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
...
Annotations@SerialVersionUID() Source[Broadcast.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/routing/Broadcast.scala#L127)Linear Supertypes[Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.17/scala/Equals.html#scala.Equals), [Group](Group.html), [RouterConfig](RouterConfig.html), [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. BroadcastGroup
2. Product
...
1. [**](../../akka/routing/BroadcastGroup.html#<init>(routeePaths:Iterable[String]):akka.routing.BroadcastGroup "Permalink")  new BroadcastGroup(routeePaths: [Iterable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Iterable.html#java.lang.Iterable)\[String])Java API

Java API

routeePathsstring representation of the actor paths of the routees, messages are
 sent with [akka.actor.ActorSelection](../actor/ActorSelection.html) to these paths
2. [**](../../akka/routing/BroadcastGroup.html#<init>(config:com.typesafe.config.Config):akka.routing.BroadcastGroup "Permalink")  new BroadcastGroup(config: Config)
3. [**](../../akka/routing/BroadcastGroup.html#<init>(paths:scala.collection.immutable.Iterable[String],routerDispatcher:String):akka.routing.BroadcastGroup "Permalink")  new BroadcastGroup(paths: [Iterable](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Iterable.html#scala.collection.immutable.Iterable)\[String], routerDispatcher: String \= [Dispatchers.DefaultDispatcherId](../index.html))pathsstring representation of the actor paths of the routees, messages are
 sent with [akka.actor.ActorSelection](../actor/ActorSelection.html) to these paths
...
1. [**](../../akka/routing/BroadcastGroup.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/routing/BroadcastGroup.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/routing/BroadcastGroup.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from BroadcastGroup toany2stringadd\[BroadcastGroup] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/routing/BroadcastGroup.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (BroadcastGroup, B)ImplicitThis member is added by an implicit conversion from BroadcastGroup toArrowAssoc\[BroadcastGroup] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/routing/BroadcastGroup.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/routing/BroadcastGroup.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/routing/BroadcastGroup.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/routing/BroadcastGroup.html#createRouter(system:akka.actor.ActorSystem):akka.routing.Router "Permalink")  def createRouter(system: [ActorSystem](../actor/ActorSystem.html)): [Router](Router.html)Create the actual router, responsible for routing messages to routees.

Create the actual router, responsible for routing messages to routees.

systemthe ActorSystem this router belongs to

Definition ClassesBroadcastGroup → [RouterConfig](RouterConfig.html)
9. [**](../../akka/routing/BroadcastGroup.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (BroadcastGroup) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BroadcastGroupImplicitThis member is added by an implicit conversion from BroadcastGroup toEnsuring\[BroadcastGroup] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/routing/BroadcastGroup.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (BroadcastGroup) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BroadcastGroupImplicitThis member is added by an implicit conversion from BroadcastGroup toEnsuring\[BroadcastGroup] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/routing/BroadcastGroup.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BroadcastGroupImplicitThis member is added by an implicit conversion from BroadcastGroup toEnsuring\[BroadcastGroup] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/routing/BroadcastGroup.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BroadcastGroupImplicitThis member is added by an implicit conversion from BroadcastGroup toEnsuring\[BroadcastGroup] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/routing/BroadcastGroup.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/routing/BroadcastGroup.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/routing/BroadcastGroup.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
16. [**](../../akka/routing/BroadcastGroup.html#isManagementMessage(msg:Any):Boolean "Permalink")  def isManagementMessage(msg: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Is the message handled by the router head actor or the
...
17. [**](../../akka/routing/BroadcastGroup.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/routing/BroadcastGroup.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/routing/BroadcastGroup.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/routing/BroadcastGroup.html#paths(system:akka.actor.ActorSystem):scala.collection.immutable.Iterable[String] "Permalink")  def paths(system: [ActorSystem](../actor/ActorSystem.html)): [Iterable](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Iterable.html#scala.collection.immutable.Iterable)\[String]Definition ClassesBroadcastGroup → [Group](Group.html)
21. [**](../../akka/routing/BroadcastGroup.html#paths:scala.collection.immutable.Iterable[String] "Permalink")  val paths: [Iterable](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Iterable.html#scala.collection.immutable.Iterable)\[String]
22. [**](../../akka/routing/BroadcastGroup.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
23. [**](../../akka/routing/BroadcastGroup.html#props():akka.actor.Props "Permalink")  def props(): [Props](../actor/Props.html)[akka.actor.Props](../actor/Props.html) for a group router based on the settings defined by
this instance.
...
24. [**](../../akka/routing/BroadcastGroup.html#routerDispatcher:String "Permalink")  val routerDispatcher: StringDispatcher ID to use for running the “head” actor, which handles
...
Definition Classes[RouterConfig](RouterConfig.html)
26. [**](../../akka/routing/BroadcastGroup.html#stopRouterWhenAllRouteesRemoved:Boolean "Permalink")  def stopRouterWhenAllRouteesRemoved: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition Classes[RouterConfig](RouterConfig.html)
27. [**](../../akka/routing/BroadcastGroup.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
28. [**](../../akka/routing/BroadcastGroup.html#verifyConfig(path:akka.actor.ActorPath):Unit "Permalink")  def verifyConfig(path: [ActorPath](../actor/ActorPath.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Check that everything is there which is needed.

Check that everything is there which is needed. Called in constructor of RoutedActorRef to fail early.

Definition Classes[RouterConfig](RouterConfig.html)
29. [**](../../akka/routing/BroadcastGroup.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
30. [**](../../akka/routing/BroadcastGroup.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
31. [**](../../akka/routing/BroadcastGroup.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
32. [**](../../akka/routing/BroadcastGroup.html#withDispatcher(dispatcherId:String):akka.routing.BroadcastGroup "Permalink")  def withDispatcher(dispatcherId: String): BroadcastGroupSetting the dispatcher to be used for the router head actor, which handles
router management messages
33. [**](../../akka/routing/BroadcastGroup.html#withFallback(other:akka.routing.RouterConfig):akka.routing.RouterConfig "Permalink")  def withFallback(other: [RouterConfig](RouterConfig.html)): [RouterConfig](RouterConfig.html)Overridable merge strategy, by default completely prefers `this` (i.e.
...
1. [**](../../akka/routing/BroadcastGroup.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/routing/BroadcastGroup.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from BroadcastGroup toStringFormat\[BroadcastGroup] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/routing/BroadcastGroup.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (BroadcastGroup, B)ImplicitThis member is added by an implicit conversion from BroadcastGroup toArrowAssoc\[BroadcastGroup] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromBroadcastGroup to any2stringadd\[BroadcastGroup]

### Inherited by implicit conversion StringFormat fromBroadcastGroup to StringFormat\[BroadcastGroup]

### Inherited by implicit conversion Ensuring fromBroadcastGroup to Ensuring\[BroadcastGroup]

### Inherited by implicit conversion ArrowAssoc fromBroadcastGroup to ArrowAssoc\[BroadcastGroup]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/routing/BroadcastGroup.html](https://doc.akka.io/api/akka-core/2.10.17/akka/routing/BroadcastGroup.html)*