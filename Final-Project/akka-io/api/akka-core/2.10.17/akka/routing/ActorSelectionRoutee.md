---
description: Akka 2.10.17 - akka.routing.ActorSelectionRoutee
knowledge_type: official_documentation
scraped_at: '2026-04-06T15:09:02Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/routing/ActorSelectionRoutee.html
title: Akka 2.10.17 - akka.routing.ActorSelectionRoutee
---

# Akka 2.10.17 - akka.routing.ActorSelectionRoutee

> **Summary:** Akka 2.10.17 - akka.routing.ActorSelectionRoutee
...
# ActorSelectionRoutee[**](../../akka/routing/ActorSelectionRoutee.html "Permalink")

### 

#### final  case class ActorSelectionRoutee(selection: [ActorSelection](../actor/ActorSelection.html)) extends [Routee](Routee.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable

[Routee](Routee.html) that sends the messages to an [akka.actor.ActorSelection](../actor/ActorSelection.html).

Source[Router.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/routing/Router.scala#L56)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.17/scala/Equals.html#scala.Equals), [Routee](Routee.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ActorSelectionRoutee
2. Serializable
3. Product
4. Equals
5. Routee
...
1. [**](../../akka/routing/ActorSelectionRoutee.html#<init>(selection:akka.actor.ActorSelection):akka.routing.ActorSelectionRoutee "Permalink")  new ActorSelectionRoutee(selection: [ActorSelection](../actor/ActorSelection.html))
### Value Members

1. [**](../../akka/routing/ActorSelectionRoutee.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/routing/ActorSelectionRoutee.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/routing/ActorSelectionRoutee.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ActorSelectionRoutee toany2stringadd\[ActorSelectionRoutee] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/routing/ActorSelectionRoutee.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ActorSelectionRoutee, B)ImplicitThis member is added by an implicit conversion from ActorSelectionRoutee toArrowAssoc\[ActorSelectionRoutee] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/routing/ActorSelectionRoutee.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/routing/ActorSelectionRoutee.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/routing/ActorSelectionRoutee.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/routing/ActorSelectionRoutee.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ActorSelectionRoutee) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ActorSelectionRouteeImplicitThis member is added by an implicit conversion from ActorSelectionRoutee toEnsuring\[ActorSelectionRoutee] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/routing/ActorSelectionRoutee.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ActorSelectionRoutee) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ActorSelectionRouteeImplicitThis member is added by an implicit conversion from ActorSelectionRoutee toEnsuring\[ActorSelectionRoutee] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/routing/ActorSelectionRoutee.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ActorSelectionRouteeImplicitThis member is added by an implicit conversion from ActorSelectionRoutee toEnsuring\[ActorSelectionRoutee] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/routing/ActorSelectionRoutee.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ActorSelectionRouteeImplicitThis member is added by an implicit conversion from ActorSelectionRoutee toEnsuring\[ActorSelectionRoutee] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/routing/ActorSelectionRoutee.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/routing/ActorSelectionRoutee.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../akka/routing/ActorSelectionRoutee.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
15. [**](../../akka/routing/ActorSelectionRoutee.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
16. [**](../../akka/routing/ActorSelectionRoutee.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/routing/ActorSelectionRoutee.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/routing/ActorSelectionRoutee.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
19. [**](../../akka/routing/ActorSelectionRoutee.html#selection:akka.actor.ActorSelection "Permalink")  val selection: [ActorSelection](../actor/ActorSelection.html)
20. [**](../../akka/routing/ActorSelectionRoutee.html#send(message:Any,sender:akka.actor.ActorRef):Unit "Permalink")  def send(message: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any), sender: [ActorRef](../actor/ActorRef.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesActorSelectionRoutee → [Routee](Routee.html)
21. [**](../../akka/routing/ActorSelectionRoutee.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../akka/routing/ActorSelectionRoutee.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/routing/ActorSelectionRoutee.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/routing/ActorSelectionRoutee.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/routing/ActorSelectionRoutee.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/routing/ActorSelectionRoutee.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ActorSelectionRoutee toStringFormat\[ActorSelectionRoutee] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/routing/ActorSelectionRoutee.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ActorSelectionRoutee, B)ImplicitThis member is added by an implicit conversion from ActorSelectionRoutee toArrowAssoc\[ActorSelectionRoutee] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromActorSelectionRoutee to any2stringadd\[ActorSelectionRoutee]

### Inherited by implicit conversion StringFormat fromActorSelectionRoutee to StringFormat\[ActorSelectionRoutee]

### Inherited by implicit conversion Ensuring fromActorSelectionRoutee to Ensuring\[ActorSelectionRoutee]

### Inherited by implicit conversion ArrowAssoc fromActorSelectionRoutee to ArrowAssoc\[ActorSelectionRoutee]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/routing/ActorSelectionRoutee.html](https://doc.akka.io/api/akka-core/2.10.17/akka/routing/ActorSelectionRoutee.html)*