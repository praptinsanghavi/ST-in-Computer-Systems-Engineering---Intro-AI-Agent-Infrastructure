...
scraped_at: '2026-04-06T03:22:04Z'
section: api
site: akka-io
...
[o](Metric.html "See companion class")[akka](../../index.html).[cluster](../index.html).[metrics](index.html)

# [Metric](Metric.html "See companion class")[**](../../../akka/cluster/metrics/Metric$.html "Permalink")

### Companion [class Metric](Metric.html "See companion class")

#### object Metric extends MetricNumericConverter with [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)

Factory for creating valid Metric instances.

Source[Metric.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-cluster-metrics/src/main/scala/akka/cluster/metrics/Metric.scala#L71)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), MetricNumericConverter, [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Metric
2. Serializable
3. MetricNumericConverter
4. AnyRef
5. Any
1. Hide All
2. Show All
...
3. [**](../../../akka/cluster/metrics/Metric$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../akka/cluster/metrics/Metric$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/cluster/metrics/Metric$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../../akka/cluster/metrics/Metric$.html#convertNumber(from:Any):Either[Long,Double] "Permalink")  def convertNumber(from: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): Either\[[Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double)]May involve rounding or truncation.

May involve rounding or truncation.

Definition ClassesMetricNumericConverter
7. [**](../../../akka/cluster/metrics/Metric$.html#create(name:String,value:scala.util.Try[Number],decayFactor:Option[Double]):Option[akka.cluster.metrics.Metric] "Permalink")  def create(name: String, value: [Try](https://www.scala-lang.org/api/2.13.17/scala/util/Try.html#scala.util.Try)\[[Number](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Number.html#java.lang.Number)], decayFactor: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double)]): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Metric](Metric.html)]Creates a new Metric instance if the Try is successful and the value is valid,
...
8. [**](../../../akka/cluster/metrics/Metric$.html#create(name:String,value:Number,decayFactor:Option[Double]):Option[akka.cluster.metrics.Metric] "Permalink")  def create(name: String, value: [Number](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Number.html#java.lang.Number), decayFactor: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double)]): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Metric](Metric.html)]Creates a new Metric instance if the value is valid, otherwise None
is returned.
...
9. [**](../../../akka/cluster/metrics/Metric$.html#createEWMA(value:Double,decayFactor:Option[Double]):Option[akka.cluster.metrics.EWMA] "Permalink")  def createEWMA(value: [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double), decayFactor: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double)]): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[EWMA](EWMA.html)]
10. [**](../../../akka/cluster/metrics/Metric$.html#defined(value:Number):Boolean "Permalink")  def defined(value: [Number](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Number.html#java.lang.Number)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)An defined value is neither negative nor NaN/Infinite:
...
11. [**](../../../akka/cluster/metrics/Metric$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
12. [**](../../../akka/cluster/metrics/Metric$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
13. [**](../../../akka/cluster/metrics/Metric$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../../akka/cluster/metrics/Metric$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../../akka/cluster/metrics/Metric$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
16. [**](../../../akka/cluster/metrics/Metric$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../../akka/cluster/metrics/Metric$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../../akka/cluster/metrics/Metric$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../../akka/cluster/metrics/Metric$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
20. [**](../../../akka/cluster/metrics/Metric$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
21. [**](../../../akka/cluster/metrics/Metric$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
22. [**](../../../akka/cluster/metrics/Metric$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
23. [**](../../../akka/cluster/metrics/Metric$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/cluster/metrics/Metric$.html](https://doc.akka.io/api/akka-core/2.10.17/akka/cluster/metrics/Metric$.html)*