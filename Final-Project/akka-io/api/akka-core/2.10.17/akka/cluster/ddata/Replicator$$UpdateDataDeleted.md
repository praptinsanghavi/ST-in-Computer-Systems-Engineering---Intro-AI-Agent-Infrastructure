---
description: Akka 2.10.17 - akka.cluster.ddata.Replicator.UpdateDataDeleted
knowledge_type: official_documentation
scraped_at: '2026-04-06T03:21:44Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/cluster/ddata/Replicator$$UpdateDataDeleted.html
title: Akka 2.10.17 - akka.cluster.ddata.Replicator.UpdateDataDeleted
---

# Akka 2.10.17 - akka.cluster.ddata.Replicator.UpdateDataDeleted

> **Summary:** Akka 2.10.17 - akka.cluster.ddata.Replicator.UpdateDataDeleted
...
# UpdateDataDeleted[**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html "Permalink")

### 

#### final  case class UpdateDataDeleted\[A \<: [ReplicatedData](ReplicatedData.html)](key: [Key](Key.html)\[A], request: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]) extends [UpdateResponse](Replicator$$UpdateResponse.html)\[A] with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable

The [Update](Replicator$$Update.html) couldn't be performed because the entry has been deleted.

Source[Replicator.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-distributed-data/src/main/scala/akka/cluster/ddata/Replicator.scala#L911)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.17/scala/Equals.html#scala.Equals), [UpdateResponse](Replicator$$UpdateResponse.html)\[A], [NoSerializationVerificationNeeded](../../actor/NoSerializationVerificationNeeded.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. UpdateDataDeleted
2. Serializable
...
1. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#<init>(key:akka.cluster.ddata.Key[A],request:Option[Any]):akka.cluster.ddata.Replicator.UpdateDataDeleted[A] "Permalink")  new UpdateDataDeleted(key: [Key](Key.html)\[A], request: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)])
### Value Members

1. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from UpdateDataDeleted\[A] toany2stringadd\[UpdateDataDeleted\[A]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (UpdateDataDeleted\[A], B)ImplicitThis member is added by an implicit conversion from UpdateDataDeleted\[A] toArrowAssoc\[UpdateDataDeleted\[A]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (UpdateDataDeleted\[A]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): UpdateDataDeleted\[A]ImplicitThis member is added by an implicit conversion from UpdateDataDeleted\[A] toEnsuring\[UpdateDataDeleted\[A]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (UpdateDataDeleted\[A]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): UpdateDataDeleted\[A]ImplicitThis member is added by an implicit conversion from UpdateDataDeleted\[A] toEnsuring\[UpdateDataDeleted\[A]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): UpdateDataDeleted\[A]ImplicitThis member is added by an implicit conversion from UpdateDataDeleted\[A] toEnsuring\[UpdateDataDeleted\[A]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): UpdateDataDeleted\[A]ImplicitThis member is added by an implicit conversion from UpdateDataDeleted\[A] toEnsuring\[UpdateDataDeleted\[A]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#getRequest:java.util.Optional[Any] "Permalink")  def getRequest: [Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]Java API

Java API

Definition Classes[UpdateResponse](Replicator$$UpdateResponse.html)
15. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
16. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#key:akka.cluster.ddata.Key[A] "Permalink")  val key: [Key](Key.html)\[A]Definition ClassesUpdateDataDeleted → [UpdateResponse](Replicator$$UpdateResponse.html)
17. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
21. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#request:Option[Any] "Permalink")  val request: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]Definition ClassesUpdateDataDeleted → [UpdateResponse](Replicator$$UpdateResponse.html)
22. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
23. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from UpdateDataDeleted\[A] toStringFormat\[UpdateDataDeleted\[A]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../akka/cluster/ddata/Replicator$$UpdateDataDeleted.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (UpdateDataDeleted\[A], B)ImplicitThis member is added by an implicit conversion from UpdateDataDeleted\[A] toArrowAssoc\[UpdateDataDeleted\[A]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromUpdateDataDeleted\[A] to any2stringadd\[UpdateDataDeleted\[A]]

### Inherited by implicit conversion StringFormat fromUpdateDataDeleted\[A] to StringFormat\[UpdateDataDeleted\[A]]

### Inherited by implicit conversion Ensuring fromUpdateDataDeleted\[A] to Ensuring\[UpdateDataDeleted\[A]]

### Inherited by implicit conversion ArrowAssoc fromUpdateDataDeleted\[A] to ArrowAssoc\[UpdateDataDeleted\[A]]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/cluster/ddata/Replicator$$UpdateDataDeleted.html](https://doc.akka.io/api/akka-core/2.10.17/akka/cluster/ddata/Replicator$$UpdateDataDeleted.html)*