...
scraped_at: '2026-04-06T03:20:39Z'
section: api
site: akka-io
...
[o](ORMultiMap.html "See companion class")[akka](../../index.html).[cluster](../index.html).[ddata](index.html)

# [ORMultiMap](ORMultiMap.html "See companion class")[**](../../../akka/cluster/ddata/ORMultiMap$.html "Permalink")

### Companion [class ORMultiMap](ORMultiMap.html "See companion class")

#### object ORMultiMap extends [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)

Source[ORMultiMap.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-distributed-data/src/main/scala/akka/cluster/ddata/ORMultiMap.scala#L11)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ORMultiMap
2. Serializable
...
3. [**](../../../akka/cluster/ddata/ORMultiMap$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../akka/cluster/ddata/ORMultiMap$.html#_empty:akka.cluster.ddata.ORMultiMap[Any,Any] "Permalink")  val \_empty: [ORMultiMap](ORMultiMap.html)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]
5. [**](../../../akka/cluster/ddata/ORMultiMap$.html#_emptyWithValueDeltas:akka.cluster.ddata.ORMultiMap[Any,Any] "Permalink")  val \_emptyWithValueDeltas: [ORMultiMap](ORMultiMap.html)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]
6. [**](../../../akka/cluster/ddata/ORMultiMap$.html#apply():akka.cluster.ddata.ORMultiMap[Any,Any] "Permalink")  def apply(): [ORMultiMap](ORMultiMap.html)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]
7. [**](../../../akka/cluster/ddata/ORMultiMap$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
8. [**](../../../akka/cluster/ddata/ORMultiMap$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../../akka/cluster/ddata/ORMultiMap$.html#create[A,B]():akka.cluster.ddata.ORMultiMap[A,B] "Permalink")  def create\[A, B](): [ORMultiMap](ORMultiMap.html)\[A, B]Java API
10. [**](../../../akka/cluster/ddata/ORMultiMap$.html#empty[A,B]:akka.cluster.ddata.ORMultiMap[A,B] "Permalink")  def empty\[A, B]: [ORMultiMap](ORMultiMap.html)\[A, B]Provides an empty multimap.
11. [**](../../../akka/cluster/ddata/ORMultiMap$.html#emptyWithValueDeltas[A,B]:akka.cluster.ddata.ORMultiMap[A,B] "Permalink")  def emptyWithValueDeltas\[A, B]: [ORMultiMap](ORMultiMap.html)\[A, B]
12. [**](../../../akka/cluster/ddata/ORMultiMap$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../../akka/cluster/ddata/ORMultiMap$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../../akka/cluster/ddata/ORMultiMap$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../../akka/cluster/ddata/ORMultiMap$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../akka/cluster/ddata/ORMultiMap$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../../akka/cluster/ddata/ORMultiMap$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../../akka/cluster/ddata/ORMultiMap$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../../akka/cluster/ddata/ORMultiMap$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../../akka/cluster/ddata/ORMultiMap$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../../akka/cluster/ddata/ORMultiMap$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../../akka/cluster/ddata/ORMultiMap$.html#unapply[A,B<:akka.cluster.ddata.ReplicatedData](value:Any):Option[Map[A,Set[B]]] "Permalink")  def unapply\[A, B \<: [ReplicatedData](ReplicatedData.html)](value: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[Map\[A, Set\[B]]]Extract the [ORMultiMap\#entries](ORMultiMap.html#entries:Map[A,Set[B]]) of an `ORMultiMap`.
23. [**](../../../akka/cluster/ddata/ORMultiMap$.html#unapply[A,B](m:akka.cluster.ddata.ORMultiMap[A,B]):Option[Map[A,Set[B]]] "Permalink")  def unapply\[A, B](m: [ORMultiMap](ORMultiMap.html)\[A, B]): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[Map\[A, Set\[B]]]Extract the [ORMultiMap\#entries](ORMultiMap.html#entries:Map[A,Set[B]]).
24. [**](../../../akka/cluster/ddata/ORMultiMap$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
25. [**](../../../akka/cluster/ddata/ORMultiMap$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
26. [**](../../../akka/cluster/ddata/ORMultiMap$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/cluster/ddata/ORMultiMap$.html](https://doc.akka.io/api/akka-core/2.10.17/akka/cluster/ddata/ORMultiMap$.html)*