...
scraped_at: '2026-04-06T03:21:21Z'
section: api
site: akka-io
...
[o](VersionVector.html "See companion class")[akka](../../index.html).[cluster](../index.html).[ddata](index.html)

# [VersionVector](VersionVector.html "See companion class")[**](../../../akka/cluster/ddata/VersionVector$.html "Permalink")

### Companion [class VersionVector](VersionVector.html "See companion class")

#### object VersionVector extends [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)

VersionVector module with helper classes and methods.

Source[VersionVector.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-distributed-data/src/main/scala/akka/cluster/ddata/VersionVector.scala#L18)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Content Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. VersionVector
2. Serializable
...
1. [**](../../../akka/cluster/ddata/VersionVector$$Ordering.html "Permalink") sealed  trait [Ordering](VersionVector$$Ordering.html) extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
### Value Members
...
3. [**](../../../akka/cluster/ddata/VersionVector$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../akka/cluster/ddata/VersionVector$.html#AfterInstance:akka.cluster.ddata.VersionVector.After.type "Permalink")  def AfterInstance: [After](VersionVector$$After$.html)Java API: The `VersionVector.After` instance
5. [**](../../../akka/cluster/ddata/VersionVector$.html#BeforeInstance:akka.cluster.ddata.VersionVector.Before.type "Permalink")  def BeforeInstance: [Before](VersionVector$$Before$.html)Java API: The `VersionVector.Before` instance
6. [**](../../../akka/cluster/ddata/VersionVector$.html#ConcurrentInstance:akka.cluster.ddata.VersionVector.Concurrent.type "Permalink")  def ConcurrentInstance: [Concurrent](VersionVector$$Concurrent$.html)Java API: The `VersionVector.Concurrent` instance
7. [**](../../../akka/cluster/ddata/VersionVector$.html#SameInstance:akka.cluster.ddata.VersionVector.Same.type "Permalink")  def SameInstance: [Same](VersionVector$$Same$.html)Java API: The `VersionVector.Same` instance
8. [**](../../../akka/cluster/ddata/VersionVector$.html#apply(node:akka.cluster.UniqueAddress,version:Long):akka.cluster.ddata.VersionVector "Permalink")  def apply(node: [UniqueAddress](../UniqueAddress.html), version: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [VersionVector](VersionVector.html)
9. [**](../../../akka/cluster/ddata/VersionVector$.html#apply(versions:scala.collection.immutable.TreeMap[akka.cluster.UniqueAddress,Long]):akka.cluster.ddata.VersionVector "Permalink")  def apply(versions: [TreeMap](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/TreeMap.html#scala.collection.immutable.TreeMap)\[[UniqueAddress](../UniqueAddress.html), [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)]): [VersionVector](VersionVector.html)
10. [**](../../../akka/cluster/ddata/VersionVector$.html#apply():akka.cluster.ddata.VersionVector "Permalink")  def apply(): [VersionVector](VersionVector.html)
...
13. [**](../../../akka/cluster/ddata/VersionVector$.html#create():akka.cluster.ddata.VersionVector "Permalink")  def create(): [VersionVector](VersionVector.html)Java API
14. [**](../../../akka/cluster/ddata/VersionVector$.html#empty:akka.cluster.ddata.VersionVector "Permalink")  val empty: [VersionVector](VersionVector.html)
15. [**](../../../akka/cluster/ddata/VersionVector$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
16. [**](../../../akka/cluster/ddata/VersionVector$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
17. [**](../../../akka/cluster/ddata/VersionVector$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../../akka/cluster/ddata/VersionVector$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../../akka/cluster/ddata/VersionVector$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
20. [**](../../../akka/cluster/ddata/VersionVector$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
21. [**](../../../akka/cluster/ddata/VersionVector$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../../akka/cluster/ddata/VersionVector$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../../akka/cluster/ddata/VersionVector$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
24. [**](../../../akka/cluster/ddata/VersionVector$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
25. [**](../../../akka/cluster/ddata/VersionVector$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../../akka/cluster/ddata/VersionVector$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
27. [**](../../../akka/cluster/ddata/VersionVector$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../../akka/cluster/ddata/VersionVector$$After$.html "Permalink")  case object [After](VersionVector$$After$.html) extends [Ordering](VersionVector$$Ordering.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
29. [**](../../../akka/cluster/ddata/VersionVector$$Before$.html "Permalink")  case object [Before](VersionVector$$Before$.html) extends [Ordering](VersionVector$$Ordering.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
30. [**](../../../akka/cluster/ddata/VersionVector$$Concurrent$.html "Permalink")  case object [Concurrent](VersionVector$$Concurrent$.html) extends [Ordering](VersionVector$$Ordering.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
31. [**](../../../akka/cluster/ddata/VersionVector$$Same$.html "Permalink")  case object [Same](VersionVector$$Same$.html) extends [Ordering](VersionVector$$Ordering.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/cluster/ddata/VersionVector$.html](https://doc.akka.io/api/akka-core/2.10.17/akka/cluster/ddata/VersionVector$.html)*