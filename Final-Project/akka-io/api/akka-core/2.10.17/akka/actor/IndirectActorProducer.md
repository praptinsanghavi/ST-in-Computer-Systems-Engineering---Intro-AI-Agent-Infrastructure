---
description: Akka 2.10.17 - akka.actor.IndirectActorProducer
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:40:36Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/IndirectActorProducer.html
title: Akka 2.10.17 - akka.actor.IndirectActorProducer
---

# Akka 2.10.17 - akka.actor.IndirectActorProducer

> **Summary:** Akka 2.10.17 - akka.actor.IndirectActorProducer
...
# IndirectActorProducer[**](../../akka/actor/IndirectActorProducer.html "Permalink")

### 

#### trait IndirectActorProducer extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
...
Source[IndirectActorProducer.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/actor/IndirectActorProducer.scala#L20)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/actor/IndirectActorProducer.html#actorClass:Class[_<:akka.actor.Actor] "Permalink") abstract  def actorClass: Class\[\_ \<: [Actor](Actor.html)]This method is used by [Props](Props.html) to determine the type of actor which will
be created.

This method is used by [Props](Props.html) to determine the type of actor which will
...
[Props\#actorClass](Props.html#actorClass():Class[_<:akka.actor.Actor]); it should be noted that such calls may
...
2. [**](../../akka/actor/IndirectActorProducer.html#produce():akka.actor.Actor "Permalink") abstract  def produce(): [Actor](Actor.html)This factory method must produce a fresh actor instance upon each
invocation.
...
1. [**](../../akka/actor/IndirectActorProducer.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/IndirectActorProducer.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/IndirectActorProducer.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from IndirectActorProducer toany2stringadd\[IndirectActorProducer] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/IndirectActorProducer.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (IndirectActorProducer, B)ImplicitThis member is added by an implicit conversion from IndirectActorProducer toArrowAssoc\[IndirectActorProducer] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/IndirectActorProducer.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/IndirectActorProducer.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/IndirectActorProducer.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/actor/IndirectActorProducer.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (IndirectActorProducer) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): IndirectActorProducerImplicitThis member is added by an implicit conversion from IndirectActorProducer toEnsuring\[IndirectActorProducer] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/actor/IndirectActorProducer.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (IndirectActorProducer) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): IndirectActorProducerImplicitThis member is added by an implicit conversion from IndirectActorProducer toEnsuring\[IndirectActorProducer] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/IndirectActorProducer.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): IndirectActorProducerImplicitThis member is added by an implicit conversion from IndirectActorProducer toEnsuring\[IndirectActorProducer] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/IndirectActorProducer.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): IndirectActorProducerImplicitThis member is added by an implicit conversion from IndirectActorProducer toEnsuring\[IndirectActorProducer] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/IndirectActorProducer.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/actor/IndirectActorProducer.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/actor/IndirectActorProducer.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/actor/IndirectActorProducer.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/actor/IndirectActorProducer.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/actor/IndirectActorProducer.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/IndirectActorProducer.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/actor/IndirectActorProducer.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/actor/IndirectActorProducer.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/actor/IndirectActorProducer.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/actor/IndirectActorProducer.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/actor/IndirectActorProducer.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/actor/IndirectActorProducer.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/IndirectActorProducer.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/actor/IndirectActorProducer.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from IndirectActorProducer toStringFormat\[IndirectActorProducer] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/IndirectActorProducer.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (IndirectActorProducer, B)ImplicitThis member is added by an implicit conversion from IndirectActorProducer toArrowAssoc\[IndirectActorProducer] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromIndirectActorProducer to any2stringadd\[IndirectActorProducer]

### Inherited by implicit conversion StringFormat fromIndirectActorProducer to StringFormat\[IndirectActorProducer]

### Inherited by implicit conversion Ensuring fromIndirectActorProducer to Ensuring\[IndirectActorProducer]

### Inherited by implicit conversion ArrowAssoc fromIndirectActorProducer to ArrowAssoc\[IndirectActorProducer]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/actor/IndirectActorProducer.html](https://doc.akka.io/api/akka-core/2.10.17/akka/actor/IndirectActorProducer.html)*