---
description: Akka 2.10.17 - akka.actor.RootActorPath
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:41:07Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/RootActorPath.html
title: Akka 2.10.17 - akka.actor.RootActorPath
---

# Akka 2.10.17 - akka.actor.RootActorPath

> **Summary:** Akka 2.10.17 - akka.actor.RootActorPath
...
# RootActorPath[**](../../akka/actor/RootActorPath.html "Permalink")

### 

#### final  case class RootActorPath(address: [Address](Address.html), name: String \= "/") extends [ActorPath](ActorPath.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
...
Annotations@SerialVersionUID() Source[ActorPath.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/actor/ActorPath.scala#L265)Linear Supertypes[Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.17/scala/Equals.html#scala.Equals), [ActorPath](ActorPath.html), [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [Comparable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Comparable.html#java.lang.Comparable)\[[ActorPath](ActorPath.html)], [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. RootActorPath
2. Product
...
1. [**](../../akka/actor/RootActorPath.html#<init>(address:akka.actor.Address,name:String):akka.actor.RootActorPath "Permalink")  new RootActorPath(address: [Address](Address.html), name: String \= "/")
### Value Members

1. [**](../../akka/actor/RootActorPath.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/RootActorPath.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/RootActorPath.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from RootActorPath toany2stringadd\[RootActorPath] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/RootActorPath.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (RootActorPath, B)ImplicitThis member is added by an implicit conversion from RootActorPath toArrowAssoc\[RootActorPath] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/RootActorPath.html#/(child:String):akka.actor.ActorPath "Permalink")  def /(child: String): [ActorPath](ActorPath.html)Create a new child actor path.

Create a new child actor path.

Definition ClassesRootActorPath → [ActorPath](ActorPath.html)
6. [**](../../akka/actor/RootActorPath.html#/(child:Iterable[String]):akka.actor.ActorPath "Permalink")  def /(child: Iterable\[String]): [ActorPath](ActorPath.html)Recursively create a descendant’s path by appending all child names.

Recursively create a descendant’s path by appending all child names.

Definition Classes[ActorPath](ActorPath.html)
7. [**](../../akka/actor/RootActorPath.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
8. [**](../../akka/actor/RootActorPath.html#address:akka.actor.Address "Permalink")  val address: [Address](Address.html)The Address under which this path can be reached; walks up the tree to
the RootActorPath.
...
Definition ClassesRootActorPath → [ActorPath](ActorPath.html)
9. [**](../../akka/actor/RootActorPath.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
10. [**](../../akka/actor/RootActorPath.html#child(child:String):akka.actor.ActorPath "Permalink")  def child(child: String): [ActorPath](ActorPath.html)Java API: Create a new child actor path.

Java API: Create a new child actor path.

Definition Classes[ActorPath](ActorPath.html)
11. [**](../../akka/actor/RootActorPath.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
12. [**](../../akka/actor/RootActorPath.html#compareTo(other:akka.actor.ActorPath):Int "Permalink")  def compareTo(other: [ActorPath](ActorPath.html)): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesRootActorPath → Comparable
13. [**](../../akka/actor/RootActorPath.html#descendant(names:Iterable[String]):akka.actor.ActorPath "Permalink")  def descendant(names: [Iterable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Iterable.html#java.lang.Iterable)\[String]): [ActorPath](ActorPath.html)Java API: Recursively create a descendant’s path by appending all child names.

Java API: Recursively create a descendant’s path by appending all child names.

Definition Classes[ActorPath](ActorPath.html)
14. [**](../../akka/actor/RootActorPath.html#elements:scala.collection.immutable.Iterable[String] "Permalink")  def elements: [Iterable](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Iterable.html#scala.collection.immutable.Iterable)\[String]Sequence of names for this path from root to this.

Sequence of names for this path from root to this. Performance implication: has to allocate a list.

Definition ClassesRootActorPath → [ActorPath](ActorPath.html)
15. [**](../../akka/actor/RootActorPath.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (RootActorPath) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): RootActorPathImplicitThis member is added by an implicit conversion from RootActorPath toEnsuring\[RootActorPath] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/actor/RootActorPath.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (RootActorPath) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): RootActorPathImplicitThis member is added by an implicit conversion from RootActorPath toEnsuring\[RootActorPath] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../akka/actor/RootActorPath.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): RootActorPathImplicitThis member is added by an implicit conversion from RootActorPath toEnsuring\[RootActorPath] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
18. [**](../../akka/actor/RootActorPath.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): RootActorPathImplicitThis member is added by an implicit conversion from RootActorPath toEnsuring\[RootActorPath] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
19. [**](../../akka/actor/RootActorPath.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
20. [**](../../akka/actor/RootActorPath.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../akka/actor/RootActorPath.html#getElements:Iterable[String] "Permalink")  def getElements: [Iterable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Iterable.html#java.lang.Iterable)\[String]Java API: Sequence of names for this path from root to this.

Java API: Sequence of names for this path from root to this. Performance implication: has to allocate a list.

Definition Classes[ActorPath](ActorPath.html)
22. [**](../../akka/actor/RootActorPath.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
23. [**](../../akka/actor/RootActorPath.html#name:String "Permalink")  val name: StringThe name of the actor that this path refers to.

The name of the actor that this path refers to.

Definition ClassesRootActorPath → [ActorPath](ActorPath.html)
24. [**](../../akka/actor/RootActorPath.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
25. [**](../../akka/actor/RootActorPath.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
26. [**](../../akka/actor/RootActorPath.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
27. [**](../../akka/actor/RootActorPath.html#parent:akka.actor.ActorPath "Permalink")  def parent: [ActorPath](ActorPath.html)The path for the parent actor.

The path for the parent actor.

Definition ClassesRootActorPath → [ActorPath](ActorPath.html)
28. [**](../../akka/actor/RootActorPath.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
29. [**](../../akka/actor/RootActorPath.html#root:akka.actor.RootActorPath "Permalink")  def root: RootActorPathWalk up the tree to obtain and return the RootActorPath.

Walk up the tree to obtain and return the RootActorPath.

Definition ClassesRootActorPath → [ActorPath](ActorPath.html)
30. [**](../../akka/actor/RootActorPath.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
31. [**](../../akka/actor/RootActorPath.html#toSerializationFormat:String "Permalink")  val toSerializationFormat: StringGenerate full String representation including the
...
Definition ClassesRootActorPath → [ActorPath](ActorPath.html)
32. [**](../../akka/actor/RootActorPath.html#toSerializationFormatWithAddress(addr:akka.actor.Address):String "Permalink")  def toSerializationFormatWithAddress(addr: [Address](Address.html)): StringGenerate full String representation including the uid for the actor cell
...
Definition ClassesRootActorPath → [ActorPath](ActorPath.html)
33. [**](../../akka/actor/RootActorPath.html#toString:String "Permalink")  val toString: StringDefinition ClassesRootActorPath → AnyRef → Any
34. [**](../../akka/actor/RootActorPath.html#toStringWithAddress(addr:akka.actor.Address):String "Permalink")  def toStringWithAddress(addr: [Address](Address.html)): StringGenerate String representation, replacing the Address in the RootActor
...
Definition ClassesRootActorPath → [ActorPath](ActorPath.html)
35. [**](../../akka/actor/RootActorPath.html#toStringWithoutAddress:String "Permalink")  def toStringWithoutAddress: StringString representation of the path elements, excluding the address
information.
...
Definition Classes[ActorPath](ActorPath.html)
36. [**](../../akka/actor/RootActorPath.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
37. [**](../../akka/actor/RootActorPath.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
38. [**](../../akka/actor/RootActorPath.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/RootActorPath.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/actor/RootActorPath.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from RootActorPath toStringFormat\[RootActorPath] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/RootActorPath.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (RootActorPath, B)ImplicitThis member is added by an implicit conversion from RootActorPath toArrowAssoc\[RootActorPath] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product)

### Inherited from [Equals](https://www.scala-lang.org/api/2.13.17/scala/Equals.html#scala.Equals)

### Inherited from [ActorPath](ActorPath.html)

### Inherited from [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)

### Inherited from [Comparable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Comparable.html#java.lang.Comparable)\[[ActorPath](ActorPath.html)]

### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromRootActorPath to any2stringadd\[RootActorPath]

### Inherited by implicit conversion StringFormat fromRootActorPath to StringFormat\[RootActorPath]

### Inherited by implicit conversion Ensuring fromRootActorPath to Ensuring\[RootActorPath]

### Inherited by implicit conversion ArrowAssoc fromRootActorPath to ArrowAssoc\[RootActorPath]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/actor/RootActorPath.html](https://doc.akka.io/api/akka-core/2.10.17/akka/actor/RootActorPath.html)*