---
description: Akka 2.10.17 - akka.actor.ExtensionIdProvider
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:40:33Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/ExtensionIdProvider.html
title: Akka 2.10.17 - akka.actor.ExtensionIdProvider
---

# Akka 2.10.17 - akka.actor.ExtensionIdProvider

> **Summary:** Akka 2.10.17 - akka.actor.ExtensionIdProvider
...
#### trait ExtensionIdProvider extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
...
Source[Extension.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/actor/Extension.scala#L130)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[CoordinatedShutdown](CoordinatedShutdown$.html), [Cluster](../cluster/Cluster$.html), [DistributedData](../cluster/ddata/DistributedData$.html), [ClusterMetricsExtension](../cluster/metrics/ClusterMetricsExtension$.html), [DistributedPubSub](../cluster/pubsub/DistributedPubSub$.html), [ClusterSharding](../cluster/sharding/ClusterSharding$.html), [ExternalShardAllocation](../cluster/sharding/external/ExternalShardAllocation$.html), [ClusterShardingInstrumentationProvider](../cluster/sharding/internal/ClusterShardingInstrumentationProvider$.html), [LeaseProvider](../coordination/lease/javadsl/LeaseProvider$.html), [LeaseProvider](../coordination/lease/scaladsl/LeaseProvider$.html), [Discovery](../discovery/Discovery$.html), [Dns](../io/Dns$.html), [Tcp](../io/Tcp$.html), [Udp](../io/Udp$.html), [UdpConnected](../io/UdpConnected$.html), [CircuitBreakersRegistry](../pattern/CircuitBreakersRegistry$.html), [Persistence](../persistence/Persistence$.html), [PersistencePluginProxyExtension](../persistence/journal/PersistencePluginProxyExtension$.html), [PersistenceQuery](../persistence/query/PersistenceQuery$.html), [DurableStateStoreRegistry](../persistence/state/DurableStateStoreRegistry$.html), [EventsourcedInstrumentationProvider](../persistence/telemetry/EventsourcedInstrumentationProvider$.html), [RecoveryPermitterInstrumentationProvider](../persistence/telemetry/RecoveryPermitterInstrumentationProvider$.html), [BoundAddressesExtension](../remote/BoundAddressesExtension$.html), [TestConductor](../remote/testconductor/TestConductor$.html), [SerializationExtension](../serialization/SerializationExtension$.html), [JacksonObjectMapperProvider](../serialization/jackson/JacksonObjectMapperProvider$.html), [SystemMaterializer](../stream/SystemMaterializer$.html), [Tcp](../stream/javadsl/Tcp$.html), [Tcp](../stream/scaladsl/Tcp$.html), [ManifestInfo](../util/ManifestInfo$.html), [AddressUidExtension](../remote/AddressUidExtension$.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/actor/ExtensionIdProvider.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/ExtensionIdProvider.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
5. [**](../../akka/actor/ExtensionIdProvider.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/ExtensionIdProvider.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/ExtensionIdProvider.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/actor/ExtensionIdProvider.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ExtensionIdProvider) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ExtensionIdProviderImplicitThis member is added by an implicit conversion from ExtensionIdProvider toEnsuring\[ExtensionIdProvider] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/actor/ExtensionIdProvider.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ExtensionIdProvider) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ExtensionIdProviderImplicitThis member is added by an implicit conversion from ExtensionIdProvider toEnsuring\[ExtensionIdProvider] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/ExtensionIdProvider.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ExtensionIdProviderImplicitThis member is added by an implicit conversion from ExtensionIdProvider toEnsuring\[ExtensionIdProvider] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/ExtensionIdProvider.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ExtensionIdProviderImplicitThis member is added by an implicit conversion from ExtensionIdProvider toEnsuring\[ExtensionIdProvider] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/ExtensionIdProvider.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/actor/ExtensionIdProvider.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
15. [**](../../akka/actor/ExtensionIdProvider.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/actor/ExtensionIdProvider.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/actor/ExtensionIdProvider.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/ExtensionIdProvider.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/actor/ExtensionIdProvider.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
...
22. [**](../../akka/actor/ExtensionIdProvider.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/actor/ExtensionIdProvider.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/actor/ExtensionIdProvider.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/ExtensionIdProvider.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/actor/ExtensionIdProvider.html](https://doc.akka.io/api/akka-core/2.10.17/akka/actor/ExtensionIdProvider.html)*