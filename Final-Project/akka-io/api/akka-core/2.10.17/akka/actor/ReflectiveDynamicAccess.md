---
description: Akka 2.10.17 - akka.actor.ReflectiveDynamicAccess
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:41:04Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/ReflectiveDynamicAccess.html
title: Akka 2.10.17 - akka.actor.ReflectiveDynamicAccess
---

# Akka 2.10.17 - akka.actor.ReflectiveDynamicAccess

> **Summary:** Akka 2.10.17 - akka.actor.ReflectiveDynamicAccess
...
# ReflectiveDynamicAccess[**](../../akka/actor/ReflectiveDynamicAccess.html "Permalink")

### 

#### class ReflectiveDynamicAccess extends [DynamicAccess](DynamicAccess.html)
...
Annotations@[DoNotInherit](../annotation/DoNotInherit.html)() Source[ReflectiveDynamicAccess.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/actor/ReflectiveDynamicAccess.scala#L25)Linear Supertypes[DynamicAccess](DynamicAccess.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/actor/ReflectiveDynamicAccess.html#<init>(classLoader:ClassLoader):akka.actor.ReflectiveDynamicAccess "Permalink")  new ReflectiveDynamicAccess(classLoader: [ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader))
### Value Members

1. [**](../../akka/actor/ReflectiveDynamicAccess.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/ReflectiveDynamicAccess.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/ReflectiveDynamicAccess.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ReflectiveDynamicAccess toany2stringadd\[ReflectiveDynamicAccess] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/ReflectiveDynamicAccess.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ReflectiveDynamicAccess, B)ImplicitThis member is added by an implicit conversion from ReflectiveDynamicAccess toArrowAssoc\[ReflectiveDynamicAccess] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/ReflectiveDynamicAccess.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/ReflectiveDynamicAccess.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/ReflectiveDynamicAccess.html#classIsOnClasspath(fqcn:String):Boolean "Permalink")  def classIsOnClasspath(fqcn: String): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesReflectiveDynamicAccess → [DynamicAccess](DynamicAccess.html)
8. [**](../../akka/actor/ReflectiveDynamicAccess.html#classLoader:ClassLoader "Permalink")  val classLoader: [ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)This is the class loader to be used in those special cases where the
...
Definition ClassesReflectiveDynamicAccess → [DynamicAccess](DynamicAccess.html)
9. [**](../../akka/actor/ReflectiveDynamicAccess.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
10. [**](../../akka/actor/ReflectiveDynamicAccess.html#createInstanceFor[T](fqcn:String,args:Seq[(Class[_],AnyRef)])(implicitevidence$3:scala.reflect.ClassTag[T]):scala.util.Try[T] "Permalink")  def createInstanceFor\[T](fqcn: String, args: [Seq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[(Class\[\_], [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef))])(implicit arg0: [ClassTag](https://www.scala-lang.org/api/2.13.17/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[T]): [Try](https://www.scala-lang.org/api/2.13.17/scala/util/Try.html#scala.util.Try)\[T]Obtain an object conforming to the type T, which is expected to be
...
Definition ClassesReflectiveDynamicAccess → [DynamicAccess](DynamicAccess.html)
11. [**](../../akka/actor/ReflectiveDynamicAccess.html#createInstanceFor[T](clazz:Class[_],args:Seq[(Class[_],AnyRef)])(implicitevidence$2:scala.reflect.ClassTag[T]):scala.util.Try[T] "Permalink")  def createInstanceFor\[T](clazz: Class\[\_], args: [Seq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[(Class\[\_], [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef))])(implicit arg0: [ClassTag](https://www.scala-lang.org/api/2.13.17/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[T]): [Try](https://www.scala-lang.org/api/2.13.17/scala/util/Try.html#scala.util.Try)\[T]Convenience method which given a `Class[_]` object and a constructor description
...
```
Definition ClassesReflectiveDynamicAccess → [DynamicAccess](DynamicAccess.html)
12. [**](../../akka/actor/ReflectiveDynamicAccess.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ReflectiveDynamicAccess) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ReflectiveDynamicAccessImplicitThis member is added by an implicit conversion from ReflectiveDynamicAccess toEnsuring\[ReflectiveDynamicAccess] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/actor/ReflectiveDynamicAccess.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ReflectiveDynamicAccess) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ReflectiveDynamicAccessImplicitThis member is added by an implicit conversion from ReflectiveDynamicAccess toEnsuring\[ReflectiveDynamicAccess] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/actor/ReflectiveDynamicAccess.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ReflectiveDynamicAccessImplicitThis member is added by an implicit conversion from ReflectiveDynamicAccess toEnsuring\[ReflectiveDynamicAccess] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/actor/ReflectiveDynamicAccess.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ReflectiveDynamicAccessImplicitThis member is added by an implicit conversion from ReflectiveDynamicAccess toEnsuring\[ReflectiveDynamicAccess] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/actor/ReflectiveDynamicAccess.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/actor/ReflectiveDynamicAccess.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
18. [**](../../akka/actor/ReflectiveDynamicAccess.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/actor/ReflectiveDynamicAccess.html#getClassFor[T](fqcn:String)(implicitevidence$1:scala.reflect.ClassTag[T]):scala.util.Try[Class[_<:T]] "Permalink")  def getClassFor\[T](fqcn: String)(implicit arg0: [ClassTag](https://www.scala-lang.org/api/2.13.17/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[T]): [Try](https://www.scala-lang.org/api/2.13.17/scala/util/Try.html#scala.util.Try)\[Class\[\_ \<: T]]Obtain a `Class[_]` object loaded with the right class loader (i.e.

Obtain a `Class[_]` object loaded with the right class loader (i.e. the one
returned by `classLoader`).

Definition ClassesReflectiveDynamicAccess → [DynamicAccess](DynamicAccess.html)
20. [**](../../akka/actor/ReflectiveDynamicAccess.html#getObjectFor[T](fqcn:String)(implicitevidence$4:scala.reflect.ClassTag[T]):scala.util.Try[T] "Permalink")  def getObjectFor\[T](fqcn: String)(implicit arg0: [ClassTag](https://www.scala-lang.org/api/2.13.17/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[T]): [Try](https://www.scala-lang.org/api/2.13.17/scala/util/Try.html#scala.util.Try)\[T]Obtain the Scala “object” instance for the given fully\-qualified class name, if there is one.

Obtain the Scala “object” instance for the given fully\-qualified class name, if there is one.

Definition ClassesReflectiveDynamicAccess → [DynamicAccess](DynamicAccess.html)
21. [**](../../akka/actor/ReflectiveDynamicAccess.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/actor/ReflectiveDynamicAccess.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
23. [**](../../akka/actor/ReflectiveDynamicAccess.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
24. [**](../../akka/actor/ReflectiveDynamicAccess.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
25. [**](../../akka/actor/ReflectiveDynamicAccess.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
26. [**](../../akka/actor/ReflectiveDynamicAccess.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
27. [**](../../akka/actor/ReflectiveDynamicAccess.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
28. [**](../../akka/actor/ReflectiveDynamicAccess.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
29. [**](../../akka/actor/ReflectiveDynamicAccess.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
30. [**](../../akka/actor/ReflectiveDynamicAccess.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/ReflectiveDynamicAccess.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/actor/ReflectiveDynamicAccess.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ReflectiveDynamicAccess toStringFormat\[ReflectiveDynamicAccess] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/ReflectiveDynamicAccess.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ReflectiveDynamicAccess, B)ImplicitThis member is added by an implicit conversion from ReflectiveDynamicAccess toArrowAssoc\[ReflectiveDynamicAccess] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [DynamicAccess](DynamicAccess.html)

### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromReflectiveDynamicAccess to any2stringadd\[ReflectiveDynamicAccess]

### Inherited by implicit conversion StringFormat fromReflectiveDynamicAccess to StringFormat\[ReflectiveDynamicAccess]

### Inherited by implicit conversion Ensuring fromReflectiveDynamicAccess to Ensuring\[ReflectiveDynamicAccess]

### Inherited by implicit conversion ArrowAssoc fromReflectiveDynamicAccess to ArrowAssoc\[ReflectiveDynamicAccess]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/actor/ReflectiveDynamicAccess.html](https://doc.akka.io/api/akka-core/2.10.17/akka/actor/ReflectiveDynamicAccess.html)*