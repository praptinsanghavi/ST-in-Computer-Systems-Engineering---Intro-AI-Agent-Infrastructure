...
[o](BootstrapSetup.html "See companion class")[akka](../index.html).[actor](index.html)

# [BootstrapSetup](BootstrapSetup.html "See companion class")[**](../../akka/actor/BootstrapSetup$.html "Permalink")

### Companion [class BootstrapSetup](BootstrapSetup.html "See companion class")

#### object BootstrapSetup

Source[ActorSystem.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/actor/ActorSystem.scala#L45)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. BootstrapSetup
2. AnyRef
...
3. [**](../../akka/actor/BootstrapSetup$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/actor/BootstrapSetup$.html#apply(config:com.typesafe.config.Config):akka.actor.BootstrapSetup "Permalink")  def apply(config: Config): [BootstrapSetup](BootstrapSetup.html)Scala API: Short for using custom config but keeping default classloader and default execution context
5. [**](../../akka/actor/BootstrapSetup$.html#apply(classLoader:Option[ClassLoader],config:Option[com.typesafe.config.Config],defaultExecutionContext:Option[scala.concurrent.ExecutionContext]):akka.actor.BootstrapSetup "Permalink")  def apply(classLoader: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)], config: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[Config], defaultExecutionContext: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ExecutionContext](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContext.html#scala.concurrent.ExecutionContext)]): [BootstrapSetup](BootstrapSetup.html)Scala API: Create bootstrap settings needed for starting the actor system

Scala API: Create bootstrap settings needed for starting the actor system

See also[BootstrapSetup](BootstrapSetup.html) for description of the properties
6. [**](../../akka/actor/BootstrapSetup$.html#apply():akka.actor.BootstrapSetup "Permalink")  def apply(): [BootstrapSetup](BootstrapSetup.html)Scala API: Construct a bootstrap settings with default values.

Scala API: Construct a bootstrap settings with default values. Note that passing that to the actor system is the
same as not passing any [BootstrapSetup](BootstrapSetup.html) at all. You can use the returned instance to derive
one that has other values than defaults using the various `with`\-methods.
7. [**](../../akka/actor/BootstrapSetup$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
8. [**](../../akka/actor/BootstrapSetup$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../akka/actor/BootstrapSetup$.html#create():akka.actor.BootstrapSetup "Permalink")  def create(): [BootstrapSetup](BootstrapSetup.html)Java API: Construct a bootstrap settings with default values.

Java API: Construct a bootstrap settings with default values. Note that passing that to the actor system is the
same as not passing any [BootstrapSetup](BootstrapSetup.html) at all. You can use the returned instance to derive
one that has other values than defaults using the various `with`\-methods.
10. [**](../../akka/actor/BootstrapSetup$.html#create(config:com.typesafe.config.Config):akka.actor.BootstrapSetup "Permalink")  def create(config: Config): [BootstrapSetup](BootstrapSetup.html)Java API: Short for using custom config but keeping default classloader and default execution context
11. [**](../../akka/actor/BootstrapSetup$.html#create(classLoader:java.util.Optional[ClassLoader],config:java.util.Optional[com.typesafe.config.Config],defaultExecutionContext:java.util.Optional[scala.concurrent.ExecutionContext]):akka.actor.BootstrapSetup "Permalink")  def create(classLoader: [Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[[ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)], config: [Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[Config], defaultExecutionContext: [Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[[ExecutionContext](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContext.html#scala.concurrent.ExecutionContext)]): [BootstrapSetup](BootstrapSetup.html)Java API: Create bootstrap settings needed for starting the actor system

Java API: Create bootstrap settings needed for starting the actor system

See also[BootstrapSetup](BootstrapSetup.html) for description of the properties
12. [**](../../akka/actor/BootstrapSetup$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/actor/BootstrapSetup$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/actor/BootstrapSetup$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/actor/BootstrapSetup$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/actor/BootstrapSetup$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/actor/BootstrapSetup$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/BootstrapSetup$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/actor/BootstrapSetup$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/actor/BootstrapSetup$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/actor/BootstrapSetup$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/actor/BootstrapSetup$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/actor/BootstrapSetup$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/actor/BootstrapSetup$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
