---
description: Akka 2.10.17 - akka.actor.AllForOneStrategy
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:40:15Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/AllForOneStrategy.html
title: Akka 2.10.17 - akka.actor.AllForOneStrategy
---

# Akka 2.10.17 - akka.actor.AllForOneStrategy

> **Summary:** Akka 2.10.17 - akka.actor.AllForOneStrategy
...
# AllForOneStrategy[**](../../akka/actor/AllForOneStrategy.html "Permalink")

### 

#### case class AllForOneStrategy(maxNrOfRetries: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int) \= \-1, withinTimeRange: [Duration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/Duration.html#scala.concurrent.duration.Duration) \= Duration.Inf, loggingEnabled: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean) \= true)(decider: [Decider](SupervisorStrategy$.html#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive])) extends [SupervisorStrategy](SupervisorStrategy.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
...
1. [**](../../akka/actor/AllForOneStrategy.html#<init>(decider:akka.actor.SupervisorStrategy.Decider):akka.actor.AllForOneStrategy "Permalink")  new AllForOneStrategy(decider: [Decider](SupervisorStrategy$.html#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive]))Java API: compatible with lambda expressions
2. [**](../../akka/actor/AllForOneStrategy.html#<init>(loggingEnabled:Boolean,decider:akka.actor.SupervisorStrategy.Decider):akka.actor.AllForOneStrategy "Permalink")  new AllForOneStrategy(loggingEnabled: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), decider: [Decider](SupervisorStrategy$.html#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive]))Java API: compatible with lambda expressions
3. [**](../../akka/actor/AllForOneStrategy.html#<init>(maxNrOfRetries:Int,withinTimeRange:java.time.Duration,decider:akka.actor.SupervisorStrategy.Decider):akka.actor.AllForOneStrategy "Permalink")  new AllForOneStrategy(maxNrOfRetries: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), withinTimeRange: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), decider: [Decider](SupervisorStrategy$.html#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive]))Java API: compatible with lambda expressions
4. [**](../../akka/actor/AllForOneStrategy.html#<init>(maxNrOfRetries:Int,withinTimeRange:scala.concurrent.duration.Duration,decider:akka.actor.SupervisorStrategy.Decider):akka.actor.AllForOneStrategy "Permalink")  new AllForOneStrategy(maxNrOfRetries: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), withinTimeRange: [Duration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/Duration.html#scala.concurrent.duration.Duration), decider: [Decider](SupervisorStrategy$.html#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive]))Java API: compatible with lambda expressions
5. [**](../../akka/actor/AllForOneStrategy.html#<init>(maxNrOfRetries:Int,withinTimeRange:java.time.Duration,trapExit:Iterable[Class[_<:Throwable]]):akka.actor.AllForOneStrategy "Permalink")  new AllForOneStrategy(maxNrOfRetries: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), withinTimeRange: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), trapExit: [Iterable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Iterable.html#java.lang.Iterable)\[Class\[\_ \<: Throwable]])Java API
6. [**](../../akka/actor/AllForOneStrategy.html#<init>(maxNrOfRetries:Int,withinTimeRange:scala.concurrent.duration.Duration,trapExit:Iterable[Class[_<:Throwable]]):akka.actor.AllForOneStrategy "Permalink")  new AllForOneStrategy(maxNrOfRetries: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), withinTimeRange: [Duration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/Duration.html#scala.concurrent.duration.Duration), trapExit: [Iterable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Iterable.html#java.lang.Iterable)\[Class\[\_ \<: Throwable]])Java API
7. [**](../../akka/actor/AllForOneStrategy.html#<init>(maxNrOfRetries:Int,withinTimeRange:java.time.Duration,decider:akka.actor.SupervisorStrategy.JDecider):akka.actor.AllForOneStrategy "Permalink")  new AllForOneStrategy(maxNrOfRetries: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), withinTimeRange: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), decider: [JDecider](SupervisorStrategy$.html#JDecider=akka.japi.Function[Throwable,akka.actor.SupervisorStrategy.Directive]))Java API
8. [**](../../akka/actor/AllForOneStrategy.html#<init>(maxNrOfRetries:Int,withinTimeRange:scala.concurrent.duration.Duration,decider:akka.actor.SupervisorStrategy.JDecider):akka.actor.AllForOneStrategy "Permalink")  new AllForOneStrategy(maxNrOfRetries: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), withinTimeRange: [Duration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/Duration.html#scala.concurrent.duration.Duration), decider: [JDecider](SupervisorStrategy$.html#JDecider=akka.japi.Function[Throwable,akka.actor.SupervisorStrategy.Directive]))Java API
9. [**](../../akka/actor/AllForOneStrategy.html#<init>(maxNrOfRetries:Int,withinTimeRange:java.time.Duration,decider:akka.actor.SupervisorStrategy.JDecider,loggingEnabled:Boolean):akka.actor.AllForOneStrategy "Permalink")  new AllForOneStrategy(maxNrOfRetries: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), withinTimeRange: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), decider: [JDecider](SupervisorStrategy$.html#JDecider=akka.japi.Function[Throwable,akka.actor.SupervisorStrategy.Directive]), loggingEnabled: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean))Java API
10. [**](../../akka/actor/AllForOneStrategy.html#<init>(maxNrOfRetries:Int,withinTimeRange:scala.concurrent.duration.Duration,decider:akka.actor.SupervisorStrategy.JDecider,loggingEnabled:Boolean):akka.actor.AllForOneStrategy "Permalink")  new AllForOneStrategy(maxNrOfRetries: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), withinTimeRange: [Duration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/Duration.html#scala.concurrent.duration.Duration), decider: [JDecider](SupervisorStrategy$.html#JDecider=akka.japi.Function[Throwable,akka.actor.SupervisorStrategy.Directive]), loggingEnabled: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean))Java API
11. [**](../../akka/actor/AllForOneStrategy.html#<init>(maxNrOfRetries:Int,withinTimeRange:scala.concurrent.duration.Duration,loggingEnabled:Boolean)(decider:akka.actor.SupervisorStrategy.Decider):akka.actor.AllForOneStrategy "Permalink")  new AllForOneStrategy(maxNrOfRetries: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int) \= \-1, withinTimeRange: [Duration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/Duration.html#scala.concurrent.duration.Duration) \= Duration.Inf, loggingEnabled: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean) \= true)(decider: [Decider](SupervisorStrategy$.html#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive]))maxNrOfRetriesthe number of times a child actor is allowed to be restarted, negative value means no limit,
 if the limit is exceeded the child actor is stopped
...
1. [**](../../akka/actor/AllForOneStrategy.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/AllForOneStrategy.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/AllForOneStrategy.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from AllForOneStrategy toany2stringadd\[AllForOneStrategy] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/AllForOneStrategy.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (AllForOneStrategy, B)ImplicitThis member is added by an implicit conversion from AllForOneStrategy toArrowAssoc\[AllForOneStrategy] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/AllForOneStrategy.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/AllForOneStrategy.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/AllForOneStrategy.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/actor/AllForOneStrategy.html#decider:akka.actor.SupervisorStrategy.Decider "Permalink")  val decider: [Decider](SupervisorStrategy$.html#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive])Returns the Decider that is associated with this SupervisorStrategy.
...
Definition ClassesAllForOneStrategy → [SupervisorStrategy](SupervisorStrategy.html)
9. [**](../../akka/actor/AllForOneStrategy.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (AllForOneStrategy) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): AllForOneStrategyImplicitThis member is added by an implicit conversion from AllForOneStrategy toEnsuring\[AllForOneStrategy] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/AllForOneStrategy.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (AllForOneStrategy) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): AllForOneStrategyImplicitThis member is added by an implicit conversion from AllForOneStrategy toEnsuring\[AllForOneStrategy] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/AllForOneStrategy.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): AllForOneStrategyImplicitThis member is added by an implicit conversion from AllForOneStrategy toEnsuring\[AllForOneStrategy] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/AllForOneStrategy.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): AllForOneStrategyImplicitThis member is added by an implicit conversion from AllForOneStrategy toEnsuring\[AllForOneStrategy] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/actor/AllForOneStrategy.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/actor/AllForOneStrategy.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/actor/AllForOneStrategy.html#handleChildTerminated(context:akka.actor.ActorContext,child:akka.actor.ActorRef,children:Iterable[akka.actor.ActorRef]):Unit "Permalink")  def handleChildTerminated(context: [ActorContext](ActorContext.html), child: [ActorRef](ActorRef.html), children: Iterable\[[ActorRef](ActorRef.html)]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)This method is called after the child has been removed from the set of children.
...
Definition ClassesAllForOneStrategy → [SupervisorStrategy](SupervisorStrategy.html)
16. [**](../../akka/actor/AllForOneStrategy.html#handleFailure(context:akka.actor.ActorContext,child:akka.actor.ActorRef,cause:Throwable,stats:akka.actor.ChildRestartStats,children:Iterable[akka.actor.ChildRestartStats]):Boolean "Permalink")  def handleFailure(context: [ActorContext](ActorContext.html), child: [ActorRef](ActorRef.html), cause: Throwable, stats: [ChildRestartStats](ChildRestartStats.html), children: Iterable\[[ChildRestartStats](ChildRestartStats.html)]): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)This is the main entry point: in case of a child’s failure, this method
...
17. [**](../../akka/actor/AllForOneStrategy.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
18. [**](../../akka/actor/AllForOneStrategy.html#logFailure(context:akka.actor.ActorContext,child:akka.actor.ActorRef,cause:Throwable,decision:akka.actor.SupervisorStrategy.Directive):Unit "Permalink")  def logFailure(context: [ActorContext](ActorContext.html), child: [ActorRef](ActorRef.html), cause: Throwable, decision: [Directive](SupervisorStrategy$$Directive.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Default logging of actor failures when
...
Definition Classes[SupervisorStrategy](SupervisorStrategy.html)
19. [**](../../akka/actor/AllForOneStrategy.html#loggingEnabled:Boolean "Permalink")  val loggingEnabled: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Logging of actor failures is done when this is `true`.

Logging of actor failures is done when this is `true`.

Definition ClassesAllForOneStrategy → [SupervisorStrategy](SupervisorStrategy.html)
20. [**](../../akka/actor/AllForOneStrategy.html#maxNrOfRetries:Int "Permalink")  val maxNrOfRetries: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
21. [**](../../akka/actor/AllForOneStrategy.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
22. [**](../../akka/actor/AllForOneStrategy.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../akka/actor/AllForOneStrategy.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../akka/actor/AllForOneStrategy.html#processFailure(context:akka.actor.ActorContext,restart:Boolean,child:akka.actor.ActorRef,cause:Throwable,stats:akka.actor.ChildRestartStats,children:Iterable[akka.actor.ChildRestartStats]):Unit "Permalink")  def processFailure(context: [ActorContext](ActorContext.html), restart: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), child: [ActorRef](ActorRef.html), cause: Throwable, stats: [ChildRestartStats](ChildRestartStats.html), children: Iterable\[[ChildRestartStats](ChildRestartStats.html)]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)This method is called to act on the failure of a child: restart if the flag is true, stop otherwise.

This method is called to act on the failure of a child: restart if the flag is true, stop otherwise.

Definition ClassesAllForOneStrategy → [SupervisorStrategy](SupervisorStrategy.html)
25. [**](../../akka/actor/AllForOneStrategy.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
26. [**](../../akka/actor/AllForOneStrategy.html#restartChild(child:akka.actor.ActorRef,cause:Throwable,suspendFirst:Boolean):Unit "Permalink") final  def restartChild(child: [ActorRef](ActorRef.html), cause: Throwable, suspendFirst: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Restart the given child, possibly suspending it first.
...
Definition Classes[SupervisorStrategy](SupervisorStrategy.html)
27. [**](../../akka/actor/AllForOneStrategy.html#resumeChild(child:akka.actor.ActorRef,cause:Throwable):Unit "Permalink") final  def resumeChild(child: [ActorRef](ActorRef.html), cause: Throwable): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Resume the previously failed child: **do never apply this to a child which
...
Definition Classes[SupervisorStrategy](SupervisorStrategy.html)
28. [**](../../akka/actor/AllForOneStrategy.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
29. [**](../../akka/actor/AllForOneStrategy.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
30. [**](../../akka/actor/AllForOneStrategy.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
31. [**](../../akka/actor/AllForOneStrategy.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
32. [**](../../akka/actor/AllForOneStrategy.html#withinTimeRange:scala.concurrent.duration.Duration "Permalink")  val withinTimeRange: [Duration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/Duration.html#scala.concurrent.duration.Duration)
### Deprecated Value Members

1. [**](../../akka/actor/AllForOneStrategy.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/actor/AllForOneStrategy.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from AllForOneStrategy toStringFormat\[AllForOneStrategy] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/AllForOneStrategy.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (AllForOneStrategy, B)ImplicitThis member is added by an implicit conversion from AllForOneStrategy toArrowAssoc\[AllForOneStrategy] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromAllForOneStrategy to any2stringadd\[AllForOneStrategy]

### Inherited by implicit conversion StringFormat fromAllForOneStrategy to StringFormat\[AllForOneStrategy]

### Inherited by implicit conversion Ensuring fromAllForOneStrategy to Ensuring\[AllForOneStrategy]

### Inherited by implicit conversion ArrowAssoc fromAllForOneStrategy to ArrowAssoc\[AllForOneStrategy]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/actor/AllForOneStrategy.html](https://doc.akka.io/api/akka-core/2.10.17/akka/actor/AllForOneStrategy.html)*