---
description: Akka 2.10.17 - akka.actor.typed.delivery.ProducerController.RequestNext
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:50:46Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/typed/delivery/ProducerController$$RequestNext.html
title: Akka 2.10.17 - akka.actor.typed.delivery.ProducerController.RequestNext
---

# Akka 2.10.17 - akka.actor.typed.delivery.ProducerController.RequestNext

> **Summary:** Akka 2.10.17 - akka.actor.typed.delivery.ProducerController.RequestNext
...
# RequestNext[**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html "Permalink")

### 

#### final  case class RequestNext\[A](producerId: String, currentSeqNr: [SeqNr](ProducerController$.html#SeqNr=Long), confirmedSeqNr: [SeqNr](ProducerController$.html#SeqNr=Long), sendNextTo: [ActorRef](../ActorRef.html)\[A], askNextTo: [ActorRef](../ActorRef.html)\[[MessageWithConfirmation](ProducerController$$MessageWithConfirmation.html)\[A]]) extends [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
...
1. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#<init>(producerId:String,currentSeqNr:akka.actor.typed.delivery.ProducerController.SeqNr,confirmedSeqNr:akka.actor.typed.delivery.ProducerController.SeqNr,sendNextTo:akka.actor.typed.ActorRef[A],askNextTo:akka.actor.typed.ActorRef[akka.actor.typed.delivery.ProducerController.MessageWithConfirmation[A]]):akka.actor.typed.delivery.ProducerController.RequestNext[A] "Permalink")  new RequestNext(producerId: String, currentSeqNr: [SeqNr](ProducerController$.html#SeqNr=Long), confirmedSeqNr: [SeqNr](ProducerController$.html#SeqNr=Long), sendNextTo: [ActorRef](../ActorRef.html)\[A], askNextTo: [ActorRef](../ActorRef.html)\[[MessageWithConfirmation](ProducerController$$MessageWithConfirmation.html)\[A]])
### Value Members

1. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from RequestNext\[A] toany2stringadd\[RequestNext\[A]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (RequestNext\[A], B)ImplicitThis member is added by an implicit conversion from RequestNext\[A] toArrowAssoc\[RequestNext\[A]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#askNextTo:akka.actor.typed.ActorRef[akka.actor.typed.delivery.ProducerController.MessageWithConfirmation[A]] "Permalink")  val askNextTo: [ActorRef](../ActorRef.html)\[[MessageWithConfirmation](ProducerController$$MessageWithConfirmation.html)\[A]]
8. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#confirmedSeqNr:akka.actor.typed.delivery.ProducerController.SeqNr "Permalink")  val confirmedSeqNr: [SeqNr](ProducerController$.html#SeqNr=Long)
10. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#currentSeqNr:akka.actor.typed.delivery.ProducerController.SeqNr "Permalink")  val currentSeqNr: [SeqNr](ProducerController$.html#SeqNr=Long)
11. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (RequestNext\[A]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): RequestNext\[A]ImplicitThis member is added by an implicit conversion from RequestNext\[A] toEnsuring\[RequestNext\[A]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (RequestNext\[A]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): RequestNext\[A]ImplicitThis member is added by an implicit conversion from RequestNext\[A] toEnsuring\[RequestNext\[A]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): RequestNext\[A]ImplicitThis member is added by an implicit conversion from RequestNext\[A] toEnsuring\[RequestNext\[A]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): RequestNext\[A]ImplicitThis member is added by an implicit conversion from RequestNext\[A] toEnsuring\[RequestNext\[A]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
16. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
18. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#producerId:String "Permalink")  val producerId: String
22. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
23. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#sendNextTo:akka.actor.typed.ActorRef[A] "Permalink")  val sendNextTo: [ActorRef](../ActorRef.html)\[A]
24. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
25. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
27. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from RequestNext\[A] toStringFormat\[RequestNext\[A]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../../akka/actor/typed/delivery/ProducerController$$RequestNext.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (RequestNext\[A], B)ImplicitThis member is added by an implicit conversion from RequestNext\[A] toArrowAssoc\[RequestNext\[A]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/actor/typed/delivery/ProducerController$$RequestNext.html](https://doc.akka.io/api/akka-core/2.10.17/akka/actor/typed/delivery/ProducerController$$RequestNext.html)*