---
description: Akka 2.10.17 - akka.util.PriorityQueueStabilizer
knowledge_type: official_documentation
scraped_at: '2026-04-06T03:24:12Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/util/PriorityQueueStabilizer$.html
title: Akka 2.10.17 - akka.util.PriorityQueueStabilizer
---

# Akka 2.10.17 - akka.util.PriorityQueueStabilizer

> **Summary:** Akka 2.10.17 - akka.util.PriorityQueueStabilizer
...
[o](PriorityQueueStabilizer.html "See companion trait")[akka](../index.html).[util](index.html)

# [PriorityQueueStabilizer](PriorityQueueStabilizer.html "See companion trait")[**](../../akka/util/PriorityQueueStabilizer$.html "Permalink")

### Companion [trait PriorityQueueStabilizer](PriorityQueueStabilizer.html "See companion trait")

#### object PriorityQueueStabilizer

Source[StablePriorityQueue.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/util/StablePriorityQueue.scala#L44)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/util/PriorityQueueStabilizer$$WrappedElement.html "Permalink")  class [WrappedElement](PriorityQueueStabilizer$$WrappedElement.html)\[E] extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
2. [**](../../akka/util/PriorityQueueStabilizer$$WrappedElementComparator.html "Permalink")  class [WrappedElementComparator](PriorityQueueStabilizer$$WrappedElementComparator.html)\[E] extends [Comparator](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Comparator.html#java.util.Comparator)\[[WrappedElement](PriorityQueueStabilizer$$WrappedElement.html)\[E]]
### Value Members
...
3. [**](../../akka/util/PriorityQueueStabilizer$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/util/PriorityQueueStabilizer$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../akka/util/PriorityQueueStabilizer$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../akka/util/PriorityQueueStabilizer$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
7. [**](../../akka/util/PriorityQueueStabilizer$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
8. [**](../../akka/util/PriorityQueueStabilizer$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
9. [**](../../akka/util/PriorityQueueStabilizer$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
10. [**](../../akka/util/PriorityQueueStabilizer$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
11. [**](../../akka/util/PriorityQueueStabilizer$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
12. [**](../../akka/util/PriorityQueueStabilizer$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../akka/util/PriorityQueueStabilizer$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../akka/util/PriorityQueueStabilizer$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
15. [**](../../akka/util/PriorityQueueStabilizer$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
...
18. [**](../../akka/util/PriorityQueueStabilizer$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
- https://doc.akka.io/api/akka-core/2.10.17/akka/util/PriorityQueueStabilizer$$WrappedElementComparator.html
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.17/akka/util/PriorityQueueStabilizer$.html](https://doc.akka.io/api/akka-core/2.10.17/akka/util/PriorityQueueStabilizer$.html)*