---
description: Akka 2.9.8 - akka.actor.typed.scaladsl.ActorContext
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:31:30Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/typed/scaladsl/ActorContext.html
title: Akka 2.9.8 - akka.actor.typed.scaladsl.ActorContext
---

# Akka 2.9.8 - akka.actor.typed.scaladsl.ActorContext

> **Summary:** Akka 2.9.8 - akka.actor.typed.scaladsl.ActorContext
...
Annotations@[DoNotInherit](../../../annotation/DoNotInherit.html)() Source[ActorContext.scala](https://github.com/akka/akka/tree/v2.9.8/akka-actor-typed/src/main/scala/akka/actor/typed/scaladsl/ActorContext.scala#L42)Linear Supertypes[ClassicActorContextProvider](../../ClassicActorContextProvider.html), [TypedActorContext](../TypedActorContext.html)\[T], [AnyRef](https://www.scala-lang.org/api/2.13.14/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.14/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ActorContext
...
actor message processing thread, such as [scala.concurrent.Future](https://www.scala-lang.org/api/2.13.14/scala/concurrent/Future.html) callbacks.
...
3. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#ask[Req,Res](target:akka.actor.typed.RecipientRef[Req],createRequest:akka.actor.typed.ActorRef[Res]=>Req)(mapResponse:scala.util.Try[Res]=>T)(implicitresponseTimeout:akka.util.Timeout,implicitclassTag:scala.reflect.ClassTag[Res]):Unit "Permalink") abstract  def ask\[Req, Res](target: [RecipientRef](../RecipientRef.html)\[Req], createRequest: ([ActorRef](../ActorRef.html)\[Res]) \=\> Req)(mapResponse: ([Try](https://www.scala-lang.org/api/2.13.14/scala/util/Try.html#scala.util.Try)\[Res]) \=\> T)(implicit responseTimeout: [Timeout](../../../util/Timeout.html), classTag: [ClassTag](https://www.scala-lang.org/api/2.13.14/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[Res]): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)Perform a single request\-response message interaction with another actor, and transform the messages back to
...
4. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#askWithStatus[Req,Res](target:akka.actor.typed.RecipientRef[Req],createRequest:akka.actor.typed.ActorRef[akka.pattern.StatusReply[Res]]=>Req)(mapResponse:scala.util.Try[Res]=>T)(implicitresponseTimeout:akka.util.Timeout,implicitclassTag:scala.reflect.ClassTag[Res]):Unit "Permalink") abstract  def askWithStatus\[Req, Res](target: [RecipientRef](../RecipientRef.html)\[Req], createRequest: ([ActorRef](../ActorRef.html)\[[StatusReply](../../../pattern/StatusReply.html)\[Res]]) \=\> Req)(mapResponse: ([Try](https://www.scala-lang.org/api/2.13.14/scala/util/Try.html#scala.util.Try)\[Res]) \=\> T)(implicit responseTimeout: [Timeout](../../../util/Timeout.html), classTag: [ClassTag](https://www.scala-lang.org/api/2.13.14/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[Res]): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)The same as [ask](#ask[Req,Res](target:akka.actor.typed.RecipientRef[Req],createRequest:akka.actor.typed.ActorRef[Res]=>Req)(mapResponse:scala.util.Try[Res]=>T)(implicitresponseTimeout:akka.util.Timeout,implicitclassTag:scala.reflect.ClassTag[Res]):Unit) but only for requests that result in a response of type [akka.pattern.StatusReply](../../../pattern/StatusReply.html).
...
5. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#cancelReceiveTimeout():Unit "Permalink") abstract  def cancelReceiveTimeout(): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)Cancel the sending of receive timeout notifications.

Cancel the sending of receive timeout notifications.

\*Warning\*: This method is not thread\-safe and must not be accessed from threads other
than the ordinary actor message processing thread, such as [scala.concurrent.Future](https://www.scala-lang.org/api/2.13.14/scala/concurrent/Future.html) callbacks.
6. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#child(name:String):Option[akka.actor.typed.ActorRef[Nothing]] "Permalink") abstract  def child(name: String): [Option](https://www.scala-lang.org/api/2.13.14/scala/Option.html#scala.Option)\[[ActorRef](../ActorRef.html)\[[Nothing](https://www.scala-lang.org/api/2.13.14/scala/Nothing.html#scala.Nothing)]]The named child Actor if it is alive.

The named child Actor if it is alive.

\*Warning\*: This method is not thread\-safe and must not be accessed from threads other
than the ordinary actor message processing thread, such as [scala.concurrent.Future](https://www.scala-lang.org/api/2.13.14/scala/concurrent/Future.html) callbacks.
7. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#children:Iterable[akka.actor.typed.ActorRef[Nothing]] "Permalink") abstract  def children: Iterable\[[ActorRef](../ActorRef.html)\[[Nothing](https://www.scala-lang.org/api/2.13.14/scala/Nothing.html#scala.Nothing)]]The list of child Actors created by this Actor during its lifetime that
...
9. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#executionContext:scala.concurrent.ExecutionContextExecutor "Permalink") implicit abstract  def executionContext: [ExecutionContextExecutor](https://www.scala-lang.org/api/2.13.14/scala/concurrent/ExecutionContextExecutor.html#scala.concurrent.ExecutionContextExecutor)This Actor’s execution context.

This Actor’s execution context. It can be used to run asynchronous tasks
like [scala.concurrent.Future](https://www.scala-lang.org/api/2.13.14/scala/concurrent/Future.html) operators.
...
\*Warning\*: This method is not thread\-safe and must not be accessed from threads other
than the ordinary actor message processing thread, such as [scala.concurrent.Future](https://www.scala-lang.org/api/2.13.14/scala/concurrent/Future.html) callbacks.
12. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#pipeToSelf[Value](future:scala.concurrent.Future[Value])(mapResult:scala.util.Try[Value]=>T):Unit "Permalink") abstract  def pipeToSelf\[Value](future: [Future](https://www.scala-lang.org/api/2.13.14/scala/concurrent/Future.html#scala.concurrent.Future)\[Value])(mapResult: ([Try](https://www.scala-lang.org/api/2.13.14/scala/util/Try.html#scala.util.Try)\[Value]) \=\> T): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)Sends the result of the given `Future` to this Actor (“`self`”), after adapted it with
the given function.
...
This method is thread\-safe and can be called from other threads than the ordinary
actor message processing thread, such as [scala.concurrent.Future](https://www.scala-lang.org/api/2.13.14/scala/concurrent/Future.html) callbacks.
13. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#scheduleOnce[U](delay:scala.concurrent.duration.FiniteDuration,target:akka.actor.typed.ActorRef[U],msg:U):akka.actor.Cancellable "Permalink") abstract  def scheduleOnce\[U](delay: [FiniteDuration](https://www.scala-lang.org/api/2.13.14/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), target: [ActorRef](../ActorRef.html)\[U], msg: U): [Cancellable](../../Cancellable.html)Schedule the sending of the given message to the given target Actor after
...
This field is thread\-safe and can be called from other threads than the ordinary
actor message processing thread, such as [scala.concurrent.Future](https://www.scala-lang.org/api/2.13.14/scala/concurrent/Future.html) callbacks.
15. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#setLoggerName(clazz:Class[_]):Unit "Permalink") abstract  def setLoggerName(clazz: Class\[\_]): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)Replace the current logger (or initialize a new logger if the logger was not touched before) with one that
...
\*Warning\*: This method is not thread\-safe and must not be accessed from threads other
than the ordinary actor message processing thread, such as [scala.concurrent.Future](https://www.scala-lang.org/api/2.13.14/scala/concurrent/Future.html) callbacks.
16. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#setLoggerName(name:String):Unit "Permalink") abstract  def setLoggerName(name: String): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)Replace the current logger (or initialize a new logger if the logger was not touched before) with one that
...
17. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#setReceiveTimeout(timeout:scala.concurrent.duration.FiniteDuration,msg:T):Unit "Permalink") abstract  def setReceiveTimeout(timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.14/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), msg: T): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)Schedule the sending of a notification in case no other
...
\*Warning\*: This method is not thread\-safe and must not be accessed from threads other
than the ordinary actor message processing thread, such as [scala.concurrent.Future](https://www.scala-lang.org/api/2.13.14/scala/concurrent/Future.html) callbacks.
20. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#stop[U](child:akka.actor.typed.ActorRef[U]):Unit "Permalink") abstract  def stop\[U](child: [ActorRef](../ActorRef.html)\[U]): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)Force the child Actor under the given name to terminate after it finishes
...
21. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#system:akka.actor.typed.ActorSystem[Nothing] "Permalink") implicit abstract  def system: [ActorSystem](../ActorSystem.html)\[[Nothing](https://www.scala-lang.org/api/2.13.14/scala/Nothing.html#scala.Nothing)]The [ActorSystem](../ActorSystem.html) to which this Actor belongs.

The [ActorSystem](../ActorSystem.html) to which this Actor belongs.

This field is thread\-safe and can be called from other threads than the ordinary
actor message processing thread, such as [scala.concurrent.Future](https://www.scala-lang.org/api/2.13.14/scala/concurrent/Future.html) callbacks.
22. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#unwatch[U](other:akka.actor.typed.ActorRef[U]):Unit "Permalink") abstract  def unwatch\[U](other: [ActorRef](../ActorRef.html)\[U]): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)Revoke the registration established by `watch`.
...
\*Warning\*: This method is not thread\-safe and must not be accessed from threads other
than the ordinary actor message processing thread, such as [scala.concurrent.Future](https://www.scala-lang.org/api/2.13.14/scala/concurrent/Future.html) callbacks.
23. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#watch[U](other:akka.actor.typed.ActorRef[U]):Unit "Permalink") abstract  def watch\[U](other: [ActorRef](../ActorRef.html)\[U]): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)Register for [akka.actor.typed.Terminated](../Terminated.html) notification once the Actor identified by the
...
\*Warning\*: This method is not thread\-safe and must not be accessed from threads other
than the ordinary actor message processing thread, such as [scala.concurrent.Future](https://www.scala-lang.org/api/2.13.14/scala/concurrent/Future.html) callbacks.
24. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#watchWith[U](other:akka.actor.typed.ActorRef[U],msg:T):Unit "Permalink") abstract  def watchWith\[U](other: [ActorRef](../ActorRef.html)\[U], msg: T): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)Register for termination notification with a custom message once the Actor identified by the
given [ActorRef](../ActorRef.html) terminates.
...
1. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.14/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.14/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.14/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
5. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.14/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.14/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
7. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.14/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ActorContext\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.14/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.14/scala/Any.html#scala.Any)): ActorContext\[T]ImplicitThis member is added by an implicit conversion from ActorContext\[T] toEnsuring\[ActorContext\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ActorContext\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.14/scala/Boolean.html#scala.Boolean)): ActorContext\[T]ImplicitThis member is added by an implicit conversion from ActorContext\[T] toEnsuring\[ActorContext\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.14/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.14/scala/Any.html#scala.Any)): ActorContext\[T]ImplicitThis member is added by an implicit conversion from ActorContext\[T] toEnsuring\[ActorContext\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.14/scala/Boolean.html#scala.Boolean)): ActorContext\[T]ImplicitThis member is added by an implicit conversion from ActorContext\[T] toEnsuring\[ActorContext\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.14/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.14/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.14/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.14/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
15. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.14/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.14/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.14/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.14/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
...
22. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.14/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.14/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.14/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../akka/actor/typed/scaladsl/ActorContext.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.14/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
- https://doc.akka.io/api/akka-core/2.9/akka/actor/ActorRef.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/ActorSystem.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/Cancellable.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/ClassicActorContextProvider.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/index.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/ActorRef.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/ActorSystem.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/Behavior$.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/Behavior.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/Props.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/RecipientRef.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/Terminated.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/TypedActorContext.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/index.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/javadsl/ActorContext.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/scaladsl/AbstractBehavior.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/scaladsl/ActorContext.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/scaladsl/AskPattern$.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/scaladsl/Behaviors$.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/scaladsl/GroupRouter.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/scaladsl/PoolRouter.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/scaladsl/Routers$.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/scaladsl/StashBuffer.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/scaladsl/StashOverflowException.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/scaladsl/TimerScheduler.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/scaladsl/adapter/index.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/scaladsl/index.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/scaladsl/package$$LoggerOps.html
- https://doc.akka.io/api/akka-core/2.9/akka/annotation/DoNotInherit.html
- https://doc.akka.io/api/akka-core/2.9/akka/index.html
- https://doc.akka.io/api/akka-core/2.9/akka/pattern/StatusReply$$Error$.html
- https://doc.akka.io/api/akka-core/2.9/akka/pattern/StatusReply$$ErrorMessage.html
- https://doc.akka.io/api/akka-core/2.9/akka/pattern/StatusReply$$Success$.html
- https://doc.akka.io/api/akka-core/2.9/akka/pattern/StatusReply.html
- https://doc.akka.io/api/akka-core/2.9/akka/util/Timeout.html
- https://doc.akka.io/api/akka-core/2.9/index.html

---
*Source: [https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/scaladsl/ActorContext.html](https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/scaladsl/ActorContext.html)*