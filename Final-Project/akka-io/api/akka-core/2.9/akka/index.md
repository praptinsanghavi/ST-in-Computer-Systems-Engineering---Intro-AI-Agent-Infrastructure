---
description: Akka 2.9.8 - akka
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:31:09Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/index.html
title: Akka 2.9.8 - akka
---

# Akka 2.9.8 - akka

> **Summary:** Akka 2.9.8 - akka
...
4. [**](../akka/NotUsed.html "Permalink") sealed abstract  class [NotUsed](NotUsed.html "This type is used in generic type signatures wherever the actual value is of no importance.") extends [AnyRef](https://www.scala-lang.org/api/2.13.14/scala/AnyRef.html#scala.AnyRef)This type is used in generic type signatures wherever the actual value is of no importance.
...
5. [**](../akka/OnlyCauseStackTrace.html "Permalink")  trait [OnlyCauseStackTrace](OnlyCauseStackTrace.html "Mix in this trait to suppress the StackTrace for the instance of the exception but not the cause, scala.util.control.NoStackTrace suppresses all the StackTraces.") extends [AnyRef](https://www.scala-lang.org/api/2.13.14/scala/AnyRef.html#scala.AnyRef)Mix in this trait to suppress the StackTrace for the instance of the exception but not the cause,
...
2. [**](../akka/Done$.html "Permalink")  case object [Done](Done$.html) extends [Done](Done.html) with [Product](https://www.scala-lang.org/api/2.13.14/scala/Product.html#scala.Product) with Serializable
3. [**](../akka/NotUsed$.html "Permalink")  case object [NotUsed](NotUsed$.html) extends [NotUsed](NotUsed.html) with [Product](https://www.scala-lang.org/api/2.13.14/scala/Product.html#scala.Product) with Serializable
4. [**](../akka/Version$.html "Permalink")  object [Version](Version$.html)
### Ungrouped

## Related Pages (Internal Links)

- https://doc.akka.io/api/akka-core/2.9/akka/AkkaException.html
- https://doc.akka.io/api/akka-core/2.9/akka/AkkaVersion$.html
- https://doc.akka.io/api/akka-core/2.9/akka/ConfigurationException.html
- https://doc.akka.io/api/akka-core/2.9/akka/Done$.html
- https://doc.akka.io/api/akka-core/2.9/akka/Done.html
- https://doc.akka.io/api/akka-core/2.9/akka/NotUsed$.html
- https://doc.akka.io/api/akka-core/2.9/akka/NotUsed.html
- https://doc.akka.io/api/akka-core/2.9/akka/OnlyCauseStackTrace.html
- https://doc.akka.io/api/akka-core/2.9/akka/UnsupportedAkkaVersion.html
- https://doc.akka.io/api/akka-core/2.9/akka/Version$.html
...
- https://doc.akka.io/api/akka-core/2.9/akka/pki/index.html
- https://doc.akka.io/api/akka-core/2.9/akka/remote/index.html
- https://doc.akka.io/api/akka-core/2.9/akka/routing/index.html
- https://doc.akka.io/api/akka-core/2.9/akka/serialization/index.html
- https://doc.akka.io/api/akka-core/2.9/akka/stream/index.html
- https://doc.akka.io/api/akka-core/2.9/akka/testkit/index.html
- https://doc.akka.io/api/akka-core/2.9/akka/util/index.html
- https://doc.akka.io/api/akka-core/2.9/index.html

---
*Source: [https://doc.akka.io/api/akka-core/2.9/akka/index.html](https://doc.akka.io/api/akka-core/2.9/akka/index.html)*