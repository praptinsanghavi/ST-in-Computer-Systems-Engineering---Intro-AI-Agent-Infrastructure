---
description: Akka 2.9.8 - akka.persistence.typed.state
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:31:14Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/persistence/typed/state/index.html
title: Akka 2.9.8 - akka.persistence.typed.state
---

# Akka 2.9.8 - akka.persistence.typed.state

> **Summary:** Akka 2.9.8 - akka.persistence.typed.state
...
3. [**](../../../../akka/persistence/typed/state/RecoveryFailed.html "Permalink") final  case class [RecoveryFailed](RecoveryFailed.html)(failure: Throwable) extends [DurableStateSignal](DurableStateSignal.html) with [Product](https://www.scala-lang.org/api/2.13.14/scala/Product.html#scala.Product) with Serializable
### Value Members

1. [**](../../../../akka/persistence/typed/state/RecoveryCompleted$.html "Permalink")  case object [RecoveryCompleted](RecoveryCompleted$.html) extends [RecoveryCompleted](RecoveryCompleted.html) with [Product](https://www.scala-lang.org/api/2.13.14/scala/Product.html#scala.Product) with Serializable
### Ungrouped
...
- https://doc.akka.io/api/akka-core/2.9/akka/persistence/typed/state/RecoveryCompleted$.html
- https://doc.akka.io/api/akka-core/2.9/akka/persistence/typed/state/RecoveryCompleted.html
- https://doc.akka.io/api/akka-core/2.9/akka/persistence/typed/state/RecoveryFailed.html
...
---
*Source: [https://doc.akka.io/api/akka-core/2.9/akka/persistence/typed/state/index.html](https://doc.akka.io/api/akka-core/2.9/akka/persistence/typed/state/index.html)*