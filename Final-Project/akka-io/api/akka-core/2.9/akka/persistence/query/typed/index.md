---
description: Akka 2.9.8 - akka.persistence.query.typed
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:44:12Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/persistence/query/typed/index.html
title: Akka 2.9.8 - akka.persistence.query.typed
---

# Akka 2.9.8 - akka.persistence.query.typed

> **Summary:** Akka 2.9.8 - akka.persistence.query.typed
...
1. [**](../../../../akka/persistence/query/typed/EventEnvelope.html "Permalink") final  class [EventEnvelope](EventEnvelope.html "Event wrapper adding meta data for the events in the result stream of akka.persistence.query.typed.scaladsl.EventsBySliceQuery query, or similar queries.")\[Event] extends [AnyRef](https://www.scala-lang.org/api/2.13.14/scala/AnyRef.html#scala.AnyRef)Event wrapper adding meta data for the events in the result stream of
...
---
*Source: [https://doc.akka.io/api/akka-core/2.9/akka/persistence/query/typed/index.html](https://doc.akka.io/api/akka-core/2.9/akka/persistence/query/typed/index.html)*