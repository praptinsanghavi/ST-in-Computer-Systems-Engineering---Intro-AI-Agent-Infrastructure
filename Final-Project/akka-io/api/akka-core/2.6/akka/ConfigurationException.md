---
description: Akka 2.6.21 - akka.ConfigurationException
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:23:21Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/ConfigurationException.html
title: Akka 2.6.21 - akka.ConfigurationException
---

# Akka 2.6.21 - akka.ConfigurationException

> **Summary:** Akka 2.6.21 - akka.ConfigurationException
...
1. [**](../akka/ConfigurationException.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../akka/ConfigurationException.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
5. [**](../akka/ConfigurationException.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
8. [**](../akka/ConfigurationException.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
9. [**](../akka/ConfigurationException.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ConfigurationException) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ConfigurationExceptionImplicitThis member is added by an implicit conversion from ConfigurationException toEnsuring\[ConfigurationException] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../akka/ConfigurationException.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ConfigurationException) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ConfigurationExceptionImplicitThis member is added by an implicit conversion from ConfigurationException toEnsuring\[ConfigurationException] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../akka/ConfigurationException.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ConfigurationExceptionImplicitThis member is added by an implicit conversion from ConfigurationException toEnsuring\[ConfigurationException] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../akka/ConfigurationException.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ConfigurationExceptionImplicitThis member is added by an implicit conversion from ConfigurationException toEnsuring\[ConfigurationException] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../akka/ConfigurationException.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../akka/ConfigurationException.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
22. [**](../akka/ConfigurationException.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
...
24. [**](../akka/ConfigurationException.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
25. [**](../akka/ConfigurationException.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
26. [**](../akka/ConfigurationException.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
27. [**](../akka/ConfigurationException.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
...
30. [**](../akka/ConfigurationException.html#printStackTrace():Unit "Permalink")  def printStackTrace(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesThrowable
...
36. [**](../akka/ConfigurationException.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../akka/ConfigurationException.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
...
- https://doc.akka.io/api/akka-core/2.6/akka/AkkaVersion$.html
...
- https://doc.akka.io/api/akka-core/2.6/akka/NotUsed.html
- https://doc.akka.io/api/akka-core/2.6/akka/OnlyCauseStackTrace.html
- https://doc.akka.io/api/akka-core/2.6/akka/UnsupportedAkkaVersion.html
- https://doc.akka.io/api/akka-core/2.6/akka/Version$.html
...
- https://doc.akka.io/api/akka-core/2.6/akka/annotation/index.html
- https://doc.akka.io/api/akka-core/2.6/akka/cluster/index.html
- https://doc.akka.io/api/akka-core/2.6/akka/coordination/index.html
- https://doc.akka.io/api/akka-core/2.6/akka/discovery/index.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/index.html
...
- https://doc.akka.io/api/akka-core/2.6/akka/japi/index.html
- https://doc.akka.io/api/akka-core/2.6/akka/osgi/index.html
- https://doc.akka.io/api/akka-core/2.6/akka/pattern/Patterns$.html
- https://doc.akka.io/api/akka-core/2.6/akka/pattern/index.html
- https://doc.akka.io/api/akka-core/2.6/akka/persistence/index.html
- https://doc.akka.io/api/akka-core/2.6/akka/pki/index.html
- https://doc.akka.io/api/akka-core/2.6/akka/remote/index.html
- https://doc.akka.io/api/akka-core/2.6/akka/routing/index.html
- https://doc.akka.io/api/akka-core/2.6/akka/serialization/index.html
- https://doc.akka.io/api/akka-core/2.6/akka/stream/index.html
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/ConfigurationException.html](https://doc.akka.io/api/akka-core/2.6/akka/ConfigurationException.html)*