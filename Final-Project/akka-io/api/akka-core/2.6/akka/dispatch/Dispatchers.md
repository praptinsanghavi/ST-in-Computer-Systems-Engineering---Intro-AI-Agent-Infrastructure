---
description: Akka 2.6.21 - akka.dispatch.Dispatchers
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:23:19Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/dispatch/Dispatchers.html
title: Akka 2.6.21 - akka.dispatch.Dispatchers
---

# Akka 2.6.21 - akka.dispatch.Dispatchers

> **Summary:** Akka 2.6.21 - akka.dispatch.Dispatchers
...
#### class Dispatchers extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)
...
Annotations@[DoNotInherit](../annotation/DoNotInherit.html)() Source[Dispatchers.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/dispatch/Dispatchers.scala#L103)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Dispatchers
2. AnyRef
...
1. [**](../../akka/dispatch/Dispatchers.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/Dispatchers.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
5. [**](../../akka/dispatch/Dispatchers.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
8. [**](../../akka/dispatch/Dispatchers.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
...
11. [**](../../akka/dispatch/Dispatchers.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (Dispatchers) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): DispatchersImplicitThis member is added by an implicit conversion from Dispatchers toEnsuring\[Dispatchers] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/dispatch/Dispatchers.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (Dispatchers) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): DispatchersImplicitThis member is added by an implicit conversion from Dispatchers toEnsuring\[Dispatchers] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/dispatch/Dispatchers.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): DispatchersImplicitThis member is added by an implicit conversion from Dispatchers toEnsuring\[Dispatchers] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/dispatch/Dispatchers.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): DispatchersImplicitThis member is added by an implicit conversion from Dispatchers toEnsuring\[Dispatchers] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/dispatch/Dispatchers.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
16. [**](../../akka/dispatch/Dispatchers.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
18. [**](../../akka/dispatch/Dispatchers.html#hasDispatcher(id:String):Boolean "Permalink")  def hasDispatcher(id: String): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Checks that the configuration provides a section for the given dispatcher.
...
19. [**](../../akka/dispatch/Dispatchers.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
20. [**](../../akka/dispatch/Dispatchers.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
...
22. [**](../../akka/dispatch/Dispatchers.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
23. [**](../../akka/dispatch/Dispatchers.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
24. [**](../../akka/dispatch/Dispatchers.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
...
26. [**](../../akka/dispatch/Dispatchers.html#registerConfigurator(id:String,configurator:akka.dispatch.MessageDispatcherConfigurator):Boolean "Permalink")  def registerConfigurator(id: String, configurator: [MessageDispatcherConfigurator](MessageDispatcherConfigurator.html)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Register a [MessageDispatcherConfigurator](MessageDispatcherConfigurator.html) that will be
...
30. [**](../../akka/dispatch/Dispatchers.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
31. [**](../../akka/dispatch/Dispatchers.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
32. [**](../../akka/dispatch/Dispatchers.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/Dispatchers.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
...
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/AbstractBoundedNodeQueue.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/AbstractNodeQueue.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BalancingDispatcherConfigurator.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BoundedControlAwareMailbox$.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BoundedControlAwareMailbox.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BoundedControlAwareMessageQueueSemantics.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BoundedDequeBasedMailbox$.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BoundedDequeBasedMailbox.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BoundedDequeBasedMessageQueue.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BoundedDequeBasedMessageQueueSemantics.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BoundedMailbox$.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BoundedMailbox.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BoundedMessageQueueSemantics.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BoundedNodeMessageQueue.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BoundedPriorityMailbox$.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BoundedPriorityMailbox.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BoundedQueueBasedMessageQueue.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BoundedStablePriorityMailbox$.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/BoundedStablePriorityMailbox.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/ControlAwareMessageQueueSemantics.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/ControlMessage.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/DefaultExecutorServiceConfigurator.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/DequeBasedMessageQueue.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/DequeBasedMessageQueueSemantics.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/Dispatcher.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/DispatcherConfigurator.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/DispatcherPrerequisites.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/Dispatchers$.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/Dispatchers.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/Envelope$.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/Envelope.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/ExecutionContexts$.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/ExecutorServiceConfigurator.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/ExecutorServiceDelegate.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/ExecutorServiceFactory.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/ExecutorServiceFactoryProvider.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/Filter$.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/Foreach.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/ForkJoinExecutorConfigurator$.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/ForkJoinExecutorConfigurator.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/Futures$.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/MailboxType.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/Mailboxes$.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/Mapper.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/MessageDispatcher.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/MessageDispatcherConfigurator.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/MessageQueue.html
- https://doc.akka.io/api/akka-core/2.6/akka/dispatch/MonitorableThreadFactory$.html

---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/dispatch/Dispatchers.html](https://doc.akka.io/api/akka-core/2.6/akka/dispatch/Dispatchers.html)*