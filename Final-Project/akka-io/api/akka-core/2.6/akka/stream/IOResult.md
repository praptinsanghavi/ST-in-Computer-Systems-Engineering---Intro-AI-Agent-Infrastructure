---
description: Akka 2.6.21 - akka.stream.IOResult
knowledge_type: official_documentation
scraped_at: '2026-04-06T03:15:23Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/stream/IOResult.html
title: Akka 2.6.21 - akka.stream.IOResult
---

# Akka 2.6.21 - akka.stream.IOResult

> **Summary:** Akka 2.6.21 - akka.stream.IOResult
...
[c](IOResult$.html "See companion object")[akka](../index.html).[stream](index.html)

# [IOResult](IOResult$.html "See companion object")[**](../../akka/stream/IOResult.html "Permalink")

### Companion [object IOResult](IOResult$.html "See companion object")

#### final  case class IOResult(count: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), status: [Try](https://www.scala-lang.org/api/2.13.8/scala/util/Try.html#scala.util.Try)\[[Done](../Done.html)]) extends [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with Serializable
...
1. [**](../../akka/stream/IOResult.html#<init>(count:Long,status:scala.util.Try[akka.Done]):akka.stream.IOResult "Permalink")  new IOResult(count: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), status: [Try](https://www.scala-lang.org/api/2.13.8/scala/util/Try.html#scala.util.Try)\[[Done](../Done.html)])countNumeric value depending on context, for example IO operations performed or bytes processed.

statusStatus of the result. Can be either [akka.Done](../Done.html) or an exception.
### Value Members

1. [**](../../akka/stream/IOResult.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/stream/IOResult.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/stream/IOResult.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from IOResult toany2stringadd\[IOResult] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/stream/IOResult.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (IOResult, B)ImplicitThis member is added by an implicit conversion from IOResult toArrowAssoc\[IOResult] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/stream/IOResult.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/stream/IOResult.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/stream/IOResult.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
8. [**](../../akka/stream/IOResult.html#count:Long "Permalink")  val count: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)
9. [**](../../akka/stream/IOResult.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (IOResult) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): IOResultImplicitThis member is added by an implicit conversion from IOResult toEnsuring\[IOResult] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/stream/IOResult.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (IOResult) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): IOResultImplicitThis member is added by an implicit conversion from IOResult toEnsuring\[IOResult] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/stream/IOResult.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): IOResultImplicitThis member is added by an implicit conversion from IOResult toEnsuring\[IOResult] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/stream/IOResult.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): IOResultImplicitThis member is added by an implicit conversion from IOResult toEnsuring\[IOResult] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/stream/IOResult.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/stream/IOResult.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
15. [**](../../akka/stream/IOResult.html#getCount:Long "Permalink")  def getCount: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)Java API: Numeric value depending on context, for example IO operations performed or bytes processed.
16. [**](../../akka/stream/IOResult.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/stream/IOResult.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/stream/IOResult.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
19. [**](../../akka/stream/IOResult.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
20. [**](../../akka/stream/IOResult.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
21. [**](../../akka/stream/IOResult.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../akka/stream/IOResult.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/stream/IOResult.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/stream/IOResult.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
25. [**](../../akka/stream/IOResult.html#withCount(value:Long):akka.stream.IOResult "Permalink")  def withCount(value: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): IOResult
### Deprecated Value Members

1. [**](../../akka/stream/IOResult.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/stream/IOResult.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from IOResult toStringFormat\[IOResult] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/stream/IOResult.html#getError:Throwable "Permalink")  def getError: ThrowableJava API: If the IO operation resulted in an error, returns the corresponding Throwable
...
Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* status is always set to Success(Done)
4. [**](../../akka/stream/IOResult.html#status:scala.util.Try[akka.Done] "Permalink")  val status: [Try](https://www.scala-lang.org/api/2.13.8/scala/util/Try.html#scala.util.Try)\[[Done](../Done.html)]Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* status is always set to Success(Done)
5. [**](../../akka/stream/IOResult.html#wasSuccessful:Boolean "Permalink")  def wasSuccessful: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Java API: Indicates whether IO operation completed successfully or not.

Java API: Indicates whether IO operation completed successfully or not.

Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* status is always set to Success(Done)
6. [**](../../akka/stream/IOResult.html#withStatus(value:scala.util.Try[akka.Done]):akka.stream.IOResult "Permalink")  def withStatus(value: [Try](https://www.scala-lang.org/api/2.13.8/scala/util/Try.html#scala.util.Try)\[[Done](../Done.html)]): IOResultAnnotations@deprecated Deprecated*(Since version 2\.6\.0\)* status is always set to Success(Done)
7. [**](../../akka/stream/IOResult.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (IOResult, B)ImplicitThis member is added by an implicit conversion from IOResult toArrowAssoc\[IOResult] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromIOResult to any2stringadd\[IOResult]

### Inherited by implicit conversion StringFormat fromIOResult to StringFormat\[IOResult]

### Inherited by implicit conversion Ensuring fromIOResult to Ensuring\[IOResult]

### Inherited by implicit conversion ArrowAssoc fromIOResult to ArrowAssoc\[IOResult]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/stream/IOResult.html](https://doc.akka.io/api/akka-core/2.6/akka/stream/IOResult.html)*