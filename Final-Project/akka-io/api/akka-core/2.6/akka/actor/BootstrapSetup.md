---
description: Akka 2.6.21 - akka.actor.BootstrapSetup
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:19:05Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/BootstrapSetup.html
title: Akka 2.6.21 - akka.actor.BootstrapSetup
---

# Akka 2.6.21 - akka.actor.BootstrapSetup

> **Summary:** Akka 2.6.21 - akka.actor.BootstrapSetup
...
Source[ActorSystem.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/ActorSystem.scala#L149)Linear Supertypes[Setup](setup/Setup.html), [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. BootstrapSetup
2. Setup
...
1. [**](../../akka/actor/BootstrapSetup.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/BootstrapSetup.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
5. [**](../../akka/actor/BootstrapSetup.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/BootstrapSetup.html#actorRefProvider:Option[akka.actor.ProviderSelection] "Permalink")  val actorRefProvider: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[ProviderSelection](ProviderSelection.html)]
...
9. [**](../../akka/actor/BootstrapSetup.html#classLoader:Option[ClassLoader] "Permalink")  val classLoader: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)]
10. [**](../../akka/actor/BootstrapSetup.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
11. [**](../../akka/actor/BootstrapSetup.html#config:Option[com.typesafe.config.Config] "Permalink")  val config: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[Config]
12. [**](../../akka/actor/BootstrapSetup.html#defaultExecutionContext:Option[scala.concurrent.ExecutionContext] "Permalink")  val defaultExecutionContext: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[ExecutionContext](https://www.scala-lang.org/api/2.13.8/scala/concurrent/ExecutionContext.html#scala.concurrent.ExecutionContext)]
13. [**](../../akka/actor/BootstrapSetup.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (BootstrapSetup) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): BootstrapSetupImplicitThis member is added by an implicit conversion from BootstrapSetup toEnsuring\[BootstrapSetup] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/actor/BootstrapSetup.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (BootstrapSetup) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): BootstrapSetupImplicitThis member is added by an implicit conversion from BootstrapSetup toEnsuring\[BootstrapSetup] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/actor/BootstrapSetup.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): BootstrapSetupImplicitThis member is added by an implicit conversion from BootstrapSetup toEnsuring\[BootstrapSetup] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/actor/BootstrapSetup.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): BootstrapSetupImplicitThis member is added by an implicit conversion from BootstrapSetup toEnsuring\[BootstrapSetup] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../akka/actor/BootstrapSetup.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/BootstrapSetup.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
20. [**](../../akka/actor/BootstrapSetup.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
21. [**](../../akka/actor/BootstrapSetup.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
22. [**](../../akka/actor/BootstrapSetup.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
23. [**](../../akka/actor/BootstrapSetup.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
24. [**](../../akka/actor/BootstrapSetup.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
...
27. [**](../../akka/actor/BootstrapSetup.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../akka/actor/BootstrapSetup.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
29. [**](../../akka/actor/BootstrapSetup.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
33. [**](../../akka/actor/BootstrapSetup.html#withDefaultExecutionContext(executionContext:scala.concurrent.ExecutionContext):akka.actor.BootstrapSetup "Permalink")  def withDefaultExecutionContext(executionContext: [ExecutionContext](https://www.scala-lang.org/api/2.13.8/scala/concurrent/ExecutionContext.html#scala.concurrent.ExecutionContext)): BootstrapSetup
### Deprecated Value Members

1. [**](../../akka/actor/BootstrapSetup.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/BootstrapSetup.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/BootstrapSetup.html)*