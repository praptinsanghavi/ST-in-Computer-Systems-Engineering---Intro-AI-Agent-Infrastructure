---
description: Akka 2.6.21 - akka.actor.UnhandledMessage
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:14:26Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/UnhandledMessage.html
title: Akka 2.6.21 - akka.actor.UnhandledMessage
---

# Akka 2.6.21 - akka.actor.UnhandledMessage

> **Summary:** Akka 2.6.21 - akka.actor.UnhandledMessage
...
#### final  case class UnhandledMessage(message: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), sender: [ActorRef](ActorRef.html), recipient: [ActorRef](ActorRef.html)) extends [NoSerializationVerificationNeeded](NoSerializationVerificationNeeded.html) with [WrappedMessage](WrappedMessage.html) with [AllDeadLetters](AllDeadLetters.html) with [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with Serializable

This message is published to the EventStream whenever an Actor receives a message it doesn't understand

Annotations@SerialVersionUID() Source[Actor.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/Actor.scala#L287)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.8/scala/Equals.html#scala.Equals), [AllDeadLetters](AllDeadLetters.html), [WrappedMessage](WrappedMessage.html), [NoSerializationVerificationNeeded](NoSerializationVerificationNeeded.html), [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. UnhandledMessage
2. Serializable
...
1. [**](../../akka/actor/UnhandledMessage.html#<init>(message:Any,sender:akka.actor.ActorRef,recipient:akka.actor.ActorRef):akka.actor.UnhandledMessage "Permalink")  new UnhandledMessage(message: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), sender: [ActorRef](ActorRef.html), recipient: [ActorRef](ActorRef.html))
### Value Members

1. [**](../../akka/actor/UnhandledMessage.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/UnhandledMessage.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
5. [**](../../akka/actor/UnhandledMessage.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/UnhandledMessage.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/UnhandledMessage.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
8. [**](../../akka/actor/UnhandledMessage.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (UnhandledMessage) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): UnhandledMessageImplicitThis member is added by an implicit conversion from UnhandledMessage toEnsuring\[UnhandledMessage] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/actor/UnhandledMessage.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (UnhandledMessage) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): UnhandledMessageImplicitThis member is added by an implicit conversion from UnhandledMessage toEnsuring\[UnhandledMessage] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/UnhandledMessage.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): UnhandledMessageImplicitThis member is added by an implicit conversion from UnhandledMessage toEnsuring\[UnhandledMessage] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/UnhandledMessage.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): UnhandledMessageImplicitThis member is added by an implicit conversion from UnhandledMessage toEnsuring\[UnhandledMessage] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/UnhandledMessage.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
...
14. [**](../../akka/actor/UnhandledMessage.html#getMessage():Any "Permalink")  def getMessage(): [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Annotations@BeanProperty()
...
17. [**](../../akka/actor/UnhandledMessage.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
18. [**](../../akka/actor/UnhandledMessage.html#message:Any "Permalink")  val message: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Definition ClassesUnhandledMessage → [AllDeadLetters](AllDeadLetters.html) → [WrappedMessage](WrappedMessage.html)
19. [**](../../akka/actor/UnhandledMessage.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
20. [**](../../akka/actor/UnhandledMessage.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
21. [**](../../akka/actor/UnhandledMessage.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
...
26. [**](../../akka/actor/UnhandledMessage.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
27. [**](../../akka/actor/UnhandledMessage.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
28. [**](../../akka/actor/UnhandledMessage.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/UnhandledMessage.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/UnhandledMessage.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/UnhandledMessage.html)*