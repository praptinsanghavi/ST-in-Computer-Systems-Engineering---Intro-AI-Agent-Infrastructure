...
scraped_at: '2026-04-06T14:18:49Z'
section: api
site: akka-io
...
[o](ActorSystem.html "See companion class")[akka](../index.html).[actor](index.html)

# [ActorSystem](ActorSystem.html "See companion class")[**](../../akka/actor/ActorSystem$.html "Permalink")

### Companion [class ActorSystem](ActorSystem.html "See companion class")

#### object ActorSystem

Source[ActorSystem.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/ActorSystem.scala#L170)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ActorSystem
2. AnyRef
...
1. [**](../../akka/actor/ActorSystem$$Settings.html "Permalink")  class [Settings](ActorSystem$$Settings.html "Settings are the overall ActorSystem Settings which also provides a convenient access to the Config object.") extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Settings are the overall ActorSystem Settings which also provides a convenient access to the Config object.
...
3. [**](../../akka/actor/ActorSystem$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/actor/ActorSystem$.html#Version:String "Permalink")  val Version: String
5. [**](../../akka/actor/ActorSystem$.html#apply(name:String,config:Option[com.typesafe.config.Config],classLoader:Option[ClassLoader],defaultExecutionContext:Option[scala.concurrent.ExecutionContext]):akka.actor.ActorSystem "Permalink")  def apply(name: String, config: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[Config] \= None, classLoader: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)] \= None, defaultExecutionContext: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[ExecutionContext](https://www.scala-lang.org/api/2.13.8/scala/concurrent/ExecutionContext.html#scala.concurrent.ExecutionContext)] \= None): [ActorSystem](ActorSystem.html)Creates a new ActorSystem with the specified name,
...
See also[The Typesafe Config Library API Documentation](https://lightbend.github.io/config/latest/api/index.html)
6. [**](../../akka/actor/ActorSystem$.html#apply(name:String,config:com.typesafe.config.Config,classLoader:ClassLoader):akka.actor.ActorSystem "Permalink")  def apply(name: String, config: Config, classLoader: [ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)): [ActorSystem](ActorSystem.html)Creates a new ActorSystem with the specified name, the specified Config, and specified ClassLoader

Creates a new ActorSystem with the specified name, the specified Config, and specified ClassLoader

See also[The Typesafe Config Library API Documentation](https://lightbend.github.io/config/latest/api/index.html)
7. [**](../../akka/actor/ActorSystem$.html#apply(name:String,config:com.typesafe.config.Config):akka.actor.ActorSystem "Permalink")  def apply(name: String, config: Config): [ActorSystem](ActorSystem.html)Creates a new ActorSystem with the specified name, and the specified Config, then
...
See also[The Typesafe Config Library API Documentation](https://lightbend.github.io/config/latest/api/index.html)
8. [**](../../akka/actor/ActorSystem$.html#apply(name:String,bootstrapSetup:akka.actor.BootstrapSetup):akka.actor.ActorSystem "Permalink")  def apply(name: String, bootstrapSetup: [BootstrapSetup](BootstrapSetup.html)): [ActorSystem](ActorSystem.html)Scala API: Shortcut for creating an actor system with custom bootstrap settings.
...
9. [**](../../akka/actor/ActorSystem$.html#apply(name:String,setup:akka.actor.setup.ActorSystemSetup):akka.actor.ActorSystem "Permalink")  def apply(name: String, setup: [ActorSystemSetup](setup/ActorSystemSetup.html)): [ActorSystem](ActorSystem.html)Scala API: Creates a new actor system with the specified name and settings
The core actor system settings are defined in [BootstrapSetup](BootstrapSetup.html)
10. [**](../../akka/actor/ActorSystem$.html#apply(name:String):akka.actor.ActorSystem "Permalink")  def apply(name: String): [ActorSystem](ActorSystem.html)Creates a new ActorSystem with the specified name,
obtains the current ClassLoader by first inspecting the current threads' getContextClassLoader,
then tries to walk the stack to find the callers class loader, then falls back to the ClassLoader
associated with the ActorSystem class.
...
11. [**](../../akka/actor/ActorSystem$.html#apply():akka.actor.ActorSystem "Permalink")  def apply(): [ActorSystem](ActorSystem.html)Creates a new ActorSystem with the name "default",
obtains the current ClassLoader by first inspecting the current threads' getContextClassLoader,
then tries to walk the stack to find the callers class loader, then falls back to the ClassLoader
associated with the ActorSystem class.
...
associated with the ActorSystem class.
Then it loads the default reference configuration using the ClassLoader.
12. [**](../../akka/actor/ActorSystem$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
13. [**](../../akka/actor/ActorSystem$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
14. [**](../../akka/actor/ActorSystem$.html#create(name:String,config:com.typesafe.config.Config,classLoader:ClassLoader,defaultExecutionContext:scala.concurrent.ExecutionContext):akka.actor.ActorSystem "Permalink")  def create(name: String, config: Config, classLoader: [ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader), defaultExecutionContext: [ExecutionContext](https://www.scala-lang.org/api/2.13.8/scala/concurrent/ExecutionContext.html#scala.concurrent.ExecutionContext)): [ActorSystem](ActorSystem.html)Creates a new ActorSystem with the specified name, the specified Config, the specified ClassLoader,
...
See also[The Typesafe Config Library API Documentation](https://lightbend.github.io/config/latest/api/index.html)
15. [**](../../akka/actor/ActorSystem$.html#create(name:String,config:com.typesafe.config.Config,classLoader:ClassLoader):akka.actor.ActorSystem "Permalink")  def create(name: String, config: Config, classLoader: [ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)): [ActorSystem](ActorSystem.html)Creates a new ActorSystem with the specified name, the specified Config, and specified ClassLoader

Creates a new ActorSystem with the specified name, the specified Config, and specified ClassLoader

See also[The Typesafe Config Library API Documentation](https://lightbend.github.io/config/latest/api/index.html)
16. [**](../../akka/actor/ActorSystem$.html#create(name:String,config:com.typesafe.config.Config):akka.actor.ActorSystem "Permalink")  def create(name: String, config: Config): [ActorSystem](ActorSystem.html)Creates a new ActorSystem with the specified name, and the specified Config, then
obtains the current ClassLoader by first inspecting the current threads' getContextClassLoader,
then tries to walk the stack to find the callers class loader, then falls back to the ClassLoader
associated with the ActorSystem class.
...
See also[The Typesafe Config Library API Documentation](https://lightbend.github.io/config/latest/api/index.html)
17. [**](../../akka/actor/ActorSystem$.html#create(name:String,bootstrapSetup:akka.actor.BootstrapSetup):akka.actor.ActorSystem "Permalink")  def create(name: String, bootstrapSetup: [BootstrapSetup](BootstrapSetup.html)): [ActorSystem](ActorSystem.html)Java API: Shortcut for creating an actor system with custom bootstrap settings.
...
18. [**](../../akka/actor/ActorSystem$.html#create(name:String,setups:akka.actor.setup.ActorSystemSetup):akka.actor.ActorSystem "Permalink")  def create(name: String, setups: [ActorSystemSetup](setup/ActorSystemSetup.html)): [ActorSystem](ActorSystem.html)Java API: Creates a new actor system with the specified name and settings
The core actor system settings are defined in [BootstrapSetup](BootstrapSetup.html)
19. [**](../../akka/actor/ActorSystem$.html#create(name:String):akka.actor.ActorSystem "Permalink")  def create(name: String): [ActorSystem](ActorSystem.html)Creates a new ActorSystem with the specified name,
obtains the current ClassLoader by first inspecting the current threads' getContextClassLoader,
then tries to walk the stack to find the callers class loader, then falls back to the ClassLoader
associated with the ActorSystem class.
...
associated with the ActorSystem class.
Then it loads the default reference configuration using the ClassLoader.
20. [**](../../akka/actor/ActorSystem$.html#create():akka.actor.ActorSystem "Permalink")  def create(): [ActorSystem](ActorSystem.html)Creates a new ActorSystem with the name "default",
obtains the current ClassLoader by first inspecting the current threads' getContextClassLoader,
then tries to walk the stack to find the callers class loader, then falls back to the ClassLoader
associated with the ActorSystem class.
...
associated with the ActorSystem class.
Then it loads the default reference configuration using the ClassLoader.
21. [**](../../akka/actor/ActorSystem$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
22. [**](../../akka/actor/ActorSystem$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
23. [**](../../akka/actor/ActorSystem$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
24. [**](../../akka/actor/ActorSystem$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
25. [**](../../akka/actor/ActorSystem$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
26. [**](../../akka/actor/ActorSystem$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
27. [**](../../akka/actor/ActorSystem$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
28. [**](../../akka/actor/ActorSystem$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
29. [**](../../akka/actor/ActorSystem$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
30. [**](../../akka/actor/ActorSystem$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
