---
description: Akka 2.6.21 - akka.actor.Address
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:15:08Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/Address.html
title: Akka 2.6.21 - akka.actor.Address
---

# Akka 2.6.21 - akka.actor.Address

> **Summary:** Akka 2.6.21 - akka.actor.Address
...
[c](Address$.html "See companion object")[akka](../index.html).[actor](index.html)

# [Address](Address$.html "See companion object")[**](../../akka/actor/Address.html "Permalink")

### Companion [object Address](Address$.html "See companion object")

#### final  case class Address extends [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with Serializable
...
1. [**](../../akka/actor/Address.html#<init>(protocol:String,system:String,host:String,port:Int):akka.actor.Address "Permalink")  new Address(protocol: String, system: String, host: String, port: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int))
2. [**](../../akka/actor/Address.html#<init>(protocol:String,system:String):akka.actor.Address "Permalink")  new Address(protocol: String, system: String)
### Value Members

1. [**](../../akka/actor/Address.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/Address.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/Address.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from Address toany2stringadd\[Address] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/Address.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (Address, B)ImplicitThis member is added by an implicit conversion from Address toArrowAssoc\[Address] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/Address.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/Address.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/Address.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
8. [**](../../akka/actor/Address.html#copy(protocol:String,system:String,host:Option[String],port:Option[Int]):akka.actor.Address "Permalink")  def copy(protocol: String \= protocol, system: String \= system, host: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[String] \= host, port: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)] \= port): Address
9. [**](../../akka/actor/Address.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (Address) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): AddressImplicitThis member is added by an implicit conversion from Address toEnsuring\[Address] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/Address.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (Address) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): AddressImplicitThis member is added by an implicit conversion from Address toEnsuring\[Address] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/Address.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): AddressImplicitThis member is added by an implicit conversion from Address toEnsuring\[Address] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/Address.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): AddressImplicitThis member is added by an implicit conversion from Address toEnsuring\[Address] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/actor/Address.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/actor/Address.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
15. [**](../../akka/actor/Address.html#getHost():java.util.Optional[String] "Permalink")  def getHost(): [Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[String]Java API: The hostname if specified or empty optional if not
16. [**](../../akka/actor/Address.html#getPort():java.util.Optional[Integer] "Permalink")  def getPort(): [Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[[Integer](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Integer.html#java.lang.Integer)]Java API: The port if specified or empty optional if not
17. [**](../../akka/actor/Address.html#hasGlobalScope:Boolean "Permalink")  def hasGlobalScope: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Returns true if this Address is usable globally.

Returns true if this Address is usable globally. Unlike locally defined addresses ([akka.actor.Address\#hasLocalScope](#hasLocalScope:Boolean))
addresses of global scope are safe to sent to other hosts, as they globally and uniquely identify an addressable
entity.
18. [**](../../akka/actor/Address.html#hasLocalScope:Boolean "Permalink")  def hasLocalScope: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Returns true if this Address is only defined locally.

Returns true if this Address is only defined locally. It is not safe to send locally scoped addresses to remote
hosts. See also [akka.actor.Address\#hasGlobalScope](#hasGlobalScope:Boolean).
19. [**](../../akka/actor/Address.html#hashCode:Int "Permalink")  lazy val hashCode: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAddress → AnyRef → AnyAnnotations@transient()
20. [**](../../akka/actor/Address.html#host:Option[String] "Permalink")  val host: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[String]
21. [**](../../akka/actor/Address.html#hostPort:String "Permalink")  def hostPort: StringReturns a String representation formatted as:

Returns a String representation formatted as:

`system@host:port`
22. [**](../../akka/actor/Address.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
23. [**](../../akka/actor/Address.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
24. [**](../../akka/actor/Address.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
25. [**](../../akka/actor/Address.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
26. [**](../../akka/actor/Address.html#port:Option[Int] "Permalink")  val port: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)]
27. [**](../../akka/actor/Address.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
28. [**](../../akka/actor/Address.html#protocol:String "Permalink")  val protocol: String
29. [**](../../akka/actor/Address.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
30. [**](../../akka/actor/Address.html#system:String "Permalink")  val system: String
31. [**](../../akka/actor/Address.html#toString:String "Permalink")  lazy val toString: StringReturns the canonical String representation of this Address formatted as:

Returns the canonical String representation of this Address formatted as:

`protocol://system@host:port`

Definition ClassesAddress → AnyRef → AnyAnnotations@transient()
32. [**](../../akka/actor/Address.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
33. [**](../../akka/actor/Address.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
34. [**](../../akka/actor/Address.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/Address.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/Address.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from Address toStringFormat\[Address] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/Address.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (Address, B)ImplicitThis member is added by an implicit conversion from Address toArrowAssoc\[Address] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromAddress to any2stringadd\[Address]

### Inherited by implicit conversion StringFormat fromAddress to StringFormat\[Address]

### Inherited by implicit conversion Ensuring fromAddress to Ensuring\[Address]

### Inherited by implicit conversion ArrowAssoc fromAddress to ArrowAssoc\[Address]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/Address.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/Address.html)*