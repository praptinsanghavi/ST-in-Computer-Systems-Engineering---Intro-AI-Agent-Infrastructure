---
description: Akka 2.6.21 - akka.actor.ActorSelection
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:14:12Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/ActorSelection.html
title: Akka 2.6.21 - akka.actor.ActorSelection
---

# Akka 2.6.21 - akka.actor.ActorSelection

> **Summary:** Akka 2.6.21 - akka.actor.ActorSelection
...
[c](ActorSelection$.html "See companion object")[akka](../index.html).[actor](index.html)

# [ActorSelection](ActorSelection$.html "See companion object")[**](../../akka/actor/ActorSelection.html "Permalink")

### Companion [object ActorSelection](ActorSelection$.html "See companion object")
...
Self TypeActorSelection with [ScalaActorSelection](ScalaActorSelection.html)Annotations@SerialVersionUID() @ccompatUsedUntil213() Source[ActorSelection.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/ActorSelection.scala#L33)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ActorSelection
2. Serializable
...
1. [**](../../akka/actor/ActorSelection.html#<init>():akka.actor.ActorSelection "Permalink")  new ActorSelection()
### Abstract Value Members

1. [**](../../akka/actor/ActorSelection.html#anchor:akka.actor.ActorRef "Permalink") abstract  val anchor: [ActorRef](ActorRef.html)Attributesprotected\[[akka](../index.html)]
2. [**](../../akka/actor/ActorSelection.html#path:IndexedSeq[akka.actor.SelectionPathElement] "Permalink") abstract  val path: [IndexedSeq](https://www.scala-lang.org/api/2.13.8/scala/collection/immutable/IndexedSeq.html#scala.collection.immutable.IndexedSeq)\[SelectionPathElement]Attributesprotected
### Concrete Value Members

1. [**](../../akka/actor/ActorSelection.html#!(msg:Any)(implicitsender:akka.actor.ActorRef):Unit "Permalink")  def !(msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any))(implicit sender: [ActorRef](ActorRef.html) \= [Actor.noSender](Actor$.html)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)ImplicitThis member is added by an implicit conversion from ActorSelection to[ScalaActorSelection](ScalaActorSelection.html) performed by method toScala in [akka.actor.ActorSelection](ActorSelection$.html).Definition Classes[ScalaActorSelection](ScalaActorSelection.html)
2. [**](../../akka/actor/ActorSelection.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/ActorSelection.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
4. [**](../../akka/actor/ActorSelection.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ActorSelection toany2stringadd\[ActorSelection] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
5. [**](../../akka/actor/ActorSelection.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ActorSelection, B)ImplicitThis member is added by an implicit conversion from ActorSelection toArrowAssoc\[ActorSelection] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
6. [**](../../akka/actor/ActorSelection.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
7. [**](../../akka/actor/ActorSelection.html#anchorPath:akka.actor.ActorPath "Permalink")  def anchorPath: [ActorPath](ActorPath.html)The [akka.actor.ActorPath](ActorPath.html) of the anchor actor.
8. [**](../../akka/actor/ActorSelection.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
9. [**](../../akka/actor/ActorSelection.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
10. [**](../../akka/actor/ActorSelection.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ActorSelection) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ActorSelectionImplicitThis member is added by an implicit conversion from ActorSelection toEnsuring\[ActorSelection] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/ActorSelection.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ActorSelection) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ActorSelectionImplicitThis member is added by an implicit conversion from ActorSelection toEnsuring\[ActorSelection] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/ActorSelection.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ActorSelectionImplicitThis member is added by an implicit conversion from ActorSelection toEnsuring\[ActorSelection] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/actor/ActorSelection.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ActorSelectionImplicitThis member is added by an implicit conversion from ActorSelection toEnsuring\[ActorSelection] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/actor/ActorSelection.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../akka/actor/ActorSelection.html#equals(obj:Any):Boolean "Permalink")  def equals(obj: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesActorSelection → AnyRef → Any
16. [**](../../akka/actor/ActorSelection.html#forward(message:Any)(implicitcontext:akka.actor.ActorContext):Unit "Permalink")  def forward(message: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any))(implicit context: [ActorContext](ActorContext.html)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Forwards the message and passes the original sender actor as the sender.

Forwards the message and passes the original sender actor as the sender.

Works, no matter whether originally sent with tell/'!' or ask/'?'.
17. [**](../../akka/actor/ActorSelection.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
18. [**](../../akka/actor/ActorSelection.html#hashCode:Int "Permalink")  lazy val hashCode: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesActorSelection → AnyRef → Any
19. [**](../../akka/actor/ActorSelection.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
20. [**](../../akka/actor/ActorSelection.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
21. [**](../../akka/actor/ActorSelection.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
22. [**](../../akka/actor/ActorSelection.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
23. [**](../../akka/actor/ActorSelection.html#pathString:String "Permalink")  def pathString: StringString representation of the path elements, starting with "/" and separated with "/".
24. [**](../../akka/actor/ActorSelection.html#resolveOne(timeout:java.time.Duration):java.util.concurrent.CompletionStage[akka.actor.ActorRef] "Permalink")  def resolveOne(timeout: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[[ActorRef](ActorRef.html)]Java API for [\#resolveOne](#resolveOne(timeout:java.time.Duration):java.util.concurrent.CompletionStage[akka.actor.ActorRef])

Java API for [\#resolveOne](#resolveOne(timeout:java.time.Duration):java.util.concurrent.CompletionStage[akka.actor.ActorRef])

Resolve the [ActorRef](ActorRef.html) matching this selection.
The result is returned as a CompletionStage that is completed with the [ActorRef](ActorRef.html)
if such an actor exists. It is completed with failure [ActorNotFound](ActorNotFound.html) if
no such actor exists or the identification didn't complete within the
supplied `timeout`.
25. [**](../../akka/actor/ActorSelection.html#resolveOne(timeout:scala.concurrent.duration.FiniteDuration):scala.concurrent.Future[akka.actor.ActorRef] "Permalink")  def resolveOne(timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): [Future](https://www.scala-lang.org/api/2.13.8/scala/concurrent/Future.html#scala.concurrent.Future)\[[ActorRef](ActorRef.html)]Resolve the [ActorRef](ActorRef.html) matching this selection.

Resolve the [ActorRef](ActorRef.html) matching this selection.
The result is returned as a Future that is completed with the [ActorRef](ActorRef.html)
if such an actor exists. It is completed with failure [ActorNotFound](ActorNotFound.html) if
no such actor exists or the identification didn't complete within the
supplied `timeout`.

Under the hood it talks to the actor to verify its existence and acquire its
[ActorRef](ActorRef.html).
26. [**](../../akka/actor/ActorSelection.html#resolveOne()(implicittimeout:akka.util.Timeout):scala.concurrent.Future[akka.actor.ActorRef] "Permalink")  def resolveOne()(implicit timeout: [Timeout](../util/Timeout.html)): [Future](https://www.scala-lang.org/api/2.13.8/scala/concurrent/Future.html#scala.concurrent.Future)\[[ActorRef](ActorRef.html)]Resolve the [ActorRef](ActorRef.html) matching this selection.
...
Under the hood it talks to the actor to verify its existence and acquire its
[ActorRef](ActorRef.html).
27. [**](../../akka/actor/ActorSelection.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
28. [**](../../akka/actor/ActorSelection.html#tell(msg:Any,sender:akka.actor.ActorRef):Unit "Permalink")  def tell(msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), sender: [ActorRef](ActorRef.html)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Sends the specified message to this ActorSelection, i.e.
...
Pass [ActorRef\#noSender](ActorRef$.html#noSender:akka.actor.ActorRef) or `null` as sender if there is nobody to reply to
29. [**](../../akka/actor/ActorSelection.html#toSerializationFormat:String "Permalink")  def toSerializationFormat: StringString representation of the actor selection suitable for storage and recreation.

String representation of the actor selection suitable for storage and recreation.
The output is similar to the URI fragment returned by [akka.actor.ActorPath\#toSerializationFormat](ActorPath.html#toSerializationFormat:String).

returnsURI fragment
30. [**](../../akka/actor/ActorSelection.html#toString():String "Permalink")  def toString(): StringDefinition ClassesActorSelection → AnyRef → Any
31. [**](../../akka/actor/ActorSelection.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
32. [**](../../akka/actor/ActorSelection.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
33. [**](../../akka/actor/ActorSelection.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/ActorSelection.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/ActorSelection.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ActorSelection toStringFormat\[ActorSelection] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/ActorSelection.html#resolveOneCS(timeout:java.time.Duration):java.util.concurrent.CompletionStage[akka.actor.ActorRef] "Permalink")  def resolveOneCS(timeout: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[[ActorRef](ActorRef.html)]Java API for [\#resolveOne](#resolveOne(timeout:java.time.Duration):java.util.concurrent.CompletionStage[akka.actor.ActorRef])
...
Annotations@deprecated Deprecated*(Since version 2\.5\.20\)* Use the overloaded method resolveOne which accepts java.time.Duration instead.
4. [**](../../akka/actor/ActorSelection.html#resolveOneCS(timeout:scala.concurrent.duration.FiniteDuration):java.util.concurrent.CompletionStage[akka.actor.ActorRef] "Permalink")  def resolveOneCS(timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[[ActorRef](ActorRef.html)]Java API for [\#resolveOne](#resolveOne(timeout:java.time.Duration):java.util.concurrent.CompletionStage[akka.actor.ActorRef])
...
Annotations@deprecated Deprecated*(Since version 2\.5\.20\)* Use the overloaded method resolveOne which accepts java.time.Duration instead.
5. [**](../../akka/actor/ActorSelection.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ActorSelection, B)ImplicitThis member is added by an implicit conversion from ActorSelection toArrowAssoc\[ActorSelection] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion toScala fromActorSelection to [ScalaActorSelection](ScalaActorSelection.html)
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/ActorSelection.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/ActorSelection.html)*