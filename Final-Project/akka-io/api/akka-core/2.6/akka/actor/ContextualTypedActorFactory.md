---
description: Akka 2.6.21 - akka.actor.ContextualTypedActorFactory
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:19:12Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/ContextualTypedActorFactory.html
title: Akka 2.6.21 - akka.actor.ContextualTypedActorFactory
---

# Akka 2.6.21 - akka.actor.ContextualTypedActorFactory

> **Summary:** Akka 2.6.21 - akka.actor.ContextualTypedActorFactory
...
# ContextualTypedActorFactory[**](../../akka/actor/ContextualTypedActorFactory.html "Permalink")

### 

#### final  case class ContextualTypedActorFactory(typedActor: [TypedActorExtension](TypedActorExtension.html), actorFactory: [ActorContext](ActorContext.html)) extends [TypedActorFactory](TypedActorFactory.html) with [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with Serializable
...
Annotations@nowarn() Source[TypedActor.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/TypedActor.scala#L686)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.8/scala/Equals.html#scala.Equals), [TypedActorFactory](TypedActorFactory.html), [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ContextualTypedActorFactory
2. Serializable
3. Product
4. Equals
5. TypedActorFactory
...
1. [**](../../akka/actor/ContextualTypedActorFactory.html#<init>(typedActor:akka.actor.TypedActorExtension,actorFactory:akka.actor.ActorContext):akka.actor.ContextualTypedActorFactory "Permalink")  new ContextualTypedActorFactory(typedActor: [TypedActorExtension](TypedActorExtension.html), actorFactory: [ActorContext](ActorContext.html))
### Value Members

1. [**](../../akka/actor/ContextualTypedActorFactory.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/ContextualTypedActorFactory.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/ContextualTypedActorFactory.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ContextualTypedActorFactory toany2stringadd\[ContextualTypedActorFactory] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/ContextualTypedActorFactory.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ContextualTypedActorFactory, B)ImplicitThis member is added by an implicit conversion from ContextualTypedActorFactory toArrowAssoc\[ContextualTypedActorFactory] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/ContextualTypedActorFactory.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/ContextualTypedActorFactory.html#actorFactory:akka.actor.ActorContext "Permalink")  val actorFactory: [ActorContext](ActorContext.html)Underlying dependency is to be able to create normal Actors

Underlying dependency is to be able to create normal Actors

Definition ClassesContextualTypedActorFactory → [TypedActorFactory](TypedActorFactory.html)
7. [**](../../akka/actor/ContextualTypedActorFactory.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
8. [**](../../akka/actor/ContextualTypedActorFactory.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
9. [**](../../akka/actor/ContextualTypedActorFactory.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ContextualTypedActorFactory) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ContextualTypedActorFactoryImplicitThis member is added by an implicit conversion from ContextualTypedActorFactory toEnsuring\[ContextualTypedActorFactory] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/ContextualTypedActorFactory.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ContextualTypedActorFactory) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ContextualTypedActorFactoryImplicitThis member is added by an implicit conversion from ContextualTypedActorFactory toEnsuring\[ContextualTypedActorFactory] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/ContextualTypedActorFactory.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ContextualTypedActorFactoryImplicitThis member is added by an implicit conversion from ContextualTypedActorFactory toEnsuring\[ContextualTypedActorFactory] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/ContextualTypedActorFactory.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ContextualTypedActorFactoryImplicitThis member is added by an implicit conversion from ContextualTypedActorFactory toEnsuring\[ContextualTypedActorFactory] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/actor/ContextualTypedActorFactory.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/actor/ContextualTypedActorFactory.html#getActorRefFor(proxy:AnyRef):akka.actor.ActorRef "Permalink")  def getActorRefFor(proxy: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [ActorRef](ActorRef.html)Retrieves the underlying ActorRef for the supplied TypedActor proxy, or null if none found

Retrieves the underlying ActorRef for the supplied TypedActor proxy, or null if none found

Definition ClassesContextualTypedActorFactory → [TypedActorFactory](TypedActorFactory.html)
15. [**](../../akka/actor/ContextualTypedActorFactory.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
16. [**](../../akka/actor/ContextualTypedActorFactory.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/actor/ContextualTypedActorFactory.html#isTypedActor(proxyOrNot:AnyRef):Boolean "Permalink")  def isTypedActor(proxyOrNot: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Returns whether the supplied AnyRef is a TypedActor proxy or not

Returns whether the supplied AnyRef is a TypedActor proxy or not

Definition ClassesContextualTypedActorFactory → [TypedActorFactory](TypedActorFactory.html)
18. [**](../../akka/actor/ContextualTypedActorFactory.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../akka/actor/ContextualTypedActorFactory.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
20. [**](../../akka/actor/ContextualTypedActorFactory.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
21. [**](../../akka/actor/ContextualTypedActorFactory.html#poisonPill(proxy:AnyRef):Boolean "Permalink")  def poisonPill(proxy: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Sends a PoisonPill the underlying ActorRef for the supplied TypedActor proxy,
...
22. [**](../../akka/actor/ContextualTypedActorFactory.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
23. [**](../../akka/actor/ContextualTypedActorFactory.html#stop(proxy:AnyRef):Boolean "Permalink")  def stop(proxy: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Stops the underlying ActorRef for the supplied TypedActor proxy,
if any, returns whether it could find the find the ActorRef or not
...
Definition Classes[TypedActorFactory](TypedActorFactory.html)
27. [**](../../akka/actor/ContextualTypedActorFactory.html#typedActorOf[R<:AnyRef,T<:R](props:akka.actor.TypedProps[T],name:String):R "Permalink")  def typedActorOf\[R \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), T \<: R](props: [TypedProps](TypedProps.html)\[T], name: String): RCreates a new TypedActor with the specified properties

Creates a new TypedActor with the specified properties

Definition Classes[TypedActorFactory](TypedActorFactory.html)
28. [**](../../akka/actor/ContextualTypedActorFactory.html#typedActorOf[R<:AnyRef,T<:R](props:akka.actor.TypedProps[T]):R "Permalink")  def typedActorOf\[R \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), T \<: R](props: [TypedProps](TypedProps.html)\[T]): RCreates a new TypedActor with the specified properties

Creates a new TypedActor with the specified properties

Definition Classes[TypedActorFactory](TypedActorFactory.html)
29. [**](../../akka/actor/ContextualTypedActorFactory.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
30. [**](../../akka/actor/ContextualTypedActorFactory.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
31. [**](../../akka/actor/ContextualTypedActorFactory.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/ContextualTypedActorFactory.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/ContextualTypedActorFactory.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ContextualTypedActorFactory toStringFormat\[ContextualTypedActorFactory] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/ContextualTypedActorFactory.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ContextualTypedActorFactory, B)ImplicitThis member is added by an implicit conversion from ContextualTypedActorFactory toArrowAssoc\[ContextualTypedActorFactory] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromContextualTypedActorFactory to any2stringadd\[ContextualTypedActorFactory]

### Inherited by implicit conversion StringFormat fromContextualTypedActorFactory to StringFormat\[ContextualTypedActorFactory]

### Inherited by implicit conversion Ensuring fromContextualTypedActorFactory to Ensuring\[ContextualTypedActorFactory]

### Inherited by implicit conversion ArrowAssoc fromContextualTypedActorFactory to ArrowAssoc\[ContextualTypedActorFactory]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/ContextualTypedActorFactory.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/ContextualTypedActorFactory.html)*