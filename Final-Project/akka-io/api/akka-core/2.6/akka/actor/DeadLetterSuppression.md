---
description: Akka 2.6.21 - akka.actor.DeadLetterSuppression
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:19:17Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/DeadLetterSuppression.html
title: Akka 2.6.21 - akka.actor.DeadLetterSuppression
---

# Akka 2.6.21 - akka.actor.DeadLetterSuppression

> **Summary:** Akka 2.6.21 - akka.actor.DeadLetterSuppression
...
# DeadLetterSuppression[**](../../akka/actor/DeadLetterSuppression.html "Permalink")

### 

#### trait DeadLetterSuppression extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)
...
Source[ActorRef.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/ActorRef.scala#L590)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Known Subclasses[PoisonPill](PoisonPill.html), [PoisonPill](PoisonPill$.html), [Terminated](Terminated.html), [SequencedMessage](typed/delivery/ConsumerController$$SequencedMessage.html), [Ack](typed/delivery/internal/ProducerControllerImpl$$Ack.html), [Request](typed/delivery/internal/ProducerControllerImpl$$Request.html), [Resend](typed/delivery/internal/ProducerControllerImpl$$Resend.html), [ClusterDomainEvent](../cluster/ClusterEvent$$ClusterDomainEvent.html), [ClusterShuttingDown](../cluster/ClusterEvent$$ClusterShuttingDown$.html), [DataCenterReachabilityEvent](../cluster/ClusterEvent$$DataCenterReachabilityEvent.html), [LeaderChanged](../cluster/ClusterEvent$$LeaderChanged.html), [MemberDowned](../cluster/ClusterEvent$$MemberDowned.html), [MemberEvent](../cluster/ClusterEvent$$MemberEvent.html), [MemberExited](../cluster/ClusterEvent$$MemberExited.html), [MemberJoined](../cluster/ClusterEvent$$MemberJoined.html), [MemberLeft](../cluster/ClusterEvent$$MemberLeft.html), [MemberPreparingForShutdown](../cluster/ClusterEvent$$MemberPreparingForShutdown.html), [MemberReadyForShutdown](../cluster/ClusterEvent$$MemberReadyForShutdown.html), [MemberRemoved](../cluster/ClusterEvent$$MemberRemoved.html), [MemberUp](../cluster/ClusterEvent$$MemberUp.html), [MemberWeaklyUp](../cluster/ClusterEvent$$MemberWeaklyUp.html), [ReachabilityEvent](../cluster/ClusterEvent$$ReachabilityEvent.html), [ReachableDataCenter](../cluster/ClusterEvent$$ReachableDataCenter.html), [ReachableMember](../cluster/ClusterEvent$$ReachableMember.html), [RoleLeaderChanged](../cluster/ClusterEvent$$RoleLeaderChanged.html), [UnreachableDataCenter](../cluster/ClusterEvent$$UnreachableDataCenter.html), [UnreachableMember](../cluster/ClusterEvent$$UnreachableMember.html), [UpdateSuccess](../cluster/ddata/Replicator$$UpdateSuccess.html), [UpdateSuccess](../cluster/ddata/typed/javadsl/Replicator$$UpdateSuccess.html), [SubscribeAck](../cluster/pubsub/DistributedPubSubMediator$$SubscribeAck.html), [StartEntityAck](../cluster/sharding/ShardRegion$$StartEntityAck.html), [SelfRemoved](../cluster/typed/SelfRemoved.html), [SelfUp](../cluster/typed/SelfUp.html), [Resolved](../discovery/ServiceDiscovery$$Resolved.html), [Abort](../io/Tcp$$Abort$.html), [Aborted](../io/Tcp$$Aborted$.html), [Close](../io/Tcp$$Close$.html), [CloseCommand](../io/Tcp$$CloseCommand.html), [Closed](../io/Tcp$$Closed$.html), [ConfirmedClose](../io/Tcp$$ConfirmedClose$.html), [ConfirmedClosed](../io/Tcp$$ConfirmedClosed$.html), [ConnectionClosed](../io/Tcp$$ConnectionClosed.html), [ErrorClosed](../io/Tcp$$ErrorClosed.html), [PeerClosed](../io/Tcp$$PeerClosed$.html), [ResumeReading](../io/Tcp$$ResumeReading$.html), [DisassociateUnderlying](../remote/transport/ActorTransportAdapter$$DisassociateUnderlying.html), [Disassociated](../remote/transport/AssociationHandle$$Disassociated.html), [CancelSubscription](../stream/testkit/TestPublisher$$CancelSubscription.html), [PublisherEvent](../stream/testkit/TestPublisher$$PublisherEvent.html), [RequestMore](../stream/testkit/TestPublisher$$RequestMore.html), [Subscribe](../stream/testkit/TestPublisher$$Subscribe.html), [OnComplete](../stream/testkit/TestSubscriber$$OnComplete$.html), [OnError](../stream/testkit/TestSubscriber$$OnError.html), [OnNext](../stream/testkit/TestSubscriber$$OnNext.html), [OnSubscribe](../stream/testkit/TestSubscriber$$OnSubscribe.html), [SubscriberEvent](../stream/testkit/TestSubscriber$$SubscriberEvent.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. DeadLetterSuppression
2. AnyRef
3. Any
Implicitly  
1. by any2stringadd
...
1. [**](../../akka/actor/DeadLetterSuppression.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/DeadLetterSuppression.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/DeadLetterSuppression.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from DeadLetterSuppression toany2stringadd\[DeadLetterSuppression] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/DeadLetterSuppression.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (DeadLetterSuppression, B)ImplicitThis member is added by an implicit conversion from DeadLetterSuppression toArrowAssoc\[DeadLetterSuppression] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/DeadLetterSuppression.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/DeadLetterSuppression.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/DeadLetterSuppression.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
8. [**](../../akka/actor/DeadLetterSuppression.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (DeadLetterSuppression) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): DeadLetterSuppressionImplicitThis member is added by an implicit conversion from DeadLetterSuppression toEnsuring\[DeadLetterSuppression] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/actor/DeadLetterSuppression.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (DeadLetterSuppression) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): DeadLetterSuppressionImplicitThis member is added by an implicit conversion from DeadLetterSuppression toEnsuring\[DeadLetterSuppression] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/DeadLetterSuppression.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): DeadLetterSuppressionImplicitThis member is added by an implicit conversion from DeadLetterSuppression toEnsuring\[DeadLetterSuppression] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/DeadLetterSuppression.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): DeadLetterSuppressionImplicitThis member is added by an implicit conversion from DeadLetterSuppression toEnsuring\[DeadLetterSuppression] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/DeadLetterSuppression.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/actor/DeadLetterSuppression.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/actor/DeadLetterSuppression.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
15. [**](../../akka/actor/DeadLetterSuppression.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
16. [**](../../akka/actor/DeadLetterSuppression.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/actor/DeadLetterSuppression.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/DeadLetterSuppression.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
19. [**](../../akka/actor/DeadLetterSuppression.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
20. [**](../../akka/actor/DeadLetterSuppression.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/actor/DeadLetterSuppression.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/actor/DeadLetterSuppression.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/actor/DeadLetterSuppression.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/actor/DeadLetterSuppression.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/DeadLetterSuppression.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/DeadLetterSuppression.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from DeadLetterSuppression toStringFormat\[DeadLetterSuppression] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/DeadLetterSuppression.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (DeadLetterSuppression, B)ImplicitThis member is added by an implicit conversion from DeadLetterSuppression toArrowAssoc\[DeadLetterSuppression] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromDeadLetterSuppression to any2stringadd\[DeadLetterSuppression]

### Inherited by implicit conversion StringFormat fromDeadLetterSuppression to StringFormat\[DeadLetterSuppression]

### Inherited by implicit conversion Ensuring fromDeadLetterSuppression to Ensuring\[DeadLetterSuppression]

### Inherited by implicit conversion ArrowAssoc fromDeadLetterSuppression to ArrowAssoc\[DeadLetterSuppression]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/DeadLetterSuppression.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/DeadLetterSuppression.html)*