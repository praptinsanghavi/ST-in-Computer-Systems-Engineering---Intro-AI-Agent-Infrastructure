---
description: Akka 2.6.21 - akka.actor.ExtensionIdProvider
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:19:37Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/ExtensionIdProvider.html
title: Akka 2.6.21 - akka.actor.ExtensionIdProvider
---

# Akka 2.6.21 - akka.actor.ExtensionIdProvider

> **Summary:** Akka 2.6.21 - akka.actor.ExtensionIdProvider
...
# ExtensionIdProvider[**](../../akka/actor/ExtensionIdProvider.html "Permalink")

### 

#### trait ExtensionIdProvider extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)
...
Source[Extension.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/Extension.scala#L130)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Known Subclasses[CoordinatedShutdown](CoordinatedShutdown$.html), [Cluster](../cluster/Cluster$.html), [DistributedData](../cluster/ddata/DistributedData$.html), [ClusterMetricsExtension](../cluster/metrics/ClusterMetricsExtension$.html), [DistributedPubSub](../cluster/pubsub/DistributedPubSub$.html), [ClusterSharding](../cluster/sharding/ClusterSharding$.html), [ShardingFlightRecorder](../cluster/sharding/ShardingFlightRecorder$.html), [ExternalShardAllocation](../cluster/sharding/external/ExternalShardAllocation$.html), [LeaseProvider](../coordination/lease/javadsl/LeaseProvider$.html), [LeaseProvider](../coordination/lease/scaladsl/LeaseProvider$.html), [Discovery](../discovery/Discovery$.html), [Dns](../io/Dns$.html), [Tcp](../io/Tcp$.html), [Udp](../io/Udp$.html), [UdpConnected](../io/UdpConnected$.html), [CircuitBreakersRegistry](../pattern/CircuitBreakersRegistry$.html), [Persistence](../persistence/Persistence$.html), [PersistencePluginProxyExtension](../persistence/journal/PersistencePluginProxyExtension$.html), [PersistenceQuery](../persistence/query/PersistenceQuery$.html), [DurableStateStoreRegistry](../persistence/state/DurableStateStoreRegistry$.html), [AddressUidExtension](../remote/AddressUidExtension$.html), [BoundAddressesExtension](../remote/BoundAddressesExtension$.html), [RemotingFlightRecorder](../remote/artery/RemotingFlightRecorder$.html), [TestConductor](../remote/testconductor/TestConductor$.html), [SerializationExtension](../serialization/SerializationExtension$.html), [JacksonObjectMapperProvider](../serialization/jackson/JacksonObjectMapperProvider$.html), [SystemMaterializer](../stream/SystemMaterializer$.html), [Tcp](../stream/javadsl/Tcp$.html), [Tcp](../stream/scaladsl/Tcp$.html), [ManifestInfo](../util/ManifestInfo$.html), [TypedActor](TypedActor$.html), [ClusterClientReceptionist](../cluster/client/ClusterClientReceptionist$.html), [TransportAdaptersExtension](../remote/transport/TransportAdaptersExtension$.html), [AkkaSSLConfig](../../com/typesafe/sslconfig/akka/AkkaSSLConfig$.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ExtensionIdProvider
2. AnyRef
3. Any
Implicitly  
1. by any2stringadd
...
1. [**](../../akka/actor/ExtensionIdProvider.html#lookup:akka.actor.ExtensionId[_<:akka.actor.Extension] "Permalink") abstract  def lookup: [ExtensionId](ExtensionId.html)\[\_ \<: [Extension](Extension.html)]Returns the canonical ExtensionId for this Extension
### Concrete Value Members

1. [**](../../akka/actor/ExtensionIdProvider.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/ExtensionIdProvider.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/ExtensionIdProvider.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ExtensionIdProvider toany2stringadd\[ExtensionIdProvider] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/ExtensionIdProvider.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ExtensionIdProvider, B)ImplicitThis member is added by an implicit conversion from ExtensionIdProvider toArrowAssoc\[ExtensionIdProvider] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/ExtensionIdProvider.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/ExtensionIdProvider.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/ExtensionIdProvider.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
8. [**](../../akka/actor/ExtensionIdProvider.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ExtensionIdProvider) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ExtensionIdProviderImplicitThis member is added by an implicit conversion from ExtensionIdProvider toEnsuring\[ExtensionIdProvider] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/actor/ExtensionIdProvider.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ExtensionIdProvider) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ExtensionIdProviderImplicitThis member is added by an implicit conversion from ExtensionIdProvider toEnsuring\[ExtensionIdProvider] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/ExtensionIdProvider.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ExtensionIdProviderImplicitThis member is added by an implicit conversion from ExtensionIdProvider toEnsuring\[ExtensionIdProvider] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/ExtensionIdProvider.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ExtensionIdProviderImplicitThis member is added by an implicit conversion from ExtensionIdProvider toEnsuring\[ExtensionIdProvider] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/ExtensionIdProvider.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/actor/ExtensionIdProvider.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/actor/ExtensionIdProvider.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
15. [**](../../akka/actor/ExtensionIdProvider.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
16. [**](../../akka/actor/ExtensionIdProvider.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/actor/ExtensionIdProvider.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/ExtensionIdProvider.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
19. [**](../../akka/actor/ExtensionIdProvider.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
20. [**](../../akka/actor/ExtensionIdProvider.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/actor/ExtensionIdProvider.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/actor/ExtensionIdProvider.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/actor/ExtensionIdProvider.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/actor/ExtensionIdProvider.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/ExtensionIdProvider.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/ExtensionIdProvider.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ExtensionIdProvider toStringFormat\[ExtensionIdProvider] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/ExtensionIdProvider.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ExtensionIdProvider, B)ImplicitThis member is added by an implicit conversion from ExtensionIdProvider toArrowAssoc\[ExtensionIdProvider] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromExtensionIdProvider to any2stringadd\[ExtensionIdProvider]

### Inherited by implicit conversion StringFormat fromExtensionIdProvider to StringFormat\[ExtensionIdProvider]

### Inherited by implicit conversion Ensuring fromExtensionIdProvider to Ensuring\[ExtensionIdProvider]

### Inherited by implicit conversion ArrowAssoc fromExtensionIdProvider to ArrowAssoc\[ExtensionIdProvider]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/ExtensionIdProvider.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/ExtensionIdProvider.html)*