---
description: Akka 2.6.21 - akka.actor.Deploy
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:19:24Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/Deploy.html
title: Akka 2.6.21 - akka.actor.Deploy
---

# Akka 2.6.21 - akka.actor.Deploy

> **Summary:** Akka 2.6.21 - akka.actor.Deploy
...
[c](Deploy$.html "See companion object")[akka](../index.html).[actor](index.html)

# [Deploy](Deploy$.html "See companion object")[**](../../akka/actor/Deploy.html "Permalink")

### Companion [object Deploy](Deploy$.html "See companion object")

#### final  class Deploy extends Serializable with [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with [Equals](https://www.scala-lang.org/api/2.13.8/scala/Equals.html#scala.Equals)
...
```
Annotations@SerialVersionUID() Source[Deployer.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/Deployer.scala#L58)Linear Supertypes[Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.8/scala/Equals.html#scala.Equals), [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Deploy
2. Product
...
1. [**](../../akka/actor/Deploy.html#<init>(scope:akka.actor.Scope):akka.actor.Deploy "Permalink")  new Deploy(scope: [Scope](Scope.html))Java API to create a Deploy with the given Scope
2. [**](../../akka/actor/Deploy.html#<init>(routing:akka.routing.RouterConfig,scope:akka.actor.Scope):akka.actor.Deploy "Permalink")  new Deploy(routing: [RouterConfig](../routing/RouterConfig.html), scope: [Scope](Scope.html))Java API to create a Deploy with the given RouterConfig with Scope
3. [**](../../akka/actor/Deploy.html#<init>(routing:akka.routing.RouterConfig):akka.actor.Deploy "Permalink")  new Deploy(routing: [RouterConfig](../routing/RouterConfig.html))Java API to create a Deploy with the given RouterConfig
4. [**](../../akka/actor/Deploy.html#<init>(path:String,config:com.typesafe.config.Config,routerConfig:akka.routing.RouterConfig,scope:akka.actor.Scope,dispatcher:String,mailbox:String):akka.actor.Deploy "Permalink")  new Deploy(path: String, config: Config, routerConfig: [RouterConfig](../routing/RouterConfig.html), scope: [Scope](Scope.html), dispatcher: String, mailbox: String)
5. [**](../../akka/actor/Deploy.html#<init>(path:String,config:com.typesafe.config.Config,routerConfig:akka.routing.RouterConfig,scope:akka.actor.Scope,dispatcher:String,mailbox:String,tags:Set[String]):akka.actor.Deploy "Permalink")  new Deploy(path: String \= "", config: Config \= [ConfigFactory.empty](../../com/index.html), routerConfig: [RouterConfig](../routing/RouterConfig.html) \= [NoRouter](../index.html), scope: [Scope](Scope.html) \= [NoScopeGiven](NoScopeGiven$.html), dispatcher: String \= [Deploy.NoDispatcherGiven](Deploy$.html), mailbox: String \= [Deploy.NoMailboxGiven](Deploy$.html), tags: Set\[String] \= Set.empty)
### Value Members

1. [**](../../akka/actor/Deploy.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/Deploy.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/Deploy.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from Deploy toany2stringadd\[Deploy] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/Deploy.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (Deploy, B)ImplicitThis member is added by an implicit conversion from Deploy toArrowAssoc\[Deploy] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/Deploy.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/Deploy.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/Deploy.html#canEqual(that:Any):Boolean "Permalink")  def canEqual(that: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesDeploy → Equals
8. [**](../../akka/actor/Deploy.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
9. [**](../../akka/actor/Deploy.html#config:com.typesafe.config.Config "Permalink")  val config: Config
10. [**](../../akka/actor/Deploy.html#copy(path:String,config:com.typesafe.config.Config,routerConfig:akka.routing.RouterConfig,scope:akka.actor.Scope,dispatcher:String,mailbox:String):akka.actor.Deploy "Permalink")  def copy(path: String \= path, config: Config \= config, routerConfig: [RouterConfig](../routing/RouterConfig.html) \= routerConfig, scope: [Scope](Scope.html) \= scope, dispatcher: String \= dispatcher, mailbox: String \= mailbox): Deploy
11. [**](../../akka/actor/Deploy.html#dispatcher:String "Permalink")  val dispatcher: String
12. [**](../../akka/actor/Deploy.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (Deploy) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): DeployImplicitThis member is added by an implicit conversion from Deploy toEnsuring\[Deploy] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/actor/Deploy.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (Deploy) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): DeployImplicitThis member is added by an implicit conversion from Deploy toEnsuring\[Deploy] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/actor/Deploy.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): DeployImplicitThis member is added by an implicit conversion from Deploy toEnsuring\[Deploy] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/actor/Deploy.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): DeployImplicitThis member is added by an implicit conversion from Deploy toEnsuring\[Deploy] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/actor/Deploy.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/actor/Deploy.html#equals(other:Any):Boolean "Permalink")  def equals(other: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesDeploy → Equals → AnyRef → Any
18. [**](../../akka/actor/Deploy.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
19. [**](../../akka/actor/Deploy.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesDeploy → AnyRef → Any
20. [**](../../akka/actor/Deploy.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
21. [**](../../akka/actor/Deploy.html#mailbox:String "Permalink")  val mailbox: String
22. [**](../../akka/actor/Deploy.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
23. [**](../../akka/actor/Deploy.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
24. [**](../../akka/actor/Deploy.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
25. [**](../../akka/actor/Deploy.html#path:String "Permalink")  val path: String
26. [**](../../akka/actor/Deploy.html#productArity:Int "Permalink")  def productArity: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesDeploy → Product
27. [**](../../akka/actor/Deploy.html#productElement(n:Int):Any "Permalink")  def productElement(n: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Definition ClassesDeploy → Product
28. [**](../../akka/actor/Deploy.html#productElementName(n:Int):String "Permalink")  def productElementName(n: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): StringDefinition ClassesProduct
29. [**](../../akka/actor/Deploy.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
30. [**](../../akka/actor/Deploy.html#productIterator:Iterator[Any] "Permalink")  def productIterator: Iterator\[[Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)]Definition ClassesProduct
31. [**](../../akka/actor/Deploy.html#productPrefix:String "Permalink")  def productPrefix: StringDefinition ClassesProduct
32. [**](../../akka/actor/Deploy.html#routerConfig:akka.routing.RouterConfig "Permalink")  val routerConfig: [RouterConfig](../routing/RouterConfig.html)
33. [**](../../akka/actor/Deploy.html#scope:akka.actor.Scope "Permalink")  val scope: [Scope](Scope.html)
34. [**](../../akka/actor/Deploy.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
35. [**](../../akka/actor/Deploy.html#tags:Set[String] "Permalink")  val tags: Set\[String]
36. [**](../../akka/actor/Deploy.html#toString():String "Permalink")  def toString(): StringDefinition ClassesDeploy → AnyRef → Any
37. [**](../../akka/actor/Deploy.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
38. [**](../../akka/actor/Deploy.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
39. [**](../../akka/actor/Deploy.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
40. [**](../../akka/actor/Deploy.html#withFallback(other:akka.actor.Deploy):akka.actor.Deploy "Permalink")  def withFallback(other: Deploy): DeployDo a merge between this and the other Deploy, where values from “this” take
precedence.
...
41. [**](../../akka/actor/Deploy.html#withTags(tags:Set[String]):akka.actor.Deploy "Permalink")  def withTags(tags: Set\[String]): Deploy
### Deprecated Value Members

1. [**](../../akka/actor/Deploy.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/Deploy.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from Deploy toStringFormat\[Deploy] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/Deploy.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (Deploy, B)ImplicitThis member is added by an implicit conversion from Deploy toArrowAssoc\[Deploy] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/Deploy.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/Deploy.html)*