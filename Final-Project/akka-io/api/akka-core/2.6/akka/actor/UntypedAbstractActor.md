---
description: Akka 2.6.21 - akka.actor.UntypedAbstractActor
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:21:23Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/UntypedAbstractActor.html
title: Akka 2.6.21 - akka.actor.UntypedAbstractActor
---

# Akka 2.6.21 - akka.actor.UntypedAbstractActor

> **Summary:** Akka 2.6.21 - akka.actor.UntypedAbstractActor
...
# UntypedAbstractActor[**](../../akka/actor/UntypedAbstractActor.html "Permalink")

### 

#### abstract  class UntypedAbstractActor extends [AbstractActor](AbstractActor.html)
...
Source[AbstractActor.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/AbstractActor.scala#L327)Linear Supertypes[AbstractActor](AbstractActor.html), [Actor](Actor.html), [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. UntypedAbstractActor
2. AbstractActor
3. Actor
4. AnyRef
5. Any
...
1. [**](../../akka/actor/UntypedAbstractActor.html#<init>():akka.actor.UntypedAbstractActor "Permalink")  new UntypedAbstractActor()
### Type Members

1. [**](../../akka/actor/UntypedAbstractActor.html#Receive=akka.actor.Actor.Receive "Permalink")  type Receive \= [PartialFunction](https://www.scala-lang.org/api/2.13.8/scala/PartialFunction.html#scala.PartialFunction)\[[Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)]Definition Classes[Actor](Actor.html)
### Abstract Value Members

1. [**](../../akka/actor/UntypedAbstractActor.html#onReceive(message:Any):Unit "Permalink") abstract  def onReceive(message: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)To be implemented by concrete UntypedAbstractActor, this defines the behavior of the
actor.
...
1. [**](../../akka/actor/UntypedAbstractActor.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/UntypedAbstractActor.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/UntypedAbstractActor.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from UntypedAbstractActor toany2stringadd\[UntypedAbstractActor] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/UntypedAbstractActor.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (UntypedAbstractActor, B)ImplicitThis member is added by an implicit conversion from UntypedAbstractActor toArrowAssoc\[UntypedAbstractActor] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/UntypedAbstractActor.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/UntypedAbstractActor.html#aroundPostRestart(reason:Throwable):Unit "Permalink")  def aroundPostRestart(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
7. [**](../../akka/actor/UntypedAbstractActor.html#aroundPostStop():Unit "Permalink")  def aroundPostStop(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
Attributesprotected\[[akka](../index.html)] Definition Classes[Actor](Actor.html)Annotations@[InternalApi](../annotation/InternalApi.html)()
8. [**](../../akka/actor/UntypedAbstractActor.html#aroundPreRestart(reason:Throwable,message:Option[Any]):Unit "Permalink")  def aroundPreRestart(reason: Throwable, message: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)]): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
Attributesprotected\[[akka](../index.html)] Definition Classes[Actor](Actor.html)Annotations@[InternalApi](../annotation/InternalApi.html)()
9. [**](../../akka/actor/UntypedAbstractActor.html#aroundPreStart():Unit "Permalink")  def aroundPreStart(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
Attributesprotected\[[akka](../index.html)] Definition Classes[Actor](Actor.html)Annotations@[InternalApi](../annotation/InternalApi.html)()
10. [**](../../akka/actor/UntypedAbstractActor.html#aroundReceive(receive:akka.actor.Actor.Receive,msg:Any):Unit "Permalink")  def aroundReceive(receive: [Actor.Receive](Actor$.html#Receive=PartialFunction[Any,Unit]), msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
Attributesprotected\[[akka](../index.html)] Definition Classes[Actor](Actor.html)Annotations@[InternalApi](../annotation/InternalApi.html)()
11. [**](../../akka/actor/UntypedAbstractActor.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
12. [**](../../akka/actor/UntypedAbstractActor.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
13. [**](../../akka/actor/UntypedAbstractActor.html#context:akka.actor.ActorContext "Permalink") implicit  val context: [ActorContext](ActorContext.html)Scala API: Stores the context for this actor, including self, and sender.
...
14. [**](../../akka/actor/UntypedAbstractActor.html#createReceive():akka.actor.AbstractActor.Receive "Permalink") final  def createReceive(): [AbstractActor.Receive](AbstractActor$$Receive.html)An actor has to define its initial receive behavior by implementing
the `createReceive` method.

An actor has to define its initial receive behavior by implementing
the `createReceive` method.

Definition ClassesUntypedAbstractActor → [AbstractActor](AbstractActor.html)
15. [**](../../akka/actor/UntypedAbstractActor.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (UntypedAbstractActor) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): UntypedAbstractActorImplicitThis member is added by an implicit conversion from UntypedAbstractActor toEnsuring\[UntypedAbstractActor] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/actor/UntypedAbstractActor.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (UntypedAbstractActor) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): UntypedAbstractActorImplicitThis member is added by an implicit conversion from UntypedAbstractActor toEnsuring\[UntypedAbstractActor] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../akka/actor/UntypedAbstractActor.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): UntypedAbstractActorImplicitThis member is added by an implicit conversion from UntypedAbstractActor toEnsuring\[UntypedAbstractActor] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
18. [**](../../akka/actor/UntypedAbstractActor.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): UntypedAbstractActorImplicitThis member is added by an implicit conversion from UntypedAbstractActor toEnsuring\[UntypedAbstractActor] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
19. [**](../../akka/actor/UntypedAbstractActor.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
20. [**](../../akka/actor/UntypedAbstractActor.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
21. [**](../../akka/actor/UntypedAbstractActor.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
22. [**](../../akka/actor/UntypedAbstractActor.html#getContext():akka.actor.AbstractActor.ActorContext "Permalink")  def getContext(): [AbstractActor.ActorContext](AbstractActor$$ActorContext.html)Returns this AbstractActor's ActorContext
...
23. [**](../../akka/actor/UntypedAbstractActor.html#getSelf():akka.actor.ActorRef "Permalink")  def getSelf(): [ActorRef](ActorRef.html)Returns the ActorRef for this actor.
...
Definition Classes[AbstractActor](AbstractActor.html)
24. [**](../../akka/actor/UntypedAbstractActor.html#getSender():akka.actor.ActorRef "Permalink")  def getSender(): [ActorRef](ActorRef.html)The reference sender Actor of the currently processed message.
...
Definition Classes[AbstractActor](AbstractActor.html)
25. [**](../../akka/actor/UntypedAbstractActor.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
26. [**](../../akka/actor/UntypedAbstractActor.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
27. [**](../../akka/actor/UntypedAbstractActor.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
28. [**](../../akka/actor/UntypedAbstractActor.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
29. [**](../../akka/actor/UntypedAbstractActor.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
30. [**](../../akka/actor/UntypedAbstractActor.html#postRestart(reason:Throwable):Unit "Permalink")  def postRestart(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback: By default it calls `preStart()`.
...
31. [**](../../akka/actor/UntypedAbstractActor.html#postStop():Unit "Permalink")  def postStop(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback.
...
33. [**](../../akka/actor/UntypedAbstractActor.html#preStart():Unit "Permalink")  def preStart(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback.
...
Definition Classes[AbstractActor](AbstractActor.html) → [Actor](Actor.html)Annotations@throws(classOf\[Exception])
34. [**](../../akka/actor/UntypedAbstractActor.html#receive:PartialFunction[Any,Unit] "Permalink")  def receive: [PartialFunction](https://www.scala-lang.org/api/2.13.8/scala/PartialFunction.html#scala.PartialFunction)\[[Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)]Scala API: This defines the initial actor behavior, it must return a partial function
with the actor logic.

Scala API: This defines the initial actor behavior, it must return a partial function
with the actor logic.

Definition ClassesUntypedAbstractActor → [AbstractActor](AbstractActor.html) → [Actor](Actor.html)
35. [**](../../akka/actor/UntypedAbstractActor.html#receiveBuilder():akka.japi.pf.ReceiveBuilder "Permalink") final  def receiveBuilder(): [ReceiveBuilder](../japi/pf/ReceiveBuilder.html)Convenience factory of the `ReceiveBuilder`.

Convenience factory of the `ReceiveBuilder`.
Creates a new empty `ReceiveBuilder`.

Definition Classes[AbstractActor](AbstractActor.html)
36. [**](../../akka/actor/UntypedAbstractActor.html#self:akka.actor.ActorRef "Permalink") implicit final  val self: [ActorRef](ActorRef.html)The 'self' field holds the ActorRef for this actor.
...
Definition Classes[Actor](Actor.html)
37. [**](../../akka/actor/UntypedAbstractActor.html#sender():akka.actor.ActorRef "Permalink") final  def sender(): [ActorRef](ActorRef.html)The reference sender Actor of the last received message.
...
Definition Classes[Actor](Actor.html)
38. [**](../../akka/actor/UntypedAbstractActor.html#supervisorStrategy:akka.actor.SupervisorStrategy "Permalink")  def supervisorStrategy: [SupervisorStrategy](SupervisorStrategy.html)User overridable definition the strategy to use for supervising
child actors.
...
39. [**](../../akka/actor/UntypedAbstractActor.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
40. [**](../../akka/actor/UntypedAbstractActor.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
41. [**](../../akka/actor/UntypedAbstractActor.html#unhandled(message:Any):Unit "Permalink")  def unhandled(message: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Recommended convention is to call this method if the message
isn't handled in [\#onReceive](#onReceive(message:Any):Unit) (e.g.

Recommended convention is to call this method if the message
isn't handled in [\#onReceive](#onReceive(message:Any):Unit) (e.g. unknown message type).
...
Definition ClassesUntypedAbstractActor → [Actor](Actor.html)
42. [**](../../akka/actor/UntypedAbstractActor.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
43. [**](../../akka/actor/UntypedAbstractActor.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
44. [**](../../akka/actor/UntypedAbstractActor.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/UntypedAbstractActor.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/UntypedAbstractActor.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from UntypedAbstractActor toStringFormat\[UntypedAbstractActor] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/UntypedAbstractActor.html#preRestart(reason:Throwable,message:Option[Any]):Unit "Permalink")  def preRestart(reason: Throwable, message: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)]): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Scala API: User overridable callback: **By default it disposes of all children and then calls `postStop()`.**
...
4. [**](../../akka/actor/UntypedAbstractActor.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (UntypedAbstractActor, B)ImplicitThis member is added by an implicit conversion from UntypedAbstractActor toArrowAssoc\[UntypedAbstractActor] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromUntypedAbstractActor to any2stringadd\[UntypedAbstractActor]

### Inherited by implicit conversion StringFormat fromUntypedAbstractActor to StringFormat\[UntypedAbstractActor]

### Inherited by implicit conversion Ensuring fromUntypedAbstractActor to Ensuring\[UntypedAbstractActor]

### Inherited by implicit conversion ArrowAssoc fromUntypedAbstractActor to ArrowAssoc\[UntypedAbstractActor]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/UntypedAbstractActor.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/UntypedAbstractActor.html)*