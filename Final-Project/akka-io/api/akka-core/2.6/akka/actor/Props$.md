...
scraped_at: '2026-04-06T14:20:24Z'
section: api
site: akka-io
...
[o](Props.html "See companion class")[akka](../index.html).[actor](index.html)

# [Props](Props.html "See companion class")[**](../../akka/actor/Props$.html "Permalink")

### Companion [class Props](Props.html "See companion class")

#### object Props extends AbstractProps with [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)
...
Source[Props.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/Props.scala#L22)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), AbstractProps, [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Props
2. Serializable
...
3. [**](../../akka/actor/Props$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/actor/Props$.html#apply(clazz:Class[_],args:Any*):akka.actor.Props "Permalink")  def apply(clazz: Class\[\_], args: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)\*): [Props](Props.html)Scala API: create a Props given a class and its constructor arguments.
5. [**](../../akka/actor/Props$.html#apply[T<:akka.actor.Actor](creator:=>T)(implicitevidence$2:scala.reflect.ClassTag[T]):akka.actor.Props "Permalink")  def apply\[T \<: [Actor](Actor.html)](creator: \=\> T)(implicit arg0: [ClassTag](https://www.scala-lang.org/api/2.13.8/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[T]): [Props](Props.html)Scala API: Returns a Props that has default values except for "creator" which will be a function that creates an instance
...
6. [**](../../akka/actor/Props$.html#apply[T<:akka.actor.Actor]()(implicitevidence$1:scala.reflect.ClassTag[T]):akka.actor.Props "Permalink")  def apply\[T \<: [Actor](Actor.html)]()(implicit arg0: [ClassTag](https://www.scala-lang.org/api/2.13.8/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[T]): [Props](Props.html)Scala API: Returns a Props that has default values except for "creator" which will be a function that creates an instance
of the supplied type using the default constructor.
7. [**](../../akka/actor/Props$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
8. [**](../../akka/actor/Props$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
9. [**](../../akka/actor/Props$.html#create[T<:akka.actor.Actor](actorClass:Class[T],creator:akka.japi.Creator[T]):akka.actor.Props "Permalink")  def create\[T \<: [Actor](Actor.html)](actorClass: Class\[T], creator: [Creator](../japi/Creator.html)\[T]): [Props](Props.html)Create new Props from the given [akka.japi.Creator](../japi/Creator.html) with the type set to the given actorClass.

Create new Props from the given [akka.japi.Creator](../japi/Creator.html) with the type set to the given actorClass.

Definition ClassesAbstractProps
10. [**](../../akka/actor/Props$.html#create(clazz:Class[_],args:AnyRef*):akka.actor.Props "Permalink")  def create(clazz: Class\[\_], args: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)\*): [Props](Props.html)Java API: create a Props given a class and its constructor arguments.

Java API: create a Props given a class and its constructor arguments.

Definition ClassesAbstractPropsAnnotations@varargs()
11. [**](../../akka/actor/Props$.html#default:akka.actor.Props "Permalink") final  val default: [Props](Props.html)The default Props instance, uses the settings from the Props object starting with default\*.
12. [**](../../akka/actor/Props$.html#defaultCreator:()=>akka.actor.Actor "Permalink") final  val defaultCreator: () \=\> [Actor](Actor.html)The defaultCreator, simply throws an UnsupportedOperationException when applied, which is used when creating a Props
13. [**](../../akka/actor/Props$.html#defaultDeploy:akka.actor.Deploy "Permalink") final  val defaultDeploy: [Deploy](Deploy.html)The default Deploy instance which is used when creating a Props
14. [**](../../akka/actor/Props$.html#defaultRoutedProps:akka.routing.RouterConfig "Permalink") final  val defaultRoutedProps: [RouterConfig](../routing/RouterConfig.html)The defaultRoutedProps is NoRouter which is used when creating a Props
15. [**](../../akka/actor/Props$.html#empty:akka.actor.Props "Permalink") final  val empty: [Props](Props.html)A Props instance whose creator will create an actor that doesn't respond to any message
16. [**](../../akka/actor/Props$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/actor/Props$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
19. [**](../../akka/actor/Props$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
20. [**](../../akka/actor/Props$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
...
24. [**](../../akka/actor/Props$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
25. [**](../../akka/actor/Props$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
26. [**](../../akka/actor/Props$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
27. [**](../../akka/actor/Props$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
28. [**](../../akka/actor/Props$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/Props$.html#create[T<:akka.actor.Actor](creator:akka.japi.Creator[T]):akka.actor.Props "Permalink")  def create\[T \<: [Actor](Actor.html)](creator: [Creator](../japi/Creator.html)\[T]): [Props](Props.html)Create new Props from the given [akka.japi.Creator](../japi/Creator.html).

Create new Props from the given [akka.japi.Creator](../japi/Creator.html).
...
Definition ClassesAbstractPropsAnnotations@deprecated Deprecated*(Since version 2\.5\.18\)* Use Props.create(actorClass, creator) instead, since this can't be used with Java 8 lambda.
2. [**](../../akka/actor/Props$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
### Inherited from [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)

### Inherited from AbstractProps
