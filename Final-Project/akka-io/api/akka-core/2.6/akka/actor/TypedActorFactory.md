---
description: Akka 2.6.21 - akka.actor.TypedActorFactory
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:21:08Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/TypedActorFactory.html
title: Akka 2.6.21 - akka.actor.TypedActorFactory
---

# Akka 2.6.21 - akka.actor.TypedActorFactory

> **Summary:** Akka 2.6.21 - akka.actor.TypedActorFactory
...
# TypedActorFactory[**](../../akka/actor/TypedActorFactory.html "Permalink")

### 

#### trait TypedActorFactory extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)
...
Source[TypedActor.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/TypedActor.scala#L34)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Known Subclasses[ContextualTypedActorFactory](ContextualTypedActorFactory.html), [TypedActorExtension](TypedActorExtension.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. TypedActorFactory
2. AnyRef
...
1. [**](../../akka/actor/TypedActorFactory.html#actorFactory:akka.actor.ActorRefFactory "Permalink") abstract  def actorFactory: [ActorRefFactory](ActorRefFactory.html)Underlying dependency is to be able to create normal Actors

Underlying dependency is to be able to create normal Actors

Attributesprotected
2. [**](../../akka/actor/TypedActorFactory.html#getActorRefFor(proxy:AnyRef):akka.actor.ActorRef "Permalink") abstract  def getActorRefFor(proxy: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [ActorRef](ActorRef.html)Retrieves the underlying ActorRef for the supplied TypedActor proxy, or null if none found
3. [**](../../akka/actor/TypedActorFactory.html#isTypedActor(proxyOrNot:AnyRef):Boolean "Permalink") abstract  def isTypedActor(proxyOrNot: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Returns whether the supplied AnyRef is a TypedActor proxy or not
4. [**](../../akka/actor/TypedActorFactory.html#typedActor:akka.actor.TypedActorExtension "Permalink") abstract  def typedActor: [TypedActorExtension](TypedActorExtension.html)Underlying dependency to a TypedActorExtension, which can either be contextual or ActorSystem "global"
...
1. [**](../../akka/actor/TypedActorFactory.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/TypedActorFactory.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/TypedActorFactory.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from TypedActorFactory toany2stringadd\[TypedActorFactory] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/TypedActorFactory.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (TypedActorFactory, B)ImplicitThis member is added by an implicit conversion from TypedActorFactory toArrowAssoc\[TypedActorFactory] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/TypedActorFactory.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/TypedActorFactory.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/TypedActorFactory.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
8. [**](../../akka/actor/TypedActorFactory.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (TypedActorFactory) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): TypedActorFactoryImplicitThis member is added by an implicit conversion from TypedActorFactory toEnsuring\[TypedActorFactory] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/actor/TypedActorFactory.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (TypedActorFactory) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): TypedActorFactoryImplicitThis member is added by an implicit conversion from TypedActorFactory toEnsuring\[TypedActorFactory] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/TypedActorFactory.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): TypedActorFactoryImplicitThis member is added by an implicit conversion from TypedActorFactory toEnsuring\[TypedActorFactory] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/TypedActorFactory.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): TypedActorFactoryImplicitThis member is added by an implicit conversion from TypedActorFactory toEnsuring\[TypedActorFactory] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/TypedActorFactory.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/actor/TypedActorFactory.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/actor/TypedActorFactory.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
15. [**](../../akka/actor/TypedActorFactory.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
16. [**](../../akka/actor/TypedActorFactory.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/actor/TypedActorFactory.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/TypedActorFactory.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
19. [**](../../akka/actor/TypedActorFactory.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
20. [**](../../akka/actor/TypedActorFactory.html#poisonPill(proxy:AnyRef):Boolean "Permalink")  def poisonPill(proxy: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Sends a PoisonPill the underlying ActorRef for the supplied TypedActor proxy,
if any, returns whether it could find the find the ActorRef or not
21. [**](../../akka/actor/TypedActorFactory.html#stop(proxy:AnyRef):Boolean "Permalink")  def stop(proxy: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Stops the underlying ActorRef for the supplied TypedActor proxy,
if any, returns whether it could find the find the ActorRef or not
22. [**](../../akka/actor/TypedActorFactory.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
23. [**](../../akka/actor/TypedActorFactory.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
24. [**](../../akka/actor/TypedActorFactory.html#typedActorOf[R<:AnyRef,T<:R](props:akka.actor.TypedProps[T],actorRef:akka.actor.ActorRef):R "Permalink")  def typedActorOf\[R \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), T \<: R](props: [TypedProps](TypedProps.html)\[T], actorRef: [ActorRef](ActorRef.html)): RCreates a TypedActor that intercepts the calls and forwards them as [akka.actor.TypedActor.MethodCall](TypedActor$$MethodCall.html)
to the provided ActorRef.
25. [**](../../akka/actor/TypedActorFactory.html#typedActorOf[R<:AnyRef,T<:R](props:akka.actor.TypedProps[T],name:String):R "Permalink")  def typedActorOf\[R \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), T \<: R](props: [TypedProps](TypedProps.html)\[T], name: String): RCreates a new TypedActor with the specified properties
26. [**](../../akka/actor/TypedActorFactory.html#typedActorOf[R<:AnyRef,T<:R](props:akka.actor.TypedProps[T]):R "Permalink")  def typedActorOf\[R \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), T \<: R](props: [TypedProps](TypedProps.html)\[T]): RCreates a new TypedActor with the specified properties
27. [**](../../akka/actor/TypedActorFactory.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../akka/actor/TypedActorFactory.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
29. [**](../../akka/actor/TypedActorFactory.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/TypedActorFactory.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/TypedActorFactory.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from TypedActorFactory toStringFormat\[TypedActorFactory] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/TypedActorFactory.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (TypedActorFactory, B)ImplicitThis member is added by an implicit conversion from TypedActorFactory toArrowAssoc\[TypedActorFactory] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromTypedActorFactory to any2stringadd\[TypedActorFactory]

### Inherited by implicit conversion StringFormat fromTypedActorFactory to StringFormat\[TypedActorFactory]

### Inherited by implicit conversion Ensuring fromTypedActorFactory to Ensuring\[TypedActorFactory]

### Inherited by implicit conversion ArrowAssoc fromTypedActorFactory to ArrowAssoc\[TypedActorFactory]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/TypedActorFactory.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/TypedActorFactory.html)*