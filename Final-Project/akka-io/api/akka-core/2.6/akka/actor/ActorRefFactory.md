---
description: Akka 2.6.21 - akka.actor.ActorRefFactory
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:18:48Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/ActorRefFactory.html
title: Akka 2.6.21 - akka.actor.ActorRefFactory
---

# Akka 2.6.21 - akka.actor.ActorRefFactory

> **Summary:** Akka 2.6.21 - akka.actor.ActorRefFactory
...
# ActorRefFactory[**](../../akka/actor/ActorRefFactory.html "Permalink")

### 

#### trait ActorRefFactory extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)

Interface implemented by ActorSystem and ActorContext, the only two places
from which you can get fresh actors.

Annotations@implicitNotFound() Source[ActorRefProvider.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/ActorRefProvider.scala#L179)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Known Subclasses[ActorContext](AbstractActor$$ActorContext.html), [ActorContext](ActorContext.html), [ActorSystem](ActorSystem.html), [ExtendedActorSystem](ExtendedActorSystem.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ActorRefFactory
2. AnyRef
...
1. [**](../../akka/actor/ActorRefFactory.html#actorOf(props:akka.actor.Props,name:String):akka.actor.ActorRef "Permalink") abstract  def actorOf(props: [Props](Props.html), name: String): [ActorRef](ActorRef.html)Create new actor as child of this context with the given name, which must
...
Exceptions thrown`UnsupportedOperationException` if invoked on an ActorSystem that
...
2. [**](../../akka/actor/ActorRefFactory.html#actorOf(props:akka.actor.Props):akka.actor.ActorRef "Permalink") abstract  def actorOf(props: [Props](Props.html)): [ActorRef](ActorRef.html)Create new actor as child of this context and give it an automatically
...
Attributesprotected
5. [**](../../akka/actor/ActorRefFactory.html#lookupRoot:akka.actor.InternalActorRef "Permalink") abstract  def lookupRoot: InternalActorRefINTERNAL API

INTERNAL API

Attributesprotected
6. [**](../../akka/actor/ActorRefFactory.html#provider:akka.actor.ActorRefProvider "Permalink") abstract  def provider: [ActorRefProvider](ActorRefProvider.html)INTERNAL API

INTERNAL API

Attributesprotected
7. [**](../../akka/actor/ActorRefFactory.html#stop(actor:akka.actor.ActorRef):Unit "Permalink") abstract  def stop(actor: [ActorRef](ActorRef.html)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Stop the actor pointed to by the given [akka.actor.ActorRef](ActorRef.html); this is
...
8. [**](../../akka/actor/ActorRefFactory.html#systemImpl:akka.actor.ActorSystemImpl "Permalink") abstract  def systemImpl: ActorSystemImplINTERNAL API
...
1. [**](../../akka/actor/ActorRefFactory.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/ActorRefFactory.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/ActorRefFactory.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ActorRefFactory toany2stringadd\[ActorRefFactory] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/ActorRefFactory.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ActorRefFactory, B)ImplicitThis member is added by an implicit conversion from ActorRefFactory toArrowAssoc\[ActorRefFactory] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/ActorRefFactory.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/ActorRefFactory.html#actorSelection(path:akka.actor.ActorPath):akka.actor.ActorSelection "Permalink")  def actorSelection(path: [ActorPath](ActorPath.html)): [ActorSelection](ActorSelection.html)Construct an [akka.actor.ActorSelection](ActorSelection.html) from the given path, which is
...
7. [**](../../akka/actor/ActorRefFactory.html#actorSelection(path:String):akka.actor.ActorSelection "Permalink")  def actorSelection(path: String): [ActorSelection](ActorSelection.html)Construct an [akka.actor.ActorSelection](ActorSelection.html) from the given path, which is
parsed for wildcards (these are replaced by regular expressions
internally).
...
the supplied path, it is recommended to send a message and gather the
replies in order to resolve the matching set of actors.
8. [**](../../akka/actor/ActorRefFactory.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
9. [**](../../akka/actor/ActorRefFactory.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
10. [**](../../akka/actor/ActorRefFactory.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ActorRefFactory) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ActorRefFactoryImplicitThis member is added by an implicit conversion from ActorRefFactory toEnsuring\[ActorRefFactory] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/ActorRefFactory.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ActorRefFactory) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ActorRefFactoryImplicitThis member is added by an implicit conversion from ActorRefFactory toEnsuring\[ActorRefFactory] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/ActorRefFactory.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ActorRefFactoryImplicitThis member is added by an implicit conversion from ActorRefFactory toEnsuring\[ActorRefFactory] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/actor/ActorRefFactory.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ActorRefFactoryImplicitThis member is added by an implicit conversion from ActorRefFactory toEnsuring\[ActorRefFactory] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/actor/ActorRefFactory.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../akka/actor/ActorRefFactory.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
16. [**](../../akka/actor/ActorRefFactory.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
17. [**](../../akka/actor/ActorRefFactory.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
18. [**](../../akka/actor/ActorRefFactory.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
19. [**](../../akka/actor/ActorRefFactory.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
20. [**](../../akka/actor/ActorRefFactory.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
21. [**](../../akka/actor/ActorRefFactory.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
22. [**](../../akka/actor/ActorRefFactory.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
23. [**](../../akka/actor/ActorRefFactory.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
24. [**](../../akka/actor/ActorRefFactory.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
25. [**](../../akka/actor/ActorRefFactory.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
26. [**](../../akka/actor/ActorRefFactory.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/ActorRefFactory.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/ActorRefFactory.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ActorRefFactory toStringFormat\[ActorRefFactory] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/ActorRefFactory.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ActorRefFactory, B)ImplicitThis member is added by an implicit conversion from ActorRefFactory toArrowAssoc\[ActorRefFactory] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromActorRefFactory to any2stringadd\[ActorRefFactory]

### Inherited by implicit conversion StringFormat fromActorRefFactory to StringFormat\[ActorRefFactory]

### Inherited by implicit conversion Ensuring fromActorRefFactory to Ensuring\[ActorRefFactory]

### Inherited by implicit conversion ArrowAssoc fromActorRefFactory to ArrowAssoc\[ActorRefFactory]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/ActorRefFactory.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/ActorRefFactory.html)*