---
description: Akka 2.6.21 - akka.actor.DynamicAccess
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:19:31Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/DynamicAccess.html
title: Akka 2.6.21 - akka.actor.DynamicAccess
---

# Akka 2.6.21 - akka.actor.DynamicAccess

> **Summary:** Akka 2.6.21 - akka.actor.DynamicAccess
...
#### abstract  class DynamicAccess extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)
...
Annotations@[DoNotInherit](../annotation/DoNotInherit.html)() Source[DynamicAccess.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/DynamicAccess.scala#L23)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Known Subclasses[ReflectiveDynamicAccess](ReflectiveDynamicAccess.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. DynamicAccess
2. AnyRef
...
1. [**](../../akka/actor/DynamicAccess.html#classIsOnClasspath(fqcn:String):Boolean "Permalink") abstract  def classIsOnClasspath(fqcn: String): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)
...
3. [**](../../akka/actor/DynamicAccess.html#createInstanceFor[T](fqcn:String,args:Seq[(Class[_],AnyRef)])(implicitevidence$3:scala.reflect.ClassTag[T]):scala.util.Try[T] "Permalink") abstract  def createInstanceFor\[T](fqcn: String, args: [Seq](https://www.scala-lang.org/api/2.13.8/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[(Class\[\_], [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef))])(implicit arg0: [ClassTag](https://www.scala-lang.org/api/2.13.8/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[T]): [Try](https://www.scala-lang.org/api/2.13.8/scala/util/Try.html#scala.util.Try)\[T]Obtain an object conforming to the type T, which is expected to be
...
4. [**](../../akka/actor/DynamicAccess.html#createInstanceFor[T](clazz:Class[_],args:Seq[(Class[_],AnyRef)])(implicitevidence$1:scala.reflect.ClassTag[T]):scala.util.Try[T] "Permalink") abstract  def createInstanceFor\[T](clazz: Class\[\_], args: [Seq](https://www.scala-lang.org/api/2.13.8/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[(Class\[\_], [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef))])(implicit arg0: [ClassTag](https://www.scala-lang.org/api/2.13.8/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[T]): [Try](https://www.scala-lang.org/api/2.13.8/scala/util/Try.html#scala.util.Try)\[T]Convenience method which given a `Class[_]` object and a constructor description
...
1. [**](../../akka/actor/DynamicAccess.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/DynamicAccess.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
5. [**](../../akka/actor/DynamicAccess.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/DynamicAccess.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/DynamicAccess.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
8. [**](../../akka/actor/DynamicAccess.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (DynamicAccess) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): DynamicAccessImplicitThis member is added by an implicit conversion from DynamicAccess toEnsuring\[DynamicAccess] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/actor/DynamicAccess.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (DynamicAccess) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): DynamicAccessImplicitThis member is added by an implicit conversion from DynamicAccess toEnsuring\[DynamicAccess] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/DynamicAccess.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): DynamicAccessImplicitThis member is added by an implicit conversion from DynamicAccess toEnsuring\[DynamicAccess] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/DynamicAccess.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): DynamicAccessImplicitThis member is added by an implicit conversion from DynamicAccess toEnsuring\[DynamicAccess] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/DynamicAccess.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/actor/DynamicAccess.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
15. [**](../../akka/actor/DynamicAccess.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
16. [**](../../akka/actor/DynamicAccess.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/actor/DynamicAccess.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/DynamicAccess.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
19. [**](../../akka/actor/DynamicAccess.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
...
22. [**](../../akka/actor/DynamicAccess.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/actor/DynamicAccess.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/actor/DynamicAccess.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/DynamicAccess.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/DynamicAccess.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/DynamicAccess.html)*