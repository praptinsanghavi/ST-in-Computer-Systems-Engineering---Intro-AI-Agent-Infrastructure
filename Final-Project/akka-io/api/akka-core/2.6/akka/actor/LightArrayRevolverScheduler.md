---
description: Akka 2.6.21 - akka.actor.LightArrayRevolverScheduler
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:19:55Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/LightArrayRevolverScheduler.html
title: Akka 2.6.21 - akka.actor.LightArrayRevolverScheduler
---

# Akka 2.6.21 - akka.actor.LightArrayRevolverScheduler

> **Summary:** Akka 2.6.21 - akka.actor.LightArrayRevolverScheduler
...
[c](LightArrayRevolverScheduler$.html "See companion object")[akka](../index.html).[actor](index.html)

# [LightArrayRevolverScheduler](LightArrayRevolverScheduler$.html "See companion object")[**](../../akka/actor/LightArrayRevolverScheduler.html "Permalink")

### Companion [object LightArrayRevolverScheduler](LightArrayRevolverScheduler$.html "See companion object")

#### class LightArrayRevolverScheduler extends [Scheduler](Scheduler.html) with [Closeable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Closeable.html#java.io.Closeable)
...
Source[LightArrayRevolverScheduler.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/LightArrayRevolverScheduler.scala#L40)Linear Supertypes[Closeable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Closeable.html#java.io.Closeable), [AutoCloseable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/AutoCloseable.html#java.lang.AutoCloseable), [Scheduler](Scheduler.html), [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/actor/LightArrayRevolverScheduler.html#<init>(config:com.typesafe.config.Config,log:akka.event.LoggingAdapter,threadFactory:java.util.concurrent.ThreadFactory):akka.actor.LightArrayRevolverScheduler "Permalink")  new LightArrayRevolverScheduler(config: Config, log: [LoggingAdapter](../event/LoggingAdapter.html), threadFactory: [ThreadFactory](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/ThreadFactory.html#java.util.concurrent.ThreadFactory))
### Value Members

1. [**](../../akka/actor/LightArrayRevolverScheduler.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/LightArrayRevolverScheduler.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/LightArrayRevolverScheduler.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from LightArrayRevolverScheduler toany2stringadd\[LightArrayRevolverScheduler] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/LightArrayRevolverScheduler.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (LightArrayRevolverScheduler, B)ImplicitThis member is added by an implicit conversion from LightArrayRevolverScheduler toArrowAssoc\[LightArrayRevolverScheduler] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/LightArrayRevolverScheduler.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/LightArrayRevolverScheduler.html#ShutdownTimeout:scala.concurrent.duration.FiniteDuration "Permalink")  val ShutdownTimeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)
7. [**](../../akka/actor/LightArrayRevolverScheduler.html#TickDuration:scala.concurrent.duration.FiniteDuration "Permalink")  val TickDuration: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)
8. [**](../../akka/actor/LightArrayRevolverScheduler.html#WheelSize:Int "Permalink")  val WheelSize: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)
9. [**](../../akka/actor/LightArrayRevolverScheduler.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
10. [**](../../akka/actor/LightArrayRevolverScheduler.html#clock():Long "Permalink")  def clock(): [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)Clock implementation is replaceable (for testing); the implementation must
...
Attributesprotected
11. [**](../../akka/actor/LightArrayRevolverScheduler.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
12. [**](../../akka/actor/LightArrayRevolverScheduler.html#close():Unit "Permalink")  def close(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesLightArrayRevolverScheduler → Closeable → AutoCloseable
13. [**](../../akka/actor/LightArrayRevolverScheduler.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (LightArrayRevolverScheduler) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): LightArrayRevolverSchedulerImplicitThis member is added by an implicit conversion from LightArrayRevolverScheduler toEnsuring\[LightArrayRevolverScheduler] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/actor/LightArrayRevolverScheduler.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (LightArrayRevolverScheduler) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): LightArrayRevolverSchedulerImplicitThis member is added by an implicit conversion from LightArrayRevolverScheduler toEnsuring\[LightArrayRevolverScheduler] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/actor/LightArrayRevolverScheduler.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): LightArrayRevolverSchedulerImplicitThis member is added by an implicit conversion from LightArrayRevolverScheduler toEnsuring\[LightArrayRevolverScheduler] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/actor/LightArrayRevolverScheduler.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): LightArrayRevolverSchedulerImplicitThis member is added by an implicit conversion from LightArrayRevolverScheduler toEnsuring\[LightArrayRevolverScheduler] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../akka/actor/LightArrayRevolverScheduler.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/LightArrayRevolverScheduler.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
19. [**](../../akka/actor/LightArrayRevolverScheduler.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
20. [**](../../akka/actor/LightArrayRevolverScheduler.html#getShutdownTimeout:scala.concurrent.duration.FiniteDuration "Permalink")  def getShutdownTimeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)Overridable for tests

Overridable for tests

Attributesprotected
21. [**](../../akka/actor/LightArrayRevolverScheduler.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
22. [**](../../akka/actor/LightArrayRevolverScheduler.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
23. [**](../../akka/actor/LightArrayRevolverScheduler.html#maxFrequency:Double "Permalink")  val maxFrequency: [Double](https://www.scala-lang.org/api/2.13.8/scala/Double.html#scala.Double)The maximum supported task frequency of this scheduler, i.e.
...
Definition ClassesLightArrayRevolverScheduler → [Scheduler](Scheduler.html)
24. [**](../../akka/actor/LightArrayRevolverScheduler.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
25. [**](../../akka/actor/LightArrayRevolverScheduler.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
26. [**](../../akka/actor/LightArrayRevolverScheduler.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
27. [**](../../akka/actor/LightArrayRevolverScheduler.html#schedule(initialDelay:scala.concurrent.duration.FiniteDuration,delay:scala.concurrent.duration.FiniteDuration,runnable:Runnable)(implicitexecutor:scala.concurrent.ExecutionContext):akka.actor.Cancellable "Permalink")  def schedule(initialDelay: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), delay: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), runnable: [Runnable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Runnable.html#java.lang.Runnable))(implicit executor: [ExecutionContext](https://www.scala-lang.org/api/2.13.8/scala/concurrent/ExecutionContext.html#scala.concurrent.ExecutionContext)): [Cancellable](Cancellable.html)Deprecated API: See [Scheduler\#scheduleWithFixedDelay](Scheduler.html#scheduleWithFixedDelay(initialDelay:java.time.Duration,delay:java.time.Duration,receiver:akka.actor.ActorRef,message:Any,executor:scala.concurrent.ExecutionContext,sender:akka.actor.ActorRef):akka.actor.Cancellable) or [Scheduler\#scheduleAtFixedRate](Scheduler.html#scheduleAtFixedRate(initialDelay:java.time.Duration,interval:java.time.Duration,receiver:akka.actor.ActorRef,message:Any,executor:scala.concurrent.ExecutionContext,sender:akka.actor.ActorRef):akka.actor.Cancellable).
...
29. [**](../../akka/actor/LightArrayRevolverScheduler.html#scheduleAtFixedRate(initialDelay:scala.concurrent.duration.FiniteDuration,interval:scala.concurrent.duration.FiniteDuration,receiver:akka.actor.ActorRef,message:Any)(implicitexecutor:scala.concurrent.ExecutionContext,implicitsender:akka.actor.ActorRef):akka.actor.Cancellable "Permalink") final  def scheduleAtFixedRate(initialDelay: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), interval: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), receiver: [ActorRef](ActorRef.html), message: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any))(implicit executor: [ExecutionContext](https://www.scala-lang.org/api/2.13.8/scala/concurrent/ExecutionContext.html#scala.concurrent.ExecutionContext), sender: [ActorRef](ActorRef.html) \= [Actor.noSender](Actor$.html)): [Cancellable](Cancellable.html)Scala API: Schedules a message to be sent repeatedly with an initial delay and
frequency.
...
reach (calculated as: `delay / tickNanos > Int.MaxValue`).
Note: For scheduling within actors `AbstractActorWithTimers` should be preferred.
34. [**](../../akka/actor/LightArrayRevolverScheduler.html#scheduleOnce(delay:scala.concurrent.duration.FiniteDuration)(f:=>Unit)(implicitexecutor:scala.concurrent.ExecutionContext):akka.actor.Cancellable "Permalink") final  def scheduleOnce(delay: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration))(f: \=\> [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit))(implicit executor: [ExecutionContext](https://www.scala-lang.org/api/2.13.8/scala/concurrent/ExecutionContext.html#scala.concurrent.ExecutionContext)): [Cancellable](Cancellable.html)Scala API: Schedules a function to be run once with a delay, i.e.
...
reach (calculated as: `delay / tickNanos > Int.MaxValue`).
Note: For scheduling within actors `AbstractActorWithTimers` should be preferred.
36. [**](../../akka/actor/LightArrayRevolverScheduler.html#scheduleOnce(delay:scala.concurrent.duration.FiniteDuration,receiver:akka.actor.ActorRef,message:Any)(implicitexecutor:scala.concurrent.ExecutionContext,implicitsender:akka.actor.ActorRef):akka.actor.Cancellable "Permalink") final  def scheduleOnce(delay: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), receiver: [ActorRef](ActorRef.html), message: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any))(implicit executor: [ExecutionContext](https://www.scala-lang.org/api/2.13.8/scala/concurrent/ExecutionContext.html#scala.concurrent.ExecutionContext), sender: [ActorRef](ActorRef.html) \= [Actor.noSender](Actor$.html)): [Cancellable](Cancellable.html)Scala API: Schedules a message to be sent once with a delay, i.e.
...
Definition Classes[Scheduler](Scheduler.html)
39. [**](../../akka/actor/LightArrayRevolverScheduler.html#scheduleWithFixedDelay(initialDelay:scala.concurrent.duration.FiniteDuration,delay:scala.concurrent.duration.FiniteDuration,receiver:akka.actor.ActorRef,message:Any)(implicitexecutor:scala.concurrent.ExecutionContext,implicitsender:akka.actor.ActorRef):akka.actor.Cancellable "Permalink") final  def scheduleWithFixedDelay(initialDelay: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), delay: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), receiver: [ActorRef](ActorRef.html), message: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any))(implicit executor: [ExecutionContext](https://www.scala-lang.org/api/2.13.8/scala/concurrent/ExecutionContext.html#scala.concurrent.ExecutionContext), sender: [ActorRef](ActorRef.html) \= [Actor.noSender](Actor$.html)): [Cancellable](Cancellable.html)Scala API: Schedules a message to be sent repeatedly with an initial delay and
a fixed `delay` between messages.
...
reach (calculated as: `delay / tickNanos > Int.MaxValue`).
Note: For scheduling within actors `AbstractActorWithTimers` should be preferred.
41. [**](../../akka/actor/LightArrayRevolverScheduler.html#startTick:Int "Permalink")  def startTick: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Replaceable for testing.

Replaceable for testing.

Attributesprotected
42. [**](../../akka/actor/LightArrayRevolverScheduler.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
43. [**](../../akka/actor/LightArrayRevolverScheduler.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
44. [**](../../akka/actor/LightArrayRevolverScheduler.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
45. [**](../../akka/actor/LightArrayRevolverScheduler.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
46. [**](../../akka/actor/LightArrayRevolverScheduler.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
47. [**](../../akka/actor/LightArrayRevolverScheduler.html#waitNanos(nanos:Long):Unit "Permalink")  def waitNanos(nanos: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Overridable for tests
...
1. [**](../../akka/actor/LightArrayRevolverScheduler.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/LightArrayRevolverScheduler.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from LightArrayRevolverScheduler toStringFormat\[LightArrayRevolverScheduler] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
...
### Inherited by implicit conversion any2stringadd fromLightArrayRevolverScheduler to any2stringadd\[LightArrayRevolverScheduler]

### Inherited by implicit conversion StringFormat fromLightArrayRevolverScheduler to StringFormat\[LightArrayRevolverScheduler]

### Inherited by implicit conversion Ensuring fromLightArrayRevolverScheduler to Ensuring\[LightArrayRevolverScheduler]

### Inherited by implicit conversion ArrowAssoc fromLightArrayRevolverScheduler to ArrowAssoc\[LightArrayRevolverScheduler]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/LightArrayRevolverScheduler.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/LightArrayRevolverScheduler.html)*