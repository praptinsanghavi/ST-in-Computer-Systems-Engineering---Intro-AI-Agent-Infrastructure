---
description: Akka 2.6.21 - akka.actor.setup
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:17:47Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/setup/index.html
title: Akka 2.6.21 - akka.actor.setup
---

# Akka 2.6.21 - akka.actor.setup

> **Summary:** Akka 2.6.21 - akka.actor.setup
...
1. [**](../../../akka/actor/setup/ActorSystemSetup.html "Permalink") final  class [ActorSystemSetup](ActorSystemSetup.html "A set of setup settings for programmatic configuration of the actor system.") extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)A set of setup settings for programmatic configuration of the actor system.
...
instances.
2. [**](../../../akka/actor/setup/Setup.html "Permalink") abstract  class [Setup](Setup.html "Marker supertype for a setup part that can be put inside ActorSystemSetup, if a specific concrete setup is not specified in the actor system setup that means defaults are used (usually from the config file) - no concrete setup instance should be mandatory in the ActorSystemSetup that an actor system is created with.") extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Marker supertype for a setup part that can be put inside [ActorSystemSetup](ActorSystemSetup.html), if a specific concrete setup
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/setup/index.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/setup/index.html)*