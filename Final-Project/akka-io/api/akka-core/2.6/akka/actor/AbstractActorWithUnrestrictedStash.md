---
description: Akka 2.6.21 - akka.actor.AbstractActorWithUnrestrictedStash
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:18:05Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/AbstractActorWithUnrestrictedStash.html
title: Akka 2.6.21 - akka.actor.AbstractActorWithUnrestrictedStash
---

# Akka 2.6.21 - akka.actor.AbstractActorWithUnrestrictedStash

> **Summary:** Akka 2.6.21 - akka.actor.AbstractActorWithUnrestrictedStash
...
# AbstractActorWithUnrestrictedStash[**](../../akka/actor/AbstractActorWithUnrestrictedStash.html "Permalink")

### 

#### abstract  class AbstractActorWithUnrestrictedStash extends [AbstractActor](AbstractActor.html) with [UnrestrictedStash](UnrestrictedStash.html)
...
1. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#<init>():akka.actor.AbstractActorWithUnrestrictedStash "Permalink")  new AbstractActorWithUnrestrictedStash()
### Type Members

1. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#Receive=akka.actor.Actor.Receive "Permalink")  type Receive \= [PartialFunction](https://www.scala-lang.org/api/2.13.8/scala/PartialFunction.html#scala.PartialFunction)\[[Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)]Definition Classes[Actor](Actor.html)
### Abstract Value Members

1. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#createReceive():akka.actor.AbstractActor.Receive "Permalink") abstract  def createReceive(): [AbstractActor.Receive](AbstractActor$$Receive.html)An actor has to define its initial receive behavior by implementing
...
1. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from AbstractActorWithUnrestrictedStash toany2stringadd\[AbstractActorWithUnrestrictedStash] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (AbstractActorWithUnrestrictedStash, B)ImplicitThis member is added by an implicit conversion from AbstractActorWithUnrestrictedStash toArrowAssoc\[AbstractActorWithUnrestrictedStash] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#aroundPostRestart(reason:Throwable):Unit "Permalink")  def aroundPostRestart(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
7. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#aroundPostStop():Unit "Permalink")  def aroundPostStop(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
Attributesprotected\[[akka](../index.html)] Definition Classes[Actor](Actor.html)Annotations@[InternalApi](../annotation/InternalApi.html)()
9. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#aroundPreStart():Unit "Permalink")  def aroundPreStart(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
Attributesprotected\[[akka](../index.html)] Definition Classes[Actor](Actor.html)Annotations@[InternalApi](../annotation/InternalApi.html)()
11. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
12. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
13. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#context:akka.actor.ActorContext "Permalink") implicit  val context: [ActorContext](ActorContext.html)Scala API: Stores the context for this actor, including self, and sender.
...
14. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (AbstractActorWithUnrestrictedStash) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): AbstractActorWithUnrestrictedStashImplicitThis member is added by an implicit conversion from AbstractActorWithUnrestrictedStash toEnsuring\[AbstractActorWithUnrestrictedStash] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (AbstractActorWithUnrestrictedStash) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): AbstractActorWithUnrestrictedStashImplicitThis member is added by an implicit conversion from AbstractActorWithUnrestrictedStash toEnsuring\[AbstractActorWithUnrestrictedStash] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): AbstractActorWithUnrestrictedStashImplicitThis member is added by an implicit conversion from AbstractActorWithUnrestrictedStash toEnsuring\[AbstractActorWithUnrestrictedStash] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): AbstractActorWithUnrestrictedStashImplicitThis member is added by an implicit conversion from AbstractActorWithUnrestrictedStash toEnsuring\[AbstractActorWithUnrestrictedStash] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
18. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
20. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
21. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#getContext():akka.actor.AbstractActor.ActorContext "Permalink")  def getContext(): [AbstractActor.ActorContext](AbstractActor$$ActorContext.html)Returns this AbstractActor's ActorContext
...
Definition Classes[AbstractActor](AbstractActor.html)
22. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#getSelf():akka.actor.ActorRef "Permalink")  def getSelf(): [ActorRef](ActorRef.html)Returns the ActorRef for this actor.
...
Definition Classes[AbstractActor](AbstractActor.html)
23. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#getSender():akka.actor.ActorRef "Permalink")  def getSender(): [ActorRef](ActorRef.html)The reference sender Actor of the currently processed message.
...
Definition Classes[AbstractActor](AbstractActor.html)
24. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
25. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
26. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
27. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
28. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
29. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#postRestart(reason:Throwable):Unit "Permalink")  def postRestart(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback: By default it calls `preStart()`.
...
30. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#postStop():Unit "Permalink")  def postStop(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit) Overridden callback.
...
33. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#preStart():Unit "Permalink")  def preStart(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback.
...
Definition Classes[AbstractActor](AbstractActor.html) → [Actor](Actor.html)Annotations@throws(classOf\[Exception])
34. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#receive:PartialFunction[Any,Unit] "Permalink")  def receive: [PartialFunction](https://www.scala-lang.org/api/2.13.8/scala/PartialFunction.html#scala.PartialFunction)\[[Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)]Scala API: This defines the initial actor behavior, it must return a partial function
...
35. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#receiveBuilder():akka.japi.pf.ReceiveBuilder "Permalink") final  def receiveBuilder(): [ReceiveBuilder](../japi/pf/ReceiveBuilder.html)Convenience factory of the `ReceiveBuilder`.

Convenience factory of the `ReceiveBuilder`.
Creates a new empty `ReceiveBuilder`.

Definition Classes[AbstractActor](AbstractActor.html)
36. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#self:akka.actor.ActorRef "Permalink") implicit final  val self: [ActorRef](ActorRef.html)The 'self' field holds the ActorRef for this actor.
...
Definition Classes[Actor](Actor.html)
37. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#sender():akka.actor.ActorRef "Permalink") final  def sender(): [ActorRef](ActorRef.html)The reference sender Actor of the last received message.
...
Definition Classes[Actor](Actor.html)
38. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#stash():Unit "Permalink")  def stash(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit) Adds the current message (the message that the actor received last) to the
 actor's stash.
...
39. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#supervisorStrategy:akka.actor.SupervisorStrategy "Permalink")  def supervisorStrategy: [SupervisorStrategy](SupervisorStrategy.html)User overridable definition the strategy to use for supervising
child actors.
...
Definition Classes[AbstractActor](AbstractActor.html) → [Actor](Actor.html)
40. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
41. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
42. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#unhandled(message:Any):Unit "Permalink")  def unhandled(message: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback.
...
Definition Classes[Actor](Actor.html)
43. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#unstashAll():Unit "Permalink")  def unstashAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit) Prepends all messages in the stash to the mailbox, and then clears the stash.
...
44. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
45. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
46. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from AbstractActorWithUnrestrictedStash toStringFormat\[AbstractActorWithUnrestrictedStash] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/AbstractActorWithUnrestrictedStash.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (AbstractActorWithUnrestrictedStash, B)ImplicitThis member is added by an implicit conversion from AbstractActorWithUnrestrictedStash toArrowAssoc\[AbstractActorWithUnrestrictedStash] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromAbstractActorWithUnrestrictedStash to any2stringadd\[AbstractActorWithUnrestrictedStash]

### Inherited by implicit conversion StringFormat fromAbstractActorWithUnrestrictedStash to StringFormat\[AbstractActorWithUnrestrictedStash]

### Inherited by implicit conversion Ensuring fromAbstractActorWithUnrestrictedStash to Ensuring\[AbstractActorWithUnrestrictedStash]

### Inherited by implicit conversion ArrowAssoc fromAbstractActorWithUnrestrictedStash to ArrowAssoc\[AbstractActorWithUnrestrictedStash]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/AbstractActorWithUnrestrictedStash.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/AbstractActorWithUnrestrictedStash.html)*