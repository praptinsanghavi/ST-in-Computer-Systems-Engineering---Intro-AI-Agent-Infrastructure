---
description: Akka 2.6.21 - akka.actor.TypedActorExtension
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:21:10Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/TypedActorExtension.html
title: Akka 2.6.21 - akka.actor.TypedActorExtension
---

# Akka 2.6.21 - akka.actor.TypedActorExtension

> **Summary:** Akka 2.6.21 - akka.actor.TypedActorExtension
...
# TypedActorExtension[**](../../akka/actor/TypedActorExtension.html "Permalink")

### 

#### class TypedActorExtension extends [TypedActorFactory](TypedActorFactory.html) with [Extension](Extension.html)

Annotations@nowarn() Source[TypedActor.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/TypedActor.scala#L693)Linear Supertypes[Extension](Extension.html), [TypedActorFactory](TypedActorFactory.html), [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. TypedActorExtension
2. Extension
3. TypedActorFactory
4. AnyRef
5. Any
...
1. [**](../../akka/actor/TypedActorExtension.html#<init>(system:akka.actor.ExtendedActorSystem):akka.actor.TypedActorExtension "Permalink")  new TypedActorExtension(system: [ExtendedActorSystem](ExtendedActorSystem.html))
### Value Members

1. [**](../../akka/actor/TypedActorExtension.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/TypedActorExtension.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/TypedActorExtension.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from TypedActorExtension toany2stringadd\[TypedActorExtension] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/TypedActorExtension.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (TypedActorExtension, B)ImplicitThis member is added by an implicit conversion from TypedActorExtension toArrowAssoc\[TypedActorExtension] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/TypedActorExtension.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/TypedActorExtension.html#DefaultReturnTimeout:akka.util.Timeout "Permalink") final  val DefaultReturnTimeout: [Timeout](../util/Timeout.html)Default timeout for typed actor methods with non\-void return type
7. [**](../../akka/actor/TypedActorExtension.html#actorFactory:akka.actor.ActorRefFactory "Permalink")  def actorFactory: [ActorRefFactory](ActorRefFactory.html)Underlying dependency is to be able to create normal Actors

Underlying dependency is to be able to create normal Actors

Attributesprotected Definition ClassesTypedActorExtension → [TypedActorFactory](TypedActorFactory.html)
8. [**](../../akka/actor/TypedActorExtension.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
9. [**](../../akka/actor/TypedActorExtension.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
10. [**](../../akka/actor/TypedActorExtension.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (TypedActorExtension) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): TypedActorExtensionImplicitThis member is added by an implicit conversion from TypedActorExtension toEnsuring\[TypedActorExtension] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/TypedActorExtension.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (TypedActorExtension) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): TypedActorExtensionImplicitThis member is added by an implicit conversion from TypedActorExtension toEnsuring\[TypedActorExtension] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/TypedActorExtension.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): TypedActorExtensionImplicitThis member is added by an implicit conversion from TypedActorExtension toEnsuring\[TypedActorExtension] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/actor/TypedActorExtension.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): TypedActorExtensionImplicitThis member is added by an implicit conversion from TypedActorExtension toEnsuring\[TypedActorExtension] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/actor/TypedActorExtension.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../akka/actor/TypedActorExtension.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
16. [**](../../akka/actor/TypedActorExtension.html#getActorRefFor(proxy:AnyRef):akka.actor.ActorRef "Permalink")  def getActorRefFor(proxy: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [ActorRef](ActorRef.html)Retrieves the underlying ActorRef for the supplied TypedActor proxy, or null if none found

Retrieves the underlying ActorRef for the supplied TypedActor proxy, or null if none found

Definition ClassesTypedActorExtension → [TypedActorFactory](TypedActorFactory.html)
17. [**](../../akka/actor/TypedActorExtension.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
18. [**](../../akka/actor/TypedActorExtension.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
19. [**](../../akka/actor/TypedActorExtension.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
20. [**](../../akka/actor/TypedActorExtension.html#isTypedActor(proxyOrNot:AnyRef):Boolean "Permalink")  def isTypedActor(proxyOrNot: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Returns whether the supplied AnyRef is a TypedActor proxy or not

Returns whether the supplied AnyRef is a TypedActor proxy or not

Definition ClassesTypedActorExtension → [TypedActorFactory](TypedActorFactory.html)
21. [**](../../akka/actor/TypedActorExtension.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
22. [**](../../akka/actor/TypedActorExtension.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
23. [**](../../akka/actor/TypedActorExtension.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
24. [**](../../akka/actor/TypedActorExtension.html#poisonPill(proxy:AnyRef):Boolean "Permalink")  def poisonPill(proxy: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Sends a PoisonPill the underlying ActorRef for the supplied TypedActor proxy,
...
Definition Classes[TypedActorFactory](TypedActorFactory.html)
25. [**](../../akka/actor/TypedActorExtension.html#stop(proxy:AnyRef):Boolean "Permalink")  def stop(proxy: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Stops the underlying ActorRef for the supplied TypedActor proxy,
if any, returns whether it could find the find the ActorRef or not
...
Definition Classes[TypedActorFactory](TypedActorFactory.html)
26. [**](../../akka/actor/TypedActorExtension.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
27. [**](../../akka/actor/TypedActorExtension.html#system:akka.actor.ExtendedActorSystem "Permalink")  val system: [ExtendedActorSystem](ExtendedActorSystem.html)
28. [**](../../akka/actor/TypedActorExtension.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
29. [**](../../akka/actor/TypedActorExtension.html#typedActor:akka.actor.TypedActorExtension "Permalink")  def typedActor: TypedActorExtensionUnderlying dependency to a TypedActorExtension, which can either be contextual or ActorSystem "global"

Underlying dependency to a TypedActorExtension, which can either be contextual or ActorSystem "global"

Attributesprotected Definition ClassesTypedActorExtension → [TypedActorFactory](TypedActorFactory.html)
30. [**](../../akka/actor/TypedActorExtension.html#typedActorOf[R<:AnyRef,T<:R](props:akka.actor.TypedProps[T],actorRef:akka.actor.ActorRef):R "Permalink")  def typedActorOf\[R \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), T \<: R](props: [TypedProps](TypedProps.html)\[T], actorRef: [ActorRef](ActorRef.html)): RCreates a TypedActor that intercepts the calls and forwards them as [akka.actor.TypedActor.MethodCall](TypedActor$$MethodCall.html)
to the provided ActorRef.

Creates a TypedActor that intercepts the calls and forwards them as [akka.actor.TypedActor.MethodCall](TypedActor$$MethodCall.html)
to the provided ActorRef.

Definition Classes[TypedActorFactory](TypedActorFactory.html)
31. [**](../../akka/actor/TypedActorExtension.html#typedActorOf[R<:AnyRef,T<:R](props:akka.actor.TypedProps[T],name:String):R "Permalink")  def typedActorOf\[R \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), T \<: R](props: [TypedProps](TypedProps.html)\[T], name: String): RCreates a new TypedActor with the specified properties

Creates a new TypedActor with the specified properties

Definition Classes[TypedActorFactory](TypedActorFactory.html)
32. [**](../../akka/actor/TypedActorExtension.html#typedActorOf[R<:AnyRef,T<:R](props:akka.actor.TypedProps[T]):R "Permalink")  def typedActorOf\[R \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), T \<: R](props: [TypedProps](TypedProps.html)\[T]): RCreates a new TypedActor with the specified properties

Creates a new TypedActor with the specified properties

Definition Classes[TypedActorFactory](TypedActorFactory.html)
33. [**](../../akka/actor/TypedActorExtension.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
34. [**](../../akka/actor/TypedActorExtension.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
35. [**](../../akka/actor/TypedActorExtension.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/TypedActorExtension.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/TypedActorExtension.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from TypedActorExtension toStringFormat\[TypedActorExtension] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/TypedActorExtension.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (TypedActorExtension, B)ImplicitThis member is added by an implicit conversion from TypedActorExtension toArrowAssoc\[TypedActorExtension] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [Extension](Extension.html)

### Inherited from [TypedActorFactory](TypedActorFactory.html)
...
### Inherited by implicit conversion any2stringadd fromTypedActorExtension to any2stringadd\[TypedActorExtension]

### Inherited by implicit conversion StringFormat fromTypedActorExtension to StringFormat\[TypedActorExtension]

### Inherited by implicit conversion Ensuring fromTypedActorExtension to Ensuring\[TypedActorExtension]

### Inherited by implicit conversion ArrowAssoc fromTypedActorExtension to ArrowAssoc\[TypedActorExtension]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/TypedActorExtension.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/TypedActorExtension.html)*