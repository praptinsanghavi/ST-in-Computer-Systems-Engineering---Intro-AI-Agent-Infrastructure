---
description: Akka 2.6.21 - akka.actor.ChildRestartStats
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:19:08Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/ChildRestartStats.html
title: Akka 2.6.21 - akka.actor.ChildRestartStats
---

# Akka 2.6.21 - akka.actor.ChildRestartStats

> **Summary:** Akka 2.6.21 - akka.actor.ChildRestartStats
...
# ChildRestartStats[**](../../akka/actor/ChildRestartStats.html "Permalink")

### 

#### final  case class ChildRestartStats(child: [ActorRef](ActorRef.html), maxNrOfRetriesCount: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int) \= 0, restartTimeWindowStartNanos: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long) \= 0L) extends ChildStats with [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with Serializable

ChildRestartStats is the statistics kept by every parent Actor for every child Actor
and is used for SupervisorStrategies to know how to deal with problems that occur for the children.

Annotations@ccompatUsedUntil213() Source[FaultHandling.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/FaultHandling.scala#L38)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.8/scala/Equals.html#scala.Equals), ChildStats, [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ChildRestartStats
2. Serializable
...
1. [**](../../akka/actor/ChildRestartStats.html#<init>(child:akka.actor.ActorRef,maxNrOfRetriesCount:Int,restartTimeWindowStartNanos:Long):akka.actor.ChildRestartStats "Permalink")  new ChildRestartStats(child: [ActorRef](ActorRef.html), maxNrOfRetriesCount: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int) \= 0, restartTimeWindowStartNanos: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long) \= 0L)
### Value Members

1. [**](../../akka/actor/ChildRestartStats.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/ChildRestartStats.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/ChildRestartStats.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ChildRestartStats toany2stringadd\[ChildRestartStats] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/ChildRestartStats.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ChildRestartStats, B)ImplicitThis member is added by an implicit conversion from ChildRestartStats toArrowAssoc\[ChildRestartStats] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/ChildRestartStats.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/ChildRestartStats.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/ChildRestartStats.html#child:akka.actor.ActorRef "Permalink")  val child: [ActorRef](ActorRef.html)
8. [**](../../akka/actor/ChildRestartStats.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
9. [**](../../akka/actor/ChildRestartStats.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ChildRestartStats) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ChildRestartStatsImplicitThis member is added by an implicit conversion from ChildRestartStats toEnsuring\[ChildRestartStats] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/ChildRestartStats.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ChildRestartStats) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ChildRestartStatsImplicitThis member is added by an implicit conversion from ChildRestartStats toEnsuring\[ChildRestartStats] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/ChildRestartStats.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ChildRestartStatsImplicitThis member is added by an implicit conversion from ChildRestartStats toEnsuring\[ChildRestartStats] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/ChildRestartStats.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ChildRestartStatsImplicitThis member is added by an implicit conversion from ChildRestartStats toEnsuring\[ChildRestartStats] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/actor/ChildRestartStats.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/actor/ChildRestartStats.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
15. [**](../../akka/actor/ChildRestartStats.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
16. [**](../../akka/actor/ChildRestartStats.html#maxNrOfRetriesCount:Int "Permalink")  var maxNrOfRetriesCount: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)
17. [**](../../akka/actor/ChildRestartStats.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/ChildRestartStats.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
19. [**](../../akka/actor/ChildRestartStats.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
20. [**](../../akka/actor/ChildRestartStats.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
21. [**](../../akka/actor/ChildRestartStats.html#requestRestartPermission(retriesWindow:(Option[Int],Option[Int])):Boolean "Permalink")  def requestRestartPermission(retriesWindow: ([Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)], [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)])): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)
22. [**](../../akka/actor/ChildRestartStats.html#restartTimeWindowStartNanos:Long "Permalink")  var restartTimeWindowStartNanos: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)
23. [**](../../akka/actor/ChildRestartStats.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
24. [**](../../akka/actor/ChildRestartStats.html#uid:Int "Permalink")  def uid: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)
25. [**](../../akka/actor/ChildRestartStats.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../akka/actor/ChildRestartStats.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
27. [**](../../akka/actor/ChildRestartStats.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/ChildRestartStats.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/ChildRestartStats.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ChildRestartStats toStringFormat\[ChildRestartStats] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/ChildRestartStats.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ChildRestartStats, B)ImplicitThis member is added by an implicit conversion from ChildRestartStats toArrowAssoc\[ChildRestartStats] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromChildRestartStats to any2stringadd\[ChildRestartStats]

### Inherited by implicit conversion StringFormat fromChildRestartStats to StringFormat\[ChildRestartStats]

### Inherited by implicit conversion Ensuring fromChildRestartStats to Ensuring\[ChildRestartStats]

### Inherited by implicit conversion ArrowAssoc fromChildRestartStats to ArrowAssoc\[ChildRestartStats]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/ChildRestartStats.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/ChildRestartStats.html)*