---
description: Akka 2.6.21 - akka.actor.ActorLogging
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:13:58Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/ActorLogging.html
title: Akka 2.6.21 - akka.actor.ActorLogging
---

# Akka 2.6.21 - akka.actor.ActorLogging

> **Summary:** Akka 2.6.21 - akka.actor.ActorLogging
...
# ActorLogging[**](../../akka/actor/ActorLogging.html "Permalink")

### 

#### trait ActorLogging extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)
...
```
Self TypeActorLogging with [Actor](Actor.html)Source[Actor.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/Actor.scala#L330)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Known Subclasses[Terminator](../Main$$Terminator.html), [AbstractFSM](AbstractFSM.html), [AbstractFSMWithStash](AbstractFSMWithStash.html), [AbstractLoggingActor](AbstractLoggingActor.html), [AbstractLoggingFSM](AbstractLoggingFSM.html), [FSM](FSM.html), [LoggingFSM](LoggingFSM.html), [LmdbDurableStore](../cluster/ddata/LmdbDurableStore.html), [Replicator](../cluster/ddata/Replicator.html), [DistributedPubSubMediator](../cluster/pubsub/DistributedPubSubMediator.html), [RemoveInternalClusterShardingData](../cluster/sharding/RemoveInternalClusterShardingData.html), [ClusterSingletonManager](../cluster/singleton/ClusterSingletonManager.html), [ClusterSingletonProxy](../cluster/singleton/ClusterSingletonProxy.html), [InetAddressDnsResolver](../io/InetAddressDnsResolver.html), [SimpleDnsManager](../io/SimpleDnsManager.html), [BenchActor](../persistence/journal/JournalPerfSpec$$BenchActor.html), [PersistencePluginProxy](../persistence/journal/PersistencePluginProxy.html), [NoSnapshotStore](../persistence/snapshot/NoSnapshotStore.html), [SnapshotStore](../persistence/snapshot/SnapshotStore.html), [SnapshotStore](../persistence/snapshot/japi/SnapshotStore.html), [PersistenceTestKitPlugin](../persistence/testkit/PersistenceTestKitPlugin.html), [PersistenceTestKitSnapshotPlugin](../persistence/testkit/PersistenceTestKitSnapshotPlugin.html), [ClusterClient](../cluster/client/ClusterClient.html), [ClusterReceptionist](../cluster/client/ClusterReceptionist.html), [AbstractPersistentFSM](../persistence/fsm/AbstractPersistentFSM.html), [AbstractPersistentFSMBase](../persistence/fsm/AbstractPersistentFSMBase.html), [AbstractPersistentLoggingFSM](../persistence/fsm/AbstractPersistentLoggingFSM.html), [LoggingPersistentFSM](../persistence/fsm/LoggingPersistentFSM.html), [PersistentFSM](../persistence/fsm/PersistentFSM.html), [PersistentFSMBase](../persistence/fsm/PersistentFSMBase.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ActorLogging
2. AnyRef
...
1. [**](../../akka/actor/ActorLogging.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/ActorLogging.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/ActorLogging.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ActorLogging toany2stringadd\[ActorLogging] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/ActorLogging.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ActorLogging, B)ImplicitThis member is added by an implicit conversion from ActorLogging toArrowAssoc\[ActorLogging] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/ActorLogging.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/ActorLogging.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/ActorLogging.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
8. [**](../../akka/actor/ActorLogging.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ActorLogging) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ActorLoggingImplicitThis member is added by an implicit conversion from ActorLogging toEnsuring\[ActorLogging] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/actor/ActorLogging.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ActorLogging) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ActorLoggingImplicitThis member is added by an implicit conversion from ActorLogging toEnsuring\[ActorLogging] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/ActorLogging.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ActorLoggingImplicitThis member is added by an implicit conversion from ActorLogging toEnsuring\[ActorLogging] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/ActorLogging.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ActorLoggingImplicitThis member is added by an implicit conversion from ActorLogging toEnsuring\[ActorLogging] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/ActorLogging.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/actor/ActorLogging.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/actor/ActorLogging.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
15. [**](../../akka/actor/ActorLogging.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
16. [**](../../akka/actor/ActorLogging.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/actor/ActorLogging.html#log:akka.event.LoggingAdapter "Permalink")  def log: [LoggingAdapter](../event/LoggingAdapter.html)
18. [**](../../akka/actor/ActorLogging.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../akka/actor/ActorLogging.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
20. [**](../../akka/actor/ActorLogging.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
21. [**](../../akka/actor/ActorLogging.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../akka/actor/ActorLogging.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
23. [**](../../akka/actor/ActorLogging.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../akka/actor/ActorLogging.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../akka/actor/ActorLogging.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/ActorLogging.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/ActorLogging.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ActorLogging toStringFormat\[ActorLogging] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/ActorLogging.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ActorLogging, B)ImplicitThis member is added by an implicit conversion from ActorLogging toArrowAssoc\[ActorLogging] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromActorLogging to any2stringadd\[ActorLogging]

### Inherited by implicit conversion StringFormat fromActorLogging to StringFormat\[ActorLogging]

### Inherited by implicit conversion Ensuring fromActorLogging to Ensuring\[ActorLogging]

### Inherited by implicit conversion ArrowAssoc fromActorLogging to ArrowAssoc\[ActorLogging]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/ActorLogging.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/ActorLogging.html)*