...
scraped_at: '2026-04-06T14:21:14Z'
section: api
site: akka-io
...
[o](TypedProps.html "See companion class")[akka](../index.html).[actor](index.html)

# [TypedProps](TypedProps.html "See companion class")[**](../../akka/actor/TypedProps$.html "Permalink")

### Companion [class TypedProps](TypedProps.html "See companion class")

#### object TypedProps extends [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)
...
Source[TypedActor.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/TypedActor.scala#L519)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. TypedProps
2. Serializable
...
3. [**](../../akka/actor/TypedProps$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/actor/TypedProps$.html#apply[T<:AnyRef]()(implicitevidence$1:scala.reflect.ClassTag[T]):akka.actor.TypedProps[T] "Permalink")  def apply\[T \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]()(implicit arg0: [ClassTag](https://www.scala-lang.org/api/2.13.8/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[T]): [TypedProps](TypedProps.html)\[T]Uses the supplied class as the factory for the TypedActor implementation,
...
Scala API
5. [**](../../akka/actor/TypedProps$.html#apply[T<:AnyRef](interface:Class[_>:T],creator:=>T):akka.actor.TypedProps[T] "Permalink")  def apply\[T \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)](interface: Class\[\_ \>: T], creator: \=\> T): [TypedProps](TypedProps.html)\[T]Uses the supplied thunk as the factory for the TypedActor implementation,
...
Scala API
6. [**](../../akka/actor/TypedProps$.html#apply[T<:AnyRef](interface:Class[_>:T],implementation:Class[T]):akka.actor.TypedProps[T] "Permalink")  def apply\[T \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)](interface: Class\[\_ \>: T], implementation: Class\[T]): [TypedProps](TypedProps.html)\[T]Uses the supplied class as the factory for the TypedActor implementation,
and that has the specified interface,
or if the interface class is not an interface, all the interfaces it implements,
appended in the sequence of interfaces.
...
Scala API
7. [**](../../akka/actor/TypedProps$.html#apply[T<:AnyRef](implementation:Class[T]):akka.actor.TypedProps[T] "Permalink")  def apply\[T \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)](implementation: Class\[T]): [TypedProps](TypedProps.html)\[T]Uses the supplied class as the factory for the TypedActor implementation,
proxying all the interfaces it implements.
...
Scala API
8. [**](../../akka/actor/TypedProps$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
9. [**](../../akka/actor/TypedProps$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
10. [**](../../akka/actor/TypedProps$.html#defaultDispatcherId:String "Permalink")  val defaultDispatcherId: String
11. [**](../../akka/actor/TypedProps$.html#defaultLoader:Option[ClassLoader] "Permalink")  val defaultLoader: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)]
12. [**](../../akka/actor/TypedProps$.html#defaultTimeout:Option[akka.util.Timeout] "Permalink")  val defaultTimeout: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[Timeout](../util/Timeout.html)]
13. [**](../../akka/actor/TypedProps$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/actor/TypedProps$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
15. [**](../../akka/actor/TypedProps$.html#extractInterfaces(clazz:Class[_]):Seq[Class[_]] "Permalink")  def extractInterfaces(clazz: Class\[\_]): [Seq](https://www.scala-lang.org/api/2.13.8/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[Class\[\_]]returnsa sequence of interfaces that the specified class implements,
or a sequence containing only itself, if itself is an interface.
16. [**](../../akka/actor/TypedProps$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
17. [**](../../akka/actor/TypedProps$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
18. [**](../../akka/actor/TypedProps$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
19. [**](../../akka/actor/TypedProps$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
20. [**](../../akka/actor/TypedProps$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
21. [**](../../akka/actor/TypedProps$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
22. [**](../../akka/actor/TypedProps$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
23. [**](../../akka/actor/TypedProps$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
24. [**](../../akka/actor/TypedProps$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
25. [**](../../akka/actor/TypedProps$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
26. [**](../../akka/actor/TypedProps$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
