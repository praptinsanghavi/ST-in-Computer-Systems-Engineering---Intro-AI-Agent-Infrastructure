---
description: Akka 2.6.21 - akka.actor.ExtensionId
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:19:34Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/ExtensionId.html
title: Akka 2.6.21 - akka.actor.ExtensionId
---

# Akka 2.6.21 - akka.actor.ExtensionId

> **Summary:** Akka 2.6.21 - akka.actor.ExtensionId
...
# ExtensionId[**](../../akka/actor/ExtensionId.html "Permalink")

### 

#### trait ExtensionId\[T \<: [Extension](Extension.html)] extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)
...
1. [**](../../akka/actor/ExtensionId.html#createExtension(system:akka.actor.ExtendedActorSystem):T "Permalink") abstract  def createExtension(system: [ExtendedActorSystem](ExtendedActorSystem.html)): TIs used by Akka to instantiate the Extension identified by this ExtensionId,
internal use only.
### Concrete Value Members

1. [**](../../akka/actor/ExtensionId.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/ExtensionId.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/ExtensionId.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ExtensionId\[T] toany2stringadd\[ExtensionId\[T]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/ExtensionId.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ExtensionId\[T], B)ImplicitThis member is added by an implicit conversion from ExtensionId\[T] toArrowAssoc\[ExtensionId\[T]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/ExtensionId.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/ExtensionId.html#apply(system:akka.actor.ClassicActorSystemProvider):T "Permalink")  def apply(system: [ClassicActorSystemProvider](ClassicActorSystemProvider.html)): TReturns an instance of the extension identified by this ExtensionId instance.
7. [**](../../akka/actor/ExtensionId.html#apply(system:akka.actor.ActorSystem):T "Permalink")  def apply(system: [ActorSystem](ActorSystem.html)): TReturns an instance of the extension identified by this ExtensionId instance.
8. [**](../../akka/actor/ExtensionId.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
9. [**](../../akka/actor/ExtensionId.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
10. [**](../../akka/actor/ExtensionId.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ExtensionId\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ExtensionId\[T]ImplicitThis member is added by an implicit conversion from ExtensionId\[T] toEnsuring\[ExtensionId\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/ExtensionId.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ExtensionId\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ExtensionId\[T]ImplicitThis member is added by an implicit conversion from ExtensionId\[T] toEnsuring\[ExtensionId\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/ExtensionId.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ExtensionId\[T]ImplicitThis member is added by an implicit conversion from ExtensionId\[T] toEnsuring\[ExtensionId\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/actor/ExtensionId.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ExtensionId\[T]ImplicitThis member is added by an implicit conversion from ExtensionId\[T] toEnsuring\[ExtensionId\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/actor/ExtensionId.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../akka/actor/ExtensionId.html#equals(other:Any):Boolean "Permalink") final  def equals(other: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesExtensionId → AnyRef → Any
16. [**](../../akka/actor/ExtensionId.html#get(system:akka.actor.ClassicActorSystemProvider):T "Permalink")  def get(system: [ClassicActorSystemProvider](ClassicActorSystemProvider.html)): TReturns an instance of the extension identified by this ExtensionId instance.
...
```
17. [**](../../akka/actor/ExtensionId.html#get(system:akka.actor.ActorSystem):T "Permalink")  def get(system: [ActorSystem](ActorSystem.html)): TReturns an instance of the extension identified by this ExtensionId instance.
...
```
18. [**](../../akka/actor/ExtensionId.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
19. [**](../../akka/actor/ExtensionId.html#hashCode():Int "Permalink") final  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesExtensionId → AnyRef → Any
20. [**](../../akka/actor/ExtensionId.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
21. [**](../../akka/actor/ExtensionId.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
22. [**](../../akka/actor/ExtensionId.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
23. [**](../../akka/actor/ExtensionId.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
24. [**](../../akka/actor/ExtensionId.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
25. [**](../../akka/actor/ExtensionId.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
26. [**](../../akka/actor/ExtensionId.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
27. [**](../../akka/actor/ExtensionId.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
28. [**](../../akka/actor/ExtensionId.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/ExtensionId.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/ExtensionId.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ExtensionId\[T] toStringFormat\[ExtensionId\[T]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/ExtensionId.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ExtensionId\[T], B)ImplicitThis member is added by an implicit conversion from ExtensionId\[T] toArrowAssoc\[ExtensionId\[T]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/ExtensionId.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/ExtensionId.html)*