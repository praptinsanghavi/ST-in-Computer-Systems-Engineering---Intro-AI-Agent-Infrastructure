---
description: Akka 2.6.21 - akka.actor.TimerScheduler
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:21:02Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/TimerScheduler.html
title: Akka 2.6.21 - akka.actor.TimerScheduler
---

# Akka 2.6.21 - akka.actor.TimerScheduler

> **Summary:** Akka 2.6.21 - akka.actor.TimerScheduler
...
#### abstract  class TimerScheduler extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)
...
Annotations@[DoNotInherit](../annotation/DoNotInherit.html)() Source[Timers.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/Timers.scala#L87)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. TimerScheduler
2. AnyRef
...
1. [**](../../akka/actor/TimerScheduler.html#cancel(key:Any):Unit "Permalink") abstract  def cancel(key: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Cancel a timer with a given `key`.
...
2. [**](../../akka/actor/TimerScheduler.html#cancelAll():Unit "Permalink") abstract  def cancelAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Cancel all timers.
3. [**](../../akka/actor/TimerScheduler.html#isTimerActive(key:Any):Boolean "Permalink") abstract  def isTimerActive(key: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Check if a timer with a given `key` is active.
4. [**](../../akka/actor/TimerScheduler.html#startSingleTimer(key:Any,msg:Any,timeout:scala.concurrent.duration.FiniteDuration):Unit "Permalink") abstract  def startSingleTimer(key: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Start a timer that will send `msg` once to the `self` actor after
the given `timeout`.
...
5. [**](../../akka/actor/TimerScheduler.html#startTimerAtFixedRate(key:Any,msg:Any,initialDelay:scala.concurrent.duration.FiniteDuration,interval:scala.concurrent.duration.FiniteDuration):Unit "Permalink") abstract  def startTimerAtFixedRate(key: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), initialDelay: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), interval: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Scala API: Schedules a message to be sent repeatedly to the `self` actor with a
given frequency.
...
previous timer is not received, even if it was already enqueued
in the mailbox when the new timer was started.
6. [**](../../akka/actor/TimerScheduler.html#startTimerAtFixedRate(key:Any,msg:Any,interval:scala.concurrent.duration.FiniteDuration):Unit "Permalink") abstract  def startTimerAtFixedRate(key: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), interval: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Scala API: Schedules a message to be sent repeatedly to the `self` actor with a
given frequency.
...
previous timer is not received, even if it was already enqueued
in the mailbox when the new timer was started.
7. [**](../../akka/actor/TimerScheduler.html#startTimerWithFixedDelay(key:Any,msg:Any,initialDelay:scala.concurrent.duration.FiniteDuration,delay:scala.concurrent.duration.FiniteDuration):Unit "Permalink") abstract  def startTimerWithFixedDelay(key: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), initialDelay: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), delay: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Scala API: Schedules a message to be sent repeatedly to the `self` actor with a
...
previous timer is not received, even if it was already enqueued
in the mailbox when the new timer was started.
8. [**](../../akka/actor/TimerScheduler.html#startTimerWithFixedDelay(key:Any,msg:Any,delay:scala.concurrent.duration.FiniteDuration):Unit "Permalink") abstract  def startTimerWithFixedDelay(key: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), delay: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Scala API: Schedules a message to be sent repeatedly to the `self` actor with a
...
previous timer is not received, even if it was already enqueued
in the mailbox when the new timer was started.
9. [**](../../akka/actor/TimerScheduler.html#startPeriodicTimer(key:Any,msg:Any,interval:scala.concurrent.duration.FiniteDuration):Unit "Permalink") abstract  def startPeriodicTimer(key: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), interval: [FiniteDuration](https://www.scala-lang.org/api/2.13.8/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Deprecated API: See [TimerScheduler\#startTimerWithFixedDelay](#startTimerWithFixedDelay(key:Any,msg:Any,initialDelay:java.time.Duration,delay:java.time.Duration):Unit) or [TimerScheduler\#startTimerAtFixedRate](#startTimerAtFixedRate(key:Any,msg:Any,initialDelay:java.time.Duration,interval:java.time.Duration):Unit).
...
1. [**](../../akka/actor/TimerScheduler.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/TimerScheduler.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
5. [**](../../akka/actor/TimerScheduler.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/TimerScheduler.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/TimerScheduler.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
8. [**](../../akka/actor/TimerScheduler.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (TimerScheduler) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): TimerSchedulerImplicitThis member is added by an implicit conversion from TimerScheduler toEnsuring\[TimerScheduler] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/actor/TimerScheduler.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (TimerScheduler) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): TimerSchedulerImplicitThis member is added by an implicit conversion from TimerScheduler toEnsuring\[TimerScheduler] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/TimerScheduler.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): TimerSchedulerImplicitThis member is added by an implicit conversion from TimerScheduler toEnsuring\[TimerScheduler] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/TimerScheduler.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): TimerSchedulerImplicitThis member is added by an implicit conversion from TimerScheduler toEnsuring\[TimerScheduler] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/TimerScheduler.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/actor/TimerScheduler.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
15. [**](../../akka/actor/TimerScheduler.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
16. [**](../../akka/actor/TimerScheduler.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/actor/TimerScheduler.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/TimerScheduler.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
19. [**](../../akka/actor/TimerScheduler.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
20. [**](../../akka/actor/TimerScheduler.html#startSingleTimer(key:Any,msg:Any,timeout:java.time.Duration):Unit "Permalink") final  def startSingleTimer(key: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), timeout: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Start a timer that will send `msg` once to the `self` actor after
the given `timeout`.
...
previous timer is not received, even if it was already enqueued
in the mailbox when the new timer was started.
21. [**](../../akka/actor/TimerScheduler.html#startTimerAtFixedRate(key:Any,msg:Any,initialDelay:java.time.Duration,interval:java.time.Duration):Unit "Permalink") final  def startTimerAtFixedRate(key: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), initialDelay: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), interval: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Java API: Schedules a message to be sent repeatedly to the `self` actor with a
given frequency.
...
previous timer is not received, even if it was already enqueued
in the mailbox when the new timer was started.
22. [**](../../akka/actor/TimerScheduler.html#startTimerAtFixedRate(key:Any,msg:Any,interval:java.time.Duration):Unit "Permalink") final  def startTimerAtFixedRate(key: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), interval: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Java API: Schedules a message to be sent repeatedly to the `self` actor with a
given frequency.
...
previous timer is not received, even if it was already enqueued
in the mailbox when the new timer was started.
23. [**](../../akka/actor/TimerScheduler.html#startTimerWithFixedDelay(key:Any,msg:Any,initialDelay:java.time.Duration,delay:java.time.Duration):Unit "Permalink") final  def startTimerWithFixedDelay(key: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), initialDelay: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), delay: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Java API: Schedules a message to be sent repeatedly to the `self` actor with a
fixed `delay` between messages after the `initialDelay`.
...
previous timer is not received, even if it was already enqueued
in the mailbox when the new timer was started.
24. [**](../../akka/actor/TimerScheduler.html#startTimerWithFixedDelay(key:Any,msg:Any,delay:java.time.Duration):Unit "Permalink") final  def startTimerWithFixedDelay(key: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), delay: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Java API: Schedules a message to be sent repeatedly to the `self` actor with a
fixed `delay` between messages.
...
27. [**](../../akka/actor/TimerScheduler.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../akka/actor/TimerScheduler.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
29. [**](../../akka/actor/TimerScheduler.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/TimerScheduler.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
...
3. [**](../../akka/actor/TimerScheduler.html#startPeriodicTimer(key:Any,msg:Any,interval:java.time.Duration):Unit "Permalink") final  def startPeriodicTimer(key: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), interval: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Deprecated API: See [TimerScheduler\#startTimerWithFixedDelay](#startTimerWithFixedDelay(key:Any,msg:Any,initialDelay:java.time.Duration,delay:java.time.Duration):Unit) or [TimerScheduler\#startTimerAtFixedRate](#startTimerAtFixedRate(key:Any,msg:Any,initialDelay:java.time.Duration,interval:java.time.Duration):Unit).
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/TimerScheduler.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/TimerScheduler.html)*