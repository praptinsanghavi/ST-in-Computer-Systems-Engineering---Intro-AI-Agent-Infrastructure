---
description: Akka 2.6.21 - akka.actor.TypedProps
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:21:18Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/TypedProps.html
title: Akka 2.6.21 - akka.actor.TypedProps
---

# Akka 2.6.21 - akka.actor.TypedProps

> **Summary:** Akka 2.6.21 - akka.actor.TypedProps
...
[c](TypedProps$.html "See companion object")[akka](../index.html).[actor](index.html)

# [TypedProps](TypedProps$.html "See companion object")[**](../../akka/actor/TypedProps.html "Permalink")

### Companion [object TypedProps](TypedProps$.html "See companion object")

#### final  case class TypedProps\[T \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)](interfaces: [Seq](https://www.scala-lang.org/api/2.13.8/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[Class\[\_]], creator: () \=\> T, dispatcher: String \= [TypedProps.defaultDispatcherId](TypedProps$.html), deploy: [Deploy](Deploy.html) \= [Props.defaultDeploy](Props$.html), timeout: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[Timeout](../util/Timeout.html)] \= [TypedProps.defaultTimeout](TypedProps$.html), loader: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)] \= [TypedProps.defaultLoader](TypedProps$.html)) extends [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with Serializable
...
1. [**](../../akka/actor/TypedProps.html#<init>(interface:Class[_>:T],implementation:Class[T]):akka.actor.TypedProps[T] "Permalink")  new TypedProps(interface: Class\[\_ \>: T], implementation: Class\[T])Java API: Uses the supplied class as the factory for the TypedActor implementation,
...
2. [**](../../akka/actor/TypedProps.html#<init>(interface:Class[_>:T],implementation:akka.japi.Creator[T]):akka.actor.TypedProps[T] "Permalink")  new TypedProps(interface: Class\[\_ \>: T], implementation: [Creator](../japi/Creator.html)\[T])Java API: Uses the supplied Creator as the factory for the TypedActor implementation,
and that has the specified interface,
or if the interface class is not an interface, all the interfaces it implements,
appended in the sequence of interfaces.
3. [**](../../akka/actor/TypedProps.html#<init>(implementation:Class[T]):akka.actor.TypedProps[T] "Permalink")  new TypedProps(implementation: Class\[T])Uses the supplied class as the factory for the TypedActor implementation,
and that has the specified interface,
or if the interface class is not an interface, all the interfaces it implements,
appended in the sequence of interfaces.
4. [**](../../akka/actor/TypedProps.html#<init>(interfaces:Seq[Class[_]],creator:()=>T,dispatcher:String,deploy:akka.actor.Deploy,timeout:Option[akka.util.Timeout],loader:Option[ClassLoader]):akka.actor.TypedProps[T] "Permalink")  new TypedProps(interfaces: [Seq](https://www.scala-lang.org/api/2.13.8/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[Class\[\_]], creator: () \=\> T, dispatcher: String \= [TypedProps.defaultDispatcherId](TypedProps$.html), deploy: [Deploy](Deploy.html) \= [Props.defaultDeploy](Props$.html), timeout: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[Timeout](../util/Timeout.html)] \= [TypedProps.defaultTimeout](TypedProps$.html), loader: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)] \= [TypedProps.defaultLoader](TypedProps$.html))Attributesprotected
### Value Members

1. [**](../../akka/actor/TypedProps.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/TypedProps.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/TypedProps.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from TypedProps\[T] toany2stringadd\[TypedProps\[T]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/TypedProps.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (TypedProps\[T], B)ImplicitThis member is added by an implicit conversion from TypedProps\[T] toArrowAssoc\[TypedProps\[T]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/TypedProps.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/TypedProps.html#actorProps():akka.actor.Props "Permalink")  def actorProps(): [Props](Props.html)Returns the akka.actor.Props representation of this TypedProps
7. [**](../../akka/actor/TypedProps.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
8. [**](../../akka/actor/TypedProps.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
9. [**](../../akka/actor/TypedProps.html#creator:()=>T "Permalink")  val creator: () \=\> T
10. [**](../../akka/actor/TypedProps.html#deploy:akka.actor.Deploy "Permalink")  val deploy: [Deploy](Deploy.html)
11. [**](../../akka/actor/TypedProps.html#dispatcher:String "Permalink")  val dispatcher: String
12. [**](../../akka/actor/TypedProps.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (TypedProps\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): TypedProps\[T]ImplicitThis member is added by an implicit conversion from TypedProps\[T] toEnsuring\[TypedProps\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/actor/TypedProps.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (TypedProps\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): TypedProps\[T]ImplicitThis member is added by an implicit conversion from TypedProps\[T] toEnsuring\[TypedProps\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/actor/TypedProps.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): TypedProps\[T]ImplicitThis member is added by an implicit conversion from TypedProps\[T] toEnsuring\[TypedProps\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/actor/TypedProps.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): TypedProps\[T]ImplicitThis member is added by an implicit conversion from TypedProps\[T] toEnsuring\[TypedProps\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/actor/TypedProps.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/actor/TypedProps.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
18. [**](../../akka/actor/TypedProps.html#interfaces:Seq[Class[_]] "Permalink")  val interfaces: [Seq](https://www.scala-lang.org/api/2.13.8/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[Class\[\_]]
19. [**](../../akka/actor/TypedProps.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
20. [**](../../akka/actor/TypedProps.html#loader:Option[ClassLoader] "Permalink")  val loader: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)]
21. [**](../../akka/actor/TypedProps.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
22. [**](../../akka/actor/TypedProps.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
23. [**](../../akka/actor/TypedProps.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
24. [**](../../akka/actor/TypedProps.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
25. [**](../../akka/actor/TypedProps.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
26. [**](../../akka/actor/TypedProps.html#timeout:Option[akka.util.Timeout] "Permalink")  val timeout: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[Timeout](../util/Timeout.html)]
27. [**](../../akka/actor/TypedProps.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../akka/actor/TypedProps.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
29. [**](../../akka/actor/TypedProps.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
30. [**](../../akka/actor/TypedProps.html#withDeploy(d:akka.actor.Deploy):akka.actor.TypedProps[T] "Permalink")  def withDeploy(d: [Deploy](Deploy.html)): TypedProps\[T]Returns a new TypedProps with the specified deployment configuration.
31. [**](../../akka/actor/TypedProps.html#withDispatcher(d:String):akka.actor.TypedProps[T] "Permalink")  def withDispatcher(d: String): TypedProps\[T]Returns a new TypedProps with the specified dispatcher set.
32. [**](../../akka/actor/TypedProps.html#withInterface(interface:Class[_>:T]):akka.actor.TypedProps[T] "Permalink")  def withInterface(interface: Class\[\_ \>: T]): TypedProps\[T]Returns a new TypedProps that has the specified interface,
or if the interface class is not an interface, all the interfaces it implements,
appended in the sequence of interfaces.
33. [**](../../akka/actor/TypedProps.html#withLoader(loader:Option[ClassLoader]):akka.actor.TypedProps[T] "Permalink")  def withLoader(loader: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)]): TypedProps\[T]Scala API: return a new TypedProps that will use the specified ClassLoader to create its proxy class in
...
Scala API
34. [**](../../akka/actor/TypedProps.html#withLoader(loader:ClassLoader):akka.actor.TypedProps[T] "Permalink")  def withLoader(loader: [ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)): TypedProps\[T]Java API: return a new TypedProps that will use the specified ClassLoader to create its proxy class in
If loader is null, it will use the bootstrap classloader.
35. [**](../../akka/actor/TypedProps.html#withTimeout(timeout:Option[akka.util.Timeout]):akka.actor.TypedProps[T] "Permalink")  def withTimeout(timeout: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[Timeout](../util/Timeout.html)]): TypedProps\[T]Scala API: return a new TypedProps that will use the specified Timeout for its non\-void\-returning methods,
if None is specified, it will use the default timeout as specified in the configuration.
36. [**](../../akka/actor/TypedProps.html#withTimeout(timeout:akka.util.Timeout):akka.actor.TypedProps[T] "Permalink")  def withTimeout(timeout: [Timeout](../util/Timeout.html)): TypedProps\[T]Java API: return a new TypedProps that will use the specified Timeout for its non\-void\-returning methods,
if null is specified, it will use the default timeout as specified in the configuration.
37. [**](../../akka/actor/TypedProps.html#withoutInterface(interface:Class[_>:T]):akka.actor.TypedProps[T] "Permalink")  def withoutInterface(interface: Class\[\_ \>: T]): TypedProps\[T]Returns a new TypedProps without the specified interface,
or if the interface class is not an interface, all the interfaces it implements.
### Deprecated Value Members

1. [**](../../akka/actor/TypedProps.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/TypedProps.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from TypedProps\[T] toStringFormat\[TypedProps\[T]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/TypedProps.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (TypedProps\[T], B)ImplicitThis member is added by an implicit conversion from TypedProps\[T] toArrowAssoc\[TypedProps\[T]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromTypedProps\[T] to any2stringadd\[TypedProps\[T]]

### Inherited by implicit conversion StringFormat fromTypedProps\[T] to StringFormat\[TypedProps\[T]]

### Inherited by implicit conversion Ensuring fromTypedProps\[T] to Ensuring\[TypedProps\[T]]

### Inherited by implicit conversion ArrowAssoc fromTypedProps\[T] to ArrowAssoc\[TypedProps\[T]]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/TypedProps.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/TypedProps.html)*