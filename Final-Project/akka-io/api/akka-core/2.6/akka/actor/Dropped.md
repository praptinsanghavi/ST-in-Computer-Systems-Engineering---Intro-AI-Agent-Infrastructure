---
description: Akka 2.6.21 - akka.actor.Dropped
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:19:33Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/Dropped.html
title: Akka 2.6.21 - akka.actor.Dropped
---

# Akka 2.6.21 - akka.actor.Dropped

> **Summary:** Akka 2.6.21 - akka.actor.Dropped
...
[c](Dropped$.html "See companion object")[akka](../index.html).[actor](index.html)

# [Dropped](Dropped$.html "See companion object")[**](../../akka/actor/Dropped.html "Permalink")

### Companion [object Dropped](Dropped$.html "See companion object")

#### final  case class Dropped(message: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), reason: String, sender: [ActorRef](ActorRef.html), recipient: [ActorRef](ActorRef.html)) extends [AllDeadLetters](AllDeadLetters.html) with [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with Serializable
...
1. [**](../../akka/actor/Dropped.html#<init>(message:Any,reason:String,sender:akka.actor.ActorRef,recipient:akka.actor.ActorRef):akka.actor.Dropped "Permalink")  new Dropped(message: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), reason: String, sender: [ActorRef](ActorRef.html), recipient: [ActorRef](ActorRef.html))
### Value Members

1. [**](../../akka/actor/Dropped.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/Dropped.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/Dropped.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from Dropped toany2stringadd\[Dropped] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/Dropped.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (Dropped, B)ImplicitThis member is added by an implicit conversion from Dropped toArrowAssoc\[Dropped] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/Dropped.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/Dropped.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/Dropped.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
8. [**](../../akka/actor/Dropped.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (Dropped) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): DroppedImplicitThis member is added by an implicit conversion from Dropped toEnsuring\[Dropped] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/actor/Dropped.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (Dropped) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): DroppedImplicitThis member is added by an implicit conversion from Dropped toEnsuring\[Dropped] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/Dropped.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): DroppedImplicitThis member is added by an implicit conversion from Dropped toEnsuring\[Dropped] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/Dropped.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): DroppedImplicitThis member is added by an implicit conversion from Dropped toEnsuring\[Dropped] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/Dropped.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/actor/Dropped.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
14. [**](../../akka/actor/Dropped.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
15. [**](../../akka/actor/Dropped.html#message:Any "Permalink")  val message: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Definition ClassesDropped → [AllDeadLetters](AllDeadLetters.html) → [WrappedMessage](WrappedMessage.html)
16. [**](../../akka/actor/Dropped.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/actor/Dropped.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
18. [**](../../akka/actor/Dropped.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
19. [**](../../akka/actor/Dropped.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
20. [**](../../akka/actor/Dropped.html#reason:String "Permalink")  val reason: String
21. [**](../../akka/actor/Dropped.html#recipient:akka.actor.ActorRef "Permalink")  val recipient: [ActorRef](ActorRef.html)Definition ClassesDropped → [AllDeadLetters](AllDeadLetters.html)
22. [**](../../akka/actor/Dropped.html#sender:akka.actor.ActorRef "Permalink")  val sender: [ActorRef](ActorRef.html)Definition ClassesDropped → [AllDeadLetters](AllDeadLetters.html)
23. [**](../../akka/actor/Dropped.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
24. [**](../../akka/actor/Dropped.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
25. [**](../../akka/actor/Dropped.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
26. [**](../../akka/actor/Dropped.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/Dropped.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/Dropped.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from Dropped toStringFormat\[Dropped] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/Dropped.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (Dropped, B)ImplicitThis member is added by an implicit conversion from Dropped toArrowAssoc\[Dropped] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromDropped to any2stringadd\[Dropped]

### Inherited by implicit conversion StringFormat fromDropped to StringFormat\[Dropped]

### Inherited by implicit conversion Ensuring fromDropped to Ensuring\[Dropped]

### Inherited by implicit conversion ArrowAssoc fromDropped to ArrowAssoc\[Dropped]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/Dropped.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/Dropped.html)*