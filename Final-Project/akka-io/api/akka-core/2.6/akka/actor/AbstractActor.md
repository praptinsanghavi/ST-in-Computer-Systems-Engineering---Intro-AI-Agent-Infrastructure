---
description: Akka 2.6.21 - akka.actor.AbstractActor
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:17:54Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/AbstractActor.html
title: Akka 2.6.21 - akka.actor.AbstractActor
---

# Akka 2.6.21 - akka.actor.AbstractActor

> **Summary:** Akka 2.6.21 - akka.actor.AbstractActor
...
[c](AbstractActor$.html "See companion object")[akka](../index.html).[actor](index.html)

# [AbstractActor](AbstractActor$.html "See companion object")[**](../../akka/actor/AbstractActor.html "Permalink")

### Companion [object AbstractActor](AbstractActor$.html "See companion object")

#### abstract  class AbstractActor extends [Actor](Actor.html)
...
```
Source[AbstractActor.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/AbstractActor.scala#L220)Linear Supertypes[Actor](Actor.html), [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Known Subclasses[AbstractActorWithStash](AbstractActorWithStash.html), [AbstractActorWithTimers](AbstractActorWithTimers.html), [AbstractActorWithUnboundedStash](AbstractActorWithUnboundedStash.html), [AbstractActorWithUnrestrictedStash](AbstractActorWithUnrestrictedStash.html), [AbstractLoggingActor](AbstractLoggingActor.html), [UntypedAbstractActor](UntypedAbstractActor.html), [AbstractPersistentActor](../persistence/AbstractPersistentActor.html), [AbstractPersistentActorWithAtLeastOnceDelivery](../persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html), [AbstractPersistentActorWithTimers](../persistence/AbstractPersistentActorWithTimers.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. AbstractActor
2. Actor
...
1. [**](../../akka/actor/AbstractActor.html#<init>():akka.actor.AbstractActor "Permalink")  new AbstractActor()
### Type Members

1. [**](../../akka/actor/AbstractActor.html#Receive=akka.actor.Actor.Receive "Permalink")  type Receive \= [PartialFunction](https://www.scala-lang.org/api/2.13.8/scala/PartialFunction.html#scala.PartialFunction)\[[Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)]Definition Classes[Actor](Actor.html)
### Abstract Value Members

1. [**](../../akka/actor/AbstractActor.html#createReceive():akka.actor.AbstractActor.Receive "Permalink") abstract  def createReceive(): [AbstractActor.Receive](AbstractActor$$Receive.html)An actor has to define its initial receive behavior by implementing
the `createReceive` method.
### Concrete Value Members

1. [**](../../akka/actor/AbstractActor.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/AbstractActor.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/AbstractActor.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from AbstractActor toany2stringadd\[AbstractActor] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/AbstractActor.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (AbstractActor, B)ImplicitThis member is added by an implicit conversion from AbstractActor toArrowAssoc\[AbstractActor] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/AbstractActor.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/AbstractActor.html#aroundPostRestart(reason:Throwable):Unit "Permalink")  def aroundPostRestart(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
7. [**](../../akka/actor/AbstractActor.html#aroundPostStop():Unit "Permalink")  def aroundPostStop(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
Attributesprotected\[[akka](../index.html)] Definition Classes[Actor](Actor.html)Annotations@[InternalApi](../annotation/InternalApi.html)()
8. [**](../../akka/actor/AbstractActor.html#aroundPreRestart(reason:Throwable,message:Option[Any]):Unit "Permalink")  def aroundPreRestart(reason: Throwable, message: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)]): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
Attributesprotected\[[akka](../index.html)] Definition Classes[Actor](Actor.html)Annotations@[InternalApi](../annotation/InternalApi.html)()
9. [**](../../akka/actor/AbstractActor.html#aroundPreStart():Unit "Permalink")  def aroundPreStart(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
Attributesprotected\[[akka](../index.html)] Definition Classes[Actor](Actor.html)Annotations@[InternalApi](../annotation/InternalApi.html)()
10. [**](../../akka/actor/AbstractActor.html#aroundReceive(receive:akka.actor.Actor.Receive,msg:Any):Unit "Permalink")  def aroundReceive(receive: [Actor.Receive](Actor$.html#Receive=PartialFunction[Any,Unit]), msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
Attributesprotected\[[akka](../index.html)] Definition Classes[Actor](Actor.html)Annotations@[InternalApi](../annotation/InternalApi.html)()
11. [**](../../akka/actor/AbstractActor.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
12. [**](../../akka/actor/AbstractActor.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
13. [**](../../akka/actor/AbstractActor.html#context:akka.actor.ActorContext "Permalink") implicit  val context: [ActorContext](ActorContext.html)Scala API: Stores the context for this actor, including self, and sender.
...
14. [**](../../akka/actor/AbstractActor.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (AbstractActor) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): AbstractActorImplicitThis member is added by an implicit conversion from AbstractActor toEnsuring\[AbstractActor] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/actor/AbstractActor.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (AbstractActor) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): AbstractActorImplicitThis member is added by an implicit conversion from AbstractActor toEnsuring\[AbstractActor] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/actor/AbstractActor.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): AbstractActorImplicitThis member is added by an implicit conversion from AbstractActor toEnsuring\[AbstractActor] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../akka/actor/AbstractActor.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): AbstractActorImplicitThis member is added by an implicit conversion from AbstractActor toEnsuring\[AbstractActor] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
18. [**](../../akka/actor/AbstractActor.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../akka/actor/AbstractActor.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
20. [**](../../akka/actor/AbstractActor.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
21. [**](../../akka/actor/AbstractActor.html#getContext():akka.actor.AbstractActor.ActorContext "Permalink")  def getContext(): [AbstractActor.ActorContext](AbstractActor$$ActorContext.html)Returns this AbstractActor's ActorContext
The ActorContext is not thread safe so do not expose it outside of the
AbstractActor.
22. [**](../../akka/actor/AbstractActor.html#getSelf():akka.actor.ActorRef "Permalink")  def getSelf(): [ActorRef](ActorRef.html)Returns the ActorRef for this actor.

Returns the ActorRef for this actor.

Same as `self()`.
23. [**](../../akka/actor/AbstractActor.html#getSender():akka.actor.ActorRef "Permalink")  def getSender(): [ActorRef](ActorRef.html)The reference sender Actor of the currently processed message.
...
WARNING: Only valid within the Actor itself, so do not close over it and
publish it to other threads!
24. [**](../../akka/actor/AbstractActor.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
25. [**](../../akka/actor/AbstractActor.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
26. [**](../../akka/actor/AbstractActor.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
27. [**](../../akka/actor/AbstractActor.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
28. [**](../../akka/actor/AbstractActor.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
29. [**](../../akka/actor/AbstractActor.html#postRestart(reason:Throwable):Unit "Permalink")  def postRestart(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback: By default it calls `preStart()`.
...
Definition ClassesAbstractActor → [Actor](Actor.html)Annotations@throws(classOf\[Exception])
30. [**](../../akka/actor/AbstractActor.html#postStop():Unit "Permalink")  def postStop(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback.
...
32. [**](../../akka/actor/AbstractActor.html#preStart():Unit "Permalink")  def preStart(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback.
...
Definition ClassesAbstractActor → [Actor](Actor.html)Annotations@throws(classOf\[Exception])
33. [**](../../akka/actor/AbstractActor.html#receive:PartialFunction[Any,Unit] "Permalink")  def receive: [PartialFunction](https://www.scala-lang.org/api/2.13.8/scala/PartialFunction.html#scala.PartialFunction)\[[Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)]Scala API: This defines the initial actor behavior, it must return a partial function
with the actor logic.

Scala API: This defines the initial actor behavior, it must return a partial function
with the actor logic.

Definition ClassesAbstractActor → [Actor](Actor.html)
34. [**](../../akka/actor/AbstractActor.html#receiveBuilder():akka.japi.pf.ReceiveBuilder "Permalink") final  def receiveBuilder(): [ReceiveBuilder](../japi/pf/ReceiveBuilder.html)Convenience factory of the `ReceiveBuilder`.

Convenience factory of the `ReceiveBuilder`.
Creates a new empty `ReceiveBuilder`.
35. [**](../../akka/actor/AbstractActor.html#self:akka.actor.ActorRef "Permalink") implicit final  val self: [ActorRef](ActorRef.html)The 'self' field holds the ActorRef for this actor.
...
Definition Classes[Actor](Actor.html)
36. [**](../../akka/actor/AbstractActor.html#sender():akka.actor.ActorRef "Permalink") final  def sender(): [ActorRef](ActorRef.html)The reference sender Actor of the last received message.
...
Definition Classes[Actor](Actor.html)
37. [**](../../akka/actor/AbstractActor.html#supervisorStrategy:akka.actor.SupervisorStrategy "Permalink")  def supervisorStrategy: [SupervisorStrategy](SupervisorStrategy.html)User overridable definition the strategy to use for supervising
child actors.
...
Definition ClassesAbstractActor → [Actor](Actor.html)
38. [**](../../akka/actor/AbstractActor.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
39. [**](../../akka/actor/AbstractActor.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
40. [**](../../akka/actor/AbstractActor.html#unhandled(message:Any):Unit "Permalink")  def unhandled(message: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback.
...
Definition Classes[Actor](Actor.html)
41. [**](../../akka/actor/AbstractActor.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
42. [**](../../akka/actor/AbstractActor.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
43. [**](../../akka/actor/AbstractActor.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/AbstractActor.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/AbstractActor.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from AbstractActor toStringFormat\[AbstractActor] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/AbstractActor.html#preRestart(reason:Throwable,message:Option[Any]):Unit "Permalink")  def preRestart(reason: Throwable, message: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)]): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Scala API: User overridable callback: **By default it disposes of all children and then calls `postStop()`.**
...
Definition ClassesAbstractActor → [Actor](Actor.html)Annotations@deprecated @throws(classOf\[Exception]) @nowarn() Deprecated*(Since version 2\.5\.0\)* Override preRestart with message parameter with Optional type instead
4. [**](../../akka/actor/AbstractActor.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (AbstractActor, B)ImplicitThis member is added by an implicit conversion from AbstractActor toArrowAssoc\[AbstractActor] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromAbstractActor to any2stringadd\[AbstractActor]

### Inherited by implicit conversion StringFormat fromAbstractActor to StringFormat\[AbstractActor]

### Inherited by implicit conversion Ensuring fromAbstractActor to Ensuring\[AbstractActor]

### Inherited by implicit conversion ArrowAssoc fromAbstractActor to ArrowAssoc\[AbstractActor]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/AbstractActor.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/AbstractActor.html)*