---
description: Akka 2.6.21 - akka.actor.SupervisorStrategy
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:20:56Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/SupervisorStrategy$.html
title: Akka 2.6.21 - akka.actor.SupervisorStrategy
---

# Akka 2.6.21 - akka.actor.SupervisorStrategy

> **Summary:** Akka 2.6.21 - akka.actor.SupervisorStrategy
...
Source[FaultHandling.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/FaultHandling.scala#L106)Linear Supertypes[SupervisorStrategyLowPriorityImplicits](SupervisorStrategyLowPriorityImplicits.html), [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Content Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
2. [**](../../akka/actor/SupervisorStrategy$.html#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive] "Permalink")  type Decider \= [PartialFunction](https://www.scala-lang.org/api/2.13.8/scala/PartialFunction.html#scala.PartialFunction)\[Throwable, [Directive](SupervisorStrategy$$Directive.html)]
3. [**](../../akka/actor/SupervisorStrategy$$Directive.html "Permalink") sealed  trait [Directive](SupervisorStrategy$$Directive.html) extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)
...
1. [**](../../akka/actor/SupervisorStrategy$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/SupervisorStrategy$.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/SupervisorStrategy$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/actor/SupervisorStrategy$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../akka/actor/SupervisorStrategy$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
...
8. [**](../../akka/actor/SupervisorStrategy$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
9. [**](../../akka/actor/SupervisorStrategy$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
12. [**](../../akka/actor/SupervisorStrategy$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
13. [**](../../akka/actor/SupervisorStrategy$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
...
17. [**](../../akka/actor/SupervisorStrategy$.html#makeDecider(trapExit:Seq[Class[_<:Throwable]]):akka.actor.SupervisorStrategy.Decider "Permalink")  def makeDecider(trapExit: [Seq](https://www.scala-lang.org/api/2.13.8/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[Class\[\_ \<: Throwable]]): [Decider](#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive])Decider builder which just checks whether one of
the given Throwables matches the cause and restarts, otherwise escalates.
18. [**](../../akka/actor/SupervisorStrategy$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../akka/actor/SupervisorStrategy$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
20. [**](../../akka/actor/SupervisorStrategy$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
...
26. [**](../../akka/actor/SupervisorStrategy$.html#seqThrowable2Decider(trapExit:Seq[Class[_<:Throwable]]):akka.actor.SupervisorStrategy.Decider "Permalink") implicit  def seqThrowable2Decider(trapExit: [Seq](https://www.scala-lang.org/api/2.13.8/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[Class\[\_ \<: Throwable]]): [Decider](#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive])Implicit conversion from `Seq` of Throwables to a `Decider`.
...
32. [**](../../akka/actor/SupervisorStrategy$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
33. [**](../../akka/actor/SupervisorStrategy$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
34. [**](../../akka/actor/SupervisorStrategy$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
35. [**](../../akka/actor/SupervisorStrategy$$Escalate$.html "Permalink")  case object [Escalate](SupervisorStrategy$$Escalate$.html "Escalates the failure to the supervisor of the supervisor, by rethrowing the cause of the failure, i.e.") extends [Directive](SupervisorStrategy$$Directive.html) with [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with SerializableEscalates the failure to the supervisor of the supervisor,
by rethrowing the cause of the failure, i.e.

Escalates the failure to the supervisor of the supervisor,
by rethrowing the cause of the failure, i.e. the supervisor fails with
the same exception as the child.
36. [**](../../akka/actor/SupervisorStrategy$$Restart$.html "Permalink")  case object [Restart](SupervisorStrategy$$Restart$.html "Discards the old Actor instance and replaces it with a new, then resumes message processing.") extends Restart with [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with SerializableDiscards the old Actor instance and replaces it with a new,
then resumes message processing.
37. [**](../../akka/actor/SupervisorStrategy$$Resume$.html "Permalink")  case object [Resume](SupervisorStrategy$$Resume$.html "Resumes message processing for the failed Actor") extends Resume with [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with SerializableResumes message processing for the failed Actor
38. [**](../../akka/actor/SupervisorStrategy$$Stop$.html "Permalink")  case object [Stop](SupervisorStrategy$$Stop$.html "Stops the Actor") extends Stop with [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with SerializableStops the Actor
### Deprecated Value Members

1. [**](../../akka/actor/SupervisorStrategy$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/SupervisorStrategy$.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/SupervisorStrategy$.html)*