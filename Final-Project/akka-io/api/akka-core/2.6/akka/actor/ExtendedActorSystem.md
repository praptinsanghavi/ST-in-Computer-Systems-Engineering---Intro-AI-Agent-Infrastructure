---
description: Akka 2.6.21 - akka.actor.ExtendedActorSystem
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:15:12Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/ExtendedActorSystem.html
title: Akka 2.6.21 - akka.actor.ExtendedActorSystem
---

# Akka 2.6.21 - akka.actor.ExtendedActorSystem

> **Summary:** Akka 2.6.21 - akka.actor.ExtendedActorSystem
...
Annotations@[DoNotInherit](../annotation/DoNotInherit.html)() Source[ActorSystem.scala](https://github.com/akka/akka/tree/v2.6.21//akka-actor/src/main/scala/akka/actor/ActorSystem.scala#L725)Linear Supertypes[ActorSystem](ActorSystem.html), [ClassicActorSystemProvider](ClassicActorSystemProvider.html), [ActorRefFactory](ActorRefFactory.html), [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
Definition Classes[ActorSystem](ActorSystem.html)
13. [**](../../akka/actor/ExtendedActorSystem.html#guardian:akka.actor.InternalActorRef "Permalink") abstract  def guardian: InternalActorRefThe top\-level supervisor of all actors created using system.actorOf(...).
...
14. [**](../../akka/actor/ExtendedActorSystem.html#hasExtension(ext:akka.actor.ExtensionId[_<:akka.actor.Extension]):Boolean "Permalink") abstract  def hasExtension(ext: [ExtensionId](ExtensionId.html)\[\_ \<: [Extension](Extension.html)]): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Returns whether the specified extension is already registered, this method can potentially block, waiting for the initialization
of the payload, if is in the process of registration from another Thread of execution
...
Definition Classes[ActorSystem](ActorSystem.html)
15. [**](../../akka/actor/ExtendedActorSystem.html#log:akka.event.LoggingAdapter "Permalink") abstract  def log: [LoggingAdapter](../event/LoggingAdapter.html)Convenient logging adapter for logging to the [ActorSystem\#eventStream](ActorSystem.html#eventStream:akka.event.EventStream).
...
Definition Classes[ActorSystem](ActorSystem.html)
16. [**](../../akka/actor/ExtendedActorSystem.html#logConfiguration():Unit "Permalink") abstract  def logConfiguration(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Log the configuration.

Log the configuration.

Definition Classes[ActorSystem](ActorSystem.html)
17. [**](../../akka/actor/ExtendedActorSystem.html#logFilter:akka.event.LoggingFilter "Permalink") abstract  def logFilter: [LoggingFilter](../event/LoggingFilter.html)Filter of log events that is used by the LoggingAdapter before
publishing log events to the eventStream
18. [**](../../akka/actor/ExtendedActorSystem.html#lookupRoot:akka.actor.InternalActorRef "Permalink") abstract  def lookupRoot: InternalActorRefINTERNAL API

INTERNAL API

Attributesprotected Definition Classes[ActorRefFactory](ActorRefFactory.html)
19. [**](../../akka/actor/ExtendedActorSystem.html#mailboxes:akka.dispatch.Mailboxes "Permalink") abstract  def mailboxes: MailboxesHelper object for looking up configured mailbox types.

Helper object for looking up configured mailbox types.

Definition Classes[ActorSystem](ActorSystem.html)
20. [**](../../akka/actor/ExtendedActorSystem.html#name:String "Permalink") abstract  def name: StringThe name of this actor system, used to distinguish multiple ones within
...
Definition Classes[ActorSystem](ActorSystem.html)
21. [**](../../akka/actor/ExtendedActorSystem.html#provider:akka.actor.ActorRefProvider "Permalink") abstract  def provider: [ActorRefProvider](ActorRefProvider.html)The ActorRefProvider is the only entity which creates all actor references within this actor system.

The ActorRefProvider is the only entity which creates all actor references within this actor system.

Definition ClassesExtendedActorSystem → [ActorRefFactory](ActorRefFactory.html)
22. [**](../../akka/actor/ExtendedActorSystem.html#registerExtension[T<:akka.actor.Extension](ext:akka.actor.ExtensionId[T]):T "Permalink") abstract  def registerExtension\[T \<: [Extension](Extension.html)](ext: [ExtensionId](ExtensionId.html)\[T]): TRegisters the provided extension and creates its payload, if this extension isn't already registered
...
Definition Classes[ActorSystem](ActorSystem.html)
23. [**](../../akka/actor/ExtendedActorSystem.html#registerOnTermination(code:Runnable):Unit "Permalink") abstract  def registerOnTermination(code: [Runnable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Runnable.html#java.lang.Runnable)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Java API: Register a block of code (callback) to run after [ActorSystem.terminate](ActorSystem.html#terminate():scala.concurrent.Future[akka.actor.Terminated]) has been issued and
...
Definition Classes[ActorSystem](ActorSystem.html)
24. [**](../../akka/actor/ExtendedActorSystem.html#registerOnTermination[T](code:=>T):Unit "Permalink") abstract  def registerOnTermination\[T](code: \=\> T): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Register a block of code (callback) to run after [ActorSystem.terminate](ActorSystem.html#terminate():scala.concurrent.Future[akka.actor.Terminated]) has been issued and
all actors in this actor system have been stopped.
...
Definition Classes[ActorSystem](ActorSystem.html)
25. [**](../../akka/actor/ExtendedActorSystem.html#scheduler:akka.actor.Scheduler "Permalink") abstract  def scheduler: [Scheduler](Scheduler.html)Light\-weight scheduler for running asynchronous tasks after some deadline
in the future.
...
Definition Classes[ActorSystem](ActorSystem.html)
26. [**](../../akka/actor/ExtendedActorSystem.html#settings:akka.actor.ActorSystem.Settings "Permalink") abstract  def settings: [Settings](ActorSystem$$Settings.html)The core settings extracted from the supplied configuration.

The core settings extracted from the supplied configuration.

Definition Classes[ActorSystem](ActorSystem.html)
27. [**](../../akka/actor/ExtendedActorSystem.html#stop(actor:akka.actor.ActorRef):Unit "Permalink") abstract  def stop(actor: [ActorRef](ActorRef.html)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Stop the actor pointed to by the given [akka.actor.ActorRef](ActorRef.html); this is
...
28. [**](../../akka/actor/ExtendedActorSystem.html#systemActorOf(props:akka.actor.Props,name:String):akka.actor.ActorRef "Permalink") abstract  def systemActorOf(props: [Props](Props.html), name: String): [ActorRef](ActorRef.html)Create an actor in the "/system" namespace.
...
29. [**](../../akka/actor/ExtendedActorSystem.html#systemGuardian:akka.actor.InternalActorRef "Permalink") abstract  def systemGuardian: InternalActorRefThe top\-level supervisor of all system\-internal services like logging.
30. [**](../../akka/actor/ExtendedActorSystem.html#systemImpl:akka.actor.ActorSystemImpl "Permalink") abstract  def systemImpl: ActorSystemImplINTERNAL API

INTERNAL API

Attributesprotected Definition Classes[ActorRefFactory](ActorRefFactory.html)
31. [**](../../akka/actor/ExtendedActorSystem.html#terminate():scala.concurrent.Future[akka.actor.Terminated] "Permalink") abstract  def terminate(): [Future](https://www.scala-lang.org/api/2.13.8/scala/concurrent/Future.html#scala.concurrent.Future)\[[Terminated](Terminated.html)]Terminates this actor system by running [CoordinatedShutdown](CoordinatedShutdown.html) with reason
...
Definition Classes[ActorSystem](ActorSystem.html)
32. [**](../../akka/actor/ExtendedActorSystem.html#threadFactory:java.util.concurrent.ThreadFactory "Permalink") abstract  def threadFactory: [ThreadFactory](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/ThreadFactory.html#java.util.concurrent.ThreadFactory)A ThreadFactory that can be used if the transport needs to create any Threads
33. [**](../../akka/actor/ExtendedActorSystem.html#whenTerminated:scala.concurrent.Future[akka.actor.Terminated] "Permalink") abstract  def whenTerminated: [Future](https://www.scala-lang.org/api/2.13.8/scala/concurrent/Future.html#scala.concurrent.Future)\[[Terminated](Terminated.html)]Returns a Future which will be completed after the ActorSystem has been terminated
and termination hooks have been executed.
...
1. [**](../../akka/actor/ExtendedActorSystem.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/ExtendedActorSystem.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
5. [**](../../akka/actor/ExtendedActorSystem.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
Definition Classes[ActorSystem](ActorSystem.html)
10. [**](../../akka/actor/ExtendedActorSystem.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
...
Definition Classes[ActorSystem](ActorSystem.html)
12. [**](../../akka/actor/ExtendedActorSystem.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ExtendedActorSystem) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ExtendedActorSystemImplicitThis member is added by an implicit conversion from ExtendedActorSystem toEnsuring\[ExtendedActorSystem] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/actor/ExtendedActorSystem.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ExtendedActorSystem) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ExtendedActorSystemImplicitThis member is added by an implicit conversion from ExtendedActorSystem toEnsuring\[ExtendedActorSystem] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/actor/ExtendedActorSystem.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): ExtendedActorSystemImplicitThis member is added by an implicit conversion from ExtendedActorSystem toEnsuring\[ExtendedActorSystem] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/actor/ExtendedActorSystem.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): ExtendedActorSystemImplicitThis member is added by an implicit conversion from ExtendedActorSystem toEnsuring\[ExtendedActorSystem] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/actor/ExtendedActorSystem.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/actor/ExtendedActorSystem.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
19. [**](../../akka/actor/ExtendedActorSystem.html#getDispatcher:scala.concurrent.ExecutionContextExecutor "Permalink")  def getDispatcher: [ExecutionContextExecutor](https://www.scala-lang.org/api/2.13.8/scala/concurrent/ExecutionContextExecutor.html#scala.concurrent.ExecutionContextExecutor)Java API: Default dispatcher as configured.
...
Definition Classes[ActorSystem](ActorSystem.html)
22. [**](../../akka/actor/ExtendedActorSystem.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
23. [**](../../akka/actor/ExtendedActorSystem.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
24. [**](../../akka/actor/ExtendedActorSystem.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
25. [**](../../akka/actor/ExtendedActorSystem.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
26. [**](../../akka/actor/ExtendedActorSystem.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
27. [**](../../akka/actor/ExtendedActorSystem.html#startTime:Long "Permalink")  val startTime: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)Start\-up time in milliseconds since the epoch.
...
30. [**](../../akka/actor/ExtendedActorSystem.html#uptime:Long "Permalink")  def uptime: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)Up\-time of this actor system in seconds.

Up\-time of this actor system in seconds.

Definition Classes[ActorSystem](ActorSystem.html)
31. [**](../../akka/actor/ExtendedActorSystem.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
32. [**](../../akka/actor/ExtendedActorSystem.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
33. [**](../../akka/actor/ExtendedActorSystem.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/ExtendedActorSystem.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
...
- https://doc.akka.io/api/akka-core/2.6/akka/ConfigurationException.html
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/ExtendedActorSystem.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/ExtendedActorSystem.html)*