---
description: Akka 2.6.21 - akka.actor.SuppressedDeadLetter
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:21:04Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/SuppressedDeadLetter.html
title: Akka 2.6.21 - akka.actor.SuppressedDeadLetter
---

# Akka 2.6.21 - akka.actor.SuppressedDeadLetter

> **Summary:** Akka 2.6.21 - akka.actor.SuppressedDeadLetter
...
# SuppressedDeadLetter[**](../../akka/actor/SuppressedDeadLetter.html "Permalink")

### 

#### final  case class SuppressedDeadLetter(message: [DeadLetterSuppression](DeadLetterSuppression.html), sender: [ActorRef](ActorRef.html), recipient: [ActorRef](ActorRef.html)) extends [AllDeadLetters](AllDeadLetters.html) with [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with Serializable
...
1. [**](../../akka/actor/SuppressedDeadLetter.html#<init>(message:akka.actor.DeadLetterSuppression,sender:akka.actor.ActorRef,recipient:akka.actor.ActorRef):akka.actor.SuppressedDeadLetter "Permalink")  new SuppressedDeadLetter(message: [DeadLetterSuppression](DeadLetterSuppression.html), sender: [ActorRef](ActorRef.html), recipient: [ActorRef](ActorRef.html))
### Value Members

1. [**](../../akka/actor/SuppressedDeadLetter.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/SuppressedDeadLetter.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/SuppressedDeadLetter.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from SuppressedDeadLetter toany2stringadd\[SuppressedDeadLetter] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/SuppressedDeadLetter.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (SuppressedDeadLetter, B)ImplicitThis member is added by an implicit conversion from SuppressedDeadLetter toArrowAssoc\[SuppressedDeadLetter] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/SuppressedDeadLetter.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/SuppressedDeadLetter.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/SuppressedDeadLetter.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
8. [**](../../akka/actor/SuppressedDeadLetter.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (SuppressedDeadLetter) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): SuppressedDeadLetterImplicitThis member is added by an implicit conversion from SuppressedDeadLetter toEnsuring\[SuppressedDeadLetter] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/actor/SuppressedDeadLetter.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (SuppressedDeadLetter) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): SuppressedDeadLetterImplicitThis member is added by an implicit conversion from SuppressedDeadLetter toEnsuring\[SuppressedDeadLetter] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/SuppressedDeadLetter.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): SuppressedDeadLetterImplicitThis member is added by an implicit conversion from SuppressedDeadLetter toEnsuring\[SuppressedDeadLetter] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/SuppressedDeadLetter.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): SuppressedDeadLetterImplicitThis member is added by an implicit conversion from SuppressedDeadLetter toEnsuring\[SuppressedDeadLetter] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/SuppressedDeadLetter.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/actor/SuppressedDeadLetter.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
14. [**](../../akka/actor/SuppressedDeadLetter.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
15. [**](../../akka/actor/SuppressedDeadLetter.html#message:akka.actor.DeadLetterSuppression "Permalink")  val message: [DeadLetterSuppression](DeadLetterSuppression.html)Definition ClassesSuppressedDeadLetter → [AllDeadLetters](AllDeadLetters.html) → [WrappedMessage](WrappedMessage.html)
16. [**](../../akka/actor/SuppressedDeadLetter.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/actor/SuppressedDeadLetter.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
18. [**](../../akka/actor/SuppressedDeadLetter.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
19. [**](../../akka/actor/SuppressedDeadLetter.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
20. [**](../../akka/actor/SuppressedDeadLetter.html#recipient:akka.actor.ActorRef "Permalink")  val recipient: [ActorRef](ActorRef.html)Definition ClassesSuppressedDeadLetter → [AllDeadLetters](AllDeadLetters.html)
21. [**](../../akka/actor/SuppressedDeadLetter.html#sender:akka.actor.ActorRef "Permalink")  val sender: [ActorRef](ActorRef.html)Definition ClassesSuppressedDeadLetter → [AllDeadLetters](AllDeadLetters.html)
22. [**](../../akka/actor/SuppressedDeadLetter.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
23. [**](../../akka/actor/SuppressedDeadLetter.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../akka/actor/SuppressedDeadLetter.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../akka/actor/SuppressedDeadLetter.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/SuppressedDeadLetter.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
2. [**](../../akka/actor/SuppressedDeadLetter.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from SuppressedDeadLetter toStringFormat\[SuppressedDeadLetter] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/SuppressedDeadLetter.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (SuppressedDeadLetter, B)ImplicitThis member is added by an implicit conversion from SuppressedDeadLetter toArrowAssoc\[SuppressedDeadLetter] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromSuppressedDeadLetter to any2stringadd\[SuppressedDeadLetter]

### Inherited by implicit conversion StringFormat fromSuppressedDeadLetter to StringFormat\[SuppressedDeadLetter]

### Inherited by implicit conversion Ensuring fromSuppressedDeadLetter to Ensuring\[SuppressedDeadLetter]

### Inherited by implicit conversion ArrowAssoc fromSuppressedDeadLetter to ArrowAssoc\[SuppressedDeadLetter]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/actor/SuppressedDeadLetter.html](https://doc.akka.io/api/akka-core/2.6/akka/actor/SuppressedDeadLetter.html)*