---
description: Akka 2.6.21 - akka.persistence.testkit.PersistenceTestKitSnapshotPlugin
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:22:24Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html
title: Akka 2.6.21 - akka.persistence.testkit.PersistenceTestKitSnapshotPlugin
---

# Akka 2.6.21 - akka.persistence.testkit.PersistenceTestKitSnapshotPlugin

> **Summary:** Akka 2.6.21 - akka.persistence.testkit.PersistenceTestKitSnapshotPlugin
...
Annotations@[InternalApi](../../annotation/InternalApi.html)() Source[PersistenceTestKitPlugin.scala](https://github.com/akka/akka/tree/v2.6.21//akka-persistence-testkit/src/main/scala/akka/persistence/testkit/PersistenceTestKitPlugin.scala#L105)Linear Supertypes[SnapshotStore](../snapshot/SnapshotStore.html), [ActorLogging](../../actor/ActorLogging.html), [Actor](../../actor/Actor.html), [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
5. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#aroundPostRestart(reason:Throwable):Unit "Permalink")  def aroundPostRestart(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
7. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#aroundPostStop():Unit "Permalink")  def aroundPostStop(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
Attributesprotected\[[akka](../../index.html)] Definition Classes[Actor](../../actor/Actor.html)Annotations@[InternalApi](../../annotation/InternalApi.html)()
9. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#aroundPreStart():Unit "Permalink")  def aroundPreStart(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
Attributesprotected\[[akka](../../index.html)] Definition Classes[Actor](../../actor/Actor.html)Annotations@[InternalApi](../../annotation/InternalApi.html)()
10. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#aroundReceive(receive:akka.actor.Actor.Receive,msg:Any):Unit "Permalink")  def aroundReceive(receive: [actor.Actor.Receive](../../actor/Actor$.html#Receive=PartialFunction[Any,Unit]), msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
12. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
...
15. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#deleteAsync(metadata:akka.persistence.SnapshotMetadata):scala.concurrent.Future[Unit] "Permalink")  def deleteAsync(metadata: [SnapshotMetadata](../SnapshotMetadata.html)): [Future](https://www.scala-lang.org/api/2.13.8/scala/concurrent/Future.html#scala.concurrent.Future)\[[Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)]Plugin API: deletes the snapshot identified by `metadata`.
...
Definition ClassesPersistenceTestKitSnapshotPlugin → [SnapshotStore](../snapshot/SnapshotStore.html)
16. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (PersistenceTestKitSnapshotPlugin) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): PersistenceTestKitSnapshotPluginImplicitThis member is added by an implicit conversion from PersistenceTestKitSnapshotPlugin toEnsuring\[PersistenceTestKitSnapshotPlugin] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (PersistenceTestKitSnapshotPlugin) \=\> [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): PersistenceTestKitSnapshotPluginImplicitThis member is added by an implicit conversion from PersistenceTestKitSnapshotPlugin toEnsuring\[PersistenceTestKitSnapshotPlugin] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
18. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): PersistenceTestKitSnapshotPluginImplicitThis member is added by an implicit conversion from PersistenceTestKitSnapshotPlugin toEnsuring\[PersistenceTestKitSnapshotPlugin] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
19. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)): PersistenceTestKitSnapshotPluginImplicitThis member is added by an implicit conversion from PersistenceTestKitSnapshotPlugin toEnsuring\[PersistenceTestKitSnapshotPlugin] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
20. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
21. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
23. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
24. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
25. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#loadAsync(persistenceId:String,criteria:akka.persistence.SnapshotSelectionCriteria):scala.concurrent.Future[Option[akka.persistence.SelectedSnapshot]] "Permalink")  def loadAsync(persistenceId: String, criteria: [SnapshotSelectionCriteria](../SnapshotSelectionCriteria.html)): [Future](https://www.scala-lang.org/api/2.13.8/scala/concurrent/Future.html#scala.concurrent.Future)\[[Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[SelectedSnapshot](../SelectedSnapshot.html)]]Plugin API: asynchronously loads a snapshot.
...
27. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
28. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
29. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
30. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#postRestart(reason:Throwable):Unit "Permalink")  def postRestart(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback: By default it calls `preStart()`.
...
31. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#postStop():Unit "Permalink")  def postStop(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback.
...
Definition Classes[Actor](../../actor/Actor.html)Annotations@throws(classOf\[Exception])
33. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#preStart():Unit "Permalink")  def preStart(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback.
...
37. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#saveAsync(metadata:akka.persistence.SnapshotMetadata,snapshot:Any):scala.concurrent.Future[Unit] "Permalink")  def saveAsync(metadata: [SnapshotMetadata](../SnapshotMetadata.html), snapshot: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Future](https://www.scala-lang.org/api/2.13.8/scala/concurrent/Future.html#scala.concurrent.Future)\[[Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)]Plugin API: asynchronously saves a snapshot.
...
43. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#unhandled(message:Any):Unit "Permalink")  def unhandled(message: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback.
...
46. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
...
- https://doc.akka.io/api/akka-core/2.6/akka/persistence/testkit/SnapshotMeta.html
- https://doc.akka.io/api/akka-core/2.6/akka/persistence/testkit/SnapshotOperation.html
- https://doc.akka.io/api/akka-core/2.6/akka/persistence/testkit/SnapshotStorage$.html

---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html](https://doc.akka.io/api/akka-core/2.6/akka/persistence/testkit/PersistenceTestKitSnapshotPlugin.html)*