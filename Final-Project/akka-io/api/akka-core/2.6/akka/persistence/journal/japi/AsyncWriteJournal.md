---
description: Akka 2.6.21 - akka.persistence.journal.japi.AsyncWriteJournal
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:22:14Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/persistence/journal/japi/AsyncWriteJournal.html
title: Akka 2.6.21 - akka.persistence.journal.japi.AsyncWriteJournal
---

# Akka 2.6.21 - akka.persistence.journal.japi.AsyncWriteJournal

> **Summary:** Akka 2.6.21 - akka.persistence.journal.japi.AsyncWriteJournal
...
Annotations@ccompatUsedUntil213() Source[AsyncWriteJournal.scala](https://github.com/akka/akka/tree/v2.6.21//akka-persistence/src/main/scala/akka/persistence/journal/japi/AsyncWriteJournal.scala#L21)Linear SupertypesAsyncWritePlugin, [journal.AsyncWriteJournal](../AsyncWriteJournal.html), WriteJournalBase, [Actor](../../../actor/Actor.html), [AsyncRecovery](AsyncRecovery.html), AsyncRecoveryPlugin, [journal.AsyncRecovery](../AsyncRecovery.html), [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. AsyncWriteJournal
2. AsyncWritePlugin
...
1. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
5. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#aroundPostRestart(reason:Throwable):Unit "Permalink")  def aroundPostRestart(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
7. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#aroundPostStop():Unit "Permalink")  def aroundPostStop(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
Attributesprotected\[[akka](../../../index.html)] Definition Classes[Actor](../../../actor/Actor.html)Annotations@[InternalApi](../../../annotation/InternalApi.html)()
8. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#aroundPreRestart(reason:Throwable,message:Option[Any]):Unit "Permalink")  def aroundPreRestart(reason: Throwable, message: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)]): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
Attributesprotected\[[akka](../../../index.html)] Definition Classes[Actor](../../../actor/Actor.html)Annotations@[InternalApi](../../../annotation/InternalApi.html)()
9. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#aroundPreStart():Unit "Permalink")  def aroundPreStart(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
Attributesprotected\[[akka](../../../index.html)] Definition Classes[Actor](../../../actor/Actor.html)Annotations@[InternalApi](../../../annotation/InternalApi.html)()
10. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#aroundReceive(receive:akka.actor.Actor.Receive,msg:Any):Unit "Permalink")  def aroundReceive(receive: [actor.Actor.Receive](../../../actor/Actor$.html#Receive=PartialFunction[Any,Unit]), msg: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)INTERNAL API.
...
14. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#asyncReplayMessages(persistenceId:String,fromSequenceNr:Long,toSequenceNr:Long,max:Long)(replayCallback:akka.persistence.PersistentRepr=>Unit):scala.concurrent.Future[Unit] "Permalink") final  def asyncReplayMessages(persistenceId: String, fromSequenceNr: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), toSequenceNr: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), max: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long))(replayCallback: ([PersistentRepr](../../PersistentRepr.html)) \=\> [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)): [Future](https://www.scala-lang.org/api/2.13.8/scala/concurrent/Future.html#scala.concurrent.Future)\[[Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)]Plugin API: asynchronously replays persistent messages.
...
15. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#asyncWriteMessages(messages:Seq[akka.persistence.AtomicWrite]):scala.concurrent.Future[Seq[scala.util.Try[Unit]]] "Permalink") final  def asyncWriteMessages(messages: [Seq](https://www.scala-lang.org/api/2.13.8/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[[AtomicWrite](../../AtomicWrite.html)]): [Future](https://www.scala-lang.org/api/2.13.8/scala/concurrent/Future.html#scala.concurrent.Future)\[[Seq](https://www.scala-lang.org/api/2.13.8/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[[Try](https://www.scala-lang.org/api/2.13.8/scala/util/Try.html#scala.util.Try)\[[Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)]]]Plugin API: asynchronously writes a batch (`Seq`) of persistent messages to the
journal.
...
Definition ClassesAsyncWriteJournal → [AsyncWriteJournal](../AsyncWriteJournal.html)
16. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
...
22. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
23. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
25. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
26. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAny
27. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
28. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
29. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
...
31. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#postRestart(reason:Throwable):Unit "Permalink")  def postRestart(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback: By default it calls `preStart()`.
...
32. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#postStop():Unit "Permalink")  def postStop(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback.
...
Definition Classes[Actor](../../../actor/Actor.html)Annotations@throws(classOf\[Exception])
33. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#preRestart(reason:Throwable,message:Option[Any]):Unit "Permalink")  def preRestart(reason: Throwable, message: [Option](https://www.scala-lang.org/api/2.13.8/scala/Option.html#scala.Option)\[[Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)]): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Scala API: User overridable callback: **By default it disposes of all children and then calls `postStop()`.**
...
Definition Classes[Actor](../../../actor/Actor.html)Annotations@throws(classOf\[Exception])
34. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#preStart():Unit "Permalink")  def preStart(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback.
...
Definition Classes[Actor](../../../actor/Actor.html)Annotations@throws(classOf\[Exception])
35. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#preparePersistentBatch(rb:Seq[akka.persistence.PersistentEnvelope]):Seq[akka.persistence.AtomicWrite] "Permalink")  def preparePersistentBatch(rb: [Seq](https://www.scala-lang.org/api/2.13.8/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[PersistentEnvelope]): [Seq](https://www.scala-lang.org/api/2.13.8/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[[AtomicWrite](../../AtomicWrite.html)]Attributesprotected Definition ClassesWriteJournalBase
36. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#receive:PartialFunction[Any,Unit] "Permalink") final  def receive: [PartialFunction](https://www.scala-lang.org/api/2.13.8/scala/PartialFunction.html#scala.PartialFunction)\[[Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any), [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)]Scala API: This defines the initial actor behavior, it must return a partial function
...
44. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#unhandled(message:Any):Unit "Permalink")  def unhandled(message: [Any](https://www.scala-lang.org/api/2.13.8/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)User overridable callback.
...
Definition Classes[Actor](../../../actor/Actor.html)
45. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
46. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
47. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../akka/persistence/journal/japi/AsyncWriteJournal.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.8/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated
...
- https://doc.akka.io/api/akka-core/2.6/akka/persistence/journal/japi/AsyncRecovery.html
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/persistence/journal/japi/AsyncWriteJournal.html](https://doc.akka.io/api/akka-core/2.6/akka/persistence/journal/japi/AsyncWriteJournal.html)*