---
description: Akka 2.6.21 - akka.cluster
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:13:15Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/cluster/index.html
title: Akka 2.6.21 - akka.cluster
---

# Akka 2.6.21 - akka.cluster

> **Summary:** Akka 2.6.21 - akka.cluster
...
- [**](../../akka/cluster/client/index.html "Permalink")  package [client](client/index.html)
...
1. [**](../../akka/cluster/client/index.html "Permalink")  package [client](client/index.html)
2. [**](../../akka/cluster/ddata/index.html "Permalink")  package [ddata](ddata/index.html)
3. [**](../../akka/cluster/metrics/index.html "Permalink")  package [metrics](metrics/index.html)
4. [**](../../akka/cluster/protobuf/index.html "Permalink")  package [protobuf](protobuf/index.html)
5. [**](../../akka/cluster/pubsub/index.html "Permalink")  package [pubsub](pubsub/index.html)
6. [**](../../akka/cluster/routing/index.html "Permalink")  package [routing](routing/index.html)
7. [**](../../akka/cluster/sbr/index.html "Permalink")  package [sbr](sbr/index.html)
8. [**](../../akka/cluster/sharding/index.html "Permalink")  package [sharding](sharding/index.html)
9. [**](../../akka/cluster/singleton/index.html "Permalink")  package [singleton](singleton/index.html)
10. [**](../../akka/cluster/typed/index.html "Permalink")  package [typed](typed/index.html)
### Type Members
...
3. [**](../../akka/cluster/ClusterNodeMBean.html "Permalink")  trait [ClusterNodeMBean](ClusterNodeMBean.html "Interface for the cluster JMX MBean.") extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Interface for the cluster JMX MBean.
...
5. [**](../../akka/cluster/ClusterSettings.html "Permalink") final  class [ClusterSettings](ClusterSettings.html) extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)
6. [**](../../akka/cluster/ConfigValidation.html "Permalink") sealed  trait [ConfigValidation](ConfigValidation.html) extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Annotations@[DoNotInherit](../annotation/DoNotInherit.html)()
7. [**](../../akka/cluster/DowningProvider.html "Permalink") abstract  class [DowningProvider](DowningProvider.html "API for plugins that will handle downing of cluster nodes.") extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)API for plugins that will handle downing of cluster nodes.
...
8. [**](../../akka/cluster/Invalid.html "Permalink") final  case class [Invalid](Invalid.html)(errorMessages: [Seq](https://www.scala-lang.org/api/2.13.8/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[String]) extends [ConfigValidation](ConfigValidation.html) with [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with Serializable
...
10. [**](../../akka/cluster/JoinConfigCompatChecker.html "Permalink") abstract  class [JoinConfigCompatChecker](JoinConfigCompatChecker.html) extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)
...
12. [**](../../akka/cluster/MemberStatus.html "Permalink") sealed abstract  class [MemberStatus](MemberStatus.html "Defines the current status of a cluster member node") extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Defines the current status of a cluster member node
...
14. [**](../../akka/cluster/UniqueAddress.html "Permalink") final  class [UniqueAddress](UniqueAddress.html "Member identifier consisting of address and random uid.") extends [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with Serializable with Ordered\[[UniqueAddress](UniqueAddress.html)]Member identifier consisting of address and random `uid`.
...
Annotations@SerialVersionUID()
15. [**](../../akka/cluster/VectorClock.html "Permalink") final  case class [VectorClock](VectorClock.html "Representation of a Vector-based clock (counting clock), inspired by Lamport logical clocks.")(versions: [TreeMap](https://www.scala-lang.org/api/2.13.8/scala/collection/immutable/TreeMap.html#scala.collection.immutable.TreeMap)\[Node, [Long](https://www.scala-lang.org/api/2.13.8/scala/Long.html#scala.Long)] \= TreeMap.empty\[VectorClock.Node, Long]) extends [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with SerializableRepresentation of a Vector\-based clock (counting clock), inspired by Lamport logical clocks.
...
4. [**](../../akka/cluster/ClusterScope$.html "Permalink")  case object [ClusterScope](ClusterScope$.html "Cluster aware scope of a akka.actor.Deploy") extends [ClusterScope](ClusterScope.html) with [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with SerializableCluster aware scope of a [akka.actor.Deploy](../actor/Deploy.html)
...
10. [**](../../akka/cluster/UniqueAddress$.html "Permalink")  object [UniqueAddress](UniqueAddress$.html) extends [AbstractFunction2](https://www.scala-lang.org/api/2.13.8/scala/runtime/AbstractFunction2.html#scala.runtime.AbstractFunction2)\[[Address](../actor/Address.html), [Int](https://www.scala-lang.org/api/2.13.8/scala/Int.html#scala.Int), [UniqueAddress](UniqueAddress.html)] with [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)
11. [**](../../akka/cluster/Valid$.html "Permalink")  case object [Valid](Valid$.html) extends [ConfigValidation](ConfigValidation.html) with [Product](https://www.scala-lang.org/api/2.13.8/scala/Product.html#scala.Product) with Serializable
### Ungrouped
...
- https://doc.akka.io/api/akka-core/2.6/akka/actor/Deploy.html
...
- https://doc.akka.io/api/akka-core/2.6/akka/actor/Scope.html
- https://doc.akka.io/api/akka-core/2.6/akka/actor/index.html
- https://doc.akka.io/api/akka-core/2.6/akka/annotation/ApiMayChange.html
...
---
*Source: [https://doc.akka.io/api/akka-core/2.6/akka/cluster/index.html](https://doc.akka.io/api/akka-core/2.6/akka/cluster/index.html)*