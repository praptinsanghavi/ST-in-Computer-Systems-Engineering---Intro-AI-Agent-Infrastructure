---
description: Akka 2.10.17 - akka.stream.scaladsl.BidiFlow
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:17:53Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/BidiFlow.html
title: Akka 2.10.17 - akka.stream.scaladsl.BidiFlow
---

# Akka 2.10.17 - akka.stream.scaladsl.BidiFlow

> **Summary:** Akka 2.10.17 - akka.stream.scaladsl.BidiFlow
...
[c](BidiFlow$.html "See companion object")[akka](../../index.html).[stream](../index.html).[scaladsl](index.html)

# [BidiFlow](BidiFlow$.html "See companion object")[**](../../../akka/stream/scaladsl/BidiFlow.html "Permalink")
...
Source[BidiFlow.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/scaladsl/BidiFlow.scala#L13)Linear Supertypes[Graph](../Graph.html)\[[BidiShape](../BidiShape.html)\[I1, O1, I2, O2], Mat], [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. BidiFlow
2. Graph
...
1. [**](../../../akka/stream/scaladsl/BidiFlow.html#<init>(traversalBuilder:akka.stream.impl.TraversalBuilder,shape:akka.stream.BidiShape[I1,O1,I2,O2]):akka.stream.scaladsl.BidiFlow[I1,O1,I2,O2,Mat] "Permalink")  new BidiFlow(traversalBuilder: TraversalBuilder, shape: [BidiShape](../BidiShape.html)\[I1, O1, I2, O2])
### Type Members

1. [**](../../../akka/stream/scaladsl/BidiFlow.html#Shape=S@scala.annotation.unchecked.uncheckedVariance "Permalink")  type Shape \= [BidiShape](../BidiShape.html)\[I1, O1, I2, O2]Type\-level accessor for the shape parameter of this graph.
...
1. [**](../../../akka/stream/scaladsl/BidiFlow.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../akka/stream/scaladsl/BidiFlow.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../akka/stream/scaladsl/BidiFlow.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from BidiFlow\[I1, O1, I2, O2, Mat] toany2stringadd\[BidiFlow\[I1, O1, I2, O2, Mat]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../akka/stream/scaladsl/BidiFlow.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (BidiFlow\[I1, O1, I2, O2, Mat], B)ImplicitThis member is added by an implicit conversion from BidiFlow\[I1, O1, I2, O2, Mat] toArrowAssoc\[BidiFlow\[I1, O1, I2, O2, Mat]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../akka/stream/scaladsl/BidiFlow.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../akka/stream/scaladsl/BidiFlow.html#addAttributes(attr:akka.stream.Attributes):akka.stream.scaladsl.BidiFlow[I1,O1,I2,O2,Mat] "Permalink")  def addAttributes(attr: [Attributes](../Attributes.html)): BidiFlow\[I1, O1, I2, O2, Mat]Add the given attributes to this Source.
...
7. [**](../../../akka/stream/scaladsl/BidiFlow.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
8. [**](../../../akka/stream/scaladsl/BidiFlow.html#asJava[JI1<:I1,JO1>:O1,JI2<:I2,JO2>:O2,JMat>:Mat]:akka.stream.javadsl.BidiFlow[JI1,JO1,JI2,JO2,JMat] "Permalink")  def asJava\[JI1 \<: I1, JO1 \>: O1, JI2 \<: I2, JO2 \>: O2, JMat \>: Mat]: [javadsl.BidiFlow](../javadsl/BidiFlow.html)\[JI1, JO1, JI2, JO2, JMat]
9. [**](../../../akka/stream/scaladsl/BidiFlow.html#async(dispatcher:String,inputBufferSize:Int):akka.stream.scaladsl.BidiFlow[I1,O1,I2,O2,Mat] "Permalink")  def async(dispatcher: String, inputBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): BidiFlow\[I1, O1, I2, O2, Mat]Put an asynchronous boundary around this `BidiFlow`
...
Definition ClassesBidiFlow → [Graph](../Graph.html)
10. [**](../../../akka/stream/scaladsl/BidiFlow.html#async(dispatcher:String):akka.stream.scaladsl.BidiFlow[I1,O1,I2,O2,Mat] "Permalink")  def async(dispatcher: String): BidiFlow\[I1, O1, I2, O2, Mat]Put an asynchronous boundary around this `BidiFlow`
...
Definition ClassesBidiFlow → [Graph](../Graph.html)
11. [**](../../../akka/stream/scaladsl/BidiFlow.html#async:akka.stream.scaladsl.BidiFlow[I1,O1,I2,O2,Mat] "Permalink")  def async: BidiFlow\[I1, O1, I2, O2, Mat]Put an asynchronous boundary around this `BidiFlow`

Put an asynchronous boundary around this `BidiFlow`

Definition ClassesBidiFlow → [Graph](../Graph.html)
12. [**](../../../akka/stream/scaladsl/BidiFlow.html#atop[OO1,II2,Mat2](bidi:akka.stream.Graph[akka.stream.BidiShape[O1,OO1,II2,I2],Mat2]):akka.stream.scaladsl.BidiFlow[I1,OO1,II2,O2,Mat] "Permalink")  def atop\[OO1, II2, Mat2](bidi: [Graph](../Graph.html)\[[BidiShape](../BidiShape.html)\[O1, OO1, II2, I2], Mat2]): BidiFlow\[I1, OO1, II2, O2, Mat]Add the given BidiFlow as the next step in a bidirectional transformation
pipeline.
...
[atopMat](#atopMat[OO1,II2,Mat2,M](bidi:akka.stream.Graph[akka.stream.BidiShape[O1,OO1,II2,I2],Mat2])(combine:(Mat,Mat2)=>M):akka.stream.scaladsl.BidiFlow[I1,OO1,II2,O2,M]) if a different strategy is needed.
13. [**](../../../akka/stream/scaladsl/BidiFlow.html#atopMat[OO1,II2,Mat2,M](bidi:akka.stream.Graph[akka.stream.BidiShape[O1,OO1,II2,I2],Mat2])(combine:(Mat,Mat2)=>M):akka.stream.scaladsl.BidiFlow[I1,OO1,II2,O2,M] "Permalink")  def atopMat\[OO1, II2, Mat2, M](bidi: [Graph](../Graph.html)\[[BidiShape](../BidiShape.html)\[O1, OO1, II2, I2], Mat2])(combine: (Mat, Mat2) \=\> M): BidiFlow\[I1, OO1, II2, O2, M]Add the given BidiFlow as the next step in a bidirectional transformation
pipeline.
...
14. [**](../../../akka/stream/scaladsl/BidiFlow.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
15. [**](../../../akka/stream/scaladsl/BidiFlow.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (BidiFlow\[I1, O1, I2, O2, Mat]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BidiFlow\[I1, O1, I2, O2, Mat]ImplicitThis member is added by an implicit conversion from BidiFlow\[I1, O1, I2, O2, Mat] toEnsuring\[BidiFlow\[I1, O1, I2, O2, Mat]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../../akka/stream/scaladsl/BidiFlow.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (BidiFlow\[I1, O1, I2, O2, Mat]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BidiFlow\[I1, O1, I2, O2, Mat]ImplicitThis member is added by an implicit conversion from BidiFlow\[I1, O1, I2, O2, Mat] toEnsuring\[BidiFlow\[I1, O1, I2, O2, Mat]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../../akka/stream/scaladsl/BidiFlow.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BidiFlow\[I1, O1, I2, O2, Mat]ImplicitThis member is added by an implicit conversion from BidiFlow\[I1, O1, I2, O2, Mat] toEnsuring\[BidiFlow\[I1, O1, I2, O2, Mat]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
18. [**](../../../akka/stream/scaladsl/BidiFlow.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BidiFlow\[I1, O1, I2, O2, Mat]ImplicitThis member is added by an implicit conversion from BidiFlow\[I1, O1, I2, O2, Mat] toEnsuring\[BidiFlow\[I1, O1, I2, O2, Mat]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
19. [**](../../../akka/stream/scaladsl/BidiFlow.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
20. [**](../../../akka/stream/scaladsl/BidiFlow.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
21. [**](../../../akka/stream/scaladsl/BidiFlow.html#getAttributes:akka.stream.Attributes "Permalink")  def getAttributes: [Attributes](../Attributes.html)Definition ClassesBidiFlow → [Graph](../Graph.html)
22. [**](../../../akka/stream/scaladsl/BidiFlow.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../../akka/stream/scaladsl/BidiFlow.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../../akka/stream/scaladsl/BidiFlow.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
25. [**](../../../akka/stream/scaladsl/BidiFlow.html#join[Mat2](flow:akka.stream.Graph[akka.stream.FlowShape[O1,I2],Mat2]):akka.stream.scaladsl.Flow[I1,O2,Mat] "Permalink")  def join\[Mat2](flow: [Graph](../Graph.html)\[[FlowShape](../FlowShape.html)\[O1, I2], Mat2]): [Flow](Flow.html)\[I1, O2, Mat]Add the given Flow as the final step in a bidirectional transformation
pipeline.
...
[joinMat](#joinMat[Mat2,M](flow:akka.stream.Graph[akka.stream.FlowShape[O1,I2],Mat2])(combine:(Mat,Mat2)=>M):akka.stream.scaladsl.Flow[I1,O2,M]) if a different strategy is needed.
26. [**](../../../akka/stream/scaladsl/BidiFlow.html#joinMat[Mat2,M](flow:akka.stream.Graph[akka.stream.FlowShape[O1,I2],Mat2])(combine:(Mat,Mat2)=>M):akka.stream.scaladsl.Flow[I1,O2,M] "Permalink")  def joinMat\[Mat2, M](flow: [Graph](../Graph.html)\[[FlowShape](../FlowShape.html)\[O1, I2], Mat2])(combine: (Mat, Mat2) \=\> M): [Flow](Flow.html)\[I1, O2, M]Add the given Flow as the final step in a bidirectional transformation
pipeline.
...
27. [**](../../../akka/stream/scaladsl/BidiFlow.html#mapMaterializedValue[Mat2](f:Mat=>Mat2):akka.stream.scaladsl.BidiFlow[I1,O1,I2,O2,Mat2] "Permalink")  def mapMaterializedValue\[Mat2](f: (Mat) \=\> Mat2): BidiFlow\[I1, O1, I2, O2, Mat2]Transform only the materialized value of this BidiFlow, leaving all other properties as they were.
28. [**](../../../akka/stream/scaladsl/BidiFlow.html#named(name:String):akka.stream.scaladsl.BidiFlow[I1,O1,I2,O2,Mat] "Permalink")  def named(name: String): BidiFlow\[I1, O1, I2, O2, Mat]Add a `name` attribute to this Flow.

Add a `name` attribute to this Flow.

Definition ClassesBidiFlow → [Graph](../Graph.html)
29. [**](../../../akka/stream/scaladsl/BidiFlow.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
30. [**](../../../akka/stream/scaladsl/BidiFlow.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
31. [**](../../../akka/stream/scaladsl/BidiFlow.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
32. [**](../../../akka/stream/scaladsl/BidiFlow.html#reversed:akka.stream.scaladsl.BidiFlow[I2,O2,I1,O1,Mat] "Permalink")  def reversed: BidiFlow\[I2, O2, I1, O1, Mat]Turn this BidiFlow around by 180 degrees, logically flipping it upside down in a protocol stack.
33. [**](../../../akka/stream/scaladsl/BidiFlow.html#shape:akka.stream.BidiShape[I1,O1,I2,O2] "Permalink")  val shape: [BidiShape](../BidiShape.html)\[I1, O1, I2, O2]The shape of a graph is all that is externally visible: its inlets and outlets.

The shape of a graph is all that is externally visible: its inlets and outlets.

Definition ClassesBidiFlow → [Graph](../Graph.html)
34. [**](../../../akka/stream/scaladsl/BidiFlow.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
35. [**](../../../akka/stream/scaladsl/BidiFlow.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
36. [**](../../../akka/stream/scaladsl/BidiFlow.html#traversalBuilder:akka.stream.impl.TraversalBuilder "Permalink")  val traversalBuilder: TraversalBuilderINTERNAL API.
...
Definition ClassesBidiFlow → [Graph](../Graph.html)
37. [**](../../../akka/stream/scaladsl/BidiFlow.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
38. [**](../../../akka/stream/scaladsl/BidiFlow.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
39. [**](../../../akka/stream/scaladsl/BidiFlow.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
40. [**](../../../akka/stream/scaladsl/BidiFlow.html#withAttributes(attr:akka.stream.Attributes):akka.stream.scaladsl.BidiFlow[I1,O1,I2,O2,Mat] "Permalink")  def withAttributes(attr: [Attributes](../Attributes.html)): BidiFlow\[I1, O1, I2, O2, Mat]Change the attributes of this [Source](Source.html) to the given ones and seal the list
of attributes.
...
1. [**](../../../akka/stream/scaladsl/BidiFlow.html#mapMaterializedValue[M2](f:M=>M2):akka.stream.Graph[S,M2] "Permalink")  def mapMaterializedValue\[M2](f: (Mat) \=\> M2): [Graph](../Graph.html)\[[BidiShape](../BidiShape.html)\[I1, O1, I2, O2], M2]Transform the materialized value of this Graph, leaving all other properties as they were.
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10/akka/stream/scaladsl/BidiFlow.html](https://doc.akka.io/api/akka-core/2.10/akka/stream/scaladsl/BidiFlow.html)*