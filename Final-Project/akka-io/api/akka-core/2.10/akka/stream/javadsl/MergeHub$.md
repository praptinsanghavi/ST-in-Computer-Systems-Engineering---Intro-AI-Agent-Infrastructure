---
description: Akka 2.10.17 - akka.stream.javadsl.MergeHub
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:55:39Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/javadsl/MergeHub$.html
title: Akka 2.10.17 - akka.stream.javadsl.MergeHub
---

# Akka 2.10.17 - akka.stream.javadsl.MergeHub

> **Summary:** Akka 2.10.17 - akka.stream.javadsl.MergeHub
...
# MergeHub[**](../../../akka/stream/javadsl/MergeHub$.html "Permalink")
...
Source[Hub.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/javadsl/Hub.scala#L21)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. MergeHub
2. AnyRef
...
1. [**](../../../akka/stream/javadsl/MergeHub$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../akka/stream/javadsl/MergeHub$.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../akka/stream/javadsl/MergeHub$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../akka/stream/javadsl/MergeHub$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/stream/javadsl/MergeHub$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../../akka/stream/javadsl/MergeHub$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
7. [**](../../../akka/stream/javadsl/MergeHub$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
8. [**](../../../akka/stream/javadsl/MergeHub$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
9. [**](../../../akka/stream/javadsl/MergeHub$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
10. [**](../../../akka/stream/javadsl/MergeHub$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
11. [**](../../../akka/stream/javadsl/MergeHub$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
12. [**](../../../akka/stream/javadsl/MergeHub$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../../akka/stream/javadsl/MergeHub$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../../akka/stream/javadsl/MergeHub$.html#of[T](clazz:Class[T]):akka.stream.javadsl.Source[T,akka.stream.javadsl.Sink[T,akka.NotUsed]] "Permalink")  def of\[T](clazz: Class\[T]): [Source](Source.html)\[T, [Sink](Sink.html)\[T, [NotUsed](../../NotUsed.html)]]Creates a [Source](Source.html) that emits elements merged from a dynamic set of producers.
...
clazzType of elements this hub emits and consumes
15. [**](../../../akka/stream/javadsl/MergeHub$.html#of[T](clazz:Class[T],perProducerBufferSize:Int):akka.stream.javadsl.Source[T,akka.stream.javadsl.Sink[T,akka.NotUsed]] "Permalink")  def of\[T](clazz: Class\[T], perProducerBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Source](Source.html)\[T, [Sink](Sink.html)\[T, [NotUsed](../../NotUsed.html)]]Creates a [Source](Source.html) that emits elements merged from a dynamic set of producers.
...
perProducerBufferSizeBuffer space used per producer.
16. [**](../../../akka/stream/javadsl/MergeHub$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
17. [**](../../../akka/stream/javadsl/MergeHub$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
...
20. [**](../../../akka/stream/javadsl/MergeHub$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
21. [**](../../../akka/stream/javadsl/MergeHub$.html#withDraining[T](clazz:Class[T]):akka.stream.javadsl.Source[T,akka.japi.Pair[akka.stream.javadsl.Sink[T,akka.NotUsed],akka.stream.javadsl.MergeHub.DrainingControl]] "Permalink")  def withDraining\[T](clazz: Class\[T]): [Source](Source.html)\[T, [Pair](../../japi/Pair.html)\[[Sink](Sink.html)\[T, [NotUsed](../../NotUsed.html)], [DrainingControl](MergeHub$$DrainingControl.html)]]Creates a [Source](Source.html) that emits elements merged from a dynamic set of producers.

Creates a [Source](Source.html) that emits elements merged from a dynamic set of producers. After the [Source](Source.html) returned
by this method is materialized, it returns a [Sink](Sink.html) as a materialized value. This [Sink](Sink.html) can be materialized
arbitrarily many times and each of the materializations will feed the elements into the original [Source](Source.html).
...
The materialized [DrainingControl](MergeHub$$DrainingControl.html) can be used to drain the Hub: any new produces using the [Sink](Sink.html) will be cancelled
and the Hub will be closed completing the [Source](Source.html) as soon as all currently connected producers complete.

clazzType of elements this hub emits and consumes
22. [**](../../../akka/stream/javadsl/MergeHub$.html#withDraining[T](clazz:Class[T],perProducerBufferSize:Int):akka.stream.javadsl.Source[T,akka.japi.Pair[akka.stream.javadsl.Sink[T,akka.NotUsed],akka.stream.javadsl.MergeHub.DrainingControl]] "Permalink")  def withDraining\[T](clazz: Class\[T], perProducerBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Source](Source.html)\[T, [Pair](../../japi/Pair.html)\[[Sink](Sink.html)\[T, [NotUsed](../../NotUsed.html)], [DrainingControl](MergeHub$$DrainingControl.html)]]Creates a [Source](Source.html) that emits elements merged from a dynamic set of producers.
...
1. [**](../../../akka/stream/javadsl/MergeHub$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
- https://doc.akka.io/api/akka-core/2.10/akka/stream/javadsl/MergeHub$$DrainingControl.html
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10/akka/stream/javadsl/MergeHub$.html](https://doc.akka.io/api/akka-core/2.10/akka/stream/javadsl/MergeHub$.html)*