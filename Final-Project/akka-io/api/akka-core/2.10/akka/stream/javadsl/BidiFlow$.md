...
scraped_at: '2026-04-06T14:55:13Z'
section: api
site: akka-io
...
[o](BidiFlow.html "See companion class")[akka](../../index.html).[stream](../index.html).[javadsl](index.html)

# [BidiFlow](BidiFlow.html "See companion class")[**](../../../akka/stream/javadsl/BidiFlow$.html "Permalink")

### Companion [class BidiFlow](BidiFlow.html "See companion class")

#### object BidiFlow

Source[BidiFlow.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/javadsl/BidiFlow.scala#L11)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. BidiFlow
2. AnyRef
...
3. [**](../../../akka/stream/javadsl/BidiFlow$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../akka/stream/javadsl/BidiFlow$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/stream/javadsl/BidiFlow$.html#bidirectionalIdleTimeout[I,O](timeout:java.time.Duration):akka.stream.javadsl.BidiFlow[I,I,O,O,akka.NotUsed] "Permalink")  def bidirectionalIdleTimeout\[I, O](timeout: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): [BidiFlow](BidiFlow.html)\[I, I, O, O, [NotUsed](../../NotUsed.html)]If the time between two processed elements \*in any direction\* exceed the provided timeout, the stream is failed
...
6. [**](../../../akka/stream/javadsl/BidiFlow$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
7. [**](../../../akka/stream/javadsl/BidiFlow$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
8. [**](../../../akka/stream/javadsl/BidiFlow$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
9. [**](../../../akka/stream/javadsl/BidiFlow$.html#fromFlows[I1,O1,I2,O2,M1,M2](flow1:akka.stream.Graph[akka.stream.FlowShape[I1,O1],M1],flow2:akka.stream.Graph[akka.stream.FlowShape[I2,O2],M2]):akka.stream.javadsl.BidiFlow[I1,O1,I2,O2,akka.NotUsed] "Permalink")  def fromFlows\[I1, O1, I2, O2, M1, M2](flow1: [Graph](../Graph.html)\[[FlowShape](../FlowShape.html)\[I1, O1], M1], flow2: [Graph](../Graph.html)\[[FlowShape](../FlowShape.html)\[I2, O2], M2]): [BidiFlow](BidiFlow.html)\[I1, O1, I2, O2, [NotUsed](../../NotUsed.html)]Wraps two Flows to create a *BidiFlow*.
...
O2 <~~ |        Flow2         | <~~ I2
    ...
    +----------------------------+
```
10. [**](../../../akka/stream/javadsl/BidiFlow$.html#fromFlowsMat[I1,O1,I2,O2,M1,M2,M](flow1:akka.stream.Graph[akka.stream.FlowShape[I1,O1],M1],flow2:akka.stream.Graph[akka.stream.FlowShape[I2,O2],M2],combine:akka.japi.function.Function2[M1,M2,M]):akka.stream.javadsl.BidiFlow[I1,O1,I2,O2,M] "Permalink")  def fromFlowsMat\[I1, O1, I2, O2, M1, M2, M](flow1: [Graph](../Graph.html)\[[FlowShape](../FlowShape.html)\[I1, O1], M1], flow2: [Graph](../Graph.html)\[[FlowShape](../FlowShape.html)\[I2, O2], M2], combine: [Function2](../../japi/function/Function2.html)\[M1, M2, M]): [BidiFlow](BidiFlow.html)\[I1, O1, I2, O2, M]Wraps two Flows to create a *BidiFlow*.
...
O2 <~~ |        Flow2         | <~~ I2
    ...
    +----------------------------+
```
11. [**](../../../akka/stream/javadsl/BidiFlow$.html#fromFunctions[I1,O1,I2,O2](top:akka.japi.function.Function[I1,O1],bottom:akka.japi.function.Function[I2,O2]):akka.stream.javadsl.BidiFlow[I1,O1,I2,O2,akka.NotUsed] "Permalink")  def fromFunctions\[I1, O1, I2, O2](top: [Function](../../japi/function/Function.html)\[I1, O1], bottom: [Function](../../japi/function/Function.html)\[I2, O2]): [BidiFlow](BidiFlow.html)\[I1, O1, I2, O2, [NotUsed](../../NotUsed.html)]Create a BidiFlow where the top and bottom flows are just one simple mapping
operator each, expressed by the two functions.
12. [**](../../../akka/stream/javadsl/BidiFlow$.html#fromGraph[I1,O1,I2,O2,M](g:akka.stream.Graph[akka.stream.BidiShape[I1,O1,I2,O2],M]):akka.stream.javadsl.BidiFlow[I1,O1,I2,O2,M] "Permalink")  def fromGraph\[I1, O1, I2, O2, M](g: [Graph](../Graph.html)\[[BidiShape](../BidiShape.html)\[I1, O1, I2, O2], M]): [BidiFlow](BidiFlow.html)\[I1, O1, I2, O2, M]A graph with the shape of a BidiFlow logically is a BidiFlow, this method makes
it so also in type.
...
14. [**](../../../akka/stream/javadsl/BidiFlow$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../../akka/stream/javadsl/BidiFlow$.html#identity[A,B]:akka.stream.javadsl.BidiFlow[A,A,B,B,akka.NotUsed] "Permalink")  def identity\[A, B]: [BidiFlow](BidiFlow.html)\[A, A, B, B, [NotUsed](../../NotUsed.html)]
16. [**](../../../akka/stream/javadsl/BidiFlow$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../../akka/stream/javadsl/BidiFlow$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../../akka/stream/javadsl/BidiFlow$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../../akka/stream/javadsl/BidiFlow$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../../akka/stream/javadsl/BidiFlow$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../../akka/stream/javadsl/BidiFlow$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
...
24. [**](../../../akka/stream/javadsl/BidiFlow$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10/akka/stream/javadsl/BidiFlow$.html](https://doc.akka.io/api/akka-core/2.10/akka/stream/javadsl/BidiFlow$.html)*