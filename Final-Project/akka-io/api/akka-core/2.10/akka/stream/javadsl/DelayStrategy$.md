...
scraped_at: '2026-04-06T14:55:22Z'
section: api
site: akka-io
...
[o](DelayStrategy.html "See companion trait")[akka](../../index.html).[stream](../index.html).[javadsl](index.html)

# [DelayStrategy](DelayStrategy.html "See companion trait")[**](../../../akka/stream/javadsl/DelayStrategy$.html "Permalink")

### Companion [trait DelayStrategy](DelayStrategy.html "See companion trait")

#### object DelayStrategy

Source[DelayStrategy.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/javadsl/DelayStrategy.scala#L26)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. DelayStrategy
2. AnyRef
...
3. [**](../../../akka/stream/javadsl/DelayStrategy$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../akka/stream/javadsl/DelayStrategy$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/stream/javadsl/DelayStrategy$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../../akka/stream/javadsl/DelayStrategy$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
7. [**](../../../akka/stream/javadsl/DelayStrategy$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
8. [**](../../../akka/stream/javadsl/DelayStrategy$.html#fixedDelay[T](delay:java.time.Duration):akka.stream.javadsl.DelayStrategy[T] "Permalink")  def fixedDelay\[T](delay: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): [DelayStrategy](DelayStrategy.html)\[T]Fixed delay strategy, always returns constant delay for any element.
...
10. [**](../../../akka/stream/javadsl/DelayStrategy$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
11. [**](../../../akka/stream/javadsl/DelayStrategy$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
12. [**](../../../akka/stream/javadsl/DelayStrategy$.html#linearIncreasingDelay[T](increaseStep:java.time.Duration,needsIncrease:T=>Boolean,initialDelay:java.time.Duration,maxDelay:java.time.Duration):akka.stream.javadsl.DelayStrategy[T] "Permalink")  def linearIncreasingDelay\[T](increaseStep: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), needsIncrease: (T) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), initialDelay: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), maxDelay: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): [DelayStrategy](DelayStrategy.html)\[T]Strategy with linear increasing delay.
...
13. [**](../../../akka/stream/javadsl/DelayStrategy$.html#linearIncreasingDelay[T](increaseStep:java.time.Duration,needsIncrease:T=>Boolean,initialDelay:java.time.Duration):akka.stream.javadsl.DelayStrategy[T] "Permalink")  def linearIncreasingDelay\[T](increaseStep: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), needsIncrease: (T) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), initialDelay: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): [DelayStrategy](DelayStrategy.html)\[T]Strategy with linear increasing delay.
...
initialDelayinitial delay for each of elements
14. [**](../../../akka/stream/javadsl/DelayStrategy$.html#linearIncreasingDelay[T](increaseStep:java.time.Duration,needsIncrease:T=>Boolean):akka.stream.javadsl.DelayStrategy[T] "Permalink")  def linearIncreasingDelay\[T](increaseStep: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), needsIncrease: (T) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): [DelayStrategy](DelayStrategy.html)\[T]Strategy with linear increasing delay.
...
needsIncreaseif `true` delay increases, if `false` delay resets to `initialDelay`
15. [**](../../../akka/stream/javadsl/DelayStrategy$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
16. [**](../../../akka/stream/javadsl/DelayStrategy$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../../akka/stream/javadsl/DelayStrategy$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../../akka/stream/javadsl/DelayStrategy$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
19. [**](../../../akka/stream/javadsl/DelayStrategy$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
...
22. [**](../../../akka/stream/javadsl/DelayStrategy$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
