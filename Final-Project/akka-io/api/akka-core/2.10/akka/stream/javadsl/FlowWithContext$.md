...
scraped_at: '2026-04-06T14:55:28Z'
section: api
site: akka-io
...
[o](FlowWithContext.html "See companion class")[akka](../../index.html).[stream](../index.html).[javadsl](index.html)

# [FlowWithContext](FlowWithContext.html "See companion class")[**](../../../akka/stream/javadsl/FlowWithContext$.html "Permalink")

### Companion [class FlowWithContext](FlowWithContext.html "See companion class")

#### object FlowWithContext

Source[FlowWithContext.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/javadsl/FlowWithContext.scala#L21)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. FlowWithContext
2. AnyRef
...
3. [**](../../../akka/stream/javadsl/FlowWithContext$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../akka/stream/javadsl/FlowWithContext$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/stream/javadsl/FlowWithContext$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../../akka/stream/javadsl/FlowWithContext$.html#create[In,Ctx]():akka.stream.javadsl.FlowWithContext[In,Ctx,In,Ctx,akka.NotUsed] "Permalink")  def create\[In, Ctx](): [FlowWithContext](FlowWithContext.html)\[In, Ctx, In, Ctx, [NotUsed](../../NotUsed.html)]
7. [**](../../../akka/stream/javadsl/FlowWithContext$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
8. [**](../../../akka/stream/javadsl/FlowWithContext$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
9. [**](../../../akka/stream/javadsl/FlowWithContext$.html#fromPairs[In,CtxIn,Out,CtxOut,Mat](under:akka.stream.javadsl.Flow[akka.japi.Pair[In,CtxIn],akka.japi.Pair[Out,CtxOut],Mat]):akka.stream.javadsl.FlowWithContext[In,CtxIn,Out,CtxOut,Mat] "Permalink")  def fromPairs\[In, CtxIn, Out, CtxOut, Mat](under: [Flow](Flow.html)\[[Pair](../../japi/Pair.html)\[In, CtxIn], [Pair](../../japi/Pair.html)\[Out, CtxOut], Mat]): [FlowWithContext](FlowWithContext.html)\[In, CtxIn, Out, CtxOut, Mat]Creates a FlowWithContext from a regular flow that operates on `Pair<data, context>` elements.
...
11. [**](../../../akka/stream/javadsl/FlowWithContext$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
12. [**](../../../akka/stream/javadsl/FlowWithContext$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
13. [**](../../../akka/stream/javadsl/FlowWithContext$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../../akka/stream/javadsl/FlowWithContext$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../../akka/stream/javadsl/FlowWithContext$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../akka/stream/javadsl/FlowWithContext$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
17. [**](../../../akka/stream/javadsl/FlowWithContext$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
...
20. [**](../../../akka/stream/javadsl/FlowWithContext$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10/akka/stream/javadsl/FlowWithContext$.html](https://doc.akka.io/api/akka-core/2.10/akka/stream/javadsl/FlowWithContext$.html)*