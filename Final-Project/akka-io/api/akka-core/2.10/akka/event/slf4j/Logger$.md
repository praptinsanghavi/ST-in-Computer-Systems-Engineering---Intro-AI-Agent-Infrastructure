...
scraped_at: '2026-04-05T20:21:03Z'
section: api
site: akka-io
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10/akka/event/slf4j/Logger$.html](https://doc.akka.io/api/akka-core/2.10/akka/event/slf4j/Logger$.html)*