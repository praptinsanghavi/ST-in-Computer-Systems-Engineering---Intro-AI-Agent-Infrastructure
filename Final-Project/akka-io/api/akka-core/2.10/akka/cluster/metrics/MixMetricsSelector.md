...
scraped_at: '2026-04-06T03:25:42Z'
section: api
site: akka-io
...
[c](MixMetricsSelector$.html "See companion object")[akka](../../index.html).[cluster](../index.html).[metrics](index.html)

# [MixMetricsSelector](MixMetricsSelector$.html "See companion object")[**](../../../akka/cluster/metrics/MixMetricsSelector.html "Permalink")

### Companion [object MixMetricsSelector](MixMetricsSelector$.html "See companion object")

#### final  case class MixMetricsSelector(selectors: [IndexedSeq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/IndexedSeq.html#scala.collection.immutable.IndexedSeq)\[[CapacityMetricsSelector](CapacityMetricsSelector.html)]) extends [MixMetricsSelectorBase](MixMetricsSelectorBase.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
...
1. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#<init>(selectors:IndexedSeq[akka.cluster.metrics.CapacityMetricsSelector]):akka.cluster.metrics.MixMetricsSelector "Permalink")  new MixMetricsSelector(selectors: [IndexedSeq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/IndexedSeq.html#scala.collection.immutable.IndexedSeq)\[[CapacityMetricsSelector](CapacityMetricsSelector.html)])
### Value Members
...
3. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from MixMetricsSelector toany2stringadd\[MixMetricsSelector] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (MixMetricsSelector, B)ImplicitThis member is added by an implicit conversion from MixMetricsSelector toArrowAssoc\[MixMetricsSelector] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#capacity(nodeMetrics:Set[akka.cluster.metrics.NodeMetrics]):Map[akka.actor.Address,Double] "Permalink")  def capacity(nodeMetrics: Set\[[NodeMetrics](NodeMetrics.html)]): Map\[[Address](../../actor/Address.html), [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double)]Remaining capacity for each node.
...
8. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (MixMetricsSelector) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): MixMetricsSelectorImplicitThis member is added by an implicit conversion from MixMetricsSelector toEnsuring\[MixMetricsSelector] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (MixMetricsSelector) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): MixMetricsSelectorImplicitThis member is added by an implicit conversion from MixMetricsSelector toEnsuring\[MixMetricsSelector] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): MixMetricsSelectorImplicitThis member is added by an implicit conversion from MixMetricsSelector toEnsuring\[MixMetricsSelector] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): MixMetricsSelectorImplicitThis member is added by an implicit conversion from MixMetricsSelector toEnsuring\[MixMetricsSelector] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
16. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
20. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#selectors:IndexedSeq[akka.cluster.metrics.CapacityMetricsSelector] "Permalink")  val selectors: [IndexedSeq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/IndexedSeq.html#scala.collection.immutable.IndexedSeq)\[[CapacityMetricsSelector](CapacityMetricsSelector.html)]
21. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
25. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#weights(nodeMetrics:Set[akka.cluster.metrics.NodeMetrics]):Map[akka.actor.Address,Int] "Permalink")  def weights(nodeMetrics: Set\[[NodeMetrics](NodeMetrics.html)]): Map\[[Address](../../actor/Address.html), [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)]The weights per address, based on the capacity produced by
the nodeMetrics.
...
2. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from MixMetricsSelector toStringFormat\[MixMetricsSelector] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../akka/cluster/metrics/MixMetricsSelector.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (MixMetricsSelector, B)ImplicitThis member is added by an implicit conversion from MixMetricsSelector toArrowAssoc\[MixMetricsSelector] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromMixMetricsSelector to any2stringadd\[MixMetricsSelector]

### Inherited by implicit conversion StringFormat fromMixMetricsSelector to StringFormat\[MixMetricsSelector]

### Inherited by implicit conversion Ensuring fromMixMetricsSelector to Ensuring\[MixMetricsSelector]

### Inherited by implicit conversion ArrowAssoc fromMixMetricsSelector to ArrowAssoc\[MixMetricsSelector]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10/akka/cluster/metrics/MixMetricsSelector.html](https://doc.akka.io/api/akka-core/2.10/akka/cluster/metrics/MixMetricsSelector.html)*