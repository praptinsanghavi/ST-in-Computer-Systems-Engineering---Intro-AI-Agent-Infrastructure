...
scraped_at: '2026-04-06T01:44:54Z'
section: api
site: akka-io
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10/akka/pattern/BackoffSupervisor$$Reset$.html](https://doc.akka.io/api/akka-core/2.10/akka/pattern/BackoffSupervisor$$Reset$.html)*