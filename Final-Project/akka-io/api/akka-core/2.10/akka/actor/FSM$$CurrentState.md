...
scraped_at: '2026-04-06T15:12:45Z'
section: api
site: akka-io
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10/akka/actor/FSM$$CurrentState.html](https://doc.akka.io/api/akka-core/2.10/akka/actor/FSM$$CurrentState.html)*