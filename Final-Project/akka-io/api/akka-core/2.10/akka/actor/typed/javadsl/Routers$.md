...
scraped_at: '2026-04-05T19:55:49Z'
section: api
site: akka-io
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10/akka/actor/typed/javadsl/Routers$.html](https://doc.akka.io/api/akka-core/2.10/akka/actor/typed/javadsl/Routers$.html)*