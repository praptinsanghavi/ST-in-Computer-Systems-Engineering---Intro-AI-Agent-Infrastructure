---
description: Akka 2.10.17 - akka.stream.scaladsl.RunnableGraph
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:05:43Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/RunnableGraph.html
title: Akka 2.10.17 - akka.stream.scaladsl.RunnableGraph
---

# Akka 2.10.17 - akka.stream.scaladsl.RunnableGraph

> **Summary:** Akka 2.10.17 - akka.stream.scaladsl.RunnableGraph
...
In order to execute this pipeline the flow must be materialized by calling [RunnableGraph\#run](#run()(implicitmaterializer:akka.stream.Materializer):Mat) on it.
...
[c](RunnableGraph$.html "See companion object")[akka](../../index.html).[stream](../index.html).[scaladsl](index.html)

# [RunnableGraph](RunnableGraph$.html "See companion object")[**](../../../akka/stream/scaladsl/RunnableGraph.html "Permalink")

### Companion [object RunnableGraph](RunnableGraph$.html "See companion object")

#### final  case class RunnableGraph\[\+Mat](traversalBuilder: TraversalBuilder) extends [Graph](../Graph.html)\[[ClosedShape](../ClosedShape.html), Mat] with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable

Flow with attached input and output, can be executed.

Source[Flow.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/scaladsl/Flow.scala#L763)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.17/scala/Equals.html#scala.Equals), [Graph](../Graph.html)\[[ClosedShape](../ClosedShape.html), Mat], [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. RunnableGraph
2. Serializable
...
1. [**](../../../akka/stream/scaladsl/RunnableGraph.html#<init>(traversalBuilder:akka.stream.impl.TraversalBuilder):akka.stream.scaladsl.RunnableGraph[Mat] "Permalink")  new RunnableGraph(traversalBuilder: TraversalBuilder)
### Type Members

1. [**](../../../akka/stream/scaladsl/RunnableGraph.html#Shape=S@scala.annotation.unchecked.uncheckedVariance "Permalink")  type Shape \= [ClosedShape](../ClosedShape.html)Type\-level accessor for the shape parameter of this graph.
...
1. [**](../../../akka/stream/scaladsl/RunnableGraph.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../akka/stream/scaladsl/RunnableGraph.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../akka/stream/scaladsl/RunnableGraph.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from RunnableGraph\[Mat] toany2stringadd\[RunnableGraph\[Mat]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../akka/stream/scaladsl/RunnableGraph.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (RunnableGraph\[Mat], B)ImplicitThis member is added by an implicit conversion from RunnableGraph\[Mat] toArrowAssoc\[RunnableGraph\[Mat]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../akka/stream/scaladsl/RunnableGraph.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../akka/stream/scaladsl/RunnableGraph.html#addAttributes(attr:akka.stream.Attributes):akka.stream.scaladsl.RunnableGraph[Mat] "Permalink")  def addAttributes(attr: [Attributes](../Attributes.html)): RunnableGraph\[Mat]Add the given attributes to this [Graph](../Graph.html).
...
7. [**](../../../akka/stream/scaladsl/RunnableGraph.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
8. [**](../../../akka/stream/scaladsl/RunnableGraph.html#asJava:akka.stream.javadsl.RunnableGraph[Mat] "Permalink")  def asJava: [javadsl.RunnableGraph](../javadsl/RunnableGraph.html)\[Mat]Converts this Scala DSL element to it's Java DSL counterpart.
9. [**](../../../akka/stream/scaladsl/RunnableGraph.html#async(dispatcher:String,inputBufferSize:Int):akka.stream.scaladsl.RunnableGraph[Mat] "Permalink")  def async(dispatcher: String, inputBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): RunnableGraph\[Mat]Note that an async boundary around a runnable graph does not make sense
...
Definition ClassesRunnableGraph → [Graph](../Graph.html)
10. [**](../../../akka/stream/scaladsl/RunnableGraph.html#async(dispatcher:String):akka.stream.scaladsl.RunnableGraph[Mat] "Permalink")  def async(dispatcher: String): RunnableGraph\[Mat]Note that an async boundary around a runnable graph does not make sense
...
Definition ClassesRunnableGraph → [Graph](../Graph.html)
11. [**](../../../akka/stream/scaladsl/RunnableGraph.html#async:akka.stream.scaladsl.RunnableGraph[Mat] "Permalink")  def async: RunnableGraph\[Mat]Note that an async boundary around a runnable graph does not make sense

Note that an async boundary around a runnable graph does not make sense

Definition ClassesRunnableGraph → [Graph](../Graph.html)
12. [**](../../../akka/stream/scaladsl/RunnableGraph.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
13. [**](../../../akka/stream/scaladsl/RunnableGraph.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (RunnableGraph\[Mat]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): RunnableGraph\[Mat]ImplicitThis member is added by an implicit conversion from RunnableGraph\[Mat] toEnsuring\[RunnableGraph\[Mat]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../../akka/stream/scaladsl/RunnableGraph.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (RunnableGraph\[Mat]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): RunnableGraph\[Mat]ImplicitThis member is added by an implicit conversion from RunnableGraph\[Mat] toEnsuring\[RunnableGraph\[Mat]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../../akka/stream/scaladsl/RunnableGraph.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): RunnableGraph\[Mat]ImplicitThis member is added by an implicit conversion from RunnableGraph\[Mat] toEnsuring\[RunnableGraph\[Mat]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../../akka/stream/scaladsl/RunnableGraph.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): RunnableGraph\[Mat]ImplicitThis member is added by an implicit conversion from RunnableGraph\[Mat] toEnsuring\[RunnableGraph\[Mat]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../../akka/stream/scaladsl/RunnableGraph.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../../akka/stream/scaladsl/RunnableGraph.html#getAttributes:akka.stream.Attributes "Permalink")  def getAttributes: [Attributes](../Attributes.html)Definition ClassesRunnableGraph → [Graph](../Graph.html)
19. [**](../../../akka/stream/scaladsl/RunnableGraph.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../../akka/stream/scaladsl/RunnableGraph.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
21. [**](../../../akka/stream/scaladsl/RunnableGraph.html#mapMaterializedValue[Mat2](f:Mat=>Mat2):akka.stream.scaladsl.RunnableGraph[Mat2] "Permalink")  def mapMaterializedValue\[Mat2](f: (Mat) \=\> Mat2): RunnableGraph\[Mat2]Transform only the materialized value of this RunnableGraph, leaving all other properties as they were.
22. [**](../../../akka/stream/scaladsl/RunnableGraph.html#named(name:String):akka.stream.scaladsl.RunnableGraph[Mat] "Permalink")  def named(name: String): RunnableGraph\[Mat]Specifies the name of the Graph.

Specifies the name of the Graph.
If the name is null or empty the name is ignored, i.e. \#none is returned.

Definition ClassesRunnableGraph → [Graph](../Graph.html)
23. [**](../../../akka/stream/scaladsl/RunnableGraph.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
24. [**](../../../akka/stream/scaladsl/RunnableGraph.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
25. [**](../../../akka/stream/scaladsl/RunnableGraph.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
26. [**](../../../akka/stream/scaladsl/RunnableGraph.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
27. [**](../../../akka/stream/scaladsl/RunnableGraph.html#run()(implicitmaterializer:akka.stream.Materializer):Mat "Permalink")  def run()(implicit materializer: [Materializer](../Materializer.html)): MatRun this flow and return the materialized instance from the flow.
...
28. [**](../../../akka/stream/scaladsl/RunnableGraph.html#shape:akka.stream.ClosedShape.type "Permalink")  def shape: [ClosedShape](../ClosedShape$.html)The shape of a graph is all that is externally visible: its inlets and outlets.

The shape of a graph is all that is externally visible: its inlets and outlets.

Definition ClassesRunnableGraph → [Graph](../Graph.html)
29. [**](../../../akka/stream/scaladsl/RunnableGraph.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
30. [**](../../../akka/stream/scaladsl/RunnableGraph.html#traversalBuilder:akka.stream.impl.TraversalBuilder "Permalink")  val traversalBuilder: TraversalBuilderINTERNAL API.
...
Definition ClassesRunnableGraph → [Graph](../Graph.html)
31. [**](../../../akka/stream/scaladsl/RunnableGraph.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
32. [**](../../../akka/stream/scaladsl/RunnableGraph.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
33. [**](../../../akka/stream/scaladsl/RunnableGraph.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
34. [**](../../../akka/stream/scaladsl/RunnableGraph.html#withAttributes(attr:akka.stream.Attributes):akka.stream.scaladsl.RunnableGraph[Mat] "Permalink")  def withAttributes(attr: [Attributes](../Attributes.html)): RunnableGraph\[Mat]Replace the attributes of this [Flow](Flow.html) with the given ones.
...
1. [**](../../../akka/stream/scaladsl/RunnableGraph.html#mapMaterializedValue[M2](f:M=>M2):akka.stream.Graph[S,M2] "Permalink")  def mapMaterializedValue\[M2](f: (Mat) \=\> M2): [Graph](../Graph.html)\[[ClosedShape](../ClosedShape.html), M2]Transform the materialized value of this Graph, leaving all other properties as they were.
...
- https://doc.akka.io/api/akka-core/current/akka/stream/javadsl/RunnableGraph.html
...
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/Concat.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/DelayStrategy$.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/DelayStrategy.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/FileIO$.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/Flow$.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/Flow.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/FlowOps.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/FlowOpsMat.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/FlowWithContext$.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/FlowWithContext.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/FlowWithContextOps.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/Framing$.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/GraphApply.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/GraphDSL$.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/Interleave$.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/Interleave.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/JavaFlowSupport$.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/JsonFraming$.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/Keep$.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/Merge$.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/Merge.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/MergeHub$.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/MergeLatest$.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/MergeLatest.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/MergePreferred$.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/MergePreferred.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/MergePrioritized$.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/MergePrioritized.html
- https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/MergeSequence$.html

---
*Source: [https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/RunnableGraph.html](https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/RunnableGraph.html)*