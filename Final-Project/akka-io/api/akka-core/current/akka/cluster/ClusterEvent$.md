...
scraped_at: '2026-04-06T13:53:28Z'
section: api
site: akka-io
...
- https://doc.akka.io/api/akka-core/current/akka/actor/DeadLetterSuppression.html
...
- https://doc.akka.io/api/akka-core/current/akka/cluster/Cluster.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$ClusterDomainEvent.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$ClusterShuttingDown$.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$CurrentClusterState$.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$CurrentClusterState.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$DataCenterReachabilityEvent.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$InitialStateAsEvents$.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$InitialStateAsSnapshot$.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$LeaderChanged.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$MemberDowned.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$MemberEvent.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$MemberExited.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$MemberJoined.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$MemberLeft.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$MemberPreparingForShutdown.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$MemberReadyForShutdown.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$MemberRemoved.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$MemberUp.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$MemberWeaklyUp.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$ReachabilityEvent.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$ReachableDataCenter.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$ReachableMember.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$RoleLeaderChanged.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$SubscriptionInitialStateMode.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$UnreachableDataCenter.html
- https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$$UnreachableMember.html
...
---
*Source: [https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$.html](https://doc.akka.io/api/akka-core/current/akka/cluster/ClusterEvent$.html)*