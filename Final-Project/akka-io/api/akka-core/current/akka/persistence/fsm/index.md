---
description: Akka 2.10.17 - akka.persistence.fsm
knowledge_type: official_documentation
scraped_at: '2026-04-06T13:57:35Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/persistence/fsm/index.html
title: Akka 2.10.17 - akka.persistence.fsm
---

# Akka 2.10.17 - akka.persistence.fsm

> **Summary:** Akka 2.10.17 - akka.persistence.fsm
...
- [**](../../../akka/persistence/fsm/index.html "Permalink")  package fsmDefinition Classes[persistence](../index.html)
- [PersistentFSM](PersistentFSM$.html "Note: Deprecated and removed except for the event and snapshot types which are needed for migrating existing PersistentFSM actors to EventSourcedBehavior using the akka.persistence.typed.scaladsl.PersistentFSMMigration and akka.persistence.typed.javadsl.PersistentFSMMigration")
...
# fsm[**](../../../akka/persistence/fsm/index.html "Permalink")
...
- https://doc.akka.io/api/akka-core/current/akka/persistence/fsm/PersistentFSM$.html
...
---
*Source: [https://doc.akka.io/api/akka-core/current/akka/persistence/fsm/index.html](https://doc.akka.io/api/akka-core/current/akka/persistence/fsm/index.html)*