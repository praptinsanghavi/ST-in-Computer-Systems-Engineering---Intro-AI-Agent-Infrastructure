...
scraped_at: '2026-04-06T13:54:10Z'
section: api
site: akka-io
...
---
*Source: [https://doc.akka.io/api/akka-core/current/akka/annotation/InternalApi.html](https://doc.akka.io/api/akka-core/current/akka/annotation/InternalApi.html)*