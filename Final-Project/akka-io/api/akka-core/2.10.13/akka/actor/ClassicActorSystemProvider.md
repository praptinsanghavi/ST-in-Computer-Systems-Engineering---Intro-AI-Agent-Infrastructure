---
description: Akka 2.10.13 - akka.actor.ClassicActorSystemProvider
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:46:14Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/ClassicActorSystemProvider.html
title: Akka 2.10.13 - akka.actor.ClassicActorSystemProvider
---

# Akka 2.10.13 - akka.actor.ClassicActorSystemProvider

> **Summary:** Akka 2.10.13 - akka.actor.ClassicActorSystemProvider
...
# ClassicActorSystemProvider[**](../../akka/actor/ClassicActorSystemProvider.html "Permalink")

### 

#### trait ClassicActorSystemProvider extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

Glue API introduced to allow minimal user effort integration between classic and typed for example for streams.

Not for user extension.

Annotations@[DoNotInherit](../annotation/DoNotInherit.html)() Source[ClassicActorSystemProvider.scala](https://github.com/akka/akka-core/tree/v2.10.13/akka-actor/src/main/scala/akka/actor/ClassicActorSystemProvider.scala#L16)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[ActorSystem](ActorSystem.html), [ExtendedActorSystem](ExtendedActorSystem.html), [ActorSystem](typed/ActorSystem.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ClassicActorSystemProvider
2. AnyRef
3. Any
Implicitly  
1. by any2stringadd
...
1. [**](../../akka/actor/ClassicActorSystemProvider.html#classicSystem:akka.actor.ActorSystem "Permalink") abstract  def classicSystem: [ActorSystem](ActorSystem.html)Allows access to the classic `akka.actor.ActorSystem` even for `akka.actor.typed.ActorSystem[_]`s.
### Concrete Value Members

1. [**](../../akka/actor/ClassicActorSystemProvider.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/ClassicActorSystemProvider.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/ClassicActorSystemProvider.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ClassicActorSystemProvider toany2stringadd\[ClassicActorSystemProvider] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/ClassicActorSystemProvider.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ClassicActorSystemProvider, B)ImplicitThis member is added by an implicit conversion from ClassicActorSystemProvider toArrowAssoc\[ClassicActorSystemProvider] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/ClassicActorSystemProvider.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/ClassicActorSystemProvider.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/ClassicActorSystemProvider.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/actor/ClassicActorSystemProvider.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ClassicActorSystemProvider) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ClassicActorSystemProviderImplicitThis member is added by an implicit conversion from ClassicActorSystemProvider toEnsuring\[ClassicActorSystemProvider] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/actor/ClassicActorSystemProvider.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ClassicActorSystemProvider) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ClassicActorSystemProviderImplicitThis member is added by an implicit conversion from ClassicActorSystemProvider toEnsuring\[ClassicActorSystemProvider] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/ClassicActorSystemProvider.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ClassicActorSystemProviderImplicitThis member is added by an implicit conversion from ClassicActorSystemProvider toEnsuring\[ClassicActorSystemProvider] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/ClassicActorSystemProvider.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ClassicActorSystemProviderImplicitThis member is added by an implicit conversion from ClassicActorSystemProvider toEnsuring\[ClassicActorSystemProvider] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/ClassicActorSystemProvider.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/actor/ClassicActorSystemProvider.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/actor/ClassicActorSystemProvider.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/actor/ClassicActorSystemProvider.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/actor/ClassicActorSystemProvider.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/actor/ClassicActorSystemProvider.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/ClassicActorSystemProvider.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/actor/ClassicActorSystemProvider.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/actor/ClassicActorSystemProvider.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/actor/ClassicActorSystemProvider.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/actor/ClassicActorSystemProvider.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/actor/ClassicActorSystemProvider.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/actor/ClassicActorSystemProvider.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/ClassicActorSystemProvider.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/actor/ClassicActorSystemProvider.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ClassicActorSystemProvider toStringFormat\[ClassicActorSystemProvider] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/ClassicActorSystemProvider.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ClassicActorSystemProvider, B)ImplicitThis member is added by an implicit conversion from ClassicActorSystemProvider toArrowAssoc\[ClassicActorSystemProvider] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromClassicActorSystemProvider to any2stringadd\[ClassicActorSystemProvider]

### Inherited by implicit conversion StringFormat fromClassicActorSystemProvider to StringFormat\[ClassicActorSystemProvider]

### Inherited by implicit conversion Ensuring fromClassicActorSystemProvider to Ensuring\[ClassicActorSystemProvider]

### Inherited by implicit conversion ArrowAssoc fromClassicActorSystemProvider to ArrowAssoc\[ClassicActorSystemProvider]

### Ungrouped

## Related Pages (Internal Links)

- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AbstractActor$.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AbstractActor.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AbstractActorWithStash.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AbstractActorWithTimers.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AbstractActorWithUnboundedStash.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AbstractActorWithUnrestrictedStash.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AbstractExtensionId.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AbstractFSM$.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AbstractFSM.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AbstractFSMWithStash.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AbstractLoggingActor.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AbstractLoggingFSM.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AbstractScheduler.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AbstractSchedulerBase.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/Actor$.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/Actor.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorContext.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorIdentity.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorInitializationException$.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorInitializationException.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorInterruptedException.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorKilledException.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorLogMarker$.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorLogging.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorNotFound.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorPath$.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorPath.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorPathExtractor$.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorPaths$.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorRef$.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorRef.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorRefFactory.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorRefProvider.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorSelection$.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorSelection.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorSystem$.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ActorSystem.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/Address$.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/Address.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AddressFromURIString$.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AllDeadLetters.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/AllForOneStrategy.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/BootstrapSetup$.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/BootstrapSetup.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/Cancellable$.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/Cancellable.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ChildActorPath.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ChildRestartStats.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ClassicActorContextProvider.html
- https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ClassicActorSystemProvider.html

---
*Source: [https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ClassicActorSystemProvider.html](https://doc.akka.io/api/akka-core/2.10.13/akka/actor/ClassicActorSystemProvider.html)*