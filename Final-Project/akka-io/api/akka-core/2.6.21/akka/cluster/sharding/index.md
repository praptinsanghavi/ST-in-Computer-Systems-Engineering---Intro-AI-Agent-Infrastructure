---
description: Akka 2.6.21 - akka.cluster.sharding
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:23:45Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/cluster/sharding/index.html
title: Akka 2.6.21 - akka.cluster.sharding
---

# Akka 2.6.21 - akka.cluster.sharding

> **Summary:** Akka 2.6.21 - akka.cluster.sharding
...
2. [**](../../../akka/cluster/sharding/protobuf/index.html "Permalink")  package [protobuf](protobuf/index.html)
3. [**](../../../akka/cluster/sharding/typed/index.html "Permalink")  package [typed](typed/index.html)
### Type Members

1. [**](../../../akka/cluster/sharding/ClusterSharding.html "Permalink")  class [ClusterSharding](ClusterSharding.html) extends [Extension](../../actor/Extension.html)See also[ClusterSharding companion object](ClusterSharding$.html)
2. [**](../../../akka/cluster/sharding/ClusterShardingHealthCheck.html "Permalink") final  class [ClusterShardingHealthCheck](ClusterShardingHealthCheck.html "INTERNAL API (ctr)") extends () \=\> [Future](https://www.scala-lang.org/api/2.13.8/scala/concurrent/Future.html#scala.concurrent.Future)\[[Boolean](https://www.scala-lang.org/api/2.13.8/scala/Boolean.html#scala.Boolean)]INTERNAL API (ctr)

INTERNAL API (ctr)

Annotations@[ApiMayChange](../../annotation/ApiMayChange.html)()
3. [**](../../../akka/cluster/sharding/ClusterShardingHealthCheckSettings.html "Permalink") final  class [ClusterShardingHealthCheckSettings](ClusterShardingHealthCheckSettings.html) extends [AnyRef](https://www.scala-lang.org/api/2.13.8/scala/AnyRef.html#scala.AnyRef)Annotations@[ApiMayChange](../../annotation/ApiMayChange.html)()
...
6. [**](../../../akka/cluster/sharding/JoinConfigCompatCheckSharding.html "Permalink") final  class [JoinConfigCompatCheckSharding](JoinConfigCompatCheckSharding.html "INTERNAL API") extends [JoinConfigCompatChecker](../JoinConfigCompatChecker.html)INTERNAL API

INTERNAL API

Annotations@[InternalApi](../../annotation/InternalApi.html)()
7. [**](../../../akka/cluster/sharding/RemoveInternalClusterShardingData.html "Permalink")  class [RemoveInternalClusterShardingData](RemoveInternalClusterShardingData.html) extends [Actor](../../actor/Actor.html) with [ActorLogging](../../actor/ActorLogging.html)See also[RemoveInternalClusterShardingData companion object](RemoveInternalClusterShardingData$.html)
8. [**](../../../akka/cluster/sharding/ShardCoordinator.html "Permalink") abstract  class [ShardCoordinator](ShardCoordinator.html "Singleton coordinator that decides where to allocate shards.") extends [Actor](../../actor/Actor.html) with [Timers](../../actor/Timers.html)Singleton coordinator that decides where to allocate shards.
...
3. [**](../../../akka/cluster/sharding/RemoveInternalClusterShardingData$.html "Permalink")  object [RemoveInternalClusterShardingData](RemoveInternalClusterShardingData$.html "Utility program that removes the internal data stored with Akka Persistence by the Cluster ShardCoordinator.")Utility program that removes the internal data stored with Akka Persistence
...
4. [**](../../../akka/cluster/sharding/ShardCoordinator$.html "Permalink")  object [ShardCoordinator](ShardCoordinator$.html)See also[ClusterSharding extension](ClusterSharding$.html)
5. [**](../../../akka/cluster/sharding/ShardRegion$.html "Permalink")  object [ShardRegion](ShardRegion$.html)See also[ClusterSharding extension](ClusterSharding$.html)
6. [**](../../../akka/cluster/sharding/ShardingFlightRecorder$.html "Permalink")  object [ShardingFlightRecorder](ShardingFlightRecorder$.html "INTERNAL API") extends [ExtensionId](../../actor/ExtensionId.html)\[ShardingFlightRecorder] with [ExtensionIdProvider](../../actor/ExtensionIdProvider.html)INTERNAL API
...
- https://doc.akka.io/api/akka-core/2.6.21/akka/actor/Actor.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/actor/ActorLogging.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/actor/Extension.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/actor/ExtensionId.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/actor/ExtensionIdProvider.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/actor/NoSerializationVerificationNeeded.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/actor/Timers.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/annotation/ApiMayChange.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/annotation/InternalApi.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/JoinConfigCompatChecker.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/Member.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/client/index.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/ddata/index.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/index.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/metrics/index.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/protobuf/index.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/pubsub/index.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/routing/index.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sbr/index.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/ClusterSharding$.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/ClusterSharding.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/ClusterShardingHealthCheck.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/ClusterShardingHealthCheckSettings.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/ClusterShardingSerializable.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/ClusterShardingSettings$.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/ClusterShardingSettings.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/JoinConfigCompatCheckSharding.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/PersistentShardCoordinator.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/RemoveInternalClusterShardingData$.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/RemoveInternalClusterShardingData.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/ShardCoordinator$.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/ShardCoordinator.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/ShardRegion$$Passivate.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/ShardRegion$.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/ShardingFlightRecorder$.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/ShardingLogMarker$.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/external/index.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/index.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/protobuf/index.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/typed/index.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/singleton/index.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/typed/index.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/index.html
- https://doc.akka.io/api/akka-core/2.6.21/akka/persistence/PersistentActor.html
- https://doc.akka.io/api/akka-core/2.6.21/index.html

---
*Source: [https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/index.html](https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/index.html)*