---
description: Akka 2.10.11 - akka.actor.LightArrayRevolverScheduler
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:15:31Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/LightArrayRevolverScheduler.html
title: Akka 2.10.11 - akka.actor.LightArrayRevolverScheduler
---

# Akka 2.10.11 - akka.actor.LightArrayRevolverScheduler

> **Summary:** Akka 2.10.11 - akka.actor.LightArrayRevolverScheduler
...
Source[LightArrayRevolverScheduler.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-actor/src/main/scala/akka/actor/LightArrayRevolverScheduler.scala#L38)Linear Supertypes[Closeable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Closeable.html#java.io.Closeable), [AutoCloseable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/AutoCloseable.html#java.lang.AutoCloseable), [Scheduler](Scheduler.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/actor/LightArrayRevolverScheduler.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/LightArrayRevolverScheduler.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
5. [**](../../akka/actor/LightArrayRevolverScheduler.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/LightArrayRevolverScheduler.html#ShutdownTimeout:scala.concurrent.duration.FiniteDuration "Permalink")  val ShutdownTimeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)
7. [**](../../akka/actor/LightArrayRevolverScheduler.html#TickDuration:scala.concurrent.duration.FiniteDuration "Permalink")  val TickDuration: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)
8. [**](../../akka/actor/LightArrayRevolverScheduler.html#WheelSize:Int "Permalink")  val WheelSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
...
10. [**](../../akka/actor/LightArrayRevolverScheduler.html#clock():Long "Permalink")  def clock(): [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)Clock implementation is replaceable (for testing); the implementation must
...
Attributesprotected
11. [**](../../akka/actor/LightArrayRevolverScheduler.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
12. [**](../../akka/actor/LightArrayRevolverScheduler.html#close():Unit "Permalink")  def close(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesLightArrayRevolverScheduler → Closeable → AutoCloseable
13. [**](../../akka/actor/LightArrayRevolverScheduler.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (LightArrayRevolverScheduler) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): LightArrayRevolverSchedulerImplicitThis member is added by an implicit conversion from LightArrayRevolverScheduler toEnsuring\[LightArrayRevolverScheduler] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/actor/LightArrayRevolverScheduler.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (LightArrayRevolverScheduler) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): LightArrayRevolverSchedulerImplicitThis member is added by an implicit conversion from LightArrayRevolverScheduler toEnsuring\[LightArrayRevolverScheduler] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/actor/LightArrayRevolverScheduler.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): LightArrayRevolverSchedulerImplicitThis member is added by an implicit conversion from LightArrayRevolverScheduler toEnsuring\[LightArrayRevolverScheduler] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/actor/LightArrayRevolverScheduler.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): LightArrayRevolverSchedulerImplicitThis member is added by an implicit conversion from LightArrayRevolverScheduler toEnsuring\[LightArrayRevolverScheduler] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../akka/actor/LightArrayRevolverScheduler.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/LightArrayRevolverScheduler.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
19. [**](../../akka/actor/LightArrayRevolverScheduler.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/actor/LightArrayRevolverScheduler.html#getShutdownTimeout:scala.concurrent.duration.FiniteDuration "Permalink")  def getShutdownTimeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)Overridable for tests

Overridable for tests

Attributesprotected
21. [**](../../akka/actor/LightArrayRevolverScheduler.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/actor/LightArrayRevolverScheduler.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
23. [**](../../akka/actor/LightArrayRevolverScheduler.html#maxFrequency:Double "Permalink")  val maxFrequency: [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double)The maximum supported task frequency of this scheduler, i.e.
...
reach (calculated as: `delay / tickNanos > Int.MaxValue`).
Note: For scheduling within actors `AbstractActorWithTimers` should be preferred.
41. [**](../../akka/actor/LightArrayRevolverScheduler.html#startTick:Int "Permalink")  def startTick: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Replaceable for testing.
...
46. [**](../../akka/actor/LightArrayRevolverScheduler.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
47. [**](../../akka/actor/LightArrayRevolverScheduler.html#waitNanos(nanos:Long):Unit "Permalink")  def waitNanos(nanos: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Overridable for tests
...
1. [**](../../akka/actor/LightArrayRevolverScheduler.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/actor/LightArrayRevolverScheduler.html](https://doc.akka.io/api/akka-core/2.10.11/akka/actor/LightArrayRevolverScheduler.html)*