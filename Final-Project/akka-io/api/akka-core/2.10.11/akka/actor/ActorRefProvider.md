---
description: Akka 2.10.11 - akka.actor.ActorRefProvider
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:14:21Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/ActorRefProvider.html
title: Akka 2.10.11 - akka.actor.ActorRefProvider
---

# Akka 2.10.11 - akka.actor.ActorRefProvider

> **Summary:** Akka 2.10.11 - akka.actor.ActorRefProvider
...
# ActorRefProvider[**](../../akka/actor/ActorRefProvider.html "Permalink")

### 

#### trait ActorRefProvider extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

Interface for all ActorRef providers to implement.
Not intended for extension outside of Akka.

Annotations@[DoNotInherit](../annotation/DoNotInherit.html)() Source[ActorRefProvider.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-actor/src/main/scala/akka/actor/ActorRefProvider.scala#L31)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ActorRefProvider
2. AnyRef
...
1. [**](../../akka/actor/ActorRefProvider.html#deadLetters:akka.actor.ActorRef "Permalink") abstract  def deadLetters: [ActorRef](ActorRef.html)Dead letter destination for this provider.
2. [**](../../akka/actor/ActorRefProvider.html#deployer:akka.actor.Deployer "Permalink") abstract  def deployer: DeployerThe Deployer associated with this ActorRefProvider
3. [**](../../akka/actor/ActorRefProvider.html#getDefaultAddress:akka.actor.Address "Permalink") abstract  def getDefaultAddress: [Address](Address.html)Obtain the external address of the default transport.
4. [**](../../akka/actor/ActorRefProvider.html#getExternalAddressFor(addr:akka.actor.Address):Option[akka.actor.Address] "Permalink") abstract  def getExternalAddressFor(addr: [Address](Address.html)): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Address](Address.html)]Obtain the address which is to be used within sender references when
...
5. [**](../../akka/actor/ActorRefProvider.html#guardian:akka.actor.LocalActorRef "Permalink") abstract  def guardian: LocalActorRefReference to the supervisor used for all top\-level user actors.
6. [**](../../akka/actor/ActorRefProvider.html#resolveActorRef(path:akka.actor.ActorPath):akka.actor.ActorRef "Permalink") abstract  def resolveActorRef(path: [ActorPath](ActorPath.html)): [ActorRef](ActorRef.html)Create actor reference for a specified path.

Create actor reference for a specified path. If no such
actor exists, it will be (equivalent to) a dead letter reference.
7. [**](../../akka/actor/ActorRefProvider.html#resolveActorRef(path:String):akka.actor.ActorRef "Permalink") abstract  def resolveActorRef(path: String): [ActorRef](ActorRef.html)Create actor reference for a specified path.

Create actor reference for a specified path. If no such
actor exists, it will be (equivalent to) a dead letter reference.
8. [**](../../akka/actor/ActorRefProvider.html#rootGuardian:akka.actor.InternalActorRef "Permalink") abstract  def rootGuardian: InternalActorRefReference to the supervisor of guardian and systemGuardian; this is
...
9. [**](../../akka/actor/ActorRefProvider.html#rootGuardianAt(address:akka.actor.Address):akka.actor.ActorRef "Permalink") abstract  def rootGuardianAt(address: [Address](Address.html)): [ActorRef](ActorRef.html)Reference to the supervisor of guardian and systemGuardian at the specified address;
...
10. [**](../../akka/actor/ActorRefProvider.html#rootPath:akka.actor.ActorPath "Permalink") abstract  def rootPath: [ActorPath](ActorPath.html)The root path for all actors within this actor system, not including any remote address information.
11. [**](../../akka/actor/ActorRefProvider.html#settings:akka.actor.ActorSystem.Settings "Permalink") abstract  def settings: [Settings](ActorSystem$$Settings.html)The Settings associated with this ActorRefProvider
12. [**](../../akka/actor/ActorRefProvider.html#systemGuardian:akka.actor.LocalActorRef "Permalink") abstract  def systemGuardian: LocalActorRefReference to the supervisor used for all top\-level system actors.
13. [**](../../akka/actor/ActorRefProvider.html#systemUid:Long "Permalink") abstract  def systemUid: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)
14. [**](../../akka/actor/ActorRefProvider.html#tempContainer:akka.actor.InternalActorRef "Permalink") abstract  def tempContainer: InternalActorRefReturns the actor reference representing the “/temp” path.
15. [**](../../akka/actor/ActorRefProvider.html#tempPath(prefix:String):akka.actor.ActorPath "Permalink") abstract  def tempPath(prefix: String): [ActorPath](ActorPath.html)Generates and returns a unique actor path starting with `prefix` below “/temp”.
16. [**](../../akka/actor/ActorRefProvider.html#tempPath():akka.actor.ActorPath "Permalink") abstract  def tempPath(): [ActorPath](ActorPath.html)Generates and returns a unique actor path below “/temp”.
17. [**](../../akka/actor/ActorRefProvider.html#terminationFuture:scala.concurrent.Future[akka.actor.Terminated] "Permalink") abstract  def terminationFuture: [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[[Terminated](Terminated.html)]This Future is completed upon termination of this ActorRefProvider, which
is usually initiated by stopping the guardian via ActorSystem.stop().
18. [**](../../akka/actor/ActorRefProvider.html#unregisterTempActor(path:akka.actor.ActorPath):Unit "Permalink") abstract  def unregisterTempActor(path: [ActorPath](ActorPath.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Unregister a temporary actor from the “/temp” path (i.e.

Unregister a temporary actor from the “/temp” path (i.e. obtained from tempPath()); do NOT pass in any other path.
### Concrete Value Members

1. [**](../../akka/actor/ActorRefProvider.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/ActorRefProvider.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/ActorRefProvider.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ActorRefProvider toany2stringadd\[ActorRefProvider] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/ActorRefProvider.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ActorRefProvider, B)ImplicitThis member is added by an implicit conversion from ActorRefProvider toArrowAssoc\[ActorRefProvider] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/ActorRefProvider.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/ActorRefProvider.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/ActorRefProvider.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/actor/ActorRefProvider.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ActorRefProvider) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ActorRefProviderImplicitThis member is added by an implicit conversion from ActorRefProvider toEnsuring\[ActorRefProvider] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/actor/ActorRefProvider.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ActorRefProvider) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ActorRefProviderImplicitThis member is added by an implicit conversion from ActorRefProvider toEnsuring\[ActorRefProvider] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/ActorRefProvider.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ActorRefProviderImplicitThis member is added by an implicit conversion from ActorRefProvider toEnsuring\[ActorRefProvider] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/ActorRefProvider.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ActorRefProviderImplicitThis member is added by an implicit conversion from ActorRefProvider toEnsuring\[ActorRefProvider] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/ActorRefProvider.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/actor/ActorRefProvider.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/actor/ActorRefProvider.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/actor/ActorRefProvider.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/actor/ActorRefProvider.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/actor/ActorRefProvider.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/ActorRefProvider.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/actor/ActorRefProvider.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/actor/ActorRefProvider.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/actor/ActorRefProvider.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/actor/ActorRefProvider.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/actor/ActorRefProvider.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/actor/ActorRefProvider.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/ActorRefProvider.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/actor/ActorRefProvider.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ActorRefProvider toStringFormat\[ActorRefProvider] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/ActorRefProvider.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ActorRefProvider, B)ImplicitThis member is added by an implicit conversion from ActorRefProvider toArrowAssoc\[ActorRefProvider] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromActorRefProvider to any2stringadd\[ActorRefProvider]

### Inherited by implicit conversion StringFormat fromActorRefProvider to StringFormat\[ActorRefProvider]

### Inherited by implicit conversion Ensuring fromActorRefProvider to Ensuring\[ActorRefProvider]

### Inherited by implicit conversion ArrowAssoc fromActorRefProvider to ArrowAssoc\[ActorRefProvider]
...
- https://doc.akka.io/api/akka-core/2.10.11/akka/actor/ActorSelection.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/actor/ActorSystem$$Settings.html
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/actor/ActorRefProvider.html](https://doc.akka.io/api/akka-core/2.10.11/akka/actor/ActorRefProvider.html)*