---
description: Akka 2.10.11 - akka.actor.Props
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:15:58Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/Props.html
title: Akka 2.10.11 - akka.actor.Props
---

# Akka 2.10.11 - akka.actor.Props

> **Summary:** Akka 2.10.11 - akka.actor.Props
...
[c](Props$.html "See companion object")[akka](../index.html).[actor](index.html)

# [Props](Props$.html "See companion object")[**](../../akka/actor/Props.html "Permalink")

### Companion [object Props](Props$.html "See companion object")

#### final  case class Props(deploy: [Deploy](Deploy.html), clazz: Class\[\_], args: [Seq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]) extends [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
...
```
Annotations@SerialVersionUID() Source[Props.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-actor/src/main/scala/akka/actor/Props.scala#L115)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.17/scala/Equals.html#scala.Equals), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Props
2. Serializable
...
1. [**](../../akka/actor/Props.html#<init>(deploy:akka.actor.Deploy,clazz:Class[_],args:Seq[Any]):akka.actor.Props "Permalink")  new Props(deploy: [Deploy](Deploy.html), clazz: Class\[\_], args: [Seq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)])
### Value Members

1. [**](../../akka/actor/Props.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/Props.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/Props.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from Props toany2stringadd\[Props] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/Props.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (Props, B)ImplicitThis member is added by an implicit conversion from Props toArrowAssoc\[Props] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/Props.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/Props.html#actorClass():Class[_<:akka.actor.Actor] "Permalink")  def actorClass(): Class\[\_ \<: [Actor](Actor.html)]Obtain an upper\-bound approximation of the actor class which is going to
...
7. [**](../../akka/actor/Props.html#args:Seq[Any] "Permalink")  val args: [Seq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]
8. [**](../../akka/actor/Props.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
9. [**](../../akka/actor/Props.html#clazz:Class[_] "Permalink")  val clazz: Class\[\_]
10. [**](../../akka/actor/Props.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
11. [**](../../akka/actor/Props.html#deploy:akka.actor.Deploy "Permalink")  val deploy: [Deploy](Deploy.html)
12. [**](../../akka/actor/Props.html#dispatcher:String "Permalink")  def dispatcher: StringConvenience method for extracting the dispatcher information from the
contained [Deploy](Deploy.html) instance.
13. [**](../../akka/actor/Props.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (Props) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): PropsImplicitThis member is added by an implicit conversion from Props toEnsuring\[Props] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/actor/Props.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (Props) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): PropsImplicitThis member is added by an implicit conversion from Props toEnsuring\[Props] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/actor/Props.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): PropsImplicitThis member is added by an implicit conversion from Props toEnsuring\[Props] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/actor/Props.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): PropsImplicitThis member is added by an implicit conversion from Props toEnsuring\[Props] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../akka/actor/Props.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/Props.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/actor/Props.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
20. [**](../../akka/actor/Props.html#mailbox:String "Permalink")  def mailbox: StringConvenience method for extracting the mailbox information from the
contained [Deploy](Deploy.html) instance.
21. [**](../../akka/actor/Props.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
22. [**](../../akka/actor/Props.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../akka/actor/Props.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../akka/actor/Props.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
25. [**](../../akka/actor/Props.html#routerConfig:akka.routing.RouterConfig "Permalink")  def routerConfig: [RouterConfig](../routing/RouterConfig.html)Convenience method for extracting the router configuration from the
contained [Deploy](Deploy.html) instance.
26. [**](../../akka/actor/Props.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
27. [**](../../akka/actor/Props.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../akka/actor/Props.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
29. [**](../../akka/actor/Props.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
30. [**](../../akka/actor/Props.html#withActorTags(tags:Set[String]):akka.actor.Props "Permalink")  def withActorTags(tags: Set\[String]): PropsScala API: Returns a new Props with the specified set of tags.
31. [**](../../akka/actor/Props.html#withActorTags(tags:String*):akka.actor.Props "Permalink")  def withActorTags(tags: String\*): PropsReturns a new Props with the specified set of tags.

Returns a new Props with the specified set of tags.

Annotations@varargs()
32. [**](../../akka/actor/Props.html#withDeploy(d:akka.actor.Deploy):akka.actor.Props "Permalink")  def withDeploy(d: [Deploy](Deploy.html)): PropsReturns a new Props with the specified deployment configuration.
33. [**](../../akka/actor/Props.html#withDispatcher(d:String):akka.actor.Props "Permalink")  def withDispatcher(d: String): PropsReturns a new Props with the specified dispatcher set.
34. [**](../../akka/actor/Props.html#withMailbox(m:String):akka.actor.Props "Permalink")  def withMailbox(m: String): PropsReturns a new Props with the specified mailbox set.
35. [**](../../akka/actor/Props.html#withRouter(r:akka.routing.RouterConfig):akka.actor.Props "Permalink")  def withRouter(r: [RouterConfig](../routing/RouterConfig.html)): PropsReturns a new Props with the specified router config set.
### Deprecated Value Members

1. [**](../../akka/actor/Props.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/actor/Props.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from Props toStringFormat\[Props] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/Props.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (Props, B)ImplicitThis member is added by an implicit conversion from Props toArrowAssoc\[Props] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/actor/Props.html](https://doc.akka.io/api/akka-core/2.10.11/akka/actor/Props.html)*