---
description: Akka 2.10.11 - akka.actor.BootstrapSetup
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:14:40Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/BootstrapSetup.html
title: Akka 2.10.11 - akka.actor.BootstrapSetup
---

# Akka 2.10.11 - akka.actor.BootstrapSetup

> **Summary:** Akka 2.10.11 - akka.actor.BootstrapSetup
...
[c](BootstrapSetup$.html "See companion object")[akka](../index.html).[actor](index.html)

# [BootstrapSetup](BootstrapSetup$.html "See companion object")[**](../../akka/actor/BootstrapSetup.html "Permalink")

### Companion [object BootstrapSetup](BootstrapSetup$.html "See companion object")

#### final  class BootstrapSetup extends [Setup](setup/Setup.html)
...
Source[ActorSystem.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-actor/src/main/scala/akka/actor/ActorSystem.scala#L157)Linear Supertypes[Setup](setup/Setup.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. BootstrapSetup
2. Setup
...
1. [**](../../akka/actor/BootstrapSetup.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/BootstrapSetup.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/BootstrapSetup.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from BootstrapSetup toany2stringadd\[BootstrapSetup] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/BootstrapSetup.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (BootstrapSetup, B)ImplicitThis member is added by an implicit conversion from BootstrapSetup toArrowAssoc\[BootstrapSetup] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/BootstrapSetup.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/BootstrapSetup.html#actorRefProvider:Option[akka.actor.ProviderSelection] "Permalink")  val actorRefProvider: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ProviderSelection](ProviderSelection.html)]
7. [**](../../akka/actor/BootstrapSetup.html#and(other:akka.actor.setup.Setup):akka.actor.setup.ActorSystemSetup "Permalink") final  def and(other: [Setup](setup/Setup.html)): [ActorSystemSetup](setup/ActorSystemSetup.html)Construct an ActorSystemSetup with this setup combined with another one.
...
8. [**](../../akka/actor/BootstrapSetup.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
9. [**](../../akka/actor/BootstrapSetup.html#classLoader:Option[ClassLoader] "Permalink")  val classLoader: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)]
10. [**](../../akka/actor/BootstrapSetup.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
11. [**](../../akka/actor/BootstrapSetup.html#config:Option[com.typesafe.config.Config] "Permalink")  val config: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[Config]
12. [**](../../akka/actor/BootstrapSetup.html#defaultExecutionContext:Option[scala.concurrent.ExecutionContext] "Permalink")  val defaultExecutionContext: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ExecutionContext](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContext.html#scala.concurrent.ExecutionContext)]
13. [**](../../akka/actor/BootstrapSetup.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (BootstrapSetup) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BootstrapSetupImplicitThis member is added by an implicit conversion from BootstrapSetup toEnsuring\[BootstrapSetup] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/actor/BootstrapSetup.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (BootstrapSetup) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BootstrapSetupImplicitThis member is added by an implicit conversion from BootstrapSetup toEnsuring\[BootstrapSetup] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/actor/BootstrapSetup.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BootstrapSetupImplicitThis member is added by an implicit conversion from BootstrapSetup toEnsuring\[BootstrapSetup] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/actor/BootstrapSetup.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BootstrapSetupImplicitThis member is added by an implicit conversion from BootstrapSetup toEnsuring\[BootstrapSetup] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../akka/actor/BootstrapSetup.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/BootstrapSetup.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
19. [**](../../akka/actor/BootstrapSetup.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/actor/BootstrapSetup.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../akka/actor/BootstrapSetup.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
22. [**](../../akka/actor/BootstrapSetup.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
23. [**](../../akka/actor/BootstrapSetup.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../akka/actor/BootstrapSetup.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
25. [**](../../akka/actor/BootstrapSetup.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
26. [**](../../akka/actor/BootstrapSetup.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
27. [**](../../akka/actor/BootstrapSetup.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../akka/actor/BootstrapSetup.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
29. [**](../../akka/actor/BootstrapSetup.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
30. [**](../../akka/actor/BootstrapSetup.html#withActorRefProvider(name:akka.actor.ProviderSelection):akka.actor.BootstrapSetup "Permalink")  def withActorRefProvider(name: [ProviderSelection](ProviderSelection.html)): BootstrapSetup
31. [**](../../akka/actor/BootstrapSetup.html#withClassloader(classLoader:ClassLoader):akka.actor.BootstrapSetup "Permalink")  def withClassloader(classLoader: [ClassLoader](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/ClassLoader.html#java.lang.ClassLoader)): BootstrapSetup
32. [**](../../akka/actor/BootstrapSetup.html#withConfig(config:com.typesafe.config.Config):akka.actor.BootstrapSetup "Permalink")  def withConfig(config: Config): BootstrapSetup
33. [**](../../akka/actor/BootstrapSetup.html#withDefaultExecutionContext(executionContext:scala.concurrent.ExecutionContext):akka.actor.BootstrapSetup "Permalink")  def withDefaultExecutionContext(executionContext: [ExecutionContext](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContext.html#scala.concurrent.ExecutionContext)): BootstrapSetup
### Deprecated Value Members

1. [**](../../akka/actor/BootstrapSetup.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/actor/BootstrapSetup.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from BootstrapSetup toStringFormat\[BootstrapSetup] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/BootstrapSetup.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (BootstrapSetup, B)ImplicitThis member is added by an implicit conversion from BootstrapSetup toArrowAssoc\[BootstrapSetup] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromBootstrapSetup to any2stringadd\[BootstrapSetup]

### Inherited by implicit conversion StringFormat fromBootstrapSetup to StringFormat\[BootstrapSetup]

### Inherited by implicit conversion Ensuring fromBootstrapSetup to Ensuring\[BootstrapSetup]

### Inherited by implicit conversion ArrowAssoc fromBootstrapSetup to ArrowAssoc\[BootstrapSetup]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/actor/BootstrapSetup.html](https://doc.akka.io/api/akka-core/2.10.11/akka/actor/BootstrapSetup.html)*