---
description: Akka 2.10.11 - akka.actor.NoScopeGiven
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:15:38Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/NoScopeGiven.html
title: Akka 2.10.11 - akka.actor.NoScopeGiven
---

# Akka 2.10.11 - akka.actor.NoScopeGiven

> **Summary:** Akka 2.10.11 - akka.actor.NoScopeGiven
...
[c](NoScopeGiven$.html "See companion object")[akka](../index.html).[actor](index.html)

# [NoScopeGiven](NoScopeGiven$.html "See companion object")[**](../../akka/actor/NoScopeGiven.html "Permalink")

### Companion [object NoScopeGiven](NoScopeGiven$.html "See companion object")

#### abstract  class NoScopeGiven extends [Scope](Scope.html)

This is the default value and as such allows overrides.

Annotations@nowarn() @SerialVersionUID() Source[Deployer.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-actor/src/main/scala/akka/actor/Deployer.scala#L200)Linear Supertypes[Scope](Scope.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[NoScopeGiven](NoScopeGiven$.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. NoScopeGiven
2. Scope
...
1. [**](../../akka/actor/NoScopeGiven.html#<init>():akka.actor.NoScopeGiven "Permalink")  new NoScopeGiven()
### Abstract Value Members

1. [**](../../akka/actor/NoScopeGiven.html#withFallback(other:akka.actor.Scope):akka.actor.Scope "Permalink") abstract  def withFallback(other: [Scope](Scope.html)): [Scope](Scope.html)When merging [akka.actor.Deploy](Deploy.html) instances using `withFallback()` on
the left one, this is propagated to “merging” scopes in the same way.

When merging [akka.actor.Deploy](Deploy.html) instances using `withFallback()` on
the left one, this is propagated to “merging” scopes in the same way.
...
Definition Classes[Scope](Scope.html)
### Concrete Value Members

1. [**](../../akka/actor/NoScopeGiven.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/NoScopeGiven.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/NoScopeGiven.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from NoScopeGiven toany2stringadd\[NoScopeGiven] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/NoScopeGiven.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (NoScopeGiven, B)ImplicitThis member is added by an implicit conversion from NoScopeGiven toArrowAssoc\[NoScopeGiven] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/NoScopeGiven.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/NoScopeGiven.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/NoScopeGiven.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/actor/NoScopeGiven.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (NoScopeGiven) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): NoScopeGivenImplicitThis member is added by an implicit conversion from NoScopeGiven toEnsuring\[NoScopeGiven] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/actor/NoScopeGiven.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (NoScopeGiven) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): NoScopeGivenImplicitThis member is added by an implicit conversion from NoScopeGiven toEnsuring\[NoScopeGiven] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/NoScopeGiven.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): NoScopeGivenImplicitThis member is added by an implicit conversion from NoScopeGiven toEnsuring\[NoScopeGiven] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/NoScopeGiven.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): NoScopeGivenImplicitThis member is added by an implicit conversion from NoScopeGiven toEnsuring\[NoScopeGiven] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/NoScopeGiven.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/actor/NoScopeGiven.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/actor/NoScopeGiven.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/actor/NoScopeGiven.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/actor/NoScopeGiven.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/actor/NoScopeGiven.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/NoScopeGiven.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/actor/NoScopeGiven.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/actor/NoScopeGiven.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/actor/NoScopeGiven.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/actor/NoScopeGiven.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/actor/NoScopeGiven.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/actor/NoScopeGiven.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/NoScopeGiven.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/actor/NoScopeGiven.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from NoScopeGiven toStringFormat\[NoScopeGiven] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/NoScopeGiven.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (NoScopeGiven, B)ImplicitThis member is added by an implicit conversion from NoScopeGiven toArrowAssoc\[NoScopeGiven] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [Scope](Scope.html)

### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromNoScopeGiven to any2stringadd\[NoScopeGiven]

### Inherited by implicit conversion StringFormat fromNoScopeGiven to StringFormat\[NoScopeGiven]

### Inherited by implicit conversion Ensuring fromNoScopeGiven to Ensuring\[NoScopeGiven]

### Inherited by implicit conversion ArrowAssoc fromNoScopeGiven to ArrowAssoc\[NoScopeGiven]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/actor/NoScopeGiven.html](https://doc.akka.io/api/akka-core/2.10.11/akka/actor/NoScopeGiven.html)*