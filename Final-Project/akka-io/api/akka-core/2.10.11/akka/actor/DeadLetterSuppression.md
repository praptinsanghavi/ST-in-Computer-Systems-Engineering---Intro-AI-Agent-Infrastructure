---
description: Akka 2.10.11 - akka.actor.DeadLetterSuppression
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:14:56Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/DeadLetterSuppression.html
title: Akka 2.10.11 - akka.actor.DeadLetterSuppression
---

# Akka 2.10.11 - akka.actor.DeadLetterSuppression

> **Summary:** Akka 2.10.11 - akka.actor.DeadLetterSuppression
...
#### trait DeadLetterSuppression extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
...
Source[ActorRef.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-actor/src/main/scala/akka/actor/ActorRef.scala#L609)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[PoisonPill](PoisonPill.html), [PoisonPill](PoisonPill$.html), [Terminated](Terminated.html), [SequencedMessage](typed/delivery/ConsumerController$$SequencedMessage.html), [Ack](typed/delivery/internal/ProducerControllerImpl$$Ack.html), [Request](typed/delivery/internal/ProducerControllerImpl$$Request.html), [Resend](typed/delivery/internal/ProducerControllerImpl$$Resend.html), [ClusterDomainEvent](../cluster/ClusterEvent$$ClusterDomainEvent.html), [ClusterShuttingDown](../cluster/ClusterEvent$$ClusterShuttingDown$.html), [LeaderChanged](../cluster/ClusterEvent$$LeaderChanged.html), [MemberDowned](../cluster/ClusterEvent$$MemberDowned.html), [MemberEvent](../cluster/ClusterEvent$$MemberEvent.html), [MemberExited](../cluster/ClusterEvent$$MemberExited.html), [MemberJoined](../cluster/ClusterEvent$$MemberJoined.html), [MemberLeft](../cluster/ClusterEvent$$MemberLeft.html), [MemberPreparingForShutdown](../cluster/ClusterEvent$$MemberPreparingForShutdown.html), [MemberReadyForShutdown](../cluster/ClusterEvent$$MemberReadyForShutdown.html), [MemberRemoved](../cluster/ClusterEvent$$MemberRemoved.html), [MemberUp](../cluster/ClusterEvent$$MemberUp.html), [MemberWeaklyUp](../cluster/ClusterEvent$$MemberWeaklyUp.html), [ReachabilityEvent](../cluster/ClusterEvent$$ReachabilityEvent.html), [ReachableMember](../cluster/ClusterEvent$$ReachableMember.html), [RoleLeaderChanged](../cluster/ClusterEvent$$RoleLeaderChanged.html), [UnreachableMember](../cluster/ClusterEvent$$UnreachableMember.html), [UpdateSuccess](../cluster/ddata/Replicator$$UpdateSuccess.html), [UpdateSuccess](../cluster/ddata/typed/javadsl/Replicator$$UpdateSuccess.html), [SubscribeAck](../cluster/pubsub/DistributedPubSubMediator$$SubscribeAck.html), [StartEntityAck](../cluster/sharding/ShardRegion$$StartEntityAck.html), [SelfRemoved](../cluster/typed/SelfRemoved.html), [SelfUp](../cluster/typed/SelfUp.html), [Resolved](../discovery/ServiceDiscovery$$Resolved.html), [Abort](../io/Tcp$$Abort$.html), [Aborted](../io/Tcp$$Aborted$.html), [Close](../io/Tcp$$Close$.html), [CloseCommand](../io/Tcp$$CloseCommand.html), [Closed](../io/Tcp$$Closed$.html), [ConfirmedClose](../io/Tcp$$ConfirmedClose$.html), [ConfirmedClosed](../io/Tcp$$ConfirmedClosed$.html), [ConnectionClosed](../io/Tcp$$ConnectionClosed.html), [ErrorClosed](../io/Tcp$$ErrorClosed.html), [PeerClosed](../io/Tcp$$PeerClosed$.html), [ResumeReading](../io/Tcp$$ResumeReading$.html), [CancelSubscription](../stream/testkit/TestPublisher$$CancelSubscription.html), [PublisherEvent](../stream/testkit/TestPublisher$$PublisherEvent.html), [RequestMore](../stream/testkit/TestPublisher$$RequestMore.html), [Subscribe](../stream/testkit/TestPublisher$$Subscribe.html), [OnComplete](../stream/testkit/TestSubscriber$$OnComplete$.html), [OnError](../stream/testkit/TestSubscriber$$OnError.html), [OnNext](../stream/testkit/TestSubscriber$$OnNext.html), [OnSubscribe](../stream/testkit/TestSubscriber$$OnSubscribe.html), [SubscriberEvent](../stream/testkit/TestSubscriber$$SubscriberEvent.html), [DataCenterReachabilityEvent](../cluster/ClusterEvent$$DataCenterReachabilityEvent.html), [ReachableDataCenter](../cluster/ClusterEvent$$ReachableDataCenter.html), [UnreachableDataCenter](../cluster/ClusterEvent$$UnreachableDataCenter.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/actor/DeadLetterSuppression.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/DeadLetterSuppression.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
5. [**](../../akka/actor/DeadLetterSuppression.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/DeadLetterSuppression.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/DeadLetterSuppression.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/actor/DeadLetterSuppression.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (DeadLetterSuppression) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): DeadLetterSuppressionImplicitThis member is added by an implicit conversion from DeadLetterSuppression toEnsuring\[DeadLetterSuppression] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/actor/DeadLetterSuppression.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (DeadLetterSuppression) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): DeadLetterSuppressionImplicitThis member is added by an implicit conversion from DeadLetterSuppression toEnsuring\[DeadLetterSuppression] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/DeadLetterSuppression.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): DeadLetterSuppressionImplicitThis member is added by an implicit conversion from DeadLetterSuppression toEnsuring\[DeadLetterSuppression] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/DeadLetterSuppression.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): DeadLetterSuppressionImplicitThis member is added by an implicit conversion from DeadLetterSuppression toEnsuring\[DeadLetterSuppression] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/DeadLetterSuppression.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/actor/DeadLetterSuppression.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/actor/DeadLetterSuppression.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/actor/DeadLetterSuppression.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/actor/DeadLetterSuppression.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/actor/DeadLetterSuppression.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/actor/DeadLetterSuppression.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/actor/DeadLetterSuppression.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
...
24. [**](../../akka/actor/DeadLetterSuppression.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/DeadLetterSuppression.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/actor/DeadLetterSuppression.html](https://doc.akka.io/api/akka-core/2.10.11/akka/actor/DeadLetterSuppression.html)*