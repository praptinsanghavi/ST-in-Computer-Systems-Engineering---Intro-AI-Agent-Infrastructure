---
description: Akka 2.10.11 - akka.actor.FSM
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:15:09Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/FSM$.html
title: Akka 2.10.11 - akka.actor.FSM
---

# Akka 2.10.11 - akka.actor.FSM

> **Summary:** Akka 2.10.11 - akka.actor.FSM
...
Source[FSM.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-actor/src/main/scala/akka/actor/FSM.scala#L19)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Content Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. FSM
2. AnyRef
...
1. [**](../../akka/actor/FSM$$CurrentState.html "Permalink") final  case class [CurrentState](FSM$$CurrentState.html "Message type which is sent directly to the subscribed actor in akka.actor.FSM.SubscribeTransitionCallBack before sending any akka.actor.FSM.Transition messages.")\[S](fsmRef: [ActorRef](ActorRef.html), state: S) extends [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableMessage type which is sent directly to the subscribed actor in
...
2. [**](../../akka/actor/FSM$$Event.html "Permalink") final  case class [Event](FSM$$Event.html "All messages sent to the akka.actor.FSM will be wrapped inside an Event, which allows pattern matching to extract both state and data.")\[D](event: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any), stateData: D) extends [NoSerializationVerificationNeeded](NoSerializationVerificationNeeded.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableAll messages sent to the [akka.actor.FSM](FSM.html) will be wrapped inside an
`Event`, which allows pattern matching to extract both state and data.
3. [**](../../akka/actor/FSM$$Failure.html "Permalink") final  case class [Failure](FSM$$Failure.html "Signifies that the akka.actor.FSM is shutting itself down because of an error, e.g.")(cause: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)) extends [Reason](FSM$$Reason.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableSignifies that the [akka.actor.FSM](FSM.html) is shutting itself down because of
an error, e.g.
...
4. [**](../../akka/actor/FSM$$LogEntry.html "Permalink") final  case class [LogEntry](FSM$$LogEntry.html "Log Entry of the akka.actor.LoggingFSM, can be obtained by calling getLog.")\[S, D](stateName: S, stateData: D, event: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)) extends [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableLog Entry of the [akka.actor.LoggingFSM](LoggingFSM.html), can be obtained by calling `getLog`.
5. [**](../../akka/actor/FSM$$Reason.html "Permalink") sealed  trait [Reason](FSM$$Reason.html "Reason why this akka.actor.FSM is shutting down.") extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Reason why this [akka.actor.FSM](FSM.html) is shutting down.
6. [**](../../akka/actor/FSM$$State.html "Permalink")  class [State](FSM$$State.html)\[S, D] extends [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
7. [**](../../akka/actor/FSM$$StopEvent.html "Permalink") final  case class [StopEvent](FSM$$StopEvent.html "Case class representing the state of the akka.actor.FSM within the onTermination block.")\[S, D](reason: [Reason](FSM$$Reason.html), currentState: S, stateData: D) extends [NoSerializationVerificationNeeded](NoSerializationVerificationNeeded.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableCase class representing the state of the [akka.actor.FSM](FSM.html) within the
`onTermination` block.
8. [**](../../akka/actor/FSM$$SubscribeTransitionCallBack.html "Permalink") final  case class [SubscribeTransitionCallBack](FSM$$SubscribeTransitionCallBack.html "Send this to an akka.actor.FSM to request first the FSM.CurrentState and then a series of FSM.Transition updates.")(actorRef: [ActorRef](ActorRef.html)) extends [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableSend this to an [akka.actor.FSM](FSM.html) to request first the [FSM.CurrentState](FSM$$CurrentState.html)
...
9. [**](../../akka/actor/FSM$$Transition.html "Permalink") final  case class [Transition](FSM$$Transition.html "Message type which is used to communicate transitions between states to all subscribed listeners (use akka.actor.FSM.SubscribeTransitionCallBack).")\[S](fsmRef: [ActorRef](ActorRef.html), from: S, to: S) extends [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableMessage type which is used to communicate transitions between states to
all subscribed listeners (use [akka.actor.FSM.SubscribeTransitionCallBack](FSM$$SubscribeTransitionCallBack.html)).
10. [**](../../akka/actor/FSM$$UnsubscribeTransitionCallBack.html "Permalink") final  case class [UnsubscribeTransitionCallBack](FSM$$UnsubscribeTransitionCallBack.html "Unsubscribe from akka.actor.FSM.Transition notifications which was effected by sending the corresponding akka.actor.FSM.SubscribeTransitionCallBack.")(actorRef: [ActorRef](ActorRef.html)) extends [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableUnsubscribe from [akka.actor.FSM.Transition](FSM$$Transition.html) notifications which was
...
3. [**](../../akka/actor/FSM$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/actor/FSM$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../akka/actor/FSM$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../akka/actor/FSM$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
7. [**](../../akka/actor/FSM$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
9. [**](../../akka/actor/FSM$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
10. [**](../../akka/actor/FSM$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
11. [**](../../akka/actor/FSM$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
12. [**](../../akka/actor/FSM$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../akka/actor/FSM$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
...
16. [**](../../akka/actor/FSM$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
17. [**](../../akka/actor/FSM$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
18. [**](../../akka/actor/FSM$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
21. [**](../../akka/actor/FSM$$Normal$.html "Permalink")  case object [Normal](FSM$$Normal$.html "Default reason if calling stop().") extends [Reason](FSM$$Reason.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableDefault reason if calling `stop()`.
22. [**](../../akka/actor/FSM$$NullFunction$.html "Permalink")  object [NullFunction](FSM$$NullFunction$.html "A partial function value which does not match anything and can be used to “reset” whenUnhandled and onTermination handlers.") extends [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any), [Nothing](https://www.scala-lang.org/api/2.13.17/scala/Nothing.html#scala.Nothing)]A partial function value which does not match anything and can be used to
...
25. [**](../../akka/actor/FSM$$StateTimeout$.html "Permalink")  case object [StateTimeout](FSM$$StateTimeout$.html "This case object is received in case of a state timeout.") extends [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableThis case object is received in case of a state timeout.
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/actor/FSM$.html](https://doc.akka.io/api/akka-core/2.10.11/akka/actor/FSM$.html)*