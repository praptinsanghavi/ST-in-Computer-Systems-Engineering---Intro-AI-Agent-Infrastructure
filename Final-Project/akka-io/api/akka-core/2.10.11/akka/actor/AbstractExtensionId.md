---
description: Akka 2.10.11 - akka.actor.AbstractExtensionId
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:13:29Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/AbstractExtensionId.html
title: Akka 2.10.11 - akka.actor.AbstractExtensionId
---

# Akka 2.10.11 - akka.actor.AbstractExtensionId

> **Summary:** Akka 2.10.11 - akka.actor.AbstractExtensionId
...
# AbstractExtensionId[**](../../akka/actor/AbstractExtensionId.html "Permalink")

### 

#### abstract  class AbstractExtensionId\[T \<: [Extension](Extension.html)] extends [ExtensionId](ExtensionId.html)\[T]

Java API for ExtensionId

Source[Extension.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-actor/src/main/scala/akka/actor/Extension.scala#L123)Linear Supertypes[ExtensionId](ExtensionId.html)\[T], [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. AbstractExtensionId
2. ExtensionId
3. AnyRef
4. Any
Implicitly  
...
1. [**](../../akka/actor/AbstractExtensionId.html#<init>():akka.actor.AbstractExtensionId[T] "Permalink")  new AbstractExtensionId()
### Abstract Value Members

1. [**](../../akka/actor/AbstractExtensionId.html#createExtension(system:akka.actor.ExtendedActorSystem):T "Permalink") abstract  def createExtension(system: [ExtendedActorSystem](ExtendedActorSystem.html)): TIs used by Akka to instantiate the Extension identified by this ExtensionId,
internal use only.
...
1. [**](../../akka/actor/AbstractExtensionId.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/AbstractExtensionId.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/AbstractExtensionId.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from AbstractExtensionId\[T] toany2stringadd\[AbstractExtensionId\[T]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/AbstractExtensionId.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (AbstractExtensionId\[T], B)ImplicitThis member is added by an implicit conversion from AbstractExtensionId\[T] toArrowAssoc\[AbstractExtensionId\[T]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/AbstractExtensionId.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/AbstractExtensionId.html#apply(system:akka.actor.ClassicActorSystemProvider):T "Permalink")  def apply(system: [ClassicActorSystemProvider](ClassicActorSystemProvider.html)): TReturns an instance of the extension identified by this ExtensionId instance.

Returns an instance of the extension identified by this ExtensionId instance.

Definition Classes[ExtensionId](ExtensionId.html)
7. [**](../../akka/actor/AbstractExtensionId.html#apply(system:akka.actor.ActorSystem):T "Permalink")  def apply(system: [ActorSystem](ActorSystem.html)): TReturns an instance of the extension identified by this ExtensionId instance.

Returns an instance of the extension identified by this ExtensionId instance.

Definition Classes[ExtensionId](ExtensionId.html)
8. [**](../../akka/actor/AbstractExtensionId.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
9. [**](../../akka/actor/AbstractExtensionId.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
10. [**](../../akka/actor/AbstractExtensionId.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (AbstractExtensionId\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): AbstractExtensionId\[T]ImplicitThis member is added by an implicit conversion from AbstractExtensionId\[T] toEnsuring\[AbstractExtensionId\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/AbstractExtensionId.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (AbstractExtensionId\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): AbstractExtensionId\[T]ImplicitThis member is added by an implicit conversion from AbstractExtensionId\[T] toEnsuring\[AbstractExtensionId\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/AbstractExtensionId.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): AbstractExtensionId\[T]ImplicitThis member is added by an implicit conversion from AbstractExtensionId\[T] toEnsuring\[AbstractExtensionId\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/actor/AbstractExtensionId.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): AbstractExtensionId\[T]ImplicitThis member is added by an implicit conversion from AbstractExtensionId\[T] toEnsuring\[AbstractExtensionId\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/actor/AbstractExtensionId.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../akka/actor/AbstractExtensionId.html#equals(other:Any):Boolean "Permalink") final  def equals(other: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition Classes[ExtensionId](ExtensionId.html) → AnyRef → Any
16. [**](../../akka/actor/AbstractExtensionId.html#get(system:akka.actor.ClassicActorSystemProvider):T "Permalink")  def get(system: [ClassicActorSystemProvider](ClassicActorSystemProvider.html)): TReturns an instance of the extension identified by this ExtensionId instance.
...
```
Definition Classes[ExtensionId](ExtensionId.html)
17. [**](../../akka/actor/AbstractExtensionId.html#get(system:akka.actor.ActorSystem):T "Permalink")  def get(system: [ActorSystem](ActorSystem.html)): TReturns an instance of the extension identified by this ExtensionId instance.
...
```
Definition Classes[ExtensionId](ExtensionId.html)
18. [**](../../akka/actor/AbstractExtensionId.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/actor/AbstractExtensionId.html#hashCode():Int "Permalink") final  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition Classes[ExtensionId](ExtensionId.html) → AnyRef → Any
20. [**](../../akka/actor/AbstractExtensionId.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
21. [**](../../akka/actor/AbstractExtensionId.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
22. [**](../../akka/actor/AbstractExtensionId.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../akka/actor/AbstractExtensionId.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../akka/actor/AbstractExtensionId.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
25. [**](../../akka/actor/AbstractExtensionId.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
26. [**](../../akka/actor/AbstractExtensionId.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
27. [**](../../akka/actor/AbstractExtensionId.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
28. [**](../../akka/actor/AbstractExtensionId.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/AbstractExtensionId.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/actor/AbstractExtensionId.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from AbstractExtensionId\[T] toStringFormat\[AbstractExtensionId\[T]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/AbstractExtensionId.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (AbstractExtensionId\[T], B)ImplicitThis member is added by an implicit conversion from AbstractExtensionId\[T] toArrowAssoc\[AbstractExtensionId\[T]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [ExtensionId](ExtensionId.html)\[T]

### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromAbstractExtensionId\[T] to any2stringadd\[AbstractExtensionId\[T]]

### Inherited by implicit conversion StringFormat fromAbstractExtensionId\[T] to StringFormat\[AbstractExtensionId\[T]]

### Inherited by implicit conversion Ensuring fromAbstractExtensionId\[T] to Ensuring\[AbstractExtensionId\[T]]

### Inherited by implicit conversion ArrowAssoc fromAbstractExtensionId\[T] to ArrowAssoc\[AbstractExtensionId\[T]]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/actor/AbstractExtensionId.html](https://doc.akka.io/api/akka-core/2.10.11/akka/actor/AbstractExtensionId.html)*