---
description: Akka 2.10.11 - akka.actor.SupervisorStrategy
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:16:22Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/SupervisorStrategy$.html
title: Akka 2.10.11 - akka.actor.SupervisorStrategy
---

# Akka 2.10.11 - akka.actor.SupervisorStrategy

> **Summary:** Akka 2.10.11 - akka.actor.SupervisorStrategy
...
[o](SupervisorStrategy.html "See companion class")[akka](../index.html).[actor](index.html)

# [SupervisorStrategy](SupervisorStrategy.html "See companion class")[**](../../akka/actor/SupervisorStrategy$.html "Permalink")

### Companion [class SupervisorStrategy](SupervisorStrategy.html "See companion class")

#### object SupervisorStrategy extends [SupervisorStrategyLowPriorityImplicits](SupervisorStrategyLowPriorityImplicits.html)

Source[FaultHandling.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-actor/src/main/scala/akka/actor/FaultHandling.scala#L107)Linear Supertypes[SupervisorStrategyLowPriorityImplicits](SupervisorStrategyLowPriorityImplicits.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Content Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/actor/SupervisorStrategy$.html#CauseDirective=(Class[_<:Throwable],akka.actor.SupervisorStrategy.Directive) "Permalink")  type CauseDirective \= (Class\[\_ \<: Throwable], [Directive](SupervisorStrategy$$Directive.html))
2. [**](../../akka/actor/SupervisorStrategy$.html#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive] "Permalink")  type Decider \= [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[Throwable, [Directive](SupervisorStrategy$$Directive.html)]
3. [**](../../akka/actor/SupervisorStrategy$$Directive.html "Permalink") sealed  trait [Directive](SupervisorStrategy$$Directive.html) extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
4. [**](../../akka/actor/SupervisorStrategy$.html#JDecider=akka.japi.Function[Throwable,akka.actor.SupervisorStrategy.Directive] "Permalink")  type JDecider \= [Function](../japi/Function.html)\[Throwable, [Directive](SupervisorStrategy$$Directive.html)]
### Value Members

1. [**](../../akka/actor/SupervisorStrategy$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/SupervisorStrategy$.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/SupervisorStrategy$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/actor/SupervisorStrategy$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../akka/actor/SupervisorStrategy$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../akka/actor/SupervisorStrategy$.html#defaultDecider:akka.actor.SupervisorStrategy.Decider "Permalink") final  val defaultDecider: [Decider](#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive])When supervisorStrategy is not specified for an actor this
`Decider` is used by default in the supervisor strategy.

When supervisorStrategy is not specified for an actor this
`Decider` is used by default in the supervisor strategy.
The child will be stopped when [akka.actor.ActorInitializationException](ActorInitializationException.html),
[akka.actor.ActorKilledException](ActorKilledException.html), or [akka.actor.DeathPactException](DeathPactException.html) is
thrown. It will be restarted for other `Exception` types.
The error is escalated if it's a `Throwable`, i.e. `Error`.
7. [**](../../akka/actor/SupervisorStrategy$.html#defaultStrategy:akka.actor.SupervisorStrategy "Permalink") final  val defaultStrategy: [SupervisorStrategy](SupervisorStrategy.html)When supervisorStrategy is not specified for an actor this
is used by default.

When supervisorStrategy is not specified for an actor this
is used by default. OneForOneStrategy with decider defined in
[\#defaultDecider](#defaultDecider:akka.actor.SupervisorStrategy.Decider).
8. [**](../../akka/actor/SupervisorStrategy$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
9. [**](../../akka/actor/SupervisorStrategy$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
10. [**](../../akka/actor/SupervisorStrategy$.html#escalate:akka.actor.SupervisorStrategy.Escalate.type "Permalink")  def escalate: [Escalate](SupervisorStrategy$$Escalate$.html)Java API: Returning this directive escalates the failure to the supervisor of the supervisor,
...
11. [**](../../akka/actor/SupervisorStrategy$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
12. [**](../../akka/actor/SupervisorStrategy$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../akka/actor/SupervisorStrategy$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
14. [**](../../akka/actor/SupervisorStrategy$.html#makeDecider(func:akka.actor.SupervisorStrategy.JDecider):akka.actor.SupervisorStrategy.Decider "Permalink")  def makeDecider(func: [JDecider](#JDecider=akka.japi.Function[Throwable,akka.actor.SupervisorStrategy.Directive])): [Decider](#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive])Converts a Java Decider into a Scala Decider
15. [**](../../akka/actor/SupervisorStrategy$.html#makeDecider(flat:Iterable[akka.actor.SupervisorStrategy.CauseDirective]):akka.actor.SupervisorStrategy.Decider "Permalink")  def makeDecider(flat: Iterable\[[CauseDirective](#CauseDirective=(Class[_<:Throwable],akka.actor.SupervisorStrategy.Directive))]): [Decider](#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive])Decider builder for Iterables of cause\-directive pairs, e.g.
...
Throwable hierarchy.
16. [**](../../akka/actor/SupervisorStrategy$.html#makeDecider(trapExit:Iterable[Class[_<:Throwable]]):akka.actor.SupervisorStrategy.Decider "Permalink")  def makeDecider(trapExit: [Iterable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Iterable.html#java.lang.Iterable)\[Class\[\_ \<: Throwable]]): [Decider](#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive])Decider builder which just checks whether one of
the given Throwables matches the cause and restarts, otherwise escalates.
17. [**](../../akka/actor/SupervisorStrategy$.html#makeDecider(trapExit:Seq[Class[_<:Throwable]]):akka.actor.SupervisorStrategy.Decider "Permalink")  def makeDecider(trapExit: [Seq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[Class\[\_ \<: Throwable]]): [Decider](#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive])Decider builder which just checks whether one of
the given Throwables matches the cause and restarts, otherwise escalates.
18. [**](../../akka/actor/SupervisorStrategy$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../akka/actor/SupervisorStrategy$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/actor/SupervisorStrategy$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../akka/actor/SupervisorStrategy$.html#restart(logLevel:akka.event.Logging.LogLevel):akka.actor.SupervisorStrategy.Directive "Permalink")  def restart(logLevel: [LogLevel](../event/Logging$$LogLevel.html)): [Directive](SupervisorStrategy$$Directive.html)Returning this directive discards the old Actor instance and replaces it with a new,
then resumes message processing.

Returning this directive discards the old Actor instance and replaces it with a new,
then resumes message processing.

logLevelLog level which will be used to log the failure
22. [**](../../akka/actor/SupervisorStrategy$.html#restart:akka.actor.SupervisorStrategy.Restart.type "Permalink")  def restart: [Restart](SupervisorStrategy$$Restart$.html)Java API: Returning this directive discards the old Actor instance and replaces it with a new,
then resumes message processing.
23. [**](../../akka/actor/SupervisorStrategy$.html#resume(logLevel:akka.event.Logging.LogLevel):akka.actor.SupervisorStrategy.Directive "Permalink")  def resume(logLevel: [LogLevel](../event/Logging$$LogLevel.html)): [Directive](SupervisorStrategy$$Directive.html)Returning this directive resumes message processing for the failed Actor.

Returning this directive resumes message processing for the failed Actor.

logLevelLog level which will be used to log the failure
24. [**](../../akka/actor/SupervisorStrategy$.html#resume:akka.actor.SupervisorStrategy.Resume.type "Permalink")  def resume: [Resume](SupervisorStrategy$$Resume$.html)Java API: Returning this directive resumes message processing for the failed Actor
25. [**](../../akka/actor/SupervisorStrategy$.html#seqCauseDirective2Decider(trapExit:Iterable[SupervisorStrategyLowPriorityImplicits.this.CauseDirective]):SupervisorStrategyLowPriorityImplicits.this.Decider "Permalink") implicit  def seqCauseDirective2Decider(trapExit: Iterable\[[CauseDirective](#CauseDirective=(Class[_<:Throwable],akka.actor.SupervisorStrategy.Directive))]): [Decider](#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive])Implicit conversion from `Seq` of Cause\-Directive pairs to a `Decider`.

Implicit conversion from `Seq` of Cause\-Directive pairs to a `Decider`. See makeDecider(causeDirective).

Definition Classes[SupervisorStrategyLowPriorityImplicits](SupervisorStrategyLowPriorityImplicits.html)
26. [**](../../akka/actor/SupervisorStrategy$.html#seqThrowable2Decider(trapExit:Seq[Class[_<:Throwable]]):akka.actor.SupervisorStrategy.Decider "Permalink") implicit  def seqThrowable2Decider(trapExit: [Seq](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[Class\[\_ \<: Throwable]]): [Decider](#Decider=PartialFunction[Throwable,akka.actor.SupervisorStrategy.Directive])Implicit conversion from `Seq` of Throwables to a `Decider`.

Implicit conversion from `Seq` of Throwables to a `Decider`.
This maps the given Throwables to restarts, otherwise escalates.
27. [**](../../akka/actor/SupervisorStrategy$.html#stop(logLevel:akka.event.Logging.LogLevel):akka.actor.SupervisorStrategy.Directive "Permalink")  def stop(logLevel: [LogLevel](../event/Logging$$LogLevel.html)): [Directive](SupervisorStrategy$$Directive.html)Returning this directive stops the Actor

Returning this directive stops the Actor

logLevelLog level which will be used to log the failure
28. [**](../../akka/actor/SupervisorStrategy$.html#stop:akka.actor.SupervisorStrategy.Stop.type "Permalink")  def stop: [Stop](SupervisorStrategy$$Stop$.html)Java API: Returning this directive stops the Actor
29. [**](../../akka/actor/SupervisorStrategy$.html#stoppingStrategy:akka.actor.SupervisorStrategy "Permalink") final  val stoppingStrategy: [SupervisorStrategy](SupervisorStrategy.html)This strategy resembles Erlang in that failing children are always
terminated (one\-for\-one).
30. [**](../../akka/actor/SupervisorStrategy$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
31. [**](../../akka/actor/SupervisorStrategy$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
32. [**](../../akka/actor/SupervisorStrategy$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
33. [**](../../akka/actor/SupervisorStrategy$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
34. [**](../../akka/actor/SupervisorStrategy$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
35. [**](../../akka/actor/SupervisorStrategy$$Escalate$.html "Permalink")  case object [Escalate](SupervisorStrategy$$Escalate$.html "Escalates the failure to the supervisor of the supervisor, by rethrowing the cause of the failure, i.e.") extends [Directive](SupervisorStrategy$$Directive.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableEscalates the failure to the supervisor of the supervisor,
by rethrowing the cause of the failure, i.e.

Escalates the failure to the supervisor of the supervisor,
by rethrowing the cause of the failure, i.e. the supervisor fails with
the same exception as the child.
36. [**](../../akka/actor/SupervisorStrategy$$Restart$.html "Permalink")  case object [Restart](SupervisorStrategy$$Restart$.html "Discards the old Actor instance and replaces it with a new, then resumes message processing.") extends Restart with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableDiscards the old Actor instance and replaces it with a new,
then resumes message processing.
37. [**](../../akka/actor/SupervisorStrategy$$Resume$.html "Permalink")  case object [Resume](SupervisorStrategy$$Resume$.html "Resumes message processing for the failed Actor") extends Resume with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableResumes message processing for the failed Actor
38. [**](../../akka/actor/SupervisorStrategy$$Stop$.html "Permalink")  case object [Stop](SupervisorStrategy$$Stop$.html "Stops the Actor") extends Stop with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with SerializableStops the Actor
### Deprecated Value Members

1. [**](../../akka/actor/SupervisorStrategy$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
### Inherited from [SupervisorStrategyLowPriorityImplicits](SupervisorStrategyLowPriorityImplicits.html)
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/actor/SupervisorStrategy$.html](https://doc.akka.io/api/akka-core/2.10.11/akka/actor/SupervisorStrategy$.html)*