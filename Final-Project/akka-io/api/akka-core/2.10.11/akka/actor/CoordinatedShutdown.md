---
description: Akka 2.10.11 - akka.actor.CoordinatedShutdown
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:14:54Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/CoordinatedShutdown.html
title: Akka 2.10.11 - akka.actor.CoordinatedShutdown
---

# Akka 2.10.11 - akka.actor.CoordinatedShutdown

> **Summary:** Akka 2.10.11 - akka.actor.CoordinatedShutdown
...
Source[CoordinatedShutdown.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-actor/src/main/scala/akka/actor/CoordinatedShutdown.scala#L361)Linear Supertypes[Extension](Extension.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
5. [**](../../akka/actor/CoordinatedShutdown.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/CoordinatedShutdown.html#addActorTerminationTask(phase:String,taskName:String,actor:akka.actor.ActorRef,stopMsg:java.util.Optional[Any]):Unit "Permalink")  def addActorTerminationTask(phase: String, taskName: String, actor: [ActorRef](ActorRef.html), stopMsg: [Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Java API: Add an actor termination task to a phase.
...
7. [**](../../akka/actor/CoordinatedShutdown.html#addActorTerminationTask(phase:String,taskName:String,actor:akka.actor.ActorRef,stopMsg:Option[Any]):Unit "Permalink")  def addActorTerminationTask(phase: String, taskName: String, actor: [ActorRef](ActorRef.html), stopMsg: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Scala API: Add an actor termination task to a phase.
...
11. [**](../../akka/actor/CoordinatedShutdown.html#addCancellableTask(phase:String,taskName:String)(task:()=>scala.concurrent.Future[akka.Done]):akka.actor.Cancellable "Permalink")  def addCancellableTask(phase: String, taskName: String)(task: () \=\> [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[[Done](../Done.html)]): [Cancellable](Cancellable.html)Scala API: Add a task to a phase, returning an object which will cancel it
on demand and remove it from the task pool (so long as the same task has not
been added elsewhere).
...
shutdown begins, tasks may be added without ever being run. A task may add tasks
to a later stage with confidence that they will be run.
12. [**](../../akka/actor/CoordinatedShutdown.html#addJvmShutdownHook(hook:Runnable):Unit "Permalink")  def addJvmShutdownHook(hook: [Runnable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Runnable.html#java.lang.Runnable)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Java API: Add a JVM shutdown hook that will be run when the JVM process
begins its shutdown sequence.
...
concurrently, but they are running before Akka internal shutdown
hooks, e.g. those shutting down Artery.
13. [**](../../akka/actor/CoordinatedShutdown.html#addJvmShutdownHook[T](hook:=>T):Unit "Permalink")  def addJvmShutdownHook\[T](hook: \=\> T): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Scala API: Add a JVM shutdown hook that will be run when the JVM process
begins its shutdown sequence.
...
It is possible to add a task to a later phase by a task in an earlier phase
and it will be performed.
15. [**](../../akka/actor/CoordinatedShutdown.html#addTask(phase:String,taskName:String)(task:()=>scala.concurrent.Future[akka.Done]):Unit "Permalink")  def addTask(phase: String, taskName: String)(task: () \=\> [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[[Done](../Done.html)]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Scala API: Add a task to a phase.
...
17. [**](../../akka/actor/CoordinatedShutdown.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/actor/CoordinatedShutdown.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (CoordinatedShutdown) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): CoordinatedShutdownImplicitThis member is added by an implicit conversion from CoordinatedShutdown toEnsuring\[CoordinatedShutdown] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
19. [**](../../akka/actor/CoordinatedShutdown.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (CoordinatedShutdown) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): CoordinatedShutdownImplicitThis member is added by an implicit conversion from CoordinatedShutdown toEnsuring\[CoordinatedShutdown] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
20. [**](../../akka/actor/CoordinatedShutdown.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): CoordinatedShutdownImplicitThis member is added by an implicit conversion from CoordinatedShutdown toEnsuring\[CoordinatedShutdown] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
21. [**](../../akka/actor/CoordinatedShutdown.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): CoordinatedShutdownImplicitThis member is added by an implicit conversion from CoordinatedShutdown toEnsuring\[CoordinatedShutdown] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
22. [**](../../akka/actor/CoordinatedShutdown.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
23. [**](../../akka/actor/CoordinatedShutdown.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
26. [**](../../akka/actor/CoordinatedShutdown.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
27. [**](../../akka/actor/CoordinatedShutdown.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
28. [**](../../akka/actor/CoordinatedShutdown.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
29. [**](../../akka/actor/CoordinatedShutdown.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
30. [**](../../akka/actor/CoordinatedShutdown.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
...
32. [**](../../akka/actor/CoordinatedShutdown.html#run(reason:akka.actor.CoordinatedShutdown.Reason,fromPhase:Option[String]):scala.concurrent.Future[akka.Done] "Permalink")  def run(reason: [Reason](CoordinatedShutdown$$Reason.html), fromPhase: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[String]): [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[[Done](../Done.html)]Scala API: Run tasks of all phases including and after the given phase.
...
33. [**](../../akka/actor/CoordinatedShutdown.html#run(reason:akka.actor.CoordinatedShutdown.Reason):scala.concurrent.Future[akka.Done] "Permalink")  def run(reason: [Reason](CoordinatedShutdown$$Reason.html)): [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[[Done](../Done.html)]Scala API: Run tasks of all phases.
...
It's safe to call this method multiple times. It will only run the shutdown sequence once.
35. [**](../../akka/actor/CoordinatedShutdown.html#shutdownReason():Option[akka.actor.CoordinatedShutdown.Reason] "Permalink")  def shutdownReason(): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Reason](CoordinatedShutdown$$Reason.html)]The `Reason` for the shutdown as passed to the `run` method.
...
37. [**](../../akka/actor/CoordinatedShutdown.html#timeout(phase:String):scala.concurrent.duration.FiniteDuration "Permalink")  def timeout(phase: String): [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)The configured timeout for a given `phase`.
...
39. [**](../../akka/actor/CoordinatedShutdown.html#totalTimeout():scala.concurrent.duration.FiniteDuration "Permalink")  def totalTimeout(): [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)Sum of timeouts of all phases that have some task.
40. [**](../../akka/actor/CoordinatedShutdown.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
41. [**](../../akka/actor/CoordinatedShutdown.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
42. [**](../../akka/actor/CoordinatedShutdown.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
3. [**](../../akka/actor/CoordinatedShutdown.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (CoordinatedShutdown, B)ImplicitThis member is added by an implicit conversion from CoordinatedShutdown toArrowAssoc\[CoordinatedShutdown] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/actor/CoordinatedShutdown.html](https://doc.akka.io/api/akka-core/2.10.11/akka/actor/CoordinatedShutdown.html)*