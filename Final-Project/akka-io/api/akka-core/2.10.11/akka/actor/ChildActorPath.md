---
description: Akka 2.10.11 - akka.actor.ChildActorPath
knowledge_type: official_documentation
scraped_at: '2026-04-06T01:14:48Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/actor/ChildActorPath.html
title: Akka 2.10.11 - akka.actor.ChildActorPath
---

# Akka 2.10.11 - akka.actor.ChildActorPath

> **Summary:** Akka 2.10.11 - akka.actor.ChildActorPath
...
1. [**](../../akka/actor/ChildActorPath.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/ChildActorPath.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/ChildActorPath.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ChildActorPath toany2stringadd\[ChildActorPath] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/ChildActorPath.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ChildActorPath, B)ImplicitThis member is added by an implicit conversion from ChildActorPath toArrowAssoc\[ChildActorPath] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/ChildActorPath.html#/(child:String):akka.actor.ActorPath "Permalink")  def /(child: String): [ActorPath](ActorPath.html)Create a new child actor path.

Create a new child actor path.

Definition ClassesChildActorPath → [ActorPath](ActorPath.html)
6. [**](../../akka/actor/ChildActorPath.html#/(child:Iterable[String]):akka.actor.ActorPath "Permalink")  def /(child: Iterable\[String]): [ActorPath](ActorPath.html)Recursively create a descendant’s path by appending all child names.

Recursively create a descendant’s path by appending all child names.

Definition Classes[ActorPath](ActorPath.html)
7. [**](../../akka/actor/ChildActorPath.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
8. [**](../../akka/actor/ChildActorPath.html#address:akka.actor.Address "Permalink")  def address: [Address](Address.html)The Address under which this path can be reached; walks up the tree to
the RootActorPath.
...
Definition ClassesChildActorPath → [ActorPath](ActorPath.html)
9. [**](../../akka/actor/ChildActorPath.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
10. [**](../../akka/actor/ChildActorPath.html#child(child:String):akka.actor.ActorPath "Permalink")  def child(child: String): [ActorPath](ActorPath.html)Java API: Create a new child actor path.

Java API: Create a new child actor path.

Definition Classes[ActorPath](ActorPath.html)
11. [**](../../akka/actor/ChildActorPath.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
12. [**](../../akka/actor/ChildActorPath.html#compareTo(other:akka.actor.ActorPath):Int "Permalink")  def compareTo(other: [ActorPath](ActorPath.html)): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesChildActorPath → Comparable
13. [**](../../akka/actor/ChildActorPath.html#descendant(names:Iterable[String]):akka.actor.ActorPath "Permalink")  def descendant(names: [Iterable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Iterable.html#java.lang.Iterable)\[String]): [ActorPath](ActorPath.html)Java API: Recursively create a descendant’s path by appending all child names.

Java API: Recursively create a descendant’s path by appending all child names.

Definition Classes[ActorPath](ActorPath.html)
14. [**](../../akka/actor/ChildActorPath.html#elements:scala.collection.immutable.Iterable[String] "Permalink")  def elements: [Iterable](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Iterable.html#scala.collection.immutable.Iterable)\[String]Sequence of names for this path from root to this.

Sequence of names for this path from root to this. Performance implication: has to allocate a list.

Definition ClassesChildActorPath → [ActorPath](ActorPath.html)
15. [**](../../akka/actor/ChildActorPath.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ChildActorPath) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ChildActorPathImplicitThis member is added by an implicit conversion from ChildActorPath toEnsuring\[ChildActorPath] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/actor/ChildActorPath.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ChildActorPath) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ChildActorPathImplicitThis member is added by an implicit conversion from ChildActorPath toEnsuring\[ChildActorPath] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../akka/actor/ChildActorPath.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ChildActorPathImplicitThis member is added by an implicit conversion from ChildActorPath toEnsuring\[ChildActorPath] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
18. [**](../../akka/actor/ChildActorPath.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ChildActorPathImplicitThis member is added by an implicit conversion from ChildActorPath toEnsuring\[ChildActorPath] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
19. [**](../../akka/actor/ChildActorPath.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
20. [**](../../akka/actor/ChildActorPath.html#equals(other:Any):Boolean "Permalink")  def equals(other: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesChildActorPath → AnyRef → Any
21. [**](../../akka/actor/ChildActorPath.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/actor/ChildActorPath.html#getElements:Iterable[String] "Permalink")  def getElements: [Iterable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Iterable.html#java.lang.Iterable)\[String]Java API: Sequence of names for this path from root to this.

Java API: Sequence of names for this path from root to this. Performance implication: has to allocate a list.

Definition Classes[ActorPath](ActorPath.html)
23. [**](../../akka/actor/ChildActorPath.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesChildActorPath → AnyRef → Any
24. [**](../../akka/actor/ChildActorPath.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
25. [**](../../akka/actor/ChildActorPath.html#name:String "Permalink")  val name: StringThe name of the actor that this path refers to.

The name of the actor that this path refers to.

Definition ClassesChildActorPath → [ActorPath](ActorPath.html)
26. [**](../../akka/actor/ChildActorPath.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
27. [**](../../akka/actor/ChildActorPath.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
28. [**](../../akka/actor/ChildActorPath.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
29. [**](../../akka/actor/ChildActorPath.html#parent:akka.actor.ActorPath "Permalink")  val parent: [ActorPath](ActorPath.html)The path for the parent actor.

The path for the parent actor.

Definition ClassesChildActorPath → [ActorPath](ActorPath.html)
30. [**](../../akka/actor/ChildActorPath.html#root:akka.actor.RootActorPath "Permalink")  def root: [RootActorPath](RootActorPath.html)Walk up the tree to obtain and return the RootActorPath.

Walk up the tree to obtain and return the RootActorPath.

Definition ClassesChildActorPath → [ActorPath](ActorPath.html)
31. [**](../../akka/actor/ChildActorPath.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
32. [**](../../akka/actor/ChildActorPath.html#toSerializationFormat:String "Permalink")  def toSerializationFormat: StringGenerate full String representation including the
...
Definition ClassesChildActorPath → [ActorPath](ActorPath.html)
33. [**](../../akka/actor/ChildActorPath.html#toSerializationFormatWithAddress(addr:akka.actor.Address):String "Permalink")  def toSerializationFormatWithAddress(addr: [Address](Address.html)): StringGenerate full String representation including the uid for the actor cell
...
Definition ClassesChildActorPath → [ActorPath](ActorPath.html)
34. [**](../../akka/actor/ChildActorPath.html#toString():String "Permalink")  def toString(): StringDefinition ClassesChildActorPath → AnyRef → Any
35. [**](../../akka/actor/ChildActorPath.html#toStringWithAddress(addr:akka.actor.Address):String "Permalink")  def toStringWithAddress(addr: [Address](Address.html)): StringGenerate String representation, replacing the Address in the RootActor
...
Definition ClassesChildActorPath → [ActorPath](ActorPath.html)
36. [**](../../akka/actor/ChildActorPath.html#toStringWithoutAddress:String "Permalink")  def toStringWithoutAddress: StringString representation of the path elements, excluding the address
information.
...
Definition Classes[ActorPath](ActorPath.html)
37. [**](../../akka/actor/ChildActorPath.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
38. [**](../../akka/actor/ChildActorPath.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
39. [**](../../akka/actor/ChildActorPath.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/ChildActorPath.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/actor/ChildActorPath.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ChildActorPath toStringFormat\[ChildActorPath] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/ChildActorPath.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ChildActorPath, B)ImplicitThis member is added by an implicit conversion from ChildActorPath toArrowAssoc\[ChildActorPath] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromChildActorPath to any2stringadd\[ChildActorPath]

### Inherited by implicit conversion StringFormat fromChildActorPath to StringFormat\[ChildActorPath]

### Inherited by implicit conversion Ensuring fromChildActorPath to Ensuring\[ChildActorPath]

### Inherited by implicit conversion ArrowAssoc fromChildActorPath to ArrowAssoc\[ChildActorPath]
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/actor/ChildActorPath.html](https://doc.akka.io/api/akka-core/2.10.11/akka/actor/ChildActorPath.html)*