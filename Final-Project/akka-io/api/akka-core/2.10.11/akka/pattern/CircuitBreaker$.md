---
description: Akka 2.10.11 - akka.pattern.CircuitBreaker
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:14:28Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/pattern/CircuitBreaker$.html
title: Akka 2.10.11 - akka.pattern.CircuitBreaker
---

# Akka 2.10.11 - akka.pattern.CircuitBreaker

> **Summary:** Akka 2.10.11 - akka.pattern.CircuitBreaker
...
[o](CircuitBreaker.html "See companion class")[akka](../index.html).[pattern](index.html)

# [CircuitBreaker](CircuitBreaker.html "See companion class")[**](../../akka/pattern/CircuitBreaker$.html "Permalink")

### Companion [class CircuitBreaker](CircuitBreaker.html "See companion class")

#### object CircuitBreaker

Companion object providing factory methods for Circuit Breaker which runs callbacks in caller's thread

Source[CircuitBreaker.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-actor/src/main/scala/akka/pattern/CircuitBreaker.scala#L31)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. CircuitBreaker
2. AnyRef
...
3. [**](../../akka/pattern/CircuitBreaker$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/pattern/CircuitBreaker$.html#apply(id:String)(implicitsystem:akka.actor.ClassicActorSystemProvider):akka.pattern.CircuitBreaker "Permalink")  def apply(id: String)(implicit system: [ClassicActorSystemProvider](../actor/ClassicActorSystemProvider.html)): [CircuitBreaker](CircuitBreaker.html)Create or find a CircuitBreaker in registry.

Create or find a CircuitBreaker in registry.

idCircuit Breaker identifier

systemActorSystem that is storing this [CircuitBreaker](CircuitBreaker.html)
5. [**](../../akka/pattern/CircuitBreaker$.html#apply(scheduler:akka.actor.Scheduler,maxFailures:Int,callTimeout:scala.concurrent.duration.FiniteDuration,resetTimeout:scala.concurrent.duration.FiniteDuration):akka.pattern.CircuitBreaker "Permalink")  def apply(scheduler: [Scheduler](../actor/Scheduler.html), maxFailures: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), callTimeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), resetTimeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): [CircuitBreaker](CircuitBreaker.html)Create a new CircuitBreaker.
...
schedulerReference to Akka scheduler
...
6. [**](../../akka/pattern/CircuitBreaker$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/pattern/CircuitBreaker$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/pattern/CircuitBreaker$.html#convertJavaFailureFnToScala[T](javaFn:java.util.function.BiFunction[java.util.Optional[T],java.util.Optional[Throwable],Boolean]):scala.util.Try[T]=>Boolean "Permalink")  def convertJavaFailureFnToScala\[T](javaFn: [BiFunction](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/BiFunction.html#java.util.function.BiFunction)\[[Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[T], [Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[Throwable], [Boolean](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Boolean.html#java.lang.Boolean)]): ([Try](https://www.scala-lang.org/api/2.13.17/scala/util/Try.html#scala.util.Try)\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Attributesprotected
9. [**](../../akka/pattern/CircuitBreaker$.html#create(scheduler:akka.actor.Scheduler,maxFailures:Int,callTimeout:java.time.Duration,resetTimeout:java.time.Duration):akka.pattern.CircuitBreaker "Permalink")  def create(scheduler: [Scheduler](../actor/Scheduler.html), maxFailures: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), callTimeout: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), resetTimeout: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): [CircuitBreaker](CircuitBreaker.html)Java API: Create a new CircuitBreaker.
...
callTimeout[java.time.Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html) of time after which to consider a call a failure

resetTimeout[java.time.Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html) of time after which to attempt to close the circuit
10. [**](../../akka/pattern/CircuitBreaker$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
11. [**](../../akka/pattern/CircuitBreaker$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
12. [**](../../akka/pattern/CircuitBreaker$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../akka/pattern/CircuitBreaker$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../akka/pattern/CircuitBreaker$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
15. [**](../../akka/pattern/CircuitBreaker$.html#lookup(id:String,system:akka.actor.ClassicActorSystemProvider):akka.pattern.CircuitBreaker "Permalink")  def lookup(id: String, system: [ClassicActorSystemProvider](../actor/ClassicActorSystemProvider.html)): [CircuitBreaker](CircuitBreaker.html)Java API: Create or find a CircuitBreaker in registry.
...
systemActorSystem that is storing this [CircuitBreaker](CircuitBreaker.html)
16. [**](../../akka/pattern/CircuitBreaker$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/pattern/CircuitBreaker$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/pattern/CircuitBreaker$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/pattern/CircuitBreaker$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
20. [**](../../akka/pattern/CircuitBreaker$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
21. [**](../../akka/pattern/CircuitBreaker$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
22. [**](../../akka/pattern/CircuitBreaker$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
23. [**](../../akka/pattern/CircuitBreaker$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/pattern/CircuitBreaker$.html](https://doc.akka.io/api/akka-core/2.10.11/akka/pattern/CircuitBreaker$.html)*