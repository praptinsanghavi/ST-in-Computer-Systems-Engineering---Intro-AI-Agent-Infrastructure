---
description: Akka 2.10.11 - akka.pattern.FutureRef
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:14:36Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/pattern/FutureRef$.html
title: Akka 2.10.11 - akka.pattern.FutureRef
---

# Akka 2.10.11 - akka.pattern.FutureRef

> **Summary:** Akka 2.10.11 - akka.pattern.FutureRef
...
[o](FutureRef.html "See companion trait")[akka](../index.html).[pattern](index.html)

# [FutureRef](FutureRef.html "See companion trait")[**](../../akka/pattern/FutureRef$.html "Permalink")

### Companion [trait FutureRef](FutureRef.html "See companion trait")

#### object FutureRef

Source[PromiseRef.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-actor/src/main/scala/akka/pattern/PromiseRef.scala#L100)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. FutureRef
2. AnyRef
...
3. [**](../../akka/pattern/FutureRef$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/pattern/FutureRef$.html#apply(timeout:akka.util.Timeout)(implicitsystem:akka.actor.ActorSystem):akka.pattern.FutureRef[Any] "Permalink")  def apply(timeout: [Timeout](../util/Timeout.html))(implicit system: [ActorSystem](../actor/ActorSystem.html)): [FutureRef](FutureRef.html)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]Constructs a new PromiseRef which will be completed with the first message sent to it.
...
```
5. [**](../../akka/pattern/FutureRef$.html#apply(system:akka.actor.ActorSystem,timeout:akka.util.Timeout):akka.pattern.FutureRef[Any] "Permalink")  def apply(system: [ActorSystem](../actor/ActorSystem.html), timeout: [Timeout](../util/Timeout.html)): [FutureRef](FutureRef.html)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]Constructs a new FutureRef which will be completed with the first message sent to it.
...
8. [**](../../akka/pattern/FutureRef$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
9. [**](../../akka/pattern/FutureRef$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
10. [**](../../akka/pattern/FutureRef$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
11. [**](../../akka/pattern/FutureRef$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
12. [**](../../akka/pattern/FutureRef$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
13. [**](../../akka/pattern/FutureRef$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/pattern/FutureRef$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/pattern/FutureRef$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/pattern/FutureRef$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
17. [**](../../akka/pattern/FutureRef$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
18. [**](../../akka/pattern/FutureRef$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
19. [**](../../akka/pattern/FutureRef$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
20. [**](../../akka/pattern/FutureRef$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/pattern/FutureRef$.html](https://doc.akka.io/api/akka-core/2.10.11/akka/pattern/FutureRef$.html)*