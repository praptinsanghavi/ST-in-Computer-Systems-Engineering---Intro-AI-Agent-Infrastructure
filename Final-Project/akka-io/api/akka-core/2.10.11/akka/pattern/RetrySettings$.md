---
description: Akka 2.10.11 - akka.pattern.RetrySettings
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:14:47Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/pattern/RetrySettings$.html
title: Akka 2.10.11 - akka.pattern.RetrySettings
---

# Akka 2.10.11 - akka.pattern.RetrySettings

> **Summary:** Akka 2.10.11 - akka.pattern.RetrySettings
...
[o](RetrySettings.html "See companion class")[akka](../index.html).[pattern](index.html)

# [RetrySettings](RetrySettings.html "See companion class")[**](../../akka/pattern/RetrySettings$.html "Permalink")

### Companion [class RetrySettings](RetrySettings.html "See companion class")

#### object RetrySettings

Source[RetrySettings.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-actor/src/main/scala/akka/pattern/RetrySettings.scala#L116)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. RetrySettings
2. AnyRef
...
3. [**](../../akka/pattern/RetrySettings$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../akka/pattern/RetrySettings$.html#apply(config:com.typesafe.config.Config):akka.pattern.RetrySettings "Permalink")  def apply(config: Config): [RetrySettings](RetrySettings.html)Scala API: Create settings from configuration.
5. [**](../../akka/pattern/RetrySettings$.html#apply(maxRetries:Int):akka.pattern.RetrySettings "Permalink")  def apply(maxRetries: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [RetrySettings](RetrySettings.html)Scala API: Create settings with exponential backoff delay between retries.
...
returnsRetrySettings with exponential backoff delay
...
8. [**](../../akka/pattern/RetrySettings$.html#create(config:com.typesafe.config.Config):akka.pattern.RetrySettings "Permalink")  def create(config: Config): [RetrySettings](RetrySettings.html)Java API: Create settings from configuration.
9. [**](../../akka/pattern/RetrySettings$.html#create(maxRetries:Int):akka.pattern.RetrySettings "Permalink")  def create(maxRetries: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [RetrySettings](RetrySettings.html)Scala API: Create settings with exponential backoff delay between retries.
...
returnsRetrySettings with exponential backoff delay
10. [**](../../akka/pattern/RetrySettings$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
11. [**](../../akka/pattern/RetrySettings$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
12. [**](../../akka/pattern/RetrySettings$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../akka/pattern/RetrySettings$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../akka/pattern/RetrySettings$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
15. [**](../../akka/pattern/RetrySettings$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
16. [**](../../akka/pattern/RetrySettings$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../akka/pattern/RetrySettings$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/pattern/RetrySettings$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
19. [**](../../akka/pattern/RetrySettings$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
20. [**](../../akka/pattern/RetrySettings$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
21. [**](../../akka/pattern/RetrySettings$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
22. [**](../../akka/pattern/RetrySettings$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/pattern/RetrySettings$.html](https://doc.akka.io/api/akka-core/2.10.11/akka/pattern/RetrySettings$.html)*