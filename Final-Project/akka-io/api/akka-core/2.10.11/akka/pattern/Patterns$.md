---
description: Akka 2.10.11 - akka.pattern.Patterns
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:14:14Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/pattern/Patterns$.html
title: Akka 2.10.11 - akka.pattern.Patterns
---

# Akka 2.10.11 - akka.pattern.Patterns

> **Summary:** Akka 2.10.11 - akka.pattern.Patterns
...
Source[Patterns.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-actor/src/main/scala/akka/pattern/Patterns.scala#L20)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Patterns
2. AnyRef
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/pattern/Patterns$.html](https://doc.akka.io/api/akka-core/2.10.11/akka/pattern/Patterns$.html)*