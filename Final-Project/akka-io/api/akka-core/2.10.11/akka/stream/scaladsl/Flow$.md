...
scraped_at: '2026-04-06T02:22:07Z'
section: api
site: akka-io
...
[o](Flow.html "See companion class")[akka](../../index.html).[stream](../index.html).[scaladsl](index.html)

# [Flow](Flow.html "See companion class")[**](../../../akka/stream/scaladsl/Flow$.html "Permalink")

### Companion [class Flow](Flow.html "See companion class")

#### object Flow

Source[Flow.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-stream/src/main/scala/akka/stream/scaladsl/Flow.scala#L376)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Flow
2. AnyRef
...
3. [**](../../../akka/stream/scaladsl/Flow$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../akka/stream/scaladsl/Flow$.html#apply[T]:akka.stream.scaladsl.Flow[T,T,akka.NotUsed] "Permalink")  def apply\[T]: [Flow](Flow.html)\[T, T, [NotUsed](../../NotUsed.html)]Returns a `Flow` which outputs all its inputs.
5. [**](../../../akka/stream/scaladsl/Flow$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
6. [**](../../../akka/stream/scaladsl/Flow$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
7. [**](../../../akka/stream/scaladsl/Flow$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
8. [**](../../../akka/stream/scaladsl/Flow$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
9. [**](../../../akka/stream/scaladsl/Flow$.html#fromFunction[A,B](f:A=>B):akka.stream.scaladsl.Flow[A,B,akka.NotUsed] "Permalink")  def fromFunction\[A, B](f: (A) \=\> B): [Flow](Flow.html)\[A, B, [NotUsed](../../NotUsed.html)]Creates a \[Flow] which will use the given function to transform its inputs to outputs.

Creates a \[Flow] which will use the given function to transform its inputs to outputs. It is equivalent
to `Flow[T].map(f)`
10. [**](../../../akka/stream/scaladsl/Flow$.html#fromGraph[I,O,M](g:akka.stream.Graph[akka.stream.FlowShape[I,O],M]):akka.stream.scaladsl.Flow[I,O,M] "Permalink")  def fromGraph\[I, O, M](g: [Graph](../Graph.html)\[[FlowShape](../FlowShape.html)\[I, O], M]): [Flow](Flow.html)\[I, O, M]A graph with the shape of a flow logically is a flow, this method makes
it so also in type.
11. [**](../../../akka/stream/scaladsl/Flow$.html#fromMaterializer[T,U,M](factory:(akka.stream.Materializer,akka.stream.Attributes)=>akka.stream.scaladsl.Flow[T,U,M]):akka.stream.scaladsl.Flow[T,U,scala.concurrent.Future[M]] "Permalink")  def fromMaterializer\[T, U, M](factory: ([Materializer](../Materializer.html), [Attributes](../Attributes.html)) \=\> [Flow](Flow.html)\[T, U, M]): [Flow](Flow.html)\[T, U, [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[M]]Defers the creation of a [Flow](Flow.html) until materialization.
...
12. [**](../../../akka/stream/scaladsl/Flow$.html#fromProcessor[I,O](processorFactory:()=>org.reactivestreams.Processor[I,O]):akka.stream.scaladsl.Flow[I,O,akka.NotUsed] "Permalink")  def fromProcessor\[I, O](processorFactory: () \=\> Processor\[I, O]): [Flow](Flow.html)\[I, O, [NotUsed](../../NotUsed.html)]Creates a Flow from a Reactive Streams org.reactivestreams.Processor
13. [**](../../../akka/stream/scaladsl/Flow$.html#fromProcessorMat[I,O,M](processorFactory:()=>(org.reactivestreams.Processor[I,O],M)):akka.stream.scaladsl.Flow[I,O,M] "Permalink")  def fromProcessorMat\[I, O, M](processorFactory: () \=\> (Processor\[I, O], M)): [Flow](Flow.html)\[I, O, M]Creates a Flow from a Reactive Streams org.reactivestreams.Processor and returns a materialized value.
14. [**](../../../akka/stream/scaladsl/Flow$.html#fromSinkAndSource[I,O](sink:akka.stream.Graph[akka.stream.SinkShape[I],_],source:akka.stream.Graph[akka.stream.SourceShape[O],_]):akka.stream.scaladsl.Flow[I,O,akka.NotUsed] "Permalink")  def fromSinkAndSource\[I, O](sink: [Graph](../Graph.html)\[[SinkShape](../SinkShape.html)\[I], \_], source: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[O], \_]): [Flow](Flow.html)\[I, O, [NotUsed](../../NotUsed.html)]Creates a `Flow` from a `Sink` and a `Source` where the Flow's input
...
See also [fromSinkAndSourceMat](#fromSinkAndSourceMat[I,O,M1,M2,M](sink:akka.stream.Graph[akka.stream.SinkShape[I],M1],source:akka.stream.Graph[akka.stream.SourceShape[O],M2])(combine:(M1,M2)=>M):akka.stream.scaladsl.Flow[I,O,M]) when access to materialized values of the parameters is needed.
15. [**](../../../akka/stream/scaladsl/Flow$.html#fromSinkAndSourceCoupled[I,O](sink:akka.stream.Graph[akka.stream.SinkShape[I],_],source:akka.stream.Graph[akka.stream.SourceShape[O],_]):akka.stream.scaladsl.Flow[I,O,akka.NotUsed] "Permalink")  def fromSinkAndSourceCoupled\[I, O](sink: [Graph](../Graph.html)\[[SinkShape](../SinkShape.html)\[I], \_], source: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[O], \_]): [Flow](Flow.html)\[I, O, [NotUsed](../../NotUsed.html)]Allows coupling termination (cancellation, completion, erroring) of Sinks and Sources while creating a Flow from them.

Allows coupling termination (cancellation, completion, erroring) of Sinks and Sources while creating a Flow from them.
Similar to [Flow.fromSinkAndSource](#fromSinkAndSource[I,O](sink:akka.stream.Graph[akka.stream.SinkShape[I],_],source:akka.stream.Graph[akka.stream.SourceShape[O],_]):akka.stream.scaladsl.Flow[I,O,akka.NotUsed]) however couples the termination of these two operators.
...
See also [fromSinkAndSourceCoupledMat](#fromSinkAndSourceCoupledMat[I,O,M1,M2,M](sink:akka.stream.Graph[akka.stream.SinkShape[I],M1],source:akka.stream.Graph[akka.stream.SourceShape[O],M2])(combine:(M1,M2)=>M):akka.stream.scaladsl.Flow[I,O,M]) when access to materialized values of the parameters is needed.
16. [**](../../../akka/stream/scaladsl/Flow$.html#fromSinkAndSourceCoupledMat[I,O,M1,M2,M](sink:akka.stream.Graph[akka.stream.SinkShape[I],M1],source:akka.stream.Graph[akka.stream.SourceShape[O],M2])(combine:(M1,M2)=>M):akka.stream.scaladsl.Flow[I,O,M] "Permalink")  def fromSinkAndSourceCoupledMat\[I, O, M1, M2, M](sink: [Graph](../Graph.html)\[[SinkShape](../SinkShape.html)\[I], M1], source: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[O], M2])(combine: (M1, M2) \=\> M): [Flow](Flow.html)\[I, O, M]Allows coupling termination (cancellation, completion, erroring) of Sinks and Sources while creating a Flow from them.
...
```
E.g. if the emitted [Flow](Flow.html) gets a cancellation, the [Source](Source.html) of course is cancelled,
however the Sink will also be completed. The table on [Flow.fromSinkAndSourceCoupled](#fromSinkAndSourceCoupled[I,O](sink:akka.stream.Graph[akka.stream.SinkShape[I],_],source:akka.stream.Graph[akka.stream.SourceShape[O],_]):akka.stream.scaladsl.Flow[I,O,akka.NotUsed])
...
17. [**](../../../akka/stream/scaladsl/Flow$.html#fromSinkAndSourceMat[I,O,M1,M2,M](sink:akka.stream.Graph[akka.stream.SinkShape[I],M1],source:akka.stream.Graph[akka.stream.SourceShape[O],M2])(combine:(M1,M2)=>M):akka.stream.scaladsl.Flow[I,O,M] "Permalink")  def fromSinkAndSourceMat\[I, O, M1, M2, M](sink: [Graph](../Graph.html)\[[SinkShape](../SinkShape.html)\[I], M1], source: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[O], M2])(combine: (M1, M2) \=\> M): [Flow](Flow.html)\[I, O, M]Creates a `Flow` from a `Sink` and a `Source` where the Flow's input
will be sent to the Sink and the Flow's output will come from the Source.
...
The `combine` function is used to compose the materialized values of the `sink` and `source`
into the materialized value of the resulting [Flow](Flow.html).
18. [**](../../../akka/stream/scaladsl/Flow$.html#futureFlow[I,O,M](flow:scala.concurrent.Future[akka.stream.scaladsl.Flow[I,O,M]]):akka.stream.scaladsl.Flow[I,O,scala.concurrent.Future[M]] "Permalink")  def futureFlow\[I, O, M](flow: [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[[Flow](Flow.html)\[I, O, M]]): [Flow](Flow.html)\[I, O, [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[M]]Turn a `Future[Flow]` into a flow that will consume the values of the source when the future completes successfully.
...
The operator's default behaviour in case of downstream cancellation before nested flow materialization (future completion) is to cancel immediately.
 This behaviour can be controlled by setting the [akka.stream.Attributes.NestedMaterializationCancellationPolicy.PropagateToNested](../Attributes$$NestedMaterializationCancellationPolicy$.html#PropagateToNested:akka.stream.Attributes.NestedMaterializationCancellationPolicy) attribute,
...
19. [**](../../../akka/stream/scaladsl/Flow$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../../akka/stream/scaladsl/Flow$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../../akka/stream/scaladsl/Flow$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
22. [**](../../../akka/stream/scaladsl/Flow$.html#lazyFlow[I,O,M](create:()=>akka.stream.scaladsl.Flow[I,O,M]):akka.stream.scaladsl.Flow[I,O,scala.concurrent.Future[M]] "Permalink")  def lazyFlow\[I, O, M](create: () \=\> [Flow](Flow.html)\[I, O, M]): [Flow](Flow.html)\[I, O, [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[M]]Defers invoking the `create` function to create a future flow until there is downstream demand and passing
...
The operator's default behaviour in case of downstream cancellation before nested flow materialization (future completion) is to cancel immediately.
 This behaviour can be controlled by setting the [akka.stream.Attributes.NestedMaterializationCancellationPolicy.PropagateToNested](../Attributes$$NestedMaterializationCancellationPolicy$.html#PropagateToNested:akka.stream.Attributes.NestedMaterializationCancellationPolicy) attribute,
this will delay downstream cancellation until nested flow's materialization which is then immediately cancelled (with the original cancellation cause).
23. [**](../../../akka/stream/scaladsl/Flow$.html#lazyFutureFlow[I,O,M](create:()=>scala.concurrent.Future[akka.stream.scaladsl.Flow[I,O,M]]):akka.stream.scaladsl.Flow[I,O,scala.concurrent.Future[M]] "Permalink")  def lazyFutureFlow\[I, O, M](create: () \=\> [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[[Flow](Flow.html)\[I, O, M]]): [Flow](Flow.html)\[I, O, [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[M]]Defers invoking the `create` function to create a future flow until there downstream demand has caused upstream
...
The operator's default behaviour in case of downstream cancellation before nested flow materialization (future completion) is to cancel immediately.
 This behaviour can be controlled by setting the [akka.stream.Attributes.NestedMaterializationCancellationPolicy.PropagateToNested](../Attributes$$NestedMaterializationCancellationPolicy$.html#PropagateToNested:akka.stream.Attributes.NestedMaterializationCancellationPolicy) attribute,
this will delay downstream cancellation until nested flow's materialization which is then immediately cancelled (with the original cancellation cause).
24. [**](../../../akka/stream/scaladsl/Flow$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
25. [**](../../../akka/stream/scaladsl/Flow$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
26. [**](../../../akka/stream/scaladsl/Flow$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
27. [**](../../../akka/stream/scaladsl/Flow$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
28. [**](../../../akka/stream/scaladsl/Flow$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
29. [**](../../../akka/stream/scaladsl/Flow$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
30. [**](../../../akka/stream/scaladsl/Flow$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
31. [**](../../../akka/stream/scaladsl/Flow$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
2. [**](../../../akka/stream/scaladsl/Flow$.html#lazyInit[I,O,M](flowFactory:I=>scala.concurrent.Future[akka.stream.scaladsl.Flow[I,O,M]],fallback:()=>M):akka.stream.scaladsl.Flow[I,O,M] "Permalink")  def lazyInit\[I, O, M](flowFactory: (I) \=\> [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[[Flow](Flow.html)\[I, O, M]], fallback: () \=\> M): [Flow](Flow.html)\[I, O, M]Creates a real `Flow` upon receiving the first element.
...
Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use 'Flow.futureFlow' in combination with prefixAndTail(1\) instead, see `futureFlow` operator docs for details
3. [**](../../../akka/stream/scaladsl/Flow$.html#lazyInitAsync[I,O,M](flowFactory:()=>scala.concurrent.Future[akka.stream.scaladsl.Flow[I,O,M]]):akka.stream.scaladsl.Flow[I,O,scala.concurrent.Future[Option[M]]] "Permalink")  def lazyInitAsync\[I, O, M](flowFactory: () \=\> [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[[Flow](Flow.html)\[I, O, M]]): [Flow](Flow.html)\[I, O, [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[[Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[M]]]Creates a real `Flow` upon receiving the first element.
...
Annotations@deprecated Deprecated*(Since version 2\.6\.0\)* Use 'Flow.lazyFutureFlow' instead
4. [**](../../../akka/stream/scaladsl/Flow$.html#setup[T,U,M](factory:(akka.stream.ActorMaterializer,akka.stream.Attributes)=>akka.stream.scaladsl.Flow[T,U,M]):akka.stream.scaladsl.Flow[T,U,scala.concurrent.Future[M]] "Permalink")  def setup\[T, U, M](factory: ([ActorMaterializer](../ActorMaterializer.html), [Attributes](../Attributes.html)) \=\> [Flow](Flow.html)\[T, U, M]): [Flow](Flow.html)\[T, U, [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[M]]Defers the creation of a [Flow](Flow.html) until materialization.
...
- https://doc.akka.io/api/akka-core/2.10.11/akka/stream/NeverMaterializedException.html
