---
description: Akka 2.10.11 - akka.stream.scaladsl.UnzipWith4
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:24:52Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/UnzipWith4.html
title: Akka 2.10.11 - akka.stream.scaladsl.UnzipWith4
---

# Akka 2.10.11 - akka.stream.scaladsl.UnzipWith4

> **Summary:** Akka 2.10.11 - akka.stream.scaladsl.UnzipWith4
...
# UnzipWith4[**](../../../akka/stream/scaladsl/UnzipWith4.html "Permalink")

### 

#### class UnzipWith4\[In, A1, A2, A3, A4] extends [GraphStage](../stage/GraphStage.html)\[[FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4]]

`UnzipWith` specialized for 4 outputs

Source[UnzipWithApply.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-stream/target/scala-2.13/src_managed/main/akka/stream/scaladsl/UnzipWithApply.scala#L541)Linear Supertypes[GraphStage](../stage/GraphStage.html)\[[FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4]], [GraphStageWithMaterializedValue](../stage/GraphStageWithMaterializedValue.html)\[[FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4], [NotUsed](../../NotUsed.html)], [Graph](../Graph.html)\[[FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4], [NotUsed](../../NotUsed.html)], [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. UnzipWith4
2. GraphStage
...
1. [**](../../../akka/stream/scaladsl/UnzipWith4.html#<init>(unzipper:In=>(A1,A2,A3,A4)):akka.stream.scaladsl.UnzipWith4[In,A1,A2,A3,A4] "Permalink")  new UnzipWith4(unzipper: (In) \=\> (A1, A2, A3, A4))
### Type Members

1. [**](../../../akka/stream/scaladsl/UnzipWith4.html#Shape=S@scala.annotation.unchecked.uncheckedVariance "Permalink")  type Shape \= [FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4]Type\-level accessor for the shape parameter of this graph.
...
1. [**](../../../akka/stream/scaladsl/UnzipWith4.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../akka/stream/scaladsl/UnzipWith4.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../akka/stream/scaladsl/UnzipWith4.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from UnzipWith4\[In, A1, A2, A3, A4] toany2stringadd\[UnzipWith4\[In, A1, A2, A3, A4]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../akka/stream/scaladsl/UnzipWith4.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (UnzipWith4\[In, A1, A2, A3, A4], B)ImplicitThis member is added by an implicit conversion from UnzipWith4\[In, A1, A2, A3, A4] toArrowAssoc\[UnzipWith4\[In, A1, A2, A3, A4]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../akka/stream/scaladsl/UnzipWith4.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../akka/stream/scaladsl/UnzipWith4.html#addAttributes(attr:akka.stream.Attributes):akka.stream.Graph[S,M] "Permalink")  def addAttributes(attr: [Attributes](../Attributes.html)): [Graph](../Graph.html)\[[FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4], [NotUsed](../../NotUsed.html)]Add the given attributes to this [Graph](../Graph.html).
...
Definition Classes[Graph](../Graph.html)
7. [**](../../../akka/stream/scaladsl/UnzipWith4.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
8. [**](../../../akka/stream/scaladsl/UnzipWith4.html#async(dispatcher:String,inputBufferSize:Int):akka.stream.Graph[S,M] "Permalink")  def async(dispatcher: String, inputBufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Graph](../Graph.html)\[[FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4], [NotUsed](../../NotUsed.html)]Put an asynchronous boundary around this `Graph`
...
Definition Classes[Graph](../Graph.html)
9. [**](../../../akka/stream/scaladsl/UnzipWith4.html#async(dispatcher:String):akka.stream.Graph[S,M] "Permalink")  def async(dispatcher: String): [Graph](../Graph.html)\[[FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4], [NotUsed](../../NotUsed.html)]Put an asynchronous boundary around this `Graph`
...
Definition Classes[Graph](../Graph.html)
10. [**](../../../akka/stream/scaladsl/UnzipWith4.html#async:akka.stream.Graph[S,M] "Permalink")  def async: [Graph](../Graph.html)\[[FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4], [NotUsed](../../NotUsed.html)]Put an asynchronous boundary around this `Graph`

Put an asynchronous boundary around this `Graph`

Definition Classes[Graph](../Graph.html)
11. [**](../../../akka/stream/scaladsl/UnzipWith4.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
12. [**](../../../akka/stream/scaladsl/UnzipWith4.html#createLogic(inheritedAttributes:akka.stream.Attributes):akka.stream.stage.GraphStageLogic "Permalink")  def createLogic(inheritedAttributes: [Attributes](../Attributes.html)): [GraphStageLogic](../stage/GraphStageLogic.html)Definition ClassesUnzipWith4 → [GraphStage](../stage/GraphStage.html)
13. [**](../../../akka/stream/scaladsl/UnzipWith4.html#createLogicAndMaterializedValue(inheritedAttributes:akka.stream.Attributes):(akka.stream.stage.GraphStageLogic,akka.NotUsed) "Permalink") final  def createLogicAndMaterializedValue(inheritedAttributes: [Attributes](../Attributes.html)): ([GraphStageLogic](../stage/GraphStageLogic.html), [NotUsed](../../NotUsed.html))Definition Classes[GraphStage](../stage/GraphStage.html) → [GraphStageWithMaterializedValue](../stage/GraphStageWithMaterializedValue.html)
14. [**](../../../akka/stream/scaladsl/UnzipWith4.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (UnzipWith4\[In, A1, A2, A3, A4]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): UnzipWith4\[In, A1, A2, A3, A4]ImplicitThis member is added by an implicit conversion from UnzipWith4\[In, A1, A2, A3, A4] toEnsuring\[UnzipWith4\[In, A1, A2, A3, A4]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../../akka/stream/scaladsl/UnzipWith4.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (UnzipWith4\[In, A1, A2, A3, A4]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): UnzipWith4\[In, A1, A2, A3, A4]ImplicitThis member is added by an implicit conversion from UnzipWith4\[In, A1, A2, A3, A4] toEnsuring\[UnzipWith4\[In, A1, A2, A3, A4]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../../akka/stream/scaladsl/UnzipWith4.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): UnzipWith4\[In, A1, A2, A3, A4]ImplicitThis member is added by an implicit conversion from UnzipWith4\[In, A1, A2, A3, A4] toEnsuring\[UnzipWith4\[In, A1, A2, A3, A4]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../../akka/stream/scaladsl/UnzipWith4.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): UnzipWith4\[In, A1, A2, A3, A4]ImplicitThis member is added by an implicit conversion from UnzipWith4\[In, A1, A2, A3, A4] toEnsuring\[UnzipWith4\[In, A1, A2, A3, A4]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
18. [**](../../../akka/stream/scaladsl/UnzipWith4.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../../akka/stream/scaladsl/UnzipWith4.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
20. [**](../../../akka/stream/scaladsl/UnzipWith4.html#getAttributes:akka.stream.Attributes "Permalink")  def getAttributes: [Attributes](../Attributes.html)Definition Classes[Graph](../Graph.html)
21. [**](../../../akka/stream/scaladsl/UnzipWith4.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../../akka/stream/scaladsl/UnzipWith4.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../../akka/stream/scaladsl/UnzipWith4.html#in:akka.stream.Inlet[In] "Permalink")  def in: [Inlet](../Inlet.html)\[In]
24. [**](../../../akka/stream/scaladsl/UnzipWith4.html#initialAttributes:akka.stream.Attributes "Permalink")  def initialAttributes: [Attributes](../Attributes.html)Definition ClassesUnzipWith4 → [GraphStageWithMaterializedValue](../stage/GraphStageWithMaterializedValue.html)
25. [**](../../../akka/stream/scaladsl/UnzipWith4.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
26. [**](../../../akka/stream/scaladsl/UnzipWith4.html#mapMaterializedValue[M2](f:M=>M2):akka.stream.Graph[S,M2] "Permalink")  def mapMaterializedValue\[M2](f: ([NotUsed](../../NotUsed.html)) \=\> M2): [Graph](../Graph.html)\[[FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4], M2]Transform the materialized value of this Graph, leaving all other properties as they were.

Transform the materialized value of this Graph, leaving all other properties as they were.

ffunction to map the graph's materialized value

ImplicitThis member is added by an implicit conversion from UnzipWith4\[In, A1, A2, A3, A4] to[GraphMapMatVal](../Graph$$GraphMapMatVal.html)\[[FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4], [NotUsed](../../NotUsed.html)] performed by method GraphMapMatVal in [akka.stream.Graph](../Graph$.html).Definition Classes[GraphMapMatVal](../Graph$$GraphMapMatVal.html)
27. [**](../../../akka/stream/scaladsl/UnzipWith4.html#named(name:String):akka.stream.Graph[S,M] "Permalink")  def named(name: String): [Graph](../Graph.html)\[[FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4], [NotUsed](../../NotUsed.html)]Specifies the name of the Graph.

Specifies the name of the Graph.
If the name is null or empty the name is ignored, i.e. \#none is returned.

Definition Classes[Graph](../Graph.html)
28. [**](../../../akka/stream/scaladsl/UnzipWith4.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
29. [**](../../../akka/stream/scaladsl/UnzipWith4.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
30. [**](../../../akka/stream/scaladsl/UnzipWith4.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
31. [**](../../../akka/stream/scaladsl/UnzipWith4.html#out0:akka.stream.Outlet[A1] "Permalink")  def out0: [Outlet](../Outlet.html)\[A1]
32. [**](../../../akka/stream/scaladsl/UnzipWith4.html#out1:akka.stream.Outlet[A2] "Permalink")  def out1: [Outlet](../Outlet.html)\[A2]
33. [**](../../../akka/stream/scaladsl/UnzipWith4.html#out2:akka.stream.Outlet[A3] "Permalink")  def out2: [Outlet](../Outlet.html)\[A3]
34. [**](../../../akka/stream/scaladsl/UnzipWith4.html#out3:akka.stream.Outlet[A4] "Permalink")  def out3: [Outlet](../Outlet.html)\[A4]
35. [**](../../../akka/stream/scaladsl/UnzipWith4.html#shape:akka.stream.FanOutShape4[In,A1,A2,A3,A4] "Permalink")  val shape: [FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4]The shape of a graph is all that is externally visible: its inlets and outlets.

The shape of a graph is all that is externally visible: its inlets and outlets.

Definition ClassesUnzipWith4 → [Graph](../Graph.html)
36. [**](../../../akka/stream/scaladsl/UnzipWith4.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
37. [**](../../../akka/stream/scaladsl/UnzipWith4.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesUnzipWith4 → AnyRef → Any
38. [**](../../../akka/stream/scaladsl/UnzipWith4.html#unzipper:In=>(A1,A2,A3,A4) "Permalink")  val unzipper: (In) \=\> (A1, A2, A3, A4)
39. [**](../../../akka/stream/scaladsl/UnzipWith4.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
40. [**](../../../akka/stream/scaladsl/UnzipWith4.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
41. [**](../../../akka/stream/scaladsl/UnzipWith4.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
42. [**](../../../akka/stream/scaladsl/UnzipWith4.html#withAttributes(attr:akka.stream.Attributes):akka.stream.Graph[S,M] "Permalink") final  def withAttributes(attr: [Attributes](../Attributes.html)): [Graph](../Graph.html)\[[FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4], [NotUsed](../../NotUsed.html)]Replace the attributes of this [Flow](Flow.html) with the given ones.
...
1. [**](../../../akka/stream/scaladsl/UnzipWith4.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../akka/stream/scaladsl/UnzipWith4.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from UnzipWith4\[In, A1, A2, A3, A4] toStringFormat\[UnzipWith4\[In, A1, A2, A3, A4]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../akka/stream/scaladsl/UnzipWith4.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (UnzipWith4\[In, A1, A2, A3, A4], B)ImplicitThis member is added by an implicit conversion from UnzipWith4\[In, A1, A2, A3, A4] toArrowAssoc\[UnzipWith4\[In, A1, A2, A3, A4]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [GraphStage](../stage/GraphStage.html)\[[FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4]]

### Inherited from [GraphStageWithMaterializedValue](../stage/GraphStageWithMaterializedValue.html)\[[FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4], [NotUsed](../../NotUsed.html)]

### Inherited from [Graph](../Graph.html)\[[FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4], [NotUsed](../../NotUsed.html)]

### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion GraphMapMatVal fromUnzipWith4\[In, A1, A2, A3, A4] to [GraphMapMatVal](../Graph$$GraphMapMatVal.html)\[[FanOutShape4](../FanOutShape4.html)\[In, A1, A2, A3, A4], [NotUsed](../../NotUsed.html)]

### Inherited by implicit conversion any2stringadd fromUnzipWith4\[In, A1, A2, A3, A4] to any2stringadd\[UnzipWith4\[In, A1, A2, A3, A4]]

### Inherited by implicit conversion StringFormat fromUnzipWith4\[In, A1, A2, A3, A4] to StringFormat\[UnzipWith4\[In, A1, A2, A3, A4]]

### Inherited by implicit conversion Ensuring fromUnzipWith4\[In, A1, A2, A3, A4] to Ensuring\[UnzipWith4\[In, A1, A2, A3, A4]]

### Inherited by implicit conversion ArrowAssoc fromUnzipWith4\[In, A1, A2, A3, A4] to ArrowAssoc\[UnzipWith4\[In, A1, A2, A3, A4]]
...
- https://doc.akka.io/api/akka-core/2.10.11/akka/stream/FanOutShape4.html
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/stream/scaladsl/UnzipWith4.html](https://doc.akka.io/api/akka-core/2.10.11/akka/stream/scaladsl/UnzipWith4.html)*