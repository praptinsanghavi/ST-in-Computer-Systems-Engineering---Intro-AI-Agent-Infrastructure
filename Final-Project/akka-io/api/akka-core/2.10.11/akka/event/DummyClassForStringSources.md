---
description: Akka 2.10.11 - akka.event.DummyClassForStringSources
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:37:33Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/event/DummyClassForStringSources.html
title: Akka 2.10.11 - akka.event.DummyClassForStringSources
---

# Akka 2.10.11 - akka.event.DummyClassForStringSources

> **Summary:** Akka 2.10.11 - akka.event.DummyClassForStringSources
...
# DummyClassForStringSources[**](../../akka/event/DummyClassForStringSources.html "Permalink")

### 

#### class DummyClassForStringSources extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
...
1. [**](../../akka/event/DummyClassForStringSources.html#<init>():akka.event.DummyClassForStringSources "Permalink")  new DummyClassForStringSources()
### Value Members

1. [**](../../akka/event/DummyClassForStringSources.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/event/DummyClassForStringSources.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/event/DummyClassForStringSources.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from DummyClassForStringSources toany2stringadd\[DummyClassForStringSources] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/event/DummyClassForStringSources.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (DummyClassForStringSources, B)ImplicitThis member is added by an implicit conversion from DummyClassForStringSources toArrowAssoc\[DummyClassForStringSources] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/event/DummyClassForStringSources.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/event/DummyClassForStringSources.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/event/DummyClassForStringSources.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/event/DummyClassForStringSources.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (DummyClassForStringSources) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): DummyClassForStringSourcesImplicitThis member is added by an implicit conversion from DummyClassForStringSources toEnsuring\[DummyClassForStringSources] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/event/DummyClassForStringSources.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (DummyClassForStringSources) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): DummyClassForStringSourcesImplicitThis member is added by an implicit conversion from DummyClassForStringSources toEnsuring\[DummyClassForStringSources] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/event/DummyClassForStringSources.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): DummyClassForStringSourcesImplicitThis member is added by an implicit conversion from DummyClassForStringSources toEnsuring\[DummyClassForStringSources] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/event/DummyClassForStringSources.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): DummyClassForStringSourcesImplicitThis member is added by an implicit conversion from DummyClassForStringSources toEnsuring\[DummyClassForStringSources] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/event/DummyClassForStringSources.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/event/DummyClassForStringSources.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/event/DummyClassForStringSources.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/event/DummyClassForStringSources.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/event/DummyClassForStringSources.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/event/DummyClassForStringSources.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/event/DummyClassForStringSources.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/event/DummyClassForStringSources.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/event/DummyClassForStringSources.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/event/DummyClassForStringSources.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/event/DummyClassForStringSources.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/event/DummyClassForStringSources.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/event/DummyClassForStringSources.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/event/DummyClassForStringSources.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/event/DummyClassForStringSources.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from DummyClassForStringSources toStringFormat\[DummyClassForStringSources] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
...
### Inherited by implicit conversion any2stringadd fromDummyClassForStringSources to any2stringadd\[DummyClassForStringSources]

### Inherited by implicit conversion StringFormat fromDummyClassForStringSources to StringFormat\[DummyClassForStringSources]

### Inherited by implicit conversion Ensuring fromDummyClassForStringSources to Ensuring\[DummyClassForStringSources]

### Inherited by implicit conversion ArrowAssoc fromDummyClassForStringSources to ArrowAssoc\[DummyClassForStringSources]
...
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$LogEvent.html
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/event/DummyClassForStringSources.html](https://doc.akka.io/api/akka-core/2.10.11/akka/event/DummyClassForStringSources.html)*