---
description: Akka 2.10.11 - akka.event.Logging.LogLevel
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:38:09Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/event/Logging$$LogLevel.html
title: Akka 2.10.11 - akka.event.Logging.LogLevel
---

# Akka 2.10.11 - akka.event.Logging.LogLevel

> **Summary:** Akka 2.10.11 - akka.event.Logging.LogLevel
...
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Debug$.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Debug.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Debug2.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Debug3.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$DefaultLogger.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Error$.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Error.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Error2.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Error3.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Info$.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Info.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Info2.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Info3.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$InitializeLogger.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$LogEvent$.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$LogEvent.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$LogEventException.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$LogEventWithCause.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$LogEventWithMarker.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$LogLevel.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$LoggerException.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$LoggerInitializationException.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$LoggerInitialized$.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$LoggerInitialized.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$StandardOutLogger.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$StdOutLogger$.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$StdOutLogger.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Warning$.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Warning.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Warning2.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Warning3.html
- https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$Warning4.html
...
---
*Source: [https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$LogLevel.html](https://doc.akka.io/api/akka-core/2.10.11/akka/event/Logging$$LogLevel.html)*