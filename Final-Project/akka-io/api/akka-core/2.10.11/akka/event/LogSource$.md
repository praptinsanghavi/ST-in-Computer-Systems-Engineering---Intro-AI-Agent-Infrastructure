...
scraped_at: '2026-04-06T02:37:39Z'
section: api
site: akka-io
...
- anything else gives compile error unless implicit [akka.event.LogSource](LogSource.html) is in scope for it
Source[Logging.scala](https://github.com/akka/akka-core/tree/v2.10.11/akka-actor/src/main/scala/akka/event/Logging.scala#L304)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. LogSource
2. AnyRef
