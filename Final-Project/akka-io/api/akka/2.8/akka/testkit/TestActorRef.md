---
description: Akka 2.8.9 - akka.testkit.TestActorRef
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:30:03Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/testkit/TestActorRef.html
title: Akka 2.8.9 - akka.testkit.TestActorRef
---

# Akka 2.8.9 - akka.testkit.TestActorRef

> **Summary:** Akka 2.8.9 - akka.testkit.TestActorRef
...
Annotations@nowarn() Source[TestActorRef.scala](https://github.com/akka/akka/tree/v2.8.9//akka-testkit/src/main/scala/akka/testkit/TestActorRef.scala#L25)Since1\.1

Linear SupertypesLocalActorRef, LocalRef, ActorRefScope, ActorRefWithCell, InternalActorRef, [ScalaActorRef](../actor/ScalaActorRef.html), [ActorRef](../actor/ActorRef.html), [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [Comparable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Comparable.html#java.lang.Comparable)\[[ActorRef](../actor/ActorRef.html)], [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)Known Subclasses[TestFSMRef](TestFSMRef.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. TestActorRef
2. LocalActorRef
...
1. [**](../../akka/testkit/TestActorRef.html#!(message:Any)(implicitsender:akka.actor.ActorRef):Unit "Permalink")  def !(message: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any))(implicit sender: [ActorRef](../actor/ActorRef.html) \= [Actor.noSender](../actor/Actor$.html)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Sends a one\-way asynchronous message.
...
2. [**](../../akka/testkit/TestActorRef.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
3. [**](../../akka/testkit/TestActorRef.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
6. [**](../../akka/testkit/TestActorRef.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
9. [**](../../akka/testkit/TestActorRef.html#children:scala.collection.immutable.Iterable[akka.actor.ActorRef] "Permalink")  def children: [Iterable](https://www.scala-lang.org/api/2.13.11/scala/collection/immutable/Iterable.html#scala.collection.immutable.Iterable)\[[ActorRef](../actor/ActorRef.html)]Definition ClassesLocalActorRef → ActorRefWithCell
10. [**](../../akka/testkit/TestActorRef.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
11. [**](../../akka/testkit/TestActorRef.html#compareTo(other:akka.actor.ActorRef):Int "Permalink") final  def compareTo(other: [ActorRef](../actor/ActorRef.html)): [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)Comparison takes path and the unique id of the actor cell into account.
...
13. [**](../../akka/testkit/TestActorRef.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (TestActorRef\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): TestActorRef\[T]ImplicitThis member is added by an implicit conversion from TestActorRef\[T] toEnsuring\[TestActorRef\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/testkit/TestActorRef.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (TestActorRef\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)): TestActorRef\[T]ImplicitThis member is added by an implicit conversion from TestActorRef\[T] toEnsuring\[TestActorRef\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/testkit/TestActorRef.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): TestActorRef\[T]ImplicitThis member is added by an implicit conversion from TestActorRef\[T] toEnsuring\[TestActorRef\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/testkit/TestActorRef.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)): TestActorRef\[T]ImplicitThis member is added by an implicit conversion from TestActorRef\[T] toEnsuring\[TestActorRef\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../akka/testkit/TestActorRef.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/testkit/TestActorRef.html#equals(that:Any):Boolean "Permalink") final  def equals(that: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Equals takes path and the unique id of the actor cell into account.

Equals takes path and the unique id of the actor cell into account.

Definition Classes[ActorRef](../actor/ActorRef.html) → AnyRef → Any
19. [**](../../akka/testkit/TestActorRef.html#forward(message:Any)(implicitcontext:akka.actor.ActorContext):Unit "Permalink")  def forward(message: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any))(implicit context: [ActorContext](../actor/ActorContext.html)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Forwards the message and passes the original sender actor as the sender.
...
24. [**](../../akka/testkit/TestActorRef.html#hashCode():Int "Permalink") final  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)Definition Classes[ActorRef](../actor/ActorRef.html) → AnyRef → Any
25. [**](../../akka/testkit/TestActorRef.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAny
26. [**](../../akka/testkit/TestActorRef.html#isLocal:Boolean "Permalink") final  def isLocal: [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesLocalRef → ActorRefScope
27. [**](../../akka/testkit/TestActorRef.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
...
29. [**](../../akka/testkit/TestActorRef.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
30. [**](../../akka/testkit/TestActorRef.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
...
Definition ClassesLocalActorRef → InternalActorRef
34. [**](../../akka/testkit/TestActorRef.html#receive(o:Any,sender:akka.actor.ActorRef):Unit "Permalink")  def receive(o: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any), sender: [ActorRef](../actor/ActorRef.html)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Directly inject messages into actor receive behavior.

Directly inject messages into actor receive behavior. Any exceptions
thrown will be available to you, while still being able to use
become/unbecome.
35. [**](../../akka/testkit/TestActorRef.html#receive(o:Any):Unit "Permalink")  def receive(o: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Directly inject messages into actor receive behavior.

Directly inject messages into actor receive behavior. Any exceptions
thrown will be available to you, while still being able to use
become/unbecome.
36. [**](../../akka/testkit/TestActorRef.html#restart(cause:Throwable):Unit "Permalink")  def restart(cause: Throwable): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesLocalActorRef → InternalActorRef
37. [**](../../akka/testkit/TestActorRef.html#resume(causedByFailure:Throwable):Unit "Permalink")  def resume(causedByFailure: Throwable): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Resumes a suspended actor.

Resumes a suspended actor.

Definition ClassesLocalActorRef → InternalActorRef
38. [**](../../akka/testkit/TestActorRef.html#sendSystemMessage(message:akka.dispatch.sysmsg.SystemMessage):Unit "Permalink")  def sendSystemMessage(message: SystemMessage): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesLocalActorRef → InternalActorRef
39. [**](../../akka/testkit/TestActorRef.html#start():Unit "Permalink")  def start(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Starts the actor after initialization.

Starts the actor after initialization.

Definition ClassesLocalActorRef → InternalActorRef
40. [**](../../akka/testkit/TestActorRef.html#stop():Unit "Permalink")  def stop(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Shuts down the actor and its message queue

Shuts down the actor and its message queue

Definition ClassesLocalActorRef → InternalActorRef
41. [**](../../akka/testkit/TestActorRef.html#suspend():Unit "Permalink")  def suspend(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Suspends the actor so that it will not process messages until resumed.
...
43. [**](../../akka/testkit/TestActorRef.html#tell(msg:Any,sender:akka.actor.ActorRef):Unit "Permalink") final  def tell(msg: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any), sender: [ActorRef](../actor/ActorRef.html)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Sends the specified message to this ActorRef, i.e.
...
48. [**](../../akka/testkit/TestActorRef.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
49. [**](../../akka/testkit/TestActorRef.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
50. [**](../../akka/testkit/TestActorRef.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
returnsthe same ActorRef that is provided to it, to allow for cleaner invocations
52. [**](../../akka/testkit/TestActorRef.html#writeReplace():AnyRef "Permalink")  def writeReplace(): [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)Attributesprotected Definition ClassesLocalActorRefAnnotations@throws(classOf\[java.io.ObjectStreamException])
### Shadowed Implicit Value Members

1. [**](../../akka/testkit/TestActorRef.html#!(message:Any)(implicitsender:akka.actor.ActorRef):Unit "Permalink")  def !(message: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any))(implicit sender: [ActorRef](../actor/ActorRef.html) \= [Actor.noSender](../actor/Actor$.html)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Scala API: Sends a one\-way asynchronous message.
...
```
Definition Classes[ActorRef](../actor/ActorRef.html)
2. [**](../../akka/testkit/TestActorRef.html#!(message:Any)(implicitsender:akka.actor.ActorRef):Unit "Permalink")  def !(message: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any))(implicit sender: [ActorRef](../actor/ActorRef.html) \= [Actor.noSender](../actor/Actor$.html)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Sends a one\-way asynchronous message.
...
3. [**](../../akka/testkit/TestActorRef.html#compareTo(other:akka.actor.ActorRef):Int "Permalink") final  def compareTo(other: [ActorRef](../actor/ActorRef.html)): [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)Comparison takes path and the unique id of the actor cell into account.
...
```
Definition Classes[ActorRef](../actor/ActorRef.html) → Comparable
4. [**](../../akka/testkit/TestActorRef.html#equals(that:Any):Boolean "Permalink") final  def equals(that: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Equals takes path and the unique id of the actor cell into account.
...
```
Definition Classes[ActorRef](../actor/ActorRef.html)
8. [**](../../akka/testkit/TestActorRef.html#tell(msg:Any,sender:akka.actor.ActorRef):Unit "Permalink") final  def tell(msg: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any), sender: [ActorRef](../actor/ActorRef.html)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Sends the specified message to this ActorRef, i.e.
...
1. [**](../../akka/testkit/TestActorRef.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated @Deprecated Deprecated
...
- https://doc.akka.io/api/akka/2.8/akka/actor/ScalaActorRef.html
- https://doc.akka.io/api/akka/2.8/akka/actor/index.html
- https://doc.akka.io/api/akka/2.8/akka/dispatch/MessageDispatcher.html
- https://doc.akka.io/api/akka/2.8/akka/index.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/CallingThreadDispatcher$.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/CallingThreadDispatcher.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/CallingThreadDispatcherConfigurator.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/CallingThreadMailbox.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/CustomEventFilter.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/DeadLettersFilter$.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/DeadLettersFilter.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/DebugFilter.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/DefaultTimeout.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/ErrorFilter.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/EventFilter$.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/EventFilter.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/ExplicitlyTriggeredScheduler.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/ImplicitSender.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/InfoFilter.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/JavaSerializable.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/SocketUtil$.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestActor$.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestActor.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestActorRef$.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestActorRef.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestActors$.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestBarrier$.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestBarrier.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestBarrierTimeoutException.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestEvent$.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestEvent.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestEventListener.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestException.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestFSMRef$.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestFSMRef.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestJavaSerializer.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestKit$.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestKit.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestKitBase.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestKitExtension$.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestKitSettings.html
- https://doc.akka.io/api/akka/2.8/akka/testkit/TestLatch$.html

---
*Source: [https://doc.akka.io/api/akka/2.8/akka/testkit/TestActorRef.html](https://doc.akka.io/api/akka/2.8/akka/testkit/TestActorRef.html)*