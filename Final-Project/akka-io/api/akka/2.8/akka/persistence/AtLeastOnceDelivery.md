---
description: Akka 2.8.9 - akka.persistence.AtLeastOnceDelivery
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:28:41Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/persistence/AtLeastOnceDelivery.html
title: Akka 2.8.9 - akka.persistence.AtLeastOnceDelivery
---

# Akka 2.8.9 - akka.persistence.AtLeastOnceDelivery

> **Summary:** Akka 2.8.9 - akka.persistence.AtLeastOnceDelivery
...
1. [**](../../akka/persistence/AtLeastOnceDelivery.html#Receive=akka.actor.Actor.Receive "Permalink")  type Receive \= [PartialFunction](https://www.scala-lang.org/api/2.13.11/scala/PartialFunction.html#scala.PartialFunction)\[[Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any), [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)]Definition Classes[Actor](../actor/Actor.html)
...
1. [**](../../akka/persistence/AtLeastOnceDelivery.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/persistence/AtLeastOnceDelivery.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
5. [**](../../akka/persistence/AtLeastOnceDelivery.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/persistence/AtLeastOnceDelivery.html#aroundPostRestart(reason:Throwable):Unit "Permalink")  def aroundPostRestart(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)INTERNAL API.

INTERNAL API.

Attributesprotected\[[akka](../index.html)] Definition ClassesEventsourced → [Actor](../actor/Actor.html)
7. [**](../../akka/persistence/AtLeastOnceDelivery.html#aroundPostStop():Unit "Permalink")  def aroundPostStop(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)INTERNAL API
...
8. [**](../../akka/persistence/AtLeastOnceDelivery.html#aroundPreRestart(reason:Throwable,message:Option[Any]):Unit "Permalink")  def aroundPreRestart(reason: Throwable, message: [Option](https://www.scala-lang.org/api/2.13.11/scala/Option.html#scala.Option)\[[Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)]): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)INTERNAL API

INTERNAL API

Attributesprotected\[[akka](../index.html)] Definition Classes[AtLeastOnceDeliveryLike](AtLeastOnceDeliveryLike.html) → Eventsourced → [Actor](../actor/Actor.html)
9. [**](../../akka/persistence/AtLeastOnceDelivery.html#aroundPreStart():Unit "Permalink")  def aroundPreStart(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)INTERNAL API.

INTERNAL API.

Attributesprotected\[[akka](../index.html)] Definition ClassesEventsourced → [Actor](../actor/Actor.html)
10. [**](../../akka/persistence/AtLeastOnceDelivery.html#aroundReceive(receive:AtLeastOnceDeliveryLike.this.Receive,message:Any):Unit "Permalink")  def aroundReceive(receive: [Receive](#Receive=akka.actor.Actor.Receive), message: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)INTERNAL API
...
12. [**](../../akka/persistence/AtLeastOnceDelivery.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
13. [**](../../akka/persistence/AtLeastOnceDelivery.html#confirmDelivery(deliveryId:Long):Boolean "Permalink")  def confirmDelivery(deliveryId: [Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Call this method when a message has been confirmed by the destination,
...
15. [**](../../akka/persistence/AtLeastOnceDelivery.html#defer[A](event:A)(handler:A=>Unit):Unit "Permalink")  def defer\[A](event: A)(handler: (A) \=\> [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Defer the handler execution until all pending handlers have been executed.
...
Definition Classes[PersistentActor](PersistentActor.html)
17. [**](../../akka/persistence/AtLeastOnceDelivery.html#deleteMessages(toSequenceNr:Long):Unit "Permalink")  def deleteMessages(toSequenceNr: [Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Permanently deletes all persistent messages with sequence numbers less than or equal `toSequenceNr`.
...
Definition ClassesEventsourced
18. [**](../../akka/persistence/AtLeastOnceDelivery.html#deleteSnapshot(sequenceNr:Long):Unit "Permalink")  def deleteSnapshot(sequenceNr: [Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Deletes the snapshot identified by `sequenceNr`.
...
19. [**](../../akka/persistence/AtLeastOnceDelivery.html#deleteSnapshots(criteria:akka.persistence.SnapshotSelectionCriteria):Unit "Permalink")  def deleteSnapshots(criteria: [SnapshotSelectionCriteria](SnapshotSelectionCriteria.html)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Deletes all snapshots matching `criteria`.
...
Definition Classes[Snapshotter](Snapshotter.html)
20. [**](../../akka/persistence/AtLeastOnceDelivery.html#deliver(destination:akka.actor.ActorSelection)(deliveryIdToMessage:Long=>Any):Unit "Permalink")  def deliver(destination: [ActorSelection](../actor/ActorSelection.html))(deliveryIdToMessage: ([Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long)) \=\> [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Scala API: Send the message created by the `deliveryIdToMessage` function to
...
This method will throw [AtLeastOnceDelivery.MaxUnconfirmedMessagesExceededException](AtLeastOnceDelivery$$MaxUnconfirmedMessagesExceededException.html)
if [\#numberOfUnconfirmed](#numberOfUnconfirmed:Int) is greater than or equal to [\#maxUnconfirmedMessages](#maxUnconfirmedMessages:Int).
22. [**](../../akka/persistence/AtLeastOnceDelivery.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (AtLeastOnceDelivery) \=\> [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): AtLeastOnceDeliveryImplicitThis member is added by an implicit conversion from AtLeastOnceDelivery toEnsuring\[AtLeastOnceDelivery] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
23. [**](../../akka/persistence/AtLeastOnceDelivery.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (AtLeastOnceDelivery) \=\> [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)): AtLeastOnceDeliveryImplicitThis member is added by an implicit conversion from AtLeastOnceDelivery toEnsuring\[AtLeastOnceDelivery] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
24. [**](../../akka/persistence/AtLeastOnceDelivery.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): AtLeastOnceDeliveryImplicitThis member is added by an implicit conversion from AtLeastOnceDelivery toEnsuring\[AtLeastOnceDelivery] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
25. [**](../../akka/persistence/AtLeastOnceDelivery.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)): AtLeastOnceDeliveryImplicitThis member is added by an implicit conversion from AtLeastOnceDelivery toEnsuring\[AtLeastOnceDelivery] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
26. [**](../../akka/persistence/AtLeastOnceDelivery.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
27. [**](../../akka/persistence/AtLeastOnceDelivery.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
30. [**](../../akka/persistence/AtLeastOnceDelivery.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
...
32. [**](../../akka/persistence/AtLeastOnceDelivery.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAny
...
Definition Classes[PersistenceIdentity](PersistenceIdentity.html)
34. [**](../../akka/persistence/AtLeastOnceDelivery.html#lastSequenceNr:Long "Permalink")  def lastSequenceNr: [Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long)Highest received sequence number so far or `0L` if this actor hasn't replayed
...
Definition ClassesEventsourced
35. [**](../../akka/persistence/AtLeastOnceDelivery.html#loadSnapshot(persistenceId:String,criteria:akka.persistence.SnapshotSelectionCriteria,toSequenceNr:Long):Unit "Permalink")  def loadSnapshot(persistenceId: String, criteria: [SnapshotSelectionCriteria](SnapshotSelectionCriteria.html), toSequenceNr: [Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Instructs the snapshot store to load the specified snapshot and send it via an [SnapshotOffer](SnapshotOffer.html)
...
Definition Classes[Snapshotter](Snapshotter.html)
36. [**](../../akka/persistence/AtLeastOnceDelivery.html#maxUnconfirmedMessages:Int "Permalink")  def maxUnconfirmedMessages: [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)Maximum number of unconfirmed messages that this actor is allowed to hold in memory.
...
Definition Classes[AtLeastOnceDeliveryLike](AtLeastOnceDeliveryLike.html)
37. [**](../../akka/persistence/AtLeastOnceDelivery.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
38. [**](../../akka/persistence/AtLeastOnceDelivery.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
39. [**](../../akka/persistence/AtLeastOnceDelivery.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
40. [**](../../akka/persistence/AtLeastOnceDelivery.html#numberOfUnconfirmed:Int "Permalink")  def numberOfUnconfirmed: [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)Number of messages that have not been confirmed yet.

Number of messages that have not been confirmed yet.

Definition Classes[AtLeastOnceDeliveryLike](AtLeastOnceDeliveryLike.html)
41. [**](../../akka/persistence/AtLeastOnceDelivery.html#onPersistFailure(cause:Throwable,event:Any,seqNr:Long):Unit "Permalink")  def onPersistFailure(cause: Throwable, event: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any), seqNr: [Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Called when persist fails.
...
Attributesprotected Definition ClassesEventsourcedAnnotations@[InternalStableApi](../annotation/InternalStableApi.html)()
43. [**](../../akka/persistence/AtLeastOnceDelivery.html#onRecoveryFailure(cause:Throwable,event:Option[Any]):Unit "Permalink")  def onRecoveryFailure(cause: Throwable, event: [Option](https://www.scala-lang.org/api/2.13.11/scala/Option.html#scala.Option)\[[Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)]): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Called whenever a message replay fails.
...
44. [**](../../akka/persistence/AtLeastOnceDelivery.html#persist[A](event:A)(handler:A=>Unit):Unit "Permalink")  def persist\[A](event: A)(handler: (A) \=\> [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Asynchronously persists `event`.
...
Definition Classes[PersistentActor](PersistentActor.html)
45. [**](../../akka/persistence/AtLeastOnceDelivery.html#persistAll[A](events:Seq[A])(handler:A=>Unit):Unit "Permalink")  def persistAll\[A](events: [Seq](https://www.scala-lang.org/api/2.13.11/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[A])(handler: (A) \=\> [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Asynchronously persists `events` in specified order.
...
Definition Classes[PersistentActor](PersistentActor.html)
46. [**](../../akka/persistence/AtLeastOnceDelivery.html#persistAllAsync[A](events:Seq[A])(handler:A=>Unit):Unit "Permalink")  def persistAllAsync\[A](events: [Seq](https://www.scala-lang.org/api/2.13.11/scala/collection/immutable/Seq.html#scala.collection.immutable.Seq)\[A])(handler: (A) \=\> [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Asynchronously persists `events` in specified order.
...
Definition Classes[PersistentActor](PersistentActor.html)
47. [**](../../akka/persistence/AtLeastOnceDelivery.html#persistAsync[A](event:A)(handler:A=>Unit):Unit "Permalink")  def persistAsync\[A](event: A)(handler: (A) \=\> [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Asynchronously persists `event`.
...
Definition Classes[PersistentActor](PersistentActor.html)
48. [**](../../akka/persistence/AtLeastOnceDelivery.html#postRestart(reason:Throwable):Unit "Permalink")  def postRestart(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)User overridable callback: By default it calls `preStart()`.
...
49. [**](../../akka/persistence/AtLeastOnceDelivery.html#postStop():Unit "Permalink")  def postStop(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit) Overridden callback.
...
50. [**](../../akka/persistence/AtLeastOnceDelivery.html#preRestart(reason:Throwable,message:Option[Any]):Unit "Permalink")  def preRestart(reason: Throwable, message: [Option](https://www.scala-lang.org/api/2.13.11/scala/Option.html#scala.Option)\[[Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)]): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit) Overridden callback.
...
Definition Classes[UnrestrictedStash](../actor/UnrestrictedStash.html) → [Actor](../actor/Actor.html)Annotations@throws(classOf\[Exception])
51. [**](../../akka/persistence/AtLeastOnceDelivery.html#preStart():Unit "Permalink")  def preStart(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)User overridable callback.
...
54. [**](../../akka/persistence/AtLeastOnceDelivery.html#recoveryFinished:Boolean "Permalink")  def recoveryFinished: [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Returns `true` if this persistent actor has successfully finished recovery.

Returns `true` if this persistent actor has successfully finished recovery.

Definition ClassesEventsourced
55. [**](../../akka/persistence/AtLeastOnceDelivery.html#recoveryRunning:Boolean "Permalink")  def recoveryRunning: [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Returns `true` if this persistent actor is currently recovering.

Returns `true` if this persistent actor is currently recovering.

Definition ClassesEventsourced
56. [**](../../akka/persistence/AtLeastOnceDelivery.html#redeliverInterval:scala.concurrent.duration.FiniteDuration "Permalink")  def redeliverInterval: [FiniteDuration](https://www.scala-lang.org/api/2.13.11/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)Interval between redelivery attempts.
...
Definition Classes[AtLeastOnceDeliveryLike](AtLeastOnceDeliveryLike.html)
57. [**](../../akka/persistence/AtLeastOnceDelivery.html#redeliveryBurstLimit:Int "Permalink")  def redeliveryBurstLimit: [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)Maximum number of unconfirmed messages that will be sent at each redelivery burst
...
Definition Classes[AtLeastOnceDeliveryLike](AtLeastOnceDeliveryLike.html)
58. [**](../../akka/persistence/AtLeastOnceDelivery.html#saveSnapshot(snapshot:Any):Unit "Permalink")  def saveSnapshot(snapshot: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Saves a `snapshot` of this snapshotter's state.
...
Definition Classes[Actor](../actor/Actor.html)
61. [**](../../akka/persistence/AtLeastOnceDelivery.html#setDeliverySnapshot(snapshot:akka.persistence.AtLeastOnceDelivery.AtLeastOnceDeliverySnapshot):Unit "Permalink")  def setDeliverySnapshot(snapshot: [AtLeastOnceDeliverySnapshot](AtLeastOnceDelivery$$AtLeastOnceDeliverySnapshot.html)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)If snapshot from [\#getDeliverySnapshot](#getDeliverySnapshot:akka.persistence.AtLeastOnceDelivery.AtLeastOnceDeliverySnapshot) was saved it will be received during recovery
...
Definition Classes[PersistenceIdentity](PersistenceIdentity.html)
63. [**](../../akka/persistence/AtLeastOnceDelivery.html#snapshotSequenceNr:Long "Permalink")  def snapshotSequenceNr: [Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long)Returns `lastSequenceNr`.
...
Definition ClassesEventsourced → [Snapshotter](Snapshotter.html)
65. [**](../../akka/persistence/AtLeastOnceDelivery.html#stash():Unit "Permalink")  def stash(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit) Adds the current message (the message that the actor received last) to the
 actor's stash.
...
69. [**](../../akka/persistence/AtLeastOnceDelivery.html#unhandled(message:Any):Unit "Permalink")  def unhandled(message: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)User overridable callback.
...
70. [**](../../akka/persistence/AtLeastOnceDelivery.html#unstashAll():Unit "Permalink")  def unstashAll(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit) Prepends all messages in the stash to the mailbox, and then clears the stash.
...
71. [**](../../akka/persistence/AtLeastOnceDelivery.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
72. [**](../../akka/persistence/AtLeastOnceDelivery.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
73. [**](../../akka/persistence/AtLeastOnceDelivery.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
74. [**](../../akka/persistence/AtLeastOnceDelivery.html#warnAfterNumberOfUnconfirmedAttempts:Int "Permalink")  def warnAfterNumberOfUnconfirmedAttempts: [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)After this number of delivery attempts an [AtLeastOnceDelivery.UnconfirmedWarning](AtLeastOnceDelivery$$UnconfirmedWarning.html) message
...
1. [**](../../akka/persistence/AtLeastOnceDelivery.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated @Deprecated Deprecated
...
- https://doc.akka.io/api/akka/2.8/akka/actor/AbstractActor$$ActorContext.html
...
- https://doc.akka.io/api/akka/2.8/akka/actor/DeathPactException.html
- https://doc.akka.io/api/akka/2.8/akka/actor/Stash.html
- https://doc.akka.io/api/akka/2.8/akka/actor/SupervisorStrategy.html
- https://doc.akka.io/api/akka/2.8/akka/actor/Terminated.html
- https://doc.akka.io/api/akka/2.8/akka/actor/UnhandledMessage.html
- https://doc.akka.io/api/akka/2.8/akka/actor/UnrestrictedStash.html
- https://doc.akka.io/api/akka/2.8/akka/annotation/InternalStableApi.html
...
---
*Source: [https://doc.akka.io/api/akka/2.8/akka/persistence/AtLeastOnceDelivery.html](https://doc.akka.io/api/akka/2.8/akka/persistence/AtLeastOnceDelivery.html)*