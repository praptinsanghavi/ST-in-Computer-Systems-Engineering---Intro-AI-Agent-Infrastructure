---
description: Akka 2.8.9 - akka.persistence.typed.crdt
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:27:44Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/persistence/typed/crdt/index.html
title: Akka 2.8.9 - akka.persistence.typed.crdt
---

# Akka 2.8.9 - akka.persistence.typed.crdt

> **Summary:** Akka 2.8.9 - akka.persistence.typed.crdt
...
1. [**](../../../../akka/persistence/typed/crdt/Counter.html "Permalink") final  case class [Counter](Counter.html)(value: BigInt) extends [OpCrdt](OpCrdt.html)\[[Updated](Counter$$Updated.html)] with [Product](https://www.scala-lang.org/api/2.13.11/scala/Product.html#scala.Product) with Serializable
2. [**](../../../../akka/persistence/typed/crdt/LwwTime.html "Permalink") final  case class [LwwTime](LwwTime.html "Utility class for comparing timestamp replica identifier when implementing last-writer wins.")(timestamp: [Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long), originReplica: [ReplicaId](../ReplicaId.html)) extends [Product](https://www.scala-lang.org/api/2.13.11/scala/Product.html#scala.Product) with SerializableUtility class for comparing timestamp replica
...
4. [**](../../../../akka/persistence/typed/crdt/OpCrdt.html "Permalink")  trait [OpCrdt](OpCrdt.html)\[Operation] extends [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)Annotations@[DoNotInherit](../../../annotation/DoNotInherit.html)()
### Value Members
...
- https://doc.akka.io/api/akka/2.8/akka/persistence/typed/crdt/Counter$$Updated.html
...
- https://doc.akka.io/api/akka/2.8/akka/persistence/typed/crdt/ORSet$$DeltaOp.html
- https://doc.akka.io/api/akka/2.8/akka/persistence/typed/crdt/ORSet$.html
- https://doc.akka.io/api/akka/2.8/akka/persistence/typed/crdt/ORSet.html
- https://doc.akka.io/api/akka/2.8/akka/persistence/typed/crdt/OpCrdt.html
...
---
*Source: [https://doc.akka.io/api/akka/2.8/akka/persistence/typed/crdt/index.html](https://doc.akka.io/api/akka/2.8/akka/persistence/typed/crdt/index.html)*