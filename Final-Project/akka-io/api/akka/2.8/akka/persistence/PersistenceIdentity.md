---
description: Akka 2.8.9 - akka.persistence.PersistenceIdentity
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:30:08Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/persistence/PersistenceIdentity.html
title: Akka 2.8.9 - akka.persistence.PersistenceIdentity
---

# Akka 2.8.9 - akka.persistence.PersistenceIdentity

> **Summary:** Akka 2.8.9 - akka.persistence.PersistenceIdentity
...
# PersistenceIdentity[**](../../akka/persistence/PersistenceIdentity.html "Permalink")

### 

#### trait PersistenceIdentity extends [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)

Identification of [PersistentActor](PersistentActor.html).

Source[Persistence.scala](https://github.com/akka/akka/tree/v2.8.9//akka-persistence/src/main/scala/akka/persistence/Persistence.scala#L67)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)Known Subclasses[AtLeastOnceDelivery](AtLeastOnceDelivery.html), [PersistentActor](PersistentActor.html), [BenchActor](journal/JournalPerfSpec$$BenchActor.html), [PersistentShardCoordinator](../cluster/sharding/PersistentShardCoordinator.html), [AbstractPersistentFSM](fsm/AbstractPersistentFSM.html), [AbstractPersistentLoggingFSM](fsm/AbstractPersistentLoggingFSM.html), [PersistentFSM](fsm/PersistentFSM.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. PersistenceIdentity
2. AnyRef
3. Any
Implicitly  
1. by any2stringadd
...
1. [**](../../akka/persistence/PersistenceIdentity.html#persistenceId:String "Permalink") abstract  def persistenceId: StringId of the persistent entity for which messages should be replayed.
### Concrete Value Members

1. [**](../../akka/persistence/PersistenceIdentity.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/persistence/PersistenceIdentity.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/persistence/PersistenceIdentity.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from PersistenceIdentity toany2stringadd\[PersistenceIdentity] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/persistence/PersistenceIdentity.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (PersistenceIdentity, B)ImplicitThis member is added by an implicit conversion from PersistenceIdentity toArrowAssoc\[PersistenceIdentity] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/persistence/PersistenceIdentity.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/persistence/PersistenceIdentity.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/persistence/PersistenceIdentity.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
8. [**](../../akka/persistence/PersistenceIdentity.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (PersistenceIdentity) \=\> [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): PersistenceIdentityImplicitThis member is added by an implicit conversion from PersistenceIdentity toEnsuring\[PersistenceIdentity] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/persistence/PersistenceIdentity.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (PersistenceIdentity) \=\> [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)): PersistenceIdentityImplicitThis member is added by an implicit conversion from PersistenceIdentity toEnsuring\[PersistenceIdentity] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/persistence/PersistenceIdentity.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): PersistenceIdentityImplicitThis member is added by an implicit conversion from PersistenceIdentity toEnsuring\[PersistenceIdentity] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/persistence/PersistenceIdentity.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)): PersistenceIdentityImplicitThis member is added by an implicit conversion from PersistenceIdentity toEnsuring\[PersistenceIdentity] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/persistence/PersistenceIdentity.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/persistence/PersistenceIdentity.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/persistence/PersistenceIdentity.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
15. [**](../../akka/persistence/PersistenceIdentity.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
16. [**](../../akka/persistence/PersistenceIdentity.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/persistence/PersistenceIdentity.html#journalPluginId:String "Permalink")  def journalPluginId: StringConfiguration id of the journal plugin servicing this persistent actor.
...
18. [**](../../akka/persistence/PersistenceIdentity.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../akka/persistence/PersistenceIdentity.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
20. [**](../../akka/persistence/PersistenceIdentity.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
21. [**](../../akka/persistence/PersistenceIdentity.html#snapshotPluginId:String "Permalink")  def snapshotPluginId: StringConfiguration id of the snapshot plugin servicing this persistent actor.
...
Configuration entry must contain few required fields, such as `class`. See `src/main/resources/reference.conf`.
22. [**](../../akka/persistence/PersistenceIdentity.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
23. [**](../../akka/persistence/PersistenceIdentity.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
24. [**](../../akka/persistence/PersistenceIdentity.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
25. [**](../../akka/persistence/PersistenceIdentity.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
26. [**](../../akka/persistence/PersistenceIdentity.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/persistence/PersistenceIdentity.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated @Deprecated Deprecated
2. [**](../../akka/persistence/PersistenceIdentity.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from PersistenceIdentity toStringFormat\[PersistenceIdentity] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/persistence/PersistenceIdentity.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (PersistenceIdentity, B)ImplicitThis member is added by an implicit conversion from PersistenceIdentity toArrowAssoc\[PersistenceIdentity] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromPersistenceIdentity to any2stringadd\[PersistenceIdentity]

### Inherited by implicit conversion StringFormat fromPersistenceIdentity to StringFormat\[PersistenceIdentity]

### Inherited by implicit conversion Ensuring fromPersistenceIdentity to Ensuring\[PersistenceIdentity]

### Inherited by implicit conversion ArrowAssoc fromPersistenceIdentity to ArrowAssoc\[PersistenceIdentity]
...
---
*Source: [https://doc.akka.io/api/akka/2.8/akka/persistence/PersistenceIdentity.html](https://doc.akka.io/api/akka/2.8/akka/persistence/PersistenceIdentity.html)*