---
description: Akka 2.8.9 - akka.actor.DeadLetter
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:27:25Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/DeadLetter.html
title: Akka 2.8.9 - akka.actor.DeadLetter
---

# Akka 2.8.9 - akka.actor.DeadLetter

> **Summary:** Akka 2.8.9 - akka.actor.DeadLetter
...
# DeadLetter[**](../../akka/actor/DeadLetter.html "Permalink")

### 

#### final  case class DeadLetter(message: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any), sender: [ActorRef](ActorRef.html), recipient: [ActorRef](ActorRef.html)) extends [AllDeadLetters](AllDeadLetters.html) with [Product](https://www.scala-lang.org/api/2.13.11/scala/Product.html#scala.Product) with Serializable
...
Annotations@SerialVersionUID() Source[ActorRef.scala](https://github.com/akka/akka/tree/v2.8.9//akka-actor/src/main/scala/akka/actor/ActorRef.scala#L581)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [Product](https://www.scala-lang.org/api/2.13.11/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.11/scala/Equals.html#scala.Equals), [AllDeadLetters](AllDeadLetters.html), [WrappedMessage](WrappedMessage.html), [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. DeadLetter
2. Serializable
...
1. [**](../../akka/actor/DeadLetter.html#<init>(message:Any,sender:akka.actor.ActorRef,recipient:akka.actor.ActorRef):akka.actor.DeadLetter "Permalink")  new DeadLetter(message: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any), sender: [ActorRef](ActorRef.html), recipient: [ActorRef](ActorRef.html))
### Value Members

1. [**](../../akka/actor/DeadLetter.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/actor/DeadLetter.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/actor/DeadLetter.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from DeadLetter toany2stringadd\[DeadLetter] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/actor/DeadLetter.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (DeadLetter, B)ImplicitThis member is added by an implicit conversion from DeadLetter toArrowAssoc\[DeadLetter] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/actor/DeadLetter.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/actor/DeadLetter.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/actor/DeadLetter.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native() @HotSpotIntrinsicCandidate()
8. [**](../../akka/actor/DeadLetter.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (DeadLetter) \=\> [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): DeadLetterImplicitThis member is added by an implicit conversion from DeadLetter toEnsuring\[DeadLetter] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/actor/DeadLetter.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (DeadLetter) \=\> [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)): DeadLetterImplicitThis member is added by an implicit conversion from DeadLetter toEnsuring\[DeadLetter] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/actor/DeadLetter.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)): DeadLetterImplicitThis member is added by an implicit conversion from DeadLetter toEnsuring\[DeadLetter] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/actor/DeadLetter.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)): DeadLetterImplicitThis member is added by an implicit conversion from DeadLetter toEnsuring\[DeadLetter] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/actor/DeadLetter.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/actor/DeadLetter.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native() @HotSpotIntrinsicCandidate()
14. [**](../../akka/actor/DeadLetter.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAny
15. [**](../../akka/actor/DeadLetter.html#message:Any "Permalink")  val message: [Any](https://www.scala-lang.org/api/2.13.11/scala/Any.html#scala.Any)Definition ClassesDeadLetter → [AllDeadLetters](AllDeadLetters.html) → [WrappedMessage](WrappedMessage.html)
16. [**](../../akka/actor/DeadLetter.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.11/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/actor/DeadLetter.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
18. [**](../../akka/actor/DeadLetter.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native() @HotSpotIntrinsicCandidate()
19. [**](../../akka/actor/DeadLetter.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
20. [**](../../akka/actor/DeadLetter.html#recipient:akka.actor.ActorRef "Permalink")  val recipient: [ActorRef](ActorRef.html)Definition ClassesDeadLetter → [AllDeadLetters](AllDeadLetters.html)
21. [**](../../akka/actor/DeadLetter.html#sender:akka.actor.ActorRef "Permalink")  val sender: [ActorRef](ActorRef.html)Definition ClassesDeadLetter → [AllDeadLetters](AllDeadLetters.html)
22. [**](../../akka/actor/DeadLetter.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
23. [**](../../akka/actor/DeadLetter.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.11/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../akka/actor/DeadLetter.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.11/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../akka/actor/DeadLetter.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/actor/DeadLetter.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.11/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated @Deprecated Deprecated
2. [**](../../akka/actor/DeadLetter.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from DeadLetter toStringFormat\[DeadLetter] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/actor/DeadLetter.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (DeadLetter, B)ImplicitThis member is added by an implicit conversion from DeadLetter toArrowAssoc\[DeadLetter] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited from [AllDeadLetters](AllDeadLetters.html)

### Inherited from [WrappedMessage](WrappedMessage.html)
...
### Inherited by implicit conversion any2stringadd fromDeadLetter to any2stringadd\[DeadLetter]

### Inherited by implicit conversion StringFormat fromDeadLetter to StringFormat\[DeadLetter]

### Inherited by implicit conversion Ensuring fromDeadLetter to Ensuring\[DeadLetter]

### Inherited by implicit conversion ArrowAssoc fromDeadLetter to ArrowAssoc\[DeadLetter]
...
---
*Source: [https://doc.akka.io/api/akka/2.8/akka/actor/DeadLetter.html](https://doc.akka.io/api/akka/2.8/akka/actor/DeadLetter.html)*