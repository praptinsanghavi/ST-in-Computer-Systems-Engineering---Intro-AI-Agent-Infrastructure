---
description: Akka 2.8.9 - akka.actor.typed.pubsub
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:26:12Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/typed/pubsub/index.html
title: Akka 2.8.9 - akka.actor.typed.pubsub
---

# Akka 2.8.9 - akka.actor.typed.pubsub

> **Summary:** Akka 2.8.9 - akka.actor.typed.pubsub
...
1. [**](../../../../akka/actor/typed/pubsub/Topic$.html "Permalink")  object [Topic](Topic$.html "A pub sub topic is an actor that handles subscribing to a topic and publishing messages to all subscribed actors.")A pub sub topic is an actor that handles subscribing to a topic and publishing messages to all subscribed actors.
...
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/pubsub/Topic$.html
...
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/receptionist/ServiceKey.html
...
---
*Source: [https://doc.akka.io/api/akka/2.8/akka/actor/typed/pubsub/index.html](https://doc.akka.io/api/akka/2.8/akka/actor/typed/pubsub/index.html)*