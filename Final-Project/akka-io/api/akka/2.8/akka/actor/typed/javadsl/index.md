---
description: Akka 2.8.9 - akka.actor.typed.javadsl
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:26:10Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka/current/akka/actor/typed/javadsl/index.html
title: Akka 2.8.9 - akka.actor.typed.javadsl
---

# Akka 2.8.9 - akka.actor.typed.javadsl

> **Summary:** Akka 2.8.9 - akka.actor.typed.javadsl
...
4. [**](../../../../akka/actor/typed/javadsl/BehaviorBuilder.html "Permalink") final  class [BehaviorBuilder](BehaviorBuilder.html "Immutable builder used for creating a Behavior by 'chaining' message and signal handlers.")\[T] extends [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)Immutable builder used for creating a [Behavior](../Behavior.html) by 'chaining' message and signal handlers.
...
Annotations@[DoNotInherit](../../../annotation/DoNotInherit.html)()
8. [**](../../../../akka/actor/typed/javadsl/ReceiveBuilder.html "Permalink") final  class [ReceiveBuilder](ReceiveBuilder.html "Mutable builder used when implementing AbstractBehavior.")\[T] extends [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)Mutable builder used when implementing [AbstractBehavior](AbstractBehavior.html).
...
Tthe common superclass of all supported messages.
9. [**](../../../../akka/actor/typed/javadsl/StashBuffer.html "Permalink")  trait [StashBuffer](StashBuffer.html "A non thread safe mutable message buffer that can be used to buffer messages inside actors and then unstash them.")\[T] extends [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)A non thread safe mutable message buffer that can be used to buffer messages inside actors
...
11. [**](../../../../akka/actor/typed/javadsl/TimerScheduler.html "Permalink")  trait [TimerScheduler](TimerScheduler.html "Support for scheduled self messages in an actor.")\[T] extends [AnyRef](https://www.scala-lang.org/api/2.13.11/scala/AnyRef.html#scala.AnyRef)Support for scheduled `self` messages in an actor.
...
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/delivery/index.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/eventstream/index.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/index.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/internal/index.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/AbstractBehavior.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/AbstractOnMessageBehavior.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/ActorContext.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/Adapter$.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/AskPattern$.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/BehaviorBuilder$.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/BehaviorBuilder.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/Behaviors$.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/GroupRouter.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/PoolRouter.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/Receive.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/ReceiveBuilder$.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/ReceiveBuilder.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/Routers$.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/StashBuffer.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/StashOverflowException.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/TimerScheduler.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/index.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/pubsub/index.html
- https://doc.akka.io/api/akka/2.8/akka/actor/typed/receptionist/index.html
...
---
*Source: [https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/index.html](https://doc.akka.io/api/akka/2.8/akka/actor/typed/javadsl/index.html)*