---
description: Akka 2.10.17 - akka.stream.javadsl.MergeSequence
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:58:25Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/javadsl/MergeSequence$.html
title: Akka 2.10.17 - akka.stream.javadsl.MergeSequence
---

# Akka 2.10.17 - akka.stream.javadsl.MergeSequence

> **Summary:** Akka 2.10.17 - akka.stream.javadsl.MergeSequence
...
# MergeSequence[**](../../../akka/stream/javadsl/MergeSequence$.html "Permalink")
...
Source[Graph.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/javadsl/Graph.scala#L567)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. MergeSequence
2. AnyRef
...
1. [**](../../../akka/stream/javadsl/MergeSequence$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../akka/stream/javadsl/MergeSequence$.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../akka/stream/javadsl/MergeSequence$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../akka/stream/javadsl/MergeSequence$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/stream/javadsl/MergeSequence$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../../akka/stream/javadsl/MergeSequence$.html#create[T](clazz:Class[T],inputCount:Int,extractSequence:akka.japi.function.Function[T,Long]):akka.stream.Graph[akka.stream.UniformFanInShape[T,T],akka.NotUsed] "Permalink")  def create\[T](clazz: Class\[T], inputCount: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), extractSequence: [Function](../../japi/function/Function.html)\[T, [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)]): [Graph](../Graph.html)\[[UniformFanInShape](../UniformFanInShape.html)\[T, T], [NotUsed](../../NotUsed.html)]Create a new anonymous `Concat` operator with the specified input types.

Create a new anonymous `Concat` operator with the specified input types.

clazza type hint for this method

inputCountThe number of input streams.

extractSequenceThe function to extract the sequence from an element.
7. [**](../../../akka/stream/javadsl/MergeSequence$.html#create[T](inputCount:Int,extractSequence:akka.japi.function.Function[T,Long]):akka.stream.Graph[akka.stream.UniformFanInShape[T,T],akka.NotUsed] "Permalink")  def create\[T](inputCount: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), extractSequence: [Function](../../japi/function/Function.html)\[T, [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)]): [Graph](../Graph.html)\[[UniformFanInShape](../UniformFanInShape.html)\[T, T], [NotUsed](../../NotUsed.html)]Create a new anonymous `MergeSequence` operator.
...
extractSequenceThe function to extract the sequence from an element.
8. [**](../../../akka/stream/javadsl/MergeSequence$.html#create[T](extractSequence:akka.japi.function.Function[T,Long]):akka.stream.Graph[akka.stream.UniformFanInShape[T,T],akka.NotUsed] "Permalink")  def create\[T](extractSequence: [Function](../../japi/function/Function.html)\[T, [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)]): [Graph](../Graph.html)\[[UniformFanInShape](../UniformFanInShape.html)\[T, T], [NotUsed](../../NotUsed.html)]Create a new anonymous `MergeSequence` operator with two input ports.

Create a new anonymous `MergeSequence` operator with two input ports.

extractSequenceThe function to extract the sequence from an element.
9. [**](../../../akka/stream/javadsl/MergeSequence$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
10. [**](../../../akka/stream/javadsl/MergeSequence$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
11. [**](../../../akka/stream/javadsl/MergeSequence$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
12. [**](../../../akka/stream/javadsl/MergeSequence$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../../akka/stream/javadsl/MergeSequence$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
14. [**](../../../akka/stream/javadsl/MergeSequence$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../../akka/stream/javadsl/MergeSequence$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../akka/stream/javadsl/MergeSequence$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../../akka/stream/javadsl/MergeSequence$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
18. [**](../../../akka/stream/javadsl/MergeSequence$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
19. [**](../../../akka/stream/javadsl/MergeSequence$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
20. [**](../../../akka/stream/javadsl/MergeSequence$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
21. [**](../../../akka/stream/javadsl/MergeSequence$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../akka/stream/javadsl/MergeSequence$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka/2.10/akka/stream/javadsl/MergeSequence$.html](https://doc.akka.io/api/akka/2.10/akka/stream/javadsl/MergeSequence$.html)*