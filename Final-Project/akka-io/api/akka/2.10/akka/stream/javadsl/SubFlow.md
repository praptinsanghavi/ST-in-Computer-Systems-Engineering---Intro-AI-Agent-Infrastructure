...
scraped_at: '2026-04-06T02:59:00Z'
section: api
site: akka-io
...
[c](SubFlow$.html "See companion object")[akka](../../index.html).[stream](../index.html).[javadsl](index.html)

# [SubFlow](SubFlow$.html "See companion object")[**](../../../akka/stream/javadsl/SubFlow.html "Permalink")

### Companion [object SubFlow](SubFlow$.html "See companion object")

#### final  class SubFlow\[In, Out, Mat] extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
...
Source[SubFlow.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/javadsl/SubFlow.scala#L45)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. SubFlow
2. AnyRef
...
1. [**](../../../akka/stream/javadsl/SubFlow.html#<init>(delegate:akka.stream.scaladsl.SubFlow[Out,Mat,[+O]akka.stream.scaladsl.Flow[In,O,Mat],akka.stream.scaladsl.Sink[In,Mat]]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  new SubFlow(delegate: [scaladsl.SubFlow](../scaladsl/SubFlow.html)\[Out, Mat, \[\+O][scaladsl.Flow](../scaladsl/Flow.html)\[In, O, Mat], [scaladsl.Sink](../scaladsl/Sink.html)\[In, Mat]])
### Value Members
...
3. [**](../../../akka/stream/javadsl/SubFlow.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from SubFlow\[In, Out, Mat] toany2stringadd\[SubFlow\[In, Out, Mat]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../akka/stream/javadsl/SubFlow.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (SubFlow\[In, Out, Mat], B)ImplicitThis member is added by an implicit conversion from SubFlow\[In, Out, Mat] toArrowAssoc\[SubFlow\[In, Out, Mat]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../akka/stream/javadsl/SubFlow.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../akka/stream/javadsl/SubFlow.html#addAttributes(attr:akka.stream.Attributes):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def addAttributes(attr: [Attributes](../Attributes.html)): SubFlow\[In, Out, Mat]Add the given attributes to this Source.

Add the given attributes to this Source. Further calls to `withAttributes`
will not remove these attributes. Note that this
operation has no effect on an empty Flow (because the attributes apply
only to the contained processing operators).
7. [**](../../../akka/stream/javadsl/SubFlow.html#aggregateWithBoundary[Agg,Emit](allocate:java.util.function.Supplier[Agg])(aggregate:akka.japi.function.Function2[Agg,Out,akka.japi.Pair[Agg,Boolean]],harvest:akka.japi.function.Function[Agg,Emit],emitOnTimer:akka.japi.Pair[java.util.function.Predicate[Agg],java.time.Duration]):akka.stream.javadsl.SubFlow[In,Emit,Mat] "Permalink")  def aggregateWithBoundary\[Agg, Emit](allocate: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[Agg])(aggregate: [Function2](../../japi/function/Function2.html)\[Agg, Out, [Pair](../../japi/Pair.html)\[Agg, [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)]], harvest: [Function](../../japi/function/Function.html)\[Agg, Emit], emitOnTimer: [Pair](../../japi/Pair.html)\[[Predicate](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Predicate.html#java.util.function.Predicate)\[Agg], [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)]): SubFlow\[In, Emit, Mat]Aggregate input elements into an arbitrary data structure that can be completed and emitted downstream
...
when custom condition is met which can be triggered by aggregate or timer.
It can be thought of a more general [groupedWeightedWithin](#groupedWeightedWithin(maxWeight:Long,maxNumber:Int,costFn:akka.japi.function.Function[Out,Long],duration:java.time.Duration):akka.stream.javadsl.SubFlow[In,java.util.List[Out@scala.annotation.unchecked.uncheckedVariance],Mat]).
...
8. [**](../../../akka/stream/javadsl/SubFlow.html#alsoTo(that:akka.stream.Graph[akka.stream.SinkShape[Out],_]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def alsoTo(that: [Graph](../Graph.html)\[[SinkShape](../SinkShape.html)\[Out], \_]): SubFlow\[In, Out, Mat]Attaches the given [Sink](Sink.html) to this [Flow](Flow.html), meaning that elements that passes
...
It is similar to [\#wireTap](#wireTap(that:akka.stream.Graph[akka.stream.SinkShape[Out],_]):akka.stream.javadsl.SubFlow[In,Out,Mat]) but will backpressure instead of dropping elements when the given [Sink](Sink.html) is not ready.
...
9. [**](../../../akka/stream/javadsl/SubFlow.html#alsoToAll(those:akka.stream.Graph[akka.stream.SinkShape[Out],_]*):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def alsoToAll(those: [Graph](../Graph.html)\[[SinkShape](../SinkShape.html)\[Out], \_]\*): SubFlow\[In, Out, Mat]Attaches the given [Sink](Sink.html)s to this [Flow](Flow.html), meaning that elements that passes
through will also be sent to all those [Sink](Sink.html)s.

Attaches the given [Sink](Sink.html)s to this [Flow](Flow.html), meaning that elements that passes
through will also be sent to all those [Sink](Sink.html)s.

It is similar to [\#wireTap](#wireTap(that:akka.stream.Graph[akka.stream.SinkShape[Out],_]):akka.stream.javadsl.SubFlow[In,Out,Mat]) but will backpressure instead of dropping elements when the given [Sink](Sink.html)s is not ready.
...
10. [**](../../../akka/stream/javadsl/SubFlow.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
11. [**](../../../akka/stream/javadsl/SubFlow.html#asScala:akka.stream.scaladsl.SubFlow[Out,Mat,[+O]akka.stream.scaladsl.Flow[In,O,Mat],akka.stream.scaladsl.Sink[In,Mat]]@scala.annotation.unchecked.uncheckedVariance "Permalink")  def asScala: [scaladsl.SubFlow](../scaladsl/SubFlow.html)\[Out, Mat, \[\+O][scaladsl.Flow](../scaladsl/Flow.html)\[In, O, Mat], [scaladsl.Sink](../scaladsl/Sink.html)\[In, Mat]]Converts this Flow to its Scala DSL counterpart
12. [**](../../../akka/stream/javadsl/SubFlow.html#async:akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def async: SubFlow\[In, Out, Mat]Put an asynchronous boundary around this `SubFlow`
13. [**](../../../akka/stream/javadsl/SubFlow.html#backpressureTimeout(timeout:java.time.Duration):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def backpressureTimeout(timeout: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): SubFlow\[In, Out, Mat]If the time between the emission of an element and the following downstream demand exceeds the provided timeout,
...
**Cancels when** downstream cancels
14. [**](../../../akka/stream/javadsl/SubFlow.html#batch[S](max:Long,seed:akka.japi.function.Function[Out,S],aggregate:akka.japi.function.Function2[S,Out,S]):akka.stream.javadsl.SubFlow[In,S,Mat] "Permalink")  def batch\[S](max: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), seed: [Function](../../japi/function/Function.html)\[Out, S], aggregate: [Function2](../../japi/function/Function2.html)\[S, Out, S]): SubFlow\[In, S, Mat]Allows a faster upstream to progress independently of a slower subscriber by aggregating elements into batches
...
See also [SubFlow.conflate](#conflate(aggregate:akka.japi.function.Function2[Out,Out,Out]):akka.stream.javadsl.SubFlow[In,Out,Mat]), [SubFlow.batchWeighted](#batchWeighted[S](max:Long,costFn:akka.japi.function.Function[Out,Long],seed:akka.japi.function.Function[Out,S],aggregate:akka.japi.function.Function2[S,Out,S]):akka.stream.javadsl.SubFlow[In,S,Mat])
...
15. [**](../../../akka/stream/javadsl/SubFlow.html#batchWeighted[S](max:Long,costFn:akka.japi.function.Function[Out,Long],seed:akka.japi.function.Function[Out,S],aggregate:akka.japi.function.Function2[S,Out,S]):akka.stream.javadsl.SubFlow[In,S,Mat] "Permalink")  def batchWeighted\[S](max: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), costFn: [Function](../../japi/function/Function.html)\[Out, [Long](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Long.html#java.lang.Long)], seed: [Function](../../japi/function/Function.html)\[Out, S], aggregate: [Function2](../../japi/function/Function2.html)\[S, Out, S]): SubFlow\[In, S, Mat]Allows a faster upstream to progress independently of a slower subscriber by aggregating elements into batches
until the subscriber is ready to accept them.
...
See also [SubFlow.conflate](#conflate(aggregate:akka.japi.function.Function2[Out,Out,Out]):akka.stream.javadsl.SubFlow[In,Out,Mat]), [SubFlow.batch](#batch[S](max:Long,seed:akka.japi.function.Function[Out,S],aggregate:akka.japi.function.Function2[S,Out,S]):akka.stream.javadsl.SubFlow[In,S,Mat])
...
16. [**](../../../akka/stream/javadsl/SubFlow.html#buffer(size:Int,overflowStrategy:akka.stream.OverflowStrategy):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def buffer(size: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), overflowStrategy: [OverflowStrategy](../OverflowStrategy.html)): SubFlow\[In, Out, Mat]Adds a fixed size buffer in the flow that allows to store elements from a faster upstream until it becomes full.
...
17. [**](../../../akka/stream/javadsl/SubFlow.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
18. [**](../../../akka/stream/javadsl/SubFlow.html#collect[T](pf:PartialFunction[Out,T]):akka.stream.javadsl.SubFlow[In,T,Mat] "Permalink")  def collect\[T](pf: [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[Out, T]): SubFlow\[In, T, Mat]Transform this stream by applying the given partial function to each of the elements
...
**Cancels when** downstream cancels
19. [**](../../../akka/stream/javadsl/SubFlow.html#collectType[T](clazz:Class[T]):akka.stream.javadsl.SubFlow[In,T,Mat] "Permalink")  def collectType\[T](clazz: Class\[T]): SubFlow\[In, T, Mat]Transform this stream by testing the type of each of the elements
...
**Cancels when** downstream cancels
20. [**](../../../akka/stream/javadsl/SubFlow.html#completionTimeout(timeout:java.time.Duration):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def completionTimeout(timeout: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): SubFlow\[In, Out, Mat]If the completion of the stream does not happen until the provided timeout, the stream is failed
...
**Cancels when** downstream cancels
21. [**](../../../akka/stream/javadsl/SubFlow.html#concat[M](that:akka.stream.Graph[akka.stream.SourceShape[Out],M]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def concat\[M](that: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out], M]): SubFlow\[In, Out, Mat]Concatenate the given [Source](Source.html) to this [Flow](Flow.html), meaning that once this
...
When needing a concat operator that is not detached use [\#concatLazy](#concatLazy[M](that:akka.stream.Graph[akka.stream.SourceShape[Out],M]):akka.stream.javadsl.SubFlow[In,Out,Mat])
...
**Cancels when** downstream cancels
22. [**](../../../akka/stream/javadsl/SubFlow.html#concatAllLazy(those:akka.stream.Graph[akka.stream.SourceShape[Out],_]*):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def concatAllLazy(those: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out], \_]\*): SubFlow\[In, Out, Mat]Concatenate the given [Source](Source.html)s to this [Flow](Flow.html), meaning that once this
Flow’s input is exhausted and all result elements have been generated,
the Source’s elements will be produced.
...
For a concat operator that is detached, use [\#concat](#concat[M](that:akka.stream.Graph[akka.stream.SourceShape[Out],M]):akka.stream.javadsl.SubFlow[In,Out,Mat])
...
Annotations@varargs() @SafeVarargs()
23. [**](../../../akka/stream/javadsl/SubFlow.html#concatLazy[M](that:akka.stream.Graph[akka.stream.SourceShape[Out],M]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def concatLazy\[M](that: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out], M]): SubFlow\[In, Out, Mat]Concatenate the given [Source](Source.html) to this [Flow](Flow.html), meaning that once this
Flow’s input is exhausted and all result elements have been generated,
the Source’s elements will be produced.
...
**Cancels when** downstream cancels
24. [**](../../../akka/stream/javadsl/SubFlow.html#concatSubstreams():akka.stream.javadsl.Flow[In,Out,Mat] "Permalink")  def concatSubstreams(): [Flow](Flow.html)\[In, Out, Mat]Flatten the sub\-flows back into the super\-flow by concatenating them.
...
25. [**](../../../akka/stream/javadsl/SubFlow.html#conflate(aggregate:akka.japi.function.Function2[Out,Out,Out]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def conflate(aggregate: [Function2](../../japi/function/Function2.html)\[Out, Out, Out]): SubFlow\[In, Out, Mat]Allows a faster upstream to progress independently of a slower subscriber by conflating elements into a summary
until the subscriber is ready to accept them.
...
This version of conflate does not change the output type of the stream. See [SubFlow.conflateWithSeed](#conflateWithSeed[S](seed:akka.japi.function.Function[Out,S],aggregate:akka.japi.function.Function2[S,Out,S]):akka.stream.javadsl.SubFlow[In,S,Mat]) for a
...
see also [SubFlow.conflateWithSeed](#conflateWithSeed[S](seed:akka.japi.function.Function[Out,S],aggregate:akka.japi.function.Function2[S,Out,S]):akka.stream.javadsl.SubFlow[In,S,Mat]) [SubFlow.batch](#batch[S](max:Long,seed:akka.japi.function.Function[Out,S],aggregate:akka.japi.function.Function2[S,Out,S]):akka.stream.javadsl.SubFlow[In,S,Mat]) [SubFlow.batchWeighted](#batchWeighted[S](max:Long,costFn:akka.japi.function.Function[Out,Long],seed:akka.japi.function.Function[Out,S],aggregate:akka.japi.function.Function2[S,Out,S]):akka.stream.javadsl.SubFlow[In,S,Mat])

aggregateTakes the currently aggregated value and the current pending element to produce a new aggregate
26. [**](../../../akka/stream/javadsl/SubFlow.html#conflateWithSeed[S](seed:akka.japi.function.Function[Out,S],aggregate:akka.japi.function.Function2[S,Out,S]):akka.stream.javadsl.SubFlow[In,S,Mat] "Permalink")  def conflateWithSeed\[S](seed: [Function](../../japi/function/Function.html)\[Out, S], aggregate: [Function2](../../japi/function/Function2.html)\[S, Out, S]): SubFlow\[In, S, Mat]Allows a faster upstream to progress independently of a slower subscriber by conflating elements into a summary
until the subscriber is ready to accept them.
...
see also [SubFlow.conflate](#conflate(aggregate:akka.japi.function.Function2[Out,Out,Out]):akka.stream.javadsl.SubFlow[In,Out,Mat]) [SubFlow.batch](#batch[S](max:Long,seed:akka.japi.function.Function[Out,S],aggregate:akka.japi.function.Function2[S,Out,S]):akka.stream.javadsl.SubFlow[In,S,Mat]) [SubFlow.batchWeighted](#batchWeighted[S](max:Long,costFn:akka.japi.function.Function[Out,Long],seed:akka.japi.function.Function[Out,S],aggregate:akka.japi.function.Function2[S,Out,S]):akka.stream.javadsl.SubFlow[In,S,Mat])

seedProvides the first state for a conflated value using the first unconsumed element as a start

aggregateTakes the currently aggregated value and the current pending element to produce a new aggregate
27. [**](../../../akka/stream/javadsl/SubFlow.html#delay(of:java.time.Duration,strategy:akka.stream.DelayOverflowStrategy):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def delay(of: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), strategy: [DelayOverflowStrategy](../DelayOverflowStrategy.html)): SubFlow\[In, Out, Mat]Shifts elements emission in time by a specified amount.
...
overFlowStrategyStrategy that is used when incoming elements cannot fit inside the buffer
29. [**](../../../akka/stream/javadsl/SubFlow.html#detach:akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def detach: SubFlow\[In, Out, Mat]Detaches upstream demand from downstream demand without detaching the
...
**Cancels when** downstream cancels
30. [**](../../../akka/stream/javadsl/SubFlow.html#divertTo(that:akka.stream.Graph[akka.stream.SinkShape[Out],_],when:akka.japi.function.Predicate[Out]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def divertTo(that: [Graph](../Graph.html)\[[SinkShape](../SinkShape.html)\[Out], \_], when: [Predicate](../../japi/function/Predicate.html)\[Out]): SubFlow\[In, Out, Mat]Attaches the given [Sink](Sink.html) to this [Flow](Flow.html), meaning that elements will be sent to the [Sink](Sink.html)
...
31. [**](../../../akka/stream/javadsl/SubFlow.html#drop(n:Long):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def drop(n: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): SubFlow\[In, Out, Mat]Discard the given number of elements at the beginning of the stream.
...
**Cancels when** downstream cancels
32. [**](../../../akka/stream/javadsl/SubFlow.html#dropWhile(p:akka.japi.function.Predicate[Out]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def dropWhile(p: [Predicate](../../japi/function/Predicate.html)\[Out]): SubFlow\[In, Out, Mat]Discard elements at the beginning of the stream while predicate is true.
...
**Cancels when** downstream cancels
33. [**](../../../akka/stream/javadsl/SubFlow.html#dropWithin(duration:java.time.Duration):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def dropWithin(duration: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): SubFlow\[In, Out, Mat]Discard the elements received within the given duration at beginning of the stream.
...
**Cancels when** downstream cancels
34. [**](../../../akka/stream/javadsl/SubFlow.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (SubFlow\[In, Out, Mat]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SubFlow\[In, Out, Mat]ImplicitThis member is added by an implicit conversion from SubFlow\[In, Out, Mat] toEnsuring\[SubFlow\[In, Out, Mat]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
35. [**](../../../akka/stream/javadsl/SubFlow.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (SubFlow\[In, Out, Mat]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SubFlow\[In, Out, Mat]ImplicitThis member is added by an implicit conversion from SubFlow\[In, Out, Mat] toEnsuring\[SubFlow\[In, Out, Mat]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
36. [**](../../../akka/stream/javadsl/SubFlow.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SubFlow\[In, Out, Mat]ImplicitThis member is added by an implicit conversion from SubFlow\[In, Out, Mat] toEnsuring\[SubFlow\[In, Out, Mat]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
37. [**](../../../akka/stream/javadsl/SubFlow.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SubFlow\[In, Out, Mat]ImplicitThis member is added by an implicit conversion from SubFlow\[In, Out, Mat] toEnsuring\[SubFlow\[In, Out, Mat]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
38. [**](../../../akka/stream/javadsl/SubFlow.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
39. [**](../../../akka/stream/javadsl/SubFlow.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
40. [**](../../../akka/stream/javadsl/SubFlow.html#expand[U](expander:akka.japi.function.Function[Out,java.util.Iterator[U]]):akka.stream.javadsl.SubFlow[In,U,Mat] "Permalink")  def expand\[U](expander: [Function](../../japi/function/Function.html)\[Out, [Iterator](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Iterator.html#java.util.Iterator)\[U]]): SubFlow\[In, U, Mat]Allows a faster downstream to progress independently of a slower upstream by extrapolating elements from an older
...
See also[\#extrapolate](#extrapolate(extrapolator:akka.japi.function.Function[Out@scala.annotation.unchecked.uncheckedVariance,java.util.Iterator[Out@scala.annotation.unchecked.uncheckedVariance]],initial:Out@scala.annotation.unchecked.uncheckedVariance):akka.stream.javadsl.SubFlow[In,Out,Mat]) for a version that always preserves the original element and allows for an initial "startup"
 element.
41. [**](../../../akka/stream/javadsl/SubFlow.html#extrapolate(extrapolator:akka.japi.function.Function[Out@scala.annotation.unchecked.uncheckedVariance,java.util.Iterator[Out@scala.annotation.unchecked.uncheckedVariance]],initial:Out@scala.annotation.unchecked.uncheckedVariance):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def extrapolate(extrapolator: [Function](../../japi/function/Function.html)\[Out, [Iterator](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Iterator.html#java.util.Iterator)\[Out]], initial: Out): SubFlow\[In, Out, Mat]Allows a faster downstream to progress independent of a slower upstream.
...
See also [\#expand](#expand[U](expander:akka.japi.function.Function[Out,java.util.Iterator[U]]):akka.stream.javadsl.SubFlow[In,U,Mat]) for a version that can overwrite the original element.
...
See also[\#expand](#expand[U](expander:akka.japi.function.Function[Out,java.util.Iterator[U]]):akka.stream.javadsl.SubFlow[In,U,Mat])
42. [**](../../../akka/stream/javadsl/SubFlow.html#extrapolate(extrapolator:akka.japi.function.Function[Out@scala.annotation.unchecked.uncheckedVariance,java.util.Iterator[Out@scala.annotation.unchecked.uncheckedVariance]]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def extrapolate(extrapolator: [Function](../../japi/function/Function.html)\[Out, [Iterator](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Iterator.html#java.util.Iterator)\[Out]]): SubFlow\[In, Out, Mat]Allows a faster downstream to progress independent of a slower upstream.
...
See also[\#expand](#expand[U](expander:akka.japi.function.Function[Out,java.util.Iterator[U]]):akka.stream.javadsl.SubFlow[In,U,Mat])
43. [**](../../../akka/stream/javadsl/SubFlow.html#filter(p:akka.japi.function.Predicate[Out]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def filter(p: [Predicate](../../japi/function/Predicate.html)\[Out]): SubFlow\[In, Out, Mat]Only pass on those elements that satisfy the given predicate.
...
**Cancels when** downstream cancels
44. [**](../../../akka/stream/javadsl/SubFlow.html#filterNot(p:akka.japi.function.Predicate[Out]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def filterNot(p: [Predicate](../../japi/function/Predicate.html)\[Out]): SubFlow\[In, Out, Mat]Only pass on those elements that NOT satisfy the given predicate.
...
**Cancels when** downstream cancels
45. [**](../../../akka/stream/javadsl/SubFlow.html#flatMapConcat[T,M](f:akka.japi.function.Function[Out,_<:akka.stream.Graph[akka.stream.SourceShape[T],M]]):akka.stream.javadsl.SubFlow[In,T,Mat] "Permalink")  def flatMapConcat\[T, M](f: [Function](../../japi/function/Function.html)\[Out, \_ \<: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[T], M]]): SubFlow\[In, T, Mat]Transform each input element into a `Source` of output elements that is
...
**Cancels when** downstream cancels
46. [**](../../../akka/stream/javadsl/SubFlow.html#flatMapMerge[T,M](breadth:Int,f:akka.japi.function.Function[Out,_<:akka.stream.Graph[akka.stream.SourceShape[T],M]]):akka.stream.javadsl.SubFlow[In,T,Mat] "Permalink")  def flatMapMerge\[T, M](breadth: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), f: [Function](../../japi/function/Function.html)\[Out, \_ \<: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[T], M]]): SubFlow\[In, T, Mat]Transform each input element into a `Source` of output elements that is
...
**Cancels when** downstream cancels
47. [**](../../../akka/stream/javadsl/SubFlow.html#flatMapPrefix[Out2,Mat2](n:Int,f:akka.japi.function.Function[Iterable[Out],akka.stream.javadsl.Flow[Out,Out2,Mat2]]):akka.stream.javadsl.SubFlow[In,Out2,Mat] "Permalink")  def flatMapPrefix\[Out2, Mat2](n: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), f: [Function](../../japi/function/Function.html)\[[Iterable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Iterable.html#java.lang.Iterable)\[Out], [Flow](Flow.html)\[Out, Out2, Mat2]]): SubFlow\[In, Out2, Mat]Takes up to `n` elements from the stream (less than `n` only if the upstream completes before emitting `n` elements),
...
48. [**](../../../akka/stream/javadsl/SubFlow.html#fold[T](zero:T)(f:akka.japi.function.Function2[T,Out,T]):akka.stream.javadsl.SubFlow[In,T,Mat] "Permalink")  def fold\[T](zero: T)(f: [Function2](../../japi/function/Function2.html)\[T, Out, T]): SubFlow\[In, T, Mat]Similar to `scan` but only emits its result when the upstream completes,
...
**Cancels when** downstream cancels
49. [**](../../../akka/stream/javadsl/SubFlow.html#foldAsync[T](zero:T)(f:akka.japi.function.Function2[T,Out,java.util.concurrent.CompletionStage[T]]):akka.stream.javadsl.SubFlow[In,T,Mat] "Permalink")  def foldAsync\[T](zero: T)(f: [Function2](../../japi/function/Function2.html)\[T, Out, [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[T]]): SubFlow\[In, T, Mat]Similar to `fold` but with an asynchronous function.
...
51. [**](../../../akka/stream/javadsl/SubFlow.html#grouped(n:Int):akka.stream.javadsl.SubFlow[In,java.util.List[Out@scala.annotation.unchecked.uncheckedVariance],Mat] "Permalink")  def grouped(n: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): SubFlow\[In, [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[Out], Mat]Chunk up this stream into groups of the given size, with the last group
...
54. [**](../../../akka/stream/javadsl/SubFlow.html#groupedWeightedWithin(maxWeight:Long,costFn:akka.japi.function.Function[Out,Long],duration:java.time.Duration):akka.stream.javadsl.SubFlow[In,java.util.List[Out@scala.annotation.unchecked.uncheckedVariance],Mat] "Permalink")  def groupedWeightedWithin(maxWeight: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), costFn: [Function](../../japi/function/Function.html)\[Out, [Long](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Long.html#java.lang.Long)], duration: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): SubFlow\[In, [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[Out], Mat]Chunk up this stream into groups of elements received within a time window,
...
IllegalArgumentException is thrown.
56. [**](../../../akka/stream/javadsl/SubFlow.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
57. [**](../../../akka/stream/javadsl/SubFlow.html#idleTimeout(timeout:java.time.Duration):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def idleTimeout(timeout: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): SubFlow\[In, Out, Mat]If the time between two processed elements exceeds the provided timeout, the stream is failed
...
**Cancels when** downstream cancels
58. [**](../../../akka/stream/javadsl/SubFlow.html#initialDelay(delay:java.time.Duration):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def initialDelay(delay: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): SubFlow\[In, Out, Mat]Delays the initial element by the specified duration.
...
**Cancels when** downstream cancels
59. [**](../../../akka/stream/javadsl/SubFlow.html#initialTimeout(timeout:java.time.Duration):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def initialTimeout(timeout: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): SubFlow\[In, Out, Mat]If the first element has not passed through this operator before the provided timeout, the stream is failed
...
**Cancels when** downstream cancels
60. [**](../../../akka/stream/javadsl/SubFlow.html#interleave(that:akka.stream.Graph[akka.stream.SourceShape[Out],_],segmentSize:Int):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def interleave(that: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out], \_], segmentSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): SubFlow\[In, Out, Mat]Interleave is a deterministic merge of the given [Source](Source.html) with elements of this [Flow](Flow.html).
...
**Cancels when** downstream cancels
61. [**](../../../akka/stream/javadsl/SubFlow.html#interleaveAll(those:java.util.List[_<:akka.stream.Graph[akka.stream.SourceShape[Out],_]],segmentSize:Int,eagerClose:Boolean):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def interleaveAll(those: [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[\_ \<: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out], \_]], segmentSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), eagerClose: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SubFlow\[In, Out, Mat]Interleave is a deterministic merge of the given [Source](Source.html)s with elements of this [Flow](Flow.html).
...
**Cancels when** downstream cancels
62. [**](../../../akka/stream/javadsl/SubFlow.html#intersperse(inject:Out):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def intersperse(inject: Out): SubFlow\[In, Out, Mat]Intersperses stream with provided element, similar to how [scala.collection.immutable.List.mkString](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/List.html#mkString:String)
...
**Cancels when** downstream cancels
63. [**](../../../akka/stream/javadsl/SubFlow.html#intersperse(start:Out,inject:Out,end:Out):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def intersperse(start: Out, inject: Out, end: Out): SubFlow\[In, Out, Mat]Intersperses stream with provided element, similar to how [scala.collection.immutable.List.mkString](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/List.html#mkString:String)
injects a separator between a List's elements.
...
**Cancels when** downstream cancels
64. [**](../../../akka/stream/javadsl/SubFlow.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
65. [**](../../../akka/stream/javadsl/SubFlow.html#keepAlive(maxIdle:java.time.Duration,injectedElem:akka.japi.function.Creator[Out]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def keepAlive(maxIdle: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), injectedElem: [Creator](../../japi/function/Creator.html)\[Out]): SubFlow\[In, Out, Mat]Injects additional elements if upstream does not emit for a configured amount of time.
...
**Cancels when** downstream cancels
66. [**](../../../akka/stream/javadsl/SubFlow.html#limit(n:Long):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def limit(n: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): SubFlow\[In, Out, Mat]Ensure stream boundedness by limiting the number of elements from upstream.
...
67. [**](../../../akka/stream/javadsl/SubFlow.html#limitWeighted(n:Long)(costFn:akka.japi.function.Function[Out,Long]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def limitWeighted(n: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long))(costFn: [Function](../../japi/function/Function.html)\[Out, [Long](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Long.html#java.lang.Long)]): SubFlow\[In, Out, Mat]Ensure stream boundedness by evaluating the cost of incoming elements
...
See also [Flow.take](Flow.html#take(n:Long):akka.stream.javadsl.Flow[In,Out,Mat]), [Flow.takeWithin](Flow.html#takeWithin(duration:java.time.Duration):akka.stream.javadsl.Flow[In,Out,Mat]), [Flow.takeWhile](Flow.html#takeWhile(p:akka.japi.function.Predicate[Out]):akka.stream.javadsl.Flow[In,Out,Mat])
68. [**](../../../akka/stream/javadsl/SubFlow.html#log(name:String):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def log(name: String): SubFlow\[In, Out, Mat]Logs elements flowing through the stream as well as completion and erroring.
...
**Cancels when** downstream cancels
69. [**](../../../akka/stream/javadsl/SubFlow.html#log(name:String,log:akka.event.LoggingAdapter):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def log(name: String, log: [LoggingAdapter](../../event/LoggingAdapter.html)): SubFlow\[In, Out, Mat]Logs elements flowing through the stream as well as completion and erroring.
...
**Cancels when** downstream cancels
70. [**](../../../akka/stream/javadsl/SubFlow.html#log(name:String,extract:akka.japi.function.Function[Out,Any]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def log(name: String, extract: [Function](../../japi/function/Function.html)\[Out, [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]): SubFlow\[In, Out, Mat]Logs elements flowing through the stream as well as completion and erroring.
...
**Cancels when** downstream cancels
71. [**](../../../akka/stream/javadsl/SubFlow.html#log(name:String,extract:akka.japi.function.Function[Out,Any],log:akka.event.LoggingAdapter):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def log(name: String, extract: [Function](../../japi/function/Function.html)\[Out, [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)], log: [LoggingAdapter](../../event/LoggingAdapter.html)): SubFlow\[In, Out, Mat]Logs elements flowing through the stream as well as completion and erroring.
...
**Cancels when** downstream cancels
72. [**](../../../akka/stream/javadsl/SubFlow.html#logWithMarker(name:String,marker:akka.japi.function.Function[Out,akka.event.LogMarker]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def logWithMarker(name: String, marker: [Function](../../japi/function/Function.html)\[Out, [LogMarker](../../event/LogMarker.html)]): SubFlow\[In, Out, Mat]Logs elements flowing through the stream as well as completion and erroring.
...
**Cancels when** downstream cancels
73. [**](../../../akka/stream/javadsl/SubFlow.html#logWithMarker(name:String,marker:akka.japi.function.Function[Out,akka.event.LogMarker],log:akka.event.MarkerLoggingAdapter):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def logWithMarker(name: String, marker: [Function](../../japi/function/Function.html)\[Out, [LogMarker](../../event/LogMarker.html)], log: [MarkerLoggingAdapter](../../event/MarkerLoggingAdapter.html)): SubFlow\[In, Out, Mat]Logs elements flowing through the stream as well as completion and erroring.
...
**Cancels when** downstream cancels
74. [**](../../../akka/stream/javadsl/SubFlow.html#logWithMarker(name:String,marker:akka.japi.function.Function[Out,akka.event.LogMarker],extract:akka.japi.function.Function[Out,Any]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def logWithMarker(name: String, marker: [Function](../../japi/function/Function.html)\[Out, [LogMarker](../../event/LogMarker.html)], extract: [Function](../../japi/function/Function.html)\[Out, [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]): SubFlow\[In, Out, Mat]Logs elements flowing through the stream as well as completion and erroring.
...
**Cancels when** downstream cancels
75. [**](../../../akka/stream/javadsl/SubFlow.html#logWithMarker(name:String,marker:akka.japi.function.Function[Out,akka.event.LogMarker],extract:akka.japi.function.Function[Out,Any],log:akka.event.MarkerLoggingAdapter):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def logWithMarker(name: String, marker: [Function](../../japi/function/Function.html)\[Out, [LogMarker](../../event/LogMarker.html)], extract: [Function](../../japi/function/Function.html)\[Out, [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)], log: [MarkerLoggingAdapter](../../event/MarkerLoggingAdapter.html)): SubFlow\[In, Out, Mat]Logs elements flowing through the stream as well as completion and erroring.
...
**Cancels when** downstream cancels
76. [**](../../../akka/stream/javadsl/SubFlow.html#map[T](f:akka.japi.function.Function[Out,T]):akka.stream.javadsl.SubFlow[In,T,Mat] "Permalink")  def map\[T](f: [Function](../../japi/function/Function.html)\[Out, T]): SubFlow\[In, T, Mat]Transform this stream by applying the given function to each of the elements
...
**Cancels when** downstream cancels
77. [**](../../../akka/stream/javadsl/SubFlow.html#mapAsync[T](parallelism:Int,f:akka.japi.function.Function[Out,java.util.concurrent.CompletionStage[T]]):akka.stream.javadsl.SubFlow[In,T,Mat] "Permalink")  def mapAsync\[T](parallelism: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), f: [Function](../../japi/function/Function.html)\[Out, [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[T]]): SubFlow\[In, T, Mat]Transform this stream by applying the given function to each of the elements
as they pass through this processing step.
...
See also[\#mapAsyncUnordered](#mapAsyncUnordered[T](parallelism:Int,f:akka.japi.function.Function[Out,java.util.concurrent.CompletionStage[T]]):akka.stream.javadsl.SubFlow[In,T,Mat])
78. [**](../../../akka/stream/javadsl/SubFlow.html#mapAsyncPartitioned[T,P](parallelism:Int,perPartition:Int,partitioner:akka.japi.function.Function[Out,P],f:java.util.function.BiFunction[Out,P,java.util.concurrent.CompletionStage[T]]):akka.stream.javadsl.SubFlow[In,T,Mat] "Permalink")  def mapAsyncPartitioned\[T, P](parallelism: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), perPartition: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), partitioner: [Function](../../japi/function/Function.html)\[Out, P], f: [BiFunction](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/BiFunction.html#java.util.function.BiFunction)\[Out, P, [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[T]]): SubFlow\[In, T, Mat]See also[akka.stream.javadsl.Flow.mapAsyncPartitioned](Flow.html#mapAsyncPartitioned[T,P](parallelism:Int,perPartition:Int,partitioner:akka.japi.function.Function[Out,P],f:java.util.function.BiFunction[Out,P,java.util.concurrent.CompletionStage[T]]):akka.stream.javadsl.Flow[In,T,Mat])
79. [**](../../../akka/stream/javadsl/SubFlow.html#mapAsyncUnordered[T](parallelism:Int,f:akka.japi.function.Function[Out,java.util.concurrent.CompletionStage[T]]):akka.stream.javadsl.SubFlow[In,T,Mat] "Permalink")  def mapAsyncUnordered\[T](parallelism: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), f: [Function](../../japi/function/Function.html)\[Out, [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[T]]): SubFlow\[In, T, Mat]Transform this stream by applying the given function to each of the elements
as they pass through this processing step.
...
See also[\#mapAsync](#mapAsync[T](parallelism:Int,f:akka.japi.function.Function[Out,java.util.concurrent.CompletionStage[T]]):akka.stream.javadsl.SubFlow[In,T,Mat])
80. [**](../../../akka/stream/javadsl/SubFlow.html#mapConcat[T](f:akka.japi.function.Function[Out,Iterable[T]]):akka.stream.javadsl.SubFlow[In,T,Mat] "Permalink")  def mapConcat\[T](f: [Function](../../japi/function/Function.html)\[Out, [Iterable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Iterable.html#java.lang.Iterable)\[T]]): SubFlow\[In, T, Mat]Transform each input element into an `Iterable` of output elements that is
...
**Cancels when** downstream cancels
81. [**](../../../akka/stream/javadsl/SubFlow.html#mapError[E<:Throwable](clazz:Class[E],f:akka.japi.function.Function[E,Throwable]):akka.stream.javadsl.SubFlow[In,Out,Mat@scala.annotation.unchecked.uncheckedVariance] "Permalink")  def mapError\[E \<: Throwable](clazz: Class\[E], f: [Function](../../japi/function/Function.html)\[E, Throwable]): SubFlow\[In, Out, Mat]While similar to [recover](#recover(pf:PartialFunction[Throwable,Out]):akka.stream.javadsl.SubFlow[In,Out,Mat]) this operator can be used to transform an error signal to a different one \*without\* logging
it as an error in the process.

While similar to [recover](#recover(pf:PartialFunction[Throwable,Out]):akka.stream.javadsl.SubFlow[In,Out,Mat]) this operator can be used to transform an error signal to a different one \*without\* logging
...
Similarly to [recover](#recover(pf:PartialFunction[Throwable,Out]):akka.stream.javadsl.SubFlow[In,Out,Mat]) throwing an exception inside `mapError` \_will\_ be logged.
...
**Cancels when** downstream cancels
82. [**](../../../akka/stream/javadsl/SubFlow.html#mapError(pf:PartialFunction[Throwable,Throwable]):akka.stream.javadsl.SubFlow[In,Out,Mat@scala.annotation.unchecked.uncheckedVariance] "Permalink")  def mapError(pf: [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[Throwable, Throwable]): SubFlow\[In, Out, Mat]While similar to [recover](#recover(pf:PartialFunction[Throwable,Out]):akka.stream.javadsl.SubFlow[In,Out,Mat]) this operator can be used to transform an error signal to a different one \*without\* logging
it as an error in the process.
...
Early completion can be done with combination of the [takeWhile](#takeWhile(p:akka.japi.function.Predicate[Out],inclusive:Boolean):akka.stream.javadsl.SubFlow[In,Out,Mat]) operator.
...
84. [**](../../../akka/stream/javadsl/SubFlow.html#merge(that:akka.stream.Graph[akka.stream.SourceShape[Out],_]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def merge(that: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out], \_]): SubFlow\[In, Out, Mat]Merge the given [Source](Source.html) to this [Flow](Flow.html), taking elements as they arrive from input streams,
...
**Cancels when** downstream cancels
85. [**](../../../akka/stream/javadsl/SubFlow.html#mergeAll(those:java.util.List[_<:akka.stream.Graph[akka.stream.SourceShape[Out],_]],eagerComplete:Boolean):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def mergeAll(those: [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[\_ \<: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out], \_]], eagerComplete: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SubFlow\[In, Out, Mat]Merge the given [Source](Source.html)s to this [Flow](Flow.html), taking elements as they arrive from input streams,
picking randomly when several elements ready.
...
87. [**](../../../akka/stream/javadsl/SubFlow.html#mergePreferred[M](that:akka.stream.Graph[akka.stream.SourceShape[Out],M],preferred:Boolean,eagerComplete:Boolean):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def mergePreferred\[M](that: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out], M], preferred: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), eagerComplete: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SubFlow\[In, Out, Mat]Merge two sources.
...
88. [**](../../../akka/stream/javadsl/SubFlow.html#mergePrioritized[M](that:akka.stream.Graph[akka.stream.SourceShape[Out],M],leftPriority:Int,rightPriority:Int,eagerComplete:Boolean):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def mergePrioritized\[M](that: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out], M], leftPriority: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), rightPriority: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), eagerComplete: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SubFlow\[In, Out, Mat]Merge two sources.
...
89. [**](../../../akka/stream/javadsl/SubFlow.html#mergeSorted[M](that:akka.stream.Graph[akka.stream.SourceShape[Out],M],comp:java.util.Comparator[Out]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def mergeSorted\[M](that: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out], M], comp: [Comparator](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Comparator.html#java.util.Comparator)\[Out]): SubFlow\[In, Out, Mat]Merge the given [Source](Source.html) to this [Flow](Flow.html), taking elements as they arrive from input streams,
...
**Cancels when** downstream cancels
90. [**](../../../akka/stream/javadsl/SubFlow.html#mergeSubstreams():akka.stream.javadsl.Flow[In,Out,Mat] "Permalink")  def mergeSubstreams(): [Flow](Flow.html)\[In, Out, Mat]Flatten the sub\-flows back into the super\-flow by performing a merge
...
91. [**](../../../akka/stream/javadsl/SubFlow.html#mergeSubstreamsWithParallelism(parallelism:Int):akka.stream.javadsl.Flow[In,Out,Mat] "Permalink")  def mergeSubstreamsWithParallelism(parallelism: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Flow](Flow.html)\[In, Out, Mat]Flatten the sub\-flows back into the super\-flow by performing a merge
...
limit is reached.
92. [**](../../../akka/stream/javadsl/SubFlow.html#named(name:String):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def named(name: String): SubFlow\[In, Out, Mat]Add a `name` attribute to this Flow.
93. [**](../../../akka/stream/javadsl/SubFlow.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
94. [**](../../../akka/stream/javadsl/SubFlow.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
95. [**](../../../akka/stream/javadsl/SubFlow.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
96. [**](../../../akka/stream/javadsl/SubFlow.html#onErrorComplete(predicate:java.util.function.Predicate[_>:Throwable]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def onErrorComplete(predicate: [Predicate](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Predicate.html#java.util.function.Predicate)\[\_ \>: Throwable]): SubFlow\[In, Out, Mat]onErrorComplete allows to complete the stream when an upstream error occurs.
...
**Cancels when** downstream cancels
97. [**](../../../akka/stream/javadsl/SubFlow.html#onErrorComplete(clazz:Class[_<:Throwable]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def onErrorComplete(clazz: Class\[\_ \<: Throwable]): SubFlow\[In, Out, Mat]onErrorComplete allows to complete the stream when an upstream error occurs.
...
**Cancels when** downstream cancels
98. [**](../../../akka/stream/javadsl/SubFlow.html#onErrorComplete():akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def onErrorComplete(): SubFlow\[In, Out, Mat]onErrorComplete allows to complete the stream when an upstream error occurs.
...
**Cancels when** downstream cancels
99. [**](../../../akka/stream/javadsl/SubFlow.html#orElse[M](secondary:akka.stream.Graph[akka.stream.SourceShape[Out],M]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def orElse\[M](secondary: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out], M]): SubFlow\[In, Out, Mat]Provides a secondary source that will be consumed if this source completes without any
elements passing by.
...
**Cancels when** downstream cancels and additionally the alternative is cancelled as soon as an element passes
 by from this stream.
100. [**](../../../akka/stream/javadsl/SubFlow.html#prefixAndTail(n:Int):akka.stream.javadsl.SubFlow[In,akka.japi.Pair[java.util.List[Out@scala.annotation.unchecked.uncheckedVariance],akka.stream.javadsl.Source[Out@scala.annotation.unchecked.uncheckedVariance,akka.NotUsed]],Mat] "Permalink")  def prefixAndTail(n: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): SubFlow\[In, [Pair](../../japi/Pair.html)\[[List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[Out], [Source](Source.html)\[Out, [NotUsed](../../NotUsed.html)]], Mat]Takes up to `n` elements from the stream (less than `n` only if the upstream completes before emitting `n` elements)
...
101. [**](../../../akka/stream/javadsl/SubFlow.html#prepend[M](that:akka.stream.Graph[akka.stream.SourceShape[Out],M]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def prepend\[M](that: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out], M]): SubFlow\[In, Out, Mat]Prepend the given [Source](Source.html) to this [Flow](Flow.html), meaning that before elements
...
When needing a prepend operator that is not detached use [\#prependLazy](#prependLazy[M](that:akka.stream.Graph[akka.stream.SourceShape[Out],M]):akka.stream.javadsl.SubFlow[In,Out,Mat])
...
**Cancels when** downstream cancels
102. [**](../../../akka/stream/javadsl/SubFlow.html#prependLazy[M](that:akka.stream.Graph[akka.stream.SourceShape[Out],M]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def prependLazy\[M](that: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out], M]): SubFlow\[In, Out, Mat]Prepend the given [Source](Source.html) to this [Flow](Flow.html), meaning that before elements
are generated from this Flow, the Source's elements will be produced until it
is exhausted, at which point Flow elements will start being produced.
...
When needing a prepend operator that is also detached use [\#prepend](#prepend[M](that:akka.stream.Graph[akka.stream.SourceShape[Out],M]):akka.stream.javadsl.SubFlow[In,Out,Mat])
...
**Cancels when** downstream cancels
103. [**](../../../akka/stream/javadsl/SubFlow.html#recover(pf:PartialFunction[Throwable,Out]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def recover(pf: [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[Throwable, Out]): SubFlow\[In, Out, Mat]Recover allows to send last element on failure and gracefully complete the stream
Since the underlying failure signal onError arrives out\-of\-band, it might jump over existing elements.
...
**Cancels when** downstream cancels
104. [**](../../../akka/stream/javadsl/SubFlow.html#recoverWith(pf:PartialFunction[Throwable,akka.stream.Graph[akka.stream.SourceShape[Out],akka.NotUsed]]):akka.stream.javadsl.SubFlow[In,Out,Mat@scala.annotation.unchecked.uncheckedVariance] "Permalink")  def recoverWith(pf: [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[Throwable, [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out], [NotUsed](../../NotUsed.html)]]): SubFlow\[In, Out, Mat]RecoverWith allows to switch to alternative Source on flow failure.
...
**Cancels when** downstream cancels
105. [**](../../../akka/stream/javadsl/SubFlow.html#recoverWithRetries(attempts:Int,pf:PartialFunction[Throwable,akka.stream.Graph[akka.stream.SourceShape[Out],akka.NotUsed]]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def recoverWithRetries(attempts: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), pf: [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[Throwable, [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out], [NotUsed](../../NotUsed.html)]]): SubFlow\[In, Out, Mat]RecoverWithRetries allows to switch to alternative Source on flow failure.
...
**Cancels when** downstream cancels
106. [**](../../../akka/stream/javadsl/SubFlow.html#reduce(f:akka.japi.function.Function2[Out,Out,Out@scala.annotation.unchecked.uncheckedVariance]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def reduce(f: [Function2](../../japi/function/Function2.html)\[Out, Out, Out]): SubFlow\[In, Out, Mat]Similar to `fold` but uses first element as zero element.
...
**Cancels when** downstream cancels
107. [**](../../../akka/stream/javadsl/SubFlow.html#scan[T](zero:T)(f:akka.japi.function.Function2[T,Out,T]):akka.stream.javadsl.SubFlow[In,T,Mat] "Permalink")  def scan\[T](zero: T)(f: [Function2](../../japi/function/Function2.html)\[T, Out, T]): SubFlow\[In, T, Mat]Similar to `fold` but is not a terminal operation,
...
**Cancels when** downstream cancels
108. [**](../../../akka/stream/javadsl/SubFlow.html#scanAsync[T](zero:T)(f:akka.japi.function.Function2[T,Out,java.util.concurrent.CompletionStage[T]]):akka.stream.javadsl.SubFlow[In,T,Mat] "Permalink")  def scanAsync\[T](zero: T)(f: [Function2](../../japi/function/Function2.html)\[T, Out, [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[T]]): SubFlow\[In, T, Mat]Similar to `scan` but with a asynchronous function,
emits its current value which starts at `zero` and then
applies the current and next value to the given function `f`,
...
**Cancels when** downstream cancels
110. [**](../../../akka/stream/javadsl/SubFlow.html#statefulMap[S,T](create:akka.japi.function.Creator[S],f:akka.japi.function.Function2[S,Out,akka.japi.Pair[S,T]],onComplete:akka.japi.function.Function[S,java.util.Optional[T]]):akka.stream.javadsl.SubFlow[In,T,Mat] "Permalink")  def statefulMap\[S, T](create: [Creator](../../japi/function/Creator.html)\[S], f: [Function2](../../japi/function/Function2.html)\[S, Out, [Pair](../../japi/Pair.html)\[S, T]], onComplete: [Function](../../japi/function/Function.html)\[S, [Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[T]]): SubFlow\[In, T, Mat]Transform each stream element with the help of a state.
...
For stateless variant see [map](#map[T](f:akka.japi.function.Function[Out,T]):akka.stream.javadsl.SubFlow[In,T,Mat]).
...
111. [**](../../../akka/stream/javadsl/SubFlow.html#statefulMapConcat[T](f:akka.japi.function.Creator[akka.japi.function.Function[Out,Iterable[T]]]):akka.stream.javadsl.SubFlow[In,T,Mat] "Permalink")  def statefulMapConcat\[T](f: [Creator](../../japi/function/Creator.html)\[[Function](../../japi/function/Function.html)\[Out, [Iterable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Iterable.html#java.lang.Iterable)\[T]]]): SubFlow\[In, T, Mat]Transform each input element into an `Iterable` of output elements that is
then flattened into the output stream.
...
invocations. For the stateless variant see [\#mapConcat](#mapConcat[T](f:akka.japi.function.Function[Out,Iterable[T]]):akka.stream.javadsl.SubFlow[In,T,Mat]).
...
**Cancels when** downstream cancels
112. [**](../../../akka/stream/javadsl/SubFlow.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
113. [**](../../../akka/stream/javadsl/SubFlow.html#take(n:Long):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def take(n: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): SubFlow\[In, Out, Mat]Terminate processing (and cancel the upstream publisher) after the given
number of elements.
...
**Cancels when** the defined number of elements has been taken or downstream cancels
114. [**](../../../akka/stream/javadsl/SubFlow.html#takeWhile(p:akka.japi.function.Predicate[Out],inclusive:Boolean):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def takeWhile(p: [Predicate](../../japi/function/Predicate.html)\[Out], inclusive: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SubFlow\[In, Out, Mat]Terminate processing (and cancel the upstream publisher) after predicate
...
115. [**](../../../akka/stream/javadsl/SubFlow.html#takeWhile(p:akka.japi.function.Predicate[Out]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def takeWhile(p: [Predicate](../../japi/function/Predicate.html)\[Out]): SubFlow\[In, Out, Mat]Terminate processing (and cancel the upstream publisher) after predicate
...
**Cancels when** predicate returned false or downstream cancels
116. [**](../../../akka/stream/javadsl/SubFlow.html#takeWithin(duration:java.time.Duration):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def takeWithin(duration: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): SubFlow\[In, Out, Mat]Terminate processing (and cancel the upstream publisher) after the given
duration.
...
Note that this can be combined with [\#take](#take(n:Long):akka.stream.javadsl.SubFlow[In,Out,Mat]) to limit the number of elements
within the duration.
...
117. [**](../../../akka/stream/javadsl/SubFlow.html#throttle(control:akka.stream.javadsl.ThrottleControl,costCalculation:akka.japi.function.Function[Out,Integer]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def throttle(control: [ThrottleControl](ThrottleControl.html), costCalculation: [Function](../../japi/function/Function.html)\[Out, [Integer](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Integer.html#java.lang.Integer)]): SubFlow\[In, Out, Mat]See also[akka.stream.javadsl.Flow.throttle](Flow.html#throttle(control:akka.stream.javadsl.ThrottleControl,costCalculation:akka.japi.function.Function[Out,Integer]):akka.stream.javadsl.Flow[In,Out,Mat])
118. [**](../../../akka/stream/javadsl/SubFlow.html#throttle(control:akka.stream.javadsl.ThrottleControl):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def throttle(control: [ThrottleControl](ThrottleControl.html)): SubFlow\[In, Out, Mat]See also[akka.stream.javadsl.Flow.throttle](Flow.html#throttle(control:akka.stream.javadsl.ThrottleControl,costCalculation:akka.japi.function.Function[Out,Integer]):akka.stream.javadsl.Flow[In,Out,Mat])
119. [**](../../../akka/stream/javadsl/SubFlow.html#throttle(cost:Int,per:java.time.Duration,maximumBurst:Int,costCalculation:akka.japi.function.Function[Out,Integer],mode:akka.stream.ThrottleMode):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def throttle(cost: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), per: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), maximumBurst: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), costCalculation: [Function](../../japi/function/Function.html)\[Out, [Integer](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Integer.html#java.lang.Integer)], mode: [ThrottleMode](../ThrottleMode.html)): SubFlow\[In, Out, Mat]Sends elements downstream with speed limited to `cost/per`.
...
**Cancels when** downstream cancels
120. [**](../../../akka/stream/javadsl/SubFlow.html#throttle(cost:Int,per:java.time.Duration,costCalculation:akka.japi.function.Function[Out,Integer]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def throttle(cost: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), per: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), costCalculation: [Function](../../japi/function/Function.html)\[Out, [Integer](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Integer.html#java.lang.Integer)]): SubFlow\[In, Out, Mat]Sends elements downstream with speed limited to `cost/per`.
...
**Cancels when** downstream cancels
121. [**](../../../akka/stream/javadsl/SubFlow.html#throttle(elements:Int,per:java.time.Duration,maximumBurst:Int,mode:akka.stream.ThrottleMode):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def throttle(elements: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), per: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration), maximumBurst: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), mode: [ThrottleMode](../ThrottleMode.html)): SubFlow\[In, Out, Mat]Sends elements downstream with speed limited to `elements/per`.
...
**Cancels when** downstream cancels
122. [**](../../../akka/stream/javadsl/SubFlow.html#throttle(elements:Int,per:java.time.Duration):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def throttle(elements: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), per: [Duration](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Duration.html#java.time.Duration)): SubFlow\[In, Out, Mat]Sends elements downstream with speed limited to `elements/per`.
...
**Cancels when** downstream cancels
123. [**](../../../akka/stream/javadsl/SubFlow.html#to(sink:akka.stream.Graph[akka.stream.SinkShape[Out],_]):akka.stream.javadsl.Sink[In,Mat] "Permalink")  def to(sink: [Graph](../Graph.html)\[[SinkShape](../SinkShape.html)\[Out], \_]): [Sink](Sink.html)\[In, Mat]Connect this SubFlow to a [Sink](Sink.html), concatenating the processing steps of both.

Connect this SubFlow to a [Sink](Sink.html), concatenating the processing steps of both.
...
124. [**](../../../akka/stream/javadsl/SubFlow.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
125. [**](../../../akka/stream/javadsl/SubFlow.html#via[T,M](flow:akka.stream.Graph[akka.stream.FlowShape[Out,T],M]):akka.stream.javadsl.SubFlow[In,T,Mat] "Permalink")  def via\[T, M](flow: [Graph](../Graph.html)\[[FlowShape](../FlowShape.html)\[Out, T], M]): SubFlow\[In, T, Mat]Transform this [Flow](Flow.html) by appending the given processing steps.
...
128. [**](../../../akka/stream/javadsl/SubFlow.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
129. [**](../../../akka/stream/javadsl/SubFlow.html#wireTap(that:akka.stream.Graph[akka.stream.SinkShape[Out],_]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def wireTap(that: [Graph](../Graph.html)\[[SinkShape](../SinkShape.html)\[Out], \_]): SubFlow\[In, Out, Mat]Attaches the given [Sink](Sink.html) to this [Flow](Flow.html) as a wire tap, meaning that elements that pass
...
It is similar to [\#alsoTo](#alsoTo(that:akka.stream.Graph[akka.stream.SinkShape[Out],_]):akka.stream.javadsl.SubFlow[In,Out,Mat]) which does backpressure instead of dropping elements.
...
**Cancels when** downstream cancels
130. [**](../../../akka/stream/javadsl/SubFlow.html#wireTap(f:akka.japi.function.Procedure[Out]):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def wireTap(f: [Procedure](../../japi/function/Procedure.html)\[Out]): SubFlow\[In, Out, Mat]This is a simplified version of `wireTap(Sink)` that takes only a simple procedure.
...
For logging signals (elements, completion, error) consider using the [log](#log(name:String):akka.stream.javadsl.SubFlow[In,Out,Mat]) operator instead,
...
**Cancels when** downstream cancels
131. [**](../../../akka/stream/javadsl/SubFlow.html#withAttributes(attr:akka.stream.Attributes):akka.stream.javadsl.SubFlow[In,Out,Mat] "Permalink")  def withAttributes(attr: [Attributes](../Attributes.html)): SubFlow\[In, Out, Mat]Change the attributes of this [Source](Source.html) to the given ones and seal the list
of attributes.
...
operation has no effect on an empty Flow (because the attributes apply
only to the contained processing operators).
132. [**](../../../akka/stream/javadsl/SubFlow.html#zip[T](source:akka.stream.Graph[akka.stream.SourceShape[T],_]):akka.stream.javadsl.SubFlow[In,akka.japi.Pair[Out@scala.annotation.unchecked.uncheckedVariance,T],Mat] "Permalink")  def zip\[T](source: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[T], \_]): SubFlow\[In, [Pair](../../japi/Pair.html)\[Out, T], Mat]Combine the elements of current [Flow](Flow.html) and the given [Source](Source.html) into a stream of tuples.
...
**Cancels when** downstream cancels
133. [**](../../../akka/stream/javadsl/SubFlow.html#zipAll[U,A>:Out](that:akka.stream.Graph[akka.stream.SourceShape[U],_],thisElem:A,thatElem:U):akka.stream.javadsl.SubFlow[In,akka.japi.Pair[A,U],Mat] "Permalink")  def zipAll\[U, A \>: Out](that: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[U], \_], thisElem: A, thatElem: U): SubFlow\[In, [Pair](../../japi/Pair.html)\[A, U], Mat]Combine the elements of current flow and the given [Source](Source.html) into a stream of tuples.
...
**Cancels when** downstream cancels
134. [**](../../../akka/stream/javadsl/SubFlow.html#zipLatest[T](source:akka.stream.Graph[akka.stream.SourceShape[T],_]):akka.stream.javadsl.SubFlow[In,akka.japi.Pair[Out@scala.annotation.unchecked.uncheckedVariance,T],Mat] "Permalink")  def zipLatest\[T](source: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[T], \_]): SubFlow\[In, [Pair](../../japi/Pair.html)\[Out, T], Mat]Combine the elements of current [Flow](Flow.html) and the given [Source](Source.html) into a stream of tuples, picking always the latest element of each.
...
**Cancels when** downstream cancels
135. [**](../../../akka/stream/javadsl/SubFlow.html#zipLatestWith[Out2,Out3](that:akka.stream.Graph[akka.stream.SourceShape[Out2],_],combine:akka.japi.function.Function2[Out,Out2,Out3]):akka.stream.javadsl.SubFlow[In,Out3,Mat] "Permalink")  def zipLatestWith\[Out2, Out3](that: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out2], \_], combine: [Function2](../../japi/function/Function2.html)\[Out, Out2, Out3]): SubFlow\[In, Out3, Mat]Put together the elements of current [Flow](Flow.html) and the given [Source](Source.html)
...
**Cancels when** downstream cancels
136. [**](../../../akka/stream/javadsl/SubFlow.html#zipWith[Out2,Out3](that:akka.stream.Graph[akka.stream.SourceShape[Out2],_],combine:akka.japi.function.Function2[Out,Out2,Out3]):akka.stream.javadsl.SubFlow[In,Out3,Mat] "Permalink")  def zipWith\[Out2, Out3](that: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[Out2], \_], combine: [Function2](../../japi/function/Function2.html)\[Out, Out2, Out3]): SubFlow\[In, Out3, Mat]Put together the elements of current [Flow](Flow.html) and the given [Source](Source.html)
...
**Cancels when** downstream cancels
137. [**](../../../akka/stream/javadsl/SubFlow.html#zipWithIndex:akka.stream.javadsl.SubFlow[In,akka.japi.Pair[Out@scala.annotation.unchecked.uncheckedVariance,Long],Mat] "Permalink")  def zipWithIndex: SubFlow\[In, [Pair](../../japi/Pair.html)\[Out, [Long](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Long.html#java.lang.Long)], Mat]Combine the elements of current [Flow](Flow.html) into a stream of tuples consisting
of all elements paired with their index.

Combine the elements of current [Flow](Flow.html) into a stream of tuples consisting
...
2. [**](../../../akka/stream/javadsl/SubFlow.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from SubFlow\[In, Out, Mat] toStringFormat\[SubFlow\[In, Out, Mat]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../akka/stream/javadsl/SubFlow.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (SubFlow\[In, Out, Mat], B)ImplicitThis member is added by an implicit conversion from SubFlow\[In, Out, Mat] toArrowAssoc\[SubFlow\[In, Out, Mat]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromSubFlow\[In, Out, Mat] to any2stringadd\[SubFlow\[In, Out, Mat]]

### Inherited by implicit conversion StringFormat fromSubFlow\[In, Out, Mat] to StringFormat\[SubFlow\[In, Out, Mat]]

### Inherited by implicit conversion Ensuring fromSubFlow\[In, Out, Mat] to Ensuring\[SubFlow\[In, Out, Mat]]

### Inherited by implicit conversion ArrowAssoc fromSubFlow\[In, Out, Mat] to ArrowAssoc\[SubFlow\[In, Out, Mat]]
...
- https://doc.akka.io/api/akka/2.10/akka/japi/function/Creator.html
...
- https://doc.akka.io/api/akka/2.10/akka/japi/function/Procedure.html
...
---
*Source: [https://doc.akka.io/api/akka/2.10/akka/stream/javadsl/SubFlow.html](https://doc.akka.io/api/akka/2.10/akka/stream/javadsl/SubFlow.html)*