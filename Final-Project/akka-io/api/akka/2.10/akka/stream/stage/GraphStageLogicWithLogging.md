---
description: Akka 2.10.17 - akka.stream.stage.GraphStageLogicWithLogging
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:47:19Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/stage/GraphStageLogicWithLogging.html
title: Akka 2.10.17 - akka.stream.stage.GraphStageLogicWithLogging
---

# Akka 2.10.17 - akka.stream.stage.GraphStageLogicWithLogging

> **Summary:** Akka 2.10.17 - akka.stream.stage.GraphStageLogicWithLogging
...
# GraphStageLogicWithLogging[**](../../../akka/stream/stage/GraphStageLogicWithLogging.html "Permalink")

### 

#### abstract  class GraphStageLogicWithLogging extends [GraphStageLogic](GraphStageLogic.html) with [StageLogging](StageLogging.html)

Java API: [GraphStageLogic](GraphStageLogic.html) with [StageLogging](StageLogging.html).

Source[GraphStage.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/stage/GraphStage.scala#L1876)Linear Supertypes[StageLogging](StageLogging.html), [GraphStageLogic](GraphStageLogic.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. GraphStageLogicWithLogging
2. StageLogging
3. GraphStageLogic
4. AnyRef
5. Any
...
1. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#<init>(_shape:akka.stream.Shape):akka.stream.stage.GraphStageLogicWithLogging "Permalink")  new GraphStageLogicWithLogging(\_shape: [Shape](../Shape.html))
### Type Members
...
1. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from GraphStageLogicWithLogging toany2stringadd\[GraphStageLogicWithLogging] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (GraphStageLogicWithLogging, B)ImplicitThis member is added by an implicit conversion from GraphStageLogicWithLogging toArrowAssoc\[GraphStageLogicWithLogging] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#abortEmitting(out:akka.stream.Outlet[_]):Unit "Permalink") final  def abortEmitting(out: [Outlet](../Outlet.html)\[\_]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Abort outstanding (suspended) emissions for the given outlet, if there are any.
...
7. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#abortReading(in:akka.stream.Inlet[_]):Unit "Permalink") final  def abortReading(in: [Inlet](../Inlet.html)\[\_]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Abort outstanding (suspended) reading for the given inlet, if there is any.
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
8. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#afterPostStop():Unit "Permalink")  def afterPostStop(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)INTERNAL API

INTERNAL API

Attributesprotected\[[stream](../index.html)] Definition Classes[GraphStageLogic](GraphStageLogic.html)
9. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
10. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#beforePreStart():Unit "Permalink")  def beforePreStart(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)INTERNAL API

INTERNAL API

Attributesprotected\[[stream](../index.html)] Definition Classes[GraphStageLogic](GraphStageLogic.html)
11. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#cancel[T](in:akka.stream.Inlet[T],cause:Throwable):Unit "Permalink") final  def cancel\[T](in: [Inlet](../Inlet.html)\[T], cause: Throwable): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Requests to stop receiving events from a given input port.

Requests to stop receiving events from a given input port. Cancelling clears any ungrabbed elements from the port.

Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
12. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#cancel[T](in:akka.stream.Inlet[T]):Unit "Permalink") final  def cancel\[T](in: [Inlet](../Inlet.html)\[T]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Requests to stop receiving events from a given input port.
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
13. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#cancelStage(cause:Throwable):Unit "Permalink") final  def cancelStage(cause: Throwable): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Automatically invokes [cancel](#cancel[T](in:akka.stream.Inlet[T],cause:Throwable):Unit) or [complete](#complete[T](out:akka.stream.Outlet[T]):Unit) on all the input or output ports that have been called,
...
Definition Classes[GraphStageLogic](GraphStageLogic.html)
14. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
15. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#complete[T](out:akka.stream.Outlet[T]):Unit "Permalink") final  def complete\[T](out: [Outlet](../Outlet.html)\[T]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Signals that there will be no more elements emitted on the given port.

Signals that there will be no more elements emitted on the given port.

Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
16. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#completeStage():Unit "Permalink") final  def completeStage(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Automatically invokes [cancel](#cancel[T](in:akka.stream.Inlet[T],cause:Throwable):Unit) or [complete](#complete[T](out:akka.stream.Outlet[T]):Unit) on all the input or output ports that have been called,
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
19. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#createAsyncCallback[T](handler:akka.japi.function.Procedure[T]):akka.stream.stage.AsyncCallback[T] "Permalink") final  def createAsyncCallback\[T](handler: [Procedure](../../japi/function/Procedure.html)\[T]): [AsyncCallback](AsyncCallback.html)\[T]Java API: Obtain a callback object that can be used asynchronously to re\-enter the
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
20. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#eagerTerminateInput:akka.stream.stage.InHandler "Permalink") final  def eagerTerminateInput: [InHandler](InHandler.html)Input handler that terminates the operator upon receiving completion.

Input handler that terminates the operator upon receiving completion.
The operator fails upon receiving a failure.

Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
21. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#eagerTerminateOutput:akka.stream.stage.OutHandler "Permalink") final  def eagerTerminateOutput: [OutHandler](OutHandler.html)Output handler that terminates the operator upon cancellation.

Output handler that terminates the operator upon cancellation.

Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
22. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#emit[T](out:akka.stream.Outlet[T],elem:T,andThen:akka.japi.function.Effect):Unit "Permalink") final  def emit\[T](out: [Outlet](../Outlet.html)\[T], elem: T, andThen: [Effect](../../japi/function/Effect.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
23. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#emit[T](out:akka.stream.Outlet[T],elem:T):Unit "Permalink") final  def emit\[T](out: [Outlet](../Outlet.html)\[T], elem: T): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Emit an element through the given outlet, suspending execution if necessary.
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
24. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#emit[T](out:akka.stream.Outlet[T],elem:T,andThen:()=>Unit):Unit "Permalink") final  def emit\[T](out: [Outlet](../Outlet.html)\[T], elem: T, andThen: () \=\> [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Emit an element through the given outlet and continue with the given thunk
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
28. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#emitMultiple[T](out:akka.stream.Outlet[T],elems:java.util.Iterator[T]):Unit "Permalink") final  def emitMultiple\[T](out: [Outlet](../Outlet.html)\[T], elems: [Iterator](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Iterator.html#java.util.Iterator)\[T]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Java API
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
31. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (GraphStageLogicWithLogging) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): GraphStageLogicWithLoggingImplicitThis member is added by an implicit conversion from GraphStageLogicWithLogging toEnsuring\[GraphStageLogicWithLogging] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
32. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (GraphStageLogicWithLogging) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): GraphStageLogicWithLoggingImplicitThis member is added by an implicit conversion from GraphStageLogicWithLogging toEnsuring\[GraphStageLogicWithLogging] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
33. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): GraphStageLogicWithLoggingImplicitThis member is added by an implicit conversion from GraphStageLogicWithLogging toEnsuring\[GraphStageLogicWithLogging] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
34. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): GraphStageLogicWithLoggingImplicitThis member is added by an implicit conversion from GraphStageLogicWithLogging toEnsuring\[GraphStageLogicWithLogging] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
35. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
36. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
37. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#fail[T](out:akka.stream.Outlet[T],ex:Throwable):Unit "Permalink") final  def fail\[T](out: [Outlet](../Outlet.html)\[T], ex: Throwable): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Signals failure through the given port.

Signals failure through the given port.

Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
38. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#failStage(ex:Throwable):Unit "Permalink") final  def failStage(ex: Throwable): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Automatically invokes [cancel](#cancel[T](in:akka.stream.Inlet[T],cause:Throwable):Unit) or [fail](#fail[T](out:akka.stream.Outlet[T],ex:Throwable):Unit) on all the input or output ports that have been called,
then marks the operator as stopped.
...
Definition Classes[GraphStageLogic](GraphStageLogic.html)
39. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#getAsyncCallback[T](handler:T=>Unit):akka.stream.stage.AsyncCallback[T] "Permalink") final  def getAsyncCallback\[T](handler: (T) \=\> [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)): [AsyncCallback](AsyncCallback.html)\[T]Obtain a callback object that can be used asynchronously to re\-enter the
current [GraphStage](GraphStage.html) with an asynchronous notification.
...
Definition Classes[GraphStageLogic](GraphStageLogic.html)
40. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
41. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#getEagerStageActor(eagerMaterializer:akka.stream.Materializer)(receive:((akka.actor.ActorRef,Any))=>Unit):akka.stream.stage.GraphStageLogic.StageActor "Permalink")  def getEagerStageActor(eagerMaterializer: [Materializer](../Materializer.html))(receive: (([ActorRef](../../actor/ActorRef.html), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any))) \=\> [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)): [StageActor](GraphStageLogic$$StageActor.html)INTERNAL API
...
42. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#getHandler(out:akka.stream.Outlet[_]):akka.stream.stage.OutHandler "Permalink") final  def getHandler(out: [Outlet](../Outlet.html)\[\_]): [OutHandler](OutHandler.html)Retrieves the current callback for the events on the given [Outlet](../Outlet.html)

Retrieves the current callback for the events on the given [Outlet](../Outlet.html)

Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
43. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#getHandler(in:akka.stream.Inlet[_]):akka.stream.stage.InHandler "Permalink") final  def getHandler(in: [Inlet](../Inlet.html)\[\_]): [InHandler](InHandler.html)Retrieves the current callback for the events on the given [Inlet](../Inlet.html)

Retrieves the current callback for the events on the given [Inlet](../Inlet.html)

Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
44. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#getStageActor(receive:((akka.actor.ActorRef,Any))=>Unit):akka.stream.stage.GraphStageLogic.StageActor "Permalink") final  def getStageActor(receive: (([ActorRef](../../actor/ActorRef.html), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any))) \=\> [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)): [StageActor](GraphStageLogic$$StageActor.html)Initialize a StageActorRef which can be used to interact with from the outside world "as\-if" an Actor.
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
45. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#grab[T](in:akka.stream.Inlet[T]):T "Permalink") final  def grab\[T](in: [Inlet](../Inlet.html)\[T]): TOnce the callback [InHandler.onPush](InHandler.html#onPush():Unit) for an input port has been invoked, the element that has been pushed
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
46. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#hasBeenPulled[T](in:akka.stream.Inlet[T]):Boolean "Permalink") final  def hasBeenPulled\[T](in: [Inlet](../Inlet.html)\[T]): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Indicates whether there is already a pending pull for the given input port.
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
47. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
48. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#ignoreTerminateInput:akka.stream.stage.InHandler "Permalink") final  def ignoreTerminateInput: [InHandler](InHandler.html)Input handler that does not terminate the operator upon receiving completion.

Input handler that does not terminate the operator upon receiving completion.
The operator fails upon receiving a failure.

Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
49. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#ignoreTerminateOutput:akka.stream.stage.OutHandler "Permalink") final  def ignoreTerminateOutput: [OutHandler](OutHandler.html)Output handler that does not terminate the operator upon cancellation.

Output handler that does not terminate the operator upon cancellation.

Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
50. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#inCount:Int "Permalink")  val inCount: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition Classes[GraphStageLogic](GraphStageLogic.html)
51. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#isAvailable[T](out:akka.stream.Outlet[T]):Boolean "Permalink") final  def isAvailable\[T](out: [Outlet](../Outlet.html)\[T]): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Return true if the given output port is ready to be pushed.

Return true if the given output port is ready to be pushed.

Definition Classes[GraphStageLogic](GraphStageLogic.html)
52. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#isAvailable[T](in:akka.stream.Inlet[T]):Boolean "Permalink") final  def isAvailable\[T](in: [Inlet](../Inlet.html)\[T]): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Indicates whether there is an element waiting at the given input port.
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
53. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#isClosed[T](out:akka.stream.Outlet[T]):Boolean "Permalink") final  def isClosed\[T](out: [Outlet](../Outlet.html)\[T]): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Indicates whether the port has been closed.

Indicates whether the port has been closed. A closed port cannot be pushed.

Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
54. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#isClosed[T](in:akka.stream.Inlet[T]):Boolean "Permalink") final  def isClosed\[T](in: [Inlet](../Inlet.html)\[T]): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Indicates whether the port has been closed.

Indicates whether the port has been closed. A closed port cannot be pulled.

Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
55. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
56. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#log:akka.event.LoggingAdapter "Permalink")  def log: [LoggingAdapter](../../event/LoggingAdapter.html)Definition Classes[StageLogging](StageLogging.html)
57. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#logSource:Class[_] "Permalink")  def logSource: Class\[\_]Override to customise reported log source

Override to customise reported log source

Attributesprotected Definition Classes[StageLogging](StageLogging.html)
58. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#materializer:akka.stream.Materializer "Permalink")  def materializer: [Materializer](../Materializer.html)The [akka.stream.Materializer](../Materializer.html) that has set this GraphStage in motion.
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
59. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
60. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
61. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
62. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#outCount:Int "Permalink")  val outCount: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition Classes[GraphStageLogic](GraphStageLogic.html)
63. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#passAlong[Out,In<:Out](from:akka.stream.Inlet[In],to:akka.stream.Outlet[Out],doFinish:Boolean,doFail:Boolean,doPull:Boolean):Unit "Permalink") final  def passAlong\[Out, In \<: Out](from: [Inlet](../Inlet.html)\[In], to: [Outlet](../Outlet.html)\[Out], doFinish: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean) \= true, doFail: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean) \= true, doPull: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean) \= false): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Install a handler on the given inlet that emits received elements on the
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
64. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#postStop():Unit "Permalink")  def postStop(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Invoked after processing of external events stopped because the operator is about to stop or fail.
...
65. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#preStart():Unit "Permalink")  def preStart(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Invoked before any external events are processed, at the startup of the operator.

Invoked before any external events are processed, at the startup of the operator.

Definition Classes[GraphStageLogic](GraphStageLogic.html)Annotations@throws(classOf\[Exception])
66. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#pull[T](in:akka.stream.Inlet[T]):Unit "Permalink") final  def pull\[T](in: [Inlet](../Inlet.html)\[T]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Requests an element on the given port.
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
67. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#push[T](out:akka.stream.Outlet[T],elem:T):Unit "Permalink") final  def push\[T](out: [Outlet](../Outlet.html)\[T], elem: T): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Emits an element through the given output port.
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
76. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#stageActor:akka.stream.stage.GraphStageLogic.StageActor "Permalink") final  def stageActor: [StageActor](GraphStageLogic$$StageActor.html)Definition Classes[GraphStageLogic](GraphStageLogic.html)
77. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#stageActorName:String "Permalink")  def stageActorName: StringOverride and return a name to be given to the StageActor of this operator.
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
78. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#subFusingMaterializer:akka.stream.Materializer "Permalink")  def subFusingMaterializer: [Materializer](../Materializer.html)An [akka.stream.Materializer](../Materializer.html) that may run fusable parts of the graphs
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
79. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
80. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#toString():String "Permalink")  def toString(): StringDefinition Classes[GraphStageLogic](GraphStageLogic.html) → AnyRef → Any
81. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#totallyIgnorantInput:akka.stream.stage.InHandler "Permalink") final  def totallyIgnorantInput: [InHandler](InHandler.html)Input handler that does not terminate the operator upon receiving completion
nor failure.
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
82. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#tryPull[T](in:akka.stream.Inlet[T]):Unit "Permalink") final  def tryPull\[T](in: [Inlet](../Inlet.html)\[T]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Requests an element on the given port unless the port is already closed.
...
Attributesprotected Definition Classes[GraphStageLogic](GraphStageLogic.html)
83. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
84. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
85. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from GraphStageLogicWithLogging toStringFormat\[GraphStageLogicWithLogging] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../akka/stream/stage/GraphStageLogicWithLogging.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (GraphStageLogicWithLogging, B)ImplicitThis member is added by an implicit conversion from GraphStageLogicWithLogging toArrowAssoc\[GraphStageLogicWithLogging] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromGraphStageLogicWithLogging to any2stringadd\[GraphStageLogicWithLogging]

### Inherited by implicit conversion StringFormat fromGraphStageLogicWithLogging to StringFormat\[GraphStageLogicWithLogging]

### Inherited by implicit conversion Ensuring fromGraphStageLogicWithLogging to Ensuring\[GraphStageLogicWithLogging]

### Inherited by implicit conversion ArrowAssoc fromGraphStageLogicWithLogging to ArrowAssoc\[GraphStageLogicWithLogging]
...
---
*Source: [https://doc.akka.io/api/akka/2.10/akka/stream/stage/GraphStageLogicWithLogging.html](https://doc.akka.io/api/akka/2.10/akka/stream/stage/GraphStageLogicWithLogging.html)*