---
description: Akka 2.10.17 - akka.stream.scaladsl.ScalaSessionAPI
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:13:58Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/ScalaSessionAPI.html
title: Akka 2.10.17 - akka.stream.scaladsl.ScalaSessionAPI
---

# Akka 2.10.17 - akka.stream.scaladsl.ScalaSessionAPI

> **Summary:** Akka 2.10.17 - akka.stream.scaladsl.ScalaSessionAPI
...
[t](ScalaSessionAPI$.html "See companion object")[akka](../../index.html).[stream](../index.html).[scaladsl](index.html)

# [ScalaSessionAPI](ScalaSessionAPI$.html "See companion object")[**](../../../akka/stream/scaladsl/ScalaSessionAPI.html "Permalink")

### Companion [object ScalaSessionAPI](ScalaSessionAPI$.html "See companion object")

#### trait ScalaSessionAPI extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

Allows access to an SSLSession with Scala types

Source[TLS.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/scaladsl/TLS.scala#L112)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[SessionBytes](../TLSProtocol$$SessionBytes.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ScalaSessionAPI
2. AnyRef
...
1. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#session:javax.net.ssl.SSLSession "Permalink") abstract  def session: [SSLSession](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/javax/net/ssl/SSLSession.html#javax.net.ssl.SSLSession)The underlying [javax.net.ssl.SSLSession](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/javax/net/ssl/SSLSession.html).
### Concrete Value Members

1. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ScalaSessionAPI toany2stringadd\[ScalaSessionAPI] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ScalaSessionAPI, B)ImplicitThis member is added by an implicit conversion from ScalaSessionAPI toArrowAssoc\[ScalaSessionAPI] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ScalaSessionAPI) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ScalaSessionAPIImplicitThis member is added by an implicit conversion from ScalaSessionAPI toEnsuring\[ScalaSessionAPI] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ScalaSessionAPI) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ScalaSessionAPIImplicitThis member is added by an implicit conversion from ScalaSessionAPI toEnsuring\[ScalaSessionAPI] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ScalaSessionAPIImplicitThis member is added by an implicit conversion from ScalaSessionAPI toEnsuring\[ScalaSessionAPI] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ScalaSessionAPIImplicitThis member is added by an implicit conversion from ScalaSessionAPI toEnsuring\[ScalaSessionAPI] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#localCertificates:List[java.security.cert.Certificate] "Permalink")  def localCertificates: List\[[Certificate](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/cert/Certificate.html#java.security.cert.Certificate)]Scala API: Extract the certificates that were actually used by this
...
18. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#localPrincipal:Option[java.security.Principal] "Permalink")  def localPrincipal: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Principal](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/Principal.html#java.security.Principal)]Scala API: Extract the Principal that was actually used by this engine
during this session’s negotiation.
19. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
20. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#peerCertificates:List[java.security.cert.Certificate] "Permalink")  def peerCertificates: List\[[Certificate](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/cert/Certificate.html#java.security.cert.Certificate)]Scala API: Extract the certificates that were used by the peer engine
during this session’s negotiation.
...
were used.
23. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#peerPrincipal:Option[java.security.Principal] "Permalink")  def peerPrincipal: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Principal](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/Principal.html#java.security.Principal)]Scala API: Extract the Principal that the peer engine presented during
this session’s negotiation.
24. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
25. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
26. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
27. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
28. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ScalaSessionAPI toStringFormat\[ScalaSessionAPI] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../akka/stream/scaladsl/ScalaSessionAPI.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ScalaSessionAPI, B)ImplicitThis member is added by an implicit conversion from ScalaSessionAPI toArrowAssoc\[ScalaSessionAPI] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromScalaSessionAPI to any2stringadd\[ScalaSessionAPI]

### Inherited by implicit conversion StringFormat fromScalaSessionAPI to StringFormat\[ScalaSessionAPI]

### Inherited by implicit conversion Ensuring fromScalaSessionAPI to Ensuring\[ScalaSessionAPI]

### Inherited by implicit conversion ArrowAssoc fromScalaSessionAPI to ArrowAssoc\[ScalaSessionAPI]
...
---
*Source: [https://doc.akka.io/api/akka/2.10/akka/stream/scaladsl/ScalaSessionAPI.html](https://doc.akka.io/api/akka/2.10/akka/stream/scaladsl/ScalaSessionAPI.html)*