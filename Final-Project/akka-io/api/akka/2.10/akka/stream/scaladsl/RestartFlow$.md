---
description: Akka 2.10.17 - akka.stream.scaladsl.RestartFlow
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:13:52Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/RestartFlow$.html
title: Akka 2.10.17 - akka.stream.scaladsl.RestartFlow
---

# Akka 2.10.17 - akka.stream.scaladsl.RestartFlow

> **Summary:** Akka 2.10.17 - akka.stream.scaladsl.RestartFlow
...
# RestartFlow[**](../../../akka/stream/scaladsl/RestartFlow$.html "Permalink")
...
Source[RestartFlow.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/scaladsl/RestartFlow.scala#L28)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. RestartFlow
2. AnyRef
...
1. [**](../../../akka/stream/scaladsl/RestartFlow$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../akka/stream/scaladsl/RestartFlow$.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../akka/stream/scaladsl/RestartFlow$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../akka/stream/scaladsl/RestartFlow$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/stream/scaladsl/RestartFlow$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../../akka/stream/scaladsl/RestartFlow$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
7. [**](../../../akka/stream/scaladsl/RestartFlow$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
8. [**](../../../akka/stream/scaladsl/RestartFlow$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
9. [**](../../../akka/stream/scaladsl/RestartFlow$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
10. [**](../../../akka/stream/scaladsl/RestartFlow$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
11. [**](../../../akka/stream/scaladsl/RestartFlow$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
12. [**](../../../akka/stream/scaladsl/RestartFlow$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../../akka/stream/scaladsl/RestartFlow$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../../akka/stream/scaladsl/RestartFlow$.html#onFailuresWithBackoff[In,Out](settings:akka.stream.RestartSettings)(flowFactory:()=>akka.stream.scaladsl.Flow[In,Out,_]):akka.stream.scaladsl.Flow[In,Out,akka.NotUsed] "Permalink")  def onFailuresWithBackoff\[In, Out](settings: [RestartSettings](../RestartSettings.html))(flowFactory: () \=\> [Flow](Flow.html)\[In, Out, \_]): [Flow](Flow.html)\[In, Out, [NotUsed](../../NotUsed.html)]Wrap the given [Flow](Flow.html) with a [Flow](Flow.html) that will restart it when it fails using an exponential
backoff.

Wrap the given [Flow](Flow.html) with a [Flow](Flow.html) that will restart it when it fails using an exponential
backoff. Notice that this [Flow](Flow.html) will not restart on completion of the wrapped flow.

This [Flow](Flow.html) will not emit any failure
The failures by the wrapped [Flow](Flow.html) will be handled by
restarting the wrapping [Flow](Flow.html) as long as maxRestarts is not reached.
Any termination signals sent to this [Flow](Flow.html) however will terminate the wrapped [Flow](Flow.html), if it's
...
15. [**](../../../akka/stream/scaladsl/RestartFlow$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
16. [**](../../../akka/stream/scaladsl/RestartFlow$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
17. [**](../../../akka/stream/scaladsl/RestartFlow$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
18. [**](../../../akka/stream/scaladsl/RestartFlow$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
19. [**](../../../akka/stream/scaladsl/RestartFlow$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
20. [**](../../../akka/stream/scaladsl/RestartFlow$.html#withBackoff[In,Out](settings:akka.stream.RestartSettings)(flowFactory:()=>akka.stream.scaladsl.Flow[In,Out,_]):akka.stream.scaladsl.Flow[In,Out,akka.NotUsed] "Permalink")  def withBackoff\[In, Out](settings: [RestartSettings](../RestartSettings.html))(flowFactory: () \=\> [Flow](Flow.html)\[In, Out, \_]): [Flow](Flow.html)\[In, Out, [NotUsed](../../NotUsed.html)]Wrap the given [Flow](Flow.html) with a [Flow](Flow.html) that will restart it when it fails or complete using an exponential
backoff.
...
1. [**](../../../akka/stream/scaladsl/RestartFlow$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../akka/stream/scaladsl/RestartFlow$.html#onFailuresWithBackoff[In,Out](minBackoff:scala.concurrent.duration.FiniteDuration,maxBackoff:scala.concurrent.duration.FiniteDuration,randomFactor:Double,maxRestarts:Int)(flowFactory:()=>akka.stream.scaladsl.Flow[In,Out,_]):akka.stream.scaladsl.Flow[In,Out,akka.NotUsed] "Permalink")  def onFailuresWithBackoff\[In, Out](minBackoff: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), maxBackoff: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), randomFactor: [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double), maxRestarts: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int))(flowFactory: () \=\> [Flow](Flow.html)\[In, Out, \_]): [Flow](Flow.html)\[In, Out, [NotUsed](../../NotUsed.html)]Wrap the given [Flow](Flow.html) with a [Flow](Flow.html) that will restart it when it fails using an exponential
backoff.
...
3. [**](../../../akka/stream/scaladsl/RestartFlow$.html#withBackoff[In,Out](minBackoff:scala.concurrent.duration.FiniteDuration,maxBackoff:scala.concurrent.duration.FiniteDuration,randomFactor:Double,maxRestarts:Int)(flowFactory:()=>akka.stream.scaladsl.Flow[In,Out,_]):akka.stream.scaladsl.Flow[In,Out,akka.NotUsed] "Permalink")  def withBackoff\[In, Out](minBackoff: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), maxBackoff: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), randomFactor: [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double), maxRestarts: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int))(flowFactory: () \=\> [Flow](Flow.html)\[In, Out, \_]): [Flow](Flow.html)\[In, Out, [NotUsed](../../NotUsed.html)]Wrap the given [Flow](Flow.html) with a [Flow](Flow.html) that will restart it when it fails or complete using an exponential
backoff.
...
Annotations@Deprecated @deprecated Deprecated*(Since version 2\.6\.10\)* Use the overloaded method which accepts akka.stream.RestartSettings instead.
4. [**](../../../akka/stream/scaladsl/RestartFlow$.html#withBackoff[In,Out](minBackoff:scala.concurrent.duration.FiniteDuration,maxBackoff:scala.concurrent.duration.FiniteDuration,randomFactor:Double)(flowFactory:()=>akka.stream.scaladsl.Flow[In,Out,_]):akka.stream.scaladsl.Flow[In,Out,akka.NotUsed] "Permalink")  def withBackoff\[In, Out](minBackoff: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), maxBackoff: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), randomFactor: [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double))(flowFactory: () \=\> [Flow](Flow.html)\[In, Out, \_]): [Flow](Flow.html)\[In, Out, [NotUsed](../../NotUsed.html)]Wrap the given [Flow](Flow.html) with a [Flow](Flow.html) that will restart it when it fails or complete using an exponential
backoff.
...
---
*Source: [https://doc.akka.io/api/akka/2.10/akka/stream/scaladsl/RestartFlow$.html](https://doc.akka.io/api/akka/2.10/akka/stream/scaladsl/RestartFlow$.html)*