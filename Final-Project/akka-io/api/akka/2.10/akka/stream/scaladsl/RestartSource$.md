---
description: Akka 2.10.17 - akka.stream.scaladsl.RestartSource
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:13:52Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/RestartSource$.html
title: Akka 2.10.17 - akka.stream.scaladsl.RestartSource
---

# Akka 2.10.17 - akka.stream.scaladsl.RestartSource

> **Summary:** Akka 2.10.17 - akka.stream.scaladsl.RestartSource
...
# RestartSource[**](../../../akka/stream/scaladsl/RestartSource$.html "Permalink")
...
Source[RestartSource.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/scaladsl/RestartSource.scala#L19)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. RestartSource
2. AnyRef
...
1. [**](../../../akka/stream/scaladsl/RestartSource$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../akka/stream/scaladsl/RestartSource$.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../akka/stream/scaladsl/RestartSource$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../akka/stream/scaladsl/RestartSource$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/stream/scaladsl/RestartSource$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../../akka/stream/scaladsl/RestartSource$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
7. [**](../../../akka/stream/scaladsl/RestartSource$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
8. [**](../../../akka/stream/scaladsl/RestartSource$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
9. [**](../../../akka/stream/scaladsl/RestartSource$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
10. [**](../../../akka/stream/scaladsl/RestartSource$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
11. [**](../../../akka/stream/scaladsl/RestartSource$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
12. [**](../../../akka/stream/scaladsl/RestartSource$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../../akka/stream/scaladsl/RestartSource$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../../akka/stream/scaladsl/RestartSource$.html#onFailuresWithBackoff[T](settings:akka.stream.RestartSettings)(sourceFactory:()=>akka.stream.scaladsl.Source[T,_]):akka.stream.scaladsl.Source[T,akka.NotUsed] "Permalink")  def onFailuresWithBackoff\[T](settings: [RestartSettings](../RestartSettings.html))(sourceFactory: () \=\> [Source](Source.html)\[T, \_]): [Source](Source.html)\[T, [NotUsed](../../NotUsed.html)]Wrap the given [Source](Source.html) with a [Source](Source.html) that will restart it when it fails using an exponential backoff.

Wrap the given [Source](Source.html) with a [Source](Source.html) that will restart it when it fails using an exponential backoff.

This [Source](Source.html) will not emit a failure as long as maxRestarts is not reached, since failure of the wrapped [Source](Source.html)
is handled by restarting it. The wrapped [Source](Source.html) can be cancelled
by cancelling this [Source](Source.html). When that happens, the wrapped [Source](Source.html), if currently running will be cancelled,
and it will not be restarted.
This can be triggered simply by the downstream cancelling, or externally by introducing a [KillSwitch](../KillSwitch.html) right
after this [Source](Source.html) in the graph.
...
sourceFactoryA factory for producing the [Source](Source.html) to wrap.
15. [**](../../../akka/stream/scaladsl/RestartSource$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
16. [**](../../../akka/stream/scaladsl/RestartSource$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
17. [**](../../../akka/stream/scaladsl/RestartSource$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
18. [**](../../../akka/stream/scaladsl/RestartSource$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
19. [**](../../../akka/stream/scaladsl/RestartSource$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
20. [**](../../../akka/stream/scaladsl/RestartSource$.html#withBackoff[T](settings:akka.stream.RestartSettings)(sourceFactory:()=>akka.stream.scaladsl.Source[T,_]):akka.stream.scaladsl.Source[T,akka.NotUsed] "Permalink")  def withBackoff\[T](settings: [RestartSettings](../RestartSettings.html))(sourceFactory: () \=\> [Source](Source.html)\[T, \_]): [Source](Source.html)\[T, [NotUsed](../../NotUsed.html)]Wrap the given [Source](Source.html) with a [Source](Source.html) that will restart it when it fails or complete using an exponential
backoff.

Wrap the given [Source](Source.html) with a [Source](Source.html) that will restart it when it fails or complete using an exponential
backoff.

This [Source](Source.html) will not emit a complete or failure as long as maxRestarts is not reached, since the completion
or failure of the wrapped [Source](Source.html) is handled by restarting it. The wrapped [Source](Source.html) can however be cancelled
by cancelling this [Source](Source.html). When that happens, the wrapped [Source](Source.html), if currently running will be cancelled,
and it will not be restarted.
This can be triggered simply by the downstream cancelling, or externally by introducing a [KillSwitch](../KillSwitch.html) right
after this [Source](Source.html) in the graph.
...
1. [**](../../../akka/stream/scaladsl/RestartSource$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../akka/stream/scaladsl/RestartSource$.html#onFailuresWithBackoff[T](minBackoff:scala.concurrent.duration.FiniteDuration,maxBackoff:scala.concurrent.duration.FiniteDuration,randomFactor:Double,maxRestarts:Int)(sourceFactory:()=>akka.stream.scaladsl.Source[T,_]):akka.stream.scaladsl.Source[T,akka.NotUsed] "Permalink")  def onFailuresWithBackoff\[T](minBackoff: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), maxBackoff: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), randomFactor: [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double), maxRestarts: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int))(sourceFactory: () \=\> [Source](Source.html)\[T, \_]): [Source](Source.html)\[T, [NotUsed](../../NotUsed.html)]Wrap the given [Source](Source.html) with a [Source](Source.html) that will restart it when it fails using an exponential backoff.
...
3. [**](../../../akka/stream/scaladsl/RestartSource$.html#onFailuresWithBackoff[T](minBackoff:scala.concurrent.duration.FiniteDuration,maxBackoff:scala.concurrent.duration.FiniteDuration,randomFactor:Double)(sourceFactory:()=>akka.stream.scaladsl.Source[T,_]):akka.stream.scaladsl.Source[T,akka.NotUsed] "Permalink")  def onFailuresWithBackoff\[T](minBackoff: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), maxBackoff: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), randomFactor: [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double))(sourceFactory: () \=\> [Source](Source.html)\[T, \_]): [Source](Source.html)\[T, [NotUsed](../../NotUsed.html)]Wrap the given [Source](Source.html) with a [Source](Source.html) that will restart it when it fails using an exponential backoff.

Wrap the given [Source](Source.html) with a [Source](Source.html) that will restart it when it fails using an exponential backoff.

This [Source](Source.html) will not emit a failure as long as maxRestarts is not reached, since failure of the wrapped [Source](Source.html)
is handled by restarting it. The wrapped [Source](Source.html) can be cancelled
by cancelling this [Source](Source.html).
When that happens, the wrapped [Source](Source.html), if currently running will be cancelled, and it will not be restarted.
This can be triggered simply by the downstream cancelling, or externally by introducing a [KillSwitch](../KillSwitch.html) right
after this [Source](Source.html) in the graph.
...
Annotations@Deprecated @deprecated Deprecated*(Since version 2\.6\.10\)* Use the overloaded method which accepts akka.stream.RestartSettings instead.
4. [**](../../../akka/stream/scaladsl/RestartSource$.html#withBackoff[T](minBackoff:scala.concurrent.duration.FiniteDuration,maxBackoff:scala.concurrent.duration.FiniteDuration,randomFactor:Double,maxRestarts:Int)(sourceFactory:()=>akka.stream.scaladsl.Source[T,_]):akka.stream.scaladsl.Source[T,akka.NotUsed] "Permalink")  def withBackoff\[T](minBackoff: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), maxBackoff: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), randomFactor: [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double), maxRestarts: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int))(sourceFactory: () \=\> [Source](Source.html)\[T, \_]): [Source](Source.html)\[T, [NotUsed](../../NotUsed.html)]Wrap the given [Source](Source.html) with a [Source](Source.html) that will restart it when it fails or complete using an exponential
backoff.
...
Annotations@Deprecated @deprecated Deprecated*(Since version 2\.6\.10\)* Use the overloaded method which accepts akka.stream.RestartSettings instead.
5. [**](../../../akka/stream/scaladsl/RestartSource$.html#withBackoff[T](minBackoff:scala.concurrent.duration.FiniteDuration,maxBackoff:scala.concurrent.duration.FiniteDuration,randomFactor:Double)(sourceFactory:()=>akka.stream.scaladsl.Source[T,_]):akka.stream.scaladsl.Source[T,akka.NotUsed] "Permalink")  def withBackoff\[T](minBackoff: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), maxBackoff: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), randomFactor: [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double))(sourceFactory: () \=\> [Source](Source.html)\[T, \_]): [Source](Source.html)\[T, [NotUsed](../../NotUsed.html)]Wrap the given [Source](Source.html) with a [Source](Source.html) that will restart it when it fails or complete using an exponential
backoff.

Wrap the given [Source](Source.html) with a [Source](Source.html) that will restart it when it fails or complete using an exponential
backoff.

This [Source](Source.html) will never emit a complete or failure, since the completion or failure of the wrapped [Source](Source.html)
is always handled by restarting it. The wrapped [Source](Source.html) can however be cancelled by cancelling this [Source](Source.html).
When that happens, the wrapped [Source](Source.html), if currently running will be cancelled, and it will not be restarted.
This can be triggered simply by the downstream cancelling, or externally by introducing a [KillSwitch](../KillSwitch.html) right
after this [Source](Source.html) in the graph.
...
---
*Source: [https://doc.akka.io/api/akka/2.10/akka/stream/scaladsl/RestartSource$.html](https://doc.akka.io/api/akka/2.10/akka/stream/scaladsl/RestartSource$.html)*