---
description: Akka 2.10.17 - akka.stream.scaladsl.PartitionHub
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:13:51Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/PartitionHub$.html
title: Akka 2.10.17 - akka.stream.scaladsl.PartitionHub
---

# Akka 2.10.17 - akka.stream.scaladsl.PartitionHub

> **Summary:** Akka 2.10.17 - akka.stream.scaladsl.PartitionHub
...
# PartitionHub[**](../../../akka/stream/scaladsl/PartitionHub$.html "Permalink")
...
Source[Hub.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/scaladsl/Hub.scala#L869)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. PartitionHub
2. AnyRef
...
1. [**](../../../akka/stream/scaladsl/PartitionHub$$ConsumerInfo.html "Permalink")  trait [ConsumerInfo](PartitionHub$$ConsumerInfo.html) extends [javadsl.PartitionHub.ConsumerInfo](../javadsl/PartitionHub$$ConsumerInfo.html)Annotations@[DoNotInherit](../../annotation/DoNotInherit.html)()
### Value Members

1. [**](../../../akka/stream/scaladsl/PartitionHub$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../akka/stream/scaladsl/PartitionHub$.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../akka/stream/scaladsl/PartitionHub$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../akka/stream/scaladsl/PartitionHub$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/stream/scaladsl/PartitionHub$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../../akka/stream/scaladsl/PartitionHub$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
7. [**](../../../akka/stream/scaladsl/PartitionHub$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
8. [**](../../../akka/stream/scaladsl/PartitionHub$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
9. [**](../../../akka/stream/scaladsl/PartitionHub$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
10. [**](../../../akka/stream/scaladsl/PartitionHub$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
11. [**](../../../akka/stream/scaladsl/PartitionHub$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
12. [**](../../../akka/stream/scaladsl/PartitionHub$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../../akka/stream/scaladsl/PartitionHub$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../../akka/stream/scaladsl/PartitionHub$.html#sink[T](partitioner:(Int,T)=>Int,startAfterNrOfConsumers:Int,bufferSize:Int):akka.stream.scaladsl.Sink[T,akka.stream.scaladsl.Source[T,akka.NotUsed]] "Permalink")  def sink\[T](partitioner: ([Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), T) \=\> [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), startAfterNrOfConsumers: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), bufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int) \= defaultBufferSize): [Sink](Sink.html)\[T, [Source](Source.html)\[T, [NotUsed](../../NotUsed.html)]]Creates a [Sink](Sink.html) that receives elements from its upstream producer and routes them to a dynamic set
of consumers.
...
elements. Otherwise the [\#statefulSink](#statefulSink[T](partitioner:()=>(akka.stream.scaladsl.PartitionHub.ConsumerInfo,T)=>Long,startAfterNrOfConsumers:Int,bufferSize:Int):akka.stream.scaladsl.Sink[T,akka.stream.scaladsl.Source[T,akka.NotUsed]]) can be used to implement more advanced routing logic.
...
bufferSizeTotal number of elements that can be buffered. If this buffer is full, the producer
 is backpressured.
15. [**](../../../akka/stream/scaladsl/PartitionHub$.html#statefulSink[T](partitioner:()=>(akka.stream.scaladsl.PartitionHub.ConsumerInfo,T)=>Long,startAfterNrOfConsumers:Int,bufferSize:Int):akka.stream.scaladsl.Sink[T,akka.stream.scaladsl.Source[T,akka.NotUsed]] "Permalink")  def statefulSink\[T](partitioner: () \=\> ([ConsumerInfo](PartitionHub$$ConsumerInfo.html), T) \=\> [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), startAfterNrOfConsumers: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), bufferSize: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int) \= defaultBufferSize): [Sink](Sink.html)\[T, [Source](Source.html)\[T, [NotUsed](../../NotUsed.html)]]Creates a [Sink](Sink.html) that receives elements from its upstream producer and routes them to a dynamic set
of consumers.
...
e.g. for implementing round\-robin or sticky session kind of routing. If state is not needed the [\#sink](#sink[T](partitioner:(Int,T)=>Int,startAfterNrOfConsumers:Int,bufferSize:Int):akka.stream.scaladsl.Sink[T,akka.stream.scaladsl.Source[T,akka.NotUsed]]) can
...
bufferSizeTotal number of elements that can be buffered. If this buffer is full, the producer
 is backpressured.
16. [**](../../../akka/stream/scaladsl/PartitionHub$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
17. [**](../../../akka/stream/scaladsl/PartitionHub$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
18. [**](../../../akka/stream/scaladsl/PartitionHub$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
19. [**](../../../akka/stream/scaladsl/PartitionHub$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
20. [**](../../../akka/stream/scaladsl/PartitionHub$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../akka/stream/scaladsl/PartitionHub$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka/2.10/akka/stream/scaladsl/PartitionHub$.html](https://doc.akka.io/api/akka/2.10/akka/stream/scaladsl/PartitionHub$.html)*