---
description: Akka 2.10.17 - akka.stream.scaladsl.SourceToCompletionStage
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:14:06Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/package$$SourceToCompletionStage.html
title: Akka 2.10.17 - akka.stream.scaladsl.SourceToCompletionStage
---

# Akka 2.10.17 - akka.stream.scaladsl.SourceToCompletionStage

> **Summary:** Akka 2.10.17 - akka.stream.scaladsl.SourceToCompletionStage
...
# SourceToCompletionStage[**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html "Permalink")

### 

#### implicit final  class SourceToCompletionStage\[Out, T] extends [AnyVal](https://www.scala-lang.org/api/2.13.17/scala/AnyVal.html#scala.AnyVal)

Source[package.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/scaladsl/package.scala#L58)Linear Supertypes[AnyVal](https://www.scala-lang.org/api/2.13.17/scala/AnyVal.html#scala.AnyVal), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. SourceToCompletionStage
2. AnyVal
3. Any
Implicitly  
1. by any2stringadd
...
1. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#<init>(src:akka.stream.scaladsl.Source[Out,scala.concurrent.Future[T]]):akka.stream.scaladsl.package.SourceToCompletionStage[Out,T] "Permalink")  new SourceToCompletionStage(src: [Source](Source.html)\[Out, [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[T]])
### Value Members

1. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
2. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAny
3. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from SourceToCompletionStage\[Out, T] toany2stringadd\[SourceToCompletionStage\[Out, T]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (SourceToCompletionStage\[Out, T], B)ImplicitThis member is added by an implicit conversion from SourceToCompletionStage\[Out, T] toArrowAssoc\[SourceToCompletionStage\[Out, T]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
6. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (SourceToCompletionStage\[Out, T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SourceToCompletionStage\[Out, T]ImplicitThis member is added by an implicit conversion from SourceToCompletionStage\[Out, T] toEnsuring\[SourceToCompletionStage\[Out, T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
8. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (SourceToCompletionStage\[Out, T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SourceToCompletionStage\[Out, T]ImplicitThis member is added by an implicit conversion from SourceToCompletionStage\[Out, T] toEnsuring\[SourceToCompletionStage\[Out, T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SourceToCompletionStage\[Out, T]ImplicitThis member is added by an implicit conversion from SourceToCompletionStage\[Out, T] toEnsuring\[SourceToCompletionStage\[Out, T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SourceToCompletionStage\[Out, T]ImplicitThis member is added by an implicit conversion from SourceToCompletionStage\[Out, T] toEnsuring\[SourceToCompletionStage\[Out, T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#getClass():Class[_<:AnyVal] "Permalink")  def getClass(): Class\[\_ \<: [AnyVal](https://www.scala-lang.org/api/2.13.17/scala/AnyVal.html#scala.AnyVal)]Definition ClassesAnyVal → Any
12. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
13. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#src:akka.stream.scaladsl.Source[Out,scala.concurrent.Future[T]] "Permalink")  val src: [Source](Source.html)\[Out, [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[T]]
14. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#toCompletionStage():akka.stream.scaladsl.Source[Out,java.util.concurrent.CompletionStage[T]] "Permalink")  def toCompletionStage(): [Source](Source.html)\[Out, [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[T]]
15. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAny
### Deprecated Value Members

1. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from SourceToCompletionStage\[Out, T] toStringFormat\[SourceToCompletionStage\[Out, T]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
2. [**](../../../akka/stream/scaladsl/package$$SourceToCompletionStage.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (SourceToCompletionStage\[Out, T], B)ImplicitThis member is added by an implicit conversion from SourceToCompletionStage\[Out, T] toArrowAssoc\[SourceToCompletionStage\[Out, T]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyVal](https://www.scala-lang.org/api/2.13.17/scala/AnyVal.html#scala.AnyVal)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromSourceToCompletionStage\[Out, T] to any2stringadd\[SourceToCompletionStage\[Out, T]]

### Inherited by implicit conversion StringFormat fromSourceToCompletionStage\[Out, T] to StringFormat\[SourceToCompletionStage\[Out, T]]

### Inherited by implicit conversion Ensuring fromSourceToCompletionStage\[Out, T] to Ensuring\[SourceToCompletionStage\[Out, T]]

### Inherited by implicit conversion ArrowAssoc fromSourceToCompletionStage\[Out, T] to ArrowAssoc\[SourceToCompletionStage\[Out, T]]
...
---
*Source: [https://doc.akka.io/api/akka/2.10/akka/stream/scaladsl/package$$SourceToCompletionStage.html](https://doc.akka.io/api/akka/2.10/akka/stream/scaladsl/package$$SourceToCompletionStage.html)*