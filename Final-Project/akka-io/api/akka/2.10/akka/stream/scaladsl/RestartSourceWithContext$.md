---
description: Akka 2.10.17 - akka.stream.scaladsl.RestartSourceWithContext
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:13:54Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/RestartSourceWithContext$.html
title: Akka 2.10.17 - akka.stream.scaladsl.RestartSourceWithContext
---

# Akka 2.10.17 - akka.stream.scaladsl.RestartSourceWithContext

> **Summary:** Akka 2.10.17 - akka.stream.scaladsl.RestartSourceWithContext
...
# RestartSourceWithContext[**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html "Permalink")
...
Source[RestartSourceWithContext.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/scaladsl/RestartSourceWithContext.scala#L16)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
7. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
8. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
9. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
10. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
11. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
12. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#onFailuresWithBackoff[T,C](settings:akka.stream.RestartSettings)(sourceFactory:()=>akka.stream.scaladsl.SourceWithContext[T,C,_]):akka.stream.scaladsl.SourceWithContext[T,C,akka.NotUsed] "Permalink")  def onFailuresWithBackoff\[T, C](settings: [RestartSettings](../RestartSettings.html))(sourceFactory: () \=\> [SourceWithContext](SourceWithContext.html)\[T, C, \_]): [SourceWithContext](SourceWithContext.html)\[T, C, [NotUsed](../../NotUsed.html)]Wrap the given [SourceWithContext](SourceWithContext.html) with a [SourceWithContext](SourceWithContext.html) that will restart it when it fails using an exponential backoff.

Wrap the given [SourceWithContext](SourceWithContext.html) with a [SourceWithContext](SourceWithContext.html) that will restart it when it fails using an exponential backoff.

The returned [SourceWithContext](SourceWithContext.html) will not emit a failure as long as maxRestarts is not reached, since the failure of the wrapped [SourceWithContext](SourceWithContext.html) is handled by restarting it. The wrapped [SourceWithContext](SourceWithContext.html) can however be canceled by canceling the returned [SourceWithContext](SourceWithContext.html). When that happens, the wrapped [SourceWithContext](SourceWithContext.html) if currently running will be canceled and will not be restarted.

settings[RestartSettings](../RestartSettings.html) defining restart configuration

sourceFactoryA factory for producing the [SourceWithContext](SourceWithContext.html) to wrap
15. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
16. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
17. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
18. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
19. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
20. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#withBackoff[T,C](settings:akka.stream.RestartSettings)(sourceFactory:()=>akka.stream.scaladsl.SourceWithContext[T,C,_]):akka.stream.scaladsl.SourceWithContext[T,C,akka.NotUsed] "Permalink")  def withBackoff\[T, C](settings: [RestartSettings](../RestartSettings.html))(sourceFactory: () \=\> [SourceWithContext](SourceWithContext.html)\[T, C, \_]): [SourceWithContext](SourceWithContext.html)\[T, C, [NotUsed](../../NotUsed.html)]Wrap the given [SourceWithContext](SourceWithContext.html) with a [SourceWithContext](SourceWithContext.html) that will restart it when it fails or completes using an exponential backoff.

Wrap the given [SourceWithContext](SourceWithContext.html) with a [SourceWithContext](SourceWithContext.html) that will restart it when it fails or completes using an exponential backoff.

The returned [SourceWithContext](SourceWithContext.html) will not emit a complete or failure as long as maxRestarts is not reached, since the completion or failure of the wrapped [SourceWithContext](SourceWithContext.html) is handled by restarting it. The wrapped [SourceWithContext](SourceWithContext.html) can however be canceled by canceling the returned [SourceWithContext](SourceWithContext.html). When that happens, the wrapped [SourceWithContext](SourceWithContext.html) if currently running will be canceled and will not be restarted.
...
1. [**](../../../akka/stream/scaladsl/RestartSourceWithContext$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka/2.10/akka/stream/scaladsl/RestartSourceWithContext$.html](https://doc.akka.io/api/akka/2.10/akka/stream/scaladsl/RestartSourceWithContext$.html)*