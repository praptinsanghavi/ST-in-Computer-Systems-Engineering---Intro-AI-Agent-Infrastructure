...
[o](BidiFlow.html "See companion class")[akka](../../index.html).[stream](../index.html).[scaladsl](index.html)

# [BidiFlow](BidiFlow.html "See companion class")[**](../../../akka/stream/scaladsl/BidiFlow$.html "Permalink")

### Companion [class BidiFlow](BidiFlow.html "See companion class")

#### object BidiFlow

Source[BidiFlow.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/scaladsl/BidiFlow.scala#L226)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. BidiFlow
2. AnyRef
...
3. [**](../../../akka/stream/scaladsl/BidiFlow$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../akka/stream/scaladsl/BidiFlow$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/stream/scaladsl/BidiFlow$.html#bidirectionalIdleTimeout[I,O](timeout:scala.concurrent.duration.FiniteDuration):akka.stream.scaladsl.BidiFlow[I,I,O,O,akka.NotUsed] "Permalink")  def bidirectionalIdleTimeout\[I, O](timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): [BidiFlow](BidiFlow.html)\[I, I, O, O, [NotUsed](../../NotUsed.html)]If the time between two processed elements \*in any direction\* exceed the provided timeout, the stream is failed
...
6. [**](../../../akka/stream/scaladsl/BidiFlow$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
7. [**](../../../akka/stream/scaladsl/BidiFlow$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
8. [**](../../../akka/stream/scaladsl/BidiFlow$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
9. [**](../../../akka/stream/scaladsl/BidiFlow$.html#fromFlows[I1,O1,I2,O2,M1,M2](flow1:akka.stream.Graph[akka.stream.FlowShape[I1,O1],M1],flow2:akka.stream.Graph[akka.stream.FlowShape[I2,O2],M2]):akka.stream.scaladsl.BidiFlow[I1,O1,I2,O2,akka.NotUsed] "Permalink")  def fromFlows\[I1, O1, I2, O2, M1, M2](flow1: [Graph](../Graph.html)\[[FlowShape](../FlowShape.html)\[I1, O1], M1], flow2: [Graph](../Graph.html)\[[FlowShape](../FlowShape.html)\[I2, O2], M2]): [BidiFlow](BidiFlow.html)\[I1, O1, I2, O2, [NotUsed](../../NotUsed.html)]Wraps two Flows to create a *BidiFlow*.
...
O2 <~~ |        Flow2         | <~~ I2
    ...
    +----------------------------+
```
10. [**](../../../akka/stream/scaladsl/BidiFlow$.html#fromFlowsMat[I1,O1,I2,O2,M1,M2,M](flow1:akka.stream.Graph[akka.stream.FlowShape[I1,O1],M1],flow2:akka.stream.Graph[akka.stream.FlowShape[I2,O2],M2])(combine:(M1,M2)=>M):akka.stream.scaladsl.BidiFlow[I1,O1,I2,O2,M] "Permalink")  def fromFlowsMat\[I1, O1, I2, O2, M1, M2, M](flow1: [Graph](../Graph.html)\[[FlowShape](../FlowShape.html)\[I1, O1], M1], flow2: [Graph](../Graph.html)\[[FlowShape](../FlowShape.html)\[I2, O2], M2])(combine: (M1, M2) \=\> M): [BidiFlow](BidiFlow.html)\[I1, O1, I2, O2, M]Wraps two Flows to create a *BidiFlow*.
...
O2 <~~ |        Flow2         | <~~ I2
    ...
    +----------------------------+
```
11. [**](../../../akka/stream/scaladsl/BidiFlow$.html#fromFunctions[I1,O1,I2,O2](outbound:I1=>O1,inbound:I2=>O2):akka.stream.scaladsl.BidiFlow[I1,O1,I2,O2,akka.NotUsed] "Permalink")  def fromFunctions\[I1, O1, I2, O2](outbound: (I1) \=\> O1, inbound: (I2) \=\> O2): [BidiFlow](BidiFlow.html)\[I1, O1, I2, O2, [NotUsed](../../NotUsed.html)]Create a BidiFlow where the top and bottom flows are just one simple mapping
operator each, expressed by the two functions.
12. [**](../../../akka/stream/scaladsl/BidiFlow$.html#fromGraph[I1,O1,I2,O2,Mat](graph:akka.stream.Graph[akka.stream.BidiShape[I1,O1,I2,O2],Mat]):akka.stream.scaladsl.BidiFlow[I1,O1,I2,O2,Mat] "Permalink")  def fromGraph\[I1, O1, I2, O2, Mat](graph: [Graph](../Graph.html)\[[BidiShape](../BidiShape.html)\[I1, O1, I2, O2], Mat]): [BidiFlow](BidiFlow.html)\[I1, O1, I2, O2, Mat]A graph with the shape of a flow logically is a flow, this method makes
it so also in type.
13. [**](../../../akka/stream/scaladsl/BidiFlow$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../../akka/stream/scaladsl/BidiFlow$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../../akka/stream/scaladsl/BidiFlow$.html#identity[A,B]:akka.stream.scaladsl.BidiFlow[A,A,B,B,akka.NotUsed] "Permalink")  def identity\[A, B]: [BidiFlow](BidiFlow.html)\[A, A, B, B, [NotUsed](../../NotUsed.html)]
16. [**](../../../akka/stream/scaladsl/BidiFlow$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../../akka/stream/scaladsl/BidiFlow$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../../akka/stream/scaladsl/BidiFlow$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../../akka/stream/scaladsl/BidiFlow$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../../akka/stream/scaladsl/BidiFlow$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../../akka/stream/scaladsl/BidiFlow$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../../akka/stream/scaladsl/BidiFlow$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../../akka/stream/scaladsl/BidiFlow$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../../akka/stream/scaladsl/BidiFlow$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
