---
description: Akka 2.10.17 - akka.stream.scaladsl.SinkQueueWithCancel
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:14:02Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/SinkQueueWithCancel.html
title: Akka 2.10.17 - akka.stream.scaladsl.SinkQueueWithCancel
---

# Akka 2.10.17 - akka.stream.scaladsl.SinkQueueWithCancel

> **Summary:** Akka 2.10.17 - akka.stream.scaladsl.SinkQueueWithCancel
...
[t](SinkQueueWithCancel$.html "See companion object")[akka](../../index.html).[stream](../index.html).[scaladsl](index.html)

# [SinkQueueWithCancel](SinkQueueWithCancel$.html "See companion object")[**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html "Permalink")

### Companion [object SinkQueueWithCancel](SinkQueueWithCancel$.html "See companion object")

#### trait SinkQueueWithCancel\[T] extends [SinkQueue](SinkQueue.html)\[T]

This trait adds cancel support to [SinkQueue](SinkQueue.html).

Source[Queue.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/scaladsl/Queue.scala#L126)Linear Supertypes[SinkQueue](SinkQueue.html)\[T], [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#cancel():Unit "Permalink") abstract  def cancel(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Cancels the stream.

Cancels the stream. This method returns right away without waiting for actual finalizing the stream.
2. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#pull():scala.concurrent.Future[Option[T]] "Permalink") abstract  def pull(): [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[[Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[T]]Pulls elements from the stream and returns a Future that:
...
Definition Classes[SinkQueue](SinkQueue.html)
### Concrete Value Members

1. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from SinkQueueWithCancel\[T] toany2stringadd\[SinkQueueWithCancel\[T]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (SinkQueueWithCancel\[T], B)ImplicitThis member is added by an implicit conversion from SinkQueueWithCancel\[T] toArrowAssoc\[SinkQueueWithCancel\[T]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#asJava:akka.stream.javadsl.SinkQueueWithCancel[T] "Permalink")  def asJava: [javadsl.SinkQueueWithCancel](../javadsl/SinkQueueWithCancel.html)\[T]ImplicitThis member is added by an implicit conversion from SinkQueueWithCancel\[T] to[QueueOps](SinkQueueWithCancel$$QueueOps.html)\[T] performed by method QueueOps in [akka.stream.scaladsl.SinkQueueWithCancel](SinkQueueWithCancel$.html).Definition Classes[QueueOps](SinkQueueWithCancel$$QueueOps.html)
8. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (SinkQueueWithCancel\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SinkQueueWithCancel\[T]ImplicitThis member is added by an implicit conversion from SinkQueueWithCancel\[T] toEnsuring\[SinkQueueWithCancel\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (SinkQueueWithCancel\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SinkQueueWithCancel\[T]ImplicitThis member is added by an implicit conversion from SinkQueueWithCancel\[T] toEnsuring\[SinkQueueWithCancel\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SinkQueueWithCancel\[T]ImplicitThis member is added by an implicit conversion from SinkQueueWithCancel\[T] toEnsuring\[SinkQueueWithCancel\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SinkQueueWithCancel\[T]ImplicitThis member is added by an implicit conversion from SinkQueueWithCancel\[T] toEnsuring\[SinkQueueWithCancel\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
15. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
18. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#queue:akka.stream.scaladsl.SinkQueueWithCancel[T] "Permalink")  val queue: SinkQueueWithCancel\[T]ImplicitThis member is added by an implicit conversion from SinkQueueWithCancel\[T] to[QueueOps](SinkQueueWithCancel$$QueueOps.html)\[T] performed by method QueueOps in [akka.stream.scaladsl.SinkQueueWithCancel](SinkQueueWithCancel$.html).Definition Classes[QueueOps](SinkQueueWithCancel$$QueueOps.html)
22. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
23. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
24. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
25. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
26. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from SinkQueueWithCancel\[T] toStringFormat\[SinkQueueWithCancel\[T]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../akka/stream/scaladsl/SinkQueueWithCancel.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (SinkQueueWithCancel\[T], B)ImplicitThis member is added by an implicit conversion from SinkQueueWithCancel\[T] toArrowAssoc\[SinkQueueWithCancel\[T]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [SinkQueue](SinkQueue.html)\[T]

### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion QueueOps fromSinkQueueWithCancel\[T] to [QueueOps](SinkQueueWithCancel$$QueueOps.html)\[T]

### Inherited by implicit conversion any2stringadd fromSinkQueueWithCancel\[T] to any2stringadd\[SinkQueueWithCancel\[T]]

### Inherited by implicit conversion StringFormat fromSinkQueueWithCancel\[T] to StringFormat\[SinkQueueWithCancel\[T]]

### Inherited by implicit conversion Ensuring fromSinkQueueWithCancel\[T] to Ensuring\[SinkQueueWithCancel\[T]]

### Inherited by implicit conversion ArrowAssoc fromSinkQueueWithCancel\[T] to ArrowAssoc\[SinkQueueWithCancel\[T]]
...
---
*Source: [https://doc.akka.io/api/akka/2.10/akka/stream/scaladsl/SinkQueueWithCancel.html](https://doc.akka.io/api/akka/2.10/akka/stream/scaladsl/SinkQueueWithCancel.html)*