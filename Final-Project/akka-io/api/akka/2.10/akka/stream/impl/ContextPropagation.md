---
description: Akka 2.10.17 - akka.stream.impl.ContextPropagation
knowledge_type: official_documentation
scraped_at: '2026-04-06T17:00:07Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/impl/ContextPropagation.html
title: Akka 2.10.17 - akka.stream.impl.ContextPropagation
---

# Akka 2.10.17 - akka.stream.impl.ContextPropagation

> **Summary:** Akka 2.10.17 - akka.stream.impl.ContextPropagation
...
- [**](../../../akka/stream/impl/index.html "Permalink")  package [impl](index.html "The architecture of Akka Streams internally consists of several distinct layers:")The architecture of Akka Streams internally consists of several distinct layers:
...
- [**](../../../akka/stream/impl/fusing/index.html "Permalink")  package [fusing](fusing/index.html)Definition Classes[impl](index.html)
- ContextPropagation
[t](ContextPropagation$.html "See companion object")[akka](../../index.html).[stream](../index.html).[impl](index.html)

# [ContextPropagation](ContextPropagation$.html "See companion object")[**](../../../akka/stream/impl/ContextPropagation.html "Permalink")

### Companion [object ContextPropagation](ContextPropagation$.html "See companion object")

#### trait ContextPropagation extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

INTERNAL API

Annotations@[InternalStableApi](../../annotation/InternalStableApi.html)() Source[ContextPropagation.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/impl/ContextPropagation.scala#L12)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ContextPropagation
2. AnyRef
3. Any
Implicitly  
1. by any2stringadd
...
1. [**](../../../akka/stream/impl/ContextPropagation.html#currentContext():AnyRef "Permalink") abstract  def currentContext(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
2. [**](../../../akka/stream/impl/ContextPropagation.html#resumeContext(context:AnyRef):Unit "Permalink") abstract  def resumeContext(context: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)
3. [**](../../../akka/stream/impl/ContextPropagation.html#resumeContext():Unit "Permalink") abstract  def resumeContext(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)
4. [**](../../../akka/stream/impl/ContextPropagation.html#suspendContext():Unit "Permalink") abstract  def suspendContext(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)
### Concrete Value Members

1. [**](../../../akka/stream/impl/ContextPropagation.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../akka/stream/impl/ContextPropagation.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../akka/stream/impl/ContextPropagation.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ContextPropagation toany2stringadd\[ContextPropagation] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../akka/stream/impl/ContextPropagation.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ContextPropagation, B)ImplicitThis member is added by an implicit conversion from ContextPropagation toArrowAssoc\[ContextPropagation] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../akka/stream/impl/ContextPropagation.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../akka/stream/impl/ContextPropagation.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../akka/stream/impl/ContextPropagation.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../../akka/stream/impl/ContextPropagation.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ContextPropagation) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ContextPropagationImplicitThis member is added by an implicit conversion from ContextPropagation toEnsuring\[ContextPropagation] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../../akka/stream/impl/ContextPropagation.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ContextPropagation) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ContextPropagationImplicitThis member is added by an implicit conversion from ContextPropagation toEnsuring\[ContextPropagation] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../akka/stream/impl/ContextPropagation.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ContextPropagationImplicitThis member is added by an implicit conversion from ContextPropagation toEnsuring\[ContextPropagation] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../akka/stream/impl/ContextPropagation.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ContextPropagationImplicitThis member is added by an implicit conversion from ContextPropagation toEnsuring\[ContextPropagation] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../akka/stream/impl/ContextPropagation.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../../akka/stream/impl/ContextPropagation.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../../akka/stream/impl/ContextPropagation.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../../akka/stream/impl/ContextPropagation.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../akka/stream/impl/ContextPropagation.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../../akka/stream/impl/ContextPropagation.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../../akka/stream/impl/ContextPropagation.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../../akka/stream/impl/ContextPropagation.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../../akka/stream/impl/ContextPropagation.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../../akka/stream/impl/ContextPropagation.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../../akka/stream/impl/ContextPropagation.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../../akka/stream/impl/ContextPropagation.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../../akka/stream/impl/ContextPropagation.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../akka/stream/impl/ContextPropagation.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../akka/stream/impl/ContextPropagation.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ContextPropagation toStringFormat\[ContextPropagation] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../akka/stream/impl/ContextPropagation.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ContextPropagation, B)ImplicitThis member is added by an implicit conversion from ContextPropagation toArrowAssoc\[ContextPropagation] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromContextPropagation to any2stringadd\[ContextPropagation]

### Inherited by implicit conversion StringFormat fromContextPropagation to StringFormat\[ContextPropagation]

### Inherited by implicit conversion Ensuring fromContextPropagation to Ensuring\[ContextPropagation]

### Inherited by implicit conversion ArrowAssoc fromContextPropagation to ArrowAssoc\[ContextPropagation]
...
- https://doc.akka.io/api/akka/2.10/akka/stream/InPort.html
- https://doc.akka.io/api/akka/2.10/akka/stream/OutPort.html
- https://doc.akka.io/api/akka/2.10/akka/stream/Shape.html
- https://doc.akka.io/api/akka/2.10/akka/stream/impl/ContextPropagation$.html
- https://doc.akka.io/api/akka/2.10/akka/stream/impl/ContextPropagation.html
- https://doc.akka.io/api/akka/2.10/akka/stream/impl/fusing/index.html
- https://doc.akka.io/api/akka/2.10/akka/stream/impl/index.html
- https://doc.akka.io/api/akka/2.10/akka/stream/index.html
- https://doc.akka.io/api/akka/2.10/akka/stream/javadsl/index.html
...
---
*Source: [https://doc.akka.io/api/akka/2.10/akka/stream/impl/ContextPropagation.html](https://doc.akka.io/api/akka/2.10/akka/stream/impl/ContextPropagation.html)*