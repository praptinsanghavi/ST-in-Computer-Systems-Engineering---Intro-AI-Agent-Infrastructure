---
description: Akka 2.10.17 - akka.io.InetAddressDnsResolver
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:54:40Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/io/InetAddressDnsResolver.html
title: Akka 2.10.17 - akka.io.InetAddressDnsResolver
---

# Akka 2.10.17 - akka.io.InetAddressDnsResolver

> **Summary:** Akka 2.10.17 - akka.io.InetAddressDnsResolver
...
Annotations@nowarn() @[InternalApi](../annotation/InternalApi.html)() Source[InetAddressDnsResolver.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/io/InetAddressDnsResolver.scala#L39)Linear Supertypes[ActorLogging](../actor/ActorLogging.html), [Actor](../actor/Actor.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/io/InetAddressDnsResolver.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/io/InetAddressDnsResolver.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
5. [**](../../akka/io/InetAddressDnsResolver.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/io/InetAddressDnsResolver.html#aroundPostRestart(reason:Throwable):Unit "Permalink")  def aroundPostRestart(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)INTERNAL API.
...
7. [**](../../akka/io/InetAddressDnsResolver.html#aroundPostStop():Unit "Permalink")  def aroundPostStop(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)INTERNAL API.
...
Attributesprotected\[[akka](../index.html)] Definition Classes[Actor](../actor/Actor.html)Annotations@[InternalApi](../annotation/InternalApi.html)()
9. [**](../../akka/io/InetAddressDnsResolver.html#aroundPreStart():Unit "Permalink")  def aroundPreStart(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)INTERNAL API.
...
12. [**](../../akka/io/InetAddressDnsResolver.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
...
14. [**](../../akka/io/InetAddressDnsResolver.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (InetAddressDnsResolver) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): InetAddressDnsResolverImplicitThis member is added by an implicit conversion from InetAddressDnsResolver toEnsuring\[InetAddressDnsResolver] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/io/InetAddressDnsResolver.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (InetAddressDnsResolver) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): InetAddressDnsResolverImplicitThis member is added by an implicit conversion from InetAddressDnsResolver toEnsuring\[InetAddressDnsResolver] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../akka/io/InetAddressDnsResolver.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): InetAddressDnsResolverImplicitThis member is added by an implicit conversion from InetAddressDnsResolver toEnsuring\[InetAddressDnsResolver] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../akka/io/InetAddressDnsResolver.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): InetAddressDnsResolverImplicitThis member is added by an implicit conversion from InetAddressDnsResolver toEnsuring\[InetAddressDnsResolver] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
18. [**](../../akka/io/InetAddressDnsResolver.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../akka/io/InetAddressDnsResolver.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
20. [**](../../akka/io/InetAddressDnsResolver.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../akka/io/InetAddressDnsResolver.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/io/InetAddressDnsResolver.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
...
24. [**](../../akka/io/InetAddressDnsResolver.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
...
26. [**](../../akka/io/InetAddressDnsResolver.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
27. [**](../../akka/io/InetAddressDnsResolver.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
...
29. [**](../../akka/io/InetAddressDnsResolver.html#postRestart(reason:Throwable):Unit "Permalink")  def postRestart(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)User overridable callback: By default it calls `preStart()`.
...
30. [**](../../akka/io/InetAddressDnsResolver.html#postStop():Unit "Permalink")  def postStop(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)User overridable callback.
...
Definition Classes[Actor](../actor/Actor.html)Annotations@throws(classOf\[Exception])
32. [**](../../akka/io/InetAddressDnsResolver.html#preStart():Unit "Permalink")  def preStart(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)User overridable callback.
...
39. [**](../../akka/io/InetAddressDnsResolver.html#unhandled(message:Any):Unit "Permalink")  def unhandled(message: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)User overridable callback.
...
42. [**](../../akka/io/InetAddressDnsResolver.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/io/InetAddressDnsResolver.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
3. [**](../../akka/io/InetAddressDnsResolver.html#negativeTtl:Long "Permalink")  val negativeTtl: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)Annotations@deprecated Deprecated*(Since version 2\.5\.17\)* Use negativeCacheDuration instead
4. [**](../../akka/io/InetAddressDnsResolver.html#positiveTtl:Long "Permalink")  val positiveTtl: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)Annotations@deprecated Deprecated*(Since version 2\.5\.17\)* Use positiveCacheDuration instead
...
- https://doc.akka.io/api/akka/2.10/akka/io/BufferPool.html
- https://doc.akka.io/api/akka/2.10/akka/io/Dns$.html
- https://doc.akka.io/api/akka/2.10/akka/io/Dns.html
- https://doc.akka.io/api/akka/2.10/akka/io/DnsExt.html
- https://doc.akka.io/api/akka/2.10/akka/io/DnsProvider.html
- https://doc.akka.io/api/akka/2.10/akka/io/IO$.html
- https://doc.akka.io/api/akka/2.10/akka/io/Inet$.html
- https://doc.akka.io/api/akka/2.10/akka/io/InetAddressDnsProvider.html
- https://doc.akka.io/api/akka/2.10/akka/io/InetAddressDnsResolver.html
- https://doc.akka.io/api/akka/2.10/akka/io/IpVersionSelector$.html
- https://doc.akka.io/api/akka/2.10/akka/io/SelectionHandlerSettings.html
- https://doc.akka.io/api/akka/2.10/akka/io/SimpleDnsCache$.html
- https://doc.akka.io/api/akka/2.10/akka/io/SimpleDnsCache.html
- https://doc.akka.io/api/akka/2.10/akka/io/SimpleDnsManager$.html
- https://doc.akka.io/api/akka/2.10/akka/io/SimpleDnsManager.html
- https://doc.akka.io/api/akka/2.10/akka/io/Tcp$.html
- https://doc.akka.io/api/akka/2.10/akka/io/TcpExt.html
- https://doc.akka.io/api/akka/2.10/akka/io/TcpMessage$.html
- https://doc.akka.io/api/akka/2.10/akka/io/TcpSO$.html
- https://doc.akka.io/api/akka/2.10/akka/io/Udp$.html
- https://doc.akka.io/api/akka/2.10/akka/io/UdpConnected$.html
- https://doc.akka.io/api/akka/2.10/akka/io/UdpConnectedExt.html
- https://doc.akka.io/api/akka/2.10/akka/io/UdpConnectedMessage$.html
- https://doc.akka.io/api/akka/2.10/akka/io/UdpExt.html
- https://doc.akka.io/api/akka/2.10/akka/io/UdpMessage$.html
- https://doc.akka.io/api/akka/2.10/akka/io/UdpSO$.html
- https://doc.akka.io/api/akka/2.10/akka/io/dns/CachePolicy$$CachePolicy.html
- https://doc.akka.io/api/akka/2.10/akka/io/dns/index.html
- https://doc.akka.io/api/akka/2.10/akka/io/index.html
- https://doc.akka.io/api/akka/2.10/index.html

---
*Source: [https://doc.akka.io/api/akka/2.10/akka/io/InetAddressDnsResolver.html](https://doc.akka.io/api/akka/2.10/akka/io/InetAddressDnsResolver.html)*