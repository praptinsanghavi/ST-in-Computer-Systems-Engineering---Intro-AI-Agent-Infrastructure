---
description: Akka 2.10.17 - akka.cluster.sharding.typed.scaladsl
knowledge_type: official_documentation
scraped_at: '2026-04-06T13:38:51Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/cluster/sharding/typed/scaladsl/index.html
title: Akka 2.10.17 - akka.cluster.sharding.typed.scaladsl
---

# Akka 2.10.17 - akka.cluster.sharding.typed.scaladsl

> **Summary:** Akka 2.10.17 - akka.cluster.sharding.typed.scaladsl
...
- [**](../../../../../akka/cluster/sharding/typed/scaladsl/index.html "Permalink")  package scaladslDefinition Classes[typed](../index.html)
...
# scaladsl[**](../../../../../akka/cluster/sharding/typed/scaladsl/index.html "Permalink")
...
1. [**](../../../../../akka/cluster/sharding/typed/scaladsl/ClusterSharding.html "Permalink")  trait [ClusterSharding](ClusterSharding.html "This extension provides sharding functionality of actors in a cluster.") extends [Extension](../../../../actor/typed/Extension.html)This extension provides sharding functionality of actors in a cluster.
...
in the cluster, registering the supported entity types with the [ClusterSharding\#init](ClusterSharding.html#init[M,E](entity:akka.cluster.sharding.typed.scaladsl.Entity[M,E]):akka.actor.typed.ActorRef[E])
...
Messages can also be sent via the [EntityRef](EntityRef.html) retrieved with [ClusterSharding\#entityRefFor](ClusterSharding.html#entityRefFor[M](typeKey:akka.cluster.sharding.typed.scaladsl.EntityTypeKey[M],entityId:String):akka.cluster.sharding.typed.scaladsl.EntityRef[M]),
...
2. [**](../../../../../akka/cluster/sharding/typed/scaladsl/ClusterShardingSetup.html "Permalink") final  class [ClusterShardingSetup](ClusterShardingSetup.html "Can be used in akka.actor.setup.ActorSystemSetup when starting the ActorSystem to replace the default implementation of the ClusterSharding extension.") extends [ExtensionSetup](../../../../actor/typed/ExtensionSetup.html)\[[ClusterSharding](ClusterSharding.html)]Can be used in [akka.actor.setup.ActorSystemSetup](../../../../actor/setup/ActorSystemSetup.html) when starting the ActorSystem
to replace the default implementation of the [ClusterSharding](ClusterSharding.html) extension.
...
3. [**](../../../../../akka/cluster/sharding/typed/scaladsl/Entity.html "Permalink") final  class [Entity](Entity.html "Defines how the entity should be created.")\[M, E] extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Defines how the entity should be created.
...
4. [**](../../../../../akka/cluster/sharding/typed/scaladsl/EntityContext.html "Permalink") final  class [EntityContext](EntityContext.html "Parameter to createBehavior function in Entity.apply.")\[M] extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Parameter to `createBehavior` function in [Entity.apply](Entity$.html#apply[M](typeKey:akka.cluster.sharding.typed.scaladsl.EntityTypeKey[M])(createBehavior:akka.cluster.sharding.typed.scaladsl.EntityContext[M]=>akka.actor.typed.Behavior[M]):akka.cluster.sharding.typed.scaladsl.Entity[M,akka.cluster.sharding.typed.ShardingEnvelope[M]]).
...
```
5. [**](../../../../../akka/cluster/sharding/typed/scaladsl/EntityRef.html "Permalink")  trait [EntityRef](EntityRef.html "A reference to an sharded Entity, which allows ActorRef-like usage.")\[\-M] extends [RecipientRef](../../../../actor/typed/RecipientRef.html)\[M]A reference to an sharded Entity, which allows `ActorRef`\-like usage.
...
Annotations@[DoNotInherit](../../../../annotation/DoNotInherit.html)()
6. [**](../../../../../akka/cluster/sharding/typed/scaladsl/EntityTypeKey.html "Permalink")  trait [EntityTypeKey](EntityTypeKey.html "The key of an entity type, the name must be unique.")\[\-T] extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)The key of an entity type, the `name` must be unique.
...
Annotations@[DoNotInherit](../../../../annotation/DoNotInherit.html)()
7. [**](../../../../../akka/cluster/sharding/typed/scaladsl/ShardedDaemonProcess.html "Permalink")  trait [ShardedDaemonProcess](ShardedDaemonProcess.html "This extension runs a pre set number of actors in a cluster.") extends [Extension](../../../../actor/typed/Extension.html)This extension runs a pre set number of actors in a cluster.
...
1. [**](../../../../../akka/cluster/sharding/typed/scaladsl/ClusterSharding$.html "Permalink")  object [ClusterSharding](ClusterSharding$.html) extends [ExtensionId](../../../../actor/typed/ExtensionId.html)\[[ClusterSharding](ClusterSharding.html)]
2. [**](../../../../../akka/cluster/sharding/typed/scaladsl/ClusterShardingSetup$.html "Permalink")  object [ClusterShardingSetup](ClusterShardingSetup$.html)
3. [**](../../../../../akka/cluster/sharding/typed/scaladsl/Entity$.html "Permalink")  object [Entity](Entity$.html)
4. [**](../../../../../akka/cluster/sharding/typed/scaladsl/EntityTypeKey$.html "Permalink")  object [EntityTypeKey](EntityTypeKey$.html)
5. [**](../../../../../akka/cluster/sharding/typed/scaladsl/ShardedDaemonProcess$.html "Permalink")  object [ShardedDaemonProcess](ShardedDaemonProcess$.html) extends [ExtensionId](../../../../actor/typed/ExtensionId.html)\[[ShardedDaemonProcess](ShardedDaemonProcess.html)]
6. [**](../../../../../akka/cluster/sharding/typed/scaladsl/StartEntity$.html "Permalink")  object [StartEntity](StartEntity$.html "Allows starting a specific Sharded Entity by its entity identifier")Allows starting a specific Sharded Entity by its entity identifier
### Ungrouped
...
- https://doc.akka.io/api/akka/2.10/akka/persistence/typed/PersistenceId.html
- https://doc.akka.io/api/akka/2.10/akka/persistence/typed/scaladsl/EventSourcedBehavior.html
- https://doc.akka.io/api/akka/2.10/index.html

---
*Source: [https://doc.akka.io/api/akka/2.10/akka/cluster/sharding/typed/scaladsl/index.html](https://doc.akka.io/api/akka/2.10/akka/cluster/sharding/typed/scaladsl/index.html)*