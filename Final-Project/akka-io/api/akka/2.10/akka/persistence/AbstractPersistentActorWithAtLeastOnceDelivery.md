---
description: Akka 2.10.17 - akka.persistence.AbstractPersistentActorWithAtLeastOnceDelivery
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:54:49Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html
title: Akka 2.10.17 - akka.persistence.AbstractPersistentActorWithAtLeastOnceDelivery
---

# Akka 2.10.17 - akka.persistence.AbstractPersistentActorWithAtLeastOnceDelivery

> **Summary:** Akka 2.10.17 - akka.persistence.AbstractPersistentActorWithAtLeastOnceDelivery
...
1. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#Receive=akka.actor.Actor.Receive "Permalink")  type Receive \= [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any), [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)]Definition Classes[Actor](../actor/Actor.html)
...
1. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
...
5. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#aroundPostRestart(reason:Throwable):Unit "Permalink")  def aroundPostRestart(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)INTERNAL API.

INTERNAL API.

Attributesprotected\[[akka](../index.html)] Definition ClassesEventsourced → [Actor](../actor/Actor.html)
7. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#aroundPostStop():Unit "Permalink")  def aroundPostStop(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)INTERNAL API
...
8. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#aroundPreRestart(reason:Throwable,message:Option[Any]):Unit "Permalink")  def aroundPreRestart(reason: Throwable, message: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)INTERNAL API

INTERNAL API

Attributesprotected\[[akka](../index.html)] Definition Classes[AtLeastOnceDeliveryLike](AtLeastOnceDeliveryLike.html) → Eventsourced → [Actor](../actor/Actor.html)
9. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#aroundPreStart():Unit "Permalink")  def aroundPreStart(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)INTERNAL API.

INTERNAL API.

Attributesprotected\[[akka](../index.html)] Definition ClassesEventsourced → [Actor](../actor/Actor.html)
10. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#aroundReceive(receive:AtLeastOnceDeliveryLike.this.Receive,message:Any):Unit "Permalink")  def aroundReceive(receive: [Receive](#Receive=akka.actor.Actor.Receive), message: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)INTERNAL API
...
12. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
13. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#confirmDelivery(deliveryId:Long):Boolean "Permalink")  def confirmDelivery(deliveryId: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Call this method when a message has been confirmed by the destination,
...
Definition ClassesAbstractPersistentActorLike
17. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#deleteMessages(toSequenceNr:Long):Unit "Permalink")  def deleteMessages(toSequenceNr: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Permanently deletes all persistent messages with sequence numbers less than or equal `toSequenceNr`.
...
19. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#deleteSnapshots(criteria:akka.persistence.SnapshotSelectionCriteria):Unit "Permalink")  def deleteSnapshots(criteria: [SnapshotSelectionCriteria](SnapshotSelectionCriteria.html)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Deletes all snapshots matching `criteria`.
...
This method will throw [AtLeastOnceDelivery.MaxUnconfirmedMessagesExceededException](AtLeastOnceDelivery$$MaxUnconfirmedMessagesExceededException.html)
if [\#numberOfUnconfirmed](#numberOfUnconfirmed:Int) is greater than or equal to [\#maxUnconfirmedMessages](#maxUnconfirmedMessages:Int).
22. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (AbstractPersistentActorWithAtLeastOnceDelivery) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): AbstractPersistentActorWithAtLeastOnceDeliveryImplicitThis member is added by an implicit conversion from AbstractPersistentActorWithAtLeastOnceDelivery toEnsuring\[AbstractPersistentActorWithAtLeastOnceDelivery] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
23. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (AbstractPersistentActorWithAtLeastOnceDelivery) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): AbstractPersistentActorWithAtLeastOnceDeliveryImplicitThis member is added by an implicit conversion from AbstractPersistentActorWithAtLeastOnceDelivery toEnsuring\[AbstractPersistentActorWithAtLeastOnceDelivery] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
24. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): AbstractPersistentActorWithAtLeastOnceDeliveryImplicitThis member is added by an implicit conversion from AbstractPersistentActorWithAtLeastOnceDelivery toEnsuring\[AbstractPersistentActorWithAtLeastOnceDelivery] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
25. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): AbstractPersistentActorWithAtLeastOnceDeliveryImplicitThis member is added by an implicit conversion from AbstractPersistentActorWithAtLeastOnceDelivery toEnsuring\[AbstractPersistentActorWithAtLeastOnceDelivery] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
26. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
...
Definition Classes[AbstractActor](../actor/AbstractActor.html)
33. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
...
35. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
...
Definition Classes[PersistenceIdentity](PersistenceIdentity.html)
37. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#lastSequenceNr:Long "Permalink")  def lastSequenceNr: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)Highest received sequence number so far or `0L` if this actor hasn't replayed
...
Definition ClassesEventsourced
38. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#loadSnapshot(persistenceId:String,criteria:akka.persistence.SnapshotSelectionCriteria,toSequenceNr:Long):Unit "Permalink")  def loadSnapshot(persistenceId: String, criteria: [SnapshotSelectionCriteria](SnapshotSelectionCriteria.html), toSequenceNr: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Instructs the snapshot store to load the specified snapshot and send it via an [SnapshotOffer](SnapshotOffer.html)
...
Definition Classes[Snapshotter](Snapshotter.html)
39. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#maxUnconfirmedMessages:Int "Permalink")  def maxUnconfirmedMessages: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Maximum number of unconfirmed messages that this actor is allowed to hold in memory.
...
Definition Classes[AtLeastOnceDeliveryLike](AtLeastOnceDeliveryLike.html)
40. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
41. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
42. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
43. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#numberOfUnconfirmed:Int "Permalink")  def numberOfUnconfirmed: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Number of messages that have not been confirmed yet.
...
Definition ClassesAbstractPersistentActorLike
51. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#postRestart(reason:Throwable):Unit "Permalink")  def postRestart(reason: Throwable): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)User overridable callback: By default it calls `preStart()`.
...
52. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#postStop():Unit "Permalink")  def postStop(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit) Overridden callback.
...
53. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#preRestart(reason:Throwable,message:Option[Any]):Unit "Permalink")  def preRestart(reason: Throwable, message: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit) Overridden callback.
...
55. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#preStart():Unit "Permalink")  def preStart(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)User overridable callback.
...
Definition Classes[AbstractActor](../actor/AbstractActor.html) → [Actor](../actor/Actor.html)Annotations@throws(classOf\[Exception])
56. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#receive:PartialFunction[Any,Unit] "Permalink")  def receive: [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[[Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any), [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)]Scala API: This defines the initial actor behavior, it must return a partial function
...
61. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#recoveryFinished:Boolean "Permalink")  def recoveryFinished: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Returns `true` if this persistent actor has successfully finished recovery.

Returns `true` if this persistent actor has successfully finished recovery.

Definition ClassesEventsourced
62. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#recoveryRunning:Boolean "Permalink")  def recoveryRunning: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Returns `true` if this persistent actor is currently recovering.
...
Definition Classes[AtLeastOnceDeliveryLike](AtLeastOnceDeliveryLike.html)
64. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#redeliveryBurstLimit:Int "Permalink")  def redeliveryBurstLimit: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Maximum number of unconfirmed messages that will be sent at each redelivery burst
...
Definition Classes[AtLeastOnceDeliveryLike](AtLeastOnceDeliveryLike.html)
65. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#saveSnapshot(snapshot:Any):Unit "Permalink")  def saveSnapshot(snapshot: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Saves a `snapshot` of this snapshotter's state.
...
Definition Classes[PersistenceIdentity](PersistenceIdentity.html)
70. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#snapshotSequenceNr:Long "Permalink")  def snapshotSequenceNr: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)Returns `lastSequenceNr`.
...
Definition ClassesEventsourced → [Snapshotter](Snapshotter.html)
72. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#stash():Unit "Permalink")  def stash(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit) Adds the current message (the message that the actor received last) to the
 actor's stash.
...
76. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#unhandled(message:Any):Unit "Permalink")  def unhandled(message: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)User overridable callback.
...
77. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#unstashAll():Unit "Permalink")  def unstashAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit) Prepends all messages in the stash to the mailbox, and then clears the stash.
...
78. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
79. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
80. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
81. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#warnAfterNumberOfUnconfirmedAttempts:Int "Permalink")  def warnAfterNumberOfUnconfirmedAttempts: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)After this number of delivery attempts an [AtLeastOnceDelivery.UnconfirmedWarning](AtLeastOnceDelivery$$UnconfirmedWarning.html) message
...
1. [**](../../akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
- https://doc.akka.io/api/akka/2.10/akka/actor/Stash.html
...
- https://doc.akka.io/api/akka/2.10/akka/actor/UnrestrictedStash.html
...
- https://doc.akka.io/api/akka/2.10/akka/dispatch/RequiresMessageQueue.html
...
- https://doc.akka.io/api/akka/2.10/akka/japi/Procedure.html
- https://doc.akka.io/api/akka/2.10/akka/japi/pf/ReceiveBuilder.html
...
- https://doc.akka.io/api/akka/2.10/akka/persistence/AtLeastOnceDelivery$$AtLeastOnceDeliverySnapshot.html
- https://doc.akka.io/api/akka/2.10/akka/persistence/AtLeastOnceDelivery$$MaxUnconfirmedMessagesExceededException.html
- https://doc.akka.io/api/akka/2.10/akka/persistence/AtLeastOnceDelivery$$UnconfirmedWarning.html
...
---
*Source: [https://doc.akka.io/api/akka/2.10/akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html](https://doc.akka.io/api/akka/2.10/akka/persistence/AbstractPersistentActorWithAtLeastOnceDelivery.html)*