...
scraped_at: '2026-04-06T16:39:00Z'
section: api
site: akka-io
...
---
*Source: [https://doc.akka.io/api/akka/current/akka/testkit/TestActor$$KeepRunning$.html](https://doc.akka.io/api/akka/current/akka/testkit/TestActor$$KeepRunning$.html)*