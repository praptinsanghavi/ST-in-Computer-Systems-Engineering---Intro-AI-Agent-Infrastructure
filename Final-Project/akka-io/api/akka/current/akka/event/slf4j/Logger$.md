...
scraped_at: '2026-04-06T16:25:55Z'
section: api
site: akka-io
...
---
*Source: [https://doc.akka.io/api/akka/current/akka/event/slf4j/Logger$.html](https://doc.akka.io/api/akka/current/akka/event/slf4j/Logger$.html)*