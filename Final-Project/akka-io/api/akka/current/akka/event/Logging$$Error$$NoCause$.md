...
scraped_at: '2026-04-06T16:26:12Z'
section: api
site: akka-io
...
---
*Source: [https://doc.akka.io/api/akka/current/akka/event/Logging$$Error$$NoCause$.html](https://doc.akka.io/api/akka/current/akka/event/Logging$$Error$$NoCause$.html)*