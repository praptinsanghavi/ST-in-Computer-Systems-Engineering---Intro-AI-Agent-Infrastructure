...
---
*Source: [https://doc.akka.io/api/akka/current/akka/persistence/typed/state/scaladsl/DurableStateBehavior$.html](https://doc.akka.io/api/akka/current/akka/persistence/typed/state/scaladsl/DurableStateBehavior$.html)*