---
description: Akka 2.10.17 - akka.stream.scaladsl.GraphDSL.Implicits.FanOutOps
knowledge_type: official_documentation
scraped_at: '2026-04-06T16:56:23Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html
title: Akka 2.10.17 - akka.stream.scaladsl.GraphDSL.Implicits.FanOutOps
---

# Akka 2.10.17 - akka.stream.scaladsl.GraphDSL.Implicits.FanOutOps

> **Summary:** Akka 2.10.17 - akka.stream.scaladsl.GraphDSL.Implicits.FanOutOps
...
# FanOutOps[**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html "Permalink")

### 

#### implicit final  class FanOutOps\[In, Out] extends [AnyVal](https://www.scala-lang.org/api/2.13.17/scala/AnyVal.html#scala.AnyVal) with [ReverseCombinerBase](GraphDSL$$Implicits$$ReverseCombinerBase.html)\[In]

Source[Graph.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/scala/akka/stream/scaladsl/Graph.scala#L1859)Linear Supertypes[ReverseCombinerBase](GraphDSL$$Implicits$$ReverseCombinerBase.html)\[In], [AnyVal](https://www.scala-lang.org/api/2.13.17/scala/AnyVal.html#scala.AnyVal), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. FanOutOps
...
1. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#<init>(j:akka.stream.UniformFanOutShape[In,Out]):akka.stream.scaladsl.GraphDSL.Implicits.FanOutOps[In,Out] "Permalink")  new FanOutOps(j: [UniformFanOutShape](../UniformFanOutShape.html)\[In, Out])
### Value Members

1. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
2. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAny
3. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from FanOutOps\[In, Out] toany2stringadd\[FanOutOps\[In, Out]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (FanOutOps\[In, Out], B)ImplicitThis member is added by an implicit conversion from FanOutOps\[In, Out] toArrowAssoc\[FanOutOps\[In, Out]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#<~(from:akka.stream.SourceShape[T])(implicitb:akka.stream.scaladsl.GraphDSL.Builder[_]):Unit "Permalink")  def \<\~(from: [SourceShape](../SourceShape.html)\[In])(implicit b: [Builder](GraphDSL$$Builder.html)\[\_]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition Classes[ReverseCombinerBase](GraphDSL$$Implicits$$ReverseCombinerBase.html)
6. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#<~(from:akka.stream.Graph[akka.stream.SourceShape[T],_])(implicitb:akka.stream.scaladsl.GraphDSL.Builder[_]):Unit "Permalink")  def \<\~(from: [Graph](../Graph.html)\[[SourceShape](../SourceShape.html)\[In], \_])(implicit b: [Builder](GraphDSL$$Builder.html)\[\_]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition Classes[ReverseCombinerBase](GraphDSL$$Implicits$$ReverseCombinerBase.html)
7. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#<~[In](flow:akka.stream.FlowShape[In,T])(implicitb:akka.stream.scaladsl.GraphDSL.Builder[_]):akka.stream.scaladsl.GraphDSL.Implicits.ReversePortOps[In] "Permalink")  def \<\~\[In](flow: [FlowShape](../FlowShape.html)\[In, In])(implicit b: [Builder](GraphDSL$$Builder.html)\[\_]): [ReversePortOps](GraphDSL$$Implicits$$ReversePortOps.html)\[In]Definition Classes[ReverseCombinerBase](GraphDSL$$Implicits$$ReverseCombinerBase.html)
8. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#<~[In](junction:akka.stream.UniformFanInShape[In,T])(implicitb:akka.stream.scaladsl.GraphDSL.Builder[_]):akka.stream.scaladsl.GraphDSL.Implicits.ReversePortOps[In] "Permalink")  def \<\~\[In](junction: [UniformFanInShape](../UniformFanInShape.html)\[In, In])(implicit b: [Builder](GraphDSL$$Builder.html)\[\_]): [ReversePortOps](GraphDSL$$Implicits$$ReversePortOps.html)\[In]Definition Classes[ReverseCombinerBase](GraphDSL$$Implicits$$ReverseCombinerBase.html)
9. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#<~[In](junction:akka.stream.UniformFanOutShape[In,T])(implicitb:akka.stream.scaladsl.GraphDSL.Builder[_]):akka.stream.scaladsl.GraphDSL.Implicits.ReversePortOps[In] "Permalink")  def \<\~\[In](junction: [UniformFanOutShape](../UniformFanOutShape.html)\[In, In])(implicit b: [Builder](GraphDSL$$Builder.html)\[\_]): [ReversePortOps](GraphDSL$$Implicits$$ReversePortOps.html)\[In]Definition Classes[ReverseCombinerBase](GraphDSL$$Implicits$$ReverseCombinerBase.html)
10. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#<~[In](via:akka.stream.Graph[akka.stream.FlowShape[In,T],_])(implicitb:akka.stream.scaladsl.GraphDSL.Builder[_]):akka.stream.scaladsl.GraphDSL.Implicits.ReversePortOps[In] "Permalink")  def \<\~\[In](via: [Graph](../Graph.html)\[[FlowShape](../FlowShape.html)\[In, In], \_])(implicit b: [Builder](GraphDSL$$Builder.html)\[\_]): [ReversePortOps](GraphDSL$$Implicits$$ReversePortOps.html)\[In]Definition Classes[ReverseCombinerBase](GraphDSL$$Implicits$$ReverseCombinerBase.html)
11. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#<~[U<:T](from:akka.stream.Outlet[U])(implicitb:akka.stream.scaladsl.GraphDSL.Builder[_]):Unit "Permalink")  def \<\~\[U \<: In](from: [Outlet](../Outlet.html)\[U])(implicit b: [Builder](GraphDSL$$Builder.html)\[\_]): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition Classes[ReverseCombinerBase](GraphDSL$$Implicits$$ReverseCombinerBase.html)
12. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
13. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
14. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (FanOutOps\[In, Out]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): FanOutOps\[In, Out]ImplicitThis member is added by an implicit conversion from FanOutOps\[In, Out] toEnsuring\[FanOutOps\[In, Out]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (FanOutOps\[In, Out]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): FanOutOps\[In, Out]ImplicitThis member is added by an implicit conversion from FanOutOps\[In, Out] toEnsuring\[FanOutOps\[In, Out]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): FanOutOps\[In, Out]ImplicitThis member is added by an implicit conversion from FanOutOps\[In, Out] toEnsuring\[FanOutOps\[In, Out]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
17. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): FanOutOps\[In, Out]ImplicitThis member is added by an implicit conversion from FanOutOps\[In, Out] toEnsuring\[FanOutOps\[In, Out]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
18. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#getClass():Class[_<:AnyVal] "Permalink")  def getClass(): Class\[\_ \<: [AnyVal](https://www.scala-lang.org/api/2.13.17/scala/AnyVal.html#scala.AnyVal)]Definition ClassesAnyVal → Any
19. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#importAndGetPortReverse(b:akka.stream.scaladsl.GraphDSL.Builder[_]):akka.stream.Inlet[In] "Permalink")  def importAndGetPortReverse(b: [Builder](GraphDSL$$Builder.html)\[\_]): [Inlet](../Inlet.html)\[In]Definition ClassesFanOutOps → [ReverseCombinerBase](GraphDSL$$Implicits$$ReverseCombinerBase.html)
20. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
21. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#j:akka.stream.UniformFanOutShape[In,Out] "Permalink")  val j: [UniformFanOutShape](../UniformFanOutShape.html)\[In, Out]
22. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAny
### Deprecated Value Members

1. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from FanOutOps\[In, Out] toStringFormat\[FanOutOps\[In, Out]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
2. [**](../../../akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (FanOutOps\[In, Out], B)ImplicitThis member is added by an implicit conversion from FanOutOps\[In, Out] toArrowAssoc\[FanOutOps\[In, Out]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromFanOutOps\[In, Out] to any2stringadd\[FanOutOps\[In, Out]]

### Inherited by implicit conversion StringFormat fromFanOutOps\[In, Out] to StringFormat\[FanOutOps\[In, Out]]

### Inherited by implicit conversion Ensuring fromFanOutOps\[In, Out] to Ensuring\[FanOutOps\[In, Out]]

### Inherited by implicit conversion ArrowAssoc fromFanOutOps\[In, Out] to ArrowAssoc\[FanOutOps\[In, Out]]
...
---
*Source: [https://doc.akka.io/api/akka/current/akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html](https://doc.akka.io/api/akka/current/akka/stream/scaladsl/GraphDSL$$Implicits$$FanOutOps.html)*