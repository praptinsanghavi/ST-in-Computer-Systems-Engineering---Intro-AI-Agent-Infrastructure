...
scraped_at: '2026-04-06T16:21:20Z'
section: api
site: akka-io
...
---
*Source: [https://doc.akka.io/api/akka/current/akka/actor/Actor$$ignoringBehavior$.html](https://doc.akka.io/api/akka/current/akka/actor/Actor$$ignoringBehavior$.html)*