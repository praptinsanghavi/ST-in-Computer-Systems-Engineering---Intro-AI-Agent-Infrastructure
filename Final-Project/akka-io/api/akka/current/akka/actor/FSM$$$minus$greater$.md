...
scraped_at: '2026-04-06T16:21:01Z'
section: api
site: akka-io
...
---
*Source: [https://doc.akka.io/api/akka/current/akka/actor/FSM$$$minus$greater$.html](https://doc.akka.io/api/akka/current/akka/actor/FSM$$$minus$greater$.html)*