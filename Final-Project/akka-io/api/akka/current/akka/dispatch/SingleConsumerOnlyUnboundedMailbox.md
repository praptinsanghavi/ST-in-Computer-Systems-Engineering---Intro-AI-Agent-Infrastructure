---
description: Akka 2.10.17 - akka.dispatch.SingleConsumerOnlyUnboundedMailbox
knowledge_type: official_documentation
scraped_at: '2026-04-05T20:38:02Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html
title: Akka 2.10.17 - akka.dispatch.SingleConsumerOnlyUnboundedMailbox
---

# Akka 2.10.17 - akka.dispatch.SingleConsumerOnlyUnboundedMailbox

> **Summary:** Akka 2.10.17 - akka.dispatch.SingleConsumerOnlyUnboundedMailbox
...
# SingleConsumerOnlyUnboundedMailbox[**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html "Permalink")

### 

#### final  case class SingleConsumerOnlyUnboundedMailbox() extends [MailboxType](MailboxType.html) with [ProducesMessageQueue](ProducesMessageQueue.html)\[[NodeMessageQueue](NodeMessageQueue.html)] with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
...
Source[Mailbox.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/dispatch/Mailbox.scala#L670)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.17/scala/Equals.html#scala.Equals), [ProducesMessageQueue](ProducesMessageQueue.html)\[[NodeMessageQueue](NodeMessageQueue.html)], [MailboxType](MailboxType.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. SingleConsumerOnlyUnboundedMailbox
2. Serializable
3. Product
4. Equals
...
1. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#<init>(settings:akka.actor.ActorSystem.Settings,config:com.typesafe.config.Config):akka.dispatch.SingleConsumerOnlyUnboundedMailbox "Permalink")  new SingleConsumerOnlyUnboundedMailbox(settings: [Settings](../actor/ActorSystem$$Settings.html), config: Config)
2. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#<init>():akka.dispatch.SingleConsumerOnlyUnboundedMailbox "Permalink")  new SingleConsumerOnlyUnboundedMailbox()
### Value Members

1. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from SingleConsumerOnlyUnboundedMailbox toany2stringadd\[SingleConsumerOnlyUnboundedMailbox] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (SingleConsumerOnlyUnboundedMailbox, B)ImplicitThis member is added by an implicit conversion from SingleConsumerOnlyUnboundedMailbox toArrowAssoc\[SingleConsumerOnlyUnboundedMailbox] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#create(owner:Option[akka.actor.ActorRef],system:Option[akka.actor.ActorSystem]):akka.dispatch.MessageQueue "Permalink") final  def create(owner: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ActorRef](../actor/ActorRef.html)], system: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ActorSystem](../actor/ActorSystem.html)]): [MessageQueue](MessageQueue.html)Definition ClassesSingleConsumerOnlyUnboundedMailbox → [MailboxType](MailboxType.html)
9. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (SingleConsumerOnlyUnboundedMailbox) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SingleConsumerOnlyUnboundedMailboxImplicitThis member is added by an implicit conversion from SingleConsumerOnlyUnboundedMailbox toEnsuring\[SingleConsumerOnlyUnboundedMailbox] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (SingleConsumerOnlyUnboundedMailbox) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SingleConsumerOnlyUnboundedMailboxImplicitThis member is added by an implicit conversion from SingleConsumerOnlyUnboundedMailbox toEnsuring\[SingleConsumerOnlyUnboundedMailbox] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SingleConsumerOnlyUnboundedMailboxImplicitThis member is added by an implicit conversion from SingleConsumerOnlyUnboundedMailbox toEnsuring\[SingleConsumerOnlyUnboundedMailbox] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SingleConsumerOnlyUnboundedMailboxImplicitThis member is added by an implicit conversion from SingleConsumerOnlyUnboundedMailbox toEnsuring\[SingleConsumerOnlyUnboundedMailbox] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
16. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
20. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
22. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
23. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from SingleConsumerOnlyUnboundedMailbox toStringFormat\[SingleConsumerOnlyUnboundedMailbox] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
...
### Inherited from [ProducesMessageQueue](ProducesMessageQueue.html)\[[NodeMessageQueue](NodeMessageQueue.html)]
...
### Inherited by implicit conversion any2stringadd fromSingleConsumerOnlyUnboundedMailbox to any2stringadd\[SingleConsumerOnlyUnboundedMailbox]

### Inherited by implicit conversion StringFormat fromSingleConsumerOnlyUnboundedMailbox to StringFormat\[SingleConsumerOnlyUnboundedMailbox]

### Inherited by implicit conversion Ensuring fromSingleConsumerOnlyUnboundedMailbox to Ensuring\[SingleConsumerOnlyUnboundedMailbox]

### Inherited by implicit conversion ArrowAssoc fromSingleConsumerOnlyUnboundedMailbox to ArrowAssoc\[SingleConsumerOnlyUnboundedMailbox]
...
---
*Source: [https://doc.akka.io/api/akka/current/akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html](https://doc.akka.io/api/akka/current/akka/dispatch/SingleConsumerOnlyUnboundedMailbox.html)*