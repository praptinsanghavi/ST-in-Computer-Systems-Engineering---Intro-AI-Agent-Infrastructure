---
description: Akka 2.10.17 - akka.dispatch.BoundedMessageQueueSemantics
knowledge_type: official_documentation
scraped_at: '2026-04-05T20:36:48Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/BoundedMessageQueueSemantics.html
title: Akka 2.10.17 - akka.dispatch.BoundedMessageQueueSemantics
---

# Akka 2.10.17 - akka.dispatch.BoundedMessageQueueSemantics

> **Summary:** Akka 2.10.17 - akka.dispatch.BoundedMessageQueueSemantics
...
# BoundedMessageQueueSemantics[**](../../akka/dispatch/BoundedMessageQueueSemantics.html "Permalink")

### 

#### trait BoundedMessageQueueSemantics extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

BoundedMessageQueueSemantics adds bounded semantics to a QueueBasedMessageQueue,
i.e. blocking enqueue with timeout.

Source[Mailbox.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/dispatch/Mailbox.scala#L539)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[MessageQueue](BoundedControlAwareMailbox$$MessageQueue.html), [BoundedControlAwareMessageQueueSemantics](BoundedControlAwareMessageQueueSemantics.html), [MessageQueue](BoundedDequeBasedMailbox$$MessageQueue.html), [BoundedDequeBasedMessageQueue](BoundedDequeBasedMessageQueue.html), [BoundedDequeBasedMessageQueueSemantics](BoundedDequeBasedMessageQueueSemantics.html), [MessageQueue](BoundedMailbox$$MessageQueue.html), [BoundedNodeMessageQueue](BoundedNodeMessageQueue.html), [MessageQueue](BoundedPriorityMailbox$$MessageQueue.html), [BoundedQueueBasedMessageQueue](BoundedQueueBasedMessageQueue.html), [MessageQueue](BoundedStablePriorityMailbox$$MessageQueue.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. BoundedMessageQueueSemantics
2. AnyRef
3. Any
Implicitly  
1. by any2stringadd
...
1. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#pushTimeOut:scala.concurrent.duration.Duration "Permalink") abstract  def pushTimeOut: [Duration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/Duration.html#scala.concurrent.duration.Duration)
### Concrete Value Members

1. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from BoundedMessageQueueSemantics toany2stringadd\[BoundedMessageQueueSemantics] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (BoundedMessageQueueSemantics, B)ImplicitThis member is added by an implicit conversion from BoundedMessageQueueSemantics toArrowAssoc\[BoundedMessageQueueSemantics] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (BoundedMessageQueueSemantics) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BoundedMessageQueueSemanticsImplicitThis member is added by an implicit conversion from BoundedMessageQueueSemantics toEnsuring\[BoundedMessageQueueSemantics] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (BoundedMessageQueueSemantics) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BoundedMessageQueueSemanticsImplicitThis member is added by an implicit conversion from BoundedMessageQueueSemantics toEnsuring\[BoundedMessageQueueSemantics] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BoundedMessageQueueSemanticsImplicitThis member is added by an implicit conversion from BoundedMessageQueueSemantics toEnsuring\[BoundedMessageQueueSemantics] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BoundedMessageQueueSemanticsImplicitThis member is added by an implicit conversion from BoundedMessageQueueSemantics toEnsuring\[BoundedMessageQueueSemantics] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/BoundedMessageQueueSemantics.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from BoundedMessageQueueSemantics toStringFormat\[BoundedMessageQueueSemantics] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
...
### Inherited by implicit conversion any2stringadd fromBoundedMessageQueueSemantics to any2stringadd\[BoundedMessageQueueSemantics]

### Inherited by implicit conversion StringFormat fromBoundedMessageQueueSemantics to StringFormat\[BoundedMessageQueueSemantics]

### Inherited by implicit conversion Ensuring fromBoundedMessageQueueSemantics to Ensuring\[BoundedMessageQueueSemantics]

### Inherited by implicit conversion ArrowAssoc fromBoundedMessageQueueSemantics to ArrowAssoc\[BoundedMessageQueueSemantics]
...
---
*Source: [https://doc.akka.io/api/akka/current/akka/dispatch/BoundedMessageQueueSemantics.html](https://doc.akka.io/api/akka/current/akka/dispatch/BoundedMessageQueueSemantics.html)*