---
description: Akka 2.10.17 - akka.dispatch.BoundedControlAwareMailbox
knowledge_type: official_documentation
scraped_at: '2026-04-05T20:36:37Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/BoundedControlAwareMailbox.html
title: Akka 2.10.17 - akka.dispatch.BoundedControlAwareMailbox
---

# Akka 2.10.17 - akka.dispatch.BoundedControlAwareMailbox

> **Summary:** Akka 2.10.17 - akka.dispatch.BoundedControlAwareMailbox
...
[c](BoundedControlAwareMailbox$.html "See companion object")[akka](../index.html).[dispatch](index.html)

# [BoundedControlAwareMailbox](BoundedControlAwareMailbox$.html "See companion object")[**](../../akka/dispatch/BoundedControlAwareMailbox.html "Permalink")

### Companion [object BoundedControlAwareMailbox](BoundedControlAwareMailbox$.html "See companion object")

#### final  case class BoundedControlAwareMailbox(capacity: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), pushTimeOut: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)) extends [MailboxType](MailboxType.html) with [ProducesMessageQueue](ProducesMessageQueue.html)\[[dispatch.BoundedControlAwareMailbox.MessageQueue](BoundedControlAwareMailbox$$MessageQueue.html)] with ProducesPushTimeoutSemanticsMailbox with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
...
Source[Mailbox.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/dispatch/Mailbox.scala#L928)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.17/scala/Equals.html#scala.Equals), ProducesPushTimeoutSemanticsMailbox, [ProducesMessageQueue](ProducesMessageQueue.html)\[[BoundedControlAwareMailbox.MessageQueue](BoundedControlAwareMailbox$$MessageQueue.html)], [MailboxType](MailboxType.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. BoundedControlAwareMailbox
2. Serializable
3. Product
4. Equals
...
1. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#<init>(settings:akka.actor.ActorSystem.Settings,config:com.typesafe.config.Config):akka.dispatch.BoundedControlAwareMailbox "Permalink")  new BoundedControlAwareMailbox(settings: [Settings](../actor/ActorSystem$$Settings.html), config: Config)
2. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#<init>(capacity:Int,pushTimeOut:scala.concurrent.duration.FiniteDuration):akka.dispatch.BoundedControlAwareMailbox "Permalink")  new BoundedControlAwareMailbox(capacity: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), pushTimeOut: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration))
### Value Members

1. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/BoundedControlAwareMailbox.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from BoundedControlAwareMailbox toany2stringadd\[BoundedControlAwareMailbox] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (BoundedControlAwareMailbox, B)ImplicitThis member is added by an implicit conversion from BoundedControlAwareMailbox toArrowAssoc\[BoundedControlAwareMailbox] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#capacity:Int "Permalink")  val capacity: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
8. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#create(owner:Option[akka.actor.ActorRef],system:Option[akka.actor.ActorSystem]):akka.dispatch.MessageQueue "Permalink")  def create(owner: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ActorRef](../actor/ActorRef.html)], system: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ActorSystem](../actor/ActorSystem.html)]): [MessageQueue](MessageQueue.html)Definition ClassesBoundedControlAwareMailbox → [MailboxType](MailboxType.html)
10. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (BoundedControlAwareMailbox) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BoundedControlAwareMailboxImplicitThis member is added by an implicit conversion from BoundedControlAwareMailbox toEnsuring\[BoundedControlAwareMailbox] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (BoundedControlAwareMailbox) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BoundedControlAwareMailboxImplicitThis member is added by an implicit conversion from BoundedControlAwareMailbox toEnsuring\[BoundedControlAwareMailbox] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BoundedControlAwareMailboxImplicitThis member is added by an implicit conversion from BoundedControlAwareMailbox toEnsuring\[BoundedControlAwareMailbox] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BoundedControlAwareMailboxImplicitThis member is added by an implicit conversion from BoundedControlAwareMailbox toEnsuring\[BoundedControlAwareMailbox] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
21. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#pushTimeOut:scala.concurrent.duration.FiniteDuration "Permalink") final  val pushTimeOut: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)Definition ClassesBoundedControlAwareMailbox → ProducesPushTimeoutSemanticsMailbox
22. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
23. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from BoundedControlAwareMailbox toStringFormat\[BoundedControlAwareMailbox] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/dispatch/BoundedControlAwareMailbox.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (BoundedControlAwareMailbox, B)ImplicitThis member is added by an implicit conversion from BoundedControlAwareMailbox toArrowAssoc\[BoundedControlAwareMailbox] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited from [ProducesMessageQueue](ProducesMessageQueue.html)\[[BoundedControlAwareMailbox.MessageQueue](BoundedControlAwareMailbox$$MessageQueue.html)]
...
### Inherited by implicit conversion any2stringadd fromBoundedControlAwareMailbox to any2stringadd\[BoundedControlAwareMailbox]

### Inherited by implicit conversion StringFormat fromBoundedControlAwareMailbox to StringFormat\[BoundedControlAwareMailbox]

### Inherited by implicit conversion Ensuring fromBoundedControlAwareMailbox to Ensuring\[BoundedControlAwareMailbox]

### Inherited by implicit conversion ArrowAssoc fromBoundedControlAwareMailbox to ArrowAssoc\[BoundedControlAwareMailbox]
...
---
*Source: [https://doc.akka.io/api/akka/current/akka/dispatch/BoundedControlAwareMailbox.html](https://doc.akka.io/api/akka/current/akka/dispatch/BoundedControlAwareMailbox.html)*