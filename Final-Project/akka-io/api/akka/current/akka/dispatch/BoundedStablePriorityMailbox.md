---
description: Akka 2.10.17 - akka.dispatch.BoundedStablePriorityMailbox
knowledge_type: official_documentation
scraped_at: '2026-04-05T20:36:55Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-core/current/akka/dispatch/BoundedStablePriorityMailbox.html
title: Akka 2.10.17 - akka.dispatch.BoundedStablePriorityMailbox
---

# Akka 2.10.17 - akka.dispatch.BoundedStablePriorityMailbox

> **Summary:** Akka 2.10.17 - akka.dispatch.BoundedStablePriorityMailbox
...
[c](BoundedStablePriorityMailbox$.html "See companion object")[akka](../index.html).[dispatch](index.html)

# [BoundedStablePriorityMailbox](BoundedStablePriorityMailbox$.html "See companion object")[**](../../akka/dispatch/BoundedStablePriorityMailbox.html "Permalink")

### Companion [object BoundedStablePriorityMailbox](BoundedStablePriorityMailbox$.html "See companion object")

#### class BoundedStablePriorityMailbox extends [MailboxType](MailboxType.html) with [ProducesMessageQueue](ProducesMessageQueue.html)\[[dispatch.BoundedStablePriorityMailbox.MessageQueue](BoundedStablePriorityMailbox$$MessageQueue.html)] with ProducesPushTimeoutSemanticsMailbox
...
Source[Mailbox.scala](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/scala/akka/dispatch/Mailbox.scala#L796)Linear SupertypesProducesPushTimeoutSemanticsMailbox, [ProducesMessageQueue](ProducesMessageQueue.html)\[[BoundedStablePriorityMailbox.MessageQueue](BoundedStablePriorityMailbox$$MessageQueue.html)], [MailboxType](MailboxType.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#<init>(cmp:java.util.Comparator[akka.dispatch.Envelope],capacity:Int,pushTimeOut:scala.concurrent.duration.Duration):akka.dispatch.BoundedStablePriorityMailbox "Permalink")  new BoundedStablePriorityMailbox(cmp: [Comparator](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Comparator.html#java.util.Comparator)\[[Envelope](Envelope.html)], capacity: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), pushTimeOut: [Duration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/Duration.html#scala.concurrent.duration.Duration))
### Value Members

1. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from BoundedStablePriorityMailbox toany2stringadd\[BoundedStablePriorityMailbox] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (BoundedStablePriorityMailbox, B)ImplicitThis member is added by an implicit conversion from BoundedStablePriorityMailbox toArrowAssoc\[BoundedStablePriorityMailbox] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#capacity:Int "Permalink") final  val capacity: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
8. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#cmp:java.util.Comparator[akka.dispatch.Envelope] "Permalink") final  val cmp: [Comparator](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Comparator.html#java.util.Comparator)\[[Envelope](Envelope.html)]
10. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#create(owner:Option[akka.actor.ActorRef],system:Option[akka.actor.ActorSystem]):akka.dispatch.MessageQueue "Permalink") final  def create(owner: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ActorRef](../actor/ActorRef.html)], system: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ActorSystem](../actor/ActorSystem.html)]): [MessageQueue](MessageQueue.html)Definition ClassesBoundedStablePriorityMailbox → [MailboxType](MailboxType.html)
11. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (BoundedStablePriorityMailbox) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BoundedStablePriorityMailboxImplicitThis member is added by an implicit conversion from BoundedStablePriorityMailbox toEnsuring\[BoundedStablePriorityMailbox] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (BoundedStablePriorityMailbox) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BoundedStablePriorityMailboxImplicitThis member is added by an implicit conversion from BoundedStablePriorityMailbox toEnsuring\[BoundedStablePriorityMailbox] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): BoundedStablePriorityMailboxImplicitThis member is added by an implicit conversion from BoundedStablePriorityMailbox toEnsuring\[BoundedStablePriorityMailbox] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): BoundedStablePriorityMailboxImplicitThis member is added by an implicit conversion from BoundedStablePriorityMailbox toEnsuring\[BoundedStablePriorityMailbox] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
16. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
17. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
20. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
21. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#pushTimeOut:scala.concurrent.duration.Duration "Permalink") final  val pushTimeOut: [Duration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/Duration.html#scala.concurrent.duration.Duration)Definition ClassesBoundedStablePriorityMailbox → ProducesPushTimeoutSemanticsMailbox
24. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
25. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
26. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
27. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
28. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from BoundedStablePriorityMailbox toStringFormat\[BoundedStablePriorityMailbox] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../akka/dispatch/BoundedStablePriorityMailbox.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (BoundedStablePriorityMailbox, B)ImplicitThis member is added by an implicit conversion from BoundedStablePriorityMailbox toArrowAssoc\[BoundedStablePriorityMailbox] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from ProducesPushTimeoutSemanticsMailbox

### Inherited from [ProducesMessageQueue](ProducesMessageQueue.html)\[[BoundedStablePriorityMailbox.MessageQueue](BoundedStablePriorityMailbox$$MessageQueue.html)]
...
### Inherited by implicit conversion any2stringadd fromBoundedStablePriorityMailbox to any2stringadd\[BoundedStablePriorityMailbox]

### Inherited by implicit conversion StringFormat fromBoundedStablePriorityMailbox to StringFormat\[BoundedStablePriorityMailbox]

### Inherited by implicit conversion Ensuring fromBoundedStablePriorityMailbox to Ensuring\[BoundedStablePriorityMailbox]

### Inherited by implicit conversion ArrowAssoc fromBoundedStablePriorityMailbox to ArrowAssoc\[BoundedStablePriorityMailbox]
...
---
*Source: [https://doc.akka.io/api/akka/current/akka/dispatch/BoundedStablePriorityMailbox.html](https://doc.akka.io/api/akka/current/akka/dispatch/BoundedStablePriorityMailbox.html)*