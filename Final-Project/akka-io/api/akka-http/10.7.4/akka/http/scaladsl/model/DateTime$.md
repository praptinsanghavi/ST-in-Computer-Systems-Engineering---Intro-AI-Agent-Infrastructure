...
scraped_at: '2026-04-05T19:11:39Z'
section: api
site: akka-io
...
[o](DateTime.html "See companion class")[akka](../../../index.html).[http](../../index.html).[scaladsl](../index.html).[model](index.html)

# [DateTime](DateTime.html "See companion class")[**](../../../../akka/http/scaladsl/model/DateTime$.html "Permalink")

### Companion [class DateTime](DateTime.html "See companion class")

#### object DateTime extends [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)

Source[DateTime.scala](https://github.com/akka/akka-http/tree/v10.7.4/akka-http-core/src/main/scala/akka/http/scaladsl/model/DateTime.scala#L121)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. DateTime
2. Serializable
...
3. [**](../../../../akka/http/scaladsl/model/DateTime$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../../akka/http/scaladsl/model/DateTime$.html#MaxValue:akka.http.scaladsl.model.DateTime "Permalink")  val MaxValue: [DateTime](DateTime.html)
5. [**](../../../../akka/http/scaladsl/model/DateTime$.html#MinValue:akka.http.scaladsl.model.DateTime "Permalink")  val MinValue: [DateTime](DateTime.html)
6. [**](../../../../akka/http/scaladsl/model/DateTime$.html#apply(clicks:Long):akka.http.scaladsl.model.DateTime "Permalink")  def apply(clicks: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [DateTime](DateTime.html)Creates a new `DateTime` from the number of milli seconds
...
7. [**](../../../../akka/http/scaladsl/model/DateTime$.html#apply(year:Int,month:Int,day:Int,hour:Int,minute:Int,second:Int):akka.http.scaladsl.model.DateTime "Permalink")  def apply(year: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), month: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), day: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), hour: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int) \= 0, minute: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int) \= 0, second: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int) \= 0): [DateTime](DateTime.html)Creates a new `DateTime` with the given properties.

Creates a new `DateTime` with the given properties.
Note that this implementation discards milliseconds (i.e. rounds down to full seconds).
8. [**](../../../../akka/http/scaladsl/model/DateTime$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
9. [**](../../../../akka/http/scaladsl/model/DateTime$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
10. [**](../../../../akka/http/scaladsl/model/DateTime$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
11. [**](../../../../akka/http/scaladsl/model/DateTime$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
12. [**](../../../../akka/http/scaladsl/model/DateTime$.html#fromIsoDateTimeString(string:String):Option[akka.http.scaladsl.model.DateTime] "Permalink")  def fromIsoDateTimeString(string: String): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[DateTime](DateTime.html)]Creates a new DateTime instance from the given String,
if it adheres to the format `yyyy-mm-ddThh:mm:ss[.SSSZ]`.

Creates a new DateTime instance from the given String,
if it adheres to the format `yyyy-mm-ddThh:mm:ss[.SSSZ]`.
Note that this implementation discards milliseconds (i.e. rounds down to full seconds).
13. [**](../../../../akka/http/scaladsl/model/DateTime$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
14. [**](../../../../akka/http/scaladsl/model/DateTime$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../../../akka/http/scaladsl/model/DateTime$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
16. [**](../../../../akka/http/scaladsl/model/DateTime$.html#month(index:Int):String "Permalink")  def month(index: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): StringReturns the three\-letter string for the month with the given index.

Returns the three\-letter string for the month with the given index. January is zero.
17. [**](../../../../akka/http/scaladsl/model/DateTime$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../../../akka/http/scaladsl/model/DateTime$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../../../akka/http/scaladsl/model/DateTime$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../../../akka/http/scaladsl/model/DateTime$.html#now:akka.http.scaladsl.model.DateTime "Permalink")  def now: [DateTime](DateTime.html)Creates a new `DateTime` instance for the current point in time.

Creates a new `DateTime` instance for the current point in time.
Note that this implementation discards milliseconds (i.e. rounds down to full seconds).
21. [**](../../../../akka/http/scaladsl/model/DateTime$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../../../akka/http/scaladsl/model/DateTime$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
23. [**](../../../../akka/http/scaladsl/model/DateTime$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../../../akka/http/scaladsl/model/DateTime$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../../../akka/http/scaladsl/model/DateTime$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../../../akka/http/scaladsl/model/DateTime$.html#weekday(index:Int):String "Permalink")  def weekday(index: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): StringReturns the three\-letter string for the weekday with the given index.
...
---
*Source: [https://doc.akka.io/api/akka-http/10.7.4/akka/http/scaladsl/model/DateTime$.html](https://doc.akka.io/api/akka-http/10.7.4/akka/http/scaladsl/model/DateTime$.html)*