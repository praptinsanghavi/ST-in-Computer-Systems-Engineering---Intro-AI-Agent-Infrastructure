...
[t](HeaderMagnet$.html "See companion object")[akka](../../../../index.html).[http](../../../index.html).[scaladsl](../../index.html).[server](../index.html).[directives](index.html)

# [HeaderMagnet](HeaderMagnet$.html "See companion object")[**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html "Permalink")

### Companion [object HeaderMagnet](HeaderMagnet$.html "See companion object")

#### trait HeaderMagnet\[T] extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

Source[HeaderDirectives.scala](https://github.com/akka/akka-http/tree/v10.7.4/akka-http/src/main/scala/akka/http/scaladsl/server/directives/HeaderDirectives.scala#L161)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. HeaderMagnet
2. AnyRef
...
1. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#classTag:scala.reflect.ClassTag[T] "Permalink") abstract  def classTag: [ClassTag](https://www.scala-lang.org/api/2.13.17/scala/reflect/ClassTag.html#scala.reflect.ClassTag)\[T]
2. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#extractPF:PartialFunction[akka.http.scaladsl.model.HttpHeader,T] "Permalink") abstract  def extractPF: [PartialFunction](https://www.scala-lang.org/api/2.13.17/scala/PartialFunction.html#scala.PartialFunction)\[[HttpHeader](../../model/HttpHeader.html), T]Returns a partial function that checks if the input value is of runtime type
...
3. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#runtimeClass:Class[T] "Permalink") abstract  def runtimeClass: Class\[T]
...
3. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from HeaderMagnet\[T] toany2stringadd\[HeaderMagnet\[T]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (HeaderMagnet\[T], B)ImplicitThis member is added by an implicit conversion from HeaderMagnet\[T] toArrowAssoc\[HeaderMagnet\[T]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (HeaderMagnet\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): HeaderMagnet\[T]ImplicitThis member is added by an implicit conversion from HeaderMagnet\[T] toEnsuring\[HeaderMagnet\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (HeaderMagnet\[T]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): HeaderMagnet\[T]ImplicitThis member is added by an implicit conversion from HeaderMagnet\[T] toEnsuring\[HeaderMagnet\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): HeaderMagnet\[T]ImplicitThis member is added by an implicit conversion from HeaderMagnet\[T] toEnsuring\[HeaderMagnet\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): HeaderMagnet\[T]ImplicitThis member is added by an implicit conversion from HeaderMagnet\[T] toEnsuring\[HeaderMagnet\[T]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#headerName:String "Permalink")  def headerName: String
...
2. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from HeaderMagnet\[T] toStringFormat\[HeaderMagnet\[T]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../../../akka/http/scaladsl/server/directives/HeaderMagnet.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (HeaderMagnet\[T], B)ImplicitThis member is added by an implicit conversion from HeaderMagnet\[T] toArrowAssoc\[HeaderMagnet\[T]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromHeaderMagnet\[T] to any2stringadd\[HeaderMagnet\[T]]

### Inherited by implicit conversion StringFormat fromHeaderMagnet\[T] to StringFormat\[HeaderMagnet\[T]]

### Inherited by implicit conversion Ensuring fromHeaderMagnet\[T] to Ensuring\[HeaderMagnet\[T]]

### Inherited by implicit conversion ArrowAssoc fromHeaderMagnet\[T] to ArrowAssoc\[HeaderMagnet\[T]]
