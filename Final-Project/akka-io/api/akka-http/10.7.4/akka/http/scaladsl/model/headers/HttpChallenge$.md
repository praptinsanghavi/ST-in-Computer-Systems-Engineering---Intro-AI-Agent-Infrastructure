...
scraped_at: '2026-04-05T23:00:50Z'
section: api
site: akka-io
...
[o](HttpChallenge.html "See companion class")[akka](../../../../index.html).[http](../../../index.html).[scaladsl](../../index.html).[model](../index.html).[headers](index.html)

# [HttpChallenge](HttpChallenge.html "See companion class")[**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html "Permalink")

### Companion [class HttpChallenge](HttpChallenge.html "See companion class")

#### object HttpChallenge extends [AbstractFunction3](https://www.scala-lang.org/api/2.13.17/scala/runtime/AbstractFunction3.html#scala.runtime.AbstractFunction3)\[String, String, Map\[String, String], [HttpChallenge](HttpChallenge.html)] with [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)

Source[HttpChallenge.scala](https://github.com/akka/akka-http/tree/v10.7.4/akka-http-core/src/main/scala/akka/http/scaladsl/model/headers/HttpChallenge.scala#L40)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [AbstractFunction3](https://www.scala-lang.org/api/2.13.17/scala/runtime/AbstractFunction3.html#scala.runtime.AbstractFunction3)\[String, String, Map\[String, String], [HttpChallenge](HttpChallenge.html)], (String, String, Map\[String, String]) \=\> [HttpChallenge](HttpChallenge.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. HttpChallenge
2. Serializable
...
3. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#apply(scheme:String,realm:Option[String],params:Map[String,String]):akka.http.scaladsl.model.headers.HttpChallenge "Permalink")  def apply(scheme: String, realm: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[String], params: Map\[String, String]): [HttpChallenge](HttpChallenge.html)
5. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#apply(scheme:String,realm:Option[String]):akka.http.scaladsl.model.headers.HttpChallenge "Permalink")  def apply(scheme: String, realm: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[String]): [HttpChallenge](HttpChallenge.html)
...
8. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#curried:T1=>(T2=>(T3=>R)) "Permalink")  def curried: (String) \=\> (String) \=\> (Map\[String, String]) \=\> [HttpChallenge](HttpChallenge.html)Definition ClassesFunction3Annotations@unspecialized()
9. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
10. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
11. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
12. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
14. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
18. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#toString():String "Permalink")  def toString(): StringDefinition ClassesFunction3 → AnyRef → Any
19. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#tupled:((T1,T2,T3))=>R "Permalink")  def tupled: ((String, String, Map\[String, String])) \=\> [HttpChallenge](HttpChallenge.html)Definition ClassesFunction3Annotations@unspecialized()
20. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
21. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
22. [**](../../../../../akka/http/scaladsl/model/headers/HttpChallenge$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
### Inherited from [AbstractFunction3](https://www.scala-lang.org/api/2.13.17/scala/runtime/AbstractFunction3.html#scala.runtime.AbstractFunction3)\[String, String, Map\[String, String], [HttpChallenge](HttpChallenge.html)]

### Inherited from (String, String, Map\[String, String]) \=\> [HttpChallenge](HttpChallenge.html)
