...
scraped_at: '2026-04-05T23:20:43Z'
section: api
site: akka-io
...
[o](Server.html "See companion class")[akka](../../../../index.html).[http](../../../index.html).[scaladsl](../../index.html).[model](../index.html).[headers](index.html)

# [Server](Server.html "See companion class")[**](../../../../../akka/http/scaladsl/model/headers/Server$.html "Permalink")

### Companion [class Server](Server.html "See companion class")

#### object Server extends [ModeledCompanion](ModeledCompanion.html)\[[Server](Server.html)] with [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)

Source[headers.scala](https://github.com/akka/akka-http/tree/v10.7.4/akka-http-core/src/main/scala/akka/http/scaladsl/model/headers/headers.scala#L967)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [ModeledCompanion](ModeledCompanion.html)\[[Server](Server.html)], Renderable, [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Server
2. Serializable
...
3. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#apply(first:akka.http.scaladsl.model.headers.ProductVersion,more:akka.http.scaladsl.model.headers.ProductVersion*):akka.http.scaladsl.model.headers.Server "Permalink")  def apply(first: [ProductVersion](ProductVersion.html), more: [ProductVersion](ProductVersion.html)\*): [Server](Server.html)
5. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#apply(products:String):akka.http.scaladsl.model.headers.Server "Permalink")  def apply(products: String): [Server](Server.html)
...
8. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
9. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
10. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
11. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
12. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
13. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#lowercaseName:String "Permalink")  val lowercaseName: StringDefinition Classes[ModeledCompanion](ModeledCompanion.html)
14. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#name:String "Permalink")  val name: StringDefinition Classes[ModeledCompanion](ModeledCompanion.html)
15. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
16. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#parseFromValueString(value:String):Either[List[akka.http.scaladsl.model.ErrorInfo],T] "Permalink")  def parseFromValueString(value: String): Either\[List\[[ErrorInfo](../ErrorInfo.html)], [Server](Server.html)]Parses the given value into a header of this type.
...
19. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#productsRenderer:akka.http.impl.util.Renderer[scala.collection.immutable.Iterable[akka.http.scaladsl.model.headers.ProductVersion]] "Permalink") implicit  val productsRenderer: Renderer\[[Iterable](https://www.scala-lang.org/api/2.13.17/scala/collection/immutable/Iterable.html#scala.collection.immutable.Iterable)\[[ProductVersion](ProductVersion.html)]]
20. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#render[R<:akka.http.impl.util.Rendering](r:R):r.type "Permalink") final  def render\[R \<: Rendering](r: R): r.typeDefinition Classes[ModeledCompanion](ModeledCompanion.html) → Renderable
21. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
23. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../../../../akka/http/scaladsl/model/headers/Server$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
### Inherited from [ModeledCompanion](ModeledCompanion.html)\[[Server](Server.html)]
