...
scraped_at: '2026-04-05T23:01:15Z'
section: api
site: akka-io
...
[o](If$minusRange.html "See companion class")[akka](../../../../index.html).[http](../../../index.html).[scaladsl](../../index.html).[model](../index.html).[headers](index.html)

# [If\-Range](If$minusRange.html "See companion class")[**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html "Permalink")

### Companion [class If\-Range](If$minusRange.html "See companion class")

#### object If\-Range extends [ModeledCompanion](ModeledCompanion.html)\[[If\-Range](If$minusRange.html)] with [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)

Source[headers.scala](https://github.com/akka/akka-http/tree/v10.7.4/akka-http-core/src/main/scala/akka/http/scaladsl/model/headers/headers.scala#L662)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [ModeledCompanion](ModeledCompanion.html)\[[If\-Range](If$minusRange.html)], Renderable, [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. If\-Range
2. Serializable
...
3. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#apply(timestamp:akka.http.scaladsl.model.DateTime):akka.http.scaladsl.model.headers.If-Range "Permalink")  def apply(timestamp: [DateTime](../DateTime.html)): [If\-Range](If$minusRange.html)
5. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#apply(tag:akka.http.scaladsl.model.headers.EntityTag):akka.http.scaladsl.model.headers.If-Range "Permalink")  def apply(tag: [EntityTag](EntityTag.html)): [If\-Range](If$minusRange.html)
...
8. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
9. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
...
11. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
12. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
13. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#lowercaseName:String "Permalink")  val lowercaseName: StringDefinition Classes[ModeledCompanion](ModeledCompanion.html)
14. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#name:String "Permalink")  val name: StringDefinition Classes[ModeledCompanion](ModeledCompanion.html)
15. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
16. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#parseFromValueString(value:String):Either[List[akka.http.scaladsl.model.ErrorInfo],T] "Permalink")  def parseFromValueString(value: String): Either\[List\[[ErrorInfo](../ErrorInfo.html)], [If\-Range](If$minusRange.html)]Parses the given value into a header of this type.
...
19. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#render[R<:akka.http.impl.util.Rendering](r:R):r.type "Permalink") final  def render\[R \<: Rendering](r: R): r.typeDefinition Classes[ModeledCompanion](ModeledCompanion.html) → Renderable
20. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
...
24. [**](../../../../../akka/http/scaladsl/model/headers/If$minusRange$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
### Inherited from [ModeledCompanion](ModeledCompanion.html)\[[If\-Range](If$minusRange.html)]
