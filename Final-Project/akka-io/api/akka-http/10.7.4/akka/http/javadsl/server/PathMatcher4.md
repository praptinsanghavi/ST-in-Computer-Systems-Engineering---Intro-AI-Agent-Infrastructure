---
description: Akka HTTP 10.7.4 - akka.http.javadsl.server.PathMatcher4
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:16:03Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/javadsl/server/PathMatcher4.html
title: Akka HTTP 10.7.4 - akka.http.javadsl.server.PathMatcher4
---

# Akka HTTP 10.7.4 - akka.http.javadsl.server.PathMatcher4

> **Summary:** Akka HTTP 10.7.4 - akka.http.javadsl.server.PathMatcher4
...
# PathMatcher4[**](../../../../akka/http/javadsl/server/PathMatcher4.html "Permalink")

### 

#### final  class PathMatcher4\[T1, T2, T3, T4] extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

A PathMatcher tries to match a prefix of a given string and returns either a PathMatcher.Matched instance
if matched, otherwise PathMatchers.Unmatched.

Source[JavaPathMatchers.scala](https://github.com/akka/akka-http/tree/v10.7.4/akka-http/target/scala-2.13/src_managed/main/akka/http/javadsl/server/JavaPathMatchers.scala#L374)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. PathMatcher4
2. AnyRef
...
1. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#<init>(toScala:akka.http.scaladsl.server.PathMatcher[(T1,T2,T3,T4)]):akka.http.javadsl.server.PathMatcher4[T1,T2,T3,T4] "Permalink")  new PathMatcher4(toScala: [PathMatcher](../../scaladsl/server/PathMatcher.html)\[(T1, T2, T3, T4)])
### Value Members

1. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../akka/http/javadsl/server/PathMatcher4.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from PathMatcher4\[T1, T2, T3, T4] toany2stringadd\[PathMatcher4\[T1, T2, T3, T4]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (PathMatcher4\[T1, T2, T3, T4], B)ImplicitThis member is added by an implicit conversion from PathMatcher4\[T1, T2, T3, T4] toArrowAssoc\[PathMatcher4\[T1, T2, T3, T4]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#concat[N1,N2](next:akka.http.javadsl.server.PathMatcher2[N1,N2]):akka.http.javadsl.server.PathMatcher6[T1,T2,T3,T4,N1,N2] "Permalink")  def concat\[N1, N2](next: [PathMatcher2](PathMatcher2.html)\[N1, N2]): [PathMatcher6](PathMatcher6.html)\[T1, T2, T3, T4, N1, N2]
9. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#concat[N](next:akka.http.javadsl.server.PathMatcher1[N]):akka.http.javadsl.server.PathMatcher5[T1,T2,T3,T4,N] "Permalink")  def concat\[N](next: [PathMatcher1](PathMatcher1.html)\[N]): [PathMatcher5](PathMatcher5.html)\[T1, T2, T3, T4, N]
10. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#concat(next:akka.http.javadsl.server.PathMatcher0):akka.http.javadsl.server.PathMatcher4[T1,T2,T3,T4] "Permalink")  def concat(next: [PathMatcher0](PathMatcher0.html)): PathMatcher4\[T1, T2, T3, T4]
11. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#concat(segment:String):akka.http.javadsl.server.PathMatcher4[T1,T2,T3,T4] "Permalink")  def concat(segment: String): PathMatcher4\[T1, T2, T3, T4]
12. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (PathMatcher4\[T1, T2, T3, T4]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): PathMatcher4\[T1, T2, T3, T4]ImplicitThis member is added by an implicit conversion from PathMatcher4\[T1, T2, T3, T4] toEnsuring\[PathMatcher4\[T1, T2, T3, T4]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (PathMatcher4\[T1, T2, T3, T4]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): PathMatcher4\[T1, T2, T3, T4]ImplicitThis member is added by an implicit conversion from PathMatcher4\[T1, T2, T3, T4] toEnsuring\[PathMatcher4\[T1, T2, T3, T4]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): PathMatcher4\[T1, T2, T3, T4]ImplicitThis member is added by an implicit conversion from PathMatcher4\[T1, T2, T3, T4] toEnsuring\[PathMatcher4\[T1, T2, T3, T4]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): PathMatcher4\[T1, T2, T3, T4]ImplicitThis member is added by an implicit conversion from PathMatcher4\[T1, T2, T3, T4] toEnsuring\[PathMatcher4\[T1, T2, T3, T4]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
16. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
18. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#invert:akka.http.javadsl.server.PathMatcher0 "Permalink")  def invert: [PathMatcher0](PathMatcher0.html)
21. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
22. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
23. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
25. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#orElse(alternative:akka.http.javadsl.server.PathMatcher4[T1,T2,T3,T4]):akka.http.javadsl.server.PathMatcher4[T1,T2,T3,T4] "Permalink")  def orElse(alternative: PathMatcher4\[T1, T2, T3, T4]): PathMatcher4\[T1, T2, T3, T4]
26. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#slash[N1,N2](next:akka.http.javadsl.server.PathMatcher2[N1,N2]):akka.http.javadsl.server.PathMatcher6[T1,T2,T3,T4,N1,N2] "Permalink")  def slash\[N1, N2](next: [PathMatcher2](PathMatcher2.html)\[N1, N2]): [PathMatcher6](PathMatcher6.html)\[T1, T2, T3, T4, N1, N2]
27. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#slash[N](next:akka.http.javadsl.server.PathMatcher1[N]):akka.http.javadsl.server.PathMatcher5[T1,T2,T3,T4,N] "Permalink")  def slash\[N](next: [PathMatcher1](PathMatcher1.html)\[N]): [PathMatcher5](PathMatcher5.html)\[T1, T2, T3, T4, N]
28. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#slash(next:akka.http.javadsl.server.PathMatcher0):akka.http.javadsl.server.PathMatcher4[T1,T2,T3,T4] "Permalink")  def slash(next: [PathMatcher0](PathMatcher0.html)): PathMatcher4\[T1, T2, T3, T4]
29. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#slash(segment:String):akka.http.javadsl.server.PathMatcher4[T1,T2,T3,T4] "Permalink")  def slash(segment: String): PathMatcher4\[T1, T2, T3, T4]
30. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#slash():akka.http.javadsl.server.PathMatcher4[T1,T2,T3,T4] "Permalink")  def slash(): PathMatcher4\[T1, T2, T3, T4]
31. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
32. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#toScala:akka.http.scaladsl.server.PathMatcher[(T1,T2,T3,T4)] "Permalink")  val toScala: [PathMatcher](../../scaladsl/server/PathMatcher.html)\[(T1, T2, T3, T4)]
33. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
34. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
35. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
36. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from PathMatcher4\[T1, T2, T3, T4] toStringFormat\[PathMatcher4\[T1, T2, T3, T4]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../../akka/http/javadsl/server/PathMatcher4.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (PathMatcher4\[T1, T2, T3, T4], B)ImplicitThis member is added by an implicit conversion from PathMatcher4\[T1, T2, T3, T4] toArrowAssoc\[PathMatcher4\[T1, T2, T3, T4]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromPathMatcher4\[T1, T2, T3, T4] to any2stringadd\[PathMatcher4\[T1, T2, T3, T4]]

### Inherited by implicit conversion StringFormat fromPathMatcher4\[T1, T2, T3, T4] to StringFormat\[PathMatcher4\[T1, T2, T3, T4]]

### Inherited by implicit conversion Ensuring fromPathMatcher4\[T1, T2, T3, T4] to Ensuring\[PathMatcher4\[T1, T2, T3, T4]]

### Inherited by implicit conversion ArrowAssoc fromPathMatcher4\[T1, T2, T3, T4] to ArrowAssoc\[PathMatcher4\[T1, T2, T3, T4]]
...
---
*Source: [https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/server/PathMatcher4.html](https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/server/PathMatcher4.html)*