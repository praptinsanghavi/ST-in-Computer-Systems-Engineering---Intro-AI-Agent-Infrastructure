---
description: Akka HTTP 10.7.4 - akka.http.javadsl.server.ExceptionHandlerBuilder
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:15:06Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/javadsl/server/ExceptionHandlerBuilder.html
title: Akka HTTP 10.7.4 - akka.http.javadsl.server.ExceptionHandlerBuilder
---

# Akka HTTP 10.7.4 - akka.http.javadsl.server.ExceptionHandlerBuilder

> **Summary:** Akka HTTP 10.7.4 - akka.http.javadsl.server.ExceptionHandlerBuilder
...
# ExceptionHandlerBuilder[**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html "Permalink")

### 

#### class ExceptionHandlerBuilder extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

Source[ExceptionHandlerBuilder.java](https://github.com/akka/akka-http/tree/v10.7.4/akka-http/src/main/java/akka/http/javadsl/server/ExceptionHandlerBuilder.java#L10)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#<init>():akka.http.javadsl.server.ExceptionHandlerBuilder "Permalink")  new ExceptionHandlerBuilder()
### Value Members

1. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ExceptionHandlerBuilder toany2stringadd\[ExceptionHandlerBuilder] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ExceptionHandlerBuilder, B)ImplicitThis member is added by an implicit conversion from ExceptionHandlerBuilder toArrowAssoc\[ExceptionHandlerBuilder] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#build():akka.http.javadsl.server.ExceptionHandler "Permalink")  def build(): [ExceptionHandler](ExceptionHandler.html)
8. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ExceptionHandlerBuilder) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ExceptionHandlerBuilderImplicitThis member is added by an implicit conversion from ExceptionHandlerBuilder toEnsuring\[ExceptionHandlerBuilder] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ExceptionHandlerBuilder) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ExceptionHandlerBuilderImplicitThis member is added by an implicit conversion from ExceptionHandlerBuilder toEnsuring\[ExceptionHandlerBuilder] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ExceptionHandlerBuilderImplicitThis member is added by an implicit conversion from ExceptionHandlerBuilder toEnsuring\[ExceptionHandlerBuilder] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ExceptionHandlerBuilderImplicitThis member is added by an implicit conversion from ExceptionHandlerBuilder toEnsuring\[ExceptionHandlerBuilder] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
15. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
18. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#match[P<:Throwable](type:Class[P],predicate:akka.japi.pf.FI.TypedPredicate[P],apply:akka.japi.pf.FI.Apply[P,akka.http.javadsl.server.Route]):akka.http.javadsl.server.ExceptionHandlerBuilder "Permalink")  def match\[P \<: [Throwable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Throwable.html#java.lang.Throwable)](type: [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[P], predicate: TypedPredicate\[P], apply: Apply\[P, [Route](Route.html)]): ExceptionHandlerBuilderAdd a new case statement to this builder.
...
applyan action to apply to the argument if the type matches and the predicate returns true

returnsa builder with the case statement added
19. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#match[P<:Throwable](type:Class[P],apply:akka.japi.pf.FI.Apply[P,akka.http.javadsl.server.Route]):akka.http.javadsl.server.ExceptionHandlerBuilder "Permalink")  def match\[P \<: [Throwable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Throwable.html#java.lang.Throwable)](type: [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[P], apply: Apply\[P, [Route](Route.html)]): ExceptionHandlerBuilderAdd a new case statement to this builder.
...
returnsa builder with the case statement added
20. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#matchAny(apply:akka.japi.pf.FI.Apply[Throwable,akka.http.javadsl.server.Route]):akka.http.javadsl.server.ExceptionHandlerBuilder "Permalink")  def matchAny(apply: Apply\[[Throwable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Throwable.html#java.lang.Throwable), [Route](Route.html)]): ExceptionHandlerBuilderAdd a new case statement to this builder, that matches any argument.
...
returnsa builder with the case statement added
21. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#matchEquals[P<:Throwable](object:P,apply:akka.japi.pf.FI.Apply[P,akka.http.javadsl.server.Route]):akka.http.javadsl.server.ExceptionHandlerBuilder "Permalink")  def matchEquals\[P \<: [Throwable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Throwable.html#java.lang.Throwable)](object: P, apply: Apply\[P, [Route](Route.html)]): ExceptionHandlerBuilderAdd a new case statement to this builder.
...
returnsa builder with the case statement added
22. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
23. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
25. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
26. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
27. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
29. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ExceptionHandlerBuilder toStringFormat\[ExceptionHandlerBuilder] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../../akka/http/javadsl/server/ExceptionHandlerBuilder.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ExceptionHandlerBuilder, B)ImplicitThis member is added by an implicit conversion from ExceptionHandlerBuilder toArrowAssoc\[ExceptionHandlerBuilder] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromExceptionHandlerBuilder to any2stringadd\[ExceptionHandlerBuilder]

### Inherited by implicit conversion StringFormat fromExceptionHandlerBuilder to StringFormat\[ExceptionHandlerBuilder]

### Inherited by implicit conversion Ensuring fromExceptionHandlerBuilder to Ensuring\[ExceptionHandlerBuilder]

### Inherited by implicit conversion ArrowAssoc fromExceptionHandlerBuilder to ArrowAssoc\[ExceptionHandlerBuilder]
...
---
*Source: [https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/server/ExceptionHandlerBuilder.html](https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/server/ExceptionHandlerBuilder.html)*