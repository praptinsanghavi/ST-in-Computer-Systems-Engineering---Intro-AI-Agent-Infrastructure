---
description: Akka HTTP 10.7.4 - akka.http.javadsl.testkit.JUnitRouteTest
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:19:25Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/javadsl/testkit/JUnitRouteTest.html
title: Akka HTTP 10.7.4 - akka.http.javadsl.testkit.JUnitRouteTest
---

# Akka HTTP 10.7.4 - akka.http.javadsl.testkit.JUnitRouteTest

> **Summary:** Akka HTTP 10.7.4 - akka.http.javadsl.testkit.JUnitRouteTest
...
6. TlsDirectives
7. CorsDirectives
8. FramedEntityStreamingDirectives
9. TimeoutDirectives
...
1. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#<init>():akka.http.javadsl.testkit.JUnitRouteTest "Permalink")  new JUnitRouteTest()
### Value Members

1. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from JUnitRouteTest toany2stringadd\[JUnitRouteTest] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (JUnitRouteTest, B)ImplicitThis member is added by an implicit conversion from JUnitRouteTest toArrowAssoc\[JUnitRouteTest] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#WS[T](uri:akka.http.javadsl.model.Uri,clientSideHandler:akka.stream.javadsl.Flow[akka.http.javadsl.model.ws.Message,akka.http.javadsl.model.ws.Message,T],materializer:akka.stream.Materializer,subprotocols:java.util.List[String]):akka.http.javadsl.model.HttpRequest "Permalink")  def WS\[T](uri: [Uri](../model/Uri.html), clientSideHandler: [Flow](https://doc.akka.io/api/akka-core/2.10.11/akka/stream/javadsl/Flow.html#akka.stream.javadsl.Flow)\[[Message](../model/ws/Message.html), [Message](../model/ws/Message.html), T], materializer: [Materializer](https://doc.akka.io/api/akka-core/2.10.11/akka/stream/Materializer.html#akka.stream.Materializer), subprotocols: [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[String]): [HttpRequest](../model/HttpRequest.html)Definition Classes[WSTestRequestBuilding](WSTestRequestBuilding.html)
7. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#WS[T](uri:akka.http.javadsl.model.Uri,clientSideHandler:akka.stream.javadsl.Flow[akka.http.javadsl.model.ws.Message,akka.http.javadsl.model.ws.Message,T],materializer:akka.stream.Materializer):akka.http.javadsl.model.HttpRequest "Permalink")  def WS\[T](uri: [Uri](../model/Uri.html), clientSideHandler: [Flow](https://doc.akka.io/api/akka-core/2.10.11/akka/stream/javadsl/Flow.html#akka.stream.javadsl.Flow)\[[Message](../model/ws/Message.html), [Message](../model/ws/Message.html), T], materializer: [Materializer](https://doc.akka.io/api/akka-core/2.10.11/akka/stream/Materializer.html#akka.stream.Materializer)): [HttpRequest](../model/HttpRequest.html)Definition Classes[WSTestRequestBuilding](WSTestRequestBuilding.html)
8. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#additionalConfig:com.typesafe.config.Config "Permalink")  def additionalConfig: [Config](https://javadoc.io/page/com.typesafe/config/1.4.5/com/typesafe/config/Config.html#com.typesafe.config.Config)Attributesprotected
9. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
10. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#attribute[T](key:akka.http.javadsl.model.AttributeKey[T],inner:java.util.function.Function[T,akka.http.javadsl.server.Route]):akka.http.javadsl.server.directives.RouteAdapter "Permalink")  def attribute\[T](key: [AttributeKey](../model/AttributeKey.html)\[T], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T, [Route](../server/Route.html)]): [RouteAdapter](../server/directives/RouteAdapter.html)Extracts the value of the request attribute with the given key.
...
Definition Classes[SecurityDirectives](../server/directives/SecurityDirectives.html)
18. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#authenticateOAuth2Async[T](realm:String,authenticator:java.util.function.Function[java.util.Optional[akka.http.javadsl.server.directives.SecurityDirectives.ProvidedCredentials],java.util.concurrent.CompletionStage[java.util.Optional[T]]],inner:java.util.function.Function[T,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def authenticateOAuth2Async\[T](realm: String, authenticator: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[[Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[[ProvidedCredentials](../server/directives/SecurityDirectives$$ProvidedCredentials.html)], [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[[Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[T]]], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T, [Route](../server/Route.html)]): [Route](../server/Route.html)A directive that wraps the inner route with OAuth2 Bearer Token authentication support.
...
Definition Classes[SecurityDirectives](../server/directives/SecurityDirectives.html)Annotations@[CorrespondsTo](../server/directives/CorrespondsTo.html)()
20. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#authenticateOAuth2Optional[T](realm:String,authenticator:java.util.function.Function[java.util.Optional[akka.http.javadsl.server.directives.SecurityDirectives.ProvidedCredentials],java.util.Optional[T]],inner:java.util.function.Function[java.util.Optional[T],akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def authenticateOAuth2Optional\[T](realm: String, authenticator: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[[Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[[ProvidedCredentials](../server/directives/SecurityDirectives$$ProvidedCredentials.html)], [Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[T]], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[[Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[T], [Route](../server/Route.html)]): [Route](../server/Route.html)A directive that wraps the inner route with OAuth2 Bearer Token authentication support.
...
32. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
33. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#complete(entity:akka.http.javadsl.model.RequestEntity):akka.http.javadsl.server.directives.RouteAdapter "Permalink")  def complete(entity: [RequestEntity](../model/RequestEntity.html)): [RouteAdapter](../server/directives/RouteAdapter.html)Completes the request as HTTP 200 OK with the given value as response entity.
...
Definition Classes[CacheConditionDirectives](../server/directives/CacheConditionDirectives.html)
68. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#conditional(lastModified:akka.http.javadsl.model.DateTime,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def conditional(lastModified: [DateTime](../model/DateTime.html), inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Wraps its inner route with support for Conditional Requests as defined
by http://tools.ietf.org/html/rfc7232
...
Definition Classes[CacheConditionDirectives](../server/directives/CacheConditionDirectives.html)
69. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#conditional(eTag:akka.http.javadsl.model.headers.EntityTag,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def conditional(eTag: [EntityTag](../model/headers/EntityTag.html), inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Wraps its inner route with support for Conditional Requests as defined
by http://tools.ietf.org/html/rfc7232
...
72. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#cors(inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def cors(inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Wraps its inner route with support for the CORS mechanism, enabling cross origin requests.
...
Definition Classes[CodingDirectives](../server/directives/CodingDirectives.html)
78. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#defaultAwaitDuration:scala.concurrent.duration.FiniteDuration "Permalink")  def defaultAwaitDuration: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)Attributesprotected Definition Classes[RouteTest](RouteTest.html)
79. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#defaultContentTypeResolver:akka.http.javadsl.server.directives.ContentTypeResolver "Permalink")  def defaultContentTypeResolver: [ContentTypeResolver](../server/directives/ContentTypeResolver.html)Default ContentTypeResolver.

Default ContentTypeResolver.

Definition Classes[FileAndResourceDirectives](../server/directives/FileAndResourceDirectives.html)
80. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#defaultDirectoryRenderer:akka.http.javadsl.server.directives.DirectoryRenderer "Permalink")  def defaultDirectoryRenderer: [DirectoryRenderer](../server/directives/DirectoryRenderer.html)Default DirectoryRenderer to be used with directory listing directives.

Default DirectoryRenderer to be used with directory listing directives.

Definition Classes[FileAndResourceDirectives](../server/directives/FileAndResourceDirectives.html)
81. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#defaultHostInfo:akka.http.javadsl.testkit.DefaultHostInfo "Permalink")  def defaultHostInfo: [DefaultHostInfo](DefaultHostInfo.html)Attributesprotected Definition Classes[RouteTest](RouteTest.html)
82. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#delete(inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def delete(inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[MethodDirectives](../server/directives/MethodDirectives.html)
83. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#deleteCookie(name:String,domain:String,path:String,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def deleteCookie(name: String, domain: String, path: String, inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Adds a Set\-Cookie response header expiring the cookie with the given properties.
...
Definition Classes[CookieDirectives](../server/directives/CookieDirectives.html)
84. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#deleteCookie(name:String,domain:String,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def deleteCookie(name: String, domain: String, inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Adds a Set\-Cookie response header expiring the cookie with the given properties.
...
Definition Classes[CookieDirectives](../server/directives/CookieDirectives.html)
85. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#deleteCookie(name:String,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def deleteCookie(name: String, inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Adds a Set\-Cookie response header expiring the cookie with the given properties.
...
Definition Classes[CodingDirectives](../server/directives/CodingDirectives.html)
89. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#encodeResponseWith(coders:Iterable[akka.http.javadsl.coding.Coder],inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def encodeResponseWith(coders: [Iterable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Iterable.html#java.lang.Iterable)\[[Coder](../coding/Coder.html)], inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Encodes the response with the encoding that is requested by the client via the `Accept-
Encoding` header.
...
Definition Classes[CodingDirectives](../server/directives/CodingDirectives.html)
90. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (JUnitRouteTest) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): JUnitRouteTestImplicitThis member is added by an implicit conversion from JUnitRouteTest toEnsuring\[JUnitRouteTest] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
91. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (JUnitRouteTest) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): JUnitRouteTestImplicitThis member is added by an implicit conversion from JUnitRouteTest toEnsuring\[JUnitRouteTest] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
92. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): JUnitRouteTestImplicitThis member is added by an implicit conversion from JUnitRouteTest toEnsuring\[JUnitRouteTest] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
93. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): JUnitRouteTestImplicitThis member is added by an implicit conversion from JUnitRouteTest toEnsuring\[JUnitRouteTest] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
94. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#entity[T](unmarshaller:akka.http.javadsl.unmarshalling.Unmarshaller[_>:akka.http.javadsl.model.HttpEntity,T],inner:java.util.function.Function[T,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def entity\[T](unmarshaller: [Unmarshaller](../unmarshalling/Unmarshaller.html)\[\_ \>: [HttpEntity](../model/HttpEntity.html), T], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T, [Route](../server/Route.html)]): [Route](../server/Route.html)Unmarshalls the requests entity using the given unmarshaller, and passes the result to \[inner].
...
Definition Classes[WebSocketDirectives](../server/directives/WebSocketDirectives.html)
126. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#failWith(error:Throwable):akka.http.javadsl.server.Route "Permalink")  def failWith(error: Throwable): [Route](../server/Route.html)Bubbles the given error up the response chain, where it is dealt with by the closest `handleExceptions`
...
Definition Classes[FileAndResourceDirectives](../server/directives/FileAndResourceDirectives.html)
149. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#getFromDirectory(directoryPath:String):akka.http.javadsl.server.Route "Permalink")  def getFromDirectory(directoryPath: String): [Route](../server/Route.html)Completes GET requests with the content of a file underneath the given directory, using the default content\-type resolver.

Completes GET requests with the content of a file underneath the given directory, using the default content\-type resolver.
If the file cannot be read the Route rejects the request.

Definition Classes[FileAndResourceDirectives](../server/directives/FileAndResourceDirectives.html)
150. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#getFromFile(file:String,resolver:akka.http.javadsl.server.directives.ContentTypeResolver):akka.http.javadsl.server.Route "Permalink")  def getFromFile(file: String, resolver: [ContentTypeResolver](../server/directives/ContentTypeResolver.html)): [Route](../server/Route.html)Completes GET requests with the content of the given file, resolving the content type using the given resolver.
...
Definition Classes[FileAndResourceDirectives](../server/directives/FileAndResourceDirectives.html)
158. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#getFromResource(path:String):akka.http.javadsl.server.Route "Permalink")  def getFromResource(path: String): [Route](../server/Route.html)Completes GET requests with the content of the given resource loaded from the default ClassLoader,
...
Definition Classes[ExecutionDirectives](../server/directives/ExecutionDirectives.html)
166. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#handleSync(handler:akka.japi.function.Function[akka.http.javadsl.model.HttpRequest,akka.http.javadsl.model.HttpResponse]):akka.http.javadsl.server.Route "Permalink")  def handleSync(handler: [Function](https://doc.akka.io/api/akka-core/2.10.11/akka/japi/function/Function.html#akka.japi.function.Function)\[[HttpRequest](../model/HttpRequest.html), [HttpResponse](../model/HttpResponse.html)]): [Route](../server/Route.html)Handle the request using a function.

Handle the request using a function.

Definition Classes[RouteDirectives](../server/directives/RouteDirectives.html)
167. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#handleWebSocketMessages[T](handler:akka.stream.javadsl.Flow[akka.http.javadsl.model.ws.Message,akka.http.javadsl.model.ws.Message,T]):akka.http.javadsl.server.Route "Permalink")  def handleWebSocketMessages\[T](handler: [Flow](https://doc.akka.io/api/akka-core/2.10.11/akka/stream/javadsl/Flow.html#akka.stream.javadsl.Flow)\[[Message](../model/ws/Message.html), [Message](../model/ws/Message.html), T]): [Route](../server/Route.html)Handles WebSocket requests with the given handler and rejects other requests with an
...
Definition Classes[WebSocketDirectives](../server/directives/WebSocketDirectives.html)
170. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#handleWith[T,R](unmarshaller:akka.http.javadsl.unmarshalling.Unmarshaller[_>:akka.http.javadsl.model.HttpEntity,T],marshaller:akka.http.javadsl.marshalling.Marshaller[R,_<:akka.http.javadsl.model.HttpResponse],inner:java.util.function.Function[T,R]):akka.http.javadsl.server.Route "Permalink")  def handleWith\[T, R](unmarshaller: [Unmarshaller](../unmarshalling/Unmarshaller.html)\[\_ \>: [HttpEntity](../model/HttpEntity.html), T], marshaller: [Marshaller](../marshalling/Marshaller.html)\[R, \_ \<: [HttpResponse](../model/HttpResponse.html)], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T, R]): [Route](../server/Route.html)Completes the request using the given function.
...
182. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
183. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#listDirectoryContents(directoryRenderer:akka.http.javadsl.server.directives.DirectoryRenderer,directories:String*):akka.http.javadsl.server.Route "Permalink")  def listDirectoryContents(directoryRenderer: [DirectoryRenderer](../server/directives/DirectoryRenderer.html), directories: String\*): [Route](../server/Route.html)Completes GET requests with a unified listing of the contents of all given directories.

Completes GET requests with a unified listing of the contents of all given directories.
The actual rendering of the directory contents is performed by the in\-scope `Marshaller[DirectoryListing]`.

Definition Classes[FileAndResourceDirectives](../server/directives/FileAndResourceDirectives.html)Annotations@varargs()
184. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#listDirectoryContents(directories:String*):akka.http.javadsl.server.Route "Permalink")  def listDirectoryContents(directories: String\*): [Route](../server/Route.html)Completes GET requests with a unified listing of the contents of all given directories.

Completes GET requests with a unified listing of the contents of all given directories.
The actual rendering of the directory contents is performed by the in\-scope `Marshaller[DirectoryListing]`.

Definition Classes[FileAndResourceDirectives](../server/directives/FileAndResourceDirectives.html)Annotations@varargs()
185. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#logRequest(show:java.util.function.Function[akka.http.javadsl.model.HttpRequest,akka.http.javadsl.server.directives.LogEntry],inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def logRequest(show: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[[HttpRequest](../model/HttpRequest.html), [LogEntry](../server/directives/LogEntry.html)], inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Produces a log entry for every incoming request.
...
186. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#logRequest(marker:String,level:akka.event.Logging.LogLevel,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def logRequest(marker: String, level: LogLevel, inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Produces a log entry for every incoming request.
...
Definition Classes[FutureDirectives](../server/directives/FutureDirectives.html)
213. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#onComplete[T](f:java.util.function.Supplier[java.util.concurrent.CompletionStage[T]],inner:java.util.function.Function[scala.util.Try[T],akka.http.javadsl.server.Route]):akka.http.javadsl.server.directives.RouteAdapter "Permalink")  def onComplete\[T](f: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[T]], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[[Try](https://www.scala-lang.org/api/2.13.17/scala/util/Try.html#scala.util.Try)\[T], [Route](../server/Route.html)]): [RouteAdapter](../server/directives/RouteAdapter.html)"Unwraps" a `CompletionStage<T>` and runs the inner route after future
completion with the future's value as an extraction of type `Try<T>`.
...
Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
246. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#pathPrefix[T](t:akka.http.javadsl.unmarshalling.Unmarshaller[String,T],inner:java.util.function.Function[T,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathPrefix\[T](t: [Unmarshaller](../unmarshalling/Unmarshaller.html)\[String, T], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T, [Route](../server/Route.html)]): [Route](../server/Route.html)Consumes a leading slash and extracts the next path segment, unmarshalling it and passing the result to the inner function.

Consumes a leading slash and extracts the next path segment, unmarshalling it and passing the result to the inner function.

Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
247. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#pathPrefix[T1,T2](p:akka.http.javadsl.server.PathMatcher2[T1,T2],inner:java.util.function.BiFunction[T1,T2,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathPrefix\[T1, T2](p: [PathMatcher2](../server/PathMatcher2.html)\[T1, T2], inner: [BiFunction](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/BiFunction.html#java.util.function.BiFunction)\[T1, T2, [Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
248. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#pathPrefix[T](p:akka.http.javadsl.server.PathMatcher1[T],inner:java.util.function.Function[T,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathPrefix\[T](p: [PathMatcher1](../server/PathMatcher1.html)\[T], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T, [Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
249. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#pathPrefix(p:akka.http.javadsl.server.PathMatcher0,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathPrefix(p: [PathMatcher0](../server/PathMatcher0.html), inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Applies the given PathMatcher0 to the remaining unmatched path after consuming a leading slash.
...
Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
250. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#pathPrefix(inner:java.util.function.Function[String,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathPrefix(inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[String, [Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
251. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#pathPrefix(segment:String,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathPrefix(segment: String, inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Matches a prefix to the remaining unmatched path after consuming a leading slash.
...
Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
261. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#pathSuffixTest[T1,T2](pm:akka.http.javadsl.server.PathMatcher2[T1,T2],inner:java.util.function.BiFunction[T1,T2,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathSuffixTest\[T1, T2](pm: [PathMatcher2](../server/PathMatcher2.html)\[T1, T2], inner: [BiFunction](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/BiFunction.html#java.util.function.BiFunction)\[T1, T2, [Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
262. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#pathSuffixTest[T1](pm:akka.http.javadsl.server.PathMatcher1[T1],inner:java.util.function.Function[T1,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathSuffixTest\[T1](pm: [PathMatcher1](../server/PathMatcher1.html)\[T1], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T1, [Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
263. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#pathSuffixTest(pm:akka.http.javadsl.server.PathMatcher0,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathSuffixTest(pm: [PathMatcher0](../server/PathMatcher0.html), inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
264. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#pathSuffixTest(segment:String,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathSuffixTest(segment: String, inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Checks whether the unmatchedPath of the [akka.http.javadsl.server.RequestContext](../server/RequestContext.html) has a suffix matched by the
given PathMatcher.
...
Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
272. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#rawPathPrefixTest[T1,T2](pm:akka.http.javadsl.server.PathMatcher2[T1,T2],inner:java.util.function.BiFunction[T1,T2,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def rawPathPrefixTest\[T1, T2](pm: [PathMatcher2](../server/PathMatcher2.html)\[T1, T2], inner: [BiFunction](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/BiFunction.html#java.util.function.BiFunction)\[T1, T2, [Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
273. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#rawPathPrefixTest[T1](pm:akka.http.javadsl.server.PathMatcher1[T1],inner:java.util.function.Function[T1,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def rawPathPrefixTest\[T1](pm: [PathMatcher1](../server/PathMatcher1.html)\[T1], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T1, [Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
274. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#rawPathPrefixTest(pm:akka.http.javadsl.server.PathMatcher0,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def rawPathPrefixTest(pm: [PathMatcher0](../server/PathMatcher0.html), inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
275. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#rawPathPrefixTest(segment:String,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def rawPathPrefixTest(segment: String, inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Checks whether the unmatchedPath of the [akka.http.javadsl.server.RequestContext](../server/RequestContext.html) has a prefix matched by the
given PathMatcher.
...
Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
281. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#reject():akka.http.javadsl.server.Route "Permalink")  def reject(): [Route](../server/Route.html)Rejects the request with an empty rejection (usually used for "no directive matched").

Rejects the request with an empty rejection (usually used for "no directive matched").

Definition Classes[RouteDirectives](../server/directives/RouteDirectives.html)
282. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#reject(rejection:akka.http.javadsl.server.Rejection,rejections:akka.http.javadsl.server.Rejection*):akka.http.javadsl.server.Route "Permalink")  def reject(rejection: [Rejection](../server/Rejection.html), rejections: [Rejection](../server/Rejection.html)\*): [Route](../server/Route.html)Rejects the request with the given rejections, or with an empty set of rejections if no rejections are given.

Rejects the request with the given rejections, or with an empty set of rejections if no rejections are given.

Definition Classes[RouteDirectives](../server/directives/RouteDirectives.html)Annotations@varargs()
283. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#rejectEmptyResponse(inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def rejectEmptyResponse(inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Converts responses with an empty entity into (empty) rejections.
...
Definition Classes[MiscDirectives](../server/directives/MiscDirectives.html)
284. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#request[T](unmarshaller:akka.http.javadsl.unmarshalling.Unmarshaller[_>:akka.http.javadsl.model.HttpRequest,T],inner:java.util.function.Function[T,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def request\[T](unmarshaller: [Unmarshaller](../unmarshalling/Unmarshaller.html)\[\_ \>: [HttpRequest](../model/HttpRequest.html), T], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T, [Route](../server/Route.html)]): [Route](../server/Route.html)Unmarshalls the request using the given unmarshaller, and passes the result to \[inner].
...
Definition Classes[FileUploadDirectives](../server/directives/FileUploadDirectives.html)
305. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
306. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#system:akka.actor.ActorSystem "Permalink") implicit  def system: [ActorSystem](https://doc.akka.io/api/akka-core/2.10.11/akka/actor/ActorSystem.html#akka.actor.ActorSystem)Definition Classes[JUnitRouteTestBase](JUnitRouteTestBase.html) → [RouteTest](RouteTest.html)
307. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#systemResource:akka.http.javadsl.testkit.ActorSystemResource "Permalink")  def systemResource: [ActorSystemResource](ActorSystemResource.html)Attributesprotected Definition ClassesJUnitRouteTest → [JUnitRouteTestBase](JUnitRouteTestBase.html)Annotations@Rule()
308. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#testRoute(first:akka.http.javadsl.server.Route,others:akka.http.javadsl.server.Route*):akka.http.javadsl.testkit.TestRoute "Permalink")  def testRoute(first: [Route](../server/Route.html), others: [Route](../server/Route.html)\*): [TestRoute](TestRoute.html)Wraps a list of route alternatives with testing support.

Wraps a list of route alternatives with testing support.

Definition Classes[RouteTest](RouteTest.html)Annotations@varargs()
309. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#toStrictEntity(timeout:scala.concurrent.duration.FiniteDuration,maxBytes:Long,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def toStrictEntity(timeout: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration), maxBytes: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)WARNING: This will read the entire request entity into memory and effectively disable streaming.
...
Definition Classes[MiscDirectives](../server/directives/MiscDirectives.html)
313. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
314. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
315. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
316. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#withExecutionContext(ec:scala.concurrent.ExecutionContextExecutor,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def withExecutionContext(ec: [ExecutionContextExecutor](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContextExecutor.html#scala.concurrent.ExecutionContextExecutor), inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Runs its inner route with the given alternative [scala.concurrent.ExecutionContextExecutor](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContextExecutor.html).
...
2. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
3. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from JUnitRouteTest toStringFormat\[JUnitRouteTest] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
4. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#route(alternatives:akka.http.javadsl.server.Route*):akka.http.javadsl.server.Route "Permalink")  def route(alternatives: [Route](../server/Route.html)\*): [Route](../server/Route.html)Java\-specific call added so you can chain together multiple alternate routes using comma,
rather than having to explicitly call route1\.orElse(route2\).orElse(route3\).
...
5. [**](../../../../akka/http/javadsl/testkit/JUnitRouteTest.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (JUnitRouteTest, B)ImplicitThis member is added by an implicit conversion from JUnitRouteTest toArrowAssoc\[JUnitRouteTest] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [JUnitRouteTestBase](JUnitRouteTestBase.html)
...
### Inherited by implicit conversion any2stringadd fromJUnitRouteTest to any2stringadd\[JUnitRouteTest]

### Inherited by implicit conversion StringFormat fromJUnitRouteTest to StringFormat\[JUnitRouteTest]

### Inherited by implicit conversion Ensuring fromJUnitRouteTest to Ensuring\[JUnitRouteTest]

### Inherited by implicit conversion ArrowAssoc fromJUnitRouteTest to ArrowAssoc\[JUnitRouteTest]
...
---
*Source: [https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/testkit/JUnitRouteTest.html](https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/testkit/JUnitRouteTest.html)*