---
description: Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.RetryAfter
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:30:14Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/javadsl/model/headers/RetryAfter.html
title: Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.RetryAfter
---

# Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.RetryAfter

> **Summary:** Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.RetryAfter
...
# RetryAfter[**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html "Permalink")

### 

#### abstract  class RetryAfter extends [scaladsl.model.HttpHeader](../../../scaladsl/model/HttpHeader.html)

 Model for the `Retry-After` header.
 Specification: //https://tools.ietf.org/html/rfc7231\#section\-7\.1\.3

Source[RetryAfter.java](https://github.com/akka/akka-http/tree/v10.7.4/akka-http-core/src/main/java/akka/http/javadsl/model/headers/RetryAfter.java#L17)Linear Supertypes[scaladsl.model.HttpHeader](../../../scaladsl/model/HttpHeader.html), ToStringRenderable, Renderable, [HttpHeader](../HttpHeader.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[Retry\-After](../../../scaladsl/model/headers/Retry$minusAfter.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. RetryAfter
2. HttpHeader
...
1. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#<init>():akka.http.javadsl.model.headers.RetryAfter "Permalink")  new RetryAfter()
### Abstract Value Members

1. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#dateTime():Option[akka.http.scaladsl.model.DateTime] "Permalink") abstract  def dateTime(): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[scaladsl.model.DateTime](../../../scaladsl/model/DateTime.html)]Attributesprotected\[[headers](index.html)]
2. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#delaySeconds():Option[Long] "Permalink") abstract  def delaySeconds(): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[Long](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Long.html#java.lang.Long)]Attributesprotected\[[headers](index.html)]
3. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#lowercaseName():String "Permalink") abstract  def lowercaseName(): StringReturns the lower\-cased name of the header.
...
4. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#name():String "Permalink") abstract  def name(): StringReturns the name of the header.

Returns the name of the header.

Definition Classes[HttpHeader](../../../scaladsl/model/HttpHeader.html) → [HttpHeader](../HttpHeader.html)
5. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#renderInRequests():Boolean "Permalink") abstract  def renderInRequests(): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Returns true if and only if the header is to be rendered in requests.

Returns true if and only if the header is to be rendered in requests.

Definition Classes[HttpHeader](../HttpHeader.html)
6. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#renderInResponses():Boolean "Permalink") abstract  def renderInResponses(): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Returns true if and only if the header is to be rendered in responses.

Returns true if and only if the header is to be rendered in responses.

Definition Classes[HttpHeader](../HttpHeader.html)
7. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#value():String "Permalink") abstract  def value(): StringReturns the String representation of the value of the header.
...
1. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from RetryAfter toany2stringadd\[RetryAfter] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (RetryAfter, B)ImplicitThis member is added by an implicit conversion from RetryAfter toArrowAssoc\[RetryAfter] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (RetryAfter) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): RetryAfterImplicitThis member is added by an implicit conversion from RetryAfter toEnsuring\[RetryAfter] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (RetryAfter) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): RetryAfterImplicitThis member is added by an implicit conversion from RetryAfter toEnsuring\[RetryAfter] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): RetryAfterImplicitThis member is added by an implicit conversion from RetryAfter toEnsuring\[RetryAfter] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): RetryAfterImplicitThis member is added by an implicit conversion from RetryAfter toEnsuring\[RetryAfter] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#getDateTime():java.util.Optional[akka.http.javadsl.model.DateTime] "Permalink")  def getDateTime(): [Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[[DateTime](../DateTime.html)]the date for the retry attempt, if available
16. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#getDelaySeconds():java.util.Optional[Long] "Permalink")  def getDelaySeconds(): [Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[[Long](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Long.html#java.lang.Long)]number of seconds for the retry attempt, if available
17. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#is(nameInLowerCase:String):Boolean "Permalink")  def is(nameInLowerCase: String): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Returns true if and only if nameInLowerCase.equals(lowercaseName()).

Returns true if and only if nameInLowerCase.equals(lowercaseName()).

Definition Classes[HttpHeader](../../../scaladsl/model/HttpHeader.html) → [HttpHeader](../HttpHeader.html)
19. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
20. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#isNot(nameInLowerCase:String):Boolean "Permalink")  def isNot(nameInLowerCase: String): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Returns !is(nameInLowerCase).

Returns !is(nameInLowerCase).

Definition Classes[HttpHeader](../../../scaladsl/model/HttpHeader.html) → [HttpHeader](../HttpHeader.html)
21. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
22. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
25. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#toString():String "Permalink")  def toString(): StringDefinition ClassesToStringRenderable → AnyRef → Any
26. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#unsafeToString:String "Permalink")  def unsafeToString: StringDefinition Classes[HttpHeader](../../../scaladsl/model/HttpHeader.html)
27. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
29. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from RetryAfter toStringFormat\[RetryAfter] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../../../akka/http/javadsl/model/headers/RetryAfter.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (RetryAfter, B)ImplicitThis member is added by an implicit conversion from RetryAfter toArrowAssoc\[RetryAfter] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited by implicit conversion any2stringadd fromRetryAfter to any2stringadd\[RetryAfter]

### Inherited by implicit conversion StringFormat fromRetryAfter to StringFormat\[RetryAfter]

### Inherited by implicit conversion Ensuring fromRetryAfter to Ensuring\[RetryAfter]

### Inherited by implicit conversion ArrowAssoc fromRetryAfter to ArrowAssoc\[RetryAfter]
...
---
*Source: [https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/model/headers/RetryAfter.html](https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/model/headers/RetryAfter.html)*