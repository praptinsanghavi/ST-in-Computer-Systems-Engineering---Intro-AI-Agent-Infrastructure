---
description: Akka HTTP 10.7.4 - akka.http.javadsl.server.RejectionHandlerBuilder
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:16:29Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/javadsl/server/RejectionHandlerBuilder.html
title: Akka HTTP 10.7.4 - akka.http.javadsl.server.RejectionHandlerBuilder
---

# Akka HTTP 10.7.4 - akka.http.javadsl.server.RejectionHandlerBuilder

> **Summary:** Akka HTTP 10.7.4 - akka.http.javadsl.server.RejectionHandlerBuilder
...
# RejectionHandlerBuilder[**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html "Permalink")

### 

#### class RejectionHandlerBuilder extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

Source[RejectionHandler.scala](https://github.com/akka/akka-http/tree/v10.7.4/akka-http/src/main/scala/akka/http/javadsl/server/RejectionHandler.scala#L42)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#<init>(asScala:akka.http.scaladsl.server.RejectionHandler.Builder):akka.http.javadsl.server.RejectionHandlerBuilder "Permalink")  new RejectionHandlerBuilder(asScala: [Builder](../../scaladsl/server/RejectionHandler$$Builder.html))
### Value Members

1. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from RejectionHandlerBuilder toany2stringadd\[RejectionHandlerBuilder] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (RejectionHandlerBuilder, B)ImplicitThis member is added by an implicit conversion from RejectionHandlerBuilder toArrowAssoc\[RejectionHandlerBuilder] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#build:akka.http.javadsl.server.RejectionHandler "Permalink")  def build: [RejectionHandler](RejectionHandler.html)
8. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (RejectionHandlerBuilder) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): RejectionHandlerBuilderImplicitThis member is added by an implicit conversion from RejectionHandlerBuilder toEnsuring\[RejectionHandlerBuilder] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (RejectionHandlerBuilder) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): RejectionHandlerBuilderImplicitThis member is added by an implicit conversion from RejectionHandlerBuilder toEnsuring\[RejectionHandlerBuilder] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): RejectionHandlerBuilderImplicitThis member is added by an implicit conversion from RejectionHandlerBuilder toEnsuring\[RejectionHandlerBuilder] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): RejectionHandlerBuilderImplicitThis member is added by an implicit conversion from RejectionHandlerBuilder toEnsuring\[RejectionHandlerBuilder] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
15. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#handle[T<:akka.http.javadsl.server.Rejection](t:Class[T],handler:java.util.function.Function[T,akka.http.javadsl.server.Route]):akka.http.javadsl.server.RejectionHandlerBuilder "Permalink")  def handle\[T \<: [Rejection](Rejection.html)](t: Class\[T], handler: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T, [Route](Route.html)]): RejectionHandlerBuilderHandles a single [Rejection](Rejection.html) with the given function.
17. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#handleAll[T<:akka.http.javadsl.server.Rejection](t:Class[T],handler:java.util.function.Function[java.util.List[T],akka.http.javadsl.server.Route]):akka.http.javadsl.server.RejectionHandlerBuilder "Permalink")  def handleAll\[T \<: [Rejection](Rejection.html)](t: Class\[T], handler: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[[List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[T], [Route](Route.html)]): RejectionHandlerBuilderHandles several Rejections of the same type at the same time.
...
18. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#handleCircuitBreakerOpenRejection(handler:java.util.function.Function[akka.http.javadsl.server.CircuitBreakerOpenRejection,akka.http.javadsl.server.Route]):akka.http.javadsl.server.RejectionHandlerBuilder "Permalink")  def handleCircuitBreakerOpenRejection(handler: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[[CircuitBreakerOpenRejection](CircuitBreakerOpenRejection.html), [Route](Route.html)]): RejectionHandlerBuilderConvenience method for handling rejections created by created by the onCompleteWithBreaker directive.
...
Use to customise the error response being written instead of the default akka.http.javadsl.model.StatusCodes.SERVICE\_UNAVAILABLE response.
19. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#handleNotFound(route:akka.http.javadsl.server.Route):akka.http.javadsl.server.RejectionHandlerBuilder "Permalink")  def handleNotFound(route: [Route](Route.html)): RejectionHandlerBuilderHandles the special "not found" case using the given [Route](Route.html).
20. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
22. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
23. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
25. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
26. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
27. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
29. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from RejectionHandlerBuilder toStringFormat\[RejectionHandlerBuilder] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../../akka/http/javadsl/server/RejectionHandlerBuilder.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (RejectionHandlerBuilder, B)ImplicitThis member is added by an implicit conversion from RejectionHandlerBuilder toArrowAssoc\[RejectionHandlerBuilder] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromRejectionHandlerBuilder to any2stringadd\[RejectionHandlerBuilder]

### Inherited by implicit conversion StringFormat fromRejectionHandlerBuilder to StringFormat\[RejectionHandlerBuilder]

### Inherited by implicit conversion Ensuring fromRejectionHandlerBuilder to Ensuring\[RejectionHandlerBuilder]

### Inherited by implicit conversion ArrowAssoc fromRejectionHandlerBuilder to ArrowAssoc\[RejectionHandlerBuilder]
...
---
*Source: [https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/server/RejectionHandlerBuilder.html](https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/server/RejectionHandlerBuilder.html)*