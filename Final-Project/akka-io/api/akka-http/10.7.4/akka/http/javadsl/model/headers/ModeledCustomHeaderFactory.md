---
description: Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.ModeledCustomHeaderFactory
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:46:08Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html
title: Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.ModeledCustomHeaderFactory
---

# Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.ModeledCustomHeaderFactory

> **Summary:** Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.ModeledCustomHeaderFactory
...
# ModeledCustomHeaderFactory[**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html "Permalink")

### 

#### abstract  class ModeledCustomHeaderFactory\[H \<: [ModeledCustomHeader](ModeledCustomHeader.html)] extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

Companion class for the `[ModeledCustomHeader](ModeledCustomHeader.html)` class. It offers methods to create `[ModeledCustomHeader](ModeledCustomHeader.html)`
from `String` or `[HttpHeader](../HttpHeader.html)`.

Source[ModeledCustomHeaderFactory.java](https://github.com/akka/akka-http/tree/v10.7.4/akka-http-core/src/main/java/akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.java#L16)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ModeledCustomHeaderFactory
2. AnyRef
3. Any
Implicitly  
1. by any2stringadd
...
1. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#<init>():akka.http.javadsl.model.headers.ModeledCustomHeaderFactory[H] "Permalink")  new ModeledCustomHeaderFactory()
### Abstract Value Members

1. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#name():String "Permalink") abstract  def name(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)
2. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#parse(value:String):H "Permalink") abstract  def parse(value: [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)): HParses the value checking that the format is correct.
...
1. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ModeledCustomHeaderFactory\[H] toany2stringadd\[ModeledCustomHeaderFactory\[H]] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ModeledCustomHeaderFactory\[H], B)ImplicitThis member is added by an implicit conversion from ModeledCustomHeaderFactory\[H] toArrowAssoc\[ModeledCustomHeaderFactory\[H]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#create(value:String):H "Permalink")  def create(value: [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)): HCreates a new `ModeledCustomHeader` from the value checking that the format is correct.

Creates a new `ModeledCustomHeader` from the value checking that the format is correct.
It may throw if value is not correct
9. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ModeledCustomHeaderFactory\[H]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ModeledCustomHeaderFactory\[H]ImplicitThis member is added by an implicit conversion from ModeledCustomHeaderFactory\[H] toEnsuring\[ModeledCustomHeaderFactory\[H]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ModeledCustomHeaderFactory\[H]) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ModeledCustomHeaderFactory\[H]ImplicitThis member is added by an implicit conversion from ModeledCustomHeaderFactory\[H] toEnsuring\[ModeledCustomHeaderFactory\[H]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ModeledCustomHeaderFactory\[H]ImplicitThis member is added by an implicit conversion from ModeledCustomHeaderFactory\[H] toEnsuring\[ModeledCustomHeaderFactory\[H]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ModeledCustomHeaderFactory\[H]ImplicitThis member is added by an implicit conversion from ModeledCustomHeaderFactory\[H] toEnsuring\[ModeledCustomHeaderFactory\[H]] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
15. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#from(header:akka.http.javadsl.model.HttpHeader):java.util.Optional[H] "Permalink")  def from(header: [HttpHeader](../HttpHeader.html)): [Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[H]Transforms an `HttpHeader` to this `ModeledCustomHeader` if the name and value are correct.
...
16. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
19. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#lowercaseName():String "Permalink")  def lowercaseName(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)
20. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
21. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
23. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
24. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
25. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
27. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ModeledCustomHeaderFactory\[H] toStringFormat\[ModeledCustomHeaderFactory\[H]] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../../../akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ModeledCustomHeaderFactory\[H], B)ImplicitThis member is added by an implicit conversion from ModeledCustomHeaderFactory\[H] toArrowAssoc\[ModeledCustomHeaderFactory\[H]] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromModeledCustomHeaderFactory\[H] to any2stringadd\[ModeledCustomHeaderFactory\[H]]

### Inherited by implicit conversion StringFormat fromModeledCustomHeaderFactory\[H] to StringFormat\[ModeledCustomHeaderFactory\[H]]

### Inherited by implicit conversion Ensuring fromModeledCustomHeaderFactory\[H] to Ensuring\[ModeledCustomHeaderFactory\[H]]

### Inherited by implicit conversion ArrowAssoc fromModeledCustomHeaderFactory\[H] to ArrowAssoc\[ModeledCustomHeaderFactory\[H]]
...
---
*Source: [https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html](https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/model/headers/ModeledCustomHeaderFactory.html)*