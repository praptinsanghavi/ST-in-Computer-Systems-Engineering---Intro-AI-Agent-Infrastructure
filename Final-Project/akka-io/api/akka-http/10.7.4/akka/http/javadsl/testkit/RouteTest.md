---
description: Akka HTTP 10.7.4 - akka.http.javadsl.testkit.RouteTest
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:19:42Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/javadsl/testkit/RouteTest.html
title: Akka HTTP 10.7.4 - akka.http.javadsl.testkit.RouteTest
---

# Akka HTTP 10.7.4 - akka.http.javadsl.testkit.RouteTest

> **Summary:** Akka HTTP 10.7.4 - akka.http.javadsl.testkit.RouteTest
...
# RouteTest[**](../../../../akka/http/javadsl/testkit/RouteTest.html "Permalink")

### 

#### abstract  class RouteTest extends [AllDirectives](../server/AllDirectives.html) with [WSTestRequestBuilding](WSTestRequestBuilding.html)
...
1. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#<init>():akka.http.javadsl.testkit.RouteTest "Permalink")  new RouteTest()
### Abstract Value Members

1. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#createTestRouteResultAsync(request:akka.http.javadsl.model.HttpRequest,result:scala.concurrent.Future[akka.http.javadsl.server.RouteResult]):akka.http.javadsl.testkit.TestRouteResult "Permalink") abstract  def createTestRouteResultAsync(request: [HttpRequest](../model/HttpRequest.html), result: [Future](https://www.scala-lang.org/api/2.13.17/scala/concurrent/Future.html#scala.concurrent.Future)\[[RouteResult](../server/RouteResult.html)]): [TestRouteResult](TestRouteResult.html)Attributesprotected
2. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#materializer:akka.stream.Materializer "Permalink") implicit abstract  def materializer: [Materializer](https://doc.akka.io/api/akka-core/2.10.11/akka/stream/Materializer.html#akka.stream.Materializer)
3. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#system:akka.actor.ActorSystem "Permalink") implicit abstract  def system: [ActorSystem](https://doc.akka.io/api/akka-core/2.10.11/akka/actor/ActorSystem.html#akka.actor.ActorSystem)
### Concrete Value Members

1. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../akka/http/javadsl/testkit/RouteTest.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from RouteTest toany2stringadd\[RouteTest] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (RouteTest, B)ImplicitThis member is added by an implicit conversion from RouteTest toArrowAssoc\[RouteTest] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#WS[T](uri:akka.http.javadsl.model.Uri,clientSideHandler:akka.stream.javadsl.Flow[akka.http.javadsl.model.ws.Message,akka.http.javadsl.model.ws.Message,T],materializer:akka.stream.Materializer,subprotocols:java.util.List[String]):akka.http.javadsl.model.HttpRequest "Permalink")  def WS\[T](uri: [Uri](../model/Uri.html), clientSideHandler: [Flow](https://doc.akka.io/api/akka-core/2.10.11/akka/stream/javadsl/Flow.html#akka.stream.javadsl.Flow)\[[Message](../model/ws/Message.html), [Message](../model/ws/Message.html), T], materializer: [Materializer](https://doc.akka.io/api/akka-core/2.10.11/akka/stream/Materializer.html#akka.stream.Materializer), subprotocols: [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[String]): [HttpRequest](../model/HttpRequest.html)Definition Classes[WSTestRequestBuilding](WSTestRequestBuilding.html)
7. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#WS[T](uri:akka.http.javadsl.model.Uri,clientSideHandler:akka.stream.javadsl.Flow[akka.http.javadsl.model.ws.Message,akka.http.javadsl.model.ws.Message,T],materializer:akka.stream.Materializer):akka.http.javadsl.model.HttpRequest "Permalink")  def WS\[T](uri: [Uri](../model/Uri.html), clientSideHandler: [Flow](https://doc.akka.io/api/akka-core/2.10.11/akka/stream/javadsl/Flow.html#akka.stream.javadsl.Flow)\[[Message](../model/ws/Message.html), [Message](../model/ws/Message.html), T], materializer: [Materializer](https://doc.akka.io/api/akka-core/2.10.11/akka/stream/Materializer.html#akka.stream.Materializer)): [HttpRequest](../model/HttpRequest.html)Definition Classes[WSTestRequestBuilding](WSTestRequestBuilding.html)
8. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
9. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#attribute[T](key:akka.http.javadsl.model.AttributeKey[T],inner:java.util.function.Function[T,akka.http.javadsl.server.Route]):akka.http.javadsl.server.directives.RouteAdapter "Permalink")  def attribute\[T](key: [AttributeKey](../model/AttributeKey.html)\[T], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T, [Route](../server/Route.html)]): [RouteAdapter](../server/directives/RouteAdapter.html)Extracts the value of the request attribute with the given key.
...
Definition Classes[SecurityDirectives](../server/directives/SecurityDirectives.html)
17. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#authenticateOAuth2Async[T](realm:String,authenticator:java.util.function.Function[java.util.Optional[akka.http.javadsl.server.directives.SecurityDirectives.ProvidedCredentials],java.util.concurrent.CompletionStage[java.util.Optional[T]]],inner:java.util.function.Function[T,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def authenticateOAuth2Async\[T](realm: String, authenticator: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[[Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[[ProvidedCredentials](../server/directives/SecurityDirectives$$ProvidedCredentials.html)], [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[[Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[T]]], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T, [Route](../server/Route.html)]): [Route](../server/Route.html)A directive that wraps the inner route with OAuth2 Bearer Token authentication support.
...
Definition Classes[SecurityDirectives](../server/directives/SecurityDirectives.html)Annotations@[CorrespondsTo](../server/directives/CorrespondsTo.html)()
19. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#authenticateOAuth2Optional[T](realm:String,authenticator:java.util.function.Function[java.util.Optional[akka.http.javadsl.server.directives.SecurityDirectives.ProvidedCredentials],java.util.Optional[T]],inner:java.util.function.Function[java.util.Optional[T],akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def authenticateOAuth2Optional\[T](realm: String, authenticator: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[[Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[[ProvidedCredentials](../server/directives/SecurityDirectives$$ProvidedCredentials.html)], [Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[T]], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[[Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[T], [Route](../server/Route.html)]): [Route](../server/Route.html)A directive that wraps the inner route with OAuth2 Bearer Token authentication support.
...
31. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
32. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#complete(entity:akka.http.javadsl.model.RequestEntity):akka.http.javadsl.server.directives.RouteAdapter "Permalink")  def complete(entity: [RequestEntity](../model/RequestEntity.html)): [RouteAdapter](../server/directives/RouteAdapter.html)Completes the request as HTTP 200 OK with the given value as response entity.
...
Definition Classes[CacheConditionDirectives](../server/directives/CacheConditionDirectives.html)
67. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#conditional(lastModified:akka.http.javadsl.model.DateTime,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def conditional(lastModified: [DateTime](../model/DateTime.html), inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Wraps its inner route with support for Conditional Requests as defined
by http://tools.ietf.org/html/rfc7232
...
Definition Classes[CacheConditionDirectives](../server/directives/CacheConditionDirectives.html)
68. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#conditional(eTag:akka.http.javadsl.model.headers.EntityTag,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def conditional(eTag: [EntityTag](../model/headers/EntityTag.html), inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Wraps its inner route with support for Conditional Requests as defined
by http://tools.ietf.org/html/rfc7232
...
Definition Classes[CodingDirectives](../server/directives/CodingDirectives.html)
76. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#defaultAwaitDuration:scala.concurrent.duration.FiniteDuration "Permalink")  def defaultAwaitDuration: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)Attributesprotected
77. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#defaultContentTypeResolver:akka.http.javadsl.server.directives.ContentTypeResolver "Permalink")  def defaultContentTypeResolver: [ContentTypeResolver](../server/directives/ContentTypeResolver.html)Default ContentTypeResolver.

Default ContentTypeResolver.

Definition Classes[FileAndResourceDirectives](../server/directives/FileAndResourceDirectives.html)
78. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#defaultDirectoryRenderer:akka.http.javadsl.server.directives.DirectoryRenderer "Permalink")  def defaultDirectoryRenderer: [DirectoryRenderer](../server/directives/DirectoryRenderer.html)Default DirectoryRenderer to be used with directory listing directives.

Default DirectoryRenderer to be used with directory listing directives.

Definition Classes[FileAndResourceDirectives](../server/directives/FileAndResourceDirectives.html)
79. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#defaultHostInfo:akka.http.javadsl.testkit.DefaultHostInfo "Permalink")  def defaultHostInfo: [DefaultHostInfo](DefaultHostInfo.html)Attributesprotected
80. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#delete(inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def delete(inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[MethodDirectives](../server/directives/MethodDirectives.html)
81. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#deleteCookie(name:String,domain:String,path:String,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def deleteCookie(name: String, domain: String, path: String, inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Adds a Set\-Cookie response header expiring the cookie with the given properties.
...
Definition Classes[CookieDirectives](../server/directives/CookieDirectives.html)
82. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#deleteCookie(name:String,domain:String,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def deleteCookie(name: String, domain: String, inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Adds a Set\-Cookie response header expiring the cookie with the given properties.
...
Definition Classes[CookieDirectives](../server/directives/CookieDirectives.html)
83. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#deleteCookie(name:String,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def deleteCookie(name: String, inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Adds a Set\-Cookie response header expiring the cookie with the given properties.
...
Definition Classes[CodingDirectives](../server/directives/CodingDirectives.html)
87. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#encodeResponseWith(coders:Iterable[akka.http.javadsl.coding.Coder],inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def encodeResponseWith(coders: [Iterable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Iterable.html#java.lang.Iterable)\[[Coder](../coding/Coder.html)], inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Encodes the response with the encoding that is requested by the client via the `Accept-
Encoding` header.
...
Definition Classes[WebSocketDirectives](../server/directives/WebSocketDirectives.html)
124. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#failWith(error:Throwable):akka.http.javadsl.server.Route "Permalink")  def failWith(error: Throwable): [Route](../server/Route.html)Bubbles the given error up the response chain, where it is dealt with by the closest `handleExceptions`
...
Definition Classes[FileAndResourceDirectives](../server/directives/FileAndResourceDirectives.html)
147. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#getFromDirectory(directoryPath:String):akka.http.javadsl.server.Route "Permalink")  def getFromDirectory(directoryPath: String): [Route](../server/Route.html)Completes GET requests with the content of a file underneath the given directory, using the default content\-type resolver.

Completes GET requests with the content of a file underneath the given directory, using the default content\-type resolver.
If the file cannot be read the Route rejects the request.

Definition Classes[FileAndResourceDirectives](../server/directives/FileAndResourceDirectives.html)
148. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#getFromFile(file:String,resolver:akka.http.javadsl.server.directives.ContentTypeResolver):akka.http.javadsl.server.Route "Permalink")  def getFromFile(file: String, resolver: [ContentTypeResolver](../server/directives/ContentTypeResolver.html)): [Route](../server/Route.html)Completes GET requests with the content of the given file, resolving the content type using the given resolver.
...
Definition Classes[FileAndResourceDirectives](../server/directives/FileAndResourceDirectives.html)
156. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#getFromResource(path:String):akka.http.javadsl.server.Route "Permalink")  def getFromResource(path: String): [Route](../server/Route.html)Completes GET requests with the content of the given resource loaded from the default ClassLoader,
...
Definition Classes[ExecutionDirectives](../server/directives/ExecutionDirectives.html)
164. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#handleSync(handler:akka.japi.function.Function[akka.http.javadsl.model.HttpRequest,akka.http.javadsl.model.HttpResponse]):akka.http.javadsl.server.Route "Permalink")  def handleSync(handler: [Function](https://doc.akka.io/api/akka-core/2.10.11/akka/japi/function/Function.html#akka.japi.function.Function)\[[HttpRequest](../model/HttpRequest.html), [HttpResponse](../model/HttpResponse.html)]): [Route](../server/Route.html)Handle the request using a function.

Handle the request using a function.

Definition Classes[RouteDirectives](../server/directives/RouteDirectives.html)
165. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#handleWebSocketMessages[T](handler:akka.stream.javadsl.Flow[akka.http.javadsl.model.ws.Message,akka.http.javadsl.model.ws.Message,T]):akka.http.javadsl.server.Route "Permalink")  def handleWebSocketMessages\[T](handler: [Flow](https://doc.akka.io/api/akka-core/2.10.11/akka/stream/javadsl/Flow.html#akka.stream.javadsl.Flow)\[[Message](../model/ws/Message.html), [Message](../model/ws/Message.html), T]): [Route](../server/Route.html)Handles WebSocket requests with the given handler and rejects other requests with an
...
Definition Classes[WebSocketDirectives](../server/directives/WebSocketDirectives.html)
168. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#handleWith[T,R](unmarshaller:akka.http.javadsl.unmarshalling.Unmarshaller[_>:akka.http.javadsl.model.HttpEntity,T],marshaller:akka.http.javadsl.marshalling.Marshaller[R,_<:akka.http.javadsl.model.HttpResponse],inner:java.util.function.Function[T,R]):akka.http.javadsl.server.Route "Permalink")  def handleWith\[T, R](unmarshaller: [Unmarshaller](../unmarshalling/Unmarshaller.html)\[\_ \>: [HttpEntity](../model/HttpEntity.html), T], marshaller: [Marshaller](../marshalling/Marshaller.html)\[R, \_ \<: [HttpResponse](../model/HttpResponse.html)], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T, R]): [Route](../server/Route.html)Completes the request using the given function.
...
180. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
181. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#listDirectoryContents(directoryRenderer:akka.http.javadsl.server.directives.DirectoryRenderer,directories:String*):akka.http.javadsl.server.Route "Permalink")  def listDirectoryContents(directoryRenderer: [DirectoryRenderer](../server/directives/DirectoryRenderer.html), directories: String\*): [Route](../server/Route.html)Completes GET requests with a unified listing of the contents of all given directories.

Completes GET requests with a unified listing of the contents of all given directories.
The actual rendering of the directory contents is performed by the in\-scope `Marshaller[DirectoryListing]`.

Definition Classes[FileAndResourceDirectives](../server/directives/FileAndResourceDirectives.html)Annotations@varargs()
182. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#listDirectoryContents(directories:String*):akka.http.javadsl.server.Route "Permalink")  def listDirectoryContents(directories: String\*): [Route](../server/Route.html)Completes GET requests with a unified listing of the contents of all given directories.

Completes GET requests with a unified listing of the contents of all given directories.
The actual rendering of the directory contents is performed by the in\-scope `Marshaller[DirectoryListing]`.

Definition Classes[FileAndResourceDirectives](../server/directives/FileAndResourceDirectives.html)Annotations@varargs()
183. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#logRequest(show:java.util.function.Function[akka.http.javadsl.model.HttpRequest,akka.http.javadsl.server.directives.LogEntry],inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def logRequest(show: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[[HttpRequest](../model/HttpRequest.html), [LogEntry](../server/directives/LogEntry.html)], inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Produces a log entry for every incoming request.
...
184. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#logRequest(marker:String,level:akka.event.Logging.LogLevel,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def logRequest(marker: String, level: LogLevel, inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Produces a log entry for every incoming request.
...
Definition Classes[FutureDirectives](../server/directives/FutureDirectives.html)
210. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#onComplete[T](f:java.util.function.Supplier[java.util.concurrent.CompletionStage[T]],inner:java.util.function.Function[scala.util.Try[T],akka.http.javadsl.server.Route]):akka.http.javadsl.server.directives.RouteAdapter "Permalink")  def onComplete\[T](f: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[T]], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[[Try](https://www.scala-lang.org/api/2.13.17/scala/util/Try.html#scala.util.Try)\[T], [Route](../server/Route.html)]): [RouteAdapter](../server/directives/RouteAdapter.html)"Unwraps" a `CompletionStage<T>` and runs the inner route after future
completion with the future's value as an extraction of type `Try<T>`.
...
Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
243. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#pathPrefix[T](t:akka.http.javadsl.unmarshalling.Unmarshaller[String,T],inner:java.util.function.Function[T,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathPrefix\[T](t: [Unmarshaller](../unmarshalling/Unmarshaller.html)\[String, T], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T, [Route](../server/Route.html)]): [Route](../server/Route.html)Consumes a leading slash and extracts the next path segment, unmarshalling it and passing the result to the inner function.

Consumes a leading slash and extracts the next path segment, unmarshalling it and passing the result to the inner function.

Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
244. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#pathPrefix[T1,T2](p:akka.http.javadsl.server.PathMatcher2[T1,T2],inner:java.util.function.BiFunction[T1,T2,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathPrefix\[T1, T2](p: [PathMatcher2](../server/PathMatcher2.html)\[T1, T2], inner: [BiFunction](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/BiFunction.html#java.util.function.BiFunction)\[T1, T2, [Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
245. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#pathPrefix[T](p:akka.http.javadsl.server.PathMatcher1[T],inner:java.util.function.Function[T,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathPrefix\[T](p: [PathMatcher1](../server/PathMatcher1.html)\[T], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T, [Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
246. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#pathPrefix(p:akka.http.javadsl.server.PathMatcher0,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathPrefix(p: [PathMatcher0](../server/PathMatcher0.html), inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Applies the given PathMatcher0 to the remaining unmatched path after consuming a leading slash.
...
Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
247. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#pathPrefix(inner:java.util.function.Function[String,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathPrefix(inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[String, [Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
248. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#pathPrefix(segment:String,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathPrefix(segment: String, inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Matches a prefix to the remaining unmatched path after consuming a leading slash.
...
Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
258. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#pathSuffixTest[T1,T2](pm:akka.http.javadsl.server.PathMatcher2[T1,T2],inner:java.util.function.BiFunction[T1,T2,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathSuffixTest\[T1, T2](pm: [PathMatcher2](../server/PathMatcher2.html)\[T1, T2], inner: [BiFunction](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/BiFunction.html#java.util.function.BiFunction)\[T1, T2, [Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
259. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#pathSuffixTest[T1](pm:akka.http.javadsl.server.PathMatcher1[T1],inner:java.util.function.Function[T1,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathSuffixTest\[T1](pm: [PathMatcher1](../server/PathMatcher1.html)\[T1], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T1, [Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
260. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#pathSuffixTest(pm:akka.http.javadsl.server.PathMatcher0,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathSuffixTest(pm: [PathMatcher0](../server/PathMatcher0.html), inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
261. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#pathSuffixTest(segment:String,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def pathSuffixTest(segment: String, inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Checks whether the unmatchedPath of the [akka.http.javadsl.server.RequestContext](../server/RequestContext.html) has a suffix matched by the
given PathMatcher.
...
Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
269. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#rawPathPrefixTest[T1,T2](pm:akka.http.javadsl.server.PathMatcher2[T1,T2],inner:java.util.function.BiFunction[T1,T2,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def rawPathPrefixTest\[T1, T2](pm: [PathMatcher2](../server/PathMatcher2.html)\[T1, T2], inner: [BiFunction](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/BiFunction.html#java.util.function.BiFunction)\[T1, T2, [Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
270. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#rawPathPrefixTest[T1](pm:akka.http.javadsl.server.PathMatcher1[T1],inner:java.util.function.Function[T1,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def rawPathPrefixTest\[T1](pm: [PathMatcher1](../server/PathMatcher1.html)\[T1], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T1, [Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
271. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#rawPathPrefixTest(pm:akka.http.javadsl.server.PathMatcher0,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def rawPathPrefixTest(pm: [PathMatcher0](../server/PathMatcher0.html), inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
272. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#rawPathPrefixTest(segment:String,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def rawPathPrefixTest(segment: String, inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Checks whether the unmatchedPath of the [akka.http.javadsl.server.RequestContext](../server/RequestContext.html) has a prefix matched by the
given PathMatcher.
...
Definition Classes[PathDirectives](../server/directives/PathDirectives.html)
278. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#reject():akka.http.javadsl.server.Route "Permalink")  def reject(): [Route](../server/Route.html)Rejects the request with an empty rejection (usually used for "no directive matched").

Rejects the request with an empty rejection (usually used for "no directive matched").

Definition Classes[RouteDirectives](../server/directives/RouteDirectives.html)
279. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#reject(rejection:akka.http.javadsl.server.Rejection,rejections:akka.http.javadsl.server.Rejection*):akka.http.javadsl.server.Route "Permalink")  def reject(rejection: [Rejection](../server/Rejection.html), rejections: [Rejection](../server/Rejection.html)\*): [Route](../server/Route.html)Rejects the request with the given rejections, or with an empty set of rejections if no rejections are given.

Rejects the request with the given rejections, or with an empty set of rejections if no rejections are given.

Definition Classes[RouteDirectives](../server/directives/RouteDirectives.html)Annotations@varargs()
280. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#rejectEmptyResponse(inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def rejectEmptyResponse(inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Converts responses with an empty entity into (empty) rejections.
...
Definition Classes[MiscDirectives](../server/directives/MiscDirectives.html)
281. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#request[T](unmarshaller:akka.http.javadsl.unmarshalling.Unmarshaller[_>:akka.http.javadsl.model.HttpRequest,T],inner:java.util.function.Function[T,akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def request\[T](unmarshaller: [Unmarshaller](../unmarshalling/Unmarshaller.html)\[\_ \>: [HttpRequest](../model/HttpRequest.html), T], inner: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[T, [Route](../server/Route.html)]): [Route](../server/Route.html)Unmarshalls the request using the given unmarshaller, and passes the result to \[inner].
...
Definition Classes[MiscDirectives](../server/directives/MiscDirectives.html)
308. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
309. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
310. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
311. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#withExecutionContext(ec:scala.concurrent.ExecutionContextExecutor,inner:java.util.function.Supplier[akka.http.javadsl.server.Route]):akka.http.javadsl.server.Route "Permalink")  def withExecutionContext(ec: [ExecutionContextExecutor](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContextExecutor.html#scala.concurrent.ExecutionContextExecutor), inner: [Supplier](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Supplier.html#java.util.function.Supplier)\[[Route](../server/Route.html)]): [Route](../server/Route.html)Runs its inner route with the given alternative [scala.concurrent.ExecutionContextExecutor](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContextExecutor.html).
...
2. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
3. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from RouteTest toStringFormat\[RouteTest] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
4. [**](../../../../akka/http/javadsl/testkit/RouteTest.html#route(alternatives:akka.http.javadsl.server.Route*):akka.http.javadsl.server.Route "Permalink")  def route(alternatives: [Route](../server/Route.html)\*): [Route](../server/Route.html)Java\-specific call added so you can chain together multiple alternate routes using comma,
rather than having to explicitly call route1\.orElse(route2\).orElse(route3\).
...
---
*Source: [https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/testkit/RouteTest.html](https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/testkit/RouteTest.html)*