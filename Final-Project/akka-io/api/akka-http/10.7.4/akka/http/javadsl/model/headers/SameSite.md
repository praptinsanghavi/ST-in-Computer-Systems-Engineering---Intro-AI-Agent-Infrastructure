---
description: Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.SameSite
knowledge_type: official_documentation
scraped_at: '2026-04-05T23:21:46Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/javadsl/model/headers/SameSite.html
title: Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.SameSite
---

# Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.SameSite

> **Summary:** Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.SameSite
...
# SameSite[**](../../../../../akka/http/javadsl/model/headers/SameSite.html "Permalink")

### 

#### sealed final  class SameSite extends [Enum](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Enum.html#java.lang.Enum)\[SameSite]
...
Source[SameSite.java](https://github.com/akka/akka-http/tree/v10.7.4/akka-http-core/src/main/java/akka/http/javadsl/model/headers/SameSite.java#L11)Linear Supertypes[Enum](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Enum.html#java.lang.Enum)\[SameSite], [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [Comparable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Comparable.html#java.lang.Comparable)\[SameSite], [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. SameSite
2. Enum
...
1. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#<init>():akka.http.javadsl.model.headers.SameSite "Permalink")  new SameSite()
### Value Members

1. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from SameSite toany2stringadd\[SameSite] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (SameSite, B)ImplicitThis member is added by an implicit conversion from SameSite toArrowAssoc\[SameSite] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#asScala():akka.http.scaladsl.model.headers.SameSite "Permalink")  def asScala(): [scaladsl.model.headers.SameSite](../../../scaladsl/model/headers/SameSite.html)
8. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#clone():Object "Permalink") final  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesEnum → AnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException])
9. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#compareTo(x$1:E):Int "Permalink") final  def compareTo(arg0: SameSite): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesEnum → Comparable
10. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (SameSite) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SameSiteImplicitThis member is added by an implicit conversion from SameSite toEnsuring\[SameSite] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (SameSite) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SameSiteImplicitThis member is added by an implicit conversion from SameSite toEnsuring\[SameSite] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): SameSiteImplicitThis member is added by an implicit conversion from SameSite toEnsuring\[SameSite] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): SameSiteImplicitThis member is added by an implicit conversion from SameSite toEnsuring\[SameSite] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#equals(x$1:Object):Boolean "Permalink") final  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesEnum → AnyRef → Any
16. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#finalize():Unit "Permalink") final  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesEnum → AnyRef
17. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#getDeclaringClass():Class[E] "Permalink") final  def getDeclaringClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[SameSite]Definition ClassesEnum
19. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#hashCode():Int "Permalink") final  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesEnum → AnyRef → Any
20. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
21. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#name():String "Permalink") final  def name(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesEnum
22. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
23. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
24. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
25. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#ordinal():Int "Permalink") final  def ordinal(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesEnum
26. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
27. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesEnum → AnyRef → Any
28. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
29. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
30. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from SameSite toStringFormat\[SameSite] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
2. [**](../../../../../akka/http/javadsl/model/headers/SameSite.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (SameSite, B)ImplicitThis member is added by an implicit conversion from SameSite toArrowAssoc\[SameSite] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [Enum](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Enum.html#java.lang.Enum)\[SameSite]

### Inherited from [Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)

### Inherited from [Comparable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Comparable.html#java.lang.Comparable)\[SameSite]

### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromSameSite to any2stringadd\[SameSite]

### Inherited by implicit conversion StringFormat fromSameSite to StringFormat\[SameSite]

### Inherited by implicit conversion Ensuring fromSameSite to Ensuring\[SameSite]

### Inherited by implicit conversion ArrowAssoc fromSameSite to ArrowAssoc\[SameSite]
...
---
*Source: [https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/model/headers/SameSite.html](https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/model/headers/SameSite.html)*