---
description: Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.CacheDirective
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:43:28Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/javadsl/model/headers/CacheDirective.html
title: Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.CacheDirective
---

# Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.CacheDirective

> **Summary:** Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.CacheDirective
...
t[akka](../../../../index.html).[http](../../../index.html).[javadsl](../../index.html).[model](../index.html).[headers](index.html)

# CacheDirective[**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html "Permalink")

### 

#### trait CacheDirective extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

Source[CacheDirective.java](https://github.com/akka/akka-http/tree/v10.7.4/akka-http-core/src/main/java/akka/http/javadsl/model/headers/CacheDirective.java#L8)See alsoCacheDirectives for convenience access to often used values.

Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[CacheDirective](../../../scaladsl/model/headers/CacheDirective.html), [CustomCacheDirective](../../../scaladsl/model/headers/CacheDirective$$CustomCacheDirective.html), [RequestDirective](../../../scaladsl/model/headers/CacheDirective$$RequestDirective.html), [ResponseDirective](../../../scaladsl/model/headers/CacheDirective$$ResponseDirective.html), [immutableDirective](../../../scaladsl/model/headers/CacheDirectives$$immutableDirective$.html), [max\-age](../../../scaladsl/model/headers/CacheDirectives$$max$minusage.html), [max\-stale](../../../scaladsl/model/headers/CacheDirectives$$max$minusstale.html), [min\-fresh](../../../scaladsl/model/headers/CacheDirectives$$min$minusfresh.html), [must\-revalidate](../../../scaladsl/model/headers/CacheDirectives$$must$minusrevalidate$.html), [no\-cache](../../../scaladsl/model/headers/CacheDirectives$$no$minuscache.html), [no\-cache](../../../scaladsl/model/headers/CacheDirectives$$no$minuscache$.html), [no\-store](../../../scaladsl/model/headers/CacheDirectives$$no$minusstore$.html), [no\-transform](../../../scaladsl/model/headers/CacheDirectives$$no$minustransform$.html), [only\-if\-cached](../../../scaladsl/model/headers/CacheDirectives$$only$minusif$minuscached$.html), [private](../../../scaladsl/model/headers/CacheDirectives$$private.html), [proxy\-revalidate](../../../scaladsl/model/headers/CacheDirectives$$proxy$minusrevalidate$.html), [public](../../../scaladsl/model/headers/CacheDirectives$$public$.html), [s\-maxage](../../../scaladsl/model/headers/CacheDirectives$$s$minusmaxage.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. CacheDirective
2. AnyRef
...
1. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#value():String "Permalink") abstract  def value(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)
### Concrete Value Members

1. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from CacheDirective toany2stringadd\[CacheDirective] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (CacheDirective, B)ImplicitThis member is added by an implicit conversion from CacheDirective toArrowAssoc\[CacheDirective] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (CacheDirective) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): CacheDirectiveImplicitThis member is added by an implicit conversion from CacheDirective toEnsuring\[CacheDirective] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (CacheDirective) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): CacheDirectiveImplicitThis member is added by an implicit conversion from CacheDirective toEnsuring\[CacheDirective] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): CacheDirectiveImplicitThis member is added by an implicit conversion from CacheDirective toEnsuring\[CacheDirective] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): CacheDirectiveImplicitThis member is added by an implicit conversion from CacheDirective toEnsuring\[CacheDirective] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from CacheDirective toStringFormat\[CacheDirective] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../../../akka/http/javadsl/model/headers/CacheDirective.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (CacheDirective, B)ImplicitThis member is added by an implicit conversion from CacheDirective toArrowAssoc\[CacheDirective] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromCacheDirective to any2stringadd\[CacheDirective]

### Inherited by implicit conversion StringFormat fromCacheDirective to StringFormat\[CacheDirective]

### Inherited by implicit conversion Ensuring fromCacheDirective to Ensuring\[CacheDirective]

### Inherited by implicit conversion ArrowAssoc fromCacheDirective to ArrowAssoc\[CacheDirective]
...
---
*Source: [https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/model/headers/CacheDirective.html](https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/model/headers/CacheDirective.html)*