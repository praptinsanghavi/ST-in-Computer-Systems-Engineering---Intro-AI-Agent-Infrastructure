---
description: Akka HTTP 10.7.4 - akka.http.javadsl.server.PathMatchers
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:16:13Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/javadsl/server/PathMatchers$.html
title: Akka HTTP 10.7.4 - akka.http.javadsl.server.PathMatchers
---

# Akka HTTP 10.7.4 - akka.http.javadsl.server.PathMatchers

> **Summary:** Akka HTTP 10.7.4 - akka.http.javadsl.server.PathMatchers
...
[o](PathMatchers.html "See companion class")[akka](../../../index.html).[http](../../index.html).[javadsl](../index.html).[server](index.html)

# [PathMatchers](PathMatchers.html "See companion class")[**](../../../../akka/http/javadsl/server/PathMatchers$.html "Permalink")

### Companion [class PathMatchers](PathMatchers.html "See companion class")

#### object PathMatchers

Source[PathMatchers.scala](https://github.com/akka/akka-http/tree/v10.7.4/akka-http/src/main/scala/akka/http/javadsl/server/PathMatchers.scala#L20)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. PathMatchers
2. AnyRef
...
1. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../akka/http/javadsl/server/PathMatchers$.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#doubleSegment:akka.http.javadsl.server.PathMatcher1[Double] "Permalink")  def doubleSegment: [PathMatcher1](PathMatcher1.html)\[[Double](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Double.html#java.lang.Double)]A PathMatcher that matches and extracts a Double value.
...
7. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
8. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
9. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
10. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
11. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#hexIntegerSegment:akka.http.javadsl.server.PathMatcher1[Integer] "Permalink")  def hexIntegerSegment: [PathMatcher1](PathMatcher1.html)\[[Integer](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Integer.html#java.lang.Integer)]A PathMatcher that efficiently matches a number of hex\-digits and extracts their (non\-negative) Int value.
...
than Int.MaxValue.
12. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#hexLongSegment:akka.http.javadsl.server.PathMatcher1[Long] "Permalink")  def hexLongSegment: [PathMatcher1](PathMatcher1.html)\[[Long](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Long.html#java.lang.Long)]A PathMatcher that efficiently matches a number of hex\-digits and extracts their (non\-negative) Long value.

A PathMatcher that efficiently matches a number of hex\-digits and extracts their (non\-negative) Long value.
The matcher will not match 0 digits or a sequence of digits that would represent an Long value larger
than Long.MaxValue.
13. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#integerSegment:akka.http.javadsl.server.PathMatcher1[Integer] "Permalink")  def integerSegment: [PathMatcher1](PathMatcher1.html)\[[Integer](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Integer.html#java.lang.Integer)]A PathMatcher that efficiently matches a number of digits and extracts their (non\-negative) Int value.

A PathMatcher that efficiently matches a number of digits and extracts their (non\-negative) Int value.
The matcher will not match 0 digits or a sequence of digits that would represent an Int value larger
than Int.MaxValue.
14. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
15. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#longSegment:akka.http.javadsl.server.PathMatcher1[Long] "Permalink")  def longSegment: [PathMatcher1](PathMatcher1.html)\[[Long](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Long.html#java.lang.Long)]A PathMatcher that efficiently matches a number of digits and extracts their (non\-negative) Long value.

A PathMatcher that efficiently matches a number of digits and extracts their (non\-negative) Long value.
The matcher will not match 0 digits or a sequence of digits that would represent an Long value larger
than Long.MaxValue.
16. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
17. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#neutral:akka.http.javadsl.server.PathMatcher0 "Permalink")  def neutral: [PathMatcher0](PathMatcher0.html)A PathMatcher that always matches, doesn't consume anything and extracts nothing.

A PathMatcher that always matches, doesn't consume anything and extracts nothing.
Serves mainly as a neutral element in PathMatcher composition.
18. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#pathEnd:akka.http.javadsl.server.PathMatcher0 "Permalink")  def pathEnd: [PathMatcher0](PathMatcher0.html)A PathMatcher that matches the very end of the requests URI path.
21. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#remaining:akka.http.javadsl.server.PathMatcher1[String] "Permalink")  def remaining: [PathMatcher1](PathMatcher1.html)\[String]A PathMatcher that matches and extracts the complete remaining,
unmatched part of the request's URI path as an (encoded!) String.
22. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#remainingPath:akka.http.javadsl.server.PathMatcher1[akka.http.scaladsl.model.Uri.Path] "Permalink")  def remainingPath: [PathMatcher1](PathMatcher1.html)\[[Path](../../scaladsl/model/Uri$$Path.html)]A PathMatcher that matches and extracts the complete remaining,
unmatched part of the request's URI path.
23. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#segment:akka.http.javadsl.server.PathMatcher1[String] "Permalink")  def segment: [PathMatcher1](PathMatcher1.html)\[String]A PathMatcher that matches if the unmatched path starts with a path segment.
...
24. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#segment(regex:java.util.regex.Pattern):akka.http.javadsl.server.PathMatcher1[String] "Permalink")  def segment(regex: [Pattern](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/regex/Pattern.html#java.util.regex.Pattern)): [PathMatcher1](PathMatcher1.html)\[String]Creates a PathMatcher that consumes (a prefix of) the first path segment
...
25. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#segment(segment:String):akka.http.javadsl.server.PathMatcher0 "Permalink")  def segment(segment: String): [PathMatcher0](PathMatcher0.html)Creates a PathMatcher that consumes (a prefix of) the first path segment
(if the path begins with a segment).
26. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#segments:akka.http.javadsl.server.PathMatcher1[java.util.List[String]] "Permalink")  def segments: [PathMatcher1](PathMatcher1.html)\[[List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[String]]A PathMatcher that matches up to 128 remaining segments as a List\[String].
...
27. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#segments(count:Int):akka.http.javadsl.server.PathMatcher1[java.util.List[String]] "Permalink")  def segments(count: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [PathMatcher1](PathMatcher1.html)\[[List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[String]]A PathMatcher that matches the given number of path segments (separated by slashes) as a List\[String].
...
If the path has a trailing slash this slash will \*not\* be matched.
28. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#segments(min:Int,max:Int):akka.http.javadsl.server.PathMatcher1[java.util.List[String]] "Permalink")  def segments(min: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int), max: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [PathMatcher1](PathMatcher1.html)\[[List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[String]]A PathMatcher that matches between `min` and `max` (both inclusively) path segments (separated by slashes)
as a List\[String].
...
If the path has a trailing slash this slash will \*not\* be matched.
29. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#separateOnSlashes(segments:String):akka.http.javadsl.server.PathMatcher0 "Permalink")  def separateOnSlashes(segments: String): [PathMatcher0](PathMatcher0.html)Converts a path string containing slashes into a PathMatcher that interprets slashes as
path segment separators.
30. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#slash():akka.http.javadsl.server.PathMatcher0 "Permalink")  def slash(): [PathMatcher0](PathMatcher0.html)A PathMatcher that matches a single slash character ('/').
31. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
32. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
33. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#uuidSegment:akka.http.javadsl.server.PathMatcher1[java.util.UUID] "Permalink")  def uuidSegment: [PathMatcher1](PathMatcher1.html)\[[UUID](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/UUID.html#java.util.UUID)]A PathMatcher that matches and extracts a java.util.UUID instance.
34. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
35. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
36. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../akka/http/javadsl/server/PathMatchers$.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/server/PathMatchers$.html](https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/server/PathMatchers$.html)*