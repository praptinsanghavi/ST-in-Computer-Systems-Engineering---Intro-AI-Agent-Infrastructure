---
description: Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.OAuth2BearerToken
knowledge_type: official_documentation
scraped_at: '2026-04-05T23:22:27Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/javadsl/model/headers/OAuth2BearerToken.html
title: Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.OAuth2BearerToken
---

# Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.OAuth2BearerToken

> **Summary:** Akka HTTP 10.7.4 - akka.http.javadsl.model.headers.OAuth2BearerToken
...
# OAuth2BearerToken[**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html "Permalink")

### 

#### abstract  class OAuth2BearerToken extends [scaladsl.model.headers.HttpCredentials](../../../scaladsl/model/headers/HttpCredentials.html)

Source[OAuth2BearerToken.java](https://github.com/akka/akka-http/tree/v10.7.4/akka-http-core/src/main/java/akka/http/javadsl/model/headers/OAuth2BearerToken.java#L7)Linear Supertypes[scaladsl.model.headers.HttpCredentials](../../../scaladsl/model/headers/HttpCredentials.html), ValueRenderable, ToStringRenderable, Renderable, [HttpCredentials](HttpCredentials.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[OAuth2BearerToken](../../../scaladsl/model/headers/OAuth2BearerToken.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. OAuth2BearerToken
2. HttpCredentials
...
1. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#<init>():akka.http.javadsl.model.headers.OAuth2BearerToken "Permalink")  new OAuth2BearerToken()
### Abstract Value Members

1. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#params:Map[String,String] "Permalink") abstract  def params: Map\[String, String]Definition Classes[HttpCredentials](../../../scaladsl/model/headers/HttpCredentials.html)
2. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#scheme():String "Permalink") abstract  def scheme(): StringDefinition Classes[HttpCredentials](../../../scaladsl/model/headers/HttpCredentials.html) → [HttpCredentials](HttpCredentials.html)
3. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#token():String "Permalink") abstract  def token(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesOAuth2BearerToken → [HttpCredentials](../../../scaladsl/model/headers/HttpCredentials.html) → [HttpCredentials](HttpCredentials.html)
### Concrete Value Members

1. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from OAuth2BearerToken toany2stringadd\[OAuth2BearerToken] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (OAuth2BearerToken, B)ImplicitThis member is added by an implicit conversion from OAuth2BearerToken toArrowAssoc\[OAuth2BearerToken] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (OAuth2BearerToken) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): OAuth2BearerTokenImplicitThis member is added by an implicit conversion from OAuth2BearerToken toEnsuring\[OAuth2BearerToken] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (OAuth2BearerToken) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): OAuth2BearerTokenImplicitThis member is added by an implicit conversion from OAuth2BearerToken toEnsuring\[OAuth2BearerToken] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): OAuth2BearerTokenImplicitThis member is added by an implicit conversion from OAuth2BearerToken toEnsuring\[OAuth2BearerToken] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): OAuth2BearerTokenImplicitThis member is added by an implicit conversion from OAuth2BearerToken toEnsuring\[OAuth2BearerToken] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#getParams():java.util.Map[String,String] "Permalink")  def getParams(): [Map](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html#java.util.Map)\[String, String]Java API

Java API

Definition Classes[HttpCredentials](../../../scaladsl/model/headers/HttpCredentials.html) → [HttpCredentials](HttpCredentials.html)
16. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
18. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#toString():String "Permalink")  def toString(): StringDefinition ClassesToStringRenderable → AnyRef → Any
23. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#value:String "Permalink")  def value: StringDefinition ClassesValueRenderable
24. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
25. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
26. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from OAuth2BearerToken toStringFormat\[OAuth2BearerToken] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../../../akka/http/javadsl/model/headers/OAuth2BearerToken.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (OAuth2BearerToken, B)ImplicitThis member is added by an implicit conversion from OAuth2BearerToken toArrowAssoc\[OAuth2BearerToken] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [scaladsl.model.headers.HttpCredentials](../../../scaladsl/model/headers/HttpCredentials.html)
...
### Inherited by implicit conversion any2stringadd fromOAuth2BearerToken to any2stringadd\[OAuth2BearerToken]

### Inherited by implicit conversion StringFormat fromOAuth2BearerToken to StringFormat\[OAuth2BearerToken]

### Inherited by implicit conversion Ensuring fromOAuth2BearerToken to Ensuring\[OAuth2BearerToken]

### Inherited by implicit conversion ArrowAssoc fromOAuth2BearerToken to ArrowAssoc\[OAuth2BearerToken]
...
---
*Source: [https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/model/headers/OAuth2BearerToken.html](https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/model/headers/OAuth2BearerToken.html)*