---
description: Akka HTTP 10.7.4 - akka.http.javadsl.server.RequestContext
knowledge_type: official_documentation
scraped_at: '2026-04-06T02:16:28Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/javadsl/server/RequestContext.html
title: Akka HTTP 10.7.4 - akka.http.javadsl.server.RequestContext
---

# Akka HTTP 10.7.4 - akka.http.javadsl.server.RequestContext

> **Summary:** Akka HTTP 10.7.4 - akka.http.javadsl.server.RequestContext
...
[c](RequestContext$.html "See companion object")[akka](../../../index.html).[http](../../index.html).[javadsl](../index.html).[server](index.html)

# [RequestContext](RequestContext$.html "See companion object")[**](../../../../akka/http/javadsl/server/RequestContext.html "Permalink")

### Companion [object RequestContext](RequestContext$.html "See companion object")

#### class RequestContext extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

Source[RequestContext.scala](https://github.com/akka/akka-http/tree/v10.7.4/akka-http/src/main/scala/akka/http/javadsl/server/RequestContext.scala#L32)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. RequestContext
2. AnyRef
...
1. [**](../../../../akka/http/javadsl/server/RequestContext.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../akka/http/javadsl/server/RequestContext.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../akka/http/javadsl/server/RequestContext.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from RequestContext toany2stringadd\[RequestContext] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../akka/http/javadsl/server/RequestContext.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (RequestContext, B)ImplicitThis member is added by an implicit conversion from RequestContext toArrowAssoc\[RequestContext] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../akka/http/javadsl/server/RequestContext.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../akka/http/javadsl/server/RequestContext.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../../akka/http/javadsl/server/RequestContext.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../../../akka/http/javadsl/server/RequestContext.html#complete[T](value:T,marshaller:akka.http.javadsl.marshalling.Marshaller[T,akka.http.javadsl.model.HttpResponse]):java.util.concurrent.CompletionStage[akka.http.javadsl.server.RouteResult] "Permalink")  def complete\[T](value: T, marshaller: [Marshaller](../marshalling/Marshaller.html)\[T, [HttpResponse](../model/HttpResponse.html)]): [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[[RouteResult](RouteResult.html)]
9. [**](../../../../akka/http/javadsl/server/RequestContext.html#completeWith(response:akka.http.javadsl.model.HttpResponse):java.util.concurrent.CompletionStage[akka.http.javadsl.server.RouteResult] "Permalink")  def completeWith(response: [HttpResponse](../model/HttpResponse.html)): [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[[RouteResult](RouteResult.html)]
10. [**](../../../../akka/http/javadsl/server/RequestContext.html#delegate:akka.http.scaladsl.server.RequestContext "Permalink")  val delegate: [scaladsl.server.RequestContext](../../scaladsl/server/RequestContext.html)
11. [**](../../../../akka/http/javadsl/server/RequestContext.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (RequestContext) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): RequestContextImplicitThis member is added by an implicit conversion from RequestContext toEnsuring\[RequestContext] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../../akka/http/javadsl/server/RequestContext.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (RequestContext) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): RequestContextImplicitThis member is added by an implicit conversion from RequestContext toEnsuring\[RequestContext] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../../../akka/http/javadsl/server/RequestContext.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): RequestContextImplicitThis member is added by an implicit conversion from RequestContext toEnsuring\[RequestContext] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
14. [**](../../../../akka/http/javadsl/server/RequestContext.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): RequestContextImplicitThis member is added by an implicit conversion from RequestContext toEnsuring\[RequestContext] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
15. [**](../../../../akka/http/javadsl/server/RequestContext.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
16. [**](../../../../akka/http/javadsl/server/RequestContext.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
17. [**](../../../../akka/http/javadsl/server/RequestContext.html#fail(error:Throwable):java.util.concurrent.CompletionStage[akka.http.javadsl.server.RouteResult] "Permalink")  def fail(error: Throwable): [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[[RouteResult](RouteResult.html)]
18. [**](../../../../akka/http/javadsl/server/RequestContext.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../../../akka/http/javadsl/server/RequestContext.html#getExecutionContext:scala.concurrent.ExecutionContextExecutor "Permalink")  def getExecutionContext: [ExecutionContextExecutor](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContextExecutor.html#scala.concurrent.ExecutionContextExecutor)
20. [**](../../../../akka/http/javadsl/server/RequestContext.html#getLog:akka.event.LoggingAdapter "Permalink")  def getLog: [LoggingAdapter](https://doc.akka.io/api/akka-core/2.10.11/akka/event/LoggingAdapter.html#akka.event.LoggingAdapter)
21. [**](../../../../akka/http/javadsl/server/RequestContext.html#getMaterializer:akka.stream.Materializer "Permalink")  def getMaterializer: [Materializer](https://doc.akka.io/api/akka-core/2.10.11/akka/stream/Materializer.html#akka.stream.Materializer)
22. [**](../../../../akka/http/javadsl/server/RequestContext.html#getParserSettings:akka.http.javadsl.settings.ParserSettings "Permalink")  def getParserSettings: [ParserSettings](../settings/ParserSettings.html)
23. [**](../../../../akka/http/javadsl/server/RequestContext.html#getRequest:akka.http.javadsl.model.HttpRequest "Permalink")  def getRequest: [HttpRequest](../model/HttpRequest.html)
24. [**](../../../../akka/http/javadsl/server/RequestContext.html#getSettings:akka.http.javadsl.settings.RoutingSettings "Permalink")  def getSettings: [RoutingSettings](../settings/RoutingSettings.html)
25. [**](../../../../akka/http/javadsl/server/RequestContext.html#getUnmatchedPath:String "Permalink")  def getUnmatchedPath: String
26. [**](../../../../akka/http/javadsl/server/RequestContext.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
27. [**](../../../../akka/http/javadsl/server/RequestContext.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
28. [**](../../../../akka/http/javadsl/server/RequestContext.html#mapRequest(f:java.util.function.Function[akka.http.javadsl.model.HttpRequest,akka.http.javadsl.model.HttpRequest]):akka.http.javadsl.server.RequestContext "Permalink")  def mapRequest(f: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[[HttpRequest](../model/HttpRequest.html), [HttpRequest](../model/HttpRequest.html)]): RequestContext
29. [**](../../../../akka/http/javadsl/server/RequestContext.html#mapUnmatchedPath(f:java.util.function.Function[String,String]):akka.http.javadsl.server.RequestContext "Permalink")  def mapUnmatchedPath(f: [Function](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Function.html#java.util.function.Function)\[String, String]): RequestContext
30. [**](../../../../akka/http/javadsl/server/RequestContext.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
31. [**](../../../../akka/http/javadsl/server/RequestContext.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
32. [**](../../../../akka/http/javadsl/server/RequestContext.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
33. [**](../../../../akka/http/javadsl/server/RequestContext.html#reconfigure(executionContext:scala.concurrent.ExecutionContextExecutor,materializer:akka.stream.Materializer,log:akka.event.LoggingAdapter,settings:akka.http.javadsl.settings.RoutingSettings):akka.http.javadsl.server.RequestContext "Permalink")  def reconfigure(executionContext: [ExecutionContextExecutor](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContextExecutor.html#scala.concurrent.ExecutionContextExecutor), materializer: [Materializer](https://doc.akka.io/api/akka-core/2.10.11/akka/stream/Materializer.html#akka.stream.Materializer), log: [LoggingAdapter](https://doc.akka.io/api/akka-core/2.10.11/akka/event/LoggingAdapter.html#akka.event.LoggingAdapter), settings: [RoutingSettings](../settings/RoutingSettings.html)): RequestContext
34. [**](../../../../akka/http/javadsl/server/RequestContext.html#redirect(uri:akka.http.javadsl.model.Uri,redirectionType:akka.http.javadsl.model.StatusCode):java.util.concurrent.CompletionStage[akka.http.javadsl.server.RouteResult] "Permalink")  def redirect(uri: [Uri](../model/Uri.html), redirectionType: [StatusCode](../model/StatusCode.html)): [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[[RouteResult](RouteResult.html)]
35. [**](../../../../akka/http/javadsl/server/RequestContext.html#reject(rejections:akka.http.javadsl.server.Rejection*):java.util.concurrent.CompletionStage[akka.http.javadsl.server.RouteResult] "Permalink")  def reject(rejections: [Rejection](Rejection.html)\*): [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[[RouteResult](RouteResult.html)]Annotations@varargs()
36. [**](../../../../akka/http/javadsl/server/RequestContext.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
37. [**](../../../../akka/http/javadsl/server/RequestContext.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
38. [**](../../../../akka/http/javadsl/server/RequestContext.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
39. [**](../../../../akka/http/javadsl/server/RequestContext.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
40. [**](../../../../akka/http/javadsl/server/RequestContext.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
41. [**](../../../../akka/http/javadsl/server/RequestContext.html#withAcceptAll:akka.http.javadsl.server.RequestContext "Permalink")  def withAcceptAll: RequestContext
42. [**](../../../../akka/http/javadsl/server/RequestContext.html#withExecutionContext(ec:scala.concurrent.ExecutionContextExecutor):akka.http.javadsl.server.RequestContext "Permalink")  def withExecutionContext(ec: [ExecutionContextExecutor](https://www.scala-lang.org/api/2.13.17/scala/concurrent/ExecutionContextExecutor.html#scala.concurrent.ExecutionContextExecutor)): RequestContext
43. [**](../../../../akka/http/javadsl/server/RequestContext.html#withLog(log:akka.event.LoggingAdapter):akka.http.javadsl.server.RequestContext "Permalink")  def withLog(log: [LoggingAdapter](https://doc.akka.io/api/akka-core/2.10.11/akka/event/LoggingAdapter.html#akka.event.LoggingAdapter)): RequestContext
44. [**](../../../../akka/http/javadsl/server/RequestContext.html#withMaterializer(materializer:akka.stream.Materializer):akka.http.javadsl.server.RequestContext "Permalink")  def withMaterializer(materializer: [Materializer](https://doc.akka.io/api/akka-core/2.10.11/akka/stream/Materializer.html#akka.stream.Materializer)): RequestContext
45. [**](../../../../akka/http/javadsl/server/RequestContext.html#withParserSettings(settings:akka.http.javadsl.settings.ParserSettings):akka.http.javadsl.server.RequestContext "Permalink")  def withParserSettings(settings: [ParserSettings](../settings/ParserSettings.html)): RequestContext
46. [**](../../../../akka/http/javadsl/server/RequestContext.html#withRequest(req:akka.http.javadsl.model.HttpRequest):akka.http.javadsl.server.RequestContext "Permalink")  def withRequest(req: [HttpRequest](../model/HttpRequest.html)): RequestContext
47. [**](../../../../akka/http/javadsl/server/RequestContext.html#withRoutingSettings(settings:akka.http.javadsl.settings.RoutingSettings):akka.http.javadsl.server.RequestContext "Permalink")  def withRoutingSettings(settings: [RoutingSettings](../settings/RoutingSettings.html)): RequestContext
48. [**](../../../../akka/http/javadsl/server/RequestContext.html#withUnmatchedPath(path:String):akka.http.javadsl.server.RequestContext "Permalink")  def withUnmatchedPath(path: String): RequestContext
### Deprecated Value Members

1. [**](../../../../akka/http/javadsl/server/RequestContext.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../../akka/http/javadsl/server/RequestContext.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from RequestContext toStringFormat\[RequestContext] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../../akka/http/javadsl/server/RequestContext.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (RequestContext, B)ImplicitThis member is added by an implicit conversion from RequestContext toArrowAssoc\[RequestContext] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
---
*Source: [https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/server/RequestContext.html](https://doc.akka.io/api/akka-http/10.7.4/akka/http/javadsl/server/RequestContext.html)*