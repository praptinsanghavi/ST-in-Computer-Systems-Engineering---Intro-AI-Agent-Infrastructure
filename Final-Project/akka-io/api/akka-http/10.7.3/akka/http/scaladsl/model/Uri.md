---
description: Akka HTTP 10.7.3 - akka.http.scaladsl.model.Uri
knowledge_type: official_documentation
scraped_at: '2026-04-06T13:43:21Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/model/Uri.html
title: Akka HTTP 10.7.3 - akka.http.scaladsl.model.Uri
---

# Akka HTTP 10.7.3 - akka.http.scaladsl.model.Uri

> **Summary:** Akka HTTP 10.7.3 - akka.http.scaladsl.model.Uri
...
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/index.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/AttributeKey$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/AttributeKey.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/AttributeKeys$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/BodyPartEntity.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/ByteContentRange.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/ContentRange$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/ContentRange.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/ContentType$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/ContentType.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/ContentTypeRange$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/ContentTypeRange.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/ContentTypes$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/DateTime$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/DateTime.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/EntityStreamException$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/EntityStreamException.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/EntityStreamSizeException.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/ErrorInfo$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/ErrorInfo.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/ExceptionWithErrorInfo.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/FormData$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/FormData.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpCharset$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpCharset.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpCharsetRange$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpCharsetRange.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpCharsets$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpEntity$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpEntity.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpHeader$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpHeader.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpMessage$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpMessage.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpMethod$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpMethod.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpMethods$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpProtocol.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpProtocols$.html
...
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/HttpResponse.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/IllegalHeaderException$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/IllegalHeaderException.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/IllegalRequestException$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/IllegalRequestException.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/IllegalResponseException$.html
- https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/IllegalResponseException.html

---
*Source: [https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/Uri.html](https://doc.akka.io/api/akka-http/10.7.3/akka/http/scaladsl/model/Uri.html)*