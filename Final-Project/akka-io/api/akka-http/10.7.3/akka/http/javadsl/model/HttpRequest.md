---
description: Akka HTTP 10.7.3 - akka.http.javadsl.model.HttpRequest
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:46:51Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/javadsl/model/HttpRequest.html
title: Akka HTTP 10.7.3 - akka.http.javadsl.model.HttpRequest
---

# Akka HTTP 10.7.3 - akka.http.javadsl.model.HttpRequest

> **Summary:** Akka HTTP 10.7.3 - akka.http.javadsl.model.HttpRequest
...
---
*Source: [https://doc.akka.io/api/akka-http/10.7.3/akka/http/javadsl/model/HttpRequest.html](https://doc.akka.io/api/akka-http/10.7.3/akka/http/javadsl/model/HttpRequest.html)*