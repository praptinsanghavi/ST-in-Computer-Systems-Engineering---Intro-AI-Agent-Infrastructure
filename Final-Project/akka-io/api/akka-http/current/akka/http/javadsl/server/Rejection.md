---
description: Akka HTTP 10.7.4 - akka.http.javadsl.server.Rejection
knowledge_type: official_documentation
scraped_at: '2026-04-06T00:50:05Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/javadsl/server/Rejection.html
title: Akka HTTP 10.7.4 - akka.http.javadsl.server.Rejection
---

# Akka HTTP 10.7.4 - akka.http.javadsl.server.Rejection

> **Summary:** Akka HTTP 10.7.4 - akka.http.javadsl.server.Rejection
...
# Rejection[**](../../../../akka/http/javadsl/server/Rejection.html "Permalink")

### 

#### trait Rejection extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
...
Source[Rejections.scala](https://github.com/akka/akka-http/tree/v10.7.4/akka-http/src/main/scala/akka/http/javadsl/server/Rejections.scala#L33)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Known Subclasses[AuthenticationFailedRejection](AuthenticationFailedRejection.html), [AuthorizationFailedRejection](AuthorizationFailedRejection.html), [CircuitBreakerOpenRejection](CircuitBreakerOpenRejection.html), [CorsRejection](CorsRejection.html), [CustomRejection](CustomRejection.html), [ExpectedWebSocketRequestRejection](ExpectedWebSocketRequestRejection.html), [InvalidOriginRejection](InvalidOriginRejection.html), [InvalidRequiredValueForQueryParamRejection](InvalidRequiredValueForQueryParamRejection.html), [MalformedFormFieldRejection](MalformedFormFieldRejection.html), [MalformedHeaderRejection](MalformedHeaderRejection.html), [MalformedQueryParamRejection](MalformedQueryParamRejection.html), [MalformedRequestContentRejection](MalformedRequestContentRejection.html), [MethodRejection](MethodRejection.html), [MissingAttributeRejection](MissingAttributeRejection.html), [MissingCookieRejection](MissingCookieRejection.html), [MissingFormFieldRejection](MissingFormFieldRejection.html), [MissingHeaderRejection](MissingHeaderRejection.html), [MissingQueryParamRejection](MissingQueryParamRejection.html), [RequestEntityExpectedRejection](RequestEntityExpectedRejection.html), [SchemeRejection](SchemeRejection.html), [TlsClientIdentityRejection](TlsClientIdentityRejection.html), [TlsClientUnverifiedRejection](TlsClientUnverifiedRejection.html), [TooManyRangesRejection](TooManyRangesRejection.html), [TransformationRejection](TransformationRejection.html), [UnacceptedResponseContentTypeRejection](UnacceptedResponseContentTypeRejection.html), [UnacceptedResponseEncodingRejection](UnacceptedResponseEncodingRejection.html), [UnsatisfiableRangeRejection](UnsatisfiableRangeRejection.html), [UnsupportedRequestContentTypeRejection](UnsupportedRequestContentTypeRejection.html), [UnsupportedRequestEncodingRejection](UnsupportedRequestEncodingRejection.html), [UnsupportedWebSocketSubprotocolRejection](UnsupportedWebSocketSubprotocolRejection.html), [ValidationRejection](ValidationRejection.html), [AuthenticationFailedRejection](../../scaladsl/server/AuthenticationFailedRejection.html), [AuthorizationFailedRejection](../../scaladsl/server/AuthorizationFailedRejection$.html), [CircuitBreakerOpenRejection](../../scaladsl/server/CircuitBreakerOpenRejection.html), [CorsRejection](../../scaladsl/server/CorsRejection.html), [ExpectedWebSocketRequestRejection](../../scaladsl/server/ExpectedWebSocketRequestRejection$.html), [InvalidOriginRejection](../../scaladsl/server/InvalidOriginRejection.html), [InvalidRequiredValueForQueryParamRejection](../../scaladsl/server/InvalidRequiredValueForQueryParamRejection.html), [MalformedFormFieldRejection](../../scaladsl/server/MalformedFormFieldRejection.html), [MalformedHeaderRejection](../../scaladsl/server/MalformedHeaderRejection.html), [MalformedQueryParamRejection](../../scaladsl/server/MalformedQueryParamRejection.html), [MalformedRequestContentRejection](../../scaladsl/server/MalformedRequestContentRejection.html), [MethodRejection](../../scaladsl/server/MethodRejection.html), [MissingAttributeRejection](../../scaladsl/server/MissingAttributeRejection.html), [MissingCookieRejection](../../scaladsl/server/MissingCookieRejection.html), [MissingFormFieldRejection](../../scaladsl/server/MissingFormFieldRejection.html), [MissingHeaderRejection](../../scaladsl/server/MissingHeaderRejection.html), [MissingQueryParamRejection](../../scaladsl/server/MissingQueryParamRejection.html), [Rejection](../../scaladsl/server/Rejection.html), [RejectionWithOptionalCause](../../scaladsl/server/RejectionWithOptionalCause.html), [RequestEntityExpectedRejection](../../scaladsl/server/RequestEntityExpectedRejection$.html), [SchemeRejection](../../scaladsl/server/SchemeRejection.html), [TlsClientIdentityRejection](../../scaladsl/server/TlsClientIdentityRejection.html), [TlsClientUnverifiedRejection](../../scaladsl/server/TlsClientUnverifiedRejection.html), [TooManyRangesRejection](../../scaladsl/server/TooManyRangesRejection.html), [TransformationRejection](../../scaladsl/server/TransformationRejection.html), [UnacceptedResponseContentTypeRejection](../../scaladsl/server/UnacceptedResponseContentTypeRejection.html), [UnacceptedResponseEncodingRejection](../../scaladsl/server/UnacceptedResponseEncodingRejection.html), [UnsatisfiableRangeRejection](../../scaladsl/server/UnsatisfiableRangeRejection.html), [UnsupportedRequestContentTypeRejection](../../scaladsl/server/UnsupportedRequestContentTypeRejection.html), [UnsupportedRequestEncodingRejection](../../scaladsl/server/UnsupportedRequestEncodingRejection.html), [UnsupportedWebSocketSubprotocolRejection](../../scaladsl/server/UnsupportedWebSocketSubprotocolRejection.html), [ValidationRejection](../../scaladsl/server/ValidationRejection.html)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Rejection
2. AnyRef
...
1. [**](../../../../akka/http/javadsl/server/Rejection.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../akka/http/javadsl/server/Rejection.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../akka/http/javadsl/server/Rejection.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from Rejection toany2stringadd\[Rejection] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../akka/http/javadsl/server/Rejection.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (Rejection, B)ImplicitThis member is added by an implicit conversion from Rejection toArrowAssoc\[Rejection] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../akka/http/javadsl/server/Rejection.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../akka/http/javadsl/server/Rejection.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../../akka/http/javadsl/server/Rejection.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../../../akka/http/javadsl/server/Rejection.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (Rejection) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): RejectionImplicitThis member is added by an implicit conversion from Rejection toEnsuring\[Rejection] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../../../akka/http/javadsl/server/Rejection.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (Rejection) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): RejectionImplicitThis member is added by an implicit conversion from Rejection toEnsuring\[Rejection] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../../akka/http/javadsl/server/Rejection.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): RejectionImplicitThis member is added by an implicit conversion from Rejection toEnsuring\[Rejection] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../../akka/http/javadsl/server/Rejection.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): RejectionImplicitThis member is added by an implicit conversion from Rejection toEnsuring\[Rejection] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../../akka/http/javadsl/server/Rejection.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../../../akka/http/javadsl/server/Rejection.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
14. [**](../../../../akka/http/javadsl/server/Rejection.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../../../akka/http/javadsl/server/Rejection.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../../akka/http/javadsl/server/Rejection.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../../../akka/http/javadsl/server/Rejection.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
18. [**](../../../../akka/http/javadsl/server/Rejection.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
19. [**](../../../../akka/http/javadsl/server/Rejection.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../../../akka/http/javadsl/server/Rejection.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../../../akka/http/javadsl/server/Rejection.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../../../akka/http/javadsl/server/Rejection.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../../../akka/http/javadsl/server/Rejection.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../../../akka/http/javadsl/server/Rejection.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../akka/http/javadsl/server/Rejection.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../../akka/http/javadsl/server/Rejection.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from Rejection toStringFormat\[Rejection] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../../akka/http/javadsl/server/Rejection.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (Rejection, B)ImplicitThis member is added by an implicit conversion from Rejection toArrowAssoc\[Rejection] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromRejection to any2stringadd\[Rejection]

### Inherited by implicit conversion StringFormat fromRejection to StringFormat\[Rejection]

### Inherited by implicit conversion Ensuring fromRejection to Ensuring\[Rejection]

### Inherited by implicit conversion ArrowAssoc fromRejection to ArrowAssoc\[Rejection]
...
---
*Source: [https://doc.akka.io/api/akka-http/current/akka/http/javadsl/server/Rejection.html](https://doc.akka.io/api/akka-http/current/akka/http/javadsl/server/Rejection.html)*