---
description: Akka HTTP 10.7.4 - akka.http.javadsl.coding
knowledge_type: official_documentation
scraped_at: '2026-04-06T00:43:24Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/javadsl/coding/index.html
title: Akka HTTP 10.7.4 - akka.http.javadsl.coding
---

# Akka HTTP 10.7.4 - akka.http.javadsl.coding

> **Summary:** Akka HTTP 10.7.4 - akka.http.javadsl.coding
...
- [**](../../../../akka/http/javadsl/coding/index.html "Permalink")  package codingDefinition Classes[javadsl](../index.html)
- [Coder](Coder.html "A coder is an implementation of the predefined encoders/decoders defined for HTTP.")
...
# coding[**](../../../../akka/http/javadsl/coding/index.html "Permalink")

#### package coding

### Type Members

1. [**](../../../../akka/http/javadsl/coding/Coder.html "Permalink") sealed final  class [Coder](Coder.html "A coder is an implementation of the predefined encoders/decoders defined for HTTP.") extends [Enum](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Enum.html#java.lang.Enum)\[[Coder](Coder.html)]A coder is an implementation of the predefined encoders/decoders defined for HTTP.
...
---
*Source: [https://doc.akka.io/api/akka-http/current/akka/http/javadsl/coding/index.html](https://doc.akka.io/api/akka-http/current/akka/http/javadsl/coding/index.html)*