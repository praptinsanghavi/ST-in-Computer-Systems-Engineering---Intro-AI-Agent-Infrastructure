---
description: Akka HTTP 10.7.4 - akka.http.scaladsl.server.MalformedFormFieldRejection
knowledge_type: official_documentation
scraped_at: '2026-04-06T00:47:02Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/server/MalformedFormFieldRejection.html
title: Akka HTTP 10.7.4 - akka.http.scaladsl.server.MalformedFormFieldRejection
---

# Akka HTTP 10.7.4 - akka.http.scaladsl.server.MalformedFormFieldRejection

> **Summary:** Akka HTTP 10.7.4 - akka.http.scaladsl.server.MalformedFormFieldRejection
...
# MalformedFormFieldRejection[**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html "Permalink")

### 

#### final  case class MalformedFormFieldRejection(fieldName: String, errorMsg: String, cause: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[Throwable] \= None) extends [javadsl.server.MalformedFormFieldRejection](../../javadsl/server/MalformedFormFieldRejection.html) with [RejectionWithOptionalCause](RejectionWithOptionalCause.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable
...
Source[Rejection.scala](https://github.com/akka/akka-http/tree/v10.7.4/akka-http/src/main/scala/akka/http/scaladsl/server/Rejection.scala#L85)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.17/scala/Equals.html#scala.Equals), [RejectionWithOptionalCause](RejectionWithOptionalCause.html), [Rejection](Rejection.html), [javadsl.server.MalformedFormFieldRejection](../../javadsl/server/MalformedFormFieldRejection.html), [javadsl.server.Rejection](../../javadsl/server/Rejection.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#<init>(fieldName:String,errorMsg:String,cause:Option[Throwable]):akka.http.scaladsl.server.MalformedFormFieldRejection "Permalink")  new MalformedFormFieldRejection(fieldName: String, errorMsg: String, cause: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[Throwable] \= None)
### Value Members

1. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from MalformedFormFieldRejection toany2stringadd\[MalformedFormFieldRejection] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (MalformedFormFieldRejection, B)ImplicitThis member is added by an implicit conversion from MalformedFormFieldRejection toArrowAssoc\[MalformedFormFieldRejection] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#cause:Option[Throwable] "Permalink")  val cause: [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[Throwable]Definition ClassesMalformedFormFieldRejection → [RejectionWithOptionalCause](RejectionWithOptionalCause.html)
8. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (MalformedFormFieldRejection) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): MalformedFormFieldRejectionImplicitThis member is added by an implicit conversion from MalformedFormFieldRejection toEnsuring\[MalformedFormFieldRejection] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (MalformedFormFieldRejection) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): MalformedFormFieldRejectionImplicitThis member is added by an implicit conversion from MalformedFormFieldRejection toEnsuring\[MalformedFormFieldRejection] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): MalformedFormFieldRejectionImplicitThis member is added by an implicit conversion from MalformedFormFieldRejection toEnsuring\[MalformedFormFieldRejection] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): MalformedFormFieldRejectionImplicitThis member is added by an implicit conversion from MalformedFormFieldRejection toEnsuring\[MalformedFormFieldRejection] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#errorMsg:String "Permalink")  val errorMsg: StringDefinition ClassesMalformedFormFieldRejection → [MalformedFormFieldRejection](../../javadsl/server/MalformedFormFieldRejection.html)
15. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#fieldName:String "Permalink")  val fieldName: StringDefinition ClassesMalformedFormFieldRejection → [MalformedFormFieldRejection](../../javadsl/server/MalformedFormFieldRejection.html)
16. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#getCause:java.util.Optional[Throwable] "Permalink") final  def getCause: [Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#java.util.Optional)\[Throwable]Definition Classes[RejectionWithOptionalCause](RejectionWithOptionalCause.html)
17. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
18. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
19. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
20. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
23. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
24. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
25. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
26. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from MalformedFormFieldRejection toStringFormat\[MalformedFormFieldRejection] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../../akka/http/scaladsl/server/MalformedFormFieldRejection.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (MalformedFormFieldRejection, B)ImplicitThis member is added by an implicit conversion from MalformedFormFieldRejection toArrowAssoc\[MalformedFormFieldRejection] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
...
### Inherited from [javadsl.server.MalformedFormFieldRejection](../../javadsl/server/MalformedFormFieldRejection.html)
...
---
*Source: [https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/server/MalformedFormFieldRejection.html](https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/server/MalformedFormFieldRejection.html)*