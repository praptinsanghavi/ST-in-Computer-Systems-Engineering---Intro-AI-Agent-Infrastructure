---
description: Akka HTTP 10.7.4 - akka.http.scaladsl.model.OptHttpResponse
knowledge_type: official_documentation
scraped_at: '2026-04-06T00:52:16Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/model/OptHttpResponse.html
title: Akka HTTP 10.7.4 - akka.http.scaladsl.model.OptHttpResponse
---

# Akka HTTP 10.7.4 - akka.http.scaladsl.model.OptHttpResponse

> **Summary:** Akka HTTP 10.7.4 - akka.http.scaladsl.model.OptHttpResponse
...
# OptHttpResponse[**](../../../../akka/http/scaladsl/model/OptHttpResponse.html "Permalink")

### 

#### final  class OptHttpResponse extends [AnyVal](https://www.scala-lang.org/api/2.13.17/scala/AnyVal.html#scala.AnyVal)

Source[HttpMessage.scala](https://github.com/akka/akka-http/tree/v10.7.4/akka-http-core/src/main/scala/akka/http/scaladsl/model/HttpMessage.scala#L626)Linear Supertypes[AnyVal](https://www.scala-lang.org/api/2.13.17/scala/AnyVal.html#scala.AnyVal), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. OptHttpResponse
2. AnyVal
...
1. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#<init>(get:akka.http.scaladsl.model.HttpResponse):akka.http.scaladsl.model.OptHttpResponse "Permalink")  new OptHttpResponse(get: [HttpResponse](HttpResponse.html))
### Value Members

1. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
2. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAny
3. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from OptHttpResponse toany2stringadd\[OptHttpResponse] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (OptHttpResponse, B)ImplicitThis member is added by an implicit conversion from OptHttpResponse toArrowAssoc\[OptHttpResponse] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
6. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (OptHttpResponse) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): OptHttpResponseImplicitThis member is added by an implicit conversion from OptHttpResponse toEnsuring\[OptHttpResponse] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
8. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (OptHttpResponse) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): OptHttpResponseImplicitThis member is added by an implicit conversion from OptHttpResponse toEnsuring\[OptHttpResponse] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
9. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): OptHttpResponseImplicitThis member is added by an implicit conversion from OptHttpResponse toEnsuring\[OptHttpResponse] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): OptHttpResponseImplicitThis member is added by an implicit conversion from OptHttpResponse toEnsuring\[OptHttpResponse] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#get:akka.http.scaladsl.model.HttpResponse "Permalink")  val get: [HttpResponse](HttpResponse.html)
12. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#getClass():Class[_<:AnyVal] "Permalink")  def getClass(): Class\[\_ \<: [AnyVal](https://www.scala-lang.org/api/2.13.17/scala/AnyVal.html#scala.AnyVal)]Definition ClassesAnyVal → Any
13. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#isEmpty:Boolean "Permalink")  def isEmpty: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)
14. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
15. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAny
### Deprecated Value Members

1. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from OptHttpResponse toStringFormat\[OptHttpResponse] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
2. [**](../../../../akka/http/scaladsl/model/OptHttpResponse.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (OptHttpResponse, B)ImplicitThis member is added by an implicit conversion from OptHttpResponse toArrowAssoc\[OptHttpResponse] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyVal](https://www.scala-lang.org/api/2.13.17/scala/AnyVal.html#scala.AnyVal)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromOptHttpResponse to any2stringadd\[OptHttpResponse]

### Inherited by implicit conversion StringFormat fromOptHttpResponse to StringFormat\[OptHttpResponse]

### Inherited by implicit conversion Ensuring fromOptHttpResponse to Ensuring\[OptHttpResponse]

### Inherited by implicit conversion ArrowAssoc fromOptHttpResponse to ArrowAssoc\[OptHttpResponse]
...
---
*Source: [https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/model/OptHttpResponse.html](https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/model/OptHttpResponse.html)*