---
description: Akka HTTP 10.7.4 - akka.http.scaladsl.server.MediaTypeNegotiator
knowledge_type: official_documentation
scraped_at: '2026-04-06T00:47:11Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/server/MediaTypeNegotiator.html
title: Akka HTTP 10.7.4 - akka.http.scaladsl.server.MediaTypeNegotiator
---

# Akka HTTP 10.7.4 - akka.http.scaladsl.server.MediaTypeNegotiator

> **Summary:** Akka HTTP 10.7.4 - akka.http.scaladsl.server.MediaTypeNegotiator
...
# MediaTypeNegotiator[**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html "Permalink")

### 

#### final  class MediaTypeNegotiator extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
...
1. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#<init>(requestHeaders:Seq[akka.http.scaladsl.model.HttpHeader]):akka.http.scaladsl.server.MediaTypeNegotiator "Permalink")  new MediaTypeNegotiator(requestHeaders: Seq\[[HttpHeader](../model/HttpHeader.html)])
### Value Members

1. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from MediaTypeNegotiator toany2stringadd\[MediaTypeNegotiator] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (MediaTypeNegotiator, B)ImplicitThis member is added by an implicit conversion from MediaTypeNegotiator toArrowAssoc\[MediaTypeNegotiator] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#acceptedMediaRanges:List[akka.http.scaladsl.model.MediaRange] "Permalink")  val acceptedMediaRanges: List\[[MediaRange](../model/MediaRange.html)]The media\-ranges accepted by the client according to the given request headers, sorted by
1\.
...
7. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
8. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (MediaTypeNegotiator) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): MediaTypeNegotiatorImplicitThis member is added by an implicit conversion from MediaTypeNegotiator toEnsuring\[MediaTypeNegotiator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (MediaTypeNegotiator) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): MediaTypeNegotiatorImplicitThis member is added by an implicit conversion from MediaTypeNegotiator toEnsuring\[MediaTypeNegotiator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): MediaTypeNegotiatorImplicitThis member is added by an implicit conversion from MediaTypeNegotiator toEnsuring\[MediaTypeNegotiator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): MediaTypeNegotiatorImplicitThis member is added by an implicit conversion from MediaTypeNegotiator toEnsuring\[MediaTypeNegotiator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
15. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#isAccepted(mediaType:akka.http.scaladsl.model.MediaType):Boolean "Permalink")  def isAccepted(mediaType: [MediaType](../model/MediaType.html)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Determines whether the given [akka.http.scaladsl.model.MediaType](../model/MediaType.html) is accepted by the client.
18. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
19. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
20. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#qValueFor(mediaType:akka.http.scaladsl.model.MediaType):Float "Permalink")  def qValueFor(mediaType: [MediaType](../model/MediaType.html)): [Float](https://www.scala-lang.org/api/2.13.17/scala/Float.html#scala.Float)Returns the q\-value that the client (implicitly or explicitly) attaches to the given media\-type.
...
23. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
24. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
25. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
27. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from MediaTypeNegotiator toStringFormat\[MediaTypeNegotiator] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../../akka/http/scaladsl/server/MediaTypeNegotiator.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (MediaTypeNegotiator, B)ImplicitThis member is added by an implicit conversion from MediaTypeNegotiator toArrowAssoc\[MediaTypeNegotiator] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromMediaTypeNegotiator to any2stringadd\[MediaTypeNegotiator]

### Inherited by implicit conversion StringFormat fromMediaTypeNegotiator to StringFormat\[MediaTypeNegotiator]

### Inherited by implicit conversion Ensuring fromMediaTypeNegotiator to Ensuring\[MediaTypeNegotiator]

### Inherited by implicit conversion ArrowAssoc fromMediaTypeNegotiator to ArrowAssoc\[MediaTypeNegotiator]
...
---
*Source: [https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/server/MediaTypeNegotiator.html](https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/server/MediaTypeNegotiator.html)*