---
description: Akka HTTP 10.7.4 - akka.http.scaladsl.server.MalformedRequestContentRejection
knowledge_type: official_documentation
scraped_at: '2026-04-06T00:47:09Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/server/MalformedRequestContentRejection.html
title: Akka HTTP 10.7.4 - akka.http.scaladsl.server.MalformedRequestContentRejection
---

# Akka HTTP 10.7.4 - akka.http.scaladsl.server.MalformedRequestContentRejection

> **Summary:** Akka HTTP 10.7.4 - akka.http.scaladsl.server.MalformedRequestContentRejection
...
# MalformedRequestContentRejection[**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html "Permalink")
...
Source[Rejection.scala](https://github.com/akka/akka-http/tree/v10.7.4/akka-http/src/main/scala/akka/http/scaladsl/server/Rejection.scala#L205)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html#java.io.Serializable), [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.17/scala/Equals.html#scala.Equals), [Rejection](Rejection.html), [javadsl.server.MalformedRequestContentRejection](../../javadsl/server/MalformedRequestContentRejection.html), [javadsl.server.Rejection](../../javadsl/server/Rejection.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. MalformedRequestContentRejection
2. Serializable
3. Product
4. Equals
5. Rejection
6. MalformedRequestContentRejection
7. Rejection
8. AnyRef
9. Any
Implicitly  
...
1. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#<init>(message:String,cause:Throwable):akka.http.scaladsl.server.MalformedRequestContentRejection "Permalink")  new MalformedRequestContentRejection(message: String, cause: Throwable)
### Value Members

1. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from MalformedRequestContentRejection toany2stringadd\[MalformedRequestContentRejection] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (MalformedRequestContentRejection, B)ImplicitThis member is added by an implicit conversion from MalformedRequestContentRejection toArrowAssoc\[MalformedRequestContentRejection] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#cause:Throwable "Permalink")  val cause: Throwable
8. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
9. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (MalformedRequestContentRejection) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): MalformedRequestContentRejectionImplicitThis member is added by an implicit conversion from MalformedRequestContentRejection toEnsuring\[MalformedRequestContentRejection] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (MalformedRequestContentRejection) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): MalformedRequestContentRejectionImplicitThis member is added by an implicit conversion from MalformedRequestContentRejection toEnsuring\[MalformedRequestContentRejection] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): MalformedRequestContentRejectionImplicitThis member is added by an implicit conversion from MalformedRequestContentRejection toEnsuring\[MalformedRequestContentRejection] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): MalformedRequestContentRejectionImplicitThis member is added by an implicit conversion from MalformedRequestContentRejection toEnsuring\[MalformedRequestContentRejection] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#getCause:Throwable "Permalink")  def getCause: ThrowableDefinition ClassesMalformedRequestContentRejection → [MalformedRequestContentRejection](../../javadsl/server/MalformedRequestContentRejection.html)
15. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
17. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#message:String "Permalink")  val message: StringDefinition ClassesMalformedRequestContentRejection → [MalformedRequestContentRejection](../../javadsl/server/MalformedRequestContentRejection.html)
18. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
19. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
20. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
22. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
23. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../../akka/http/scaladsl/server/MalformedRequestContentRejection.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from MalformedRequestContentRejection toStringFormat\[MalformedRequestContentRejection] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
...
### Inherited from [javadsl.server.MalformedRequestContentRejection](../../javadsl/server/MalformedRequestContentRejection.html)
...
### Inherited by implicit conversion any2stringadd fromMalformedRequestContentRejection to any2stringadd\[MalformedRequestContentRejection]

### Inherited by implicit conversion StringFormat fromMalformedRequestContentRejection to StringFormat\[MalformedRequestContentRejection]

### Inherited by implicit conversion Ensuring fromMalformedRequestContentRejection to Ensuring\[MalformedRequestContentRejection]

### Inherited by implicit conversion ArrowAssoc fromMalformedRequestContentRejection to ArrowAssoc\[MalformedRequestContentRejection]
...
---
*Source: [https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/server/MalformedRequestContentRejection.html](https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/server/MalformedRequestContentRejection.html)*