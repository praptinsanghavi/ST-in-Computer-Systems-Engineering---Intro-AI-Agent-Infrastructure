...
scraped_at: '2026-04-06T00:46:03Z'
section: api
site: akka-io
...
[o](ConjunctionMagnet.html "See companion trait")[akka](../../../index.html).[http](../../index.html).[scaladsl](../index.html).[server](index.html)

# [ConjunctionMagnet](ConjunctionMagnet.html "See companion trait")[**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html "Permalink")

### Companion [trait ConjunctionMagnet](ConjunctionMagnet.html "See companion trait")

#### object ConjunctionMagnet

Source[Directive.scala](https://github.com/akka/akka-http/tree/v10.7.4/akka-http/src/main/scala/akka/http/scaladsl/server/Directive.scala#L228)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ConjunctionMagnet
2. AnyRef
...
3. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
4. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
7. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
8. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#fromDirective[L,R](other:akka.http.scaladsl.server.Directive[R])(implicitjoin:akka.http.scaladsl.server.util.TupleOps.Join[L,R]):akka.http.scaladsl.server.ConjunctionMagnet[L]{typeOut=akka.http.scaladsl.server.Directive[join.Out]} "Permalink") implicit  def fromDirective\[L, R](other: [Directive](Directive.html)\[R])(implicit join: [Join](util/TupleOps$$Join.html)\[L, R]): [ConjunctionMagnet](ConjunctionMagnet.html)\[L] { type Out \= akka.http.scaladsl.server.Directive\[join.Out] }
9. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#fromRouteGenerator[T,R<:akka.http.scaladsl.server.Route](generator:T=>R):akka.http.scaladsl.server.ConjunctionMagnet[Unit]{typeOut=akka.http.scaladsl.server.RouteGenerator[T]} "Permalink") implicit  def fromRouteGenerator\[T, R \<: [Route](index.html#Route=akka.http.scaladsl.server.RequestContext=>scala.concurrent.Future[akka.http.scaladsl.server.RouteResult])](generator: (T) \=\> R): [ConjunctionMagnet](ConjunctionMagnet.html)\[[Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)] { type Out \= akka.http.scaladsl.server.RouteGenerator\[T] }
10. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#fromStandardRoute[L](route:akka.http.scaladsl.server.StandardRoute):akka.http.scaladsl.server.ConjunctionMagnet[L]{typeOut=akka.http.scaladsl.server.StandardRoute} "Permalink") implicit  def fromStandardRoute\[L](route: [StandardRoute](StandardRoute.html)): [ConjunctionMagnet](ConjunctionMagnet.html)\[L] { type Out \= akka.http.scaladsl.server.StandardRoute }
11. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
12. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
13. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
14. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
18. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
19. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
20. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
21. [**](../../../../akka/http/scaladsl/server/ConjunctionMagnet$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
