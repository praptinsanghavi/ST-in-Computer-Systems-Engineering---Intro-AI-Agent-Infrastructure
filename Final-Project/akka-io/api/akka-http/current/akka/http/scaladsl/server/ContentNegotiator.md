---
description: Akka HTTP 10.7.4 - akka.http.scaladsl.server.ContentNegotiator
knowledge_type: official_documentation
scraped_at: '2026-04-06T00:46:08Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/server/ContentNegotiator.html
title: Akka HTTP 10.7.4 - akka.http.scaladsl.server.ContentNegotiator
---

# Akka HTTP 10.7.4 - akka.http.scaladsl.server.ContentNegotiator

> **Summary:** Akka HTTP 10.7.4 - akka.http.scaladsl.server.ContentNegotiator
...
[c](ContentNegotiator$.html "See companion object")[akka](../../../index.html).[http](../../index.html).[scaladsl](../index.html).[server](index.html)

# [ContentNegotiator](ContentNegotiator$.html "See companion object")[**](../../../../akka/http/scaladsl/server/ContentNegotiator.html "Permalink")

### Companion [object ContentNegotiator](ContentNegotiator$.html "See companion object")

#### final  class ContentNegotiator extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

Source[ContentNegotation.scala](https://github.com/akka/akka-http/tree/v10.7.4/akka-http/src/main/scala/akka/http/scaladsl/server/ContentNegotation.scala#L94)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)Type Hierarchy****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ContentNegotiator
2. AnyRef
...
1. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#<init>(requestHeaders:Seq[akka.http.scaladsl.model.HttpHeader]):akka.http.scaladsl.server.ContentNegotiator "Permalink")  new ContentNegotiator(requestHeaders: Seq\[[HttpHeader](../model/HttpHeader.html)])
### Value Members

1. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
2. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html###:Int "Permalink") final  def \#\#: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → Any
3. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#+(other:String):String "Permalink")  def \+(other: String): StringImplicitThis member is added by an implicit conversion from ContentNegotiator toany2stringadd\[ContentNegotiator] performed by method any2stringadd in scala.Predef.Definition Classesany2stringadd
4. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#->[B](y:B):(A,B) "Permalink")  def \-\>\[B](y: B): (ContentNegotiator, B)ImplicitThis member is added by an implicit conversion from ContentNegotiator toArrowAssoc\[ContentNegotiator] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@inline()
5. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
6. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
8. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#csn:akka.http.scaladsl.server.CharsetNegotiator "Permalink")  val csn: [CharsetNegotiator](CharsetNegotiator.html)
9. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#ensuring(cond:A=>Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: (ContentNegotiator) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ContentNegotiatorImplicitThis member is added by an implicit conversion from ContentNegotiator toEnsuring\[ContentNegotiator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
10. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#ensuring(cond:A=>Boolean):A "Permalink")  def ensuring(cond: (ContentNegotiator) \=\> [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ContentNegotiatorImplicitThis member is added by an implicit conversion from ContentNegotiator toEnsuring\[ContentNegotiator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
11. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#ensuring(cond:Boolean,msg:=>Any):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean), msg: \=\> [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)): ContentNegotiatorImplicitThis member is added by an implicit conversion from ContentNegotiator toEnsuring\[ContentNegotiator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
12. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#ensuring(cond:Boolean):A "Permalink")  def ensuring(cond: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ContentNegotiatorImplicitThis member is added by an implicit conversion from ContentNegotiator toEnsuring\[ContentNegotiator] performed by method Ensuring in scala.Predef.Definition ClassesEnsuring
13. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
14. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
15. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
16. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
17. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
18. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#mtn:akka.http.scaladsl.server.MediaTypeNegotiator "Permalink")  val mtn: [MediaTypeNegotiator](MediaTypeNegotiator.html)
19. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
20. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
21. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
22. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#pickContentType(alternatives:List[akka.http.scaladsl.server.ContentNegotiator.Alternative]):Option[akka.http.scaladsl.model.ContentType] "Permalink")  def pickContentType(alternatives: List\[[Alternative](ContentNegotiator$$Alternative.html)]): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[[ContentType](../model/ContentType.html)]Picks the best of the given content alternatives given the preferences
...
23. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#qValueFor(alternative:akka.http.scaladsl.server.ContentNegotiator.Alternative):Float "Permalink")  def qValueFor(alternative: [Alternative](ContentNegotiator$$Alternative.html)): [Float](https://www.scala-lang.org/api/2.13.17/scala/Float.html#scala.Float)
24. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
25. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
26. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
27. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
28. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
### Deprecated Value Members

1. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#finalize():Unit "Permalink")  def finalize(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
2. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#formatted(fmtstr:String):String "Permalink")  def formatted(fmtstr: String): StringImplicitThis member is added by an implicit conversion from ContentNegotiator toStringFormat\[ContentNegotiator] performed by method StringFormat in scala.Predef.Definition ClassesStringFormatAnnotations@deprecated @inline() Deprecated*(Since version 2\.12\.16\)* Use `formatString.format(value)` instead of `value.formatted(formatString)`,
or use the `f""` string interpolator. In Java 15 and later, `formatted` resolves to the new method in String which has reversed parameters.
3. [**](../../../../akka/http/scaladsl/server/ContentNegotiator.html#→[B](y:B):(A,B) "Permalink")  def →\[B](y: B): (ContentNegotiator, B)ImplicitThis member is added by an implicit conversion from ContentNegotiator toArrowAssoc\[ContentNegotiator] performed by method ArrowAssoc in scala.Predef.Definition ClassesArrowAssocAnnotations@deprecated Deprecated*(Since version 2\.13\.0\)* Use `->` instead. If you still wish to display it as one character, consider using a font with programming ligatures such as Fira Code.
### Inherited from [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

### Inherited from [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)

### Inherited by implicit conversion any2stringadd fromContentNegotiator to any2stringadd\[ContentNegotiator]

### Inherited by implicit conversion StringFormat fromContentNegotiator to StringFormat\[ContentNegotiator]

### Inherited by implicit conversion Ensuring fromContentNegotiator to Ensuring\[ContentNegotiator]

### Inherited by implicit conversion ArrowAssoc fromContentNegotiator to ArrowAssoc\[ContentNegotiator]
...
---
*Source: [https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/server/ContentNegotiator.html](https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/server/ContentNegotiator.html)*