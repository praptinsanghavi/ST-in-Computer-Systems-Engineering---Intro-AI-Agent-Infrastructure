...
# [MetadataBuilder](MetadataBuilder.html "See companion class")[**](../../../akka/grpc/scaladsl/MetadataBuilder$.html "Permalink")

### Companion [class MetadataBuilder](MetadataBuilder.html "See companion class")

#### object MetadataBuilder

Source[MetadataBuilder.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/scaladsl/MetadataBuilder.scala#L67)Linear SupertypesAnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. MetadataBuilder
2. AnyRef
...
4. [**](../../../akka/grpc/scaladsl/MetadataBuilder$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/grpc/scaladsl/MetadataBuilder$.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
6. [**](../../../akka/grpc/scaladsl/MetadataBuilder$.html#empty:akka.grpc.scaladsl.Metadata "Permalink")  val empty: [Metadata](Metadata.html)An empty Metadata instance, for use as a default.
7. [**](../../../akka/grpc/scaladsl/MetadataBuilder$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
8. [**](../../../akka/grpc/scaladsl/MetadataBuilder$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
9. [**](../../../akka/grpc/scaladsl/MetadataBuilder$.html#fromHeaders(headers:Seq[akka.http.scaladsl.model.HttpHeader]):akka.grpc.scaladsl.Metadata "Permalink")  def fromHeaders(headers: Seq\[HttpHeader]): [Metadata](Metadata.html)Creates a Metadata instance from a sequence of HTTP headers.
...
10. [**](../../../akka/grpc/scaladsl/MetadataBuilder$.html#fromHttpMessage(message:akka.http.scaladsl.model.HttpMessage):akka.grpc.scaladsl.Metadata "Permalink")  def fromHttpMessage(message: HttpMessage): [Metadata](Metadata.html)Creates a Metadata instance from an HTTP message.
