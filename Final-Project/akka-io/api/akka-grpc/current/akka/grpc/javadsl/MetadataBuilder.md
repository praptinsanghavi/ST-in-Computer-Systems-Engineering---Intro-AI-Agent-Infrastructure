...
[c](MetadataBuilder$.html "See companion object")[akka](../../index.html).[grpc](../index.html).[javadsl](index.html)

# [MetadataBuilder](MetadataBuilder$.html "See companion object")[**](../../../akka/grpc/javadsl/MetadataBuilder.html "Permalink")
...
Annotations@ApiMayChange() Source[MetadataBuilder.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/javadsl/MetadataBuilder.scala#L22)Linear SupertypesAnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. MetadataBuilder
2. AnyRef
...
1. [**](../../../akka/grpc/javadsl/MetadataBuilder.html#<init>():akka.grpc.javadsl.MetadataBuilder "Permalink")  new MetadataBuilder()
### Value Members
...
4. [**](../../../akka/grpc/javadsl/MetadataBuilder.html#addBinary(key:String,value:akka.util.ByteString):akka.grpc.javadsl.MetadataBuilder "Permalink")  def addBinary(key: String, value: ByteString): MetadataBuilderAdds a binary entry.
...
5. [**](../../../akka/grpc/javadsl/MetadataBuilder.html#addText(key:String,value:String):akka.grpc.javadsl.MetadataBuilder "Permalink")  def addText(key: String, value: String): MetadataBuilderAdds a string entry.
...
returnsThe updated builder.
6. [**](../../../akka/grpc/javadsl/MetadataBuilder.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../akka/grpc/javadsl/MetadataBuilder.html#build():akka.grpc.javadsl.Metadata "Permalink")  def build(): [Metadata](Metadata.html)Builds the immutable metadata instance.

Builds the immutable metadata instance.

returnsThe instance.
8. [**](../../../akka/grpc/javadsl/MetadataBuilder.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
9. [**](../../../akka/grpc/javadsl/MetadataBuilder.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
10. [**](../../../akka/grpc/javadsl/MetadataBuilder.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
