---
description: Akka gRPC 2.5.10 - akka.grpc.internal.ProtoMarshaller
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:36:20Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/ProtoMarshaller.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.ProtoMarshaller
---

# Akka gRPC 2.5.10 - akka.grpc.internal.ProtoMarshaller

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.ProtoMarshaller
...
# ProtoMarshaller[**](../../../akka/grpc/internal/ProtoMarshaller.html "Permalink")

### 

#### class ProtoMarshaller\[T \<: Message] extends [BaseMarshaller](BaseMarshaller.html)\[T]

INTERNAL API

Annotations@InternalStableApi() Source[Marshallers.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/Marshallers.scala#L39)Linear Supertypes[BaseMarshaller](BaseMarshaller.html)\[T], [WithProtobufSerializer](WithProtobufSerializer.html)\[T], io.grpc.MethodDescriptor.Marshaller\[T], AnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ProtoMarshaller
2. BaseMarshaller
...
1. [**](../../../akka/grpc/internal/ProtoMarshaller.html#<init>(protobufSerializer:akka.grpc.ProtobufSerializer[T]):akka.grpc.internal.ProtoMarshaller[T] "Permalink")  new ProtoMarshaller(protobufSerializer: [ProtobufSerializer](../ProtobufSerializer.html)\[T])
### Value Members

1. [**](../../../akka/grpc/internal/ProtoMarshaller.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/ProtoMarshaller.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/ProtoMarshaller.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/ProtoMarshaller.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/grpc/internal/ProtoMarshaller.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
6. [**](../../../akka/grpc/internal/ProtoMarshaller.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
7. [**](../../../akka/grpc/internal/ProtoMarshaller.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
8. [**](../../../akka/grpc/internal/ProtoMarshaller.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
9. [**](../../../akka/grpc/internal/ProtoMarshaller.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
10. [**](../../../akka/grpc/internal/ProtoMarshaller.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
11. [**](../../../akka/grpc/internal/ProtoMarshaller.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
12. [**](../../../akka/grpc/internal/ProtoMarshaller.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
13. [**](../../../akka/grpc/internal/ProtoMarshaller.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
14. [**](../../../akka/grpc/internal/ProtoMarshaller.html#parse(stream:java.io.InputStream):T "Permalink")  def parse(stream: [InputStream](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/io/InputStream.html#java.io.InputStream)): TDefinition ClassesProtoMarshaller → [BaseMarshaller](BaseMarshaller.html) → Marshaller
15. [**](../../../akka/grpc/internal/ProtoMarshaller.html#protobufSerializer:akka.grpc.ProtobufSerializer[T] "Permalink")  val protobufSerializer: [ProtobufSerializer](../ProtobufSerializer.html)\[T]Definition Classes[BaseMarshaller](BaseMarshaller.html) → [WithProtobufSerializer](WithProtobufSerializer.html)
16. [**](../../../akka/grpc/internal/ProtoMarshaller.html#stream(value:T):java.io.InputStream "Permalink")  def stream(value: T): [InputStream](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/io/InputStream.html#java.io.InputStream)Definition ClassesProtoMarshaller → Marshaller
17. [**](../../../akka/grpc/internal/ProtoMarshaller.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
18. [**](../../../akka/grpc/internal/ProtoMarshaller.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
19. [**](../../../akka/grpc/internal/ProtoMarshaller.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
20. [**](../../../akka/grpc/internal/ProtoMarshaller.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
21. [**](../../../akka/grpc/internal/ProtoMarshaller.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/ProtoMarshaller.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
### Inherited from [BaseMarshaller](BaseMarshaller.html)\[T]

### Inherited from [WithProtobufSerializer](WithProtobufSerializer.html)\[T]

### Inherited from io.grpc.MethodDescriptor.Marshaller\[T]
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/ProtoMarshaller.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/ProtoMarshaller.html)*