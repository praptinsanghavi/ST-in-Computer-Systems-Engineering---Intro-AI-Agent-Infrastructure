---
description: Akka gRPC 2.5.10 - akka.grpc.internal.ClientState
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:35:44Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/ClientState.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.ClientState
---

# Akka gRPC 2.5.10 - akka.grpc.internal.ClientState

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.ClientState
...
# ClientState[**](../../../akka/grpc/internal/ClientState.html "Permalink")
...
Source[ClientState.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/ClientState.scala#L24)Linear SupertypesAnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ClientState
2. AnyRef
...
1. [**](../../../akka/grpc/internal/ClientState.html#<init>(settings:akka.grpc.GrpcClientSettings,log:akka.event.LoggingAdapter)(implicitsys:akka.actor.ClassicActorSystemProvider):akka.grpc.internal.ClientState "Permalink")  new ClientState(settings: [GrpcClientSettings](../GrpcClientSettings.html), log: LoggingAdapter)(implicit sys: ClassicActorSystemProvider)Annotations@InternalStableApi()
### Value Members

1. [**](../../../akka/grpc/internal/ClientState.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/ClientState.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/ClientState.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/ClientState.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/grpc/internal/ClientState.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
6. [**](../../../akka/grpc/internal/ClientState.html#close():scala.concurrent.Future[akka.Done] "Permalink")  def close(): Future\[Done]
7. [**](../../../akka/grpc/internal/ClientState.html#closeCS():java.util.concurrent.CompletionStage[akka.Done] "Permalink")  def closeCS(): [CompletionStage](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[Done]
8. [**](../../../akka/grpc/internal/ClientState.html#closed():scala.concurrent.Future[akka.Done] "Permalink")  def closed(): Future\[Done]
9. [**](../../../akka/grpc/internal/ClientState.html#closedCS():java.util.concurrent.CompletionStage[akka.Done] "Permalink")  def closedCS(): [CompletionStage](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[Done]
10. [**](../../../akka/grpc/internal/ClientState.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
11. [**](../../../akka/grpc/internal/ClientState.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
12. [**](../../../akka/grpc/internal/ClientState.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
13. [**](../../../akka/grpc/internal/ClientState.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
14. [**](../../../akka/grpc/internal/ClientState.html#internalChannel:akka.grpc.internal.InternalChannel "Permalink")  val internalChannel: [InternalChannel](InternalChannel.html)
15. [**](../../../akka/grpc/internal/ClientState.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
16. [**](../../../akka/grpc/internal/ClientState.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
17. [**](../../../akka/grpc/internal/ClientState.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
18. [**](../../../akka/grpc/internal/ClientState.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
19. [**](../../../akka/grpc/internal/ClientState.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
20. [**](../../../akka/grpc/internal/ClientState.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
21. [**](../../../akka/grpc/internal/ClientState.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
22. [**](../../../akka/grpc/internal/ClientState.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../../akka/grpc/internal/ClientState.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/ClientState.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/ClientState.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/ClientState.html)*