---
description: Akka gRPC 2.5.10 - akka.grpc.internal.ServiceDescriptionImpl
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:36:32Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/ServiceDescriptionImpl.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.ServiceDescriptionImpl
---

# Akka gRPC 2.5.10 - akka.grpc.internal.ServiceDescriptionImpl

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.ServiceDescriptionImpl
...
# ServiceDescriptionImpl[**](../../../akka/grpc/internal/ServiceDescriptionImpl.html "Permalink")

### 

#### class ServiceDescriptionImpl extends [ServiceDescription](../ServiceDescription.html)

INTERNAL API

Annotations@InternalApi() Source[ServiceDescriptionImpl.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/ServiceDescriptionImpl.scala#L17)Linear Supertypes[ServiceDescription](../ServiceDescription.html), AnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ServiceDescriptionImpl
...
1. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#<init>(name:String,descriptor:com.google.protobuf.Descriptors.FileDescriptor):akka.grpc.internal.ServiceDescriptionImpl "Permalink")  new ServiceDescriptionImpl(name: String, descriptor: FileDescriptor)
### Value Members

1. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
6. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#descriptor:com.google.protobuf.Descriptors.FileDescriptor "Permalink")  val descriptor: FileDescriptorDefinition ClassesServiceDescriptionImpl → [ServiceDescription](../ServiceDescription.html)
7. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
8. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
9. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
10. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
11. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
12. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#name:String "Permalink")  val name: StringDefinition ClassesServiceDescriptionImpl → [ServiceDescription](../ServiceDescription.html)
13. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
14. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
15. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
16. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
17. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
18. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
19. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
20. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/ServiceDescriptionImpl.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
### Inherited from [ServiceDescription](../ServiceDescription.html)
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/ServiceDescriptionImpl.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/ServiceDescriptionImpl.html)*