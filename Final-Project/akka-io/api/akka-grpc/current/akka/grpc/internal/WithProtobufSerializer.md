---
description: Akka gRPC 2.5.10 - akka.grpc.internal.WithProtobufSerializer
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:36:36Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/WithProtobufSerializer.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.WithProtobufSerializer
---

# Akka gRPC 2.5.10 - akka.grpc.internal.WithProtobufSerializer

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.WithProtobufSerializer
...
# WithProtobufSerializer[**](../../../akka/grpc/internal/WithProtobufSerializer.html "Permalink")

### 

#### trait WithProtobufSerializer\[T] extends AnyRef

Source[WithProtobufSerializer.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/WithProtobufSerializer.scala#L9)Linear SupertypesAnyRef, AnyKnown Subclasses[BaseMarshaller](BaseMarshaller.html), [Marshaller](Marshaller.html), [ProtoMarshaller](ProtoMarshaller.html)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. WithProtobufSerializer
2. AnyRef
3. Any
1. Hide All
2. Show All
...
1. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#protobufSerializer:akka.grpc.ProtobufSerializer[T] "Permalink") abstract  def protobufSerializer: [ProtobufSerializer](../ProtobufSerializer.html)\[T]
### Concrete Value Members

1. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/WithProtobufSerializer.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
6. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
7. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
8. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
9. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
10. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
11. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
12. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
13. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
14. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
15. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
16. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
17. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
18. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/WithProtobufSerializer.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/WithProtobufSerializer.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/WithProtobufSerializer.html)*