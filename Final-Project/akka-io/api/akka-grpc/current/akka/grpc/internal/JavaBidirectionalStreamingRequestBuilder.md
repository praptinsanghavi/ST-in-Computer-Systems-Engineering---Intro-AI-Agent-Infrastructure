---
description: Akka gRPC 2.5.10 - akka.grpc.internal.JavaBidirectionalStreamingRequestBuilder
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:36:06Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.JavaBidirectionalStreamingRequestBuilder
---

# Akka gRPC 2.5.10 - akka.grpc.internal.JavaBidirectionalStreamingRequestBuilder

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.JavaBidirectionalStreamingRequestBuilder
...
# JavaBidirectionalStreamingRequestBuilder[**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html "Permalink")

### 

#### final  class JavaBidirectionalStreamingRequestBuilder\[I, O] extends [StreamResponseRequestBuilder](../javadsl/StreamResponseRequestBuilder.html)\[Source\[I, NotUsed], O] with [MetadataOperations](MetadataOperations.html)\[JavaBidirectionalStreamingRequestBuilder\[I, O]]

INTERNAL API

Annotations@InternalApi() Source[RequestBuilderImpl.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/RequestBuilderImpl.scala#L512)Linear Supertypes[MetadataOperations](MetadataOperations.html)\[JavaBidirectionalStreamingRequestBuilder\[I, O]], [StreamResponseRequestBuilder](../javadsl/StreamResponseRequestBuilder.html)\[Source\[I, NotUsed], O], AnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. JavaBidirectionalStreamingRequestBuilder
...
1. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#<init>(descriptor:io.grpc.MethodDescriptor[I,O],channel:akka.grpc.internal.InternalChannel,defaultOptions:io.grpc.CallOptions,settings:akka.grpc.GrpcClientSettings)(implicitec:scala.concurrent.ExecutionContext):akka.grpc.internal.JavaBidirectionalStreamingRequestBuilder[I,O] "Permalink")  new JavaBidirectionalStreamingRequestBuilder(descriptor: MethodDescriptor\[I, O], channel: [InternalChannel](InternalChannel.html), defaultOptions: CallOptions, settings: [GrpcClientSettings](../GrpcClientSettings.html))(implicit ec: ExecutionContext)Annotations@InternalStableApi()
2. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#<init>(descriptor:io.grpc.MethodDescriptor[I,O],channel:akka.grpc.internal.InternalChannel,defaultOptions:io.grpc.CallOptions,settings:akka.grpc.GrpcClientSettings,headers:akka.grpc.internal.MetadataImpl)(implicitec:scala.concurrent.ExecutionContext):akka.grpc.internal.JavaBidirectionalStreamingRequestBuilder[I,O] "Permalink")  new JavaBidirectionalStreamingRequestBuilder(descriptor: MethodDescriptor\[I, O], channel: [InternalChannel](InternalChannel.html), defaultOptions: CallOptions, settings: [GrpcClientSettings](../GrpcClientSettings.html), headers: [MetadataImpl](MetadataImpl.html))(implicit ec: ExecutionContext)
3. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#<init>(descriptor:io.grpc.MethodDescriptor[I,O],fqMethodName:String,channel:akka.grpc.internal.InternalChannel,defaultOptions:io.grpc.CallOptions,settings:akka.grpc.GrpcClientSettings)(implicitec:scala.concurrent.ExecutionContext):akka.grpc.internal.JavaBidirectionalStreamingRequestBuilder[I,O] "Permalink")  new JavaBidirectionalStreamingRequestBuilder(descriptor: MethodDescriptor\[I, O], fqMethodName: String, channel: [InternalChannel](InternalChannel.html), defaultOptions: CallOptions, settings: [GrpcClientSettings](../GrpcClientSettings.html))(implicit ec: ExecutionContext)Annotations@deprecated @InternalStableApi() Deprecated*(Since version 1\.1\.0\)* fqMethodName was removed since it can be derived from the descriptor
### Value Members

1. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#addHeader(key:String,value:akka.util.ByteString):T "Permalink")  def addHeader(key: String, value: ByteString): JavaBidirectionalStreamingRequestBuilder\[I, O]Definition Classes[MetadataOperations](MetadataOperations.html)
5. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#addHeader(key:String,value:String):T "Permalink")  def addHeader(key: String, value: String): JavaBidirectionalStreamingRequestBuilder\[I, O]Definition Classes[MetadataOperations](MetadataOperations.html)
6. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
8. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
9. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
10. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
11. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
12. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#headers:akka.grpc.internal.MetadataImpl "Permalink")  val headers: [MetadataImpl](MetadataImpl.html)Definition ClassesJavaBidirectionalStreamingRequestBuilder → [MetadataOperations](MetadataOperations.html)
13. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#invoke(request:akka.stream.javadsl.Source[I,akka.NotUsed]):akka.stream.javadsl.Source[O,akka.NotUsed] "Permalink")  def invoke(request: Source\[I, NotUsed]): Source\[O, NotUsed]Invoke the gRPC method with the additional metadata added

Invoke the gRPC method with the additional metadata added

Definition ClassesJavaBidirectionalStreamingRequestBuilder → [StreamResponseRequestBuilder](../javadsl/StreamResponseRequestBuilder.html)
14. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#invokeWithMetadata(source:akka.stream.javadsl.Source[I,akka.NotUsed]):akka.stream.javadsl.Source[O,java.util.concurrent.CompletionStage[akka.grpc.GrpcResponseMetadata]] "Permalink")  def invokeWithMetadata(source: Source\[I, NotUsed]): Source\[O, [CompletionStage](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[[GrpcResponseMetadata](../GrpcResponseMetadata.html)]]Invoke the gRPC method with the additional metadata added and provide access to response metadata

Invoke the gRPC method with the additional metadata added and provide access to response metadata

Definition ClassesJavaBidirectionalStreamingRequestBuilder → [StreamResponseRequestBuilder](../javadsl/StreamResponseRequestBuilder.html)
15. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
16. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
17. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
18. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
19. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#setDeadline(deadline:java.time.Duration):akka.grpc.internal.JavaBidirectionalStreamingRequestBuilder[I,O] "Permalink")  def setDeadline(deadline: [Duration](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/time/Duration.html#java.time.Duration)): JavaBidirectionalStreamingRequestBuilder\[I, O]Set the deadline for this call
...
Definition ClassesJavaBidirectionalStreamingRequestBuilder → [StreamResponseRequestBuilder](../javadsl/StreamResponseRequestBuilder.html)
20. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#withHeaders(headers:akka.grpc.internal.MetadataImpl):akka.grpc.internal.JavaBidirectionalStreamingRequestBuilder[I,O] "Permalink")  def withHeaders(headers: [MetadataImpl](MetadataImpl.html)): JavaBidirectionalStreamingRequestBuilder\[I, O]Definition ClassesJavaBidirectionalStreamingRequestBuilder → [MetadataOperations](MetadataOperations.html)
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
### Inherited from [MetadataOperations](MetadataOperations.html)\[JavaBidirectionalStreamingRequestBuilder\[I, O]]

### Inherited from [StreamResponseRequestBuilder](../javadsl/StreamResponseRequestBuilder.html)\[Source\[I, NotUsed], O]
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/JavaBidirectionalStreamingRequestBuilder.html)*