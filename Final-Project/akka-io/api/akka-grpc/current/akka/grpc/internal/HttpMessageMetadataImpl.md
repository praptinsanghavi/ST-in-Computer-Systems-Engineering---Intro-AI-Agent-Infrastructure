---
description: Akka gRPC 2.5.10 - akka.grpc.internal.HttpMessageMetadataImpl
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:36:03Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/HttpMessageMetadataImpl.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.HttpMessageMetadataImpl
---

# Akka gRPC 2.5.10 - akka.grpc.internal.HttpMessageMetadataImpl

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.HttpMessageMetadataImpl
...
# HttpMessageMetadataImpl[**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html "Permalink")

### 

#### class HttpMessageMetadataImpl extends [HeaderMetadataImpl](HeaderMetadataImpl.html)

This class wraps an HttpMessage with the Metadata interface.

Source[MetadataImpl.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/MetadataImpl.scala#L223)Linear Supertypes[HeaderMetadataImpl](HeaderMetadataImpl.html), [Metadata](../scaladsl/Metadata.html), AnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#<init>(message:akka.http.scaladsl.model.HttpMessage):akka.grpc.internal.HttpMessageMetadataImpl "Permalink")  new HttpMessageMetadataImpl(message: HttpMessage)messageThe HTTP message to wrap.
### Value Members

1. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#asList:List[(String,akka.grpc.scaladsl.MetadataEntry)] "Permalink")  def asList: List\[(String, [MetadataEntry](../scaladsl/MetadataEntry.html))]returnsA list of (key, MetadataEntry) tuples.

Definition Classes[HeaderMetadataImpl](HeaderMetadataImpl.html) → [Metadata](../scaladsl/Metadata.html)
6. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#asMap:Map[String,List[akka.grpc.scaladsl.MetadataEntry]] "Permalink")  def asMap: Map\[String, List\[[MetadataEntry](../scaladsl/MetadataEntry.html)]]returnsThe metadata as a map.

Definition Classes[HeaderMetadataImpl](HeaderMetadataImpl.html) → [Metadata](../scaladsl/Metadata.html)
7. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#attribute[T](key:akka.http.scaladsl.model.AttributeKey[T]):Option[T] "Permalink")  def attribute\[T](key: AttributeKey\[T]): Option\[T]Get an attribute from the underlying akka\-http message associated with this metadata.
...
Definition ClassesHttpMessageMetadataImpl → [HeaderMetadataImpl](HeaderMetadataImpl.html) → [Metadata](../scaladsl/Metadata.html)
8. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
9. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
10. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
11. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#getBinary(key:String):Option[akka.util.ByteString] "Permalink")  def getBinary(key: String): Option\[ByteString]returnsThe binary header value for `key` if one exists, if the same key has multiple values the last occurrence
 that is a text key is used.

Definition Classes[HeaderMetadataImpl](HeaderMetadataImpl.html) → [Metadata](../scaladsl/Metadata.html)
12. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
13. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#getText(key:String):Option[String] "Permalink")  def getText(key: String): Option\[String]returnsThe text header value for `key` if one exists, if the same key has multiple values the last occurrence
 that is a text key is used.

Definition Classes[HeaderMetadataImpl](HeaderMetadataImpl.html) → [Metadata](../scaladsl/Metadata.html)
14. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
15. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
16. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
17. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
18. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
19. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
20. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#toString():String "Permalink")  def toString(): StringDefinition Classes[HeaderMetadataImpl](HeaderMetadataImpl.html) → AnyRef → Any
21. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
22. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/HttpMessageMetadataImpl.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
### Inherited from [HeaderMetadataImpl](HeaderMetadataImpl.html)
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/HttpMessageMetadataImpl.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/HttpMessageMetadataImpl.html)*