---
description: Akka gRPC 2.5.10 - akka.grpc.internal.GrpcProtocolWebBase
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:35:53Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/GrpcProtocolWebBase.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.GrpcProtocolWebBase
---

# Akka gRPC 2.5.10 - akka.grpc.internal.GrpcProtocolWebBase

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.GrpcProtocolWebBase
...
# GrpcProtocolWebBase[**](../../../akka/grpc/internal/GrpcProtocolWebBase.html "Permalink")

### 

#### abstract  class GrpcProtocolWebBase extends [AbstractGrpcProtocol](AbstractGrpcProtocol.html)

Source[GrpcProtocolWeb.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/GrpcProtocolWeb.scala#L16)Linear Supertypes[AbstractGrpcProtocol](AbstractGrpcProtocol.html), [GrpcProtocol](../GrpcProtocol.html), AnyRef, AnyKnown Subclasses[GrpcProtocolWeb](GrpcProtocolWeb$.html), [GrpcProtocolWebText](GrpcProtocolWebText$.html)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. GrpcProtocolWebBase
...
1. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#<init>(subType:String):akka.grpc.internal.GrpcProtocolWebBase "Permalink")  new GrpcProtocolWebBase(subType: String)
### Abstract Value Members

1. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#postEncode(frame:akka.util.ByteString):akka.util.ByteString "Permalink") abstract  def postEncode(frame: ByteString): ByteStringAttributesprotected
2. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#preDecodeFlow:akka.stream.scaladsl.Flow[akka.util.ByteString,akka.util.ByteString,akka.NotUsed] "Permalink") abstract  def preDecodeFlow: Flow\[ByteString, ByteString, NotUsed]Attributesprotected
3. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#preDecodeStrict(frame:akka.util.ByteString):akka.util.ByteString "Permalink") abstract  def preDecodeStrict(frame: ByteString): ByteStringAttributesprotected
### Concrete Value Members

1. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
6. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#contentType:akka.http.scaladsl.model.ContentType.Binary "Permalink")  val contentType: BinaryINTERNAL API
...
7. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
8. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
9. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
10. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
11. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
12. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#mediaTypes:Set[akka.http.javadsl.model.MediaType] "Permalink")  val mediaTypes: Set\[MediaType]INTERNAL API
...
Definition Classes[AbstractGrpcProtocol](AbstractGrpcProtocol.html) → [GrpcProtocol](../GrpcProtocol.html)
13. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
14. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#newReader(codec:akka.grpc.internal.Codec):akka.grpc.GrpcProtocol.GrpcProtocolReader "Permalink")  def newReader(codec: [Codec](Codec.html)): [GrpcProtocolReader](../GrpcProtocol$$GrpcProtocolReader.html)Obtains a reader for this protocol.
...
Definition Classes[AbstractGrpcProtocol](AbstractGrpcProtocol.html) → [GrpcProtocol](../GrpcProtocol.html)
15. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#newWriter(codec:akka.grpc.internal.Codec):akka.grpc.GrpcProtocol.GrpcProtocolWriter "Permalink")  def newWriter(codec: [Codec](Codec.html)): [GrpcProtocolWriter](../GrpcProtocol$$GrpcProtocolWriter.html)Obtains a writer for this protocol:
...
Definition Classes[AbstractGrpcProtocol](AbstractGrpcProtocol.html) → [GrpcProtocol](../GrpcProtocol.html)
16. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
17. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
18. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#reader(codec:akka.grpc.internal.Codec):akka.grpc.GrpcProtocol.GrpcProtocolReader "Permalink")  def reader(codec: [Codec](Codec.html)): [GrpcProtocolReader](../GrpcProtocol$$GrpcProtocolReader.html)Attributesprotected Definition ClassesGrpcProtocolWebBase → [AbstractGrpcProtocol](AbstractGrpcProtocol.html)
19. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
20. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
21. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
22. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
24. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#writer(codec:akka.grpc.internal.Codec):akka.grpc.GrpcProtocol.GrpcProtocolWriter "Permalink")  def writer(codec: [Codec](Codec.html)): [GrpcProtocolWriter](../GrpcProtocol$$GrpcProtocolWriter.html)Attributesprotected Definition ClassesGrpcProtocolWebBase → [AbstractGrpcProtocol](AbstractGrpcProtocol.html)
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/GrpcProtocolWebBase.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/GrpcProtocolWebBase.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/GrpcProtocolWebBase.html)*