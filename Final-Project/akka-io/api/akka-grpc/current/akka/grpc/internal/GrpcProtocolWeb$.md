---
description: Akka gRPC 2.5.10 - akka.grpc.internal.GrpcProtocolWeb
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:35:51Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/GrpcProtocolWeb$.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.GrpcProtocolWeb
---

# Akka gRPC 2.5.10 - akka.grpc.internal.GrpcProtocolWeb

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.GrpcProtocolWeb
...
# GrpcProtocolWeb[**](../../../akka/grpc/internal/GrpcProtocolWeb$.html "Permalink")

### 

#### object GrpcProtocolWeb extends [GrpcProtocolWebBase](GrpcProtocolWebBase.html)
...
Source[GrpcProtocolWeb.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/GrpcProtocolWeb.scala#L85)Linear Supertypes[GrpcProtocolWebBase](GrpcProtocolWebBase.html), [AbstractGrpcProtocol](AbstractGrpcProtocol.html), [GrpcProtocol](../GrpcProtocol.html), AnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. GrpcProtocolWeb
...
1. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
6. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#contentType:akka.http.scaladsl.model.ContentType.Binary "Permalink")  val contentType: BinaryINTERNAL API
...
7. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
8. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
9. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
10. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
11. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
12. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#mediaTypes:Set[akka.http.javadsl.model.MediaType] "Permalink")  val mediaTypes: Set\[MediaType]INTERNAL API
...
Definition Classes[AbstractGrpcProtocol](AbstractGrpcProtocol.html) → [GrpcProtocol](../GrpcProtocol.html)
13. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
14. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#newReader(codec:akka.grpc.internal.Codec):akka.grpc.GrpcProtocol.GrpcProtocolReader "Permalink")  def newReader(codec: [Codec](Codec.html)): [GrpcProtocolReader](../GrpcProtocol$$GrpcProtocolReader.html)Obtains a reader for this protocol.
...
Definition Classes[AbstractGrpcProtocol](AbstractGrpcProtocol.html) → [GrpcProtocol](../GrpcProtocol.html)
15. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#newWriter(codec:akka.grpc.internal.Codec):akka.grpc.GrpcProtocol.GrpcProtocolWriter "Permalink")  def newWriter(codec: [Codec](Codec.html)): [GrpcProtocolWriter](../GrpcProtocol$$GrpcProtocolWriter.html)Obtains a writer for this protocol:
...
Definition Classes[AbstractGrpcProtocol](AbstractGrpcProtocol.html) → [GrpcProtocol](../GrpcProtocol.html)
16. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
17. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
18. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#postEncode(frame:akka.util.ByteString):akka.util.ByteString "Permalink") final  def postEncode(frame: ByteString): ByteStringDefinition ClassesGrpcProtocolWeb → [GrpcProtocolWebBase](GrpcProtocolWebBase.html)
19. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#preDecodeFlow:akka.stream.scaladsl.Flow[akka.util.ByteString,akka.util.ByteString,akka.NotUsed] "Permalink") final  def preDecodeFlow: Flow\[ByteString, ByteString, NotUsed]Definition ClassesGrpcProtocolWeb → [GrpcProtocolWebBase](GrpcProtocolWebBase.html)
20. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#preDecodeStrict(frame:akka.util.ByteString):akka.util.ByteString "Permalink") final  def preDecodeStrict(frame: ByteString): ByteStringDefinition ClassesGrpcProtocolWeb → [GrpcProtocolWebBase](GrpcProtocolWebBase.html)
21. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#reader(codec:akka.grpc.internal.Codec):akka.grpc.GrpcProtocol.GrpcProtocolReader "Permalink")  def reader(codec: [Codec](Codec.html)): [GrpcProtocolReader](../GrpcProtocol$$GrpcProtocolReader.html)Attributesprotected Definition Classes[GrpcProtocolWebBase](GrpcProtocolWebBase.html) → [AbstractGrpcProtocol](AbstractGrpcProtocol.html)
22. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
23. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
24. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
25. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
27. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#writer(codec:akka.grpc.internal.Codec):akka.grpc.GrpcProtocol.GrpcProtocolWriter "Permalink")  def writer(codec: [Codec](Codec.html)): [GrpcProtocolWriter](../GrpcProtocol$$GrpcProtocolWriter.html)Attributesprotected Definition Classes[GrpcProtocolWebBase](GrpcProtocolWebBase.html) → [AbstractGrpcProtocol](AbstractGrpcProtocol.html)
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/GrpcProtocolWeb$.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/GrpcProtocolWeb$.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/GrpcProtocolWeb$.html)*