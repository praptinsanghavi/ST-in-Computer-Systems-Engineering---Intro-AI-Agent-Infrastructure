---
description: Akka gRPC 2.5.10 - akka.grpc.internal.ServerReflectionImpl
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:36:31Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/ServerReflectionImpl$.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.ServerReflectionImpl
---

# Akka gRPC 2.5.10 - akka.grpc.internal.ServerReflectionImpl

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.ServerReflectionImpl
...
[o](ServerReflectionImpl.html "See companion class")[akka](../../index.html).[grpc](../index.html).[internal](index.html)

# [ServerReflectionImpl](ServerReflectionImpl.html "See companion class")[**](../../../akka/grpc/internal/ServerReflectionImpl$.html "Permalink")

### Companion [class ServerReflectionImpl](ServerReflectionImpl.html "See companion class")

#### object ServerReflectionImpl

INTERNAL API

Annotations@InternalApi() Source[ServerReflectionImpl.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/ServerReflectionImpl.scala#L107)Linear SupertypesAnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#apply(fileDescriptors:Seq[com.google.protobuf.Descriptors.FileDescriptor],services:List[String]):akka.grpc.internal.ServerReflectionImpl "Permalink")  def apply(fileDescriptors: Seq\[FileDescriptor], services: List\[String]): [ServerReflectionImpl](ServerReflectionImpl.html)
5. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
6. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
7. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#containsExtension(container:String,number:Int,fileDesc:com.google.protobuf.Descriptors.FileDescriptor):Boolean "Permalink")  def containsExtension(container: String, number: Int, fileDesc: FileDescriptor): Boolean
8. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#containsSymbol(symbol:String,fileDesc:com.google.protobuf.Descriptors.FileDescriptor):Boolean "Permalink")  def containsSymbol(symbol: String, fileDesc: FileDescriptor): Boolean
9. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
10. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
11. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#findExtensionNumbersForContainingType(container:String,fileDescriptors:Map[String,com.google.protobuf.Descriptors.FileDescriptor]):List[Int] "Permalink")  def findExtensionNumbersForContainingType(container: String, fileDescriptors: Map\[String, FileDescriptor]): List\[Int]
12. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#findFileDescForExtension(container:String,number:Int,fileDescriptors:Map[String,com.google.protobuf.Descriptors.FileDescriptor]):Option[com.google.protobuf.Descriptors.FileDescriptor] "Permalink")  def findFileDescForExtension(container: String, number: Int, fileDescriptors: Map\[String, FileDescriptor]): Option\[FileDescriptor]
13. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#findFileDescForSymbol(symbol:String,fileDescriptors:Map[String,com.google.protobuf.Descriptors.FileDescriptor]):Option[com.google.protobuf.Descriptors.FileDescriptor] "Permalink")  def findFileDescForSymbol(symbol: String, fileDescriptors: Map\[String, FileDescriptor]): Option\[FileDescriptor]
14. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
15. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
16. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
17. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
18. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
19. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
20. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#splitNext(name:String):(String,String) "Permalink")  def splitNext(name: String): (String, String)
21. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
23. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
25. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/ServerReflectionImpl$.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/ServerReflectionImpl$.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/ServerReflectionImpl$.html)*