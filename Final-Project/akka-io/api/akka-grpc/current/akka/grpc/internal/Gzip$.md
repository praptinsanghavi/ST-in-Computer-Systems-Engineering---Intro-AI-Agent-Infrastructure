---
description: Akka gRPC 2.5.10 - akka.grpc.internal.Gzip
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:35:58Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/Gzip$.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.Gzip
---

# Akka gRPC 2.5.10 - akka.grpc.internal.Gzip

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.Gzip
...
# Gzip[**](../../../akka/grpc/internal/Gzip$.html "Permalink")

### 

#### object Gzip extends [Codec](Codec.html)

Source[Gzip.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/Gzip.scala#L12)Linear Supertypes[Codec](Codec.html), AnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Gzip
2. Codec
...
1. [**](../../../akka/grpc/internal/Gzip$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/Gzip$.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/Gzip$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/Gzip$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/grpc/internal/Gzip$.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
6. [**](../../../akka/grpc/internal/Gzip$.html#compress(uncompressed:akka.util.ByteString):akka.util.ByteString "Permalink")  def compress(uncompressed: ByteString): ByteStringDefinition ClassesGzip → [Codec](Codec.html)
7. [**](../../../akka/grpc/internal/Gzip$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
8. [**](../../../akka/grpc/internal/Gzip$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
9. [**](../../../akka/grpc/internal/Gzip$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
10. [**](../../../akka/grpc/internal/Gzip$.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
11. [**](../../../akka/grpc/internal/Gzip$.html#isCompressed:Boolean "Permalink")  def isCompressed: BooleanDefinition Classes[Codec](Codec.html)
12. [**](../../../akka/grpc/internal/Gzip$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
13. [**](../../../akka/grpc/internal/Gzip$.html#name:String "Permalink")  val name: StringDefinition ClassesGzip → [Codec](Codec.html)
14. [**](../../../akka/grpc/internal/Gzip$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
15. [**](../../../akka/grpc/internal/Gzip$.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
16. [**](../../../akka/grpc/internal/Gzip$.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
17. [**](../../../akka/grpc/internal/Gzip$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
18. [**](../../../akka/grpc/internal/Gzip$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
19. [**](../../../akka/grpc/internal/Gzip$.html#uncompress(compressedBitSet:Boolean,bytes:akka.util.ByteString):akka.util.ByteString "Permalink")  def uncompress(compressedBitSet: Boolean, bytes: ByteString): ByteStringProcess the given frame bytes, uncompress if the compression bit is set.
...
Definition ClassesGzip → [Codec](Codec.html)
20. [**](../../../akka/grpc/internal/Gzip$.html#uncompress(compressed:akka.util.ByteString):akka.util.ByteString "Permalink")  def uncompress(compressed: ByteString): ByteStringDefinition ClassesGzip → [Codec](Codec.html)
21. [**](../../../akka/grpc/internal/Gzip$.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
22. [**](../../../akka/grpc/internal/Gzip$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../../akka/grpc/internal/Gzip$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/Gzip$.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/Gzip$.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/Gzip$.html)*