---
description: Akka gRPC 2.5.10 - akka.grpc.internal.MetadataOperations
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:36:16Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/MetadataOperations.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.MetadataOperations
---

# Akka gRPC 2.5.10 - akka.grpc.internal.MetadataOperations

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.MetadataOperations
...
t[akka](../../index.html).[grpc](../index.html).[internal](index.html)

# MetadataOperations[**](../../../akka/grpc/internal/MetadataOperations.html "Permalink")

### 

#### trait MetadataOperations\[T \<: MetadataOperations\[T]] extends AnyRef

INTERNAL API

Annotations@InternalApi() Source[RequestBuilderImpl.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/RequestBuilderImpl.scala#L566)Linear SupertypesAnyRef, AnyKnown Subclasses[JavaBidirectionalStreamingRequestBuilder](JavaBidirectionalStreamingRequestBuilder.html), [JavaClientStreamingRequestBuilder](JavaClientStreamingRequestBuilder.html), [JavaServerStreamingRequestBuilder](JavaServerStreamingRequestBuilder.html), [JavaUnaryRequestBuilder](JavaUnaryRequestBuilder.html), [ScalaBidirectionalStreamingRequestBuilder](ScalaBidirectionalStreamingRequestBuilder.html), [ScalaClientStreamingRequestBuilder](ScalaClientStreamingRequestBuilder.html), [ScalaServerStreamingRequestBuilder](ScalaServerStreamingRequestBuilder.html), [ScalaUnaryRequestBuilder](ScalaUnaryRequestBuilder.html)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. MetadataOperations
2. AnyRef
3. Any
1. Hide All
2. Show All
...
1. [**](../../../akka/grpc/internal/MetadataOperations.html#headers:akka.grpc.internal.MetadataImpl "Permalink") abstract  def headers: [MetadataImpl](MetadataImpl.html)
2. [**](../../../akka/grpc/internal/MetadataOperations.html#withHeaders(headers:akka.grpc.internal.MetadataImpl):T "Permalink") abstract  def withHeaders(headers: [MetadataImpl](MetadataImpl.html)): T
### Concrete Value Members

1. [**](../../../akka/grpc/internal/MetadataOperations.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/MetadataOperations.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/MetadataOperations.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/MetadataOperations.html#addHeader(key:String,value:akka.util.ByteString):T "Permalink")  def addHeader(key: String, value: ByteString): T
5. [**](../../../akka/grpc/internal/MetadataOperations.html#addHeader(key:String,value:String):T "Permalink")  def addHeader(key: String, value: String): T
6. [**](../../../akka/grpc/internal/MetadataOperations.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../akka/grpc/internal/MetadataOperations.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
8. [**](../../../akka/grpc/internal/MetadataOperations.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
9. [**](../../../akka/grpc/internal/MetadataOperations.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
10. [**](../../../akka/grpc/internal/MetadataOperations.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
11. [**](../../../akka/grpc/internal/MetadataOperations.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
12. [**](../../../akka/grpc/internal/MetadataOperations.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
13. [**](../../../akka/grpc/internal/MetadataOperations.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
14. [**](../../../akka/grpc/internal/MetadataOperations.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
15. [**](../../../akka/grpc/internal/MetadataOperations.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
16. [**](../../../akka/grpc/internal/MetadataOperations.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
17. [**](../../../akka/grpc/internal/MetadataOperations.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
18. [**](../../../akka/grpc/internal/MetadataOperations.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
19. [**](../../../akka/grpc/internal/MetadataOperations.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
20. [**](../../../akka/grpc/internal/MetadataOperations.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/MetadataOperations.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/MetadataOperations.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/MetadataOperations.html)*