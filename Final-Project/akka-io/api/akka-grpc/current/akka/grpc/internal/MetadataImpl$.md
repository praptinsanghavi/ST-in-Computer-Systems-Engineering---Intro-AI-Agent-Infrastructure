---
description: Akka gRPC 2.5.10 - akka.grpc.internal.MetadataImpl
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:36:17Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/MetadataImpl$.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.MetadataImpl
---

# Akka gRPC 2.5.10 - akka.grpc.internal.MetadataImpl

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.MetadataImpl
...
[o](MetadataImpl.html "See companion class")[akka](../../index.html).[grpc](../index.html).[internal](index.html)

# [MetadataImpl](MetadataImpl.html "See companion class")[**](../../../akka/grpc/internal/MetadataImpl$.html "Permalink")

### Companion [class MetadataImpl](MetadataImpl.html "See companion class")

#### object MetadataImpl

INTERNAL API

Annotations@InternalApi() Source[MetadataImpl.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/MetadataImpl.scala#L27)Linear SupertypesAnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. MetadataImpl
2. AnyRef
...
1. [**](../../../akka/grpc/internal/MetadataImpl$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/MetadataImpl$.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/MetadataImpl$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/MetadataImpl$.html#BINARY_SUFFIX:String "Permalink")  val BINARY\_SUFFIX: String
5. [**](../../../akka/grpc/internal/MetadataImpl$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
6. [**](../../../akka/grpc/internal/MetadataImpl$.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
7. [**](../../../akka/grpc/internal/MetadataImpl$.html#decodeBinaryHeader(value:String):akka.util.ByteString "Permalink")  def decodeBinaryHeader(value: String): ByteString
8. [**](../../../akka/grpc/internal/MetadataImpl$.html#empty:akka.grpc.internal.MetadataImpl "Permalink")  val empty: [MetadataImpl](MetadataImpl.html)
9. [**](../../../akka/grpc/internal/MetadataImpl$.html#encodeBinaryHeader(bytes:akka.util.ByteString):String "Permalink")  def encodeBinaryHeader(bytes: ByteString): String
10. [**](../../../akka/grpc/internal/MetadataImpl$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
11. [**](../../../akka/grpc/internal/MetadataImpl$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
12. [**](../../../akka/grpc/internal/MetadataImpl$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
13. [**](../../../akka/grpc/internal/MetadataImpl$.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
14. [**](../../../akka/grpc/internal/MetadataImpl$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
15. [**](../../../akka/grpc/internal/MetadataImpl$.html#javaMetadataFromGoogleGrpcMetadata(mutableMetadata:io.grpc.Metadata):akka.grpc.javadsl.Metadata "Permalink")  def javaMetadataFromGoogleGrpcMetadata(mutableMetadata: Metadata): [Metadata](../javadsl/Metadata.html)
16. [**](../../../akka/grpc/internal/MetadataImpl$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
17. [**](../../../akka/grpc/internal/MetadataImpl$.html#niceStringRep(metadata:Map[String,List[akka.grpc.scaladsl.MetadataEntry]]):String "Permalink")  def niceStringRep(metadata: Map\[String, List\[[MetadataEntry](../scaladsl/MetadataEntry.html)]]): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)
18. [**](../../../akka/grpc/internal/MetadataImpl$.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
19. [**](../../../akka/grpc/internal/MetadataImpl$.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
20. [**](../../../akka/grpc/internal/MetadataImpl$.html#scalaMetadataFromGoogleGrpcMetadata(mutableMetadata:io.grpc.Metadata):akka.grpc.scaladsl.Metadata "Permalink")  def scalaMetadataFromGoogleGrpcMetadata(mutableMetadata: Metadata): [Metadata](../scaladsl/Metadata.html)
21. [**](../../../akka/grpc/internal/MetadataImpl$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
22. [**](../../../akka/grpc/internal/MetadataImpl$.html#toMap(list:List[(String,akka.grpc.scaladsl.MetadataEntry)]):Map[String,List[akka.grpc.scaladsl.MetadataEntry]] "Permalink")  def toMap(list: List\[(String, [MetadataEntry](../scaladsl/MetadataEntry.html))]): Map\[String, List\[[MetadataEntry](../scaladsl/MetadataEntry.html)]]
23. [**](../../../akka/grpc/internal/MetadataImpl$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
24. [**](../../../akka/grpc/internal/MetadataImpl$.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
25. [**](../../../akka/grpc/internal/MetadataImpl$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
26. [**](../../../akka/grpc/internal/MetadataImpl$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/MetadataImpl$.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/MetadataImpl$.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/MetadataImpl$.html)*