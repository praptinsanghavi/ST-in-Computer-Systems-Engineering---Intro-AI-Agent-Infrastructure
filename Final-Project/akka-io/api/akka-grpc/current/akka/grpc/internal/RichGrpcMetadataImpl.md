---
description: Akka gRPC 2.5.10 - akka.grpc.internal.RichGrpcMetadataImpl
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:36:24Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/RichGrpcMetadataImpl.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.RichGrpcMetadataImpl
---

# Akka gRPC 2.5.10 - akka.grpc.internal.RichGrpcMetadataImpl

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.RichGrpcMetadataImpl
...
# RichGrpcMetadataImpl[**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html "Permalink")

### 

#### class RichGrpcMetadataImpl extends [GrpcMetadataImpl](GrpcMetadataImpl.html) with [MetadataStatus](../scaladsl/MetadataStatus.html)

Source[MetadataImpl.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/MetadataImpl.scala#L291)Linear Supertypes[MetadataStatus](../scaladsl/MetadataStatus.html), [GrpcMetadataImpl](GrpcMetadataImpl.html), [Metadata](../scaladsl/Metadata.html), AnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#<init>(delegate:io.grpc.Status,meta:io.grpc.Metadata):akka.grpc.internal.RichGrpcMetadataImpl "Permalink")  new RichGrpcMetadataImpl(delegate: Status, meta: Metadata)
### Value Members

1. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#asList:List[(String,akka.grpc.scaladsl.MetadataEntry)] "Permalink")  def asList: List\[(String, [MetadataEntry](../scaladsl/MetadataEntry.html))]returnsA list of (key, MetadataEntry) tuples.

Definition Classes[GrpcMetadataImpl](GrpcMetadataImpl.html) → [Metadata](../scaladsl/Metadata.html)
6. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#asMap:Map[String,List[akka.grpc.scaladsl.MetadataEntry]] "Permalink")  def asMap: Map\[String, List\[[MetadataEntry](../scaladsl/MetadataEntry.html)]]returnsThe metadata as a map.

Definition Classes[GrpcMetadataImpl](GrpcMetadataImpl.html) → [Metadata](../scaladsl/Metadata.html)
7. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#attribute[T](key:akka.http.scaladsl.model.AttributeKey[T]):Option[T] "Permalink")  def attribute\[T](key: AttributeKey\[T]): Option\[T]Get an attribute from the underlying akka\-http message associated with this metadata.
...
Definition Classes[GrpcMetadataImpl](GrpcMetadataImpl.html) → [Metadata](../scaladsl/Metadata.html)
8. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
9. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#code:Int "Permalink")  def code: IntDefinition ClassesRichGrpcMetadataImpl → [MetadataStatus](../scaladsl/MetadataStatus.html)
10. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#details:Seq[com.google.protobuf.any.Any] "Permalink")  lazy val details: Seq\[Any]Definition ClassesRichGrpcMetadataImpl → [MetadataStatus](../scaladsl/MetadataStatus.html)
11. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
12. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
13. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#getBinary(key:String):Option[akka.util.ByteString] "Permalink")  def getBinary(key: String): Option\[ByteString]returnsThe binary header value for `key` if one exists, if the same key has multiple values the last occurrence
 that is a text key is used.

Definition Classes[GrpcMetadataImpl](GrpcMetadataImpl.html) → [Metadata](../scaladsl/Metadata.html)
14. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
15. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#getParsedDetails[K<:scalapb.GeneratedMessage](implicitcompanion:scalapb.GeneratedMessageCompanion[K]):Seq[K] "Permalink")  def getParsedDetails\[K \<: GeneratedMessage](implicit companion: GeneratedMessageCompanion\[K]): Seq\[K]Definition ClassesRichGrpcMetadataImpl → [MetadataStatus](../scaladsl/MetadataStatus.html)
16. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#getText(key:String):Option[String] "Permalink")  def getText(key: String): Option\[String]returnsThe text header value for `key` if one exists, if the same key has multiple values the last occurrence
 that is a text key is used.

Definition Classes[GrpcMetadataImpl](GrpcMetadataImpl.html) → [Metadata](../scaladsl/Metadata.html)
17. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
18. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
19. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#message:String "Permalink")  def message: StringDefinition ClassesRichGrpcMetadataImpl → [MetadataStatus](../scaladsl/MetadataStatus.html)
20. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
21. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
22. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
23. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#raw:Option[io.grpc.Metadata] "Permalink")  val raw: Option\[Metadata]INTERNAL API

INTERNAL API

Definition ClassesRichGrpcMetadataImpl → [Metadata](../scaladsl/Metadata.html)
24. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#status:com.google.rpc.Status "Permalink")  lazy val status: StatusDefinition ClassesRichGrpcMetadataImpl → [MetadataStatus](../scaladsl/MetadataStatus.html)
25. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
26. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#toString():String "Permalink")  def toString(): StringDefinition Classes[GrpcMetadataImpl](GrpcMetadataImpl.html) → AnyRef → Any
27. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
28. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
29. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/RichGrpcMetadataImpl.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
### Inherited from [MetadataStatus](../scaladsl/MetadataStatus.html)

### Inherited from [GrpcMetadataImpl](GrpcMetadataImpl.html)
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/RichGrpcMetadataImpl.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/RichGrpcMetadataImpl.html)*