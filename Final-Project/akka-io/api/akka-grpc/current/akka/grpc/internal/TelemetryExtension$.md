---
description: Akka gRPC 2.5.10 - akka.grpc.internal.TelemetryExtension
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:36:34Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/TelemetryExtension$.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.TelemetryExtension
---

# Akka gRPC 2.5.10 - akka.grpc.internal.TelemetryExtension

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.TelemetryExtension
...
# TelemetryExtension[**](../../../akka/grpc/internal/TelemetryExtension$.html "Permalink")
...
Annotations@InternalStableApi() Source[TelemetrySpi.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/TelemetrySpi.scala#L26)Linear SupertypesExtensionIdProvider, ExtensionId\[TelemetryExtensionImpl], AnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. TelemetryExtension
...
1. [**](../../../akka/grpc/internal/TelemetryExtension$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/TelemetryExtension$.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/TelemetryExtension$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/TelemetryExtension$.html#apply(system:akka.actor.ClassicActorSystemProvider):T "Permalink")  def apply(system: ClassicActorSystemProvider): TelemetryExtensionImplDefinition ClassesExtensionId
5. [**](../../../akka/grpc/internal/TelemetryExtension$.html#apply(system:akka.actor.ActorSystem):T "Permalink")  def apply(system: ActorSystem): TelemetryExtensionImplDefinition ClassesExtensionId
6. [**](../../../akka/grpc/internal/TelemetryExtension$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../akka/grpc/internal/TelemetryExtension$.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
8. [**](../../../akka/grpc/internal/TelemetryExtension$.html#createExtension(system:akka.actor.ExtendedActorSystem):akka.grpc.internal.TelemetryExtensionImpl "Permalink")  def createExtension(system: ExtendedActorSystem): TelemetryExtensionImplDefinition ClassesTelemetryExtension → ExtensionId
9. [**](../../../akka/grpc/internal/TelemetryExtension$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
10. [**](../../../akka/grpc/internal/TelemetryExtension$.html#equals(other:Any):Boolean "Permalink") final  def equals(other: Any): BooleanDefinition ClassesExtensionId → AnyRef → Any
11. [**](../../../akka/grpc/internal/TelemetryExtension$.html#get(system:akka.actor.ClassicActorSystemProvider):akka.grpc.internal.TelemetryExtensionImpl "Permalink")  def get(system: ClassicActorSystemProvider): TelemetryExtensionImplDefinition ClassesTelemetryExtension → ExtensionId
12. [**](../../../akka/grpc/internal/TelemetryExtension$.html#get(system:akka.actor.ActorSystem):akka.grpc.internal.TelemetryExtensionImpl "Permalink")  def get(system: ActorSystem): TelemetryExtensionImplJava API

Java API

Definition ClassesTelemetryExtension → ExtensionId
13. [**](../../../akka/grpc/internal/TelemetryExtension$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
14. [**](../../../akka/grpc/internal/TelemetryExtension$.html#hashCode():Int "Permalink") final  def hashCode(): IntDefinition ClassesExtensionId → AnyRef → Any
15. [**](../../../akka/grpc/internal/TelemetryExtension$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
16. [**](../../../akka/grpc/internal/TelemetryExtension$.html#lookup:akka.grpc.internal.TelemetryExtension.type "Permalink")  def lookup: TelemetryExtensionDefinition ClassesTelemetryExtension → ExtensionIdProvider
17. [**](../../../akka/grpc/internal/TelemetryExtension$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
18. [**](../../../akka/grpc/internal/TelemetryExtension$.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
19. [**](../../../akka/grpc/internal/TelemetryExtension$.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
20. [**](../../../akka/grpc/internal/TelemetryExtension$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../../akka/grpc/internal/TelemetryExtension$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../../akka/grpc/internal/TelemetryExtension$.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../../akka/grpc/internal/TelemetryExtension$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../../akka/grpc/internal/TelemetryExtension$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/TelemetryExtension$.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
### Inherited from ExtensionIdProvider

### Inherited from ExtensionId\[TelemetryExtensionImpl]
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/TelemetryExtension$.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/TelemetryExtension$.html)*