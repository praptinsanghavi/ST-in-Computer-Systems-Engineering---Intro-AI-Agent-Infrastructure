---
description: Akka gRPC 2.5.10 - akka.grpc.internal.GrpcRequestHelpers
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:35:52Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/GrpcRequestHelpers$.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.GrpcRequestHelpers
---

# Akka gRPC 2.5.10 - akka.grpc.internal.GrpcRequestHelpers

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.GrpcRequestHelpers
...
# GrpcRequestHelpers[**](../../../akka/grpc/internal/GrpcRequestHelpers$.html "Permalink")

### 

#### object GrpcRequestHelpers

Annotations@InternalApi() Source[GrpcRequestHelpers.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/GrpcRequestHelpers.scala#L23)Linear SupertypesAnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. GrpcRequestHelpers
2. AnyRef
3. Any
1. Hide All
2. Show All
...
1. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#apply[T](uri:akka.http.scaladsl.model.Uri,headers:Seq[akka.http.scaladsl.model.HttpHeader],e:akka.stream.scaladsl.Source[T,akka.NotUsed],eHandler:akka.actor.ActorSystem=>PartialFunction[Throwable,akka.grpc.Trailers])(implicitm:akka.grpc.ProtobufSerializer[T],implicitwriter:akka.grpc.GrpcProtocol.GrpcProtocolWriter,implicitsystem:akka.actor.ClassicActorSystemProvider):akka.http.scaladsl.model.HttpRequest "Permalink")  def apply\[T](uri: Uri, headers: Seq\[HttpHeader], e: Source\[T, NotUsed], eHandler: (ActorSystem) \=\> PartialFunction\[Throwable, [Trailers](../Trailers.html)] \= [GrpcExceptionHandler.defaultMapper](../../index.html))(implicit m: [ProtobufSerializer](../ProtobufSerializer.html)\[T], writer: [GrpcProtocolWriter](../GrpcProtocol$$GrpcProtocolWriter.html), system: ClassicActorSystemProvider): HttpRequest
5. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
6. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
7. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
8. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
9. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
10. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
11. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
12. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
13. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
14. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
15. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
16. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
17. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
18. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
19. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/GrpcRequestHelpers$.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/GrpcRequestHelpers$.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/GrpcRequestHelpers$.html)*