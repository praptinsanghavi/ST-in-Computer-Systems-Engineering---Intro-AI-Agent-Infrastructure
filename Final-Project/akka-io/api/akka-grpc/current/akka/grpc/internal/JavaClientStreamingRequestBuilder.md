---
description: Akka gRPC 2.5.10 - akka.grpc.internal.JavaClientStreamingRequestBuilder
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:36:08Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/JavaClientStreamingRequestBuilder.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.JavaClientStreamingRequestBuilder
---

# Akka gRPC 2.5.10 - akka.grpc.internal.JavaClientStreamingRequestBuilder

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.JavaClientStreamingRequestBuilder
...
- JavaClientStreamingRequestBuilder
...
# JavaClientStreamingRequestBuilder[**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html "Permalink")

### 

#### final  class JavaClientStreamingRequestBuilder\[I, O] extends [SingleResponseRequestBuilder](../javadsl/SingleResponseRequestBuilder.html)\[Source\[I, NotUsed], O] with [MetadataOperations](MetadataOperations.html)\[JavaClientStreamingRequestBuilder\[I, O]]

INTERNAL API

Annotations@InternalApi() Source[RequestBuilderImpl.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/RequestBuilderImpl.scala#L274)Linear Supertypes[MetadataOperations](MetadataOperations.html)\[JavaClientStreamingRequestBuilder\[I, O]], [SingleResponseRequestBuilder](../javadsl/SingleResponseRequestBuilder.html)\[Source\[I, NotUsed], O], AnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. JavaClientStreamingRequestBuilder
...
1. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#<init>(descriptor:io.grpc.MethodDescriptor[I,O],channel:akka.grpc.internal.InternalChannel,defaultOptions:io.grpc.CallOptions,settings:akka.grpc.GrpcClientSettings,headers:akka.grpc.internal.MetadataImpl)(implicitmat:akka.stream.Materializer,implicitec:scala.concurrent.ExecutionContext):akka.grpc.internal.JavaClientStreamingRequestBuilder[I,O] "Permalink")  new JavaClientStreamingRequestBuilder(descriptor: MethodDescriptor\[I, O], channel: [InternalChannel](InternalChannel.html), defaultOptions: CallOptions, settings: [GrpcClientSettings](../GrpcClientSettings.html), headers: [MetadataImpl](MetadataImpl.html))(implicit mat: Materializer, ec: ExecutionContext)
2. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#<init>(descriptor:io.grpc.MethodDescriptor[I,O],channel:akka.grpc.internal.InternalChannel,defaultOptions:io.grpc.CallOptions,settings:akka.grpc.GrpcClientSettings)(implicitmat:akka.stream.Materializer,implicitec:scala.concurrent.ExecutionContext):akka.grpc.internal.JavaClientStreamingRequestBuilder[I,O] "Permalink")  new JavaClientStreamingRequestBuilder(descriptor: MethodDescriptor\[I, O], channel: [InternalChannel](InternalChannel.html), defaultOptions: CallOptions, settings: [GrpcClientSettings](../GrpcClientSettings.html))(implicit mat: Materializer, ec: ExecutionContext)Annotations@InternalStableApi()
3. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#<init>(descriptor:io.grpc.MethodDescriptor[I,O],channel:akka.grpc.internal.InternalChannel,defaultOptions:io.grpc.CallOptions,settings:akka.grpc.GrpcClientSettings,headers:akka.grpc.internal.MetadataImpl,retrySettings:Option[akka.pattern.RetrySettings])(implicitmat:akka.stream.Materializer,implicitec:scala.concurrent.ExecutionContext):akka.grpc.internal.JavaClientStreamingRequestBuilder[I,O] "Permalink")  new JavaClientStreamingRequestBuilder(descriptor: MethodDescriptor\[I, O], channel: [InternalChannel](InternalChannel.html), defaultOptions: CallOptions, settings: [GrpcClientSettings](../GrpcClientSettings.html), headers: [MetadataImpl](MetadataImpl.html), retrySettings: Option\[RetrySettings])(implicit mat: Materializer, ec: ExecutionContext)
4. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#<init>(descriptor:io.grpc.MethodDescriptor[I,O],fqMethodName:String,channel:akka.grpc.internal.InternalChannel,defaultOptions:io.grpc.CallOptions,settings:akka.grpc.GrpcClientSettings)(implicitmat:akka.stream.Materializer,implicitec:scala.concurrent.ExecutionContext):akka.grpc.internal.JavaClientStreamingRequestBuilder[I,O] "Permalink")  new JavaClientStreamingRequestBuilder(descriptor: MethodDescriptor\[I, O], fqMethodName: String, channel: [InternalChannel](InternalChannel.html), defaultOptions: CallOptions, settings: [GrpcClientSettings](../GrpcClientSettings.html))(implicit mat: Materializer, ec: ExecutionContext)Annotations@deprecated @InternalStableApi() Deprecated*(Since version 1\.1\.0\)* fqMethodName was removed since it can be derived from the descriptor
### Value Members

1. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#addHeader(key:String,value:akka.util.ByteString):T "Permalink")  def addHeader(key: String, value: ByteString): JavaClientStreamingRequestBuilder\[I, O]Definition Classes[MetadataOperations](MetadataOperations.html)
5. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#addHeader(key:String,value:String):T "Permalink")  def addHeader(key: String, value: String): JavaClientStreamingRequestBuilder\[I, O]Definition Classes[MetadataOperations](MetadataOperations.html)
6. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
8. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
9. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
10. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
11. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
12. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#headers:akka.grpc.internal.MetadataImpl "Permalink")  val headers: [MetadataImpl](MetadataImpl.html)Definition ClassesJavaClientStreamingRequestBuilder → [MetadataOperations](MetadataOperations.html)
13. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#invoke(request:akka.stream.javadsl.Source[I,akka.NotUsed]):java.util.concurrent.CompletionStage[O] "Permalink")  def invoke(request: Source\[I, NotUsed]): [CompletionStage](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[O]Invoke the gRPC method with the additional metadata added

Invoke the gRPC method with the additional metadata added

Definition ClassesJavaClientStreamingRequestBuilder → [SingleResponseRequestBuilder](../javadsl/SingleResponseRequestBuilder.html)
14. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#invokeWithMetadata(request:akka.stream.javadsl.Source[I,akka.NotUsed]):java.util.concurrent.CompletionStage[akka.grpc.GrpcSingleResponse[O]] "Permalink")  def invokeWithMetadata(request: Source\[I, NotUsed]): [CompletionStage](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[[GrpcSingleResponse](../GrpcSingleResponse.html)\[O]]Invoke the gRPC method with the additional metadata added and provide access to response metadata

Invoke the gRPC method with the additional metadata added and provide access to response metadata

Definition ClassesJavaClientStreamingRequestBuilder → [SingleResponseRequestBuilder](../javadsl/SingleResponseRequestBuilder.html)
15. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
16. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
17. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
18. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
19. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#setDeadline(deadline:java.time.Duration):akka.grpc.internal.JavaClientStreamingRequestBuilder[I,O] "Permalink")  def setDeadline(deadline: [Duration](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/time/Duration.html#java.time.Duration)): JavaClientStreamingRequestBuilder\[I, O]Set the deadline for this call
...
Definition ClassesJavaClientStreamingRequestBuilder → [SingleResponseRequestBuilder](../javadsl/SingleResponseRequestBuilder.html)
20. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#withHeaders(headers:akka.grpc.internal.MetadataImpl):akka.grpc.internal.JavaClientStreamingRequestBuilder[I,O] "Permalink")  def withHeaders(headers: [MetadataImpl](MetadataImpl.html)): JavaClientStreamingRequestBuilder\[I, O]Definition ClassesJavaClientStreamingRequestBuilder → [MetadataOperations](MetadataOperations.html)
26. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#withRetry(maxRetries:Int):akka.grpc.internal.JavaClientStreamingRequestBuilder[I,O] "Permalink")  def withRetry(maxRetries: Int): JavaClientStreamingRequestBuilder\[I, O]Set the retry settings for this call.
...
Definition ClassesJavaClientStreamingRequestBuilder → [SingleResponseRequestBuilder](../javadsl/SingleResponseRequestBuilder.html)
27. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#withRetry(retrySettings:akka.pattern.RetrySettings):akka.grpc.internal.JavaClientStreamingRequestBuilder[I,O] "Permalink")  def withRetry(retrySettings: RetrySettings): JavaClientStreamingRequestBuilder\[I, O]Use these retry settings to retry if the call fails.
...
1. [**](../../../akka/grpc/internal/JavaClientStreamingRequestBuilder.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
### Inherited from [MetadataOperations](MetadataOperations.html)\[JavaClientStreamingRequestBuilder\[I, O]]

### Inherited from [SingleResponseRequestBuilder](../javadsl/SingleResponseRequestBuilder.html)\[Source\[I, NotUsed], O]
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/JavaClientStreamingRequestBuilder.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/JavaClientStreamingRequestBuilder.html)*