---
description: Akka gRPC 2.5.10 - akka.grpc.internal.Codecs
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:35:42Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/Codecs$.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.Codecs
---

# Akka gRPC 2.5.10 - akka.grpc.internal.Codecs

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.Codecs
...
# Codecs[**](../../../akka/grpc/internal/Codecs$.html "Permalink")

### 

#### object Codecs

Source[Codecs.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/Codecs.scala#L15)Linear SupertypesAnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Codecs
2. AnyRef
...
1. [**](../../../akka/grpc/internal/Codecs$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/Codecs$.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/Codecs$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/Codecs$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/grpc/internal/Codecs$.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
6. [**](../../../akka/grpc/internal/Codecs$.html#detect(encoding:Option[String]):scala.util.Try[akka.grpc.internal.Codec] "Permalink")  def detect(encoding: Option\[String]): Try\[[Codec](Codec.html)]Determines the `Message-Encoding` specified in a gRPC stream to be unmarshalled.

Determines the `Message-Encoding` specified in a gRPC stream to be unmarshalled.

encodingthe specified message encoding.

returnsthe specified codec to uncompress data frame bodies with, [Identity](Identity$.html) if no encoding was specified, or Failure if an unsupported encoding was specified.
7. [**](../../../akka/grpc/internal/Codecs$.html#detect(message:akka.http.javadsl.model.HttpMessage):scala.util.Try[akka.grpc.internal.Codec] "Permalink")  def detect(message: HttpMessage): Try\[[Codec](Codec.html)]Determines the `Message-Encoding` specified in a message.

Determines the `Message-Encoding` specified in a message.

messagethe gRPC message

returnsthe specified codec to uncompress data frame bodies with, [Identity](Identity$.html) if no encoding was specified, or Failure if an unsupported encoding was specified.
8. [**](../../../akka/grpc/internal/Codecs$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
9. [**](../../../akka/grpc/internal/Codecs$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
10. [**](../../../akka/grpc/internal/Codecs$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
11. [**](../../../akka/grpc/internal/Codecs$.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
12. [**](../../../akka/grpc/internal/Codecs$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
13. [**](../../../akka/grpc/internal/Codecs$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
14. [**](../../../akka/grpc/internal/Codecs$.html#negotiate(request:akka.http.javadsl.model.HttpRequest):akka.grpc.internal.Codec "Permalink")  def negotiate(request: HttpRequest): [Codec](Codec.html)Determines the message encoding to use for a server response to a client.

Determines the message encoding to use for a server response to a client.

requestthe gRPC client request.

returnsa codec to compress data frame bodies with, which will be [Identity](Identity$.html) unless the client specifies support for another supported encoding.
15. [**](../../../akka/grpc/internal/Codecs$.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
16. [**](../../../akka/grpc/internal/Codecs$.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
17. [**](../../../akka/grpc/internal/Codecs$.html#supportedCodecs:Seq[akka.grpc.internal.Codec] "Permalink")  val supportedCodecs: Seq\[[Codec](Codec.html)]
18. [**](../../../akka/grpc/internal/Codecs$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
19. [**](../../../akka/grpc/internal/Codecs$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
20. [**](../../../akka/grpc/internal/Codecs$.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
21. [**](../../../akka/grpc/internal/Codecs$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
22. [**](../../../akka/grpc/internal/Codecs$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/Codecs$.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/Codecs$.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/Codecs$.html)*