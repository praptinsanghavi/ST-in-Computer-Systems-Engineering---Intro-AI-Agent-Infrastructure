---
description: Akka gRPC 2.5.10 - akka.grpc.internal.NettyClientUtils
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:36:20Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/NettyClientUtils$.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.NettyClientUtils
---

# Akka gRPC 2.5.10 - akka.grpc.internal.NettyClientUtils

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.NettyClientUtils
...
# NettyClientUtils[**](../../../akka/grpc/internal/NettyClientUtils$.html "Permalink")
...
Annotations@InternalApi() Source[NettyClientUtils.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/NettyClientUtils.scala#L50)Linear SupertypesAnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. NettyClientUtils
2. AnyRef
...
1. [**](../../../akka/grpc/internal/NettyClientUtils$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/NettyClientUtils$.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/NettyClientUtils$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/NettyClientUtils$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/grpc/internal/NettyClientUtils$.html#callOptions(settings:akka.grpc.GrpcClientSettings):io.grpc.CallOptions "Permalink")  def callOptions(settings: [GrpcClientSettings](../GrpcClientSettings.html)): CallOptionsINTERNAL API

INTERNAL API

Annotations@InternalApi()
6. [**](../../../akka/grpc/internal/NettyClientUtils$.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
7. [**](../../../akka/grpc/internal/NettyClientUtils$.html#createChannel(settings:akka.grpc.GrpcClientSettings,log:akka.event.LoggingAdapter)(implicitec:scala.concurrent.ExecutionContext,implicitsystem:akka.actor.ActorSystem):akka.grpc.internal.InternalChannel "Permalink")  def createChannel(settings: [GrpcClientSettings](../GrpcClientSettings.html), log: LoggingAdapter)(implicit ec: ExecutionContext, system: ActorSystem): [InternalChannel](InternalChannel.html)INTERNAL API

INTERNAL API

Annotations@InternalApi()
8. [**](../../../akka/grpc/internal/NettyClientUtils$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
9. [**](../../../akka/grpc/internal/NettyClientUtils$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
10. [**](../../../akka/grpc/internal/NettyClientUtils$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
11. [**](../../../akka/grpc/internal/NettyClientUtils$.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
12. [**](../../../akka/grpc/internal/NettyClientUtils$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
13. [**](../../../akka/grpc/internal/NettyClientUtils$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
14. [**](../../../akka/grpc/internal/NettyClientUtils$.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
15. [**](../../../akka/grpc/internal/NettyClientUtils$.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
16. [**](../../../akka/grpc/internal/NettyClientUtils$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
17. [**](../../../akka/grpc/internal/NettyClientUtils$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
18. [**](../../../akka/grpc/internal/NettyClientUtils$.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
19. [**](../../../akka/grpc/internal/NettyClientUtils$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
20. [**](../../../akka/grpc/internal/NettyClientUtils$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/NettyClientUtils$.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/NettyClientUtils$.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/NettyClientUtils$.html)*