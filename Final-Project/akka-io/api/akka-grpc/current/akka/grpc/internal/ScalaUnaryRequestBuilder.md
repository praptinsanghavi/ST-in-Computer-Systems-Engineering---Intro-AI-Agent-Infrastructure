---
description: Akka gRPC 2.5.10 - akka.grpc.internal.ScalaUnaryRequestBuilder
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:36:29Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/ScalaUnaryRequestBuilder.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.ScalaUnaryRequestBuilder
---

# Akka gRPC 2.5.10 - akka.grpc.internal.ScalaUnaryRequestBuilder

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.ScalaUnaryRequestBuilder
...
# ScalaUnaryRequestBuilder[**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html "Permalink")

### 

#### final  class ScalaUnaryRequestBuilder\[I, O] extends [SingleResponseRequestBuilder](../scaladsl/SingleResponseRequestBuilder.html)\[I, O] with [MetadataOperations](MetadataOperations.html)\[ScalaUnaryRequestBuilder\[I, O]]

INTERNAL API

Annotations@InternalApi() Source[RequestBuilderImpl.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/RequestBuilderImpl.scala#L29)Linear Supertypes[MetadataOperations](MetadataOperations.html)\[ScalaUnaryRequestBuilder\[I, O]], [SingleResponseRequestBuilder](../scaladsl/SingleResponseRequestBuilder.html)\[I, O], AnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#<init>(descriptor:io.grpc.MethodDescriptor[I,O],channel:akka.grpc.internal.InternalChannel,defaultOptions:io.grpc.CallOptions,settings:akka.grpc.GrpcClientSettings)(implicitec:scala.concurrent.ExecutionContext):akka.grpc.internal.ScalaUnaryRequestBuilder[I,O] "Permalink")  new ScalaUnaryRequestBuilder(descriptor: MethodDescriptor\[I, O], channel: [InternalChannel](InternalChannel.html), defaultOptions: CallOptions, settings: [GrpcClientSettings](../GrpcClientSettings.html))(implicit ec: ExecutionContext)Annotations@InternalStableApi()
2. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#<init>(descriptor:io.grpc.MethodDescriptor[I,O],channel:akka.grpc.internal.InternalChannel,defaultOptions:io.grpc.CallOptions,settings:akka.grpc.GrpcClientSettings,headers:akka.grpc.internal.MetadataImpl)(implicitec:scala.concurrent.ExecutionContext):akka.grpc.internal.ScalaUnaryRequestBuilder[I,O] "Permalink")  new ScalaUnaryRequestBuilder(descriptor: MethodDescriptor\[I, O], channel: [InternalChannel](InternalChannel.html), defaultOptions: CallOptions, settings: [GrpcClientSettings](../GrpcClientSettings.html), headers: [MetadataImpl](MetadataImpl.html))(implicit ec: ExecutionContext)
3. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#<init>(descriptor:io.grpc.MethodDescriptor[I,O],channel:akka.grpc.internal.InternalChannel,defaultOptions:io.grpc.CallOptions,settings:akka.grpc.GrpcClientSettings,headers:akka.grpc.internal.MetadataImpl,retrySettings:Option[akka.pattern.RetrySettings])(implicitec:scala.concurrent.ExecutionContext,implicitsystem:akka.actor.ClassicActorSystemProvider):akka.grpc.internal.ScalaUnaryRequestBuilder[I,O] "Permalink")  new ScalaUnaryRequestBuilder(descriptor: MethodDescriptor\[I, O], channel: [InternalChannel](InternalChannel.html), defaultOptions: CallOptions, settings: [GrpcClientSettings](../GrpcClientSettings.html), headers: [MetadataImpl](MetadataImpl.html), retrySettings: Option\[RetrySettings])(implicit ec: ExecutionContext, system: ClassicActorSystemProvider)
### Value Members

1. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#addHeader(key:String,value:akka.util.ByteString):T "Permalink")  def addHeader(key: String, value: ByteString): ScalaUnaryRequestBuilder\[I, O]Definition Classes[MetadataOperations](MetadataOperations.html)
5. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#addHeader(key:String,value:String):T "Permalink")  def addHeader(key: String, value: String): ScalaUnaryRequestBuilder\[I, O]Definition Classes[MetadataOperations](MetadataOperations.html)
6. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
8. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
9. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
10. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
11. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
12. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#headers:akka.grpc.internal.MetadataImpl "Permalink")  val headers: [MetadataImpl](MetadataImpl.html)Definition ClassesScalaUnaryRequestBuilder → [MetadataOperations](MetadataOperations.html)
13. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#invoke(request:I):scala.concurrent.Future[O] "Permalink")  def invoke(request: I): Future\[O]Invoke the gRPC method with the additional metadata added

Invoke the gRPC method with the additional metadata added

Definition ClassesScalaUnaryRequestBuilder → [SingleResponseRequestBuilder](../scaladsl/SingleResponseRequestBuilder.html)
14. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#invokeWithMetadata(request:I):scala.concurrent.Future[akka.grpc.GrpcSingleResponse[O]] "Permalink")  def invokeWithMetadata(request: I): Future\[[GrpcSingleResponse](../GrpcSingleResponse.html)\[O]]Invoke the gRPC method with the additional metadata added and provide access to response metadata

Invoke the gRPC method with the additional metadata added and provide access to response metadata

Definition ClassesScalaUnaryRequestBuilder → [SingleResponseRequestBuilder](../scaladsl/SingleResponseRequestBuilder.html)
15. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
16. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
17. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
18. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
19. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#setDeadline(deadline:scala.concurrent.duration.Duration):akka.grpc.scaladsl.SingleResponseRequestBuilder[I,O] "Permalink")  def setDeadline(deadline: Duration): [SingleResponseRequestBuilder](../scaladsl/SingleResponseRequestBuilder.html)\[I, O]Set the deadline for this call
...
Definition ClassesScalaUnaryRequestBuilder → [SingleResponseRequestBuilder](../scaladsl/SingleResponseRequestBuilder.html)
20. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
21. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
22. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
24. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
25. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#withHeaders(headers:akka.grpc.internal.MetadataImpl):akka.grpc.internal.ScalaUnaryRequestBuilder[I,O] "Permalink")  def withHeaders(headers: [MetadataImpl](MetadataImpl.html)): ScalaUnaryRequestBuilder\[I, O]Definition ClassesScalaUnaryRequestBuilder → [MetadataOperations](MetadataOperations.html)
26. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#withRetry(maxRetries:Int):akka.grpc.scaladsl.SingleResponseRequestBuilder[I,O] "Permalink")  def withRetry(maxRetries: Int): [SingleResponseRequestBuilder](../scaladsl/SingleResponseRequestBuilder.html)\[I, O]Set the retry settings for this call.
...
Definition ClassesScalaUnaryRequestBuilder → [SingleResponseRequestBuilder](../scaladsl/SingleResponseRequestBuilder.html)
27. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#withRetry(retrySettings:akka.pattern.RetrySettings):akka.grpc.scaladsl.SingleResponseRequestBuilder[I,O] "Permalink")  def withRetry(retrySettings: RetrySettings): [SingleResponseRequestBuilder](../scaladsl/SingleResponseRequestBuilder.html)\[I, O]Use these retry settings to retry if the call fails.
...
1. [**](../../../akka/grpc/internal/ScalaUnaryRequestBuilder.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
### Inherited from [MetadataOperations](MetadataOperations.html)\[ScalaUnaryRequestBuilder\[I, O]]

### Inherited from [SingleResponseRequestBuilder](../scaladsl/SingleResponseRequestBuilder.html)\[I, O]
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/ScalaUnaryRequestBuilder.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/ScalaUnaryRequestBuilder.html)*