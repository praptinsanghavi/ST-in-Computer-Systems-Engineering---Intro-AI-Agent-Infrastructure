---
description: Akka gRPC 2.5.10 - akka.grpc.internal.Identity
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:36:05Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/Identity$.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.Identity
---

# Akka gRPC 2.5.10 - akka.grpc.internal.Identity

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.Identity
...
# Identity[**](../../../akka/grpc/internal/Identity$.html "Permalink")

### 

#### object Identity extends [Codec](Codec.html)

Source[Identity.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/Identity.scala#L10)Linear Supertypes[Codec](Codec.html), AnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Identity
2. Codec
...
1. [**](../../../akka/grpc/internal/Identity$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/Identity$.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/Identity$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/Identity$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/grpc/internal/Identity$.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
6. [**](../../../akka/grpc/internal/Identity$.html#compress(bytes:akka.util.ByteString):akka.util.ByteString "Permalink")  def compress(bytes: ByteString): ByteStringDefinition ClassesIdentity → [Codec](Codec.html)
7. [**](../../../akka/grpc/internal/Identity$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
8. [**](../../../akka/grpc/internal/Identity$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
9. [**](../../../akka/grpc/internal/Identity$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
10. [**](../../../akka/grpc/internal/Identity$.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
11. [**](../../../akka/grpc/internal/Identity$.html#isCompressed:Boolean "Permalink")  def isCompressed: BooleanDefinition Classes[Codec](Codec.html)
12. [**](../../../akka/grpc/internal/Identity$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
13. [**](../../../akka/grpc/internal/Identity$.html#name:String "Permalink")  val name: [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesIdentity → [Codec](Codec.html)
14. [**](../../../akka/grpc/internal/Identity$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
15. [**](../../../akka/grpc/internal/Identity$.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
16. [**](../../../akka/grpc/internal/Identity$.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
17. [**](../../../akka/grpc/internal/Identity$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
18. [**](../../../akka/grpc/internal/Identity$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
19. [**](../../../akka/grpc/internal/Identity$.html#uncompress(compressedBitSet:Boolean,bytes:akka.util.ByteString):akka.util.ByteString "Permalink")  def uncompress(compressedBitSet: Boolean, bytes: ByteString): ByteStringProcess the given frame bytes, uncompress if the compression bit is set.
...
Definition ClassesIdentity → [Codec](Codec.html)
20. [**](../../../akka/grpc/internal/Identity$.html#uncompress(bytes:akka.util.ByteString):akka.util.ByteString "Permalink")  def uncompress(bytes: ByteString): ByteStringDefinition ClassesIdentity → [Codec](Codec.html)
21. [**](../../../akka/grpc/internal/Identity$.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
22. [**](../../../akka/grpc/internal/Identity$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
23. [**](../../../akka/grpc/internal/Identity$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/Identity$.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
### Inherited from [Codec](Codec.html)
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/Identity$.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/Identity$.html)*