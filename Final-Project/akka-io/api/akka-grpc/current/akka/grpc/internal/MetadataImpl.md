...
scraped_at: '2026-04-05T22:36:15Z'
section: api
site: akka-io
...
[c](MetadataImpl$.html "See companion object")[akka](../../index.html).[grpc](../index.html).[internal](index.html)

# [MetadataImpl](MetadataImpl$.html "See companion object")[**](../../../akka/grpc/internal/MetadataImpl.html "Permalink")

### Companion [object MetadataImpl](MetadataImpl$.html "See companion object")

#### final  class MetadataImpl extends AnyRef

INTERNAL API

Annotations@InternalApi() Source[MetadataImpl.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/MetadataImpl.scala#L68)Linear SupertypesAnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. MetadataImpl
2. AnyRef
...
1. [**](../../../akka/grpc/internal/MetadataImpl.html#<init>(entries:List[(String,akka.grpc.scaladsl.MetadataEntry)]):akka.grpc.internal.MetadataImpl "Permalink")  new MetadataImpl(entries: List\[(String, [MetadataEntry](../scaladsl/MetadataEntry.html))])
### Value Members
...
4. [**](../../../akka/grpc/internal/MetadataImpl.html#addEntry(key:String,value:akka.util.ByteString):akka.grpc.internal.MetadataImpl "Permalink")  def addEntry(key: String, value: ByteString): MetadataImpl
5. [**](../../../akka/grpc/internal/MetadataImpl.html#addEntry(key:String,value:String):akka.grpc.internal.MetadataImpl "Permalink")  def addEntry(key: String, value: String): MetadataImpl
6. [**](../../../akka/grpc/internal/MetadataImpl.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
7. [**](../../../akka/grpc/internal/MetadataImpl.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
8. [**](../../../akka/grpc/internal/MetadataImpl.html#entries:List[(String,akka.grpc.scaladsl.MetadataEntry)] "Permalink")  val entries: List\[(String, [MetadataEntry](../scaladsl/MetadataEntry.html))]
9. [**](../../../akka/grpc/internal/MetadataImpl.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
10. [**](../../../akka/grpc/internal/MetadataImpl.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
11. [**](../../../akka/grpc/internal/MetadataImpl.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
12. [**](../../../akka/grpc/internal/MetadataImpl.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
13. [**](../../../akka/grpc/internal/MetadataImpl.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
14. [**](../../../akka/grpc/internal/MetadataImpl.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
15. [**](../../../akka/grpc/internal/MetadataImpl.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
16. [**](../../../akka/grpc/internal/MetadataImpl.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
17. [**](../../../akka/grpc/internal/MetadataImpl.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
18. [**](../../../akka/grpc/internal/MetadataImpl.html#toGoogleGrpcMetadata():io.grpc.Metadata "Permalink")  def toGoogleGrpcMetadata(): Metadata
19. [**](../../../akka/grpc/internal/MetadataImpl.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
20. [**](../../../akka/grpc/internal/MetadataImpl.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
21. [**](../../../akka/grpc/internal/MetadataImpl.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
22. [**](../../../akka/grpc/internal/MetadataImpl.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
