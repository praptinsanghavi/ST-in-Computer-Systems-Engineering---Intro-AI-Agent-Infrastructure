---
description: Akka gRPC 2.5.10 - akka.grpc.internal.BaseMarshaller
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:35:36Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/BaseMarshaller.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.BaseMarshaller
---

# Akka gRPC 2.5.10 - akka.grpc.internal.BaseMarshaller

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.BaseMarshaller
...
# BaseMarshaller[**](../../../akka/grpc/internal/BaseMarshaller.html "Permalink")

### 

#### abstract  class BaseMarshaller\[T] extends io.grpc.MethodDescriptor.Marshaller\[T] with [WithProtobufSerializer](WithProtobufSerializer.html)\[T]

INTERNAL API

Annotations@InternalStableApi() Source[Marshallers.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/Marshallers.scala#L17)Linear Supertypes[WithProtobufSerializer](WithProtobufSerializer.html)\[T], io.grpc.MethodDescriptor.Marshaller\[T], AnyRef, AnyKnown Subclasses[Marshaller](Marshaller.html), [ProtoMarshaller](ProtoMarshaller.html)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. BaseMarshaller
...
1. [**](../../../akka/grpc/internal/BaseMarshaller.html#<init>(protobufSerializer:akka.grpc.ProtobufSerializer[T]):akka.grpc.internal.BaseMarshaller[T] "Permalink")  new BaseMarshaller(protobufSerializer: [ProtobufSerializer](../ProtobufSerializer.html)\[T])
### Abstract Value Members

1. [**](../../../akka/grpc/internal/BaseMarshaller.html#stream(x$1:T):java.io.InputStream "Permalink") abstract  def stream(arg0: T): [InputStream](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/io/InputStream.html#java.io.InputStream)Definition ClassesMarshaller
### Concrete Value Members

1. [**](../../../akka/grpc/internal/BaseMarshaller.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/BaseMarshaller.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/BaseMarshaller.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/BaseMarshaller.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/grpc/internal/BaseMarshaller.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
6. [**](../../../akka/grpc/internal/BaseMarshaller.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
7. [**](../../../akka/grpc/internal/BaseMarshaller.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
8. [**](../../../akka/grpc/internal/BaseMarshaller.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
9. [**](../../../akka/grpc/internal/BaseMarshaller.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
10. [**](../../../akka/grpc/internal/BaseMarshaller.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
11. [**](../../../akka/grpc/internal/BaseMarshaller.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
12. [**](../../../akka/grpc/internal/BaseMarshaller.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
13. [**](../../../akka/grpc/internal/BaseMarshaller.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
14. [**](../../../akka/grpc/internal/BaseMarshaller.html#parse(stream:java.io.InputStream):T "Permalink")  def parse(stream: [InputStream](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/io/InputStream.html#java.io.InputStream)): TDefinition ClassesBaseMarshaller → Marshaller
15. [**](../../../akka/grpc/internal/BaseMarshaller.html#protobufSerializer:akka.grpc.ProtobufSerializer[T] "Permalink")  val protobufSerializer: [ProtobufSerializer](../ProtobufSerializer.html)\[T]Definition ClassesBaseMarshaller → [WithProtobufSerializer](WithProtobufSerializer.html)
16. [**](../../../akka/grpc/internal/BaseMarshaller.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
17. [**](../../../akka/grpc/internal/BaseMarshaller.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
18. [**](../../../akka/grpc/internal/BaseMarshaller.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
19. [**](../../../akka/grpc/internal/BaseMarshaller.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
20. [**](../../../akka/grpc/internal/BaseMarshaller.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/BaseMarshaller.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/BaseMarshaller.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/BaseMarshaller.html)*