---
description: Akka gRPC 2.5.10 - akka.grpc.internal.AkkaHttpClientUtils
knowledge_type: official_documentation
scraped_at: '2026-04-05T22:35:32Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/AkkaHttpClientUtils$.html
title: Akka gRPC 2.5.10 - akka.grpc.internal.AkkaHttpClientUtils
---

# Akka gRPC 2.5.10 - akka.grpc.internal.AkkaHttpClientUtils

> **Summary:** Akka gRPC 2.5.10 - akka.grpc.internal.AkkaHttpClientUtils
...
# AkkaHttpClientUtils[**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html "Permalink")
...
Annotations@InternalApi() Source[AkkaHttpClientUtils.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/AkkaHttpClientUtils.scala#L58)Linear SupertypesAnyRef, Any****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$$ResponsePromise.html "Permalink")  case class [ResponsePromise](AkkaHttpClientUtils$$ResponsePromise.html)(promise: Promise\[HttpResponse]) extends RequestResponseAssociation with Product with Serializable
### Value Members

1. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#!=(x$1:Any):Boolean "Permalink") final  def !\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
2. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html###:Int "Permalink") final  def \#\#: IntDefinition ClassesAnyRef → Any
3. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#==(x$1:Any):Boolean "Permalink") final  def \=\=(arg0: Any): BooleanDefinition ClassesAnyRef → Any
4. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
6. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#createChannel(settings:akka.grpc.GrpcClientSettings,log:akka.event.LoggingAdapter)(implicitsys:akka.actor.ClassicActorSystemProvider):akka.grpc.internal.InternalChannel "Permalink")  def createChannel(settings: [GrpcClientSettings](../GrpcClientSettings.html), log: LoggingAdapter)(implicit sys: ClassicActorSystemProvider): [InternalChannel](InternalChannel.html)INTERNAL API

INTERNAL API

Annotations@InternalApi()
7. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
8. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
9. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
10. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
11. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
12. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
13. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
14. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
15. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#responseToSource[O](requestUri:akka.http.scaladsl.model.Uri,response:scala.concurrent.Future[akka.http.scaladsl.model.HttpResponse],deserializer:akka.grpc.ProtobufSerializer[O],streamingResponse:Boolean)(implicitec:scala.concurrent.ExecutionContext,implicitmat:akka.stream.Materializer):akka.stream.scaladsl.Source[O,scala.concurrent.Future[akka.grpc.GrpcResponseMetadata]] "Permalink")  def responseToSource\[O](requestUri: Uri, response: Future\[HttpResponse], deserializer: [ProtobufSerializer](../ProtobufSerializer.html)\[O], streamingResponse: Boolean)(implicit ec: ExecutionContext, mat: Materializer): Source\[O, Future\[[GrpcResponseMetadata](../GrpcResponseMetadata.html)]]INTERNAL API

INTERNAL API

Annotations@InternalApi()
16. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
17. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
18. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
19. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
20. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
21. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$$ResponsePromise$.html "Permalink")  object [ResponsePromise](AkkaHttpClientUtils$$ResponsePromise$.html) extends [Serializable](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/io/Serializable.html#java.io.Serializable)
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/AkkaHttpClientUtils$.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
...
---
*Source: [https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/AkkaHttpClientUtils$.html](https://doc.akka.io/api/akka-grpc/current/akka/grpc/internal/AkkaHttpClientUtils$.html)*