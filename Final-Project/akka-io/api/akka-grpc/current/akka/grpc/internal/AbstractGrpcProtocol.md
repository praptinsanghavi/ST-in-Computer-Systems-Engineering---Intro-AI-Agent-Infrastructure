...
scraped_at: '2026-04-05T22:35:33Z'
section: api
site: akka-io
...
[c](AbstractGrpcProtocol$.html "See companion object")[akka](../../index.html).[grpc](../index.html).[internal](index.html)

# [AbstractGrpcProtocol](AbstractGrpcProtocol$.html "See companion object")[**](../../../akka/grpc/internal/AbstractGrpcProtocol.html "Permalink")

### Companion [object AbstractGrpcProtocol](AbstractGrpcProtocol$.html "See companion object")

#### abstract  class AbstractGrpcProtocol extends [GrpcProtocol](../GrpcProtocol.html)

Source[AbstractGrpcProtocol.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/src/main/scala/akka/grpc/internal/AbstractGrpcProtocol.scala#L23)Linear Supertypes[GrpcProtocol](../GrpcProtocol.html), AnyRef, AnyKnown Subclasses[GrpcProtocolNative](GrpcProtocolNative$.html), [GrpcProtocolWeb](GrpcProtocolWeb$.html), [GrpcProtocolWebBase](GrpcProtocolWebBase.html), [GrpcProtocolWebText](GrpcProtocolWebText$.html)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#<init>(subType:String):akka.grpc.internal.AbstractGrpcProtocol "Permalink")  new AbstractGrpcProtocol(subType: String)
### Abstract Value Members

1. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#reader(codec:akka.grpc.internal.Codec):akka.grpc.GrpcProtocol.GrpcProtocolReader "Permalink") abstract  def reader(codec: [Codec](Codec.html)): [GrpcProtocolReader](../GrpcProtocol$$GrpcProtocolReader.html)Attributesprotected
2. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#writer(codec:akka.grpc.internal.Codec):akka.grpc.GrpcProtocol.GrpcProtocolWriter "Permalink") abstract  def writer(codec: [Codec](Codec.html)): [GrpcProtocolWriter](../GrpcProtocol$$GrpcProtocolWriter.html)Attributesprotected
...
6. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#contentType:akka.http.scaladsl.model.ContentType.Binary "Permalink")  val contentType: BinaryINTERNAL API

INTERNAL API

The canonical media type to use for this protocol variant

Definition ClassesAbstractGrpcProtocol → [GrpcProtocol](../GrpcProtocol.html)
...
9. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
10. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
11. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
12. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#mediaTypes:Set[akka.http.javadsl.model.MediaType] "Permalink")  val mediaTypes: Set\[MediaType]INTERNAL API
...
14. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#newReader(codec:akka.grpc.internal.Codec):akka.grpc.GrpcProtocol.GrpcProtocolReader "Permalink")  def newReader(codec: [Codec](Codec.html)): [GrpcProtocolReader](../GrpcProtocol$$GrpcProtocolReader.html)Obtains a reader for this protocol.
...
Definition ClassesAbstractGrpcProtocol → [GrpcProtocol](../GrpcProtocol.html)
15. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#newWriter(codec:akka.grpc.internal.Codec):akka.grpc.GrpcProtocol.GrpcProtocolWriter "Permalink")  def newWriter(codec: [Codec](Codec.html)): [GrpcProtocolWriter](../GrpcProtocol$$GrpcProtocolWriter.html)Obtains a writer for this protocol:
...
Definition ClassesAbstractGrpcProtocol → [GrpcProtocol](../GrpcProtocol.html)
16. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
17. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
18. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
19. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
20. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
21. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
22. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
### Deprecated Value Members

1. [**](../../../akka/grpc/internal/AbstractGrpcProtocol.html#finalize():Unit "Permalink")  def finalize(): UnitAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.Throwable]) @Deprecated Deprecated*(Since version 9\)*
