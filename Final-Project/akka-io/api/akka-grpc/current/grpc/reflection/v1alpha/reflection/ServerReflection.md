...
scraped_at: '2026-04-05T22:36:44Z'
section: api
site: akka-io
...
[t](ServerReflection$.html "See companion object")[grpc](../../../index.html).[reflection](../../index.html).[v1alpha](../index.html).[reflection](index.html)

# [ServerReflection](ServerReflection$.html "See companion object")[**](../../../../grpc/reflection/v1alpha/reflection/ServerReflection.html "Permalink")

### Companion [object ServerReflection](ServerReflection$.html "See companion object")

#### trait ServerReflection extends AnyRef

Annotations@[AkkaGrpcGenerated](../../../../akka/grpc/AkkaGrpcGenerated.html)() Source[ServerReflection.scala](https://github.com/akka/akka-grpc/tree/v2.5.10/runtime/target/scala-2.13/src_managed/main/grpc/reflection/v1alpha/reflection/ServerReflection.scala#L11)Linear SupertypesAnyRef, AnyKnown Subclasses[ServerReflectionImpl](../../../../akka/grpc/internal/ServerReflectionImpl.html), [ServerReflectionClient](ServerReflectionClient.html)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. ServerReflection
2. AnyRef
...
6. [**](../../../../grpc/reflection/v1alpha/reflection/ServerReflection.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: AnyRef): BooleanDefinition ClassesAnyRef
7. [**](../../../../grpc/reflection/v1alpha/reflection/ServerReflection.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: AnyRef): BooleanDefinition ClassesAnyRef → Any
8. [**](../../../../grpc/reflection/v1alpha/reflection/ServerReflection.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@native()
9. [**](../../../../grpc/reflection/v1alpha/reflection/ServerReflection.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@native()
10. [**](../../../../grpc/reflection/v1alpha/reflection/ServerReflection.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: BooleanDefinition ClassesAny
11. [**](../../../../grpc/reflection/v1alpha/reflection/ServerReflection.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: AnyRef): BooleanDefinition ClassesAnyRef
12. [**](../../../../grpc/reflection/v1alpha/reflection/ServerReflection.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@native()
13. [**](../../../../grpc/reflection/v1alpha/reflection/ServerReflection.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@native()
14. [**](../../../../grpc/reflection/v1alpha/reflection/ServerReflection.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
15. [**](../../../../grpc/reflection/v1alpha/reflection/ServerReflection.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
16. [**](../../../../grpc/reflection/v1alpha/reflection/ServerReflection.html#wait():Unit "Permalink") final  def wait(): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
17. [**](../../../../grpc/reflection/v1alpha/reflection/ServerReflection.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
18. [**](../../../../grpc/reflection/v1alpha/reflection/ServerReflection.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
