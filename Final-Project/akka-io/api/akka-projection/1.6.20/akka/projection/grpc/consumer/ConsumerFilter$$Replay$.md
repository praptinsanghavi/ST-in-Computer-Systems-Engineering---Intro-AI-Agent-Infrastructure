...
scraped_at: '2026-04-06T14:47:57Z'
section: api
site: akka-io
...
[o](ConsumerFilter$$Replay.html "See companion class")[akka](../../../index.html).[projection](../../index.html).[grpc](../index.html).[consumer](index.html).[ConsumerFilter](ConsumerFilter$.html)

# [Replay](ConsumerFilter$$Replay.html "See companion class")[**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html "Permalink")

### Companion [class Replay](ConsumerFilter$$Replay.html "See companion class")

#### object Replay extends [AbstractFunction2](https://www.scala-lang.org/api/2.13.17/scala/runtime/AbstractFunction2.html#scala.runtime.AbstractFunction2)\[String, Set\[[PersistenceIdOffset](ConsumerFilter$$PersistenceIdOffset.html)], [Replay](ConsumerFilter$$Replay.html)] with [Serializable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base//java.base/java/io/Serializable.html#java.io.Serializable)

Source[ConsumerFilter.scala](https://github.com/akka/akka-projection/tree/v1.6.20/akka-projection-grpc/src/main/scala/akka/projection/grpc/consumer/ConsumerFilter.scala#L81)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base//java.base/java/io/Serializable.html#java.io.Serializable), [AbstractFunction2](https://www.scala-lang.org/api/2.13.17/scala/runtime/AbstractFunction2.html#scala.runtime.AbstractFunction2)\[String, Set\[[PersistenceIdOffset](ConsumerFilter$$PersistenceIdOffset.html)], [Replay](ConsumerFilter$$Replay.html)], (String, Set\[[PersistenceIdOffset](ConsumerFilter$$PersistenceIdOffset.html)]) \=\> [Replay](ConsumerFilter$$Replay.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. Replay
2. Serializable
...
4. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#apply(streamId:String,persistenceIdOffsets:Set[akka.projection.grpc.consumer.ConsumerFilter.PersistenceIdOffset],correlationId:java.util.UUID):akka.projection.grpc.consumer.ConsumerFilter.Replay "Permalink")  def apply(streamId: String, persistenceIdOffsets: Set\[[PersistenceIdOffset](ConsumerFilter$$PersistenceIdOffset.html)], correlationId: [UUID](https://docs.oracle.com/en/java/javase/17/docs/api/java.base//java.base/java/util/UUID.html#java.util.UUID)): [Replay](ConsumerFilter$$Replay.html)Use the `replayCorrelationId` from the `GrpcReadJournal`.
5. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#apply(streamId:String,persistenceIdOffsets:Set[akka.projection.grpc.consumer.ConsumerFilter.PersistenceIdOffset]):akka.projection.grpc.consumer.ConsumerFilter.Replay "Permalink")  def apply(streamId: String, persistenceIdOffsets: Set\[[PersistenceIdOffset](ConsumerFilter$$PersistenceIdOffset.html)]): [Replay](ConsumerFilter$$Replay.html)Definition ClassesReplay → Function2
...
7. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @IntrinsicCandidate() @native()
8. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#curried:T1=>(T2=>R) "Permalink")  def curried: (String) \=\> (Set\[[PersistenceIdOffset](ConsumerFilter$$PersistenceIdOffset.html)]) \=\> [Replay](ConsumerFilter$$Replay.html)Definition ClassesFunction2Annotations@unspecialized()
9. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
10. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
11. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base//java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@IntrinsicCandidate() @native()
12. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@IntrinsicCandidate() @native()
13. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
14. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@IntrinsicCandidate() @native()
16. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@IntrinsicCandidate() @native()
17. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
18. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#toString():String "Permalink")  def toString(): StringDefinition ClassesFunction2 → AnyRef → Any
19. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#tupled:((T1,T2))=>R "Permalink")  def tupled: ((String, Set\[[PersistenceIdOffset](ConsumerFilter$$PersistenceIdOffset.html)])) \=\> [Replay](ConsumerFilter$$Replay.html)Definition ClassesFunction2Annotations@unspecialized()
20. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#unapply(arg:akka.projection.grpc.consumer.ConsumerFilter.Replay):Option[(String,Set[akka.projection.grpc.consumer.ConsumerFilter.PersistenceIdOffset])] "Permalink")  def unapply(arg: [Replay](ConsumerFilter$$Replay.html)): [Option](https://www.scala-lang.org/api/2.13.17/scala/Option.html#scala.Option)\[(String, Set\[[PersistenceIdOffset](ConsumerFilter$$PersistenceIdOffset.html)])]
...
23. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$Replay$.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
...
### Inherited from [AbstractFunction2](https://www.scala-lang.org/api/2.13.17/scala/runtime/AbstractFunction2.html#scala.runtime.AbstractFunction2)\[String, Set\[[PersistenceIdOffset](ConsumerFilter$$PersistenceIdOffset.html)], [Replay](ConsumerFilter$$Replay.html)]

### Inherited from (String, Set\[[PersistenceIdOffset](ConsumerFilter$$PersistenceIdOffset.html)]) \=\> [Replay](ConsumerFilter$$Replay.html)
