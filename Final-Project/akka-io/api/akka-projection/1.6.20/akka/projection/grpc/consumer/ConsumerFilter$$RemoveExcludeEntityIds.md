...
scraped_at: '2026-04-06T14:47:34Z'
section: api
site: akka-io
...
[c](ConsumerFilter$$RemoveExcludeEntityIds$.html "See companion object")[akka](../../../index.html).[projection](../../index.html).[grpc](../index.html).[consumer](index.html).[ConsumerFilter](ConsumerFilter$.html)

# [RemoveExcludeEntityIds](ConsumerFilter$$RemoveExcludeEntityIds$.html "See companion object")[**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html "Permalink")

### Companion [object RemoveExcludeEntityIds](ConsumerFilter$$RemoveExcludeEntityIds$.html "See companion object")

#### final  case class RemoveExcludeEntityIds(entityIds: Set\[String]) extends [RemoveCriteria](ConsumerFilter$$RemoveCriteria.html) with [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product) with Serializable

Remove a previously added [ExcludeEntityIds](ConsumerFilter$$ExcludeEntityIds.html).

Source[ConsumerFilter.scala](https://github.com/akka/akka-projection/tree/v1.6.20/akka-projection-grpc/src/main/scala/akka/projection/grpc/consumer/ConsumerFilter.scala#L393)Linear Supertypes[Serializable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base//java.base/java/io/Serializable.html#java.io.Serializable), [Product](https://www.scala-lang.org/api/2.13.17/scala/Product.html#scala.Product), [Equals](https://www.scala-lang.org/api/2.13.17/scala/Equals.html#scala.Equals), [RemoveCriteria](ConsumerFilter$$RemoveCriteria.html), [FilterCriteria](ConsumerFilter$$FilterCriteria.html), [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
1. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html#<init>(entityIds:java.util.Set[String]):akka.projection.grpc.consumer.ConsumerFilter.RemoveExcludeEntityIds "Permalink")  new RemoveExcludeEntityIds(entityIds: [Set](https://docs.oracle.com/en/java/javase/17/docs/api/java.base//java.base/java/util/Set.html#java.util.Set)\[String])Java API
2. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html#<init>(entityIds:Set[String]):akka.projection.grpc.consumer.ConsumerFilter.RemoveExcludeEntityIds "Permalink")  new RemoveExcludeEntityIds(entityIds: Set\[String])
### Value Members
...
4. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @IntrinsicCandidate() @native()
6. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html#entityIds:Set[String] "Permalink")  val entityIds: Set\[String]
...
8. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base//java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@IntrinsicCandidate() @native()
9. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
10. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
11. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@IntrinsicCandidate() @native()
12. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@IntrinsicCandidate() @native()
13. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html#productElementNames:Iterator[String] "Permalink")  def productElementNames: Iterator\[String]Definition ClassesProduct
14. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
15. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html#toString():String "Permalink")  def toString(): StringDefinition ClassesRemoveExcludeEntityIds → AnyRef → Any
16. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
17. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
18. [**](../../../../akka/projection/grpc/consumer/ConsumerFilter$$RemoveExcludeEntityIds.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
