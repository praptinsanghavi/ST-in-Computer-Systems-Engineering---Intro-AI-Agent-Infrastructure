---
description: Akka Projection 1.5.9 - akka.projection.state
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:32:07Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-projection/1.5.9/akka/projection/state/index.html
title: Akka Projection 1.5.9 - akka.projection.state
---

# Akka Projection 1.5.9 - akka.projection.state

> **Summary:** Akka Projection 1.5.9 - akka.projection.state
...
- https://doc.akka.io/api/akka-projection/1.5.9/akka/projection/state/javadsl/index.html
- https://doc.akka.io/api/akka-projection/1.5.9/akka/projection/state/scaladsl/index.html
...
---
*Source: [https://doc.akka.io/api/akka-projection/1.5.9/akka/projection/state/index.html](https://doc.akka.io/api/akka-projection/1.5.9/akka/projection/state/index.html)*