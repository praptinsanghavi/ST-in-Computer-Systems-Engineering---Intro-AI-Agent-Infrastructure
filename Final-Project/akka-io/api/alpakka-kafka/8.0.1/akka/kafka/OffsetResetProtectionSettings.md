...
scraped_at: '2026-04-06T03:05:36Z'
section: api
site: akka-io
...
[c](OffsetResetProtectionSettings$.html "See companion object")[akka](../index.html).[kafka](index.html)

# [OffsetResetProtectionSettings](OffsetResetProtectionSettings$.html "See companion object")[**](../../akka/kafka/OffsetResetProtectionSettings.html "Permalink")

### Companion [object OffsetResetProtectionSettings](OffsetResetProtectionSettings$.html "See companion object")

#### class OffsetResetProtectionSettings extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

Source[OffsetResetProtectionSettings.scala](https://github.com/akka/alpakka-kafka/tree/v8.0.1/core/src/main/scala/akka/kafka/OffsetResetProtectionSettings.scala#L15)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
4. [**](../../akka/kafka/OffsetResetProtectionSettings.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../akka/kafka/OffsetResetProtectionSettings.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
6. [**](../../akka/kafka/OffsetResetProtectionSettings.html#enable:Boolean "Permalink")  val enable: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)
7. [**](../../akka/kafka/OffsetResetProtectionSettings.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
8. [**](../../akka/kafka/OffsetResetProtectionSettings.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
9. [**](../../akka/kafka/OffsetResetProtectionSettings.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native()
10. [**](../../akka/kafka/OffsetResetProtectionSettings.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native()
11. [**](../../akka/kafka/OffsetResetProtectionSettings.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
12. [**](../../akka/kafka/OffsetResetProtectionSettings.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
13. [**](../../akka/kafka/OffsetResetProtectionSettings.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native()
14. [**](../../akka/kafka/OffsetResetProtectionSettings.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native()
15. [**](../../akka/kafka/OffsetResetProtectionSettings.html#offsetThreshold:Long "Permalink")  val offsetThreshold: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)
16. [**](../../akka/kafka/OffsetResetProtectionSettings.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
17. [**](../../akka/kafka/OffsetResetProtectionSettings.html#timeThreshold:scala.concurrent.duration.FiniteDuration "Permalink")  val timeThreshold: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)
18. [**](../../akka/kafka/OffsetResetProtectionSettings.html#toString():String "Permalink")  def toString(): StringDefinition ClassesOffsetResetProtectionSettings → AnyRef → Any
19. [**](../../akka/kafka/OffsetResetProtectionSettings.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
20. [**](../../akka/kafka/OffsetResetProtectionSettings.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
21. [**](../../akka/kafka/OffsetResetProtectionSettings.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
22. [**](../../akka/kafka/OffsetResetProtectionSettings.html#withEnable(enable:Boolean):akka.kafka.OffsetResetProtectionSettings "Permalink")  def withEnable(enable: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): OffsetResetProtectionSettingsWhether offset\-reset protection should be enabled.
23. [**](../../akka/kafka/OffsetResetProtectionSettings.html#withOffsetThreshold(offsetThreshold:Long):akka.kafka.OffsetResetProtectionSettings "Permalink")  def withOffsetThreshold(offsetThreshold: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): OffsetResetProtectionSettingsIf consumer gets a record with an offset that is more than this number of offsets back from the previously
requested offset, it is considered a reset.
24. [**](../../akka/kafka/OffsetResetProtectionSettings.html#withTimeThreshold(timeThreshold:java.time.Duration):akka.kafka.OffsetResetProtectionSettings "Permalink")  def withTimeThreshold(timeThreshold: [Duration](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/time/Duration.html#java.time.Duration)): OffsetResetProtectionSettingsJava API

Java API

If the record is more than this duration earlier the last received record, it is considered a reset
25. [**](../../akka/kafka/OffsetResetProtectionSettings.html#withTimeThreshold(timeThreshold:scala.concurrent.duration.FiniteDuration):akka.kafka.OffsetResetProtectionSettings "Permalink")  def withTimeThreshold(timeThreshold: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): OffsetResetProtectionSettingsScala API.
