...
scraped_at: '2026-04-06T03:05:24Z'
section: api
site: akka-io
...
[c](CommitterSettings$.html "See companion object")[akka](../index.html).[kafka](index.html)

# [CommitterSettings](CommitterSettings$.html "See companion object")[**](../../akka/kafka/CommitterSettings.html "Permalink")

### Companion [object CommitterSettings](CommitterSettings$.html "See companion object")

#### class CommitterSettings extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
...
Source[CommitterSettings.scala](https://github.com/akka/alpakka-kafka/tree/v8.0.1/core/src/main/scala/akka/kafka/CommitterSettings.scala#L165)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
1. CommitterSettings
2. AnyRef
...
4. [**](../../akka/kafka/CommitterSettings.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../akka/kafka/CommitterSettings.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
6. [**](../../akka/kafka/CommitterSettings.html#delivery:akka.kafka.CommitDelivery "Permalink")  val delivery: [CommitDelivery](CommitDelivery.html)
7. [**](../../akka/kafka/CommitterSettings.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
8. [**](../../akka/kafka/CommitterSettings.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
9. [**](../../akka/kafka/CommitterSettings.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native()
10. [**](../../akka/kafka/CommitterSettings.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native()
11. [**](../../akka/kafka/CommitterSettings.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
12. [**](../../akka/kafka/CommitterSettings.html#maxBatch:Long "Permalink")  val maxBatch: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)
13. [**](../../akka/kafka/CommitterSettings.html#maxInterval:scala.concurrent.duration.FiniteDuration "Permalink")  val maxInterval: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)
14. [**](../../akka/kafka/CommitterSettings.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
15. [**](../../akka/kafka/CommitterSettings.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native()
16. [**](../../akka/kafka/CommitterSettings.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native()
17. [**](../../akka/kafka/CommitterSettings.html#parallelism:Int "Permalink")  val parallelism: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
18. [**](../../akka/kafka/CommitterSettings.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
19. [**](../../akka/kafka/CommitterSettings.html#toString():String "Permalink")  def toString(): StringDefinition ClassesCommitterSettings → AnyRef → Any
20. [**](../../akka/kafka/CommitterSettings.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
21. [**](../../akka/kafka/CommitterSettings.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
22. [**](../../akka/kafka/CommitterSettings.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
23. [**](../../akka/kafka/CommitterSettings.html#when:akka.kafka.CommitWhen "Permalink")  val when: [CommitWhen](CommitWhen.html)
24. [**](../../akka/kafka/CommitterSettings.html#withCommitWhen(value:akka.kafka.CommitWhen):akka.kafka.CommitterSettings "Permalink")  def withCommitWhen(value: [CommitWhen](CommitWhen.html)): CommitterSettingsAnnotations@ApiMayChange()
25. [**](../../akka/kafka/CommitterSettings.html#withDelivery(value:akka.kafka.CommitDelivery):akka.kafka.CommitterSettings "Permalink")  def withDelivery(value: [CommitDelivery](CommitDelivery.html)): CommitterSettingsAnnotations@ApiMayChange()
26. [**](../../akka/kafka/CommitterSettings.html#withMaxBatch(maxBatch:Long):akka.kafka.CommitterSettings "Permalink")  def withMaxBatch(maxBatch: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): CommitterSettings
27. [**](../../akka/kafka/CommitterSettings.html#withMaxInterval(maxInterval:java.time.Duration):akka.kafka.CommitterSettings "Permalink")  def withMaxInterval(maxInterval: [Duration](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/time/Duration.html#java.time.Duration)): CommitterSettings
28. [**](../../akka/kafka/CommitterSettings.html#withMaxInterval(maxInterval:scala.concurrent.duration.FiniteDuration):akka.kafka.CommitterSettings "Permalink")  def withMaxInterval(maxInterval: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): CommitterSettings
29. [**](../../akka/kafka/CommitterSettings.html#withParallelism(parallelism:Int):akka.kafka.CommitterSettings "Permalink")  def withParallelism(parallelism: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): CommitterSettings
