...
scraped_at: '2026-04-06T03:05:26Z'
section: api
site: akka-io
...
[c](ConnectionCheckerSettings$.html "See companion object")[akka](../index.html).[kafka](index.html)

# [ConnectionCheckerSettings](ConnectionCheckerSettings$.html "See companion object")[**](../../akka/kafka/ConnectionCheckerSettings.html "Permalink")

### Companion [object ConnectionCheckerSettings](ConnectionCheckerSettings$.html "See companion object")

#### class ConnectionCheckerSettings extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)

Source[ConnectionCheckerSettings.scala](https://github.com/akka/alpakka-kafka/tree/v8.0.1/core/src/main/scala/akka/kafka/ConnectionCheckerSettings.scala#L15)Linear Supertypes[AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef), [Any](https://www.scala-lang.org/api/2.13.17/scala/Any.html#scala.Any)****Ordering1. Alphabetic
2. By Inheritance
Inherited  
...
4. [**](../../akka/kafka/ConnectionCheckerSettings.html#asInstanceOf[T0]:T0 "Permalink") final  def asInstanceOf\[T0]: T0Definition ClassesAny
5. [**](../../akka/kafka/ConnectionCheckerSettings.html#checkInterval:scala.concurrent.duration.FiniteDuration "Permalink")  val checkInterval: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)
6. [**](../../akka/kafka/ConnectionCheckerSettings.html#clone():Object "Permalink")  def clone(): [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Attributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @native()
7. [**](../../akka/kafka/ConnectionCheckerSettings.html#enable:Boolean "Permalink")  val enable: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)
8. [**](../../akka/kafka/ConnectionCheckerSettings.html#eq(x$1:AnyRef):Boolean "Permalink") final  def eq(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
9. [**](../../akka/kafka/ConnectionCheckerSettings.html#equals(x$1:Object):Boolean "Permalink")  def equals(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef → Any
10. [**](../../akka/kafka/ConnectionCheckerSettings.html#factor:Double "Permalink")  val factor: [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double)
11. [**](../../akka/kafka/ConnectionCheckerSettings.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)]Definition ClassesAnyRef → AnyAnnotations@native()
12. [**](../../akka/kafka/ConnectionCheckerSettings.html#hashCode():Int "Permalink")  def hashCode(): [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)Definition ClassesAnyRef → AnyAnnotations@native()
13. [**](../../akka/kafka/ConnectionCheckerSettings.html#isInstanceOf[T0]:Boolean "Permalink") final  def isInstanceOf\[T0]: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAny
14. [**](../../akka/kafka/ConnectionCheckerSettings.html#maxRetries:Int "Permalink")  val maxRetries: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)
15. [**](../../akka/kafka/ConnectionCheckerSettings.html#ne(x$1:AnyRef):Boolean "Permalink") final  def ne(arg0: [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)): [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)Definition ClassesAnyRef
16. [**](../../akka/kafka/ConnectionCheckerSettings.html#notify():Unit "Permalink") final  def notify(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native()
17. [**](../../akka/kafka/ConnectionCheckerSettings.html#notifyAll():Unit "Permalink") final  def notifyAll(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@native()
18. [**](../../akka/kafka/ConnectionCheckerSettings.html#synchronized[T0](x$1:=>T0):T0 "Permalink") final  def synchronized\[T0](arg0: \=\> T0): T0Definition ClassesAnyRef
19. [**](../../akka/kafka/ConnectionCheckerSettings.html#toString():String "Permalink")  def toString(): StringDefinition ClassesConnectionCheckerSettings → AnyRef → Any
20. [**](../../akka/kafka/ConnectionCheckerSettings.html#wait():Unit "Permalink") final  def wait(): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
21. [**](../../akka/kafka/ConnectionCheckerSettings.html#wait(x$1:Long,x$2:Int):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long), arg1: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException])
22. [**](../../akka/kafka/ConnectionCheckerSettings.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: [Long](https://www.scala-lang.org/api/2.13.17/scala/Long.html#scala.Long)): [Unit](https://www.scala-lang.org/api/2.13.17/scala/Unit.html#scala.Unit)Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
23. [**](../../akka/kafka/ConnectionCheckerSettings.html#withCheckInterval(checkInterval:java.time.Duration):akka.kafka.ConnectionCheckerSettings "Permalink")  def withCheckInterval(checkInterval: [Duration](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/time/Duration.html#java.time.Duration)): ConnectionCheckerSettingsJava API
24. [**](../../akka/kafka/ConnectionCheckerSettings.html#withCheckInterval(checkInterval:scala.concurrent.duration.FiniteDuration):akka.kafka.ConnectionCheckerSettings "Permalink")  def withCheckInterval(checkInterval: [FiniteDuration](https://www.scala-lang.org/api/2.13.17/scala/concurrent/duration/FiniteDuration.html#scala.concurrent.duration.FiniteDuration)): ConnectionCheckerSettingsScala API
25. [**](../../akka/kafka/ConnectionCheckerSettings.html#withEnable(enable:Boolean):akka.kafka.ConnectionCheckerSettings "Permalink")  def withEnable(enable: [Boolean](https://www.scala-lang.org/api/2.13.17/scala/Boolean.html#scala.Boolean)): ConnectionCheckerSettings
26. [**](../../akka/kafka/ConnectionCheckerSettings.html#withFactor(factor:Double):akka.kafka.ConnectionCheckerSettings "Permalink")  def withFactor(factor: [Double](https://www.scala-lang.org/api/2.13.17/scala/Double.html#scala.Double)): ConnectionCheckerSettings
27. [**](../../akka/kafka/ConnectionCheckerSettings.html#withMaxRetries(maxRetries:Int):akka.kafka.ConnectionCheckerSettings "Permalink")  def withMaxRetries(maxRetries: [Int](https://www.scala-lang.org/api/2.13.17/scala/Int.html#scala.Int)): ConnectionCheckerSettings
