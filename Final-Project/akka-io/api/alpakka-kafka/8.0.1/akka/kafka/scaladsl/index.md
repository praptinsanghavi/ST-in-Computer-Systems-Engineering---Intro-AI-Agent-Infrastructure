---
description: Alpakka Kafka 8.0.1 - akka.kafka.scaladsl
knowledge_type: official_documentation
scraped_at: '2026-04-06T03:05:13Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/alpakka-kafka/current/akka/kafka/scaladsl/index.html
title: Alpakka Kafka 8.0.1 - akka.kafka.scaladsl
---

# Alpakka Kafka 8.0.1 - akka.kafka.scaladsl

> **Summary:** Alpakka Kafka 8.0.1 - akka.kafka.scaladsl
...
- [**](../../../akka/kafka/scaladsl/index.html "Permalink")  package scaladslDefinition Classes[kafka](../index.html)
...
# scaladsl[**](../../../akka/kafka/scaladsl/index.html "Permalink")
...
1. [**](../../../akka/kafka/scaladsl/MetadataClient.html "Permalink")  class [MetadataClient](MetadataClient.html) extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)
2. [**](../../../akka/kafka/scaladsl/PartitionAssignmentHandler.html "Permalink")  trait [PartitionAssignmentHandler](PartitionAssignmentHandler.html "The API is new and may change in further releases.") extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)The API is new and may change in further releases.
...
3. [**](../../../akka/kafka/scaladsl/SendProducer.html "Permalink") final  class [SendProducer](SendProducer.html "Utility class for producing to Kafka without using Akka Streams.")\[K, V] extends [AnyRef](https://www.scala-lang.org/api/2.13.17/scala/AnyRef.html#scala.AnyRef)Utility class for producing to Kafka without using Akka Streams.
### Value Members

1. [**](../../../akka/kafka/scaladsl/Committer$.html "Permalink")  object [Committer](Committer$.html)
2. [**](../../../akka/kafka/scaladsl/Consumer$.html "Permalink")  object [Consumer](Consumer$.html "Akka Stream connector for subscribing to Kafka topics.")Akka Stream connector for subscribing to Kafka topics.
3. [**](../../../akka/kafka/scaladsl/DiscoverySupport$.html "Permalink")  object [DiscoverySupport](DiscoverySupport$.html "Scala API.")Scala API.
...
4. [**](../../../akka/kafka/scaladsl/MetadataClient$.html "Permalink")  object [MetadataClient](MetadataClient$.html)
5. [**](../../../akka/kafka/scaladsl/Producer$.html "Permalink")  object [Producer](Producer$.html "Akka Stream connector for publishing messages to Kafka topics.")Akka Stream connector for publishing messages to Kafka topics.
6. [**](../../../akka/kafka/scaladsl/SendProducer$.html "Permalink")  object [SendProducer](SendProducer$.html)
7. [**](../../../akka/kafka/scaladsl/Transactional$.html "Permalink")  object [Transactional](Transactional$.html "Akka Stream connector to support transactions between Kafka topics.")Akka Stream connector to support transactions between Kafka topics.
### Ungrouped
...
---
*Source: [https://doc.akka.io/api/alpakka-kafka/8.0.1/akka/kafka/scaladsl/index.html](https://doc.akka.io/api/alpakka-kafka/8.0.1/akka/kafka/scaladsl/index.html)*