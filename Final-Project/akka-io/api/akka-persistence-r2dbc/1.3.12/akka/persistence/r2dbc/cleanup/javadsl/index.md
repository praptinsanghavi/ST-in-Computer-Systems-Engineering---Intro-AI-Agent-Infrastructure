---
description: Akka Persistence R2DBC 1.3.12 - akka.persistence.r2dbc.cleanup.javadsl
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:48:32Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-persistence-r2dbc/1.3.12/akka/persistence/r2dbc/cleanup/javadsl/index.html
title: Akka Persistence R2DBC 1.3.12 - akka.persistence.r2dbc.cleanup.javadsl
---

# Akka Persistence R2DBC 1.3.12 - akka.persistence.r2dbc.cleanup.javadsl

> **Summary:** Akka Persistence R2DBC 1.3.12 - akka.persistence.r2dbc.cleanup.javadsl
...
- [**](../../../../../akka/persistence/r2dbc/cleanup/javadsl/index.html "Permalink")  package javadslDefinition Classes[cleanup](../index.html)
...
- [**](../../../../../akka/persistence/r2dbc/cleanup/scaladsl/index.html "Permalink")  package [scaladsl](../scaladsl/index.html)Definition Classes[cleanup](../index.html)
p[akka](../../../../index.html).[persistence](../../../index.html).[r2dbc](../../index.html).[cleanup](../index.html)

# javadsl[**](../../../../../akka/persistence/r2dbc/cleanup/javadsl/index.html "Permalink")

#### package javadsl

### Type Members

1. [**](../../../../../akka/persistence/r2dbc/cleanup/javadsl/DurableStateCleanup.html "Permalink") final  class [DurableStateCleanup](DurableStateCleanup.html "Java API: Tool for deleting durable state for a given list of persistenceIds without using DurableStateBehavior actors.") extends AnyRefJava API: Tool for deleting durable state for a given list of `persistenceIds` without using `DurableStateBehavior`
actors.
...
2. [**](../../../../../akka/persistence/r2dbc/cleanup/javadsl/EventSourcedCleanup.html "Permalink") final  class [EventSourcedCleanup](EventSourcedCleanup.html "Java API: Tool for deleting events and/or snapshots for a given list of persistenceIds without using persistent actors.") extends AnyRefJava API: Tool for deleting events and/or snapshots for a given list of `persistenceIds` without using persistent
actors.
...
---
*Source: [https://doc.akka.io/api/akka-persistence-r2dbc/1.3.12/akka/persistence/r2dbc/cleanup/javadsl/index.html](https://doc.akka.io/api/akka-persistence-r2dbc/1.3.12/akka/persistence/r2dbc/cleanup/javadsl/index.html)*