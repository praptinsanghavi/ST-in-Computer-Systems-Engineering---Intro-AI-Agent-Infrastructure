...
scraped_at: '2026-04-06T14:45:42Z'
section: api
site: akka-io
source_url: https://doc.akka.io/api/akka-persistence-r2dbc/1.2.6/akka/persistence/r2dbc/cleanup/javadsl/DurableStateCleanup.html
title: ''
---
...
5. [**](../../../../../akka/persistence/r2dbc/cleanup/javadsl/DurableStateCleanup.html#clone():Object "Permalink")  def clone(): AnyRefAttributesprotected\[lang] Definition ClassesAnyRefAnnotations@throws(classOf\[java.lang.CloneNotSupportedException]) @HotSpotIntrinsicCandidate() @native()
6. [**](../../../../../akka/persistence/r2dbc/cleanup/javadsl/DurableStateCleanup.html#deleteState(persistenceId:String,resetRevisionNumber:Boolean):java.util.concurrent.CompletionStage[akka.Done] "Permalink")  def deleteState(persistenceId: String, resetRevisionNumber: Boolean): [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[Done]Delete the state related to one single `persistenceId`.
7. [**](../../../../../akka/persistence/r2dbc/cleanup/javadsl/DurableStateCleanup.html#deleteStates(persistenceIds:java.util.List[String],resetRevisionNumber:Boolean):java.util.concurrent.CompletionStage[akka.Done] "Permalink")  def deleteStates(persistenceIds: [List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html#java.util.List)\[String], resetRevisionNumber: Boolean): [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html#java.util.concurrent.CompletionStage)\[Done]Delete all states related to the given list of `persistenceIds`.
...
10. [**](../../../../../akka/persistence/r2dbc/cleanup/javadsl/DurableStateCleanup.html#getClass():Class[_] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html#java.lang.Class)\[\_ \<: AnyRef]Definition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
11. [**](../../../../../akka/persistence/r2dbc/cleanup/javadsl/DurableStateCleanup.html#hashCode():Int "Permalink")  def hashCode(): IntDefinition ClassesAnyRef → AnyAnnotations@HotSpotIntrinsicCandidate() @native()
...
14. [**](../../../../../akka/persistence/r2dbc/cleanup/javadsl/DurableStateCleanup.html#notify():Unit "Permalink") final  def notify(): UnitDefinition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
15. [**](../../../../../akka/persistence/r2dbc/cleanup/javadsl/DurableStateCleanup.html#notifyAll():Unit "Permalink") final  def notifyAll(): UnitDefinition ClassesAnyRefAnnotations@HotSpotIntrinsicCandidate() @native()
...
17. [**](../../../../../akka/persistence/r2dbc/cleanup/javadsl/DurableStateCleanup.html#toString():String "Permalink")  def toString(): [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html#java.lang.String)Definition ClassesAnyRef → Any
...
19. [**](../../../../../akka/persistence/r2dbc/cleanup/javadsl/DurableStateCleanup.html#wait(x$1:Long):Unit "Permalink") final  def wait(arg0: Long): UnitDefinition ClassesAnyRefAnnotations@throws(classOf\[java.lang.InterruptedException]) @native()
...
---
*Source: [https://doc.akka.io/api/akka-persistence-r2dbc/1.2.6/akka/persistence/r2dbc/cleanup/javadsl/DurableStateCleanup.html](https://doc.akka.io/api/akka-persistence-r2dbc/1.2.6/akka/persistence/r2dbc/cleanup/javadsl/DurableStateCleanup.html)*