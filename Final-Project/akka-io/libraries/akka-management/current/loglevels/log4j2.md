...
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-management/current/loglevels/log4j2.html
title: Log4j2 • Akka Management
---

# Log4j2 • Akka Management
...
| --- | --- |
| Artifact | com.lightbend.akka.management akka\-management\-loglevels\-log4j2 1\.6\.4 [Akka library snapshot repository](https://repo.akka.io/snapshots) |
...
| Readiness level | [Community\-driven](https://doc.akka.io/docs/akka-dependencies/current/support-terminology.html#community-driven) Since 1\.1\.1, 2021\-11\-18 |
...
Requires [Akka Management](../akka-management.html) and that the application uses [Log4j2](https://logging.apache.org/log4j/2.x/) as logging backend.
...
libraryDependencies ++= Seq(
  "com.lightbend.akka.management" %% "akka-management-loglevels-log4j2" % AkkaManagementVersion,
...
dependencies {
  implementation "com.lightbend.akka.management:akka-management-loglevels-log4j2_${versions.ScalaBinary}:${versions.AkkaManagementVersion}"
...
<dependencies&gt
  <dependency>
    ...
    <artifactId>akka-management-loglevels-log4j2_${scala.binary.version}</artifactId>
...
- https://doc.akka.io/libraries/akka-management/current/loglevels/logback.html

---
*Source: [https://doc.akka.io/libraries/akka-management/current/loglevels/log4j2.html](https://doc.akka.io/libraries/akka-management/current/loglevels/log4j2.html)*