...
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-persistence-jdbc/current/migration.html
title: Migration • Akka Persistence JDBC
---

# Migration • Akka Persistence JDBC
...
H2 has undergone considerable changes that broke backwards compatibility to make H2 SQL Standard compliant. For migration please refer to the H2 [migration guide](https://www.h2database.com/html/migration-to-v2.html)
...
### Example 1: Migrating to version 5.4.0
...
### Example 2: Migrating to version 5.0.0
...
---
*Source: [https://doc.akka.io/libraries/akka-persistence-jdbc/current/migration.html](https://doc.akka.io/libraries/akka-persistence-jdbc/current/migration.html)*