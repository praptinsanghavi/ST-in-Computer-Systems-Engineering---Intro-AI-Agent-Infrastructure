...
scraped_at: '2026-04-06T03:15:13Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/general/configuration-reference.html
...
Make your edits/overrides in your `application.conf`. Don’t override default values if you are not sure of the implications. [Akka Config Checker](https://doc.akka.io/libraries/akka-enhancements/current/config-checker.html) is a useful tool for finding potential configuration issues.
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-actor/src/main/resources/reference.conf "Go to snippet source")####################################
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-actor-typed/src/main/resources/reference.conf "Go to snippet source")akka.actor.typed {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-cluster-typed/src/main/resources/reference.conf "Go to snippet source")############################################
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-cluster/src/main/resources/reference.conf "Go to snippet source")######################################
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-discovery/src/main/resources/reference.conf "Go to snippet source")######################################################
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-coordination/src/main/resources/reference.conf "Go to snippet source")akka.coordination {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-multi-node-testkit/src/main/resources/reference.conf "Go to snippet source")#############################################
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-typed/src/main/resources/reference.conf "Go to snippet source")akka.actor {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/main/resources/reference.conf "Go to snippet source")###########################################################
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-query/src/main/resources/reference.conf "Go to snippet source")#######################################################
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-testkit/src/main/resources/reference.conf "Go to snippet source")##################################################
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-remote/src/main/resources/reference.conf#L2-L263 "Go to snippet source")#####################################
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-testkit/src/main/resources/reference.conf "Go to snippet source")######################################
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-cluster-metrics/src/main/resources/reference.conf "Go to snippet source")##############################################
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-cluster-tools/src/main/resources/reference.conf "Go to snippet source")############################################
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-cluster-sharding-typed/src/main/resources/reference.conf "Go to snippet source")  
# //#sharding-ext-config
# //#number-of-shards
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-cluster-sharding/src/main/resources/reference.conf "Go to snippet source")###############################################
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-distributed-data/src/main/resources/reference.conf "Go to snippet source")##############################################
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-stream/src/main/resources/reference.conf "Go to snippet source")#####################################
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-stream-testkit/src/main/resources/reference.conf "Go to snippet source")akka.stream.testkit {
...
### Example 13: akka-remote classic (deprecated)
...
### Example 15: akka-cluster-metrics
...
### Example 17: akka-cluster-sharding-typed
...
### Example 18: akka-cluster-sharding
...
### Example 19: akka-distributed-data
...
### Example 21: akka-stream-testkit
...
- https://doc.akka.io/libraries/akka-enhancements/current/config-checker.html

---
*Source: [https://doc.akka.io/libraries/akka-core/2.6/general/configuration-reference.html](https://doc.akka.io/libraries/akka-core/2.6/general/configuration-reference.html)*