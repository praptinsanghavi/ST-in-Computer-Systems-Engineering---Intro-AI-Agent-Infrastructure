...
title: Flow.lazyFlow • Akka Documentation
---

# Flow.lazyFlow • Akka Documentation
...
[`Flow.lazyFlow`](https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/Flow.html#lazyFlow(akka.japi.function.Creator) "akka.stream.javadsl.Flow")[`Flow.lazyFlow`](https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Flow$.html#lazyFlow[I,O,M](create:()=>akka.stream.scaladsl.Flow[I,O,M]):akka.stream.scaladsl.Flow[I,O,scala.concurrent.Future[M]] "akka.stream.scaladsl.Flow")
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/stream/operators/flow/Lazy.scala#L20-L42 "Go to snippet source")val numbers = Source
  .unfold(0) { n =>
    val next = n + 1
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/stream/operators/flow/Lazy.java#L25-L52 "Go to snippet source")Source<Integer, NotUsed> numbers =
    Source.unfold(
            0,
            n -> {
              int next = n + 1;
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/stream/operators/flow/Lazy.scala#L48-L65 "Go to snippet source")val mutableFold = Flow.lazyFlow { () =>
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/stream/operators/flow/Lazy.java#L58-L81 "Go to snippet source")Flow<Integer, List<Integer>, CompletionStage<NotUsed>> mutableFold =
    Flow.lazyFlow(
        () -> {
...
- https://doc.akka.io/libraries/akka-core/2.6/stream/operators/Source-or-Flow/flatMapPrefix.html
...
---
*Source: [https://doc.akka.io/libraries/akka-core/2.6/stream/operators/Flow/lazyFlow.html](https://doc.akka.io/libraries/akka-core/2.6/stream/operators/Flow/lazyFlow.html)*