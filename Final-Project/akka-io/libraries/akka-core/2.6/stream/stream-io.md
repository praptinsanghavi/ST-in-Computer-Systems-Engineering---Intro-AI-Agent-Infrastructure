...
title: Working with streaming IO • Akka Documentation
---
...
In order to implement a simple EchoServer we `bind` to a given address, which returns a [`Source`](https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/Source.html "akka.stream.javadsl.Source")[`Source`](https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Source.html "akka.stream.scaladsl.Source")\[[`IncomingConnection`](https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/Tcp.IncomingConnection.html "akka.stream.javadsl.Tcp.IncomingConnection")[`IncomingConnection`](https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Tcp$$IncomingConnection.html "akka.stream.scaladsl.Tcp.IncomingConnection"), [`Future`](http://www.scala-lang.org/api/2.13.8/scala/concurrent/Future.html "scala.concurrent.Future")\[[`ServerBinding`](https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/Tcp.ServerBinding.html "akka.stream.javadsl.Tcp.ServerBinding")[`ServerBinding`](https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Tcp$$ServerBinding.html "akka.stream.scaladsl.Tcp.ServerBinding")][`Source`](https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/Source.html "akka.stream.javadsl.Source")[`Source`](https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Source.html "akka.stream.scaladsl.Source")\<[`IncomingConnection`](https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/Tcp.IncomingConnection.html "akka.stream.javadsl.Tcp.IncomingConnection")[`IncomingConnection`](https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Tcp$$IncomingConnection.html "akka.stream.scaladsl.Tcp.IncomingConnection"), [`CompletionStage`](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html "java.util.concurrent.CompletionStage")\<[`ServerBinding`](https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/Tcp.ServerBinding.html "akka.stream.javadsl.Tcp.ServerBinding")[`ServerBinding`](https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Tcp$$ServerBinding.html "akka.stream.scaladsl.Tcp.ServerBinding")\>\>, which will emit an `IncomingConnection` element for each new connection that the Server should handle:

Scala

```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/stream/io/StreamTcpDocSpec.scala#L29-L36 "Go to snippet source")val binding: Future[ServerBinding] =
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/stream/io/StreamTcpDocTest.java#L62-L64 "Go to snippet source")// IncomingConnection and ServerBinding imported from Tcp
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/stream/io/StreamTcpDocTest.java#L73-L88 "Go to snippet source")connections.runForeach(
    connection -> {
...
Closing connections is possible by cancelling the *incoming connection* [`Flow`](https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/Flow.html "akka.stream.javadsl.Flow")[`Flow`](https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Flow.html "akka.stream.scaladsl.Flow") from your server logic (e.g. by connecting its downstream to a [`Sink.cancelled`](https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/Sink.html#cancelled() "akka.stream.javadsl.Sink")[`Sink.cancelled`](https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Sink$.html#cancelled[T]:akka.stream.scaladsl.Sink[T,akka.NotUsed] "akka.stream.scaladsl.Sink") and its upstream to a [`Source.empty`](https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/Source.html#empty() "akka.stream.javadsl.Source")[`Source.empty`](https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Source$.html#empty[T]:akka.stream.scaladsl.Source[T,akka.NotUsed] "akka.stream.scaladsl.Source"). It is also possible to shut down the server’s socket by cancelling the [`IncomingConnection`](https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/Tcp.IncomingConnection.html "akka.stream.javadsl.Tcp.IncomingConnection")[`IncomingConnection`](https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Tcp$$IncomingConnection.html "akka.stream.scaladsl.Tcp.IncomingConnection") source `connections`.
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/stream/io/StreamTcpDocSpec.scala#L114-L132 "Go to snippet source")val connection = Tcp(system).outgoingConnection("127.0.0.1", 8888)
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/stream/io/StreamTcpDocTest.java#L150-L177 "Go to snippet source")final Flow<ByteString, ByteString, CompletionStage<OutgoingConnection>> connection =
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/stream/io/StreamTcpDocSpec.scala#L70-L95 "Go to snippet source")connections
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/stream/io/StreamTcpDocTest.java#L103-L141 "Go to snippet source")connections
    .to(
        Sink.foreach(
...
To emit the initial message we merge a [`Source`](https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/Source.html "akka.stream.javadsl.Source")[`Source`](https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Source.html "akka.stream.scaladsl.Source") with a single element, after the command processing but before the framing and transformation to [`ByteString`](https://doc.akka.io/api/akka-core/2.6/akka/util/ByteString.html "akka.util.ByteString")[`ByteString`](https://doc.akka.io/japi/akka-core/2.6/akka/util/ByteString.html "akka.util.ByteString") s this way we do not have to repeat such logic.
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-stream-tests/src/test/java/akka/stream/javadsl/JsonFramingTest.java#L36-L47 "Go to snippet source")String input =
...
Similar factories as shown above for raw TCP but where the data is encrypted using TLS are available from `Tcp` through `outgoingConnectionWithTls`, `bindWithTls` and `bindAndHandleWithTls`, see the [``Tcp Scaladoc``](https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Tcp.html "akka.stream.scaladsl.Tcp")[``Tcp Javadoc``](https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/Tcp.html "akka.stream.javadsl.Tcp") for details.
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-stream-tests/src/test/scala/akka/stream/io/TcpSpec.scala#L922-L960 "Go to snippet source")import java.security.KeyStore
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-stream-tests/src/test/java/akka/stream/javadsl/TcpTest.java#L46-L224 "Go to snippet source")// imports
...
Akka Streams provide simple Sources and Sinks that can work with [`ByteString`](https://doc.akka.io/api/akka-core/2.6/akka/util/ByteString.html "akka.util.ByteString")[`ByteString`](https://doc.akka.io/japi/akka-core/2.6/akka/util/ByteString.html "akka.util.ByteString") instances to perform IO operations on files.
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/stream/io/StreamFileDocSpec.scala#L31-L55 "Go to snippet source")import akka.stream.scaladsl._
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/stream/io/StreamFileDocTest.java#L50-L69 "Go to snippet source")final Path file = Paths.get("example.csv");
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/stream/io/StreamFileDocSpec.scala#L61 "Go to snippet source")FileIO.fromPath(file).withAttributes(ActorAttributes.dispatcher("custom-blocking-io-dispatcher"))
```

Java

```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/stream/io/StreamFileDocTest.java#L83-L84 "Go to snippet source")FileIO.toPath(file)
...
- https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Framing$.html
- https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/JsonFraming$.html
...
- https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Source.html
- https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Tcp$$IncomingConnection.html
- https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Tcp$$ServerBinding.html
- https://doc.akka.io/api/akka-core/2.6/akka/stream/scaladsl/Tcp.html
...
- https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/Framing.html
- https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/JsonFraming.html
...
- https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/Tcp.IncomingConnection.html
- https://doc.akka.io/japi/akka-core/2.6/akka/stream/javadsl/Tcp.ServerBinding.html
...
- https://doc.akka.io/libraries/akka-core/2.6/io-tcp.html
- https://doc.akka.io/libraries/akka-core/2.6/stream/stream-customize.html
- https://doc.akka.io/libraries/akka-core/2.6/stream/stream-error.html
- https://doc.akka.io/libraries/akka-core/2.6/stream/stream-graphs.html
- https://doc.akka.io/libraries/akka-core/2.6/stream/stream-refs.html

---
*Source: [https://doc.akka.io/libraries/akka-core/2.6/stream/stream-io.html](https://doc.akka.io/libraries/akka-core/2.6/stream/stream-io.html)*