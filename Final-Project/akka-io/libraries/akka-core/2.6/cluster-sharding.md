...
| --- | --- |
| Artifact | com.typesafe.akka akka\-cluster\-sharding 2\.6\.21 [Snapshots are available](project/links.html#snapshots-repository) |
...
| API documentation | [API (Scaladoc)](https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/sharding/index.html) [API (Javadoc)](https://doc.akka.io/japi/akka-core/2.6.21/akka/cluster/sharding/package-summary.html) |
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-cluster-sharding/src/multi-jvm/scala/akka/cluster/sharding/ClusterShardingSpec.scala#L29-L69 "Go to snippet source")case object Increment
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java#L155-L237 "Go to snippet source")static class Counter extends AbstractPersistentActor {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-cluster-sharding/src/multi-jvm/scala/akka/cluster/sharding/ClusterShardingSpec.scala#L676-L681 "Go to snippet source")val counterRegion: ActorRef = ClusterSharding(system).start(
  typeName = "Counter",
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java#L25-L84 "Go to snippet source")import akka.japi.Option;
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-cluster-sharding/src/multi-jvm/scala/akka/cluster/sharding/ClusterShardingSpec.scala#L186-L200 "Go to snippet source")val extractEntityId: ShardRegion.ExtractEntityId = {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java#L20-L76 "Go to snippet source")import akka.cluster.sharding.ShardRegion;
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-cluster-sharding/src/multi-jvm/scala/akka/cluster/sharding/ClusterShardingSpec.scala#L704-L710 "Go to snippet source")val counterRegion: ActorRef = ClusterSharding(system).shardRegion("Counter")
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java#L88-L92 "Go to snippet source")ActorRef counterRegion = ClusterSharding.get(system).shardRegion("Counter");
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-cluster-sharding/src/multi-jvm/scala/akka/cluster/sharding/ClusterShardingSpec.scala#L205-L212 "Go to snippet source")val extractShardId: ShardRegion.ExtractShardId = {
  case EntityEnvelope(id, _)       => (id % numberOfShards).toString
  case Get(id)                     => (id % numberOfShards).toString
  case ShardRegion.StartEntity(id) =>
    // StartEntity is used by remembering entities feature
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java#L133-L148 "Go to snippet source")@Override
public String shardId(Object message) {
  int numberOfShards = 100;
  if (message instanceof Counter.EntityEnvelope) {
    long id = ((Counter.EntityEnvelope) message).id;
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-cluster-sharding/src/multi-jvm/scala/akka/cluster/sharding/ClusterShardingSpec.scala#L96-L109 "Go to snippet source")class CounterSupervisor extends Actor {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java#L241-L265 "Go to snippet source")static class CounterSupervisor extends AbstractActor {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-cluster-sharding/src/multi-jvm/scala/akka/cluster/sharding/ClusterShardingSpec.scala#L693-L698 "Go to snippet source")ClusterSharding(system).start(
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java#L96-L98 "Go to snippet source")ClusterSharding.get(system)
    .start(
...
- https://doc.akka.io/japi/akka-core/2.6.21/akka/cluster/sharding/package-summary.html
...
- https://doc.akka.io/libraries/akka-core/2.6/distributed-data.html
- https://doc.akka.io/libraries/akka-core/2.6/fault-tolerance.html
...
- https://doc.akka.io/libraries/akka-core/2.6/typed/cluster-sharding-concepts.html
...
---
*Source: [https://doc.akka.io/libraries/akka-core/2.6/cluster-sharding.html](https://doc.akka.io/libraries/akka-core/2.6/cluster-sharding.html)*