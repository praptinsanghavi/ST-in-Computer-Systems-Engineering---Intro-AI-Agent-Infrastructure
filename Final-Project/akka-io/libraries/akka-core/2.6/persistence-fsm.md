...
scraped_at: '2026-04-06T03:15:00Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/persistence-fsm.html
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/test/scala/akka/persistence/fsm/PersistentFSMSpec.scala#L437-L441 "Go to snippet source")sealed trait Command
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/test/java/akka/persistence/fsm/AbstractPersistentFSMTest.java#L114-L136 "Go to snippet source")public static final class AddItem implements Command {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/test/scala/akka/persistence/fsm/PersistentFSMSpec.scala#L404-L416 "Go to snippet source")sealed trait UserState extends FSMState
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/test/java/akka/persistence/fsm/AbstractPersistentFSMTest.java#L28-L44 "Go to snippet source")enum UserState implements PersistentFSM.FSMState {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/test/scala/akka/persistence/fsm/PersistentFSMSpec.scala#L445-L449 "Go to snippet source")sealed trait DomainEvent
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/test/java/akka/persistence/fsm/AbstractPersistentFSMTest.java#L142-L160 "Go to snippet source")public static final class ItemAdded implements DomainEvent {
  private final Item item;
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/test/scala/akka/persistence/fsm/PersistentFSMSpec.scala#L420-L433 "Go to snippet source")case class Item(id: String, name: String, price: Float)
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/test/java/akka/persistence/fsm/AbstractPersistentFSMTest.java#L48-L108 "Go to snippet source")public static class ShoppingCart {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/test/scala/akka/persistence/fsm/PersistentFSMSpec.scala#L488-L538 "Go to snippet source")startWith(LookingAround, EmptyShoppingCart)
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/test/java/akka/persistence/fsm/AbstractPersistentFSMTest.java#L206-L279 "Go to snippet source")startWith(UserState.LOOKING_AROUND, new ShoppingCart());
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/test/scala/akka/persistence/fsm/PersistentFSMSpec.scala#L548-L555 "Go to snippet source")override def applyEvent(event: DomainEvent, cartBeforeEvent: ShoppingCart): ShoppingCart = {
  event match {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/test/java/akka/persistence/fsm/AbstractPersistentFSMTest.java#L290-L302 "Go to snippet source")@Override
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/test/scala/akka/persistence/fsm/PersistentFSMSpec.scala#L502-L509 "Go to snippet source")goto(Paid).applying(OrderExecuted).andThen {
  case NonEmptyShoppingCart(items) =>
    reportActor ! PurchaseWasMade(items)
}
```
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/test/java/akka/persistence/fsm/AbstractPersistentFSMTest.java#L227-L237 "Go to snippet source")(event, data) ->
    goTo(UserState.PAID)
        .applying(OrderExecuted.INSTANCE)
        .andThen(
            exec(
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/test/scala/akka/persistence/fsm/PersistentFSMSpec.scala#L513-L517 "Go to snippet source")stop().applying(OrderDiscarded).andThen {
  case _ =>
    reportActor ! ShoppingCardDiscarded
    saveStateSnapshot()
}
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence/src/test/java/akka/persistence/fsm/AbstractPersistentFSMTest.java#L242-L250 "Go to snippet source")(event, data) ->
    stop()
        .applying(OrderDiscarded.INSTANCE)
        .andThen(
            exec(
...
Persistent FSMs can be represented using [Persistence Typed](typed/persistence.html). The data stored by Persistence FSM can be read by an [`EventSourcedBehavior`](https://doc.akka.io/japi/akka-core/2.6/akka/persistence/typed/javadsl/EventSourcedBehavior.html "akka.persistence.typed.javadsl.EventSourcedBehavior")[`EventSourcedBehavior`](https://doc.akka.io/api/akka-core/2.6/akka/persistence/typed/scaladsl/EventSourcedBehavior.html "akka.persistence.typed.scaladsl.EventSourcedBehavior") using a snapshot adapter and an event adapter. The adapters are required as Persistent FSM doesn’t store snapshots and user data directly, it wraps them in internal types that include state transition information.

Before reading the migration guide it is advised to understand [Persistence Typed](typed/persistence.html). 

### Migration steps

1. Modify or create new commands to include `replyTo` [`ActorRef`](https://doc.akka.io/api/akka-core/2.6/akka/actor/typed/ActorRef.html "akka.actor.typed.ActorRef")[`ActorRef`](https://doc.akka.io/japi/akka-core/2.6/akka/actor/typed/ActorRef.html "akka.actor.typed.ActorRef")
...
5. Add an [`EventAdapter`](https://doc.akka.io/api/akka-core/2.6/akka/persistence/typed/EventAdapter.html "akka.persistence.typed.EventAdapter")[`EventAdapter`](https://doc.akka.io/japi/akka-core/2.6/akka/persistence/typed/EventAdapter.html "akka.persistence.typed.EventAdapter") to convert state transition events added by `PersistentFSM` into private events or filter them
6. If snapshots are used add a [`SnapshotAdapter`](https://doc.akka.io/api/akka-core/2.6/akka/persistence/typed/SnapshotAdapter.html "akka.persistence.typed.SnapshotAdapter")[`SnapshotAdapter`](https://doc.akka.io/japi/akka-core/2.6/akka/persistence/typed/SnapshotAdapter.html "akka.persistence.typed.SnapshotAdapter") to convert PersistentFSM snapshots into the `EventSourcedBehavior`s `State`
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-typed/src/test/scala/docs/akka/persistence/typed/PersistentFsmToTypedMigrationSpec.scala#L55-L60 "Go to snippet source")sealed trait Command
case class AddItem(item: Item) extends Command
case object Buy extends Command
case object Leave extends Command
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-typed/src/test/java/jdocs/akka/persistence/typed/PersistentFsmToTypedMigrationCompileOnlyTest.java#L20-L48 "Go to snippet source")interface Command {}
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-typed/src/test/scala/docs/akka/persistence/typed/PersistentFsmToTypedMigrationSpec.scala#L64-L68 "Go to snippet source")sealed trait State
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-typed/src/test/java/jdocs/akka/persistence/typed/PersistentFsmToTypedMigrationCompileOnlyTest.java#L52-L82 "Go to snippet source")abstract static class State {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-typed/src/test/scala/docs/akka/persistence/typed/PersistentFsmToTypedMigrationSpec.scala#L109-L154 "Go to snippet source")def commandHandler(timers: TimerScheduler[Command])(state: State, command: Command): Effect[DomainEvent, State] =
  state match {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-typed/src/test/java/jdocs/akka/persistence/typed/PersistentFsmToTypedMigrationCompileOnlyTest.java#L135-L155 "Go to snippet source")  CommandHandlerBuilder<Command, DomainEvent, State> builder = newCommandHandlerBuilder();
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-typed/src/test/scala/docs/akka/persistence/typed/PersistentFsmToTypedMigrationSpec.scala#L193-L200 "Go to snippet source").receiveSignal {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-typed/src/test/java/jdocs/akka/persistence/typed/PersistentFsmToTypedMigrationCompileOnlyTest.java#L218-L229 "Go to snippet source")@Override
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-typed/src/test/scala/docs/akka/persistence/typed/PersistentFsmToTypedMigrationSpec.scala#L158-L180 "Go to snippet source")def eventHandler(state: State, event: DomainEvent): State = {
  state match {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-typed/src/test/java/jdocs/akka/persistence/typed/PersistentFsmToTypedMigrationCompileOnlyTest.java#L186-L209 "Go to snippet source")@Override
...
The last step is the adapters that will allow the new [`EventSourcedBehavior`](https://doc.akka.io/japi/akka-core/2.6/akka/persistence/typed/javadsl/EventSourcedBehavior.html "akka.persistence.typed.javadsl.EventSourcedBehavior")[`EventSourcedBehavior`](https://doc.akka.io/api/akka-core/2.6/akka/persistence/typed/scaladsl/EventSourcedBehavior.html "akka.persistence.typed.scaladsl.EventSourcedBehavior") to read the old data:

Scala

```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-typed/src/test/scala/docs/akka/persistence/typed/PersistentFsmToTypedMigrationSpec.scala#L86-L103 "Go to snippet source")class PersistentFsmEventAdapter extends EventAdapter[DomainEvent, Any] {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-typed/src/test/java/jdocs/akka/persistence/typed/PersistentFsmToTypedMigrationCompileOnlyTest.java#L86-L113 "Go to snippet source")public static class PersistentFSMEventAdapter extends EventAdapter<DomainEvent, Object> {
...
The snapshot adapter needs to adapt an internal type of PersistentFSM so a helper function is provided to build the [`SnapshotAdapter`](https://doc.akka.io/api/akka-core/2.6/akka/persistence/typed/SnapshotAdapter.html "akka.persistence.typed.SnapshotAdapter")[`SnapshotAdapter`](https://doc.akka.io/japi/akka-core/2.6/akka/persistence/typed/SnapshotAdapter.html "akka.persistence.typed.SnapshotAdapter"):

Scala

```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-typed/src/test/scala/docs/akka/persistence/typed/PersistentFsmToTypedMigrationSpec.scala#L72-L82 "Go to snippet source")val persistentFSMSnapshotAdapter: SnapshotAdapter[State] = PersistentFSMMigration.snapshotAdapter[State] {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-persistence-typed/src/test/java/jdocs/akka/persistence/typed/PersistentFsmToTypedMigrationCompileOnlyTest.java#L233-L251 "Go to snippet source")@Override
...
That concludes all the steps to allow an [`EventSourcedBehavior`](https://doc.akka.io/japi/akka-core/2.6/akka/persistence/typed/javadsl/EventSourcedBehavior.html "akka.persistence.typed.javadsl.EventSourcedBehavior")[`EventSourcedBehavior`](https://doc.akka.io/api/akka-core/2.6/akka/persistence/typed/scaladsl/EventSourcedBehavior.html "akka.persistence.typed.scaladsl.EventSourcedBehavior") to read a `PersistentFSM`’s data. Once the new code has been running you can not roll back as the PersistentFSM will not be able to read data written by Persistence Typed. 
...
- https://doc.akka.io/api/akka-core/2.6/akka/persistence/typed/EventAdapter.html
- https://doc.akka.io/api/akka-core/2.6/akka/persistence/typed/SnapshotAdapter.html
...
- https://doc.akka.io/japi/akka-core/2.6/akka/persistence/typed/EventAdapter.html
- https://doc.akka.io/japi/akka-core/2.6/akka/persistence/typed/SnapshotAdapter.html
...
- https://doc.akka.io/libraries/akka-core/2.6/typed/persistence.html

---
*Source: [https://doc.akka.io/libraries/akka-core/2.6/persistence-fsm.html](https://doc.akka.io/libraries/akka-core/2.6/persistence-fsm.html)*