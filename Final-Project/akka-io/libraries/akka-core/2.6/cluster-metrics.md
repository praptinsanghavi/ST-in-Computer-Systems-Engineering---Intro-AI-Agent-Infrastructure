...
scraped_at: '2026-04-06T14:23:47Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/cluster-metrics.html
title: Classic Cluster Metrics Extension • Akka Documentation
---

# Classic Cluster Metrics Extension • Akka Documentation
...
| --- | --- |
| Artifact | com.typesafe.akka akka\-cluster\-metrics 2\.6\.21 [Snapshots are available](project/links.html#snapshots-repository) |
...
| API documentation | [API (Scaladoc)](https://doc.akka.io/api/akka-core/2.6.21/akka/cluster/metrics/index.html) [API (Javadoc)](https://doc.akka.io/japi/akka-core/2.6.21/akka/cluster/metrics/package-summary.html) |
...
Both user\-provided and built\-in metrics collectors can optionally use [Hyperic Sigar](http://www.hyperic.com/products/sigar) for a wider and more accurate range of metrics compared to what can be retrieved from ordinary JMX MBeans.
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/cluster/FactorialBackend.scala#L17-L38 "Go to snippet source")class FactorialBackend extends Actor with ActorLogging {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/cluster/FactorialBackend.java#L14-L38 "Go to snippet source")public class FactorialBackend extends AbstractActor {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/cluster/FactorialFrontend.scala#L20-L47 "Go to snippet source")class FactorialFrontend(upToN: Int, repeat: Boolean) extends Actor with ActorLogging {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/cluster/FactorialFrontend.java#L30-L77 "Go to snippet source")public class FactorialFrontend extends AbstractActor {
  final int upToN;
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/cluster/FactorialFrontend.scala#L71-L85 "Go to snippet source")import akka.cluster.routing.ClusterRouterGroup
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/cluster/FactorialFrontend.java#L83-L97 "Go to snippet source")int totalInstances = 100;
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/cluster/MetricsListener.scala#L8-L49 "Go to snippet source")import akka.actor.ActorLogging
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/cluster/MetricsListener.java#L8-L73 "Go to snippet source")import akka.actor.AbstractActor;
import akka.cluster.Cluster;
import akka.cluster.ClusterEvent.CurrentClusterState;
import akka.cluster.metrics.ClusterMetricsChanged;
import akka.cluster.metrics.NodeMetrics;
...
- https://doc.akka.io/japi/akka-core/2.6.21/akka/cluster/metrics/package-summary.html
...
---
*Source: [https://doc.akka.io/libraries/akka-core/2.6/cluster-metrics.html](https://doc.akka.io/libraries/akka-core/2.6/cluster-metrics.html)*