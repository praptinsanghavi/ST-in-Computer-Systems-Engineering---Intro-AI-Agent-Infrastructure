...
scraped_at: '2026-04-06T14:23:43Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/typed/cluster-sharding-concepts.html
title: Cluster Sharding concepts • Akka Documentation
---
...
See also [Shard allocation](cluster-sharding.html#shard-allocation).

### ShardCoordinator state

The state of shard locations in the `ShardCoordinator` is persistent (durable) with [Distributed Data](distributed-data.html) (or see [Classic Distributed Data](../distributed-data.html)) to survive failures. 
...
Reliable end\-to\-end messaging, with at\-least\-once semantics can be added by using the [Reliable Delivery](reliable-delivery.html#sharding) feature.
...
- https://doc.akka.io/libraries/akka-core/2.6/typed/cluster-sharded-daemon-process.html
...
---
*Source: [https://doc.akka.io/libraries/akka-core/2.6/typed/cluster-sharding-concepts.html](https://doc.akka.io/libraries/akka-core/2.6/typed/cluster-sharding-concepts.html)*