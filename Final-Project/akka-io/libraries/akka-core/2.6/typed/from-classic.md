...
scraped_at: '2026-04-06T14:04:37Z'
section: libraries
site: akka-io
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-actor-typed-tests/src/test/scala/docs/akka/typed/fromclassic/ClassicSample.scala#L8-L34 "Go to snippet source")import akka.actor.Actor
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/fromclassic/ClassicSample.java#L8-L51 "Go to snippet source")import akka.actor.AbstractActor;
import akka.actor.Props;
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-actor-typed-tests/src/test/scala/docs/akka/typed/fromclassic/TypedSample.scala#L8-L35 "Go to snippet source")import akka.actor.typed.ActorRef
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/fromclassic/TypedSample.java#L8-L63 "Go to snippet source")import akka.actor.typed.ActorRef;
import akka.actor.typed.Behavior;
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-actor-typed-tests/src/test/scala/docs/akka/typed/fromclassic/TypedSample.scala#L39-L68 "Go to snippet source")object Parent {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/fromclassic/TypedSample.java#L67-L122 "Go to snippet source")public class Parent extends AbstractBehavior<Parent.Command> {
...
- https://doc.akka.io/libraries/akka-core/2.6/fsm.html
...
- https://doc.akka.io/libraries/akka-core/2.6/typed/guide/tutorial_3.html
- https://doc.akka.io/libraries/akka-core/2.6/typed/index-cluster.html
...
- https://doc.akka.io/libraries/akka-core/2.6/typed/routers.html
- https://doc.akka.io/libraries/akka-core/2.6/typed/stash.html
...
---
*Source: [https://doc.akka.io/libraries/akka-core/2.6/typed/from-classic.html](https://doc.akka.io/libraries/akka-core/2.6/typed/from-classic.html)*