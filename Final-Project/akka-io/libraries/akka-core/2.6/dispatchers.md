...
scraped_at: '2026-04-06T03:15:19Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/dispatchers.html
title: Classic Dispatchers • Akka Documentation
---
...
Dispatchers implement the [`ExecutionContext`](http://www.scala-lang.org/api/2.13.8/scala/concurrent/ExecutionContext.html "scala.concurrent.ExecutionContext")[`Executor`](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/Executor.html "java.util.concurrent.Executor") interface and can thus be used to run [`Future`](http://www.scala-lang.org/api/2.13.8/scala/concurrent/Future.html "scala.concurrent.Future")[`CompletableFuture`](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletableFuture.html "java.util.concurrent.CompletableFuture") invocations etc.

Scala

```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/dispatcher/DispatcherDocSpec.scala#L339-L340 "Go to snippet source")// for use with Futures, Scheduler, etc.
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/dispatcher/DispatcherDocTest.java#L91-L94 "Go to snippet source")// this is scala.concurrent.ExecutionContextExecutor, which implements
...
So in case you want to give your [`Actor`](https://doc.akka.io/api/akka-core/2.6/akka/actor/Actor.html "akka.actor.Actor")[`Actor`](https://doc.akka.io/japi/akka-core/2.6/akka/actor/Actor.html "akka.actor.Actor") a different dispatcher than the default, you need to do two things, of which the first is to configure the dispatcher:

```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/dispatcher/DispatcherDocSpec.scala#L49-L67 "Go to snippet source")my-dispatcher {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/dispatcher/DispatcherDocSpec.scala#L131-L138 "Go to snippet source")blocking-io-dispatcher {
  type = Dispatcher
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/dispatcher/DispatcherDocSpec.scala#L295-L296 "Go to snippet source")import akka.actor.Props
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/dispatcher/DispatcherDocTest.java#L57 "Go to snippet source")ActorRef myActor = system.actorOf(Props.create(MyActor.class), "myactor");
```

```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/dispatcher/DispatcherDocSpec.scala#L170-L174 "Go to snippet source")akka.actor.deployment {
  /myactor {
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/scala/docs/dispatcher/DispatcherDocSpec.scala#L303-L305 "Go to snippet source")import akka.actor.Props
val myActor =
...
```
[source](https://github.com/akka/akka/tree/v2.6.21/akka-docs/src/test/java/jdocs/dispatcher/DispatcherDocTest.java#L65-L66 "Go to snippet source")ActorRef myActor =
    system.actorOf(Props.create(MyActor.class).withDispatcher("my-dispatcher"), "myactor3");
```

Note
The dispatcher you specify in [`withDispatcher`](https://doc.akka.io/api/akka-core/2.6/akka/actor/Props.html#withDispatcher(d:String):akka.actor.Props "akka.actor.Props")[`withDispatcher`](https://doc.akka.io/japi/akka-core/2.6/akka/actor/Props.html#withDispatcher(java.lang.String) "akka.actor.Props") and the `dispatcher` property in the deployment configuration is in fact a path into your configuration. So in this example it’s a top\-level section, but you could for instance put it as a sub\-section, where you’d use periods to denote sub\-sections, like this: `"foo.bar.my-dispatcher"`
...
- https://doc.akka.io/libraries/akka-core/2.6/mailboxes.html
...
---
*Source: [https://doc.akka.io/libraries/akka-core/2.6/dispatchers.html](https://doc.akka.io/libraries/akka-core/2.6/dispatchers.html)*