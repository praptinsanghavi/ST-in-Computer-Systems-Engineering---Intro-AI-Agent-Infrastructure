...
title: Sharded Daemon Process • Akka Documentation
---
...
| --- | --- |
| Artifact | com.typesafe.akka akka\-cluster\-sharding\-typed 2\.9\.8 [Snapshots are available](project/links.html#snapshots-repository) |
...
| API documentation | [API (Scaladoc)](https://doc.akka.io/api/akka/2.9.8/akka/cluster/sharding/typed/index.html) [API (Javadoc)](https://doc.akka.io/japi/akka/2.9.8/akka/cluster/sharding/typed/package-summary.html) |
...
```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-cluster-sharding-typed/src/test/scala/akka/cluster/sharding/typed/scaladsl/ShardedDaemonProcessSpec.scala#L193-L194 "Go to snippet source")val tags = Vector("tag-1", "tag-2", "tag-3")
...
```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-cluster-sharding-typed/src/test/java/akka/cluster/sharding/typed/javadsl/ShardedDaemonProcessCompileOnlyTest.java#L42-L48 "Go to snippet source")List<String> tags = Arrays.asList("tag-1", "tag-2", "tag-3");
...
Starting the sharded daemon process with `initWithContext` returns an `ActorRef[ShardedDaemonProcessCommand]` that accepts a [`ChangeNumberOfProcesses`](https://doc.akka.io/api/akka-core/2.9/akka/cluster/sharding/typed/ChangeNumberOfProcesses.html "akka.cluster.sharding.typed.ChangeNumberOfProcesses")[`ChangeNumberOfProcesses`](https://doc.akka.io/japi/akka-core/2.9/akka/cluster/sharding/typed/ChangeNumberOfProcesses.html "akka.cluster.sharding.typed.ChangeNumberOfProcesses") command to rescale the process to a new number of workers.
...
To colocate such processes you can use the [`ConsistentHashingShardAllocationStrategy`](https://doc.akka.io/api/akka-core/2.9/akka/cluster/sharding/ConsistentHashingShardAllocationStrategy.html "akka.cluster.sharding.ConsistentHashingShardAllocationStrategy")[`ConsistentHashingShardAllocationStrategy`](https://doc.akka.io/japi/akka-core/2.9/akka/cluster/sharding/ConsistentHashingShardAllocationStrategy.html "akka.cluster.sharding.ConsistentHashingShardAllocationStrategy") as `shardAllocationStrategy` parameter of the `init` or `initWithContext` methods. 
...
The following configuration properties are read by the [`ShardedDaemonProcessSettings`](https://doc.akka.io/api/akka-core/2.9/akka/cluster/sharding/typed/ShardedDaemonProcessSettings.html "akka.cluster.sharding.typed.ShardedDaemonProcessSettings")[`ShardedDaemonProcessSettings`](https://doc.akka.io/japi/akka-core/2.9/akka/cluster/sharding/typed/ShardedDaemonProcessSettings.html "akka.cluster.sharding.typed.ShardedDaemonProcessSettings") when created with a [`ActorSystem`](https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/ActorSystem.html "akka.actor.typed.ActorSystem")[`ActorSystem`](https://doc.akka.io/japi/akka-core/2.9/akka/actor/typed/ActorSystem.html "akka.actor.typed.ActorSystem") parameter:

```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-cluster-sharding-typed/src/main/resources/reference.conf#L17-L37 "Go to snippet source")akka.cluster.sharded-daemon-process {
...
- https://doc.akka.io/api/akka-core/2.9/akka/cluster/sharding/ConsistentHashingShardAllocationStrategy.html
- https://doc.akka.io/api/akka-core/2.9/akka/cluster/sharding/typed/ChangeNumberOfProcesses.html
- https://doc.akka.io/api/akka-core/2.9/akka/cluster/sharding/typed/ShardedDaemonProcessSettings.html
- https://doc.akka.io/api/akka/2.9.8/akka/cluster/sharding/typed/index.html
...
- https://doc.akka.io/japi/akka-core/2.9/akka/cluster/sharding/ConsistentHashingShardAllocationStrategy.html
- https://doc.akka.io/japi/akka-core/2.9/akka/cluster/sharding/typed/ChangeNumberOfProcesses.html
- https://doc.akka.io/japi/akka-core/2.9/akka/cluster/sharding/typed/ShardedDaemonProcessSettings.html
- https://doc.akka.io/japi/akka/2.9.8/akka/cluster/sharding/typed/package-summary.html
- https://doc.akka.io/libraries/akka-core/2.9/persistence-query.html
- https://doc.akka.io/libraries/akka-core/2.9/typed/actor-discovery.html
- https://doc.akka.io/libraries/akka-core/2.9/typed/cluster-dc.html
- https://doc.akka.io/libraries/akka-core/2.9/typed/cluster-sharding-concepts.html
- https://doc.akka.io/libraries/akka-core/2.9/typed/cluster-singleton.html
- https://doc.akka.io/libraries/akka-core/2.9/typed/persistence.html
- https://doc.akka.io/libraries/akka-core/2.9/typed/project/links.html

---
*Source: [https://doc.akka.io/libraries/akka-core/2.9/typed/cluster-sharded-daemon-process.html](https://doc.akka.io/libraries/akka-core/2.9/typed/cluster-sharded-daemon-process.html)*