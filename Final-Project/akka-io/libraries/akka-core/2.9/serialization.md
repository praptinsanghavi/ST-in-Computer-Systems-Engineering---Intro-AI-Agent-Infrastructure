...
scraped_at: '2026-04-06T14:31:35Z'
section: libraries
site: akka-io
...
```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-docs/src/test/scala/docs/serialization/SerializationDocSpec.scala#L176-L190 "Go to snippet source")akka {
  actor {
    serializers {
      jackson-json = "akka.serialization.jackson.JacksonJsonSerializer"
      jackson-cbor = "akka.serialization.jackson.JacksonCborSerializer"
...
```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-docs/src/test/scala/docs/serialization/SerializationDocSpec.scala#L8-L12 "Go to snippet source")import akka.actor._
...
```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-docs/src/test/java/jdocs/serialization/SerializationDocTest.java#L14-L19 "Go to snippet source")import akka.actor.*;
...
```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-docs/src/test/scala/docs/serialization/SerializationDocSpec.scala#L200-L214 "Go to snippet source")val system = ActorSystem("example")
...
```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-docs/src/test/java/jdocs/serialization/SerializationDocTest.java#L161-L176 "Go to snippet source")ActorSystem system = ActorSystem.create("example");
...
The [`SerializationExtension`](https://doc.akka.io/api/akka-core/2.9/akka/serialization/SerializationExtension$.html "akka.serialization.SerializationExtension")[`SerializationExtension`](https://doc.akka.io/japi/akka-core/2.9/akka/serialization/SerializationExtension.html "akka.serialization.SerializationExtension") is a Classic [`Extension`](https://doc.akka.io/api/akka-core/2.9/akka/actor/Extension.html "akka.actor.Extension")[`Extension`](https://doc.akka.io/japi/akka-core/2.9/akka/actor/Extension.html "akka.actor.Extension"), but it can be used with an [`akka.actor.typed.ActorSystem`](https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/ActorSystem.html "akka.actor.typed.ActorSystem")[`akka.actor.typed.ActorSystem`](https://doc.akka.io/japi/akka-core/2.9/akka/actor/typed/ActorSystem.html "akka.actor.typed.ActorSystem") like this:

Scala

```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-docs/src/test/scala/docs/serialization/SerializationDocSpec.scala#L225-L230 "Go to snippet source")import akka.actor.typed.ActorSystem
...
```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-docs/src/test/java/jdocs/serialization/SerializationDocTest.java#L187-L191 "Go to snippet source")akka.actor.typed.ActorSystem<Void> system =
...
A custom `Serializer` has to inherit from [`akka.serialization.Serializer`](https://doc.akka.io/api/akka-core/2.9/akka/serialization/Serializer.html "akka.serialization.Serializer")[`akka.serialization.Serializer`](https://doc.akka.io/japi/akka-core/2.9/akka/serialization/Serializer.html "akka.serialization.Serializer")[`akka.serialization.JSerializer`](https://doc.akka.io/api/akka-core/2.9/akka/serialization/JSerializer.html "akka.serialization.JSerializer")[`akka.serialization.JSerializer`](https://doc.akka.io/japi/akka-core/2.9/akka/serialization/JSerializer.html "akka.serialization.JSerializer") and can be defined like the following:
...
```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-docs/src/test/scala/docs/serialization/SerializationDocSpec.scala#L27-L58 "Go to snippet source")class MyOwnSerializer extends Serializer {
...
```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-docs/src/test/java/jdocs/serialization/SerializationDocTest.java#L25-L64 "Go to snippet source")static class MyOwnSerializer extends JSerializer {
...
The `identifier` must be unique. The identifier is used when selecting which serializer to use for deserialization. If you have accidentally configured several serializers with the same identifier that will be detected and prevent the [`ActorSystem`](https://doc.akka.io/api/akka-core/2.9/akka/actor/ActorSystem.html "akka.actor.ActorSystem")[`ActorSystem`](https://doc.akka.io/japi/akka-core/2.9/akka/actor/ActorSystem.html "akka.actor.ActorSystem") from being started. It can be a hardcoded value because it must remain the same value to support rolling updates. 

If you prefer to define the identifier in cofiguration that is supported by the [`BaseSerializer`](https://doc.akka.io/api/akka-core/2.9/akka/serialization/BaseSerializer.html "akka.serialization.BaseSerializer")[`BaseSerializer`](https://doc.akka.io/japi/akka-core/2.9/akka/serialization/BaseSerializer.html "akka.serialization.BaseSerializer") trait, which implements the `def identifier` by reading it from configuration based on the serializer’s class name:

Scala

```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-docs/src/test/scala/docs/serialization/SerializationDocSpec.scala#L112-L118 "Go to snippet source")akka {
  actor {
...
```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-docs/src/test/scala/docs/serialization/SerializationDocSpec.scala#L62-L101 "Go to snippet source")class MyOwnSerializer2 extends SerializerWithStringManifest {
...
```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-docs/src/test/java/jdocs/serialization/SerializationDocTest.java#L85-L124 "Go to snippet source")static class MyOwnSerializer2 extends SerializerWithStringManifest {
...
To serialize actor references to/from string representation you would use the [`ActorRefResolver`](https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/ActorRefResolver.html "akka.actor.typed.ActorRefResolver")[`ActorRefResolver`](https://doc.akka.io/japi/akka-core/2.9/akka/actor/typed/ActorRefResolver.html "akka.actor.typed.ActorRefResolver").
...
```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-cluster-typed/src/test/scala/docs/akka/cluster/typed/PingSerializer.scala#L16-L52 "Go to snippet source")class PingSerializer(system: ExtendedActorSystem) extends SerializerWithStringManifest {
...
```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-cluster-typed/src/test/java/jdocs/akka/cluster/typed/PingSerializerExampleTest.java#L27-L86 "Go to snippet source")public class PingSerializer extends SerializerWithStringManifest {
...
Serialization of Classic [`ActorRef`](https://doc.akka.io/api/akka-core/2.9/akka/actor/ActorRef.html "akka.actor.ActorRef")[`ActorRef`](https://doc.akka.io/japi/akka-core/2.9/akka/actor/ActorRef.html "akka.actor.ActorRef") is described in [Classic Serialization](serialization-classic.html#serializing-actorrefs). Classic and Typed actor references have the same serialization format so they can be interchanged.
...
```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-docs/src/test/scala/docs/serialization/SerializationDocSpec.scala#L127-L131 "Go to snippet source")akka {
  actor {
...
Certain messages can be excluded from verification by extending the marker traitinterface [`akka.actor.NoSerializationVerificationNeeded`](https://doc.akka.io/api/akka-core/2.9/akka/actor/NoSerializationVerificationNeeded.html "akka.actor.NoSerializationVerificationNeeded")[`akka.actor.NoSerializationVerificationNeeded`](https://doc.akka.io/japi/akka-core/2.9/akka/actor/NoSerializationVerificationNeeded.html "akka.actor.NoSerializationVerificationNeeded") or define a class name prefix in configuration `akka.actor.no-serialization-verification-needed-class-prefix`.

If you want to verify that your [`Props`](https://doc.akka.io/api/akka-core/2.9/akka/actor/Props.html "akka.actor.Props")[`Props`](https://doc.akka.io/japi/akka-core/2.9/akka/actor/Props.html "akka.actor.Props") are serializable you can enable the following config option:

```
[source](https://github.com/akka/akka/tree/v2.9.8/akka-docs/src/test/scala/docs/serialization/SerializationDocSpec.scala#L142-L146 "Go to snippet source")akka {
  actor {
...
- https://doc.akka.io/api/akka-core/2.9/akka/actor/NoSerializationVerificationNeeded.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/Props.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/ActorRefResolver.html
- https://doc.akka.io/api/akka-core/2.9/akka/actor/typed/ActorSystem.html
- https://doc.akka.io/api/akka-core/2.9/akka/serialization/BaseSerializer.html
- https://doc.akka.io/api/akka-core/2.9/akka/serialization/JSerializer.html
- https://doc.akka.io/api/akka-core/2.9/akka/serialization/SerializationExtension$.html
- https://doc.akka.io/api/akka-core/2.9/akka/serialization/Serializer.html
- https://doc.akka.io/api/akka-core/2.9/akka/serialization/SerializerWithStringManifest.html
- https://doc.akka.io/japi/akka-core/2.9/akka/actor/ActorRef.html
...
- https://doc.akka.io/japi/akka-core/2.9/akka/actor/NoSerializationVerificationNeeded.html
- https://doc.akka.io/japi/akka-core/2.9/akka/actor/Props.html
- https://doc.akka.io/japi/akka-core/2.9/akka/actor/typed/ActorRefResolver.html
- https://doc.akka.io/japi/akka-core/2.9/akka/actor/typed/ActorSystem.html
- https://doc.akka.io/japi/akka-core/2.9/akka/serialization/BaseSerializer.html
- https://doc.akka.io/japi/akka-core/2.9/akka/serialization/JSerializer.html
- https://doc.akka.io/japi/akka-core/2.9/akka/serialization/SerializationExtension.html
- https://doc.akka.io/japi/akka-core/2.9/akka/serialization/Serializer.html
- https://doc.akka.io/japi/akka-core/2.9/akka/serialization/SerializerWithStringManifest.html
- https://doc.akka.io/libraries/akka-core/2.9/persistence.html
- https://doc.akka.io/libraries/akka-core/2.9/serialization-classic.html
- https://doc.akka.io/libraries/akka-core/2.9/serialization-jackson.html
- https://doc.akka.io/libraries/akka-core/2.9/typed/reliable-delivery.html

---
*Source: [https://doc.akka.io/libraries/akka-core/2.9/serialization.html](https://doc.akka.io/libraries/akka-core/2.9/serialization.html)*