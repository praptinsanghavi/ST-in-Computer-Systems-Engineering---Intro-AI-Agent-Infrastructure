...
scraped_at: '2026-04-06T02:08:55Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/typed/guide/modules.html
title: Overview of Akka libraries and modules • Akka core
---

# Overview of Akka libraries and modules • Akka core
...
- [Actor library](modules.html#actor-library)
- [Remoting](modules.html#remoting)
- [Cluster](modules.html#cluster)
- [Cluster Sharding](modules.html#cluster-sharding)
- [Cluster Singleton](modules.html#cluster-singleton)
- [Persistence](modules.html#persistence)
- [Projections](modules.html#projections)
- [Distributed Data](modules.html#distributed-data)
- [Streams](modules.html#streams)
- [Alpakka](modules.html#alpakka)
- [HTTP](modules.html#http)
- [gRPC](modules.html#grpc)
...
In situations where eventual consistency is acceptable, it is possible to share data between nodes in an Akka Cluster and accept both reads and writes even in the face of cluster partitions. This can be achieved using [Conflict Free Replicated Data Types](https://en.wikipedia.org/wiki/Conflict-free_replicated_data_type) (CRDTs), where writes on different nodes can happen concurrently and are merged in a predictable way afterward. The Distributed Data module provides infrastructure to share data and a number of useful data types.
...
This library provides an implementation of gRPC that integrates nicely with the [HTTP](modules.html#http) and [Streams](modules.html#streams) modules. It is capable of generating both client and server\-side artifacts from protobuf service definitions, which can then be exposed using Akka HTTP, and handled using Streams.
...
- https://doc.akka.io/
- https://doc.akka.io/libraries/akka-core/2.10/typed/guide/actors-intro.html
- https://doc.akka.io/libraries/akka-core/2.10/typed/guide/modules.html
- https://doc.akka.io/libraries/akka-core/2.10/typed/guide/tutorial.html
...
- https://doc.akka.io/libraries/alpakka/current/overview.html

---
*Source: [https://doc.akka.io/libraries/akka-core/2.10/typed/guide/modules.html](https://doc.akka.io/libraries/akka-core/2.10/typed/guide/modules.html)*