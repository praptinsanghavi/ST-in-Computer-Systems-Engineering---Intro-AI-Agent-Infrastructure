...
scraped_at: '2026-04-06T03:06:37Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/typed/testing-sync.html
title: Synchronous behavior testing • Akka core
---

# Synchronous behavior testing • Akka core
...
Certain [`Behavior`](https://doc.akka.io/api/akka-core/2.10/akka/actor/typed/Behavior.html "akka.actor.typed.Behavior")[`Behavior`](https://doc.akka.io/japi/akka-core/2.10/akka/actor/typed/Behavior.html "akka.actor.typed.Behavior")s will be hard to test synchronously and the `BehaviorTestKit` doesn’t support testing of all features. In those cases the [asynchronous ActorTestKit](testing-async.html#asynchronous-testing) is recommended. Example of limitations:
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/SyncTestingExampleSpec.scala#L8-L16 "Go to snippet source")import akka.actor.testkit.typed.CapturedLogEvent
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/java/jdocs/akka/actor/testkit/typed/javadsl/SyncTestingExampleTest.java#L8-L20 "Go to snippet source")import akka.actor.testkit.typed.CapturedLogEvent;
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/SyncTestingExampleSpec.scala#L32-L84 "Go to snippet source")object Hello {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/java/jdocs/akka/actor/testkit/typed/javadsl/SyncTestingExampleTest.java#L38-L208 "Go to snippet source")public static class Hello extends AbstractBehavior<Hello.Command> {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/SyncTestingExampleSpec.scala#L26-L28 "Go to snippet source")val childActor = Behaviors.receiveMessage[String] { _ =>
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/java/jdocs/akka/actor/testkit/typed/javadsl/SyncTestingExampleTest.java#L30-L34 "Go to snippet source")public static class Child {
...
All of the tests make use of the [`BehaviorTestKit`](https://doc.akka.io/japi/akka-core/2.10/akka/actor/testkit/typed/javadsl/BehaviorTestKit.html "akka.actor.testkit.typed.javadsl.BehaviorTestKit")[`BehaviorTestKit`](https://doc.akka.io/api/akka-core/2.10/akka/actor/testkit/typed/scaladsl/BehaviorTestKit.html "akka.actor.testkit.typed.scaladsl.BehaviorTestKit") to avoid the need for a real `ActorContext`. Some of the tests make use of the [`TestInbox`](https://doc.akka.io/japi/akka-core/2.10/akka/actor/testkit/typed/javadsl/TestInbox.html "akka.actor.testkit.typed.javadsl.TestInbox")[`TestInbox`](https://doc.akka.io/api/akka-core/2.10/akka/actor/testkit/typed/scaladsl/TestInbox.html "akka.actor.testkit.typed.scaladsl.TestInbox") which allows the creation of an [`ActorRef`](https://doc.akka.io/api/akka-core/2.10/akka/actor/typed/ActorRef.html "akka.actor.typed.ActorRef")[`ActorRef`](https://doc.akka.io/japi/akka-core/2.10/akka/actor/typed/ActorRef.html "akka.actor.typed.ActorRef") that can be used for synchronous testing, similar to the `TestProbe` used for asynchronous testing.
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/SyncTestingExampleSpec.scala#L116-L118 "Go to snippet source")val testKit = BehaviorTestKit(Hello())
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/java/jdocs/akka/actor/testkit/typed/javadsl/SyncTestingExampleTest.java#L214-L216 "Go to snippet source")BehaviorTestKit<Hello.Command> test = BehaviorTestKit.create(Hello.create());
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/SyncTestingExampleSpec.scala#L124-L126 "Go to snippet source")val testKit = BehaviorTestKit(Hello())
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/java/jdocs/akka/actor/testkit/typed/javadsl/SyncTestingExampleTest.java#L223-L225 "Go to snippet source")BehaviorTestKit<Hello.Command> test = BehaviorTestKit.create(Hello.create());
...
For testing sending a message a [`TestInbox`](https://doc.akka.io/japi/akka-core/2.10/akka/actor/testkit/typed/javadsl/TestInbox.html "akka.actor.testkit.typed.javadsl.TestInbox")[`TestInbox`](https://doc.akka.io/api/akka-core/2.10/akka/actor/testkit/typed/scaladsl/TestInbox.html "akka.actor.testkit.typed.scaladsl.TestInbox") is created that provides an [`ActorRef`](https://doc.akka.io/api/akka-core/2.10/akka/actor/typed/ActorRef.html "akka.actor.typed.ActorRef")[`ActorRef`](https://doc.akka.io/japi/akka-core/2.10/akka/actor/typed/ActorRef.html "akka.actor.typed.ActorRef") and methods to assert against the messages that have been sent to it.

Scala

```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/SyncTestingExampleSpec.scala#L132-L135 "Go to snippet source")val testKit = BehaviorTestKit(Hello())
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/java/jdocs/akka/actor/testkit/typed/javadsl/SyncTestingExampleTest.java#L232-L235 "Go to snippet source")BehaviorTestKit<Hello.Command> test = BehaviorTestKit.create(Hello.create());
TestInbox<String> inbox = TestInbox.create();
test.run(new Hello.SayHello(inbox.getRef()));
inbox.expectMessage("hello");
```

Another use case is sending a message to a child actor you can do this by looking up the [`TestInbox`](https://doc.akka.io/japi/akka-core/2.10/akka/actor/testkit/typed/javadsl/TestInbox.html "akka.actor.testkit.typed.javadsl.TestInbox")[`TestInbox`](https://doc.akka.io/api/akka-core/2.10/akka/actor/testkit/typed/scaladsl/TestInbox.html "akka.actor.testkit.typed.scaladsl.TestInbox") for a child actor from the [`BehaviorTestKit`](https://doc.akka.io/japi/akka-core/2.10/akka/actor/testkit/typed/javadsl/BehaviorTestKit.html "akka.actor.testkit.typed.javadsl.BehaviorTestKit")[`BehaviorTestKit`](https://doc.akka.io/api/akka-core/2.10/akka/actor/testkit/typed/scaladsl/BehaviorTestKit.html "akka.actor.testkit.typed.scaladsl.BehaviorTestKit"):

Scala

```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/SyncTestingExampleSpec.scala#L141-L144 "Go to snippet source")val testKit = BehaviorTestKit(Hello())
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/java/jdocs/akka/actor/testkit/typed/javadsl/SyncTestingExampleTest.java#L242-L245 "Go to snippet source")BehaviorTestKit<Hello.Command> testKit = BehaviorTestKit.create(Hello.create());
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/SyncTestingExampleSpec.scala#L150-L155 "Go to snippet source")val testKit = BehaviorTestKit(Hello())
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/java/jdocs/akka/actor/testkit/typed/javadsl/SyncTestingExampleTest.java#L252-L256 "Go to snippet source")BehaviorTestKit<Hello.Command> testKit = BehaviorTestKit.create(Hello.create());
...
An [ask via `ActorContext`](interaction-patterns.html#request-response-with-ask-between-two-actors) can be tested with the assistance of the [`Effect.AskInitiated`](https://doc.akka.io/api/akka-core/2.10/akka/actor/testkit/typed/Effect$$AskInitiated.html "akka.actor.testkit.typed.Effect.AskInitiated")[`Effect.AskInitiated`](https://doc.akka.io/japi/akka-core/2.10/akka/actor/testkit/typed/Effect.AskInitiated.html "akka.actor.testkit.typed.Effect.AskInitiated") `Effect`. The request message is sent to the target recipient and can be obtained from the `AskInitiated`. The interaction may be completed by calling `respondWith` or `timeout` on the `AskInitiated`, and the transformation of the response or timeout into the requestor’s protocol may also be tested using the `adaptResponse` or `adaptTimeout` methods.

Scala

```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/SyncTestingExampleSpec.scala#L170-L202 "Go to snippet source")val testKit = BehaviorTestKit(Hello())
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/java/jdocs/akka/actor/testkit/typed/javadsl/SyncTestingExampleTest.java#L283-L319 "Go to snippet source")BehaviorTestKit<Hello.Command> test = BehaviorTestKit.create(Hello.create());
...
The [`BehaviorTestKit`](https://doc.akka.io/japi/akka-core/2.10/akka/actor/testkit/typed/javadsl/BehaviorTestKit.html "akka.actor.testkit.typed.javadsl.BehaviorTestKit")[`BehaviorTestKit`](https://doc.akka.io/api/akka-core/2.10/akka/actor/testkit/typed/scaladsl/BehaviorTestKit.html "akka.actor.testkit.typed.scaladsl.BehaviorTestKit") keeps track other effects you can verify, look at the sub\-classes of [`Effect`](https://doc.akka.io/api/akka-core/2.10/akka/actor/testkit/typed/Effect.html "akka.actor.testkit.typed.Effect")[`Effect`](https://doc.akka.io/japi/akka-core/2.10/akka/actor/testkit/typed/Effect.html "akka.actor.testkit.typed.Effect")
...
The [`BehaviorTestKit`](https://doc.akka.io/japi/akka-core/2.10/akka/actor/testkit/typed/javadsl/BehaviorTestKit.html "akka.actor.testkit.typed.javadsl.BehaviorTestKit")[`BehaviorTestKit`](https://doc.akka.io/api/akka-core/2.10/akka/actor/testkit/typed/scaladsl/BehaviorTestKit.html "akka.actor.testkit.typed.scaladsl.BehaviorTestKit") also keeps track of everything that is being logged. Here, you can see an example on how to check if the behavior logged certain messages:

Scala

```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/scala/docs/akka/actor/testkit/typed/scaladsl/SyncTestingExampleSpec.scala#L161-L164 "Go to snippet source")val testKit = BehaviorTestKit(Hello())
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-testkit-typed/src/test/java/jdocs/akka/actor/testkit/typed/javadsl/SyncTestingExampleTest.java#L263-L276 "Go to snippet source")BehaviorTestKit<Hello.Command> test = BehaviorTestKit.create(Hello.create());
...
See the other public methods and API documentation on [`BehaviorTestKit`](https://doc.akka.io/japi/akka-core/2.10/akka/actor/testkit/typed/javadsl/BehaviorTestKit.html "akka.actor.testkit.typed.javadsl.BehaviorTestKit")[`BehaviorTestKit`](https://doc.akka.io/api/akka-core/2.10/akka/actor/testkit/typed/scaladsl/BehaviorTestKit.html "akka.actor.testkit.typed.scaladsl.BehaviorTestKit") for other types of verification.
...
---
*Source: [https://doc.akka.io/libraries/akka-core/2.10/typed/testing-sync.html](https://doc.akka.io/libraries/akka-core/2.10/typed/testing-sync.html)*