...
title: Coordinated Shutdown • Akka core
---

# Coordinated Shutdown • Akka core
...
The [`CoordinatedShutdown`](https://doc.akka.io/api/akka-core/2.10/akka/actor/CoordinatedShutdown$.html "akka.actor.CoordinatedShutdown")[`CoordinatedShutdown`](https://doc.akka.io/japi/akka-core/2.10/akka/actor/CoordinatedShutdown.html "akka.actor.CoordinatedShutdown") extension registers internal and user\-defined tasks to be executed during the shutdown process. The tasks are grouped in configuration\-defined “phases” which define the shutdown order.
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/resources/reference.conf#L1249-L1352 "Go to snippet source")# CoordinatedShutdown is enabled by default and will run the tasks that
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/typed/CoordinatedActorShutdownSpec.scala#L21-L48 "Go to snippet source")object MyActor {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/typed/CoordinatedActorShutdownTest.java#L15-L77 "Go to snippet source")import static akka.actor.typed.javadsl.AskPattern.ask;
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/typed/CoordinatedActorShutdownSpec.scala#L61-L70 "Go to snippet source")val c: Cancellable =
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/typed/CoordinatedActorShutdownTest.java#L101-L106 "Go to snippet source")Cancellable cancellable =
    CoordinatedShutdown.get(system)
        .addCancellableTask(
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/ActorDocTest.java#L891-L896 "Go to snippet source")CoordinatedShutdown.get(system)
...
To start the coordinated shutdown process you can either invoke `terminate()` on the `ActorSystem`, or `run` `runAll` on the `CoordinatedShutdown` extension and pass it a class implementing [`CoordinatedShutdown.Reason`](https://doc.akka.io/api/akka-core/2.10/akka/actor/CoordinatedShutdown$$Reason.html "akka.actor.CoordinatedShutdown.Reason")[`CoordinatedShutdown.Reason`](https://doc.akka.io/japi/akka-core/2.10/akka/actor/CoordinatedShutdown.Reason.html "akka.actor.CoordinatedShutdown.Reason") for informational purposes:

Scala

```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/typed/CoordinatedActorShutdownSpec.scala#L83-L89 "Go to snippet source")// shut down with `ActorSystemTerminateReason`
system.terminate()
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/typed/CoordinatedActorShutdownTest.java#L117-L129 "Go to snippet source")// shut down with `ActorSystemTerminateReason`
system.terminate();
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/typed/CoordinatedActorShutdownSpec.scala#L74-L76 "Go to snippet source")CoordinatedShutdown(system).addJvmShutdownHook {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/typed/CoordinatedActorShutdownTest.java#L110-L111 "Go to snippet source")CoordinatedShutdown.get(system)
...
- https://doc.akka.io/japi/akka-core/2.10/akka/actor/CoordinatedShutdown.Reason.html
...
---
*Source: [https://doc.akka.io/libraries/akka-core/2.10/coordinated-shutdown.html](https://doc.akka.io/libraries/akka-core/2.10/coordinated-shutdown.html)*