...
scraped_at: '2026-04-06T01:18:46Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/fsm.html
title: Classic FSM • Akka core
---

# Classic FSM • Akka core
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L48-L49 "Go to snippet source")import akka.actor.FSM
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/fsm/Buncher.java#L8-L14 "Go to snippet source")import akka.actor.AbstractFSM;
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L21-L27 "Go to snippet source")// received events
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/fsm/Events.java#L14-L107 "Go to snippet source")static final class SetTarget {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L30-L37 "Go to snippet source")// states
sealed trait State
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/fsm/Buncher.java#L95-L154 "Go to snippet source")// states
enum State {
  Idle,
  Active
}
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L52-L95 "Go to snippet source")class Buncher extends FSM[State, Data] {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/fsm/Buncher.java#L24-L157 "Go to snippet source")public class Buncher extends AbstractFSM<State, Data> {
  {
    startWith(Idle, Uninitialized);
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L82-L90 "Go to snippet source")whenUnhandled {
  // common code for both states
  case Event(Queue(obj), t @ Todo(_, v)) =>
    goto(Active).using(t.copy(queue = v :+ obj))
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/fsm/Buncher.java#L71-L85 "Go to snippet source")whenUnhandled(
    matchEvent(
            Queue.class,
            Todo.class,
            (queue, todo) -> goTo(Active).using(todo.addElement(queue.getObj())))
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L65-L71 "Go to snippet source")onTransition {
  case Active -> Idle =>
    stateData match {
      case Todo(ref, queue) => ref ! Batch(queue)
      case _                => // nothing to do
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/fsm/Buncher.java#L40-L59 "Go to snippet source")onTransition(
    matchState(
            Active,
            Idle,
            () -> {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L13-L233 "Go to snippet source")import akka.actor.Props
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/fsm/BuncherTest.java#L23-L79 "Go to snippet source")public class BuncherTest extends AbstractJavaTest {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L58-L78 "Go to snippet source")when(Idle) {
  case Event(SetTarget(ref), Uninitialized) =>
    stay().using(Todo(ref, Vector.empty))
}
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/fsm/Buncher.java#L30-L36 "Go to snippet source")when(
    Idle,
    matchEvent(
        SetTarget.class,
        Uninitialized.class,
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L209 "Go to snippet source")when(SomeState)(FSM.NullFunction)
```

Java

```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/fsm/FSMDocTest.java#L75 "Go to snippet source")when(SomeState, AbstractFSM.NullFunction());
```
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L171-L178 "Go to snippet source")whenUnhandled {
  case Event(x: X, data) =>
    log.info("Received unhandled event: " + x)
    stay()
  case Event(msg, _) =>
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/fsm/FSMDocTest.java#L123-L135 "Go to snippet source")  whenUnhandled(
      matchEvent(
              X.class,
              (x, data) -> {
                log().info("Received unhandled event: " + x);
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L112-L115 "Go to snippet source")when(SomeState) {
  case Event(msg, _) =>
    goto(Processing).using(newData).forMax(5.seconds).replying(WillDo)
}
```
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/fsm/FSMDocTest.java#L63-L71 "Go to snippet source")when(
    SomeState,
    matchAnyEvent(
        (msg, data) -> {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L119-L123 "Go to snippet source")onTransition {
  case Idle -> Active => startTimerWithFixedDelay("timeout", Tick, 1.second)
  case Active -> _    => cancelTimer("timeout")
  case x -> Idle      => log.info("entering Idle from " + x)
}
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/fsm/FSMDocTest.java#L79-L85 "Go to snippet source")onTransition(
    matchState(
            Idle,
            Active,
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L127-L131 "Go to snippet source")onTransition(handler _)
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/fsm/FSMDocTest.java#L56-L89 "Go to snippet source")public void handler(StateType from, StateType to) {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L143-L148 "Go to snippet source")when(SomeState)(transform {
  case Event(bytes: ByteString, read) => stay().using(read + bytes.length)
}.using {
  case s @ FSM.State(state, read, timeout, stopReason, replies) if read > 1000 =>
    goto(Processing)
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L152-L159 "Go to snippet source")val processingTrigger: PartialFunction[State, State] = {
  case s @ FSM.State(state, read, timeout, stopReason, replies) if read > 1000 =>
    goto(Processing)
}
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L135-L139 "Go to snippet source")when(Error) {
  case Event("stop", _) =>
    // do cleanup ...
    stop()
}
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/fsm/FSMDocTest.java#L93-L100 "Go to snippet source")when(
    Error,
    matchEventEquals(
        "stop",
        (event, data) -> {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L163-L167 "Go to snippet source")onTermination {
  case StopEvent(FSM.Normal, state, data)         => // ...
  case StopEvent(FSM.Shutdown, state, data)       => // ...
  case StopEvent(FSM.Failure(cause), state, data) => // ...
}
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/fsm/FSMDocTest.java#L104-L119 "Go to snippet source")onTermination(
    matchStop(
            Normal(),
            (state, data) -> {
              /* Do something here */
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/actor/FSMDocSpec.scala#L184-L197 "Go to snippet source")import akka.actor.LoggingFSM
class MyFSM extends LoggingFSM[StateType, Data] {
  override def logDepth = 12
  onTermination {
    case StopEvent(FSM.Failure(_), state, data) =>
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/actor/fsm/FSMDocTest.java#L141-L198 "Go to snippet source")static class MyFSM extends AbstractLoggingFSM<StateType, Data> {
  @Override
  public int logDepth() {
    return 12;
  }
...
### Example 18: TheFSM Trait and ObjectAbstractFSM Class
...
### Example 19: TheFSM Trait and ObjectAbstractFSM Class
...
### Example 20: Defining States

```text
when(<name>[, stateTimeout = <timeout>])(stateFunction)
```

### Example 21: Defining States
...
### Example 25: Defining the Initial State

```text
startWith(state, data[, timeout])
```

### Example 26: Unhandled Events
...
### Example 28: Initiating Transitions
...
### Example 29: Initiating Transitions
...
### Example 30: Internal Monitoring

```text
onTransition(handler)
```

### Example 31: Internal Monitoring
...
### Example 32: Internal Monitoring
...
### Example 40: Termination from Inside

```text
stop([reason[, data]])
```

### Example 41: Termination from Inside
...
### Example 42: Termination from Inside
...
- https://doc.akka.io/
- https://doc.akka.io/libraries/akka-core/2.10/fsm.html
...
- https://doc.akka.io/libraries/akka-core/2.10/scheduler.html
...
---
*Source: [https://doc.akka.io/libraries/akka-core/2.10/fsm.html](https://doc.akka.io/libraries/akka-core/2.10/fsm.html)*