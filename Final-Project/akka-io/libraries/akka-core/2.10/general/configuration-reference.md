...
scraped_at: '2026-04-05T19:18:29Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/general/configuration-reference.html
title: Default configuration • Akka core
---

# Default configuration • Akka core
...
Make your edits/overrides in your `application.conf`. Don’t override default values if you are not sure of the implications. [Akka Config Checker](https://doc.akka.io/libraries/akka-diagnostics/current/config-checker.html) is a useful tool for finding potential configuration issues.
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor/src/main/resources/reference.conf "Go to snippet source")####################################
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed/src/main/resources/reference.conf "Go to snippet source")akka.actor.typed {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-cluster-typed/src/main/resources/reference.conf "Go to snippet source")############################################
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-cluster/src/main/resources/reference.conf "Go to snippet source")######################################
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-discovery/src/main/resources/reference.conf "Go to snippet source")######################################################
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-coordination/src/main/resources/reference.conf "Go to snippet source")akka.coordination {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-multi-node-testkit/src/main/resources/reference.conf "Go to snippet source")#############################################
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-persistence-typed/src/main/resources/reference.conf "Go to snippet source")akka.actor {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-persistence/src/main/resources/reference.conf "Go to snippet source")###########################################################
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-persistence-query/src/main/resources/reference.conf "Go to snippet source")#######################################################
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-persistence-testkit/src/main/resources/reference.conf "Go to snippet source")##################################################
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-remote/src/main/resources/reference.conf#L2-L771 "Go to snippet source")#####################################
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-testkit/src/main/resources/reference.conf "Go to snippet source")######################################
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-cluster-tools/src/main/resources/reference.conf "Go to snippet source")############################################
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-cluster-sharding-typed/src/main/resources/reference.conf "Go to snippet source")  
# //#sharding-ext-config
# //#number-of-shards
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-cluster-sharding/src/main/resources/reference.conf "Go to snippet source")###############################################
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-distributed-data/src/main/resources/reference.conf "Go to snippet source")##############################################
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream/src/main/resources/reference.conf "Go to snippet source")#####################################
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-stream-testkit/src/main/resources/reference.conf "Go to snippet source")akka.stream.testkit {
...
---
*Source: [https://doc.akka.io/libraries/akka-core/2.10/general/configuration-reference.html](https://doc.akka.io/libraries/akka-core/2.10/general/configuration-reference.html)*