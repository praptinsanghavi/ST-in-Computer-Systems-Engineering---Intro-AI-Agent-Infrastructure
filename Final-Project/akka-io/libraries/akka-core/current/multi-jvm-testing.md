---
description: Multi JVM testing of distributed systems built with Akka.
knowledge_type: official_documentation
scraped_at: '2026-04-05T18:24:33Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/multi-jvm-testing.html
title: Multi JVM Testing • Akka core
---

# Multi JVM Testing • Akka core

> **Summary:** Multi JVM testing of distributed systems built with Akka.
...
The multi\-JVM testing is an sbt plugin that you can find at [https://github.com/sbt/sbt\-multi\-jvm](https://github.com/sbt/sbt-multi-jvm). To configure it in your project you should do the following steps:
...
There has also been some additions made to the `SbtMultiJvm` plugin to accommodate the [may change](common/may-change.html) module [multi node testing](multi-node-testing.html), described in that section.

## Example project

[Akka Cluster Sample with Scala](../attachments/akka-samples-cluster-scala.zip) is an example project that can be downloaded, and with instructions of how to run.
...
### Example 7: Creating application tests

```none
{TestName}MultiJvm{NodeName}
```

### Example 8: Creating application tests
...
### Example 9: Creating application tests
...
### Example 10: Changing Defaults

```text
jvmOptions in MultiJvm := Seq("-Xmx256M")
```

### Example 11: Changing Defaults
...
### Example 12: Changing Defaults

```none
multiJvmMarker in MultiJvm := "ClusterTest"
```

### Example 13: Configuration of the JVM instances

```text
-Dakka.remote.port=9991 -Xmx256m
```

### Example 14: Configuration of the JVM instances

```text
-Dakka.remote.port=9992 -Xmx256m
```

### Example 15: Configuration of the JVM instances

```text
-Dakka.remote.port=9993 -Xmx256m
```

### Example 16: ScalaTest
...
---
*Source: [https://doc.akka.io/libraries/akka-core/current/multi-jvm-testing.html](https://doc.akka.io/libraries/akka-core/current/multi-jvm-testing.html)*