...
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/typed/guide/tutorial.html
title: Introduction to the Example • Akka core
---

# Introduction to the Example • Akka core
...
You should have already followed the instructions in the [first Hello World example](../actors.html#first-example) to download and run the Hello World example. You will use this as a seed project and add the functionality described in this tutorial.

Note
Both the Java and Scala DSLs of Akka modules bundled in the same JAR. For a smooth development experience, when using an IDE such as Eclipse or IntelliJ, you can disable the auto\-importer from suggesting `javadsl` imports when working in Scala, or viceversa. See [IDE Tips](../../additional/ide.html). 
...
---
*Source: [https://doc.akka.io/libraries/akka-core/current/typed/guide/tutorial.html](https://doc.akka.io/libraries/akka-core/current/typed/guide/tutorial.html)*