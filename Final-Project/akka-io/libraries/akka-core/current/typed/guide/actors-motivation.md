...
scraped_at: '2026-04-06T01:24:40Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/typed/guide/actors-motivation.html
title: Why modern systems need a new programming model • Akka core
---
...
The actor model was proposed decades ago by [Carl Hewitt](https://en.wikipedia.org/wiki/Carl_Hewitt#Actor_model) as a way to handle parallel processing in a high performance network — an environment that was not available at the time. Today, hardware and infrastructure capabilities have caught up with and exceeded Hewitt’s vision. Consequently, organizations building distributed systems with demanding requirements encounter challenges that cannot fully be solved with a traditional object\-oriented programming (OOP) model, but that can benefit from the actor model.
...
- [The challenge of encapsulation](actors-motivation.html#the-challenge-of-encapsulation)
- [The illusion of shared memory on modern computer architectures](actors-motivation.html#the-illusion-of-shared-memory-on-modern-computer-architectures)
- [The illusion of a call stack](actors-motivation.html#the-illusion-of-a-call-stack)
...
---
*Source: [https://doc.akka.io/libraries/akka-core/current/typed/guide/actors-motivation.html](https://doc.akka.io/libraries/akka-core/current/typed/guide/actors-motivation.html)*