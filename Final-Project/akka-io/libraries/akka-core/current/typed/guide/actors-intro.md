...
scraped_at: '2026-04-05T19:00:41Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/typed/guide/actors-intro.html
title: How the Actor Model Meets the Needs of Modern, Distributed Systems • Akka core
---

# How the Actor Model Meets the Needs of Modern, Distributed Systems • Akka core
...
An important difference between passing messages and calling methods is that messages have no return value. By sending a message, an actor delegates work to another actor. As we saw in [The illusion of a call stack](actors-motivation.html#the-illusion-of-a-call-stack), if it expected a return value, the sending actor would either need to block or to execute the other actor’s work on the same thread. Instead, the receiving actor delivers the results in a reply message.
...
---
*Source: [https://doc.akka.io/libraries/akka-core/current/typed/guide/actors-intro.html](https://doc.akka.io/libraries/akka-core/current/typed/guide/actors-intro.html)*