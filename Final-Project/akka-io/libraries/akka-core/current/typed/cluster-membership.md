...
title: Cluster Membership Service • Akka core
---

# Cluster Membership Service • Akka core
...
To use this feature use `Cluster(system).prepareForFullClusterShutdown()` in classic or [`PrepareForFullClusterShutdown`](https://doc.akka.io/api/akka-core/2.10/akka/cluster/typed/PrepareForFullClusterShutdown.html "akka.cluster.typed.PrepareForFullClusterShutdown")[`PrepareForFullClusterShutdown`](https://doc.akka.io/japi/akka-core/2.10/akka/cluster/typed/PrepareForFullClusterShutdown.html "akka.cluster.typed.PrepareForFullClusterShutdown") in typed.
...
- https://doc.akka.io/libraries/akka-core/current/typed/cluster-concepts.html
...
---
*Source: [https://doc.akka.io/libraries/akka-core/current/typed/cluster-membership.html](https://doc.akka.io/libraries/akka-core/current/typed/cluster-membership.html)*