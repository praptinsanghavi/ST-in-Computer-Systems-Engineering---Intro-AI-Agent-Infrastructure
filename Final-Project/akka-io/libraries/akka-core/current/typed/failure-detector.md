...
scraped_at: '2026-04-05T18:24:29Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/typed/failure-detector.html
title: Phi Accrual Failure Detector • Akka core
---

# Phi Accrual Failure Detector • Akka core
...
The heartbeat arrival times are interpreted by an implementation of [The Phi Accrual Failure Detector](https://pdfs.semanticscholar.org/11ae/4c0c0d0c36dc177c1fff5eb84fa49aa3e1a8.pdf) by Hayashibara et al.
...
The `threshold` that is the basis for the calculation is configurable by the user, but typically it’s enough to configure the `acceptable-heartbeat-pause` as described above.
...
### Example 1: Failure Detector Heartbeats
...
---
*Source: [https://doc.akka.io/libraries/akka-core/current/typed/failure-detector.html](https://doc.akka.io/libraries/akka-core/current/typed/failure-detector.html)*