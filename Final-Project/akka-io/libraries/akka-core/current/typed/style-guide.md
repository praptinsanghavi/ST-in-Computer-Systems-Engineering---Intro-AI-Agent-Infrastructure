...
scraped_at: '2026-04-05T18:21:38Z'
section: libraries
site: akka-io
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L19-L58 "Go to snippet source")  
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L9-L74 "Go to snippet source")import akka.actor.typed.Behavior;
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L19-L95 "Go to snippet source")  
import akka.actor.typed.Behavior
import akka.actor.typed.scaladsl.ActorContext
import akka.actor.typed.scaladsl.Behaviors
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L9-L141 "Go to snippet source")import akka.actor.typed.Behavior;
import akka.actor.typed.SupervisorStrategy;
import akka.actor.typed.javadsl.ActorContext;
import akka.actor.typed.javadsl.Behaviors;
...
- In the functional style the state is updated by returning a new behavior that holds the new immutable state, the `n: Int``final int n` parameter of the `counter` method.
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L102-L136 "Go to snippet source")  
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L149-L230 "Go to snippet source")  
// this is an anti-example, better solutions exists
public class Counter {
  public interface Command {}
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L142-L178 "Go to snippet source")  
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L236-L324 "Go to snippet source")  
// this is better than previous example, but even better solution exists
public class Counter {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L184-L225 "Go to snippet source")  
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L330-L412 "Go to snippet source")  
// this is better than previous examples
public class Counter {
  // messages omitted for brevity, same messages as above example
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L231-L266 "Go to snippet source")  
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L272-L297 "Go to snippet source")object CountDown {
  sealed trait Command
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L418-L455 "Go to snippet source")public class CountDown extends AbstractBehavior<CountDown.Command> {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L305 "Go to snippet source")val countDown = context.spawn(CountDown(100, doneRef), "countDown")
```

Java

```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L464-L465 "Go to snippet source")ActorRef<CountDown.Command> countDown =
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L309 "Go to snippet source")countDown ! CountDown.Down
```

Java

```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L469 "Go to snippet source")countDown.tell(CountDown.Down.INSTANCE);
```
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L35-L58 "Go to snippet source")object Counter {
  sealed trait Command
  case object Increment extends Command
  final case class GetValue(replyTo: ActorRef[Value]) extends Command
  final case class Value(n: Int)
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L83-L141 "Go to snippet source")public class Counter extends AbstractBehavior<Counter.Command> {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L316-L325 "Go to snippet source")object CounterProtocol {
  sealed trait Command
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L477-L513 "Go to snippet source")interface CounterProtocol {
  interface Command {}
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L331-L366 "Go to snippet source")object Counter {
  sealed trait Command
  case object Increment extends Command
  final case class GetValue(replyTo: ActorRef[Value]) extends Command
  final case class Value(n: Int)
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L522-L643 "Go to snippet source")public class Counter extends AbstractBehavior<Counter.Command> {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L372-L417 "Go to snippet source")// above example is preferred, but this is possible and not wrong
object Counter {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L650-L733 "Go to snippet source")// above example is preferred, but this is possible and not wrong
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L88-L90 "Go to snippet source")public enum Increment implements Command {
  INSTANCE
}
```
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L124 "Go to snippet source").onMessage(Increment.class, notUsed -> onIncrement())
```
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L571-L594 "Go to snippet source")@Override
public Receive<Command> createReceive() {
  return newReceiveBuilder()
      .onMessage(Increment.class, notUsed -> onIncrement())
      .build();
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L571-L609 "Go to snippet source")@Override
public Receive<Command> createReceive() {
  return newReceiveBuilder()
      .onMessage(GetValue.class, this::onGetValue)
      .build();
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L519-L640 "Go to snippet source")// this is an anti-pattern, don't use lambdas with a large block of code
  public Receive<Command> createReceive() {
    return newReceiveBuilder()
        .onMessage(
            Increment.class,
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L456-L459 "Go to snippet source")sealed trait Command
case object Down extends Command
final case class GetValue(replyTo: ActorRef[Value]) extends Command
final case class Value(n: Int)
```
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L467-L475 "Go to snippet source")val zero: Behavior[Command] = {
  Behaviors.receiveMessage {
    case GetValue(replyTo) =>
      replyTo ! Value(0)
      Behaviors.same
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L480-L486 "Go to snippet source")val zero: Behavior[Command] = {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L496-L499 "Go to snippet source")sealed trait Command
case object Down extends Command
final case class GetValue(replyTo: ActorRef[Value]) extends Command
final case class Value(n: Int)
```
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L503-L507 "Go to snippet source")def getHandler(value: Int): PartialFunction[Command, Behavior[Command]] = {
  case GetValue(replyTo) =>
    replyTo ! Value(value)
    Behaviors.same
}
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L529-L537 "Go to snippet source")val zero: Behavior[Command] = Behaviors.setup { context =>
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L427-L433 "Go to snippet source")import akka.actor.typed.scaladsl.AskPattern._
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L437 "Go to snippet source")val result2: Future[OperationResult] = counter.ask(Increment(delta = 2, _))
```
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L442-L443 "Go to snippet source")// doesn't compile
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L448 "Go to snippet source")val result3: Future[OperationResult] = counter ? (Increment(delta = 2, _))
```
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L545-L557 "Go to snippet source")def apply(): Behavior[Command] =
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L741-L756 "Go to snippet source")public static Behavior<Command> apply() {
  return Behaviors.setup(
      context ->
          Behaviors.withStash(
              100,
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/scala/docs/akka/typed/StyleGuideDocExamples.scala#L565-L581 "Go to snippet source")def apply(): Behavior[Command] =
  Behaviors.setup { context =>
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-actor-typed-tests/src/test/java/jdocs/akka/typed/StyleGuideDocExamples.java#L764-L784 "Go to snippet source")public static Behavior<Command> create() {
  return Behaviors.setup(
      context -> {
        // only run on initial actor start, not on crash-restart
...
- https://doc.akka.io/libraries/akka-core/current/typed/from-classic.html
...
---
*Source: [https://doc.akka.io/libraries/akka-core/current/typed/style-guide.html](https://doc.akka.io/libraries/akka-core/current/typed/style-guide.html)*