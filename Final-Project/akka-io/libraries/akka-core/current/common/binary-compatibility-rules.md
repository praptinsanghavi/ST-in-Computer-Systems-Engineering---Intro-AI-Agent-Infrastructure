...
scraped_at: '2026-04-05T18:23:56Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/common/binary-compatibility-rules.html
title: Binary Compatibility Rules • Akka core
---

# Binary Compatibility Rules • Akka core
...
- [`@ApiMayChange`](https://doc.akka.io/japi/akka-core/2.10/akka/annotation/ApiMayChange.html "akka.annotation.ApiMayChange") – which marks APIs which are known to be not fully stable yet. Read more in [Modules marked “May Change”](may-change.html)
- [`@DoNotInherit`](https://doc.akka.io/japi/akka-core/2.10/akka/annotation/DoNotInherit.html "akka.annotation.DoNotInherit") – which marks APIs that are designed under a closed\-world assumption, and thus must not be extended outside Akka itself (or such code will risk facing binary incompatibilities). E.g. an interface may be marked using this annotation, and while the type is public, it is not meant for extension by user\-code. This allows adding new methods to these interfaces without risking to break client code. Examples of such API are the [`FlowOps`](https://doc.akka.io/api/akka-core/2.10/akka/stream/scaladsl/FlowOps.html "akka.stream.scaladsl.FlowOps") trait or the Akka HTTP domain model.
...
- https://doc.akka.io/japi/akka-core/2.10/akka/annotation/DoNotInherit.html
- https://doc.akka.io/japi/akka-core/2.10/akka/annotation/InternalApi.html
...
- https://doc.akka.io/libraries/akka-core/current/project/index.html
- https://doc.akka.io/libraries/akka-core/current/typed/guide/modules.html

---
*Source: [https://doc.akka.io/libraries/akka-core/current/common/binary-compatibility-rules.html](https://doc.akka.io/libraries/akka-core/current/common/binary-compatibility-rules.html)*