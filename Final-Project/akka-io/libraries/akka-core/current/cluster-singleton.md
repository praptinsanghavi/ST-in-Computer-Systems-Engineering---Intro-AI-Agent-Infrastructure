...
scraped_at: '2026-04-05T19:18:45Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/cluster-singleton.html
title: Classic Cluster Singleton • Akka core
---

# Classic Cluster Singleton • Akka core
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-cluster-tools/src/multi-jvm/scala/akka/cluster/singleton/ClusterSingletonManagerSpec.scala#L52-L117 "Go to snippet source")object PointToPointChannel {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-cluster-tools/src/test/java/akka/cluster/singleton/TestSingletonMessages.java#L8-L82 "Go to snippet source")public class TestSingletonMessages {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-cluster-tools/src/multi-jvm/scala/akka/cluster/singleton/ClusterSingletonManagerSpec.scala#L223-L228 "Go to snippet source")system.actorOf(
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-cluster-tools/src/test/java/akka/cluster/singleton/ClusterSingletonManagerTest.java#L21-L29 "Go to snippet source")final ClusterSingletonManagerSettings settings =
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-cluster-tools/src/multi-jvm/scala/akka/cluster/singleton/ClusterSingletonManagerSpec.scala#L149-L155 "Go to snippet source")case End =>
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-cluster-tools/src/test/java/akka/cluster/singleton/Consumer.java#L53-L60 "Go to snippet source").match(End.class, message -> queue.tell(UnregisterConsumer.class, getSelf()))
.match(
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-cluster-tools/src/multi-jvm/scala/akka/cluster/singleton/ClusterSingletonManagerSpec.scala#L234-L238 "Go to snippet source")val proxy = system.actorOf(
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-cluster-tools/src/test/java/akka/cluster/singleton/ClusterSingletonManagerTest.java#L33-L38 "Go to snippet source")ClusterSingletonProxySettings proxySettings =
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/cluster/singleton/ClusterSingletonSupervision.scala#L8-L15 "Go to snippet source")import akka.actor.{ Actor, Props, SupervisorStrategy }
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/cluster/singleton/SupervisorActor.java#L8-L34 "Go to snippet source")import akka.actor.AbstractActor;
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/cluster/singleton/ClusterSingletonSupervision.scala#L23-L30 "Go to snippet source")import akka.actor.{ PoisonPill, Props }
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/cluster/singleton/ClusterSingletonSupervision.java#L13-L16 "Go to snippet source")import akka.actor.PoisonPill;
import akka.actor.Props;
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/cluster/singleton/ClusterSingletonSupervision.java#L23-L31 "Go to snippet source")return getContext()
    .system()
    .actorOf(
        ClusterSingletonManager.props(
            Props.create(
...
- https://doc.akka.io/libraries/akka-core/current/cluster-routing.html
...
---
*Source: [https://doc.akka.io/libraries/akka-core/current/cluster-singleton.html](https://doc.akka.io/libraries/akka-core/current/cluster-singleton.html)*