...
scraped_at: '2026-04-05T18:23:59Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/additional/rolling-updates.html
title: Rolling Updates • Akka core
---

# Rolling Updates • Akka core
...
To understand which is old and new it compares the version numbers using normal conventions, see [`Version`](https://doc.akka.io/api/akka-core/2.10/akka/util/Version.html "akka.util.Version")[`Version`](https://doc.akka.io/japi/akka-core/2.10/akka/util/Version.html "akka.util.Version") for more details.

When using [Kubernetes Deployments](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/) with `RollingUpdate` strategy you should enable the [app\-version from Deployment feature from Akka Management](https://doc.akka.io/libraries/akka-management/current/rolling-updates.html#app-version-from-deployment) to automatically define the `app-version` from the Kubernetes `deployment.kubernetes.io/revision` annotation.
...
If you’ve migrated from `PersistentFSM` to `EventSourcedBehavior` (See the [Akka 2\.8 migration guide](https://doc.akka.io/libraries/akka-core/2.8/persistence-fsm.html#migration-to-eventsourcedbehavior)) and are using PersistenceFSM with Cluster Sharding, a full shutdown is required as shards can move between new and old nodes.

### Migrating from classic remoting to Artery

If you’ve migrated from classic remoting to Artery which has a completely different protocol, a rolling update is not supported. For more details on this migration see [the migration guide](https://doc.akka.io/libraries/akka-core/2.6/project/migration-guide-2.5.x-2.6.x.html#migrating-from-classic-remoting-to-artery).
...
- https://doc.akka.io/libraries/akka-core/current/additional/native-image.html
...
- https://doc.akka.io/libraries/akka-core/current/project/rolling-update.html
...
---
*Source: [https://doc.akka.io/libraries/akka-core/current/additional/rolling-updates.html](https://doc.akka.io/libraries/akka-core/current/additional/rolling-updates.html)*