...
scraped_at: '2026-04-05T20:33:04Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/security/2017-02-10-java-serialization.html
title: Java Serialization, Fixed in Akka 2.4.17 • Akka core
---

# Java Serialization, Fixed in Akka 2.4.17 • Akka core
...
To protect against such attacks the system should be updated to Akka *2\.4\.17* or later and be configured with [disabled Java serializer](https://doc.akka.io/libraries/akka-core/2.5/remoting.html#disable-java-serializer). Additional protection can be achieved when running in an untrusted network by enabling [TLS with mutual authentication](../remote-security.html#remote-tls).
...
- https://doc.akka.io/libraries/akka-core/current/security/2017-08-09-camel.html
- https://doc.akka.io/libraries/akka-core/current/security/index.html

---
*Source: [https://doc.akka.io/libraries/akka-core/current/security/2017-02-10-java-serialization.html](https://doc.akka.io/libraries/akka-core/current/security/2017-02-10-java-serialization.html)*