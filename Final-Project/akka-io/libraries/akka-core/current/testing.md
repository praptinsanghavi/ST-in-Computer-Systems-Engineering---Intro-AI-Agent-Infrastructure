...
scraped_at: '2026-04-05T19:01:37Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/testing.html
title: Testing Classic Actors • Akka core
---

# Testing Classic Actors • Akka core
...
| --- | --- |
| Artifact | com.typesafe.akka akka\-testkit 2\.10\.17 [Snapshots are available](project/links.html#snapshots-repository) |
...
| API documentation | [API (Scaladoc)](https://doc.akka.io/api/akka-core/2.10.17/akka/testkit/index.html) [API (Javadoc)](https://doc.akka.io/japi/akka-core/2.10.17/akka/testkit/package-summary.html) |
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/PlainWordSpec.scala#L8-L36 "Go to snippet source")import akka.actor.ActorSystem
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitSampleTest.java#L8-L99 "Go to snippet source")import akka.actor.AbstractActor;
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L127-L136 "Go to snippet source")val hello: String = expectMsg("hello")
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L248-L258 "Go to snippet source")final String hello = expectMsgEquals("hello");
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L326-L341 "Go to snippet source")import akka.testkit.EventFilter
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L500-L516 "Go to snippet source")new TestKit(system) {
  {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L78-L90 "Go to snippet source")case class TriggerScheduling(foo: String)
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L80-L95 "Go to snippet source")static class TestTimerActor extends AbstractActorWithTimers {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L303-L313 "Go to snippet source")import akka.testkit.TestProbe
import akka.actor.Props
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L428-L445 "Go to snippet source")new TestKit(system) {
  {
    final TestKit probe = new TestKit(system);
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L208-L217 "Go to snippet source")import akka.actor.Props
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L127-L138 "Go to snippet source")new TestKit(system) {
  {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L223-L225 "Go to snippet source")import scala.concurrent.duration._
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L291-L297 "Go to snippet source")new TestKit(system) {
  {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/PlainWordSpec.scala#L15-L20 "Go to snippet source")class MySpec()
    extends TestKit(ActorSystem("MySpec"))
    with ImplicitSender
    with AnyWordSpecLike
    with Matchers
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L14-L17 "Go to snippet source")import scala.concurrent.duration._
import akka.actor._
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L47-L59 "Go to snippet source")class MyDoubleEcho extends Actor {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L231-L237 "Go to snippet source")val probe1 = TestProbe()
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L304-L335 "Go to snippet source")new TestKit(system) {
  {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L256-L260 "Go to snippet source")val worker = TestProbe("worker")
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L342-L350 "Go to snippet source")new TestKit(system) {
  {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L241-L250 "Go to snippet source")final case class Update(id: Int, value: String)
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L357-L373 "Go to snippet source")new TestKit(system) {
  {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L268-L271 "Go to snippet source")val probe = TestProbe()
probe.watch(target)
target ! PoisonPill
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L381-L389 "Go to snippet source")new TestKit(system) {
  {
    final TestKit probe = new TestKit(system);
    probe.watch(target);
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L280-L284 "Go to snippet source")val probe = TestProbe()
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L396-L405 "Go to snippet source")new TestKit(system) {
  {
    final TestKit probe = new TestKit(system);
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L63-L74 "Go to snippet source")class Source(target: ActorRef) extends Actor {
  def receive = {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L292-L297 "Go to snippet source")val probe = TestProbe()
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L412-L421 "Go to snippet source")new TestKit(system) {
  {
    final TestKit probe = new TestKit(system);
    probe.getRef().tell("hello", getRef());
    probe.expectMsgEquals("hello");
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-testkit/src/test/scala/akka/testkit/TestProbeSpec.scala#L119-L126 "Go to snippet source")val probe = TestProbe()
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L468-L486 "Go to snippet source")new TestKit(system) {
  {
    final TestKit probe = new TestKit(system);
    // install auto-pilot
    probe.setAutoPilot(
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L367-L370 "Go to snippet source")val probe = TestProbe()
within(1 second) {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L453-L458 "Go to snippet source")new TestKit(system) {
  {
    final TestKit probe = new TestKit(system);
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/ParentChildSpec.scala#L25-L39 "Go to snippet source")class Parent extends Actor {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/ParentChildTest.java#L29-L53 "Go to snippet source")static class Parent extends AbstractActor {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/ParentChildSpec.scala#L43-L47 "Go to snippet source")class DependentChild(parent: ActorRef) extends Actor {
  def receive = {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/ParentChildTest.java#L58-L71 "Go to snippet source")class DependentChild extends AbstractActor {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/ParentChildSpec.scala#L128-L135 "Go to snippet source")"A TestProbe serving as parent" should {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/ParentChildTest.java#L188-L192 "Go to snippet source")TestKit parent = new TestKit(system);
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/ParentChildSpec.scala#L139-L153 "Go to snippet source")"A fabricated parent" should {
  "test its child responses" in {
    val proxy = TestProbe()
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/ParentChildTest.java#L155-L182 "Go to snippet source")class FabricatedParentCreator implements Creator<Actor> {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/ParentChildTest.java#L200-L204 "Go to snippet source")TestProbe proxy = new TestProbe(system);
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/ParentChildSpec.scala#L51-L68 "Go to snippet source")class DependentParent(childProps: Props, probe: ActorRef) extends Actor {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/ParentChildTest.java#L76-L92 "Go to snippet source")class DependentParent extends AbstractActor {
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/ParentChildTest.java#L97-L112 "Go to snippet source")class GenericDependentParent extends AbstractActor {
  final ActorRef child;
  boolean ponged = false;
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/ParentChildSpec.scala#L112-L113 "Go to snippet source")val maker = (_: ActorRefFactory) => probe.ref
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/ParentChildTest.java#L139-L140 "Go to snippet source")Function<ActorRefFactory, ActorRef> maker = param -> probe.ref();
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/ParentChildSpec.scala#L121-L122 "Go to snippet source")val maker = (f: ActorRefFactory) => f.actorOf(Props(new Child))
val parent = system.actorOf(Props(new GenericDependentParent(maker)))
```
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/ParentChildTest.java#L148-L149 "Go to snippet source")Function<ActorRefFactory, ActorRef> maker = f -> f.actorOf(Props.create(Child.class));
ActorRef parent = system.actorOf(Props.create(GenericDependentParent.class, maker));
```
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L319-L320 "Go to snippet source")import akka.testkit.CallingThreadDispatcher
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L493 "Go to snippet source")system.actorOf(Props.create(MyActor.class).withDispatcher(CallingThreadDispatcher.Id()));
```
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L95-L101 "Go to snippet source")import akka.event.LoggingReceive
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L347-L360 "Go to snippet source")import akka.testkit.TestKitBase
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestKitUsageSpec.scala#L10-L150 "Go to snippet source")import scala.util.Random
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L112-L115 "Go to snippet source")import akka.testkit.TestActorRef
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L48-L76 "Go to snippet source")static class MyActor extends AbstractActor {
  @Override
  public Receive createReceive() {
    return receiveBuilder()
        .matchEquals(
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L145-L165 "Go to snippet source")import akka.testkit.TestFSMRef
import scala.concurrent.duration._
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L172-L178 "Go to snippet source")import akka.testkit.TestActorRef
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L101-L106 "Go to snippet source")final Props props = Props.create(MyActor.class);
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/testkit/TestkitDocSpec.scala#L194-L201 "Go to snippet source")import akka.testkit.TestActorRef
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/testkit/TestKitDocTest.java#L113-L120 "Go to snippet source")final Props props = Props.create(MyActor.class);
...
### Example 4: Asynchronous Testing:TestKit
...
### Example 5: Asynchronous Testing:TestKit
...
### Example 8: Expecting Log Messages
...
### Example 9: Expecting Log Messages
...
### Example 10: Expecting Log Messages

```text
akka.loggers = [akka.testkit.TestEventListener]
```

### Example 11: Overriding behavior
...
### Example 12: Overriding behavior
...
### Example 13: Overriding behavior
...
### Example 17: Accounting for Slow Test Systems
...
### Example 18: Accounting for Slow Test Systems
...
### Example 19: Resolving Conflicts with Implicit ActorRef
...
### Example 20: Using Multiple Probe Actors
...
### Example 21: Using Multiple Probe Actors
...
### Example 22: Using Multiple Probe Actors
...
### Example 28: Watching Other Actors from Probes
...
### Example 29: Watching Other Actors from Probes
...
### Example 30: Replying to Messages Received by Probes
...
### Example 31: Replying to Messages Received by Probes
...
### Example 32: Forwarding Messages Received by Probes
...
### Example 33: Forwarding Messages Received by Probes
...
### Example 34: Forwarding Messages Received by Probes
...
### Example 37: Caution about Timing Assertions
...
### Example 38: Caution about Timing Assertions
...
### Example 39: Testing parent-child relationships
...
### Example 40: Testing parent-child relationships
...
### Example 41: Introduce a child to its parent
...
### Example 42: Introduce a child to its parent
...
### Example 43: Create the child usingTestProbeTestKit
...
### Example 44: Create the child usingTestProbeTestKit
...
### Example 45: Using a fabricated parent
...
### Example 46: Using a fabricated parent
...
### Example 47: Using a fabricated parent
...
### Example 48: Externalize child making from the parent
...
### Example 49: Externalize child making from the parent
...
### Example 50: Externalize child making from the parent
...
### Example 58: Tracing Actor Invocations
...
### Example 59: Tracing Actor Invocations
...
### Example 60: When you need it to be a trait
...
### Example 62: Obtaining a Reference to anActor
...
### Example 63: Obtaining a Reference to anActor
...
### Example 64: Testing Finite State Machines
...
### Example 65: Testing the Actor’s Behavior
...
### Example 66: Testing the Actor’s Behavior
...
### Example 67: The Way In-Between: Expecting Exceptions
...
### Example 68: The Way In-Between: Expecting Exceptions
...
---
*Source: [https://doc.akka.io/libraries/akka-core/current/testing.html](https://doc.akka.io/libraries/akka-core/current/testing.html)*