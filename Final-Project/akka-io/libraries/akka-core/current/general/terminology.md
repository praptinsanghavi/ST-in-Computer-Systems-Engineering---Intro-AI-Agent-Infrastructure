...
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/general/terminology.html
title: Terminology, Concepts • Akka core
---

# Terminology, Concepts • Akka core
...
It’s not always possible to avoid using blocking APIs, please see [`Blocking Needs Careful Management`](../typed/dispatchers.html#blocking-management) to use those safely within the actor code.
...
Note
The only guarantee that Akka provides about messages sent between a given pair of actors is that their order is always preserved. see [Message Delivery Reliability](message-delivery-reliability.html)
...
---
*Source: [https://doc.akka.io/libraries/akka-core/current/general/terminology.html](https://doc.akka.io/libraries/akka-core/current/general/terminology.html)*