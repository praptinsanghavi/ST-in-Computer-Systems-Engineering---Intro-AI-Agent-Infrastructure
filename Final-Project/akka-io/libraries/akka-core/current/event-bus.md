...
scraped_at: '2026-04-05T20:21:08Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-core/current/event-bus.html
title: Classic Event Bus • Akka core
---

# Classic Event Bus • Akka core
...
For the full documentation of this feature and for new projects see [Event Bus](typed/event-stream.html).
...
The event stream is the main event bus of each actor system: it is used for carrying [log messages](logging.html) and [Dead Letters](event-bus.html#dead-letters) and may be used by the user code for other purposes as well. It uses [Subchannel Classification](event-bus.html#subchannel-classification) which enables registering to related sets of channels. The following example demonstrates how a simple subscription works. Given a simple actor:

```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/event/LoggingDocSpec.scala#L119-L170 "Go to snippet source")import akka.actor.{ Actor, DeadLetter, Props }
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/event/LoggingDocTest.java#L35-L36 "Go to snippet source")import akka.actor.ActorRef;
import akka.actor.ActorSystem;
```

```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/event/LoggingDocTest.java#L247-L258 "Go to snippet source")static class DeadLetterActor extends AbstractActor {
  @Override
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/event/LoggingDocTest.java#L60-L62 "Go to snippet source")final ActorSystem system = ActorSystem.create("DeadLetters");
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/event/LoggingDocSpec.scala#L130-L187 "Go to snippet source")abstract class AllKindsOfMusic { def artist: String }
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/event/LoggingDocTest.java#L68-L116 "Go to snippet source")interface AllKindsOfMusic {}
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/event/LoggingDocSpec.scala#L196-L197 "Go to snippet source")import akka.actor.SuppressedDeadLetter
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/event/LoggingDocTest.java#L127 "Go to snippet source")system.getEventStream().subscribe(actor, SuppressedDeadLetter.class);
```
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/scala/docs/event/LoggingDocSpec.scala#L201-L202 "Go to snippet source")import akka.actor.AllDeadLetters
...
```
[source](https://github.com/akka/akka-core/tree/v2.10.17/akka-docs/src/test/java/jdocs/event/LoggingDocTest.java#L139 "Go to snippet source")system.getEventStream().subscribe(actor, AllDeadLetters.class);
```
...
### Example 6: Lookup Classification
...
### Example 7: Lookup Classification
...
### Example 8: Lookup Classification
...
### Example 9: Lookup Classification
...
### Example 10: Subchannel Classification
...
### Example 11: Subchannel Classification
...
### Example 12: Subchannel Classification
...
### Example 13: Subchannel Classification
...
### Example 14: Scanning Classification
...
### Example 15: Scanning Classification
...
### Example 16: Scanning Classification
...
### Example 17: Scanning Classification
...
### Example 18: Actor Classification
...
### Example 19: Actor Classification
...
### Example 20: Actor Classification
...
### Example 21: Actor Classification
...
### Example 29: Default Handlers

```text
system.eventStream.setLogLevel(Logging.DebugLevel)
```

### Example 30: Default Handlers

```text
system.eventStream.setLogLevel(Logging.DebugLevel());
```

### Example 31: Dead Letters
...
- https://doc.akka.io/libraries/akka-core/current/distributed-pub-sub.html
...
---
*Source: [https://doc.akka.io/libraries/akka-core/current/event-bus.html](https://doc.akka.io/libraries/akka-core/current/event-bus.html)*