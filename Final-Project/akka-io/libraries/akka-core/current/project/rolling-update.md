...
title: Rolling Updates and Versions • Akka core
---

# Rolling Updates and Versions • Akka core
...
Note
[Rolling update from classic remoting to Artery](../additional/rolling-updates.html#migrating-from-classic-remoting-to-artery) is not supported since the protocol is completely different. It will require a full cluster shutdown and new startup.
...
See [migration guide](migration-guide-2.5.x-2.6.x.html) when updating from 2\.5\.x to 2\.6\.x.
...
Issue: [\#28918](https://github.com/akka/akka-core/issues/28918). JacksonCborSerializer was using plain JSON format instead of CBOR.
...
### Example 1: 2.6.5 JacksonCborSerializer
...
- https://doc.akka.io/libraries/akka-core/current/project/issue-tracking.html
- https://doc.akka.io/libraries/akka-core/current/project/migration-guide-2.5.x-2.6.x.html
- https://doc.akka.io/libraries/akka-core/current/project/migration-guide-old.html

---
*Source: [https://doc.akka.io/libraries/akka-core/current/project/rolling-update.html](https://doc.akka.io/libraries/akka-core/current/project/rolling-update.html)*