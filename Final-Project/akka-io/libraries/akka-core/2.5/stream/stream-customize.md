...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/stream/GraphStageDocSpec.scala#L25-L36 "Go to snippet source")import akka.stream.SourceShape
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/stream/GraphStageDocTest.java#L55-L91 "Go to snippet source")public class NumbersSource extends GraphStage<SourceShape<Integer>> {
  // Define the (sole) output port of this stage
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/stream/GraphStageDocSpec.scala#L43-L70 "Go to snippet source")import akka.stream.Attributes
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/stream/GraphStageDocSpec.scala#L74-L84 "Go to snippet source")// A GraphStage is a proper Graph, just like what GraphDSL.create would return
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/stream/GraphStageDocTest.java#L135-L146 "Go to snippet source")// A GraphStage is a proper Graph, just like what GraphDSL.create would return
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/stream/GraphStageDocSpec.scala#L93-L117 "Go to snippet source")import akka.stream.Attributes
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/stream/GraphStageDocTest.java#L95-L129 "Go to snippet source")public class StdoutSink extends GraphStage<SinkShape<Integer>> {
...
- `onDownstreamFinish()` is called once the downstream has cancelled and no longer allows messages to be pushed to it. No more `onPull()` will arrive after this event. If not overridden this will default to stopping the operator.
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/stream/GraphStageDocSpec.scala#L124-L144 "Go to snippet source")class Map[A, B](f: A => B) extends GraphStage[FlowShape[A, B]] {
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/stream/GraphStageDocTest.java#L163-L205 "Go to snippet source")public class Map<A, B> extends GraphStage<FlowShape<A, B>> {
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/stream/GraphStageDocSpec.scala#L158-L180 "Go to snippet source")class Filter[A](p: A => Boolean) extends GraphStage[FlowShape[A, A]] {
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/stream/GraphStageDocTest.java#L230-L276 "Go to snippet source")public final class Filter<A> extends GraphStage<FlowShape<A, A>> {
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/stream/GraphStageDocSpec.scala#L195-L232 "Go to snippet source")class Duplicator[A] extends GraphStage[FlowShape[A, A]] {
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/stream/GraphStageDocTest.java#L295-L349 "Go to snippet source")public class Duplicator<A> extends GraphStage<FlowShape<A, A>> {
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/stream/GraphStageDocSpec.scala#L247-L271 "Go to snippet source")class Duplicator[A] extends GraphStage[FlowShape[A, A]] {
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/stream/GraphStageDocTest.java#L365-L405 "Go to snippet source")public class Duplicator2<A> extends GraphStage<FlowShape<A, A>> {
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/stream/GraphStageDocSpec.scala#L288-L290 "Go to snippet source")val resultFuture =
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/stream/GraphStageDocTest.java#L426-L432 "Go to snippet source")CompletionStage<String> resultFuture =
...
You can extend the [`GraphStageLogicWithLogging`](https://doc.akka.io/api/akka-core/2.5/akka/stream/stage/GraphStageLogicWithLogging.html "akka.stream.stage.GraphStageLogicWithLogging")[`GraphStageLogicWithLogging`](https://doc.akka.io/japi/akka-core/2.5/?akka/stream/stage/GraphStageLogicWithLogging.html "akka.stream.stage.GraphStageLogicWithLogging") or [`TimerGraphStageLogicWithLogging`](https://doc.akka.io/api/akka-core/2.5/akka/stream/stage/TimerGraphStageLogicWithLogging.html "akka.stream.stage.TimerGraphStageLogicWithLogging")[`TimerGraphStageLogicWithLogging`](https://doc.akka.io/japi/akka-core/2.5/?akka/stream/stage/TimerGraphStageLogicWithLogging.html "akka.stream.stage.TimerGraphStageLogicWithLogging") classes instead of the usual `GraphStageLogic` to enable you to obtain a `LoggingAdapter` inside your operator as long as the `Materializer` you’re using is able to provide you with a logger.
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/stream/GraphStageLoggingDocSpec.scala#L19-L41 "Go to snippet source")import akka.stream.stage.{ GraphStage, GraphStageLogic, OutHandler, StageLogging }
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/stream/GraphStageLoggingDocTest.java#L32-L68 "Go to snippet source")public class RandomLettersSource extends GraphStage<SourceShape<String>> {
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/stream/GraphStageDocSpec.scala#L360-L392 "Go to snippet source")// each time an event is pushed through it will trigger a period of silence
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/stream/GraphStageDocTest.java#L524-L582 "Go to snippet source")// each time an event is pushed through it will trigger a period of silence
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/stream/GraphStageDocSpec.scala#L299-L325 "Go to snippet source")// will close upstream in all materializations of the graph stage instance
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/stream/GraphStageDocTest.java#L439-L498 "Go to snippet source")// will close upstream in all materializations of the stage instance
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/stream/GraphStageDocSpec.scala#L408-L444 "Go to snippet source")class FirstValue[A] extends GraphStageWithMaterializedValue[FlowShape[A, A], Future[A]] {
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/stream/GraphStageDocTest.java#L597-L652 "Go to snippet source")public class FirstValue<A>
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/stream/GraphStageDocSpec.scala#L459-L521 "Go to snippet source")class TwoBuffer[A] extends GraphStage[FlowShape[A, A]] {
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/stream/GraphStageDocTest.java#L668-L746 "Go to snippet source")public class TwoBuffer<A> extends GraphStage<FlowShape<A, A>> {
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/stream/GraphStageDocSpec.scala#L560-L566 "Go to snippet source")implicit class FlowDuplicator[In, Out, Mat](s: Flow[In, Out, Mat]) {
...
- https://doc.akka.io/api/akka-core/2.5/akka/stream/stage/GraphStageLogicWithLogging.html
- https://doc.akka.io/api/akka-core/2.5/akka/stream/stage/TimerGraphStageLogicWithLogging.html
- https://doc.akka.io/japi/akka-core/2.5/?akka/stream/stage/GraphStageLogicWithLogging.html
- https://doc.akka.io/japi/akka-core/2.5/?akka/stream/stage/TimerGraphStageLogicWithLogging.html
- https://doc.akka.io/libraries/akka-core/2.5/common/may-change.html
- https://doc.akka.io/libraries/akka-core/2.5/logging.html
- https://doc.akka.io/libraries/akka-core/2.5/stream/stream-composition.html
- https://doc.akka.io/libraries/akka-core/2.5/stream/stream-cookbook.html
- https://doc.akka.io/libraries/akka-core/2.5/stream/stream-customize.html
- https://doc.akka.io/libraries/akka-core/2.5/stream/stream-dynamic.html
- https://doc.akka.io/libraries/akka-core/2.5/stream/stream-integrations.html

---
*Source: [https://doc.akka.io/libraries/akka-core/2.5/stream/stream-customize.html](https://doc.akka.io/libraries/akka-core/2.5/stream/stream-customize.html)*