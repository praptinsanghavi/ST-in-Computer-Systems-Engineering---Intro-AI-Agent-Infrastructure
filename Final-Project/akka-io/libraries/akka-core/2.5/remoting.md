...
scraped_at: '2026-04-06T16:20:51Z'
section: libraries
site: akka-io
...
```
dependencies {
  implementation "com.typesafe.akka:akka-remote_2.12:2.5.32"
}
```
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/remoting/RemoteDeploymentDocSpec.scala#L63-L65 "Go to snippet source")  
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/remoting/RemoteDeploymentDocTest.java#L66-L68 "Go to snippet source")  
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/remoting/RemoteDeploymentDocSpec.scala#L10-L11 "Go to snippet source")import akka.actor.{ Address, AddressFromURIString, Deploy, Props }
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/remoting/RemoteDeploymentDocTest.java#L15-L21 "Go to snippet source")import akka.actor.ActorRef;
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/remoting/RemoteDeploymentDocSpec.scala#L55-L56 "Go to snippet source")val one = AddressFromURIString("akka.tcp://sys@host:1234")
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/remoting/RemoteDeploymentDocTest.java#L52-L53 "Go to snippet source")Address addr = new Address("akka.tcp", "sys", "host", 1234);
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/remoting/RemoteDeploymentDocSpec.scala#L39 "Go to snippet source")val ref = system.actorOf(Props[SampleActor].withDeploy(Deploy(scope = RemoteScope(address))))
```

Java

```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/remoting/RemoteDeploymentDocTest.java#L56-L58 "Go to snippet source")ActorRef ref =
    system.actorOf(
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-remote/src/test/scala/akka/remote/RemoteDeploymentWhitelistSpec.scala#L108-L115 "Go to snippet source")akka.remote.deployment {
  enable-whitelist = on
...
For more information please see [Serialization](serialization.html).

### Disabling the Java Serializer

It is highly recommended that you [disable Java serialization](serialization.html#disable-java-serializer).
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/routing/RouterDocSpec.scala#L209-L215 "Go to snippet source")akka.actor.deployment {
  /parent/remotePool {
    router = round-robin-pool
    nr-of-instances = 10
    target.nodes = ["akka.tcp://[[email protected]](/cdn-cgi/l/email-protection):2552", "akka.tcp://[[email protected]](/cdn-cgi/l/email-protection):2552"]
  }
}
```
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/scala/docs/routing/RouterDocSpec.scala#L229-L237 "Go to snippet source")akka.actor.deployment {
  /parent/remoteGroup {
    router = round-robin-group
    routees.paths = [
      "akka.tcp://[[email protected]](/cdn-cgi/l/email-protection):2552/user/workers/w1",
      "akka.tcp://[[email protected]](/cdn-cgi/l/email-protection):2552/user/workers/w1",
      "akka.tcp://[[email protected]](/cdn-cgi/l/email-protection):2552/user/workers/w1"]
  }
}
...
There are lots of configuration properties that are related to remoting in Akka. We refer to the [reference configuration](general/configuration.html#config-akka-remote) for more information.
...
```
[source](https://github.com/akka/akka/tree/v2.5.32/akka-docs/src/test/java/jdocs/remoting/RemoteDeploymentDocTest.java#L75-L76 "Go to snippet source")ConfigFactory.parseString("akka.remote.netty.tcp.hostname=\"1.2.3.4\"")
...
### Example 5: Looking up Remote Actors
...
### Example 6: Looking up Remote Actors
...
### Example 7: Looking up Remote Actors
...
### Example 10: Creating Actors Remotely
...
### Example 11: Creating Actors Remotely
...
### Example 12: Creating Actors Remotely
...
### Example 13: Programmatic Remote Deployment
...
### Example 14: Programmatic Remote Deployment
...
### Example 15: Programmatic Remote Deployment
...
### Example 19: Remote deployment whitelist
...
### Example 23: Configuring SSL/TLS for Akka Remoting
...
### Example 24: Configuring SSL/TLS for Akka Remoting
...
### Example 25: Untrusted Mode

```text
akka.remote.untrusted-mode = on
```

### Example 26: Untrusted Mode

```text
akka.remote.trusted-selection-paths = ["/user/receptionist", "/user/namingService"]
```

### Example 27: Remote Configuration
...
### Example 28: Akka behind NAT or in a Docker container
...
- https://doc.akka.io/libraries/akka-core/2.5/general/remoting.html
- https://doc.akka.io/libraries/akka-core/2.5/index-network.html
...
---
*Source: [https://doc.akka.io/libraries/akka-core/2.5/remoting.html](https://doc.akka.io/libraries/akka-core/2.5/remoting.html)*