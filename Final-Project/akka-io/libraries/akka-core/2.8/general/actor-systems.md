---
description: The Akka ActorSystem.
knowledge_type: official_documentation
scraped_at: '2026-04-06T14:23:58Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/docs/akka/current/general/actor-systems.html
title: Actor Systems • Akka Documentation
---

# Actor Systems • Akka Documentation

> **Summary:** The Akka ActorSystem.
...
When you know everything is done for your application, you can have the user guardian actor stop, or call the [`terminate`](https://doc.akka.io/api/akka/2.8/akka/actor/typed/ActorSystem.html#terminate():Unit "akka.actor.typed.ActorSystem")[`terminate()`](https://doc.akka.io/japi/akka/2.8/akka/actor/typed/ActorSystem.html#terminate() "akka.actor.typed.ActorSystem") method of [`ActorSystem`](https://doc.akka.io/api/akka/2.8/akka/actor/typed/ActorSystem.html "akka.actor.typed.ActorSystem")[`ActorSystem`](https://doc.akka.io/japi/akka/2.8/akka/actor/typed/ActorSystem.html "akka.actor.typed.ActorSystem"). That will run [`CoordinatedShutdown`](../coordinated-shutdown.html) stopping all running actors.

If you want to execute some operations while terminating [`ActorSystem`](https://doc.akka.io/api/akka/2.8/akka/actor/typed/ActorSystem.html "akka.actor.typed.ActorSystem")[`ActorSystem`](https://doc.akka.io/japi/akka/2.8/akka/actor/typed/ActorSystem.html "akka.actor.typed.ActorSystem"), look at [`CoordinatedShutdown`](../coordinated-shutdown.html).
...
- https://doc.akka.io/libraries/akka-core/2.8/general/actors.html
- https://doc.akka.io/libraries/akka-core/2.8/general/terminology.html
- https://doc.akka.io/libraries/akka-core/2.8/typed/dispatchers.html

---
*Source: [https://doc.akka.io/libraries/akka-core/2.8/general/actor-systems.html](https://doc.akka.io/libraries/akka-core/2.8/general/actor-systems.html)*