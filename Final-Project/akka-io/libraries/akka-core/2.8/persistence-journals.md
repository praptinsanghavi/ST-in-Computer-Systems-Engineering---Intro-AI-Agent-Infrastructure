...
scraped_at: '2026-04-06T14:30:11Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/docs/akka/current/persistence-journals.html
title: Persistence - Building a storage backend • Akka Documentation
---
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistencePluginDocSpec.scala#L18-L21 "Go to snippet source")import akka.persistence._
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/persistence/LambdaPersistencePluginDocTest.java#L8-L11 "Go to snippet source")import akka.dispatch.Futures;
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-persistence/src/main/scala/akka/persistence/journal/AsyncWriteJournal.scala#L202-L288 "Go to snippet source")/**
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-persistence/src/main/java/akka/persistence/journal/japi/AsyncWritePlugin.java#L13-L74 "Go to snippet source")/**
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistencePluginDocSpec.scala#L157-L161 "Go to snippet source")def asyncWriteMessages(messages: immutable.Seq[AtomicWrite]): Future[immutable.Seq[Try[Unit]]] =
  Future.fromTry(Try {
    // blocking call here
    ???
  })
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/persistence/LambdaPersistencePluginDocTest.java#L98-L109 "Go to snippet source")@Override
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-persistence/src/main/scala/akka/persistence/journal/AsyncRecovery.scala#L16-L70 "Go to snippet source")/**
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-persistence/src/main/java/akka/persistence/journal/japi/AsyncRecoveryPlugin.java#L13-L49 "Go to snippet source")/**
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistencePluginDocSpec.scala#L69-L78 "Go to snippet source")# Path to the journal plugin to be used
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-persistence/src/main/scala/akka/persistence/snapshot/SnapshotStore.scala#L127-L178 "Go to snippet source")  
/**
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-persistence/src/main/java/akka/persistence/snapshot/japi/SnapshotStorePlugin.java#L15-L45 "Go to snippet source")/**
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistencePluginDocSpec.scala#L82-L91 "Go to snippet source")# Path to the snapshot store plugin to be used
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistencePluginDocSpec.scala#L188-L197 "Go to snippet source")class MyJournalSpec
    extends JournalSpec(
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/persistence/LambdaPersistencePluginDocTest.java#L136-L150 "Go to snippet source")@RunWith(JUnitRunner.class)
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistencePluginDocSpec.scala#L204-L212 "Go to snippet source")class MySnapshotStoreSpec
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/persistence/LambdaPersistencePluginDocTest.java#L157-L166 "Go to snippet source")@RunWith(JUnitRunner.class)
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistencePluginDocSpec.scala#L222-L244 "Go to snippet source")class MyJournalSpec
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/persistence/LambdaPersistencePluginDocTest.java#L174-L212 "Go to snippet source")@RunWith(JUnitRunner.class)
class MyJournalSpecTest extends JavaJournalSpec {
...
---
*Source: [https://doc.akka.io/libraries/akka-core/2.8/persistence-journals.html](https://doc.akka.io/libraries/akka-core/2.8/persistence-journals.html)*