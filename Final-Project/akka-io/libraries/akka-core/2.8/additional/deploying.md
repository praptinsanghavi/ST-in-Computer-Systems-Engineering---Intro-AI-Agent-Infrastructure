...
scraped_at: '2026-04-06T14:28:25Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/docs/akka/current/additional/deploying.html
title: Deploying • Akka Documentation
---
...
To take advantage of running inside Kubernetes while forming a cluster, [Akka Cluster Bootstrap](https://doc.akka.io/docs/akka-management/current/bootstrap/) helps forming or joining a cluster using Akka Discovery to discover peer nodes. with the Kubernetes API or Kubernetes via DNS. 

You can look at the [Cluster with Kubernetes example project](https://developer.lightbend.com/start/?group=akka&project=akka-sample-cluster-kubernetes-java) to see what this looks like in practice.

### Rolling updates

Enable the [Kubernetes Rolling Updates](https://doc.akka.io/docs/akka-management/current/rolling-updates.html#kubernetes-rolling-updates) and [app\-version from Deployment](https://doc.akka.io/docs/akka-management/current/rolling-updates.html#app-version-from-deployment) features from Akka Management for smooth rolling updates.
...
- https://doc.akka.io/docs/akka-management/current/kubernetes-deployment/index.html
...
---
*Source: [https://doc.akka.io/libraries/akka-core/2.8/additional/deploying.html](https://doc.akka.io/libraries/akka-core/2.8/additional/deploying.html)*