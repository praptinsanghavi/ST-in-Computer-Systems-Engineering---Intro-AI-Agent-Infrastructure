...
scraped_at: '2026-04-06T14:25:51Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/docs/akka/current/persistence-schema-evolution.html
title: Schema Evolution for Event Sourced Actors • Akka Documentation
---
...
Since events are never deleted, we need to have a way to be able to replay (read) old events, in such way that does not force the [`PersistentActor`](https://doc.akka.io/api/akka/2.8/akka/persistence/PersistentActor.html "akka.persistence.PersistentActor")[`AbstractPersistentActor`](https://doc.akka.io/japi/akka/2.8/akka/persistence/AbstractPersistentActor.html "akka.persistence.AbstractPersistentActor") to be aware of all possible versions of an event that it may have persisted in the past. Instead, we want the Actors to work on some form of “latest” version of the event and provide some means of either converting old “versions” of stored events into this “latest” event type, or constantly evolve the event definition \- in a backwards compatible way \- such that the new deserialization code can still read old events.
...
Akka Persistence provides [Google Protocol Buffers](https://developers.google.com/protocol-buffers/) based serializers (using [Akka Serialization](serialization.html)) for its own message types such as [`PersistentRepr`](https://doc.akka.io/api/akka/2.8/akka/persistence/PersistentRepr.html "akka.persistence.PersistentRepr")[`PersistentRepr`](https://doc.akka.io/japi/akka/2.8/akka/persistence/PersistentRepr.html "akka.persistence.PersistentRepr"), [`AtomicWrite`](https://doc.akka.io/api/akka/2.8/akka/persistence/AtomicWrite.html "akka.persistence.AtomicWrite")[`AtomicWrite`](https://doc.akka.io/japi/akka/2.8/akka/persistence/AtomicWrite.html "akka.persistence.AtomicWrite") and snapshots. Journal plugin implementations *may* choose to use those provided serializers, or pick a serializer which suits the underlying database better.

Note
Serialization is **NOT** handled automatically by Akka Persistence itself. Instead, it only provides the above described serializers, and in case a [`AsyncWriteJournal`](https://doc.akka.io/api/akka/2.8/akka/persistence/journal/AsyncWriteJournal.html "akka.persistence.journal.AsyncWriteJournal")[`AsyncWriteJournal`](https://doc.akka.io/japi/akka/2.8/akka/persistence/journal/japi/AsyncWriteJournal.html "akka.persistence.journal.japi.AsyncWriteJournal") plugin implementation chooses to use them directly, the above serialization scheme will be used.
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistenceSchemaEvolutionDocSpec.scala#L168 "Go to snippet source")final case class Person(name: String, surname: String)
```

Java

```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/persistence/PersistenceSchemaEvolutionDocTest.java#L167-L175 "Go to snippet source")static class Person {
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistenceSchemaEvolutionDocSpec.scala#L172-L210 "Go to snippet source")/**
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/persistence/PersistenceSchemaEvolutionDocTest.java#L180-L231 "Go to snippet source")/**
 * Simplest possible serializer, uses a string representation of the Person class.
 *
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistenceSchemaEvolutionDocSpec.scala#L217-L228 "Go to snippet source")# application.conf
akka {
  actor {
    serializers {
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistenceSchemaEvolutionDocSpec.scala#L51-L66 "Go to snippet source")sealed abstract class SeatType { def code: String }
object SeatType {
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/persistence/PersistenceSchemaEvolutionDocTest.java#L22-L55 "Go to snippet source")static enum SeatType {
  Window("W"),
  Aisle("A"),
  Other("O"),
  Unknown("");
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/main/protobuf/FlightAppModels.proto#L10-L18 "Go to snippet source")// FlightAppModels.proto
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistenceSchemaEvolutionDocSpec.scala#L70-L109 "Go to snippet source")/**
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/persistence/PersistenceSchemaEvolutionDocTest.java#L60-L118 "Go to snippet source")/**
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistenceSchemaEvolutionDocSpec.scala#L116-L124 "Go to snippet source")// protobuf message definition, BEFORE:
message SeatReserved {
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistenceSchemaEvolutionDocSpec.scala#L131-L161 "Go to snippet source")class JsonRenamedFieldAdapter extends EventAdapter {
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/persistence/PersistenceSchemaEvolutionDocTest.java#L124-L159 "Go to snippet source")static class JsonRenamedFieldAdapter implements EventAdapter {
...
The [`EventAdapter`](https://doc.akka.io/api/akka/2.8/akka/persistence/journal/EventAdapter.html "akka.persistence.journal.EventAdapter")[`EventAdapter`](https://doc.akka.io/japi/akka/2.8/akka/persistence/journal/EventAdapter.html "akka.persistence.journal.EventAdapter") can drop old events (\*\*O\*\*) by emitting an empty [`EventSeq`](https://doc.akka.io/api/akka/2.8/akka/persistence/journal/EventSeq.html "akka.persistence.journal.EventSeq")[`EventSeq`](https://doc.akka.io/japi/akka/2.8/akka/persistence/journal/EventSeq.html "akka.persistence.journal.EventSeq"). Other events can be passed through (\*\*E\*\*).
...
In the just described technique we have saved the PersistentActor from receiving un\-wanted events by filtering them out in the [`EventAdapter`](https://doc.akka.io/api/akka/2.8/akka/persistence/journal/EventAdapter.html "akka.persistence.journal.EventAdapter")[`EventAdapter`](https://doc.akka.io/japi/akka/2.8/akka/persistence/journal/EventAdapter.html "akka.persistence.journal.EventAdapter"), however the event itself still was deserialized and loaded into memory. This has two notable *downsides*:
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistenceSchemaEvolutionDocSpec.scala#L265-L287 "Go to snippet source")case object EventDeserializationSkipped
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/persistence/PersistenceSchemaEvolutionDocTest.java#L327-L363 "Go to snippet source")static class EventDeserializationSkipped {
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistenceSchemaEvolutionDocSpec.scala#L291-L299 "Go to snippet source")class SkippedEventsAwareAdapter extends EventAdapter {
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/persistence/PersistenceSchemaEvolutionDocTest.java#L368-L384 "Go to snippet source")static class SkippedEventsAwareAdapter implements EventAdapter {
  @Override
  public String manifest(Object event) {
    return "";
  }
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistenceSchemaEvolutionDocSpec.scala#L327-L340 "Go to snippet source")/** Domain model - highly optimised for domain language and maybe "fluent" usage */
object DomainModel {
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/persistence/PersistenceSchemaEvolutionDocTest.java#L433-L482 "Go to snippet source")// Domain model - highly optimised for domain language and maybe "fluent" usage
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistenceSchemaEvolutionDocSpec.scala#L344-L355 "Go to snippet source")class DetachedModelsAdapter extends EventAdapter {
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/persistence/PersistenceSchemaEvolutionDocTest.java#L486-L511 "Go to snippet source")class DetachedModelsAdapter implements EventAdapter {
  @Override
  public String manifest(Object event) {
    return "";
  }
...
In this approach, the [`EventAdapter`](https://doc.akka.io/api/akka/2.8/akka/persistence/journal/EventAdapter.html "akka.persistence.journal.EventAdapter")[`EventAdapter`](https://doc.akka.io/japi/akka/2.8/akka/persistence/journal/EventAdapter.html "akka.persistence.journal.EventAdapter") is used as the marshalling layer: it serializes the events to/from JSON. The journal plugin notices that the incoming event type is JSON (for example by performing a `match` on the incoming event) and stores the incoming object directly.

Scala

```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistenceSchemaEvolutionDocSpec.scala#L365-L379 "Go to snippet source")class JsonDataModelAdapter extends EventAdapter {
  override def manifest(event: Any): String = ""
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/persistence/PersistenceSchemaEvolutionDocTest.java#L516-L541 "Go to snippet source")static class JsonDataModelAdapter implements EventAdapter {
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/scala/docs/persistence/PersistenceSchemaEvolutionDocSpec.scala#L236-L259 "Go to snippet source")trait Version1
trait Version2
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/persistence/PersistenceSchemaEvolutionDocTest.java#L248-L314 "Go to snippet source")interface Version1 {};
...
### Example 9: Configuring payload serializers
...
### Example 10: Configuring payload serializers
...
### Example 11: Configuring payload serializers
...
### Example 21: Remove event class and ignore events
...
### Example 22: Remove event class and ignore events
...
### Example 23: Remove event class and ignore events
...
### Example 25: Detach domain model from data model
...
### Example 26: Detach domain model from data model
...
### Example 27: Detach domain model from data model
...
### Example 28: Store events as human-readable data model
...
### Example 29: Store events as human-readable data model
...
### Example 30: Split large event into fine-grained events
...
### Example 31: Split large event into fine-grained events
...
- https://doc.akka.io/japi/akka/2.8/akka/persistence/AtomicWrite.html
- https://doc.akka.io/japi/akka/2.8/akka/persistence/PersistentRepr.html
...
- https://doc.akka.io/japi/akka/2.8/akka/persistence/journal/japi/AsyncWriteJournal.html
- https://doc.akka.io/japi/akka/2.8/akka/serialization/SerializerWithStringManifest.html
- https://doc.akka.io/libraries/akka-core/2.8/persistence-query.html
...
- https://doc.akka.io/libraries/akka-core/2.8/typed/persistence-fsm.html

---
*Source: [https://doc.akka.io/libraries/akka-core/2.8/persistence-schema-evolution.html](https://doc.akka.io/libraries/akka-core/2.8/persistence-schema-evolution.html)*