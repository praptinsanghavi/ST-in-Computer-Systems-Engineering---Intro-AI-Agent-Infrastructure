...
scraped_at: '2026-04-06T14:28:21Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/docs/akka/current/cluster-sharding.html
title: Classic Cluster Sharding • Akka Documentation
---

# Classic Cluster Sharding • Akka Documentation
...
| --- | --- |
| Artifact | com.typesafe.akka akka\-cluster\-sharding 2\.8\.9 [Snapshots are available](project/links.html#snapshots-repository) |
...
| API documentation | [API (Scaladoc)](https://doc.akka.io/api/akka/2.8.9/akka/cluster/sharding/index.html) [API (Javadoc)](https://doc.akka.io/japi/akka/2.8.9/akka/cluster/sharding/package-summary.html) |
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-cluster-sharding/src/multi-jvm/scala/akka/cluster/sharding/ClusterShardingSpec.scala#L30-L70 "Go to snippet source")case object Increment
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java#L155-L237 "Go to snippet source")static class Counter extends AbstractPersistentActor {
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-cluster-sharding/src/multi-jvm/scala/akka/cluster/sharding/ClusterShardingSpec.scala#L677-L682 "Go to snippet source")val counterRegion: ActorRef = ClusterSharding(system).start(
  typeName = "Counter",
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java#L25-L84 "Go to snippet source")import akka.japi.Option;
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-cluster-sharding/src/multi-jvm/scala/akka/cluster/sharding/ClusterShardingSpec.scala#L187-L201 "Go to snippet source")val extractEntityId: ShardRegion.ExtractEntityId = {
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java#L20-L76 "Go to snippet source")import akka.cluster.sharding.ShardRegion;
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-cluster-sharding/src/multi-jvm/scala/akka/cluster/sharding/ClusterShardingSpec.scala#L705-L711 "Go to snippet source")val counterRegion: ActorRef = ClusterSharding(system).shardRegion("Counter")
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java#L88-L92 "Go to snippet source")ActorRef counterRegion = ClusterSharding.get(system).shardRegion("Counter");
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-cluster-sharding/src/multi-jvm/scala/akka/cluster/sharding/ClusterShardingSpec.scala#L206-L213 "Go to snippet source")val extractShardId: ShardRegion.ExtractShardId = {
  case EntityEnvelope(id, _)       => (id % numberOfShards).toString
  case Get(id)                     => (id % numberOfShards).toString
  case ShardRegion.StartEntity(id) =>
    // StartEntity is used by remembering entities feature
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java#L133-L148 "Go to snippet source")@Override
public String shardId(Object message) {
  int numberOfShards = 100;
  if (message instanceof Counter.EntityEnvelope) {
    long id = ((Counter.EntityEnvelope) message).id;
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-cluster-sharding/src/multi-jvm/scala/akka/cluster/sharding/ClusterShardingSpec.scala#L97-L110 "Go to snippet source")class CounterSupervisor extends Actor {
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java#L241-L265 "Go to snippet source")static class CounterSupervisor extends AbstractActor {
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-cluster-sharding/src/multi-jvm/scala/akka/cluster/sharding/ClusterShardingSpec.scala#L694-L699 "Go to snippet source")ClusterSharding(system).start(
...
```
[source](https://github.com/akka/akka/tree/v2.8.9/akka-docs/src/test/java/jdocs/sharding/ClusterShardingTest.java#L96-L98 "Go to snippet source")ClusterSharding.get(system)
    .start(
...
- https://doc.akka.io/api/akka/2.8.9/akka/cluster/sharding/index.html
- https://doc.akka.io/japi/akka/2.8.9/akka/cluster/sharding/package-summary.html
- https://doc.akka.io/libraries/akka-core/2.8/additional/rolling-updates.html
- https://doc.akka.io/libraries/akka-core/2.8/cluster-client.html
- https://doc.akka.io/libraries/akka-core/2.8/cluster-metrics.html
...
- https://doc.akka.io/libraries/akka-core/2.8/distributed-data.html
...
- https://doc.akka.io/libraries/akka-core/2.8/typed/cluster-sharding-concepts.html
...
---
*Source: [https://doc.akka.io/libraries/akka-core/2.8/cluster-sharding.html](https://doc.akka.io/libraries/akka-core/2.8/cluster-sharding.html)*