---
description: Release notes for all Alpakka Kafka 1.0.x releases.
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:17:36Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/alpakka-kafka/current/release-notes/1.0.x.html
title: Alpakka Kafka 1.0.x • Alpakka Kafka Documentation
---

# Alpakka Kafka 1.0.x • Alpakka Kafka Documentation

> **Summary:** Release notes for all Alpakka Kafka 1.0.x releases.
...
| --- | --- | --- | --- |
| [2m **2m**](https://github.com/2m) | 13 | 629 | 213 |
| [ennru **ennru**](https://github.com/ennru) | 7 | 1327 | 203 |
| [tayvs **tayvs**](https://github.com/tayvs) | 1 | 397 | 9 |
| [lomigmegard **lomigmegard**](https://github.com/lomigmegard) | 1 | 1 | 1 |
...
| Author | Commits | Lines added | Lines removed |
| --- | --- | --- | --- |
| [2m **2m**](https://github.com/2m) | 30 | 2947 | 2735 |
| [ennru **ennru**](https://github.com/ennru) | 3 | 966 | 301 |
| [mowczare **mowczare**](https://github.com/mowczare) | 2 | 40 | 32 |
| [mowczare **Jimmycheong**](https://github.com/Jimmycheong) | 1 | 3 | 3 |
...
- Transactions: Avoid a timeout during draining [\#787](https://github.com/akka/alpakka-kafka/issues/787) by  [Szymon Matejczyk, @szymonm](https://github.com/szymonm)
- Error handling: Signal exceptions from subscribe to stream, part of [\#772](https://github.com/akka/alpakka-kafka/issues/772)
- Testkit: Pull Embedded Kafka from new organisation id, part of [\#772](https://github.com/akka/alpakka-kafka/issues/772)
- Testkit: Improve Java API and make timeouts configurable via config [\#786](https://github.com/akka/alpakka-kafka/issues/786)
- Testkit: Specify the Docker image version for Testcontainers Kafka [\#783](https://github.com/akka/alpakka-kafka/issues/783) as suggested by [@miguelpuyol](https://github.com/miguelpuyol)
...
| Author | Commits | Lines added | Lines removed |
| --- | --- | --- | --- |
| [2m **2m**](https://github.com/2m) | 17 | 957 | 517 |
| [szymonm **szymonm**](https://github.com/szymonm) | 2 | 29 | 17 |
| [ennru **ennru**](https://github.com/ennru) | 2 | 15 | 6 |
...
- Improvements for transactional support
	- Transactions: Add offsets to be committed directly after `producer.send` [\#752](https://github.com/akka/alpakka-kafka/issues/752)
	- Fix transaction offsets for transactional producer [\#742](https://github.com/akka/alpakka-kafka/issues/742) by [Szymon Matejczyk, @szymonm](https://github.com/szymonm)
- Do not fail commits during a rebalance (avoiding `CommitFailedException`) [\#755](https://github.com/akka/alpakka-kafka/issues/755)
- [Testcontainers](https://java.testcontainers.org/) support in the [Alpakka Kafka testkit](../testing-testcontainers.html#testing-with-a-docker-kafka-cluster) [\#775](https://github.com/akka/alpakka-kafka/issues/775)
...
| Author | Commits | Lines added | Lines removed |
| --- | --- | --- | --- |
| [ennru **ennru**](https://github.com/ennru) | 23 | 2165 | 1453 |
| [2m **2m**](https://github.com/2m) | 4 | 147 | 59 |
| [szymonm **szymonm**](https://github.com/szymonm) | 3 | 669 | 192 |
| [fancywriter **fancywriter**](https://github.com/fancywriter) | 1 | 5 | 3 |
...
The upgrade to the Apache Kafka client 2\.1\.1 is the only change compared to release [1\.0](1.0.x.html#1-0).
...
| Author | Commits | Lines added | Lines removed |
| --- | --- | --- | --- |
| [Philippus **Philippus**](https://github.com/Philippus) | 1 | 1 | 1 |
...
- [Alpakka Kafka testkit](../testing.html)
...
- https://doc.akka.io/libraries/alpakka-kafka/current/release-notes/1.1.x.html
...
---
*Source: [https://doc.akka.io/libraries/alpakka-kafka/current/release-notes/1.0.x.html](https://doc.akka.io/libraries/alpakka-kafka/current/release-notes/1.0.x.html)*