...
scraped_at: '2026-04-06T14:45:30Z'
section: libraries
site: akka-io
...
```
[source](https://github.com/akka/akka-grpc/tree/v2.4.4/plugin-tester-scala/src/main/scala/example/myapp/helloworld/MtlsGreeterServer.scala#L6-L79 "Go to snippet source")package example.myapp.helloworld
...
```
[source](https://github.com/akka/akka-grpc/tree/v2.4.4/plugin-tester-java/src/main/java/example/myapp/helloworld/MtlsGreeterServer.java#L6-L90 "Go to snippet source")package example.myapp.helloworld;
...
It is possible to rotate the certificates without restarting the service, see the [Akka HTTP documentation](https://doc.akka.io/libraries/akka-http/10.6/server-side/server-https-support.html#rotating-certificates). 
...
```
[source](https://github.com/akka/akka-grpc/tree/v2.4.4/plugin-tester-scala/src/main/scala/example/myapp/helloworld/MtlsGreeterClient.scala#L6-L69 "Go to snippet source")package example.myapp.helloworld
...
```
[source](https://github.com/akka/akka-grpc/tree/v2.4.4/plugin-tester-java/src/main/java/example/myapp/helloworld/MtlsGreeterClient.java#L6-L76 "Go to snippet source")package example.myapp.helloworld;
...
For more details about the Akka HTTP certificate utilities see [Akka HTTP documentation](https://doc.akka.io/libraries/akka-http/10.6/client-side/client-https-support.html#convenient-loading-of-key-and-certificate).
...
```
[source](https://github.com/akka/akka-grpc/tree/v2.4.4/plugin-tester-scala/src/main/scala/example/myapp/helloworld/GreeterServerWithClientCertIdentity.scala#L36-L48 "Go to snippet source")// Create service handlers
...
```
[source](https://github.com/akka/akka-grpc/tree/v2.4.4/plugin-tester-java/src/main/java/example/myapp/helloworld/GreeterServerWithClientCertIdentity.java#L46-L64 "Go to snippet source")// Instantiate implementation
GreeterService impl = new GreeterServiceImpl(mat);
...
- https://doc.akka.io/libraries/akka-grpc/2.4/deploy.html
- https://doc.akka.io/libraries/akka-grpc/2.4/troubleshooting.html
- https://doc.akka.io/libraries/akka-http/10.6/client-side/client-https-support.html
- https://doc.akka.io/libraries/akka-http/10.6/server-side/server-https-support.html

---
*Source: [https://doc.akka.io/libraries/akka-grpc/2.4/mtls.html](https://doc.akka.io/libraries/akka-grpc/2.4/mtls.html)*