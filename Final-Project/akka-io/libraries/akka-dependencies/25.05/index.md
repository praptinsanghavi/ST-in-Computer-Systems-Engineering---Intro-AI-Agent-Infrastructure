...
scraped_at: '2026-04-06T13:45:04Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-dependencies/25.05/index.html
...
# Akka library versions 25\.05

This table lists all Akka libraries that are part of the Akka 25\.05 release along with their current versions.

Akka 25\.05\.11 is cross\-built for Scala 2\.13 and Scala 3\.3\. Akka is certified for use with certain Java versions, see [Java Versions](java-versions.html).
...
| --- | --- | --- |
| Akka Dependencies BOM | 25\.05\.11 |  |
| Akka (core) | 2\.10\.10 | [Documentation](https://doc.akka.io/libraries/akka-core/current/) [JavaDoc](https://doc.akka.io/japi/akka/current/index.html) [ScalaDoc](https://doc.akka.io/api/akka/current/akka/) |
| Akka Actors | 2\.10\.10 | [Documentation](https://doc.akka.io/libraries/akka-core/current/typed/index.html) [JavaDoc](https://doc.akka.io/japi/akka/current/akka/actor/typed/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka/current/akka/actor/typed/index.html) |
| Akka Cluster | 2\.10\.10 | [Documentation](https://doc.akka.io/libraries/akka-core/current/typed/index-cluster.html) [JavaDoc](https://doc.akka.io/japi/akka/current/akka/cluster/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka/current/akka/cluster/index.html) |
| Akka Event Sourcing | 2\.10\.10 | [Documentation](https://doc.akka.io/libraries/akka-core/current/typed/index-persistence.html) [JavaDoc](https://doc.akka.io/japi/akka/current/akka/persistence/typed/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka/current/akka/persistence/typed/index.html) |
| Akka Durable State | 2\.10\.10 | [Documentation](https://doc.akka.io/libraries/akka-core/current/typed/index-persistence-durable-state.html) [JavaDoc](https://doc.akka.io/japi/akka/current/akka/persistence/typed/state/javadsl/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka/current/akka/persistence/typed/state/scaladsl/index.html) |
| Akka Streams | 2\.10\.10 | [Documentation](https://doc.akka.io/libraries/akka-core/current/stream/index.html) [Operators](https://doc.akka.io/libraries/akka-core/current/stream/operators/index.html) [JavaDoc](https://doc.akka.io/japi/akka/current/akka/stream/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka/current/akka/stream/index.html) |
| Akka gRPC | 2\.5\.7 | [Documentation](https://doc.akka.io/libraries/akka-grpc/current/) [ScalaDoc](https://doc.akka.io/api/akka-grpc/current/akka/grpc/) |
| Akka HTTP | 10\.7\.2 | [Documentation](https://doc.akka.io/libraries/akka-http/current/) [Predefined Directives](https://doc.akka.io/libraries/akka-http/current/routing-dsl/directives/alphabetically.html) [JavaDoc](https://doc.akka.io/japi/akka-http/current/) [ScalaDoc](https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/index.html) |
| Akka Persistence plugin for Cassandra | 1\.3\.2 | [Documentation](https://doc.akka.io/libraries/akka-persistence-cassandra/current/) |
| Akka Persistence plugin for JDBC | 5\.5\.3 | [Documentation](https://doc.akka.io/libraries/akka-persistence-jdbc/current/) |
| Akka Persistence plugin for R2DBC | 1\.3\.7 | [Documentation](https://doc.akka.io/libraries/akka-persistence-r2dbc/current/) |
| Akka Persistence plugin for DynamoDB | 2\.0\.8 | [Documentation](https://doc.akka.io/libraries/akka-persistence-dynamodb/current/) |
| Akka Projections | 1\.6\.15 | [Documentation](https://doc.akka.io/libraries/akka-projection/current/) |
| Akka Management | 1\.6\.3 | [Documentation](https://doc.akka.io/libraries/akka-management/current/) |
| Akka Diagnostics | 2\.2\.1 | [Documentation](https://doc.akka.io/libraries/akka-diagnostics/current/) |
| Alpakka | 9\.0\.2 | [Documentation](https://doc.akka.io/docs/alpakka/current/) |
| Alpakka Kafka | 7\.0\.4 | [Documentation](https://doc.akka.io/docs/alpakka-kafka/current/) |
...
```
<properties>
  <akka.version>2.10.10</akka.version>
...
## Akka Persistence plugin for Cassandra 1\.3\.2
...
sbt
```
libraryDependencies += "com.typesafe.akka" %% "akka-persistence-cassandra" % "1.3.2"
```
Gradle
```
def versions = [
...
dependencies {
  implementation "com.typesafe.akka:akka-persistence-cassandra_${versions.ScalaBinary}:1.3.2"
}
```

## Akka Persistence plugin for DynamoDB 2\.0\.8
...
sbt
```
libraryDependencies += "com.lightbend.akka" %% "akka-persistence-dynamodb" % "2.0.8"
```
Gradle
```
def versions = [
...
dependencies {
  implementation "com.lightbend.akka:akka-persistence-dynamodb_${versions.ScalaBinary}:2.0.8"
}
```

## Akka Persistence plugin for JDBC 5\.5\.3
...
sbt
```
libraryDependencies += "com.lightbend.akka" %% "akka-persistence-jdbc" % "5.5.3"
```
Gradle
```
def versions = [
...
dependencies {
  implementation "com.lightbend.akka:akka-persistence-jdbc_${versions.ScalaBinary}:5.5.3"
}
```

## Akka Persistence plugin for R2DBC 1\.3\.7
...
sbt
```
libraryDependencies += "com.lightbend.akka" %% "akka-persistence-r2dbc" % "1.3.7"
```
Gradle
```
def versions = [
...
dependencies {
  implementation "com.lightbend.akka:akka-persistence-r2dbc_${versions.ScalaBinary}:1.3.7"
}
```

## Akka Projections 1\.6\.15
...
sbt
```
libraryDependencies += "com.lightbend.akka" %% "akka-projection-core" % "1.6.15"
```
Gradle
```
def versions = [
...
dependencies {
  implementation "com.lightbend.akka:akka-projection-core_${versions.ScalaBinary}:1.6.15"
}
```

## Akka Management 1\.6\.3
...
```
<properties>
  <akka.management.version>1.6.3</akka.management.version>
  <scala.binary.version>2.13</scala.binary.version>
</properties>
<dependencies&gt
  <dependency>
...
sbt
```
libraryDependencies += "com.lightbend.akka" %% "akka-diagnostics" % "2.2.1"
```
Gradle
```
def versions = [
...
dependencies {
  implementation "com.lightbend.akka:akka-diagnostics_${versions.ScalaBinary}:2.2.1"
}
```
...
sbt
```
libraryDependencies += "com.typesafe.akka" %% "akka-stream-kafka" % "7.0.4"
```
Gradle
```
def versions = [
...
dependencies {
  implementation "com.typesafe.akka:akka-stream-kafka_${versions.ScalaBinary}:7.0.4"
}
```
...
### Example 13: Akka Persistence plugin for Cassandra 1.3.2
...
### Example 14: Akka Persistence plugin for Cassandra 1.3.2

```scala
libraryDependencies += "com.typesafe.akka" %% "akka-persistence-cassandra" % "1.3.2"
```

### Example 15: Akka Persistence plugin for Cassandra 1.3.2
...
### Example 16: Akka Persistence plugin for DynamoDB 2.0.8
...
### Example 17: Akka Persistence plugin for DynamoDB 2.0.8

```scala
libraryDependencies += "com.lightbend.akka" %% "akka-persistence-dynamodb" % "2.0.8"
```

### Example 18: Akka Persistence plugin for DynamoDB 2.0.8
...
### Example 19: Akka Persistence plugin for JDBC 5.5.3
...
### Example 20: Akka Persistence plugin for JDBC 5.5.3

```scala
libraryDependencies += "com.lightbend.akka" %% "akka-persistence-jdbc" % "5.5.3"
```

### Example 21: Akka Persistence plugin for JDBC 5.5.3
...
### Example 22: Akka Persistence plugin for R2DBC 1.3.7
...
### Example 23: Akka Persistence plugin for R2DBC 1.3.7

```scala
libraryDependencies += "com.lightbend.akka" %% "akka-persistence-r2dbc" % "1.3.7"
```

### Example 24: Akka Persistence plugin for R2DBC 1.3.7
...
### Example 25: Akka Projections 1.6.15
...
### Example 26: Akka Projections 1.6.15

```scala
libraryDependencies += "com.lightbend.akka" %% "akka-projection-core" % "1.6.15"
```

### Example 27: Akka Projections 1.6.15
...
### Example 31: Akka Diagnostics 2.2.1
...
### Example 32: Akka Diagnostics 2.2.1

```scala
libraryDependencies += "com.lightbend.akka" %% "akka-diagnostics" % "2.2.1"
```

### Example 33: Akka Diagnostics 2.2.1
...
### Example 34: Alpakka Kafka 7.0.4
...
### Example 35: Alpakka Kafka 7.0.4

```scala
libraryDependencies += "com.typesafe.akka" %% "akka-stream-kafka" % "7.0.4"
```

### Example 36: Alpakka Kafka 7.0.4
...
- https://doc.akka.io/libraries/akka-dependencies/25.05/java-versions.html
- https://doc.akka.io/libraries/akka-dependencies/25.05/support-terminology.html
...
---
*Source: [https://doc.akka.io/libraries/akka-dependencies/25.05/index.html](https://doc.akka.io/libraries/akka-dependencies/25.05/index.html)*