---
description: Akka Dependencies
knowledge_type: official_documentation
scraped_at: '2026-04-06T13:48:08Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-dependencies/24.05/index.html
title: Akka module versions
---

# Akka module versions

> **Summary:** Akka Dependencies

## Content

# Akka module versions 24\.05

This table lists all Akka modules that are part of the Akka 24\.05 release along with their current versions.

Akka 24\.05\.7 is cross\-built for Scala 2\.13 and Scala 3\.3\. Akka is certified for use with certain Java versions, see [Java Versions](java-versions.html).

Some modules in Akka do not live up to the high standards Lightbend requires to fully support them for Akka Licensees. Modules are marked with their [readiness level](support-terminology.html) in the “project info” section of their documentation.
...
| --- | --- | --- |
| Akka Dependencies BOM | 24\.05\.7 |  |
| Akka (core) | 2\.9\.7 | [Documentation](https://doc.akka.io/libraries/akka-core/current/) [JavaDoc](https://doc.akka.io/japi/akka-core/current/index.html) [ScalaDoc](https://doc.akka.io/api/akka-core/current/akka/) |
| Akka Actors | 2\.9\.7 | [Documentation](https://doc.akka.io/libraries/akka-core/current/typed/index.html) [JavaDoc](https://doc.akka.io/japi/akka-core/current/akka/actor/typed/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka-core/current/akka/actor/typed/index.html) |
| Akka Cluster | 2\.9\.7 | [Documentation](https://doc.akka.io/libraries/akka-core/current/typed/index-cluster.html) [JavaDoc](https://doc.akka.io/japi/akka-core/current/akka/cluster/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka-core/current/akka/cluster/index.html) |
| Akka Event Sourcing | 2\.9\.7 | [Documentation](https://doc.akka.io/libraries/akka-core/current/typed/index-persistence.html) [JavaDoc](https://doc.akka.io/japi/akka-core/current/akka/persistence/typed/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka-core/current/akka/persistence/typed/index.html) |
| Akka Durable State | 2\.9\.7 | [Documentation](https://doc.akka.io/libraries/akka-core/current/typed/index-persistence-durable-state.html) [JavaDoc](https://doc.akka.io/japi/akka-core/current/akka/persistence/typed/state/javadsl/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka-core/current/akka/persistence/typed/state/scaladsl/index.html) |
| Akka Streams | 2\.9\.7 | [Documentation](https://doc.akka.io/libraries/akka-core/current/stream/index.html) [Operators](https://doc.akka.io/libraries/akka-core/current/stream/operators/index.html) [JavaDoc](https://doc.akka.io/japi/akka-core/current/akka/stream/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka-core/current/akka/stream/index.html) |
| Akka gRPC | 2\.4\.4 | [Documentation](https://doc.akka.io/libraries/akka-grpc/current/) [ScalaDoc](https://doc.akka.io/api/akka-grpc/current/akka/grpc/) |
| Akka HTTP | 10\.6\.3 | [Documentation](https://doc.akka.io/libraries/akka-http/current/) [Predefined Directives](https://doc.akka.io/libraries/akka-http/current/routing-dsl/directives/alphabetically.html) [JavaDoc](https://doc.akka.io/japi/akka-http/current/) [ScalaDoc](https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/index.html) |
| Akka Persistence plugin for Cassandra | 1\.2\.1 | [Documentation](https://doc.akka.io/libraries/akka-persistence-cassandra/current/) |
| Akka Persistence plugin for JDBC | 5\.4\.2 | [Documentation](https://doc.akka.io/libraries/akka-persistence-jdbc/current/) |
| Akka Persistence plugin for R2DBC | 1\.2\.6 | [Documentation](https://doc.akka.io/libraries/akka-persistence-r2dbc/current/) |
| Akka Projections | 1\.5\.9 | [Documentation](https://doc.akka.io/libraries/akka-projection/current/) |
| Akka Management | 1\.5\.2 | [Documentation](https://doc.akka.io/libraries/akka-management/current/) |
| Akka Diagnostics | 2\.1\.1 | [Documentation](https://doc.akka.io/libraries/akka-diagnostics/current/) |
| Alpakka | 8\.0\.0 | [Documentation](https://doc.akka.io/docs/alpakka/current/) |
| Alpakka Kafka | 6\.0\.0 | [Documentation](https://doc.akka.io/docs/alpakka-kafka/current/) |
...
[Documentation](https://doc.akka.io/libraries/akka-core/current/) [JavaDoc](https://doc.akka.io/japi/akka-core/current/index.html) [ScalaDoc](https://doc.akka.io/api/akka-core/current/akka/) [Migration guides](https://doc.akka.io/libraries/akka-core/current/project/migration-guides.html)
...
```
<properties>
  <akka.version>2.9.7</akka.version>
...
[Documentation](https://doc.akka.io/libraries/akka-core/current/typed/index.html) [JavaDoc](https://doc.akka.io/japi/akka-core/current/akka/actor/typed/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka-core/current/akka/actor/typed/index.html)

### Akka Cluster

Akka Cluster provides a fault\-tolerant decentralized peer\-to\-peer based Cluster Membership Service with no single point of failure or single point of bottleneck. It does this using gossip protocols and an automatic failure detector.

[Documentation](https://doc.akka.io/libraries/akka-core/current/typed/index-cluster.html) [JavaDoc](https://doc.akka.io/japi/akka-core/current/akka/cluster/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka-core/current/akka/cluster/index.html)
...
[Documentation](https://doc.akka.io/libraries/akka-core/current/typed/index-persistence.html) [JavaDoc](https://doc.akka.io/japi/akka-core/current/akka/persistence/typed/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka-core/current/akka/persistence/typed/index.html)

### Akka Durable State

Enables stateful actors to persist their latest state, so that it can be recovered when an actor is restarted.

[Documentation](https://doc.akka.io/libraries/akka-core/current/typed/index-persistence-durable-state.html) [JavaDoc](https://doc.akka.io/japi/akka-core/current/akka/persistence/typed/state/javadsl/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka-core/current/akka/persistence/typed/state/scaladsl/index.html)
...
[JavaDoc](https://doc.akka.io/japi/akka-core/current/akka/stream/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka-core/current/akka/stream/index.html)
...
## Akka Persistence plugin for Cassandra 1\.2\.1
...
sbt
```
libraryDependencies += "com.typesafe.akka" %% "akka-persistence-cassandra" % "1.2.1"
```
Gradle
```
def versions = [
...
dependencies {
  implementation "com.typesafe.akka:akka-persistence-cassandra_${versions.ScalaBinary}:1.2.1"
}
```

## Akka Persistence plugin for JDBC 5\.4\.2
...
sbt
```
libraryDependencies += "com.lightbend.akka" %% "akka-persistence-jdbc" % "5.4.2"
```
Gradle
```
def versions = [
...
dependencies {
  implementation "com.lightbend.akka:akka-persistence-jdbc_${versions.ScalaBinary}:5.4.2"
}
```

## Akka Persistence plugin for R2DBC 1\.2\.6
...
sbt
```
libraryDependencies += "com.lightbend.akka" %% "akka-diagnostics" % "2.1.1"
```
Gradle
```
def versions = [
...
dependencies {
  implementation "com.lightbend.akka:akka-diagnostics_${versions.ScalaBinary}:2.1.1"
}
```
...
dependencies {
  implementation "com.typesafe.akka:akka-stream-kafka_${versions.ScalaBinary}:6.0.0"
}
```
...
### Example 4: Complete dependency listing of Akka core modules
...
### Example 5: Complete dependency listing of Akka core modules
...
### Example 6: Complete dependency listing of Akka core modules
...
### Example 10: Complete dependency listing of Akka HTTP modules
...
### Example 11: Complete dependency listing of Akka HTTP modules
...
### Example 12: Complete dependency listing of Akka HTTP modules
...
### Example 13: Akka Persistence plugin for Cassandra 1.2.1
...
### Example 14: Akka Persistence plugin for Cassandra 1.2.1

```scala
libraryDependencies += "com.typesafe.akka" %% "akka-persistence-cassandra" % "1.2.1"
```

### Example 15: Akka Persistence plugin for Cassandra 1.2.1
...
### Example 16: Akka Persistence plugin for JDBC 5.4.2
...
### Example 17: Akka Persistence plugin for JDBC 5.4.2

```scala
libraryDependencies += "com.lightbend.akka" %% "akka-persistence-jdbc" % "5.4.2"
```

### Example 18: Akka Persistence plugin for JDBC 5.4.2
...
### Example 19: Akka Persistence plugin for R2DBC 1.2.6
...
### Example 20: Akka Persistence plugin for R2DBC 1.2.6

```scala
libraryDependencies += "com.lightbend.akka" %% "akka-persistence-r2dbc" % "1.2.6"
```

### Example 21: Akka Persistence plugin for R2DBC 1.2.6
...
### Example 22: Akka Projections 1.5.9
...
### Example 23: Akka Projections 1.5.9

```scala
libraryDependencies += "com.lightbend.akka" %% "akka-projection-core" % "1.5.9"
```

### Example 24: Akka Projections 1.5.9
...
### Example 25: Complete dependency listing of Akka Management modules
...
### Example 26: Complete dependency listing of Akka Management modules
...
### Example 27: Complete dependency listing of Akka Management modules
...
### Example 28: Akka Diagnostics 2.1.1
...
### Example 29: Akka Diagnostics 2.1.1

```scala
libraryDependencies += "com.lightbend.akka" %% "akka-diagnostics" % "2.1.1"
```

### Example 30: Akka Diagnostics 2.1.1
...
### Example 31: Alpakka Kafka 6.0.0
...
### Example 32: Alpakka Kafka 6.0.0

```scala
libraryDependencies += "com.typesafe.akka" %% "akka-stream-kafka" % "6.0.0"
```

### Example 33: Alpakka Kafka 6.0.0
...
- https://doc.akka.io/api/akka-core/current/akka/
...
- https://doc.akka.io/japi/akka-core/current/index.html
...
- https://doc.akka.io/libraries/akka-dependencies/24.05/java-versions.html
- https://doc.akka.io/libraries/akka-dependencies/24.05/support-terminology.html
...
---
*Source: [https://doc.akka.io/libraries/akka-dependencies/24.05/index.html](https://doc.akka.io/libraries/akka-dependencies/24.05/index.html)*