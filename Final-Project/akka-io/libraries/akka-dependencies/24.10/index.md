...
scraped_at: '2026-04-06T13:45:14Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-dependencies/24.10/index.html
...
Akka 24\.10\.11 is cross\-built for Scala 2\.13 and Scala 3\.3\. Akka is certified for use with certain Java versions, see [Java Versions](java-versions.html).

Some modules in Akka do not live up to the high standards we require to fully support them for Akka Licensees. Modules are marked with their [readiness level](support-terminology.html) in the “project info” section of their documentation.
...
| --- | --- | --- |
| Akka Dependencies BOM | 24\.10\.11 |  |
| Akka (core) | 2\.10\.4 | [Documentation](https://doc.akka.io/libraries/akka-core/current/) [JavaDoc](https://doc.akka.io/japi/akka/current/index.html) [ScalaDoc](https://doc.akka.io/api/akka/current/akka/) |
| Akka Actors | 2\.10\.4 | [Documentation](https://doc.akka.io/libraries/akka-core/current/typed/index.html) [JavaDoc](https://doc.akka.io/japi/akka/current/akka/actor/typed/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka/current/akka/actor/typed/index.html) |
| Akka Cluster | 2\.10\.4 | [Documentation](https://doc.akka.io/libraries/akka-core/current/typed/index-cluster.html) [JavaDoc](https://doc.akka.io/japi/akka/current/akka/cluster/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka/current/akka/cluster/index.html) |
| Akka Event Sourcing | 2\.10\.4 | [Documentation](https://doc.akka.io/libraries/akka-core/current/typed/index-persistence.html) [JavaDoc](https://doc.akka.io/japi/akka/current/akka/persistence/typed/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka/current/akka/persistence/typed/index.html) |
| Akka Durable State | 2\.10\.4 | [Documentation](https://doc.akka.io/libraries/akka-core/current/typed/index-persistence-durable-state.html) [JavaDoc](https://doc.akka.io/japi/akka/current/akka/persistence/typed/state/javadsl/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka/current/akka/persistence/typed/state/scaladsl/index.html) |
| Akka Streams | 2\.10\.4 | [Documentation](https://doc.akka.io/libraries/akka-core/current/stream/index.html) [Operators](https://doc.akka.io/libraries/akka-core/current/stream/operators/index.html) [JavaDoc](https://doc.akka.io/japi/akka/current/akka/stream/package-summary.html) [ScalaDoc](https://doc.akka.io/api/akka/current/akka/stream/index.html) |
| Akka gRPC | 2\.5\.4 | [Documentation](https://doc.akka.io/libraries/akka-grpc/current/) [ScalaDoc](https://doc.akka.io/api/akka-grpc/current/akka/grpc/) |
| Akka HTTP | 10\.7\.0 | [Documentation](https://doc.akka.io/libraries/akka-http/current/) [Predefined Directives](https://doc.akka.io/libraries/akka-http/current/routing-dsl/directives/alphabetically.html) [JavaDoc](https://doc.akka.io/japi/akka-http/current/) [ScalaDoc](https://doc.akka.io/api/akka-http/current/akka/http/scaladsl/index.html) |
| Akka Persistence plugin for Cassandra | 1\.3\.0 | [Documentation](https://doc.akka.io/libraries/akka-persistence-cassandra/current/) |
| Akka Persistence plugin for JDBC | 5\.5\.1 | [Documentation](https://doc.akka.io/libraries/akka-persistence-jdbc/current/) |
| Akka Persistence plugin for R2DBC | 1\.3\.4 | [Documentation](https://doc.akka.io/libraries/akka-persistence-r2dbc/current/) |
| Akka Persistence plugin for DynamoDB | 2\.0\.5 | [Documentation](https://doc.akka.io/libraries/akka-persistence-dynamodb/current/) |
| Akka Projections | 1\.6\.12 | [Documentation](https://doc.akka.io/libraries/akka-projection/current/) |
| Akka Management | 1\.6\.0 | [Documentation](https://doc.akka.io/libraries/akka-management/current/) |
| Akka Diagnostics | 2\.2\.0 | [Documentation](https://doc.akka.io/libraries/akka-diagnostics/current/) |
| Alpakka | 9\.0\.1 | [Documentation](https://doc.akka.io/docs/alpakka/current/) |
| Alpakka Kafka | 7\.0\.1 | [Documentation](https://doc.akka.io/docs/alpakka-kafka/current/) |
...
```
<properties>
  <akka.version>2.10.4</akka.version>
...
plugins {
  id 'java'
  id 'application'
  id 'com.lightbend.akka.grpc.gradle' version '2.5.4'
}
repositories {
  mavenCentral()
  maven {
...
## Akka Persistence plugin for JDBC 5\.5\.1
...
sbt
```
libraryDependencies += "com.lightbend.akka" %% "akka-persistence-jdbc" % "5.5.1"
```
Gradle
```
def versions = [
...
dependencies {
  implementation "com.lightbend.akka:akka-persistence-jdbc_${versions.ScalaBinary}:5.5.1"
}
```

## Akka Persistence plugin for R2DBC 1\.3\.4
...
sbt
```
libraryDependencies += "com.lightbend.akka" %% "akka-persistence-r2dbc" % "1.3.4"
```
Gradle
```
def versions = [
...
dependencies {
  implementation "com.lightbend.akka:akka-persistence-r2dbc_${versions.ScalaBinary}:1.3.4"
}
```

## Akka Projections 1\.6\.12
...
sbt
```
libraryDependencies += "com.lightbend.akka" %% "akka-projection-core" % "1.6.12"
```
Gradle
```
def versions = [
...
dependencies {
  implementation "com.lightbend.akka:akka-projection-core_${versions.ScalaBinary}:1.6.12"
}
```
...
sbt
```
libraryDependencies += "com.typesafe.akka" %% "akka-stream-kafka" % "7.0.1"
```
Gradle
```
def versions = [
...
dependencies {
  implementation "com.typesafe.akka:akka-stream-kafka_${versions.ScalaBinary}:7.0.1"
}
```
...
### Example 13: Akka Persistence plugin for Cassandra 1.3.0
...
### Example 14: Akka Persistence plugin for Cassandra 1.3.0

```scala
libraryDependencies += "com.typesafe.akka" %% "akka-persistence-cassandra" % "1.3.0"
```

### Example 15: Akka Persistence plugin for Cassandra 1.3.0
...
### Example 16: Akka Persistence plugin for DynamoDB 2.0.5
...
### Example 17: Akka Persistence plugin for DynamoDB 2.0.5

```scala
libraryDependencies += "com.lightbend.akka" %% "akka-persistence-dynamodb" % "2.0.5"
```

### Example 18: Akka Persistence plugin for DynamoDB 2.0.5
...
### Example 19: Akka Persistence plugin for JDBC 5.5.1
...
### Example 20: Akka Persistence plugin for JDBC 5.5.1

```scala
libraryDependencies += "com.lightbend.akka" %% "akka-persistence-jdbc" % "5.5.1"
```

### Example 21: Akka Persistence plugin for JDBC 5.5.1
...
### Example 22: Akka Persistence plugin for R2DBC 1.3.4
...
### Example 23: Akka Persistence plugin for R2DBC 1.3.4

```scala
libraryDependencies += "com.lightbend.akka" %% "akka-persistence-r2dbc" % "1.3.4"
```

### Example 24: Akka Persistence plugin for R2DBC 1.3.4
...
### Example 25: Akka Projections 1.6.12
...
### Example 26: Akka Projections 1.6.12

```scala
libraryDependencies += "com.lightbend.akka" %% "akka-projection-core" % "1.6.12"
```

### Example 27: Akka Projections 1.6.12
...
### Example 28: Complete dependency listing of Akka Management modules
...
### Example 29: Complete dependency listing of Akka Management modules
...
### Example 30: Complete dependency listing of Akka Management modules
...
### Example 31: Akka Diagnostics 2.2.0
...
### Example 32: Akka Diagnostics 2.2.0

```scala
libraryDependencies += "com.lightbend.akka" %% "akka-diagnostics" % "2.2.0"
```

### Example 33: Akka Diagnostics 2.2.0
...
### Example 34: Alpakka Kafka 7.0.1
...
### Example 35: Alpakka Kafka 7.0.1

```scala
libraryDependencies += "com.typesafe.akka" %% "akka-stream-kafka" % "7.0.1"
```

### Example 36: Alpakka Kafka 7.0.1
...
- https://doc.akka.io/libraries/akka-dependencies/24.10/java-versions.html
- https://doc.akka.io/libraries/akka-dependencies/24.10/support-terminology.html
...
- https://doc.akka.io/libraries/akka-insights/2.18/home.
...
---
*Source: [https://doc.akka.io/libraries/akka-dependencies/24.10/index.html](https://doc.akka.io/libraries/akka-dependencies/24.10/index.html)*