...
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-http/current/../quickstart-java/index.html
title: Akka HTTP Quickstart for Java
---
...
You can run the Akka HTTP example project on Linux, MacOS, or Windows. The only prerequisite is Java 17 or later, and an installation of [maven](https://maven.apache.org/index.html).
...
- https://doc.akka.io/libraries/akka-http/current/attachments/akka-http-quickstart-java.zip
- https://doc.akka.io/libraries/akka-http/current/quickstart-java/backend-actor.html

---
*Source: [https://doc.akka.io/libraries/akka-http/current/quickstart-java/index.html](https://doc.akka.io/libraries/akka-http/current/quickstart-java/index.html)*