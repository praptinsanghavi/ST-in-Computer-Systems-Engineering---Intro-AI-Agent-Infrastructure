...
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-persistence-cassandra/current/configuration.html
title: Configuration • Akka Persistence Cassandra
---

# Configuration • Akka Persistence Cassandra
...
```
[source](https://github.com/akka/akka-persistence-cassandra/tree/v1.3.4/core/src/main/resources/reference.conf "Go to snippet source")  
...
akka.persistence.cassandra {
  ...
  events-by-tag {
    ...
    # When a tag write fails, it is retried with exponential backoff. These settings control
    # the minimum and maximum delay between retries.
    tag-write-retry-min-backoff = 20ms
    tag-write-retry-max-backoff = 5s
...
```
[source](https://github.com/akka/akka-persistence-cassandra/tree/v1.3.4/core/src/main/resources/reference.conf#L583-L614 "Go to snippet source")# See reference configuration at
# https://docs.datastax.com/en/developer/java-driver/latest/manual/core/configuration/reference/
# (check which exact version Akka Persistence Cassandra uses)
datastax-java-driver {
...
The Cassandra server contact points can be defined with the [Cassandra driver configuration](https://docs.datastax.com/en/developer/java-driver/4.14/manual/core/configuration/)
...
Alternatively, Akka Discovery can be used for finding the Cassandra server contact points as described in the [Alpakka Cassandra documentation](https://doc.akka.io/docs/alpakka/10.0/cassandra.html#using-akka-discovery).
...
### Example 2: Cassandra driver overrides
...
### Example 3: Contact points configuration
...
- https://doc.akka.io/libraries/akka-persistence-cassandra/current/healthcheck.html
- https://doc.akka.io/libraries/akka-persistence-cassandra/current/server.html

---
*Source: [https://doc.akka.io/libraries/akka-persistence-cassandra/current/configuration.html](https://doc.akka.io/libraries/akka-persistence-cassandra/current/configuration.html)*