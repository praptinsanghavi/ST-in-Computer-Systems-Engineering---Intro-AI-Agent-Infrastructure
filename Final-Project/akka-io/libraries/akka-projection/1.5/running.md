...
scraped_at: '2026-04-06T14:31:04Z'
section: libraries
site: akka-io
...
sbt
```
libraryDependencies += "com.typesafe.akka" %% "akka-cluster-sharding-typed" % "2.9.6"
```
Maven
```
<properties>
...
dependencies {
  implementation "com.typesafe.akka:akka-cluster-sharding-typed_${versions.ScalaBinary}:2.9.6"
}
```
...
```
[source](https://github.com/akka/akka-projection/tree/master/examples/src/test/java/jdocs/eventsourced/ShoppingCart.java#L309-L311 "Go to snippet source")public static final List<String> tags =
...
```
[source](https://github.com/akka/akka-projection/tree/master/examples/src/test/scala/docs/cassandra/CassandraProjectionDocExample.scala#L20-L23 "Go to snippet source")import akka.persistence.cassandra.query.scaladsl.CassandraReadJournal
...
```
[source](https://github.com/akka/akka-projection/tree/master/examples/src/test/scala/docs/cassandra/CassandraProjectionDocExample.scala#L14-L16 "Go to snippet source")import akka.cluster.sharding.typed.scaladsl.ShardedDaemonProcess
...
```
[source](https://github.com/akka/akka-projection/tree/master/examples/src/test/scala/docs/cassandra/CassandraProjectionDocExample.scala#L206-L222 "Go to snippet source")def sourceProvider(tag: String) =
  EventSourcedProvider
    .eventsByTag[ShoppingCart.Event](
      system = system,
      readJournalPluginId = CassandraReadJournal.Identifier,
...
```
[source](https://github.com/akka/akka-projection/tree/master/examples/src/test/scala/docs/cassandra/CassandraProjectionDocExample.scala#L232-L253 "Go to snippet source")import akka.cluster.typed.ClusterSingleton
...
---
*Source: [https://doc.akka.io/libraries/akka-projection/1.5/running.html](https://doc.akka.io/libraries/akka-projection/1.5/running.html)*