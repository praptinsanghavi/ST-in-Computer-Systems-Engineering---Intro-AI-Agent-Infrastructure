...
Setting up the consumer starts with creating an [`EventProducerPushDestination`](/api/akka-projection/1.5.9/akka/projection/grpc/consumer/javadsl/EventProducerPushDestination.html "akka.projection.grpc.consumer.javadsl.EventProducerPushDestination")[`EventProducerPushDestination`](/api/akka-projection/1.5.9/akka/projection/grpc/consumer/scaladsl/EventProducerPushDestination.html "akka.projection.grpc.consumer.scaladsl.EventProducerPushDestination") defining what stream id it will accept. The stream id is a public identifier of entity types between producers and consumers, a producer pushing events for unknown stream ids will be denied.

The destination is then used as a parameter to [`EventProducerPushDestination`](/api/akka-projection/1.5.9/akka/projection/grpc/consumer/javadsl/EventProducerPushDestination.html#grpcServiceHandler "akka.projection.grpc.consumer.javadsl.EventProducerPushDestination")[`EventProducerPushDestination`](/api/akka-projection/1.5.9/akka/projection/grpc/consumer/scaladsl/EventProducerPushDestination.html#grpcServiceHandler "akka.projection.grpc.consumer.scaladsl.EventProducerPushDestination") to get a gRPC service handler that can be bound as an Akka HTTP/gRPC endpoint:
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-grpc-tests/src/test/java/akka/projection/grpc/consumer/javadsl/EventProducerPushDestinationCompileTest.java#L72-L77 "Go to snippet source")EventProducerPushDestination destination = EventProducerPushDestination.create("stream-id", protoDescriptors, system);
...
Filters are set for the destination using [`withConsumerFilters`](/api/akka-projection/1.5.9/akka/projection/grpc/consumer/javadsl/EventProducerPushDestination.html#withConsumerFilters(java.util.List) "akka.projection.grpc.consumer.javadsl.EventProducerPushDestination")[`withConsumerFilters`](/api/akka-projection/1.5.9/akka/projection/grpc/consumer/scaladsl/EventProducerPushDestination.html#withConsumerFilters(filters:immutable.Seq) "akka.projection.grpc.consumer.scaladsl.EventProducerPushDestination")
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-grpc-tests/src/test/java/akka/projection/grpc/consumer/javadsl/EventProducerPushDestinationCompileTest.java#L83-L87 "Go to snippet source")EventProducerPushDestination destination =
...
The events and some of their metadata can be transformed before being stored in the consumer, [`withTransformation`](/api/akka-projection/1.5.9/akka/projection/grpc/consumer/javadsl/EventProducerPushDestination.html#withTransformation(Transformation) "akka.projection.grpc.consumer.javadsl.EventProducerPushDestination")[`withTransformation`](/api/akka-projection/1.5.9/akka/projection/grpc/consumer/scaladsl/EventProducerPushDestination.html#withTransformation(transformation:Transformation) "akka.projection.grpc.consumer.scaladsl.EventProducerPushDestination") defines a single transformation to use for all producers, while [`EventProducerPushDestination`](/api/akka-projection/1.5.9/akka/projection/grpc/consumer/javadsl/EventProducerPushDestination.html#withTransformationForOrigin "akka.projection.grpc.consumer.javadsl.EventProducerPushDestination")[`EventProducerPushDestination`](/api/akka-projection/1.5.9/akka/projection/grpc/consumer/scaladsl/EventProducerPushDestination.html#withTransformationForOrigin "akka.projection.grpc.consumer.scaladsl.EventProducerPushDestination") is invoked with an origin id for the producer and additional metadata specified when setting up the producer and can provide transformations based on those.
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-grpc-tests/src/test/java/akka/projection/grpc/consumer/javadsl/EventProducerPushDestinationCompileTest.java#L93-L104 "Go to snippet source")EventProducerPushDestination destination =
  EventProducerPushDestination.create("stream-id", protoDescriptors, system)
...
Connections from producers can be intercepted by adding an interceptor via [`withInterceptor`](/api/akka-projection/1.5.9/akka/projection/grpc/consumer/javadsl/EventProducerPushDestination.html#withInterceptor "akka.projection.grpc.consumer.javadsl.EventProducerPushDestination")[`withInterceptor`](/api/akka-projection/1.5.9/akka/projection/grpc/consumer/scaladsl/EventProducerPushDestination.html#withInterceptor "akka.projection.grpc.consumer.scaladsl.EventProducerPushDestination"). This can be used together with the additional producer metadata to add authentication, as an alternative to or in addition to mTLS.

## Producer set up

The producer is essentially a special projection handler for a projection running on the producer. It could be a single actor system running one projection handling all slices, or it could be [Sharded Daemon Process](https://doc.akka.io/libraries/akka-core/2.9/typed/cluster-sharded-daemon-process.md) pushing events for partitioned slices of the entities.

The producer is created through [`EventProducerPush`](/api/akka-projection/1.5.9/akka/projection/grpc/producer/javadsl/EventProducerPush.html "akka.projection.grpc.producer.javadsl.EventProducerPush")[`EventProducerPush`](/api/akka-projection/1.5.9/akka/projection/grpc/producer/scaladsl/EventProducerPush.html "akka.projection.grpc.producer.scaladsl.EventProducerPush"), which has a method `handler()` which returns a handler to be plugged into an `atLeastOnceFlow` projection. The first parameter, the `originId` is how the producer identifies itself to the consumer.
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-grpc-tests/src/test/java/akka/projection/grpc/producer/javadsl/EventProducerPushCompileTest.java#L34-L51 "Go to snippet source")EventProducerPush<String> eventProducer = EventProducerPush.create(
    "producer-id",
...
The producer can also define filters, an event filtered by the producer is never passed over to the consumer, regardless of configured consumer filters. The filters are defined using `withProducerFilter` or `withTopicProducerFilter` on [`EventProducerSource`](/api/akka-projection/1.5.9/akka/projection/grpc/producer/javadsl/EventProducerSource.html "akka.projection.grpc.producer.javadsl.EventProducerSource")[`EventProducer.EventProducerSource`](/api/akka-projection/1.5.9/akka/projection/grpc/producer/scaladsl/EventProducer$$EventProducerSource.html "akka.projection.grpc.producer.scaladsl.EventProducer.EventProducerSource"). 

### Additional connection metadata

It is possible to define additional connection metadata that is passed to the consumer on connection when constructing the [`EventProducerPush`](/api/akka-projection/1.5.9/akka/projection/grpc/producer/javadsl/EventProducerPush.html "akka.projection.grpc.producer.javadsl.EventProducerPush")[`EventProducerPush`](/api/akka-projection/1.5.9/akka/projection/grpc/producer/scaladsl/EventProducerPush.html "akka.projection.grpc.producer.scaladsl.EventProducerPush"). This can be used for authenticating a producer in the consumer interceptor, or providing additional details to use when transforming events in the consumer.
...
- https://doc.akka.io/libraries/akka-projection/1.5/grpc-replicated-event-sourcing-transport.html
- https://doc.akka.io/libraries/akka-projection/1.5/grpc.html

---
*Source: [https://doc.akka.io/libraries/akka-projection/1.5/grpc-producer-push.html](https://doc.akka.io/libraries/akka-projection/1.5/grpc-producer-push.html)*