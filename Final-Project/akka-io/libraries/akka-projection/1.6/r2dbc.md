...
scraped_at: '2026-04-06T02:02:43Z'
section: libraries
site: akka-io
...
The [`R2dbcProjection`](/api/akka-projection/1.6.20/akka/projection/r2dbc/javadsl/R2dbcProjection$.html "akka.projection.r2dbc.javadsl.R2dbcProjection")[`R2dbcProjection`](/api/akka-projection/1.6.20/akka/projection/r2dbc/scaladsl/R2dbcProjection$.html "akka.projection.r2dbc.scaladsl.R2dbcProjection") has support for storing the offset in a relational database using R2DBC via [Akka Persistence R2DBC](https://doc.akka.io/libraries/akka-persistence-r2dbc/1.3/overview.html).

The source of the envelopes is from a `SourceProvider`, which can be:

- events from Event Sourced entities via the [SourceProvider for eventsBySlices](eventsourced.html#sourceprovider-for-eventsbyslices) with the [eventsBySlices query](https://doc.akka.io/libraries/akka-persistence-r2dbc/1.3/query.html#eventsbyslices)
- state changes for Durable State entities via the [SourceProvider for changesBySlices](durable-state.html#sourceprovider-for-changesbyslices) with the [changesBySlices query](https://doc.akka.io/libraries/akka-persistence-r2dbc/1.3/query.html#changesbyslices)
- any other `SourceProvider` with supported [offset types](r2dbc.html#offset-types)

A [`R2dbcHandler`](/api/akka-projection/1.6.20/akka/projection/r2dbc/javadsl/R2dbcHandler.html "akka.projection.r2dbc.javadsl.R2dbcHandler")[`R2dbcHandler`](/api/akka-projection/1.6.20/akka/projection/r2dbc/scaladsl/R2dbcHandler.html "akka.projection.r2dbc.scaladsl.R2dbcHandler") receives a [`R2dbcSession`](/api/akka-projection/1.6.20/akka/projection/r2dbc/javadsl/R2dbcSession.html "akka.projection.r2dbc.javadsl.R2dbcSession")[`R2dbcSession`](/api/akka-projection/1.6.20/akka/projection/r2dbc/scaladsl/R2dbcSession.html "akka.projection.r2dbc.scaladsl.R2dbcSession") instance and an envelope. The `R2dbcSession` provides the means to access an open R2DBC connection that can be used to process the envelope. The target database operations can be run in the same transaction as the storage of the offset, which means that [exactly\-once](r2dbc.html#exactly-once) processing semantics is supported. It also offers [at\-least\-once](r2dbc.html#at-least-once) semantics.
...
Note that Akka R2DBC changed configuration structure in 1\.2\.0 needed for this version of Akka Projection, if upgrading from Akka Projection 1\.4\.x you will likely need to update your configuration according to [the migration guide](https://doc.akka.io/libraries/akka-persistence-r2dbc/1.3/migration-guide.html)

Akka Projections R2DBC depends on Akka 2\.10\.13 or later, and note that it is important that all `akka-*` dependencies are in the same version, so it is recommended to depend on them explicitly to avoid problems with transient dependencies causing an unlucky mix of versions.

| Project Info: Akka Projections R2DBC | |
| --- | --- |
| Artifact | com.lightbend.akka akka\-projection\-r2dbc 1\.6\.20 [Snapshots are available](snapshots.html) |
...
| Readiness level | [Supported](https://doc.akka.io/docs/akka-dependencies/current/support-terminology.html#supported), support is available from [Lightbend](https://www.lightbend.com/akka) Since 1\.4\.0, 2023\-03\-23 |
...
| --- | --- | --- |
| com.lightbend.akka | akka\-persistence\-r2dbc\_2\.13 | [1\.3\.12](https://mvnrepository.com/artifact/com.lightbend.akka/akka-persistence-r2dbc_2.13/1.3.12) |
...
| com.lightbend.akka | akka\-projection\-durable\-state\_2\.13 | [1\.6\.20](https://mvnrepository.com/artifact/com.lightbend.akka/akka-projection-durable-state_2.13/1.6.20) |
...
| com.lightbend.akka | akka\-projection\-grpc\_2\.13 | [1\.6\.20](https://mvnrepository.com/artifact/com.lightbend.akka/akka-projection-grpc_2.13/1.6.20) |
...
com.lightbend.akka    akka-persistence-r2dbc_2.13    [1.3.12](https://mvnrepository.com/artifact/com.lightbend.akka/akka-persistence-r2dbc_2.13/1.3.12)    BUSL-1.1
...
com.lightbend.akka    akka-projection-core_2.13    [1.6.20](https://mvnrepository.com/artifact/com.lightbend.akka/akka-projection-core_2.13/1.6.20)
    ...
    com.typesafe.akka    akka-stream_2.13    [2.10.13](https://mvnrepository.com/artifact/com.typesafe.akka/akka-stream_2.13/2.10.13)    BUSL-1.1
        ...
        org.scala-lang    scala-library    [2.13.17](https://mvnrepository.com/artifact/org.scala-lang/scala-library/2.13.17)    Apache-2.0
    org.scala-lang    scala-library    [2.13.17](https://mvnrepository.com/artifact/org.scala-lang/scala-library/2.13.17)    Apache-2.0
com.lightbend.akka    akka-projection-durable-state_2.13    [1.6.20](https://mvnrepository.com/artifact/com.lightbend.akka/akka-projection-durable-state_2.13/1.6.20)
    com.lightbend.akka    akka-projection-core_2.13    [1.6.20](https://mvnrepository.com/artifact/com.lightbend.akka/akka-projection-core_2.13/1.6.20)
        com.typesafe.akka    akka-actor-typed_2.13    [2.10.13](https://mvnrepository.com/artifact/com.typesafe.akka/akka-actor-typed_2.13/2.10.13)    BUSL-1.1
            com.typesafe.akka    akka-actor_2.13    [2.10.13](https://mvnrepository.com/artifact/com.typesafe.akka/akka-actor_2.13/2.10.13)    BUSL-1.1
                com.typesafe    config    [1.4.5](https://mvnrepository.com/artifact/com.typesafe/config/1.4.5)    Apache-2.0
...
com.lightbend.akka    akka-projection-eventsourced_2.13    [1.6.20](https://mvnrepository.com/artifact/com.lightbend.akka/akka-projection-eventsourced_2.13/1.6.20)
    ...
    com.typesafe.akka    akka-persistence-query_2.13    [2.10.13](https://mvnrepository.com/artifact/com.typesafe.akka/akka-persistence-query_2.13/2.10.13)    BUSL-1.1
        ...
        org.scala-lang    scala-library    [2.13.17](https://mvnrepository.com/artifact/org.scala-lang/scala-library/2.13.17)    Apache-2.0
    org.scala-lang    scala-library    [2.13.17](https://mvnrepository.com/artifact/org.scala-lang/scala-library/2.13.17)    Apache-2.0
com.lightbend.akka    akka-projection-grpc_2.13    [1.6.20](https://mvnrepository.com/artifact/com.lightbend.akka/akka-projection-grpc_2.13/1.6.20)
...
By default, `akka-projection-r2dbc` uses the same connection pool and `dialect` as `akka-persistence-r2dbc`, see [Connection configuration](https://doc.akka.io/libraries/akka-persistence-r2dbc/1.3/config.html#connection-configuration).
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/main/resources/reference.conf#L5-L115 "Go to snippet source")akka.projection.r2dbc {
  ...
  offset-store {
    ...
    # Delete old entries from the offset store database when offset timestamps
    # are older than this duration.
    # The deletion criteria is combined with delete-after-consumed.
    # Delete when offset timestamp is older than delete-after and consumed timestamp
    # is older than delete-after-consumed.
    #
    # For compatibility with older versions the default for this is 1 day, but
    # if database storage size isn't a concern it is more efficient and safer to keep
    # offsets for a longer time, such as 10 days.
    delete-after = 1 day

    # Delete old entries from the offset store database when consumed timestamps
    # are older than this duration.
    # For example, when rebuilding a projection from old events it is best to
    # keep all offsets during the rebuild phase. The offsets can also be useful
    # after a rebuild to confirm that all events have been processed.
    #
    # The deletion criteria is combined with delete-after.
    # Delete when offset timestamp is older than delete-after and consumed timestamp
    # is older than delete-after-consumed.
    delete-after-consumed = 9 days

    # Delete old entries from the offset store database with this frequency.
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/scala/docs/home/projection/R2dbcProjectionDocExample.scala#L115-L159 "Go to snippet source")  
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/java/jdocs/home/projection/R2dbcProjectionDocExample.java#L40-L197 "Go to snippet source")import akka.cluster.sharding.typed.javadsl.ShardedDaemonProcess;
import akka.projection.ProjectionBehavior;
import akka.persistence.query.typed.EventEnvelope;
import akka.projection.Projection;
import akka.projection.ProjectionId;
...
It is possible to dynamically scale the number of Projection instances as described in [Sharded Daemon Process documentation](https://doc.akka.io/libraries/akka-core/2.10/typed/cluster-sharded-daemon-process.html#dynamic-scaling-of-number-of-workers). 
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/scala/docs/home/projection/R2dbcProjectionDocExample.scala#L190-L198 "Go to snippet source")  
import akka.projection.ProjectionId
import akka.projection.r2dbc.scaladsl.R2dbcProjection
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/java/jdocs/home/projection/R2dbcProjectionDocExample.java#L50-L225 "Go to snippet source")import akka.projection.ProjectionId;
import akka.projection.r2dbc.R2dbcProjectionSettings;
import akka.projection.r2dbc.javadsl.R2dbcProjection;
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/scala/docs/home/projection/R2dbcProjectionDocExample.scala#L204-L213 "Go to snippet source")  
import akka.projection.ProjectionId
import akka.projection.r2dbc.scaladsl.R2dbcProjection
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/java/jdocs/home/projection/R2dbcProjectionDocExample.java#L50-L242 "Go to snippet source")import akka.projection.ProjectionId;
import akka.projection.r2dbc.R2dbcProjectionSettings;
import akka.projection.r2dbc.javadsl.R2dbcProjection;
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/scala/docs/home/projection/R2dbcProjectionDocExample.scala#L219-L228 "Go to snippet source")  
import akka.projection.ProjectionId
import akka.projection.r2dbc.scaladsl.R2dbcProjection
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/java/jdocs/home/projection/R2dbcProjectionDocExample.java#L50-L259 "Go to snippet source")import akka.projection.ProjectionId;
import akka.projection.r2dbc.R2dbcProjectionSettings;
import akka.projection.r2dbc.javadsl.R2dbcProjection;
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/scala/docs/home/projection/R2dbcProjectionDocExample.scala#L28-L75 "Go to snippet source")import akka.persistence.query.typed.EventEnvelope
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/java/jdocs/home/projection/R2dbcProjectionDocExample.java#L27-L125 "Go to snippet source")import akka.projection.r2dbc.javadsl.R2dbcHandler;
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/scala/docs/home/projection/R2dbcProjectionDocExample.scala#L28-L107 "Go to snippet source")import akka.persistence.query.typed.EventEnvelope
import akka.projection.r2dbc.scaladsl.R2dbcHandler
import akka.projection.r2dbc.scaladsl.R2dbcSession
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/java/jdocs/home/projection/R2dbcProjectionDocExample.java#L27-L157 "Go to snippet source")import akka.projection.r2dbc.javadsl.R2dbcHandler;
import akka.projection.r2dbc.javadsl.R2dbcSession;
import io.r2dbc.spi.Statement;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
...
The [`Handler`](/api/akka-projection/1.6.20/akka/projection/javadsl/Handler.html "akka.projection.javadsl.Handler")[`Handler`](/api/akka-projection/1.6.20/akka/projection/scaladsl/Handler.html "akka.projection.scaladsl.Handler") can be used with `R2dbcProjection.atLeastOnceAsync` and `R2dbcProjection.groupedWithinAsync` if the handler is not storing the projection result in the database. The handler could send to a Kafka topic or integrate with something else.
...
In addition to the caveats described there a `R2dbcProjection.atLeastOnceFlow` must not filter out envelopes. Always emit a `Done` element for each completed envelope, even if application processing was skipped for the envelope.
...
- [`TimestampOffset`](https://doc.akka.io/api/akka-core/2.10/akka/persistence/query/TimestampOffset.html "akka.persistence.query.TimestampOffset")[`TimestampOffset`](https://doc.akka.io/japi/akka-core/2.10/akka/persistence/query/TimestampOffset.html "akka.persistence.query.TimestampOffset") that is used for [SourceProvider for eventsBySlices](eventsourced.html#sourceprovider-for-eventsbyslices) and [SourceProvider for changesBySlices](durable-state.html#sourceprovider-for-changesbyslices)
- other [`Offset`](https://doc.akka.io/api/akka-core/2.10/akka/persistence/query/Offset.html "akka.persistence.query.Offset")[`Offset`](https://doc.akka.io/japi/akka-core/2.10/akka/persistence/query/Offset.html "akka.persistence.query.Offset") types
...
See [eventsBySlices documentation](https://doc.akka.io/libraries/akka-persistence-r2dbc/1.3/query.html#publish-events-for-lower-latency-of-eventsbyslices).

## Multiple plugins

Just like how multiple plugins can be configured as described for [the R2DBC persistence plugin](https://doc.akka.io/libraries/akka-persistence-r2dbc/1.3/config.html#multiple-plugins) multiple projection configurations are possible.

For Projection offset store you need another config section:

```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/scala/docs/home/projection/R2dbcProjectionDocExample.scala#L236-L242 "Go to snippet source")second-projection-r2dbc = ${akka.projection.r2dbc}
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/scala/docs/home/projection/R2dbcProjectionDocExample.scala#L246-L257 "Go to snippet source")second-projection-r2dbc = ${akka.projection.r2dbc}
second-projection-r2dbc {
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/scala/docs/home/projection/R2dbcProjectionDocExample.scala#L262-L272 "Go to snippet source")  
import akka.projection.ProjectionId
import akka.projection.r2dbc.scaladsl.R2dbcProjection
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/java/jdocs/home/projection/R2dbcProjectionDocExample.java#L265-L273 "Go to snippet source")ProjectionId projectionId =
    ProjectionId.of("ShoppingCarts", "carts-" + minSlice + "-" + maxSlice);
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/scala/docs/home/projection/R2dbcProjectionDocExample.scala#L279-L292 "Go to snippet source")  
import akka.projection.ProjectionId
import akka.projection.r2dbc.scaladsl.R2dbcProjection
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/java/jdocs/home/projection/R2dbcProjectionDocExample.java#L60-L291 "Go to snippet source")import io.r2dbc.pool.ConnectionPool;
...
```
[source](https://github.com/akka/akka-projection/tree/master/akka-projection-r2dbc/src/test/scala/docs/home/projection/R2dbcProjectionDocExample.scala#L300-L304 "Go to snippet source")akka.projection.r2dbc.offset-store {
  delete-interval = 1 hour
...
The deletion criteria is a combination of `delete-after` and `delete-after-consumed`. Delete when offset timestamp (event timestamp) is older than `delete-after` and the timestamp when the projection consumed the event is older than `delete-after-consumed`.

When rebuilding a projection from old events it is best to keep all offsets during the rebuild phase. This is handled by the `delete-after-consumed`. The offsets can also be useful after a rebuild to confirm that all events have been processed.

For compatibility with older versions the default for `delete-after` is 1 day, but if database storage size isn’t a concern it is more efficient and safer to keep offsets for a longer time, such as 10 days.
...
### Example 29: Custom Connection Factory
...
### Example 30: Custom Connection Factory
...
- https://doc.akka.io/libraries/akka-persistence-r2dbc/1.3/overview.html
- https://doc.akka.io/libraries/akka-persistence-r2dbc/1.3/query.html
- https://doc.akka.io/libraries/akka-projection/1.6/cassandra.html
- https://doc.akka.io/libraries/akka-projection/1.6/durable-state.html
- https://doc.akka.io/libraries/akka-projection/1.6/error.html
- https://doc.akka.io/libraries/akka-projection/1.6/eventsourced.html
- https://doc.akka.io/libraries/akka-projection/1.6/flow.html
- https://doc.akka.io/libraries/akka-projection/1.6/kafka.html
...
---
*Source: [https://doc.akka.io/libraries/akka-projection/1.6/r2dbc.html](https://doc.akka.io/libraries/akka-projection/1.6/r2dbc.html)*