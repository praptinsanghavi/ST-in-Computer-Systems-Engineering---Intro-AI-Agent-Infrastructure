...
scraped_at: '2026-04-06T13:44:08Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-insights/current/home.html/plugins/slf4jevents/slf4j-events.html
...
```
dependencies {
  implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-slf4j-events', version: '2.22.2'
}
```
...
dependencies {
    implementation(
            [group: 'ch.qos.logback', name: 'logback-classic', version: '1.5.7']
    )
}
```
...
dependencies {
    implementation(
        [group: 'org.apache.logging.log4j', name: 'log4j-api', version: '2.17.2'],
        [group: 'org.apache.logging.log4j', name: 'log4j-core', version: '2.17.2'],
        [group: 'org.apache.logging.log4j', name: 'log4j-slf4j-impl', version: '2.17.2']
    )
}
```
...
- https://doc.akka.io/libraries/akka-insights/current/plugins/telegraf/telegraf.html
...
---
*Source: [https://doc.akka.io/libraries/akka-insights/current/plugins/slf4jevents/slf4j-events.html](https://doc.akka.io/libraries/akka-insights/current/plugins/slf4jevents/slf4j-events.html)*