...
scraped_at: '2026-04-06T13:44:03Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-insights/current/home.html/plugins/datadog/datadog.html
...
We provide an easy\-to\-get\-started plugin that contains all settings required for pushing Akka related metrics to Datadog.
...
dependencies {
  implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-datadog', version: '2.22.2'
}
```
...
```
dependencies {
  implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-datadog-socket', version: '2.22.2'
}
```
...
- https://doc.akka.io/libraries/akka-insights/current/plugins/newrelic/newrelic.html
- https://doc.akka.io/libraries/akka-insights/current/plugins/opentelemetry/global-opentelemetry.html
- https://doc.akka.io/libraries/akka-insights/current/setup/setup.html

---
*Source: [https://doc.akka.io/libraries/akka-insights/current/plugins/datadog/datadog.html](https://doc.akka.io/libraries/akka-insights/current/plugins/datadog/datadog.html)*