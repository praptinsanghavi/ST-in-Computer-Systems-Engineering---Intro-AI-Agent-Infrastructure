...
scraped_at: '2026-04-06T13:43:59Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-insights/current/home.html/extensions/custom-metrics.html
...
```
dependencies {
  implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-akka-typed_2.13', version: '2.22.2'
}
```
...
Note
Custom metrics on the actor\-level require you to explicitly enable the actor for instrumentation through the [actor configuration](../instrumentations/akka/actors.html).
...
- https://doc.akka.io/libraries/akka-insights/current/reference/api/javadoc/?com/lightbend/cinnamon/akka/CinnamonMetrics.html

---
*Source: [https://doc.akka.io/libraries/akka-insights/current/extensions/custom-metrics.html](https://doc.akka.io/libraries/akka-insights/current/extensions/custom-metrics.html)*