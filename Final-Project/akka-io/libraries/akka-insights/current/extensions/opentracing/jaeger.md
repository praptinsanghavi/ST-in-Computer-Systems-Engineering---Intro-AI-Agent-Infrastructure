...
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-insights/current/home.html/extensions/opentracing/jaeger.html
...
dependencies {
    ...
    implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-opentracing-jaeger', version: '2.22.2'
}
```
...
---
*Source: [https://doc.akka.io/libraries/akka-insights/current/extensions/opentracing/jaeger.html](https://doc.akka.io/libraries/akka-insights/current/extensions/opentracing/jaeger.html)*