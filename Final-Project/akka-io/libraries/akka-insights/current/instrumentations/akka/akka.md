...
scraped_at: '2026-04-06T13:43:54Z'
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-insights/current/home.html/instrumentations/akka/akka.html
...
```
dependencies {
  implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-akka_2.13', version: '2.22.2'
}
```
...
Additional cluster sharding metrics — including shard region buffer size, shard home latency, message drops, and shard handoff latency — are available via the [Akka Cluster Sharding](../akka-cluster-sharding/akka-cluster-sharding.html) module.
...
// Use Akka Cluster instrumentation
dependencies {
    implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-akka-cluster_2.13', version: '2.22.2'
}
```
...
- https://doc.akka.io/libraries/akka-insights/current/instrumentations/akka/dispatchers.html
...
---
*Source: [https://doc.akka.io/libraries/akka-insights/current/instrumentations/akka/akka.html](https://doc.akka.io/libraries/akka-insights/current/instrumentations/akka/akka.html)*