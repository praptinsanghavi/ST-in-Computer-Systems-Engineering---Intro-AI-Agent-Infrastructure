...
section: libraries
site: akka-io
source_url: /extensions/opentracing/datadog.html
...
dependencies {
    ...
    implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-opentracing-datadog', version: '2.21.4'
}
```
...
- https://doc.akka.io/libraries/akka-insights/2.21/extensions/opentracing/xray.html
...
---
*Source: [https://doc.akka.io/libraries/akka-insights/2.21/extensions/opentracing/datadog.html](https://doc.akka.io/libraries/akka-insights/2.21/extensions/opentracing/datadog.html)*