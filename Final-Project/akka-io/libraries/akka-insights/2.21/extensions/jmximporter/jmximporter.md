...
section: libraries
site: akka-io
source_url: /extensions/jmximporter/jmximporter.html
...
```
dependencies {
    implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-jmx-importer', version: '2.21.4'
}
```
...
---
*Source: [https://doc.akka.io/libraries/akka-insights/2.21/extensions/jmximporter/jmximporter.html](https://doc.akka.io/libraries/akka-insights/2.21/extensions/jmximporter/jmximporter.html)*