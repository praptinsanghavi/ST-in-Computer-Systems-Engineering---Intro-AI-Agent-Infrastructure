...
scraped_at: '2026-04-06T01:24:25Z'
section: libraries
site: akka-io
source_url: /plugins/slf4jevents/slf4j-events.html
...
```
dependencies {
  implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-slf4j-events', version: '2.21.4'
}
```
...
- https://doc.akka.io/libraries/akka-insights/2.21/plugins/telegraf/telegraf.html
...
---
*Source: [https://doc.akka.io/libraries/akka-insights/2.21/plugins/slf4jevents/slf4j-events.html](https://doc.akka.io/libraries/akka-insights/2.21/plugins/slf4jevents/slf4j-events.html)*