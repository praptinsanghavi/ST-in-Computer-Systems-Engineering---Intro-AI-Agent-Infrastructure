...
section: libraries
site: akka-io
source_url: /plugins/chmetrics/elastic.html
...
dependencies {
  implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-chmetrics-elasticsearch-reporter', version: '2.21.4'
}
```
...
---
*Source: [https://doc.akka.io/libraries/akka-insights/2.21/plugins/chmetrics/elastic.html](https://doc.akka.io/libraries/akka-insights/2.21/plugins/chmetrics/elastic.html)*