...
scraped_at: '2026-04-06T01:24:22Z'
section: libraries
site: akka-io
source_url: /plugins/datadog/datadog.html
...
dependencies {
  implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-datadog', version: '2.21.4'
}
```
...
```
dependencies {
  implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-datadog-socket', version: '2.21.4'
}
```
...
- https://doc.akka.io/libraries/akka-insights/2.21/plugins/opentelemetry/global-opentelemetry.html
- https://doc.akka.io/libraries/akka-insights/2.21/setup/setup.html

---
*Source: [https://doc.akka.io/libraries/akka-insights/2.21/plugins/datadog/datadog.html](https://doc.akka.io/libraries/akka-insights/2.21/plugins/datadog/datadog.html)*