...
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-insights/current//extensions/opentracing/jaeger.html
...
dependencies {
    ...
    implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-opentracing-jaeger', version: '2.19.4'
}
```
...
- https://doc.akka.io/libraries/akka-insights/2.19/extensions/opentracing/backends.html
...
---
*Source: [https://doc.akka.io/libraries/akka-insights/2.19/extensions/opentracing/jaeger.html](https://doc.akka.io/libraries/akka-insights/2.19/extensions/opentracing/jaeger.html)*