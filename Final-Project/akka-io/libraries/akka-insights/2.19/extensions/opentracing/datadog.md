...
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-insights/current//extensions/opentracing/datadog.html
...
dependencies {
    ...
    implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-opentracing-datadog', version: '2.19.4'
}
```
...
- https://doc.akka.io/libraries/akka-insights/2.19/extensions/opentracing/xray.html
...
---
*Source: [https://doc.akka.io/libraries/akka-insights/2.19/extensions/opentracing/datadog.html](https://doc.akka.io/libraries/akka-insights/2.19/extensions/opentracing/datadog.html)*