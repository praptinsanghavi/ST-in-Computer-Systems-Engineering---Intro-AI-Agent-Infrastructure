...
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-insights/current//extensions/mdc.html
...
```
dependencies {
  implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-slf4j-mdc_2.13', version: '2.19.4'
}
```
...
- https://doc.akka.io/libraries/akka-insights/2.19/extensions/opentracing/api.html
- https://doc.akka.io/libraries/akka-insights/2.19/extensions/opentracing/compatibility.html
...
---
*Source: [https://doc.akka.io/libraries/akka-insights/2.19/extensions/mdc.html](https://doc.akka.io/libraries/akka-insights/2.19/extensions/mdc.html)*