...
section: libraries
site: akka-io
source_url: https://doc.akka.io/libraries/akka-insights/current//extensions/jmximporter/jmximporter.html
...
```
dependencies {
    implementation group: 'com.lightbend.cinnamon', name: 'cinnamon-jmx-importer', version: '2.19.4'
}
```
...
- https://doc.akka.io/libraries/akka-insights/2.19/extensions/jmximporter/predefined.html
- https://doc.akka.io/libraries/akka-insights/2.19/extensions/producers.html

---
*Source: [https://doc.akka.io/libraries/akka-insights/2.19/extensions/jmximporter/jmximporter.html](https://doc.akka.io/libraries/akka-insights/2.19/extensions/jmximporter/jmximporter.html)*