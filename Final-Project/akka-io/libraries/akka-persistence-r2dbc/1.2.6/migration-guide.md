...
scraped_at: '2026-04-06T14:44:44Z'
section: libraries
site: akka-io
...
Some accessors on the [`R2dbcSettings`](/api/akka-persistence-r2dbc/1.2.6/akka/persistence/r2dbc/R2dbcSettings.html "akka.persistence.r2dbc.R2dbcSettings")[`R2dbcSettings`](/api/akka-persistence-r2dbc/1.2.6/akka/persistence/r2dbc/R2dbcSettings.html "akka.persistence.r2dbc.R2dbcSettings") class has been removed, the `ConnectionFactorySettings` and `Dialect` classes has been removed. A public API for looking at what dialect is used is now provided through `R2dbcSettings.dialectName`.
...
### Example 10: Optional changes for eventsBySlicesStartingFromSnapshots
...
### Example 11: Optional changes for eventsBySlicesStartingFromSnapshots
...
- https://doc.akka.io/api/akka-persistence-r2dbc/1.2.6/akka/persistence/r2dbc/R2dbcSettings.html
...
- https://doc.akka.io/libraries/akka-persistence-r2dbc/1.2.6/native-image.html
- https://doc.akka.io/libraries/akka-persistence-r2dbc/1.2.6/query.html

---
*Source: [https://doc.akka.io/libraries/akka-persistence-r2dbc/1.2.6/migration-guide.html](https://doc.akka.io/libraries/akka-persistence-r2dbc/1.2.6/migration-guide.html)*