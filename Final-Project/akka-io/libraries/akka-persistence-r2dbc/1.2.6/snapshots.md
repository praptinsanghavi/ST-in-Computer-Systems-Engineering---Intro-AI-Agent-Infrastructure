...
scraped_at: '2026-04-06T14:31:52Z'
section: libraries
site: akka-io
...
The snapshot plugin enables storing and loading snapshots for [event sourced persistent actors](https://doc.akka.io/libraries/akka-core/2.9/typed/persistence.html).
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/core/src/main/resources/reference.conf#L60-L74 "Go to snippet source")akka.persistence.r2dbc {
  snapshot {
...
The snapshot plugin is used whenever a snapshot write is triggered through the [Akka Persistence APIs](https://doc.akka.io/libraries/akka-core/2.9/typed/persistence-snapshot.html).

## Snapshot serialization

The state is serialized with [Akka Serialization](https://doc.akka.io/libraries/akka-core/2.9/serialization.html) and the binary snapshot representation is stored in the `snapshot` column together with information about what serializer that was used in the `ser_id` and `ser_manifest` columns.
...
---
*Source: [https://doc.akka.io/libraries/akka-persistence-r2dbc/1.2.6/snapshots.html](https://doc.akka.io/libraries/akka-persistence-r2dbc/1.2.6/snapshots.html)*