...
scraped_at: '2026-04-06T14:45:45Z'
section: libraries
site: akka-io
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/core/src/main/resources/reference.conf#L187-L213 "Go to snippet source")# Number of tables and databases that the data will be split into. The selection of data
...
When using the [default allocation strategy for Akka Cluster Sharding](https://doc.akka.io/libraries/akka-core/2.9/typed/cluster-sharding.html#shard-allocation) the there is no correlation between the slice of the entity and to which node the entity will be allocated. That means that there will be database connections from an Akka node to each of the databases. With a large Akka cluster each database would have to handle many connections, maybe more than its connection limit. That would be an inefficient use of resources on both the Akka side and the databases.

To reduce number of connections you can change the allocation strategy to [`SliceRangeShardAllocationStrategy`](https://doc.akka.io/api/akka-core/2.9/akka/cluster/sharding/typed/SliceRangeShardAllocationStrategy.html "akka.cluster.sharding.typed.SliceRangeShardAllocationStrategy")[`SliceRangeShardAllocationStrategy`](https://doc.akka.io/japi/akka-core/2.9/?akka/cluster/sharding/typed/SliceRangeShardAllocationStrategy.html "akka.cluster.sharding.typed.SliceRangeShardAllocationStrategy"). It will collocate entities with the same slice and contiguous range of slices to the same Akka node. Thereby the connections from one Akka node will go to one or a few databases since the database sharding is based on slice ranges.

Java

```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/java/jdocs/home/sharding/ShardingDocExample.java#L7-L38 "Go to snippet source")import akka.actor.typed.ActorSystem;
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/scala/docs/home/sharding/ShardingDocExample.scala#L7-L35 "Go to snippet source")import akka.actor.typed.ActorSystem
import akka.actor.typed.Behavior
import akka.cluster.sharding.typed.SliceRangeShardAllocationStrategy
...
Note that `SliceRangeShardAllocationStrategy` also requires change of the message extractor to [`SliceRangeShardAllocationStrategy.ShardBySliceMessageExtractor`](https://doc.akka.io/api/akka-core/2.9/akka/cluster/sharding/typed/SliceRangeShardAllocationStrategy$$ShardBySliceMessageExtractor.html "akka.cluster.sharding.typed.SliceRangeShardAllocationStrategy.ShardBySliceMessageExtractor")[`SliceRangeShardAllocationStrategy.ShardBySliceMessageExtractor`](https://doc.akka.io/japi/akka-core/2.9/?akka/cluster/sharding/typed/SliceRangeShardAllocationStrategy.ShardBySliceMessageExtractor.html "akka.cluster.sharding.typed.SliceRangeShardAllocationStrategy.ShardBySliceMessageExtractor").
...
- https://doc.akka.io/api/akka-core/2.9/akka/cluster/sharding/typed/SliceRangeShardAllocationStrategy$$ShardBySliceMessageExtractor.html
- https://doc.akka.io/api/akka-core/2.9/akka/cluster/sharding/typed/SliceRangeShardAllocationStrategy.html
- https://doc.akka.io/japi/akka-core/2.9/?akka/cluster/sharding/typed/SliceRangeShardAllocationStrategy.ShardBySliceMessageExtractor.html
- https://doc.akka.io/japi/akka-core/2.9/?akka/cluster/sharding/typed/SliceRangeShardAllocationStrategy.html
...
---
*Source: [https://doc.akka.io/libraries/akka-persistence-r2dbc/1.2.6/data-partition.html](https://doc.akka.io/libraries/akka-persistence-r2dbc/1.2.6/data-partition.html)*