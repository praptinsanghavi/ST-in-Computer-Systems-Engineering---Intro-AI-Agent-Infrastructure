...
scraped_at: '2026-04-05T19:30:28Z'
section: libraries
site: akka-io
...
[`R2dbcReadJournal`](/api/akka-persistence-r2dbc/1.2.6/akka/persistence/r2dbc/query/javadsl/R2dbcReadJournal.html "akka.persistence.r2dbc.query.javadsl.R2dbcReadJournal")[`R2dbcReadJournal`](/api/akka-persistence-r2dbc/1.2.6/akka/persistence/r2dbc/query/scaladsl/R2dbcReadJournal.html "akka.persistence.r2dbc.query.scaladsl.R2dbcReadJournal") implements the following [Persistence Queries](https://doc.akka.io/libraries/akka-core/2.9/persistence-query.html):
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/java/jdocs/home/query/QueryDocCompileOnly.java#L17-L51 "Go to snippet source")import akka.persistence.query.PersistenceQuery;
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/scala/docs/home/query/QueryDocCompileOnly.scala#L18-L22 "Go to snippet source")import akka.persistence.query.PersistenceQuery
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/java/jdocs/home/query/QueryDocCompileOnly.java#L63-L67 "Go to snippet source")PersistenceId persistenceId = PersistenceId.of("MyEntity", "id1");
eventQueries
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/scala/docs/home/query/QueryDocCompileOnly.scala#L35-L39 "Go to snippet source")val persistenceId = PersistenceId("MyEntity", "id1")
eventQueries
  .currentEventsByPersistenceId(persistenceId.id, 1, 101)
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/java/jdocs/home/query/QueryDocCompileOnly.java#L29-L92 "Go to snippet source")import akka.stream.javadsl.Source;
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/scala/docs/home/query/QueryDocCompileOnly.scala#L45-L60 "Go to snippet source")import akka.persistence.query.typed.EventEnvelope
...
[`R2dbcDurableStateStore`](/api/akka-persistence-r2dbc/1.2.6/akka/persistence/r2dbc/state/javadsl/R2dbcDurableStateStore.html "akka.persistence.r2dbc.state.javadsl.R2dbcDurableStateStore")[`R2dbcDurableStateStore`](/api/akka-persistence-r2dbc/1.2.6/akka/persistence/r2dbc/state/scaladsl/R2dbcDurableStateStore.html "akka.persistence.r2dbc.state.scaladsl.R2dbcDurableStateStore") implements the following [Persistence Queries](https://doc.akka.io/libraries/akka-core/2.9/durable-state/persistence-query.html):
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/java/jdocs/home/query/QueryDocCompileOnly.java#L23-L58 "Go to snippet source")import akka.persistence.r2dbc.state.javadsl.R2dbcDurableStateStore;
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/scala/docs/home/query/QueryDocCompileOnly.scala#L26-L30 "Go to snippet source")import akka.persistence.state.DurableStateStoreRegistry
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/java/jdocs/home/query/QueryDocCompileOnly.java#L35-L118 "Go to snippet source")import akka.persistence.query.DurableStateChange;
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/scala/docs/home/query/QueryDocCompileOnly.scala#L66-L82 "Go to snippet source")import akka.persistence.query.UpdatedDurableState
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/core/src/main/resources/reference.conf#L122-L171 "Go to snippet source")akka.persistence.r2dbc {
  query {
...
- https://doc.akka.io/libraries/akka-persistence-r2dbc/1.2.6/R2dbcReadJournal.loadEnvelope.html
...
---
*Source: [https://doc.akka.io/libraries/akka-persistence-r2dbc/1.2.6/query.html](https://doc.akka.io/libraries/akka-persistence-r2dbc/1.2.6/query.html)*