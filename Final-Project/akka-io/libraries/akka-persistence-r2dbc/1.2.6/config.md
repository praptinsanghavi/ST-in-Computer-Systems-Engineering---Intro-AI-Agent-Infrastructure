...
scraped_at: '2026-04-06T14:31:32Z'
section: libraries
site: akka-io
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/resources/application-postgres.conf#L7-L23 "Go to snippet source")akka.persistence.r2dbc.connection-factory = ${akka.persistence.r2dbc.postgres}
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/resources/application-yugabyte.conf#L7-L24 "Go to snippet source")akka.persistence.r2dbc.connection-factory = ${akka.persistence.r2dbc.yugabyte}
akka.persistence.r2dbc.connection-factory {
  host = "localhost"
  host = ${?DB_HOST}
  port = 5433
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/resources/application-h2.conf#L7-L13 "Go to snippet source")akka.persistence.r2dbc.connection-factory = ${akka.persistence.r2dbc.h2}
akka.persistence.r2dbc.connection-factory {
  protocol = "file"
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/resources/application-sqlserver.conf#L7-L17 "Go to snippet source")akka.persistence.r2dbc.connection-factory = ${akka.persistence.r2dbc.sqlserver}
akka.persistence.r2dbc.connection-factory {
  host = "localhost"
  host = ${?DB_HOST}
  database = "db"
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/core/src/main/resources/reference.conf#L279-L333 "Go to snippet source")# the connection can be configured with a url, eg: "r2dbc:postgresql://<host>:5432/<database>"
url = ""
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/core/src/main/resources/reference.conf#L279-L347 "Go to snippet source")# the connection can be configured with a url, eg: "r2dbc:postgresql://<host>:5432/<database>"
url = ""
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/core/src/main/resources/reference.conf#L357-L394 "Go to snippet source")# the connection can be configured with a url, eg: 'r2dbc:h2:file:////some/path/db-file;DB_CLOSE_DELAY=-1'
url = ""
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/core/src/main/resources/reference.conf#L405-L427 "Go to snippet source")# the connection can be configured with a url, eg: "r2dbc:sqlserver://<host>:1433/<database>"
url = ""
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/core/src/main/resources/reference.conf#L225-L264 "Go to snippet source")# Initial pool size.
initial-size = 5
# Maximum pool size.
max-size = 20
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/core/src/test/scala/akka/persistence/r2dbc/journal/MultiPluginSpec.scala#L26-L28 "Go to snippet source")akka.persistence.journal.plugin = "akka.persistence.r2dbc.journal"
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/core/src/test/scala/akka/persistence/r2dbc/journal/MultiPluginSpec.scala#L32-L54 "Go to snippet source")second-r2dbc = ${akka.persistence.r2dbc}
second-r2dbc {
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/core/src/test/scala/akka/persistence/r2dbc/journal/MultiPluginSpec.scala#L83-L85 "Go to snippet source")EventSourcedBehavior(persistenceId, emptyState = State(), commandHandler, eventHandler)
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.2.6/docs/src/test/java/jdocs/home/MultiPluginDocExample.java#L16-L56 "Go to snippet source")public class MyEntity extends EventSourcedBehavior<MyEntity.Command, MyEntity.Event, MyEntity.State> {
  @Override
...
- https://doc.akka.io/libraries/akka-persistence-r2dbc/1.2.6/data-partition.html
...
---
*Source: [https://doc.akka.io/libraries/akka-persistence-r2dbc/1.2.6/config.html](https://doc.akka.io/libraries/akka-persistence-r2dbc/1.2.6/config.html)*