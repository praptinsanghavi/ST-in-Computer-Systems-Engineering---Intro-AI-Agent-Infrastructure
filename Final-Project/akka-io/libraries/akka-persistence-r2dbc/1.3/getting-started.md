...
scraped_at: '2026-04-05T19:30:15Z'
section: libraries
site: akka-io
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.3.12/docker/docker-compose-postgres.yml "Go to snippet source")version: '2.2'
services:
  postgres-db:
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.3.12/docker/docker-compose-yugabyte.yml "Go to snippet source")version: '2.2'
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.3.12/docker/docker-compose-sqlserver.yml "Go to snippet source")version: '2.2'
services:
  sqlserver:
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.3.12/ddl-scripts/create_tables_postgres.sql "Go to snippet source")CREATE TABLE IF NOT EXISTS event_journal(
  slice INT NOT NULL,
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.3.12/ddl-scripts/create_tables_postgres_jsonb.sql "Go to snippet source")CREATE TABLE IF NOT EXISTS event_journal(
  slice INT NOT NULL,
  entity_type VARCHAR(255) NOT NULL,
  persistence_id VARCHAR(255) NOT NULL,
  seq_nr BIGINT NOT NULL,
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.3.12/ddl-scripts/create_tables_yugabyte.sql "Go to snippet source")CREATE TABLE IF NOT EXISTS event_journal(
  slice INT NOT NULL,
  entity_type VARCHAR(255) NOT NULL,
  persistence_id VARCHAR(255) NOT NULL,
  seq_nr BIGINT NOT NULL,
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.3.12/ddl-scripts/create_tables_sqlserver.sql "Go to snippet source")IF object_id('event_journal') is null
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.3.12/ddl-scripts/drop_tables_postgres.sql "Go to snippet source")DROP INDEX event_journal_slice_idx;
...
```
[source](https://github.com/akka/akka-persistence-r2dbc/tree/v1.3.12/ddl-scripts/drop_tables_sqlserver.sql "Go to snippet source")DROP INDEX event_journal.event_journal_slice_idx;
...
### Example 11: Microsoft SQL Server
...
### Example 12: Microsoft SQL Server

```scala
libraryDependencies += "io.r2dbc" %% "r2dbc-mssql" % "1.0.2.RELEASE"
```

### Example 13: Microsoft SQL Server
...
### Example 15: Local testing with docker
...
### Example 16: Local testing with docker
...
### Example 17: Local testing with docker
...
### Example 21: Creating the schema
...
### Example 22: Creating the schema
...
### Example 23: Creating the schema
...
### Example 28: Dropping the schema
...
### Example 29: Dropping the schema
...
### Example 30: Dropping the schema
...
---
*Source: [https://doc.akka.io/libraries/akka-persistence-r2dbc/1.3/getting-started.html](https://doc.akka.io/libraries/akka-persistence-r2dbc/1.3/getting-started.html)*