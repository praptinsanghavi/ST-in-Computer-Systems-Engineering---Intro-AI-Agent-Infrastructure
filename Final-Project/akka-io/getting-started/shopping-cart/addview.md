...
site: akka-io
source_url: https://doc.akka.io/getting-started/shopping-cart/addview.html
title: 'Authenticated user-specific lookup :: Akka Documentation'
---

# Authenticated user-specific lookup :: Akka Documentation
...
### Example 1: Creating isolated data types
...
### Example 2: Creating isolated data types
...
### Example 3: Creating isolated data types
...
### Example 4: Adding a shopping cart view
...
### Example 5: Creating a user entity
...
### Example 6: Creating a user entity
...
### Example 7: Adding a cart consumer
...
### Example 8: Securing the HTTP endpoint
...
### Example 9: Securing the HTTP endpoint
...
### Example 10: Securing the HTTP endpoint
...
### Example 11: Exercising the service
...
---
*Source: [https://doc.akka.io/getting-started/shopping-cart/addview.html](https://doc.akka.io/getting-started/shopping-cart/addview.html)*