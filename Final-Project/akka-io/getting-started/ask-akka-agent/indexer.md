...
site: akka-io
source_url: https://doc.akka.io/getting-started/ask-akka-agent/indexer.html
title: 'Knowledge indexing with a workflow :: Akka Documentation'
---

# Knowledge indexing with a workflow :: Akka Documentation
...
### Example 7: Injecting the MongoDB client
...
### Example 8: Injecting the MongoDB client
...
---
*Source: [https://doc.akka.io/getting-started/ask-akka-agent/indexer.html](https://doc.akka.io/getting-started/ask-akka-agent/indexer.html)*