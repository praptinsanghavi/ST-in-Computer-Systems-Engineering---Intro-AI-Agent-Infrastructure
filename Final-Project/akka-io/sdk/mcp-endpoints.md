...
scraped_at: '2026-04-05T18:19:02Z'
section: sdk
site: akka-io
source_url: https://doc.akka.io/sdk/mcp-endpoints.html
title: 'Designing MCP Endpoints :: Akka Documentation'
---

# Designing MCP Endpoints :: Akka Documentation

## Content

# Designing MCP Endpoints

![Endpoint](../_images/endpoint.png) An Endpoint is a component that creates an externally accessible API. MCP Endpoints allow you to expose a services to MCP clients such as LLM chat agent desktop applications and agents running on other services.
...
---
*Source: [https://doc.akka.io/sdk/mcp-endpoints.html](https://doc.akka.io/sdk/mcp-endpoints.html)*