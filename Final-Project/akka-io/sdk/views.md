...
scraped_at: '2026-04-05T18:19:03Z'
section: sdk
site: akka-io
source_url: https://doc.akka.io/sdk/views.html
title: 'Implementing Views :: Akka Documentation'
---

# Implementing Views :: Akka Documentation
...
- [Key Value Entity state changes](#value-entity)
- [Event Sourced Entity events](#event-sourced-entity)
- [Workflow state changes](#workflow)
- [Messages received from subscribing to topics on a broker](#topic-view)
...
- [How to transform results](#results-projection)
- [How to modify a View](#changing)
...
To create a View that lists customers by their name, [define the view](#_define_the_view) for a service that selects customers by name and associates a table name with the View. The table is created and used to store the View.
...
you have to [define the view to consume events](#_define_the_view_to_consume_events).
...
The source of a View can be also a Workflow state changes. It works the same way as shown in [Creating a View from an Event Sourced Entity](#event-sourced-entity) or [Creating a View from a Key Value Entity](#value-entity), but you define it with `@Consume.FromWorkflow` instead.
...
The source of a View can be a topic. It works the same way as shown in [Creating a View from an Event Sourced Entity](#event-sourced-entity) or [Creating a View from a Key Value Entity](#value-entity), but you define it with `@Consume.FromTopic` instead.
...
|  | This is not intended as transport for [service to service](consuming-producing.html#s2s-eventing) propagation of updates, and it does not guarantee delivery. For such use cases you should instead publish events to a topic, see [Consuming and producing](consuming-producing.html) |
| --- | --- |
...
### Example 1: Creating a View from a Key Value Entity
...
### Example 3: Using a transformed model

```java
public record CustomerSummary(String customerId, String name, String email) {}
```

### Example 4: Using a transformed model
...
### Example 5: Handling Key Value Entity deletes
...
### Example 6: Creating a View from an Event Sourced Entity
...
### Example 7: Define the View to consume events
...
### Example 8: Starting from Snapshot
...
### Example 9: Creating a View from a Workflow
...
### Example 10: Creating a View from a topic
...
### Example 11: Streaming the result
...
### Example 12: Streaming view updates
...
### Example 13: How to modify a View

```sql
SELECT * FROM customers WHERE name = :customer_name
```

### Example 14: How to modify a View

```sql
SELECT * FROM customers WHERE name = :customer_name AND is-active = true
```

### Example 15: Testing the View
...
- https://doc.akka.io/reference/views/index.html
...
- https://doc.akka.io/sdk/serialization.html

---
*Source: [https://doc.akka.io/sdk/views.html](https://doc.akka.io/sdk/views.html)*