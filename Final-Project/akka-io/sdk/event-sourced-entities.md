...
section: sdk
site: akka-io
source_url: https://doc.akka.io/sdk/event-sourced-entities.html
title: 'Implementing Event Sourced Entities :: Akka Documentation'
---

# Implementing Event Sourced Entities :: Akka Documentation
...
An Event Sourced Entity must not update its in\-memory state directly as a result of a [*command*](../reference/glossary.html#command). The handling of a command, if it results in changes being required to state, should persist [*events*](../reference/glossary.html#event). These events will then be processed by the entity, at which point the in\-memory state can and should be changed in response.
...
Calling a command handler through the TestKit gives us back an [`EventSourcedResult`](_attachments/testkit/akka/javasdk/testkit/EventSourcedResult.html). This class has methods that we can use to assert the handling of the command, such as:
...
### Example 3: Implementing behavior
...
### Example 9: Multi-region replication
...
### Example 10: Replication filters
...
### Example 11: Replication filters
...
### Example 12: Publishing notifications
...
### Example 13: Subscribing to notifications
...
---
*Source: [https://doc.akka.io/sdk/event-sourced-entities.html](https://doc.akka.io/sdk/event-sourced-entities.html)*