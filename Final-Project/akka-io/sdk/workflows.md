...
scraped_at: '2026-04-05T18:19:04Z'
section: sdk
site: akka-io
source_url: https://doc.akka.io/sdk/workflows.html
title: 'Implementing Workflows :: Akka Documentation'
---

# Implementing Workflows :: Akka Documentation
...
| **3** | Otherwise, transitions to the `WAITING_FOR_ACCEPTANCE` step, which will [pause](#_pausing_workflow) the workflow and wait for the human acceptance of the transfer. |
...
### Example 10: Calling external services
...
### Example 13: Publishing notifications
...
### Example 14: Subscribing to notifications
...
### Example 18: Multi-region replication
...
- https://doc.akka.io/java/_attachments/workflow-quickstart.zip
...
---
*Source: [https://doc.akka.io/sdk/workflows.html](https://doc.akka.io/sdk/workflows.html)*