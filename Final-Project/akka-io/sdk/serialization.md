...
scraped_at: '2026-04-05T18:19:33Z'
section: sdk
site: akka-io
source_url: https://doc.akka.io/sdk/serialization.html
...
byte[] serialized = SerializationTestkit.serialize(
  new CustomerCreatedOld("[[email protected]](/cdn-cgi/l/email-protection)", "bob", "Wall Street", "New York")
);
...
### Example 1: Jackson serialization
...
### Example 2: Adding an optional field

```java
record NameChanged(String newName) implements CustomerEvent {}
```

### Example 3: Adding an optional field
...
### Example 4: Adding a mandatory field
...
### Example 5: Adding a mandatory field
...
### Example 6: Renaming a field

```java
record AddressChanged(Address address) implements CustomerEvent {}
```

### Example 7: Renaming a field
...
### Example 9: Changing the structure
...
### Example 10: Changing the structure
...
### Example 11: Changing the structure
...
---
*Source: [https://doc.akka.io/sdk/serialization.html](https://doc.akka.io/sdk/serialization.html)*