...
section: sdk
site: akka-io
source_url: https://doc.akka.io/sdk/component-and-service-calls.html
title: 'Component and service calls :: Akka Documentation'
---

# Component and service calls :: Akka Documentation
...
For component client error handling, see [Errors and failures](errors-and-failures.html) section.
...
### Example 4: Calling Akka services over HTTP
...
### Example 5: Calling external HTTP services
...
### Example 6: Calling Akka services over gRPC
...
### Example 7: Calling external gRPC services
...
### Example 8: Calling external gRPC services
...
- https://doc.akka.io/sdk/errors-and-failures.html
- https://doc.akka.io/sdk/grpc-endpoints.html
- https://doc.akka.io/sdk/setup-and-dependency-injection.html

---
*Source: [https://doc.akka.io/sdk/component-and-service-calls.html](https://doc.akka.io/sdk/component-and-service-calls.html)*