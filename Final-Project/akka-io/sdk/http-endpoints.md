...
scraped_at: '2026-04-05T18:19:01Z'
section: sdk
site: akka-io
source_url: https://doc.akka.io/sdk/http-endpoints.html
title: 'Designing HTTP Endpoints :: Akka Documentation'
---

# Designing HTTP Endpoints :: Akka Documentation
...
including headers. See [Low level requests](#_low_level_requests) below for more details
...
- `CompletionStage<T>` to respond based on an asynchronous result.
	...
	the error handling explained in [error responses](#_error_responses).
- `akka.http.javadsl.model.HttpResponse` for complete control over the response, see [Low level responses](#_low_level_responses) below
...
Browsers only use HTTP GET requests for SSE. Other HTTP methods will not be possible to consume through
...
### Example 8: Interacting with other components
...
### Example 9: Interacting with other HTTP services
...
### Example 10: Low level responses
...
### Example 11: Low level responses
...
### Example 12: Low level responses
...
### Example 15: Serving static content
...
### Example 16: Serving static content
...
### Example 17: OpenAPI endpoint schema
...
### Example 18: OpenAPI endpoint schema
...
### Example 19: OpenAPI endpoint schema
...
### Example 20: Streaming responses requires extra thought
...
### Example 21: Streaming responses requires extra thought
...
### Example 22: Streaming responses requires extra thought
...
### Example 23: Streaming responses requires extra thought
...
### Example 24: Creating a WebSocket endpoint
...
### Example 25: Creating a WebSocket endpoint
...
### Example 26: Testing WebSocket endpoints
...
- https://doc.akka.io/reference/jwts.html
...
---
*Source: [https://doc.akka.io/sdk/http-endpoints.html](https://doc.akka.io/sdk/http-endpoints.html)*