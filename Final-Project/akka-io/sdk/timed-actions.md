...
section: sdk
site: akka-io
source_url: https://doc.akka.io/sdk/timed-actions.html
title: 'Timers :: Akka Documentation'
---

# Timers :: Akka Documentation
...
|  | You could entirely skip timer deletion when handling confirmation. In this case, the registered timer would be triggered later, and `OrderEntity.cancel` would handle this case gracefully. However, it’s always good practice to perform housekeeping to save resources. |
| --- | --- |
...
### Example 3: Handling the timer call
...
### Example 4: Handling the timer call
...
---
*Source: [https://doc.akka.io/sdk/timed-actions.html](https://doc.akka.io/sdk/timed-actions.html)*