---
description: 'declaration: package: akka.javasdk.agent, interface: Guardrail, class:
  GuardrailException'
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:31:06Z'
section: sdk
site: akka-io
source_url: https://doc.akka.io/sdk/_attachments/api/akka/javasdk/agent/Guardrail.GuardrailException.html
title: Guardrail.GuardrailException
---

# Guardrail.GuardrailException

> **Summary:** declaration: package: akka.javasdk.agent, interface: Guardrail, class: GuardrailException
...
public static final class Guardrail.GuardrailException
...
Thrown when the text didn't pass the evaluation criteria, and `report-only` is true. Can
 be handled in `onFailure`.

See Also:

- [Serialized Form](../../../serialized-form.html#akka.javasdk.agent.Guardrail.GuardrailException)
...
Constructor
Description
`[GuardrailException](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message)`
- ## Method Summary
...
- ## Constructor Details
	...
	public GuardrailException([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message)
...
---
*Source: [https://doc.akka.io/sdk/_attachments/api/akka/javasdk/agent/Guardrail.GuardrailException.html](https://doc.akka.io/sdk/_attachments/api/akka/javasdk/agent/Guardrail.GuardrailException.html)*