...
description: 'declaration: package: akka.javasdk.workflow, class: Workflow, interface:
  StepHandler, record: OneArgStepHandler'
knowledge_type: official_documentation
scraped_at: '2026-04-05T19:33:04Z'
section: sdk
site: akka-io
source_url: https://doc.akka.io/sdk/_attachments/api/akka/javasdk/workflow/Workflow.StepHandler.OneArgStepHandler.html
title: Workflow.StepHandler.OneArgStepHandler
---

# Workflow.StepHandler.OneArgStepHandler

> **Summary:** declaration: package: akka.javasdk.workflow, class: Workflow, interface: StepHandler, record: OneArgStepHandler

## Content

Package [akka.javasdk.workflow](package-summary.html)
# Record Class Workflow.StepHandler.OneArgStepHandler
...
akka.javasdk.workflow.Workflow.StepHandler.OneArgStepHandler
...
public static record Workflow.StepHandler.OneArgStepHandler(akka.japi.function.Function2\<?,?,[Workflow.StepEffect](Workflow.StepEffect.html "interface in akka.javasdk.workflow")\> handler, [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html "class or interface in java.lang") input)
...
implements [Workflow.StepHandler](Workflow.StepHandler.html "interface in akka.javasdk.workflow")

- ## Nested Class Summary

## Nested classes/interfaces inherited from interface akka.javasdk.workflow.[Workflow.StepHandler](Workflow.StepHandler.html "interface in akka.javasdk.workflow")

`[Workflow.StepHandler.NoArgStepHandler](Workflow.StepHandler.NoArgStepHandler.html "class in akka.javasdk.workflow"), [Workflow.StepHandler.OneArgStepHandler](Workflow.StepHandler.OneArgStepHandler.html "class in akka.javasdk.workflow")`
- ## Constructor Summary
...
Constructor
Description
`[OneArgStepHandler](#%3Cinit%3E(akka.japi.function.Function2,java.lang.Object))(akka.japi.function.Function2<?,?,[Workflow.StepEffect](Workflow.StepEffect.html "interface in akka.javasdk.workflow")> handler,
...
`akka.japi.function.Function2<?,?,[Workflow.StepEffect](Workflow.StepEffect.html "interface in akka.javasdk.workflow")>`
`[handler](#handler())()`
...
- ## Constructor Details
	...
	public OneArgStepHandler(akka.japi.function.Function2\<?,?,[Workflow.StepEffect](Workflow.StepEffect.html "interface in akka.javasdk.workflow")\> handler,
	 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html "class or interface in java.lang") input)
	Creates an instance of a `OneArgStepHandler` record class.
...
- ## Method Details
	...
	public akka.japi.function.Function2\<?,?,[Workflow.StepEffect](Workflow.StepEffect.html "interface in akka.javasdk.workflow")\> handler()
	Returns the value of the `handler` record component.
...
---
*Source: [https://doc.akka.io/sdk/_attachments/api/akka/javasdk/workflow/Workflow.StepHandler.OneArgStepHandler.html](https://doc.akka.io/sdk/_attachments/api/akka/javasdk/workflow/Workflow.StepHandler.OneArgStepHandler.html)*