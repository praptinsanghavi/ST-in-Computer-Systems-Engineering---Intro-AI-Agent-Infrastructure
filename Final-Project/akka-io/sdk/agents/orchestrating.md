...
scraped_at: '2026-04-05T19:39:25Z'
section: sdk
site: akka-io
source_url: https://doc.akka.io/sdk/agents/orchestrating.html
title: 'Orchestrating multiple agents :: Akka Documentation'
---

# Orchestrating multiple agents :: Akka Documentation
...
Let’s first look at how to define a workflow that orchestrates several agents in a predefined steps. This is similar to the [`ActivityAgentManager`](calling.html) that was illustrated above, but it uses both the `WeatherAgent` and the `ActivityAgent`. First it retrieves the weather forecast and then it finds suitable activities.
...
Note that in ![steps 2](../../concepts/_images/steps-2.svg) of the `Selector` we retrieve a subset of the agents with a certain
...
### Example 1: Using a predefined workflow
...
### Example 2: Creating dynamic plans
...
### Example 3: Creating dynamic plans
...
### Example 4: Creating dynamic plans
...
### Example 5: Creating dynamic plans

```java
public record AgentSelection(List<String> agents) {}
```

### Example 6: Creating dynamic plans
...
### Example 7: Creating dynamic plans
...
### Example 8: Creating dynamic plans
...
- https://doc.akka.io/sdk/agents/calling.html
- https://doc.akka.io/sdk/agents/streaming.html

---
*Source: [https://doc.akka.io/sdk/agents/orchestrating.html](https://doc.akka.io/sdk/agents/orchestrating.html)*