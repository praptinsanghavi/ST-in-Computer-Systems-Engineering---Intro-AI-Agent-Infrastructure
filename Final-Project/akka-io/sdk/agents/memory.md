...
section: sdk
site: akka-io
source_url: https://doc.akka.io/sdk/agents/memory.html
title: 'Managing session memory :: Akka Documentation'
---

# Managing session memory :: Akka Documentation
...
The [`MemoryProvider`](../_attachments/api/akka/javasdk/agent/MemoryProvider.html) interface allows you to control how session memory behaves:
...
In multi\-agent scenarios, you may want to control which messages from the session history are visible to specific agents. The [`MemoryFilter`](../_attachments/api/akka/javasdk/agent/MemoryFilter.html) API allows you to filter messages based on the agent component ID or role that produced them.
...
| **1** | The two `includeFromAgentId` calls are merged into a single Include filter that includes messages from both "weather\-agent" and "activity\-agent". This filter works as an OR clause: it includes all messages generated by "weather\-agent" or by "activity\-agent". |
| --- | --- |
...
### Example 1: Session memory configuration
...
### Example 2: Session memory configuration
...
### Example 3: Session memory configuration
...
### Example 4: Filter by agent component ID
...
### Example 5: Filter by agent component ID
...
### Example 8: Combining filters with other options
...
### Example 9: Available filter types
...
### Example 10: Available filter types
...
### Example 11: Accessing session memory
...
---
*Source: [https://doc.akka.io/sdk/agents/memory.html](https://doc.akka.io/sdk/agents/memory.html)*