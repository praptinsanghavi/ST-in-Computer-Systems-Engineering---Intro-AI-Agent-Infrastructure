...
scraped_at: '2026-04-06T14:57:34Z'
section: sdk
site: akka-io
source_url: https://doc.akka.io/sdk/agents/calling.html
title: 'Calling agents :: Akka Documentation'
---

# Calling agents :: Akka Documentation
...
### Example 2: Drive the agent from a workflow
...
### Example 3: Drive the agent from a workflow

```java
.stepConfig(ActivityAgentManager::suggestActivities, ofSeconds(60))
```

### Example 4: Drive the agent from a workflow
...
- https://doc.akka.io/sdk/agents/orchestrating.html
- https://doc.akka.io/sdk/component-and-service-calls.html
- https://doc.akka.io/sdk/workflows.html

---
*Source: [https://doc.akka.io/sdk/agents/calling.html](https://doc.akka.io/sdk/agents/calling.html)*